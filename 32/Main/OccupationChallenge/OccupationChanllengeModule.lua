...
def.static("table").OnSScoChallengeAward = function(p)
  ...
  if awardInfo.itemMap and next(awardInfo.itemMap) then
    PersonalHelper.CommonMsg(PersonalHelper.Type.ColorText, str, "ffff00", PersonalHelper.Type.ColorText, textRes.Common[150], "ffff00", PersonalHelper.Type.ItemMapWithLink, awardInfo.itemMap)
  end
