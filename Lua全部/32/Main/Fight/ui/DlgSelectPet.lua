...
def.method().ShowChildList = function(self)
  ...
  local summonTimes = constant.CChildrenConsts.child_summon_max - fightMgr.Instance().summonChildTimes
  local listPanel = self.m_panel:FindDirect("Img_Bg0/Scroll View/List")
  self.m_panel:FindDirect("Img_Bg0/Label_TipsNum"):GetComponent("UILabel").text = tostring(summonTimes)
