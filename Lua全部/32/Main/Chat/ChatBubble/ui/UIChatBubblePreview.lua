...
def.method("number", "=>", "table").GetOccupationModelInfo = function(self, ocp)
  ...
  if heroOccupation ~= ocp then
    ...
    local occupationBag = OcpEquipmentMgr.Instance():GetOccupationBag(ocp, heroProp.gender)
    ...
    local socpModelInfo = OcpEquipmentMgr.Instance():GetOccupationModelInfo(ocp, heroProp.gender)
