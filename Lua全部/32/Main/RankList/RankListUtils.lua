...
local OccupationCharMap = {
  ...
  [OccupationEnum.YIN_YANG_SHI] = ChartType.YINYANGSHI_MULTI_FIGHT_VALUE
}
...
local OccupWorldBossChartMap = {
  ...
  [OccupationEnum.YIN_YANG_SHI] = ChartType.BIG_BOSS_YINYANGSHI
}
...
local ChartOccupWorldBossMap = {
  ...
  [ChartType.BIG_BOSS_REMOTE_YINYANGSHI] = OccupationEnum.YIN_YANG_SHI
}
