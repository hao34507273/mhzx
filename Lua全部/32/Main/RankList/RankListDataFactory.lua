...
def.const("table").TYPE2CLASS = {
  ...
  [ChartType.YINYANGSHI_MULTI_FIGHT_VALUE] = import(".data.OccupationFightListData", CUR_CLASS_NAME),
  ...
  [ChartType.BIG_BOSS_YINYANGSHI] = import(".data.BigBossRankListData", CUR_CLASS_NAME),
  ...
  [ChartType.BIG_BOSS_REMOTE_YINYANGSHI] = import(".data.BigBossRemoteRankListData", CUR_CLASS_NAME),
