...
ModelInfo.RADIANCE_CFG_ID = 40
ModelInfo.PET_CFG_ID = 41
ModelInfo.PET_GEN = 42
ModelInfo.CHILDREN_FEISHENG_TIMES = 43
ModelInfo.PET_CUSTOM_TEXTURE_PIC_ID = 44
ModelInfo.MOUNTS_CUSTOM_TEXTURE_PIC_ID = 45
ModelInfo.AIRCRAFT_CUSTOM_TEXTURE_PIC_ID = 46
ModelInfo.KITE_EFFECT_ID = 50
ModelInfo.ROLE_TRANSPARENT = 51
