...
/*     */ 
/*     */ 
/*     */ public class ApolloGetAuthKeyReq
/*     */   extends __ApolloGetAuthKeyReq__
/*     */ {
/*     */   public static final int PROTOCOL_TYPE = 12071;
...
/*     */ 
/*     */ 
/*     */   public ApolloGetAuthKeyReq()
/*     */   {
/*  38 */     this.account = new Octets();
/*  39 */     this.roleid = 0L;
/*  40 */     this.client_ip = new Octets();
/*  41 */     this.async_data = new Octets();
/*  42 */     this.reserved1 = 0;
/*  43 */     this.reserved2 = 0;
/*     */   }
/*     */   
/*     */   public ApolloGetAuthKeyReq(Octets _account_, long _roleid_, Octets _client_ip_, Octets _async_data_, int _reserved1_, int _reserved2_) {
/*  47 */     this.account = _account_;
/*  48 */     this.roleid = _roleid_;
/*  49 */     this.client_ip = _client_ip_;
...
/*  62 */     _os_.marshal(this.client_ip);
...
/*  72 */     this.client_ip = _os_.unmarshal_Octets();
...
/*  84 */     if ((_o1_ instanceof ApolloGetAuthKeyReq)) {
/*  85 */       ApolloGetAuthKeyReq _o_ = (ApolloGetAuthKeyReq)_o1_;
/*  86 */       if (!this.account.equals(_o_.account)) return false;
/*  87 */       if (this.roleid != _o_.roleid) return false;
/*  88 */       if (!this.client_ip.equals(_o_.client_ip)) return false;
...
/* 101 */     _h_ += this.client_ip.hashCode();
...
/* 113 */     _sb_.append("B").append(this.client_ip.size()).append(",");
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\apollo\ApolloGetAuthKeyReq.class
