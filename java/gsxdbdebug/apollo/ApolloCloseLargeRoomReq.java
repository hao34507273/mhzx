...
/*     */ 
/*     */ public class ApolloCloseLargeRoomReq
/*     */   extends __ApolloCloseLargeRoomReq__
/*     */ {
/*     */   public static final int PROTOCOL_TYPE = 12053;
...
/*     */ 
/*     */ 
/*     */   public ApolloCloseLargeRoomReq()
/*     */   {
...
/*     */   }
/*     */   
/*     */   public ApolloCloseLargeRoomReq(Octets _account_, long _roleid_, long _roomid_, long _roomkey_, int _user_openid_, int _close_type_, long _gid_, Octets _uuid_, Octets _async_data_, int _reserved1_, int _reserved2_) {
...
/*  62 */     this.close_type = _close_type_;
/*  63 */     this.gid = _gid_;
/*  64 */     this.uuid = _uuid_;
...
/*  80 */     _os_.marshal(this.close_type);
...
/*  95 */     this.close_type = _os_.unmarshal_int();
...
/* 109 */     if ((_o1_ instanceof ApolloCloseLargeRoomReq)) {
/* 110 */       ApolloCloseLargeRoomReq _o_ = (ApolloCloseLargeRoomReq)_o1_;
...
/* 116 */       if (this.close_type != _o_.close_type) return false;
...
/* 151 */     _sb_.append(this.close_type).append(",");
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\apollo\ApolloCloseLargeRoomReq.class
