...
/*     */ 
/*     */ public class SLuckyBagNumLevelCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SLuckyBagNumLevelCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SLuckyBagNumLevelCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public int min;
/*     */   public int max;
...
/*  28 */     this.min = Integer.valueOf(rootElement.attributeValue("min")).intValue();
/*  29 */     this.max = Integer.valueOf(rootElement.attributeValue("max")).intValue();
/*  30 */     this.brassNum = Integer.valueOf(rootElement.attributeValue("brassNum")).intValue();
/*  31 */     this.jadeNum = Integer.valueOf(rootElement.attributeValue("jadeNum")).intValue();
/*  32 */     this.boxNum = Integer.valueOf(rootElement.attributeValue("boxNum")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  37 */     _os_.marshal(this.id);
/*  38 */     _os_.marshal(this.min);
/*  39 */     _os_.marshal(this.max);
/*  40 */     _os_.marshal(this.brassNum);
/*  41 */     _os_.marshal(this.jadeNum);
/*  42 */     _os_.marshal(this.boxNum);
/*  43 */     return _os_;
/*     */   }
/*     */   
...
/*  49 */     this.min = _os_.unmarshal_int();
/*  50 */     this.max = _os_.unmarshal_int();
/*  51 */     this.brassNum = _os_.unmarshal_int();
/*  52 */     this.jadeNum = _os_.unmarshal_int();
/*  53 */     this.boxNum = _os_.unmarshal_int();
/*  54 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  59 */     String path = dir + "mzm.gsp.luckybag.confbean.SLuckyBagNumLevelCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  72 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.luckybag.confbean.SLuckyBagNumLevelCfg"))
/*     */         {
/*     */ 
/*  75 */           SLuckyBagNumLevelCfg obj = new SLuckyBagNumLevelCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SLuckyBagNumLevelCfg> all)
/*     */   {
/*  89 */     String path = dir + "mzm.gsp.luckybag.confbean.SLuckyBagNumLevelCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 101 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.luckybag.confbean.SLuckyBagNumLevelCfg"))
/*     */         {
/*     */ 
/* 104 */           SLuckyBagNumLevelCfg obj = new SLuckyBagNumLevelCfg();
...
/*     */     
/* 120 */     String path = dir + "mzm.gsp.luckybag.confbean.SLuckyBagNumLevelCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 147 */           SLuckyBagNumLevelCfg _v_ = new SLuckyBagNumLevelCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SLuckyBagNumLevelCfg> all)
/*     */   {
/* 167 */     String path = dir + "mzm.gsp.luckybag.confbean.SLuckyBagNumLevelCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 194 */           SLuckyBagNumLevelCfg _v_ = new SLuckyBagNumLevelCfg();
...
/*     */ 
/*     */ 
/*     */   public static SLuckyBagNumLevelCfg getOld(int key)
/*     */   {
/* 215 */     return (SLuckyBagNumLevelCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SLuckyBagNumLevelCfg get(int key)
/*     */   {
/* 220 */     return (SLuckyBagNumLevelCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SLuckyBagNumLevelCfg> getOldAll()
/*     */   {
/* 225 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SLuckyBagNumLevelCfg> getAll()
/*     */   {
/* 230 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SLuckyBagNumLevelCfg> newAll)
/*     */   {
/* 235 */     oldAll = all;
/* 236 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\luckybag\confbean\SLuckyBagNumLevelCfg.class
