...
/*     */ 
/*     */ public class SLuckyBagMapCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SLuckyBagMapCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SLuckyBagMapCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public int mapCfgid;
/*     */   
...
/*  37 */     this.mapCfgid = _os_.unmarshal_int();
/*  38 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.luckybag.confbean.SLuckyBagMapCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.luckybag.confbean.SLuckyBagMapCfg"))
/*     */         {
/*     */ 
/*  59 */           SLuckyBagMapCfg obj = new SLuckyBagMapCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SLuckyBagMapCfg> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.luckybag.confbean.SLuckyBagMapCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.luckybag.confbean.SLuckyBagMapCfg"))
/*     */         {
/*     */ 
/*  88 */           SLuckyBagMapCfg obj = new SLuckyBagMapCfg();
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.luckybag.confbean.SLuckyBagMapCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           SLuckyBagMapCfg _v_ = new SLuckyBagMapCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SLuckyBagMapCfg> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.luckybag.confbean.SLuckyBagMapCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           SLuckyBagMapCfg _v_ = new SLuckyBagMapCfg();
...
/*     */ 
/*     */ 
/*     */   public static SLuckyBagMapCfg getOld(int key)
/*     */   {
/* 199 */     return (SLuckyBagMapCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SLuckyBagMapCfg get(int key)
/*     */   {
/* 204 */     return (SLuckyBagMapCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SLuckyBagMapCfg> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SLuckyBagMapCfg> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SLuckyBagMapCfg> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\luckybag\confbean\SLuckyBagMapCfg.class
