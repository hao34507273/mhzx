...
/*     */ 
/*     */ public class SLuckyBagScoreCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SLuckyBagScoreCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SLuckyBagScoreCfg> all = null;
/*     */   
/*     */   public int id;
...
/*     */   {
/*  47 */     String path = dir + "mzm.gsp.luckybag.confbean.SLuckyBagScoreCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  60 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.luckybag.confbean.SLuckyBagScoreCfg"))
/*     */         {
/*     */ 
/*  63 */           SLuckyBagScoreCfg obj = new SLuckyBagScoreCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SLuckyBagScoreCfg> all)
/*     */   {
/*  77 */     String path = dir + "mzm.gsp.luckybag.confbean.SLuckyBagScoreCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  89 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.luckybag.confbean.SLuckyBagScoreCfg"))
/*     */         {
/*     */ 
/*  92 */           SLuckyBagScoreCfg obj = new SLuckyBagScoreCfg();
...
/*     */     
/* 108 */     String path = dir + "mzm.gsp.luckybag.confbean.SLuckyBagScoreCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 135 */           SLuckyBagScoreCfg _v_ = new SLuckyBagScoreCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SLuckyBagScoreCfg> all)
/*     */   {
/* 155 */     String path = dir + "mzm.gsp.luckybag.confbean.SLuckyBagScoreCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 182 */           SLuckyBagScoreCfg _v_ = new SLuckyBagScoreCfg();
...
/*     */ 
/*     */ 
/*     */   public static SLuckyBagScoreCfg getOld(int key)
/*     */   {
/* 203 */     return (SLuckyBagScoreCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SLuckyBagScoreCfg get(int key)
/*     */   {
/* 208 */     return (SLuckyBagScoreCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SLuckyBagScoreCfg> getOldAll()
/*     */   {
/* 213 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SLuckyBagScoreCfg> getAll()
/*     */   {
/* 218 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SLuckyBagScoreCfg> newAll)
/*     */   {
/* 223 */     oldAll = all;
/* 224 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\luckybag\confbean\SLuckyBagScoreCfg.class
