...
/*     */ 
/*     */ public class SLuckyBagControllerCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SLuckyBagControllerCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SLuckyBagControllerCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public int controllerCfgid;
/*     */   public int time;
/*     */   public int type;
/*     */   
...
/*  26 */     this.controllerCfgid = Integer.valueOf(rootElement.attributeValue("controllerCfgid")).intValue();
/*  27 */     this.time = Integer.valueOf(rootElement.attributeValue("time")).intValue();
...
/*  34 */     _os_.marshal(this.controllerCfgid);
/*  35 */     _os_.marshal(this.time);
/*  36 */     _os_.marshal(this.type);
/*  37 */     return _os_;
/*     */   }
/*     */   
...
/*  43 */     this.controllerCfgid = _os_.unmarshal_int();
/*  44 */     this.time = _os_.unmarshal_int();
/*  45 */     this.type = _os_.unmarshal_int();
/*  46 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  51 */     String path = dir + "mzm.gsp.luckybag.confbean.SLuckyBagControllerCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  64 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.luckybag.confbean.SLuckyBagControllerCfg"))
/*     */         {
/*     */ 
/*  67 */           SLuckyBagControllerCfg obj = new SLuckyBagControllerCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SLuckyBagControllerCfg> all)
/*     */   {
/*  81 */     String path = dir + "mzm.gsp.luckybag.confbean.SLuckyBagControllerCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.luckybag.confbean.SLuckyBagControllerCfg"))
/*     */         {
/*     */ 
/*  96 */           SLuckyBagControllerCfg obj = new SLuckyBagControllerCfg();
...
/*     */     
/* 112 */     String path = dir + "mzm.gsp.luckybag.confbean.SLuckyBagControllerCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 139 */           SLuckyBagControllerCfg _v_ = new SLuckyBagControllerCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SLuckyBagControllerCfg> all)
/*     */   {
/* 159 */     String path = dir + "mzm.gsp.luckybag.confbean.SLuckyBagControllerCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 186 */           SLuckyBagControllerCfg _v_ = new SLuckyBagControllerCfg();
...
/*     */ 
/*     */ 
/*     */   public static SLuckyBagControllerCfg getOld(int key)
/*     */   {
/* 207 */     return (SLuckyBagControllerCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SLuckyBagControllerCfg get(int key)
/*     */   {
/* 212 */     return (SLuckyBagControllerCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SLuckyBagControllerCfg> getOldAll()
/*     */   {
/* 217 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SLuckyBagControllerCfg> getAll()
/*     */   {
/* 222 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SLuckyBagControllerCfg> newAll)
/*     */   {
/* 227 */     oldAll = all;
/* 228 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\luckybag\confbean\SLuckyBagControllerCfg.class
