...
/*     */ 
/*     */ public class SLuckyBagRefreshCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SLuckyBagRefreshCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SLuckyBagRefreshCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public int commonTimeCfgid;
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.id = Integer.valueOf(rootElement.attributeValue("id")).intValue();
/*  24 */     this.commonTimeCfgid = Integer.valueOf(rootElement.attributeValue("commonTimeCfgid")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  29 */     _os_.marshal(this.id);
/*  30 */     _os_.marshal(this.commonTimeCfgid);
/*  31 */     return _os_;
/*     */   }
/*     */   
...
/*  37 */     this.commonTimeCfgid = _os_.unmarshal_int();
/*  38 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.luckybag.confbean.SLuckyBagRefreshCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.luckybag.confbean.SLuckyBagRefreshCfg"))
/*     */         {
/*     */ 
/*  59 */           SLuckyBagRefreshCfg obj = new SLuckyBagRefreshCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SLuckyBagRefreshCfg> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.luckybag.confbean.SLuckyBagRefreshCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.luckybag.confbean.SLuckyBagRefreshCfg"))
/*     */         {
/*     */ 
/*  88 */           SLuckyBagRefreshCfg obj = new SLuckyBagRefreshCfg();
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.luckybag.confbean.SLuckyBagRefreshCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           SLuckyBagRefreshCfg _v_ = new SLuckyBagRefreshCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SLuckyBagRefreshCfg> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.luckybag.confbean.SLuckyBagRefreshCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           SLuckyBagRefreshCfg _v_ = new SLuckyBagRefreshCfg();
...
/*     */ 
/*     */ 
/*     */   public static SLuckyBagRefreshCfg getOld(int key)
/*     */   {
/* 199 */     return (SLuckyBagRefreshCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SLuckyBagRefreshCfg get(int key)
/*     */   {
/* 204 */     return (SLuckyBagRefreshCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SLuckyBagRefreshCfg> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SLuckyBagRefreshCfg> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SLuckyBagRefreshCfg> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\luckybag\confbean\SLuckyBagRefreshCfg.class
