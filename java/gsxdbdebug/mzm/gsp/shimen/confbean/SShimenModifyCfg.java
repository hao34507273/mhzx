...
/*     */ 
/*     */ public class SShimenModifyCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SShimenModifyCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SShimenModifyCfg> all = null;
/*     */   
...
/*     */   {
/*  47 */     String path = dir + "mzm.gsp.shimen.confbean.SShimenModifyCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  60 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.shimen.confbean.SShimenModifyCfg"))
/*     */         {
/*     */ 
/*  63 */           SShimenModifyCfg obj = new SShimenModifyCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SShimenModifyCfg> all)
/*     */   {
/*  77 */     String path = dir + "mzm.gsp.shimen.confbean.SShimenModifyCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  89 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.shimen.confbean.SShimenModifyCfg"))
/*     */         {
/*     */ 
/*  92 */           SShimenModifyCfg obj = new SShimenModifyCfg();
...
/*     */     
/* 108 */     String path = dir + "mzm.gsp.shimen.confbean.SShimenModifyCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 135 */           SShimenModifyCfg _v_ = new SShimenModifyCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SShimenModifyCfg> all)
/*     */   {
/* 155 */     String path = dir + "mzm.gsp.shimen.confbean.SShimenModifyCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 182 */           SShimenModifyCfg _v_ = new SShimenModifyCfg();
...
/*     */ 
/*     */ 
/*     */   public static SShimenModifyCfg getOld(int key)
/*     */   {
/* 203 */     return (SShimenModifyCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SShimenModifyCfg get(int key)
/*     */   {
/* 208 */     return (SShimenModifyCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SShimenModifyCfg> getOldAll()
/*     */   {
/* 213 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SShimenModifyCfg> getAll()
/*     */   {
/* 218 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SShimenModifyCfg> newAll)
/*     */   {
/* 223 */     oldAll = all;
/* 224 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\shimen\confbean\SShimenModifyCfg.class
