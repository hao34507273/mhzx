...
/*     */ 
/*     */ public class SOcp2graphnpcs implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SOcp2graphnpcs> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SOcp2graphnpcs> all = null;
/*     */   
/*     */   public int ocp;
/*     */   public int graphid;
/*     */   public int npc;
...
/*     */   {
/*  25 */     this.ocp = Integer.valueOf(rootElement.attributeValue("ocp")).intValue();
/*  26 */     this.graphid = Integer.valueOf(rootElement.attributeValue("graphid")).intValue();
/*  27 */     this.npc = Integer.valueOf(rootElement.attributeValue("npc")).intValue();
/*  28 */     this.npcservice = Integer.valueOf(rootElement.attributeValue("npcservice")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  33 */     _os_.marshal(this.ocp);
/*  34 */     _os_.marshal(this.graphid);
/*  35 */     _os_.marshal(this.npc);
/*  36 */     _os_.marshal(this.npcservice);
/*  37 */     return _os_;
/*     */   }
/*     */   
/*     */   public OctetsStream unmarshal(OctetsStream _os_) throws com.goldhuman.Common.Marshal.MarshalException
/*     */   {
/*  42 */     this.ocp = _os_.unmarshal_int();
/*  43 */     this.graphid = _os_.unmarshal_int();
/*  44 */     this.npc = _os_.unmarshal_int();
/*  45 */     this.npcservice = _os_.unmarshal_int();
/*  46 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  51 */     String path = dir + "mzm.gsp.shimen.confbean.SOcp2graphnpcs.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  64 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.shimen.confbean.SOcp2graphnpcs"))
/*     */         {
/*     */ 
/*  67 */           SOcp2graphnpcs obj = new SOcp2graphnpcs();
/*  68 */           obj.loadFromXml(elem);
/*  69 */           if (all.put(Integer.valueOf(obj.ocp), obj) != null) {
/*  70 */             throw new RuntimeException("duplicate key : " + obj.ocp);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SOcp2graphnpcs> all)
/*     */   {
/*  81 */     String path = dir + "mzm.gsp.shimen.confbean.SOcp2graphnpcs.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.shimen.confbean.SOcp2graphnpcs"))
/*     */         {
/*     */ 
/*  96 */           SOcp2graphnpcs obj = new SOcp2graphnpcs();
/*  97 */           obj.loadFromXml(elem);
/*  98 */           if (all.put(Integer.valueOf(obj.ocp), obj) != null) {
/*  99 */             throw new RuntimeException("duplicate key : " + obj.ocp);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 112 */     String path = dir + "mzm.gsp.shimen.confbean.SOcp2graphnpcs.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 139 */           SOcp2graphnpcs _v_ = new SOcp2graphnpcs();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SOcp2graphnpcs> all)
/*     */   {
/* 159 */     String path = dir + "mzm.gsp.shimen.confbean.SOcp2graphnpcs.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 186 */           SOcp2graphnpcs _v_ = new SOcp2graphnpcs();
...
/*     */ 
/*     */ 
/*     */   public static SOcp2graphnpcs getOld(int key)
/*     */   {
/* 207 */     return (SOcp2graphnpcs)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SOcp2graphnpcs get(int key)
/*     */   {
/* 212 */     return (SOcp2graphnpcs)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SOcp2graphnpcs> getOldAll()
/*     */   {
/* 217 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SOcp2graphnpcs> getAll()
/*     */   {
/* 222 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SOcp2graphnpcs> newAll)
/*     */   {
/* 227 */     oldAll = all;
/* 228 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\shimen\confbean\SOcp2graphnpcs.class
