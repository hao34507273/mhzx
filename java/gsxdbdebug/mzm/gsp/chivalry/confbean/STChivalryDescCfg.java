...
/*     */ 
/*     */ public class STChivalryDescCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, STChivalryDescCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, STChivalryDescCfg> all = null;
/*     */   
/*     */   public int activityType;
/*     */   public int gainUp;
/*     */   public int daySumType;
/*     */   public int allDaySum;
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  25 */     this.activityType = Integer.valueOf(rootElement.attributeValue("activityType")).intValue();
/*  26 */     this.gainUp = Integer.valueOf(rootElement.attributeValue("gainUp")).intValue();
/*  27 */     this.daySumType = Integer.valueOf(rootElement.attributeValue("daySumType")).intValue();
/*  28 */     this.allDaySum = Integer.valueOf(rootElement.attributeValue("allDaySum")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  33 */     _os_.marshal(this.activityType);
/*  34 */     _os_.marshal(this.gainUp);
/*  35 */     _os_.marshal(this.daySumType);
/*  36 */     _os_.marshal(this.allDaySum);
/*  37 */     return _os_;
/*     */   }
/*     */   
...
/*  43 */     this.gainUp = _os_.unmarshal_int();
/*  44 */     this.daySumType = _os_.unmarshal_int();
/*  45 */     this.allDaySum = _os_.unmarshal_int();
/*  46 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  51 */     String path = dir + "mzm.gsp.chivalry.confbean.STChivalryDescCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  64 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.chivalry.confbean.STChivalryDescCfg"))
/*     */         {
/*     */ 
/*  67 */           STChivalryDescCfg obj = new STChivalryDescCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, STChivalryDescCfg> all)
/*     */   {
/*  81 */     String path = dir + "mzm.gsp.chivalry.confbean.STChivalryDescCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.chivalry.confbean.STChivalryDescCfg"))
/*     */         {
/*     */ 
/*  96 */           STChivalryDescCfg obj = new STChivalryDescCfg();
...
/*     */     
/* 112 */     String path = dir + "mzm.gsp.chivalry.confbean.STChivalryDescCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 139 */           STChivalryDescCfg _v_ = new STChivalryDescCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, STChivalryDescCfg> all)
/*     */   {
/* 159 */     String path = dir + "mzm.gsp.chivalry.confbean.STChivalryDescCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 186 */           STChivalryDescCfg _v_ = new STChivalryDescCfg();
...
/*     */ 
/*     */ 
/*     */   public static STChivalryDescCfg getOld(int key)
/*     */   {
/* 207 */     return (STChivalryDescCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static STChivalryDescCfg get(int key)
/*     */   {
/* 212 */     return (STChivalryDescCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, STChivalryDescCfg> getOldAll()
/*     */   {
/* 217 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, STChivalryDescCfg> getAll()
/*     */   {
/* 222 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, STChivalryDescCfg> newAll)
/*     */   {
/* 227 */     oldAll = all;
/* 228 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\chivalry\confbean\STChivalryDescCfg.class
