...
/*     */ 
/*     */ public class SFabaoArtifactPropertyTable implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SFabaoArtifactPropertyTable> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SFabaoArtifactPropertyTable> all = null;
/*     */   
/*     */   public int id;
/*  19 */   public HashMap<Integer, ArtifactProperty> propertyMap = new HashMap();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.id = Integer.valueOf(rootElement.attributeValue("id")).intValue();
/*     */     
/*  25 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "propertyMap");
...
/*  51 */             keyElem = elem;
/*     */           }
/*  53 */           else if ((valueElem == null) && (elem.getName().equalsIgnoreCase("mzm.gsp.fabaolingqi.confbean.ArtifactProperty")))
/*     */           {
/*  55 */             valueElem = elem;
/*     */           }
/*     */         }
...
/*     */         
/*     */         int _k_;
/*     */         ArtifactProperty _v_;
/*     */         try
/*     */         {
/*  68 */           _k_ = Integer.valueOf(keyElem.getText()).intValue();
/*  69 */           _v_ = new ArtifactProperty();
...
/*     */         }
/*     */         
/*  77 */         this.propertyMap.put(Integer.valueOf(_k_), _v_);
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*  85 */     _os_.compact_uint32(this.propertyMap.size());
/*  86 */     for (java.util.Map.Entry<Integer, ArtifactProperty> _e_ : this.propertyMap.entrySet())
/*     */     {
...
/*     */       
/* 102 */       ArtifactProperty _v_ = new ArtifactProperty();
/* 103 */       _v_.unmarshal(_os_);
/* 104 */       this.propertyMap.put(Integer.valueOf(_k_), _v_);
/*     */     }
/* 106 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/* 111 */     String path = dir + "mzm.gsp.fabaolingqi.confbean.SFabaoArtifactPropertyTable.xml";
/*     */     
/*     */     try
/*     */     {
/* 115 */       all = new HashMap();
...
/* 124 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.fabaolingqi.confbean.SFabaoArtifactPropertyTable"))
/*     */         {
/*     */ 
/* 127 */           SFabaoArtifactPropertyTable obj = new SFabaoArtifactPropertyTable();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SFabaoArtifactPropertyTable> all)
/*     */   {
/* 141 */     String path = dir + "mzm.gsp.fabaolingqi.confbean.SFabaoArtifactPropertyTable.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 153 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.fabaolingqi.confbean.SFabaoArtifactPropertyTable"))
/*     */         {
/*     */ 
/* 156 */           SFabaoArtifactPropertyTable obj = new SFabaoArtifactPropertyTable();
...
/* 170 */     all = new HashMap();
/*     */     
/* 172 */     String path = dir + "mzm.gsp.fabaolingqi.confbean.SFabaoArtifactPropertyTable.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 199 */           SFabaoArtifactPropertyTable _v_ = new SFabaoArtifactPropertyTable();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SFabaoArtifactPropertyTable> all)
/*     */   {
/* 219 */     String path = dir + "mzm.gsp.fabaolingqi.confbean.SFabaoArtifactPropertyTable.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 246 */           SFabaoArtifactPropertyTable _v_ = new SFabaoArtifactPropertyTable();
...
/*     */ 
/*     */ 
/*     */   public static SFabaoArtifactPropertyTable getOld(int key)
/*     */   {
/* 267 */     return (SFabaoArtifactPropertyTable)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SFabaoArtifactPropertyTable get(int key)
/*     */   {
/* 272 */     return (SFabaoArtifactPropertyTable)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SFabaoArtifactPropertyTable> getOldAll()
/*     */   {
/* 277 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SFabaoArtifactPropertyTable> getAll()
/*     */   {
/* 282 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SFabaoArtifactPropertyTable> newAll)
/*     */   {
/* 287 */     oldAll = all;
/* 288 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\fabaolingqi\confbean\SFabaoArtifactPropertyTable.class
