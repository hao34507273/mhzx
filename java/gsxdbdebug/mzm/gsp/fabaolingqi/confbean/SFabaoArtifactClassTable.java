...
/*     */ 
/*     */ public class SFabaoArtifactClassTable implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SFabaoArtifactClassTable> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SFabaoArtifactClassTable> all = null;
/*     */   
/*     */   public int classId;
/*  19 */   public HashMap<Integer, Integer> level2cfgId = new HashMap();
/*  20 */   public HashMap<Integer, Integer> level2exp = new HashMap();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  24 */     this.classId = Integer.valueOf(rootElement.attributeValue("classId")).intValue();
/*     */     
/*  26 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "level2cfgId");
...
/*     */         }
/*     */         
/*  77 */         this.level2cfgId.put(Integer.valueOf(_k_), Integer.valueOf(_v_));
/*     */       }
/*     */     }
/*     */     
/*  81 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "level2exp");
...
/*     */         }
/*     */         
/* 132 */         this.level2exp.put(Integer.valueOf(_k_), Integer.valueOf(_v_));
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*     */   {
/* 139 */     _os_.marshal(this.classId);
/* 140 */     _os_.compact_uint32(this.level2cfgId.size());
/* 141 */     for (java.util.Map.Entry<Integer, Integer> _e_ : this.level2cfgId.entrySet())
/*     */     {
/* 143 */       _os_.marshal(((Integer)_e_.getKey()).intValue());
/* 144 */       _os_.marshal(((Integer)_e_.getValue()).intValue());
/*     */     }
/* 146 */     _os_.compact_uint32(this.level2exp.size());
/* 147 */     for (java.util.Map.Entry<Integer, Integer> _e_ : this.level2exp.entrySet())
/*     */     {
...
/*     */   {
/* 157 */     this.classId = _os_.unmarshal_int();
...
/* 164 */       this.level2cfgId.put(Integer.valueOf(_k_), Integer.valueOf(_v_));
/*     */     }
...
/* 172 */       this.level2exp.put(Integer.valueOf(_k_), Integer.valueOf(_v_));
/*     */     }
/* 174 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/* 179 */     String path = dir + "mzm.gsp.fabaolingqi.confbean.SFabaoArtifactClassTable.xml";
/*     */     
/*     */     try
/*     */     {
/* 183 */       all = new HashMap();
...
/* 192 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.fabaolingqi.confbean.SFabaoArtifactClassTable"))
/*     */         {
/*     */ 
/* 195 */           SFabaoArtifactClassTable obj = new SFabaoArtifactClassTable();
/* 196 */           obj.loadFromXml(elem);
/* 197 */           if (all.put(Integer.valueOf(obj.classId), obj) != null) {
/* 198 */             throw new RuntimeException("duplicate key : " + obj.classId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SFabaoArtifactClassTable> all)
/*     */   {
/* 209 */     String path = dir + "mzm.gsp.fabaolingqi.confbean.SFabaoArtifactClassTable.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 221 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.fabaolingqi.confbean.SFabaoArtifactClassTable"))
/*     */         {
/*     */ 
/* 224 */           SFabaoArtifactClassTable obj = new SFabaoArtifactClassTable();
/* 225 */           obj.loadFromXml(elem);
/* 226 */           if (all.put(Integer.valueOf(obj.classId), obj) != null) {
/* 227 */             throw new RuntimeException("duplicate key : " + obj.classId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/* 238 */     all = new HashMap();
/*     */     
/* 240 */     String path = dir + "mzm.gsp.fabaolingqi.confbean.SFabaoArtifactClassTable.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 267 */           SFabaoArtifactClassTable _v_ = new SFabaoArtifactClassTable();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SFabaoArtifactClassTable> all)
/*     */   {
/* 287 */     String path = dir + "mzm.gsp.fabaolingqi.confbean.SFabaoArtifactClassTable.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 314 */           SFabaoArtifactClassTable _v_ = new SFabaoArtifactClassTable();
...
/*     */ 
/*     */ 
/*     */   public static SFabaoArtifactClassTable getOld(int key)
/*     */   {
/* 335 */     return (SFabaoArtifactClassTable)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SFabaoArtifactClassTable get(int key)
/*     */   {
/* 340 */     return (SFabaoArtifactClassTable)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SFabaoArtifactClassTable> getOldAll()
/*     */   {
/* 345 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SFabaoArtifactClassTable> getAll()
/*     */   {
/* 350 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SFabaoArtifactClassTable> newAll)
/*     */   {
/* 355 */     oldAll = all;
/* 356 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\fabaolingqi\confbean\SFabaoArtifactClassTable.class
