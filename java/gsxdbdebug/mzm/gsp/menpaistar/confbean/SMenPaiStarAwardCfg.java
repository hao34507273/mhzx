...
/*     */ 
/*     */ public class SMenPaiStarAwardCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SMenPaiStarAwardCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SMenPaiStarAwardCfg> all = null;
/*     */   
...
/*     */   {
/*  24 */     this.occupationType = Integer.valueOf(rootElement.attributeValue("occupationType")).intValue();
/*  25 */     this.appellation = Integer.valueOf(rootElement.attributeValue("appellation")).intValue();
/*  26 */     this.mailCfgid = Integer.valueOf(rootElement.attributeValue("mailCfgid")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  31 */     _os_.marshal(this.occupationType);
/*  32 */     _os_.marshal(this.appellation);
...
/*     */   {
/*  39 */     this.occupationType = _os_.unmarshal_int();
/*  40 */     this.appellation = _os_.unmarshal_int();
...
/*     */   {
/*  47 */     String path = dir + "mzm.gsp.menpaistar.confbean.SMenPaiStarAwardCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  60 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.menpaistar.confbean.SMenPaiStarAwardCfg"))
/*     */         {
/*     */ 
/*  63 */           SMenPaiStarAwardCfg obj = new SMenPaiStarAwardCfg();
/*  64 */           obj.loadFromXml(elem);
/*  65 */           if (all.put(Integer.valueOf(obj.occupationType), obj) != null) {
/*  66 */             throw new RuntimeException("duplicate key : " + obj.occupationType);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SMenPaiStarAwardCfg> all)
/*     */   {
/*  77 */     String path = dir + "mzm.gsp.menpaistar.confbean.SMenPaiStarAwardCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  89 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.menpaistar.confbean.SMenPaiStarAwardCfg"))
/*     */         {
/*     */ 
/*  92 */           SMenPaiStarAwardCfg obj = new SMenPaiStarAwardCfg();
/*  93 */           obj.loadFromXml(elem);
/*  94 */           if (all.put(Integer.valueOf(obj.occupationType), obj) != null) {
/*  95 */             throw new RuntimeException("duplicate key : " + obj.occupationType);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 108 */     String path = dir + "mzm.gsp.menpaistar.confbean.SMenPaiStarAwardCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 135 */           SMenPaiStarAwardCfg _v_ = new SMenPaiStarAwardCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SMenPaiStarAwardCfg> all)
/*     */   {
/* 155 */     String path = dir + "mzm.gsp.menpaistar.confbean.SMenPaiStarAwardCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 182 */           SMenPaiStarAwardCfg _v_ = new SMenPaiStarAwardCfg();
...
/*     */ 
/*     */ 
/*     */   public static SMenPaiStarAwardCfg getOld(int key)
/*     */   {
/* 203 */     return (SMenPaiStarAwardCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SMenPaiStarAwardCfg get(int key)
/*     */   {
/* 208 */     return (SMenPaiStarAwardCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMenPaiStarAwardCfg> getOldAll()
/*     */   {
/* 213 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMenPaiStarAwardCfg> getAll()
/*     */   {
/* 218 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SMenPaiStarAwardCfg> newAll)
/*     */   {
/* 223 */     oldAll = all;
/* 224 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\menpaistar\confbean\SMenPaiStarAwardCfg.class
