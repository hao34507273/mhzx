...
/*     */ 
/*     */ public class SVoteNumCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SVoteNumCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SVoteNumCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public int num;
/*     */   
...
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.menpaistar.confbean.SVoteNumCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.menpaistar.confbean.SVoteNumCfg"))
/*     */         {
/*     */ 
/*  59 */           SVoteNumCfg obj = new SVoteNumCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SVoteNumCfg> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.menpaistar.confbean.SVoteNumCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.menpaistar.confbean.SVoteNumCfg"))
/*     */         {
/*     */ 
/*  88 */           SVoteNumCfg obj = new SVoteNumCfg();
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.menpaistar.confbean.SVoteNumCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           SVoteNumCfg _v_ = new SVoteNumCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SVoteNumCfg> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.menpaistar.confbean.SVoteNumCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           SVoteNumCfg _v_ = new SVoteNumCfg();
...
/*     */ 
/*     */ 
/*     */   public static SVoteNumCfg getOld(int key)
/*     */   {
/* 199 */     return (SVoteNumCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SVoteNumCfg get(int key)
/*     */   {
/* 204 */     return (SVoteNumCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SVoteNumCfg> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SVoteNumCfg> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SVoteNumCfg> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\menpaistar\confbean\SVoteNumCfg.class
