...
/*     */ 
/*     */ public class SVotePointCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SVotePointCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SVotePointCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public int maxLevel;
/*     */   public int point;
...
/*  26 */     this.maxLevel = Integer.valueOf(rootElement.attributeValue("maxLevel")).intValue();
/*  27 */     this.point = Integer.valueOf(rootElement.attributeValue("point")).intValue();
/*  28 */     this.overflow = Integer.valueOf(rootElement.attributeValue("overflow")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  33 */     _os_.marshal(this.id);
/*  34 */     _os_.marshal(this.maxLevel);
/*  35 */     _os_.marshal(this.point);
/*  36 */     _os_.marshal(this.overflow);
/*  37 */     return _os_;
/*     */   }
/*     */   
...
/*  43 */     this.maxLevel = _os_.unmarshal_int();
/*  44 */     this.point = _os_.unmarshal_int();
/*  45 */     this.overflow = _os_.unmarshal_int();
/*  46 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  51 */     String path = dir + "mzm.gsp.menpaistar.confbean.SVotePointCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  64 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.menpaistar.confbean.SVotePointCfg"))
/*     */         {
/*     */ 
/*  67 */           SVotePointCfg obj = new SVotePointCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SVotePointCfg> all)
/*     */   {
/*  81 */     String path = dir + "mzm.gsp.menpaistar.confbean.SVotePointCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.menpaistar.confbean.SVotePointCfg"))
/*     */         {
/*     */ 
/*  96 */           SVotePointCfg obj = new SVotePointCfg();
...
/*     */     
/* 112 */     String path = dir + "mzm.gsp.menpaistar.confbean.SVotePointCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 139 */           SVotePointCfg _v_ = new SVotePointCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SVotePointCfg> all)
/*     */   {
/* 159 */     String path = dir + "mzm.gsp.menpaistar.confbean.SVotePointCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 186 */           SVotePointCfg _v_ = new SVotePointCfg();
...
/*     */ 
/*     */ 
/*     */   public static SVotePointCfg getOld(int key)
/*     */   {
/* 207 */     return (SVotePointCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SVotePointCfg get(int key)
/*     */   {
/* 212 */     return (SVotePointCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SVotePointCfg> getOldAll()
/*     */   {
/* 217 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SVotePointCfg> getAll()
/*     */   {
/* 222 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SVotePointCfg> newAll)
/*     */   {
/* 227 */     oldAll = all;
/* 228 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\menpaistar\confbean\SVotePointCfg.class
