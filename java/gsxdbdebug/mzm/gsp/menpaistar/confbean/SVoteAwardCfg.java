...
/*     */ 
/*     */ public class SVoteAwardCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SVoteAwardCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SVoteAwardCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public int value;
/*     */   
...
/*  24 */     this.value = Integer.valueOf(rootElement.attributeValue("value")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  29 */     _os_.marshal(this.id);
/*  30 */     _os_.marshal(this.value);
/*  31 */     return _os_;
/*     */   }
/*     */   
...
/*  37 */     this.value = _os_.unmarshal_int();
/*  38 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.menpaistar.confbean.SVoteAwardCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.menpaistar.confbean.SVoteAwardCfg"))
/*     */         {
/*     */ 
/*  59 */           SVoteAwardCfg obj = new SVoteAwardCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SVoteAwardCfg> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.menpaistar.confbean.SVoteAwardCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.menpaistar.confbean.SVoteAwardCfg"))
/*     */         {
/*     */ 
/*  88 */           SVoteAwardCfg obj = new SVoteAwardCfg();
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.menpaistar.confbean.SVoteAwardCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           SVoteAwardCfg _v_ = new SVoteAwardCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SVoteAwardCfg> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.menpaistar.confbean.SVoteAwardCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           SVoteAwardCfg _v_ = new SVoteAwardCfg();
...
/*     */ 
/*     */ 
/*     */   public static SVoteAwardCfg getOld(int key)
/*     */   {
/* 199 */     return (SVoteAwardCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SVoteAwardCfg get(int key)
/*     */   {
/* 204 */     return (SVoteAwardCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SVoteAwardCfg> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SVoteAwardCfg> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SVoteAwardCfg> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\menpaistar\confbean\SVoteAwardCfg.class
