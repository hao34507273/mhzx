...
/*     */ 
/*     */ public class SMapToModuleFunSwitchCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SMapToModuleFunSwitchCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SMapToModuleFunSwitchCfg> all = null;
/*     */   
/*     */   public int id;
...
/*  24 */     this.moduleFunSwitchId = Integer.valueOf(rootElement.attributeValue("moduleFunSwitchId")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  29 */     _os_.marshal(this.id);
/*  30 */     _os_.marshal(this.moduleFunSwitchId);
/*  31 */     return _os_;
/*     */   }
/*     */   
...
/*  37 */     this.moduleFunSwitchId = _os_.unmarshal_int();
/*  38 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.guaji.confbean.SMapToModuleFunSwitchCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.guaji.confbean.SMapToModuleFunSwitchCfg"))
/*     */         {
/*     */ 
/*  59 */           SMapToModuleFunSwitchCfg obj = new SMapToModuleFunSwitchCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SMapToModuleFunSwitchCfg> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.guaji.confbean.SMapToModuleFunSwitchCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.guaji.confbean.SMapToModuleFunSwitchCfg"))
/*     */         {
/*     */ 
/*  88 */           SMapToModuleFunSwitchCfg obj = new SMapToModuleFunSwitchCfg();
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.guaji.confbean.SMapToModuleFunSwitchCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           SMapToModuleFunSwitchCfg _v_ = new SMapToModuleFunSwitchCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SMapToModuleFunSwitchCfg> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.guaji.confbean.SMapToModuleFunSwitchCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           SMapToModuleFunSwitchCfg _v_ = new SMapToModuleFunSwitchCfg();
...
/*     */ 
/*     */ 
/*     */   public static SMapToModuleFunSwitchCfg getOld(int key)
/*     */   {
/* 199 */     return (SMapToModuleFunSwitchCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SMapToModuleFunSwitchCfg get(int key)
/*     */   {
/* 204 */     return (SMapToModuleFunSwitchCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMapToModuleFunSwitchCfg> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMapToModuleFunSwitchCfg> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SMapToModuleFunSwitchCfg> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\guaji\confbean\SMapToModuleFunSwitchCfg.class
