...
/*     */ 
/*     */ public class SWorShipSalaryCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SWorShipSalaryCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SWorShipSalaryCfg> all = null;
/*     */   
/*     */   public int minNum;
/*     */   public int maxNum;
...
/*     */   {
/*  24 */     this.minNum = Integer.valueOf(rootElement.attributeValue("minNum")).intValue();
/*  25 */     this.maxNum = Integer.valueOf(rootElement.attributeValue("maxNum")).intValue();
/*  26 */     this.salaryPerOneFile = Integer.valueOf(rootElement.attributeValue("salaryPerOneFile")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  31 */     _os_.marshal(this.minNum);
/*  32 */     _os_.marshal(this.maxNum);
/*  33 */     _os_.marshal(this.salaryPerOneFile);
/*  34 */     return _os_;
/*     */   }
/*     */   
/*     */   public OctetsStream unmarshal(OctetsStream _os_) throws com.goldhuman.Common.Marshal.MarshalException
/*     */   {
/*  39 */     this.minNum = _os_.unmarshal_int();
/*  40 */     this.maxNum = _os_.unmarshal_int();
/*  41 */     this.salaryPerOneFile = _os_.unmarshal_int();
/*  42 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  47 */     String path = dir + "mzm.gsp.activity.confbean.SWorShipSalaryCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  60 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity.confbean.SWorShipSalaryCfg"))
/*     */         {
/*     */ 
/*  63 */           SWorShipSalaryCfg obj = new SWorShipSalaryCfg();
/*  64 */           obj.loadFromXml(elem);
/*  65 */           if (all.put(Integer.valueOf(obj.minNum), obj) != null) {
/*  66 */             throw new RuntimeException("duplicate key : " + obj.minNum);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SWorShipSalaryCfg> all)
/*     */   {
/*  77 */     String path = dir + "mzm.gsp.activity.confbean.SWorShipSalaryCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  89 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity.confbean.SWorShipSalaryCfg"))
/*     */         {
/*     */ 
/*  92 */           SWorShipSalaryCfg obj = new SWorShipSalaryCfg();
/*  93 */           obj.loadFromXml(elem);
/*  94 */           if (all.put(Integer.valueOf(obj.minNum), obj) != null) {
/*  95 */             throw new RuntimeException("duplicate key : " + obj.minNum);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 108 */     String path = dir + "mzm.gsp.activity.confbean.SWorShipSalaryCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 135 */           SWorShipSalaryCfg _v_ = new SWorShipSalaryCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SWorShipSalaryCfg> all)
/*     */   {
/* 155 */     String path = dir + "mzm.gsp.activity.confbean.SWorShipSalaryCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 182 */           SWorShipSalaryCfg _v_ = new SWorShipSalaryCfg();
...
/*     */ 
/*     */ 
/*     */   public static SWorShipSalaryCfg getOld(int key)
/*     */   {
/* 203 */     return (SWorShipSalaryCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SWorShipSalaryCfg get(int key)
/*     */   {
/* 208 */     return (SWorShipSalaryCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SWorShipSalaryCfg> getOldAll()
/*     */   {
/* 213 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SWorShipSalaryCfg> getAll()
/*     */   {
/* 218 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SWorShipSalaryCfg> newAll)
/*     */   {
/* 223 */     oldAll = all;
/* 224 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\activity\confbean\SWorShipSalaryCfg.class
