...
/*     */ 
/*     */ public class HuSongSpecialNpcCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, HuSongSpecialNpcCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, HuSongSpecialNpcCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public String name;
...
/*  28 */     this.occupation = Integer.valueOf(rootElement.attributeValue("occupation")).intValue();
/*  29 */     this.gender = Integer.valueOf(rootElement.attributeValue("gender")).intValue();
/*  30 */     this.npc_cfgid = Integer.valueOf(rootElement.attributeValue("npc_cfgid")).intValue();
/*     */   }
/*     */   
...
/*  39 */     _os_.marshal(this.npc_cfgid);
/*  40 */     return _os_;
/*     */   }
/*     */   
...
/*  47 */     this.occupation = _os_.unmarshal_int();
/*  48 */     this.gender = _os_.unmarshal_int();
/*  49 */     this.npc_cfgid = _os_.unmarshal_int();
/*  50 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  55 */     String path = dir + "mzm.gsp.activity.confbean.HuSongSpecialNpcCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  68 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity.confbean.HuSongSpecialNpcCfg"))
/*     */         {
/*     */ 
/*  71 */           HuSongSpecialNpcCfg obj = new HuSongSpecialNpcCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, HuSongSpecialNpcCfg> all)
/*     */   {
/*  85 */     String path = dir + "mzm.gsp.activity.confbean.HuSongSpecialNpcCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  97 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity.confbean.HuSongSpecialNpcCfg"))
/*     */         {
/*     */ 
/* 100 */           HuSongSpecialNpcCfg obj = new HuSongSpecialNpcCfg();
...
/*     */     
/* 116 */     String path = dir + "mzm.gsp.activity.confbean.HuSongSpecialNpcCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 143 */           HuSongSpecialNpcCfg _v_ = new HuSongSpecialNpcCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, HuSongSpecialNpcCfg> all)
/*     */   {
/* 163 */     String path = dir + "mzm.gsp.activity.confbean.HuSongSpecialNpcCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 190 */           HuSongSpecialNpcCfg _v_ = new HuSongSpecialNpcCfg();
...
/*     */ 
/*     */ 
/*     */   public static HuSongSpecialNpcCfg getOld(int key)
/*     */   {
/* 211 */     return (HuSongSpecialNpcCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static HuSongSpecialNpcCfg get(int key)
/*     */   {
/* 216 */     return (HuSongSpecialNpcCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, HuSongSpecialNpcCfg> getOldAll()
/*     */   {
/* 221 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, HuSongSpecialNpcCfg> getAll()
/*     */   {
/* 226 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, HuSongSpecialNpcCfg> newAll)
/*     */   {
/* 231 */     oldAll = all;
/* 232 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\activity\confbean\HuSongSpecialNpcCfg.class
