...
/*     */ 
/*     */ public class SHuSongMoneyCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SHuSongMoneyCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SHuSongMoneyCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public int levelMin;
/*     */   public int levelMax;
...
/*  27 */     this.levelMin = Integer.valueOf(rootElement.attributeValue("levelMin")).intValue();
/*  28 */     this.levelMax = Integer.valueOf(rootElement.attributeValue("levelMax")).intValue();
/*  29 */     this.HuSongType = Integer.valueOf(rootElement.attributeValue("HuSongType")).intValue();
...
/*  38 */     _os_.marshal(this.HuSongType);
...
/*  46 */     this.levelMin = _os_.unmarshal_int();
/*  47 */     this.levelMax = _os_.unmarshal_int();
/*  48 */     this.HuSongType = _os_.unmarshal_int();
...
/*     */   {
/*  55 */     String path = dir + "mzm.gsp.activity.confbean.SHuSongMoneyCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  68 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity.confbean.SHuSongMoneyCfg"))
/*     */         {
/*     */ 
/*  71 */           SHuSongMoneyCfg obj = new SHuSongMoneyCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SHuSongMoneyCfg> all)
/*     */   {
/*  85 */     String path = dir + "mzm.gsp.activity.confbean.SHuSongMoneyCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  97 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity.confbean.SHuSongMoneyCfg"))
/*     */         {
/*     */ 
/* 100 */           SHuSongMoneyCfg obj = new SHuSongMoneyCfg();
...
/*     */     
/* 116 */     String path = dir + "mzm.gsp.activity.confbean.SHuSongMoneyCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 143 */           SHuSongMoneyCfg _v_ = new SHuSongMoneyCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SHuSongMoneyCfg> all)
/*     */   {
/* 163 */     String path = dir + "mzm.gsp.activity.confbean.SHuSongMoneyCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 190 */           SHuSongMoneyCfg _v_ = new SHuSongMoneyCfg();
...
/*     */ 
/*     */ 
/*     */   public static SHuSongMoneyCfg getOld(int key)
/*     */   {
/* 211 */     return (SHuSongMoneyCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SHuSongMoneyCfg get(int key)
/*     */   {
/* 216 */     return (SHuSongMoneyCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SHuSongMoneyCfg> getOldAll()
/*     */   {
/* 221 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SHuSongMoneyCfg> getAll()
/*     */   {
/* 226 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SHuSongMoneyCfg> newAll)
/*     */   {
/* 231 */     oldAll = all;
/* 232 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\activity\confbean\SHuSongMoneyCfg.class
