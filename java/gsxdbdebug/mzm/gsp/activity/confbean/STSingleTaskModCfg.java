...
/*     */ 
/*     */ public class STSingleTaskModCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, STSingleTaskModCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, STSingleTaskModCfg> all = null;
/*     */   
/*     */   public int activityId;
/*  19 */   public HashMap<Integer, Integer> ring2modId = new HashMap();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.activityId = Integer.valueOf(rootElement.attributeValue("activityId")).intValue();
/*     */     
/*  25 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "ring2modId");
...
/*     */         }
/*     */         
/*  76 */         this.ring2modId.put(Integer.valueOf(_k_), Integer.valueOf(_v_));
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*  84 */     _os_.compact_uint32(this.ring2modId.size());
/*  85 */     for (java.util.Map.Entry<Integer, Integer> _e_ : this.ring2modId.entrySet())
/*     */     {
...
/* 102 */       this.ring2modId.put(Integer.valueOf(_k_), Integer.valueOf(_v_));
/*     */     }
/* 104 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/* 109 */     String path = dir + "mzm.gsp.activity.confbean.STSingleTaskModCfg.xml";
/*     */     
/*     */     try
/*     */     {
/* 113 */       all = new HashMap();
...
/* 122 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity.confbean.STSingleTaskModCfg"))
/*     */         {
/*     */ 
/* 125 */           STSingleTaskModCfg obj = new STSingleTaskModCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, STSingleTaskModCfg> all)
/*     */   {
/* 139 */     String path = dir + "mzm.gsp.activity.confbean.STSingleTaskModCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 151 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity.confbean.STSingleTaskModCfg"))
/*     */         {
/*     */ 
/* 154 */           STSingleTaskModCfg obj = new STSingleTaskModCfg();
...
/* 168 */     all = new HashMap();
/*     */     
/* 170 */     String path = dir + "mzm.gsp.activity.confbean.STSingleTaskModCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 197 */           STSingleTaskModCfg _v_ = new STSingleTaskModCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, STSingleTaskModCfg> all)
/*     */   {
/* 217 */     String path = dir + "mzm.gsp.activity.confbean.STSingleTaskModCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 244 */           STSingleTaskModCfg _v_ = new STSingleTaskModCfg();
...
/*     */ 
/*     */ 
/*     */   public static STSingleTaskModCfg getOld(int key)
/*     */   {
/* 265 */     return (STSingleTaskModCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static STSingleTaskModCfg get(int key)
/*     */   {
/* 270 */     return (STSingleTaskModCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, STSingleTaskModCfg> getOldAll()
/*     */   {
/* 275 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, STSingleTaskModCfg> getAll()
/*     */   {
/* 280 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, STSingleTaskModCfg> newAll)
/*     */   {
/* 285 */     oldAll = all;
/* 286 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\activity\confbean\STSingleTaskModCfg.class
