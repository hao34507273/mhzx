...
/*     */ 
/*     */ public class SGangTaskModifyCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SGangTaskModifyCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SGangTaskModifyCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public int ringNum;
/*     */   public int modifyId;
...
/*  25 */     this.ringNum = Integer.valueOf(rootElement.attributeValue("ringNum")).intValue();
...
/*  40 */     this.ringNum = _os_.unmarshal_int();
...
/*     */   {
/*  47 */     String path = dir + "mzm.gsp.activity.confbean.SGangTaskModifyCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  60 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity.confbean.SGangTaskModifyCfg"))
/*     */         {
/*     */ 
/*  63 */           SGangTaskModifyCfg obj = new SGangTaskModifyCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SGangTaskModifyCfg> all)
/*     */   {
/*  77 */     String path = dir + "mzm.gsp.activity.confbean.SGangTaskModifyCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  89 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity.confbean.SGangTaskModifyCfg"))
/*     */         {
/*     */ 
/*  92 */           SGangTaskModifyCfg obj = new SGangTaskModifyCfg();
...
/*     */     
/* 108 */     String path = dir + "mzm.gsp.activity.confbean.SGangTaskModifyCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 135 */           SGangTaskModifyCfg _v_ = new SGangTaskModifyCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SGangTaskModifyCfg> all)
/*     */   {
/* 155 */     String path = dir + "mzm.gsp.activity.confbean.SGangTaskModifyCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 182 */           SGangTaskModifyCfg _v_ = new SGangTaskModifyCfg();
...
/*     */ 
/*     */ 
/*     */   public static SGangTaskModifyCfg getOld(int key)
/*     */   {
/* 203 */     return (SGangTaskModifyCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SGangTaskModifyCfg get(int key)
/*     */   {
/* 208 */     return (SGangTaskModifyCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SGangTaskModifyCfg> getOldAll()
/*     */   {
/* 213 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SGangTaskModifyCfg> getAll()
/*     */   {
/* 218 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SGangTaskModifyCfg> newAll)
/*     */   {
/* 223 */     oldAll = all;
/* 224 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\activity\confbean\SGangTaskModifyCfg.class
