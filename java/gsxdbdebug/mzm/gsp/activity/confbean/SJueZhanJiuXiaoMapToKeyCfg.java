...
/*     */ 
/*     */ public class SJueZhanJiuXiaoMapToKeyCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SJueZhanJiuXiaoMapToKeyCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SJueZhanJiuXiaoMapToKeyCfg> all = null;
/*     */   
/*     */   public int activityid;
/*  19 */   public HashMap<Integer, Integer> mapid2key = new HashMap();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.activityid = Integer.valueOf(rootElement.attributeValue("activityid")).intValue();
/*     */     
/*  25 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "mapid2key");
...
/*     */         }
/*     */         
/*  76 */         this.mapid2key.put(Integer.valueOf(_k_), Integer.valueOf(_v_));
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*  84 */     _os_.compact_uint32(this.mapid2key.size());
/*  85 */     for (java.util.Map.Entry<Integer, Integer> _e_ : this.mapid2key.entrySet())
/*     */     {
...
/* 102 */       this.mapid2key.put(Integer.valueOf(_k_), Integer.valueOf(_v_));
/*     */     }
/* 104 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/* 109 */     String path = dir + "mzm.gsp.activity.confbean.SJueZhanJiuXiaoMapToKeyCfg.xml";
/*     */     
/*     */     try
/*     */     {
/* 113 */       all = new HashMap();
...
/* 122 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity.confbean.SJueZhanJiuXiaoMapToKeyCfg"))
/*     */         {
/*     */ 
/* 125 */           SJueZhanJiuXiaoMapToKeyCfg obj = new SJueZhanJiuXiaoMapToKeyCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SJueZhanJiuXiaoMapToKeyCfg> all)
/*     */   {
/* 139 */     String path = dir + "mzm.gsp.activity.confbean.SJueZhanJiuXiaoMapToKeyCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 151 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity.confbean.SJueZhanJiuXiaoMapToKeyCfg"))
/*     */         {
/*     */ 
/* 154 */           SJueZhanJiuXiaoMapToKeyCfg obj = new SJueZhanJiuXiaoMapToKeyCfg();
...
/* 168 */     all = new HashMap();
/*     */     
/* 170 */     String path = dir + "mzm.gsp.activity.confbean.SJueZhanJiuXiaoMapToKeyCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 197 */           SJueZhanJiuXiaoMapToKeyCfg _v_ = new SJueZhanJiuXiaoMapToKeyCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SJueZhanJiuXiaoMapToKeyCfg> all)
/*     */   {
/* 217 */     String path = dir + "mzm.gsp.activity.confbean.SJueZhanJiuXiaoMapToKeyCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 244 */           SJueZhanJiuXiaoMapToKeyCfg _v_ = new SJueZhanJiuXiaoMapToKeyCfg();
...
/*     */ 
/*     */ 
/*     */   public static SJueZhanJiuXiaoMapToKeyCfg getOld(int key)
/*     */   {
/* 265 */     return (SJueZhanJiuXiaoMapToKeyCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SJueZhanJiuXiaoMapToKeyCfg get(int key)
/*     */   {
/* 270 */     return (SJueZhanJiuXiaoMapToKeyCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SJueZhanJiuXiaoMapToKeyCfg> getOldAll()
/*     */   {
/* 275 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SJueZhanJiuXiaoMapToKeyCfg> getAll()
/*     */   {
/* 280 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SJueZhanJiuXiaoMapToKeyCfg> newAll)
/*     */   {
/* 285 */     oldAll = all;
/* 286 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\activity\confbean\SJueZhanJiuXiaoMapToKeyCfg.class
