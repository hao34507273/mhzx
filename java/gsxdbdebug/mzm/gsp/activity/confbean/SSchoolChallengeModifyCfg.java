...
/*     */ 
/*     */ public class SSchoolChallengeModifyCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SSchoolChallengeModifyCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SSchoolChallengeModifyCfg> all = null;
/*     */   
...
/*     */   {
/*  24 */     this.ringCount = Integer.valueOf(rootElement.attributeValue("ringCount")).intValue();
...
/*     */   {
/*  31 */     _os_.marshal(this.ringCount);
...
/*     */   {
/*  39 */     this.ringCount = _os_.unmarshal_int();
...
/*     */   {
/*  47 */     String path = dir + "mzm.gsp.activity.confbean.SSchoolChallengeModifyCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  60 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity.confbean.SSchoolChallengeModifyCfg"))
/*     */         {
/*     */ 
/*  63 */           SSchoolChallengeModifyCfg obj = new SSchoolChallengeModifyCfg();
/*  64 */           obj.loadFromXml(elem);
/*  65 */           if (all.put(Integer.valueOf(obj.ringCount), obj) != null) {
/*  66 */             throw new RuntimeException("duplicate key : " + obj.ringCount);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SSchoolChallengeModifyCfg> all)
/*     */   {
/*  77 */     String path = dir + "mzm.gsp.activity.confbean.SSchoolChallengeModifyCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  89 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity.confbean.SSchoolChallengeModifyCfg"))
/*     */         {
/*     */ 
/*  92 */           SSchoolChallengeModifyCfg obj = new SSchoolChallengeModifyCfg();
/*  93 */           obj.loadFromXml(elem);
/*  94 */           if (all.put(Integer.valueOf(obj.ringCount), obj) != null) {
/*  95 */             throw new RuntimeException("duplicate key : " + obj.ringCount);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 108 */     String path = dir + "mzm.gsp.activity.confbean.SSchoolChallengeModifyCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 135 */           SSchoolChallengeModifyCfg _v_ = new SSchoolChallengeModifyCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SSchoolChallengeModifyCfg> all)
/*     */   {
/* 155 */     String path = dir + "mzm.gsp.activity.confbean.SSchoolChallengeModifyCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 182 */           SSchoolChallengeModifyCfg _v_ = new SSchoolChallengeModifyCfg();
...
/*     */ 
/*     */ 
/*     */   public static SSchoolChallengeModifyCfg getOld(int key)
/*     */   {
/* 203 */     return (SSchoolChallengeModifyCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SSchoolChallengeModifyCfg get(int key)
/*     */   {
/* 208 */     return (SSchoolChallengeModifyCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SSchoolChallengeModifyCfg> getOldAll()
/*     */   {
/* 213 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SSchoolChallengeModifyCfg> getAll()
/*     */   {
/* 218 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SSchoolChallengeModifyCfg> newAll)
/*     */   {
/* 223 */     oldAll = all;
/* 224 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\activity\confbean\SSchoolChallengeModifyCfg.class
