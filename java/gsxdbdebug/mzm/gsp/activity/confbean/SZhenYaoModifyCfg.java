...
/*     */ 
/*     */ public class SZhenYaoModifyCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SZhenYaoModifyCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SZhenYaoModifyCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public int ringCount;
/*     */   public int minLevel;
/*     */   public int maxLevel;
/*     */   public boolean isCutDoublePoint;
/*     */   public int modifyId;
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  27 */     this.id = Integer.valueOf(rootElement.attributeValue("id")).intValue();
/*  28 */     this.ringCount = Integer.valueOf(rootElement.attributeValue("ringCount")).intValue();
...
/*  31 */     this.isCutDoublePoint = Boolean.valueOf(rootElement.attributeValue("isCutDoublePoint")).booleanValue();
/*  32 */     this.modifyId = Integer.valueOf(rootElement.attributeValue("modifyId")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  37 */     _os_.marshal(this.id);
/*  38 */     _os_.marshal(this.ringCount);
/*  39 */     _os_.marshal(this.minLevel);
/*  40 */     _os_.marshal(this.maxLevel);
/*  41 */     _os_.marshal(this.isCutDoublePoint);
/*  42 */     _os_.marshal(this.modifyId);
/*  43 */     return _os_;
/*     */   }
/*     */   
...
/*  49 */     this.ringCount = _os_.unmarshal_int();
/*  50 */     this.minLevel = _os_.unmarshal_int();
/*  51 */     this.maxLevel = _os_.unmarshal_int();
/*  52 */     this.isCutDoublePoint = _os_.unmarshal_boolean();
/*  53 */     this.modifyId = _os_.unmarshal_int();
/*  54 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  59 */     String path = dir + "mzm.gsp.activity.confbean.SZhenYaoModifyCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  72 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity.confbean.SZhenYaoModifyCfg"))
/*     */         {
/*     */ 
/*  75 */           SZhenYaoModifyCfg obj = new SZhenYaoModifyCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SZhenYaoModifyCfg> all)
/*     */   {
/*  89 */     String path = dir + "mzm.gsp.activity.confbean.SZhenYaoModifyCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 101 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity.confbean.SZhenYaoModifyCfg"))
/*     */         {
/*     */ 
/* 104 */           SZhenYaoModifyCfg obj = new SZhenYaoModifyCfg();
...
/*     */     
/* 120 */     String path = dir + "mzm.gsp.activity.confbean.SZhenYaoModifyCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 147 */           SZhenYaoModifyCfg _v_ = new SZhenYaoModifyCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SZhenYaoModifyCfg> all)
/*     */   {
/* 167 */     String path = dir + "mzm.gsp.activity.confbean.SZhenYaoModifyCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 194 */           SZhenYaoModifyCfg _v_ = new SZhenYaoModifyCfg();
...
/*     */ 
/*     */ 
/*     */   public static SZhenYaoModifyCfg getOld(int key)
/*     */   {
/* 215 */     return (SZhenYaoModifyCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SZhenYaoModifyCfg get(int key)
/*     */   {
/* 220 */     return (SZhenYaoModifyCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SZhenYaoModifyCfg> getOldAll()
/*     */   {
/* 225 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SZhenYaoModifyCfg> getAll()
/*     */   {
/* 230 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SZhenYaoModifyCfg> newAll)
/*     */   {
/* 235 */     oldAll = all;
/* 236 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\activity\confbean\SZhenYaoModifyCfg.class
