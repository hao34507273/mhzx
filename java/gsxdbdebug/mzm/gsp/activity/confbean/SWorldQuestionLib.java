...
/*     */ 
/*     */ public class SWorldQuestionLib implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SWorldQuestionLib> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SWorldQuestionLib> all = null;
/*     */   
/*     */   public int id;
...
/*  25 */     this.question = rootElement.attributeValue("question");
...
/*  32 */     _os_.marshal(this.question, "UTF-8");
...
/*  40 */     this.question = _os_.unmarshal_String("UTF-8");
...
/*     */   {
/*  47 */     String path = dir + "mzm.gsp.activity.confbean.SWorldQuestionLib.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  60 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity.confbean.SWorldQuestionLib"))
/*     */         {
/*     */ 
/*  63 */           SWorldQuestionLib obj = new SWorldQuestionLib();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SWorldQuestionLib> all)
/*     */   {
/*  77 */     String path = dir + "mzm.gsp.activity.confbean.SWorldQuestionLib.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  89 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity.confbean.SWorldQuestionLib"))
/*     */         {
/*     */ 
/*  92 */           SWorldQuestionLib obj = new SWorldQuestionLib();
...
/*     */     
/* 108 */     String path = dir + "mzm.gsp.activity.confbean.SWorldQuestionLib.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 135 */           SWorldQuestionLib _v_ = new SWorldQuestionLib();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SWorldQuestionLib> all)
/*     */   {
/* 155 */     String path = dir + "mzm.gsp.activity.confbean.SWorldQuestionLib.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 182 */           SWorldQuestionLib _v_ = new SWorldQuestionLib();
...
/*     */ 
/*     */ 
/*     */   public static SWorldQuestionLib getOld(int key)
/*     */   {
/* 203 */     return (SWorldQuestionLib)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SWorldQuestionLib get(int key)
/*     */   {
/* 208 */     return (SWorldQuestionLib)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SWorldQuestionLib> getOldAll()
/*     */   {
/* 213 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SWorldQuestionLib> getAll()
/*     */   {
/* 218 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SWorldQuestionLib> newAll)
/*     */   {
/* 223 */     oldAll = all;
/* 224 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\activity\confbean\SWorldQuestionLib.class
