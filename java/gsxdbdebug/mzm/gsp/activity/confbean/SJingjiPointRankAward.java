...
/*     */ 
/*     */ public class SJingjiPointRankAward implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SJingjiPointRankAward> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SJingjiPointRankAward> all = null;
/*     */   
/*     */   public int maxrank;
/*     */   public int id;
/*     */   public int rewardid;
...
/*     */   {
/*  24 */     this.maxrank = Integer.valueOf(rootElement.attributeValue("maxrank")).intValue();
/*  25 */     this.id = Integer.valueOf(rootElement.attributeValue("id")).intValue();
/*  26 */     this.rewardid = Integer.valueOf(rootElement.attributeValue("rewardid")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  31 */     _os_.marshal(this.maxrank);
/*  32 */     _os_.marshal(this.id);
/*  33 */     _os_.marshal(this.rewardid);
/*  34 */     return _os_;
/*     */   }
/*     */   
/*     */   public OctetsStream unmarshal(OctetsStream _os_) throws com.goldhuman.Common.Marshal.MarshalException
/*     */   {
/*  39 */     this.maxrank = _os_.unmarshal_int();
/*  40 */     this.id = _os_.unmarshal_int();
/*  41 */     this.rewardid = _os_.unmarshal_int();
/*  42 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  47 */     String path = dir + "mzm.gsp.activity.confbean.SJingjiPointRankAward.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  60 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity.confbean.SJingjiPointRankAward"))
/*     */         {
/*     */ 
/*  63 */           SJingjiPointRankAward obj = new SJingjiPointRankAward();
/*  64 */           obj.loadFromXml(elem);
/*  65 */           if (all.put(Integer.valueOf(obj.maxrank), obj) != null) {
/*  66 */             throw new RuntimeException("duplicate key : " + obj.maxrank);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SJingjiPointRankAward> all)
/*     */   {
/*  77 */     String path = dir + "mzm.gsp.activity.confbean.SJingjiPointRankAward.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  89 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity.confbean.SJingjiPointRankAward"))
/*     */         {
/*     */ 
/*  92 */           SJingjiPointRankAward obj = new SJingjiPointRankAward();
/*  93 */           obj.loadFromXml(elem);
/*  94 */           if (all.put(Integer.valueOf(obj.maxrank), obj) != null) {
/*  95 */             throw new RuntimeException("duplicate key : " + obj.maxrank);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 108 */     String path = dir + "mzm.gsp.activity.confbean.SJingjiPointRankAward.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 135 */           SJingjiPointRankAward _v_ = new SJingjiPointRankAward();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SJingjiPointRankAward> all)
/*     */   {
/* 155 */     String path = dir + "mzm.gsp.activity.confbean.SJingjiPointRankAward.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 182 */           SJingjiPointRankAward _v_ = new SJingjiPointRankAward();
...
/*     */ 
/*     */ 
/*     */   public static SJingjiPointRankAward getOld(int key)
/*     */   {
/* 203 */     return (SJingjiPointRankAward)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SJingjiPointRankAward get(int key)
/*     */   {
/* 208 */     return (SJingjiPointRankAward)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SJingjiPointRankAward> getOldAll()
/*     */   {
/* 213 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SJingjiPointRankAward> getAll()
/*     */   {
/* 218 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SJingjiPointRankAward> newAll)
/*     */   {
/* 223 */     oldAll = all;
/* 224 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\activity\confbean\SJingjiPointRankAward.class
