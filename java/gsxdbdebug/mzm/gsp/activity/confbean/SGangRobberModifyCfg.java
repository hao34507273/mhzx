...
/*     */ 
/*     */ public class SGangRobberModifyCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SGangRobberModifyCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SGangRobberModifyCfg> all = null;
/*     */   
/*     */   public int count;
/*     */   public int modifyid;
/*     */   
...
/*     */   {
/*  23 */     this.count = Integer.valueOf(rootElement.attributeValue("count")).intValue();
/*  24 */     this.modifyid = Integer.valueOf(rootElement.attributeValue("modifyid")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  29 */     _os_.marshal(this.count);
/*  30 */     _os_.marshal(this.modifyid);
/*  31 */     return _os_;
/*     */   }
/*     */   
...
/*  37 */     this.modifyid = _os_.unmarshal_int();
/*  38 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.activity.confbean.SGangRobberModifyCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity.confbean.SGangRobberModifyCfg"))
/*     */         {
/*     */ 
/*  59 */           SGangRobberModifyCfg obj = new SGangRobberModifyCfg();
/*  60 */           obj.loadFromXml(elem);
/*  61 */           if (all.put(Integer.valueOf(obj.count), obj) != null) {
/*  62 */             throw new RuntimeException("duplicate key : " + obj.count);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SGangRobberModifyCfg> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.activity.confbean.SGangRobberModifyCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity.confbean.SGangRobberModifyCfg"))
/*     */         {
/*     */ 
/*  88 */           SGangRobberModifyCfg obj = new SGangRobberModifyCfg();
/*  89 */           obj.loadFromXml(elem);
/*  90 */           if (all.put(Integer.valueOf(obj.count), obj) != null) {
/*  91 */             throw new RuntimeException("duplicate key : " + obj.count);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.activity.confbean.SGangRobberModifyCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           SGangRobberModifyCfg _v_ = new SGangRobberModifyCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SGangRobberModifyCfg> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.activity.confbean.SGangRobberModifyCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           SGangRobberModifyCfg _v_ = new SGangRobberModifyCfg();
...
/*     */ 
/*     */ 
/*     */   public static SGangRobberModifyCfg getOld(int key)
/*     */   {
/* 199 */     return (SGangRobberModifyCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SGangRobberModifyCfg get(int key)
/*     */   {
/* 204 */     return (SGangRobberModifyCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SGangRobberModifyCfg> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SGangRobberModifyCfg> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SGangRobberModifyCfg> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\activity\confbean\SGangRobberModifyCfg.class
