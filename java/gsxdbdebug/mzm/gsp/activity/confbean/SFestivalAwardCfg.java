...
/*     */ 
/*     */ public class SFestivalAwardCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SFestivalAwardCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SFestivalAwardCfg> all = null;
/*     */   
/*     */   public int id;
...
/*  28 */     this.festivalName = rootElement.attributeValue("festivalName");
/*  29 */     this.limitTime = Integer.valueOf(rootElement.attributeValue("limitTime")).intValue();
/*  30 */     this.giftid = Integer.valueOf(rootElement.attributeValue("giftid")).intValue();
/*  31 */     this.notifyMailid = Integer.valueOf(rootElement.attributeValue("notifyMailid")).intValue();
/*  32 */     this.minLevel = Integer.valueOf(rootElement.attributeValue("minLevel")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  37 */     _os_.marshal(this.id);
/*  38 */     _os_.marshal(this.festivalName, "UTF-8");
/*  39 */     _os_.marshal(this.limitTime);
/*  40 */     _os_.marshal(this.giftid);
/*  41 */     _os_.marshal(this.notifyMailid);
/*  42 */     _os_.marshal(this.minLevel);
/*  43 */     return _os_;
/*     */   }
/*     */   
...
/*  49 */     this.festivalName = _os_.unmarshal_String("UTF-8");
/*  50 */     this.limitTime = _os_.unmarshal_int();
/*  51 */     this.giftid = _os_.unmarshal_int();
/*  52 */     this.notifyMailid = _os_.unmarshal_int();
/*  53 */     this.minLevel = _os_.unmarshal_int();
/*  54 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  59 */     String path = dir + "mzm.gsp.activity.confbean.SFestivalAwardCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  72 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity.confbean.SFestivalAwardCfg"))
/*     */         {
/*     */ 
/*  75 */           SFestivalAwardCfg obj = new SFestivalAwardCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SFestivalAwardCfg> all)
/*     */   {
/*  89 */     String path = dir + "mzm.gsp.activity.confbean.SFestivalAwardCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 101 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity.confbean.SFestivalAwardCfg"))
/*     */         {
/*     */ 
/* 104 */           SFestivalAwardCfg obj = new SFestivalAwardCfg();
...
/*     */     
/* 120 */     String path = dir + "mzm.gsp.activity.confbean.SFestivalAwardCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 147 */           SFestivalAwardCfg _v_ = new SFestivalAwardCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SFestivalAwardCfg> all)
/*     */   {
/* 167 */     String path = dir + "mzm.gsp.activity.confbean.SFestivalAwardCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 194 */           SFestivalAwardCfg _v_ = new SFestivalAwardCfg();
...
/*     */ 
/*     */ 
/*     */   public static SFestivalAwardCfg getOld(int key)
/*     */   {
/* 215 */     return (SFestivalAwardCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SFestivalAwardCfg get(int key)
/*     */   {
/* 220 */     return (SFestivalAwardCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SFestivalAwardCfg> getOldAll()
/*     */   {
/* 225 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SFestivalAwardCfg> getAll()
/*     */   {
/* 230 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SFestivalAwardCfg> newAll)
/*     */   {
/* 235 */     oldAll = all;
/* 236 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\activity\confbean\SFestivalAwardCfg.class
