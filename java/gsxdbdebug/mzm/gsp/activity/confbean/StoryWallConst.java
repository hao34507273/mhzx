...
/*     */ 
/*     */ public class StoryWallConst
/*     */ {
/*  13 */   private static volatile StoryWallConst oldInstance = null;
/*     */   
/*  15 */   private static StoryWallConst instance = new StoryWallConst();
/*     */   public int activityid;
/*     */   public int npcid;
/*     */   public int serviceid;
/*     */   public int storycount;
/*     */   
/*     */   public static StoryWallConst getOldInstance()
/*     */   {
/*  23 */     return oldInstance;
/*     */   }
/*     */   
/*     */   public static StoryWallConst getInstance()
/*     */   {
/*  28 */     return instance;
/*     */   }
/*     */   
...
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.activity.confbean.StoryWallConst.xml";
/*     */     try
/*     */     {
...
/*  64 */       this.npcid = Integer.valueOf(((Element)data.get("npcid")).attributeValue("value")).intValue();
/*  65 */       this.serviceid = Integer.valueOf(((Element)data.get("serviceid")).attributeValue("value")).intValue();
/*  66 */       this.storycount = Integer.valueOf(((Element)data.get("storycount")).attributeValue("value")).intValue();
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*  75 */     String path = dir + "mzm.gsp.activity.confbean.StoryWallConst.xml";
/*     */     try
/*     */     {
...
/*  96 */       this.npcid = Integer.valueOf(((Element)data.get("npcid")).attributeValue("value")).intValue();
/*  97 */       this.serviceid = Integer.valueOf(((Element)data.get("serviceid")).attributeValue("value")).intValue();
/*  98 */       this.storycount = Integer.valueOf(((Element)data.get("storycount")).attributeValue("value")).intValue();
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/* 109 */     String path = dir + "mzm.gsp.activity.confbean.StoryWallConst.bny";
/*     */     try
/*     */     {
...
/* 125 */         this.npcid = _os_.unmarshal_int();
/* 126 */         this.serviceid = _os_.unmarshal_int();
/* 127 */         this.storycount = _os_.unmarshal_int();
/*     */       }
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*     */   {
/* 138 */     String path = dir + "mzm.gsp.activity.confbean.StoryWallConst.bny";
/*     */     try
/*     */     {
...
/* 154 */         this.npcid = _os_.unmarshal_int();
/* 155 */         this.serviceid = _os_.unmarshal_int();
/* 156 */         this.storycount = _os_.unmarshal_int();
/*     */       }
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*     */   }
/*     */   
/*     */   public static void setInstance(StoryWallConst newInstance)
/*     */   {
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\activity\confbean\StoryWallConst.class
