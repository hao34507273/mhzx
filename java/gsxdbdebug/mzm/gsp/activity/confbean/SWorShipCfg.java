...
/*     */ 
/*     */ public class SWorShipCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SWorShipCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SWorShipCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public String actionName;
/*     */   public int index;
/*  21 */   public java.util.ArrayList<String> contentList = new java.util.ArrayList();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  25 */     this.id = Integer.valueOf(rootElement.attributeValue("id")).intValue();
/*  26 */     this.actionName = rootElement.attributeValue("actionName");
/*  27 */     this.index = Integer.valueOf(rootElement.attributeValue("index")).intValue();
/*     */     
/*  29 */     Element collectionElement = util.XmlHelper.getVariableElement(rootElement, "contentList");
...
/*  62 */     _os_.marshal(this.actionName, "UTF-8");
/*  63 */     _os_.marshal(this.index);
/*  64 */     _os_.compact_uint32(this.contentList.size());
/*  65 */     for (String _v_ : this.contentList)
/*     */     {
...
/*  75 */     this.actionName = _os_.unmarshal_String("UTF-8");
/*  76 */     this.index = _os_.unmarshal_int();
/*  77 */     for (int _size_ = _os_.uncompact_uint32(); _size_ > 0; _size_--)
/*     */     {
/*     */ 
/*  80 */       String _v_ = _os_.unmarshal_String("UTF-8");
/*  81 */       this.contentList.add(_v_);
/*     */     }
/*  83 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/*  88 */     String path = dir + "mzm.gsp.activity.confbean.SWorShipCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 101 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity.confbean.SWorShipCfg"))
/*     */         {
/*     */ 
/* 104 */           SWorShipCfg obj = new SWorShipCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SWorShipCfg> all)
/*     */   {
/* 118 */     String path = dir + "mzm.gsp.activity.confbean.SWorShipCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 130 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity.confbean.SWorShipCfg"))
/*     */         {
/*     */ 
/* 133 */           SWorShipCfg obj = new SWorShipCfg();
...
/*     */     
/* 149 */     String path = dir + "mzm.gsp.activity.confbean.SWorShipCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 176 */           SWorShipCfg _v_ = new SWorShipCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SWorShipCfg> all)
/*     */   {
/* 196 */     String path = dir + "mzm.gsp.activity.confbean.SWorShipCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 223 */           SWorShipCfg _v_ = new SWorShipCfg();
...
/*     */ 
/*     */ 
/*     */   public static SWorShipCfg getOld(int key)
/*     */   {
/* 244 */     return (SWorShipCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SWorShipCfg get(int key)
/*     */   {
/* 249 */     return (SWorShipCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SWorShipCfg> getOldAll()
/*     */   {
/* 254 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SWorShipCfg> getAll()
/*     */   {
/* 259 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SWorShipCfg> newAll)
/*     */   {
/* 264 */     oldAll = all;
/* 265 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\activity\confbean\SWorShipCfg.class
