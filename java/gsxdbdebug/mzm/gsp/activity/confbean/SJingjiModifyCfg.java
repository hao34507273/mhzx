...
/*     */ 
/*     */ public class SJingjiModifyCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SJingjiModifyCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SJingjiModifyCfg> all = null;
/*     */   
/*     */   public int count;
/*     */   public int id;
/*     */   public int modifyId;
...
/*     */   {
/*  47 */     String path = dir + "mzm.gsp.activity.confbean.SJingjiModifyCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  60 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity.confbean.SJingjiModifyCfg"))
/*     */         {
/*     */ 
/*  63 */           SJingjiModifyCfg obj = new SJingjiModifyCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SJingjiModifyCfg> all)
/*     */   {
/*  77 */     String path = dir + "mzm.gsp.activity.confbean.SJingjiModifyCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  89 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity.confbean.SJingjiModifyCfg"))
/*     */         {
/*     */ 
/*  92 */           SJingjiModifyCfg obj = new SJingjiModifyCfg();
...
/*     */     
/* 108 */     String path = dir + "mzm.gsp.activity.confbean.SJingjiModifyCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 135 */           SJingjiModifyCfg _v_ = new SJingjiModifyCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SJingjiModifyCfg> all)
/*     */   {
/* 155 */     String path = dir + "mzm.gsp.activity.confbean.SJingjiModifyCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 182 */           SJingjiModifyCfg _v_ = new SJingjiModifyCfg();
...
/*     */ 
/*     */ 
/*     */   public static SJingjiModifyCfg getOld(int key)
/*     */   {
/* 203 */     return (SJingjiModifyCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SJingjiModifyCfg get(int key)
/*     */   {
/* 208 */     return (SJingjiModifyCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SJingjiModifyCfg> getOldAll()
/*     */   {
/* 213 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SJingjiModifyCfg> getAll()
/*     */   {
/* 218 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SJingjiModifyCfg> newAll)
/*     */   {
/* 223 */     oldAll = all;
/* 224 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\activity\confbean\SJingjiModifyCfg.class
