...
/*     */ 
/*     */ public class STOpenId2ActivityId implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, STOpenId2ActivityId> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, STOpenId2ActivityId> all = null;
/*     */   
/*     */   public int openId;
...
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.activity.confbean.STOpenId2ActivityId.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity.confbean.STOpenId2ActivityId"))
/*     */         {
/*     */ 
/*  59 */           STOpenId2ActivityId obj = new STOpenId2ActivityId();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, STOpenId2ActivityId> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.activity.confbean.STOpenId2ActivityId.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity.confbean.STOpenId2ActivityId"))
/*     */         {
/*     */ 
/*  88 */           STOpenId2ActivityId obj = new STOpenId2ActivityId();
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.activity.confbean.STOpenId2ActivityId.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           STOpenId2ActivityId _v_ = new STOpenId2ActivityId();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, STOpenId2ActivityId> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.activity.confbean.STOpenId2ActivityId.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           STOpenId2ActivityId _v_ = new STOpenId2ActivityId();
...
/*     */ 
/*     */ 
/*     */   public static STOpenId2ActivityId getOld(int key)
/*     */   {
/* 199 */     return (STOpenId2ActivityId)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static STOpenId2ActivityId get(int key)
/*     */   {
/* 204 */     return (STOpenId2ActivityId)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, STOpenId2ActivityId> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, STOpenId2ActivityId> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, STOpenId2ActivityId> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\activity\confbean\STOpenId2ActivityId.class
