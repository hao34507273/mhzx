...
/*     */ 
/*     */ public class STGraph2ActivityId implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, STGraph2ActivityId> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, STGraph2ActivityId> all = null;
/*     */   
/*     */   public int graphId;
...
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.activity.confbean.STGraph2ActivityId.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity.confbean.STGraph2ActivityId"))
/*     */         {
/*     */ 
/*  59 */           STGraph2ActivityId obj = new STGraph2ActivityId();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, STGraph2ActivityId> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.activity.confbean.STGraph2ActivityId.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity.confbean.STGraph2ActivityId"))
/*     */         {
/*     */ 
/*  88 */           STGraph2ActivityId obj = new STGraph2ActivityId();
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.activity.confbean.STGraph2ActivityId.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           STGraph2ActivityId _v_ = new STGraph2ActivityId();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, STGraph2ActivityId> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.activity.confbean.STGraph2ActivityId.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           STGraph2ActivityId _v_ = new STGraph2ActivityId();
...
/*     */ 
/*     */ 
/*     */   public static STGraph2ActivityId getOld(int key)
/*     */   {
/* 199 */     return (STGraph2ActivityId)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static STGraph2ActivityId get(int key)
/*     */   {
/* 204 */     return (STGraph2ActivityId)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, STGraph2ActivityId> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, STGraph2ActivityId> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, STGraph2ActivityId> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\activity\confbean\STGraph2ActivityId.class
