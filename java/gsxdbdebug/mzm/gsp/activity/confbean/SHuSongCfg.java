...
/*     */ 
/*     */ public class SHuSongCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SHuSongCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SHuSongCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public int huSongMonsterid;
/*     */   public int handupNPCid;
/*     */   public int HuSongType;
/*  22 */   public java.util.ArrayList<Integer> fighterids = new java.util.ArrayList();
/*     */   public int awardid;
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  27 */     this.id = Integer.valueOf(rootElement.attributeValue("id")).intValue();
/*  28 */     this.huSongMonsterid = Integer.valueOf(rootElement.attributeValue("huSongMonsterid")).intValue();
/*  29 */     this.handupNPCid = Integer.valueOf(rootElement.attributeValue("handupNPCid")).intValue();
/*  30 */     this.HuSongType = Integer.valueOf(rootElement.attributeValue("HuSongType")).intValue();
/*     */     
/*  32 */     Element collectionElement = util.XmlHelper.getVariableElement(rootElement, "fighterids");
...
/*     */         }
/*     */         
/*  57 */         this.fighterids.add(Integer.valueOf(_v_));
/*     */       }
/*     */     }
/*  60 */     this.awardid = Integer.valueOf(rootElement.attributeValue("awardid")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  65 */     _os_.marshal(this.id);
/*  66 */     _os_.marshal(this.huSongMonsterid);
/*  67 */     _os_.marshal(this.handupNPCid);
/*  68 */     _os_.marshal(this.HuSongType);
/*  69 */     _os_.compact_uint32(this.fighterids.size());
/*  70 */     for (Integer _v_ : this.fighterids)
/*     */     {
/*  72 */       _os_.marshal(_v_.intValue());
/*     */     }
/*  74 */     _os_.marshal(this.awardid);
/*  75 */     return _os_;
/*     */   }
/*     */   
...
/*  81 */     this.huSongMonsterid = _os_.unmarshal_int();
/*  82 */     this.handupNPCid = _os_.unmarshal_int();
/*  83 */     this.HuSongType = _os_.unmarshal_int();
/*  84 */     for (int _size_ = _os_.uncompact_uint32(); _size_ > 0; _size_--)
/*     */     {
/*     */ 
/*  87 */       int _v_ = _os_.unmarshal_int();
/*  88 */       this.fighterids.add(Integer.valueOf(_v_));
/*     */     }
/*  90 */     this.awardid = _os_.unmarshal_int();
/*  91 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  96 */     String path = dir + "mzm.gsp.activity.confbean.SHuSongCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 109 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity.confbean.SHuSongCfg"))
/*     */         {
/*     */ 
/* 112 */           SHuSongCfg obj = new SHuSongCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SHuSongCfg> all)
/*     */   {
/* 126 */     String path = dir + "mzm.gsp.activity.confbean.SHuSongCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 138 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity.confbean.SHuSongCfg"))
/*     */         {
/*     */ 
/* 141 */           SHuSongCfg obj = new SHuSongCfg();
...
/*     */     
/* 157 */     String path = dir + "mzm.gsp.activity.confbean.SHuSongCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 184 */           SHuSongCfg _v_ = new SHuSongCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SHuSongCfg> all)
/*     */   {
/* 204 */     String path = dir + "mzm.gsp.activity.confbean.SHuSongCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 231 */           SHuSongCfg _v_ = new SHuSongCfg();
...
/*     */ 
/*     */ 
/*     */   public static SHuSongCfg getOld(int key)
/*     */   {
/* 252 */     return (SHuSongCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SHuSongCfg get(int key)
/*     */   {
/* 257 */     return (SHuSongCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SHuSongCfg> getOldAll()
/*     */   {
/* 262 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SHuSongCfg> getAll()
/*     */   {
/* 267 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SHuSongCfg> newAll)
/*     */   {
/* 272 */     oldAll = all;
/* 273 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\activity\confbean\SHuSongCfg.class
