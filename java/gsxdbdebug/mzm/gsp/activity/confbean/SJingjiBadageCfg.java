...
/*     */ 
/*     */ public class SJingjiBadageCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SJingjiBadageCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SJingjiBadageCfg> all = null;
/*     */   
/*     */   public int maxrank;
/*     */   public int id;
/*     */   public int badage;
...
/*  26 */     this.badage = Integer.valueOf(rootElement.attributeValue("badage")).intValue();
/*     */   }
/*     */   
...
/*  41 */     this.badage = _os_.unmarshal_int();
/*  42 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  47 */     String path = dir + "mzm.gsp.activity.confbean.SJingjiBadageCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  60 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity.confbean.SJingjiBadageCfg"))
/*     */         {
/*     */ 
/*  63 */           SJingjiBadageCfg obj = new SJingjiBadageCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SJingjiBadageCfg> all)
/*     */   {
/*  77 */     String path = dir + "mzm.gsp.activity.confbean.SJingjiBadageCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  89 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity.confbean.SJingjiBadageCfg"))
/*     */         {
/*     */ 
/*  92 */           SJingjiBadageCfg obj = new SJingjiBadageCfg();
...
/*     */     
/* 108 */     String path = dir + "mzm.gsp.activity.confbean.SJingjiBadageCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 135 */           SJingjiBadageCfg _v_ = new SJingjiBadageCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SJingjiBadageCfg> all)
/*     */   {
/* 155 */     String path = dir + "mzm.gsp.activity.confbean.SJingjiBadageCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 182 */           SJingjiBadageCfg _v_ = new SJingjiBadageCfg();
...
/*     */ 
/*     */ 
/*     */   public static SJingjiBadageCfg getOld(int key)
/*     */   {
/* 203 */     return (SJingjiBadageCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SJingjiBadageCfg get(int key)
/*     */   {
/* 208 */     return (SJingjiBadageCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SJingjiBadageCfg> getOldAll()
/*     */   {
/* 213 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SJingjiBadageCfg> getAll()
/*     */   {
/* 218 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SJingjiBadageCfg> newAll)
/*     */   {
/* 223 */     oldAll = all;
/* 224 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\activity\confbean\SJingjiBadageCfg.class
