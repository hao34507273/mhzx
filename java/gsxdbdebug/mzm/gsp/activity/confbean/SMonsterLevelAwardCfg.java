...
/*     */ 
/*     */ public class SMonsterLevelAwardCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SMonsterLevelAwardCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SMonsterLevelAwardCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public int activityId;
/*     */   public int levelLimit;
/*     */   public int awardTypeId1;
/*     */   public int awardTypeId2;
/*     */   
...
/*  28 */     this.levelLimit = Integer.valueOf(rootElement.attributeValue("levelLimit")).intValue();
/*  29 */     this.awardTypeId1 = Integer.valueOf(rootElement.attributeValue("awardTypeId1")).intValue();
/*  30 */     this.awardTypeId2 = Integer.valueOf(rootElement.attributeValue("awardTypeId2")).intValue();
/*     */   }
/*     */   
...
/*  37 */     _os_.marshal(this.levelLimit);
/*  38 */     _os_.marshal(this.awardTypeId1);
/*  39 */     _os_.marshal(this.awardTypeId2);
/*  40 */     return _os_;
/*     */   }
/*     */   
...
/*  47 */     this.levelLimit = _os_.unmarshal_int();
/*  48 */     this.awardTypeId1 = _os_.unmarshal_int();
/*  49 */     this.awardTypeId2 = _os_.unmarshal_int();
/*  50 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  55 */     String path = dir + "mzm.gsp.activity.confbean.SMonsterLevelAwardCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  68 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity.confbean.SMonsterLevelAwardCfg"))
/*     */         {
/*     */ 
/*  71 */           SMonsterLevelAwardCfg obj = new SMonsterLevelAwardCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SMonsterLevelAwardCfg> all)
/*     */   {
/*  85 */     String path = dir + "mzm.gsp.activity.confbean.SMonsterLevelAwardCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  97 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity.confbean.SMonsterLevelAwardCfg"))
/*     */         {
/*     */ 
/* 100 */           SMonsterLevelAwardCfg obj = new SMonsterLevelAwardCfg();
...
/*     */     
/* 116 */     String path = dir + "mzm.gsp.activity.confbean.SMonsterLevelAwardCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 143 */           SMonsterLevelAwardCfg _v_ = new SMonsterLevelAwardCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SMonsterLevelAwardCfg> all)
/*     */   {
/* 163 */     String path = dir + "mzm.gsp.activity.confbean.SMonsterLevelAwardCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 190 */           SMonsterLevelAwardCfg _v_ = new SMonsterLevelAwardCfg();
...
/*     */ 
/*     */ 
/*     */   public static SMonsterLevelAwardCfg getOld(int key)
/*     */   {
/* 211 */     return (SMonsterLevelAwardCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SMonsterLevelAwardCfg get(int key)
/*     */   {
/* 216 */     return (SMonsterLevelAwardCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMonsterLevelAwardCfg> getOldAll()
/*     */   {
/* 221 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMonsterLevelAwardCfg> getAll()
/*     */   {
/* 226 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SMonsterLevelAwardCfg> newAll)
/*     */   {
/* 231 */     oldAll = all;
/* 232 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\activity\confbean\SMonsterLevelAwardCfg.class
