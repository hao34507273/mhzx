...
/*     */ 
/*     */ public class SActiviteAwardCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SActiviteAwardCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SActiviteAwardCfg> all = null;
/*     */   
/*     */   public int role_level;
/*  19 */   public TreeMap<Integer, SActiveAwardBean> active_award_map = new TreeMap();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.role_level = Integer.valueOf(rootElement.attributeValue("role_level")).intValue();
/*     */     
/*  25 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "active_award_map");
...
/*  51 */             keyElem = elem;
/*     */           }
/*  53 */           else if ((valueElem == null) && (elem.getName().equalsIgnoreCase("mzm.gsp.activity.confbean.SActiveAwardBean")))
/*     */           {
/*  55 */             valueElem = elem;
/*     */           }
/*     */         }
...
/*     */         
/*     */         int _k_;
/*     */         SActiveAwardBean _v_;
/*     */         try
/*     */         {
/*  68 */           _k_ = Integer.valueOf(keyElem.getText()).intValue();
/*  69 */           _v_ = new SActiveAwardBean();
...
/*     */         }
/*     */         
/*  77 */         this.active_award_map.put(Integer.valueOf(_k_), _v_);
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*     */   {
/*  84 */     _os_.marshal(this.role_level);
/*  85 */     _os_.compact_uint32(this.active_award_map.size());
/*  86 */     for (java.util.Map.Entry<Integer, SActiveAwardBean> _e_ : this.active_award_map.entrySet())
/*     */     {
...
/*     */   {
/*  96 */     this.role_level = _os_.unmarshal_int();
/*  97 */     for (int _size_ = _os_.uncompact_uint32(); _size_ > 0; _size_--)
/*     */     {
/*     */ 
/* 100 */       int _k_ = _os_.unmarshal_int();
/*     */       
/* 102 */       SActiveAwardBean _v_ = new SActiveAwardBean();
/* 103 */       _v_.unmarshal(_os_);
/* 104 */       this.active_award_map.put(Integer.valueOf(_k_), _v_);
/*     */     }
/* 106 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/* 111 */     String path = dir + "mzm.gsp.activity.confbean.SActiviteAwardCfg.xml";
/*     */     
/*     */     try
/*     */     {
/* 115 */       all = new TreeMap();
...
/* 124 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity.confbean.SActiviteAwardCfg"))
/*     */         {
/*     */ 
/* 127 */           SActiviteAwardCfg obj = new SActiviteAwardCfg();
/* 128 */           obj.loadFromXml(elem);
/* 129 */           if (all.put(Integer.valueOf(obj.role_level), obj) != null) {
/* 130 */             throw new RuntimeException("duplicate key : " + obj.role_level);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SActiviteAwardCfg> all)
/*     */   {
/* 141 */     String path = dir + "mzm.gsp.activity.confbean.SActiviteAwardCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 153 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity.confbean.SActiviteAwardCfg"))
/*     */         {
/*     */ 
/* 156 */           SActiviteAwardCfg obj = new SActiviteAwardCfg();
/* 157 */           obj.loadFromXml(elem);
/* 158 */           if (all.put(Integer.valueOf(obj.role_level), obj) != null) {
/* 159 */             throw new RuntimeException("duplicate key : " + obj.role_level);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/* 170 */     all = new TreeMap();
/*     */     
/* 172 */     String path = dir + "mzm.gsp.activity.confbean.SActiviteAwardCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 199 */           SActiviteAwardCfg _v_ = new SActiviteAwardCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SActiviteAwardCfg> all)
/*     */   {
/* 219 */     String path = dir + "mzm.gsp.activity.confbean.SActiviteAwardCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 246 */           SActiviteAwardCfg _v_ = new SActiviteAwardCfg();
...
/*     */ 
/*     */ 
/*     */   public static SActiviteAwardCfg getOld(int key)
/*     */   {
/* 267 */     return (SActiviteAwardCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SActiviteAwardCfg get(int key)
/*     */   {
/* 272 */     return (SActiviteAwardCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SActiviteAwardCfg> getOldAll()
/*     */   {
/* 277 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SActiviteAwardCfg> getAll()
/*     */   {
/* 282 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SActiviteAwardCfg> newAll)
/*     */   {
/* 287 */     oldAll = all;
/* 288 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\activity\confbean\SActiviteAwardCfg.class
