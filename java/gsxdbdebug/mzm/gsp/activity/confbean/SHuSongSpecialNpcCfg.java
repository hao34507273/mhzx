...
/*     */ 
/*     */ public class SHuSongSpecialNpcCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SHuSongSpecialNpcCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SHuSongSpecialNpcCfg> all = null;
/*     */   
/*     */   public int id;
/*  19 */   public java.util.ArrayList<Integer> npc_cfgids = new java.util.ArrayList();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.id = Integer.valueOf(rootElement.attributeValue("id")).intValue();
/*     */     
/*  25 */     Element collectionElement = util.XmlHelper.getVariableElement(rootElement, "npc_cfgids");
...
/*     */         }
/*     */         
/*  50 */         this.npc_cfgids.add(Integer.valueOf(_v_));
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*  58 */     _os_.compact_uint32(this.npc_cfgids.size());
/*  59 */     for (Integer _v_ : this.npc_cfgids)
/*     */     {
...
/*  73 */       this.npc_cfgids.add(Integer.valueOf(_v_));
/*     */     }
/*  75 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/*  80 */     String path = dir + "mzm.gsp.activity.confbean.SHuSongSpecialNpcCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity.confbean.SHuSongSpecialNpcCfg"))
/*     */         {
/*     */ 
/*  96 */           SHuSongSpecialNpcCfg obj = new SHuSongSpecialNpcCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SHuSongSpecialNpcCfg> all)
/*     */   {
/* 110 */     String path = dir + "mzm.gsp.activity.confbean.SHuSongSpecialNpcCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 122 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity.confbean.SHuSongSpecialNpcCfg"))
/*     */         {
/*     */ 
/* 125 */           SHuSongSpecialNpcCfg obj = new SHuSongSpecialNpcCfg();
...
/*     */     
/* 141 */     String path = dir + "mzm.gsp.activity.confbean.SHuSongSpecialNpcCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 168 */           SHuSongSpecialNpcCfg _v_ = new SHuSongSpecialNpcCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SHuSongSpecialNpcCfg> all)
/*     */   {
/* 188 */     String path = dir + "mzm.gsp.activity.confbean.SHuSongSpecialNpcCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 215 */           SHuSongSpecialNpcCfg _v_ = new SHuSongSpecialNpcCfg();
...
/*     */ 
/*     */ 
/*     */   public static SHuSongSpecialNpcCfg getOld(int key)
/*     */   {
/* 236 */     return (SHuSongSpecialNpcCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SHuSongSpecialNpcCfg get(int key)
/*     */   {
/* 241 */     return (SHuSongSpecialNpcCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SHuSongSpecialNpcCfg> getOldAll()
/*     */   {
/* 246 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SHuSongSpecialNpcCfg> getAll()
/*     */   {
/* 251 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SHuSongSpecialNpcCfg> newAll)
/*     */   {
/* 256 */     oldAll = all;
/* 257 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\activity\confbean\SHuSongSpecialNpcCfg.class
