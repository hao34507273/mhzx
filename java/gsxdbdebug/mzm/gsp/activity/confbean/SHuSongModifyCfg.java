...
/*     */ 
/*     */ public class SHuSongModifyCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SHuSongModifyCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SHuSongModifyCfg> all = null;
/*     */   
...
/*     */   {
/*  23 */     this.loseTimes = Integer.valueOf(rootElement.attributeValue("loseTimes")).intValue();
/*  24 */     this.modifyid = Integer.valueOf(rootElement.attributeValue("modifyid")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  29 */     _os_.marshal(this.loseTimes);
...
/*     */   {
/*  36 */     this.loseTimes = _os_.unmarshal_int();
...
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.activity.confbean.SHuSongModifyCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity.confbean.SHuSongModifyCfg"))
/*     */         {
/*     */ 
/*  59 */           SHuSongModifyCfg obj = new SHuSongModifyCfg();
/*  60 */           obj.loadFromXml(elem);
/*  61 */           if (all.put(Integer.valueOf(obj.loseTimes), obj) != null) {
/*  62 */             throw new RuntimeException("duplicate key : " + obj.loseTimes);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SHuSongModifyCfg> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.activity.confbean.SHuSongModifyCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity.confbean.SHuSongModifyCfg"))
/*     */         {
/*     */ 
/*  88 */           SHuSongModifyCfg obj = new SHuSongModifyCfg();
/*  89 */           obj.loadFromXml(elem);
/*  90 */           if (all.put(Integer.valueOf(obj.loseTimes), obj) != null) {
/*  91 */             throw new RuntimeException("duplicate key : " + obj.loseTimes);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.activity.confbean.SHuSongModifyCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           SHuSongModifyCfg _v_ = new SHuSongModifyCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SHuSongModifyCfg> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.activity.confbean.SHuSongModifyCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           SHuSongModifyCfg _v_ = new SHuSongModifyCfg();
...
/*     */ 
/*     */ 
/*     */   public static SHuSongModifyCfg getOld(int key)
/*     */   {
/* 199 */     return (SHuSongModifyCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SHuSongModifyCfg get(int key)
/*     */   {
/* 204 */     return (SHuSongModifyCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SHuSongModifyCfg> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SHuSongModifyCfg> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SHuSongModifyCfg> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\activity\confbean\SHuSongModifyCfg.class
