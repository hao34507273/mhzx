...
/*     */ 
/*     */ public class SGangRaceActionCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SGangRaceActionCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SGangRaceActionCfg> all = null;
/*     */   
/*     */   public int id;
...
/*  30 */     this.ActCode = Integer.valueOf(rootElement.attributeValue("ActCode")).intValue();
/*  31 */     this.MoveStep = Integer.valueOf(rootElement.attributeValue("MoveStep")).intValue();
/*  32 */     this.MinRound = Integer.valueOf(rootElement.attributeValue("MinRound")).intValue();
/*  33 */     this.MaxRound = Integer.valueOf(rootElement.attributeValue("MaxRound")).intValue();
/*  34 */     this.RandValue = Integer.valueOf(rootElement.attributeValue("RandValue")).intValue();
/*     */   }
/*     */   
...
/*  41 */     _os_.marshal(this.ActCode);
/*  42 */     _os_.marshal(this.MoveStep);
/*  43 */     _os_.marshal(this.MinRound);
/*  44 */     _os_.marshal(this.MaxRound);
/*  45 */     _os_.marshal(this.RandValue);
/*  46 */     return _os_;
/*     */   }
/*     */   
...
/*  53 */     this.ActCode = _os_.unmarshal_int();
/*  54 */     this.MoveStep = _os_.unmarshal_int();
/*  55 */     this.MinRound = _os_.unmarshal_int();
/*  56 */     this.MaxRound = _os_.unmarshal_int();
/*  57 */     this.RandValue = _os_.unmarshal_int();
/*  58 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  63 */     String path = dir + "mzm.gsp.activity.confbean.SGangRaceActionCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  76 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity.confbean.SGangRaceActionCfg"))
/*     */         {
/*     */ 
/*  79 */           SGangRaceActionCfg obj = new SGangRaceActionCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SGangRaceActionCfg> all)
/*     */   {
/*  93 */     String path = dir + "mzm.gsp.activity.confbean.SGangRaceActionCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 105 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity.confbean.SGangRaceActionCfg"))
/*     */         {
/*     */ 
/* 108 */           SGangRaceActionCfg obj = new SGangRaceActionCfg();
...
/*     */     
/* 124 */     String path = dir + "mzm.gsp.activity.confbean.SGangRaceActionCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 151 */           SGangRaceActionCfg _v_ = new SGangRaceActionCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SGangRaceActionCfg> all)
/*     */   {
/* 171 */     String path = dir + "mzm.gsp.activity.confbean.SGangRaceActionCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 198 */           SGangRaceActionCfg _v_ = new SGangRaceActionCfg();
...
/*     */ 
/*     */ 
/*     */   public static SGangRaceActionCfg getOld(int key)
/*     */   {
/* 219 */     return (SGangRaceActionCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SGangRaceActionCfg get(int key)
/*     */   {
/* 224 */     return (SGangRaceActionCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SGangRaceActionCfg> getOldAll()
/*     */   {
/* 229 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SGangRaceActionCfg> getAll()
/*     */   {
/* 234 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SGangRaceActionCfg> newAll)
/*     */   {
/* 239 */     oldAll = all;
/* 240 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\activity\confbean\SGangRaceActionCfg.class
