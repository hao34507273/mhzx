...
/*     */ 
/*     */ public class SOnceActivityCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SOnceActivityCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SOnceActivityCfg> all = null;
/*     */   
/*     */   public int activityId;
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  22 */     this.activityId = Integer.valueOf(rootElement.attributeValue("activityId")).intValue();
/*     */   }
/*     */   
...
/*     */   {
/*  39 */     String path = dir + "mzm.gsp.activity.confbean.SOnceActivityCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  52 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity.confbean.SOnceActivityCfg"))
/*     */         {
/*     */ 
/*  55 */           SOnceActivityCfg obj = new SOnceActivityCfg();
/*  56 */           obj.loadFromXml(elem);
/*  57 */           if (all.put(Integer.valueOf(obj.activityId), obj) != null) {
/*  58 */             throw new RuntimeException("duplicate key : " + obj.activityId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SOnceActivityCfg> all)
/*     */   {
/*  69 */     String path = dir + "mzm.gsp.activity.confbean.SOnceActivityCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  81 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity.confbean.SOnceActivityCfg"))
/*     */         {
/*     */ 
/*  84 */           SOnceActivityCfg obj = new SOnceActivityCfg();
/*  85 */           obj.loadFromXml(elem);
/*  86 */           if (all.put(Integer.valueOf(obj.activityId), obj) != null) {
/*  87 */             throw new RuntimeException("duplicate key : " + obj.activityId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 100 */     String path = dir + "mzm.gsp.activity.confbean.SOnceActivityCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 127 */           SOnceActivityCfg _v_ = new SOnceActivityCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SOnceActivityCfg> all)
/*     */   {
/* 147 */     String path = dir + "mzm.gsp.activity.confbean.SOnceActivityCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 174 */           SOnceActivityCfg _v_ = new SOnceActivityCfg();
...
/*     */ 
/*     */ 
/*     */   public static SOnceActivityCfg getOld(int key)
/*     */   {
/* 195 */     return (SOnceActivityCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SOnceActivityCfg get(int key)
/*     */   {
/* 200 */     return (SOnceActivityCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SOnceActivityCfg> getOldAll()
/*     */   {
/* 205 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SOnceActivityCfg> getAll()
/*     */   {
/* 210 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SOnceActivityCfg> newAll)
/*     */   {
/* 215 */     oldAll = all;
/* 216 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\activity\confbean\SOnceActivityCfg.class
