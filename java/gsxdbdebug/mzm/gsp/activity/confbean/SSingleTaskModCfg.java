...
/*     */ 
/*     */ public class SSingleTaskModCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SSingleTaskModCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SSingleTaskModCfg> all = null;
/*     */   
/*     */   public int id;
...
/*     */   {
/*  51 */     String path = dir + "mzm.gsp.activity.confbean.SSingleTaskModCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  64 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity.confbean.SSingleTaskModCfg"))
/*     */         {
/*     */ 
/*  67 */           SSingleTaskModCfg obj = new SSingleTaskModCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SSingleTaskModCfg> all)
/*     */   {
/*  81 */     String path = dir + "mzm.gsp.activity.confbean.SSingleTaskModCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity.confbean.SSingleTaskModCfg"))
/*     */         {
/*     */ 
/*  96 */           SSingleTaskModCfg obj = new SSingleTaskModCfg();
...
/*     */     
/* 112 */     String path = dir + "mzm.gsp.activity.confbean.SSingleTaskModCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 139 */           SSingleTaskModCfg _v_ = new SSingleTaskModCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SSingleTaskModCfg> all)
/*     */   {
/* 159 */     String path = dir + "mzm.gsp.activity.confbean.SSingleTaskModCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 186 */           SSingleTaskModCfg _v_ = new SSingleTaskModCfg();
...
/*     */ 
/*     */ 
/*     */   public static SSingleTaskModCfg getOld(int key)
/*     */   {
/* 207 */     return (SSingleTaskModCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SSingleTaskModCfg get(int key)
/*     */   {
/* 212 */     return (SSingleTaskModCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SSingleTaskModCfg> getOldAll()
/*     */   {
/* 217 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SSingleTaskModCfg> getAll()
/*     */   {
/* 222 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SSingleTaskModCfg> newAll)
/*     */   {
/* 227 */     oldAll = all;
/* 228 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\activity\confbean\SSingleTaskModCfg.class
