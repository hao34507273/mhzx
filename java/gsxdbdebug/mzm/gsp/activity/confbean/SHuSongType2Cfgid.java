...
/*     */ 
/*     */ public class SHuSongType2Cfgid implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SHuSongType2Cfgid> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SHuSongType2Cfgid> all = null;
/*     */   
/*     */   public int type;
...
/*     */   {
/*  80 */     String path = dir + "mzm.gsp.activity.confbean.SHuSongType2Cfgid.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity.confbean.SHuSongType2Cfgid"))
/*     */         {
/*     */ 
/*  96 */           SHuSongType2Cfgid obj = new SHuSongType2Cfgid();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SHuSongType2Cfgid> all)
/*     */   {
/* 110 */     String path = dir + "mzm.gsp.activity.confbean.SHuSongType2Cfgid.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 122 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity.confbean.SHuSongType2Cfgid"))
/*     */         {
/*     */ 
/* 125 */           SHuSongType2Cfgid obj = new SHuSongType2Cfgid();
...
/*     */     
/* 141 */     String path = dir + "mzm.gsp.activity.confbean.SHuSongType2Cfgid.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 168 */           SHuSongType2Cfgid _v_ = new SHuSongType2Cfgid();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SHuSongType2Cfgid> all)
/*     */   {
/* 188 */     String path = dir + "mzm.gsp.activity.confbean.SHuSongType2Cfgid.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 215 */           SHuSongType2Cfgid _v_ = new SHuSongType2Cfgid();
...
/*     */ 
/*     */ 
/*     */   public static SHuSongType2Cfgid getOld(int key)
/*     */   {
/* 236 */     return (SHuSongType2Cfgid)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SHuSongType2Cfgid get(int key)
/*     */   {
/* 241 */     return (SHuSongType2Cfgid)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SHuSongType2Cfgid> getOldAll()
/*     */   {
/* 246 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SHuSongType2Cfgid> getAll()
/*     */   {
/* 251 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SHuSongType2Cfgid> newAll)
/*     */   {
/* 256 */     oldAll = all;
/* 257 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\activity\confbean\SHuSongType2Cfgid.class
