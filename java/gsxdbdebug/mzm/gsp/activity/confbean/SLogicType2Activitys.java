...
/*     */ 
/*     */ public class SLogicType2Activitys implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SLogicType2Activitys> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SLogicType2Activitys> all = null;
/*     */   
/*     */   public int logicType;
/*  19 */   public java.util.HashSet<Integer> activityids = new java.util.HashSet();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.logicType = Integer.valueOf(rootElement.attributeValue("logicType")).intValue();
/*     */     
/*  25 */     Element collectionElement = util.XmlHelper.getVariableElement(rootElement, "activityids");
...
/*     */         }
/*     */         
/*  50 */         this.activityids.add(Integer.valueOf(_v_));
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*     */   {
/*  57 */     _os_.marshal(this.logicType);
/*  58 */     _os_.compact_uint32(this.activityids.size());
/*  59 */     for (Integer _v_ : this.activityids)
/*     */     {
...
/*     */   {
/*  80 */     String path = dir + "mzm.gsp.activity.confbean.SLogicType2Activitys.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity.confbean.SLogicType2Activitys"))
/*     */         {
/*     */ 
/*  96 */           SLogicType2Activitys obj = new SLogicType2Activitys();
/*  97 */           obj.loadFromXml(elem);
/*  98 */           if (all.put(Integer.valueOf(obj.logicType), obj) != null) {
/*  99 */             throw new RuntimeException("duplicate key : " + obj.logicType);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SLogicType2Activitys> all)
/*     */   {
/* 110 */     String path = dir + "mzm.gsp.activity.confbean.SLogicType2Activitys.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 122 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity.confbean.SLogicType2Activitys"))
/*     */         {
/*     */ 
/* 125 */           SLogicType2Activitys obj = new SLogicType2Activitys();
/* 126 */           obj.loadFromXml(elem);
/* 127 */           if (all.put(Integer.valueOf(obj.logicType), obj) != null) {
/* 128 */             throw new RuntimeException("duplicate key : " + obj.logicType);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 141 */     String path = dir + "mzm.gsp.activity.confbean.SLogicType2Activitys.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 168 */           SLogicType2Activitys _v_ = new SLogicType2Activitys();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SLogicType2Activitys> all)
/*     */   {
/* 188 */     String path = dir + "mzm.gsp.activity.confbean.SLogicType2Activitys.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 215 */           SLogicType2Activitys _v_ = new SLogicType2Activitys();
...
/*     */ 
/*     */ 
/*     */   public static SLogicType2Activitys getOld(int key)
/*     */   {
/* 236 */     return (SLogicType2Activitys)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SLogicType2Activitys get(int key)
/*     */   {
/* 241 */     return (SLogicType2Activitys)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SLogicType2Activitys> getOldAll()
/*     */   {
/* 246 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SLogicType2Activitys> getAll()
/*     */   {
/* 251 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SLogicType2Activitys> newAll)
/*     */   {
/* 256 */     oldAll = all;
/* 257 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\activity\confbean\SLogicType2Activitys.class
