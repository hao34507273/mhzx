...
/*     */ 
/*     */ public class SWorldQuestionTime implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SWorldQuestionTime> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SWorldQuestionTime> all = null;
/*     */   
/*     */   public int id;
/*     */   public int commontimeId;
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.id = Integer.valueOf(rootElement.attributeValue("id")).intValue();
/*  24 */     this.commontimeId = Integer.valueOf(rootElement.attributeValue("commontimeId")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  29 */     _os_.marshal(this.id);
/*  30 */     _os_.marshal(this.commontimeId);
/*  31 */     return _os_;
/*     */   }
/*     */   
...
/*  37 */     this.commontimeId = _os_.unmarshal_int();
/*  38 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.activity.confbean.SWorldQuestionTime.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity.confbean.SWorldQuestionTime"))
/*     */         {
/*     */ 
/*  59 */           SWorldQuestionTime obj = new SWorldQuestionTime();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SWorldQuestionTime> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.activity.confbean.SWorldQuestionTime.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity.confbean.SWorldQuestionTime"))
/*     */         {
/*     */ 
/*  88 */           SWorldQuestionTime obj = new SWorldQuestionTime();
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.activity.confbean.SWorldQuestionTime.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           SWorldQuestionTime _v_ = new SWorldQuestionTime();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SWorldQuestionTime> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.activity.confbean.SWorldQuestionTime.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           SWorldQuestionTime _v_ = new SWorldQuestionTime();
...
/*     */ 
/*     */ 
/*     */   public static SWorldQuestionTime getOld(int key)
/*     */   {
/* 199 */     return (SWorldQuestionTime)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SWorldQuestionTime get(int key)
/*     */   {
/* 204 */     return (SWorldQuestionTime)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SWorldQuestionTime> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SWorldQuestionTime> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SWorldQuestionTime> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\activity\confbean\SWorldQuestionTime.class
