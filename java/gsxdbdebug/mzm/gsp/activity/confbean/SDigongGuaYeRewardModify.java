...
/*     */ 
/*     */ public class SDigongGuaYeRewardModify implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SDigongGuaYeRewardModify> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SDigongGuaYeRewardModify> all = null;
/*     */   
/*     */   public int id;
/*     */   public String templatename;
/*     */   public int lowDifMonsterLevel;
/*     */   public int highDifMonsterLevel;
/*     */   public boolean isCostDoublePoint;
...
/*  29 */     this.lowDifMonsterLevel = Integer.valueOf(rootElement.attributeValue("lowDifMonsterLevel")).intValue();
/*  30 */     this.highDifMonsterLevel = Integer.valueOf(rootElement.attributeValue("highDifMonsterLevel")).intValue();
/*  31 */     this.isCostDoublePoint = Boolean.valueOf(rootElement.attributeValue("isCostDoublePoint")).booleanValue();
/*  32 */     this.modifyValueTableId = Integer.valueOf(rootElement.attributeValue("modifyValueTableId")).intValue();
/*     */   }
/*     */   
...
/*  39 */     _os_.marshal(this.lowDifMonsterLevel);
/*  40 */     _os_.marshal(this.highDifMonsterLevel);
/*  41 */     _os_.marshal(this.isCostDoublePoint);
/*  42 */     _os_.marshal(this.modifyValueTableId);
/*  43 */     return _os_;
/*     */   }
/*     */   
...
/*  50 */     this.lowDifMonsterLevel = _os_.unmarshal_int();
/*  51 */     this.highDifMonsterLevel = _os_.unmarshal_int();
/*  52 */     this.isCostDoublePoint = _os_.unmarshal_boolean();
/*  53 */     this.modifyValueTableId = _os_.unmarshal_int();
/*  54 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  59 */     String path = dir + "mzm.gsp.activity.confbean.SDigongGuaYeRewardModify.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  72 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity.confbean.SDigongGuaYeRewardModify"))
/*     */         {
/*     */ 
/*  75 */           SDigongGuaYeRewardModify obj = new SDigongGuaYeRewardModify();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SDigongGuaYeRewardModify> all)
/*     */   {
/*  89 */     String path = dir + "mzm.gsp.activity.confbean.SDigongGuaYeRewardModify.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 101 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity.confbean.SDigongGuaYeRewardModify"))
/*     */         {
/*     */ 
/* 104 */           SDigongGuaYeRewardModify obj = new SDigongGuaYeRewardModify();
...
/*     */     
/* 120 */     String path = dir + "mzm.gsp.activity.confbean.SDigongGuaYeRewardModify.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 147 */           SDigongGuaYeRewardModify _v_ = new SDigongGuaYeRewardModify();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SDigongGuaYeRewardModify> all)
/*     */   {
/* 167 */     String path = dir + "mzm.gsp.activity.confbean.SDigongGuaYeRewardModify.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 194 */           SDigongGuaYeRewardModify _v_ = new SDigongGuaYeRewardModify();
...
/*     */ 
/*     */ 
/*     */   public static SDigongGuaYeRewardModify getOld(int key)
/*     */   {
/* 215 */     return (SDigongGuaYeRewardModify)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SDigongGuaYeRewardModify get(int key)
/*     */   {
/* 220 */     return (SDigongGuaYeRewardModify)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SDigongGuaYeRewardModify> getOldAll()
/*     */   {
/* 225 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SDigongGuaYeRewardModify> getAll()
/*     */   {
/* 230 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SDigongGuaYeRewardModify> newAll)
/*     */   {
/* 235 */     oldAll = all;
/* 236 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\activity\confbean\SDigongGuaYeRewardModify.class
