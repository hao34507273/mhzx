...
/*     */ 
/*     */ public class SCoupleDailyActivityCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SCoupleDailyActivityCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SCoupleDailyActivityCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public String templatename;
/*     */   public String taskDes;
/*     */   public int taskType;
/*     */   public int successAwardId;
...
/*  29 */     this.taskDes = rootElement.attributeValue("taskDes");
/*  30 */     this.taskType = Integer.valueOf(rootElement.attributeValue("taskType")).intValue();
/*  31 */     this.successAwardId = Integer.valueOf(rootElement.attributeValue("successAwardId")).intValue();
/*  32 */     this.failAwardId = Integer.valueOf(rootElement.attributeValue("failAwardId")).intValue();
/*     */   }
/*     */   
...
/*  39 */     _os_.marshal(this.taskDes, "UTF-8");
/*  40 */     _os_.marshal(this.taskType);
/*  41 */     _os_.marshal(this.successAwardId);
/*  42 */     _os_.marshal(this.failAwardId);
/*  43 */     return _os_;
/*     */   }
/*     */   
...
/*  50 */     this.taskDes = _os_.unmarshal_String("UTF-8");
/*  51 */     this.taskType = _os_.unmarshal_int();
/*  52 */     this.successAwardId = _os_.unmarshal_int();
/*  53 */     this.failAwardId = _os_.unmarshal_int();
/*  54 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  59 */     String path = dir + "mzm.gsp.activity.confbean.SCoupleDailyActivityCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  72 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity.confbean.SCoupleDailyActivityCfg"))
/*     */         {
/*     */ 
/*  75 */           SCoupleDailyActivityCfg obj = new SCoupleDailyActivityCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SCoupleDailyActivityCfg> all)
/*     */   {
/*  89 */     String path = dir + "mzm.gsp.activity.confbean.SCoupleDailyActivityCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 101 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity.confbean.SCoupleDailyActivityCfg"))
/*     */         {
/*     */ 
/* 104 */           SCoupleDailyActivityCfg obj = new SCoupleDailyActivityCfg();
...
/*     */     
/* 120 */     String path = dir + "mzm.gsp.activity.confbean.SCoupleDailyActivityCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 147 */           SCoupleDailyActivityCfg _v_ = new SCoupleDailyActivityCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SCoupleDailyActivityCfg> all)
/*     */   {
/* 167 */     String path = dir + "mzm.gsp.activity.confbean.SCoupleDailyActivityCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 194 */           SCoupleDailyActivityCfg _v_ = new SCoupleDailyActivityCfg();
...
/*     */ 
/*     */ 
/*     */   public static SCoupleDailyActivityCfg getOld(int key)
/*     */   {
/* 215 */     return (SCoupleDailyActivityCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SCoupleDailyActivityCfg get(int key)
/*     */   {
/* 220 */     return (SCoupleDailyActivityCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SCoupleDailyActivityCfg> getOldAll()
/*     */   {
/* 225 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SCoupleDailyActivityCfg> getAll()
/*     */   {
/* 230 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SCoupleDailyActivityCfg> newAll)
/*     */   {
/* 235 */     oldAll = all;
/* 236 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\activity\confbean\SCoupleDailyActivityCfg.class
