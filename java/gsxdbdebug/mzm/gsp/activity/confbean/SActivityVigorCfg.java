...
/*     */ 
/*     */ public class SActivityVigorCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SActivityVigorCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SActivityVigorCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public int maxCount;
/*     */   
...
/*  24 */     this.maxCount = Integer.valueOf(rootElement.attributeValue("maxCount")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  29 */     _os_.marshal(this.id);
/*  30 */     _os_.marshal(this.maxCount);
/*  31 */     return _os_;
/*     */   }
/*     */   
...
/*  37 */     this.maxCount = _os_.unmarshal_int();
/*  38 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.activity.confbean.SActivityVigorCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity.confbean.SActivityVigorCfg"))
/*     */         {
/*     */ 
/*  59 */           SActivityVigorCfg obj = new SActivityVigorCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SActivityVigorCfg> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.activity.confbean.SActivityVigorCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity.confbean.SActivityVigorCfg"))
/*     */         {
/*     */ 
/*  88 */           SActivityVigorCfg obj = new SActivityVigorCfg();
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.activity.confbean.SActivityVigorCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           SActivityVigorCfg _v_ = new SActivityVigorCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SActivityVigorCfg> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.activity.confbean.SActivityVigorCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           SActivityVigorCfg _v_ = new SActivityVigorCfg();
...
/*     */ 
/*     */ 
/*     */   public static SActivityVigorCfg getOld(int key)
/*     */   {
/* 199 */     return (SActivityVigorCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SActivityVigorCfg get(int key)
/*     */   {
/* 204 */     return (SActivityVigorCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SActivityVigorCfg> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SActivityVigorCfg> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SActivityVigorCfg> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\activity\confbean\SActivityVigorCfg.class
