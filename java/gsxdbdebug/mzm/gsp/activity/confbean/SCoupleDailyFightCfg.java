...
/*     */ 
/*     */ public class SCoupleDailyFightCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SCoupleDailyFightCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SCoupleDailyFightCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public int fightId;
/*     */   
...
/*  24 */     this.fightId = Integer.valueOf(rootElement.attributeValue("fightId")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  29 */     _os_.marshal(this.id);
/*  30 */     _os_.marshal(this.fightId);
/*  31 */     return _os_;
/*     */   }
/*     */   
...
/*  37 */     this.fightId = _os_.unmarshal_int();
/*  38 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.activity.confbean.SCoupleDailyFightCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity.confbean.SCoupleDailyFightCfg"))
/*     */         {
/*     */ 
/*  59 */           SCoupleDailyFightCfg obj = new SCoupleDailyFightCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SCoupleDailyFightCfg> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.activity.confbean.SCoupleDailyFightCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity.confbean.SCoupleDailyFightCfg"))
/*     */         {
/*     */ 
/*  88 */           SCoupleDailyFightCfg obj = new SCoupleDailyFightCfg();
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.activity.confbean.SCoupleDailyFightCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           SCoupleDailyFightCfg _v_ = new SCoupleDailyFightCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SCoupleDailyFightCfg> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.activity.confbean.SCoupleDailyFightCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           SCoupleDailyFightCfg _v_ = new SCoupleDailyFightCfg();
...
/*     */ 
/*     */ 
/*     */   public static SCoupleDailyFightCfg getOld(int key)
/*     */   {
/* 199 */     return (SCoupleDailyFightCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SCoupleDailyFightCfg get(int key)
/*     */   {
/* 204 */     return (SCoupleDailyFightCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SCoupleDailyFightCfg> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SCoupleDailyFightCfg> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SCoupleDailyFightCfg> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\activity\confbean\SCoupleDailyFightCfg.class
