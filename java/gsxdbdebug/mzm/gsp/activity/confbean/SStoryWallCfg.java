...
/*     */ 
/*     */ public class SStoryWallCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SStoryWallCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SStoryWallCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public int index;
/*     */   public int awardId;
...
/*  25 */     this.index = Integer.valueOf(rootElement.attributeValue("index")).intValue();
...
/*  40 */     this.index = _os_.unmarshal_int();
...
/*     */   {
/*  47 */     String path = dir + "mzm.gsp.activity.confbean.SStoryWallCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  60 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity.confbean.SStoryWallCfg"))
/*     */         {
/*     */ 
/*  63 */           SStoryWallCfg obj = new SStoryWallCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SStoryWallCfg> all)
/*     */   {
/*  77 */     String path = dir + "mzm.gsp.activity.confbean.SStoryWallCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  89 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity.confbean.SStoryWallCfg"))
/*     */         {
/*     */ 
/*  92 */           SStoryWallCfg obj = new SStoryWallCfg();
...
/*     */     
/* 108 */     String path = dir + "mzm.gsp.activity.confbean.SStoryWallCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 135 */           SStoryWallCfg _v_ = new SStoryWallCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SStoryWallCfg> all)
/*     */   {
/* 155 */     String path = dir + "mzm.gsp.activity.confbean.SStoryWallCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 182 */           SStoryWallCfg _v_ = new SStoryWallCfg();
...
/*     */ 
/*     */ 
/*     */   public static SStoryWallCfg getOld(int key)
/*     */   {
/* 203 */     return (SStoryWallCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SStoryWallCfg get(int key)
/*     */   {
/* 208 */     return (SStoryWallCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SStoryWallCfg> getOldAll()
/*     */   {
/* 213 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SStoryWallCfg> getAll()
/*     */   {
/* 218 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SStoryWallCfg> newAll)
/*     */   {
/* 223 */     oldAll = all;
/* 224 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\activity\confbean\SStoryWallCfg.class
