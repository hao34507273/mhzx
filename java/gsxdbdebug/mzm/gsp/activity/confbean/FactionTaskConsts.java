...
/*     */ 
/*     */ public class FactionTaskConsts
/*     */ {
/*  13 */   private static volatile FactionTaskConsts oldInstance = null;
/*     */   
/*  15 */   private static FactionTaskConsts instance = new FactionTaskConsts();
/*     */   public int ACTIVITYID;
/*     */   public int NPC_ID;
/*     */   public int NPC_SERVICE;
/*     */   public int TASK_GRAPH_ID;
/*     */   
/*     */   public static FactionTaskConsts getOldInstance()
/*     */   {
/*  23 */     return oldInstance;
/*     */   }
/*     */   
/*     */   public static FactionTaskConsts getInstance()
/*     */   {
/*  28 */     return instance;
/*     */   }
/*     */   
...
/*     */   {
/*  48 */     String path = dir + "mzm.gsp.activity.confbean.FactionTaskConsts.xml";
/*     */     try
/*     */     {
...
/*  74 */       this.NUM_UP = Integer.valueOf(((Element)data.get("NUM_UP")).attributeValue("value")).intValue();
/*  75 */       this.PERFECT_NUM = Integer.valueOf(((Element)data.get("PERFECT_NUM")).attributeValue("value")).intValue();
/*  76 */       this.PER_AWARD_ID = Integer.valueOf(((Element)data.get("PER_AWARD_ID")).attributeValue("value")).intValue();
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*  85 */     String path = dir + "mzm.gsp.activity.confbean.FactionTaskConsts.xml";
/*     */     try
/*     */     {
...
/* 108 */       this.TASK_GRAPH_ID = Integer.valueOf(((Element)data.get("TASK_GRAPH_ID")).attributeValue("value")).intValue();
/* 109 */       this.CAN_JOIN_LEVEL = Integer.valueOf(((Element)data.get("CAN_JOIN_LEVEL")).attributeValue("value")).intValue();
/* 110 */       this.AWARD_ID = Integer.valueOf(((Element)data.get("AWARD_ID")).attributeValue("value")).intValue();
/* 111 */       this.NUM_UP = Integer.valueOf(((Element)data.get("NUM_UP")).attributeValue("value")).intValue();
/* 112 */       this.PERFECT_NUM = Integer.valueOf(((Element)data.get("PERFECT_NUM")).attributeValue("value")).intValue();
/* 113 */       this.PER_AWARD_ID = Integer.valueOf(((Element)data.get("PER_AWARD_ID")).attributeValue("value")).intValue();
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/* 124 */     String path = dir + "mzm.gsp.activity.confbean.FactionTaskConsts.bny";
/*     */     try
/*     */     {
...
/* 142 */         this.TASK_GRAPH_ID = _os_.unmarshal_int();
/* 143 */         this.CAN_JOIN_LEVEL = _os_.unmarshal_int();
/* 144 */         this.AWARD_ID = _os_.unmarshal_int();
/* 145 */         this.NUM_UP = _os_.unmarshal_int();
/* 146 */         this.PERFECT_NUM = _os_.unmarshal_int();
/* 147 */         this.PER_AWARD_ID = _os_.unmarshal_int();
/*     */       }
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*     */   {
/* 158 */     String path = dir + "mzm.gsp.activity.confbean.FactionTaskConsts.bny";
/*     */     try
/*     */     {
...
/* 176 */         this.TASK_GRAPH_ID = _os_.unmarshal_int();
/* 177 */         this.CAN_JOIN_LEVEL = _os_.unmarshal_int();
/* 178 */         this.AWARD_ID = _os_.unmarshal_int();
/* 179 */         this.NUM_UP = _os_.unmarshal_int();
/* 180 */         this.PERFECT_NUM = _os_.unmarshal_int();
/* 181 */         this.PER_AWARD_ID = _os_.unmarshal_int();
/*     */       }
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*     */   }
/*     */   
/*     */   public static void setInstance(FactionTaskConsts newInstance)
/*     */   {
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\activity\confbean\FactionTaskConsts.class
