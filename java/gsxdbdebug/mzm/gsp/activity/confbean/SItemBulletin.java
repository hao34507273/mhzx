...
/*     */ 
/*     */ public class SItemBulletin implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SItemBulletin> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SItemBulletin> all = null;
/*     */   
/*     */   public int itemId;
...
/*  24 */     this.bulletType = Integer.valueOf(rootElement.attributeValue("bulletType")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  29 */     _os_.marshal(this.itemId);
/*  30 */     _os_.marshal(this.bulletType);
/*  31 */     return _os_;
/*     */   }
/*     */   
...
/*  37 */     this.bulletType = _os_.unmarshal_int();
/*  38 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.activity.confbean.SItemBulletin.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity.confbean.SItemBulletin"))
/*     */         {
/*     */ 
/*  59 */           SItemBulletin obj = new SItemBulletin();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SItemBulletin> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.activity.confbean.SItemBulletin.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity.confbean.SItemBulletin"))
/*     */         {
/*     */ 
/*  88 */           SItemBulletin obj = new SItemBulletin();
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.activity.confbean.SItemBulletin.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           SItemBulletin _v_ = new SItemBulletin();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SItemBulletin> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.activity.confbean.SItemBulletin.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           SItemBulletin _v_ = new SItemBulletin();
...
/*     */ 
/*     */ 
/*     */   public static SItemBulletin getOld(int key)
/*     */   {
/* 199 */     return (SItemBulletin)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SItemBulletin get(int key)
/*     */   {
/* 204 */     return (SItemBulletin)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SItemBulletin> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SItemBulletin> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SItemBulletin> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\activity\confbean\SItemBulletin.class
