...
/*     */ 
/*     */ public class SMarketCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SMarketCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SMarketCfg> all = null;
/*     */   
/*     */   public int id;
...
/*  25 */     this.isSearch = Boolean.valueOf(rootElement.attributeValue("isSearch")).booleanValue();
/*  26 */     this.conditionEffectTime = Integer.valueOf(rootElement.attributeValue("conditionEffectTime")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  31 */     _os_.marshal(this.id);
/*  32 */     _os_.marshal(this.isSearch);
/*  33 */     _os_.marshal(this.conditionEffectTime);
/*  34 */     return _os_;
/*     */   }
/*     */   
...
/*  40 */     this.isSearch = _os_.unmarshal_boolean();
/*  41 */     this.conditionEffectTime = _os_.unmarshal_int();
/*  42 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  47 */     String path = dir + "mzm.gsp.market.confbean.SMarketCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  60 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.market.confbean.SMarketCfg"))
/*     */         {
/*     */ 
/*  63 */           SMarketCfg obj = new SMarketCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SMarketCfg> all)
/*     */   {
/*  77 */     String path = dir + "mzm.gsp.market.confbean.SMarketCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  89 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.market.confbean.SMarketCfg"))
/*     */         {
/*     */ 
/*  92 */           SMarketCfg obj = new SMarketCfg();
...
/*     */     
/* 108 */     String path = dir + "mzm.gsp.market.confbean.SMarketCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 135 */           SMarketCfg _v_ = new SMarketCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SMarketCfg> all)
/*     */   {
/* 155 */     String path = dir + "mzm.gsp.market.confbean.SMarketCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 182 */           SMarketCfg _v_ = new SMarketCfg();
...
/*     */ 
/*     */ 
/*     */   public static SMarketCfg getOld(int key)
/*     */   {
/* 203 */     return (SMarketCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SMarketCfg get(int key)
/*     */   {
/* 208 */     return (SMarketCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMarketCfg> getOldAll()
/*     */   {
/* 213 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMarketCfg> getAll()
/*     */   {
/* 218 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SMarketCfg> newAll)
/*     */   {
/* 223 */     oldAll = all;
/* 224 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\market\confbean\SMarketCfg.class
