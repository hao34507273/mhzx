...
/*     */ 
/*     */ public class SItemSubTypeIds implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SItemSubTypeIds> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SItemSubTypeIds> all = null;
/*     */   
/*     */   public int subid;
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  22 */     this.subid = Integer.valueOf(rootElement.attributeValue("subid")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  27 */     _os_.marshal(this.subid);
/*  28 */     return _os_;
/*     */   }
/*     */   
/*     */   public OctetsStream unmarshal(OctetsStream _os_) throws com.goldhuman.Common.Marshal.MarshalException
/*     */   {
/*  33 */     this.subid = _os_.unmarshal_int();
/*  34 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  39 */     String path = dir + "mzm.gsp.market.confbean.SItemSubTypeIds.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  52 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.market.confbean.SItemSubTypeIds"))
/*     */         {
/*     */ 
/*  55 */           SItemSubTypeIds obj = new SItemSubTypeIds();
/*  56 */           obj.loadFromXml(elem);
/*  57 */           if (all.put(Integer.valueOf(obj.subid), obj) != null) {
/*  58 */             throw new RuntimeException("duplicate key : " + obj.subid);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SItemSubTypeIds> all)
/*     */   {
/*  69 */     String path = dir + "mzm.gsp.market.confbean.SItemSubTypeIds.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  81 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.market.confbean.SItemSubTypeIds"))
/*     */         {
/*     */ 
/*  84 */           SItemSubTypeIds obj = new SItemSubTypeIds();
/*  85 */           obj.loadFromXml(elem);
/*  86 */           if (all.put(Integer.valueOf(obj.subid), obj) != null) {
/*  87 */             throw new RuntimeException("duplicate key : " + obj.subid);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 100 */     String path = dir + "mzm.gsp.market.confbean.SItemSubTypeIds.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 127 */           SItemSubTypeIds _v_ = new SItemSubTypeIds();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SItemSubTypeIds> all)
/*     */   {
/* 147 */     String path = dir + "mzm.gsp.market.confbean.SItemSubTypeIds.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 174 */           SItemSubTypeIds _v_ = new SItemSubTypeIds();
...
/*     */ 
/*     */ 
/*     */   public static SItemSubTypeIds getOld(int key)
/*     */   {
/* 195 */     return (SItemSubTypeIds)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SItemSubTypeIds get(int key)
/*     */   {
/* 200 */     return (SItemSubTypeIds)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SItemSubTypeIds> getOldAll()
/*     */   {
/* 205 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SItemSubTypeIds> getAll()
/*     */   {
/* 210 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SItemSubTypeIds> newAll)
/*     */   {
/* 215 */     oldAll = all;
/* 216 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\market\confbean\SItemSubTypeIds.class
