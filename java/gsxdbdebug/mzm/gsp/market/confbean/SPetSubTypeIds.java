...
/*     */ 
/*     */ public class SPetSubTypeIds implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SPetSubTypeIds> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SPetSubTypeIds> all = null;
/*     */   
/*     */   public int subid;
/*     */   
...
/*     */   {
/*  39 */     String path = dir + "mzm.gsp.market.confbean.SPetSubTypeIds.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  52 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.market.confbean.SPetSubTypeIds"))
/*     */         {
/*     */ 
/*  55 */           SPetSubTypeIds obj = new SPetSubTypeIds();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SPetSubTypeIds> all)
/*     */   {
/*  69 */     String path = dir + "mzm.gsp.market.confbean.SPetSubTypeIds.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  81 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.market.confbean.SPetSubTypeIds"))
/*     */         {
/*     */ 
/*  84 */           SPetSubTypeIds obj = new SPetSubTypeIds();
...
/*     */     
/* 100 */     String path = dir + "mzm.gsp.market.confbean.SPetSubTypeIds.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 127 */           SPetSubTypeIds _v_ = new SPetSubTypeIds();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SPetSubTypeIds> all)
/*     */   {
/* 147 */     String path = dir + "mzm.gsp.market.confbean.SPetSubTypeIds.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 174 */           SPetSubTypeIds _v_ = new SPetSubTypeIds();
...
/*     */ 
/*     */ 
/*     */   public static SPetSubTypeIds getOld(int key)
/*     */   {
/* 195 */     return (SPetSubTypeIds)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SPetSubTypeIds get(int key)
/*     */   {
/* 200 */     return (SPetSubTypeIds)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPetSubTypeIds> getOldAll()
/*     */   {
/* 205 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPetSubTypeIds> getAll()
/*     */   {
/* 210 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SPetSubTypeIds> newAll)
/*     */   {
/* 215 */     oldAll = all;
/* 216 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\market\confbean\SPetSubTypeIds.class
