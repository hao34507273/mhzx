...
/*     */ 
/*     */ public class MarketSupplyItemCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, MarketSupplyItemCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, MarketSupplyItemCfg> all = null;
/*     */   
/*     */   public int itemid;
/*     */   public int id;
...
/*     */   {
/* 114 */     String path = dir + "mzm.gsp.market.confbean.MarketSupplyItemCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 127 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.market.confbean.MarketSupplyItemCfg"))
/*     */         {
/*     */ 
/* 130 */           MarketSupplyItemCfg obj = new MarketSupplyItemCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, MarketSupplyItemCfg> all)
/*     */   {
/* 144 */     String path = dir + "mzm.gsp.market.confbean.MarketSupplyItemCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 156 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.market.confbean.MarketSupplyItemCfg"))
/*     */         {
/*     */ 
/* 159 */           MarketSupplyItemCfg obj = new MarketSupplyItemCfg();
...
/*     */     
/* 175 */     String path = dir + "mzm.gsp.market.confbean.MarketSupplyItemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 202 */           MarketSupplyItemCfg _v_ = new MarketSupplyItemCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, MarketSupplyItemCfg> all)
/*     */   {
/* 222 */     String path = dir + "mzm.gsp.market.confbean.MarketSupplyItemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 249 */           MarketSupplyItemCfg _v_ = new MarketSupplyItemCfg();
...
/*     */ 
/*     */ 
/*     */   public static MarketSupplyItemCfg getOld(int key)
/*     */   {
/* 270 */     return (MarketSupplyItemCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static MarketSupplyItemCfg get(int key)
/*     */   {
/* 275 */     return (MarketSupplyItemCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, MarketSupplyItemCfg> getOldAll()
/*     */   {
/* 280 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, MarketSupplyItemCfg> getAll()
/*     */   {
/* 285 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, MarketSupplyItemCfg> newAll)
/*     */   {
/* 290 */     oldAll = all;
/* 291 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\market\confbean\MarketSupplyItemCfg.class
