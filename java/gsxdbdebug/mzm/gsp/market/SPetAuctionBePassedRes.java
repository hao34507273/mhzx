...
/*     */ 
/*     */ 
/*     */ public class SPetAuctionBePassedRes
/*     */   extends __SPetAuctionBePassedRes__
/*     */ {
/*     */   public static final int PROTOCOL_TYPE = 12601446;
...
/*     */ 
/*     */ 
/*     */   public SPetAuctionBePassedRes() {}
/*     */   
/*     */ 
/*     */ 
/*     */   public SPetAuctionBePassedRes(long _marketid_, int _petcfgid_, int _myprice_, int _newprice_)
/*     */   {
...
/*  70 */     if ((_o1_ instanceof SPetAuctionBePassedRes)) {
/*  71 */       SPetAuctionBePassedRes _o_ = (SPetAuctionBePassedRes)_o1_;
/*  72 */       if (this.marketid != _o_.marketid) return false;
/*  73 */       if (this.petcfgid != _o_.petcfgid) return false;
...
/*     */   }
/*     */   
/*     */   public int compareTo(SPetAuctionBePassedRes _o_) {
/* 102 */     if (_o_ == this) return 0;
/* 103 */     int _c_ = 0;
/* 104 */     _c_ = Long.signum(this.marketid - _o_.marketid);
/* 105 */     if (0 != _c_) return _c_;
/* 106 */     _c_ = this.petcfgid - _o_.petcfgid;
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\market\SPetAuctionBePassedRes.class
