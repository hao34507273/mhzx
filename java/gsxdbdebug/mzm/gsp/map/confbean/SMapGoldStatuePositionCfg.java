...
/*     */ 
/*     */ public class SMapGoldStatuePositionCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SMapGoldStatuePositionCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SMapGoldStatuePositionCfg> all = null;
/*     */   
/*     */   public int sn;
/*     */   public int mapId;
/*     */   public int x;
...
/*     */   {
/*  25 */     this.sn = Integer.valueOf(rootElement.attributeValue("sn")).intValue();
/*  26 */     this.mapId = Integer.valueOf(rootElement.attributeValue("mapId")).intValue();
/*  27 */     this.x = Integer.valueOf(rootElement.attributeValue("x")).intValue();
/*  28 */     this.y = Integer.valueOf(rootElement.attributeValue("y")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  33 */     _os_.marshal(this.sn);
/*  34 */     _os_.marshal(this.mapId);
/*  35 */     _os_.marshal(this.x);
/*  36 */     _os_.marshal(this.y);
/*  37 */     return _os_;
/*     */   }
/*     */   
/*     */   public OctetsStream unmarshal(OctetsStream _os_) throws com.goldhuman.Common.Marshal.MarshalException
/*     */   {
/*  42 */     this.sn = _os_.unmarshal_int();
/*  43 */     this.mapId = _os_.unmarshal_int();
/*  44 */     this.x = _os_.unmarshal_int();
/*  45 */     this.y = _os_.unmarshal_int();
/*  46 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  51 */     String path = dir + "mzm.gsp.map.confbean.SMapGoldStatuePositionCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  64 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.map.confbean.SMapGoldStatuePositionCfg"))
/*     */         {
/*     */ 
/*  67 */           SMapGoldStatuePositionCfg obj = new SMapGoldStatuePositionCfg();
/*  68 */           obj.loadFromXml(elem);
/*  69 */           if (all.put(Integer.valueOf(obj.sn), obj) != null) {
/*  70 */             throw new RuntimeException("duplicate key : " + obj.sn);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SMapGoldStatuePositionCfg> all)
/*     */   {
/*  81 */     String path = dir + "mzm.gsp.map.confbean.SMapGoldStatuePositionCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.map.confbean.SMapGoldStatuePositionCfg"))
/*     */         {
/*     */ 
/*  96 */           SMapGoldStatuePositionCfg obj = new SMapGoldStatuePositionCfg();
/*  97 */           obj.loadFromXml(elem);
/*  98 */           if (all.put(Integer.valueOf(obj.sn), obj) != null) {
/*  99 */             throw new RuntimeException("duplicate key : " + obj.sn);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 112 */     String path = dir + "mzm.gsp.map.confbean.SMapGoldStatuePositionCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 139 */           SMapGoldStatuePositionCfg _v_ = new SMapGoldStatuePositionCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SMapGoldStatuePositionCfg> all)
/*     */   {
/* 159 */     String path = dir + "mzm.gsp.map.confbean.SMapGoldStatuePositionCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 186 */           SMapGoldStatuePositionCfg _v_ = new SMapGoldStatuePositionCfg();
...
/*     */ 
/*     */ 
/*     */   public static SMapGoldStatuePositionCfg getOld(int key)
/*     */   {
/* 207 */     return (SMapGoldStatuePositionCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SMapGoldStatuePositionCfg get(int key)
/*     */   {
/* 212 */     return (SMapGoldStatuePositionCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMapGoldStatuePositionCfg> getOldAll()
/*     */   {
/* 217 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMapGoldStatuePositionCfg> getAll()
/*     */   {
/* 222 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SMapGoldStatuePositionCfg> newAll)
/*     */   {
/* 227 */     oldAll = all;
/* 228 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\map\confbean\SMapGoldStatuePositionCfg.class
