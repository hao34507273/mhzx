...
/*     */ {
/*  13 */   private static volatile MapConsts oldInstance = null;
/*     */   
/*  15 */   private static MapConsts instance = new MapConsts();
/*     */   
/*     */   public int TASK_FLY_SPEED;
/*     */   public int MAPOBJECT_TALK_DIST;
/*     */   public double FLY_VIEW_EXTEND;
/*     */   
/*     */   public static MapConsts getOldInstance()
/*     */   {
/*  23 */     return oldInstance;
/*     */   }
/*     */   
/*     */   public static MapConsts getInstance()
/*     */   {
/*  28 */     return instance;
/*     */   }
/*     */   
...
/*     */   {
/*  42 */     String path = dir + "mzm.gsp.map.confbean.MapConsts.xml";
/*     */     try
/*     */     {
...
/*     */         }
/*     */       }
/*  62 */       this.TASK_FLY_SPEED = Integer.valueOf(((Element)data.get("TASK_FLY_SPEED")).attributeValue("value")).intValue();
/*  63 */       this.MAPOBJECT_TALK_DIST = Integer.valueOf(((Element)data.get("MAPOBJECT_TALK_DIST")).attributeValue("value")).intValue();
/*  64 */       this.FLY_VIEW_EXTEND = Double.valueOf(((Element)data.get("FLY_VIEW_EXTEND")).attributeValue("value")).doubleValue();
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*  73 */     String path = dir + "mzm.gsp.map.confbean.MapConsts.xml";
/*     */     try
/*     */     {
...
/*     */         }
/*     */       }
/*  93 */       this.TASK_FLY_SPEED = Integer.valueOf(((Element)data.get("TASK_FLY_SPEED")).attributeValue("value")).intValue();
/*  94 */       this.MAPOBJECT_TALK_DIST = Integer.valueOf(((Element)data.get("MAPOBJECT_TALK_DIST")).attributeValue("value")).intValue();
/*  95 */       this.FLY_VIEW_EXTEND = Double.valueOf(((Element)data.get("FLY_VIEW_EXTEND")).attributeValue("value")).doubleValue();
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/* 106 */     String path = dir + "mzm.gsp.map.confbean.MapConsts.bny";
/*     */     try
/*     */     {
...
/* 121 */         this.TASK_FLY_SPEED = _os_.unmarshal_int();
/* 122 */         this.MAPOBJECT_TALK_DIST = _os_.unmarshal_int();
/* 123 */         this.FLY_VIEW_EXTEND = _os_.unmarshal_float();
/*     */       }
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*     */   {
/* 134 */     String path = dir + "mzm.gsp.map.confbean.MapConsts.bny";
/*     */     try
/*     */     {
...
/* 149 */         this.TASK_FLY_SPEED = _os_.unmarshal_int();
/* 150 */         this.MAPOBJECT_TALK_DIST = _os_.unmarshal_int();
/* 151 */         this.FLY_VIEW_EXTEND = _os_.unmarshal_float();
/*     */       }
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*     */   }
/*     */   
/*     */   public static void setInstance(MapConsts newInstance)
/*     */   {
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\map\confbean\MapConsts.class
