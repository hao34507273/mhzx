...
/*     */ 
/*     */ public class SMapGoldStatueCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SMapGoldStatueCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SMapGoldStatueCfg> all = null;
/*     */   
/*     */   public int occupation;
/*  19 */   public HashMap<Integer, GoldStatueInfo> infos = new HashMap();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.occupation = Integer.valueOf(rootElement.attributeValue("occupation")).intValue();
/*     */     
/*  25 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "infos");
...
/*  51 */             keyElem = elem;
/*     */           }
/*  53 */           else if ((valueElem == null) && (elem.getName().equalsIgnoreCase("mzm.gsp.map.confbean.GoldStatueInfo")))
/*     */           {
/*  55 */             valueElem = elem;
/*     */           }
/*     */         }
...
/*     */         }
/*     */         
/*  77 */         this.infos.put(Integer.valueOf(_k_), _v_);
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*     */   {
/*  84 */     _os_.marshal(this.occupation);
/*  85 */     _os_.compact_uint32(this.infos.size());
/*  86 */     for (java.util.Map.Entry<Integer, GoldStatueInfo> _e_ : this.infos.entrySet())
/*     */     {
...
/*     */   {
/*  96 */     this.occupation = _os_.unmarshal_int();
/*  97 */     for (int _size_ = _os_.uncompact_uint32(); _size_ > 0; _size_--)
/*     */     {
/*     */ 
/* 100 */       int _k_ = _os_.unmarshal_int();
/*     */       
/* 102 */       GoldStatueInfo _v_ = new GoldStatueInfo();
/* 103 */       _v_.unmarshal(_os_);
/* 104 */       this.infos.put(Integer.valueOf(_k_), _v_);
/*     */     }
/* 106 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/* 111 */     String path = dir + "mzm.gsp.map.confbean.SMapGoldStatueCfg.xml";
/*     */     
/*     */     try
/*     */     {
/* 115 */       all = new HashMap();
...
/* 124 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.map.confbean.SMapGoldStatueCfg"))
/*     */         {
/*     */ 
/* 127 */           SMapGoldStatueCfg obj = new SMapGoldStatueCfg();
/* 128 */           obj.loadFromXml(elem);
/* 129 */           if (all.put(Integer.valueOf(obj.occupation), obj) != null) {
/* 130 */             throw new RuntimeException("duplicate key : " + obj.occupation);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SMapGoldStatueCfg> all)
/*     */   {
/* 141 */     String path = dir + "mzm.gsp.map.confbean.SMapGoldStatueCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 153 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.map.confbean.SMapGoldStatueCfg"))
/*     */         {
/*     */ 
/* 156 */           SMapGoldStatueCfg obj = new SMapGoldStatueCfg();
/* 157 */           obj.loadFromXml(elem);
/* 158 */           if (all.put(Integer.valueOf(obj.occupation), obj) != null) {
/* 159 */             throw new RuntimeException("duplicate key : " + obj.occupation);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/* 170 */     all = new HashMap();
/*     */     
/* 172 */     String path = dir + "mzm.gsp.map.confbean.SMapGoldStatueCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 199 */           SMapGoldStatueCfg _v_ = new SMapGoldStatueCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SMapGoldStatueCfg> all)
/*     */   {
/* 219 */     String path = dir + "mzm.gsp.map.confbean.SMapGoldStatueCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 246 */           SMapGoldStatueCfg _v_ = new SMapGoldStatueCfg();
...
/*     */ 
/*     */ 
/*     */   public static SMapGoldStatueCfg getOld(int key)
/*     */   {
/* 267 */     return (SMapGoldStatueCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SMapGoldStatueCfg get(int key)
/*     */   {
/* 272 */     return (SMapGoldStatueCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMapGoldStatueCfg> getOldAll()
/*     */   {
/* 277 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMapGoldStatueCfg> getAll()
/*     */   {
/* 282 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SMapGoldStatueCfg> newAll)
/*     */   {
/* 287 */     oldAll = all;
/* 288 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\map\confbean\SMapGoldStatueCfg.class
