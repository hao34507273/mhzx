...
/*     */ 
/*     */ public class SMapGoldStatueCfgOriginal implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SMapGoldStatueCfgOriginal> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SMapGoldStatueCfgOriginal> all = null;
/*     */   
/*     */   public int id;
...
/*  25 */     this.occupation = Integer.valueOf(rootElement.attributeValue("occupation")).intValue();
/*  26 */     this.gender = Integer.valueOf(rootElement.attributeValue("gender")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  31 */     _os_.marshal(this.id);
/*  32 */     _os_.marshal(this.occupation);
...
/*  40 */     this.occupation = _os_.unmarshal_int();
...
/*     */   {
/*  47 */     String path = dir + "mzm.gsp.map.confbean.SMapGoldStatueCfgOriginal.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  60 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.map.confbean.SMapGoldStatueCfgOriginal"))
/*     */         {
/*     */ 
/*  63 */           SMapGoldStatueCfgOriginal obj = new SMapGoldStatueCfgOriginal();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SMapGoldStatueCfgOriginal> all)
/*     */   {
/*  77 */     String path = dir + "mzm.gsp.map.confbean.SMapGoldStatueCfgOriginal.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  89 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.map.confbean.SMapGoldStatueCfgOriginal"))
/*     */         {
/*     */ 
/*  92 */           SMapGoldStatueCfgOriginal obj = new SMapGoldStatueCfgOriginal();
...
/*     */     
/* 108 */     String path = dir + "mzm.gsp.map.confbean.SMapGoldStatueCfgOriginal.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 135 */           SMapGoldStatueCfgOriginal _v_ = new SMapGoldStatueCfgOriginal();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SMapGoldStatueCfgOriginal> all)
/*     */   {
/* 155 */     String path = dir + "mzm.gsp.map.confbean.SMapGoldStatueCfgOriginal.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 182 */           SMapGoldStatueCfgOriginal _v_ = new SMapGoldStatueCfgOriginal();
...
/*     */ 
/*     */ 
/*     */   public static SMapGoldStatueCfgOriginal getOld(int key)
/*     */   {
/* 203 */     return (SMapGoldStatueCfgOriginal)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SMapGoldStatueCfgOriginal get(int key)
/*     */   {
/* 208 */     return (SMapGoldStatueCfgOriginal)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMapGoldStatueCfgOriginal> getOldAll()
/*     */   {
/* 213 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMapGoldStatueCfgOriginal> getAll()
/*     */   {
/* 218 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SMapGoldStatueCfgOriginal> newAll)
/*     */   {
/* 223 */     oldAll = all;
/* 224 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\map\confbean\SMapGoldStatueCfgOriginal.class
