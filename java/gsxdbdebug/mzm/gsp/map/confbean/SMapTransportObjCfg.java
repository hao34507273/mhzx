...
/*     */ 
/*     */ public class SMapTransportObjCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SMapTransportObjCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SMapTransportObjCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public int mapId;
...
/*  27 */     this.transportId = Integer.valueOf(rootElement.attributeValue("transportId")).intValue();
/*  28 */     this.controllerId = Integer.valueOf(rootElement.attributeValue("controllerId")).intValue();
/*     */   }
/*     */   
...
/*  35 */     _os_.marshal(this.transportId);
/*  36 */     _os_.marshal(this.controllerId);
/*  37 */     return _os_;
/*     */   }
/*     */   
...
/*  44 */     this.transportId = _os_.unmarshal_int();
/*  45 */     this.controllerId = _os_.unmarshal_int();
/*  46 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  51 */     String path = dir + "mzm.gsp.map.confbean.SMapTransportObjCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  64 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.map.confbean.SMapTransportObjCfg"))
/*     */         {
/*     */ 
/*  67 */           SMapTransportObjCfg obj = new SMapTransportObjCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SMapTransportObjCfg> all)
/*     */   {
/*  81 */     String path = dir + "mzm.gsp.map.confbean.SMapTransportObjCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.map.confbean.SMapTransportObjCfg"))
/*     */         {
/*     */ 
/*  96 */           SMapTransportObjCfg obj = new SMapTransportObjCfg();
...
/*     */     
/* 112 */     String path = dir + "mzm.gsp.map.confbean.SMapTransportObjCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 139 */           SMapTransportObjCfg _v_ = new SMapTransportObjCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SMapTransportObjCfg> all)
/*     */   {
/* 159 */     String path = dir + "mzm.gsp.map.confbean.SMapTransportObjCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 186 */           SMapTransportObjCfg _v_ = new SMapTransportObjCfg();
...
/*     */ 
/*     */ 
/*     */   public static SMapTransportObjCfg getOld(int key)
/*     */   {
/* 207 */     return (SMapTransportObjCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SMapTransportObjCfg get(int key)
/*     */   {
/* 212 */     return (SMapTransportObjCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMapTransportObjCfg> getOldAll()
/*     */   {
/* 217 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMapTransportObjCfg> getAll()
/*     */   {
/* 222 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SMapTransportObjCfg> newAll)
/*     */   {
/* 227 */     oldAll = all;
/* 228 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\map\confbean\SMapTransportObjCfg.class
