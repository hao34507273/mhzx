...
/*     */ 
/*     */ 
/*     */ public class SMapMonsterStartMove
/*     */   extends __SMapMonsterStartMove__
/*     */ {
/*     */   public static final int PROTOCOL_TYPE = 12590867;
...
/*     */ 
/*     */ 
/*     */   public SMapMonsterStartMove()
/*     */   {
/*  36 */     this.targetloc = new Location();
/*  37 */     this.currentloc = new Location();
/*     */   }
/*     */   
/*     */   public SMapMonsterStartMove(int _instanceid_, Location _targetloc_, Location _currentloc_, int _velocity_) {
...
/*  62 */     this.instanceid = _os_.unmarshal_int();
...
/*  74 */     if ((_o1_ instanceof SMapMonsterStartMove)) {
/*  75 */       SMapMonsterStartMove _o_ = (SMapMonsterStartMove)_o1_;
/*  76 */       if (this.instanceid != _o_.instanceid) return false;
...
/*  96 */     _sb_.append("(");
/*  97 */     _sb_.append(this.instanceid).append(",");
...
/*     */   }
/*     */   
/*     */   public int compareTo(SMapMonsterStartMove _o_) {
/* 106 */     if (_o_ == this) return 0;
/* 107 */     int _c_ = 0;
/* 108 */     _c_ = this.instanceid - _o_.instanceid;
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\map\SMapMonsterStartMove.class
