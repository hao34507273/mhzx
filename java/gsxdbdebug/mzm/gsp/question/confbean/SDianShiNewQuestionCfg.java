...
/*     */ 
/*     */ public class SDianShiNewQuestionCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SDianShiNewQuestionCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SDianShiNewQuestionCfg> all = null;
/*     */   
...
/*     */   {
/*  23 */     this.timestamp = Integer.valueOf(rootElement.attributeValue("timestamp")).intValue();
/*     */     
...
/*     */   {
/*  57 */     _os_.marshal(this.timestamp);
...
/*     */   {
/*  68 */     this.timestamp = _os_.unmarshal_int();
...
/*     */   {
/*  80 */     String path = dir + "mzm.gsp.question.confbean.SDianShiNewQuestionCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.question.confbean.SDianShiNewQuestionCfg"))
/*     */         {
/*     */ 
/*  96 */           SDianShiNewQuestionCfg obj = new SDianShiNewQuestionCfg();
/*  97 */           obj.loadFromXml(elem);
/*  98 */           if (all.put(Integer.valueOf(obj.timestamp), obj) != null) {
/*  99 */             throw new RuntimeException("duplicate key : " + obj.timestamp);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SDianShiNewQuestionCfg> all)
/*     */   {
/* 110 */     String path = dir + "mzm.gsp.question.confbean.SDianShiNewQuestionCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 122 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.question.confbean.SDianShiNewQuestionCfg"))
/*     */         {
/*     */ 
/* 125 */           SDianShiNewQuestionCfg obj = new SDianShiNewQuestionCfg();
/* 126 */           obj.loadFromXml(elem);
/* 127 */           if (all.put(Integer.valueOf(obj.timestamp), obj) != null) {
/* 128 */             throw new RuntimeException("duplicate key : " + obj.timestamp);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 141 */     String path = dir + "mzm.gsp.question.confbean.SDianShiNewQuestionCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 168 */           SDianShiNewQuestionCfg _v_ = new SDianShiNewQuestionCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SDianShiNewQuestionCfg> all)
/*     */   {
/* 188 */     String path = dir + "mzm.gsp.question.confbean.SDianShiNewQuestionCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 215 */           SDianShiNewQuestionCfg _v_ = new SDianShiNewQuestionCfg();
...
/*     */ 
/*     */ 
/*     */   public static SDianShiNewQuestionCfg getOld(int key)
/*     */   {
/* 236 */     return (SDianShiNewQuestionCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SDianShiNewQuestionCfg get(int key)
/*     */   {
/* 241 */     return (SDianShiNewQuestionCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SDianShiNewQuestionCfg> getOldAll()
/*     */   {
/* 246 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SDianShiNewQuestionCfg> getAll()
/*     */   {
/* 251 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SDianShiNewQuestionCfg> newAll)
/*     */   {
/* 256 */     oldAll = all;
/* 257 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\question\confbean\SDianShiNewQuestionCfg.class
