...
/*     */ 
/*     */ public class SWordQuestionLevelCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SWordQuestionLevelCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SWordQuestionLevelCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public int everyQuestionIntervalSec;
/*     */   public int oneRoleRightProp;
/*     */   public int allRoleRightProp;
/*     */   public int everyoneQuestionNum;
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  26 */     this.id = Integer.valueOf(rootElement.attributeValue("id")).intValue();
/*  27 */     this.everyQuestionIntervalSec = Integer.valueOf(rootElement.attributeValue("everyQuestionIntervalSec")).intValue();
/*  28 */     this.oneRoleRightProp = Integer.valueOf(rootElement.attributeValue("oneRoleRightProp")).intValue();
/*  29 */     this.allRoleRightProp = Integer.valueOf(rootElement.attributeValue("allRoleRightProp")).intValue();
/*  30 */     this.everyoneQuestionNum = Integer.valueOf(rootElement.attributeValue("everyoneQuestionNum")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  35 */     _os_.marshal(this.id);
/*  36 */     _os_.marshal(this.everyQuestionIntervalSec);
/*  37 */     _os_.marshal(this.oneRoleRightProp);
/*  38 */     _os_.marshal(this.allRoleRightProp);
/*  39 */     _os_.marshal(this.everyoneQuestionNum);
/*  40 */     return _os_;
/*     */   }
/*     */   
...
/*  46 */     this.everyQuestionIntervalSec = _os_.unmarshal_int();
/*  47 */     this.oneRoleRightProp = _os_.unmarshal_int();
/*  48 */     this.allRoleRightProp = _os_.unmarshal_int();
/*  49 */     this.everyoneQuestionNum = _os_.unmarshal_int();
/*  50 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  55 */     String path = dir + "mzm.gsp.question.confbean.SWordQuestionLevelCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  68 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.question.confbean.SWordQuestionLevelCfg"))
/*     */         {
/*     */ 
/*  71 */           SWordQuestionLevelCfg obj = new SWordQuestionLevelCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SWordQuestionLevelCfg> all)
/*     */   {
/*  85 */     String path = dir + "mzm.gsp.question.confbean.SWordQuestionLevelCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  97 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.question.confbean.SWordQuestionLevelCfg"))
/*     */         {
/*     */ 
/* 100 */           SWordQuestionLevelCfg obj = new SWordQuestionLevelCfg();
...
/*     */     
/* 116 */     String path = dir + "mzm.gsp.question.confbean.SWordQuestionLevelCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 143 */           SWordQuestionLevelCfg _v_ = new SWordQuestionLevelCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SWordQuestionLevelCfg> all)
/*     */   {
/* 163 */     String path = dir + "mzm.gsp.question.confbean.SWordQuestionLevelCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 190 */           SWordQuestionLevelCfg _v_ = new SWordQuestionLevelCfg();
...
/*     */ 
/*     */ 
/*     */   public static SWordQuestionLevelCfg getOld(int key)
/*     */   {
/* 211 */     return (SWordQuestionLevelCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SWordQuestionLevelCfg get(int key)
/*     */   {
/* 216 */     return (SWordQuestionLevelCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SWordQuestionLevelCfg> getOldAll()
/*     */   {
/* 221 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SWordQuestionLevelCfg> getAll()
/*     */   {
/* 226 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SWordQuestionLevelCfg> newAll)
/*     */   {
/* 231 */     oldAll = all;
/* 232 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\question\confbean\SWordQuestionLevelCfg.class
