...
/*     */ 
/*     */ public class SQuestionLv2QuestionItemId implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SQuestionLv2QuestionItemId> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SQuestionLv2QuestionItemId> all = null;
/*     */   
/*     */   public int questionLv;
/*  19 */   public java.util.ArrayList<Integer> questionIds = new java.util.ArrayList();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.questionLv = Integer.valueOf(rootElement.attributeValue("questionLv")).intValue();
/*     */     
/*  25 */     Element collectionElement = util.XmlHelper.getVariableElement(rootElement, "questionIds");
...
/*     */         }
/*     */         
/*  50 */         this.questionIds.add(Integer.valueOf(_v_));
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*     */   {
/*  57 */     _os_.marshal(this.questionLv);
/*  58 */     _os_.compact_uint32(this.questionIds.size());
/*  59 */     for (Integer _v_ : this.questionIds)
/*     */     {
...
/*     */   {
/*  80 */     String path = dir + "mzm.gsp.question.confbean.SQuestionLv2QuestionItemId.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.question.confbean.SQuestionLv2QuestionItemId"))
/*     */         {
/*     */ 
/*  96 */           SQuestionLv2QuestionItemId obj = new SQuestionLv2QuestionItemId();
/*  97 */           obj.loadFromXml(elem);
/*  98 */           if (all.put(Integer.valueOf(obj.questionLv), obj) != null) {
/*  99 */             throw new RuntimeException("duplicate key : " + obj.questionLv);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SQuestionLv2QuestionItemId> all)
/*     */   {
/* 110 */     String path = dir + "mzm.gsp.question.confbean.SQuestionLv2QuestionItemId.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 122 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.question.confbean.SQuestionLv2QuestionItemId"))
/*     */         {
/*     */ 
/* 125 */           SQuestionLv2QuestionItemId obj = new SQuestionLv2QuestionItemId();
/* 126 */           obj.loadFromXml(elem);
/* 127 */           if (all.put(Integer.valueOf(obj.questionLv), obj) != null) {
/* 128 */             throw new RuntimeException("duplicate key : " + obj.questionLv);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 141 */     String path = dir + "mzm.gsp.question.confbean.SQuestionLv2QuestionItemId.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 168 */           SQuestionLv2QuestionItemId _v_ = new SQuestionLv2QuestionItemId();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SQuestionLv2QuestionItemId> all)
/*     */   {
/* 188 */     String path = dir + "mzm.gsp.question.confbean.SQuestionLv2QuestionItemId.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 215 */           SQuestionLv2QuestionItemId _v_ = new SQuestionLv2QuestionItemId();
...
/*     */ 
/*     */ 
/*     */   public static SQuestionLv2QuestionItemId getOld(int key)
/*     */   {
/* 236 */     return (SQuestionLv2QuestionItemId)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SQuestionLv2QuestionItemId get(int key)
/*     */   {
/* 241 */     return (SQuestionLv2QuestionItemId)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SQuestionLv2QuestionItemId> getOldAll()
/*     */   {
/* 246 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SQuestionLv2QuestionItemId> getAll()
/*     */   {
/* 251 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SQuestionLv2QuestionItemId> newAll)
/*     */   {
/* 256 */     oldAll = all;
/* 257 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\question\confbean\SQuestionLv2QuestionItemId.class
