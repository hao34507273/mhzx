...
/*     */ 
/*     */ public class SPictureQuestionItemCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SPictureQuestionItemCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SPictureQuestionItemCfg> all = null;
/*     */   
...
/*     */   {
/*  29 */     _os_.marshal(this.questionType);
...
/*     */   {
/*  36 */     this.questionType = _os_.unmarshal_int();
...
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.question.confbean.SPictureQuestionItemCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.question.confbean.SPictureQuestionItemCfg"))
/*     */         {
/*     */ 
/*  59 */           SPictureQuestionItemCfg obj = new SPictureQuestionItemCfg();
/*  60 */           obj.loadFromXml(elem);
/*  61 */           if (all.put(Integer.valueOf(obj.questionType), obj) != null) {
/*  62 */             throw new RuntimeException("duplicate key : " + obj.questionType);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SPictureQuestionItemCfg> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.question.confbean.SPictureQuestionItemCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.question.confbean.SPictureQuestionItemCfg"))
/*     */         {
/*     */ 
/*  88 */           SPictureQuestionItemCfg obj = new SPictureQuestionItemCfg();
/*  89 */           obj.loadFromXml(elem);
/*  90 */           if (all.put(Integer.valueOf(obj.questionType), obj) != null) {
/*  91 */             throw new RuntimeException("duplicate key : " + obj.questionType);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.question.confbean.SPictureQuestionItemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           SPictureQuestionItemCfg _v_ = new SPictureQuestionItemCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SPictureQuestionItemCfg> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.question.confbean.SPictureQuestionItemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           SPictureQuestionItemCfg _v_ = new SPictureQuestionItemCfg();
...
/*     */ 
/*     */ 
/*     */   public static SPictureQuestionItemCfg getOld(int key)
/*     */   {
/* 199 */     return (SPictureQuestionItemCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SPictureQuestionItemCfg get(int key)
/*     */   {
/* 204 */     return (SPictureQuestionItemCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPictureQuestionItemCfg> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPictureQuestionItemCfg> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SPictureQuestionItemCfg> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\question\confbean\SPictureQuestionItemCfg.class
