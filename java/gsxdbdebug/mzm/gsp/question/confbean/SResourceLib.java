...
/*     */ 
/*     */ public class SResourceLib implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SResourceLib> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SResourceLib> all = null;
/*     */   
/*     */   public int id;
/*     */   public int type;
/*     */   
...
/*  37 */     this.type = _os_.unmarshal_int();
/*  38 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.question.confbean.SResourceLib.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.question.confbean.SResourceLib"))
/*     */         {
/*     */ 
/*  59 */           SResourceLib obj = new SResourceLib();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SResourceLib> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.question.confbean.SResourceLib.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.question.confbean.SResourceLib"))
/*     */         {
/*     */ 
/*  88 */           SResourceLib obj = new SResourceLib();
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.question.confbean.SResourceLib.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           SResourceLib _v_ = new SResourceLib();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SResourceLib> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.question.confbean.SResourceLib.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           SResourceLib _v_ = new SResourceLib();
...
/*     */ 
/*     */ 
/*     */   public static SResourceLib getOld(int key)
/*     */   {
/* 199 */     return (SResourceLib)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SResourceLib get(int key)
/*     */   {
/* 204 */     return (SResourceLib)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SResourceLib> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SResourceLib> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SResourceLib> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\question\confbean\SResourceLib.class
