...
/*     */ 
/*     */ public class STypeId2PicQuesItemResId implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, STypeId2PicQuesItemResId> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, STypeId2PicQuesItemResId> all = null;
/*     */   
/*     */   public int typeId;
/*  19 */   public java.util.ArrayList<Integer> picQuesItemResIds = new java.util.ArrayList();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.typeId = Integer.valueOf(rootElement.attributeValue("typeId")).intValue();
/*     */     
/*  25 */     Element collectionElement = util.XmlHelper.getVariableElement(rootElement, "picQuesItemResIds");
...
/*     */         }
/*     */         
/*  50 */         this.picQuesItemResIds.add(Integer.valueOf(_v_));
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*  58 */     _os_.compact_uint32(this.picQuesItemResIds.size());
/*  59 */     for (Integer _v_ : this.picQuesItemResIds)
/*     */     {
...
/*  73 */       this.picQuesItemResIds.add(Integer.valueOf(_v_));
/*     */     }
/*  75 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/*  80 */     String path = dir + "mzm.gsp.question.confbean.STypeId2PicQuesItemResId.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.question.confbean.STypeId2PicQuesItemResId"))
/*     */         {
/*     */ 
/*  96 */           STypeId2PicQuesItemResId obj = new STypeId2PicQuesItemResId();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, STypeId2PicQuesItemResId> all)
/*     */   {
/* 110 */     String path = dir + "mzm.gsp.question.confbean.STypeId2PicQuesItemResId.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 122 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.question.confbean.STypeId2PicQuesItemResId"))
/*     */         {
/*     */ 
/* 125 */           STypeId2PicQuesItemResId obj = new STypeId2PicQuesItemResId();
...
/*     */     
/* 141 */     String path = dir + "mzm.gsp.question.confbean.STypeId2PicQuesItemResId.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 168 */           STypeId2PicQuesItemResId _v_ = new STypeId2PicQuesItemResId();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, STypeId2PicQuesItemResId> all)
/*     */   {
/* 188 */     String path = dir + "mzm.gsp.question.confbean.STypeId2PicQuesItemResId.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 215 */           STypeId2PicQuesItemResId _v_ = new STypeId2PicQuesItemResId();
...
/*     */ 
/*     */ 
/*     */   public static STypeId2PicQuesItemResId getOld(int key)
/*     */   {
/* 236 */     return (STypeId2PicQuesItemResId)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static STypeId2PicQuesItemResId get(int key)
/*     */   {
/* 241 */     return (STypeId2PicQuesItemResId)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, STypeId2PicQuesItemResId> getOldAll()
/*     */   {
/* 246 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, STypeId2PicQuesItemResId> getAll()
/*     */   {
/* 251 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, STypeId2PicQuesItemResId> newAll)
/*     */   {
/* 256 */     oldAll = all;
/* 257 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\question\confbean\STypeId2PicQuesItemResId.class
