...
/*     */ 
/*     */ public class SKeJuQuestionItemCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SKeJuQuestionItemCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SKeJuQuestionItemCfg> all = null;
/*     */   
/*     */   public int id;
...
/*  26 */     this.answer_num = Integer.valueOf(rootElement.attributeValue("answer_num")).intValue();
/*     */   }
/*     */   
...
/*  33 */     _os_.marshal(this.answer_num);
/*  34 */     return _os_;
/*     */   }
/*     */   
...
/*  41 */     this.answer_num = _os_.unmarshal_int();
/*  42 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  47 */     String path = dir + "mzm.gsp.question.confbean.SKeJuQuestionItemCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  60 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.question.confbean.SKeJuQuestionItemCfg"))
/*     */         {
/*     */ 
/*  63 */           SKeJuQuestionItemCfg obj = new SKeJuQuestionItemCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SKeJuQuestionItemCfg> all)
/*     */   {
/*  77 */     String path = dir + "mzm.gsp.question.confbean.SKeJuQuestionItemCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  89 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.question.confbean.SKeJuQuestionItemCfg"))
/*     */         {
/*     */ 
/*  92 */           SKeJuQuestionItemCfg obj = new SKeJuQuestionItemCfg();
...
/*     */     
/* 108 */     String path = dir + "mzm.gsp.question.confbean.SKeJuQuestionItemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 135 */           SKeJuQuestionItemCfg _v_ = new SKeJuQuestionItemCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SKeJuQuestionItemCfg> all)
/*     */   {
/* 155 */     String path = dir + "mzm.gsp.question.confbean.SKeJuQuestionItemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 182 */           SKeJuQuestionItemCfg _v_ = new SKeJuQuestionItemCfg();
...
/*     */ 
/*     */ 
/*     */   public static SKeJuQuestionItemCfg getOld(int key)
/*     */   {
/* 203 */     return (SKeJuQuestionItemCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SKeJuQuestionItemCfg get(int key)
/*     */   {
/* 208 */     return (SKeJuQuestionItemCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SKeJuQuestionItemCfg> getOldAll()
/*     */   {
/* 213 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SKeJuQuestionItemCfg> getAll()
/*     */   {
/* 218 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SKeJuQuestionItemCfg> newAll)
/*     */   {
/* 223 */     oldAll = all;
/* 224 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\question\confbean\SKeJuQuestionItemCfg.class
