...
/*     */ 
/*     */ public class SQYXTQuestionCheckCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SQYXTQuestionCheckCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SQYXTQuestionCheckCfg> all = null;
/*     */   
/*     */   public int id;
...
/*  27 */     this.answerNum = Integer.valueOf(rootElement.attributeValue("answerNum")).intValue();
/*     */     
/*  29 */     Element collectionElement = util.XmlHelper.getVariableElement(rootElement, "answerList");
...
/*  40 */       if (elem.getName().equalsIgnoreCase("string"))
/*     */       {
/*     */         String _v_;
/*     */         
/*     */ 
...
/*  62 */     _os_.marshal(this.questionLv);
/*  63 */     _os_.marshal(this.answerNum);
/*  64 */     _os_.compact_uint32(this.answerList.size());
/*  65 */     for (String _v_ : this.answerList)
/*     */     {
/*  67 */       _os_.marshal(_v_, "UTF-8");
/*     */     }
/*  69 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/*  88 */     String path = dir + "mzm.gsp.question.confbean.SQYXTQuestionCheckCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 101 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.question.confbean.SQYXTQuestionCheckCfg"))
/*     */         {
/*     */ 
/* 104 */           SQYXTQuestionCheckCfg obj = new SQYXTQuestionCheckCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SQYXTQuestionCheckCfg> all)
/*     */   {
/* 118 */     String path = dir + "mzm.gsp.question.confbean.SQYXTQuestionCheckCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 130 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.question.confbean.SQYXTQuestionCheckCfg"))
/*     */         {
/*     */ 
/* 133 */           SQYXTQuestionCheckCfg obj = new SQYXTQuestionCheckCfg();
...
/*     */     
/* 149 */     String path = dir + "mzm.gsp.question.confbean.SQYXTQuestionCheckCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 176 */           SQYXTQuestionCheckCfg _v_ = new SQYXTQuestionCheckCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SQYXTQuestionCheckCfg> all)
/*     */   {
/* 196 */     String path = dir + "mzm.gsp.question.confbean.SQYXTQuestionCheckCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 223 */           SQYXTQuestionCheckCfg _v_ = new SQYXTQuestionCheckCfg();
...
/*     */ 
/*     */ 
/*     */   public static SQYXTQuestionCheckCfg getOld(int key)
/*     */   {
/* 244 */     return (SQYXTQuestionCheckCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SQYXTQuestionCheckCfg get(int key)
/*     */   {
/* 249 */     return (SQYXTQuestionCheckCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SQYXTQuestionCheckCfg> getOldAll()
/*     */   {
/* 254 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SQYXTQuestionCheckCfg> getAll()
/*     */   {
/* 259 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SQYXTQuestionCheckCfg> newAll)
/*     */   {
/* 264 */     oldAll = all;
/* 265 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\question\confbean\SQYXTQuestionCheckCfg.class
