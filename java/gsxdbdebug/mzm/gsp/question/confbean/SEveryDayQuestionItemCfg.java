...
/*     */ 
/*     */ public class SEveryDayQuestionItemCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SEveryDayQuestionItemCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SEveryDayQuestionItemCfg> all = null;
/*     */   
/*     */   public int id;
...
/*  25 */     this.questionDesc = rootElement.attributeValue("questionDesc");
/*     */     
...
/*  60 */     _os_.marshal(this.questionDesc, "UTF-8");
...
/*  72 */     this.questionDesc = _os_.unmarshal_String("UTF-8");
...
/*     */   {
/*  84 */     String path = dir + "mzm.gsp.question.confbean.SEveryDayQuestionItemCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  97 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.question.confbean.SEveryDayQuestionItemCfg"))
/*     */         {
/*     */ 
/* 100 */           SEveryDayQuestionItemCfg obj = new SEveryDayQuestionItemCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SEveryDayQuestionItemCfg> all)
/*     */   {
/* 114 */     String path = dir + "mzm.gsp.question.confbean.SEveryDayQuestionItemCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 126 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.question.confbean.SEveryDayQuestionItemCfg"))
/*     */         {
/*     */ 
/* 129 */           SEveryDayQuestionItemCfg obj = new SEveryDayQuestionItemCfg();
...
/*     */     
/* 145 */     String path = dir + "mzm.gsp.question.confbean.SEveryDayQuestionItemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 172 */           SEveryDayQuestionItemCfg _v_ = new SEveryDayQuestionItemCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SEveryDayQuestionItemCfg> all)
/*     */   {
/* 192 */     String path = dir + "mzm.gsp.question.confbean.SEveryDayQuestionItemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 219 */           SEveryDayQuestionItemCfg _v_ = new SEveryDayQuestionItemCfg();
...
/*     */ 
/*     */ 
/*     */   public static SEveryDayQuestionItemCfg getOld(int key)
/*     */   {
/* 240 */     return (SEveryDayQuestionItemCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SEveryDayQuestionItemCfg get(int key)
/*     */   {
/* 245 */     return (SEveryDayQuestionItemCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SEveryDayQuestionItemCfg> getOldAll()
/*     */   {
/* 250 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SEveryDayQuestionItemCfg> getAll()
/*     */   {
/* 255 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SEveryDayQuestionItemCfg> newAll)
/*     */   {
/* 260 */     oldAll = all;
/* 261 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\question\confbean\SEveryDayQuestionItemCfg.class
