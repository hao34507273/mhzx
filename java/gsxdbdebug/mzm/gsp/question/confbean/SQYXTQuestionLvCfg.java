...
/*     */ 
/*     */ public class SQYXTQuestionLvCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SQYXTQuestionLvCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SQYXTQuestionLvCfg> all = null;
/*     */   
/*     */   public int id;
/*  19 */   public java.util.ArrayList<Integer> questionCfgIdList = new java.util.ArrayList();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.id = Integer.valueOf(rootElement.attributeValue("id")).intValue();
/*     */     
/*  25 */     Element collectionElement = util.XmlHelper.getVariableElement(rootElement, "questionCfgIdList");
...
/*     */         }
/*     */         
/*  50 */         this.questionCfgIdList.add(Integer.valueOf(_v_));
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*  58 */     _os_.compact_uint32(this.questionCfgIdList.size());
/*  59 */     for (Integer _v_ : this.questionCfgIdList)
/*     */     {
...
/*  73 */       this.questionCfgIdList.add(Integer.valueOf(_v_));
/*     */     }
/*  75 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/*  80 */     String path = dir + "mzm.gsp.question.confbean.SQYXTQuestionLvCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.question.confbean.SQYXTQuestionLvCfg"))
/*     */         {
/*     */ 
/*  96 */           SQYXTQuestionLvCfg obj = new SQYXTQuestionLvCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SQYXTQuestionLvCfg> all)
/*     */   {
/* 110 */     String path = dir + "mzm.gsp.question.confbean.SQYXTQuestionLvCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 122 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.question.confbean.SQYXTQuestionLvCfg"))
/*     */         {
/*     */ 
/* 125 */           SQYXTQuestionLvCfg obj = new SQYXTQuestionLvCfg();
...
/*     */     
/* 141 */     String path = dir + "mzm.gsp.question.confbean.SQYXTQuestionLvCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 168 */           SQYXTQuestionLvCfg _v_ = new SQYXTQuestionLvCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SQYXTQuestionLvCfg> all)
/*     */   {
/* 188 */     String path = dir + "mzm.gsp.question.confbean.SQYXTQuestionLvCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 215 */           SQYXTQuestionLvCfg _v_ = new SQYXTQuestionLvCfg();
...
/*     */ 
/*     */ 
/*     */   public static SQYXTQuestionLvCfg getOld(int key)
/*     */   {
/* 236 */     return (SQYXTQuestionLvCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SQYXTQuestionLvCfg get(int key)
/*     */   {
/* 241 */     return (SQYXTQuestionLvCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SQYXTQuestionLvCfg> getOldAll()
/*     */   {
/* 246 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SQYXTQuestionLvCfg> getAll()
/*     */   {
/* 251 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SQYXTQuestionLvCfg> newAll)
/*     */   {
/* 256 */     oldAll = all;
/* 257 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\question\confbean\SQYXTQuestionLvCfg.class
