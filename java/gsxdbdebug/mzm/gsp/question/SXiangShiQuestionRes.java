...
/*     */ 
/*     */ 
/*     */ public class SXiangShiQuestionRes
/*     */   extends __SXiangShiQuestionRes__
/*     */ {
/*     */   public static final int PROTOCOL_TYPE = 12594724;
...
/*     */ 
/*     */ 
/*     */   public SXiangShiQuestionRes()
/*     */   {
/*  37 */     this.answer_sequence = new ArrayList();
/*     */   }
/*     */   
/*     */   public SXiangShiQuestionRes(int _questionid_, int _alreadyanswer_, int _rightanswer_, long _sessionid_, ArrayList<Integer> _answer_sequence_) {
...
/*  65 */     this.questionid = _os_.unmarshal_int();
...
/*  82 */     if ((_o1_ instanceof SXiangShiQuestionRes)) {
/*  83 */       SXiangShiQuestionRes _o_ = (SXiangShiQuestionRes)_o1_;
/*  84 */       if (this.questionid != _o_.questionid) return false;
...
/* 106 */     _sb_.append("(");
/* 107 */     _sb_.append(this.questionid).append(",");
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\question\SXiangShiQuestionRes.class
