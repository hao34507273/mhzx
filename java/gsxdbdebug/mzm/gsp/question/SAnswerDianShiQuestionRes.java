...
/*     */ 
/*     */ 
/*     */ public class SAnswerDianShiQuestionRes
/*     */   extends __SAnswerDianShiQuestionRes__
/*     */ {
/*     */   public static final int PROTOCOL_TYPE = 12594717;
...
/*     */ 
/*     */ 
/*     */   public SAnswerDianShiQuestionRes()
/*     */   {
/*  38 */     this.answer_sequence = new ArrayList();
/*     */   }
/*     */   
/*     */   public SAnswerDianShiQuestionRes(int _newquestionid_, int _alreadyanswer_, int _rightanswer_, int _totaladdtime_, long _sessionid_, ArrayList<Integer> _answer_sequence_) {
/*  42 */     this.newquestionid = _newquestionid_;
...
/*  55 */     _os_.marshal(this.newquestionid);
...
/*  68 */     this.newquestionid = _os_.unmarshal_int();
...
/*  86 */     if ((_o1_ instanceof SAnswerDianShiQuestionRes)) {
/*  87 */       SAnswerDianShiQuestionRes _o_ = (SAnswerDianShiQuestionRes)_o1_;
/*  88 */       if (this.newquestionid != _o_.newquestionid) return false;
...
/* 112 */     _sb_.append("(");
/* 113 */     _sb_.append(this.newquestionid).append(",");
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\question\SAnswerDianShiQuestionRes.class
