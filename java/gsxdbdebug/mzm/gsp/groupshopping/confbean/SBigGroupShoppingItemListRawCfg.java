...
/*     */ 
/*     */ public class SBigGroupShoppingItemListRawCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SBigGroupShoppingItemListRawCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SBigGroupShoppingItemListRawCfg> all = null;
/*     */   
/*     */   public int id;
...
/*     */   {
/*  51 */     String path = dir + "mzm.gsp.groupshopping.confbean.SBigGroupShoppingItemListRawCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  64 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.groupshopping.confbean.SBigGroupShoppingItemListRawCfg"))
/*     */         {
/*     */ 
/*  67 */           SBigGroupShoppingItemListRawCfg obj = new SBigGroupShoppingItemListRawCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SBigGroupShoppingItemListRawCfg> all)
/*     */   {
/*  81 */     String path = dir + "mzm.gsp.groupshopping.confbean.SBigGroupShoppingItemListRawCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.groupshopping.confbean.SBigGroupShoppingItemListRawCfg"))
/*     */         {
/*     */ 
/*  96 */           SBigGroupShoppingItemListRawCfg obj = new SBigGroupShoppingItemListRawCfg();
...
/*     */     
/* 112 */     String path = dir + "mzm.gsp.groupshopping.confbean.SBigGroupShoppingItemListRawCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 139 */           SBigGroupShoppingItemListRawCfg _v_ = new SBigGroupShoppingItemListRawCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SBigGroupShoppingItemListRawCfg> all)
/*     */   {
/* 159 */     String path = dir + "mzm.gsp.groupshopping.confbean.SBigGroupShoppingItemListRawCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 186 */           SBigGroupShoppingItemListRawCfg _v_ = new SBigGroupShoppingItemListRawCfg();
...
/*     */ 
/*     */ 
/*     */   public static SBigGroupShoppingItemListRawCfg getOld(int key)
/*     */   {
/* 207 */     return (SBigGroupShoppingItemListRawCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SBigGroupShoppingItemListRawCfg get(int key)
/*     */   {
/* 212 */     return (SBigGroupShoppingItemListRawCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SBigGroupShoppingItemListRawCfg> getOldAll()
/*     */   {
/* 217 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SBigGroupShoppingItemListRawCfg> getAll()
/*     */   {
/* 222 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SBigGroupShoppingItemListRawCfg> newAll)
/*     */   {
/* 227 */     oldAll = all;
/* 228 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\groupshopping\confbean\SBigGroupShoppingItemListRawCfg.class
