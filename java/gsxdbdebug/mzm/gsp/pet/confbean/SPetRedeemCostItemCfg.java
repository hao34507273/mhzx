...
/*     */ 
/*     */ public class SPetRedeemCostItemCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SPetRedeemCostItemCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SPetRedeemCostItemCfg> all = null;
/*     */   
/*     */   public int id;
...
/*  77 */     this.petId = _os_.unmarshal_int();
...
/*     */   {
/*  90 */     String path = dir + "mzm.gsp.pet.confbean.SPetRedeemCostItemCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 103 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.pet.confbean.SPetRedeemCostItemCfg"))
/*     */         {
/*     */ 
/* 106 */           SPetRedeemCostItemCfg obj = new SPetRedeemCostItemCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SPetRedeemCostItemCfg> all)
/*     */   {
/* 120 */     String path = dir + "mzm.gsp.pet.confbean.SPetRedeemCostItemCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 132 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.pet.confbean.SPetRedeemCostItemCfg"))
/*     */         {
/*     */ 
/* 135 */           SPetRedeemCostItemCfg obj = new SPetRedeemCostItemCfg();
...
/*     */     
/* 151 */     String path = dir + "mzm.gsp.pet.confbean.SPetRedeemCostItemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           SPetRedeemCostItemCfg _v_ = new SPetRedeemCostItemCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SPetRedeemCostItemCfg> all)
/*     */   {
/* 198 */     String path = dir + "mzm.gsp.pet.confbean.SPetRedeemCostItemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 225 */           SPetRedeemCostItemCfg _v_ = new SPetRedeemCostItemCfg();
...
/*     */ 
/*     */ 
/*     */   public static SPetRedeemCostItemCfg getOld(int key)
/*     */   {
/* 246 */     return (SPetRedeemCostItemCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SPetRedeemCostItemCfg get(int key)
/*     */   {
/* 251 */     return (SPetRedeemCostItemCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPetRedeemCostItemCfg> getOldAll()
/*     */   {
/* 256 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPetRedeemCostItemCfg> getAll()
/*     */   {
/* 261 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SPetRedeemCostItemCfg> newAll)
/*     */   {
/* 266 */     oldAll = all;
/* 267 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\pet\confbean\SPetRedeemCostItemCfg.class
