...
/*     */ 
/*     */ public class SPetTypeRefCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SPetTypeRefCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SPetTypeRefCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public String templateName;
/*     */   public int petType;
/*     */   public int typeRefQuality;
/*     */   
...
/*  28 */     this.typeRefQuality = Integer.valueOf(rootElement.attributeValue("typeRefQuality")).intValue();
/*     */   }
/*     */   
...
/*  35 */     _os_.marshal(this.petType);
/*  36 */     _os_.marshal(this.typeRefQuality);
/*  37 */     return _os_;
/*     */   }
/*     */   
...
/*  44 */     this.petType = _os_.unmarshal_int();
/*  45 */     this.typeRefQuality = _os_.unmarshal_int();
/*  46 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  51 */     String path = dir + "mzm.gsp.pet.confbean.SPetTypeRefCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  64 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.pet.confbean.SPetTypeRefCfg"))
/*     */         {
/*     */ 
/*  67 */           SPetTypeRefCfg obj = new SPetTypeRefCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SPetTypeRefCfg> all)
/*     */   {
/*  81 */     String path = dir + "mzm.gsp.pet.confbean.SPetTypeRefCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.pet.confbean.SPetTypeRefCfg"))
/*     */         {
/*     */ 
/*  96 */           SPetTypeRefCfg obj = new SPetTypeRefCfg();
...
/*     */     
/* 112 */     String path = dir + "mzm.gsp.pet.confbean.SPetTypeRefCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 139 */           SPetTypeRefCfg _v_ = new SPetTypeRefCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SPetTypeRefCfg> all)
/*     */   {
/* 159 */     String path = dir + "mzm.gsp.pet.confbean.SPetTypeRefCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 186 */           SPetTypeRefCfg _v_ = new SPetTypeRefCfg();
...
/*     */ 
/*     */ 
/*     */   public static SPetTypeRefCfg getOld(int key)
/*     */   {
/* 207 */     return (SPetTypeRefCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SPetTypeRefCfg get(int key)
/*     */   {
/* 212 */     return (SPetTypeRefCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPetTypeRefCfg> getOldAll()
/*     */   {
/* 217 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPetTypeRefCfg> getAll()
/*     */   {
/* 222 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SPetTypeRefCfg> newAll)
/*     */   {
/* 227 */     oldAll = all;
/* 228 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\pet\confbean\SPetTypeRefCfg.class
