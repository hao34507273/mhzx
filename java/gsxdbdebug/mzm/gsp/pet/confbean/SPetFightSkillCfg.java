...
/*     */ 
/*     */ public class SPetFightSkillCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SPetFightSkillCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SPetFightSkillCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public int skillId;
...
/*  25 */     this.skillId = Integer.valueOf(rootElement.attributeValue("skillId")).intValue();
/*  26 */     this.unlockScore = Integer.valueOf(rootElement.attributeValue("unlockScore")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  31 */     _os_.marshal(this.id);
/*  32 */     _os_.marshal(this.skillId);
/*  33 */     _os_.marshal(this.unlockScore);
/*  34 */     return _os_;
/*     */   }
/*     */   
...
/*  40 */     this.skillId = _os_.unmarshal_int();
/*  41 */     this.unlockScore = _os_.unmarshal_int();
/*  42 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  47 */     String path = dir + "mzm.gsp.pet.confbean.SPetFightSkillCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  60 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.pet.confbean.SPetFightSkillCfg"))
/*     */         {
/*     */ 
/*  63 */           SPetFightSkillCfg obj = new SPetFightSkillCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SPetFightSkillCfg> all)
/*     */   {
/*  77 */     String path = dir + "mzm.gsp.pet.confbean.SPetFightSkillCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  89 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.pet.confbean.SPetFightSkillCfg"))
/*     */         {
/*     */ 
/*  92 */           SPetFightSkillCfg obj = new SPetFightSkillCfg();
...
/*     */     
/* 108 */     String path = dir + "mzm.gsp.pet.confbean.SPetFightSkillCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 135 */           SPetFightSkillCfg _v_ = new SPetFightSkillCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SPetFightSkillCfg> all)
/*     */   {
/* 155 */     String path = dir + "mzm.gsp.pet.confbean.SPetFightSkillCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 182 */           SPetFightSkillCfg _v_ = new SPetFightSkillCfg();
...
/*     */ 
/*     */ 
/*     */   public static SPetFightSkillCfg getOld(int key)
/*     */   {
/* 203 */     return (SPetFightSkillCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SPetFightSkillCfg get(int key)
/*     */   {
/* 208 */     return (SPetFightSkillCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPetFightSkillCfg> getOldAll()
/*     */   {
/* 213 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPetFightSkillCfg> getAll()
/*     */   {
/* 218 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SPetFightSkillCfg> newAll)
/*     */   {
/* 223 */     oldAll = all;
/* 224 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\pet\confbean\SPetFightSkillCfg.class
