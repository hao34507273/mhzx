...
/*     */ 
/*     */ public class SPetFanSHengConf implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SPetFanSHengConf> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SPetFanSHengConf> all = null;
/*     */   
/*     */   public int templateId;
/*     */   public String templateName;
/*     */   public int putTongFanShengDanItemNum;
/*     */   public int gaoJiFanShengDanItemNum;
/*     */   public int baobaoProp;
/*     */   public int bianYiProp;
/*     */   
...
/*  29 */     this.putTongFanShengDanItemNum = Integer.valueOf(rootElement.attributeValue("putTongFanShengDanItemNum")).intValue();
/*  30 */     this.gaoJiFanShengDanItemNum = Integer.valueOf(rootElement.attributeValue("gaoJiFanShengDanItemNum")).intValue();
/*  31 */     this.baobaoProp = Integer.valueOf(rootElement.attributeValue("baobaoProp")).intValue();
/*  32 */     this.bianYiProp = Integer.valueOf(rootElement.attributeValue("bianYiProp")).intValue();
/*     */   }
/*     */   
...
/*  39 */     _os_.marshal(this.putTongFanShengDanItemNum);
/*  40 */     _os_.marshal(this.gaoJiFanShengDanItemNum);
/*  41 */     _os_.marshal(this.baobaoProp);
/*  42 */     _os_.marshal(this.bianYiProp);
/*  43 */     return _os_;
/*     */   }
/*     */   
...
/*  50 */     this.putTongFanShengDanItemNum = _os_.unmarshal_int();
/*  51 */     this.gaoJiFanShengDanItemNum = _os_.unmarshal_int();
/*  52 */     this.baobaoProp = _os_.unmarshal_int();
/*  53 */     this.bianYiProp = _os_.unmarshal_int();
/*  54 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  59 */     String path = dir + "mzm.gsp.pet.confbean.SPetFanSHengConf.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  72 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.pet.confbean.SPetFanSHengConf"))
/*     */         {
/*     */ 
/*  75 */           SPetFanSHengConf obj = new SPetFanSHengConf();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SPetFanSHengConf> all)
/*     */   {
/*  89 */     String path = dir + "mzm.gsp.pet.confbean.SPetFanSHengConf.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 101 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.pet.confbean.SPetFanSHengConf"))
/*     */         {
/*     */ 
/* 104 */           SPetFanSHengConf obj = new SPetFanSHengConf();
...
/*     */     
/* 120 */     String path = dir + "mzm.gsp.pet.confbean.SPetFanSHengConf.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 147 */           SPetFanSHengConf _v_ = new SPetFanSHengConf();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SPetFanSHengConf> all)
/*     */   {
/* 167 */     String path = dir + "mzm.gsp.pet.confbean.SPetFanSHengConf.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 194 */           SPetFanSHengConf _v_ = new SPetFanSHengConf();
...
/*     */ 
/*     */ 
/*     */   public static SPetFanSHengConf getOld(int key)
/*     */   {
/* 215 */     return (SPetFanSHengConf)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SPetFanSHengConf get(int key)
/*     */   {
/* 220 */     return (SPetFanSHengConf)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPetFanSHengConf> getOldAll()
/*     */   {
/* 225 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPetFanSHengConf> getAll()
/*     */   {
/* 230 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SPetFanSHengConf> newAll)
/*     */   {
/* 235 */     oldAll = all;
/* 236 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\pet\confbean\SPetFanSHengConf.class
