...
/*     */ 
/*     */ public class PetFightFormationImproveCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, PetFightFormationImproveCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, PetFightFormationImproveCfg> all = null;
/*     */   
/*     */   public int id;
/*  19 */   public java.util.ArrayList<PetFightFormationLevelInfo> levels = new java.util.ArrayList();
/*     */   
...
/*  36 */       if (elem.getName().equalsIgnoreCase("mzm.gsp.pet.confbean.PetFightFormationLevelInfo"))
/*     */       {
/*     */         PetFightFormationLevelInfo _v_;
/*     */         
/*     */ 
/*     */         try
/*     */         {
/*  43 */           _v_ = new PetFightFormationLevelInfo();
...
/*  60 */     for (PetFightFormationLevelInfo _v_ : this.levels)
/*     */     {
/*  62 */       _os_.marshal(_v_);
/*     */     }
/*  64 */     return _os_;
...
/*     */     {
/*     */ 
/*  73 */       PetFightFormationLevelInfo _v_ = new PetFightFormationLevelInfo();
...
/*     */   {
/*  82 */     String path = dir + "mzm.gsp.pet.confbean.PetFightFormationImproveCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  95 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.pet.confbean.PetFightFormationImproveCfg"))
/*     */         {
/*     */ 
/*  98 */           PetFightFormationImproveCfg obj = new PetFightFormationImproveCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, PetFightFormationImproveCfg> all)
/*     */   {
/* 112 */     String path = dir + "mzm.gsp.pet.confbean.PetFightFormationImproveCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 124 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.pet.confbean.PetFightFormationImproveCfg"))
/*     */         {
/*     */ 
/* 127 */           PetFightFormationImproveCfg obj = new PetFightFormationImproveCfg();
...
/*     */     
/* 143 */     String path = dir + "mzm.gsp.pet.confbean.PetFightFormationImproveCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 170 */           PetFightFormationImproveCfg _v_ = new PetFightFormationImproveCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, PetFightFormationImproveCfg> all)
/*     */   {
/* 190 */     String path = dir + "mzm.gsp.pet.confbean.PetFightFormationImproveCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 217 */           PetFightFormationImproveCfg _v_ = new PetFightFormationImproveCfg();
...
/*     */ 
/*     */ 
/*     */   public static PetFightFormationImproveCfg getOld(int key)
/*     */   {
/* 238 */     return (PetFightFormationImproveCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static PetFightFormationImproveCfg get(int key)
/*     */   {
/* 243 */     return (PetFightFormationImproveCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, PetFightFormationImproveCfg> getOldAll()
/*     */   {
/* 248 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, PetFightFormationImproveCfg> getAll()
/*     */   {
/* 253 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, PetFightFormationImproveCfg> newAll)
/*     */   {
/* 258 */     oldAll = all;
/* 259 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\pet\confbean\PetFightFormationImproveCfg.class
