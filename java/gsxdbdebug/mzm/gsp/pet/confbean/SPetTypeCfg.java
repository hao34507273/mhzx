...
/*     */ 
/*     */ public class SPetTypeCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SPetTypeCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SPetTypeCfg> all = null;
/*     */   
/*     */   public int id;
...
/*  28 */     this.wildId = Integer.valueOf(rootElement.attributeValue("wildId")).intValue();
/*  29 */     this.baobaoId = Integer.valueOf(rootElement.attributeValue("baobaoId")).intValue();
/*  30 */     this.bianYiId = Integer.valueOf(rootElement.attributeValue("bianYiId")).intValue();
/*     */   }
/*     */   
...
/*  37 */     _os_.marshal(this.wildId);
/*  38 */     _os_.marshal(this.baobaoId);
/*  39 */     _os_.marshal(this.bianYiId);
/*  40 */     return _os_;
/*     */   }
/*     */   
...
/*  47 */     this.wildId = _os_.unmarshal_int();
/*  48 */     this.baobaoId = _os_.unmarshal_int();
/*  49 */     this.bianYiId = _os_.unmarshal_int();
/*  50 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  55 */     String path = dir + "mzm.gsp.pet.confbean.SPetTypeCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  68 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.pet.confbean.SPetTypeCfg"))
/*     */         {
/*     */ 
/*  71 */           SPetTypeCfg obj = new SPetTypeCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SPetTypeCfg> all)
/*     */   {
/*  85 */     String path = dir + "mzm.gsp.pet.confbean.SPetTypeCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  97 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.pet.confbean.SPetTypeCfg"))
/*     */         {
/*     */ 
/* 100 */           SPetTypeCfg obj = new SPetTypeCfg();
...
/*     */     
/* 116 */     String path = dir + "mzm.gsp.pet.confbean.SPetTypeCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 143 */           SPetTypeCfg _v_ = new SPetTypeCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SPetTypeCfg> all)
/*     */   {
/* 163 */     String path = dir + "mzm.gsp.pet.confbean.SPetTypeCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 190 */           SPetTypeCfg _v_ = new SPetTypeCfg();
...
/*     */ 
/*     */ 
/*     */   public static SPetTypeCfg getOld(int key)
/*     */   {
/* 211 */     return (SPetTypeCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SPetTypeCfg get(int key)
/*     */   {
/* 216 */     return (SPetTypeCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPetTypeCfg> getOldAll()
/*     */   {
/* 221 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPetTypeCfg> getAll()
/*     */   {
/* 226 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SPetTypeCfg> newAll)
/*     */   {
/* 231 */     oldAll = all;
/* 232 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\pet\confbean\SPetTypeCfg.class
