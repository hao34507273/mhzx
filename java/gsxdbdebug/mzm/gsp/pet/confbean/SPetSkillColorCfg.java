...
/*     */ 
/*     */ public class SPetSkillColorCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SPetSkillColorCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SPetSkillColorCfg> all = null;
/*     */   
/*     */   public int id;
...
/*  29 */     this.score = Integer.valueOf(rootElement.attributeValue("score")).intValue();
/*  30 */     this.color = Integer.valueOf(rootElement.attributeValue("color")).intValue();
/*  31 */     this.skillLevel = Integer.valueOf(rootElement.attributeValue("skillLevel")).intValue();
/*  32 */     this.skillLevelUpRate = Integer.valueOf(rootElement.attributeValue("skillLevelUpRate")).intValue();
/*     */   }
/*     */   
...
/*  40 */     _os_.marshal(this.color);
/*  41 */     _os_.marshal(this.skillLevel);
/*  42 */     _os_.marshal(this.skillLevelUpRate);
/*  43 */     return _os_;
/*     */   }
/*     */   
...
/*  50 */     this.score = _os_.unmarshal_int();
/*  51 */     this.color = _os_.unmarshal_int();
/*  52 */     this.skillLevel = _os_.unmarshal_int();
/*  53 */     this.skillLevelUpRate = _os_.unmarshal_int();
/*  54 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  59 */     String path = dir + "mzm.gsp.pet.confbean.SPetSkillColorCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  72 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.pet.confbean.SPetSkillColorCfg"))
/*     */         {
/*     */ 
/*  75 */           SPetSkillColorCfg obj = new SPetSkillColorCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SPetSkillColorCfg> all)
/*     */   {
/*  89 */     String path = dir + "mzm.gsp.pet.confbean.SPetSkillColorCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 101 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.pet.confbean.SPetSkillColorCfg"))
/*     */         {
/*     */ 
/* 104 */           SPetSkillColorCfg obj = new SPetSkillColorCfg();
...
/*     */     
/* 120 */     String path = dir + "mzm.gsp.pet.confbean.SPetSkillColorCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 147 */           SPetSkillColorCfg _v_ = new SPetSkillColorCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SPetSkillColorCfg> all)
/*     */   {
/* 167 */     String path = dir + "mzm.gsp.pet.confbean.SPetSkillColorCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 194 */           SPetSkillColorCfg _v_ = new SPetSkillColorCfg();
...
/*     */ 
/*     */ 
/*     */   public static SPetSkillColorCfg getOld(int key)
/*     */   {
/* 215 */     return (SPetSkillColorCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SPetSkillColorCfg get(int key)
/*     */   {
/* 220 */     return (SPetSkillColorCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPetSkillColorCfg> getOldAll()
/*     */   {
/* 225 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPetSkillColorCfg> getAll()
/*     */   {
/* 230 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SPetSkillColorCfg> newAll)
/*     */   {
/* 235 */     oldAll = all;
/* 236 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\pet\confbean\SPetSkillColorCfg.class
