...
/*     */ 
/*     */ public class SPetReplaceSkillCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SPetReplaceSkillCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SPetReplaceSkillCfg> all = null;
/*     */   
/*     */   public int petCfgId;
/*     */   public int itemId;
/*     */   public int itemNum;
...
/*     */   {
/*  24 */     this.petCfgId = Integer.valueOf(rootElement.attributeValue("petCfgId")).intValue();
/*  25 */     this.itemId = Integer.valueOf(rootElement.attributeValue("itemId")).intValue();
/*  26 */     this.itemNum = Integer.valueOf(rootElement.attributeValue("itemNum")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  31 */     _os_.marshal(this.petCfgId);
/*  32 */     _os_.marshal(this.itemId);
/*  33 */     _os_.marshal(this.itemNum);
/*  34 */     return _os_;
/*     */   }
/*     */   
/*     */   public OctetsStream unmarshal(OctetsStream _os_) throws com.goldhuman.Common.Marshal.MarshalException
/*     */   {
/*  39 */     this.petCfgId = _os_.unmarshal_int();
/*  40 */     this.itemId = _os_.unmarshal_int();
/*  41 */     this.itemNum = _os_.unmarshal_int();
/*  42 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  47 */     String path = dir + "mzm.gsp.pet.confbean.SPetReplaceSkillCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  60 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.pet.confbean.SPetReplaceSkillCfg"))
/*     */         {
/*     */ 
/*  63 */           SPetReplaceSkillCfg obj = new SPetReplaceSkillCfg();
/*  64 */           obj.loadFromXml(elem);
/*  65 */           if (all.put(Integer.valueOf(obj.petCfgId), obj) != null) {
/*  66 */             throw new RuntimeException("duplicate key : " + obj.petCfgId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SPetReplaceSkillCfg> all)
/*     */   {
/*  77 */     String path = dir + "mzm.gsp.pet.confbean.SPetReplaceSkillCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  89 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.pet.confbean.SPetReplaceSkillCfg"))
/*     */         {
/*     */ 
/*  92 */           SPetReplaceSkillCfg obj = new SPetReplaceSkillCfg();
/*  93 */           obj.loadFromXml(elem);
/*  94 */           if (all.put(Integer.valueOf(obj.petCfgId), obj) != null) {
/*  95 */             throw new RuntimeException("duplicate key : " + obj.petCfgId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 108 */     String path = dir + "mzm.gsp.pet.confbean.SPetReplaceSkillCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 135 */           SPetReplaceSkillCfg _v_ = new SPetReplaceSkillCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SPetReplaceSkillCfg> all)
/*     */   {
/* 155 */     String path = dir + "mzm.gsp.pet.confbean.SPetReplaceSkillCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 182 */           SPetReplaceSkillCfg _v_ = new SPetReplaceSkillCfg();
...
/*     */ 
/*     */ 
/*     */   public static SPetReplaceSkillCfg getOld(int key)
/*     */   {
/* 203 */     return (SPetReplaceSkillCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SPetReplaceSkillCfg get(int key)
/*     */   {
/* 208 */     return (SPetReplaceSkillCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPetReplaceSkillCfg> getOldAll()
/*     */   {
/* 213 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPetReplaceSkillCfg> getAll()
/*     */   {
/* 218 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SPetReplaceSkillCfg> newAll)
/*     */   {
/* 223 */     oldAll = all;
/* 224 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\pet\confbean\SPetReplaceSkillCfg.class
