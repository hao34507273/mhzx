...
/*     */ 
/*     */ public class SPetSpecialSkillConf implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SPetSpecialSkillConf> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SPetSpecialSkillConf> all = null;
/*     */   
/*     */   public int skillId;
/*     */   public boolean canHuaSheng;
/*     */   public boolean isAutoRemember;
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  24 */     this.skillId = Integer.valueOf(rootElement.attributeValue("skillId")).intValue();
/*  25 */     this.canHuaSheng = Boolean.valueOf(rootElement.attributeValue("canHuaSheng")).booleanValue();
/*  26 */     this.isAutoRemember = Boolean.valueOf(rootElement.attributeValue("isAutoRemember")).booleanValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  31 */     _os_.marshal(this.skillId);
/*  32 */     _os_.marshal(this.canHuaSheng);
/*  33 */     _os_.marshal(this.isAutoRemember);
/*  34 */     return _os_;
/*     */   }
/*     */   
/*     */   public OctetsStream unmarshal(OctetsStream _os_) throws com.goldhuman.Common.Marshal.MarshalException
/*     */   {
/*  39 */     this.skillId = _os_.unmarshal_int();
/*  40 */     this.canHuaSheng = _os_.unmarshal_boolean();
/*  41 */     this.isAutoRemember = _os_.unmarshal_boolean();
/*  42 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  47 */     String path = dir + "mzm.gsp.pet.confbean.SPetSpecialSkillConf.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  60 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.pet.confbean.SPetSpecialSkillConf"))
/*     */         {
/*     */ 
/*  63 */           SPetSpecialSkillConf obj = new SPetSpecialSkillConf();
/*  64 */           obj.loadFromXml(elem);
/*  65 */           if (all.put(Integer.valueOf(obj.skillId), obj) != null) {
/*  66 */             throw new RuntimeException("duplicate key : " + obj.skillId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SPetSpecialSkillConf> all)
/*     */   {
/*  77 */     String path = dir + "mzm.gsp.pet.confbean.SPetSpecialSkillConf.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  89 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.pet.confbean.SPetSpecialSkillConf"))
/*     */         {
/*     */ 
/*  92 */           SPetSpecialSkillConf obj = new SPetSpecialSkillConf();
/*  93 */           obj.loadFromXml(elem);
/*  94 */           if (all.put(Integer.valueOf(obj.skillId), obj) != null) {
/*  95 */             throw new RuntimeException("duplicate key : " + obj.skillId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 108 */     String path = dir + "mzm.gsp.pet.confbean.SPetSpecialSkillConf.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 135 */           SPetSpecialSkillConf _v_ = new SPetSpecialSkillConf();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SPetSpecialSkillConf> all)
/*     */   {
/* 155 */     String path = dir + "mzm.gsp.pet.confbean.SPetSpecialSkillConf.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 182 */           SPetSpecialSkillConf _v_ = new SPetSpecialSkillConf();
...
/*     */ 
/*     */ 
/*     */   public static SPetSpecialSkillConf getOld(int key)
/*     */   {
/* 203 */     return (SPetSpecialSkillConf)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SPetSpecialSkillConf get(int key)
/*     */   {
/* 208 */     return (SPetSpecialSkillConf)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPetSpecialSkillConf> getOldAll()
/*     */   {
/* 213 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPetSpecialSkillConf> getAll()
/*     */   {
/* 218 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SPetSpecialSkillConf> newAll)
/*     */   {
/* 223 */     oldAll = all;
/* 224 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\pet\confbean\SPetSpecialSkillConf.class
