...
/*     */ 
/*     */ public class PetGetHuiJuanItemCostCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, PetGetHuiJuanItemCostCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, PetGetHuiJuanItemCostCfg> all = null;
/*     */   
/*     */   public int id;
...
/*  29 */     this.petType = Integer.valueOf(rootElement.attributeValue("petType")).intValue();
/*  30 */     this.costType = Integer.valueOf(rootElement.attributeValue("costType")).intValue();
/*  31 */     this.priceItemId = Integer.valueOf(rootElement.attributeValue("priceItemId")).intValue();
...
/*  39 */     _os_.marshal(this.petType);
/*  40 */     _os_.marshal(this.costType);
/*  41 */     _os_.marshal(this.priceItemId);
/*  42 */     _os_.marshal(this.costNum);
/*  43 */     return _os_;
/*     */   }
/*     */   
...
/*  50 */     this.petType = _os_.unmarshal_int();
/*  51 */     this.costType = _os_.unmarshal_int();
/*  52 */     this.priceItemId = _os_.unmarshal_int();
/*  53 */     this.costNum = _os_.unmarshal_int();
/*  54 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  59 */     String path = dir + "mzm.gsp.pet.confbean.PetGetHuiJuanItemCostCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  72 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.pet.confbean.PetGetHuiJuanItemCostCfg"))
/*     */         {
/*     */ 
/*  75 */           PetGetHuiJuanItemCostCfg obj = new PetGetHuiJuanItemCostCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, PetGetHuiJuanItemCostCfg> all)
/*     */   {
/*  89 */     String path = dir + "mzm.gsp.pet.confbean.PetGetHuiJuanItemCostCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 101 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.pet.confbean.PetGetHuiJuanItemCostCfg"))
/*     */         {
/*     */ 
/* 104 */           PetGetHuiJuanItemCostCfg obj = new PetGetHuiJuanItemCostCfg();
...
/*     */     
/* 120 */     String path = dir + "mzm.gsp.pet.confbean.PetGetHuiJuanItemCostCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 147 */           PetGetHuiJuanItemCostCfg _v_ = new PetGetHuiJuanItemCostCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, PetGetHuiJuanItemCostCfg> all)
/*     */   {
/* 167 */     String path = dir + "mzm.gsp.pet.confbean.PetGetHuiJuanItemCostCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 194 */           PetGetHuiJuanItemCostCfg _v_ = new PetGetHuiJuanItemCostCfg();
...
/*     */ 
/*     */ 
/*     */   public static PetGetHuiJuanItemCostCfg getOld(int key)
/*     */   {
/* 215 */     return (PetGetHuiJuanItemCostCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static PetGetHuiJuanItemCostCfg get(int key)
/*     */   {
/* 220 */     return (PetGetHuiJuanItemCostCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, PetGetHuiJuanItemCostCfg> getOldAll()
/*     */   {
/* 225 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, PetGetHuiJuanItemCostCfg> getAll()
/*     */   {
/* 230 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, PetGetHuiJuanItemCostCfg> newAll)
/*     */   {
/* 235 */     oldAll = all;
/* 236 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\pet\confbean\PetGetHuiJuanItemCostCfg.class
