...
/*     */ 
/*     */ public class SPetFindBackConf implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SPetFindBackConf> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SPetFindBackConf> all = null;
/*     */   
...
/*  31 */     this.petType = Integer.valueOf(rootElement.attributeValue("petType")).intValue();
/*  32 */     this.catchLevel = Integer.valueOf(rootElement.attributeValue("catchLevel")).intValue();
/*  33 */     this.awardId = Integer.valueOf(rootElement.attributeValue("awardId")).intValue();
/*  34 */     this.costRMB = Integer.valueOf(rootElement.attributeValue("costRMB")).intValue();
/*  35 */     this.costCopper = Integer.valueOf(rootElement.attributeValue("costCopper")).intValue();
/*  36 */     this.dayLimit = Integer.valueOf(rootElement.attributeValue("dayLimit")).intValue();
/*     */   }
/*     */   
...
/*  43 */     _os_.marshal(this.petType);
/*  44 */     _os_.marshal(this.catchLevel);
/*  45 */     _os_.marshal(this.awardId);
/*  46 */     _os_.marshal(this.costRMB);
/*  47 */     _os_.marshal(this.costCopper);
/*  48 */     _os_.marshal(this.dayLimit);
/*  49 */     return _os_;
/*     */   }
/*     */   
...
/*  56 */     this.petType = _os_.unmarshal_int();
/*  57 */     this.catchLevel = _os_.unmarshal_int();
/*  58 */     this.awardId = _os_.unmarshal_int();
/*  59 */     this.costRMB = _os_.unmarshal_int();
/*  60 */     this.costCopper = _os_.unmarshal_int();
/*  61 */     this.dayLimit = _os_.unmarshal_int();
/*  62 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  67 */     String path = dir + "mzm.gsp.pet.confbean.SPetFindBackConf.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  80 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.pet.confbean.SPetFindBackConf"))
/*     */         {
/*     */ 
/*  83 */           SPetFindBackConf obj = new SPetFindBackConf();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SPetFindBackConf> all)
/*     */   {
/*  97 */     String path = dir + "mzm.gsp.pet.confbean.SPetFindBackConf.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 109 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.pet.confbean.SPetFindBackConf"))
/*     */         {
/*     */ 
/* 112 */           SPetFindBackConf obj = new SPetFindBackConf();
...
/*     */     
/* 128 */     String path = dir + "mzm.gsp.pet.confbean.SPetFindBackConf.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 155 */           SPetFindBackConf _v_ = new SPetFindBackConf();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SPetFindBackConf> all)
/*     */   {
/* 175 */     String path = dir + "mzm.gsp.pet.confbean.SPetFindBackConf.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 202 */           SPetFindBackConf _v_ = new SPetFindBackConf();
...
/*     */ 
/*     */ 
/*     */   public static SPetFindBackConf getOld(int key)
/*     */   {
/* 223 */     return (SPetFindBackConf)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SPetFindBackConf get(int key)
/*     */   {
/* 228 */     return (SPetFindBackConf)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPetFindBackConf> getOldAll()
/*     */   {
/* 233 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPetFindBackConf> getAll()
/*     */   {
/* 238 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SPetFindBackConf> newAll)
/*     */   {
/* 243 */     oldAll = all;
/* 244 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\pet\confbean\SPetFindBackConf.class
