...
/*     */ 
/*     */ public class SPetShopCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SPetShopCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SPetShopCfg> all = null;
/*     */   
/*     */   public int petId;
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  22 */     this.petId = Integer.valueOf(rootElement.attributeValue("petId")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  27 */     _os_.marshal(this.petId);
/*  28 */     return _os_;
/*     */   }
/*     */   
/*     */   public OctetsStream unmarshal(OctetsStream _os_) throws com.goldhuman.Common.Marshal.MarshalException
/*     */   {
/*  33 */     this.petId = _os_.unmarshal_int();
/*  34 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  39 */     String path = dir + "mzm.gsp.pet.confbean.SPetShopCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  52 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.pet.confbean.SPetShopCfg"))
/*     */         {
/*     */ 
/*  55 */           SPetShopCfg obj = new SPetShopCfg();
/*  56 */           obj.loadFromXml(elem);
/*  57 */           if (all.put(Integer.valueOf(obj.petId), obj) != null) {
/*  58 */             throw new RuntimeException("duplicate key : " + obj.petId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SPetShopCfg> all)
/*     */   {
/*  69 */     String path = dir + "mzm.gsp.pet.confbean.SPetShopCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  81 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.pet.confbean.SPetShopCfg"))
/*     */         {
/*     */ 
/*  84 */           SPetShopCfg obj = new SPetShopCfg();
/*  85 */           obj.loadFromXml(elem);
/*  86 */           if (all.put(Integer.valueOf(obj.petId), obj) != null) {
/*  87 */             throw new RuntimeException("duplicate key : " + obj.petId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 100 */     String path = dir + "mzm.gsp.pet.confbean.SPetShopCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 127 */           SPetShopCfg _v_ = new SPetShopCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SPetShopCfg> all)
/*     */   {
/* 147 */     String path = dir + "mzm.gsp.pet.confbean.SPetShopCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 174 */           SPetShopCfg _v_ = new SPetShopCfg();
...
/*     */ 
/*     */ 
/*     */   public static SPetShopCfg getOld(int key)
/*     */   {
/* 195 */     return (SPetShopCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SPetShopCfg get(int key)
/*     */   {
/* 200 */     return (SPetShopCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPetShopCfg> getOldAll()
/*     */   {
/* 205 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPetShopCfg> getAll()
/*     */   {
/* 210 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SPetShopCfg> newAll)
/*     */   {
/* 215 */     oldAll = all;
/* 216 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\pet\confbean\SPetShopCfg.class
