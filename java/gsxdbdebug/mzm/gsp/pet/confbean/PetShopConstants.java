...
/*     */ {
/*  13 */   private static volatile PetShopConstants oldInstance = null;
/*     */   
/*  15 */   private static PetShopConstants instance = new PetShopConstants();
/*     */   
/*     */   public int SELL_PER_DAY_LIMIT;
/*     */   public int SELL_2_BUY_RATE;
/*     */   public int CAN_BUY_MORE_THAN_ROLE_LEVEL;
/*     */   
/*     */   public static PetShopConstants getOldInstance()
/*     */   {
/*  23 */     return oldInstance;
/*     */   }
/*     */   
/*     */   public static PetShopConstants getInstance()
/*     */   {
/*  28 */     return instance;
/*     */   }
/*     */   
...
/*     */   {
/*  42 */     String path = dir + "mzm.gsp.pet.confbean.PetShopConstants.xml";
/*     */     try
/*     */     {
...
/*     */         }
/*     */       }
/*  62 */       this.SELL_PER_DAY_LIMIT = Integer.valueOf(((Element)data.get("SELL_PER_DAY_LIMIT")).attributeValue("value")).intValue();
/*  63 */       this.SELL_2_BUY_RATE = Integer.valueOf(((Element)data.get("SELL_2_BUY_RATE")).attributeValue("value")).intValue();
/*  64 */       this.CAN_BUY_MORE_THAN_ROLE_LEVEL = Integer.valueOf(((Element)data.get("CAN_BUY_MORE_THAN_ROLE_LEVEL")).attributeValue("value")).intValue();
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*  73 */     String path = dir + "mzm.gsp.pet.confbean.PetShopConstants.xml";
/*     */     try
/*     */     {
...
/*     */         }
/*     */       }
/*  93 */       this.SELL_PER_DAY_LIMIT = Integer.valueOf(((Element)data.get("SELL_PER_DAY_LIMIT")).attributeValue("value")).intValue();
/*  94 */       this.SELL_2_BUY_RATE = Integer.valueOf(((Element)data.get("SELL_2_BUY_RATE")).attributeValue("value")).intValue();
/*  95 */       this.CAN_BUY_MORE_THAN_ROLE_LEVEL = Integer.valueOf(((Element)data.get("CAN_BUY_MORE_THAN_ROLE_LEVEL")).attributeValue("value")).intValue();
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/* 106 */     String path = dir + "mzm.gsp.pet.confbean.PetShopConstants.bny";
/*     */     try
/*     */     {
...
/* 121 */         this.SELL_PER_DAY_LIMIT = _os_.unmarshal_int();
/* 122 */         this.SELL_2_BUY_RATE = _os_.unmarshal_int();
/* 123 */         this.CAN_BUY_MORE_THAN_ROLE_LEVEL = _os_.unmarshal_int();
/*     */       }
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*     */   {
/* 134 */     String path = dir + "mzm.gsp.pet.confbean.PetShopConstants.bny";
/*     */     try
/*     */     {
...
/* 149 */         this.SELL_PER_DAY_LIMIT = _os_.unmarshal_int();
/* 150 */         this.SELL_2_BUY_RATE = _os_.unmarshal_int();
/* 151 */         this.CAN_BUY_MORE_THAN_ROLE_LEVEL = _os_.unmarshal_int();
/*     */       }
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*     */   }
/*     */   
/*     */   public static void setInstance(PetShopConstants newInstance)
/*     */   {
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\pet\confbean\PetShopConstants.class
