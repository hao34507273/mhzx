...
/*     */ 
/*     */ public class SPetExp2Level implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SPetExp2Level> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SPetExp2Level> all = null;
/*     */   
/*     */   public int levelto;
/*     */   public int needExp;
/*     */   
...
/*     */   {
/*  23 */     this.levelto = Integer.valueOf(rootElement.attributeValue("levelto")).intValue();
/*  24 */     this.needExp = Integer.valueOf(rootElement.attributeValue("needExp")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  29 */     _os_.marshal(this.levelto);
/*  30 */     _os_.marshal(this.needExp);
/*  31 */     return _os_;
/*     */   }
/*     */   
/*     */   public OctetsStream unmarshal(OctetsStream _os_) throws com.goldhuman.Common.Marshal.MarshalException
/*     */   {
/*  36 */     this.levelto = _os_.unmarshal_int();
/*  37 */     this.needExp = _os_.unmarshal_int();
/*  38 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.pet.confbean.SPetExp2Level.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.pet.confbean.SPetExp2Level"))
/*     */         {
/*     */ 
/*  59 */           SPetExp2Level obj = new SPetExp2Level();
/*  60 */           obj.loadFromXml(elem);
/*  61 */           if (all.put(Integer.valueOf(obj.levelto), obj) != null) {
/*  62 */             throw new RuntimeException("duplicate key : " + obj.levelto);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SPetExp2Level> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.pet.confbean.SPetExp2Level.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.pet.confbean.SPetExp2Level"))
/*     */         {
/*     */ 
/*  88 */           SPetExp2Level obj = new SPetExp2Level();
/*  89 */           obj.loadFromXml(elem);
/*  90 */           if (all.put(Integer.valueOf(obj.levelto), obj) != null) {
/*  91 */             throw new RuntimeException("duplicate key : " + obj.levelto);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.pet.confbean.SPetExp2Level.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           SPetExp2Level _v_ = new SPetExp2Level();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SPetExp2Level> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.pet.confbean.SPetExp2Level.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           SPetExp2Level _v_ = new SPetExp2Level();
...
/*     */ 
/*     */ 
/*     */   public static SPetExp2Level getOld(int key)
/*     */   {
/* 199 */     return (SPetExp2Level)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SPetExp2Level get(int key)
/*     */   {
/* 204 */     return (SPetExp2Level)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPetExp2Level> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPetExp2Level> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SPetExp2Level> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\pet\confbean\SPetExp2Level.class
