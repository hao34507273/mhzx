...
/*     */ 
/*     */ public class SPetSkillScoreCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SPetSkillScoreCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SPetSkillScoreCfg> all = null;
/*     */   
/*     */   public int skillId;
/*     */   public int score;
...
/*  26 */     this.skillLevel = Integer.valueOf(rootElement.attributeValue("skillLevel")).intValue();
/*     */   }
/*     */   
...
/*  33 */     _os_.marshal(this.skillLevel);
/*  34 */     return _os_;
/*     */   }
/*     */   
...
/*  41 */     this.skillLevel = _os_.unmarshal_int();
/*  42 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  47 */     String path = dir + "mzm.gsp.pet.confbean.SPetSkillScoreCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  60 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.pet.confbean.SPetSkillScoreCfg"))
/*     */         {
/*     */ 
/*  63 */           SPetSkillScoreCfg obj = new SPetSkillScoreCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SPetSkillScoreCfg> all)
/*     */   {
/*  77 */     String path = dir + "mzm.gsp.pet.confbean.SPetSkillScoreCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  89 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.pet.confbean.SPetSkillScoreCfg"))
/*     */         {
/*     */ 
/*  92 */           SPetSkillScoreCfg obj = new SPetSkillScoreCfg();
...
/*     */     
/* 108 */     String path = dir + "mzm.gsp.pet.confbean.SPetSkillScoreCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 135 */           SPetSkillScoreCfg _v_ = new SPetSkillScoreCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SPetSkillScoreCfg> all)
/*     */   {
/* 155 */     String path = dir + "mzm.gsp.pet.confbean.SPetSkillScoreCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 182 */           SPetSkillScoreCfg _v_ = new SPetSkillScoreCfg();
...
/*     */ 
/*     */ 
/*     */   public static SPetSkillScoreCfg getOld(int key)
/*     */   {
/* 203 */     return (SPetSkillScoreCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SPetSkillScoreCfg get(int key)
/*     */   {
/* 208 */     return (SPetSkillScoreCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPetSkillScoreCfg> getOldAll()
/*     */   {
/* 213 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPetSkillScoreCfg> getAll()
/*     */   {
/* 218 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SPetSkillScoreCfg> newAll)
/*     */   {
/* 223 */     oldAll = all;
/* 224 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\pet\confbean\SPetSkillScoreCfg.class
