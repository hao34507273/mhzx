...
/*     */ 
/*     */ public class STPetTransformProp implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, STPetTransformProp> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, STPetTransformProp> all = null;
/*     */   
/*     */   public int secondPro;
/*  19 */   public HashMap<Integer, Double> basePro2value = new HashMap();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.secondPro = Integer.valueOf(rootElement.attributeValue("secondPro")).intValue();
/*     */     
/*  25 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "basePro2value");
...
/*     */         }
/*     */         
/*  76 */         this.basePro2value.put(Integer.valueOf(_k_), Double.valueOf(_v_));
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*     */   {
/*  83 */     _os_.marshal(this.secondPro);
/*  84 */     _os_.compact_uint32(this.basePro2value.size());
/*  85 */     for (java.util.Map.Entry<Integer, Double> _e_ : this.basePro2value.entrySet())
/*     */     {
...
/*     */   {
/*  95 */     this.secondPro = _os_.unmarshal_int();
...
/* 102 */       this.basePro2value.put(Integer.valueOf(_k_), Double.valueOf(_v_));
/*     */     }
/* 104 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/* 109 */     String path = dir + "mzm.gsp.pet.confbean.STPetTransformProp.xml";
/*     */     
/*     */     try
/*     */     {
/* 113 */       all = new HashMap();
...
/* 122 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.pet.confbean.STPetTransformProp"))
/*     */         {
/*     */ 
/* 125 */           STPetTransformProp obj = new STPetTransformProp();
/* 126 */           obj.loadFromXml(elem);
/* 127 */           if (all.put(Integer.valueOf(obj.secondPro), obj) != null) {
/* 128 */             throw new RuntimeException("duplicate key : " + obj.secondPro);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, STPetTransformProp> all)
/*     */   {
/* 139 */     String path = dir + "mzm.gsp.pet.confbean.STPetTransformProp.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 151 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.pet.confbean.STPetTransformProp"))
/*     */         {
/*     */ 
/* 154 */           STPetTransformProp obj = new STPetTransformProp();
/* 155 */           obj.loadFromXml(elem);
/* 156 */           if (all.put(Integer.valueOf(obj.secondPro), obj) != null) {
/* 157 */             throw new RuntimeException("duplicate key : " + obj.secondPro);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/* 168 */     all = new HashMap();
/*     */     
/* 170 */     String path = dir + "mzm.gsp.pet.confbean.STPetTransformProp.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 197 */           STPetTransformProp _v_ = new STPetTransformProp();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, STPetTransformProp> all)
/*     */   {
/* 217 */     String path = dir + "mzm.gsp.pet.confbean.STPetTransformProp.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 244 */           STPetTransformProp _v_ = new STPetTransformProp();
...
/*     */ 
/*     */ 
/*     */   public static STPetTransformProp getOld(int key)
/*     */   {
/* 265 */     return (STPetTransformProp)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static STPetTransformProp get(int key)
/*     */   {
/* 270 */     return (STPetTransformProp)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, STPetTransformProp> getOldAll()
/*     */   {
/* 275 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, STPetTransformProp> getAll()
/*     */   {
/* 280 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, STPetTransformProp> newAll)
/*     */   {
/* 285 */     oldAll = all;
/* 286 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\pet\confbean\STPetTransformProp.class
