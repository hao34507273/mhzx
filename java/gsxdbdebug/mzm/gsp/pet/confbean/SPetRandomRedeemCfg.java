...
/*     */ 
/*     */ public class SPetRandomRedeemCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SPetRandomRedeemCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SPetRandomRedeemCfg> all = null;
/*     */   
/*     */   public int id;
...
/*     */   {
/*  51 */     String path = dir + "mzm.gsp.pet.confbean.SPetRandomRedeemCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  64 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.pet.confbean.SPetRandomRedeemCfg"))
/*     */         {
/*     */ 
/*  67 */           SPetRandomRedeemCfg obj = new SPetRandomRedeemCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SPetRandomRedeemCfg> all)
/*     */   {
/*  81 */     String path = dir + "mzm.gsp.pet.confbean.SPetRandomRedeemCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.pet.confbean.SPetRandomRedeemCfg"))
/*     */         {
/*     */ 
/*  96 */           SPetRandomRedeemCfg obj = new SPetRandomRedeemCfg();
...
/*     */     
/* 112 */     String path = dir + "mzm.gsp.pet.confbean.SPetRandomRedeemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 139 */           SPetRandomRedeemCfg _v_ = new SPetRandomRedeemCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SPetRandomRedeemCfg> all)
/*     */   {
/* 159 */     String path = dir + "mzm.gsp.pet.confbean.SPetRandomRedeemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 186 */           SPetRandomRedeemCfg _v_ = new SPetRandomRedeemCfg();
...
/*     */ 
/*     */ 
/*     */   public static SPetRandomRedeemCfg getOld(int key)
/*     */   {
/* 207 */     return (SPetRandomRedeemCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SPetRandomRedeemCfg get(int key)
/*     */   {
/* 212 */     return (SPetRandomRedeemCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPetRandomRedeemCfg> getOldAll()
/*     */   {
/* 217 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPetRandomRedeemCfg> getAll()
/*     */   {
/* 222 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SPetRandomRedeemCfg> newAll)
/*     */   {
/* 227 */     oldAll = all;
/* 228 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\pet\confbean\SPetRandomRedeemCfg.class
