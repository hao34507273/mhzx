...
/*     */ 
/*     */ public class SPetJinJieSkillCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SPetJinJieSkillCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SPetJinJieSkillCfg> all = null;
/*     */   
/*     */   public int petCfgId;
/*  19 */   public java.util.ArrayList<Integer> stageSkills = new java.util.ArrayList();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.petCfgId = Integer.valueOf(rootElement.attributeValue("petCfgId")).intValue();
/*     */     
/*  25 */     Element collectionElement = util.XmlHelper.getVariableElement(rootElement, "stageSkills");
...
/*     */         }
/*     */         
/*  50 */         this.stageSkills.add(Integer.valueOf(_v_));
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*  58 */     _os_.compact_uint32(this.stageSkills.size());
/*  59 */     for (Integer _v_ : this.stageSkills)
/*     */     {
...
/*     */   {
/*  80 */     String path = dir + "mzm.gsp.pet.confbean.SPetJinJieSkillCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.pet.confbean.SPetJinJieSkillCfg"))
/*     */         {
/*     */ 
/*  96 */           SPetJinJieSkillCfg obj = new SPetJinJieSkillCfg();
/*  97 */           obj.loadFromXml(elem);
/*  98 */           if (all.put(Integer.valueOf(obj.petCfgId), obj) != null) {
/*  99 */             throw new RuntimeException("duplicate key : " + obj.petCfgId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SPetJinJieSkillCfg> all)
/*     */   {
/* 110 */     String path = dir + "mzm.gsp.pet.confbean.SPetJinJieSkillCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 122 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.pet.confbean.SPetJinJieSkillCfg"))
/*     */         {
/*     */ 
/* 125 */           SPetJinJieSkillCfg obj = new SPetJinJieSkillCfg();
/* 126 */           obj.loadFromXml(elem);
/* 127 */           if (all.put(Integer.valueOf(obj.petCfgId), obj) != null) {
/* 128 */             throw new RuntimeException("duplicate key : " + obj.petCfgId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 141 */     String path = dir + "mzm.gsp.pet.confbean.SPetJinJieSkillCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 168 */           SPetJinJieSkillCfg _v_ = new SPetJinJieSkillCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SPetJinJieSkillCfg> all)
/*     */   {
/* 188 */     String path = dir + "mzm.gsp.pet.confbean.SPetJinJieSkillCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 215 */           SPetJinJieSkillCfg _v_ = new SPetJinJieSkillCfg();
...
/*     */ 
/*     */ 
/*     */   public static SPetJinJieSkillCfg getOld(int key)
/*     */   {
/* 236 */     return (SPetJinJieSkillCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SPetJinJieSkillCfg get(int key)
/*     */   {
/* 241 */     return (SPetJinJieSkillCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPetJinJieSkillCfg> getOldAll()
/*     */   {
/* 246 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPetJinJieSkillCfg> getAll()
/*     */   {
/* 251 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SPetJinJieSkillCfg> newAll)
/*     */   {
/* 256 */     oldAll = all;
/* 257 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\pet\confbean\SPetJinJieSkillCfg.class
