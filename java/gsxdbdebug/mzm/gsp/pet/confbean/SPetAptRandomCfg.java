...
/*     */ 
/*     */ public class SPetAptRandomCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SPetAptRandomCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SPetAptRandomCfg> all = null;
/*     */   
/*     */   public int templateId;
/*     */   public String templateName;
/*  20 */   public java.util.LinkedList<AptRandomRegion> aptRandomList = new java.util.LinkedList();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  24 */     this.templateId = Integer.valueOf(rootElement.attributeValue("templateId")).intValue();
/*  25 */     this.templateName = rootElement.attributeValue("templateName");
/*     */     
/*  27 */     Element collectionElement = util.XmlHelper.getVariableElement(rootElement, "aptRandomList");
...
/*  38 */       if (elem.getName().equalsIgnoreCase("mzm.gsp.pet.confbean.AptRandomRegion"))
/*     */       {
/*     */         AptRandomRegion _v_;
/*     */         
/*     */ 
...
/*     */   {
/*  60 */     _os_.marshal(this.templateId);
/*  61 */     _os_.marshal(this.templateName, "UTF-8");
/*  62 */     _os_.compact_uint32(this.aptRandomList.size());
/*  63 */     for (AptRandomRegion _v_ : this.aptRandomList)
/*     */     {
/*  65 */       _os_.marshal(_v_);
/*     */     }
/*  67 */     return _os_;
...
/*     */   {
/*  86 */     String path = dir + "mzm.gsp.pet.confbean.SPetAptRandomCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  99 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.pet.confbean.SPetAptRandomCfg"))
/*     */         {
/*     */ 
/* 102 */           SPetAptRandomCfg obj = new SPetAptRandomCfg();
/* 103 */           obj.loadFromXml(elem);
/* 104 */           if (all.put(Integer.valueOf(obj.templateId), obj) != null) {
/* 105 */             throw new RuntimeException("duplicate key : " + obj.templateId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SPetAptRandomCfg> all)
/*     */   {
/* 116 */     String path = dir + "mzm.gsp.pet.confbean.SPetAptRandomCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 128 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.pet.confbean.SPetAptRandomCfg"))
/*     */         {
/*     */ 
/* 131 */           SPetAptRandomCfg obj = new SPetAptRandomCfg();
/* 132 */           obj.loadFromXml(elem);
/* 133 */           if (all.put(Integer.valueOf(obj.templateId), obj) != null) {
/* 134 */             throw new RuntimeException("duplicate key : " + obj.templateId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 147 */     String path = dir + "mzm.gsp.pet.confbean.SPetAptRandomCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 174 */           SPetAptRandomCfg _v_ = new SPetAptRandomCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SPetAptRandomCfg> all)
/*     */   {
/* 194 */     String path = dir + "mzm.gsp.pet.confbean.SPetAptRandomCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 221 */           SPetAptRandomCfg _v_ = new SPetAptRandomCfg();
...
/*     */ 
/*     */ 
/*     */   public static SPetAptRandomCfg getOld(int key)
/*     */   {
/* 242 */     return (SPetAptRandomCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SPetAptRandomCfg get(int key)
/*     */   {
/* 247 */     return (SPetAptRandomCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPetAptRandomCfg> getOldAll()
/*     */   {
/* 252 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPetAptRandomCfg> getAll()
/*     */   {
/* 257 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SPetAptRandomCfg> newAll)
/*     */   {
/* 262 */     oldAll = all;
/* 263 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\pet\confbean\SPetAptRandomCfg.class
