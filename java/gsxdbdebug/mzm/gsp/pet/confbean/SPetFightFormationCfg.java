...
/*     */ 
/*     */ public class SPetFightFormationCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SPetFightFormationCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SPetFightFormationCfg> all = null;
/*     */   
/*     */   public int id;
...
/*  28 */     this.position1 = Integer.valueOf(rootElement.attributeValue("position1")).intValue();
/*  29 */     this.position2 = Integer.valueOf(rootElement.attributeValue("position2")).intValue();
/*  30 */     this.position3 = Integer.valueOf(rootElement.attributeValue("position3")).intValue();
/*  31 */     this.position4 = Integer.valueOf(rootElement.attributeValue("position4")).intValue();
/*  32 */     this.position5 = Integer.valueOf(rootElement.attributeValue("position5")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  37 */     _os_.marshal(this.id);
/*  38 */     _os_.marshal(this.position1);
/*  39 */     _os_.marshal(this.position2);
/*  40 */     _os_.marshal(this.position3);
/*  41 */     _os_.marshal(this.position4);
/*  42 */     _os_.marshal(this.position5);
/*  43 */     return _os_;
/*     */   }
/*     */   
...
/*  49 */     this.position1 = _os_.unmarshal_int();
/*  50 */     this.position2 = _os_.unmarshal_int();
/*  51 */     this.position3 = _os_.unmarshal_int();
/*  52 */     this.position4 = _os_.unmarshal_int();
/*  53 */     this.position5 = _os_.unmarshal_int();
/*  54 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  59 */     String path = dir + "mzm.gsp.pet.confbean.SPetFightFormationCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  72 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.pet.confbean.SPetFightFormationCfg"))
/*     */         {
/*     */ 
/*  75 */           SPetFightFormationCfg obj = new SPetFightFormationCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SPetFightFormationCfg> all)
/*     */   {
/*  89 */     String path = dir + "mzm.gsp.pet.confbean.SPetFightFormationCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 101 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.pet.confbean.SPetFightFormationCfg"))
/*     */         {
/*     */ 
/* 104 */           SPetFightFormationCfg obj = new SPetFightFormationCfg();
...
/*     */     
/* 120 */     String path = dir + "mzm.gsp.pet.confbean.SPetFightFormationCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 147 */           SPetFightFormationCfg _v_ = new SPetFightFormationCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SPetFightFormationCfg> all)
/*     */   {
/* 167 */     String path = dir + "mzm.gsp.pet.confbean.SPetFightFormationCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 194 */           SPetFightFormationCfg _v_ = new SPetFightFormationCfg();
...
/*     */ 
/*     */ 
/*     */   public static SPetFightFormationCfg getOld(int key)
/*     */   {
/* 215 */     return (SPetFightFormationCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SPetFightFormationCfg get(int key)
/*     */   {
/* 220 */     return (SPetFightFormationCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPetFightFormationCfg> getOldAll()
/*     */   {
/* 225 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPetFightFormationCfg> getAll()
/*     */   {
/* 230 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SPetFightFormationCfg> newAll)
/*     */   {
/* 235 */     oldAll = all;
/* 236 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\pet\confbean\SPetFightFormationCfg.class
