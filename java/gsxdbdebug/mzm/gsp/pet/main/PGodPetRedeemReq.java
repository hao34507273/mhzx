...
/*     */ 
/*     */ public class PGodPetRedeemReq
/*     */   extends LogicProcedure
/*     */ {
/*     */   private final long roleId;
/*     */   private final int petcfgid;
/*     */   
/*     */   public PGodPetRedeemReq(long roleId, int petcfgid)
/*     */   {
...
/*  51 */       GameServer.logger().error(String.format("[pet]PGodPetRedeemReq.processImp@ role in STATUS_ROAM not use fun!|roleid=%d|status_set=%s", new Object[] { Long.valueOf(this.roleId), statusSet }));
/*     */       
/*     */ 
/*  54 */       return false;
/*     */     }
/*  56 */     if (!NpcInterface.checkNpcService(PetConstants.getInstance().GOLD_PET_REDEEM_NPCID, 150205300, this.roleId)) {
/*  57 */       return false;
/*     */     }
...
/*  76 */       ItemOperateResult result = ItemInterface.removeItemsByItemType(this.roleId, costItem.itemTypeId, costItem.itemNum, new TLogArg(LogReason.PET_SHENSHOU_REDEEM_REM));
/*  77 */       if (!result.success()) {
/*  78 */         PetManager.logDebug("PGodPetRedeemReq.processImp@remove item error|roleid=%d|itemTypeId=%d|itemNum=%d", new Object[] { Long.valueOf(this.roleId), Integer.valueOf(costItem.itemTypeId), Integer.valueOf(costItem.itemNum) });
/*  79 */         return false;
/*     */       }
...
/*  99 */     sBulletinInfo.bulletintype = 23;
...
/*     */     
/* 111 */     PetManager.addPetGetTlog(this.roleId, hostIp, userId, petId, this.petcfgid, PetGetTLogEnum.SHENSHOU_NPC, skillList.size());
/* 112 */     PetManager.addPetSkillChangeTlog(this.roleId, hostIp, userId, petId, this.petcfgid, PetSkillChangeLogEnum.INIT, skillList);
/*     */     
/* 114 */     PetManager.logInfo("PGodPetRedeemReq.processImp@exchange shenshou pet success!" + this.roleId + "|" + this.petcfgid + "|" + itemId + "|" + item.itemNum, new Object[0]);
/*     */     
/* 116 */     return true;
/*     */   }
/*     */ }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\pet\main\PGodPetRedeemReq.class
