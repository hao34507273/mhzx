...
/*     */ import mzm.gsp.Role;
/*     */ import mzm.gsp.multioccupation.main.PActivateNewOccupationReq;
/*     */ 
/*     */ public class CActiveNewOccupationReq
/*     */   extends __CActiveNewOccupationReq__
/*     */ {
/*     */   public static final int PROTOCOL_TYPE = 12606979;
/*     */   public int new_occupation;
/*     */   public int old_occupation;
/*     */   public long current_currency;
/*     */   public int npcid;
/*     */   
/*     */   protected void process()
/*     */   {
/*  19 */     long roleid = Role.getRoleId(this);
/*  20 */     Role.addRoleProcedure(roleid, new PActivateNewOccupationReq(roleid, this.new_occupation, this.old_occupation, this.current_currency, this.npcid));
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */ 
/*     */ 
/*     */   public CActiveNewOccupationReq() {}
/*     */   
/*     */ 
/*     */ 
/*     */   public CActiveNewOccupationReq(int _new_occupation_, int _old_occupation_, long _current_currency_, int _npcid_)
/*     */   {
/*  42 */     this.new_occupation = _new_occupation_;
/*  43 */     this.old_occupation = _old_occupation_;
/*  44 */     this.current_currency = _current_currency_;
...
/*  55 */     _os_.marshal(this.current_currency);
...
/*  63 */     this.current_currency = _os_.unmarshal_long();
...
/*  73 */     if ((_o1_ instanceof CActiveNewOccupationReq)) {
/*  74 */       CActiveNewOccupationReq _o_ = (CActiveNewOccupationReq)_o1_;
/*  75 */       if (this.new_occupation != _o_.new_occupation) return false;
/*  76 */       if (this.old_occupation != _o_.old_occupation) return false;
/*  77 */       if (this.current_currency != _o_.current_currency) return false;
...
/*  88 */     _h_ += (int)this.current_currency;
/*  89 */     _h_ += this.npcid;
/*  90 */     return _h_;
/*     */   }
/*     */   
...
/*  98 */     _sb_.append(this.current_currency).append(",");
/*  99 */     _sb_.append(this.npcid).append(",");
/* 100 */     _sb_.append(")");
/* 101 */     return _sb_.toString();
/*     */   }
/*     */   
/*     */   public int compareTo(CActiveNewOccupationReq _o_) {
...
/* 111 */     _c_ = Long.signum(this.current_currency - _o_.current_currency);
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\multioccupation\CActiveNewOccupationReq.class
