...
/*     */ 
/*     */ public class SMountsDyeColorCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SMountsDyeColorCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SMountsDyeColorCfg> all = null;
/*     */   
/*     */   public int mountsCfgId;
/*  19 */   public HashMap<Integer, MountsDyeColorBean> mountsDyeColorMap = new HashMap();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.mountsCfgId = Integer.valueOf(rootElement.attributeValue("mountsCfgId")).intValue();
/*     */     
/*  25 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "mountsDyeColorMap");
...
/*  51 */             keyElem = elem;
/*     */           }
/*  53 */           else if ((valueElem == null) && (elem.getName().equalsIgnoreCase("mzm.gsp.mounts.confbean.MountsDyeColorBean")))
/*     */           {
/*  55 */             valueElem = elem;
/*     */           }
/*     */         }
...
/*     */         
/*     */         int _k_;
/*     */         MountsDyeColorBean _v_;
/*     */         try
/*     */         {
/*  68 */           _k_ = Integer.valueOf(keyElem.getText()).intValue();
/*  69 */           _v_ = new MountsDyeColorBean();
...
/*     */         }
/*     */         
/*  77 */         this.mountsDyeColorMap.put(Integer.valueOf(_k_), _v_);
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*  85 */     _os_.compact_uint32(this.mountsDyeColorMap.size());
/*  86 */     for (java.util.Map.Entry<Integer, MountsDyeColorBean> _e_ : this.mountsDyeColorMap.entrySet())
/*     */     {
...
/*     */       
/* 102 */       MountsDyeColorBean _v_ = new MountsDyeColorBean();
/* 103 */       _v_.unmarshal(_os_);
/* 104 */       this.mountsDyeColorMap.put(Integer.valueOf(_k_), _v_);
/*     */     }
/* 106 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/* 111 */     String path = dir + "mzm.gsp.mounts.confbean.SMountsDyeColorCfg.xml";
/*     */     
/*     */     try
/*     */     {
/* 115 */       all = new HashMap();
...
/* 124 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.mounts.confbean.SMountsDyeColorCfg"))
/*     */         {
/*     */ 
/* 127 */           SMountsDyeColorCfg obj = new SMountsDyeColorCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SMountsDyeColorCfg> all)
/*     */   {
/* 141 */     String path = dir + "mzm.gsp.mounts.confbean.SMountsDyeColorCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 153 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.mounts.confbean.SMountsDyeColorCfg"))
/*     */         {
/*     */ 
/* 156 */           SMountsDyeColorCfg obj = new SMountsDyeColorCfg();
...
/* 170 */     all = new HashMap();
/*     */     
/* 172 */     String path = dir + "mzm.gsp.mounts.confbean.SMountsDyeColorCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 199 */           SMountsDyeColorCfg _v_ = new SMountsDyeColorCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SMountsDyeColorCfg> all)
/*     */   {
/* 219 */     String path = dir + "mzm.gsp.mounts.confbean.SMountsDyeColorCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 246 */           SMountsDyeColorCfg _v_ = new SMountsDyeColorCfg();
...
/*     */ 
/*     */ 
/*     */   public static SMountsDyeColorCfg getOld(int key)
/*     */   {
/* 267 */     return (SMountsDyeColorCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SMountsDyeColorCfg get(int key)
/*     */   {
/* 272 */     return (SMountsDyeColorCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMountsDyeColorCfg> getOldAll()
/*     */   {
/* 277 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMountsDyeColorCfg> getAll()
/*     */   {
/* 282 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SMountsDyeColorCfg> newAll)
/*     */   {
/* 287 */     oldAll = all;
/* 288 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\mounts\confbean\SMountsDyeColorCfg.class
