...
/*     */ 
/*     */ public class SMountsRankCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SMountsRankCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SMountsRankCfg> all = null;
/*     */   
/*     */   public int mountsCfgId;
/*  19 */   public HashMap<Integer, MountsRankInfoBean> mountsRankMapInfo = new HashMap();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.mountsCfgId = Integer.valueOf(rootElement.attributeValue("mountsCfgId")).intValue();
/*     */     
/*  25 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "mountsRankMapInfo");
...
/*  51 */             keyElem = elem;
/*     */           }
/*  53 */           else if ((valueElem == null) && (elem.getName().equalsIgnoreCase("mzm.gsp.mounts.confbean.MountsRankInfoBean")))
/*     */           {
/*  55 */             valueElem = elem;
/*     */           }
/*     */         }
...
/*     */         
/*     */         int _k_;
/*     */         MountsRankInfoBean _v_;
/*     */         try
/*     */         {
/*  68 */           _k_ = Integer.valueOf(keyElem.getText()).intValue();
/*  69 */           _v_ = new MountsRankInfoBean();
...
/*     */         }
/*     */         
/*  77 */         this.mountsRankMapInfo.put(Integer.valueOf(_k_), _v_);
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*  85 */     _os_.compact_uint32(this.mountsRankMapInfo.size());
/*  86 */     for (java.util.Map.Entry<Integer, MountsRankInfoBean> _e_ : this.mountsRankMapInfo.entrySet())
/*     */     {
...
/*     */       
/* 102 */       MountsRankInfoBean _v_ = new MountsRankInfoBean();
/* 103 */       _v_.unmarshal(_os_);
/* 104 */       this.mountsRankMapInfo.put(Integer.valueOf(_k_), _v_);
/*     */     }
/* 106 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/* 111 */     String path = dir + "mzm.gsp.mounts.confbean.SMountsRankCfg.xml";
/*     */     
/*     */     try
/*     */     {
/* 115 */       all = new HashMap();
...
/* 124 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.mounts.confbean.SMountsRankCfg"))
/*     */         {
/*     */ 
/* 127 */           SMountsRankCfg obj = new SMountsRankCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SMountsRankCfg> all)
/*     */   {
/* 141 */     String path = dir + "mzm.gsp.mounts.confbean.SMountsRankCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 153 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.mounts.confbean.SMountsRankCfg"))
/*     */         {
/*     */ 
/* 156 */           SMountsRankCfg obj = new SMountsRankCfg();
...
/* 170 */     all = new HashMap();
/*     */     
/* 172 */     String path = dir + "mzm.gsp.mounts.confbean.SMountsRankCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 199 */           SMountsRankCfg _v_ = new SMountsRankCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SMountsRankCfg> all)
/*     */   {
/* 219 */     String path = dir + "mzm.gsp.mounts.confbean.SMountsRankCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 246 */           SMountsRankCfg _v_ = new SMountsRankCfg();
...
/*     */ 
/*     */ 
/*     */   public static SMountsRankCfg getOld(int key)
/*     */   {
/* 267 */     return (SMountsRankCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SMountsRankCfg get(int key)
/*     */   {
/* 272 */     return (SMountsRankCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMountsRankCfg> getOldAll()
/*     */   {
/* 277 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMountsRankCfg> getAll()
/*     */   {
/* 282 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SMountsRankCfg> newAll)
/*     */   {
/* 287 */     oldAll = all;
/* 288 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\mounts\confbean\SMountsRankCfg.class
