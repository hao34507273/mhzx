...
/*     */ 
/*     */ public class SMountsBattleCellCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SMountsBattleCellCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SMountsBattleCellCfg> all = null;
/*     */   
/*     */   public int cellId;
/*     */   public int unLockRoleLevel;
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.cellId = Integer.valueOf(rootElement.attributeValue("cellId")).intValue();
/*  24 */     this.unLockRoleLevel = Integer.valueOf(rootElement.attributeValue("unLockRoleLevel")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  29 */     _os_.marshal(this.cellId);
/*  30 */     _os_.marshal(this.unLockRoleLevel);
/*  31 */     return _os_;
/*     */   }
/*     */   
/*     */   public OctetsStream unmarshal(OctetsStream _os_) throws com.goldhuman.Common.Marshal.MarshalException
/*     */   {
/*  36 */     this.cellId = _os_.unmarshal_int();
/*  37 */     this.unLockRoleLevel = _os_.unmarshal_int();
/*  38 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.mounts.confbean.SMountsBattleCellCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.mounts.confbean.SMountsBattleCellCfg"))
/*     */         {
/*     */ 
/*  59 */           SMountsBattleCellCfg obj = new SMountsBattleCellCfg();
/*  60 */           obj.loadFromXml(elem);
/*  61 */           if (all.put(Integer.valueOf(obj.cellId), obj) != null) {
/*  62 */             throw new RuntimeException("duplicate key : " + obj.cellId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SMountsBattleCellCfg> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.mounts.confbean.SMountsBattleCellCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.mounts.confbean.SMountsBattleCellCfg"))
/*     */         {
/*     */ 
/*  88 */           SMountsBattleCellCfg obj = new SMountsBattleCellCfg();
/*  89 */           obj.loadFromXml(elem);
/*  90 */           if (all.put(Integer.valueOf(obj.cellId), obj) != null) {
/*  91 */             throw new RuntimeException("duplicate key : " + obj.cellId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.mounts.confbean.SMountsBattleCellCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           SMountsBattleCellCfg _v_ = new SMountsBattleCellCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SMountsBattleCellCfg> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.mounts.confbean.SMountsBattleCellCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           SMountsBattleCellCfg _v_ = new SMountsBattleCellCfg();
...
/*     */ 
/*     */ 
/*     */   public static SMountsBattleCellCfg getOld(int key)
/*     */   {
/* 199 */     return (SMountsBattleCellCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SMountsBattleCellCfg get(int key)
/*     */   {
/* 204 */     return (SMountsBattleCellCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMountsBattleCellCfg> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMountsBattleCellCfg> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SMountsBattleCellCfg> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\mounts\confbean\SMountsBattleCellCfg.class
