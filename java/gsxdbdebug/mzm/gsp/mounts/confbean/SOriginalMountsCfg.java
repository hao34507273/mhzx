...
/*     */ 
/*     */ public class SOriginalMountsCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SOriginalMountsCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SOriginalMountsCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public int maxMountRoleNum;
/*  20 */   public java.util.ArrayList<Integer> mountActions = new java.util.ArrayList();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  24 */     this.id = Integer.valueOf(rootElement.attributeValue("id")).intValue();
/*  25 */     this.maxMountRoleNum = Integer.valueOf(rootElement.attributeValue("maxMountRoleNum")).intValue();
/*     */     
/*  27 */     Element collectionElement = util.XmlHelper.getVariableElement(rootElement, "mountActions");
...
/*     */         }
/*     */         
/*  52 */         this.mountActions.add(Integer.valueOf(_v_));
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*  60 */     _os_.marshal(this.maxMountRoleNum);
/*  61 */     _os_.compact_uint32(this.mountActions.size());
/*  62 */     for (Integer _v_ : this.mountActions)
/*     */     {
...
/*  72 */     this.maxMountRoleNum = _os_.unmarshal_int();
/*  73 */     for (int _size_ = _os_.uncompact_uint32(); _size_ > 0; _size_--)
/*     */     {
/*     */ 
/*  76 */       int _v_ = _os_.unmarshal_int();
/*  77 */       this.mountActions.add(Integer.valueOf(_v_));
/*     */     }
/*  79 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/*  84 */     String path = dir + "mzm.gsp.mounts.confbean.SOriginalMountsCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  97 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.mounts.confbean.SOriginalMountsCfg"))
/*     */         {
/*     */ 
/* 100 */           SOriginalMountsCfg obj = new SOriginalMountsCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SOriginalMountsCfg> all)
/*     */   {
/* 114 */     String path = dir + "mzm.gsp.mounts.confbean.SOriginalMountsCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 126 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.mounts.confbean.SOriginalMountsCfg"))
/*     */         {
/*     */ 
/* 129 */           SOriginalMountsCfg obj = new SOriginalMountsCfg();
...
/*     */     
/* 145 */     String path = dir + "mzm.gsp.mounts.confbean.SOriginalMountsCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 172 */           SOriginalMountsCfg _v_ = new SOriginalMountsCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SOriginalMountsCfg> all)
/*     */   {
/* 192 */     String path = dir + "mzm.gsp.mounts.confbean.SOriginalMountsCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 219 */           SOriginalMountsCfg _v_ = new SOriginalMountsCfg();
...
/*     */ 
/*     */ 
/*     */   public static SOriginalMountsCfg getOld(int key)
/*     */   {
/* 240 */     return (SOriginalMountsCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SOriginalMountsCfg get(int key)
/*     */   {
/* 245 */     return (SOriginalMountsCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SOriginalMountsCfg> getOldAll()
/*     */   {
/* 250 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SOriginalMountsCfg> getAll()
/*     */   {
/* 255 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SOriginalMountsCfg> newAll)
/*     */   {
/* 260 */     oldAll = all;
/* 261 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\mounts\confbean\SOriginalMountsCfg.class
