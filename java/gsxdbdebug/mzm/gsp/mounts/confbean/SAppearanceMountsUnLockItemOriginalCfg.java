...
/*     */ 
/*     */ public class SAppearanceMountsUnLockItemOriginalCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SAppearanceMountsUnLockItemOriginalCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SAppearanceMountsUnLockItemOriginalCfg> all = null;
/*     */   
/*     */   public int id;
...
/*  26 */     this.itemCategory = Integer.valueOf(rootElement.attributeValue("itemCategory")).intValue();
/*  27 */     this.itemId = Integer.valueOf(rootElement.attributeValue("itemId")).intValue();
/*  28 */     this.lastTime = Integer.valueOf(rootElement.attributeValue("lastTime")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  33 */     _os_.marshal(this.id);
/*  34 */     _os_.marshal(this.itemCategory);
/*  35 */     _os_.marshal(this.itemId);
/*  36 */     _os_.marshal(this.lastTime);
/*  37 */     return _os_;
/*     */   }
/*     */   
...
/*  43 */     this.itemCategory = _os_.unmarshal_int();
/*  44 */     this.itemId = _os_.unmarshal_int();
/*  45 */     this.lastTime = _os_.unmarshal_int();
/*  46 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  51 */     String path = dir + "mzm.gsp.mounts.confbean.SAppearanceMountsUnLockItemOriginalCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  64 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.mounts.confbean.SAppearanceMountsUnLockItemOriginalCfg"))
/*     */         {
/*     */ 
/*  67 */           SAppearanceMountsUnLockItemOriginalCfg obj = new SAppearanceMountsUnLockItemOriginalCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SAppearanceMountsUnLockItemOriginalCfg> all)
/*     */   {
/*  81 */     String path = dir + "mzm.gsp.mounts.confbean.SAppearanceMountsUnLockItemOriginalCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.mounts.confbean.SAppearanceMountsUnLockItemOriginalCfg"))
/*     */         {
/*     */ 
/*  96 */           SAppearanceMountsUnLockItemOriginalCfg obj = new SAppearanceMountsUnLockItemOriginalCfg();
...
/*     */     
/* 112 */     String path = dir + "mzm.gsp.mounts.confbean.SAppearanceMountsUnLockItemOriginalCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 139 */           SAppearanceMountsUnLockItemOriginalCfg _v_ = new SAppearanceMountsUnLockItemOriginalCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SAppearanceMountsUnLockItemOriginalCfg> all)
/*     */   {
/* 159 */     String path = dir + "mzm.gsp.mounts.confbean.SAppearanceMountsUnLockItemOriginalCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 186 */           SAppearanceMountsUnLockItemOriginalCfg _v_ = new SAppearanceMountsUnLockItemOriginalCfg();
...
/*     */ 
/*     */ 
/*     */   public static SAppearanceMountsUnLockItemOriginalCfg getOld(int key)
/*     */   {
/* 207 */     return (SAppearanceMountsUnLockItemOriginalCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SAppearanceMountsUnLockItemOriginalCfg get(int key)
/*     */   {
/* 212 */     return (SAppearanceMountsUnLockItemOriginalCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SAppearanceMountsUnLockItemOriginalCfg> getOldAll()
/*     */   {
/* 217 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SAppearanceMountsUnLockItemOriginalCfg> getAll()
/*     */   {
/* 222 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SAppearanceMountsUnLockItemOriginalCfg> newAll)
/*     */   {
/* 227 */     oldAll = all;
/* 228 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\mounts\confbean\SAppearanceMountsUnLockItemOriginalCfg.class
