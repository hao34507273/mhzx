...
/*     */ 
/*     */ public class SMountsCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SMountsCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SMountsCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public String mountsName;
/*     */   public int mountsType;
/*     */   public int mountsModelId;
/*     */   public int defaultDyeColorId;
/*     */   public int maxMountRoleNum;
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  27 */     this.id = Integer.valueOf(rootElement.attributeValue("id")).intValue();
/*  28 */     this.mountsName = rootElement.attributeValue("mountsName");
/*  29 */     this.mountsType = Integer.valueOf(rootElement.attributeValue("mountsType")).intValue();
/*  30 */     this.mountsModelId = Integer.valueOf(rootElement.attributeValue("mountsModelId")).intValue();
/*  31 */     this.defaultDyeColorId = Integer.valueOf(rootElement.attributeValue("defaultDyeColorId")).intValue();
/*  32 */     this.maxMountRoleNum = Integer.valueOf(rootElement.attributeValue("maxMountRoleNum")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  37 */     _os_.marshal(this.id);
/*  38 */     _os_.marshal(this.mountsName, "UTF-8");
/*  39 */     _os_.marshal(this.mountsType);
/*  40 */     _os_.marshal(this.mountsModelId);
/*  41 */     _os_.marshal(this.defaultDyeColorId);
/*  42 */     _os_.marshal(this.maxMountRoleNum);
/*  43 */     return _os_;
/*     */   }
/*     */   
...
/*  49 */     this.mountsName = _os_.unmarshal_String("UTF-8");
/*  50 */     this.mountsType = _os_.unmarshal_int();
/*  51 */     this.mountsModelId = _os_.unmarshal_int();
/*  52 */     this.defaultDyeColorId = _os_.unmarshal_int();
/*  53 */     this.maxMountRoleNum = _os_.unmarshal_int();
/*  54 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  59 */     String path = dir + "mzm.gsp.mounts.confbean.SMountsCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  72 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.mounts.confbean.SMountsCfg"))
/*     */         {
/*     */ 
/*  75 */           SMountsCfg obj = new SMountsCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SMountsCfg> all)
/*     */   {
/*  89 */     String path = dir + "mzm.gsp.mounts.confbean.SMountsCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 101 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.mounts.confbean.SMountsCfg"))
/*     */         {
/*     */ 
/* 104 */           SMountsCfg obj = new SMountsCfg();
...
/*     */     
/* 120 */     String path = dir + "mzm.gsp.mounts.confbean.SMountsCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 147 */           SMountsCfg _v_ = new SMountsCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SMountsCfg> all)
/*     */   {
/* 167 */     String path = dir + "mzm.gsp.mounts.confbean.SMountsCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 194 */           SMountsCfg _v_ = new SMountsCfg();
...
/*     */ 
/*     */ 
/*     */   public static SMountsCfg getOld(int key)
/*     */   {
/* 215 */     return (SMountsCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SMountsCfg get(int key)
/*     */   {
/* 220 */     return (SMountsCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMountsCfg> getOldAll()
/*     */   {
/* 225 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMountsCfg> getAll()
/*     */   {
/* 230 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SMountsCfg> newAll)
/*     */   {
/* 235 */     oldAll = all;
/* 236 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\mounts\confbean\SMountsCfg.class
