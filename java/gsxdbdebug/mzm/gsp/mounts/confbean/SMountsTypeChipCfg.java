...
/*     */ 
/*     */ public class SMountsTypeChipCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SMountsTypeChipCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SMountsTypeChipCfg> all = null;
/*     */   
/*     */   public int mountsType;
/*  19 */   public HashMap<Integer, Integer> chipItemId2score = new HashMap();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.mountsType = Integer.valueOf(rootElement.attributeValue("mountsType")).intValue();
/*     */     
/*  25 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "chipItemId2score");
...
/*     */         }
/*     */         
/*  76 */         this.chipItemId2score.put(Integer.valueOf(_k_), Integer.valueOf(_v_));
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*     */   {
/*  83 */     _os_.marshal(this.mountsType);
/*  84 */     _os_.compact_uint32(this.chipItemId2score.size());
/*  85 */     for (java.util.Map.Entry<Integer, Integer> _e_ : this.chipItemId2score.entrySet())
/*     */     {
...
/*     */   {
/*  95 */     this.mountsType = _os_.unmarshal_int();
...
/* 102 */       this.chipItemId2score.put(Integer.valueOf(_k_), Integer.valueOf(_v_));
/*     */     }
/* 104 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/* 109 */     String path = dir + "mzm.gsp.mounts.confbean.SMountsTypeChipCfg.xml";
/*     */     
/*     */     try
/*     */     {
/* 113 */       all = new HashMap();
...
/* 122 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.mounts.confbean.SMountsTypeChipCfg"))
/*     */         {
/*     */ 
/* 125 */           SMountsTypeChipCfg obj = new SMountsTypeChipCfg();
/* 126 */           obj.loadFromXml(elem);
/* 127 */           if (all.put(Integer.valueOf(obj.mountsType), obj) != null) {
/* 128 */             throw new RuntimeException("duplicate key : " + obj.mountsType);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SMountsTypeChipCfg> all)
/*     */   {
/* 139 */     String path = dir + "mzm.gsp.mounts.confbean.SMountsTypeChipCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 151 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.mounts.confbean.SMountsTypeChipCfg"))
/*     */         {
/*     */ 
/* 154 */           SMountsTypeChipCfg obj = new SMountsTypeChipCfg();
/* 155 */           obj.loadFromXml(elem);
/* 156 */           if (all.put(Integer.valueOf(obj.mountsType), obj) != null) {
/* 157 */             throw new RuntimeException("duplicate key : " + obj.mountsType);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/* 168 */     all = new HashMap();
/*     */     
/* 170 */     String path = dir + "mzm.gsp.mounts.confbean.SMountsTypeChipCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 197 */           SMountsTypeChipCfg _v_ = new SMountsTypeChipCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SMountsTypeChipCfg> all)
/*     */   {
/* 217 */     String path = dir + "mzm.gsp.mounts.confbean.SMountsTypeChipCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 244 */           SMountsTypeChipCfg _v_ = new SMountsTypeChipCfg();
...
/*     */ 
/*     */ 
/*     */   public static SMountsTypeChipCfg getOld(int key)
/*     */   {
/* 265 */     return (SMountsTypeChipCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SMountsTypeChipCfg get(int key)
/*     */   {
/* 270 */     return (SMountsTypeChipCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMountsTypeChipCfg> getOldAll()
/*     */   {
/* 275 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMountsTypeChipCfg> getAll()
/*     */   {
/* 280 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SMountsTypeChipCfg> newAll)
/*     */   {
/* 285 */     oldAll = all;
/* 286 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\mounts\confbean\SMountsTypeChipCfg.class
