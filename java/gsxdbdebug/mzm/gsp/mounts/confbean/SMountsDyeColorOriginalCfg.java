...
/*     */ 
/*     */ public class SMountsDyeColorOriginalCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SMountsDyeColorOriginalCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SMountsDyeColorOriginalCfg> all = null;
/*     */   
/*     */   public int id;
...
/*  29 */     this.colorId = Integer.valueOf(rootElement.attributeValue("colorId")).intValue();
...
/*  32 */     this.itemcount = Integer.valueOf(rootElement.attributeValue("itemcount")).intValue();
/*     */   }
/*     */   
...
/*  39 */     _os_.marshal(this.colorId);
/*  40 */     _os_.marshal(this.itemid);
/*  41 */     _os_.marshal(this.costItemType);
/*  42 */     _os_.marshal(this.itemcount);
/*  43 */     return _os_;
/*     */   }
/*     */   
...
/*  50 */     this.colorId = _os_.unmarshal_int();
/*  51 */     this.itemid = _os_.unmarshal_int();
/*  52 */     this.costItemType = _os_.unmarshal_int();
/*  53 */     this.itemcount = _os_.unmarshal_int();
/*  54 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  59 */     String path = dir + "mzm.gsp.mounts.confbean.SMountsDyeColorOriginalCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  72 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.mounts.confbean.SMountsDyeColorOriginalCfg"))
/*     */         {
/*     */ 
/*  75 */           SMountsDyeColorOriginalCfg obj = new SMountsDyeColorOriginalCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SMountsDyeColorOriginalCfg> all)
/*     */   {
/*  89 */     String path = dir + "mzm.gsp.mounts.confbean.SMountsDyeColorOriginalCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 101 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.mounts.confbean.SMountsDyeColorOriginalCfg"))
/*     */         {
/*     */ 
/* 104 */           SMountsDyeColorOriginalCfg obj = new SMountsDyeColorOriginalCfg();
...
/*     */     
/* 120 */     String path = dir + "mzm.gsp.mounts.confbean.SMountsDyeColorOriginalCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 147 */           SMountsDyeColorOriginalCfg _v_ = new SMountsDyeColorOriginalCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SMountsDyeColorOriginalCfg> all)
/*     */   {
/* 167 */     String path = dir + "mzm.gsp.mounts.confbean.SMountsDyeColorOriginalCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 194 */           SMountsDyeColorOriginalCfg _v_ = new SMountsDyeColorOriginalCfg();
...
/*     */ 
/*     */ 
/*     */   public static SMountsDyeColorOriginalCfg getOld(int key)
/*     */   {
/* 215 */     return (SMountsDyeColorOriginalCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SMountsDyeColorOriginalCfg get(int key)
/*     */   {
/* 220 */     return (SMountsDyeColorOriginalCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMountsDyeColorOriginalCfg> getOldAll()
/*     */   {
/* 225 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMountsDyeColorOriginalCfg> getAll()
/*     */   {
/* 230 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SMountsDyeColorOriginalCfg> newAll)
/*     */   {
/* 235 */     oldAll = all;
/* 236 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\mounts\confbean\SMountsDyeColorOriginalCfg.class
