...
/*     */ 
/*     */ public class SAppearanceMountsUnLockItemCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SAppearanceMountsUnLockItemCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SAppearanceMountsUnLockItemCfg> all = null;
/*     */   
/*     */   public int itemCategory;
/*  19 */   public HashMap<Integer, Integer> unLockItemMap = new HashMap();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.itemCategory = Integer.valueOf(rootElement.attributeValue("itemCategory")).intValue();
/*     */     
/*  25 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "unLockItemMap");
...
/*     */         }
/*     */         
/*  76 */         this.unLockItemMap.put(Integer.valueOf(_k_), Integer.valueOf(_v_));
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*     */   {
/*  83 */     _os_.marshal(this.itemCategory);
/*  84 */     _os_.compact_uint32(this.unLockItemMap.size());
/*  85 */     for (java.util.Map.Entry<Integer, Integer> _e_ : this.unLockItemMap.entrySet())
/*     */     {
...
/*     */   {
/*  95 */     this.itemCategory = _os_.unmarshal_int();
...
/* 102 */       this.unLockItemMap.put(Integer.valueOf(_k_), Integer.valueOf(_v_));
/*     */     }
/* 104 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/* 109 */     String path = dir + "mzm.gsp.mounts.confbean.SAppearanceMountsUnLockItemCfg.xml";
/*     */     
/*     */     try
/*     */     {
/* 113 */       all = new HashMap();
...
/* 122 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.mounts.confbean.SAppearanceMountsUnLockItemCfg"))
/*     */         {
/*     */ 
/* 125 */           SAppearanceMountsUnLockItemCfg obj = new SAppearanceMountsUnLockItemCfg();
/* 126 */           obj.loadFromXml(elem);
/* 127 */           if (all.put(Integer.valueOf(obj.itemCategory), obj) != null) {
/* 128 */             throw new RuntimeException("duplicate key : " + obj.itemCategory);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SAppearanceMountsUnLockItemCfg> all)
/*     */   {
/* 139 */     String path = dir + "mzm.gsp.mounts.confbean.SAppearanceMountsUnLockItemCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 151 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.mounts.confbean.SAppearanceMountsUnLockItemCfg"))
/*     */         {
/*     */ 
/* 154 */           SAppearanceMountsUnLockItemCfg obj = new SAppearanceMountsUnLockItemCfg();
/* 155 */           obj.loadFromXml(elem);
/* 156 */           if (all.put(Integer.valueOf(obj.itemCategory), obj) != null) {
/* 157 */             throw new RuntimeException("duplicate key : " + obj.itemCategory);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/* 168 */     all = new HashMap();
/*     */     
/* 170 */     String path = dir + "mzm.gsp.mounts.confbean.SAppearanceMountsUnLockItemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 197 */           SAppearanceMountsUnLockItemCfg _v_ = new SAppearanceMountsUnLockItemCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SAppearanceMountsUnLockItemCfg> all)
/*     */   {
/* 217 */     String path = dir + "mzm.gsp.mounts.confbean.SAppearanceMountsUnLockItemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 244 */           SAppearanceMountsUnLockItemCfg _v_ = new SAppearanceMountsUnLockItemCfg();
...
/*     */ 
/*     */ 
/*     */   public static SAppearanceMountsUnLockItemCfg getOld(int key)
/*     */   {
/* 265 */     return (SAppearanceMountsUnLockItemCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SAppearanceMountsUnLockItemCfg get(int key)
/*     */   {
/* 270 */     return (SAppearanceMountsUnLockItemCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SAppearanceMountsUnLockItemCfg> getOldAll()
/*     */   {
/* 275 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SAppearanceMountsUnLockItemCfg> getAll()
/*     */   {
/* 280 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SAppearanceMountsUnLockItemCfg> newAll)
/*     */   {
/* 285 */     oldAll = all;
/* 286 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\mounts\confbean\SAppearanceMountsUnLockItemCfg.class
