...
/*     */ 
/*     */ public class SMountsPassiveSkillCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SMountsPassiveSkillCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SMountsPassiveSkillCfg> all = null;
/*     */   
/*     */   public int mountsCfgId;
/*  19 */   public TreeMap<Integer, MountsPassiveSkillBean> rankPassiveSkillMap = new TreeMap();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.mountsCfgId = Integer.valueOf(rootElement.attributeValue("mountsCfgId")).intValue();
/*     */     
/*  25 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "rankPassiveSkillMap");
...
/*  51 */             keyElem = elem;
/*     */           }
/*  53 */           else if ((valueElem == null) && (elem.getName().equalsIgnoreCase("mzm.gsp.mounts.confbean.MountsPassiveSkillBean")))
/*     */           {
/*  55 */             valueElem = elem;
/*     */           }
/*     */         }
...
/*     */         
/*     */         int _k_;
/*     */         MountsPassiveSkillBean _v_;
/*     */         try
/*     */         {
/*  68 */           _k_ = Integer.valueOf(keyElem.getText()).intValue();
/*  69 */           _v_ = new MountsPassiveSkillBean();
...
/*     */         }
/*     */         
/*  77 */         this.rankPassiveSkillMap.put(Integer.valueOf(_k_), _v_);
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*     */   {
/*  84 */     _os_.marshal(this.mountsCfgId);
/*  85 */     _os_.compact_uint32(this.rankPassiveSkillMap.size());
/*  86 */     for (java.util.Map.Entry<Integer, MountsPassiveSkillBean> _e_ : this.rankPassiveSkillMap.entrySet())
/*     */     {
...
/*     */   {
/*  96 */     this.mountsCfgId = _os_.unmarshal_int();
/*  97 */     for (int _size_ = _os_.uncompact_uint32(); _size_ > 0; _size_--)
/*     */     {
/*     */ 
/* 100 */       int _k_ = _os_.unmarshal_int();
/*     */       
/* 102 */       MountsPassiveSkillBean _v_ = new MountsPassiveSkillBean();
/* 103 */       _v_.unmarshal(_os_);
/* 104 */       this.rankPassiveSkillMap.put(Integer.valueOf(_k_), _v_);
/*     */     }
/* 106 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/* 111 */     String path = dir + "mzm.gsp.mounts.confbean.SMountsPassiveSkillCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 124 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.mounts.confbean.SMountsPassiveSkillCfg"))
/*     */         {
/*     */ 
/* 127 */           SMountsPassiveSkillCfg obj = new SMountsPassiveSkillCfg();
/* 128 */           obj.loadFromXml(elem);
/* 129 */           if (all.put(Integer.valueOf(obj.mountsCfgId), obj) != null) {
/* 130 */             throw new RuntimeException("duplicate key : " + obj.mountsCfgId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SMountsPassiveSkillCfg> all)
/*     */   {
/* 141 */     String path = dir + "mzm.gsp.mounts.confbean.SMountsPassiveSkillCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 153 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.mounts.confbean.SMountsPassiveSkillCfg"))
/*     */         {
/*     */ 
/* 156 */           SMountsPassiveSkillCfg obj = new SMountsPassiveSkillCfg();
/* 157 */           obj.loadFromXml(elem);
/* 158 */           if (all.put(Integer.valueOf(obj.mountsCfgId), obj) != null) {
/* 159 */             throw new RuntimeException("duplicate key : " + obj.mountsCfgId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 172 */     String path = dir + "mzm.gsp.mounts.confbean.SMountsPassiveSkillCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 199 */           SMountsPassiveSkillCfg _v_ = new SMountsPassiveSkillCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SMountsPassiveSkillCfg> all)
/*     */   {
/* 219 */     String path = dir + "mzm.gsp.mounts.confbean.SMountsPassiveSkillCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 246 */           SMountsPassiveSkillCfg _v_ = new SMountsPassiveSkillCfg();
...
/*     */ 
/*     */ 
/*     */   public static SMountsPassiveSkillCfg getOld(int key)
/*     */   {
/* 267 */     return (SMountsPassiveSkillCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SMountsPassiveSkillCfg get(int key)
/*     */   {
/* 272 */     return (SMountsPassiveSkillCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMountsPassiveSkillCfg> getOldAll()
/*     */   {
/* 277 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMountsPassiveSkillCfg> getAll()
/*     */   {
/* 282 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SMountsPassiveSkillCfg> newAll)
/*     */   {
/* 287 */     oldAll = all;
/* 288 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\mounts\confbean\SMountsPassiveSkillCfg.class
