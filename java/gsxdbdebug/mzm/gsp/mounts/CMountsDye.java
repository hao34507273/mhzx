...
/*     */ import mzm.gsp.Role;
/*     */ import mzm.gsp.mounts.main.PCMountsDye;
/*     */ 
/*     */ public class CMountsDye
/*     */   extends __CMountsDye__
/*     */ {
/*     */   public static final int PROTOCOL_TYPE = 12606214;
...
/*  23 */       return;
/*     */     }
/*  25 */     Role.addRoleProcedure(roleId, new PCMountsDye(roleId, this.mounts_id, this.color_id, this.is_use_yuan_bao, this.client_current_yuan_bao, this.need_yuan_bao));
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */ 
/*     */ 
/*     */   public CMountsDye(long _mounts_id_, int _color_id_, int _is_use_yuan_bao_, long _client_current_yuan_bao_, int _need_yuan_bao_)
/*     */   {
/*  46 */     this.mounts_id = _mounts_id_;
/*  47 */     this.color_id = _color_id_;
...
/*  68 */     this.color_id = _os_.unmarshal_int();
...
/*  80 */     if ((_o1_ instanceof CMountsDye)) {
/*  81 */       CMountsDye _o_ = (CMountsDye)_o1_;
/*  82 */       if (this.mounts_id != _o_.mounts_id) return false;
/*  83 */       if (this.color_id != _o_.color_id) return false;
...
/* 106 */     _sb_.append(this.color_id).append(",");
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\mounts\CMountsDye.class
