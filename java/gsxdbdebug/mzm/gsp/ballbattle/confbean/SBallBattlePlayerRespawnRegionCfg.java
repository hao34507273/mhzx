...
/*     */ 
/*     */ public class SBallBattlePlayerRespawnRegionCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SBallBattlePlayerRespawnRegionCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SBallBattlePlayerRespawnRegionCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public int regionNumber;
/*  20 */   public java.util.ArrayList<Integer> regions = new java.util.ArrayList();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  24 */     this.id = Integer.valueOf(rootElement.attributeValue("id")).intValue();
/*  25 */     this.regionNumber = Integer.valueOf(rootElement.attributeValue("regionNumber")).intValue();
/*     */     
/*  27 */     Element collectionElement = util.XmlHelper.getVariableElement(rootElement, "regions");
...
/*     */         }
/*     */         
/*  52 */         this.regions.add(Integer.valueOf(_v_));
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*  60 */     _os_.marshal(this.regionNumber);
/*  61 */     _os_.compact_uint32(this.regions.size());
/*  62 */     for (Integer _v_ : this.regions)
/*     */     {
...
/*     */   {
/*  84 */     String path = dir + "mzm.gsp.ballbattle.confbean.SBallBattlePlayerRespawnRegionCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  97 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.ballbattle.confbean.SBallBattlePlayerRespawnRegionCfg"))
/*     */         {
/*     */ 
/* 100 */           SBallBattlePlayerRespawnRegionCfg obj = new SBallBattlePlayerRespawnRegionCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SBallBattlePlayerRespawnRegionCfg> all)
/*     */   {
/* 114 */     String path = dir + "mzm.gsp.ballbattle.confbean.SBallBattlePlayerRespawnRegionCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 126 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.ballbattle.confbean.SBallBattlePlayerRespawnRegionCfg"))
/*     */         {
/*     */ 
/* 129 */           SBallBattlePlayerRespawnRegionCfg obj = new SBallBattlePlayerRespawnRegionCfg();
...
/*     */     
/* 145 */     String path = dir + "mzm.gsp.ballbattle.confbean.SBallBattlePlayerRespawnRegionCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 172 */           SBallBattlePlayerRespawnRegionCfg _v_ = new SBallBattlePlayerRespawnRegionCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SBallBattlePlayerRespawnRegionCfg> all)
/*     */   {
/* 192 */     String path = dir + "mzm.gsp.ballbattle.confbean.SBallBattlePlayerRespawnRegionCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 219 */           SBallBattlePlayerRespawnRegionCfg _v_ = new SBallBattlePlayerRespawnRegionCfg();
...
/*     */ 
/*     */ 
/*     */   public static SBallBattlePlayerRespawnRegionCfg getOld(int key)
/*     */   {
/* 240 */     return (SBallBattlePlayerRespawnRegionCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SBallBattlePlayerRespawnRegionCfg get(int key)
/*     */   {
/* 245 */     return (SBallBattlePlayerRespawnRegionCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SBallBattlePlayerRespawnRegionCfg> getOldAll()
/*     */   {
/* 250 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SBallBattlePlayerRespawnRegionCfg> getAll()
/*     */   {
/* 255 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SBallBattlePlayerRespawnRegionCfg> newAll)
/*     */   {
/* 260 */     oldAll = all;
/* 261 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\ballbattle\confbean\SBallBattlePlayerRespawnRegionCfg.class
