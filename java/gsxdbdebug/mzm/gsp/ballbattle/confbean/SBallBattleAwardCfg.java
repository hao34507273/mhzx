...
/*     */ 
/*     */ public class SBallBattleAwardCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SBallBattleAwardCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SBallBattleAwardCfg> all = null;
/*     */   
/*     */   public int activityId;
/*  19 */   public java.util.ArrayList<SAwardBean> awards = new java.util.ArrayList();
/*     */   
...
/*  36 */       if (elem.getName().equalsIgnoreCase("mzm.gsp.ballbattle.confbean.SAwardBean"))
/*     */       {
/*     */         SAwardBean _v_;
/*     */         
/*     */ 
...
/*  60 */     for (SAwardBean _v_ : this.awards)
/*     */     {
/*  62 */       _os_.marshal(_v_);
/*     */     }
/*  64 */     return _os_;
...
/*     */     {
/*     */ 
/*  73 */       SAwardBean _v_ = new SAwardBean();
...
/*     */   {
/*  82 */     String path = dir + "mzm.gsp.ballbattle.confbean.SBallBattleAwardCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  95 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.ballbattle.confbean.SBallBattleAwardCfg"))
/*     */         {
/*     */ 
/*  98 */           SBallBattleAwardCfg obj = new SBallBattleAwardCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SBallBattleAwardCfg> all)
/*     */   {
/* 112 */     String path = dir + "mzm.gsp.ballbattle.confbean.SBallBattleAwardCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 124 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.ballbattle.confbean.SBallBattleAwardCfg"))
/*     */         {
/*     */ 
/* 127 */           SBallBattleAwardCfg obj = new SBallBattleAwardCfg();
...
/*     */     
/* 143 */     String path = dir + "mzm.gsp.ballbattle.confbean.SBallBattleAwardCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 170 */           SBallBattleAwardCfg _v_ = new SBallBattleAwardCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SBallBattleAwardCfg> all)
/*     */   {
/* 190 */     String path = dir + "mzm.gsp.ballbattle.confbean.SBallBattleAwardCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 217 */           SBallBattleAwardCfg _v_ = new SBallBattleAwardCfg();
...
/*     */ 
/*     */ 
/*     */   public static SBallBattleAwardCfg getOld(int key)
/*     */   {
/* 238 */     return (SBallBattleAwardCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SBallBattleAwardCfg get(int key)
/*     */   {
/* 243 */     return (SBallBattleAwardCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SBallBattleAwardCfg> getOldAll()
/*     */   {
/* 248 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SBallBattleAwardCfg> getAll()
/*     */   {
/* 253 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SBallBattleAwardCfg> newAll)
/*     */   {
/* 258 */     oldAll = all;
/* 259 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\ballbattle\confbean\SBallBattleAwardCfg.class
