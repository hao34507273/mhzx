...
/*     */ 
/*     */ public class SBallBattleAwardRawCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SBallBattleAwardRawCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SBallBattleAwardRawCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public int awardId;
...
/*  26 */     this.lowestAwardPosition = Integer.valueOf(rootElement.attributeValue("lowestAwardPosition")).intValue();
/*     */   }
/*     */   
...
/*  33 */     _os_.marshal(this.lowestAwardPosition);
/*  34 */     return _os_;
/*     */   }
/*     */   
...
/*  41 */     this.lowestAwardPosition = _os_.unmarshal_int();
/*  42 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  47 */     String path = dir + "mzm.gsp.ballbattle.confbean.SBallBattleAwardRawCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  60 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.ballbattle.confbean.SBallBattleAwardRawCfg"))
/*     */         {
/*     */ 
/*  63 */           SBallBattleAwardRawCfg obj = new SBallBattleAwardRawCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SBallBattleAwardRawCfg> all)
/*     */   {
/*  77 */     String path = dir + "mzm.gsp.ballbattle.confbean.SBallBattleAwardRawCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  89 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.ballbattle.confbean.SBallBattleAwardRawCfg"))
/*     */         {
/*     */ 
/*  92 */           SBallBattleAwardRawCfg obj = new SBallBattleAwardRawCfg();
...
/*     */     
/* 108 */     String path = dir + "mzm.gsp.ballbattle.confbean.SBallBattleAwardRawCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 135 */           SBallBattleAwardRawCfg _v_ = new SBallBattleAwardRawCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SBallBattleAwardRawCfg> all)
/*     */   {
/* 155 */     String path = dir + "mzm.gsp.ballbattle.confbean.SBallBattleAwardRawCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 182 */           SBallBattleAwardRawCfg _v_ = new SBallBattleAwardRawCfg();
...
/*     */ 
/*     */ 
/*     */   public static SBallBattleAwardRawCfg getOld(int key)
/*     */   {
/* 203 */     return (SBallBattleAwardRawCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SBallBattleAwardRawCfg get(int key)
/*     */   {
/* 208 */     return (SBallBattleAwardRawCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SBallBattleAwardRawCfg> getOldAll()
/*     */   {
/* 213 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SBallBattleAwardRawCfg> getAll()
/*     */   {
/* 218 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SBallBattleAwardRawCfg> newAll)
/*     */   {
/* 223 */     oldAll = all;
/* 224 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\ballbattle\confbean\SBallBattleAwardRawCfg.class
