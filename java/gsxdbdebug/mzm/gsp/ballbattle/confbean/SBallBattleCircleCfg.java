...
/*     */ 
/*     */ public class SBallBattleCircleCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SBallBattleCircleCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SBallBattleCircleCfg> all = null;
/*     */   
/*     */   public int id;
...
/*  23 */   public java.util.ArrayList<SBallBattleCircleBean> circles = new java.util.ArrayList();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  27 */     this.id = Integer.valueOf(rootElement.attributeValue("id")).intValue();
/*  28 */     this.initRadius = Integer.valueOf(rootElement.attributeValue("initRadius")).intValue();
/*  29 */     this.initGeneItemNumber = Integer.valueOf(rootElement.attributeValue("initGeneItemNumber")).intValue();
/*  30 */     this.circleCenterX = Integer.valueOf(rootElement.attributeValue("circleCenterX")).intValue();
/*  31 */     this.circleCenterY = Integer.valueOf(rootElement.attributeValue("circleCenterY")).intValue();
/*     */     
/*  33 */     Element collectionElement = util.XmlHelper.getVariableElement(rootElement, "circles");
...
/*  44 */       if (elem.getName().equalsIgnoreCase("mzm.gsp.ballbattle.confbean.SBallBattleCircleBean"))
/*     */       {
/*     */         SBallBattleCircleBean _v_;
/*     */         
/*     */ 
/*     */         try
/*     */         {
/*  51 */           _v_ = new SBallBattleCircleBean();
...
/*  67 */     _os_.marshal(this.initRadius);
/*  68 */     _os_.marshal(this.initGeneItemNumber);
/*  69 */     _os_.marshal(this.circleCenterX);
/*  70 */     _os_.marshal(this.circleCenterY);
/*  71 */     _os_.compact_uint32(this.circles.size());
/*  72 */     for (SBallBattleCircleBean _v_ : this.circles)
/*     */     {
/*  74 */       _os_.marshal(_v_);
/*     */     }
/*  76 */     return _os_;
...
/*  82 */     this.initRadius = _os_.unmarshal_int();
/*  83 */     this.initGeneItemNumber = _os_.unmarshal_int();
/*  84 */     this.circleCenterX = _os_.unmarshal_int();
/*  85 */     this.circleCenterY = _os_.unmarshal_int();
/*  86 */     for (int _size_ = _os_.uncompact_uint32(); _size_ > 0; _size_--)
/*     */     {
/*     */ 
/*  89 */       SBallBattleCircleBean _v_ = new SBallBattleCircleBean();
/*  90 */       _v_.unmarshal(_os_);
/*  91 */       this.circles.add(_v_);
/*     */     }
/*  93 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/*  98 */     String path = dir + "mzm.gsp.ballbattle.confbean.SBallBattleCircleCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 111 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.ballbattle.confbean.SBallBattleCircleCfg"))
/*     */         {
/*     */ 
/* 114 */           SBallBattleCircleCfg obj = new SBallBattleCircleCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SBallBattleCircleCfg> all)
/*     */   {
/* 128 */     String path = dir + "mzm.gsp.ballbattle.confbean.SBallBattleCircleCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 140 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.ballbattle.confbean.SBallBattleCircleCfg"))
/*     */         {
/*     */ 
/* 143 */           SBallBattleCircleCfg obj = new SBallBattleCircleCfg();
...
/*     */     
/* 159 */     String path = dir + "mzm.gsp.ballbattle.confbean.SBallBattleCircleCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 186 */           SBallBattleCircleCfg _v_ = new SBallBattleCircleCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SBallBattleCircleCfg> all)
/*     */   {
/* 206 */     String path = dir + "mzm.gsp.ballbattle.confbean.SBallBattleCircleCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 233 */           SBallBattleCircleCfg _v_ = new SBallBattleCircleCfg();
...
/*     */ 
/*     */ 
/*     */   public static SBallBattleCircleCfg getOld(int key)
/*     */   {
/* 254 */     return (SBallBattleCircleCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SBallBattleCircleCfg get(int key)
/*     */   {
/* 259 */     return (SBallBattleCircleCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SBallBattleCircleCfg> getOldAll()
/*     */   {
/* 264 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SBallBattleCircleCfg> getAll()
/*     */   {
/* 269 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SBallBattleCircleCfg> newAll)
/*     */   {
/* 274 */     oldAll = all;
/* 275 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\ballbattle\confbean\SBallBattleCircleCfg.class
