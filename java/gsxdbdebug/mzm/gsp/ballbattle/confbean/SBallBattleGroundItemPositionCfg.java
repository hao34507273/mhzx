...
/*     */ 
/*     */ public class SBallBattleGroundItemPositionCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SBallBattleGroundItemPositionCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SBallBattleGroundItemPositionCfg> all = null;
/*     */   
/*     */   public int activityId;
/*  19 */   public java.util.ArrayList<SGroundItemPosition> positions = new java.util.ArrayList();
/*     */   
...
/*  36 */       if (elem.getName().equalsIgnoreCase("mzm.gsp.ballbattle.confbean.SGroundItemPosition"))
/*     */       {
/*     */         SGroundItemPosition _v_;
/*     */         
/*     */ 
/*     */         try
/*     */         {
/*  43 */           _v_ = new SGroundItemPosition();
...
/*  59 */     _os_.compact_uint32(this.positions.size());
/*  60 */     for (SGroundItemPosition _v_ : this.positions)
/*     */     {
/*  62 */       _os_.marshal(_v_);
/*     */     }
/*  64 */     return _os_;
...
/*     */     {
/*     */ 
/*  73 */       SGroundItemPosition _v_ = new SGroundItemPosition();
/*  74 */       _v_.unmarshal(_os_);
/*  75 */       this.positions.add(_v_);
/*     */     }
/*  77 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/*  82 */     String path = dir + "mzm.gsp.ballbattle.confbean.SBallBattleGroundItemPositionCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  95 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.ballbattle.confbean.SBallBattleGroundItemPositionCfg"))
/*     */         {
/*     */ 
/*  98 */           SBallBattleGroundItemPositionCfg obj = new SBallBattleGroundItemPositionCfg();
/*  99 */           obj.loadFromXml(elem);
/* 100 */           if (all.put(Integer.valueOf(obj.activityId), obj) != null) {
/* 101 */             throw new RuntimeException("duplicate key : " + obj.activityId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SBallBattleGroundItemPositionCfg> all)
/*     */   {
/* 112 */     String path = dir + "mzm.gsp.ballbattle.confbean.SBallBattleGroundItemPositionCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 124 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.ballbattle.confbean.SBallBattleGroundItemPositionCfg"))
/*     */         {
/*     */ 
/* 127 */           SBallBattleGroundItemPositionCfg obj = new SBallBattleGroundItemPositionCfg();
...
/*     */     
/* 143 */     String path = dir + "mzm.gsp.ballbattle.confbean.SBallBattleGroundItemPositionCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 170 */           SBallBattleGroundItemPositionCfg _v_ = new SBallBattleGroundItemPositionCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SBallBattleGroundItemPositionCfg> all)
/*     */   {
/* 190 */     String path = dir + "mzm.gsp.ballbattle.confbean.SBallBattleGroundItemPositionCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 217 */           SBallBattleGroundItemPositionCfg _v_ = new SBallBattleGroundItemPositionCfg();
...
/*     */ 
/*     */ 
/*     */   public static SBallBattleGroundItemPositionCfg getOld(int key)
/*     */   {
/* 238 */     return (SBallBattleGroundItemPositionCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SBallBattleGroundItemPositionCfg get(int key)
/*     */   {
/* 243 */     return (SBallBattleGroundItemPositionCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SBallBattleGroundItemPositionCfg> getOldAll()
/*     */   {
/* 248 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SBallBattleGroundItemPositionCfg> getAll()
/*     */   {
/* 253 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SBallBattleGroundItemPositionCfg> newAll)
/*     */   {
/* 258 */     oldAll = all;
/* 259 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\ballbattle\confbean\SBallBattleGroundItemPositionCfg.class
