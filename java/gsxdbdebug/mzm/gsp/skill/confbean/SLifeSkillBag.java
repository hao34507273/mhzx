...
/*     */ 
/*     */ public class SLifeSkillBag implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SLifeSkillBag> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SLifeSkillBag> all = null;
/*     */   
/*     */   public int id;
...
/*  27 */     this.templateId = rootElement.attributeValue("templateId");
/*  28 */     this.idType = Integer.valueOf(rootElement.attributeValue("idType")).intValue();
/*  29 */     this.siftItemId = Integer.valueOf(rootElement.attributeValue("siftItemId")).intValue();
...
/*  36 */     _os_.marshal(this.templateId, "UTF-8");
/*  37 */     _os_.marshal(this.idType);
/*  38 */     _os_.marshal(this.siftItemId);
/*  39 */     _os_.marshal(this.openLevel);
/*  40 */     return _os_;
/*     */   }
/*     */   
...
/*  46 */     this.templateId = _os_.unmarshal_String("UTF-8");
/*  47 */     this.idType = _os_.unmarshal_int();
/*  48 */     this.siftItemId = _os_.unmarshal_int();
...
/*     */   {
/*  55 */     String path = dir + "mzm.gsp.skill.confbean.SLifeSkillBag.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  68 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.skill.confbean.SLifeSkillBag"))
/*     */         {
/*     */ 
/*  71 */           SLifeSkillBag obj = new SLifeSkillBag();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SLifeSkillBag> all)
/*     */   {
/*  85 */     String path = dir + "mzm.gsp.skill.confbean.SLifeSkillBag.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  97 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.skill.confbean.SLifeSkillBag"))
/*     */         {
/*     */ 
/* 100 */           SLifeSkillBag obj = new SLifeSkillBag();
...
/*     */     
/* 116 */     String path = dir + "mzm.gsp.skill.confbean.SLifeSkillBag.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 143 */           SLifeSkillBag _v_ = new SLifeSkillBag();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SLifeSkillBag> all)
/*     */   {
/* 163 */     String path = dir + "mzm.gsp.skill.confbean.SLifeSkillBag.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 190 */           SLifeSkillBag _v_ = new SLifeSkillBag();
...
/*     */ 
/*     */ 
/*     */   public static SLifeSkillBag getOld(int key)
/*     */   {
/* 211 */     return (SLifeSkillBag)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SLifeSkillBag get(int key)
/*     */   {
/* 216 */     return (SLifeSkillBag)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SLifeSkillBag> getOldAll()
/*     */   {
/* 221 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SLifeSkillBag> getAll()
/*     */   {
/* 226 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SLifeSkillBag> newAll)
/*     */   {
/* 231 */     oldAll = all;
/* 232 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\skill\confbean\SLifeSkillBag.class
