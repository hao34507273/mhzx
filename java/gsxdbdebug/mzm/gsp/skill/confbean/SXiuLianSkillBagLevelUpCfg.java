...
/*     */ 
/*     */ public class SXiuLianSkillBagLevelUpCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SXiuLianSkillBagLevelUpCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SXiuLianSkillBagLevelUpCfg> all = null;
/*     */   
/*     */   public int id;
...
/*  29 */     this.levelcfgid = Integer.valueOf(rootElement.attributeValue("levelcfgid")).intValue();
/*  30 */     this.skillbaglevel = Integer.valueOf(rootElement.attributeValue("skillbaglevel")).intValue();
/*  31 */     this.needRoleLevel = Integer.valueOf(rootElement.attributeValue("needRoleLevel")).intValue();
/*  32 */     this.needExp = Integer.valueOf(rootElement.attributeValue("needExp")).intValue();
/*     */   }
/*     */   
...
/*  39 */     _os_.marshal(this.levelcfgid);
/*  40 */     _os_.marshal(this.skillbaglevel);
/*  41 */     _os_.marshal(this.needRoleLevel);
/*  42 */     _os_.marshal(this.needExp);
/*  43 */     return _os_;
/*     */   }
/*     */   
...
/*  50 */     this.levelcfgid = _os_.unmarshal_int();
/*  51 */     this.skillbaglevel = _os_.unmarshal_int();
/*  52 */     this.needRoleLevel = _os_.unmarshal_int();
/*  53 */     this.needExp = _os_.unmarshal_int();
/*  54 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  59 */     String path = dir + "mzm.gsp.skill.confbean.SXiuLianSkillBagLevelUpCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  72 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.skill.confbean.SXiuLianSkillBagLevelUpCfg"))
/*     */         {
/*     */ 
/*  75 */           SXiuLianSkillBagLevelUpCfg obj = new SXiuLianSkillBagLevelUpCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SXiuLianSkillBagLevelUpCfg> all)
/*     */   {
/*  89 */     String path = dir + "mzm.gsp.skill.confbean.SXiuLianSkillBagLevelUpCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 101 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.skill.confbean.SXiuLianSkillBagLevelUpCfg"))
/*     */         {
/*     */ 
/* 104 */           SXiuLianSkillBagLevelUpCfg obj = new SXiuLianSkillBagLevelUpCfg();
...
/*     */     
/* 120 */     String path = dir + "mzm.gsp.skill.confbean.SXiuLianSkillBagLevelUpCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 147 */           SXiuLianSkillBagLevelUpCfg _v_ = new SXiuLianSkillBagLevelUpCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SXiuLianSkillBagLevelUpCfg> all)
/*     */   {
/* 167 */     String path = dir + "mzm.gsp.skill.confbean.SXiuLianSkillBagLevelUpCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 194 */           SXiuLianSkillBagLevelUpCfg _v_ = new SXiuLianSkillBagLevelUpCfg();
...
/*     */ 
/*     */ 
/*     */   public static SXiuLianSkillBagLevelUpCfg getOld(int key)
/*     */   {
/* 215 */     return (SXiuLianSkillBagLevelUpCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SXiuLianSkillBagLevelUpCfg get(int key)
/*     */   {
/* 220 */     return (SXiuLianSkillBagLevelUpCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SXiuLianSkillBagLevelUpCfg> getOldAll()
/*     */   {
/* 225 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SXiuLianSkillBagLevelUpCfg> getAll()
/*     */   {
/* 230 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SXiuLianSkillBagLevelUpCfg> newAll)
/*     */   {
/* 235 */     oldAll = all;
/* 236 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\skill\confbean\SXiuLianSkillBagLevelUpCfg.class
