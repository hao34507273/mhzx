...
/*     */ 
/*     */ public class LianYaoSkillConsts
/*     */ {
/*  13 */   private static volatile LianYaoSkillConsts oldInstance = null;
/*     */   
/*  15 */   private static LianYaoSkillConsts instance = new LianYaoSkillConsts();
/*     */   
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   public static LianYaoSkillConsts getOldInstance()
/*     */   {
/*  23 */     return oldInstance;
/*     */   }
/*     */   
/*     */   public static LianYaoSkillConsts getInstance()
/*     */   {
/*  28 */     return instance;
/*     */   }
/*     */   
/*  31 */   public int NEED_SILVER_PER_GRID = 35;
/*  32 */   public int NEED_ITEM_NUM = 0;
/*     */   
...
/*     */   {
/*  41 */     String path = dir + "mzm.gsp.skill.confbean.LianYaoSkillConsts.xml";
/*     */     try
/*     */     {
...
/*     */         }
/*     */       }
/*  61 */       this.NEED_SILVER_PER_GRID = Integer.valueOf(((Element)data.get("NEED_SILVER_PER_GRID")).attributeValue("value")).intValue();
/*  62 */       this.NEED_ITEM_NUM = Integer.valueOf(((Element)data.get("NEED_ITEM_NUM")).attributeValue("value")).intValue();
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*  71 */     String path = dir + "mzm.gsp.skill.confbean.LianYaoSkillConsts.xml";
/*     */     try
/*     */     {
...
/*     */         }
/*     */       }
/*  91 */       this.NEED_SILVER_PER_GRID = Integer.valueOf(((Element)data.get("NEED_SILVER_PER_GRID")).attributeValue("value")).intValue();
/*  92 */       this.NEED_ITEM_NUM = Integer.valueOf(((Element)data.get("NEED_ITEM_NUM")).attributeValue("value")).intValue();
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/* 103 */     String path = dir + "mzm.gsp.skill.confbean.LianYaoSkillConsts.bny";
/*     */     try
/*     */     {
...
/* 118 */         this.NEED_SILVER_PER_GRID = _os_.unmarshal_int();
/* 119 */         this.NEED_ITEM_NUM = _os_.unmarshal_int();
/*     */       }
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*     */   {
/* 130 */     String path = dir + "mzm.gsp.skill.confbean.LianYaoSkillConsts.bny";
/*     */     try
/*     */     {
...
/* 145 */         this.NEED_SILVER_PER_GRID = _os_.unmarshal_int();
/* 146 */         this.NEED_ITEM_NUM = _os_.unmarshal_int();
/*     */       }
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*     */   }
/*     */   
/*     */   public static void setInstance(LianYaoSkillConsts newInstance)
/*     */   {
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\skill\confbean\LianYaoSkillConsts.class
