...
/*     */ 
/*     */ public class SXiuLianSkillCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SXiuLianSkillCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SXiuLianSkillCfg> all = null;
/*     */   
/*     */   public int id;
...
/*  28 */     this.target = Integer.valueOf(rootElement.attributeValue("target")).intValue();
/*  29 */     this.skillId = Integer.valueOf(rootElement.attributeValue("skillId")).intValue();
/*  30 */     this.levelcfgid = Integer.valueOf(rootElement.attributeValue("levelcfgid")).intValue();
/*     */   }
/*     */   
...
/*  37 */     _os_.marshal(this.target);
/*  38 */     _os_.marshal(this.skillId);
...
/*  47 */     this.target = _os_.unmarshal_int();
/*  48 */     this.skillId = _os_.unmarshal_int();
/*  49 */     this.levelcfgid = _os_.unmarshal_int();
/*  50 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  55 */     String path = dir + "mzm.gsp.skill.confbean.SXiuLianSkillCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  68 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.skill.confbean.SXiuLianSkillCfg"))
/*     */         {
/*     */ 
/*  71 */           SXiuLianSkillCfg obj = new SXiuLianSkillCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SXiuLianSkillCfg> all)
/*     */   {
/*  85 */     String path = dir + "mzm.gsp.skill.confbean.SXiuLianSkillCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  97 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.skill.confbean.SXiuLianSkillCfg"))
/*     */         {
/*     */ 
/* 100 */           SXiuLianSkillCfg obj = new SXiuLianSkillCfg();
...
/*     */     
/* 116 */     String path = dir + "mzm.gsp.skill.confbean.SXiuLianSkillCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 143 */           SXiuLianSkillCfg _v_ = new SXiuLianSkillCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SXiuLianSkillCfg> all)
/*     */   {
/* 163 */     String path = dir + "mzm.gsp.skill.confbean.SXiuLianSkillCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 190 */           SXiuLianSkillCfg _v_ = new SXiuLianSkillCfg();
...
/*     */ 
/*     */ 
/*     */   public static SXiuLianSkillCfg getOld(int key)
/*     */   {
/* 211 */     return (SXiuLianSkillCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SXiuLianSkillCfg get(int key)
/*     */   {
/* 216 */     return (SXiuLianSkillCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SXiuLianSkillCfg> getOldAll()
/*     */   {
/* 221 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SXiuLianSkillCfg> getAll()
/*     */   {
/* 226 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SXiuLianSkillCfg> newAll)
/*     */   {
/* 231 */     oldAll = all;
/* 232 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\skill\confbean\SXiuLianSkillCfg.class
