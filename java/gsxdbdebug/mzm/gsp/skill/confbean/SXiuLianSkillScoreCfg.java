...
/*     */ 
/*     */ public class SXiuLianSkillScoreCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SXiuLianSkillScoreCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SXiuLianSkillScoreCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public String templatename;
/*     */   public int xiuLianSkillId;
...
/*  28 */     this.xiuLianSkillId = Integer.valueOf(rootElement.attributeValue("xiuLianSkillId")).intValue();
/*  29 */     this.skillLevel = Integer.valueOf(rootElement.attributeValue("skillLevel")).intValue();
...
/*  37 */     _os_.marshal(this.xiuLianSkillId);
/*  38 */     _os_.marshal(this.skillLevel);
...
/*  47 */     this.xiuLianSkillId = _os_.unmarshal_int();
/*  48 */     this.skillLevel = _os_.unmarshal_int();
...
/*     */   {
/*  55 */     String path = dir + "mzm.gsp.skill.confbean.SXiuLianSkillScoreCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  68 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.skill.confbean.SXiuLianSkillScoreCfg"))
/*     */         {
/*     */ 
/*  71 */           SXiuLianSkillScoreCfg obj = new SXiuLianSkillScoreCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SXiuLianSkillScoreCfg> all)
/*     */   {
/*  85 */     String path = dir + "mzm.gsp.skill.confbean.SXiuLianSkillScoreCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  97 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.skill.confbean.SXiuLianSkillScoreCfg"))
/*     */         {
/*     */ 
/* 100 */           SXiuLianSkillScoreCfg obj = new SXiuLianSkillScoreCfg();
...
/*     */     
/* 116 */     String path = dir + "mzm.gsp.skill.confbean.SXiuLianSkillScoreCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 143 */           SXiuLianSkillScoreCfg _v_ = new SXiuLianSkillScoreCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SXiuLianSkillScoreCfg> all)
/*     */   {
/* 163 */     String path = dir + "mzm.gsp.skill.confbean.SXiuLianSkillScoreCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 190 */           SXiuLianSkillScoreCfg _v_ = new SXiuLianSkillScoreCfg();
...
/*     */ 
/*     */ 
/*     */   public static SXiuLianSkillScoreCfg getOld(int key)
/*     */   {
/* 211 */     return (SXiuLianSkillScoreCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SXiuLianSkillScoreCfg get(int key)
/*     */   {
/* 216 */     return (SXiuLianSkillScoreCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SXiuLianSkillScoreCfg> getOldAll()
/*     */   {
/* 221 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SXiuLianSkillScoreCfg> getAll()
/*     */   {
/* 226 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SXiuLianSkillScoreCfg> newAll)
/*     */   {
/* 231 */     oldAll = all;
/* 232 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\skill\confbean\SXiuLianSkillScoreCfg.class
