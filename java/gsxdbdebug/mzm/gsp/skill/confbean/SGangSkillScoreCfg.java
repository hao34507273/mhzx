...
/*     */ 
/*     */ public class SGangSkillScoreCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SGangSkillScoreCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SGangSkillScoreCfg> all = null;
/*     */   
/*     */   public int id;
/*  19 */   public HashMap<Integer, Integer> skillLevelScore = new HashMap();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.id = Integer.valueOf(rootElement.attributeValue("id")).intValue();
/*     */     
/*  25 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "skillLevelScore");
...
/*     */         }
/*     */         
/*  76 */         this.skillLevelScore.put(Integer.valueOf(_k_), Integer.valueOf(_v_));
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*  84 */     _os_.compact_uint32(this.skillLevelScore.size());
/*  85 */     for (java.util.Map.Entry<Integer, Integer> _e_ : this.skillLevelScore.entrySet())
/*     */     {
...
/* 102 */       this.skillLevelScore.put(Integer.valueOf(_k_), Integer.valueOf(_v_));
/*     */     }
/* 104 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/* 109 */     String path = dir + "mzm.gsp.skill.confbean.SGangSkillScoreCfg.xml";
/*     */     
/*     */     try
/*     */     {
/* 113 */       all = new HashMap();
...
/* 122 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.skill.confbean.SGangSkillScoreCfg"))
/*     */         {
/*     */ 
/* 125 */           SGangSkillScoreCfg obj = new SGangSkillScoreCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SGangSkillScoreCfg> all)
/*     */   {
/* 139 */     String path = dir + "mzm.gsp.skill.confbean.SGangSkillScoreCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 151 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.skill.confbean.SGangSkillScoreCfg"))
/*     */         {
/*     */ 
/* 154 */           SGangSkillScoreCfg obj = new SGangSkillScoreCfg();
...
/* 168 */     all = new HashMap();
/*     */     
/* 170 */     String path = dir + "mzm.gsp.skill.confbean.SGangSkillScoreCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 197 */           SGangSkillScoreCfg _v_ = new SGangSkillScoreCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SGangSkillScoreCfg> all)
/*     */   {
/* 217 */     String path = dir + "mzm.gsp.skill.confbean.SGangSkillScoreCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 244 */           SGangSkillScoreCfg _v_ = new SGangSkillScoreCfg();
...
/*     */ 
/*     */ 
/*     */   public static SGangSkillScoreCfg getOld(int key)
/*     */   {
/* 265 */     return (SGangSkillScoreCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SGangSkillScoreCfg get(int key)
/*     */   {
/* 270 */     return (SGangSkillScoreCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SGangSkillScoreCfg> getOldAll()
/*     */   {
/* 275 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SGangSkillScoreCfg> getAll()
/*     */   {
/* 280 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SGangSkillScoreCfg> newAll)
/*     */   {
/* 285 */     oldAll = all;
/* 286 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\skill\confbean\SGangSkillScoreCfg.class
