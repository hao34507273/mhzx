...
/*     */ 
/*     */ public class SSkillTargetPosSortCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SSkillTargetPosSortCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SSkillTargetPosSortCfg> all = null;
/*     */   
/*     */   public int group;
/*  19 */   public HashMap<Integer, PosSortRule> posSortMap = new HashMap();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.group = Integer.valueOf(rootElement.attributeValue("group")).intValue();
/*     */     
/*  25 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "posSortMap");
...
/*  51 */             keyElem = elem;
/*     */           }
/*  53 */           else if ((valueElem == null) && (elem.getName().equalsIgnoreCase("mzm.gsp.skill.confbean.PosSortRule")))
/*     */           {
/*  55 */             valueElem = elem;
/*     */           }
/*     */         }
...
/*     */         }
/*     */         
/*  77 */         this.posSortMap.put(Integer.valueOf(_k_), _v_);
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*     */   {
/*  84 */     _os_.marshal(this.group);
/*  85 */     _os_.compact_uint32(this.posSortMap.size());
/*  86 */     for (java.util.Map.Entry<Integer, PosSortRule> _e_ : this.posSortMap.entrySet())
/*     */     {
...
/*     */   {
/*  96 */     this.group = _os_.unmarshal_int();
/*  97 */     for (int _size_ = _os_.uncompact_uint32(); _size_ > 0; _size_--)
/*     */     {
/*     */ 
/* 100 */       int _k_ = _os_.unmarshal_int();
/*     */       
/* 102 */       PosSortRule _v_ = new PosSortRule();
/* 103 */       _v_.unmarshal(_os_);
/* 104 */       this.posSortMap.put(Integer.valueOf(_k_), _v_);
/*     */     }
/* 106 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/* 111 */     String path = dir + "mzm.gsp.skill.confbean.SSkillTargetPosSortCfg.xml";
/*     */     
/*     */     try
/*     */     {
/* 115 */       all = new HashMap();
...
/* 124 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.skill.confbean.SSkillTargetPosSortCfg"))
/*     */         {
/*     */ 
/* 127 */           SSkillTargetPosSortCfg obj = new SSkillTargetPosSortCfg();
/* 128 */           obj.loadFromXml(elem);
/* 129 */           if (all.put(Integer.valueOf(obj.group), obj) != null) {
/* 130 */             throw new RuntimeException("duplicate key : " + obj.group);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SSkillTargetPosSortCfg> all)
/*     */   {
/* 141 */     String path = dir + "mzm.gsp.skill.confbean.SSkillTargetPosSortCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 153 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.skill.confbean.SSkillTargetPosSortCfg"))
/*     */         {
/*     */ 
/* 156 */           SSkillTargetPosSortCfg obj = new SSkillTargetPosSortCfg();
/* 157 */           obj.loadFromXml(elem);
/* 158 */           if (all.put(Integer.valueOf(obj.group), obj) != null) {
/* 159 */             throw new RuntimeException("duplicate key : " + obj.group);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/* 170 */     all = new HashMap();
/*     */     
/* 172 */     String path = dir + "mzm.gsp.skill.confbean.SSkillTargetPosSortCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 199 */           SSkillTargetPosSortCfg _v_ = new SSkillTargetPosSortCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SSkillTargetPosSortCfg> all)
/*     */   {
/* 219 */     String path = dir + "mzm.gsp.skill.confbean.SSkillTargetPosSortCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 246 */           SSkillTargetPosSortCfg _v_ = new SSkillTargetPosSortCfg();
...
/*     */ 
/*     */ 
/*     */   public static SSkillTargetPosSortCfg getOld(int key)
/*     */   {
/* 267 */     return (SSkillTargetPosSortCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SSkillTargetPosSortCfg get(int key)
/*     */   {
/* 272 */     return (SSkillTargetPosSortCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SSkillTargetPosSortCfg> getOldAll()
/*     */   {
/* 277 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SSkillTargetPosSortCfg> getAll()
/*     */   {
/* 282 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SSkillTargetPosSortCfg> newAll)
/*     */   {
/* 287 */     oldAll = all;
/* 288 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\skill\confbean\SSkillTargetPosSortCfg.class
