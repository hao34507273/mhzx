...
/*     */ 
/*     */ public class SMoveTempAction implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SMoveTempAction> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SMoveTempAction> all = null;
/*     */   
/*     */   public int id;
/*     */   public int duration;
/*     */   
...
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.skill.confbean.SMoveTempAction.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.skill.confbean.SMoveTempAction"))
/*     */         {
/*     */ 
/*  59 */           SMoveTempAction obj = new SMoveTempAction();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SMoveTempAction> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.skill.confbean.SMoveTempAction.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.skill.confbean.SMoveTempAction"))
/*     */         {
/*     */ 
/*  88 */           SMoveTempAction obj = new SMoveTempAction();
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.skill.confbean.SMoveTempAction.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           SMoveTempAction _v_ = new SMoveTempAction();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SMoveTempAction> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.skill.confbean.SMoveTempAction.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           SMoveTempAction _v_ = new SMoveTempAction();
...
/*     */ 
/*     */ 
/*     */   public static SMoveTempAction getOld(int key)
/*     */   {
/* 199 */     return (SMoveTempAction)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SMoveTempAction get(int key)
/*     */   {
/* 204 */     return (SMoveTempAction)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMoveTempAction> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMoveTempAction> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SMoveTempAction> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\skill\confbean\SMoveTempAction.class
