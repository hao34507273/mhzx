...
/*     */ 
/*     */ public class STXiuLianSkillBagLevelUpCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, STXiuLianSkillBagLevelUpCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, STXiuLianSkillBagLevelUpCfg> all = null;
/*     */   
/*     */   public int type;
/*  19 */   public HashMap<Integer, STXiuLianSkillBagLevelUpCfgInfo> level2skillinfo = new HashMap();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.type = Integer.valueOf(rootElement.attributeValue("type")).intValue();
/*     */     
/*  25 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "level2skillinfo");
...
/*  51 */             keyElem = elem;
/*     */           }
/*  53 */           else if ((valueElem == null) && (elem.getName().equalsIgnoreCase("mzm.gsp.skill.confbean.STXiuLianSkillBagLevelUpCfgInfo")))
/*     */           {
/*  55 */             valueElem = elem;
/*     */           }
/*     */         }
...
/*     */         
/*     */         int _k_;
/*     */         STXiuLianSkillBagLevelUpCfgInfo _v_;
/*     */         try
/*     */         {
/*  68 */           _k_ = Integer.valueOf(keyElem.getText()).intValue();
/*  69 */           _v_ = new STXiuLianSkillBagLevelUpCfgInfo();
...
/*     */         }
/*     */         
/*  77 */         this.level2skillinfo.put(Integer.valueOf(_k_), _v_);
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*  85 */     _os_.compact_uint32(this.level2skillinfo.size());
/*  86 */     for (java.util.Map.Entry<Integer, STXiuLianSkillBagLevelUpCfgInfo> _e_ : this.level2skillinfo.entrySet())
/*     */     {
...
/*     */       
/* 102 */       STXiuLianSkillBagLevelUpCfgInfo _v_ = new STXiuLianSkillBagLevelUpCfgInfo();
/* 103 */       _v_.unmarshal(_os_);
/* 104 */       this.level2skillinfo.put(Integer.valueOf(_k_), _v_);
/*     */     }
/* 106 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/* 111 */     String path = dir + "mzm.gsp.skill.confbean.STXiuLianSkillBagLevelUpCfg.xml";
/*     */     
/*     */     try
/*     */     {
/* 115 */       all = new HashMap();
...
/* 124 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.skill.confbean.STXiuLianSkillBagLevelUpCfg"))
/*     */         {
/*     */ 
/* 127 */           STXiuLianSkillBagLevelUpCfg obj = new STXiuLianSkillBagLevelUpCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, STXiuLianSkillBagLevelUpCfg> all)
/*     */   {
/* 141 */     String path = dir + "mzm.gsp.skill.confbean.STXiuLianSkillBagLevelUpCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 153 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.skill.confbean.STXiuLianSkillBagLevelUpCfg"))
/*     */         {
/*     */ 
/* 156 */           STXiuLianSkillBagLevelUpCfg obj = new STXiuLianSkillBagLevelUpCfg();
...
/* 170 */     all = new HashMap();
/*     */     
/* 172 */     String path = dir + "mzm.gsp.skill.confbean.STXiuLianSkillBagLevelUpCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 199 */           STXiuLianSkillBagLevelUpCfg _v_ = new STXiuLianSkillBagLevelUpCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, STXiuLianSkillBagLevelUpCfg> all)
/*     */   {
/* 219 */     String path = dir + "mzm.gsp.skill.confbean.STXiuLianSkillBagLevelUpCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 246 */           STXiuLianSkillBagLevelUpCfg _v_ = new STXiuLianSkillBagLevelUpCfg();
...
/*     */ 
/*     */ 
/*     */   public static STXiuLianSkillBagLevelUpCfg getOld(int key)
/*     */   {
/* 267 */     return (STXiuLianSkillBagLevelUpCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static STXiuLianSkillBagLevelUpCfg get(int key)
/*     */   {
/* 272 */     return (STXiuLianSkillBagLevelUpCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, STXiuLianSkillBagLevelUpCfg> getOldAll()
/*     */   {
/* 277 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, STXiuLianSkillBagLevelUpCfg> getAll()
/*     */   {
/* 282 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, STXiuLianSkillBagLevelUpCfg> newAll)
/*     */   {
/* 287 */     oldAll = all;
/* 288 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\skill\confbean\STXiuLianSkillBagLevelUpCfg.class
