...
/*     */ 
/*     */ public class SCookDrugQualityCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SCookDrugQualityCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SCookDrugQualityCfg> all = null;
/*     */   
/*     */   public int id;
...
/*  32 */     this.itemMaxQuality = Integer.valueOf(rootElement.attributeValue("itemMaxQuality")).intValue();
/*     */   }
/*     */   
...
/*  42 */     _os_.marshal(this.itemMaxQuality);
/*  43 */     return _os_;
/*     */   }
/*     */   
...
/*  53 */     this.itemMaxQuality = _os_.unmarshal_int();
/*  54 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  59 */     String path = dir + "mzm.gsp.skill.confbean.SCookDrugQualityCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  72 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.skill.confbean.SCookDrugQualityCfg"))
/*     */         {
/*     */ 
/*  75 */           SCookDrugQualityCfg obj = new SCookDrugQualityCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SCookDrugQualityCfg> all)
/*     */   {
/*  89 */     String path = dir + "mzm.gsp.skill.confbean.SCookDrugQualityCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 101 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.skill.confbean.SCookDrugQualityCfg"))
/*     */         {
/*     */ 
/* 104 */           SCookDrugQualityCfg obj = new SCookDrugQualityCfg();
...
/*     */     
/* 120 */     String path = dir + "mzm.gsp.skill.confbean.SCookDrugQualityCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 147 */           SCookDrugQualityCfg _v_ = new SCookDrugQualityCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SCookDrugQualityCfg> all)
/*     */   {
/* 167 */     String path = dir + "mzm.gsp.skill.confbean.SCookDrugQualityCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 194 */           SCookDrugQualityCfg _v_ = new SCookDrugQualityCfg();
...
/*     */ 
/*     */ 
/*     */   public static SCookDrugQualityCfg getOld(int key)
/*     */   {
/* 215 */     return (SCookDrugQualityCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SCookDrugQualityCfg get(int key)
/*     */   {
/* 220 */     return (SCookDrugQualityCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SCookDrugQualityCfg> getOldAll()
/*     */   {
/* 225 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SCookDrugQualityCfg> getAll()
/*     */   {
/* 230 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SCookDrugQualityCfg> newAll)
/*     */   {
/* 235 */     oldAll = all;
/* 236 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\skill\confbean\SCookDrugQualityCfg.class
