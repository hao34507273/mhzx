...
/*     */ 
/*     */ public class GangSkillConst
/*     */ {
/*  13 */   private static volatile GangSkillConst oldInstance = null;
/*     */   
/*  15 */   private static GangSkillConst instance = new GangSkillConst();
/*     */   
/*     */   public int ENABLE_GANG_SKILL_ROLE_LEVEL;
/*     */   
/*     */   public int MAX_SKILL_LEVEL;
/*     */   
/*     */   public static GangSkillConst getOldInstance()
/*     */   {
/*  23 */     return oldInstance;
/*     */   }
/*     */   
/*     */   public static GangSkillConst getInstance()
/*     */   {
/*  28 */     return instance;
/*     */   }
/*     */   
...
/*     */   {
/*  41 */     String path = dir + "mzm.gsp.skill.confbean.GangSkillConst.xml";
/*     */     try
/*     */     {
...
/*     */         }
/*     */       }
/*  61 */       this.ENABLE_GANG_SKILL_ROLE_LEVEL = Integer.valueOf(((Element)data.get("ENABLE_GANG_SKILL_ROLE_LEVEL")).attributeValue("value")).intValue();
/*  62 */       this.MAX_SKILL_LEVEL = Integer.valueOf(((Element)data.get("MAX_SKILL_LEVEL")).attributeValue("value")).intValue();
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*  71 */     String path = dir + "mzm.gsp.skill.confbean.GangSkillConst.xml";
/*     */     try
/*     */     {
...
/*     */         }
/*     */       }
/*  91 */       this.ENABLE_GANG_SKILL_ROLE_LEVEL = Integer.valueOf(((Element)data.get("ENABLE_GANG_SKILL_ROLE_LEVEL")).attributeValue("value")).intValue();
/*  92 */       this.MAX_SKILL_LEVEL = Integer.valueOf(((Element)data.get("MAX_SKILL_LEVEL")).attributeValue("value")).intValue();
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/* 103 */     String path = dir + "mzm.gsp.skill.confbean.GangSkillConst.bny";
/*     */     try
/*     */     {
...
/* 118 */         this.ENABLE_GANG_SKILL_ROLE_LEVEL = _os_.unmarshal_int();
/* 119 */         this.MAX_SKILL_LEVEL = _os_.unmarshal_int();
/*     */       }
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*     */   {
/* 130 */     String path = dir + "mzm.gsp.skill.confbean.GangSkillConst.bny";
/*     */     try
/*     */     {
...
/* 145 */         this.ENABLE_GANG_SKILL_ROLE_LEVEL = _os_.unmarshal_int();
/* 146 */         this.MAX_SKILL_LEVEL = _os_.unmarshal_int();
/*     */       }
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*     */   }
/*     */   
/*     */   public static void setInstance(GangSkillConst newInstance)
/*     */   {
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\skill\confbean\GangSkillConst.class
