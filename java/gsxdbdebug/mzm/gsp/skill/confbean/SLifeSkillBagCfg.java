...
/*     */ 
/*     */ public class SLifeSkillBagCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SLifeSkillBagCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SLifeSkillBagCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public String templatename;
/*     */   public String name;
/*     */   public int skillBagType;
/*  22 */   public java.util.LinkedList<Integer> skillBagList = new java.util.LinkedList();
/*     */   public int levelUpTypeId;
/*     */   
...
/*  30 */     this.skillBagType = Integer.valueOf(rootElement.attributeValue("skillBagType")).intValue();
/*     */     
/*  32 */     Element collectionElement = util.XmlHelper.getVariableElement(rootElement, "skillBagList");
...
/*     */         }
/*     */         
/*  57 */         this.skillBagList.add(Integer.valueOf(_v_));
/*     */       }
/*     */     }
/*  60 */     this.levelUpTypeId = Integer.valueOf(rootElement.attributeValue("levelUpTypeId")).intValue();
/*     */   }
/*     */   
...
/*  67 */     _os_.marshal(this.name, "UTF-8");
/*  68 */     _os_.marshal(this.skillBagType);
/*  69 */     _os_.compact_uint32(this.skillBagList.size());
/*  70 */     for (Integer _v_ : this.skillBagList)
/*     */     {
/*  72 */       _os_.marshal(_v_.intValue());
/*     */     }
/*  74 */     _os_.marshal(this.levelUpTypeId);
/*  75 */     return _os_;
/*     */   }
/*     */   
...
/*  83 */     this.skillBagType = _os_.unmarshal_int();
/*  84 */     for (int _size_ = _os_.uncompact_uint32(); _size_ > 0; _size_--)
/*     */     {
/*     */ 
/*  87 */       int _v_ = _os_.unmarshal_int();
/*  88 */       this.skillBagList.add(Integer.valueOf(_v_));
/*     */     }
/*  90 */     this.levelUpTypeId = _os_.unmarshal_int();
/*  91 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  96 */     String path = dir + "mzm.gsp.skill.confbean.SLifeSkillBagCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 109 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.skill.confbean.SLifeSkillBagCfg"))
/*     */         {
/*     */ 
/* 112 */           SLifeSkillBagCfg obj = new SLifeSkillBagCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SLifeSkillBagCfg> all)
/*     */   {
/* 126 */     String path = dir + "mzm.gsp.skill.confbean.SLifeSkillBagCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 138 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.skill.confbean.SLifeSkillBagCfg"))
/*     */         {
/*     */ 
/* 141 */           SLifeSkillBagCfg obj = new SLifeSkillBagCfg();
...
/*     */     
/* 157 */     String path = dir + "mzm.gsp.skill.confbean.SLifeSkillBagCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 184 */           SLifeSkillBagCfg _v_ = new SLifeSkillBagCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SLifeSkillBagCfg> all)
/*     */   {
/* 204 */     String path = dir + "mzm.gsp.skill.confbean.SLifeSkillBagCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 231 */           SLifeSkillBagCfg _v_ = new SLifeSkillBagCfg();
...
/*     */ 
/*     */ 
/*     */   public static SLifeSkillBagCfg getOld(int key)
/*     */   {
/* 252 */     return (SLifeSkillBagCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SLifeSkillBagCfg get(int key)
/*     */   {
/* 257 */     return (SLifeSkillBagCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SLifeSkillBagCfg> getOldAll()
/*     */   {
/* 262 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SLifeSkillBagCfg> getAll()
/*     */   {
/* 267 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SLifeSkillBagCfg> newAll)
/*     */   {
/* 272 */     oldAll = all;
/* 273 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\skill\confbean\SLifeSkillBagCfg.class
