...
/*     */ 
/*     */ public class SGangSkillScoreOriginalCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SGangSkillScoreOriginalCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SGangSkillScoreOriginalCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public int gangSkillCfgid;
...
/*  26 */     this.gangSkillCfgid = Integer.valueOf(rootElement.attributeValue("gangSkillCfgid")).intValue();
/*  27 */     this.skillLevel = Integer.valueOf(rootElement.attributeValue("skillLevel")).intValue();
/*  28 */     this.score = Integer.valueOf(rootElement.attributeValue("score")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  33 */     _os_.marshal(this.id);
/*  34 */     _os_.marshal(this.gangSkillCfgid);
/*  35 */     _os_.marshal(this.skillLevel);
...
/*  43 */     this.gangSkillCfgid = _os_.unmarshal_int();
/*  44 */     this.skillLevel = _os_.unmarshal_int();
...
/*     */   {
/*  51 */     String path = dir + "mzm.gsp.skill.confbean.SGangSkillScoreOriginalCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  64 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.skill.confbean.SGangSkillScoreOriginalCfg"))
/*     */         {
/*     */ 
/*  67 */           SGangSkillScoreOriginalCfg obj = new SGangSkillScoreOriginalCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SGangSkillScoreOriginalCfg> all)
/*     */   {
/*  81 */     String path = dir + "mzm.gsp.skill.confbean.SGangSkillScoreOriginalCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.skill.confbean.SGangSkillScoreOriginalCfg"))
/*     */         {
/*     */ 
/*  96 */           SGangSkillScoreOriginalCfg obj = new SGangSkillScoreOriginalCfg();
...
/*     */     
/* 112 */     String path = dir + "mzm.gsp.skill.confbean.SGangSkillScoreOriginalCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 139 */           SGangSkillScoreOriginalCfg _v_ = new SGangSkillScoreOriginalCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SGangSkillScoreOriginalCfg> all)
/*     */   {
/* 159 */     String path = dir + "mzm.gsp.skill.confbean.SGangSkillScoreOriginalCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 186 */           SGangSkillScoreOriginalCfg _v_ = new SGangSkillScoreOriginalCfg();
...
/*     */ 
/*     */ 
/*     */   public static SGangSkillScoreOriginalCfg getOld(int key)
/*     */   {
/* 207 */     return (SGangSkillScoreOriginalCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SGangSkillScoreOriginalCfg get(int key)
/*     */   {
/* 212 */     return (SGangSkillScoreOriginalCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SGangSkillScoreOriginalCfg> getOldAll()
/*     */   {
/* 217 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SGangSkillScoreOriginalCfg> getAll()
/*     */   {
/* 222 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SGangSkillScoreOriginalCfg> newAll)
/*     */   {
/* 227 */     oldAll = all;
/* 228 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\skill\confbean\SGangSkillScoreOriginalCfg.class
