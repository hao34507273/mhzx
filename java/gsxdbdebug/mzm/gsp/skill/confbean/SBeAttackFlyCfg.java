...
/*     */ 
/*     */ public class SBeAttackFlyCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SBeAttackFlyCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SBeAttackFlyCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public int time;
/*     */   
...
/*  37 */     this.time = _os_.unmarshal_int();
/*  38 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.skill.confbean.SBeAttackFlyCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.skill.confbean.SBeAttackFlyCfg"))
/*     */         {
/*     */ 
/*  59 */           SBeAttackFlyCfg obj = new SBeAttackFlyCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SBeAttackFlyCfg> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.skill.confbean.SBeAttackFlyCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.skill.confbean.SBeAttackFlyCfg"))
/*     */         {
/*     */ 
/*  88 */           SBeAttackFlyCfg obj = new SBeAttackFlyCfg();
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.skill.confbean.SBeAttackFlyCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           SBeAttackFlyCfg _v_ = new SBeAttackFlyCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SBeAttackFlyCfg> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.skill.confbean.SBeAttackFlyCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           SBeAttackFlyCfg _v_ = new SBeAttackFlyCfg();
...
/*     */ 
/*     */ 
/*     */   public static SBeAttackFlyCfg getOld(int key)
/*     */   {
/* 199 */     return (SBeAttackFlyCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SBeAttackFlyCfg get(int key)
/*     */   {
/* 204 */     return (SBeAttackFlyCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SBeAttackFlyCfg> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SBeAttackFlyCfg> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SBeAttackFlyCfg> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\skill\confbean\SBeAttackFlyCfg.class
