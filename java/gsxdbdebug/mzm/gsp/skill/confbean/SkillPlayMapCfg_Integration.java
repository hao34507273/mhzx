...
/*     */ 
/*     */ public class SkillPlayMapCfg_Integration implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SkillPlayMapCfg_Integration> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SkillPlayMapCfg_Integration> all = null;
/*     */   
/*     */   public int id;
...
/*  27 */     this.sourceSkillPlayid = Integer.valueOf(rootElement.attributeValue("sourceSkillPlayid")).intValue();
/*  28 */     this.finalSkillPlayid = Integer.valueOf(rootElement.attributeValue("finalSkillPlayid")).intValue();
/*  29 */     this.fightStateGroupId = Integer.valueOf(rootElement.attributeValue("fightStateGroupId")).intValue();
/*  30 */     this.fightState = Integer.valueOf(rootElement.attributeValue("fightState")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  35 */     _os_.marshal(this.id);
/*  36 */     _os_.marshal(this.sourceSkillPlayid);
/*  37 */     _os_.marshal(this.finalSkillPlayid);
/*  38 */     _os_.marshal(this.fightStateGroupId);
/*  39 */     _os_.marshal(this.fightState);
/*  40 */     return _os_;
/*     */   }
/*     */   
...
/*  46 */     this.sourceSkillPlayid = _os_.unmarshal_int();
/*  47 */     this.finalSkillPlayid = _os_.unmarshal_int();
/*  48 */     this.fightStateGroupId = _os_.unmarshal_int();
/*  49 */     this.fightState = _os_.unmarshal_int();
/*  50 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  55 */     String path = dir + "mzm.gsp.skill.confbean.SkillPlayMapCfg_Integration.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  68 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.skill.confbean.SkillPlayMapCfg_Integration"))
/*     */         {
/*     */ 
/*  71 */           SkillPlayMapCfg_Integration obj = new SkillPlayMapCfg_Integration();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SkillPlayMapCfg_Integration> all)
/*     */   {
/*  85 */     String path = dir + "mzm.gsp.skill.confbean.SkillPlayMapCfg_Integration.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  97 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.skill.confbean.SkillPlayMapCfg_Integration"))
/*     */         {
/*     */ 
/* 100 */           SkillPlayMapCfg_Integration obj = new SkillPlayMapCfg_Integration();
...
/*     */     
/* 116 */     String path = dir + "mzm.gsp.skill.confbean.SkillPlayMapCfg_Integration.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 143 */           SkillPlayMapCfg_Integration _v_ = new SkillPlayMapCfg_Integration();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SkillPlayMapCfg_Integration> all)
/*     */   {
/* 163 */     String path = dir + "mzm.gsp.skill.confbean.SkillPlayMapCfg_Integration.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 190 */           SkillPlayMapCfg_Integration _v_ = new SkillPlayMapCfg_Integration();
...
/*     */ 
/*     */ 
/*     */   public static SkillPlayMapCfg_Integration getOld(int key)
/*     */   {
/* 211 */     return (SkillPlayMapCfg_Integration)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SkillPlayMapCfg_Integration get(int key)
/*     */   {
/* 216 */     return (SkillPlayMapCfg_Integration)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SkillPlayMapCfg_Integration> getOldAll()
/*     */   {
/* 221 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SkillPlayMapCfg_Integration> getAll()
/*     */   {
/* 226 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SkillPlayMapCfg_Integration> newAll)
/*     */   {
/* 231 */     oldAll = all;
/* 232 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\skill\confbean\SkillPlayMapCfg_Integration.class
