...
/*     */ 
/*     */ public class SSkillEffectGroupSubCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SSkillEffectGroupSubCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SSkillEffectGroupSubCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public int effectid;
/*  20 */   public java.util.ArrayList<Integer> effectformula = new java.util.ArrayList();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  24 */     this.id = Integer.valueOf(rootElement.attributeValue("id")).intValue();
/*  25 */     this.effectid = Integer.valueOf(rootElement.attributeValue("effectid")).intValue();
/*     */     
/*  27 */     Element collectionElement = util.XmlHelper.getVariableElement(rootElement, "effectformula");
...
/*     */         }
/*     */         
/*  52 */         this.effectformula.add(Integer.valueOf(_v_));
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*  60 */     _os_.marshal(this.effectid);
/*  61 */     _os_.compact_uint32(this.effectformula.size());
/*  62 */     for (Integer _v_ : this.effectformula)
/*     */     {
...
/*     */   {
/*  84 */     String path = dir + "mzm.gsp.skill.confbean.SSkillEffectGroupSubCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  97 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.skill.confbean.SSkillEffectGroupSubCfg"))
/*     */         {
/*     */ 
/* 100 */           SSkillEffectGroupSubCfg obj = new SSkillEffectGroupSubCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SSkillEffectGroupSubCfg> all)
/*     */   {
/* 114 */     String path = dir + "mzm.gsp.skill.confbean.SSkillEffectGroupSubCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 126 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.skill.confbean.SSkillEffectGroupSubCfg"))
/*     */         {
/*     */ 
/* 129 */           SSkillEffectGroupSubCfg obj = new SSkillEffectGroupSubCfg();
...
/*     */     
/* 145 */     String path = dir + "mzm.gsp.skill.confbean.SSkillEffectGroupSubCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 172 */           SSkillEffectGroupSubCfg _v_ = new SSkillEffectGroupSubCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SSkillEffectGroupSubCfg> all)
/*     */   {
/* 192 */     String path = dir + "mzm.gsp.skill.confbean.SSkillEffectGroupSubCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 219 */           SSkillEffectGroupSubCfg _v_ = new SSkillEffectGroupSubCfg();
...
/*     */ 
/*     */ 
/*     */   public static SSkillEffectGroupSubCfg getOld(int key)
/*     */   {
/* 240 */     return (SSkillEffectGroupSubCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SSkillEffectGroupSubCfg get(int key)
/*     */   {
/* 245 */     return (SSkillEffectGroupSubCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SSkillEffectGroupSubCfg> getOldAll()
/*     */   {
/* 250 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SSkillEffectGroupSubCfg> getAll()
/*     */   {
/* 255 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SSkillEffectGroupSubCfg> newAll)
/*     */   {
/* 260 */     oldAll = all;
/* 261 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\skill\confbean\SSkillEffectGroupSubCfg.class
