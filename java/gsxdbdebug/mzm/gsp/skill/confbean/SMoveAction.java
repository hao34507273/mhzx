...
/*     */ 
/*     */ public class SMoveAction implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SMoveAction> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SMoveAction> all = null;
/*     */   
/*     */   public int id;
/*     */   public int duration;
/*     */   
...
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.skill.confbean.SMoveAction.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.skill.confbean.SMoveAction"))
/*     */         {
/*     */ 
/*  59 */           SMoveAction obj = new SMoveAction();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SMoveAction> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.skill.confbean.SMoveAction.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.skill.confbean.SMoveAction"))
/*     */         {
/*     */ 
/*  88 */           SMoveAction obj = new SMoveAction();
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.skill.confbean.SMoveAction.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           SMoveAction _v_ = new SMoveAction();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SMoveAction> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.skill.confbean.SMoveAction.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           SMoveAction _v_ = new SMoveAction();
...
/*     */ 
/*     */ 
/*     */   public static SMoveAction getOld(int key)
/*     */   {
/* 199 */     return (SMoveAction)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SMoveAction get(int key)
/*     */   {
/* 204 */     return (SMoveAction)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMoveAction> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMoveAction> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SMoveAction> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\skill\confbean\SMoveAction.class
