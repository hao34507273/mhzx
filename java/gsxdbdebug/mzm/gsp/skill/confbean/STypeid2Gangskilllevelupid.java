...
/*     */ 
/*     */ public class STypeid2Gangskilllevelupid implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, STypeid2Gangskilllevelupid> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, STypeid2Gangskilllevelupid> all = null;
/*     */   
/*     */   public int typeId;
/*  19 */   public java.util.ArrayList<Integer> levelupids = new java.util.ArrayList();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.typeId = Integer.valueOf(rootElement.attributeValue("typeId")).intValue();
/*     */     
/*  25 */     Element collectionElement = util.XmlHelper.getVariableElement(rootElement, "levelupids");
...
/*     */         }
/*     */         
/*  50 */         this.levelupids.add(Integer.valueOf(_v_));
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*  58 */     _os_.compact_uint32(this.levelupids.size());
/*  59 */     for (Integer _v_ : this.levelupids)
/*     */     {
...
/*  73 */       this.levelupids.add(Integer.valueOf(_v_));
/*     */     }
/*  75 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/*  80 */     String path = dir + "mzm.gsp.skill.confbean.STypeid2Gangskilllevelupid.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.skill.confbean.STypeid2Gangskilllevelupid"))
/*     */         {
/*     */ 
/*  96 */           STypeid2Gangskilllevelupid obj = new STypeid2Gangskilllevelupid();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, STypeid2Gangskilllevelupid> all)
/*     */   {
/* 110 */     String path = dir + "mzm.gsp.skill.confbean.STypeid2Gangskilllevelupid.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 122 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.skill.confbean.STypeid2Gangskilllevelupid"))
/*     */         {
/*     */ 
/* 125 */           STypeid2Gangskilllevelupid obj = new STypeid2Gangskilllevelupid();
...
/*     */     
/* 141 */     String path = dir + "mzm.gsp.skill.confbean.STypeid2Gangskilllevelupid.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 168 */           STypeid2Gangskilllevelupid _v_ = new STypeid2Gangskilllevelupid();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, STypeid2Gangskilllevelupid> all)
/*     */   {
/* 188 */     String path = dir + "mzm.gsp.skill.confbean.STypeid2Gangskilllevelupid.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 215 */           STypeid2Gangskilllevelupid _v_ = new STypeid2Gangskilllevelupid();
...
/*     */ 
/*     */ 
/*     */   public static STypeid2Gangskilllevelupid getOld(int key)
/*     */   {
/* 236 */     return (STypeid2Gangskilllevelupid)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static STypeid2Gangskilllevelupid get(int key)
/*     */   {
/* 241 */     return (STypeid2Gangskilllevelupid)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, STypeid2Gangskilllevelupid> getOldAll()
/*     */   {
/* 246 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, STypeid2Gangskilllevelupid> getAll()
/*     */   {
/* 251 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, STypeid2Gangskilllevelupid> newAll)
/*     */   {
/* 256 */     oldAll = all;
/* 257 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\skill\confbean\STypeid2Gangskilllevelupid.class
