...
/*     */ 
/*     */ public class SSourceSkillsCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SSourceSkillsCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SSourceSkillsCfg> all = null;
/*     */   
/*     */   public int sourceSkillCfgid;
/*  19 */   public java.util.HashSet<Integer> skills = new java.util.HashSet();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.sourceSkillCfgid = Integer.valueOf(rootElement.attributeValue("sourceSkillCfgid")).intValue();
/*     */     
/*  25 */     Element collectionElement = util.XmlHelper.getVariableElement(rootElement, "skills");
...
/*     */         }
/*     */         
/*  50 */         this.skills.add(Integer.valueOf(_v_));
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*     */   {
/*  57 */     _os_.marshal(this.sourceSkillCfgid);
/*  58 */     _os_.compact_uint32(this.skills.size());
/*  59 */     for (Integer _v_ : this.skills)
/*     */     {
...
/*     */   {
/*  80 */     String path = dir + "mzm.gsp.skill.confbean.SSourceSkillsCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.skill.confbean.SSourceSkillsCfg"))
/*     */         {
/*     */ 
/*  96 */           SSourceSkillsCfg obj = new SSourceSkillsCfg();
/*  97 */           obj.loadFromXml(elem);
/*  98 */           if (all.put(Integer.valueOf(obj.sourceSkillCfgid), obj) != null) {
/*  99 */             throw new RuntimeException("duplicate key : " + obj.sourceSkillCfgid);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SSourceSkillsCfg> all)
/*     */   {
/* 110 */     String path = dir + "mzm.gsp.skill.confbean.SSourceSkillsCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 122 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.skill.confbean.SSourceSkillsCfg"))
/*     */         {
/*     */ 
/* 125 */           SSourceSkillsCfg obj = new SSourceSkillsCfg();
/* 126 */           obj.loadFromXml(elem);
/* 127 */           if (all.put(Integer.valueOf(obj.sourceSkillCfgid), obj) != null) {
/* 128 */             throw new RuntimeException("duplicate key : " + obj.sourceSkillCfgid);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 141 */     String path = dir + "mzm.gsp.skill.confbean.SSourceSkillsCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 168 */           SSourceSkillsCfg _v_ = new SSourceSkillsCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SSourceSkillsCfg> all)
/*     */   {
/* 188 */     String path = dir + "mzm.gsp.skill.confbean.SSourceSkillsCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 215 */           SSourceSkillsCfg _v_ = new SSourceSkillsCfg();
...
/*     */ 
/*     */ 
/*     */   public static SSourceSkillsCfg getOld(int key)
/*     */   {
/* 236 */     return (SSourceSkillsCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SSourceSkillsCfg get(int key)
/*     */   {
/* 241 */     return (SSourceSkillsCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SSourceSkillsCfg> getOldAll()
/*     */   {
/* 246 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SSourceSkillsCfg> getAll()
/*     */   {
/* 251 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SSourceSkillsCfg> newAll)
/*     */   {
/* 256 */     oldAll = all;
/* 257 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\skill\confbean\SSourceSkillsCfg.class
