...
/*     */ 
/*     */ public class SMountsSkillCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SMountsSkillCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SMountsSkillCfg> all = null;
/*     */   
/*     */   public int mountsSkillClassid;
/*  19 */   public HashMap<Integer, Integer> mountsSkillMap = new HashMap();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.mountsSkillClassid = Integer.valueOf(rootElement.attributeValue("mountsSkillClassid")).intValue();
/*     */     
/*  25 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "mountsSkillMap");
...
/*     */         }
/*     */         
/*  76 */         this.mountsSkillMap.put(Integer.valueOf(_k_), Integer.valueOf(_v_));
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*     */   {
/*  83 */     _os_.marshal(this.mountsSkillClassid);
/*  84 */     _os_.compact_uint32(this.mountsSkillMap.size());
/*  85 */     for (java.util.Map.Entry<Integer, Integer> _e_ : this.mountsSkillMap.entrySet())
/*     */     {
...
/*     */   {
/*  95 */     this.mountsSkillClassid = _os_.unmarshal_int();
...
/* 102 */       this.mountsSkillMap.put(Integer.valueOf(_k_), Integer.valueOf(_v_));
/*     */     }
/* 104 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/* 109 */     String path = dir + "mzm.gsp.skill.confbean.SMountsSkillCfg.xml";
/*     */     
/*     */     try
/*     */     {
/* 113 */       all = new HashMap();
...
/* 122 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.skill.confbean.SMountsSkillCfg"))
/*     */         {
/*     */ 
/* 125 */           SMountsSkillCfg obj = new SMountsSkillCfg();
/* 126 */           obj.loadFromXml(elem);
/* 127 */           if (all.put(Integer.valueOf(obj.mountsSkillClassid), obj) != null) {
/* 128 */             throw new RuntimeException("duplicate key : " + obj.mountsSkillClassid);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SMountsSkillCfg> all)
/*     */   {
/* 139 */     String path = dir + "mzm.gsp.skill.confbean.SMountsSkillCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 151 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.skill.confbean.SMountsSkillCfg"))
/*     */         {
/*     */ 
/* 154 */           SMountsSkillCfg obj = new SMountsSkillCfg();
/* 155 */           obj.loadFromXml(elem);
/* 156 */           if (all.put(Integer.valueOf(obj.mountsSkillClassid), obj) != null) {
/* 157 */             throw new RuntimeException("duplicate key : " + obj.mountsSkillClassid);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/* 168 */     all = new HashMap();
/*     */     
/* 170 */     String path = dir + "mzm.gsp.skill.confbean.SMountsSkillCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 197 */           SMountsSkillCfg _v_ = new SMountsSkillCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SMountsSkillCfg> all)
/*     */   {
/* 217 */     String path = dir + "mzm.gsp.skill.confbean.SMountsSkillCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 244 */           SMountsSkillCfg _v_ = new SMountsSkillCfg();
...
/*     */ 
/*     */ 
/*     */   public static SMountsSkillCfg getOld(int key)
/*     */   {
/* 265 */     return (SMountsSkillCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SMountsSkillCfg get(int key)
/*     */   {
/* 270 */     return (SMountsSkillCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMountsSkillCfg> getOldAll()
/*     */   {
/* 275 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMountsSkillCfg> getAll()
/*     */   {
/* 280 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SMountsSkillCfg> newAll)
/*     */   {
/* 285 */     oldAll = all;
/* 286 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\skill\confbean\SMountsSkillCfg.class
