...
/*     */ 
/*     */ public class SComplexSkillCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SComplexSkillCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SComplexSkillCfg> all = null;
/*     */   
/*     */   public int id;
...
/*  26 */     this.occupation = Integer.valueOf(rootElement.attributeValue("occupation")).intValue();
/*  27 */     this.skillid = Integer.valueOf(rootElement.attributeValue("skillid")).intValue();
/*  28 */     this.probable = Integer.valueOf(rootElement.attributeValue("probable")).intValue();
/*     */   }
/*     */   
...
/*  45 */     this.probable = _os_.unmarshal_int();
/*  46 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  51 */     String path = dir + "mzm.gsp.skill.confbean.SComplexSkillCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  64 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.skill.confbean.SComplexSkillCfg"))
/*     */         {
/*     */ 
/*  67 */           SComplexSkillCfg obj = new SComplexSkillCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SComplexSkillCfg> all)
/*     */   {
/*  81 */     String path = dir + "mzm.gsp.skill.confbean.SComplexSkillCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.skill.confbean.SComplexSkillCfg"))
/*     */         {
/*     */ 
/*  96 */           SComplexSkillCfg obj = new SComplexSkillCfg();
...
/*     */     
/* 112 */     String path = dir + "mzm.gsp.skill.confbean.SComplexSkillCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 139 */           SComplexSkillCfg _v_ = new SComplexSkillCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SComplexSkillCfg> all)
/*     */   {
/* 159 */     String path = dir + "mzm.gsp.skill.confbean.SComplexSkillCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 186 */           SComplexSkillCfg _v_ = new SComplexSkillCfg();
...
/*     */ 
/*     */ 
/*     */   public static SComplexSkillCfg getOld(int key)
/*     */   {
/* 207 */     return (SComplexSkillCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SComplexSkillCfg get(int key)
/*     */   {
/* 212 */     return (SComplexSkillCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SComplexSkillCfg> getOldAll()
/*     */   {
/* 217 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SComplexSkillCfg> getAll()
/*     */   {
/* 222 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SComplexSkillCfg> newAll)
/*     */   {
/* 227 */     oldAll = all;
/* 228 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\skill\confbean\SComplexSkillCfg.class
