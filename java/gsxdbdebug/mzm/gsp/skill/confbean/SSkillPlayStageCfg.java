...
/*     */ 
/*     */ public class SSkillPlayStageCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SSkillPlayStageCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SSkillPlayStageCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public int actionid;
/*  20 */   public java.util.ArrayList<Effectid2LateTime> effectlist = new java.util.ArrayList();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  24 */     this.id = Integer.valueOf(rootElement.attributeValue("id")).intValue();
/*  25 */     this.actionid = Integer.valueOf(rootElement.attributeValue("actionid")).intValue();
/*     */     
/*  27 */     Element collectionElement = util.XmlHelper.getVariableElement(rootElement, "effectlist");
...
/*  38 */       if (elem.getName().equalsIgnoreCase("mzm.gsp.skill.confbean.Effectid2LateTime"))
/*     */       {
/*     */         Effectid2LateTime _v_;
/*     */         
/*     */ 
/*     */         try
/*     */         {
/*  45 */           _v_ = new Effectid2LateTime();
...
/*  61 */     _os_.marshal(this.actionid);
/*  62 */     _os_.compact_uint32(this.effectlist.size());
/*  63 */     for (Effectid2LateTime _v_ : this.effectlist)
/*     */     {
/*  65 */       _os_.marshal(_v_);
/*     */     }
/*  67 */     return _os_;
...
/*  73 */     this.actionid = _os_.unmarshal_int();
/*  74 */     for (int _size_ = _os_.uncompact_uint32(); _size_ > 0; _size_--)
/*     */     {
/*     */ 
/*  77 */       Effectid2LateTime _v_ = new Effectid2LateTime();
/*  78 */       _v_.unmarshal(_os_);
/*  79 */       this.effectlist.add(_v_);
/*     */     }
/*  81 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/*  86 */     String path = dir + "mzm.gsp.skill.confbean.SSkillPlayStageCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  99 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.skill.confbean.SSkillPlayStageCfg"))
/*     */         {
/*     */ 
/* 102 */           SSkillPlayStageCfg obj = new SSkillPlayStageCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SSkillPlayStageCfg> all)
/*     */   {
/* 116 */     String path = dir + "mzm.gsp.skill.confbean.SSkillPlayStageCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 128 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.skill.confbean.SSkillPlayStageCfg"))
/*     */         {
/*     */ 
/* 131 */           SSkillPlayStageCfg obj = new SSkillPlayStageCfg();
...
/*     */     
/* 147 */     String path = dir + "mzm.gsp.skill.confbean.SSkillPlayStageCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 174 */           SSkillPlayStageCfg _v_ = new SSkillPlayStageCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SSkillPlayStageCfg> all)
/*     */   {
/* 194 */     String path = dir + "mzm.gsp.skill.confbean.SSkillPlayStageCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 221 */           SSkillPlayStageCfg _v_ = new SSkillPlayStageCfg();
...
/*     */ 
/*     */ 
/*     */   public static SSkillPlayStageCfg getOld(int key)
/*     */   {
/* 242 */     return (SSkillPlayStageCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SSkillPlayStageCfg get(int key)
/*     */   {
/* 247 */     return (SSkillPlayStageCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SSkillPlayStageCfg> getOldAll()
/*     */   {
/* 252 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SSkillPlayStageCfg> getAll()
/*     */   {
/* 257 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SSkillPlayStageCfg> newAll)
/*     */   {
/* 262 */     oldAll = all;
/* 263 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\skill\confbean\SSkillPlayStageCfg.class
