...
/*     */ 
/*     */ public class SSkillBagMenPaiCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SSkillBagMenPaiCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SSkillBagMenPaiCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public int menpaiid;
/*  20 */   public java.util.ArrayList<Integer> bag = new java.util.ArrayList();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  24 */     this.id = Integer.valueOf(rootElement.attributeValue("id")).intValue();
/*  25 */     this.menpaiid = Integer.valueOf(rootElement.attributeValue("menpaiid")).intValue();
/*     */     
/*  27 */     Element collectionElement = util.XmlHelper.getVariableElement(rootElement, "bag");
...
/*     */         }
/*     */         
/*  52 */         this.bag.add(Integer.valueOf(_v_));
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*  60 */     _os_.marshal(this.menpaiid);
/*  61 */     _os_.compact_uint32(this.bag.size());
/*  62 */     for (Integer _v_ : this.bag)
/*     */     {
...
/*     */   {
/*  84 */     String path = dir + "mzm.gsp.skill.confbean.SSkillBagMenPaiCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  97 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.skill.confbean.SSkillBagMenPaiCfg"))
/*     */         {
/*     */ 
/* 100 */           SSkillBagMenPaiCfg obj = new SSkillBagMenPaiCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SSkillBagMenPaiCfg> all)
/*     */   {
/* 114 */     String path = dir + "mzm.gsp.skill.confbean.SSkillBagMenPaiCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 126 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.skill.confbean.SSkillBagMenPaiCfg"))
/*     */         {
/*     */ 
/* 129 */           SSkillBagMenPaiCfg obj = new SSkillBagMenPaiCfg();
...
/*     */     
/* 145 */     String path = dir + "mzm.gsp.skill.confbean.SSkillBagMenPaiCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 172 */           SSkillBagMenPaiCfg _v_ = new SSkillBagMenPaiCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SSkillBagMenPaiCfg> all)
/*     */   {
/* 192 */     String path = dir + "mzm.gsp.skill.confbean.SSkillBagMenPaiCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 219 */           SSkillBagMenPaiCfg _v_ = new SSkillBagMenPaiCfg();
...
/*     */ 
/*     */ 
/*     */   public static SSkillBagMenPaiCfg getOld(int key)
/*     */   {
/* 240 */     return (SSkillBagMenPaiCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SSkillBagMenPaiCfg get(int key)
/*     */   {
/* 245 */     return (SSkillBagMenPaiCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SSkillBagMenPaiCfg> getOldAll()
/*     */   {
/* 250 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SSkillBagMenPaiCfg> getAll()
/*     */   {
/* 255 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SSkillBagMenPaiCfg> newAll)
/*     */   {
/* 260 */     oldAll = all;
/* 261 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\skill\confbean\SSkillBagMenPaiCfg.class
