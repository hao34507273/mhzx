...
/*     */ 
/*     */ public class SActionMap implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SActionMap> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SActionMap> all = null;
/*     */   
/*     */   public int modelid;
/*  19 */   public HashMap<Integer, ActionData> actionid2Action = new HashMap();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.modelid = Integer.valueOf(rootElement.attributeValue("modelid")).intValue();
/*     */     
/*  25 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "actionid2Action");
...
/*  51 */             keyElem = elem;
/*     */           }
/*  53 */           else if ((valueElem == null) && (elem.getName().equalsIgnoreCase("mzm.gsp.skill.confbean.ActionData")))
/*     */           {
/*  55 */             valueElem = elem;
/*     */           }
/*     */         }
...
/*     */         }
/*     */         
/*  77 */         this.actionid2Action.put(Integer.valueOf(_k_), _v_);
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*  85 */     _os_.compact_uint32(this.actionid2Action.size());
/*  86 */     for (java.util.Map.Entry<Integer, ActionData> _e_ : this.actionid2Action.entrySet())
/*     */     {
...
/*     */       
/* 102 */       ActionData _v_ = new ActionData();
/* 103 */       _v_.unmarshal(_os_);
/* 104 */       this.actionid2Action.put(Integer.valueOf(_k_), _v_);
/*     */     }
/* 106 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/* 111 */     String path = dir + "mzm.gsp.skill.confbean.SActionMap.xml";
/*     */     
/*     */     try
/*     */     {
/* 115 */       all = new HashMap();
...
/* 124 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.skill.confbean.SActionMap"))
/*     */         {
/*     */ 
/* 127 */           SActionMap obj = new SActionMap();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SActionMap> all)
/*     */   {
/* 141 */     String path = dir + "mzm.gsp.skill.confbean.SActionMap.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 153 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.skill.confbean.SActionMap"))
/*     */         {
/*     */ 
/* 156 */           SActionMap obj = new SActionMap();
...
/* 170 */     all = new HashMap();
/*     */     
/* 172 */     String path = dir + "mzm.gsp.skill.confbean.SActionMap.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 199 */           SActionMap _v_ = new SActionMap();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SActionMap> all)
/*     */   {
/* 219 */     String path = dir + "mzm.gsp.skill.confbean.SActionMap.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 246 */           SActionMap _v_ = new SActionMap();
...
/*     */ 
/*     */ 
/*     */   public static SActionMap getOld(int key)
/*     */   {
/* 267 */     return (SActionMap)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SActionMap get(int key)
/*     */   {
/* 272 */     return (SActionMap)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SActionMap> getOldAll()
/*     */   {
/* 277 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SActionMap> getAll()
/*     */   {
/* 282 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SActionMap> newAll)
/*     */   {
/* 287 */     oldAll = all;
/* 288 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\skill\confbean\SActionMap.class
