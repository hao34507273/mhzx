...
/*     */ 
/*     */ public class SOutFightEffectGroup implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SOutFightEffectGroup> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SOutFightEffectGroup> all = null;
/*     */   
/*     */   public int id;
/*     */   public String templatename;
/*     */   public int effectId;
/*  21 */   public java.util.LinkedList<Integer> formulaList = new java.util.LinkedList();
/*     */   
...
/*  27 */     this.effectId = Integer.valueOf(rootElement.attributeValue("effectId")).intValue();
/*     */     
/*  29 */     Element collectionElement = util.XmlHelper.getVariableElement(rootElement, "formulaList");
...
/*     */         }
/*     */         
/*  54 */         this.formulaList.add(Integer.valueOf(_v_));
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*  62 */     _os_.marshal(this.templatename, "UTF-8");
/*  63 */     _os_.marshal(this.effectId);
/*  64 */     _os_.compact_uint32(this.formulaList.size());
/*  65 */     for (Integer _v_ : this.formulaList)
/*     */     {
...
/*  75 */     this.templatename = _os_.unmarshal_String("UTF-8");
/*  76 */     this.effectId = _os_.unmarshal_int();
/*  77 */     for (int _size_ = _os_.uncompact_uint32(); _size_ > 0; _size_--)
/*     */     {
/*     */ 
/*  80 */       int _v_ = _os_.unmarshal_int();
/*  81 */       this.formulaList.add(Integer.valueOf(_v_));
/*     */     }
/*  83 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/*  88 */     String path = dir + "mzm.gsp.skill.confbean.SOutFightEffectGroup.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 101 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.skill.confbean.SOutFightEffectGroup"))
/*     */         {
/*     */ 
/* 104 */           SOutFightEffectGroup obj = new SOutFightEffectGroup();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SOutFightEffectGroup> all)
/*     */   {
/* 118 */     String path = dir + "mzm.gsp.skill.confbean.SOutFightEffectGroup.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 130 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.skill.confbean.SOutFightEffectGroup"))
/*     */         {
/*     */ 
/* 133 */           SOutFightEffectGroup obj = new SOutFightEffectGroup();
...
/*     */     
/* 149 */     String path = dir + "mzm.gsp.skill.confbean.SOutFightEffectGroup.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 176 */           SOutFightEffectGroup _v_ = new SOutFightEffectGroup();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SOutFightEffectGroup> all)
/*     */   {
/* 196 */     String path = dir + "mzm.gsp.skill.confbean.SOutFightEffectGroup.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 223 */           SOutFightEffectGroup _v_ = new SOutFightEffectGroup();
...
/*     */ 
/*     */ 
/*     */   public static SOutFightEffectGroup getOld(int key)
/*     */   {
/* 244 */     return (SOutFightEffectGroup)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SOutFightEffectGroup get(int key)
/*     */   {
/* 249 */     return (SOutFightEffectGroup)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SOutFightEffectGroup> getOldAll()
/*     */   {
/* 254 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SOutFightEffectGroup> getAll()
/*     */   {
/* 259 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SOutFightEffectGroup> newAll)
/*     */   {
/* 264 */     oldAll = all;
/* 265 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\skill\confbean\SOutFightEffectGroup.class
