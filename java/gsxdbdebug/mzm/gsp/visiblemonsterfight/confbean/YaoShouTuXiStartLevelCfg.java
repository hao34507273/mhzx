...
/*     */ 
/*     */ public class YaoShouTuXiStartLevelCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, YaoShouTuXiStartLevelCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, YaoShouTuXiStartLevelCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public String templatename;
/*     */   public int visibleMonsterId;
/*  21 */   public java.util.ArrayList<MonsterStarLevelBean> starLevelList = new java.util.ArrayList();
/*     */   
...
/*  27 */     this.visibleMonsterId = Integer.valueOf(rootElement.attributeValue("visibleMonsterId")).intValue();
/*     */     
/*  29 */     Element collectionElement = util.XmlHelper.getVariableElement(rootElement, "starLevelList");
...
/*  40 */       if (elem.getName().equalsIgnoreCase("mzm.gsp.visiblemonsterfight.confbean.MonsterStarLevelBean"))
/*     */       {
/*     */         MonsterStarLevelBean _v_;
/*     */         
/*     */ 
/*     */         try
/*     */         {
/*  47 */           _v_ = new MonsterStarLevelBean();
...
/*  64 */     _os_.marshal(this.visibleMonsterId);
/*  65 */     _os_.compact_uint32(this.starLevelList.size());
/*  66 */     for (MonsterStarLevelBean _v_ : this.starLevelList)
/*     */     {
/*  68 */       _os_.marshal(_v_);
/*     */     }
/*  70 */     return _os_;
...
/*  77 */     this.visibleMonsterId = _os_.unmarshal_int();
/*  78 */     for (int _size_ = _os_.uncompact_uint32(); _size_ > 0; _size_--)
/*     */     {
/*     */ 
/*  81 */       MonsterStarLevelBean _v_ = new MonsterStarLevelBean();
/*  82 */       _v_.unmarshal(_os_);
/*  83 */       this.starLevelList.add(_v_);
/*     */     }
/*  85 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/*  90 */     String path = dir + "mzm.gsp.visiblemonsterfight.confbean.YaoShouTuXiStartLevelCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 103 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.visiblemonsterfight.confbean.YaoShouTuXiStartLevelCfg"))
/*     */         {
/*     */ 
/* 106 */           YaoShouTuXiStartLevelCfg obj = new YaoShouTuXiStartLevelCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, YaoShouTuXiStartLevelCfg> all)
/*     */   {
/* 120 */     String path = dir + "mzm.gsp.visiblemonsterfight.confbean.YaoShouTuXiStartLevelCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 132 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.visiblemonsterfight.confbean.YaoShouTuXiStartLevelCfg"))
/*     */         {
/*     */ 
/* 135 */           YaoShouTuXiStartLevelCfg obj = new YaoShouTuXiStartLevelCfg();
...
/*     */     
/* 151 */     String path = dir + "mzm.gsp.visiblemonsterfight.confbean.YaoShouTuXiStartLevelCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           YaoShouTuXiStartLevelCfg _v_ = new YaoShouTuXiStartLevelCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, YaoShouTuXiStartLevelCfg> all)
/*     */   {
/* 198 */     String path = dir + "mzm.gsp.visiblemonsterfight.confbean.YaoShouTuXiStartLevelCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 225 */           YaoShouTuXiStartLevelCfg _v_ = new YaoShouTuXiStartLevelCfg();
...
/*     */ 
/*     */ 
/*     */   public static YaoShouTuXiStartLevelCfg getOld(int key)
/*     */   {
/* 246 */     return (YaoShouTuXiStartLevelCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static YaoShouTuXiStartLevelCfg get(int key)
/*     */   {
/* 251 */     return (YaoShouTuXiStartLevelCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, YaoShouTuXiStartLevelCfg> getOldAll()
/*     */   {
/* 256 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, YaoShouTuXiStartLevelCfg> getAll()
/*     */   {
/* 261 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, YaoShouTuXiStartLevelCfg> newAll)
/*     */   {
/* 266 */     oldAll = all;
/* 267 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\visiblemonsterfight\confbean\YaoShouTuXiStartLevelCfg.class
