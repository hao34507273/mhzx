...
/*     */ 
/*     */ public class SDeamonFightRewardModify implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SDeamonFightRewardModify> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SDeamonFightRewardModify> all = null;
/*     */   
/*     */   public int id;
...
/*     */   {
/*  55 */     String path = dir + "mzm.gsp.visiblemonsterfight.confbean.SDeamonFightRewardModify.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  68 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.visiblemonsterfight.confbean.SDeamonFightRewardModify"))
/*     */         {
/*     */ 
/*  71 */           SDeamonFightRewardModify obj = new SDeamonFightRewardModify();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SDeamonFightRewardModify> all)
/*     */   {
/*  85 */     String path = dir + "mzm.gsp.visiblemonsterfight.confbean.SDeamonFightRewardModify.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  97 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.visiblemonsterfight.confbean.SDeamonFightRewardModify"))
/*     */         {
/*     */ 
/* 100 */           SDeamonFightRewardModify obj = new SDeamonFightRewardModify();
...
/*     */     
/* 116 */     String path = dir + "mzm.gsp.visiblemonsterfight.confbean.SDeamonFightRewardModify.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 143 */           SDeamonFightRewardModify _v_ = new SDeamonFightRewardModify();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SDeamonFightRewardModify> all)
/*     */   {
/* 163 */     String path = dir + "mzm.gsp.visiblemonsterfight.confbean.SDeamonFightRewardModify.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 190 */           SDeamonFightRewardModify _v_ = new SDeamonFightRewardModify();
...
/*     */ 
/*     */ 
/*     */   public static SDeamonFightRewardModify getOld(int key)
/*     */   {
/* 211 */     return (SDeamonFightRewardModify)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SDeamonFightRewardModify get(int key)
/*     */   {
/* 216 */     return (SDeamonFightRewardModify)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SDeamonFightRewardModify> getOldAll()
/*     */   {
/* 221 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SDeamonFightRewardModify> getAll()
/*     */   {
/* 226 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SDeamonFightRewardModify> newAll)
/*     */   {
/* 231 */     oldAll = all;
/* 232 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\visiblemonsterfight\confbean\SDeamonFightRewardModify.class
