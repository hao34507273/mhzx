...
/*     */ 
/*     */ public class SBeastFightRewardModify implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SBeastFightRewardModify> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SBeastFightRewardModify> all = null;
/*     */   
/*     */   public int id;
...
/*     */   {
/*  55 */     String path = dir + "mzm.gsp.visiblemonsterfight.confbean.SBeastFightRewardModify.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  68 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.visiblemonsterfight.confbean.SBeastFightRewardModify"))
/*     */         {
/*     */ 
/*  71 */           SBeastFightRewardModify obj = new SBeastFightRewardModify();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SBeastFightRewardModify> all)
/*     */   {
/*  85 */     String path = dir + "mzm.gsp.visiblemonsterfight.confbean.SBeastFightRewardModify.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  97 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.visiblemonsterfight.confbean.SBeastFightRewardModify"))
/*     */         {
/*     */ 
/* 100 */           SBeastFightRewardModify obj = new SBeastFightRewardModify();
...
/*     */     
/* 116 */     String path = dir + "mzm.gsp.visiblemonsterfight.confbean.SBeastFightRewardModify.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 143 */           SBeastFightRewardModify _v_ = new SBeastFightRewardModify();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SBeastFightRewardModify> all)
/*     */   {
/* 163 */     String path = dir + "mzm.gsp.visiblemonsterfight.confbean.SBeastFightRewardModify.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 190 */           SBeastFightRewardModify _v_ = new SBeastFightRewardModify();
...
/*     */ 
/*     */ 
/*     */   public static SBeastFightRewardModify getOld(int key)
/*     */   {
/* 211 */     return (SBeastFightRewardModify)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SBeastFightRewardModify get(int key)
/*     */   {
/* 216 */     return (SBeastFightRewardModify)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SBeastFightRewardModify> getOldAll()
/*     */   {
/* 221 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SBeastFightRewardModify> getAll()
/*     */   {
/* 226 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SBeastFightRewardModify> newAll)
/*     */   {
/* 231 */     oldAll = all;
/* 232 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\visiblemonsterfight\confbean\SBeastFightRewardModify.class
