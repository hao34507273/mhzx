...
/*     */ 
/*     */ public class SAchievementScoreActivityCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SAchievementScoreActivityCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SAchievementScoreActivityCfg> all = null;
/*     */   
/*     */   public int activityId;
/*  19 */   public HashMap<Integer, Integer> scoreMap = new HashMap();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.activityId = Integer.valueOf(rootElement.attributeValue("activityId")).intValue();
/*     */     
/*  25 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "scoreMap");
...
/*     */         }
/*     */         
/*  76 */         this.scoreMap.put(Integer.valueOf(_k_), Integer.valueOf(_v_));
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*  84 */     _os_.compact_uint32(this.scoreMap.size());
/*  85 */     for (java.util.Map.Entry<Integer, Integer> _e_ : this.scoreMap.entrySet())
/*     */     {
...
/*     */   {
/*  95 */     this.activityId = _os_.unmarshal_int();
...
/* 102 */       this.scoreMap.put(Integer.valueOf(_k_), Integer.valueOf(_v_));
/*     */     }
/* 104 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/* 109 */     String path = dir + "mzm.gsp.achievement.confbean.SAchievementScoreActivityCfg.xml";
/*     */     
/*     */     try
/*     */     {
/* 113 */       all = new HashMap();
...
/* 122 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.achievement.confbean.SAchievementScoreActivityCfg"))
/*     */         {
/*     */ 
/* 125 */           SAchievementScoreActivityCfg obj = new SAchievementScoreActivityCfg();
/* 126 */           obj.loadFromXml(elem);
/* 127 */           if (all.put(Integer.valueOf(obj.activityId), obj) != null) {
/* 128 */             throw new RuntimeException("duplicate key : " + obj.activityId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SAchievementScoreActivityCfg> all)
/*     */   {
/* 139 */     String path = dir + "mzm.gsp.achievement.confbean.SAchievementScoreActivityCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 151 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.achievement.confbean.SAchievementScoreActivityCfg"))
/*     */         {
/*     */ 
/* 154 */           SAchievementScoreActivityCfg obj = new SAchievementScoreActivityCfg();
/* 155 */           obj.loadFromXml(elem);
/* 156 */           if (all.put(Integer.valueOf(obj.activityId), obj) != null) {
/* 157 */             throw new RuntimeException("duplicate key : " + obj.activityId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/* 168 */     all = new HashMap();
/*     */     
/* 170 */     String path = dir + "mzm.gsp.achievement.confbean.SAchievementScoreActivityCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 197 */           SAchievementScoreActivityCfg _v_ = new SAchievementScoreActivityCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SAchievementScoreActivityCfg> all)
/*     */   {
/* 217 */     String path = dir + "mzm.gsp.achievement.confbean.SAchievementScoreActivityCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 244 */           SAchievementScoreActivityCfg _v_ = new SAchievementScoreActivityCfg();
...
/*     */ 
/*     */ 
/*     */   public static SAchievementScoreActivityCfg getOld(int key)
/*     */   {
/* 265 */     return (SAchievementScoreActivityCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SAchievementScoreActivityCfg get(int key)
/*     */   {
/* 270 */     return (SAchievementScoreActivityCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SAchievementScoreActivityCfg> getOldAll()
/*     */   {
/* 275 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SAchievementScoreActivityCfg> getAll()
/*     */   {
/* 280 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SAchievementScoreActivityCfg> newAll)
/*     */   {
/* 285 */     oldAll = all;
/* 286 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\achievement\confbean\SAchievementScoreActivityCfg.class
