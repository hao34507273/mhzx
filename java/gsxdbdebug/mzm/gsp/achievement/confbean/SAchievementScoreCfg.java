...
/*     */ 
/*     */ public class SAchievementScoreCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SAchievementScoreCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SAchievementScoreCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public int score;
/*     */   public int awardId;
/*     */   public int scoreIndexId;
/*     */   public int activityCfgId;
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  26 */     this.id = Integer.valueOf(rootElement.attributeValue("id")).intValue();
/*  27 */     this.score = Integer.valueOf(rootElement.attributeValue("score")).intValue();
/*  28 */     this.awardId = Integer.valueOf(rootElement.attributeValue("awardId")).intValue();
/*  29 */     this.scoreIndexId = Integer.valueOf(rootElement.attributeValue("scoreIndexId")).intValue();
...
/*  37 */     _os_.marshal(this.awardId);
/*  38 */     _os_.marshal(this.scoreIndexId);
...
/*  46 */     this.score = _os_.unmarshal_int();
/*  47 */     this.awardId = _os_.unmarshal_int();
/*  48 */     this.scoreIndexId = _os_.unmarshal_int();
...
/*     */   {
/*  55 */     String path = dir + "mzm.gsp.achievement.confbean.SAchievementScoreCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  68 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.achievement.confbean.SAchievementScoreCfg"))
/*     */         {
/*     */ 
/*  71 */           SAchievementScoreCfg obj = new SAchievementScoreCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SAchievementScoreCfg> all)
/*     */   {
/*  85 */     String path = dir + "mzm.gsp.achievement.confbean.SAchievementScoreCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  97 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.achievement.confbean.SAchievementScoreCfg"))
/*     */         {
/*     */ 
/* 100 */           SAchievementScoreCfg obj = new SAchievementScoreCfg();
...
/*     */     
/* 116 */     String path = dir + "mzm.gsp.achievement.confbean.SAchievementScoreCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 143 */           SAchievementScoreCfg _v_ = new SAchievementScoreCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SAchievementScoreCfg> all)
/*     */   {
/* 163 */     String path = dir + "mzm.gsp.achievement.confbean.SAchievementScoreCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 190 */           SAchievementScoreCfg _v_ = new SAchievementScoreCfg();
...
/*     */ 
/*     */ 
/*     */   public static SAchievementScoreCfg getOld(int key)
/*     */   {
/* 211 */     return (SAchievementScoreCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SAchievementScoreCfg get(int key)
/*     */   {
/* 216 */     return (SAchievementScoreCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SAchievementScoreCfg> getOldAll()
/*     */   {
/* 221 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SAchievementScoreCfg> getAll()
/*     */   {
/* 226 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SAchievementScoreCfg> newAll)
/*     */   {
/* 231 */     oldAll = all;
/* 232 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\achievement\confbean\SAchievementScoreCfg.class
