...
/*     */ 
/*     */ public class SActivityAchieveDisplayCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SActivityAchieveDisplayCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SActivityAchieveDisplayCfg> all = null;
/*     */   
/*     */   public int id;
...
/*  32 */     _os_.marshal(this.mailCfgid);
/*  33 */     _os_.marshal(this.name, "UTF-8");
/*  34 */     return _os_;
/*     */   }
/*     */   
...
/*  40 */     this.mailCfgid = _os_.unmarshal_int();
/*  41 */     this.name = _os_.unmarshal_String("UTF-8");
/*  42 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  47 */     String path = dir + "mzm.gsp.achievement.confbean.SActivityAchieveDisplayCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  60 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.achievement.confbean.SActivityAchieveDisplayCfg"))
/*     */         {
/*     */ 
/*  63 */           SActivityAchieveDisplayCfg obj = new SActivityAchieveDisplayCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SActivityAchieveDisplayCfg> all)
/*     */   {
/*  77 */     String path = dir + "mzm.gsp.achievement.confbean.SActivityAchieveDisplayCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  89 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.achievement.confbean.SActivityAchieveDisplayCfg"))
/*     */         {
/*     */ 
/*  92 */           SActivityAchieveDisplayCfg obj = new SActivityAchieveDisplayCfg();
...
/*     */     
/* 108 */     String path = dir + "mzm.gsp.achievement.confbean.SActivityAchieveDisplayCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 135 */           SActivityAchieveDisplayCfg _v_ = new SActivityAchieveDisplayCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SActivityAchieveDisplayCfg> all)
/*     */   {
/* 155 */     String path = dir + "mzm.gsp.achievement.confbean.SActivityAchieveDisplayCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 182 */           SActivityAchieveDisplayCfg _v_ = new SActivityAchieveDisplayCfg();
...
/*     */ 
/*     */ 
/*     */   public static SActivityAchieveDisplayCfg getOld(int key)
/*     */   {
/* 203 */     return (SActivityAchieveDisplayCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SActivityAchieveDisplayCfg get(int key)
/*     */   {
/* 208 */     return (SActivityAchieveDisplayCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SActivityAchieveDisplayCfg> getOldAll()
/*     */   {
/* 213 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SActivityAchieveDisplayCfg> getAll()
/*     */   {
/* 218 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SActivityAchieveDisplayCfg> newAll)
/*     */   {
/* 223 */     oldAll = all;
/* 224 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\achievement\confbean\SActivityAchieveDisplayCfg.class
