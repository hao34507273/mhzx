...
/*     */ 
/*     */ public class SOriginalAchievementSubTypeCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SOriginalAchievementSubTypeCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SOriginalAchievementSubTypeCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public int bigTypeCfgId;
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.id = Integer.valueOf(rootElement.attributeValue("id")).intValue();
/*  24 */     this.bigTypeCfgId = Integer.valueOf(rootElement.attributeValue("bigTypeCfgId")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  29 */     _os_.marshal(this.id);
/*  30 */     _os_.marshal(this.bigTypeCfgId);
/*  31 */     return _os_;
/*     */   }
/*     */   
...
/*  37 */     this.bigTypeCfgId = _os_.unmarshal_int();
/*  38 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.achievement.confbean.SOriginalAchievementSubTypeCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.achievement.confbean.SOriginalAchievementSubTypeCfg"))
/*     */         {
/*     */ 
/*  59 */           SOriginalAchievementSubTypeCfg obj = new SOriginalAchievementSubTypeCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SOriginalAchievementSubTypeCfg> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.achievement.confbean.SOriginalAchievementSubTypeCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.achievement.confbean.SOriginalAchievementSubTypeCfg"))
/*     */         {
/*     */ 
/*  88 */           SOriginalAchievementSubTypeCfg obj = new SOriginalAchievementSubTypeCfg();
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.achievement.confbean.SOriginalAchievementSubTypeCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           SOriginalAchievementSubTypeCfg _v_ = new SOriginalAchievementSubTypeCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SOriginalAchievementSubTypeCfg> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.achievement.confbean.SOriginalAchievementSubTypeCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           SOriginalAchievementSubTypeCfg _v_ = new SOriginalAchievementSubTypeCfg();
...
/*     */ 
/*     */ 
/*     */   public static SOriginalAchievementSubTypeCfg getOld(int key)
/*     */   {
/* 199 */     return (SOriginalAchievementSubTypeCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SOriginalAchievementSubTypeCfg get(int key)
/*     */   {
/* 204 */     return (SOriginalAchievementSubTypeCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SOriginalAchievementSubTypeCfg> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SOriginalAchievementSubTypeCfg> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SOriginalAchievementSubTypeCfg> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\achievement\confbean\SOriginalAchievementSubTypeCfg.class
