...
/*     */ 
/*     */ public class SOriginalAchievementBigTypeCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SOriginalAchievementBigTypeCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SOriginalAchievementBigTypeCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public String name;
/*     */   public int index;
...
/*  26 */     this.index = Integer.valueOf(rootElement.attributeValue("index")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  31 */     _os_.marshal(this.id);
/*  32 */     _os_.marshal(this.name, "UTF-8");
...
/*  40 */     this.name = _os_.unmarshal_String("UTF-8");
/*  41 */     this.index = _os_.unmarshal_int();
/*  42 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  47 */     String path = dir + "mzm.gsp.achievement.confbean.SOriginalAchievementBigTypeCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  60 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.achievement.confbean.SOriginalAchievementBigTypeCfg"))
/*     */         {
/*     */ 
/*  63 */           SOriginalAchievementBigTypeCfg obj = new SOriginalAchievementBigTypeCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SOriginalAchievementBigTypeCfg> all)
/*     */   {
/*  77 */     String path = dir + "mzm.gsp.achievement.confbean.SOriginalAchievementBigTypeCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  89 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.achievement.confbean.SOriginalAchievementBigTypeCfg"))
/*     */         {
/*     */ 
/*  92 */           SOriginalAchievementBigTypeCfg obj = new SOriginalAchievementBigTypeCfg();
...
/*     */     
/* 108 */     String path = dir + "mzm.gsp.achievement.confbean.SOriginalAchievementBigTypeCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 135 */           SOriginalAchievementBigTypeCfg _v_ = new SOriginalAchievementBigTypeCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SOriginalAchievementBigTypeCfg> all)
/*     */   {
/* 155 */     String path = dir + "mzm.gsp.achievement.confbean.SOriginalAchievementBigTypeCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 182 */           SOriginalAchievementBigTypeCfg _v_ = new SOriginalAchievementBigTypeCfg();
...
/*     */ 
/*     */ 
/*     */   public static SOriginalAchievementBigTypeCfg getOld(int key)
/*     */   {
/* 203 */     return (SOriginalAchievementBigTypeCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SOriginalAchievementBigTypeCfg get(int key)
/*     */   {
/* 208 */     return (SOriginalAchievementBigTypeCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SOriginalAchievementBigTypeCfg> getOldAll()
/*     */   {
/* 213 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SOriginalAchievementBigTypeCfg> getAll()
/*     */   {
/* 218 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SOriginalAchievementBigTypeCfg> newAll)
/*     */   {
/* 223 */     oldAll = all;
/* 224 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\achievement\confbean\SOriginalAchievementBigTypeCfg.class
