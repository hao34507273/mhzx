...
/*     */ 
/*     */ public class SCarnivalConsts
/*     */ {
/*  13 */   private static volatile SCarnivalConsts oldInstance = null;
/*     */   
/*  15 */   private static SCarnivalConsts instance = new SCarnivalConsts();
/*     */   
/*     */   public int lastTime;
/*     */   public int carnivalActivityId;
/*     */   public int mailId;
/*     */   
/*     */   public static SCarnivalConsts getOldInstance()
/*     */   {
/*  23 */     return oldInstance;
/*     */   }
/*     */   
/*     */   public static SCarnivalConsts getInstance()
/*     */   {
/*  28 */     return instance;
/*     */   }
/*     */   
...
/*     */   {
/*  42 */     String path = dir + "mzm.gsp.achievement.confbean.SCarnivalConsts.xml";
/*     */     try
/*     */     {
...
/*     */         }
/*     */       }
/*  62 */       this.lastTime = Integer.valueOf(((Element)data.get("lastTime")).attributeValue("value")).intValue();
/*  63 */       this.carnivalActivityId = Integer.valueOf(((Element)data.get("carnivalActivityId")).attributeValue("value")).intValue();
/*  64 */       this.mailId = Integer.valueOf(((Element)data.get("mailId")).attributeValue("value")).intValue();
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*  73 */     String path = dir + "mzm.gsp.achievement.confbean.SCarnivalConsts.xml";
/*     */     try
/*     */     {
...
/*     */         }
/*     */       }
/*  93 */       this.lastTime = Integer.valueOf(((Element)data.get("lastTime")).attributeValue("value")).intValue();
/*  94 */       this.carnivalActivityId = Integer.valueOf(((Element)data.get("carnivalActivityId")).attributeValue("value")).intValue();
/*  95 */       this.mailId = Integer.valueOf(((Element)data.get("mailId")).attributeValue("value")).intValue();
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/* 106 */     String path = dir + "mzm.gsp.achievement.confbean.SCarnivalConsts.bny";
/*     */     try
/*     */     {
...
/* 121 */         this.lastTime = _os_.unmarshal_int();
/* 122 */         this.carnivalActivityId = _os_.unmarshal_int();
/* 123 */         this.mailId = _os_.unmarshal_int();
/*     */       }
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*     */   {
/* 134 */     String path = dir + "mzm.gsp.achievement.confbean.SCarnivalConsts.bny";
/*     */     try
/*     */     {
...
/* 149 */         this.lastTime = _os_.unmarshal_int();
/* 150 */         this.carnivalActivityId = _os_.unmarshal_int();
/* 151 */         this.mailId = _os_.unmarshal_int();
/*     */       }
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*     */   }
/*     */   
/*     */   public static void setInstance(SCarnivalConsts newInstance)
/*     */   {
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\achievement\confbean\SCarnivalConsts.class
