...
/*     */ {
/*  13 */   private static volatile AchievementConsts oldInstance = null;
/*     */   
/*  15 */   private static AchievementConsts instance = new AchievementConsts();
/*     */   public int activityId;
/*     */   public int invisibleAchievementIndex;
/*     */   public int openLevel;
/*     */   public int mailId;
/*     */   
/*     */   public static AchievementConsts getOldInstance()
/*     */   {
/*  23 */     return oldInstance;
/*     */   }
/*     */   
/*     */   public static AchievementConsts getInstance()
/*     */   {
/*  28 */     return instance;
/*     */   }
/*     */   
...
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.achievement.confbean.AchievementConsts.xml";
/*     */     try
/*     */     {
...
/*  64 */       this.invisibleAchievementIndex = Integer.valueOf(((Element)data.get("invisibleAchievementIndex")).attributeValue("value")).intValue();
/*  65 */       this.openLevel = Integer.valueOf(((Element)data.get("openLevel")).attributeValue("value")).intValue();
/*  66 */       this.mailId = Integer.valueOf(((Element)data.get("mailId")).attributeValue("value")).intValue();
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*  75 */     String path = dir + "mzm.gsp.achievement.confbean.AchievementConsts.xml";
/*     */     try
/*     */     {
...
/*  96 */       this.invisibleAchievementIndex = Integer.valueOf(((Element)data.get("invisibleAchievementIndex")).attributeValue("value")).intValue();
/*  97 */       this.openLevel = Integer.valueOf(((Element)data.get("openLevel")).attributeValue("value")).intValue();
/*  98 */       this.mailId = Integer.valueOf(((Element)data.get("mailId")).attributeValue("value")).intValue();
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/* 109 */     String path = dir + "mzm.gsp.achievement.confbean.AchievementConsts.bny";
/*     */     try
/*     */     {
...
/* 125 */         this.invisibleAchievementIndex = _os_.unmarshal_int();
/* 126 */         this.openLevel = _os_.unmarshal_int();
/* 127 */         this.mailId = _os_.unmarshal_int();
/*     */       }
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*     */   {
/* 138 */     String path = dir + "mzm.gsp.achievement.confbean.AchievementConsts.bny";
/*     */     try
/*     */     {
...
/* 154 */         this.invisibleAchievementIndex = _os_.unmarshal_int();
/* 155 */         this.openLevel = _os_.unmarshal_int();
/* 156 */         this.mailId = _os_.unmarshal_int();
/*     */       }
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*     */   }
/*     */   
/*     */   public static void setInstance(AchievementConsts newInstance)
/*     */   {
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\achievement\confbean\AchievementConsts.class
