...
/*     */ 
/*     */ public class SBigbossAward implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SBigbossAward> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SBigbossAward> all = null;
/*     */   
/*     */   public int id;
/*     */   public int minRank;
/*     */   public int maxRank;
...
/*  26 */     this.minRank = Integer.valueOf(rootElement.attributeValue("minRank")).intValue();
/*  27 */     this.maxRank = Integer.valueOf(rootElement.attributeValue("maxRank")).intValue();
...
/*  34 */     _os_.marshal(this.minRank);
/*  35 */     _os_.marshal(this.maxRank);
...
/*  43 */     this.minRank = _os_.unmarshal_int();
/*  44 */     this.maxRank = _os_.unmarshal_int();
...
/*     */   {
/*  51 */     String path = dir + "mzm.gsp.bigboss.confbean.SBigbossAward.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  64 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.bigboss.confbean.SBigbossAward"))
/*     */         {
/*     */ 
/*  67 */           SBigbossAward obj = new SBigbossAward();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SBigbossAward> all)
/*     */   {
/*  81 */     String path = dir + "mzm.gsp.bigboss.confbean.SBigbossAward.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.bigboss.confbean.SBigbossAward"))
/*     */         {
/*     */ 
/*  96 */           SBigbossAward obj = new SBigbossAward();
...
/*     */     
/* 112 */     String path = dir + "mzm.gsp.bigboss.confbean.SBigbossAward.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 139 */           SBigbossAward _v_ = new SBigbossAward();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SBigbossAward> all)
/*     */   {
/* 159 */     String path = dir + "mzm.gsp.bigboss.confbean.SBigbossAward.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 186 */           SBigbossAward _v_ = new SBigbossAward();
...
/*     */ 
/*     */ 
/*     */   public static SBigbossAward getOld(int key)
/*     */   {
/* 207 */     return (SBigbossAward)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SBigbossAward get(int key)
/*     */   {
/* 212 */     return (SBigbossAward)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SBigbossAward> getOldAll()
/*     */   {
/* 217 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SBigbossAward> getAll()
/*     */   {
/* 222 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SBigbossAward> newAll)
/*     */   {
/* 227 */     oldAll = all;
/* 228 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\bigboss\confbean\SBigbossAward.class
