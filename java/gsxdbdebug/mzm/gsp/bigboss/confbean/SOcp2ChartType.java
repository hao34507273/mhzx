...
/*     */ 
/*     */ public class SOcp2ChartType implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SOcp2ChartType> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SOcp2ChartType> all = null;
/*     */   
/*     */   public int ocp;
...
/*     */   {
/*  23 */     this.ocp = Integer.valueOf(rootElement.attributeValue("ocp")).intValue();
/*  24 */     this.charttype = Integer.valueOf(rootElement.attributeValue("charttype")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  29 */     _os_.marshal(this.ocp);
/*  30 */     _os_.marshal(this.charttype);
/*  31 */     return _os_;
/*     */   }
/*     */   
/*     */   public OctetsStream unmarshal(OctetsStream _os_) throws com.goldhuman.Common.Marshal.MarshalException
/*     */   {
/*  36 */     this.ocp = _os_.unmarshal_int();
/*  37 */     this.charttype = _os_.unmarshal_int();
/*  38 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.bigboss.confbean.SOcp2ChartType.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.bigboss.confbean.SOcp2ChartType"))
/*     */         {
/*     */ 
/*  59 */           SOcp2ChartType obj = new SOcp2ChartType();
/*  60 */           obj.loadFromXml(elem);
/*  61 */           if (all.put(Integer.valueOf(obj.ocp), obj) != null) {
/*  62 */             throw new RuntimeException("duplicate key : " + obj.ocp);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SOcp2ChartType> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.bigboss.confbean.SOcp2ChartType.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.bigboss.confbean.SOcp2ChartType"))
/*     */         {
/*     */ 
/*  88 */           SOcp2ChartType obj = new SOcp2ChartType();
/*  89 */           obj.loadFromXml(elem);
/*  90 */           if (all.put(Integer.valueOf(obj.ocp), obj) != null) {
/*  91 */             throw new RuntimeException("duplicate key : " + obj.ocp);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.bigboss.confbean.SOcp2ChartType.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           SOcp2ChartType _v_ = new SOcp2ChartType();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SOcp2ChartType> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.bigboss.confbean.SOcp2ChartType.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           SOcp2ChartType _v_ = new SOcp2ChartType();
...
/*     */ 
/*     */ 
/*     */   public static SOcp2ChartType getOld(int key)
/*     */   {
/* 199 */     return (SOcp2ChartType)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SOcp2ChartType get(int key)
/*     */   {
/* 204 */     return (SOcp2ChartType)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SOcp2ChartType> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SOcp2ChartType> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SOcp2ChartType> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\bigboss\confbean\SOcp2ChartType.class
