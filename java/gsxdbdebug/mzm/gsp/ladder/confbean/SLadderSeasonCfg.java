...
/*     */ 
/*     */ public class SLadderSeasonCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SLadderSeasonCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SLadderSeasonCfg> all = null;
/*     */   
...
/*     */   {
/*  23 */     this.beginTime = Integer.valueOf(rootElement.attributeValue("beginTime")).intValue();
/*  24 */     this.seasonNum = Integer.valueOf(rootElement.attributeValue("seasonNum")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  29 */     _os_.marshal(this.beginTime);
/*  30 */     _os_.marshal(this.seasonNum);
/*  31 */     return _os_;
/*     */   }
/*     */   
/*     */   public OctetsStream unmarshal(OctetsStream _os_) throws com.goldhuman.Common.Marshal.MarshalException
/*     */   {
/*  36 */     this.beginTime = _os_.unmarshal_int();
/*  37 */     this.seasonNum = _os_.unmarshal_int();
/*  38 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.ladder.confbean.SLadderSeasonCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.ladder.confbean.SLadderSeasonCfg"))
/*     */         {
/*     */ 
/*  59 */           SLadderSeasonCfg obj = new SLadderSeasonCfg();
/*  60 */           obj.loadFromXml(elem);
/*  61 */           if (all.put(Integer.valueOf(obj.beginTime), obj) != null) {
/*  62 */             throw new RuntimeException("duplicate key : " + obj.beginTime);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SLadderSeasonCfg> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.ladder.confbean.SLadderSeasonCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.ladder.confbean.SLadderSeasonCfg"))
/*     */         {
/*     */ 
/*  88 */           SLadderSeasonCfg obj = new SLadderSeasonCfg();
/*  89 */           obj.loadFromXml(elem);
/*  90 */           if (all.put(Integer.valueOf(obj.beginTime), obj) != null) {
/*  91 */             throw new RuntimeException("duplicate key : " + obj.beginTime);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.ladder.confbean.SLadderSeasonCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           SLadderSeasonCfg _v_ = new SLadderSeasonCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SLadderSeasonCfg> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.ladder.confbean.SLadderSeasonCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           SLadderSeasonCfg _v_ = new SLadderSeasonCfg();
...
/*     */ 
/*     */ 
/*     */   public static SLadderSeasonCfg getOld(int key)
/*     */   {
/* 199 */     return (SLadderSeasonCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SLadderSeasonCfg get(int key)
/*     */   {
/* 204 */     return (SLadderSeasonCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SLadderSeasonCfg> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SLadderSeasonCfg> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SLadderSeasonCfg> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\ladder\confbean\SLadderSeasonCfg.class
