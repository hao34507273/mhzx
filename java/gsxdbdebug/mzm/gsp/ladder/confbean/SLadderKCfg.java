...
/*     */ 
/*     */ public class SLadderKCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SLadderKCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SLadderKCfg> all = null;
/*     */   
/*     */   public int score;
/*     */   public int k;
/*     */   
...
/*     */   {
/*  23 */     this.score = Integer.valueOf(rootElement.attributeValue("score")).intValue();
/*  24 */     this.k = Integer.valueOf(rootElement.attributeValue("k")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  29 */     _os_.marshal(this.score);
/*  30 */     _os_.marshal(this.k);
/*  31 */     return _os_;
/*     */   }
/*     */   
/*     */   public OctetsStream unmarshal(OctetsStream _os_) throws com.goldhuman.Common.Marshal.MarshalException
/*     */   {
/*  36 */     this.score = _os_.unmarshal_int();
/*  37 */     this.k = _os_.unmarshal_int();
/*  38 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.ladder.confbean.SLadderKCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.ladder.confbean.SLadderKCfg"))
/*     */         {
/*     */ 
/*  59 */           SLadderKCfg obj = new SLadderKCfg();
/*  60 */           obj.loadFromXml(elem);
/*  61 */           if (all.put(Integer.valueOf(obj.score), obj) != null) {
/*  62 */             throw new RuntimeException("duplicate key : " + obj.score);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SLadderKCfg> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.ladder.confbean.SLadderKCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.ladder.confbean.SLadderKCfg"))
/*     */         {
/*     */ 
/*  88 */           SLadderKCfg obj = new SLadderKCfg();
/*  89 */           obj.loadFromXml(elem);
/*  90 */           if (all.put(Integer.valueOf(obj.score), obj) != null) {
/*  91 */             throw new RuntimeException("duplicate key : " + obj.score);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.ladder.confbean.SLadderKCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           SLadderKCfg _v_ = new SLadderKCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SLadderKCfg> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.ladder.confbean.SLadderKCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           SLadderKCfg _v_ = new SLadderKCfg();
...
/*     */ 
/*     */ 
/*     */   public static SLadderKCfg getOld(int key)
/*     */   {
/* 199 */     return (SLadderKCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SLadderKCfg get(int key)
/*     */   {
/* 204 */     return (SLadderKCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SLadderKCfg> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SLadderKCfg> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SLadderKCfg> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\ladder\confbean\SLadderKCfg.class
