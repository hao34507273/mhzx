...
/*     */ 
/*     */ public class SLadderCountAwardCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SLadderCountAwardCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SLadderCountAwardCfg> all = null;
/*     */   
/*     */   public int count;
/*     */   public int awardid;
/*     */   
...
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.ladder.confbean.SLadderCountAwardCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.ladder.confbean.SLadderCountAwardCfg"))
/*     */         {
/*     */ 
/*  59 */           SLadderCountAwardCfg obj = new SLadderCountAwardCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SLadderCountAwardCfg> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.ladder.confbean.SLadderCountAwardCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.ladder.confbean.SLadderCountAwardCfg"))
/*     */         {
/*     */ 
/*  88 */           SLadderCountAwardCfg obj = new SLadderCountAwardCfg();
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.ladder.confbean.SLadderCountAwardCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           SLadderCountAwardCfg _v_ = new SLadderCountAwardCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SLadderCountAwardCfg> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.ladder.confbean.SLadderCountAwardCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           SLadderCountAwardCfg _v_ = new SLadderCountAwardCfg();
...
/*     */ 
/*     */ 
/*     */   public static SLadderCountAwardCfg getOld(int key)
/*     */   {
/* 199 */     return (SLadderCountAwardCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SLadderCountAwardCfg get(int key)
/*     */   {
/* 204 */     return (SLadderCountAwardCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SLadderCountAwardCfg> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SLadderCountAwardCfg> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SLadderCountAwardCfg> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\ladder\confbean\SLadderCountAwardCfg.class
