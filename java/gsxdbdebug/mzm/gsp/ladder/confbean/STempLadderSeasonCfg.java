...
/*     */ 
/*     */ public class STempLadderSeasonCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, STempLadderSeasonCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, STempLadderSeasonCfg> all = null;
/*     */   
/*     */   public int id;
...
/*  29 */     this.seasonNum = Integer.valueOf(rootElement.attributeValue("seasonNum")).intValue();
/*  30 */     this.year = Integer.valueOf(rootElement.attributeValue("year")).intValue();
/*  31 */     this.month = Integer.valueOf(rootElement.attributeValue("month")).intValue();
/*  32 */     this.day = Integer.valueOf(rootElement.attributeValue("day")).intValue();
/*  33 */     this.hour = Integer.valueOf(rootElement.attributeValue("hour")).intValue();
/*  34 */     this.minute = Integer.valueOf(rootElement.attributeValue("minute")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  39 */     _os_.marshal(this.id);
/*  40 */     _os_.marshal(this.seasonNum);
/*  41 */     _os_.marshal(this.year);
/*  42 */     _os_.marshal(this.month);
/*  43 */     _os_.marshal(this.day);
/*  44 */     _os_.marshal(this.hour);
/*  45 */     _os_.marshal(this.minute);
/*  46 */     return _os_;
/*     */   }
/*     */   
...
/*  52 */     this.seasonNum = _os_.unmarshal_int();
/*  53 */     this.year = _os_.unmarshal_int();
/*  54 */     this.month = _os_.unmarshal_int();
/*  55 */     this.day = _os_.unmarshal_int();
/*  56 */     this.hour = _os_.unmarshal_int();
/*  57 */     this.minute = _os_.unmarshal_int();
/*  58 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  63 */     String path = dir + "mzm.gsp.ladder.confbean.STempLadderSeasonCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  76 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.ladder.confbean.STempLadderSeasonCfg"))
/*     */         {
/*     */ 
/*  79 */           STempLadderSeasonCfg obj = new STempLadderSeasonCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, STempLadderSeasonCfg> all)
/*     */   {
/*  93 */     String path = dir + "mzm.gsp.ladder.confbean.STempLadderSeasonCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 105 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.ladder.confbean.STempLadderSeasonCfg"))
/*     */         {
/*     */ 
/* 108 */           STempLadderSeasonCfg obj = new STempLadderSeasonCfg();
...
/*     */     
/* 124 */     String path = dir + "mzm.gsp.ladder.confbean.STempLadderSeasonCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 151 */           STempLadderSeasonCfg _v_ = new STempLadderSeasonCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, STempLadderSeasonCfg> all)
/*     */   {
/* 171 */     String path = dir + "mzm.gsp.ladder.confbean.STempLadderSeasonCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 198 */           STempLadderSeasonCfg _v_ = new STempLadderSeasonCfg();
...
/*     */ 
/*     */ 
/*     */   public static STempLadderSeasonCfg getOld(int key)
/*     */   {
/* 219 */     return (STempLadderSeasonCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static STempLadderSeasonCfg get(int key)
/*     */   {
/* 224 */     return (STempLadderSeasonCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, STempLadderSeasonCfg> getOldAll()
/*     */   {
/* 229 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, STempLadderSeasonCfg> getAll()
/*     */   {
/* 234 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, STempLadderSeasonCfg> newAll)
/*     */   {
/* 239 */     oldAll = all;
/* 240 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\ladder\confbean\STempLadderSeasonCfg.class
