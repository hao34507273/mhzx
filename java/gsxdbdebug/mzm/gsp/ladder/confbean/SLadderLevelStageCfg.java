...
/*     */ 
/*     */ public class SLadderLevelStageCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SLadderLevelStageCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SLadderLevelStageCfg> all = null;
/*     */   
/*     */   public int level;
...
/*  24 */     this.initScore = Integer.valueOf(rootElement.attributeValue("initScore")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  29 */     _os_.marshal(this.level);
/*  30 */     _os_.marshal(this.initScore);
/*  31 */     return _os_;
/*     */   }
/*     */   
...
/*  37 */     this.initScore = _os_.unmarshal_int();
/*  38 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.ladder.confbean.SLadderLevelStageCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.ladder.confbean.SLadderLevelStageCfg"))
/*     */         {
/*     */ 
/*  59 */           SLadderLevelStageCfg obj = new SLadderLevelStageCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SLadderLevelStageCfg> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.ladder.confbean.SLadderLevelStageCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.ladder.confbean.SLadderLevelStageCfg"))
/*     */         {
/*     */ 
/*  88 */           SLadderLevelStageCfg obj = new SLadderLevelStageCfg();
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.ladder.confbean.SLadderLevelStageCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           SLadderLevelStageCfg _v_ = new SLadderLevelStageCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SLadderLevelStageCfg> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.ladder.confbean.SLadderLevelStageCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           SLadderLevelStageCfg _v_ = new SLadderLevelStageCfg();
...
/*     */ 
/*     */ 
/*     */   public static SLadderLevelStageCfg getOld(int key)
/*     */   {
/* 199 */     return (SLadderLevelStageCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SLadderLevelStageCfg get(int key)
/*     */   {
/* 204 */     return (SLadderLevelStageCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SLadderLevelStageCfg> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SLadderLevelStageCfg> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SLadderLevelStageCfg> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\ladder\confbean\SLadderLevelStageCfg.class
