...
/*     */ 
/*     */ public class SLadderRankCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SLadderRankCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SLadderRankCfg> all = null;
/*     */   
...
/*     */   {
/*  24 */     this.chartType = Integer.valueOf(rootElement.attributeValue("chartType")).intValue();
/*  25 */     this.isLocal = Boolean.valueOf(rootElement.attributeValue("isLocal")).booleanValue();
/*  26 */     this.level = Integer.valueOf(rootElement.attributeValue("level")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  31 */     _os_.marshal(this.chartType);
/*  32 */     _os_.marshal(this.isLocal);
...
/*     */   {
/*  39 */     this.chartType = _os_.unmarshal_int();
/*  40 */     this.isLocal = _os_.unmarshal_boolean();
/*  41 */     this.level = _os_.unmarshal_int();
/*  42 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  47 */     String path = dir + "mzm.gsp.ladder.confbean.SLadderRankCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  60 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.ladder.confbean.SLadderRankCfg"))
/*     */         {
/*     */ 
/*  63 */           SLadderRankCfg obj = new SLadderRankCfg();
/*  64 */           obj.loadFromXml(elem);
/*  65 */           if (all.put(Integer.valueOf(obj.chartType), obj) != null) {
/*  66 */             throw new RuntimeException("duplicate key : " + obj.chartType);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SLadderRankCfg> all)
/*     */   {
/*  77 */     String path = dir + "mzm.gsp.ladder.confbean.SLadderRankCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  89 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.ladder.confbean.SLadderRankCfg"))
/*     */         {
/*     */ 
/*  92 */           SLadderRankCfg obj = new SLadderRankCfg();
/*  93 */           obj.loadFromXml(elem);
/*  94 */           if (all.put(Integer.valueOf(obj.chartType), obj) != null) {
/*  95 */             throw new RuntimeException("duplicate key : " + obj.chartType);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 108 */     String path = dir + "mzm.gsp.ladder.confbean.SLadderRankCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 135 */           SLadderRankCfg _v_ = new SLadderRankCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SLadderRankCfg> all)
/*     */   {
/* 155 */     String path = dir + "mzm.gsp.ladder.confbean.SLadderRankCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 182 */           SLadderRankCfg _v_ = new SLadderRankCfg();
...
/*     */ 
/*     */ 
/*     */   public static SLadderRankCfg getOld(int key)
/*     */   {
/* 203 */     return (SLadderRankCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SLadderRankCfg get(int key)
/*     */   {
/* 208 */     return (SLadderRankCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SLadderRankCfg> getOldAll()
/*     */   {
/* 213 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SLadderRankCfg> getAll()
/*     */   {
/* 218 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SLadderRankCfg> newAll)
/*     */   {
/* 223 */     oldAll = all;
/* 224 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\ladder\confbean\SLadderRankCfg.class
