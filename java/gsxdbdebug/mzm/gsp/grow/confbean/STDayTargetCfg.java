...
/*     */ 
/*     */ public class STDayTargetCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, STDayTargetCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, STDayTargetCfg> all = null;
/*     */   
/*     */   public int levelLow;
/*  19 */   public HashMap<Integer, STDayTargetData> lvUp2Data = new HashMap();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.levelLow = Integer.valueOf(rootElement.attributeValue("levelLow")).intValue();
/*     */     
/*  25 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "lvUp2Data");
...
/*  51 */             keyElem = elem;
/*     */           }
/*  53 */           else if ((valueElem == null) && (elem.getName().equalsIgnoreCase("mzm.gsp.grow.confbean.STDayTargetData")))
/*     */           {
/*  55 */             valueElem = elem;
/*     */           }
/*     */         }
...
/*     */         }
/*     */         
/*  77 */         this.lvUp2Data.put(Integer.valueOf(_k_), _v_);
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*     */   {
/*  84 */     _os_.marshal(this.levelLow);
/*  85 */     _os_.compact_uint32(this.lvUp2Data.size());
/*  86 */     for (java.util.Map.Entry<Integer, STDayTargetData> _e_ : this.lvUp2Data.entrySet())
/*     */     {
...
/*     */   {
/*  96 */     this.levelLow = _os_.unmarshal_int();
/*  97 */     for (int _size_ = _os_.uncompact_uint32(); _size_ > 0; _size_--)
/*     */     {
/*     */ 
/* 100 */       int _k_ = _os_.unmarshal_int();
/*     */       
/* 102 */       STDayTargetData _v_ = new STDayTargetData();
/* 103 */       _v_.unmarshal(_os_);
/* 104 */       this.lvUp2Data.put(Integer.valueOf(_k_), _v_);
/*     */     }
/* 106 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/* 111 */     String path = dir + "mzm.gsp.grow.confbean.STDayTargetCfg.xml";
/*     */     
/*     */     try
/*     */     {
/* 115 */       all = new HashMap();
...
/* 124 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.grow.confbean.STDayTargetCfg"))
/*     */         {
/*     */ 
/* 127 */           STDayTargetCfg obj = new STDayTargetCfg();
/* 128 */           obj.loadFromXml(elem);
/* 129 */           if (all.put(Integer.valueOf(obj.levelLow), obj) != null) {
/* 130 */             throw new RuntimeException("duplicate key : " + obj.levelLow);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, STDayTargetCfg> all)
/*     */   {
/* 141 */     String path = dir + "mzm.gsp.grow.confbean.STDayTargetCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 153 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.grow.confbean.STDayTargetCfg"))
/*     */         {
/*     */ 
/* 156 */           STDayTargetCfg obj = new STDayTargetCfg();
/* 157 */           obj.loadFromXml(elem);
/* 158 */           if (all.put(Integer.valueOf(obj.levelLow), obj) != null) {
/* 159 */             throw new RuntimeException("duplicate key : " + obj.levelLow);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/* 170 */     all = new HashMap();
/*     */     
/* 172 */     String path = dir + "mzm.gsp.grow.confbean.STDayTargetCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 199 */           STDayTargetCfg _v_ = new STDayTargetCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, STDayTargetCfg> all)
/*     */   {
/* 219 */     String path = dir + "mzm.gsp.grow.confbean.STDayTargetCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 246 */           STDayTargetCfg _v_ = new STDayTargetCfg();
...
/*     */ 
/*     */ 
/*     */   public static STDayTargetCfg getOld(int key)
/*     */   {
/* 267 */     return (STDayTargetCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static STDayTargetCfg get(int key)
/*     */   {
/* 272 */     return (STDayTargetCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, STDayTargetCfg> getOldAll()
/*     */   {
/* 277 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, STDayTargetCfg> getAll()
/*     */   {
/* 282 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, STDayTargetCfg> newAll)
/*     */   {
/* 287 */     oldAll = all;
/* 288 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\grow\confbean\STDayTargetCfg.class
