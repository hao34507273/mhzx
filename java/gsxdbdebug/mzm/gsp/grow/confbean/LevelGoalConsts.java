...
/*     */ 
/*     */ public class LevelGoalConsts
/*     */ {
/*  13 */   private static volatile LevelGoalConsts oldInstance = null;
/*     */   
/*  15 */   private static LevelGoalConsts instance = new LevelGoalConsts();
/*     */   
/*     */ 
/*     */   public int LEVEL_INTERVAL;
/*     */   
/*     */ 
/*     */   public static LevelGoalConsts getOldInstance()
/*     */   {
/*  23 */     return oldInstance;
/*     */   }
/*     */   
/*     */   public static LevelGoalConsts getInstance()
/*     */   {
/*  28 */     return instance;
/*     */   }
/*     */   
...
/*     */   {
/*  40 */     String path = dir + "mzm.gsp.grow.confbean.LevelGoalConsts.xml";
/*     */     try
/*     */     {
...
/*     */         }
/*     */       }
/*  60 */       this.LEVEL_INTERVAL = Integer.valueOf(((Element)data.get("LEVEL_INTERVAL")).attributeValue("value")).intValue();
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*  69 */     String path = dir + "mzm.gsp.grow.confbean.LevelGoalConsts.xml";
/*     */     try
/*     */     {
...
/*     */         }
/*     */       }
/*  89 */       this.LEVEL_INTERVAL = Integer.valueOf(((Element)data.get("LEVEL_INTERVAL")).attributeValue("value")).intValue();
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/* 100 */     String path = dir + "mzm.gsp.grow.confbean.LevelGoalConsts.bny";
/*     */     try
/*     */     {
...
/* 115 */         this.LEVEL_INTERVAL = _os_.unmarshal_int();
/*     */       }
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*     */   {
/* 126 */     String path = dir + "mzm.gsp.grow.confbean.LevelGoalConsts.bny";
/*     */     try
/*     */     {
...
/* 141 */         this.LEVEL_INTERVAL = _os_.unmarshal_int();
/*     */       }
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*     */   }
/*     */   
/*     */   public static void setInstance(LevelGoalConsts newInstance)
/*     */   {
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\grow\confbean\LevelGoalConsts.class
