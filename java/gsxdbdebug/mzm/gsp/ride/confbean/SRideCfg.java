...
/*     */ 
/*     */ public class SRideCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SRideCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SRideCfg> all = null;
/*     */   
/*     */   public int id;
...
/*  30 */     this.moveSpeed = Integer.valueOf(rootElement.attributeValue("moveSpeed")).intValue();
/*     */   }
/*     */   
...
/*  37 */     _os_.marshal(this.name, "UTF-8");
/*  38 */     _os_.marshal(this.modelId);
/*  39 */     _os_.marshal(this.moveSpeed);
/*  40 */     return _os_;
/*     */   }
/*     */   
...
/*  47 */     this.name = _os_.unmarshal_String("UTF-8");
/*  48 */     this.modelId = _os_.unmarshal_int();
/*  49 */     this.moveSpeed = _os_.unmarshal_int();
/*  50 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  55 */     String path = dir + "mzm.gsp.ride.confbean.SRideCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  68 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.ride.confbean.SRideCfg"))
/*     */         {
/*     */ 
/*  71 */           SRideCfg obj = new SRideCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SRideCfg> all)
/*     */   {
/*  85 */     String path = dir + "mzm.gsp.ride.confbean.SRideCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  97 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.ride.confbean.SRideCfg"))
/*     */         {
/*     */ 
/* 100 */           SRideCfg obj = new SRideCfg();
...
/*     */     
/* 116 */     String path = dir + "mzm.gsp.ride.confbean.SRideCfg.bny";
/*     */     try
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SRideCfg> all)
/*     */   {
/* 163 */     String path = dir + "mzm.gsp.ride.confbean.SRideCfg.bny";
/*     */     try
/*     */     {
...
/*     */ 
/*     */ 
/*     */   public static SRideCfg getOld(int key)
/*     */   {
/* 211 */     return (SRideCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SRideCfg get(int key)
/*     */   {
/* 216 */     return (SRideCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SRideCfg> getOldAll()
/*     */   {
/* 221 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SRideCfg> getAll()
/*     */   {
/* 226 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SRideCfg> newAll)
/*     */   {
/* 231 */     oldAll = all;
/* 232 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\ride\confbean\SRideCfg.class
