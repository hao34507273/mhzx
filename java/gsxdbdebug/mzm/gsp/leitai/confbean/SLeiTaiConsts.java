/*     */ package mzm.gsp.leitai.confbean;
/*     */ 
...
/*     */ 
/*     */ public class SLeiTaiConsts
/*     */ {
/*  13 */   private static volatile SLeiTaiConsts oldInstance = null;
/*     */   
/*  15 */   private static SLeiTaiConsts instance = new SLeiTaiConsts();
/*     */   
/*     */   public int LEI_TAI_MAP_ID;
/*     */   
/*     */   public int LEI_TAI_REFRESH_NUM;
/*     */   
/*     */   public static SLeiTaiConsts getOldInstance()
/*     */   {
/*  23 */     return oldInstance;
/*     */   }
/*     */   
/*     */   public static SLeiTaiConsts getInstance()
/*     */   {
/*  28 */     return instance;
/*     */   }
/*     */   
...
/*     */   {
/*  41 */     String path = dir + "mzm.gsp.leitai.confbean.SLeiTaiConsts.xml";
/*     */     try
/*     */     {
...
/*     */         }
/*     */       }
/*  61 */       this.LEI_TAI_MAP_ID = Integer.valueOf(((Element)data.get("LEI_TAI_MAP_ID")).attributeValue("value")).intValue();
/*  62 */       this.LEI_TAI_REFRESH_NUM = Integer.valueOf(((Element)data.get("LEI_TAI_REFRESH_NUM")).attributeValue("value")).intValue();
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*  71 */     String path = dir + "mzm.gsp.leitai.confbean.SLeiTaiConsts.xml";
/*     */     try
/*     */     {
...
/*     */         }
/*     */       }
/*  91 */       this.LEI_TAI_MAP_ID = Integer.valueOf(((Element)data.get("LEI_TAI_MAP_ID")).attributeValue("value")).intValue();
/*  92 */       this.LEI_TAI_REFRESH_NUM = Integer.valueOf(((Element)data.get("LEI_TAI_REFRESH_NUM")).attributeValue("value")).intValue();
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/* 103 */     String path = dir + "mzm.gsp.leitai.confbean.SLeiTaiConsts.bny";
/*     */     try
/*     */     {
...
/* 118 */         this.LEI_TAI_MAP_ID = _os_.unmarshal_int();
/* 119 */         this.LEI_TAI_REFRESH_NUM = _os_.unmarshal_int();
/*     */       }
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*     */   {
/* 130 */     String path = dir + "mzm.gsp.leitai.confbean.SLeiTaiConsts.bny";
/*     */     try
/*     */     {
...
/* 145 */         this.LEI_TAI_MAP_ID = _os_.unmarshal_int();
/* 146 */         this.LEI_TAI_REFRESH_NUM = _os_.unmarshal_int();
/*     */       }
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*     */   }
/*     */   
/*     */   public static void setInstance(SLeiTaiConsts newInstance)
/*     */   {
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\leitai\confbean\SLeiTaiConsts.class
