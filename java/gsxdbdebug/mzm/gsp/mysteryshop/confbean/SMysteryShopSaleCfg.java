...
/*     */ 
/*     */ public class SMysteryShopSaleCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SMysteryShopSaleCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SMysteryShopSaleCfg> all = null;
/*     */   
/*     */   public int id;
/*  19 */   public HashMap<Integer, Integer> saleMap = new HashMap();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.id = Integer.valueOf(rootElement.attributeValue("id")).intValue();
/*     */     
/*  25 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "saleMap");
...
/*     */         }
/*     */         
/*  76 */         this.saleMap.put(Integer.valueOf(_k_), Integer.valueOf(_v_));
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*  84 */     _os_.compact_uint32(this.saleMap.size());
/*  85 */     for (java.util.Map.Entry<Integer, Integer> _e_ : this.saleMap.entrySet())
/*     */     {
...
/* 102 */       this.saleMap.put(Integer.valueOf(_k_), Integer.valueOf(_v_));
/*     */     }
/* 104 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/* 109 */     String path = dir + "mzm.gsp.mysteryshop.confbean.SMysteryShopSaleCfg.xml";
/*     */     
/*     */     try
/*     */     {
/* 113 */       all = new HashMap();
...
/* 122 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.mysteryshop.confbean.SMysteryShopSaleCfg"))
/*     */         {
/*     */ 
/* 125 */           SMysteryShopSaleCfg obj = new SMysteryShopSaleCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SMysteryShopSaleCfg> all)
/*     */   {
/* 139 */     String path = dir + "mzm.gsp.mysteryshop.confbean.SMysteryShopSaleCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 151 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.mysteryshop.confbean.SMysteryShopSaleCfg"))
/*     */         {
/*     */ 
/* 154 */           SMysteryShopSaleCfg obj = new SMysteryShopSaleCfg();
...
/* 168 */     all = new HashMap();
/*     */     
/* 170 */     String path = dir + "mzm.gsp.mysteryshop.confbean.SMysteryShopSaleCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 197 */           SMysteryShopSaleCfg _v_ = new SMysteryShopSaleCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SMysteryShopSaleCfg> all)
/*     */   {
/* 217 */     String path = dir + "mzm.gsp.mysteryshop.confbean.SMysteryShopSaleCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 244 */           SMysteryShopSaleCfg _v_ = new SMysteryShopSaleCfg();
...
/*     */ 
/*     */ 
/*     */   public static SMysteryShopSaleCfg getOld(int key)
/*     */   {
/* 265 */     return (SMysteryShopSaleCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SMysteryShopSaleCfg get(int key)
/*     */   {
/* 270 */     return (SMysteryShopSaleCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMysteryShopSaleCfg> getOldAll()
/*     */   {
/* 275 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMysteryShopSaleCfg> getAll()
/*     */   {
/* 280 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SMysteryShopSaleCfg> newAll)
/*     */   {
/* 285 */     oldAll = all;
/* 286 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\mysteryshop\confbean\SMysteryShopSaleCfg.class
