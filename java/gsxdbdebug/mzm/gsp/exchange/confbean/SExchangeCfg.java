...
/*     */ 
/*     */ public class SExchangeCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SExchangeCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SExchangeCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public int moduleid;
/*  20 */   public HashMap<Integer, ExchangeAwardInfo> exchange_award_info_map = new HashMap();
/*     */   
...
/*     */     
/*  27 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "exchange_award_info_map");
...
/*  53 */             keyElem = elem;
/*     */           }
/*  55 */           else if ((valueElem == null) && (elem.getName().equalsIgnoreCase("mzm.gsp.exchange.confbean.ExchangeAwardInfo")))
/*     */           {
/*  57 */             valueElem = elem;
/*     */           }
/*     */         }
...
/*     */         
/*     */         int _k_;
/*     */         ExchangeAwardInfo _v_;
/*     */         try
/*     */         {
/*  70 */           _k_ = Integer.valueOf(keyElem.getText()).intValue();
/*  71 */           _v_ = new ExchangeAwardInfo();
...
/*     */         }
/*     */         
/*  79 */         this.exchange_award_info_map.put(Integer.valueOf(_k_), _v_);
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*  88 */     _os_.compact_uint32(this.exchange_award_info_map.size());
/*  89 */     for (java.util.Map.Entry<Integer, ExchangeAwardInfo> _e_ : this.exchange_award_info_map.entrySet())
/*     */     {
...
/*     */       
/* 106 */       ExchangeAwardInfo _v_ = new ExchangeAwardInfo();
/* 107 */       _v_.unmarshal(_os_);
/* 108 */       this.exchange_award_info_map.put(Integer.valueOf(_k_), _v_);
/*     */     }
/* 110 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/* 115 */     String path = dir + "mzm.gsp.exchange.confbean.SExchangeCfg.xml";
/*     */     
/*     */     try
/*     */     {
/* 119 */       all = new HashMap();
...
/* 128 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.exchange.confbean.SExchangeCfg"))
/*     */         {
/*     */ 
/* 131 */           SExchangeCfg obj = new SExchangeCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SExchangeCfg> all)
/*     */   {
/* 145 */     String path = dir + "mzm.gsp.exchange.confbean.SExchangeCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 157 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.exchange.confbean.SExchangeCfg"))
/*     */         {
/*     */ 
/* 160 */           SExchangeCfg obj = new SExchangeCfg();
...
/* 174 */     all = new HashMap();
/*     */     
/* 176 */     String path = dir + "mzm.gsp.exchange.confbean.SExchangeCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 203 */           SExchangeCfg _v_ = new SExchangeCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SExchangeCfg> all)
/*     */   {
/* 223 */     String path = dir + "mzm.gsp.exchange.confbean.SExchangeCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 250 */           SExchangeCfg _v_ = new SExchangeCfg();
...
/*     */ 
/*     */ 
/*     */   public static SExchangeCfg getOld(int key)
/*     */   {
/* 271 */     return (SExchangeCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SExchangeCfg get(int key)
/*     */   {
/* 276 */     return (SExchangeCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SExchangeCfg> getOldAll()
/*     */   {
/* 281 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SExchangeCfg> getAll()
/*     */   {
/* 286 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SExchangeCfg> newAll)
/*     */   {
/* 291 */     oldAll = all;
/* 292 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\exchange\confbean\SExchangeCfg.class
