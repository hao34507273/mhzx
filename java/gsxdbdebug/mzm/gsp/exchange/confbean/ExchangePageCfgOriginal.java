...
/*     */ 
/*     */ public class ExchangePageCfgOriginal implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, ExchangePageCfgOriginal> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, ExchangePageCfgOriginal> all = null;
/*     */   
/*     */   public int id;
/*     */   public String desc;
...
/*  28 */     this.activity_desc = rootElement.attributeValue("activity_desc");
/*  29 */     this.time_desc = rootElement.attributeValue("time_desc");
/*  30 */     this.display_sort_id = Integer.valueOf(rootElement.attributeValue("display_sort_id")).intValue();
/*     */   }
/*     */   
...
/*  37 */     _os_.marshal(this.activity_desc, "UTF-8");
/*  38 */     _os_.marshal(this.time_desc, "UTF-8");
/*  39 */     _os_.marshal(this.display_sort_id);
/*  40 */     return _os_;
/*     */   }
/*     */   
...
/*  47 */     this.activity_desc = _os_.unmarshal_String("UTF-8");
/*  48 */     this.time_desc = _os_.unmarshal_String("UTF-8");
/*  49 */     this.display_sort_id = _os_.unmarshal_int();
/*  50 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  55 */     String path = dir + "mzm.gsp.exchange.confbean.ExchangePageCfgOriginal.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  68 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.exchange.confbean.ExchangePageCfgOriginal"))
/*     */         {
/*     */ 
/*  71 */           ExchangePageCfgOriginal obj = new ExchangePageCfgOriginal();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, ExchangePageCfgOriginal> all)
/*     */   {
/*  85 */     String path = dir + "mzm.gsp.exchange.confbean.ExchangePageCfgOriginal.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  97 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.exchange.confbean.ExchangePageCfgOriginal"))
/*     */         {
/*     */ 
/* 100 */           ExchangePageCfgOriginal obj = new ExchangePageCfgOriginal();
...
/*     */     
/* 116 */     String path = dir + "mzm.gsp.exchange.confbean.ExchangePageCfgOriginal.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 143 */           ExchangePageCfgOriginal _v_ = new ExchangePageCfgOriginal();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, ExchangePageCfgOriginal> all)
/*     */   {
/* 163 */     String path = dir + "mzm.gsp.exchange.confbean.ExchangePageCfgOriginal.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 190 */           ExchangePageCfgOriginal _v_ = new ExchangePageCfgOriginal();
...
/*     */ 
/*     */ 
/*     */   public static ExchangePageCfgOriginal getOld(int key)
/*     */   {
/* 211 */     return (ExchangePageCfgOriginal)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static ExchangePageCfgOriginal get(int key)
/*     */   {
/* 216 */     return (ExchangePageCfgOriginal)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, ExchangePageCfgOriginal> getOldAll()
/*     */   {
/* 221 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, ExchangePageCfgOriginal> getAll()
/*     */   {
/* 226 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, ExchangePageCfgOriginal> newAll)
/*     */   {
/* 231 */     oldAll = all;
/* 232 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\exchange\confbean\ExchangePageCfgOriginal.class
