...
/*    */ 
/*    */ public class DamageWithoutVampire extends mzm.gsp.effect.main.FighterEffect implements mzm.gsp.effect.fighter.Interface.OpOnce
/*    */ {
/*    */   private int exatk;
...
/*    */   
/*    */   public DamageWithoutVampire(int exatk, int exatkrate, int skillDamageRate, int skillDamageRateMax, int fixDamage)
/*    */   {
/* 20 */     this.exatk = exatk;
...
/* 42 */     outputObj.vampire = false;
/*    */     
/* 44 */     FightUtil.DamageInputObj damageInputObj = new FightUtil.DamageInputObj(outputObj, tagertOutputObj, releaser, target, skill, effectGroup);
/*    */     
/*    */ 
/* 47 */     FightUtil.DamageOutputObj damageOutputObj = new FightUtil.DamageOutputObj();
/* 48 */     mzm.gsp.fight.main.FightUtil.handleCommonDamage(damageInputObj, damageOutputObj);
/*    */     
/* 50 */     return damageOutputObj.isHit;
/*    */   }
/*    */   
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\effect\fighter\DamageWithoutVampire.class
