...
/*    */ 
/*    */ public class PetDamage extends mzm.gsp.effect.main.FighterEffect implements mzm.gsp.fight.handle.BeforeAttackHandle
/*    */ {
/*    */   private int rate;
/*    */   
/*    */   public PetDamage(int rate)
/*    */   {
/* 12 */     this.rate = rate;
/*    */   }
/*    */   
...
/* 31 */       if ((target != null) && 
/* 32 */         (target.isPetType())) {
/* 33 */         outputObj.damageRate += this.rate;
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\effect\fighter\PetDamage.class
