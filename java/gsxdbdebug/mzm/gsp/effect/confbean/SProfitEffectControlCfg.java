...
/*     */ 
/*     */ public class SProfitEffectControlCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SProfitEffectControlCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SProfitEffectControlCfg> all = null;
/*     */   
/*     */   public int id;
...
/*  26 */     this.desc = rootElement.attributeValue("desc");
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  31 */     _os_.marshal(this.id);
/*  32 */     _os_.marshal(this.templatename, "UTF-8");
/*  33 */     _os_.marshal(this.desc, "UTF-8");
/*  34 */     return _os_;
/*     */   }
/*     */   
...
/*  40 */     this.templatename = _os_.unmarshal_String("UTF-8");
/*  41 */     this.desc = _os_.unmarshal_String("UTF-8");
/*  42 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  47 */     String path = dir + "mzm.gsp.effect.confbean.SProfitEffectControlCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  60 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.effect.confbean.SProfitEffectControlCfg"))
/*     */         {
/*     */ 
/*  63 */           SProfitEffectControlCfg obj = new SProfitEffectControlCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SProfitEffectControlCfg> all)
/*     */   {
/*  77 */     String path = dir + "mzm.gsp.effect.confbean.SProfitEffectControlCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  89 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.effect.confbean.SProfitEffectControlCfg"))
/*     */         {
/*     */ 
/*  92 */           SProfitEffectControlCfg obj = new SProfitEffectControlCfg();
...
/*     */     
/* 108 */     String path = dir + "mzm.gsp.effect.confbean.SProfitEffectControlCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 135 */           SProfitEffectControlCfg _v_ = new SProfitEffectControlCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SProfitEffectControlCfg> all)
/*     */   {
/* 155 */     String path = dir + "mzm.gsp.effect.confbean.SProfitEffectControlCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 182 */           SProfitEffectControlCfg _v_ = new SProfitEffectControlCfg();
...
/*     */ 
/*     */ 
/*     */   public static SProfitEffectControlCfg getOld(int key)
/*     */   {
/* 203 */     return (SProfitEffectControlCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SProfitEffectControlCfg get(int key)
/*     */   {
/* 208 */     return (SProfitEffectControlCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SProfitEffectControlCfg> getOldAll()
/*     */   {
/* 213 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SProfitEffectControlCfg> getAll()
/*     */   {
/* 218 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SProfitEffectControlCfg> newAll)
/*     */   {
/* 223 */     oldAll = all;
/* 224 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\effect\confbean\SProfitEffectControlCfg.class
