...
/*     */ 
/*     */ public class SEffectFormula implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SEffectFormula> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SEffectFormula> all = null;
/*     */   
/*     */   public int id;
...
/*     */   {
/*  84 */     String path = dir + "mzm.gsp.effect.confbean.SEffectFormula.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  97 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.effect.confbean.SEffectFormula"))
/*     */         {
/*     */ 
/* 100 */           SEffectFormula obj = new SEffectFormula();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SEffectFormula> all)
/*     */   {
/* 114 */     String path = dir + "mzm.gsp.effect.confbean.SEffectFormula.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 126 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.effect.confbean.SEffectFormula"))
/*     */         {
/*     */ 
/* 129 */           SEffectFormula obj = new SEffectFormula();
...
/*     */     
/* 145 */     String path = dir + "mzm.gsp.effect.confbean.SEffectFormula.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 172 */           SEffectFormula _v_ = new SEffectFormula();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SEffectFormula> all)
/*     */   {
/* 192 */     String path = dir + "mzm.gsp.effect.confbean.SEffectFormula.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 219 */           SEffectFormula _v_ = new SEffectFormula();
...
/*     */ 
/*     */ 
/*     */   public static SEffectFormula getOld(int key)
/*     */   {
/* 240 */     return (SEffectFormula)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SEffectFormula get(int key)
/*     */   {
/* 245 */     return (SEffectFormula)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SEffectFormula> getOldAll()
/*     */   {
/* 250 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SEffectFormula> getAll()
/*     */   {
/* 255 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SEffectFormula> newAll)
/*     */   {
/* 260 */     oldAll = all;
/* 261 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\effect\confbean\SEffectFormula.class
