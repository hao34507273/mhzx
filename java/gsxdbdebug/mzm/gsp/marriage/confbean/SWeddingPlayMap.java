...
/*     */ 
/*     */ public class SWeddingPlayMap implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SWeddingPlayMap> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SWeddingPlayMap> all = null;
/*     */   
/*     */   public int levelid;
/*  19 */   public HashMap<Integer, Integer> step2Time = new HashMap();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.levelid = Integer.valueOf(rootElement.attributeValue("levelid")).intValue();
/*     */     
/*  25 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "step2Time");
...
/*     */         }
/*     */         
/*  76 */         this.step2Time.put(Integer.valueOf(_k_), Integer.valueOf(_v_));
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*     */   {
/*  83 */     _os_.marshal(this.levelid);
/*  84 */     _os_.compact_uint32(this.step2Time.size());
/*  85 */     for (java.util.Map.Entry<Integer, Integer> _e_ : this.step2Time.entrySet())
/*     */     {
...
/*     */   {
/*  95 */     this.levelid = _os_.unmarshal_int();
...
/* 102 */       this.step2Time.put(Integer.valueOf(_k_), Integer.valueOf(_v_));
/*     */     }
/* 104 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/* 109 */     String path = dir + "mzm.gsp.marriage.confbean.SWeddingPlayMap.xml";
/*     */     
/*     */     try
/*     */     {
/* 113 */       all = new HashMap();
...
/* 122 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.marriage.confbean.SWeddingPlayMap"))
/*     */         {
/*     */ 
/* 125 */           SWeddingPlayMap obj = new SWeddingPlayMap();
/* 126 */           obj.loadFromXml(elem);
/* 127 */           if (all.put(Integer.valueOf(obj.levelid), obj) != null) {
/* 128 */             throw new RuntimeException("duplicate key : " + obj.levelid);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SWeddingPlayMap> all)
/*     */   {
/* 139 */     String path = dir + "mzm.gsp.marriage.confbean.SWeddingPlayMap.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 151 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.marriage.confbean.SWeddingPlayMap"))
/*     */         {
/*     */ 
/* 154 */           SWeddingPlayMap obj = new SWeddingPlayMap();
/* 155 */           obj.loadFromXml(elem);
/* 156 */           if (all.put(Integer.valueOf(obj.levelid), obj) != null) {
/* 157 */             throw new RuntimeException("duplicate key : " + obj.levelid);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/* 168 */     all = new HashMap();
/*     */     
/* 170 */     String path = dir + "mzm.gsp.marriage.confbean.SWeddingPlayMap.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 197 */           SWeddingPlayMap _v_ = new SWeddingPlayMap();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SWeddingPlayMap> all)
/*     */   {
/* 217 */     String path = dir + "mzm.gsp.marriage.confbean.SWeddingPlayMap.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 244 */           SWeddingPlayMap _v_ = new SWeddingPlayMap();
...
/*     */ 
/*     */ 
/*     */   public static SWeddingPlayMap getOld(int key)
/*     */   {
/* 265 */     return (SWeddingPlayMap)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SWeddingPlayMap get(int key)
/*     */   {
/* 270 */     return (SWeddingPlayMap)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SWeddingPlayMap> getOldAll()
/*     */   {
/* 275 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SWeddingPlayMap> getAll()
/*     */   {
/* 280 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SWeddingPlayMap> newAll)
/*     */   {
/* 285 */     oldAll = all;
/* 286 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\marriage\confbean\SWeddingPlayMap.class
