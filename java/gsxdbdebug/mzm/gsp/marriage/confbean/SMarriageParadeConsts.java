...
/*     */ 
/*     */ public class SMarriageParadeConsts
/*     */ {
/*  13 */   private static volatile SMarriageParadeConsts oldInstance = null;
/*     */   
/*  15 */   private static SMarriageParadeConsts instance = new SMarriageParadeConsts();
/*     */   
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   public static SMarriageParadeConsts getOldInstance()
/*     */   {
/*  23 */     return oldInstance;
/*     */   }
/*     */   
/*     */   public static SMarriageParadeConsts getInstance()
/*     */   {
/*  28 */     return instance;
/*     */   }
/*     */   
/*  31 */   public int paradeNPC = 150100000;
/*     */   
...
/*     */   {
/*  40 */     String path = dir + "mzm.gsp.marriage.confbean.SMarriageParadeConsts.xml";
/*     */     try
/*     */     {
...
/*     */         }
/*     */       }
/*  60 */       this.paradeNPC = Integer.valueOf(((Element)data.get("paradeNPC")).attributeValue("value")).intValue();
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*  69 */     String path = dir + "mzm.gsp.marriage.confbean.SMarriageParadeConsts.xml";
/*     */     try
/*     */     {
...
/*     */         }
/*     */       }
/*  89 */       this.paradeNPC = Integer.valueOf(((Element)data.get("paradeNPC")).attributeValue("value")).intValue();
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/* 100 */     String path = dir + "mzm.gsp.marriage.confbean.SMarriageParadeConsts.bny";
/*     */     try
/*     */     {
...
/* 115 */         this.paradeNPC = _os_.unmarshal_int();
/*     */       }
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*     */   {
/* 126 */     String path = dir + "mzm.gsp.marriage.confbean.SMarriageParadeConsts.bny";
/*     */     try
/*     */     {
...
/* 141 */         this.paradeNPC = _os_.unmarshal_int();
/*     */       }
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*     */   }
/*     */   
/*     */   public static void setInstance(SMarriageParadeConsts newInstance)
/*     */   {
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\marriage\confbean\SMarriageParadeConsts.class
