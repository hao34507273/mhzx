...
/*     */ 
/*     */ public class SMarriageTitileCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SMarriageTitileCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SMarriageTitileCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public int moneyType;
/*     */   public int moneyNum;
/*     */   public int manTitle;
/*     */   public int womenTitle;
/*     */   
...
/*  28 */     this.moneyNum = Integer.valueOf(rootElement.attributeValue("moneyNum")).intValue();
/*  29 */     this.manTitle = Integer.valueOf(rootElement.attributeValue("manTitle")).intValue();
/*  30 */     this.womenTitle = Integer.valueOf(rootElement.attributeValue("womenTitle")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  35 */     _os_.marshal(this.id);
/*  36 */     _os_.marshal(this.moneyType);
/*  37 */     _os_.marshal(this.moneyNum);
/*  38 */     _os_.marshal(this.manTitle);
/*  39 */     _os_.marshal(this.womenTitle);
/*  40 */     return _os_;
/*     */   }
/*     */   
...
/*  46 */     this.moneyType = _os_.unmarshal_int();
/*  47 */     this.moneyNum = _os_.unmarshal_int();
/*  48 */     this.manTitle = _os_.unmarshal_int();
/*  49 */     this.womenTitle = _os_.unmarshal_int();
/*  50 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  55 */     String path = dir + "mzm.gsp.marriage.confbean.SMarriageTitileCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  68 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.marriage.confbean.SMarriageTitileCfg"))
/*     */         {
/*     */ 
/*  71 */           SMarriageTitileCfg obj = new SMarriageTitileCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SMarriageTitileCfg> all)
/*     */   {
/*  85 */     String path = dir + "mzm.gsp.marriage.confbean.SMarriageTitileCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  97 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.marriage.confbean.SMarriageTitileCfg"))
/*     */         {
/*     */ 
/* 100 */           SMarriageTitileCfg obj = new SMarriageTitileCfg();
...
/*     */     
/* 116 */     String path = dir + "mzm.gsp.marriage.confbean.SMarriageTitileCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 143 */           SMarriageTitileCfg _v_ = new SMarriageTitileCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SMarriageTitileCfg> all)
/*     */   {
/* 163 */     String path = dir + "mzm.gsp.marriage.confbean.SMarriageTitileCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 190 */           SMarriageTitileCfg _v_ = new SMarriageTitileCfg();
...
/*     */ 
/*     */ 
/*     */   public static SMarriageTitileCfg getOld(int key)
/*     */   {
/* 211 */     return (SMarriageTitileCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SMarriageTitileCfg get(int key)
/*     */   {
/* 216 */     return (SMarriageTitileCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMarriageTitileCfg> getOldAll()
/*     */   {
/* 221 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMarriageTitileCfg> getAll()
/*     */   {
/* 226 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SMarriageTitileCfg> newAll)
/*     */   {
/* 231 */     oldAll = all;
/* 232 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\marriage\confbean\SMarriageTitileCfg.class
