...
/*     */ 
/*     */ public class SMarriageGiftCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SMarriageGiftCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SMarriageGiftCfg> all = null;
/*     */   
/*     */   public int id;
...
/*     */   {
/*  47 */     String path = dir + "mzm.gsp.marriage.confbean.SMarriageGiftCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  60 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.marriage.confbean.SMarriageGiftCfg"))
/*     */         {
/*     */ 
/*  63 */           SMarriageGiftCfg obj = new SMarriageGiftCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SMarriageGiftCfg> all)
/*     */   {
/*  77 */     String path = dir + "mzm.gsp.marriage.confbean.SMarriageGiftCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  89 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.marriage.confbean.SMarriageGiftCfg"))
/*     */         {
/*     */ 
/*  92 */           SMarriageGiftCfg obj = new SMarriageGiftCfg();
...
/*     */     
/* 108 */     String path = dir + "mzm.gsp.marriage.confbean.SMarriageGiftCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 135 */           SMarriageGiftCfg _v_ = new SMarriageGiftCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SMarriageGiftCfg> all)
/*     */   {
/* 155 */     String path = dir + "mzm.gsp.marriage.confbean.SMarriageGiftCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 182 */           SMarriageGiftCfg _v_ = new SMarriageGiftCfg();
...
/*     */ 
/*     */ 
/*     */   public static SMarriageGiftCfg getOld(int key)
/*     */   {
/* 203 */     return (SMarriageGiftCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SMarriageGiftCfg get(int key)
/*     */   {
/* 208 */     return (SMarriageGiftCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMarriageGiftCfg> getOldAll()
/*     */   {
/* 213 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMarriageGiftCfg> getAll()
/*     */   {
/* 218 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SMarriageGiftCfg> newAll)
/*     */   {
/* 223 */     oldAll = all;
/* 224 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\marriage\confbean\SMarriageGiftCfg.class
