...
/*     */ 
/*     */ public class SQMHWScoreModifyCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SQMHWScoreModifyCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SQMHWScoreModifyCfg> all = null;
/*     */   
/*     */   public int teamNum;
/*     */   public double modifyParam;
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.teamNum = Integer.valueOf(rootElement.attributeValue("teamNum")).intValue();
/*  24 */     this.modifyParam = Double.valueOf(rootElement.attributeValue("modifyParam")).doubleValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  29 */     _os_.marshal(this.teamNum);
/*  30 */     _os_.marshal(this.modifyParam);
/*  31 */     return _os_;
/*     */   }
/*     */   
/*     */   public OctetsStream unmarshal(OctetsStream _os_) throws com.goldhuman.Common.Marshal.MarshalException
/*     */   {
/*  36 */     this.teamNum = _os_.unmarshal_int();
/*  37 */     this.modifyParam = _os_.unmarshal_float();
/*  38 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.qmhw.confbean.SQMHWScoreModifyCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.qmhw.confbean.SQMHWScoreModifyCfg"))
/*     */         {
/*     */ 
/*  59 */           SQMHWScoreModifyCfg obj = new SQMHWScoreModifyCfg();
/*  60 */           obj.loadFromXml(elem);
/*  61 */           if (all.put(Integer.valueOf(obj.teamNum), obj) != null) {
/*  62 */             throw new RuntimeException("duplicate key : " + obj.teamNum);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SQMHWScoreModifyCfg> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.qmhw.confbean.SQMHWScoreModifyCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.qmhw.confbean.SQMHWScoreModifyCfg"))
/*     */         {
/*     */ 
/*  88 */           SQMHWScoreModifyCfg obj = new SQMHWScoreModifyCfg();
/*  89 */           obj.loadFromXml(elem);
/*  90 */           if (all.put(Integer.valueOf(obj.teamNum), obj) != null) {
/*  91 */             throw new RuntimeException("duplicate key : " + obj.teamNum);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.qmhw.confbean.SQMHWScoreModifyCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           SQMHWScoreModifyCfg _v_ = new SQMHWScoreModifyCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SQMHWScoreModifyCfg> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.qmhw.confbean.SQMHWScoreModifyCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           SQMHWScoreModifyCfg _v_ = new SQMHWScoreModifyCfg();
...
/*     */ 
/*     */ 
/*     */   public static SQMHWScoreModifyCfg getOld(int key)
/*     */   {
/* 199 */     return (SQMHWScoreModifyCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SQMHWScoreModifyCfg get(int key)
/*     */   {
/* 204 */     return (SQMHWScoreModifyCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SQMHWScoreModifyCfg> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SQMHWScoreModifyCfg> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SQMHWScoreModifyCfg> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\qmhw\confbean\SQMHWScoreModifyCfg.class
