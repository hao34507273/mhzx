...
/*     */ 
/*     */ public class SQMHWFightAwardCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SQMHWFightAwardCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SQMHWFightAwardCfg> all = null;
/*     */   
/*     */   public int count;
/*     */   public int winAwardId;
/*     */   public int loseAwardid;
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  24 */     this.count = Integer.valueOf(rootElement.attributeValue("count")).intValue();
/*  25 */     this.winAwardId = Integer.valueOf(rootElement.attributeValue("winAwardId")).intValue();
/*  26 */     this.loseAwardid = Integer.valueOf(rootElement.attributeValue("loseAwardid")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  31 */     _os_.marshal(this.count);
/*  32 */     _os_.marshal(this.winAwardId);
/*  33 */     _os_.marshal(this.loseAwardid);
/*  34 */     return _os_;
/*     */   }
/*     */   
...
/*  40 */     this.winAwardId = _os_.unmarshal_int();
/*  41 */     this.loseAwardid = _os_.unmarshal_int();
/*  42 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  47 */     String path = dir + "mzm.gsp.qmhw.confbean.SQMHWFightAwardCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  60 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.qmhw.confbean.SQMHWFightAwardCfg"))
/*     */         {
/*     */ 
/*  63 */           SQMHWFightAwardCfg obj = new SQMHWFightAwardCfg();
/*  64 */           obj.loadFromXml(elem);
/*  65 */           if (all.put(Integer.valueOf(obj.count), obj) != null) {
/*  66 */             throw new RuntimeException("duplicate key : " + obj.count);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SQMHWFightAwardCfg> all)
/*     */   {
/*  77 */     String path = dir + "mzm.gsp.qmhw.confbean.SQMHWFightAwardCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  89 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.qmhw.confbean.SQMHWFightAwardCfg"))
/*     */         {
/*     */ 
/*  92 */           SQMHWFightAwardCfg obj = new SQMHWFightAwardCfg();
/*  93 */           obj.loadFromXml(elem);
/*  94 */           if (all.put(Integer.valueOf(obj.count), obj) != null) {
/*  95 */             throw new RuntimeException("duplicate key : " + obj.count);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 108 */     String path = dir + "mzm.gsp.qmhw.confbean.SQMHWFightAwardCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 135 */           SQMHWFightAwardCfg _v_ = new SQMHWFightAwardCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SQMHWFightAwardCfg> all)
/*     */   {
/* 155 */     String path = dir + "mzm.gsp.qmhw.confbean.SQMHWFightAwardCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 182 */           SQMHWFightAwardCfg _v_ = new SQMHWFightAwardCfg();
...
/*     */ 
/*     */ 
/*     */   public static SQMHWFightAwardCfg getOld(int key)
/*     */   {
/* 203 */     return (SQMHWFightAwardCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SQMHWFightAwardCfg get(int key)
/*     */   {
/* 208 */     return (SQMHWFightAwardCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SQMHWFightAwardCfg> getOldAll()
/*     */   {
/* 213 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SQMHWFightAwardCfg> getAll()
/*     */   {
/* 218 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SQMHWFightAwardCfg> newAll)
/*     */   {
/* 223 */     oldAll = all;
/* 224 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\qmhw\confbean\SQMHWFightAwardCfg.class
