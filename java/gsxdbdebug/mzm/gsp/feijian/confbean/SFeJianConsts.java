...
/*     */ 
/*     */ public class SFeJianConsts
/*     */ {
/*  13 */   private static volatile SFeJianConsts oldInstance = null;
/*     */   
/*  15 */   private static SFeJianConsts instance = new SFeJianConsts();
/*     */   
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   public static SFeJianConsts getOldInstance()
/*     */   {
/*  23 */     return oldInstance;
/*     */   }
/*     */   
/*     */   public static SFeJianConsts getInstance()
/*     */   {
/*  28 */     return instance;
/*     */   }
/*     */   
/*  31 */   public int DEFAULT_FEIJIANID = 470000001;
/*     */   public int fei_jian_open_level;
/*     */   
...
/*     */   {
/*  41 */     String path = dir + "mzm.gsp.feijian.confbean.SFeJianConsts.xml";
/*     */     try
/*     */     {
...
/*     */         }
/*     */       }
/*  61 */       this.DEFAULT_FEIJIANID = Integer.valueOf(((Element)data.get("DEFAULT_FEIJIANID")).attributeValue("value")).intValue();
/*  62 */       this.fei_jian_open_level = Integer.valueOf(((Element)data.get("fei_jian_open_level")).attributeValue("value")).intValue();
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*  71 */     String path = dir + "mzm.gsp.feijian.confbean.SFeJianConsts.xml";
/*     */     try
/*     */     {
...
/*     */         }
/*     */       }
/*  91 */       this.DEFAULT_FEIJIANID = Integer.valueOf(((Element)data.get("DEFAULT_FEIJIANID")).attributeValue("value")).intValue();
/*  92 */       this.fei_jian_open_level = Integer.valueOf(((Element)data.get("fei_jian_open_level")).attributeValue("value")).intValue();
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/* 103 */     String path = dir + "mzm.gsp.feijian.confbean.SFeJianConsts.bny";
/*     */     try
/*     */     {
...
/* 118 */         this.DEFAULT_FEIJIANID = _os_.unmarshal_int();
/* 119 */         this.fei_jian_open_level = _os_.unmarshal_int();
/*     */       }
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*     */   {
/* 130 */     String path = dir + "mzm.gsp.feijian.confbean.SFeJianConsts.bny";
/*     */     try
/*     */     {
...
/* 145 */         this.DEFAULT_FEIJIANID = _os_.unmarshal_int();
/* 146 */         this.fei_jian_open_level = _os_.unmarshal_int();
/*     */       }
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*     */   }
/*     */   
/*     */   public static void setInstance(SFeJianConsts newInstance)
/*     */   {
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\feijian\confbean\SFeJianConsts.class
