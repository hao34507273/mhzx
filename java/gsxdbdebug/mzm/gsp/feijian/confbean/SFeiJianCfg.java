...
/*     */ 
/*     */ public class SFeiJianCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SFeiJianCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SFeiJianCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public String templateName;
/*     */   public int feiJianType;
/*     */   public String name;
/*     */   public int modelId;
/*     */   public int velocity;
/*  24 */   public java.util.ArrayList<Pro2Value> proList = new java.util.ArrayList();
/*     */   
...
/*  30 */     this.feiJianType = Integer.valueOf(rootElement.attributeValue("feiJianType")).intValue();
/*  31 */     this.name = rootElement.attributeValue("name");
/*  32 */     this.modelId = Integer.valueOf(rootElement.attributeValue("modelId")).intValue();
/*  33 */     this.velocity = Integer.valueOf(rootElement.attributeValue("velocity")).intValue();
/*     */     
/*  35 */     Element collectionElement = util.XmlHelper.getVariableElement(rootElement, "proList");
...
/*  46 */       if (elem.getName().equalsIgnoreCase("mzm.gsp.feijian.confbean.Pro2Value"))
/*     */       {
/*     */         Pro2Value _v_;
/*     */         
/*     */ 
...
/*  69 */     _os_.marshal(this.templateName, "UTF-8");
/*  70 */     _os_.marshal(this.feiJianType);
/*  71 */     _os_.marshal(this.name, "UTF-8");
/*  72 */     _os_.marshal(this.modelId);
/*  73 */     _os_.marshal(this.velocity);
/*  74 */     _os_.compact_uint32(this.proList.size());
/*  75 */     for (Pro2Value _v_ : this.proList)
/*     */     {
/*  77 */       _os_.marshal(_v_);
/*     */     }
/*  79 */     return _os_;
...
/*  86 */     this.feiJianType = _os_.unmarshal_int();
/*  87 */     this.name = _os_.unmarshal_String("UTF-8");
/*  88 */     this.modelId = _os_.unmarshal_int();
/*  89 */     this.velocity = _os_.unmarshal_int();
/*  90 */     for (int _size_ = _os_.uncompact_uint32(); _size_ > 0; _size_--)
/*     */     {
/*     */ 
/*  93 */       Pro2Value _v_ = new Pro2Value();
/*  94 */       _v_.unmarshal(_os_);
/*  95 */       this.proList.add(_v_);
/*     */     }
/*  97 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/* 102 */     String path = dir + "mzm.gsp.feijian.confbean.SFeiJianCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 115 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.feijian.confbean.SFeiJianCfg"))
/*     */         {
/*     */ 
/* 118 */           SFeiJianCfg obj = new SFeiJianCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SFeiJianCfg> all)
/*     */   {
/* 132 */     String path = dir + "mzm.gsp.feijian.confbean.SFeiJianCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 144 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.feijian.confbean.SFeiJianCfg"))
/*     */         {
/*     */ 
/* 147 */           SFeiJianCfg obj = new SFeiJianCfg();
...
/*     */     
/* 163 */     String path = dir + "mzm.gsp.feijian.confbean.SFeiJianCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 190 */           SFeiJianCfg _v_ = new SFeiJianCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SFeiJianCfg> all)
/*     */   {
/* 210 */     String path = dir + "mzm.gsp.feijian.confbean.SFeiJianCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 237 */           SFeiJianCfg _v_ = new SFeiJianCfg();
...
/*     */ 
/*     */ 
/*     */   public static SFeiJianCfg getOld(int key)
/*     */   {
/* 258 */     return (SFeiJianCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SFeiJianCfg get(int key)
/*     */   {
/* 263 */     return (SFeiJianCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SFeiJianCfg> getOldAll()
/*     */   {
/* 268 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SFeiJianCfg> getAll()
/*     */   {
/* 273 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SFeiJianCfg> newAll)
/*     */   {
/* 278 */     oldAll = all;
/* 279 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\feijian\confbean\SFeiJianCfg.class
