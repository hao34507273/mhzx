...
/*     */ 
/*     */ public class SFeiJianDyeColorCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SFeiJianDyeColorCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SFeiJianDyeColorCfg> all = null;
/*     */   
/*     */   public int fei_jian_cfg_id;
/*  19 */   public HashMap<Integer, FeiJianDyeBean> fei_jian_dye_map = new HashMap();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.fei_jian_cfg_id = Integer.valueOf(rootElement.attributeValue("fei_jian_cfg_id")).intValue();
/*     */     
/*  25 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "fei_jian_dye_map");
...
/*  51 */             keyElem = elem;
/*     */           }
/*  53 */           else if ((valueElem == null) && (elem.getName().equalsIgnoreCase("mzm.gsp.feijian.confbean.FeiJianDyeBean")))
/*     */           {
/*  55 */             valueElem = elem;
/*     */           }
/*     */         }
...
/*     */         }
/*     */         
/*  77 */         this.fei_jian_dye_map.put(Integer.valueOf(_k_), _v_);
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*     */   {
/*  84 */     _os_.marshal(this.fei_jian_cfg_id);
/*  85 */     _os_.compact_uint32(this.fei_jian_dye_map.size());
/*  86 */     for (java.util.Map.Entry<Integer, FeiJianDyeBean> _e_ : this.fei_jian_dye_map.entrySet())
/*     */     {
...
/*     */   {
/*  96 */     this.fei_jian_cfg_id = _os_.unmarshal_int();
/*  97 */     for (int _size_ = _os_.uncompact_uint32(); _size_ > 0; _size_--)
/*     */     {
/*     */ 
/* 100 */       int _k_ = _os_.unmarshal_int();
/*     */       
/* 102 */       FeiJianDyeBean _v_ = new FeiJianDyeBean();
/* 103 */       _v_.unmarshal(_os_);
/* 104 */       this.fei_jian_dye_map.put(Integer.valueOf(_k_), _v_);
/*     */     }
/* 106 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/* 111 */     String path = dir + "mzm.gsp.feijian.confbean.SFeiJianDyeColorCfg.xml";
/*     */     
/*     */     try
/*     */     {
/* 115 */       all = new HashMap();
...
/* 124 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.feijian.confbean.SFeiJianDyeColorCfg"))
/*     */         {
/*     */ 
/* 127 */           SFeiJianDyeColorCfg obj = new SFeiJianDyeColorCfg();
/* 128 */           obj.loadFromXml(elem);
/* 129 */           if (all.put(Integer.valueOf(obj.fei_jian_cfg_id), obj) != null) {
/* 130 */             throw new RuntimeException("duplicate key : " + obj.fei_jian_cfg_id);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SFeiJianDyeColorCfg> all)
/*     */   {
/* 141 */     String path = dir + "mzm.gsp.feijian.confbean.SFeiJianDyeColorCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 153 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.feijian.confbean.SFeiJianDyeColorCfg"))
/*     */         {
/*     */ 
/* 156 */           SFeiJianDyeColorCfg obj = new SFeiJianDyeColorCfg();
/* 157 */           obj.loadFromXml(elem);
/* 158 */           if (all.put(Integer.valueOf(obj.fei_jian_cfg_id), obj) != null) {
/* 159 */             throw new RuntimeException("duplicate key : " + obj.fei_jian_cfg_id);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/* 170 */     all = new HashMap();
/*     */     
/* 172 */     String path = dir + "mzm.gsp.feijian.confbean.SFeiJianDyeColorCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 199 */           SFeiJianDyeColorCfg _v_ = new SFeiJianDyeColorCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SFeiJianDyeColorCfg> all)
/*     */   {
/* 219 */     String path = dir + "mzm.gsp.feijian.confbean.SFeiJianDyeColorCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 246 */           SFeiJianDyeColorCfg _v_ = new SFeiJianDyeColorCfg();
...
/*     */ 
/*     */ 
/*     */   public static SFeiJianDyeColorCfg getOld(int key)
/*     */   {
/* 267 */     return (SFeiJianDyeColorCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SFeiJianDyeColorCfg get(int key)
/*     */   {
/* 272 */     return (SFeiJianDyeColorCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SFeiJianDyeColorCfg> getOldAll()
/*     */   {
/* 277 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SFeiJianDyeColorCfg> getAll()
/*     */   {
/* 282 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SFeiJianDyeColorCfg> newAll)
/*     */   {
/* 287 */     oldAll = all;
/* 288 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\feijian\confbean\SFeiJianDyeColorCfg.class
