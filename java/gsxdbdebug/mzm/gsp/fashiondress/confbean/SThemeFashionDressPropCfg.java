...
/*     */ 
/*     */ public class SThemeFashionDressPropCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SThemeFashionDressPropCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SThemeFashionDressPropCfg> all = null;
/*     */   
/*     */   public int theme_fashion_dress_cfg_id;
/*  19 */   public TreeMap<Integer, ExtraInfo> extra_infos = new TreeMap();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.theme_fashion_dress_cfg_id = Integer.valueOf(rootElement.attributeValue("theme_fashion_dress_cfg_id")).intValue();
/*     */     
/*  25 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "extra_infos");
...
/*  51 */             keyElem = elem;
/*     */           }
/*  53 */           else if ((valueElem == null) && (elem.getName().equalsIgnoreCase("mzm.gsp.fashiondress.confbean.ExtraInfo")))
/*     */           {
/*  55 */             valueElem = elem;
/*     */           }
/*     */         }
...
/*     */         }
/*     */         
/*  77 */         this.extra_infos.put(Integer.valueOf(_k_), _v_);
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*     */   {
/*  84 */     _os_.marshal(this.theme_fashion_dress_cfg_id);
/*  85 */     _os_.compact_uint32(this.extra_infos.size());
/*  86 */     for (java.util.Map.Entry<Integer, ExtraInfo> _e_ : this.extra_infos.entrySet())
/*     */     {
...
/*     */   {
/*  96 */     this.theme_fashion_dress_cfg_id = _os_.unmarshal_int();
/*  97 */     for (int _size_ = _os_.uncompact_uint32(); _size_ > 0; _size_--)
/*     */     {
/*     */ 
/* 100 */       int _k_ = _os_.unmarshal_int();
/*     */       
/* 102 */       ExtraInfo _v_ = new ExtraInfo();
/* 103 */       _v_.unmarshal(_os_);
/* 104 */       this.extra_infos.put(Integer.valueOf(_k_), _v_);
/*     */     }
/* 106 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/* 111 */     String path = dir + "mzm.gsp.fashiondress.confbean.SThemeFashionDressPropCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 124 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.fashiondress.confbean.SThemeFashionDressPropCfg"))
/*     */         {
/*     */ 
/* 127 */           SThemeFashionDressPropCfg obj = new SThemeFashionDressPropCfg();
/* 128 */           obj.loadFromXml(elem);
/* 129 */           if (all.put(Integer.valueOf(obj.theme_fashion_dress_cfg_id), obj) != null) {
/* 130 */             throw new RuntimeException("duplicate key : " + obj.theme_fashion_dress_cfg_id);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SThemeFashionDressPropCfg> all)
/*     */   {
/* 141 */     String path = dir + "mzm.gsp.fashiondress.confbean.SThemeFashionDressPropCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 153 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.fashiondress.confbean.SThemeFashionDressPropCfg"))
/*     */         {
/*     */ 
/* 156 */           SThemeFashionDressPropCfg obj = new SThemeFashionDressPropCfg();
/* 157 */           obj.loadFromXml(elem);
/* 158 */           if (all.put(Integer.valueOf(obj.theme_fashion_dress_cfg_id), obj) != null) {
/* 159 */             throw new RuntimeException("duplicate key : " + obj.theme_fashion_dress_cfg_id);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 172 */     String path = dir + "mzm.gsp.fashiondress.confbean.SThemeFashionDressPropCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 199 */           SThemeFashionDressPropCfg _v_ = new SThemeFashionDressPropCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SThemeFashionDressPropCfg> all)
/*     */   {
/* 219 */     String path = dir + "mzm.gsp.fashiondress.confbean.SThemeFashionDressPropCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 246 */           SThemeFashionDressPropCfg _v_ = new SThemeFashionDressPropCfg();
...
/*     */ 
/*     */ 
/*     */   public static SThemeFashionDressPropCfg getOld(int key)
/*     */   {
/* 267 */     return (SThemeFashionDressPropCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SThemeFashionDressPropCfg get(int key)
/*     */   {
/* 272 */     return (SThemeFashionDressPropCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SThemeFashionDressPropCfg> getOldAll()
/*     */   {
/* 277 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SThemeFashionDressPropCfg> getAll()
/*     */   {
/* 282 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SThemeFashionDressPropCfg> newAll)
/*     */   {
/* 287 */     oldAll = all;
/* 288 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\fashiondress\confbean\SThemeFashionDressPropCfg.class
