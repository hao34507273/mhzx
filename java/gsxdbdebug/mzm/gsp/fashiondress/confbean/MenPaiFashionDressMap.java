...
/*    */ 
/*    */ public class MenPaiFashionDressMap implements com.goldhuman.Common.Marshal.Marshal
/*    */ {
/*  9 */   public HashMap<Integer, GenderFashionDressList> menPaiFashionDressMap = new HashMap();
/*    */   
/*    */ 
/*    */   public void loadFromXml(Element rootElement)
/*    */   {
/* 14 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "menPaiFashionDressMap");
...
/* 40 */             keyElem = elem;
/*    */           }
/* 42 */           else if ((valueElem == null) && (elem.getName().equalsIgnoreCase("mzm.gsp.fashiondress.confbean.GenderFashionDressList")))
/*    */           {
/* 44 */             valueElem = elem;
/*    */           }
/*    */         }
...
/*    */         
/*    */         int _k_;
/*    */         GenderFashionDressList _v_;
/*    */         try
/*    */         {
/* 57 */           _k_ = Integer.valueOf(keyElem.getText()).intValue();
/* 58 */           _v_ = new GenderFashionDressList();
...
/*    */         }
/*    */         
/* 66 */         this.menPaiFashionDressMap.put(Integer.valueOf(_k_), _v_);
/*    */       }
/*    */     }
/*    */   }
/*    */   
...
/*    */   {
/* 73 */     _os_.compact_uint32(this.menPaiFashionDressMap.size());
/* 74 */     for (java.util.Map.Entry<Integer, GenderFashionDressList> _e_ : this.menPaiFashionDressMap.entrySet())
/*    */     {
...
/*    */       
/* 89 */       GenderFashionDressList _v_ = new GenderFashionDressList();
/* 90 */       _v_.unmarshal(_os_);
/* 91 */       this.menPaiFashionDressMap.put(Integer.valueOf(_k_), _v_);
/*    */     }
/* 93 */     return _os_;
/*    */   }
/*    */ }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\fashiondress\confbean\MenPaiFashionDressMap.class
