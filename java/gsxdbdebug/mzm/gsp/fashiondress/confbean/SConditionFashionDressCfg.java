...
/*     */ 
/*     */ public class SConditionFashionDressCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SConditionFashionDressCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SConditionFashionDressCfg> all = null;
/*     */   
/*     */   public int conditionType;
/*  19 */   public HashMap<Integer, MenPaiFashionDressMap> conditionIdMap = new HashMap();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.conditionType = Integer.valueOf(rootElement.attributeValue("conditionType")).intValue();
/*     */     
/*  25 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "conditionIdMap");
...
/*  51 */             keyElem = elem;
/*     */           }
/*  53 */           else if ((valueElem == null) && (elem.getName().equalsIgnoreCase("mzm.gsp.fashiondress.confbean.MenPaiFashionDressMap")))
/*     */           {
/*  55 */             valueElem = elem;
/*     */           }
/*     */         }
...
/*     */         
/*     */         int _k_;
/*     */         MenPaiFashionDressMap _v_;
/*     */         try
/*     */         {
/*  68 */           _k_ = Integer.valueOf(keyElem.getText()).intValue();
/*  69 */           _v_ = new MenPaiFashionDressMap();
...
/*     */         }
/*     */         
/*  77 */         this.conditionIdMap.put(Integer.valueOf(_k_), _v_);
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*     */   {
/*  84 */     _os_.marshal(this.conditionType);
/*  85 */     _os_.compact_uint32(this.conditionIdMap.size());
/*  86 */     for (java.util.Map.Entry<Integer, MenPaiFashionDressMap> _e_ : this.conditionIdMap.entrySet())
/*     */     {
...
/*     */   {
/*  96 */     this.conditionType = _os_.unmarshal_int();
/*  97 */     for (int _size_ = _os_.uncompact_uint32(); _size_ > 0; _size_--)
/*     */     {
/*     */ 
/* 100 */       int _k_ = _os_.unmarshal_int();
/*     */       
/* 102 */       MenPaiFashionDressMap _v_ = new MenPaiFashionDressMap();
/* 103 */       _v_.unmarshal(_os_);
/* 104 */       this.conditionIdMap.put(Integer.valueOf(_k_), _v_);
/*     */     }
/* 106 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/* 111 */     String path = dir + "mzm.gsp.fashiondress.confbean.SConditionFashionDressCfg.xml";
/*     */     
/*     */     try
/*     */     {
/* 115 */       all = new HashMap();
...
/* 124 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.fashiondress.confbean.SConditionFashionDressCfg"))
/*     */         {
/*     */ 
/* 127 */           SConditionFashionDressCfg obj = new SConditionFashionDressCfg();
/* 128 */           obj.loadFromXml(elem);
/* 129 */           if (all.put(Integer.valueOf(obj.conditionType), obj) != null) {
/* 130 */             throw new RuntimeException("duplicate key : " + obj.conditionType);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SConditionFashionDressCfg> all)
/*     */   {
/* 141 */     String path = dir + "mzm.gsp.fashiondress.confbean.SConditionFashionDressCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 153 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.fashiondress.confbean.SConditionFashionDressCfg"))
/*     */         {
/*     */ 
/* 156 */           SConditionFashionDressCfg obj = new SConditionFashionDressCfg();
/* 157 */           obj.loadFromXml(elem);
/* 158 */           if (all.put(Integer.valueOf(obj.conditionType), obj) != null) {
/* 159 */             throw new RuntimeException("duplicate key : " + obj.conditionType);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/* 170 */     all = new HashMap();
/*     */     
/* 172 */     String path = dir + "mzm.gsp.fashiondress.confbean.SConditionFashionDressCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 199 */           SConditionFashionDressCfg _v_ = new SConditionFashionDressCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SConditionFashionDressCfg> all)
/*     */   {
/* 219 */     String path = dir + "mzm.gsp.fashiondress.confbean.SConditionFashionDressCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 246 */           SConditionFashionDressCfg _v_ = new SConditionFashionDressCfg();
...
/*     */ 
/*     */ 
/*     */   public static SConditionFashionDressCfg getOld(int key)
/*     */   {
/* 267 */     return (SConditionFashionDressCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SConditionFashionDressCfg get(int key)
/*     */   {
/* 272 */     return (SConditionFashionDressCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SConditionFashionDressCfg> getOldAll()
/*     */   {
/* 277 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SConditionFashionDressCfg> getAll()
/*     */   {
/* 282 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SConditionFashionDressCfg> newAll)
/*     */   {
/* 287 */     oldAll = all;
/* 288 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\fashiondress\confbean\SConditionFashionDressCfg.class
