...
/*     */ 
/*     */ public class SFashionDressDyeTypeCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SFashionDressDyeTypeCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SFashionDressDyeTypeCfg> all = null;
/*     */   
/*     */   public int fashionDressDyeTypeId;
/*  19 */   public java.util.ArrayList<Integer> fashionDressCfgIdList = new java.util.ArrayList();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.fashionDressDyeTypeId = Integer.valueOf(rootElement.attributeValue("fashionDressDyeTypeId")).intValue();
/*     */     
...
/*     */   {
/*  57 */     _os_.marshal(this.fashionDressDyeTypeId);
...
/*     */   {
/*  68 */     this.fashionDressDyeTypeId = _os_.unmarshal_int();
...
/*     */   {
/*  80 */     String path = dir + "mzm.gsp.fashiondress.confbean.SFashionDressDyeTypeCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.fashiondress.confbean.SFashionDressDyeTypeCfg"))
/*     */         {
/*     */ 
/*  96 */           SFashionDressDyeTypeCfg obj = new SFashionDressDyeTypeCfg();
/*  97 */           obj.loadFromXml(elem);
/*  98 */           if (all.put(Integer.valueOf(obj.fashionDressDyeTypeId), obj) != null) {
/*  99 */             throw new RuntimeException("duplicate key : " + obj.fashionDressDyeTypeId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SFashionDressDyeTypeCfg> all)
/*     */   {
/* 110 */     String path = dir + "mzm.gsp.fashiondress.confbean.SFashionDressDyeTypeCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 122 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.fashiondress.confbean.SFashionDressDyeTypeCfg"))
/*     */         {
/*     */ 
/* 125 */           SFashionDressDyeTypeCfg obj = new SFashionDressDyeTypeCfg();
/* 126 */           obj.loadFromXml(elem);
/* 127 */           if (all.put(Integer.valueOf(obj.fashionDressDyeTypeId), obj) != null) {
/* 128 */             throw new RuntimeException("duplicate key : " + obj.fashionDressDyeTypeId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 141 */     String path = dir + "mzm.gsp.fashiondress.confbean.SFashionDressDyeTypeCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 168 */           SFashionDressDyeTypeCfg _v_ = new SFashionDressDyeTypeCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SFashionDressDyeTypeCfg> all)
/*     */   {
/* 188 */     String path = dir + "mzm.gsp.fashiondress.confbean.SFashionDressDyeTypeCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 215 */           SFashionDressDyeTypeCfg _v_ = new SFashionDressDyeTypeCfg();
...
/*     */ 
/*     */ 
/*     */   public static SFashionDressDyeTypeCfg getOld(int key)
/*     */   {
/* 236 */     return (SFashionDressDyeTypeCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SFashionDressDyeTypeCfg get(int key)
/*     */   {
/* 241 */     return (SFashionDressDyeTypeCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SFashionDressDyeTypeCfg> getOldAll()
/*     */   {
/* 246 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SFashionDressDyeTypeCfg> getAll()
/*     */   {
/* 251 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SFashionDressDyeTypeCfg> newAll)
/*     */   {
/* 256 */     oldAll = all;
/* 257 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\fashiondress\confbean\SFashionDressDyeTypeCfg.class
