...
/*     */ 
/*     */ public class SFashionDressUnLockConditionCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SFashionDressUnLockConditionCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SFashionDressUnLockConditionCfg> all = null;
/*     */   
/*     */   public int id;
...
/*  25 */     this.conditionType = Integer.valueOf(rootElement.attributeValue("conditionType")).intValue();
/*  26 */     this.conditionValue = Integer.valueOf(rootElement.attributeValue("conditionValue")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  31 */     _os_.marshal(this.id);
/*  32 */     _os_.marshal(this.conditionType);
/*  33 */     _os_.marshal(this.conditionValue);
/*  34 */     return _os_;
/*     */   }
/*     */   
...
/*  40 */     this.conditionType = _os_.unmarshal_int();
/*  41 */     this.conditionValue = _os_.unmarshal_int();
/*  42 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  47 */     String path = dir + "mzm.gsp.fashiondress.confbean.SFashionDressUnLockConditionCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  60 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.fashiondress.confbean.SFashionDressUnLockConditionCfg"))
/*     */         {
/*     */ 
/*  63 */           SFashionDressUnLockConditionCfg obj = new SFashionDressUnLockConditionCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SFashionDressUnLockConditionCfg> all)
/*     */   {
/*  77 */     String path = dir + "mzm.gsp.fashiondress.confbean.SFashionDressUnLockConditionCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  89 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.fashiondress.confbean.SFashionDressUnLockConditionCfg"))
/*     */         {
/*     */ 
/*  92 */           SFashionDressUnLockConditionCfg obj = new SFashionDressUnLockConditionCfg();
...
/*     */     
/* 108 */     String path = dir + "mzm.gsp.fashiondress.confbean.SFashionDressUnLockConditionCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 135 */           SFashionDressUnLockConditionCfg _v_ = new SFashionDressUnLockConditionCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SFashionDressUnLockConditionCfg> all)
/*     */   {
/* 155 */     String path = dir + "mzm.gsp.fashiondress.confbean.SFashionDressUnLockConditionCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 182 */           SFashionDressUnLockConditionCfg _v_ = new SFashionDressUnLockConditionCfg();
...
/*     */ 
/*     */ 
/*     */   public static SFashionDressUnLockConditionCfg getOld(int key)
/*     */   {
/* 203 */     return (SFashionDressUnLockConditionCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SFashionDressUnLockConditionCfg get(int key)
/*     */   {
/* 208 */     return (SFashionDressUnLockConditionCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SFashionDressUnLockConditionCfg> getOldAll()
/*     */   {
/* 213 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SFashionDressUnLockConditionCfg> getAll()
/*     */   {
/* 218 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SFashionDressUnLockConditionCfg> newAll)
/*     */   {
/* 223 */     oldAll = all;
/* 224 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\fashiondress\confbean\SFashionDressUnLockConditionCfg.class
