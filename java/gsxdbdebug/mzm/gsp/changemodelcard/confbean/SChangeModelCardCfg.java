...
/*     */ 
/*     */ public class SChangeModelCardCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SChangeModelCardCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SChangeModelCardCfg> all = null;
/*     */   
/*     */   public int id;
...
/*  28 */     this.cardName = rootElement.attributeValue("cardName");
/*  29 */     this.quality = Integer.valueOf(rootElement.attributeValue("quality")).intValue();
/*  30 */     this.classType = Integer.valueOf(rootElement.attributeValue("classType")).intValue();
/*  31 */     this.useLevel = Integer.valueOf(rootElement.attributeValue("useLevel")).intValue();
/*  32 */     this.changeModelId = Integer.valueOf(rootElement.attributeValue("changeModelId")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  37 */     _os_.marshal(this.id);
/*  38 */     _os_.marshal(this.cardName, "UTF-8");
/*  39 */     _os_.marshal(this.quality);
/*  40 */     _os_.marshal(this.classType);
/*  41 */     _os_.marshal(this.useLevel);
/*  42 */     _os_.marshal(this.changeModelId);
/*  43 */     return _os_;
/*     */   }
/*     */   
...
/*  49 */     this.cardName = _os_.unmarshal_String("UTF-8");
/*  50 */     this.quality = _os_.unmarshal_int();
/*  51 */     this.classType = _os_.unmarshal_int();
/*  52 */     this.useLevel = _os_.unmarshal_int();
/*  53 */     this.changeModelId = _os_.unmarshal_int();
/*  54 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  59 */     String path = dir + "mzm.gsp.changemodelcard.confbean.SChangeModelCardCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  72 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.changemodelcard.confbean.SChangeModelCardCfg"))
/*     */         {
/*     */ 
/*  75 */           SChangeModelCardCfg obj = new SChangeModelCardCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SChangeModelCardCfg> all)
/*     */   {
/*  89 */     String path = dir + "mzm.gsp.changemodelcard.confbean.SChangeModelCardCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 101 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.changemodelcard.confbean.SChangeModelCardCfg"))
/*     */         {
/*     */ 
/* 104 */           SChangeModelCardCfg obj = new SChangeModelCardCfg();
...
/*     */     
/* 120 */     String path = dir + "mzm.gsp.changemodelcard.confbean.SChangeModelCardCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 147 */           SChangeModelCardCfg _v_ = new SChangeModelCardCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SChangeModelCardCfg> all)
/*     */   {
/* 167 */     String path = dir + "mzm.gsp.changemodelcard.confbean.SChangeModelCardCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 194 */           SChangeModelCardCfg _v_ = new SChangeModelCardCfg();
...
/*     */ 
/*     */ 
/*     */   public static SChangeModelCardCfg getOld(int key)
/*     */   {
/* 215 */     return (SChangeModelCardCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SChangeModelCardCfg get(int key)
/*     */   {
/* 220 */     return (SChangeModelCardCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SChangeModelCardCfg> getOldAll()
/*     */   {
/* 225 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SChangeModelCardCfg> getAll()
/*     */   {
/* 230 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SChangeModelCardCfg> newAll)
/*     */   {
/* 235 */     oldAll = all;
/* 236 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\changemodelcard\confbean\SChangeModelCardCfg.class
