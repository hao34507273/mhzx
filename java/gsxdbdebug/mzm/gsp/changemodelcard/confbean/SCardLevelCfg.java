...
/*     */ 
/*     */ public class SCardLevelCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SCardLevelCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SCardLevelCfg> all = null;
/*     */   
/*     */   public int cardCfgId;
/*  19 */   public HashMap<Integer, SCardLevelBean> level2Bean = new HashMap();
/*     */   
...
/*  51 */             keyElem = elem;
/*     */           }
/*  53 */           else if ((valueElem == null) && (elem.getName().equalsIgnoreCase("mzm.gsp.changemodelcard.confbean.SCardLevelBean")))
/*     */           {
/*  55 */             valueElem = elem;
/*     */           }
/*     */         }
...
/*     */   {
/*  84 */     _os_.marshal(this.cardCfgId);
/*  85 */     _os_.compact_uint32(this.level2Bean.size());
/*  86 */     for (java.util.Map.Entry<Integer, SCardLevelBean> _e_ : this.level2Bean.entrySet())
/*     */     {
...
/*     */   {
/* 111 */     String path = dir + "mzm.gsp.changemodelcard.confbean.SCardLevelCfg.xml";
/*     */     
/*     */     try
/*     */     {
/* 115 */       all = new HashMap();
...
/* 124 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.changemodelcard.confbean.SCardLevelCfg"))
/*     */         {
/*     */ 
/* 127 */           SCardLevelCfg obj = new SCardLevelCfg();
/* 128 */           obj.loadFromXml(elem);
/* 129 */           if (all.put(Integer.valueOf(obj.cardCfgId), obj) != null) {
/* 130 */             throw new RuntimeException("duplicate key : " + obj.cardCfgId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SCardLevelCfg> all)
/*     */   {
/* 141 */     String path = dir + "mzm.gsp.changemodelcard.confbean.SCardLevelCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 153 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.changemodelcard.confbean.SCardLevelCfg"))
/*     */         {
/*     */ 
/* 156 */           SCardLevelCfg obj = new SCardLevelCfg();
/* 157 */           obj.loadFromXml(elem);
/* 158 */           if (all.put(Integer.valueOf(obj.cardCfgId), obj) != null) {
/* 159 */             throw new RuntimeException("duplicate key : " + obj.cardCfgId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/* 170 */     all = new HashMap();
/*     */     
/* 172 */     String path = dir + "mzm.gsp.changemodelcard.confbean.SCardLevelCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 199 */           SCardLevelCfg _v_ = new SCardLevelCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SCardLevelCfg> all)
/*     */   {
/* 219 */     String path = dir + "mzm.gsp.changemodelcard.confbean.SCardLevelCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 246 */           SCardLevelCfg _v_ = new SCardLevelCfg();
...
/*     */ 
/*     */ 
/*     */   public static SCardLevelCfg getOld(int key)
/*     */   {
/* 267 */     return (SCardLevelCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SCardLevelCfg get(int key)
/*     */   {
/* 272 */     return (SCardLevelCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SCardLevelCfg> getOldAll()
/*     */   {
/* 277 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SCardLevelCfg> getAll()
/*     */   {
/* 282 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SCardLevelCfg> newAll)
/*     */   {
/* 287 */     oldAll = all;
/* 288 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\changemodelcard\confbean\SCardLevelCfg.class
