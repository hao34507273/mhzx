...
/*     */ 
/*     */ public class SClassLevelCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SClassLevelCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SClassLevelCfg> all = null;
/*     */   
/*     */   public int classType;
/*  19 */   public HashMap<Integer, SClassLevelBean> level2Bean = new HashMap();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.classType = Integer.valueOf(rootElement.attributeValue("classType")).intValue();
/*     */     
...
/*  51 */             keyElem = elem;
/*     */           }
/*  53 */           else if ((valueElem == null) && (elem.getName().equalsIgnoreCase("mzm.gsp.changemodelcard.confbean.SClassLevelBean")))
/*     */           {
/*  55 */             valueElem = elem;
/*     */           }
/*     */         }
...
/*     */   {
/*  84 */     _os_.marshal(this.classType);
/*  85 */     _os_.compact_uint32(this.level2Bean.size());
/*  86 */     for (java.util.Map.Entry<Integer, SClassLevelBean> _e_ : this.level2Bean.entrySet())
/*     */     {
...
/*     */   {
/* 111 */     String path = dir + "mzm.gsp.changemodelcard.confbean.SClassLevelCfg.xml";
/*     */     
/*     */     try
/*     */     {
/* 115 */       all = new HashMap();
...
/* 124 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.changemodelcard.confbean.SClassLevelCfg"))
/*     */         {
/*     */ 
/* 127 */           SClassLevelCfg obj = new SClassLevelCfg();
/* 128 */           obj.loadFromXml(elem);
/* 129 */           if (all.put(Integer.valueOf(obj.classType), obj) != null) {
/* 130 */             throw new RuntimeException("duplicate key : " + obj.classType);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SClassLevelCfg> all)
/*     */   {
/* 141 */     String path = dir + "mzm.gsp.changemodelcard.confbean.SClassLevelCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 153 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.changemodelcard.confbean.SClassLevelCfg"))
/*     */         {
/*     */ 
/* 156 */           SClassLevelCfg obj = new SClassLevelCfg();
/* 157 */           obj.loadFromXml(elem);
/* 158 */           if (all.put(Integer.valueOf(obj.classType), obj) != null) {
/* 159 */             throw new RuntimeException("duplicate key : " + obj.classType);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/* 170 */     all = new HashMap();
/*     */     
/* 172 */     String path = dir + "mzm.gsp.changemodelcard.confbean.SClassLevelCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 199 */           SClassLevelCfg _v_ = new SClassLevelCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SClassLevelCfg> all)
/*     */   {
/* 219 */     String path = dir + "mzm.gsp.changemodelcard.confbean.SClassLevelCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 246 */           SClassLevelCfg _v_ = new SClassLevelCfg();
...
/*     */ 
/*     */ 
/*     */   public static SClassLevelCfg getOld(int key)
/*     */   {
/* 267 */     return (SClassLevelCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SClassLevelCfg get(int key)
/*     */   {
/* 272 */     return (SClassLevelCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SClassLevelCfg> getOldAll()
/*     */   {
/* 277 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SClassLevelCfg> getAll()
/*     */   {
/* 282 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SClassLevelCfg> newAll)
/*     */   {
/* 287 */     oldAll = all;
/* 288 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\changemodelcard\confbean\SClassLevelCfg.class
