...
/*     */ 
/*     */ public class SOriginalChangeModelCardItemFilterCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SOriginalChangeModelCardItemFilterCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SOriginalChangeModelCardItemFilterCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public int type;
...
/*  26 */     this.itemCfgId = Integer.valueOf(rootElement.attributeValue("itemCfgId")).intValue();
/*     */   }
/*     */   
...
/*  33 */     _os_.marshal(this.itemCfgId);
/*  34 */     return _os_;
/*     */   }
/*     */   
...
/*  40 */     this.type = _os_.unmarshal_int();
/*  41 */     this.itemCfgId = _os_.unmarshal_int();
/*  42 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  47 */     String path = dir + "mzm.gsp.changemodelcard.confbean.SOriginalChangeModelCardItemFilterCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  60 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.changemodelcard.confbean.SOriginalChangeModelCardItemFilterCfg"))
/*     */         {
/*     */ 
/*  63 */           SOriginalChangeModelCardItemFilterCfg obj = new SOriginalChangeModelCardItemFilterCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SOriginalChangeModelCardItemFilterCfg> all)
/*     */   {
/*  77 */     String path = dir + "mzm.gsp.changemodelcard.confbean.SOriginalChangeModelCardItemFilterCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  89 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.changemodelcard.confbean.SOriginalChangeModelCardItemFilterCfg"))
/*     */         {
/*     */ 
/*  92 */           SOriginalChangeModelCardItemFilterCfg obj = new SOriginalChangeModelCardItemFilterCfg();
...
/*     */     
/* 108 */     String path = dir + "mzm.gsp.changemodelcard.confbean.SOriginalChangeModelCardItemFilterCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 135 */           SOriginalChangeModelCardItemFilterCfg _v_ = new SOriginalChangeModelCardItemFilterCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SOriginalChangeModelCardItemFilterCfg> all)
/*     */   {
/* 155 */     String path = dir + "mzm.gsp.changemodelcard.confbean.SOriginalChangeModelCardItemFilterCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 182 */           SOriginalChangeModelCardItemFilterCfg _v_ = new SOriginalChangeModelCardItemFilterCfg();
...
/*     */ 
/*     */ 
/*     */   public static SOriginalChangeModelCardItemFilterCfg getOld(int key)
/*     */   {
/* 203 */     return (SOriginalChangeModelCardItemFilterCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SOriginalChangeModelCardItemFilterCfg get(int key)
/*     */   {
/* 208 */     return (SOriginalChangeModelCardItemFilterCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SOriginalChangeModelCardItemFilterCfg> getOldAll()
/*     */   {
/* 213 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SOriginalChangeModelCardItemFilterCfg> getAll()
/*     */   {
/* 218 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SOriginalChangeModelCardItemFilterCfg> newAll)
/*     */   {
/* 223 */     oldAll = all;
/* 224 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\changemodelcard\confbean\SOriginalChangeModelCardItemFilterCfg.class
