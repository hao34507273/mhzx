...
/*     */ 
/*     */ public class SPetMarkCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SPetMarkCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SPetMarkCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public int quality;
/*     */   public int category;
...
/*  27 */     this.quality = Integer.valueOf(rootElement.attributeValue("quality")).intValue();
/*  28 */     this.category = Integer.valueOf(rootElement.attributeValue("category")).intValue();
...
/*  36 */     _os_.marshal(this.quality);
/*  37 */     _os_.marshal(this.category);
...
/*  46 */     this.quality = _os_.unmarshal_int();
/*  47 */     this.category = _os_.unmarshal_int();
/*  48 */     this.type = _os_.unmarshal_int();
...
/*     */   {
/*  55 */     String path = dir + "mzm.gsp.petmark.confbean.SPetMarkCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  68 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.petmark.confbean.SPetMarkCfg"))
/*     */         {
/*     */ 
/*  71 */           SPetMarkCfg obj = new SPetMarkCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SPetMarkCfg> all)
/*     */   {
/*  85 */     String path = dir + "mzm.gsp.petmark.confbean.SPetMarkCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  97 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.petmark.confbean.SPetMarkCfg"))
/*     */         {
/*     */ 
/* 100 */           SPetMarkCfg obj = new SPetMarkCfg();
...
/*     */     
/* 116 */     String path = dir + "mzm.gsp.petmark.confbean.SPetMarkCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 143 */           SPetMarkCfg _v_ = new SPetMarkCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SPetMarkCfg> all)
/*     */   {
/* 163 */     String path = dir + "mzm.gsp.petmark.confbean.SPetMarkCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 190 */           SPetMarkCfg _v_ = new SPetMarkCfg();
...
/*     */ 
/*     */ 
/*     */   public static SPetMarkCfg getOld(int key)
/*     */   {
/* 211 */     return (SPetMarkCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SPetMarkCfg get(int key)
/*     */   {
/* 216 */     return (SPetMarkCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPetMarkCfg> getOldAll()
/*     */   {
/* 221 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPetMarkCfg> getAll()
/*     */   {
/* 226 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SPetMarkCfg> newAll)
/*     */   {
/* 231 */     oldAll = all;
/* 232 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\petmark\confbean\SPetMarkCfg.class
