...
/*     */ 
/*     */ public class SPetMarkLevelCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SPetMarkLevelCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SPetMarkLevelCfg> all = null;
/*     */   
/*     */   public int markCfgId;
/*  19 */   public HashMap<Integer, SPetMarkLevelBean> level2Bean = new HashMap();
/*     */   
...
/*  51 */             keyElem = elem;
/*     */           }
/*  53 */           else if ((valueElem == null) && (elem.getName().equalsIgnoreCase("mzm.gsp.petmark.confbean.SPetMarkLevelBean")))
/*     */           {
/*  55 */             valueElem = elem;
/*     */           }
/*     */         }
...
/*     */         
/*     */         int _k_;
/*     */         SPetMarkLevelBean _v_;
/*     */         try
/*     */         {
/*  68 */           _k_ = Integer.valueOf(keyElem.getText()).intValue();
/*  69 */           _v_ = new SPetMarkLevelBean();
...
/*     */   {
/*  84 */     _os_.marshal(this.markCfgId);
/*  85 */     _os_.compact_uint32(this.level2Bean.size());
/*  86 */     for (java.util.Map.Entry<Integer, SPetMarkLevelBean> _e_ : this.level2Bean.entrySet())
/*     */     {
...
/*     */   {
/* 111 */     String path = dir + "mzm.gsp.petmark.confbean.SPetMarkLevelCfg.xml";
/*     */     
/*     */     try
/*     */     {
/* 115 */       all = new HashMap();
...
/* 124 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.petmark.confbean.SPetMarkLevelCfg"))
/*     */         {
/*     */ 
/* 127 */           SPetMarkLevelCfg obj = new SPetMarkLevelCfg();
/* 128 */           obj.loadFromXml(elem);
/* 129 */           if (all.put(Integer.valueOf(obj.markCfgId), obj) != null) {
/* 130 */             throw new RuntimeException("duplicate key : " + obj.markCfgId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SPetMarkLevelCfg> all)
/*     */   {
/* 141 */     String path = dir + "mzm.gsp.petmark.confbean.SPetMarkLevelCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 153 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.petmark.confbean.SPetMarkLevelCfg"))
/*     */         {
/*     */ 
/* 156 */           SPetMarkLevelCfg obj = new SPetMarkLevelCfg();
/* 157 */           obj.loadFromXml(elem);
/* 158 */           if (all.put(Integer.valueOf(obj.markCfgId), obj) != null) {
/* 159 */             throw new RuntimeException("duplicate key : " + obj.markCfgId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/* 170 */     all = new HashMap();
/*     */     
/* 172 */     String path = dir + "mzm.gsp.petmark.confbean.SPetMarkLevelCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 199 */           SPetMarkLevelCfg _v_ = new SPetMarkLevelCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SPetMarkLevelCfg> all)
/*     */   {
/* 219 */     String path = dir + "mzm.gsp.petmark.confbean.SPetMarkLevelCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 246 */           SPetMarkLevelCfg _v_ = new SPetMarkLevelCfg();
...
/*     */ 
/*     */ 
/*     */   public static SPetMarkLevelCfg getOld(int key)
/*     */   {
/* 267 */     return (SPetMarkLevelCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SPetMarkLevelCfg get(int key)
/*     */   {
/* 272 */     return (SPetMarkLevelCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPetMarkLevelCfg> getOldAll()
/*     */   {
/* 277 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPetMarkLevelCfg> getAll()
/*     */   {
/* 282 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SPetMarkLevelCfg> newAll)
/*     */   {
/* 287 */     oldAll = all;
/* 288 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\petmark\confbean\SPetMarkLevelCfg.class
