...
/*     */ 
/*     */ public class STTaskUsedNpcLibCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, STTaskUsedNpcLibCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, STTaskUsedNpcLibCfg> all = null;
/*     */   
/*     */   public int npcLibId;
/*  19 */   public java.util.HashSet<Integer> npcIds = new java.util.HashSet();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.npcLibId = Integer.valueOf(rootElement.attributeValue("npcLibId")).intValue();
/*     */     
/*  25 */     Element collectionElement = util.XmlHelper.getVariableElement(rootElement, "npcIds");
...
/*     */         }
/*     */         
/*  50 */         this.npcIds.add(Integer.valueOf(_v_));
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*     */   {
/*  57 */     _os_.marshal(this.npcLibId);
/*  58 */     _os_.compact_uint32(this.npcIds.size());
/*  59 */     for (Integer _v_ : this.npcIds)
/*     */     {
...
/*     */   {
/*  80 */     String path = dir + "mzm.gsp.task.confbean.STTaskUsedNpcLibCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.task.confbean.STTaskUsedNpcLibCfg"))
/*     */         {
/*     */ 
/*  96 */           STTaskUsedNpcLibCfg obj = new STTaskUsedNpcLibCfg();
/*  97 */           obj.loadFromXml(elem);
/*  98 */           if (all.put(Integer.valueOf(obj.npcLibId), obj) != null) {
/*  99 */             throw new RuntimeException("duplicate key : " + obj.npcLibId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, STTaskUsedNpcLibCfg> all)
/*     */   {
/* 110 */     String path = dir + "mzm.gsp.task.confbean.STTaskUsedNpcLibCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 122 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.task.confbean.STTaskUsedNpcLibCfg"))
/*     */         {
/*     */ 
/* 125 */           STTaskUsedNpcLibCfg obj = new STTaskUsedNpcLibCfg();
/* 126 */           obj.loadFromXml(elem);
/* 127 */           if (all.put(Integer.valueOf(obj.npcLibId), obj) != null) {
/* 128 */             throw new RuntimeException("duplicate key : " + obj.npcLibId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 141 */     String path = dir + "mzm.gsp.task.confbean.STTaskUsedNpcLibCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 168 */           STTaskUsedNpcLibCfg _v_ = new STTaskUsedNpcLibCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, STTaskUsedNpcLibCfg> all)
/*     */   {
/* 188 */     String path = dir + "mzm.gsp.task.confbean.STTaskUsedNpcLibCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 215 */           STTaskUsedNpcLibCfg _v_ = new STTaskUsedNpcLibCfg();
...
/*     */ 
/*     */ 
/*     */   public static STTaskUsedNpcLibCfg getOld(int key)
/*     */   {
/* 236 */     return (STTaskUsedNpcLibCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static STTaskUsedNpcLibCfg get(int key)
/*     */   {
/* 241 */     return (STTaskUsedNpcLibCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, STTaskUsedNpcLibCfg> getOldAll()
/*     */   {
/* 246 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, STTaskUsedNpcLibCfg> getAll()
/*     */   {
/* 251 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, STTaskUsedNpcLibCfg> newAll)
/*     */   {
/* 256 */     oldAll = all;
/* 257 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\task\confbean\STTaskUsedNpcLibCfg.class
