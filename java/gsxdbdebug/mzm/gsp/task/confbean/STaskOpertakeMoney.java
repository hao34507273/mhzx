...
/*     */ 
/*     */ public class STaskOpertakeMoney implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, STaskOpertakeMoney> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, STaskOpertakeMoney> all = null;
/*     */   
/*     */   public int id;
/*     */   public int operType;
/*     */   public int teamType;
...
/*  28 */     this.takeMoney = Integer.valueOf(rootElement.attributeValue("takeMoney")).intValue();
/*     */   }
/*     */   
...
/*  36 */     _os_.marshal(this.takeMoney);
/*  37 */     return _os_;
/*     */   }
/*     */   
...
/*  45 */     this.takeMoney = _os_.unmarshal_int();
/*  46 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  51 */     String path = dir + "mzm.gsp.task.confbean.STaskOpertakeMoney.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  64 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.task.confbean.STaskOpertakeMoney"))
/*     */         {
/*     */ 
/*  67 */           STaskOpertakeMoney obj = new STaskOpertakeMoney();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, STaskOpertakeMoney> all)
/*     */   {
/*  81 */     String path = dir + "mzm.gsp.task.confbean.STaskOpertakeMoney.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.task.confbean.STaskOpertakeMoney"))
/*     */         {
/*     */ 
/*  96 */           STaskOpertakeMoney obj = new STaskOpertakeMoney();
...
/*     */     
/* 112 */     String path = dir + "mzm.gsp.task.confbean.STaskOpertakeMoney.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 139 */           STaskOpertakeMoney _v_ = new STaskOpertakeMoney();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, STaskOpertakeMoney> all)
/*     */   {
/* 159 */     String path = dir + "mzm.gsp.task.confbean.STaskOpertakeMoney.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 186 */           STaskOpertakeMoney _v_ = new STaskOpertakeMoney();
...
/*     */ 
/*     */ 
/*     */   public static STaskOpertakeMoney getOld(int key)
/*     */   {
/* 207 */     return (STaskOpertakeMoney)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static STaskOpertakeMoney get(int key)
/*     */   {
/* 212 */     return (STaskOpertakeMoney)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, STaskOpertakeMoney> getOldAll()
/*     */   {
/* 217 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, STaskOpertakeMoney> getAll()
/*     */   {
/* 222 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, STaskOpertakeMoney> newAll)
/*     */   {
/* 227 */     oldAll = all;
/* 228 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\task\confbean\STaskOpertakeMoney.class
