...
/*     */ 
/*     */ public class STNpcIdToGraphIds implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, STNpcIdToGraphIds> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, STNpcIdToGraphIds> all = null;
/*     */   
/*     */   public int npcId;
/*  19 */   public java.util.HashSet<Integer> graphIds = new java.util.HashSet();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.npcId = Integer.valueOf(rootElement.attributeValue("npcId")).intValue();
/*     */     
/*  25 */     Element collectionElement = util.XmlHelper.getVariableElement(rootElement, "graphIds");
...
/*     */         }
/*     */         
/*  50 */         this.graphIds.add(Integer.valueOf(_v_));
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*     */   {
/*  57 */     _os_.marshal(this.npcId);
/*  58 */     _os_.compact_uint32(this.graphIds.size());
/*  59 */     for (Integer _v_ : this.graphIds)
/*     */     {
...
/*     */   {
/*  80 */     String path = dir + "mzm.gsp.task.confbean.STNpcIdToGraphIds.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.task.confbean.STNpcIdToGraphIds"))
/*     */         {
/*     */ 
/*  96 */           STNpcIdToGraphIds obj = new STNpcIdToGraphIds();
/*  97 */           obj.loadFromXml(elem);
/*  98 */           if (all.put(Integer.valueOf(obj.npcId), obj) != null) {
/*  99 */             throw new RuntimeException("duplicate key : " + obj.npcId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, STNpcIdToGraphIds> all)
/*     */   {
/* 110 */     String path = dir + "mzm.gsp.task.confbean.STNpcIdToGraphIds.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 122 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.task.confbean.STNpcIdToGraphIds"))
/*     */         {
/*     */ 
/* 125 */           STNpcIdToGraphIds obj = new STNpcIdToGraphIds();
/* 126 */           obj.loadFromXml(elem);
/* 127 */           if (all.put(Integer.valueOf(obj.npcId), obj) != null) {
/* 128 */             throw new RuntimeException("duplicate key : " + obj.npcId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 141 */     String path = dir + "mzm.gsp.task.confbean.STNpcIdToGraphIds.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 168 */           STNpcIdToGraphIds _v_ = new STNpcIdToGraphIds();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, STNpcIdToGraphIds> all)
/*     */   {
/* 188 */     String path = dir + "mzm.gsp.task.confbean.STNpcIdToGraphIds.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 215 */           STNpcIdToGraphIds _v_ = new STNpcIdToGraphIds();
...
/*     */ 
/*     */ 
/*     */   public static STNpcIdToGraphIds getOld(int key)
/*     */   {
/* 236 */     return (STNpcIdToGraphIds)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static STNpcIdToGraphIds get(int key)
/*     */   {
/* 241 */     return (STNpcIdToGraphIds)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, STNpcIdToGraphIds> getOldAll()
/*     */   {
/* 246 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, STNpcIdToGraphIds> getAll()
/*     */   {
/* 251 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, STNpcIdToGraphIds> newAll)
/*     */   {
/* 256 */     oldAll = all;
/* 257 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\task\confbean\STNpcIdToGraphIds.class
