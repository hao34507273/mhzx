...
/*     */ 
/*     */ public class STaskConteam implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, STaskConteam> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, STaskConteam> all = null;
/*     */   
/*     */   public int id;
/*     */   public int contype;
/*     */   public int personCount;
/*     */   public int personRelation;
...
/*  28 */     this.personCount = Integer.valueOf(rootElement.attributeValue("personCount")).intValue();
/*  29 */     this.personRelation = Integer.valueOf(rootElement.attributeValue("personRelation")).intValue();
/*  30 */     this.friendPoint = Integer.valueOf(rootElement.attributeValue("friendPoint")).intValue();
/*     */   }
/*     */   
...
/*  37 */     _os_.marshal(this.personCount);
/*  38 */     _os_.marshal(this.personRelation);
/*  39 */     _os_.marshal(this.friendPoint);
/*  40 */     return _os_;
/*     */   }
/*     */   
...
/*  47 */     this.personCount = _os_.unmarshal_int();
/*  48 */     this.personRelation = _os_.unmarshal_int();
/*  49 */     this.friendPoint = _os_.unmarshal_int();
/*  50 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  55 */     String path = dir + "mzm.gsp.task.confbean.STaskConteam.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  68 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.task.confbean.STaskConteam"))
/*     */         {
/*     */ 
/*  71 */           STaskConteam obj = new STaskConteam();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, STaskConteam> all)
/*     */   {
/*  85 */     String path = dir + "mzm.gsp.task.confbean.STaskConteam.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  97 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.task.confbean.STaskConteam"))
/*     */         {
/*     */ 
/* 100 */           STaskConteam obj = new STaskConteam();
...
/*     */     
/* 116 */     String path = dir + "mzm.gsp.task.confbean.STaskConteam.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 143 */           STaskConteam _v_ = new STaskConteam();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, STaskConteam> all)
/*     */   {
/* 163 */     String path = dir + "mzm.gsp.task.confbean.STaskConteam.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 190 */           STaskConteam _v_ = new STaskConteam();
...
/*     */ 
/*     */ 
/*     */   public static STaskConteam getOld(int key)
/*     */   {
/* 211 */     return (STaskConteam)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static STaskConteam get(int key)
/*     */   {
/* 216 */     return (STaskConteam)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, STaskConteam> getOldAll()
/*     */   {
/* 221 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, STaskConteam> getAll()
/*     */   {
/* 226 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, STaskConteam> newAll)
/*     */   {
/* 231 */     oldAll = all;
/* 232 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\task\confbean\STaskConteam.class
