...
/*     */ 
/*     */ public class STaskOperplayOpera implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, STaskOperplayOpera> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, STaskOperplayOpera> all = null;
/*     */   
/*     */   public int id;
/*     */   public int operType;
/*     */   public int teamType;
...
/*  28 */     this.operaID = Integer.valueOf(rootElement.attributeValue("operaID")).intValue();
/*     */   }
/*     */   
...
/*  45 */     this.operaID = _os_.unmarshal_int();
/*  46 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  51 */     String path = dir + "mzm.gsp.task.confbean.STaskOperplayOpera.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  64 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.task.confbean.STaskOperplayOpera"))
/*     */         {
/*     */ 
/*  67 */           STaskOperplayOpera obj = new STaskOperplayOpera();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, STaskOperplayOpera> all)
/*     */   {
/*  81 */     String path = dir + "mzm.gsp.task.confbean.STaskOperplayOpera.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.task.confbean.STaskOperplayOpera"))
/*     */         {
/*     */ 
/*  96 */           STaskOperplayOpera obj = new STaskOperplayOpera();
...
/*     */     
/* 112 */     String path = dir + "mzm.gsp.task.confbean.STaskOperplayOpera.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 139 */           STaskOperplayOpera _v_ = new STaskOperplayOpera();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, STaskOperplayOpera> all)
/*     */   {
/* 159 */     String path = dir + "mzm.gsp.task.confbean.STaskOperplayOpera.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 186 */           STaskOperplayOpera _v_ = new STaskOperplayOpera();
...
/*     */ 
/*     */ 
/*     */   public static STaskOperplayOpera getOld(int key)
/*     */   {
/* 207 */     return (STaskOperplayOpera)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static STaskOperplayOpera get(int key)
/*     */   {
/* 212 */     return (STaskOperplayOpera)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, STaskOperplayOpera> getOldAll()
/*     */   {
/* 217 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, STaskOperplayOpera> getAll()
/*     */   {
/* 222 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, STaskOperplayOpera> newAll)
/*     */   {
/* 227 */     oldAll = all;
/* 228 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\task\confbean\STaskOperplayOpera.class
