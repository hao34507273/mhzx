...
/*     */ 
/*     */ public class STaskCongraphFinishCount implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, STaskCongraphFinishCount> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, STaskCongraphFinishCount> all = null;
/*     */   
/*     */   public int id;
/*     */   public int graphId;
...
/*  27 */     this.finishCount = Integer.valueOf(rootElement.attributeValue("finishCount")).intValue();
...
/*  35 */     _os_.marshal(this.finishCount);
...
/*  44 */     this.finishCount = _os_.unmarshal_int();
/*  45 */     this.contype = _os_.unmarshal_int();
/*  46 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  51 */     String path = dir + "mzm.gsp.task.confbean.STaskCongraphFinishCount.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  64 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.task.confbean.STaskCongraphFinishCount"))
/*     */         {
/*     */ 
/*  67 */           STaskCongraphFinishCount obj = new STaskCongraphFinishCount();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, STaskCongraphFinishCount> all)
/*     */   {
/*  81 */     String path = dir + "mzm.gsp.task.confbean.STaskCongraphFinishCount.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.task.confbean.STaskCongraphFinishCount"))
/*     */         {
/*     */ 
/*  96 */           STaskCongraphFinishCount obj = new STaskCongraphFinishCount();
...
/*     */     
/* 112 */     String path = dir + "mzm.gsp.task.confbean.STaskCongraphFinishCount.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 139 */           STaskCongraphFinishCount _v_ = new STaskCongraphFinishCount();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, STaskCongraphFinishCount> all)
/*     */   {
/* 159 */     String path = dir + "mzm.gsp.task.confbean.STaskCongraphFinishCount.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 186 */           STaskCongraphFinishCount _v_ = new STaskCongraphFinishCount();
...
/*     */ 
/*     */ 
/*     */   public static STaskCongraphFinishCount getOld(int key)
/*     */   {
/* 207 */     return (STaskCongraphFinishCount)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static STaskCongraphFinishCount get(int key)
/*     */   {
/* 212 */     return (STaskCongraphFinishCount)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, STaskCongraphFinishCount> getOldAll()
/*     */   {
/* 217 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, STaskCongraphFinishCount> getAll()
/*     */   {
/* 222 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, STaskCongraphFinishCount> newAll)
/*     */   {
/* 227 */     oldAll = all;
/* 228 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\task\confbean\STaskCongraphFinishCount.class
