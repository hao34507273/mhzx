...
/*     */ 
/*     */ public class STTaskId2PvcId implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, STTaskId2PvcId> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, STTaskId2PvcId> all = null;
/*     */   
/*     */   public int taskId;
/*     */   public int pvcId;
/*     */   
...
/*  24 */     this.pvcId = Integer.valueOf(rootElement.attributeValue("pvcId")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  29 */     _os_.marshal(this.taskId);
/*  30 */     _os_.marshal(this.pvcId);
/*  31 */     return _os_;
/*     */   }
/*     */   
...
/*  37 */     this.pvcId = _os_.unmarshal_int();
/*  38 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.task.confbean.STTaskId2PvcId.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.task.confbean.STTaskId2PvcId"))
/*     */         {
/*     */ 
/*  59 */           STTaskId2PvcId obj = new STTaskId2PvcId();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, STTaskId2PvcId> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.task.confbean.STTaskId2PvcId.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.task.confbean.STTaskId2PvcId"))
/*     */         {
/*     */ 
/*  88 */           STTaskId2PvcId obj = new STTaskId2PvcId();
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.task.confbean.STTaskId2PvcId.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           STTaskId2PvcId _v_ = new STTaskId2PvcId();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, STTaskId2PvcId> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.task.confbean.STTaskId2PvcId.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           STTaskId2PvcId _v_ = new STTaskId2PvcId();
...
/*     */ 
/*     */ 
/*     */   public static STTaskId2PvcId getOld(int key)
/*     */   {
/* 199 */     return (STTaskId2PvcId)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static STTaskId2PvcId get(int key)
/*     */   {
/* 204 */     return (STTaskId2PvcId)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, STTaskId2PvcId> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, STTaskId2PvcId> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, STTaskId2PvcId> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\task\confbean\STTaskId2PvcId.class
