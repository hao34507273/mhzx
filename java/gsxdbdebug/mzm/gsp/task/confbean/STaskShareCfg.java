...
/*     */ 
/*     */ public class STaskShareCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, STaskShareCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, STaskShareCfg> all = null;
/*     */   
/*     */   public int id;
...
/*  24 */     this.shareType = Integer.valueOf(rootElement.attributeValue("shareType")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  29 */     _os_.marshal(this.id);
/*  30 */     _os_.marshal(this.shareType);
/*  31 */     return _os_;
/*     */   }
/*     */   
...
/*  37 */     this.shareType = _os_.unmarshal_int();
/*  38 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.task.confbean.STaskShareCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.task.confbean.STaskShareCfg"))
/*     */         {
/*     */ 
/*  59 */           STaskShareCfg obj = new STaskShareCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, STaskShareCfg> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.task.confbean.STaskShareCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.task.confbean.STaskShareCfg"))
/*     */         {
/*     */ 
/*  88 */           STaskShareCfg obj = new STaskShareCfg();
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.task.confbean.STaskShareCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           STaskShareCfg _v_ = new STaskShareCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, STaskShareCfg> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.task.confbean.STaskShareCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           STaskShareCfg _v_ = new STaskShareCfg();
...
/*     */ 
/*     */ 
/*     */   public static STaskShareCfg getOld(int key)
/*     */   {
/* 199 */     return (STaskShareCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static STaskShareCfg get(int key)
/*     */   {
/* 204 */     return (STaskShareCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, STaskShareCfg> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, STaskShareCfg> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, STaskShareCfg> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\task\confbean\STaskShareCfg.class
