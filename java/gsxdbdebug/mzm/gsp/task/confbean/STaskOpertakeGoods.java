...
/*     */ 
/*     */ public class STaskOpertakeGoods implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, STaskOpertakeGoods> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, STaskOpertakeGoods> all = null;
/*     */   
/*     */   public int id;
/*     */   public int operType;
/*     */   public int teamType;
...
/*  30 */     this.cfgType = Integer.valueOf(rootElement.attributeValue("cfgType")).intValue();
/*  31 */     this.cfgId = Integer.valueOf(rootElement.attributeValue("cfgId")).intValue();
/*  32 */     this.cfgCount = Integer.valueOf(rootElement.attributeValue("cfgCount")).intValue();
/*     */   }
/*     */   
...
/*  40 */     _os_.marshal(this.cfgType);
/*  41 */     _os_.marshal(this.cfgId);
/*  42 */     _os_.marshal(this.cfgCount);
/*  43 */     return _os_;
/*     */   }
/*     */   
...
/*  51 */     this.cfgType = _os_.unmarshal_int();
/*  52 */     this.cfgId = _os_.unmarshal_int();
/*  53 */     this.cfgCount = _os_.unmarshal_int();
/*  54 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  59 */     String path = dir + "mzm.gsp.task.confbean.STaskOpertakeGoods.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  72 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.task.confbean.STaskOpertakeGoods"))
/*     */         {
/*     */ 
/*  75 */           STaskOpertakeGoods obj = new STaskOpertakeGoods();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, STaskOpertakeGoods> all)
/*     */   {
/*  89 */     String path = dir + "mzm.gsp.task.confbean.STaskOpertakeGoods.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 101 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.task.confbean.STaskOpertakeGoods"))
/*     */         {
/*     */ 
/* 104 */           STaskOpertakeGoods obj = new STaskOpertakeGoods();
...
/*     */     
/* 120 */     String path = dir + "mzm.gsp.task.confbean.STaskOpertakeGoods.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 147 */           STaskOpertakeGoods _v_ = new STaskOpertakeGoods();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, STaskOpertakeGoods> all)
/*     */   {
/* 167 */     String path = dir + "mzm.gsp.task.confbean.STaskOpertakeGoods.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 194 */           STaskOpertakeGoods _v_ = new STaskOpertakeGoods();
...
/*     */ 
/*     */ 
/*     */   public static STaskOpertakeGoods getOld(int key)
/*     */   {
/* 215 */     return (STaskOpertakeGoods)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static STaskOpertakeGoods get(int key)
/*     */   {
/* 220 */     return (STaskOpertakeGoods)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, STaskOpertakeGoods> getOldAll()
/*     */   {
/* 225 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, STaskOpertakeGoods> getAll()
/*     */   {
/* 230 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, STaskOpertakeGoods> newAll)
/*     */   {
/* 235 */     oldAll = all;
/* 236 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\task\confbean\STaskOpertakeGoods.class
