...
/*     */ 
/*     */ public class STaskOperGiveTaskGoods implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, STaskOperGiveTaskGoods> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, STaskOperGiveTaskGoods> all = null;
/*     */   
/*     */   public int id;
/*     */   public int operType;
/*     */   public int teamType;
/*     */   public int taskGoodsId;
/*     */   
...
/*  28 */     this.taskGoodsId = Integer.valueOf(rootElement.attributeValue("taskGoodsId")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  33 */     _os_.marshal(this.id);
/*  34 */     _os_.marshal(this.operType);
/*  35 */     _os_.marshal(this.teamType);
/*  36 */     _os_.marshal(this.taskGoodsId);
/*  37 */     return _os_;
/*     */   }
/*     */   
...
/*  43 */     this.operType = _os_.unmarshal_int();
/*  44 */     this.teamType = _os_.unmarshal_int();
/*  45 */     this.taskGoodsId = _os_.unmarshal_int();
/*  46 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  51 */     String path = dir + "mzm.gsp.task.confbean.STaskOperGiveTaskGoods.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  64 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.task.confbean.STaskOperGiveTaskGoods"))
/*     */         {
/*     */ 
/*  67 */           STaskOperGiveTaskGoods obj = new STaskOperGiveTaskGoods();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, STaskOperGiveTaskGoods> all)
/*     */   {
/*  81 */     String path = dir + "mzm.gsp.task.confbean.STaskOperGiveTaskGoods.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.task.confbean.STaskOperGiveTaskGoods"))
/*     */         {
/*     */ 
/*  96 */           STaskOperGiveTaskGoods obj = new STaskOperGiveTaskGoods();
...
/*     */     
/* 112 */     String path = dir + "mzm.gsp.task.confbean.STaskOperGiveTaskGoods.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 139 */           STaskOperGiveTaskGoods _v_ = new STaskOperGiveTaskGoods();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, STaskOperGiveTaskGoods> all)
/*     */   {
/* 159 */     String path = dir + "mzm.gsp.task.confbean.STaskOperGiveTaskGoods.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 186 */           STaskOperGiveTaskGoods _v_ = new STaskOperGiveTaskGoods();
...
/*     */ 
/*     */ 
/*     */   public static STaskOperGiveTaskGoods getOld(int key)
/*     */   {
/* 207 */     return (STaskOperGiveTaskGoods)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static STaskOperGiveTaskGoods get(int key)
/*     */   {
/* 212 */     return (STaskOperGiveTaskGoods)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, STaskOperGiveTaskGoods> getOldAll()
/*     */   {
/* 217 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, STaskOperGiveTaskGoods> getAll()
/*     */   {
/* 222 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, STaskOperGiveTaskGoods> newAll)
/*     */   {
/* 227 */     oldAll = all;
/* 228 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\task\confbean\STaskOperGiveTaskGoods.class
