...
/*     */ 
/*     */ public class STaskConSharePengYouQuan implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, STaskConSharePengYouQuan> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, STaskConSharePengYouQuan> all = null;
/*     */   
/*     */   public int id;
/*     */   public int contype;
/*     */   public int shareId;
/*     */   public int needShareCount;
/*     */   
...
/*  27 */     this.shareId = Integer.valueOf(rootElement.attributeValue("shareId")).intValue();
/*  28 */     this.needShareCount = Integer.valueOf(rootElement.attributeValue("needShareCount")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  33 */     _os_.marshal(this.id);
/*  34 */     _os_.marshal(this.contype);
/*  35 */     _os_.marshal(this.shareId);
/*  36 */     _os_.marshal(this.needShareCount);
/*  37 */     return _os_;
/*     */   }
/*     */   
...
/*  43 */     this.contype = _os_.unmarshal_int();
/*  44 */     this.shareId = _os_.unmarshal_int();
/*  45 */     this.needShareCount = _os_.unmarshal_int();
/*  46 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  51 */     String path = dir + "mzm.gsp.task.confbean.STaskConSharePengYouQuan.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  64 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.task.confbean.STaskConSharePengYouQuan"))
/*     */         {
/*     */ 
/*  67 */           STaskConSharePengYouQuan obj = new STaskConSharePengYouQuan();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, STaskConSharePengYouQuan> all)
/*     */   {
/*  81 */     String path = dir + "mzm.gsp.task.confbean.STaskConSharePengYouQuan.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.task.confbean.STaskConSharePengYouQuan"))
/*     */         {
/*     */ 
/*  96 */           STaskConSharePengYouQuan obj = new STaskConSharePengYouQuan();
...
/*     */     
/* 112 */     String path = dir + "mzm.gsp.task.confbean.STaskConSharePengYouQuan.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 139 */           STaskConSharePengYouQuan _v_ = new STaskConSharePengYouQuan();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, STaskConSharePengYouQuan> all)
/*     */   {
/* 159 */     String path = dir + "mzm.gsp.task.confbean.STaskConSharePengYouQuan.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 186 */           STaskConSharePengYouQuan _v_ = new STaskConSharePengYouQuan();
...
/*     */ 
/*     */ 
/*     */   public static STaskConSharePengYouQuan getOld(int key)
/*     */   {
/* 207 */     return (STaskConSharePengYouQuan)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static STaskConSharePengYouQuan get(int key)
/*     */   {
/* 212 */     return (STaskConSharePengYouQuan)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, STaskConSharePengYouQuan> getOldAll()
/*     */   {
/* 217 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, STaskConSharePengYouQuan> getAll()
/*     */   {
/* 222 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, STaskConSharePengYouQuan> newAll)
/*     */   {
/* 227 */     oldAll = all;
/* 228 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\task\confbean\STaskConSharePengYouQuan.class
