...
/*     */ 
/*     */ public class STaskConsex implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, STaskConsex> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, STaskConsex> all = null;
/*     */   
/*     */   public int id;
/*     */   public int contype;
/*     */   public int sex;
...
/*  26 */     this.sex = Integer.valueOf(rootElement.attributeValue("sex")).intValue();
/*     */   }
/*     */   
...
/*  41 */     this.sex = _os_.unmarshal_int();
/*  42 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  47 */     String path = dir + "mzm.gsp.task.confbean.STaskConsex.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  60 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.task.confbean.STaskConsex"))
/*     */         {
/*     */ 
/*  63 */           STaskConsex obj = new STaskConsex();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, STaskConsex> all)
/*     */   {
/*  77 */     String path = dir + "mzm.gsp.task.confbean.STaskConsex.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  89 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.task.confbean.STaskConsex"))
/*     */         {
/*     */ 
/*  92 */           STaskConsex obj = new STaskConsex();
...
/*     */     
/* 108 */     String path = dir + "mzm.gsp.task.confbean.STaskConsex.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 135 */           STaskConsex _v_ = new STaskConsex();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, STaskConsex> all)
/*     */   {
/* 155 */     String path = dir + "mzm.gsp.task.confbean.STaskConsex.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 182 */           STaskConsex _v_ = new STaskConsex();
...
/*     */ 
/*     */ 
/*     */   public static STaskConsex getOld(int key)
/*     */   {
/* 203 */     return (STaskConsex)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static STaskConsex get(int key)
/*     */   {
/* 208 */     return (STaskConsex)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, STaskConsex> getOldAll()
/*     */   {
/* 213 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, STaskConsex> getAll()
/*     */   {
/* 218 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, STaskConsex> newAll)
/*     */   {
/* 223 */     oldAll = all;
/* 224 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\task\confbean\STaskConsex.class
