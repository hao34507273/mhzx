...
/*     */ 
/*     */ public class STaskContoPlace implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, STaskContoPlace> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, STaskContoPlace> all = null;
/*     */   
/*     */   public int id;
/*     */   public int contype;
/*     */   public int radis;
...
/*  30 */     this.contype = Integer.valueOf(rootElement.attributeValue("contype")).intValue();
/*  31 */     this.radis = Integer.valueOf(rootElement.attributeValue("radis")).intValue();
/*  32 */     this.tipDialog = rootElement.attributeValue("tipDialog");
/*  33 */     this.mapId = Integer.valueOf(rootElement.attributeValue("mapId")).intValue();
/*  34 */     this.x = Integer.valueOf(rootElement.attributeValue("x")).intValue();
/*  35 */     this.y = Integer.valueOf(rootElement.attributeValue("y")).intValue();
/*  36 */     this.z = Integer.valueOf(rootElement.attributeValue("z")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  41 */     _os_.marshal(this.id);
/*  42 */     _os_.marshal(this.contype);
/*  43 */     _os_.marshal(this.radis);
/*  44 */     _os_.marshal(this.tipDialog, "UTF-8");
/*  45 */     _os_.marshal(this.mapId);
/*  46 */     _os_.marshal(this.x);
/*  47 */     _os_.marshal(this.y);
/*  48 */     _os_.marshal(this.z);
/*  49 */     return _os_;
/*     */   }
/*     */   
...
/*  55 */     this.contype = _os_.unmarshal_int();
/*  56 */     this.radis = _os_.unmarshal_int();
/*  57 */     this.tipDialog = _os_.unmarshal_String("UTF-8");
/*  58 */     this.mapId = _os_.unmarshal_int();
/*  59 */     this.x = _os_.unmarshal_int();
/*  60 */     this.y = _os_.unmarshal_int();
/*  61 */     this.z = _os_.unmarshal_int();
/*  62 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  67 */     String path = dir + "mzm.gsp.task.confbean.STaskContoPlace.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  80 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.task.confbean.STaskContoPlace"))
/*     */         {
/*     */ 
/*  83 */           STaskContoPlace obj = new STaskContoPlace();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, STaskContoPlace> all)
/*     */   {
/*  97 */     String path = dir + "mzm.gsp.task.confbean.STaskContoPlace.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 109 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.task.confbean.STaskContoPlace"))
/*     */         {
/*     */ 
/* 112 */           STaskContoPlace obj = new STaskContoPlace();
...
/*     */     
/* 128 */     String path = dir + "mzm.gsp.task.confbean.STaskContoPlace.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 155 */           STaskContoPlace _v_ = new STaskContoPlace();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, STaskContoPlace> all)
/*     */   {
/* 175 */     String path = dir + "mzm.gsp.task.confbean.STaskContoPlace.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 202 */           STaskContoPlace _v_ = new STaskContoPlace();
...
/*     */ 
/*     */ 
/*     */   public static STaskContoPlace getOld(int key)
/*     */   {
/* 223 */     return (STaskContoPlace)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static STaskContoPlace get(int key)
/*     */   {
/* 228 */     return (STaskContoPlace)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, STaskContoPlace> getOldAll()
/*     */   {
/* 233 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, STaskContoPlace> getAll()
/*     */   {
/* 238 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, STaskContoPlace> newAll)
/*     */   {
/* 243 */     oldAll = all;
/* 244 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\task\confbean\STaskContoPlace.class
