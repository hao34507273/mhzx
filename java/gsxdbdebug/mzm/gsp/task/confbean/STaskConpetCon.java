...
/*     */ 
/*     */ public class STaskConpetCon implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, STaskConpetCon> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, STaskConpetCon> all = null;
/*     */   
/*     */   public int id;
/*     */   public int contype;
/*     */   public int petId;
...
/*  27 */     this.petId = Integer.valueOf(rootElement.attributeValue("petId")).intValue();
/*  28 */     this.petCount = Integer.valueOf(rootElement.attributeValue("petCount")).intValue();
/*     */   }
/*     */   
...
/*  35 */     _os_.marshal(this.petId);
/*  36 */     _os_.marshal(this.petCount);
/*  37 */     return _os_;
/*     */   }
/*     */   
...
/*  44 */     this.petId = _os_.unmarshal_int();
/*  45 */     this.petCount = _os_.unmarshal_int();
/*  46 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  51 */     String path = dir + "mzm.gsp.task.confbean.STaskConpetCon.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  64 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.task.confbean.STaskConpetCon"))
/*     */         {
/*     */ 
/*  67 */           STaskConpetCon obj = new STaskConpetCon();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, STaskConpetCon> all)
/*     */   {
/*  81 */     String path = dir + "mzm.gsp.task.confbean.STaskConpetCon.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.task.confbean.STaskConpetCon"))
/*     */         {
/*     */ 
/*  96 */           STaskConpetCon obj = new STaskConpetCon();
...
/*     */     
/* 112 */     String path = dir + "mzm.gsp.task.confbean.STaskConpetCon.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 139 */           STaskConpetCon _v_ = new STaskConpetCon();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, STaskConpetCon> all)
/*     */   {
/* 159 */     String path = dir + "mzm.gsp.task.confbean.STaskConpetCon.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 186 */           STaskConpetCon _v_ = new STaskConpetCon();
...
/*     */ 
/*     */ 
/*     */   public static STaskConpetCon getOld(int key)
/*     */   {
/* 207 */     return (STaskConpetCon)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static STaskConpetCon get(int key)
/*     */   {
/* 212 */     return (STaskConpetCon)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, STaskConpetCon> getOldAll()
/*     */   {
/* 217 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, STaskConpetCon> getAll()
/*     */   {
/* 222 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, STaskConpetCon> newAll)
/*     */   {
/* 227 */     oldAll = all;
/* 228 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\task\confbean\STaskConpetCon.class
