...
/*     */ 
/*     */ public class STaskOperAddBuff implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, STaskOperAddBuff> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, STaskOperAddBuff> all = null;
/*     */   
/*     */   public int id;
/*     */   public int operType;
/*     */   public int teamType;
...
/*     */   {
/*  51 */     String path = dir + "mzm.gsp.task.confbean.STaskOperAddBuff.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  64 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.task.confbean.STaskOperAddBuff"))
/*     */         {
/*     */ 
/*  67 */           STaskOperAddBuff obj = new STaskOperAddBuff();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, STaskOperAddBuff> all)
/*     */   {
/*  81 */     String path = dir + "mzm.gsp.task.confbean.STaskOperAddBuff.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.task.confbean.STaskOperAddBuff"))
/*     */         {
/*     */ 
/*  96 */           STaskOperAddBuff obj = new STaskOperAddBuff();
...
/*     */     
/* 112 */     String path = dir + "mzm.gsp.task.confbean.STaskOperAddBuff.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 139 */           STaskOperAddBuff _v_ = new STaskOperAddBuff();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, STaskOperAddBuff> all)
/*     */   {
/* 159 */     String path = dir + "mzm.gsp.task.confbean.STaskOperAddBuff.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 186 */           STaskOperAddBuff _v_ = new STaskOperAddBuff();
...
/*     */ 
/*     */ 
/*     */   public static STaskOperAddBuff getOld(int key)
/*     */   {
/* 207 */     return (STaskOperAddBuff)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static STaskOperAddBuff get(int key)
/*     */   {
/* 212 */     return (STaskOperAddBuff)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, STaskOperAddBuff> getOldAll()
/*     */   {
/* 217 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, STaskOperAddBuff> getAll()
/*     */   {
/* 222 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, STaskOperAddBuff> newAll)
/*     */   {
/* 227 */     oldAll = all;
/* 228 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\task\confbean\STaskOperAddBuff.class
