...
/*     */ 
/*     */ public class STaskEffectCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, STaskEffectCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, STaskEffectCfg> all = null;
/*     */   
/*     */   public int id;
...
/*  28 */     this.graphId = Integer.valueOf(rootElement.attributeValue("graphId")).intValue();
/*  29 */     this.taskId = Integer.valueOf(rootElement.attributeValue("taskId")).intValue();
/*  30 */     this.effectId = Integer.valueOf(rootElement.attributeValue("effectId")).intValue();
/*     */   }
/*     */   
...
/*  37 */     _os_.marshal(this.graphId);
/*  38 */     _os_.marshal(this.taskId);
/*  39 */     _os_.marshal(this.effectId);
/*  40 */     return _os_;
/*     */   }
/*     */   
...
/*  47 */     this.graphId = _os_.unmarshal_int();
/*  48 */     this.taskId = _os_.unmarshal_int();
/*  49 */     this.effectId = _os_.unmarshal_int();
/*  50 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  55 */     String path = dir + "mzm.gsp.task.confbean.STaskEffectCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  68 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.task.confbean.STaskEffectCfg"))
/*     */         {
/*     */ 
/*  71 */           STaskEffectCfg obj = new STaskEffectCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, STaskEffectCfg> all)
/*     */   {
/*  85 */     String path = dir + "mzm.gsp.task.confbean.STaskEffectCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  97 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.task.confbean.STaskEffectCfg"))
/*     */         {
/*     */ 
/* 100 */           STaskEffectCfg obj = new STaskEffectCfg();
...
/*     */     
/* 116 */     String path = dir + "mzm.gsp.task.confbean.STaskEffectCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 143 */           STaskEffectCfg _v_ = new STaskEffectCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, STaskEffectCfg> all)
/*     */   {
/* 163 */     String path = dir + "mzm.gsp.task.confbean.STaskEffectCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 190 */           STaskEffectCfg _v_ = new STaskEffectCfg();
...
/*     */ 
/*     */ 
/*     */   public static STaskEffectCfg getOld(int key)
/*     */   {
/* 211 */     return (STaskEffectCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static STaskEffectCfg get(int key)
/*     */   {
/* 216 */     return (STaskEffectCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, STaskEffectCfg> getOldAll()
/*     */   {
/* 221 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, STaskEffectCfg> getAll()
/*     */   {
/* 226 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, STaskEffectCfg> newAll)
/*     */   {
/* 231 */     oldAll = all;
/* 232 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\task\confbean\STaskEffectCfg.class
