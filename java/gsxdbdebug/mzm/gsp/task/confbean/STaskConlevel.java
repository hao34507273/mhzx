...
/*     */ 
/*     */ public class STaskConlevel implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, STaskConlevel> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, STaskConlevel> all = null;
/*     */   
/*     */   public int id;
/*     */   public int contype;
/*     */   public int minLevel;
...
/*  28 */     this.minLevel = Integer.valueOf(rootElement.attributeValue("minLevel")).intValue();
/*  29 */     this.maxLevel = Integer.valueOf(rootElement.attributeValue("maxLevel")).intValue();
...
/*  37 */     _os_.marshal(this.minLevel);
/*  38 */     _os_.marshal(this.maxLevel);
/*  39 */     _os_.marshal(this.levelType);
/*  40 */     return _os_;
/*     */   }
/*     */   
...
/*  47 */     this.minLevel = _os_.unmarshal_int();
/*  48 */     this.maxLevel = _os_.unmarshal_int();
/*  49 */     this.levelType = _os_.unmarshal_int();
/*  50 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  55 */     String path = dir + "mzm.gsp.task.confbean.STaskConlevel.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  68 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.task.confbean.STaskConlevel"))
/*     */         {
/*     */ 
/*  71 */           STaskConlevel obj = new STaskConlevel();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, STaskConlevel> all)
/*     */   {
/*  85 */     String path = dir + "mzm.gsp.task.confbean.STaskConlevel.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  97 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.task.confbean.STaskConlevel"))
/*     */         {
/*     */ 
/* 100 */           STaskConlevel obj = new STaskConlevel();
...
/*     */     
/* 116 */     String path = dir + "mzm.gsp.task.confbean.STaskConlevel.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 143 */           STaskConlevel _v_ = new STaskConlevel();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, STaskConlevel> all)
/*     */   {
/* 163 */     String path = dir + "mzm.gsp.task.confbean.STaskConlevel.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 190 */           STaskConlevel _v_ = new STaskConlevel();
...
/*     */ 
/*     */ 
/*     */   public static STaskConlevel getOld(int key)
/*     */   {
/* 211 */     return (STaskConlevel)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static STaskConlevel get(int key)
/*     */   {
/* 216 */     return (STaskConlevel)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, STaskConlevel> getOldAll()
/*     */   {
/* 221 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, STaskConlevel> getAll()
/*     */   {
/* 226 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, STaskConlevel> newAll)
/*     */   {
/* 231 */     oldAll = all;
/* 232 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\task\confbean\STaskConlevel.class
