...
/*     */ 
/*     */ public class SLeiTaiWinCount implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SLeiTaiWinCount> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SLeiTaiWinCount> all = null;
/*     */   
/*     */   public int id;
/*     */   public int contype;
/*     */   public int winCount;
...
/*  25 */     this.contype = Integer.valueOf(rootElement.attributeValue("contype")).intValue();
/*  26 */     this.winCount = Integer.valueOf(rootElement.attributeValue("winCount")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  31 */     _os_.marshal(this.id);
/*  32 */     _os_.marshal(this.contype);
/*  33 */     _os_.marshal(this.winCount);
/*  34 */     return _os_;
/*     */   }
/*     */   
...
/*  40 */     this.contype = _os_.unmarshal_int();
/*  41 */     this.winCount = _os_.unmarshal_int();
/*  42 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  47 */     String path = dir + "mzm.gsp.task.confbean.SLeiTaiWinCount.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  60 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.task.confbean.SLeiTaiWinCount"))
/*     */         {
/*     */ 
/*  63 */           SLeiTaiWinCount obj = new SLeiTaiWinCount();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SLeiTaiWinCount> all)
/*     */   {
/*  77 */     String path = dir + "mzm.gsp.task.confbean.SLeiTaiWinCount.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  89 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.task.confbean.SLeiTaiWinCount"))
/*     */         {
/*     */ 
/*  92 */           SLeiTaiWinCount obj = new SLeiTaiWinCount();
...
/*     */     
/* 108 */     String path = dir + "mzm.gsp.task.confbean.SLeiTaiWinCount.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 135 */           SLeiTaiWinCount _v_ = new SLeiTaiWinCount();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SLeiTaiWinCount> all)
/*     */   {
/* 155 */     String path = dir + "mzm.gsp.task.confbean.SLeiTaiWinCount.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 182 */           SLeiTaiWinCount _v_ = new SLeiTaiWinCount();
...
/*     */ 
/*     */ 
/*     */   public static SLeiTaiWinCount getOld(int key)
/*     */   {
/* 203 */     return (SLeiTaiWinCount)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SLeiTaiWinCount get(int key)
/*     */   {
/* 208 */     return (SLeiTaiWinCount)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SLeiTaiWinCount> getOldAll()
/*     */   {
/* 213 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SLeiTaiWinCount> getAll()
/*     */   {
/* 218 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SLeiTaiWinCount> newAll)
/*     */   {
/* 223 */     oldAll = all;
/* 224 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\task\confbean\SLeiTaiWinCount.class
