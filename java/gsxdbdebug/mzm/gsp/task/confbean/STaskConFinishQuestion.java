...
/*     */ 
/*     */ public class STaskConFinishQuestion implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, STaskConFinishQuestion> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, STaskConFinishQuestion> all = null;
/*     */   
/*     */   public int id;
/*     */   public int contype;
/*     */   public int npcId;
/*     */   public int questionLibId;
/*     */   public int needRightNum;
...
/*  29 */     this.npcId = Integer.valueOf(rootElement.attributeValue("npcId")).intValue();
/*  30 */     this.questionLibId = Integer.valueOf(rootElement.attributeValue("questionLibId")).intValue();
/*  31 */     this.needRightNum = Integer.valueOf(rootElement.attributeValue("needRightNum")).intValue();
/*  32 */     this.questionContentId = Integer.valueOf(rootElement.attributeValue("questionContentId")).intValue();
/*     */   }
/*     */   
...
/*  39 */     _os_.marshal(this.npcId);
/*  40 */     _os_.marshal(this.questionLibId);
/*  41 */     _os_.marshal(this.needRightNum);
/*  42 */     _os_.marshal(this.questionContentId);
/*  43 */     return _os_;
/*     */   }
/*     */   
...
/*  51 */     this.questionLibId = _os_.unmarshal_int();
/*  52 */     this.needRightNum = _os_.unmarshal_int();
/*  53 */     this.questionContentId = _os_.unmarshal_int();
/*  54 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  59 */     String path = dir + "mzm.gsp.task.confbean.STaskConFinishQuestion.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  72 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.task.confbean.STaskConFinishQuestion"))
/*     */         {
/*     */ 
/*  75 */           STaskConFinishQuestion obj = new STaskConFinishQuestion();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, STaskConFinishQuestion> all)
/*     */   {
/*  89 */     String path = dir + "mzm.gsp.task.confbean.STaskConFinishQuestion.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 101 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.task.confbean.STaskConFinishQuestion"))
/*     */         {
/*     */ 
/* 104 */           STaskConFinishQuestion obj = new STaskConFinishQuestion();
...
/*     */     
/* 120 */     String path = dir + "mzm.gsp.task.confbean.STaskConFinishQuestion.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 147 */           STaskConFinishQuestion _v_ = new STaskConFinishQuestion();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, STaskConFinishQuestion> all)
/*     */   {
/* 167 */     String path = dir + "mzm.gsp.task.confbean.STaskConFinishQuestion.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 194 */           STaskConFinishQuestion _v_ = new STaskConFinishQuestion();
...
/*     */ 
/*     */ 
/*     */   public static STaskConFinishQuestion getOld(int key)
/*     */   {
/* 215 */     return (STaskConFinishQuestion)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static STaskConFinishQuestion get(int key)
/*     */   {
/* 220 */     return (STaskConFinishQuestion)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, STaskConFinishQuestion> getOldAll()
/*     */   {
/* 225 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, STaskConFinishQuestion> getAll()
/*     */   {
/* 230 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, STaskConFinishQuestion> newAll)
/*     */   {
/* 235 */     oldAll = all;
/* 236 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\task\confbean\STaskConFinishQuestion.class
