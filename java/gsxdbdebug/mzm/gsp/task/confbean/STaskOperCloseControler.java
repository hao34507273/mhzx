...
/*     */ 
/*     */ public class STaskOperCloseControler implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, STaskOperCloseControler> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, STaskOperCloseControler> all = null;
/*     */   
/*     */   public int id;
/*     */   public int operType;
/*     */   public int teamType;
...
/*     */   {
/*  88 */     String path = dir + "mzm.gsp.task.confbean.STaskOperCloseControler.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 101 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.task.confbean.STaskOperCloseControler"))
/*     */         {
/*     */ 
/* 104 */           STaskOperCloseControler obj = new STaskOperCloseControler();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, STaskOperCloseControler> all)
/*     */   {
/* 118 */     String path = dir + "mzm.gsp.task.confbean.STaskOperCloseControler.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 130 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.task.confbean.STaskOperCloseControler"))
/*     */         {
/*     */ 
/* 133 */           STaskOperCloseControler obj = new STaskOperCloseControler();
...
/*     */     
/* 149 */     String path = dir + "mzm.gsp.task.confbean.STaskOperCloseControler.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 176 */           STaskOperCloseControler _v_ = new STaskOperCloseControler();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, STaskOperCloseControler> all)
/*     */   {
/* 196 */     String path = dir + "mzm.gsp.task.confbean.STaskOperCloseControler.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 223 */           STaskOperCloseControler _v_ = new STaskOperCloseControler();
...
/*     */ 
/*     */ 
/*     */   public static STaskOperCloseControler getOld(int key)
/*     */   {
/* 244 */     return (STaskOperCloseControler)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static STaskOperCloseControler get(int key)
/*     */   {
/* 249 */     return (STaskOperCloseControler)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, STaskOperCloseControler> getOldAll()
/*     */   {
/* 254 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, STaskOperCloseControler> getAll()
/*     */   {
/* 259 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, STaskOperCloseControler> newAll)
/*     */   {
/* 264 */     oldAll = all;
/* 265 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\task\confbean\STaskOperCloseControler.class
