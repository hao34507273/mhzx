...
/*     */ 
/*     */ public class STaskConwinCount implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, STaskConwinCount> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, STaskConwinCount> all = null;
/*     */   
/*     */   public int id;
/*     */   public int contype;
/*     */   public int mapId;
...
/*  29 */     this.battleId = Integer.valueOf(rootElement.attributeValue("battleId")).intValue();
/*  30 */     this.winCount = Integer.valueOf(rootElement.attributeValue("winCount")).intValue();
/*     */   }
/*     */   
...
/*  37 */     _os_.marshal(this.mapId);
/*  38 */     _os_.marshal(this.battleId);
/*  39 */     _os_.marshal(this.winCount);
/*  40 */     return _os_;
/*     */   }
/*     */   
...
/*  47 */     this.mapId = _os_.unmarshal_int();
/*  48 */     this.battleId = _os_.unmarshal_int();
/*  49 */     this.winCount = _os_.unmarshal_int();
/*  50 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  55 */     String path = dir + "mzm.gsp.task.confbean.STaskConwinCount.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  68 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.task.confbean.STaskConwinCount"))
/*     */         {
/*     */ 
/*  71 */           STaskConwinCount obj = new STaskConwinCount();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, STaskConwinCount> all)
/*     */   {
/*  85 */     String path = dir + "mzm.gsp.task.confbean.STaskConwinCount.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  97 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.task.confbean.STaskConwinCount"))
/*     */         {
/*     */ 
/* 100 */           STaskConwinCount obj = new STaskConwinCount();
...
/*     */     
/* 116 */     String path = dir + "mzm.gsp.task.confbean.STaskConwinCount.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 143 */           STaskConwinCount _v_ = new STaskConwinCount();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, STaskConwinCount> all)
/*     */   {
/* 163 */     String path = dir + "mzm.gsp.task.confbean.STaskConwinCount.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 190 */           STaskConwinCount _v_ = new STaskConwinCount();
...
/*     */ 
/*     */ 
/*     */   public static STaskConwinCount getOld(int key)
/*     */   {
/* 211 */     return (STaskConwinCount)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static STaskConwinCount get(int key)
/*     */   {
/* 216 */     return (STaskConwinCount)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, STaskConwinCount> getOldAll()
/*     */   {
/* 221 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, STaskConwinCount> getAll()
/*     */   {
/* 226 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, STaskConwinCount> newAll)
/*     */   {
/* 231 */     oldAll = all;
/* 232 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\task\confbean\STaskConwinCount.class
