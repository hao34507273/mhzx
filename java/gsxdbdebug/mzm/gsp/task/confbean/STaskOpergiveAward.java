...
/*     */ 
/*     */ public class STaskOpergiveAward implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, STaskOpergiveAward> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, STaskOpergiveAward> all = null;
/*     */   
/*     */   public int id;
/*     */   public int operType;
/*     */   public int teamType;
...
/*  28 */     this.rewardId = Integer.valueOf(rootElement.attributeValue("rewardId")).intValue();
/*     */   }
/*     */   
...
/*  45 */     this.rewardId = _os_.unmarshal_int();
/*  46 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  51 */     String path = dir + "mzm.gsp.task.confbean.STaskOpergiveAward.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  64 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.task.confbean.STaskOpergiveAward"))
/*     */         {
/*     */ 
/*  67 */           STaskOpergiveAward obj = new STaskOpergiveAward();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, STaskOpergiveAward> all)
/*     */   {
/*  81 */     String path = dir + "mzm.gsp.task.confbean.STaskOpergiveAward.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.task.confbean.STaskOpergiveAward"))
/*     */         {
/*     */ 
/*  96 */           STaskOpergiveAward obj = new STaskOpergiveAward();
...
/*     */     
/* 112 */     String path = dir + "mzm.gsp.task.confbean.STaskOpergiveAward.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 139 */           STaskOpergiveAward _v_ = new STaskOpergiveAward();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, STaskOpergiveAward> all)
/*     */   {
/* 159 */     String path = dir + "mzm.gsp.task.confbean.STaskOpergiveAward.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 186 */           STaskOpergiveAward _v_ = new STaskOpergiveAward();
...
/*     */ 
/*     */ 
/*     */   public static STaskOpergiveAward getOld(int key)
/*     */   {
/* 207 */     return (STaskOpergiveAward)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static STaskOpergiveAward get(int key)
/*     */   {
/* 212 */     return (STaskOpergiveAward)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, STaskOpergiveAward> getOldAll()
/*     */   {
/* 217 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, STaskOpergiveAward> getAll()
/*     */   {
/* 222 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, STaskOpergiveAward> newAll)
/*     */   {
/* 227 */     oldAll = all;
/* 228 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\task\confbean\STaskOpergiveAward.class
