...
/*     */ 
/*     */ public class STaskConUseTaskGoods implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, STaskConUseTaskGoods> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, STaskConUseTaskGoods> all = null;
/*     */   
/*     */   public int id;
...
/*  25 */     this.taskGoodsId = Integer.valueOf(rootElement.attributeValue("taskGoodsId")).intValue();
...
/*  32 */     _os_.marshal(this.taskGoodsId);
/*  33 */     _os_.marshal(this.contype);
/*  34 */     return _os_;
/*     */   }
/*     */   
...
/*  40 */     this.taskGoodsId = _os_.unmarshal_int();
/*  41 */     this.contype = _os_.unmarshal_int();
/*  42 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  47 */     String path = dir + "mzm.gsp.task.confbean.STaskConUseTaskGoods.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  60 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.task.confbean.STaskConUseTaskGoods"))
/*     */         {
/*     */ 
/*  63 */           STaskConUseTaskGoods obj = new STaskConUseTaskGoods();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, STaskConUseTaskGoods> all)
/*     */   {
/*  77 */     String path = dir + "mzm.gsp.task.confbean.STaskConUseTaskGoods.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  89 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.task.confbean.STaskConUseTaskGoods"))
/*     */         {
/*     */ 
/*  92 */           STaskConUseTaskGoods obj = new STaskConUseTaskGoods();
...
/*     */     
/* 108 */     String path = dir + "mzm.gsp.task.confbean.STaskConUseTaskGoods.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 135 */           STaskConUseTaskGoods _v_ = new STaskConUseTaskGoods();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, STaskConUseTaskGoods> all)
/*     */   {
/* 155 */     String path = dir + "mzm.gsp.task.confbean.STaskConUseTaskGoods.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 182 */           STaskConUseTaskGoods _v_ = new STaskConUseTaskGoods();
...
/*     */ 
/*     */ 
/*     */   public static STaskConUseTaskGoods getOld(int key)
/*     */   {
/* 203 */     return (STaskConUseTaskGoods)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static STaskConUseTaskGoods get(int key)
/*     */   {
/* 208 */     return (STaskConUseTaskGoods)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, STaskConUseTaskGoods> getOldAll()
/*     */   {
/* 213 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, STaskConUseTaskGoods> getAll()
/*     */   {
/* 218 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, STaskConUseTaskGoods> newAll)
/*     */   {
/* 223 */     oldAll = all;
/* 224 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\task\confbean\STaskConUseTaskGoods.class
