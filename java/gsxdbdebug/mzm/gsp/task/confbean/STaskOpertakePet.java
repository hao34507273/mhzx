...
/*     */ 
/*     */ public class STaskOpertakePet implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, STaskOpertakePet> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, STaskOpertakePet> all = null;
/*     */   
/*     */   public int id;
/*     */   public int operType;
/*     */   public int teamType;
...
/*  28 */     this.takePet = Integer.valueOf(rootElement.attributeValue("takePet")).intValue();
/*     */   }
/*     */   
...
/*  45 */     this.takePet = _os_.unmarshal_int();
/*  46 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  51 */     String path = dir + "mzm.gsp.task.confbean.STaskOpertakePet.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  64 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.task.confbean.STaskOpertakePet"))
/*     */         {
/*     */ 
/*  67 */           STaskOpertakePet obj = new STaskOpertakePet();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, STaskOpertakePet> all)
/*     */   {
/*  81 */     String path = dir + "mzm.gsp.task.confbean.STaskOpertakePet.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.task.confbean.STaskOpertakePet"))
/*     */         {
/*     */ 
/*  96 */           STaskOpertakePet obj = new STaskOpertakePet();
...
/*     */     
/* 112 */     String path = dir + "mzm.gsp.task.confbean.STaskOpertakePet.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 139 */           STaskOpertakePet _v_ = new STaskOpertakePet();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, STaskOpertakePet> all)
/*     */   {
/* 159 */     String path = dir + "mzm.gsp.task.confbean.STaskOpertakePet.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 186 */           STaskOpertakePet _v_ = new STaskOpertakePet();
...
/*     */ 
/*     */ 
/*     */   public static STaskOpertakePet getOld(int key)
/*     */   {
/* 207 */     return (STaskOpertakePet)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static STaskOpertakePet get(int key)
/*     */   {
/* 212 */     return (STaskOpertakePet)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, STaskOpertakePet> getOldAll()
/*     */   {
/* 217 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, STaskOpertakePet> getAll()
/*     */   {
/* 222 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, STaskOpertakePet> newAll)
/*     */   {
/* 227 */     oldAll = all;
/* 228 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\task\confbean\STaskOpertakePet.class
