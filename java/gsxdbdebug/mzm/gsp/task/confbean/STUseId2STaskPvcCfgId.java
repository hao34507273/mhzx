...
/*     */ 
/*     */ public class STUseId2STaskPvcCfgId implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, STUseId2STaskPvcCfgId> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, STUseId2STaskPvcCfgId> all = null;
/*     */   
/*     */   public int taskUsePvcId;
/*     */   public int sTaskPvcCfgId;
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.taskUsePvcId = Integer.valueOf(rootElement.attributeValue("taskUsePvcId")).intValue();
/*  24 */     this.sTaskPvcCfgId = Integer.valueOf(rootElement.attributeValue("sTaskPvcCfgId")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  29 */     _os_.marshal(this.taskUsePvcId);
/*  30 */     _os_.marshal(this.sTaskPvcCfgId);
/*  31 */     return _os_;
/*     */   }
/*     */   
/*     */   public OctetsStream unmarshal(OctetsStream _os_) throws com.goldhuman.Common.Marshal.MarshalException
/*     */   {
/*  36 */     this.taskUsePvcId = _os_.unmarshal_int();
/*  37 */     this.sTaskPvcCfgId = _os_.unmarshal_int();
/*  38 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.task.confbean.STUseId2STaskPvcCfgId.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.task.confbean.STUseId2STaskPvcCfgId"))
/*     */         {
/*     */ 
/*  59 */           STUseId2STaskPvcCfgId obj = new STUseId2STaskPvcCfgId();
/*  60 */           obj.loadFromXml(elem);
/*  61 */           if (all.put(Integer.valueOf(obj.taskUsePvcId), obj) != null) {
/*  62 */             throw new RuntimeException("duplicate key : " + obj.taskUsePvcId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, STUseId2STaskPvcCfgId> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.task.confbean.STUseId2STaskPvcCfgId.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.task.confbean.STUseId2STaskPvcCfgId"))
/*     */         {
/*     */ 
/*  88 */           STUseId2STaskPvcCfgId obj = new STUseId2STaskPvcCfgId();
/*  89 */           obj.loadFromXml(elem);
/*  90 */           if (all.put(Integer.valueOf(obj.taskUsePvcId), obj) != null) {
/*  91 */             throw new RuntimeException("duplicate key : " + obj.taskUsePvcId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.task.confbean.STUseId2STaskPvcCfgId.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           STUseId2STaskPvcCfgId _v_ = new STUseId2STaskPvcCfgId();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, STUseId2STaskPvcCfgId> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.task.confbean.STUseId2STaskPvcCfgId.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           STUseId2STaskPvcCfgId _v_ = new STUseId2STaskPvcCfgId();
...
/*     */ 
/*     */ 
/*     */   public static STUseId2STaskPvcCfgId getOld(int key)
/*     */   {
/* 199 */     return (STUseId2STaskPvcCfgId)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static STUseId2STaskPvcCfgId get(int key)
/*     */   {
/* 204 */     return (STUseId2STaskPvcCfgId)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, STUseId2STaskPvcCfgId> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, STUseId2STaskPvcCfgId> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, STUseId2STaskPvcCfgId> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\task\confbean\STUseId2STaskPvcCfgId.class
