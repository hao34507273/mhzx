...
/*     */ 
/*     */ public class STaskConkillMonsterCount implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, STaskConkillMonsterCount> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, STaskConkillMonsterCount> all = null;
/*     */   
/*     */   public int id;
/*     */   public int contype;
/*     */   public int killMonsterMapId;
...
/*  28 */     this.killMonsterMapId = Integer.valueOf(rootElement.attributeValue("killMonsterMapId")).intValue();
/*  29 */     this.killMonsterId = Integer.valueOf(rootElement.attributeValue("killMonsterId")).intValue();
/*  30 */     this.killMonsterCount = Integer.valueOf(rootElement.attributeValue("killMonsterCount")).intValue();
/*     */   }
/*     */   
...
/*  37 */     _os_.marshal(this.killMonsterMapId);
/*  38 */     _os_.marshal(this.killMonsterId);
/*  39 */     _os_.marshal(this.killMonsterCount);
/*  40 */     return _os_;
/*     */   }
/*     */   
...
/*  47 */     this.killMonsterMapId = _os_.unmarshal_int();
/*  48 */     this.killMonsterId = _os_.unmarshal_int();
/*  49 */     this.killMonsterCount = _os_.unmarshal_int();
/*  50 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  55 */     String path = dir + "mzm.gsp.task.confbean.STaskConkillMonsterCount.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  68 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.task.confbean.STaskConkillMonsterCount"))
/*     */         {
/*     */ 
/*  71 */           STaskConkillMonsterCount obj = new STaskConkillMonsterCount();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, STaskConkillMonsterCount> all)
/*     */   {
/*  85 */     String path = dir + "mzm.gsp.task.confbean.STaskConkillMonsterCount.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  97 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.task.confbean.STaskConkillMonsterCount"))
/*     */         {
/*     */ 
/* 100 */           STaskConkillMonsterCount obj = new STaskConkillMonsterCount();
...
/*     */     
/* 116 */     String path = dir + "mzm.gsp.task.confbean.STaskConkillMonsterCount.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 143 */           STaskConkillMonsterCount _v_ = new STaskConkillMonsterCount();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, STaskConkillMonsterCount> all)
/*     */   {
/* 163 */     String path = dir + "mzm.gsp.task.confbean.STaskConkillMonsterCount.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 190 */           STaskConkillMonsterCount _v_ = new STaskConkillMonsterCount();
...
/*     */ 
/*     */ 
/*     */   public static STaskConkillMonsterCount getOld(int key)
/*     */   {
/* 211 */     return (STaskConkillMonsterCount)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static STaskConkillMonsterCount get(int key)
/*     */   {
/* 216 */     return (STaskConkillMonsterCount)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, STaskConkillMonsterCount> getOldAll()
/*     */   {
/* 221 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, STaskConkillMonsterCount> getAll()
/*     */   {
/* 226 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, STaskConkillMonsterCount> newAll)
/*     */   {
/* 231 */     oldAll = all;
/* 232 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\task\confbean\STaskConkillMonsterCount.class
