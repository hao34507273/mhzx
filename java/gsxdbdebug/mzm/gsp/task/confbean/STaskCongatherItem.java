...
/*     */ 
/*     */ public class STaskCongatherItem implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, STaskCongatherItem> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, STaskCongatherItem> all = null;
/*     */   
/*     */   public int id;
/*     */   public int gatherId;
/*     */   public int taskBagItemId;
...
/*  27 */     this.gatherId = Integer.valueOf(rootElement.attributeValue("gatherId")).intValue();
/*  28 */     this.taskBagItemId = Integer.valueOf(rootElement.attributeValue("taskBagItemId")).intValue();
/*  29 */     this.gatherCount = Integer.valueOf(rootElement.attributeValue("gatherCount")).intValue();
...
/*  36 */     _os_.marshal(this.gatherId);
/*  37 */     _os_.marshal(this.taskBagItemId);
/*  38 */     _os_.marshal(this.gatherCount);
/*  39 */     _os_.marshal(this.contype);
/*  40 */     return _os_;
/*     */   }
/*     */   
...
/*  46 */     this.gatherId = _os_.unmarshal_int();
/*  47 */     this.taskBagItemId = _os_.unmarshal_int();
/*  48 */     this.gatherCount = _os_.unmarshal_int();
...
/*     */   {
/*  55 */     String path = dir + "mzm.gsp.task.confbean.STaskCongatherItem.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  68 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.task.confbean.STaskCongatherItem"))
/*     */         {
/*     */ 
/*  71 */           STaskCongatherItem obj = new STaskCongatherItem();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, STaskCongatherItem> all)
/*     */   {
/*  85 */     String path = dir + "mzm.gsp.task.confbean.STaskCongatherItem.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  97 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.task.confbean.STaskCongatherItem"))
/*     */         {
/*     */ 
/* 100 */           STaskCongatherItem obj = new STaskCongatherItem();
...
/*     */     
/* 116 */     String path = dir + "mzm.gsp.task.confbean.STaskCongatherItem.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 143 */           STaskCongatherItem _v_ = new STaskCongatherItem();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, STaskCongatherItem> all)
/*     */   {
/* 163 */     String path = dir + "mzm.gsp.task.confbean.STaskCongatherItem.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 190 */           STaskCongatherItem _v_ = new STaskCongatherItem();
...
/*     */ 
/*     */ 
/*     */   public static STaskCongatherItem getOld(int key)
/*     */   {
/* 211 */     return (STaskCongatherItem)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static STaskCongatherItem get(int key)
/*     */   {
/* 216 */     return (STaskCongatherItem)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, STaskCongatherItem> getOldAll()
/*     */   {
/* 221 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, STaskCongatherItem> getAll()
/*     */   {
/* 226 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, STaskCongatherItem> newAll)
/*     */   {
/* 231 */     oldAll = all;
/* 232 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\task\confbean\STaskCongatherItem.class
