...
/*     */ 
/*     */ public class STaskNPCLibCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, STaskNPCLibCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, STaskNPCLibCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public int npcLibId;
/*     */   public int npcId;
...
/*  25 */     this.npcLibId = Integer.valueOf(rootElement.attributeValue("npcLibId")).intValue();
/*  26 */     this.npcId = Integer.valueOf(rootElement.attributeValue("npcId")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  31 */     _os_.marshal(this.id);
/*  32 */     _os_.marshal(this.npcLibId);
/*  33 */     _os_.marshal(this.npcId);
/*  34 */     return _os_;
/*     */   }
/*     */   
...
/*  40 */     this.npcLibId = _os_.unmarshal_int();
/*  41 */     this.npcId = _os_.unmarshal_int();
/*  42 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  47 */     String path = dir + "mzm.gsp.task.confbean.STaskNPCLibCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  60 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.task.confbean.STaskNPCLibCfg"))
/*     */         {
/*     */ 
/*  63 */           STaskNPCLibCfg obj = new STaskNPCLibCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, STaskNPCLibCfg> all)
/*     */   {
/*  77 */     String path = dir + "mzm.gsp.task.confbean.STaskNPCLibCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  89 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.task.confbean.STaskNPCLibCfg"))
/*     */         {
/*     */ 
/*  92 */           STaskNPCLibCfg obj = new STaskNPCLibCfg();
...
/*     */     
/* 108 */     String path = dir + "mzm.gsp.task.confbean.STaskNPCLibCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 135 */           STaskNPCLibCfg _v_ = new STaskNPCLibCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, STaskNPCLibCfg> all)
/*     */   {
/* 155 */     String path = dir + "mzm.gsp.task.confbean.STaskNPCLibCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 182 */           STaskNPCLibCfg _v_ = new STaskNPCLibCfg();
...
/*     */ 
/*     */ 
/*     */   public static STaskNPCLibCfg getOld(int key)
/*     */   {
/* 203 */     return (STaskNPCLibCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static STaskNPCLibCfg get(int key)
/*     */   {
/* 208 */     return (STaskNPCLibCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, STaskNPCLibCfg> getOldAll()
/*     */   {
/* 213 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, STaskNPCLibCfg> getAll()
/*     */   {
/* 218 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, STaskNPCLibCfg> newAll)
/*     */   {
/* 223 */     oldAll = all;
/* 224 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\task\confbean\STaskNPCLibCfg.class
