...
/*     */ 
/*     */ public class STaskConnpcDialog implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, STaskConnpcDialog> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, STaskConnpcDialog> all = null;
/*     */   
/*     */   public int id;
/*     */   public int contype;
/*     */   public int npcId;
/*     */   public String dlgWords;
/*     */   
...
/*  28 */     this.dlgWords = rootElement.attributeValue("dlgWords");
/*     */   }
/*     */   
...
/*  36 */     _os_.marshal(this.dlgWords, "UTF-8");
/*  37 */     return _os_;
/*     */   }
/*     */   
...
/*  45 */     this.dlgWords = _os_.unmarshal_String("UTF-8");
/*  46 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  51 */     String path = dir + "mzm.gsp.task.confbean.STaskConnpcDialog.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  64 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.task.confbean.STaskConnpcDialog"))
/*     */         {
/*     */ 
/*  67 */           STaskConnpcDialog obj = new STaskConnpcDialog();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, STaskConnpcDialog> all)
/*     */   {
/*  81 */     String path = dir + "mzm.gsp.task.confbean.STaskConnpcDialog.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.task.confbean.STaskConnpcDialog"))
/*     */         {
/*     */ 
/*  96 */           STaskConnpcDialog obj = new STaskConnpcDialog();
...
/*     */     
/* 112 */     String path = dir + "mzm.gsp.task.confbean.STaskConnpcDialog.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 139 */           STaskConnpcDialog _v_ = new STaskConnpcDialog();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, STaskConnpcDialog> all)
/*     */   {
/* 159 */     String path = dir + "mzm.gsp.task.confbean.STaskConnpcDialog.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 186 */           STaskConnpcDialog _v_ = new STaskConnpcDialog();
...
/*     */ 
/*     */ 
/*     */   public static STaskConnpcDialog getOld(int key)
/*     */   {
/* 207 */     return (STaskConnpcDialog)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static STaskConnpcDialog get(int key)
/*     */   {
/* 212 */     return (STaskConnpcDialog)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, STaskConnpcDialog> getOldAll()
/*     */   {
/* 217 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, STaskConnpcDialog> getAll()
/*     */   {
/* 222 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, STaskConnpcDialog> newAll)
/*     */   {
/* 227 */     oldAll = all;
/* 228 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\task\confbean\STaskConnpcDialog.class
