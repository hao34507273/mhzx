...
/*     */ 
/*     */ public class STaskOperDelBuff implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, STaskOperDelBuff> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, STaskOperDelBuff> all = null;
/*     */   
/*     */   public int id;
/*     */   public int operType;
/*     */   public int teamType;
...
/*     */   {
/*  51 */     String path = dir + "mzm.gsp.task.confbean.STaskOperDelBuff.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  64 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.task.confbean.STaskOperDelBuff"))
/*     */         {
/*     */ 
/*  67 */           STaskOperDelBuff obj = new STaskOperDelBuff();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, STaskOperDelBuff> all)
/*     */   {
/*  81 */     String path = dir + "mzm.gsp.task.confbean.STaskOperDelBuff.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.task.confbean.STaskOperDelBuff"))
/*     */         {
/*     */ 
/*  96 */           STaskOperDelBuff obj = new STaskOperDelBuff();
...
/*     */     
/* 112 */     String path = dir + "mzm.gsp.task.confbean.STaskOperDelBuff.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 139 */           STaskOperDelBuff _v_ = new STaskOperDelBuff();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, STaskOperDelBuff> all)
/*     */   {
/* 159 */     String path = dir + "mzm.gsp.task.confbean.STaskOperDelBuff.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 186 */           STaskOperDelBuff _v_ = new STaskOperDelBuff();
...
/*     */ 
/*     */ 
/*     */   public static STaskOperDelBuff getOld(int key)
/*     */   {
/* 207 */     return (STaskOperDelBuff)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static STaskOperDelBuff get(int key)
/*     */   {
/* 212 */     return (STaskOperDelBuff)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, STaskOperDelBuff> getOldAll()
/*     */   {
/* 217 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, STaskOperDelBuff> getAll()
/*     */   {
/* 222 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, STaskOperDelBuff> newAll)
/*     */   {
/* 227 */     oldAll = all;
/* 228 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\task\confbean\STaskOperDelBuff.class
