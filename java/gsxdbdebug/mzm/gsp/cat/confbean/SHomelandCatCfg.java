...
/*     */ 
/*     */ public class SHomelandCatCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SHomelandCatCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SHomelandCatCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public String catName;
/*     */   public int level;
/*     */   public int npcid;
/*     */   public int explore_npcid;
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  26 */     this.id = Integer.valueOf(rootElement.attributeValue("id")).intValue();
/*  27 */     this.catName = rootElement.attributeValue("catName");
...
/*  30 */     this.explore_npcid = Integer.valueOf(rootElement.attributeValue("explore_npcid")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  35 */     _os_.marshal(this.id);
/*  36 */     _os_.marshal(this.catName, "UTF-8");
/*  37 */     _os_.marshal(this.level);
/*  38 */     _os_.marshal(this.npcid);
/*  39 */     _os_.marshal(this.explore_npcid);
/*  40 */     return _os_;
/*     */   }
/*     */   
...
/*  46 */     this.catName = _os_.unmarshal_String("UTF-8");
/*  47 */     this.level = _os_.unmarshal_int();
/*  48 */     this.npcid = _os_.unmarshal_int();
/*  49 */     this.explore_npcid = _os_.unmarshal_int();
/*  50 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  55 */     String path = dir + "mzm.gsp.cat.confbean.SHomelandCatCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  68 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.cat.confbean.SHomelandCatCfg"))
/*     */         {
/*     */ 
/*  71 */           SHomelandCatCfg obj = new SHomelandCatCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SHomelandCatCfg> all)
/*     */   {
/*  85 */     String path = dir + "mzm.gsp.cat.confbean.SHomelandCatCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  97 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.cat.confbean.SHomelandCatCfg"))
/*     */         {
/*     */ 
/* 100 */           SHomelandCatCfg obj = new SHomelandCatCfg();
...
/*     */     
/* 116 */     String path = dir + "mzm.gsp.cat.confbean.SHomelandCatCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 143 */           SHomelandCatCfg _v_ = new SHomelandCatCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SHomelandCatCfg> all)
/*     */   {
/* 163 */     String path = dir + "mzm.gsp.cat.confbean.SHomelandCatCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 190 */           SHomelandCatCfg _v_ = new SHomelandCatCfg();
...
/*     */ 
/*     */ 
/*     */   public static SHomelandCatCfg getOld(int key)
/*     */   {
/* 211 */     return (SHomelandCatCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SHomelandCatCfg get(int key)
/*     */   {
/* 216 */     return (SHomelandCatCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SHomelandCatCfg> getOldAll()
/*     */   {
/* 221 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SHomelandCatCfg> getAll()
/*     */   {
/* 226 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SHomelandCatCfg> newAll)
/*     */   {
/* 231 */     oldAll = all;
/* 232 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\cat\confbean\SHomelandCatCfg.class
