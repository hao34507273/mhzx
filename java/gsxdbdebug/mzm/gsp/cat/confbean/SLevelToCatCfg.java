...
/*     */ 
/*     */ public class SLevelToCatCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SLevelToCatCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SLevelToCatCfg> all = null;
/*     */   
/*     */   public int level;
/*     */   public int catLevelCfgid;
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.level = Integer.valueOf(rootElement.attributeValue("level")).intValue();
/*  24 */     this.catLevelCfgid = Integer.valueOf(rootElement.attributeValue("catLevelCfgid")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  29 */     _os_.marshal(this.level);
/*  30 */     _os_.marshal(this.catLevelCfgid);
/*  31 */     return _os_;
/*     */   }
/*     */   
...
/*  37 */     this.catLevelCfgid = _os_.unmarshal_int();
/*  38 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.cat.confbean.SLevelToCatCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.cat.confbean.SLevelToCatCfg"))
/*     */         {
/*     */ 
/*  59 */           SLevelToCatCfg obj = new SLevelToCatCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SLevelToCatCfg> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.cat.confbean.SLevelToCatCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.cat.confbean.SLevelToCatCfg"))
/*     */         {
/*     */ 
/*  88 */           SLevelToCatCfg obj = new SLevelToCatCfg();
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.cat.confbean.SLevelToCatCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           SLevelToCatCfg _v_ = new SLevelToCatCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SLevelToCatCfg> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.cat.confbean.SLevelToCatCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           SLevelToCatCfg _v_ = new SLevelToCatCfg();
...
/*     */ 
/*     */ 
/*     */   public static SLevelToCatCfg getOld(int key)
/*     */   {
/* 199 */     return (SLevelToCatCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SLevelToCatCfg get(int key)
/*     */   {
/* 204 */     return (SLevelToCatCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SLevelToCatCfg> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SLevelToCatCfg> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SLevelToCatCfg> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\cat\confbean\SLevelToCatCfg.class
