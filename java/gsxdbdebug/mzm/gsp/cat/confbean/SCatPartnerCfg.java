...
/*     */ 
/*     */ public class SCatPartnerCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SCatPartnerCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SCatPartnerCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public int weight;
/*     */   public int awardid;
...
/*  28 */     this.random_weight = Integer.valueOf(rootElement.attributeValue("random_weight")).intValue();
/*     */   }
/*     */   
...
/*  36 */     _os_.marshal(this.random_weight);
/*  37 */     return _os_;
/*     */   }
/*     */   
...
/*  45 */     this.random_weight = _os_.unmarshal_int();
/*  46 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  51 */     String path = dir + "mzm.gsp.cat.confbean.SCatPartnerCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  64 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.cat.confbean.SCatPartnerCfg"))
/*     */         {
/*     */ 
/*  67 */           SCatPartnerCfg obj = new SCatPartnerCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SCatPartnerCfg> all)
/*     */   {
/*  81 */     String path = dir + "mzm.gsp.cat.confbean.SCatPartnerCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.cat.confbean.SCatPartnerCfg"))
/*     */         {
/*     */ 
/*  96 */           SCatPartnerCfg obj = new SCatPartnerCfg();
...
/*     */     
/* 112 */     String path = dir + "mzm.gsp.cat.confbean.SCatPartnerCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 139 */           SCatPartnerCfg _v_ = new SCatPartnerCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SCatPartnerCfg> all)
/*     */   {
/* 159 */     String path = dir + "mzm.gsp.cat.confbean.SCatPartnerCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 186 */           SCatPartnerCfg _v_ = new SCatPartnerCfg();
...
/*     */ 
/*     */ 
/*     */   public static SCatPartnerCfg getOld(int key)
/*     */   {
/* 207 */     return (SCatPartnerCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SCatPartnerCfg get(int key)
/*     */   {
/* 212 */     return (SCatPartnerCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SCatPartnerCfg> getOldAll()
/*     */   {
/* 217 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SCatPartnerCfg> getAll()
/*     */   {
/* 222 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SCatPartnerCfg> newAll)
/*     */   {
/* 227 */     oldAll = all;
/* 228 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\cat\confbean\SCatPartnerCfg.class
