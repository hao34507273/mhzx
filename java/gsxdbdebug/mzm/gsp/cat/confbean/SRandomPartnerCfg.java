...
/*     */ 
/*     */ public class SRandomPartnerCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SRandomPartnerCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SRandomPartnerCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public int weightSum;
/*     */   public int randomWeightSum;
/*  21 */   public java.util.ArrayList<Integer> partnerCfgids = new java.util.ArrayList();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  25 */     this.id = Integer.valueOf(rootElement.attributeValue("id")).intValue();
/*  26 */     this.weightSum = Integer.valueOf(rootElement.attributeValue("weightSum")).intValue();
/*  27 */     this.randomWeightSum = Integer.valueOf(rootElement.attributeValue("randomWeightSum")).intValue();
/*     */     
/*  29 */     Element collectionElement = util.XmlHelper.getVariableElement(rootElement, "partnerCfgids");
...
/*     */         }
/*     */         
/*  54 */         this.partnerCfgids.add(Integer.valueOf(_v_));
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*  62 */     _os_.marshal(this.weightSum);
/*  63 */     _os_.marshal(this.randomWeightSum);
/*  64 */     _os_.compact_uint32(this.partnerCfgids.size());
/*  65 */     for (Integer _v_ : this.partnerCfgids)
/*     */     {
...
/*  75 */     this.weightSum = _os_.unmarshal_int();
/*  76 */     this.randomWeightSum = _os_.unmarshal_int();
/*  77 */     for (int _size_ = _os_.uncompact_uint32(); _size_ > 0; _size_--)
/*     */     {
/*     */ 
/*  80 */       int _v_ = _os_.unmarshal_int();
/*  81 */       this.partnerCfgids.add(Integer.valueOf(_v_));
/*     */     }
/*  83 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/*  88 */     String path = dir + "mzm.gsp.cat.confbean.SRandomPartnerCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 101 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.cat.confbean.SRandomPartnerCfg"))
/*     */         {
/*     */ 
/* 104 */           SRandomPartnerCfg obj = new SRandomPartnerCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SRandomPartnerCfg> all)
/*     */   {
/* 118 */     String path = dir + "mzm.gsp.cat.confbean.SRandomPartnerCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 130 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.cat.confbean.SRandomPartnerCfg"))
/*     */         {
/*     */ 
/* 133 */           SRandomPartnerCfg obj = new SRandomPartnerCfg();
...
/*     */     
/* 149 */     String path = dir + "mzm.gsp.cat.confbean.SRandomPartnerCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 176 */           SRandomPartnerCfg _v_ = new SRandomPartnerCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SRandomPartnerCfg> all)
/*     */   {
/* 196 */     String path = dir + "mzm.gsp.cat.confbean.SRandomPartnerCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 223 */           SRandomPartnerCfg _v_ = new SRandomPartnerCfg();
...
/*     */ 
/*     */ 
/*     */   public static SRandomPartnerCfg getOld(int key)
/*     */   {
/* 244 */     return (SRandomPartnerCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SRandomPartnerCfg get(int key)
/*     */   {
/* 249 */     return (SRandomPartnerCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SRandomPartnerCfg> getOldAll()
/*     */   {
/* 254 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SRandomPartnerCfg> getAll()
/*     */   {
/* 259 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SRandomPartnerCfg> newAll)
/*     */   {
/* 264 */     oldAll = all;
/* 265 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\cat\confbean\SRandomPartnerCfg.class
