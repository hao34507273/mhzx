/*     */ package mzm.gsp.vigor.confbean;
/*     */ 
...
/*     */ 
/*     */ public class SVigorDescCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SVigorDescCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SVigorDescCfg> all = null;
/*     */   
/*     */   public int id;
...
/*  27 */     this.awardType = Integer.valueOf(rootElement.attributeValue("awardType")).intValue();
...
/*  35 */     _os_.marshal(this.awardType);
...
/*  44 */     this.awardType = _os_.unmarshal_int();
...
/*     */   {
/*  51 */     String path = dir + "mzm.gsp.vigor.confbean.SVigorDescCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  64 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.vigor.confbean.SVigorDescCfg"))
/*     */         {
/*     */ 
/*  67 */           SVigorDescCfg obj = new SVigorDescCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SVigorDescCfg> all)
/*     */   {
/*  81 */     String path = dir + "mzm.gsp.vigor.confbean.SVigorDescCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.vigor.confbean.SVigorDescCfg"))
/*     */         {
/*     */ 
/*  96 */           SVigorDescCfg obj = new SVigorDescCfg();
...
/*     */     
/* 112 */     String path = dir + "mzm.gsp.vigor.confbean.SVigorDescCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 139 */           SVigorDescCfg _v_ = new SVigorDescCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SVigorDescCfg> all)
/*     */   {
/* 159 */     String path = dir + "mzm.gsp.vigor.confbean.SVigorDescCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 186 */           SVigorDescCfg _v_ = new SVigorDescCfg();
...
/*     */ 
/*     */ 
/*     */   public static SVigorDescCfg getOld(int key)
/*     */   {
/* 207 */     return (SVigorDescCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SVigorDescCfg get(int key)
/*     */   {
/* 212 */     return (SVigorDescCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SVigorDescCfg> getOldAll()
/*     */   {
/* 217 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SVigorDescCfg> getAll()
/*     */   {
/* 222 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SVigorDescCfg> newAll)
/*     */   {
/* 227 */     oldAll = all;
/* 228 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\vigor\confbean\SVigorDescCfg.class
