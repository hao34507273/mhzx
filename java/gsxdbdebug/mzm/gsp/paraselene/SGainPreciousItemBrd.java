...
/*    */ 
/*    */ 
/*    */ public class SGainPreciousItemBrd
/*    */   extends __SGainPreciousItemBrd__
/*    */ {
/*    */   public static final int PROTOCOL_TYPE = 12598296;
/*    */   public String name;
...
/*    */ 
/*    */ 
/*    */   public SGainPreciousItemBrd()
/*    */   {
/* 34 */     this.name = "";
/* 35 */     this.items = new HashMap();
/*    */   }
/*    */   
/*    */   public SGainPreciousItemBrd(String _name_, HashMap<Integer, Integer> _items_) {
/* 39 */     this.name = _name_;
...
/* 74 */     if ((_o1_ instanceof SGainPreciousItemBrd)) {
/* 75 */       SGainPreciousItemBrd _o_ = (SGainPreciousItemBrd)_o1_;
...
/* 92 */     _sb_.append("(");
/* 93 */     _sb_.append("T").append(this.name.length()).append(",");
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\paraselene\SGainPreciousItemBrd.class
