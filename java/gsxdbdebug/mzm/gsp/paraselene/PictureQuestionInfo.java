...
/*     */   }
/*     */   
/*     */   public PictureQuestionInfo(long _roleid_, String _name_, int _sex_, int _level_, int _occupation_, int _point_, int _avatarid_, int _avatarframeid_) {
...
/*  55 */     this.point = _os_.unmarshal_int();
...
/*  63 */     if ((_o1_ instanceof PictureQuestionInfo)) {
/*  64 */       PictureQuestionInfo _o_ = (PictureQuestionInfo)_o1_;
...
/*  70 */       if (this.point != _o_.point) return false;
...
/*  99 */     _sb_.append(this.point).append(",");
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\paraselene\PictureQuestionInfo.class
