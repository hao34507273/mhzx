...
/*     */ 
/*     */ public class SJigsawCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SJigsawCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SJigsawCfg> all = null;
/*     */   
/*     */   public int id;
...
/*  25 */     this.limittime = Integer.valueOf(rootElement.attributeValue("limittime")).intValue();
/*  26 */     this.sucrate = Integer.valueOf(rootElement.attributeValue("sucrate")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  31 */     _os_.marshal(this.id);
/*  32 */     _os_.marshal(this.limittime);
/*  33 */     _os_.marshal(this.sucrate);
/*  34 */     return _os_;
/*     */   }
/*     */   
...
/*  40 */     this.limittime = _os_.unmarshal_int();
...
/*     */   {
/*  47 */     String path = dir + "mzm.gsp.paraselene.confbean.SJigsawCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  60 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.paraselene.confbean.SJigsawCfg"))
/*     */         {
/*     */ 
/*  63 */           SJigsawCfg obj = new SJigsawCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SJigsawCfg> all)
/*     */   {
/*  77 */     String path = dir + "mzm.gsp.paraselene.confbean.SJigsawCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  89 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.paraselene.confbean.SJigsawCfg"))
/*     */         {
/*     */ 
/*  92 */           SJigsawCfg obj = new SJigsawCfg();
...
/*     */     
/* 108 */     String path = dir + "mzm.gsp.paraselene.confbean.SJigsawCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 135 */           SJigsawCfg _v_ = new SJigsawCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SJigsawCfg> all)
/*     */   {
/* 155 */     String path = dir + "mzm.gsp.paraselene.confbean.SJigsawCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 182 */           SJigsawCfg _v_ = new SJigsawCfg();
...
/*     */ 
/*     */ 
/*     */   public static SJigsawCfg getOld(int key)
/*     */   {
/* 203 */     return (SJigsawCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SJigsawCfg get(int key)
/*     */   {
/* 208 */     return (SJigsawCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SJigsawCfg> getOldAll()
/*     */   {
/* 213 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SJigsawCfg> getAll()
/*     */   {
/* 218 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SJigsawCfg> newAll)
/*     */   {
/* 223 */     oldAll = all;
/* 224 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\paraselene\confbean\SJigsawCfg.class
