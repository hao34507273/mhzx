...
/*     */ 
/*     */ public class SFeiShengCommitItemActivityCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SFeiShengCommitItemActivityCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SFeiShengCommitItemActivityCfg> all = null;
/*     */   
...
/*     */   public int award_id;
/*  24 */   public HashMap<Integer, Integer> need_items = new HashMap();
/*     */   
...
/*     */     
/*  35 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "need_items");
...
/*     */         }
/*     */         
/*  86 */         this.need_items.put(Integer.valueOf(_k_), Integer.valueOf(_v_));
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*  99 */     _os_.compact_uint32(this.need_items.size());
/* 100 */     for (java.util.Map.Entry<Integer, Integer> _e_ : this.need_items.entrySet())
/*     */     {
...
/* 122 */       this.need_items.put(Integer.valueOf(_k_), Integer.valueOf(_v_));
/*     */     }
/* 124 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/* 129 */     String path = dir + "mzm.gsp.feisheng.confbean.SFeiShengCommitItemActivityCfg.xml";
/*     */     
/*     */     try
/*     */     {
/* 133 */       all = new HashMap();
...
/* 142 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.feisheng.confbean.SFeiShengCommitItemActivityCfg"))
/*     */         {
/*     */ 
/* 145 */           SFeiShengCommitItemActivityCfg obj = new SFeiShengCommitItemActivityCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SFeiShengCommitItemActivityCfg> all)
/*     */   {
/* 159 */     String path = dir + "mzm.gsp.feisheng.confbean.SFeiShengCommitItemActivityCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 171 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.feisheng.confbean.SFeiShengCommitItemActivityCfg"))
/*     */         {
/*     */ 
/* 174 */           SFeiShengCommitItemActivityCfg obj = new SFeiShengCommitItemActivityCfg();
...
/* 188 */     all = new HashMap();
/*     */     
/* 190 */     String path = dir + "mzm.gsp.feisheng.confbean.SFeiShengCommitItemActivityCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 217 */           SFeiShengCommitItemActivityCfg _v_ = new SFeiShengCommitItemActivityCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SFeiShengCommitItemActivityCfg> all)
/*     */   {
/* 237 */     String path = dir + "mzm.gsp.feisheng.confbean.SFeiShengCommitItemActivityCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 264 */           SFeiShengCommitItemActivityCfg _v_ = new SFeiShengCommitItemActivityCfg();
...
/*     */ 
/*     */ 
/*     */   public static SFeiShengCommitItemActivityCfg getOld(int key)
/*     */   {
/* 285 */     return (SFeiShengCommitItemActivityCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SFeiShengCommitItemActivityCfg get(int key)
/*     */   {
/* 290 */     return (SFeiShengCommitItemActivityCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SFeiShengCommitItemActivityCfg> getOldAll()
/*     */   {
/* 295 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SFeiShengCommitItemActivityCfg> getAll()
/*     */   {
/* 300 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SFeiShengCommitItemActivityCfg> newAll)
/*     */   {
/* 305 */     oldAll = all;
/* 306 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\feisheng\confbean\SFeiShengCommitItemActivityCfg.class
