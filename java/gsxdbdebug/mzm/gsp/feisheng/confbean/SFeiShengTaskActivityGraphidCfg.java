...
/*     */ 
/*     */ public class SFeiShengTaskActivityGraphidCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SFeiShengTaskActivityGraphidCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SFeiShengTaskActivityGraphidCfg> all = null;
/*     */   
...
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.feisheng.confbean.SFeiShengTaskActivityGraphidCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.feisheng.confbean.SFeiShengTaskActivityGraphidCfg"))
/*     */         {
/*     */ 
/*  59 */           SFeiShengTaskActivityGraphidCfg obj = new SFeiShengTaskActivityGraphidCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SFeiShengTaskActivityGraphidCfg> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.feisheng.confbean.SFeiShengTaskActivityGraphidCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.feisheng.confbean.SFeiShengTaskActivityGraphidCfg"))
/*     */         {
/*     */ 
/*  88 */           SFeiShengTaskActivityGraphidCfg obj = new SFeiShengTaskActivityGraphidCfg();
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.feisheng.confbean.SFeiShengTaskActivityGraphidCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           SFeiShengTaskActivityGraphidCfg _v_ = new SFeiShengTaskActivityGraphidCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SFeiShengTaskActivityGraphidCfg> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.feisheng.confbean.SFeiShengTaskActivityGraphidCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           SFeiShengTaskActivityGraphidCfg _v_ = new SFeiShengTaskActivityGraphidCfg();
...
/*     */ 
/*     */ 
/*     */   public static SFeiShengTaskActivityGraphidCfg getOld(int key)
/*     */   {
/* 199 */     return (SFeiShengTaskActivityGraphidCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SFeiShengTaskActivityGraphidCfg get(int key)
/*     */   {
/* 204 */     return (SFeiShengTaskActivityGraphidCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SFeiShengTaskActivityGraphidCfg> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SFeiShengTaskActivityGraphidCfg> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SFeiShengTaskActivityGraphidCfg> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\feisheng\confbean\SFeiShengTaskActivityGraphidCfg.class
