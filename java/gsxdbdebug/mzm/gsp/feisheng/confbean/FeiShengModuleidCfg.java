...
/*     */ 
/*     */ public class FeiShengModuleidCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, FeiShengModuleidCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, FeiShengModuleidCfg> all = null;
/*     */   
/*     */   public int moduleid;
...
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.feisheng.confbean.FeiShengModuleidCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.feisheng.confbean.FeiShengModuleidCfg"))
/*     */         {
/*     */ 
/*  59 */           FeiShengModuleidCfg obj = new FeiShengModuleidCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, FeiShengModuleidCfg> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.feisheng.confbean.FeiShengModuleidCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.feisheng.confbean.FeiShengModuleidCfg"))
/*     */         {
/*     */ 
/*  88 */           FeiShengModuleidCfg obj = new FeiShengModuleidCfg();
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.feisheng.confbean.FeiShengModuleidCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           FeiShengModuleidCfg _v_ = new FeiShengModuleidCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, FeiShengModuleidCfg> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.feisheng.confbean.FeiShengModuleidCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           FeiShengModuleidCfg _v_ = new FeiShengModuleidCfg();
...
/*     */ 
/*     */ 
/*     */   public static FeiShengModuleidCfg getOld(int key)
/*     */   {
/* 199 */     return (FeiShengModuleidCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static FeiShengModuleidCfg get(int key)
/*     */   {
/* 204 */     return (FeiShengModuleidCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, FeiShengModuleidCfg> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, FeiShengModuleidCfg> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, FeiShengModuleidCfg> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\feisheng\confbean\FeiShengModuleidCfg.class
