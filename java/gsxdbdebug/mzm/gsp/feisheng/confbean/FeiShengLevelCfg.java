...
/*     */ 
/*     */ public class FeiShengLevelCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, FeiShengLevelCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, FeiShengLevelCfg> all = null;
/*     */   
/*     */   public int level;
...
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.feisheng.confbean.FeiShengLevelCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.feisheng.confbean.FeiShengLevelCfg"))
/*     */         {
/*     */ 
/*  59 */           FeiShengLevelCfg obj = new FeiShengLevelCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, FeiShengLevelCfg> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.feisheng.confbean.FeiShengLevelCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.feisheng.confbean.FeiShengLevelCfg"))
/*     */         {
/*     */ 
/*  88 */           FeiShengLevelCfg obj = new FeiShengLevelCfg();
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.feisheng.confbean.FeiShengLevelCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           FeiShengLevelCfg _v_ = new FeiShengLevelCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, FeiShengLevelCfg> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.feisheng.confbean.FeiShengLevelCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           FeiShengLevelCfg _v_ = new FeiShengLevelCfg();
...
/*     */ 
/*     */ 
/*     */   public static FeiShengLevelCfg getOld(int key)
/*     */   {
/* 199 */     return (FeiShengLevelCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static FeiShengLevelCfg get(int key)
/*     */   {
/* 204 */     return (FeiShengLevelCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, FeiShengLevelCfg> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, FeiShengLevelCfg> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, FeiShengLevelCfg> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\feisheng\confbean\FeiShengLevelCfg.class
