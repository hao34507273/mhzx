...
/*     */ 
/*     */ public class FeiShengServerLevelCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, FeiShengServerLevelCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, FeiShengServerLevelCfg> all = null;
/*     */   
...
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.feisheng.confbean.FeiShengServerLevelCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.feisheng.confbean.FeiShengServerLevelCfg"))
/*     */         {
/*     */ 
/*  59 */           FeiShengServerLevelCfg obj = new FeiShengServerLevelCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, FeiShengServerLevelCfg> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.feisheng.confbean.FeiShengServerLevelCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.feisheng.confbean.FeiShengServerLevelCfg"))
/*     */         {
/*     */ 
/*  88 */           FeiShengServerLevelCfg obj = new FeiShengServerLevelCfg();
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.feisheng.confbean.FeiShengServerLevelCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           FeiShengServerLevelCfg _v_ = new FeiShengServerLevelCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, FeiShengServerLevelCfg> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.feisheng.confbean.FeiShengServerLevelCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           FeiShengServerLevelCfg _v_ = new FeiShengServerLevelCfg();
...
/*     */ 
/*     */ 
/*     */   public static FeiShengServerLevelCfg getOld(int key)
/*     */   {
/* 199 */     return (FeiShengServerLevelCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static FeiShengServerLevelCfg get(int key)
/*     */   {
/* 204 */     return (FeiShengServerLevelCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, FeiShengServerLevelCfg> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, FeiShengServerLevelCfg> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, FeiShengServerLevelCfg> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\feisheng\confbean\FeiShengServerLevelCfg.class
