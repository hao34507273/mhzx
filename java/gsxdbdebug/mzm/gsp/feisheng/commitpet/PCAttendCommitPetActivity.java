...
/*     */ import mzm.gsp.feisheng.SAttendCommitPetActivityFail;
/*     */ import mzm.gsp.feisheng.SAttendCommitPetActivitySuccess;
...
/*     */ 
/*     */ 
/*     */ public class PCAttendCommitPetActivity
/*     */   extends LogicProcedure
/*     */ {
/*     */   private final long roleid;
/*     */   private final int activityCfgid;
/*     */   
/*     */   public PCAttendCommitPetActivity(long roleid, int activityCfgid)
/*     */   {
...
/*     */     throws Exception
/*     */   {
/*  48 */     if (!CommitPetActivityManager.isFeiShengCommitPetActivitySwitchOpenForRole(this.roleid, this.activityCfgid))
/*     */     {
/*     */ 
/*  51 */       onFail(-1, null);
/*  52 */       return false;
/*     */     }
/*  54 */     if (!RoleStatusInterface.checkCanSetStatus(this.roleid, 957, true))
/*     */     {
/*     */ 
/*     */ 
/*  58 */       onFail(-2, null);
/*  59 */       return false;
/*     */     }
/*  61 */     SFeiShengCommitPetActivityCfg cfg = SFeiShengCommitPetActivityCfg.get(this.activityCfgid);
/*  62 */     if (cfg == null)
/*     */     {
/*     */ 
/*  65 */       onFail(-3, null);
...
/*     */     }
/*     */     
/*  98 */     if (!CommitPetActivityManager.cutAllNeedPet(this.roleid, this.activityCfgid))
/*     */     {
/*     */ 
/* 101 */       onFail(2, null);
/* 102 */       return false;
...
/*     */     {
/* 107 */       AwardModel awardModel = AwardInterface.award(cfg.award_id, userid, this.roleid, false, true, new AwardReason(LogReason.FEI_SHENG_COMMIT_PET_AWARD, this.activityCfgid));
/*     */       
...
/*     */     
/*     */ 
/* 126 */     SAttendCommitPetActivitySuccess protocol = new SAttendCommitPetActivitySuccess();
/* 127 */     protocol.activity_cfg_id = this.activityCfgid;
/* 128 */     OnlineManager.getInstance().send(this.roleid, protocol);
/*     */     
/* 130 */     StringBuilder sb = new StringBuilder();
/* 131 */     sb.append(String.format("[feisheng]PCAttendCommitPetActivity.processImp@attend commit pet activity success|roleid=%d|activity_cfg_id=%d", new Object[] { Long.valueOf(this.roleid), Integer.valueOf(this.activityCfgid) }));
/*     */     
/*     */ 
...
/* 141 */     sb.append(String.format("[feisheng]PCAttendCommitPetActivity.processImp@attend commit pet activity fail|roleid=%d|activity_cfg_id=%d|res=%d", new Object[] { Long.valueOf(this.roleid), Integer.valueOf(this.activityCfgid), Integer.valueOf(res) }));
/*     */     
/*     */ 
...
/* 153 */     if (res > 0)
/*     */     {
/* 155 */       SAttendCommitPetActivityFail protocol = new SAttendCommitPetActivityFail();
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\feisheng\commitpet\PCAttendCommitPetActivity.class
