...
/*     */ 
/*     */ public class SWatchItemCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SWatchItemCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SWatchItemCfg> all = null;
/*     */   
/*     */   public int typeId;
/*  19 */   public HashMap<Integer, Integer> itemId2MaxNum = new HashMap();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.typeId = Integer.valueOf(rootElement.attributeValue("typeId")).intValue();
/*     */     
/*  25 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "itemId2MaxNum");
...
/*     */         }
/*     */         
/*  76 */         this.itemId2MaxNum.put(Integer.valueOf(_k_), Integer.valueOf(_v_));
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*     */   {
/*  83 */     _os_.marshal(this.typeId);
/*  84 */     _os_.compact_uint32(this.itemId2MaxNum.size());
/*  85 */     for (java.util.Map.Entry<Integer, Integer> _e_ : this.itemId2MaxNum.entrySet())
/*     */     {
...
/*     */   {
/*  95 */     this.typeId = _os_.unmarshal_int();
...
/* 102 */       this.itemId2MaxNum.put(Integer.valueOf(_k_), Integer.valueOf(_v_));
/*     */     }
/* 104 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/* 109 */     String path = dir + "mzm.gsp.resourcecheck.confbean.SWatchItemCfg.xml";
/*     */     
/*     */     try
/*     */     {
/* 113 */       all = new HashMap();
...
/* 122 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.resourcecheck.confbean.SWatchItemCfg"))
/*     */         {
/*     */ 
/* 125 */           SWatchItemCfg obj = new SWatchItemCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SWatchItemCfg> all)
/*     */   {
/* 139 */     String path = dir + "mzm.gsp.resourcecheck.confbean.SWatchItemCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 151 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.resourcecheck.confbean.SWatchItemCfg"))
/*     */         {
/*     */ 
/* 154 */           SWatchItemCfg obj = new SWatchItemCfg();
/* 155 */           obj.loadFromXml(elem);
/* 156 */           if (all.put(Integer.valueOf(obj.typeId), obj) != null) {
/* 157 */             throw new RuntimeException("duplicate key : " + obj.typeId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/* 168 */     all = new HashMap();
/*     */     
/* 170 */     String path = dir + "mzm.gsp.resourcecheck.confbean.SWatchItemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 197 */           SWatchItemCfg _v_ = new SWatchItemCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SWatchItemCfg> all)
/*     */   {
/* 217 */     String path = dir + "mzm.gsp.resourcecheck.confbean.SWatchItemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 244 */           SWatchItemCfg _v_ = new SWatchItemCfg();
...
/*     */ 
/*     */ 
/*     */   public static SWatchItemCfg getOld(int key)
/*     */   {
/* 265 */     return (SWatchItemCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SWatchItemCfg get(int key)
/*     */   {
/* 270 */     return (SWatchItemCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SWatchItemCfg> getOldAll()
/*     */   {
/* 275 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SWatchItemCfg> getAll()
/*     */   {
/* 280 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SWatchItemCfg> newAll)
/*     */   {
/* 285 */     oldAll = all;
/* 286 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\resourcecheck\confbean\SWatchItemCfg.class
