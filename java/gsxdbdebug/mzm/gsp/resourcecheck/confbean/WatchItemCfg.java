...
/*     */ 
/*     */ public class WatchItemCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, WatchItemCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, WatchItemCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public int typeId;
/*     */   public int itemId;
...
/*  28 */     this.maxNum = Integer.valueOf(rootElement.attributeValue("maxNum")).intValue();
/*     */   }
/*     */   
...
/*  45 */     this.maxNum = _os_.unmarshal_int();
/*  46 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  51 */     String path = dir + "mzm.gsp.resourcecheck.confbean.WatchItemCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  64 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.resourcecheck.confbean.WatchItemCfg"))
/*     */         {
/*     */ 
/*  67 */           WatchItemCfg obj = new WatchItemCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, WatchItemCfg> all)
/*     */   {
/*  81 */     String path = dir + "mzm.gsp.resourcecheck.confbean.WatchItemCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.resourcecheck.confbean.WatchItemCfg"))
/*     */         {
/*     */ 
/*  96 */           WatchItemCfg obj = new WatchItemCfg();
...
/*     */     
/* 112 */     String path = dir + "mzm.gsp.resourcecheck.confbean.WatchItemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 139 */           WatchItemCfg _v_ = new WatchItemCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, WatchItemCfg> all)
/*     */   {
/* 159 */     String path = dir + "mzm.gsp.resourcecheck.confbean.WatchItemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 186 */           WatchItemCfg _v_ = new WatchItemCfg();
...
/*     */ 
/*     */ 
/*     */   public static WatchItemCfg getOld(int key)
/*     */   {
/* 207 */     return (WatchItemCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static WatchItemCfg get(int key)
/*     */   {
/* 212 */     return (WatchItemCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, WatchItemCfg> getOldAll()
/*     */   {
/* 217 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, WatchItemCfg> getAll()
/*     */   {
/* 222 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, WatchItemCfg> newAll)
/*     */   {
/* 227 */     oldAll = all;
/* 228 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\resourcecheck\confbean\WatchItemCfg.class
