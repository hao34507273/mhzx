...
/*     */ 
/*     */ public class SGoldExpectePerDayCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SGoldExpectePerDayCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SGoldExpectePerDayCfg> all = null;
/*     */   
/*     */   public int level;
/*     */   public int id;
/*     */   public int gainMax;
...
/*  26 */     this.gainMax = Integer.valueOf(rootElement.attributeValue("gainMax")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  31 */     _os_.marshal(this.level);
/*  32 */     _os_.marshal(this.id);
/*  33 */     _os_.marshal(this.gainMax);
/*  34 */     return _os_;
/*     */   }
/*     */   
/*     */   public OctetsStream unmarshal(OctetsStream _os_) throws com.goldhuman.Common.Marshal.MarshalException
/*     */   {
/*  39 */     this.level = _os_.unmarshal_int();
/*  40 */     this.id = _os_.unmarshal_int();
/*  41 */     this.gainMax = _os_.unmarshal_int();
/*  42 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  47 */     String path = dir + "mzm.gsp.resourcecheck.confbean.SGoldExpectePerDayCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  60 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.resourcecheck.confbean.SGoldExpectePerDayCfg"))
/*     */         {
/*     */ 
/*  63 */           SGoldExpectePerDayCfg obj = new SGoldExpectePerDayCfg();
/*  64 */           obj.loadFromXml(elem);
/*  65 */           if (all.put(Integer.valueOf(obj.level), obj) != null) {
/*  66 */             throw new RuntimeException("duplicate key : " + obj.level);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SGoldExpectePerDayCfg> all)
/*     */   {
/*  77 */     String path = dir + "mzm.gsp.resourcecheck.confbean.SGoldExpectePerDayCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  89 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.resourcecheck.confbean.SGoldExpectePerDayCfg"))
/*     */         {
/*     */ 
/*  92 */           SGoldExpectePerDayCfg obj = new SGoldExpectePerDayCfg();
/*  93 */           obj.loadFromXml(elem);
/*  94 */           if (all.put(Integer.valueOf(obj.level), obj) != null) {
/*  95 */             throw new RuntimeException("duplicate key : " + obj.level);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 108 */     String path = dir + "mzm.gsp.resourcecheck.confbean.SGoldExpectePerDayCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 135 */           SGoldExpectePerDayCfg _v_ = new SGoldExpectePerDayCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SGoldExpectePerDayCfg> all)
/*     */   {
/* 155 */     String path = dir + "mzm.gsp.resourcecheck.confbean.SGoldExpectePerDayCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 182 */           SGoldExpectePerDayCfg _v_ = new SGoldExpectePerDayCfg();
...
/*     */ 
/*     */ 
/*     */   public static SGoldExpectePerDayCfg getOld(int key)
/*     */   {
/* 203 */     return (SGoldExpectePerDayCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SGoldExpectePerDayCfg get(int key)
/*     */   {
/* 208 */     return (SGoldExpectePerDayCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SGoldExpectePerDayCfg> getOldAll()
/*     */   {
/* 213 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SGoldExpectePerDayCfg> getAll()
/*     */   {
/* 218 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SGoldExpectePerDayCfg> newAll)
/*     */   {
/* 223 */     oldAll = all;
/* 224 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\resourcecheck\confbean\SGoldExpectePerDayCfg.class
