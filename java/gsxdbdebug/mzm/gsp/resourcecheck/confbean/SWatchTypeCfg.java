...
/*     */ 
/*     */ public class SWatchTypeCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SWatchTypeCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SWatchTypeCfg> all = null;
/*     */   
/*     */   public int logReason;
/*     */   public int typeId;
/*     */   public int id;
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  24 */     this.logReason = Integer.valueOf(rootElement.attributeValue("logReason")).intValue();
/*  25 */     this.typeId = Integer.valueOf(rootElement.attributeValue("typeId")).intValue();
/*  26 */     this.id = Integer.valueOf(rootElement.attributeValue("id")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  31 */     _os_.marshal(this.logReason);
/*  32 */     _os_.marshal(this.typeId);
...
/*     */   {
/*  39 */     this.logReason = _os_.unmarshal_int();
/*  40 */     this.typeId = _os_.unmarshal_int();
...
/*     */   {
/*  47 */     String path = dir + "mzm.gsp.resourcecheck.confbean.SWatchTypeCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  60 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.resourcecheck.confbean.SWatchTypeCfg"))
/*     */         {
/*     */ 
/*  63 */           SWatchTypeCfg obj = new SWatchTypeCfg();
/*  64 */           obj.loadFromXml(elem);
/*  65 */           if (all.put(Integer.valueOf(obj.logReason), obj) != null) {
/*  66 */             throw new RuntimeException("duplicate key : " + obj.logReason);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SWatchTypeCfg> all)
/*     */   {
/*  77 */     String path = dir + "mzm.gsp.resourcecheck.confbean.SWatchTypeCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  89 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.resourcecheck.confbean.SWatchTypeCfg"))
/*     */         {
/*     */ 
/*  92 */           SWatchTypeCfg obj = new SWatchTypeCfg();
/*  93 */           obj.loadFromXml(elem);
/*  94 */           if (all.put(Integer.valueOf(obj.logReason), obj) != null) {
/*  95 */             throw new RuntimeException("duplicate key : " + obj.logReason);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 108 */     String path = dir + "mzm.gsp.resourcecheck.confbean.SWatchTypeCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 135 */           SWatchTypeCfg _v_ = new SWatchTypeCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SWatchTypeCfg> all)
/*     */   {
/* 155 */     String path = dir + "mzm.gsp.resourcecheck.confbean.SWatchTypeCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 182 */           SWatchTypeCfg _v_ = new SWatchTypeCfg();
...
/*     */ 
/*     */ 
/*     */   public static SWatchTypeCfg getOld(int key)
/*     */   {
/* 203 */     return (SWatchTypeCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SWatchTypeCfg get(int key)
/*     */   {
/* 208 */     return (SWatchTypeCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SWatchTypeCfg> getOldAll()
/*     */   {
/* 213 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SWatchTypeCfg> getAll()
/*     */   {
/* 218 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SWatchTypeCfg> newAll)
/*     */   {
/* 223 */     oldAll = all;
/* 224 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\resourcecheck\confbean\SWatchTypeCfg.class
