...
/*     */ 
/*     */ public class SAwardRoleExpBark implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SAwardRoleExpBark> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SAwardRoleExpBark> all = null;
/*     */   
/*     */   public int roleLv;
/*     */   public int upline;
/*     */   
...
/*     */   {
/*  23 */     this.roleLv = Integer.valueOf(rootElement.attributeValue("roleLv")).intValue();
/*  24 */     this.upline = Integer.valueOf(rootElement.attributeValue("upline")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  29 */     _os_.marshal(this.roleLv);
/*  30 */     _os_.marshal(this.upline);
/*  31 */     return _os_;
/*     */   }
/*     */   
/*     */   public OctetsStream unmarshal(OctetsStream _os_) throws com.goldhuman.Common.Marshal.MarshalException
/*     */   {
/*  36 */     this.roleLv = _os_.unmarshal_int();
/*  37 */     this.upline = _os_.unmarshal_int();
/*  38 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.resourcecheck.confbean.SAwardRoleExpBark.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.resourcecheck.confbean.SAwardRoleExpBark"))
/*     */         {
/*     */ 
/*  59 */           SAwardRoleExpBark obj = new SAwardRoleExpBark();
/*  60 */           obj.loadFromXml(elem);
/*  61 */           if (all.put(Integer.valueOf(obj.roleLv), obj) != null) {
/*  62 */             throw new RuntimeException("duplicate key : " + obj.roleLv);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SAwardRoleExpBark> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.resourcecheck.confbean.SAwardRoleExpBark.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.resourcecheck.confbean.SAwardRoleExpBark"))
/*     */         {
/*     */ 
/*  88 */           SAwardRoleExpBark obj = new SAwardRoleExpBark();
/*  89 */           obj.loadFromXml(elem);
/*  90 */           if (all.put(Integer.valueOf(obj.roleLv), obj) != null) {
/*  91 */             throw new RuntimeException("duplicate key : " + obj.roleLv);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.resourcecheck.confbean.SAwardRoleExpBark.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           SAwardRoleExpBark _v_ = new SAwardRoleExpBark();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SAwardRoleExpBark> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.resourcecheck.confbean.SAwardRoleExpBark.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           SAwardRoleExpBark _v_ = new SAwardRoleExpBark();
...
/*     */ 
/*     */ 
/*     */   public static SAwardRoleExpBark getOld(int key)
/*     */   {
/* 199 */     return (SAwardRoleExpBark)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SAwardRoleExpBark get(int key)
/*     */   {
/* 204 */     return (SAwardRoleExpBark)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SAwardRoleExpBark> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SAwardRoleExpBark> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SAwardRoleExpBark> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\resourcecheck\confbean\SAwardRoleExpBark.class
