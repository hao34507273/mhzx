...
/*     */ 
/*     */ public class SZhenfaLevelUp2expnum implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SZhenfaLevelUp2expnum> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SZhenfaLevelUp2expnum> all = null;
/*     */   
/*     */   public int level;
/*     */   public int expnum;
/*     */   
...
/*  24 */     this.expnum = Integer.valueOf(rootElement.attributeValue("expnum")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  29 */     _os_.marshal(this.level);
/*  30 */     _os_.marshal(this.expnum);
/*  31 */     return _os_;
/*     */   }
/*     */   
/*     */   public OctetsStream unmarshal(OctetsStream _os_) throws com.goldhuman.Common.Marshal.MarshalException
/*     */   {
/*  36 */     this.level = _os_.unmarshal_int();
/*  37 */     this.expnum = _os_.unmarshal_int();
/*  38 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.zhenfa.confbean.SZhenfaLevelUp2expnum.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.zhenfa.confbean.SZhenfaLevelUp2expnum"))
/*     */         {
/*     */ 
/*  59 */           SZhenfaLevelUp2expnum obj = new SZhenfaLevelUp2expnum();
/*  60 */           obj.loadFromXml(elem);
/*  61 */           if (all.put(Integer.valueOf(obj.level), obj) != null) {
/*  62 */             throw new RuntimeException("duplicate key : " + obj.level);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SZhenfaLevelUp2expnum> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.zhenfa.confbean.SZhenfaLevelUp2expnum.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.zhenfa.confbean.SZhenfaLevelUp2expnum"))
/*     */         {
/*     */ 
/*  88 */           SZhenfaLevelUp2expnum obj = new SZhenfaLevelUp2expnum();
/*  89 */           obj.loadFromXml(elem);
/*  90 */           if (all.put(Integer.valueOf(obj.level), obj) != null) {
/*  91 */             throw new RuntimeException("duplicate key : " + obj.level);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.zhenfa.confbean.SZhenfaLevelUp2expnum.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           SZhenfaLevelUp2expnum _v_ = new SZhenfaLevelUp2expnum();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SZhenfaLevelUp2expnum> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.zhenfa.confbean.SZhenfaLevelUp2expnum.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           SZhenfaLevelUp2expnum _v_ = new SZhenfaLevelUp2expnum();
...
/*     */ 
/*     */ 
/*     */   public static SZhenfaLevelUp2expnum getOld(int key)
/*     */   {
/* 199 */     return (SZhenfaLevelUp2expnum)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SZhenfaLevelUp2expnum get(int key)
/*     */   {
/* 204 */     return (SZhenfaLevelUp2expnum)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SZhenfaLevelUp2expnum> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SZhenfaLevelUp2expnum> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SZhenfaLevelUp2expnum> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\zhenfa\confbean\SZhenfaLevelUp2expnum.class
