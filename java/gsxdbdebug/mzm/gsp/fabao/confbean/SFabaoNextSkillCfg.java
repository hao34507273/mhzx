...
/*     */ 
/*     */ public class SFabaoNextSkillCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SFabaoNextSkillCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SFabaoNextSkillCfg> all = null;
/*     */   
/*     */   public int skillId;
/*     */   public int nextRankSkillid;
/*     */   public int skillidRank;
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  24 */     this.skillId = Integer.valueOf(rootElement.attributeValue("skillId")).intValue();
/*  25 */     this.nextRankSkillid = Integer.valueOf(rootElement.attributeValue("nextRankSkillid")).intValue();
/*  26 */     this.skillidRank = Integer.valueOf(rootElement.attributeValue("skillidRank")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  31 */     _os_.marshal(this.skillId);
/*  32 */     _os_.marshal(this.nextRankSkillid);
/*  33 */     _os_.marshal(this.skillidRank);
/*  34 */     return _os_;
/*     */   }
/*     */   
...
/*  40 */     this.nextRankSkillid = _os_.unmarshal_int();
/*  41 */     this.skillidRank = _os_.unmarshal_int();
/*  42 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  47 */     String path = dir + "mzm.gsp.fabao.confbean.SFabaoNextSkillCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  60 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.fabao.confbean.SFabaoNextSkillCfg"))
/*     */         {
/*     */ 
/*  63 */           SFabaoNextSkillCfg obj = new SFabaoNextSkillCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SFabaoNextSkillCfg> all)
/*     */   {
/*  77 */     String path = dir + "mzm.gsp.fabao.confbean.SFabaoNextSkillCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  89 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.fabao.confbean.SFabaoNextSkillCfg"))
/*     */         {
/*     */ 
/*  92 */           SFabaoNextSkillCfg obj = new SFabaoNextSkillCfg();
...
/*     */     
/* 108 */     String path = dir + "mzm.gsp.fabao.confbean.SFabaoNextSkillCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 135 */           SFabaoNextSkillCfg _v_ = new SFabaoNextSkillCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SFabaoNextSkillCfg> all)
/*     */   {
/* 155 */     String path = dir + "mzm.gsp.fabao.confbean.SFabaoNextSkillCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 182 */           SFabaoNextSkillCfg _v_ = new SFabaoNextSkillCfg();
...
/*     */ 
/*     */ 
/*     */   public static SFabaoNextSkillCfg getOld(int key)
/*     */   {
/* 203 */     return (SFabaoNextSkillCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SFabaoNextSkillCfg get(int key)
/*     */   {
/* 208 */     return (SFabaoNextSkillCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SFabaoNextSkillCfg> getOldAll()
/*     */   {
/* 213 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SFabaoNextSkillCfg> getAll()
/*     */   {
/* 218 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SFabaoNextSkillCfg> newAll)
/*     */   {
/* 223 */     oldAll = all;
/* 224 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\fabao\confbean\SFabaoNextSkillCfg.class
