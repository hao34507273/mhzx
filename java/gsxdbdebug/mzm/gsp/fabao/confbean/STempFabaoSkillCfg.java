...
/*     */ 
/*     */ public class STempFabaoSkillCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, STempFabaoSkillCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, STempFabaoSkillCfg> all = null;
/*     */   
/*     */   public int id;
/*  19 */   public HashMap<Integer, Integer> skillMap = new HashMap();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.id = Integer.valueOf(rootElement.attributeValue("id")).intValue();
/*     */     
/*  25 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "skillMap");
...
/*     */         }
/*     */         
/*  76 */         this.skillMap.put(Integer.valueOf(_k_), Integer.valueOf(_v_));
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*  84 */     _os_.compact_uint32(this.skillMap.size());
/*  85 */     for (java.util.Map.Entry<Integer, Integer> _e_ : this.skillMap.entrySet())
/*     */     {
...
/* 102 */       this.skillMap.put(Integer.valueOf(_k_), Integer.valueOf(_v_));
/*     */     }
/* 104 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/* 109 */     String path = dir + "mzm.gsp.fabao.confbean.STempFabaoSkillCfg.xml";
/*     */     
/*     */     try
/*     */     {
/* 113 */       all = new HashMap();
...
/* 122 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.fabao.confbean.STempFabaoSkillCfg"))
/*     */         {
/*     */ 
/* 125 */           STempFabaoSkillCfg obj = new STempFabaoSkillCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, STempFabaoSkillCfg> all)
/*     */   {
/* 139 */     String path = dir + "mzm.gsp.fabao.confbean.STempFabaoSkillCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 151 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.fabao.confbean.STempFabaoSkillCfg"))
/*     */         {
/*     */ 
/* 154 */           STempFabaoSkillCfg obj = new STempFabaoSkillCfg();
...
/* 168 */     all = new HashMap();
/*     */     
/* 170 */     String path = dir + "mzm.gsp.fabao.confbean.STempFabaoSkillCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 197 */           STempFabaoSkillCfg _v_ = new STempFabaoSkillCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, STempFabaoSkillCfg> all)
/*     */   {
/* 217 */     String path = dir + "mzm.gsp.fabao.confbean.STempFabaoSkillCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 244 */           STempFabaoSkillCfg _v_ = new STempFabaoSkillCfg();
...
/*     */ 
/*     */ 
/*     */   public static STempFabaoSkillCfg getOld(int key)
/*     */   {
/* 265 */     return (STempFabaoSkillCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static STempFabaoSkillCfg get(int key)
/*     */   {
/* 270 */     return (STempFabaoSkillCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, STempFabaoSkillCfg> getOldAll()
/*     */   {
/* 275 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, STempFabaoSkillCfg> getAll()
/*     */   {
/* 280 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, STempFabaoSkillCfg> newAll)
/*     */   {
/* 285 */     oldAll = all;
/* 286 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\fabao\confbean\STempFabaoSkillCfg.class
