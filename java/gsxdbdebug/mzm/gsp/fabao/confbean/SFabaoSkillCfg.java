...
/*     */ 
/*     */ public class SFabaoSkillCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SFabaoSkillCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SFabaoSkillCfg> all = null;
/*     */   
/*     */   public int id;
/*  19 */   public java.util.ArrayList<SkillProbs> probs = new java.util.ArrayList();
/*     */   
...
/*  36 */       if (elem.getName().equalsIgnoreCase("mzm.gsp.fabao.confbean.SkillProbs"))
/*     */       {
/*     */         SkillProbs _v_;
/*     */         
/*     */ 
...
/*  59 */     _os_.compact_uint32(this.probs.size());
/*  60 */     for (SkillProbs _v_ : this.probs)
/*     */     {
/*  62 */       _os_.marshal(_v_);
/*     */     }
/*  64 */     return _os_;
...
/*     */     {
/*     */ 
/*  73 */       SkillProbs _v_ = new SkillProbs();
/*  74 */       _v_.unmarshal(_os_);
/*  75 */       this.probs.add(_v_);
/*     */     }
/*  77 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/*  82 */     String path = dir + "mzm.gsp.fabao.confbean.SFabaoSkillCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  95 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.fabao.confbean.SFabaoSkillCfg"))
/*     */         {
/*     */ 
/*  98 */           SFabaoSkillCfg obj = new SFabaoSkillCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SFabaoSkillCfg> all)
/*     */   {
/* 112 */     String path = dir + "mzm.gsp.fabao.confbean.SFabaoSkillCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 124 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.fabao.confbean.SFabaoSkillCfg"))
/*     */         {
/*     */ 
/* 127 */           SFabaoSkillCfg obj = new SFabaoSkillCfg();
...
/*     */     
/* 143 */     String path = dir + "mzm.gsp.fabao.confbean.SFabaoSkillCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 170 */           SFabaoSkillCfg _v_ = new SFabaoSkillCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SFabaoSkillCfg> all)
/*     */   {
/* 190 */     String path = dir + "mzm.gsp.fabao.confbean.SFabaoSkillCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 217 */           SFabaoSkillCfg _v_ = new SFabaoSkillCfg();
...
/*     */ 
/*     */ 
/*     */   public static SFabaoSkillCfg getOld(int key)
/*     */   {
/* 238 */     return (SFabaoSkillCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SFabaoSkillCfg get(int key)
/*     */   {
/* 243 */     return (SFabaoSkillCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SFabaoSkillCfg> getOldAll()
/*     */   {
/* 248 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SFabaoSkillCfg> getAll()
/*     */   {
/* 253 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SFabaoSkillCfg> newAll)
/*     */   {
/* 258 */     oldAll = all;
/* 259 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\fabao\confbean\SFabaoSkillCfg.class
