...
/*     */ 
/*     */ public class STempFabaoLevelCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, STempFabaoLevelCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, STempFabaoLevelCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public int classid;
/*     */   public int lv;
...
/*  27 */     this.classid = Integer.valueOf(rootElement.attributeValue("classid")).intValue();
/*  28 */     this.lv = Integer.valueOf(rootElement.attributeValue("lv")).intValue();
/*  29 */     this.roleLv = Integer.valueOf(rootElement.attributeValue("roleLv")).intValue();
/*  30 */     this.needExp = Integer.valueOf(rootElement.attributeValue("needExp")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  35 */     _os_.marshal(this.id);
/*  36 */     _os_.marshal(this.classid);
/*  37 */     _os_.marshal(this.lv);
/*  38 */     _os_.marshal(this.roleLv);
/*  39 */     _os_.marshal(this.needExp);
/*  40 */     return _os_;
/*     */   }
/*     */   
...
/*  46 */     this.classid = _os_.unmarshal_int();
/*  47 */     this.lv = _os_.unmarshal_int();
/*  48 */     this.roleLv = _os_.unmarshal_int();
/*  49 */     this.needExp = _os_.unmarshal_int();
/*  50 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  55 */     String path = dir + "mzm.gsp.fabao.confbean.STempFabaoLevelCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  68 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.fabao.confbean.STempFabaoLevelCfg"))
/*     */         {
/*     */ 
/*  71 */           STempFabaoLevelCfg obj = new STempFabaoLevelCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, STempFabaoLevelCfg> all)
/*     */   {
/*  85 */     String path = dir + "mzm.gsp.fabao.confbean.STempFabaoLevelCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  97 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.fabao.confbean.STempFabaoLevelCfg"))
/*     */         {
/*     */ 
/* 100 */           STempFabaoLevelCfg obj = new STempFabaoLevelCfg();
...
/*     */     
/* 116 */     String path = dir + "mzm.gsp.fabao.confbean.STempFabaoLevelCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 143 */           STempFabaoLevelCfg _v_ = new STempFabaoLevelCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, STempFabaoLevelCfg> all)
/*     */   {
/* 163 */     String path = dir + "mzm.gsp.fabao.confbean.STempFabaoLevelCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 190 */           STempFabaoLevelCfg _v_ = new STempFabaoLevelCfg();
...
/*     */ 
/*     */ 
/*     */   public static STempFabaoLevelCfg getOld(int key)
/*     */   {
/* 211 */     return (STempFabaoLevelCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static STempFabaoLevelCfg get(int key)
/*     */   {
/* 216 */     return (STempFabaoLevelCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, STempFabaoLevelCfg> getOldAll()
/*     */   {
/* 221 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, STempFabaoLevelCfg> getAll()
/*     */   {
/* 226 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, STempFabaoLevelCfg> newAll)
/*     */   {
/* 231 */     oldAll = all;
/* 232 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\fabao\confbean\STempFabaoLevelCfg.class
