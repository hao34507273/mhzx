...
/*     */ 
/*     */ public class SFabaoExtraEffectCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SFabaoExtraEffectCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SFabaoExtraEffectCfg> all = null;
/*     */   
/*     */   public int fabaoMinRankLv;
/*  19 */   public HashMap<Integer, ProType2Value> rolelv2proMap = new HashMap();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.fabaoMinRankLv = Integer.valueOf(rootElement.attributeValue("fabaoMinRankLv")).intValue();
/*     */     
/*  25 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "rolelv2proMap");
...
/*  51 */             keyElem = elem;
/*     */           }
/*  53 */           else if ((valueElem == null) && (elem.getName().equalsIgnoreCase("mzm.gsp.fabao.confbean.ProType2Value")))
/*     */           {
/*  55 */             valueElem = elem;
/*     */           }
/*     */         }
...
/*     */         }
/*     */         
/*  77 */         this.rolelv2proMap.put(Integer.valueOf(_k_), _v_);
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*     */   {
/*  84 */     _os_.marshal(this.fabaoMinRankLv);
/*  85 */     _os_.compact_uint32(this.rolelv2proMap.size());
/*  86 */     for (java.util.Map.Entry<Integer, ProType2Value> _e_ : this.rolelv2proMap.entrySet())
/*     */     {
...
/*     */   {
/*  96 */     this.fabaoMinRankLv = _os_.unmarshal_int();
/*  97 */     for (int _size_ = _os_.uncompact_uint32(); _size_ > 0; _size_--)
/*     */     {
/*     */ 
/* 100 */       int _k_ = _os_.unmarshal_int();
/*     */       
/* 102 */       ProType2Value _v_ = new ProType2Value();
/* 103 */       _v_.unmarshal(_os_);
/* 104 */       this.rolelv2proMap.put(Integer.valueOf(_k_), _v_);
/*     */     }
/* 106 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/* 111 */     String path = dir + "mzm.gsp.fabao.confbean.SFabaoExtraEffectCfg.xml";
/*     */     
/*     */     try
/*     */     {
/* 115 */       all = new java.util.TreeMap();
...
/* 124 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.fabao.confbean.SFabaoExtraEffectCfg"))
/*     */         {
/*     */ 
/* 127 */           SFabaoExtraEffectCfg obj = new SFabaoExtraEffectCfg();
/* 128 */           obj.loadFromXml(elem);
/* 129 */           if (all.put(Integer.valueOf(obj.fabaoMinRankLv), obj) != null) {
/* 130 */             throw new RuntimeException("duplicate key : " + obj.fabaoMinRankLv);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SFabaoExtraEffectCfg> all)
/*     */   {
/* 141 */     String path = dir + "mzm.gsp.fabao.confbean.SFabaoExtraEffectCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 153 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.fabao.confbean.SFabaoExtraEffectCfg"))
/*     */         {
/*     */ 
/* 156 */           SFabaoExtraEffectCfg obj = new SFabaoExtraEffectCfg();
/* 157 */           obj.loadFromXml(elem);
/* 158 */           if (all.put(Integer.valueOf(obj.fabaoMinRankLv), obj) != null) {
/* 159 */             throw new RuntimeException("duplicate key : " + obj.fabaoMinRankLv);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   {
/* 170 */     all = new java.util.TreeMap();
/*     */     
/* 172 */     String path = dir + "mzm.gsp.fabao.confbean.SFabaoExtraEffectCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 199 */           SFabaoExtraEffectCfg _v_ = new SFabaoExtraEffectCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SFabaoExtraEffectCfg> all)
/*     */   {
/* 219 */     String path = dir + "mzm.gsp.fabao.confbean.SFabaoExtraEffectCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 246 */           SFabaoExtraEffectCfg _v_ = new SFabaoExtraEffectCfg();
...
/*     */ 
/*     */ 
/*     */   public static SFabaoExtraEffectCfg getOld(int key)
/*     */   {
/* 267 */     return (SFabaoExtraEffectCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SFabaoExtraEffectCfg get(int key)
/*     */   {
/* 272 */     return (SFabaoExtraEffectCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SFabaoExtraEffectCfg> getOldAll()
/*     */   {
/* 277 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SFabaoExtraEffectCfg> getAll()
/*     */   {
/* 282 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SFabaoExtraEffectCfg> newAll)
/*     */   {
/* 287 */     oldAll = all;
/* 288 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\fabao\confbean\SFabaoExtraEffectCfg.class
