...
/*     */ 
/*     */ public class SFabaoAttributeCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SFabaoAttributeCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SFabaoAttributeCfg> all = null;
/*     */   
/*     */   public int proClassid;
/*  19 */   public HashMap<Integer, ProType2Value> lv2Pro = new HashMap();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.proClassid = Integer.valueOf(rootElement.attributeValue("proClassid")).intValue();
/*     */     
/*  25 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "lv2Pro");
...
/*     */         }
/*     */         
/*  77 */         this.lv2Pro.put(Integer.valueOf(_k_), _v_);
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*     */   {
/*  84 */     _os_.marshal(this.proClassid);
/*  85 */     _os_.compact_uint32(this.lv2Pro.size());
/*  86 */     for (java.util.Map.Entry<Integer, ProType2Value> _e_ : this.lv2Pro.entrySet())
/*     */     {
...
/*     */   {
/*  96 */     this.proClassid = _os_.unmarshal_int();
...
/* 104 */       this.lv2Pro.put(Integer.valueOf(_k_), _v_);
/*     */     }
/* 106 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/* 111 */     String path = dir + "mzm.gsp.fabao.confbean.SFabaoAttributeCfg.xml";
/*     */     
/*     */     try
/*     */     {
/* 115 */       all = new HashMap();
...
/* 124 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.fabao.confbean.SFabaoAttributeCfg"))
/*     */         {
/*     */ 
/* 127 */           SFabaoAttributeCfg obj = new SFabaoAttributeCfg();
/* 128 */           obj.loadFromXml(elem);
/* 129 */           if (all.put(Integer.valueOf(obj.proClassid), obj) != null) {
/* 130 */             throw new RuntimeException("duplicate key : " + obj.proClassid);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SFabaoAttributeCfg> all)
/*     */   {
/* 141 */     String path = dir + "mzm.gsp.fabao.confbean.SFabaoAttributeCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 153 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.fabao.confbean.SFabaoAttributeCfg"))
/*     */         {
/*     */ 
/* 156 */           SFabaoAttributeCfg obj = new SFabaoAttributeCfg();
/* 157 */           obj.loadFromXml(elem);
/* 158 */           if (all.put(Integer.valueOf(obj.proClassid), obj) != null) {
/* 159 */             throw new RuntimeException("duplicate key : " + obj.proClassid);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/* 170 */     all = new HashMap();
/*     */     
/* 172 */     String path = dir + "mzm.gsp.fabao.confbean.SFabaoAttributeCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 199 */           SFabaoAttributeCfg _v_ = new SFabaoAttributeCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SFabaoAttributeCfg> all)
/*     */   {
/* 219 */     String path = dir + "mzm.gsp.fabao.confbean.SFabaoAttributeCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 246 */           SFabaoAttributeCfg _v_ = new SFabaoAttributeCfg();
...
/*     */ 
/*     */ 
/*     */   public static SFabaoAttributeCfg getOld(int key)
/*     */   {
/* 267 */     return (SFabaoAttributeCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SFabaoAttributeCfg get(int key)
/*     */   {
/* 272 */     return (SFabaoAttributeCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SFabaoAttributeCfg> getOldAll()
/*     */   {
/* 277 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SFabaoAttributeCfg> getAll()
/*     */   {
/* 282 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SFabaoAttributeCfg> newAll)
/*     */   {
/* 287 */     oldAll = all;
/* 288 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\fabao\confbean\SFabaoAttributeCfg.class
