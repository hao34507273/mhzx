...
/*     */ 
/*     */ public class SFabaoLevelCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SFabaoLevelCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SFabaoLevelCfg> all = null;
/*     */   
/*     */   public int classid;
/*  19 */   public HashMap<Integer, FaBaoLevelInfo> lv2FaBaoLevelInfo = new HashMap();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.classid = Integer.valueOf(rootElement.attributeValue("classid")).intValue();
/*     */     
/*  25 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "lv2FaBaoLevelInfo");
...
/*  51 */             keyElem = elem;
/*     */           }
/*  53 */           else if ((valueElem == null) && (elem.getName().equalsIgnoreCase("mzm.gsp.fabao.confbean.FaBaoLevelInfo")))
/*     */           {
/*  55 */             valueElem = elem;
/*     */           }
/*     */         }
...
/*     */         }
/*     */         
/*  77 */         this.lv2FaBaoLevelInfo.put(Integer.valueOf(_k_), _v_);
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*     */   {
/*  84 */     _os_.marshal(this.classid);
/*  85 */     _os_.compact_uint32(this.lv2FaBaoLevelInfo.size());
/*  86 */     for (java.util.Map.Entry<Integer, FaBaoLevelInfo> _e_ : this.lv2FaBaoLevelInfo.entrySet())
/*     */     {
...
/*     */   {
/*  96 */     this.classid = _os_.unmarshal_int();
/*  97 */     for (int _size_ = _os_.uncompact_uint32(); _size_ > 0; _size_--)
/*     */     {
/*     */ 
/* 100 */       int _k_ = _os_.unmarshal_int();
/*     */       
/* 102 */       FaBaoLevelInfo _v_ = new FaBaoLevelInfo();
/* 103 */       _v_.unmarshal(_os_);
/* 104 */       this.lv2FaBaoLevelInfo.put(Integer.valueOf(_k_), _v_);
/*     */     }
/* 106 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/* 111 */     String path = dir + "mzm.gsp.fabao.confbean.SFabaoLevelCfg.xml";
/*     */     
/*     */     try
/*     */     {
/* 115 */       all = new HashMap();
...
/* 124 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.fabao.confbean.SFabaoLevelCfg"))
/*     */         {
/*     */ 
/* 127 */           SFabaoLevelCfg obj = new SFabaoLevelCfg();
/* 128 */           obj.loadFromXml(elem);
/* 129 */           if (all.put(Integer.valueOf(obj.classid), obj) != null) {
/* 130 */             throw new RuntimeException("duplicate key : " + obj.classid);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SFabaoLevelCfg> all)
/*     */   {
/* 141 */     String path = dir + "mzm.gsp.fabao.confbean.SFabaoLevelCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 153 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.fabao.confbean.SFabaoLevelCfg"))
/*     */         {
/*     */ 
/* 156 */           SFabaoLevelCfg obj = new SFabaoLevelCfg();
/* 157 */           obj.loadFromXml(elem);
/* 158 */           if (all.put(Integer.valueOf(obj.classid), obj) != null) {
/* 159 */             throw new RuntimeException("duplicate key : " + obj.classid);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/* 170 */     all = new HashMap();
/*     */     
/* 172 */     String path = dir + "mzm.gsp.fabao.confbean.SFabaoLevelCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 199 */           SFabaoLevelCfg _v_ = new SFabaoLevelCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SFabaoLevelCfg> all)
/*     */   {
/* 219 */     String path = dir + "mzm.gsp.fabao.confbean.SFabaoLevelCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 246 */           SFabaoLevelCfg _v_ = new SFabaoLevelCfg();
...
/*     */ 
/*     */ 
/*     */   public static SFabaoLevelCfg getOld(int key)
/*     */   {
/* 267 */     return (SFabaoLevelCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SFabaoLevelCfg get(int key)
/*     */   {
/* 272 */     return (SFabaoLevelCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SFabaoLevelCfg> getOldAll()
/*     */   {
/* 277 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SFabaoLevelCfg> getAll()
/*     */   {
/* 282 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SFabaoLevelCfg> newAll)
/*     */   {
/* 287 */     oldAll = all;
/* 288 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\fabao\confbean\SFabaoLevelCfg.class
