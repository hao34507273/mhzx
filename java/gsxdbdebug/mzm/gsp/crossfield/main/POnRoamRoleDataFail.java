...
/*    */     throws Exception
/*    */   {
/* 22 */     if (!(this.arg instanceof SingleCrossFieldRoamRoleDataFailArg))
/*    */     {
/* 24 */       return false;
/*    */     }
/* 26 */     SingleCrossFieldRoamRoleDataFailArg arg = (SingleCrossFieldRoamRoleDataFailArg)this.arg;
...
/*    */     
/* 41 */     CrossFieldManager.logger.info(String.format("[crossfield]POnGenRoamTokenFail.processImp@roam role data fail process|roleid=%d|activity_cfg_id=%d", new Object[] { Long.valueOf(roleid), Integer.valueOf(arg.getContext().getActivityCfgid()) }));
/*    */     
/*    */ 
/* 44 */     CrossFieldTLogManager.addMatchTLog(roleid, 2, arg.getContext().getActivityCfgid(), arg.getContext().getContextid(), 3L);
/*    */     
/*    */ 
/* 47 */     return true;
/*    */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\crossfield\main\POnRoamRoleDataFail.class
