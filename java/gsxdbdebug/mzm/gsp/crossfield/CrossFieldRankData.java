...
/*    */ 
/*    */ public class CrossFieldRankData implements Marshal
/*    */ {
/*    */   public int rank;
/*    */   public long roleid;
/*    */   public Octets name;
...
/*    */   
/*    */   public CrossFieldRankData()
/*    */   {
/* 19 */     this.name = new Octets();
/*    */   }
/*    */   
/*    */   public CrossFieldRankData(int _rank_, long _roleid_, Octets _name_, int _occupation_, int _star_num_, int _timestamp_) {
/* 23 */     this.rank = _rank_;
/* 24 */     this.roleid = _roleid_;
/* 25 */     this.name = _name_;
/* 26 */     this.occupation = _occupation_;
/* 27 */     this.star_num = _star_num_;
...
/* 50 */     this.star_num = _os_.unmarshal_int();
...
/* 57 */     if ((_o1_ instanceof CrossFieldRankData)) {
/* 58 */       CrossFieldRankData _o_ = (CrossFieldRankData)_o1_;
...
/* 63 */       if (this.star_num != _o_.star_num) return false;
...
/* 88 */     _sb_.append(this.star_num).append(",");
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\crossfield\CrossFieldRankData.class
