...
/*     */ 
/*     */ public class SCrossFieldSeasonCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SCrossFieldSeasonCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SCrossFieldSeasonCfg> all = null;
/*     */   
/*     */   public int sort_id;
...
/*     */   {
/*  23 */     this.sort_id = Integer.valueOf(rootElement.attributeValue("sort_id")).intValue();
/*  24 */     this.begin_timestamp = Integer.valueOf(rootElement.attributeValue("begin_timestamp")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  29 */     _os_.marshal(this.sort_id);
/*  30 */     _os_.marshal(this.begin_timestamp);
/*  31 */     return _os_;
/*     */   }
/*     */   
/*     */   public OctetsStream unmarshal(OctetsStream _os_) throws com.goldhuman.Common.Marshal.MarshalException
/*     */   {
/*  36 */     this.sort_id = _os_.unmarshal_int();
/*  37 */     this.begin_timestamp = _os_.unmarshal_int();
/*  38 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.crossfield.confbean.SCrossFieldSeasonCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.crossfield.confbean.SCrossFieldSeasonCfg"))
/*     */         {
/*     */ 
/*  59 */           SCrossFieldSeasonCfg obj = new SCrossFieldSeasonCfg();
/*  60 */           obj.loadFromXml(elem);
/*  61 */           if (all.put(Integer.valueOf(obj.sort_id), obj) != null) {
/*  62 */             throw new RuntimeException("duplicate key : " + obj.sort_id);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SCrossFieldSeasonCfg> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.crossfield.confbean.SCrossFieldSeasonCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.crossfield.confbean.SCrossFieldSeasonCfg"))
/*     */         {
/*     */ 
/*  88 */           SCrossFieldSeasonCfg obj = new SCrossFieldSeasonCfg();
/*  89 */           obj.loadFromXml(elem);
/*  90 */           if (all.put(Integer.valueOf(obj.sort_id), obj) != null) {
/*  91 */             throw new RuntimeException("duplicate key : " + obj.sort_id);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.crossfield.confbean.SCrossFieldSeasonCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           SCrossFieldSeasonCfg _v_ = new SCrossFieldSeasonCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SCrossFieldSeasonCfg> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.crossfield.confbean.SCrossFieldSeasonCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           SCrossFieldSeasonCfg _v_ = new SCrossFieldSeasonCfg();
...
/*     */ 
/*     */ 
/*     */   public static SCrossFieldSeasonCfg getOld(int key)
/*     */   {
/* 199 */     return (SCrossFieldSeasonCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SCrossFieldSeasonCfg get(int key)
/*     */   {
/* 204 */     return (SCrossFieldSeasonCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SCrossFieldSeasonCfg> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SCrossFieldSeasonCfg> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SCrossFieldSeasonCfg> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\crossfield\confbean\SCrossFieldSeasonCfg.class
