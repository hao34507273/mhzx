...
/*     */ 
/*     */ public class SMallTypeCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SMallTypeCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SMallTypeCfg> all = null;
/*     */   
/*     */   public int mallType;
/*     */   public int id;
/*     */   public int sort;
...
/*     */   {
/*  25 */     this.mallType = Integer.valueOf(rootElement.attributeValue("mallType")).intValue();
/*  26 */     this.id = Integer.valueOf(rootElement.attributeValue("id")).intValue();
/*  27 */     this.sort = Integer.valueOf(rootElement.attributeValue("sort")).intValue();
/*  28 */     this.refreshtime = Integer.valueOf(rootElement.attributeValue("refreshtime")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  33 */     _os_.marshal(this.mallType);
/*  34 */     _os_.marshal(this.id);
/*  35 */     _os_.marshal(this.sort);
/*  36 */     _os_.marshal(this.refreshtime);
/*  37 */     return _os_;
/*     */   }
/*     */   
/*     */   public OctetsStream unmarshal(OctetsStream _os_) throws com.goldhuman.Common.Marshal.MarshalException
/*     */   {
/*  42 */     this.mallType = _os_.unmarshal_int();
/*  43 */     this.id = _os_.unmarshal_int();
/*  44 */     this.sort = _os_.unmarshal_int();
/*  45 */     this.refreshtime = _os_.unmarshal_int();
/*  46 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  51 */     String path = dir + "mzm.gsp.mall.confbean.SMallTypeCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  64 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.mall.confbean.SMallTypeCfg"))
/*     */         {
/*     */ 
/*  67 */           SMallTypeCfg obj = new SMallTypeCfg();
/*  68 */           obj.loadFromXml(elem);
/*  69 */           if (all.put(Integer.valueOf(obj.mallType), obj) != null) {
/*  70 */             throw new RuntimeException("duplicate key : " + obj.mallType);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SMallTypeCfg> all)
/*     */   {
/*  81 */     String path = dir + "mzm.gsp.mall.confbean.SMallTypeCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.mall.confbean.SMallTypeCfg"))
/*     */         {
/*     */ 
/*  96 */           SMallTypeCfg obj = new SMallTypeCfg();
/*  97 */           obj.loadFromXml(elem);
/*  98 */           if (all.put(Integer.valueOf(obj.mallType), obj) != null) {
/*  99 */             throw new RuntimeException("duplicate key : " + obj.mallType);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 112 */     String path = dir + "mzm.gsp.mall.confbean.SMallTypeCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 139 */           SMallTypeCfg _v_ = new SMallTypeCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SMallTypeCfg> all)
/*     */   {
/* 159 */     String path = dir + "mzm.gsp.mall.confbean.SMallTypeCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 186 */           SMallTypeCfg _v_ = new SMallTypeCfg();
...
/*     */ 
/*     */ 
/*     */   public static SMallTypeCfg getOld(int key)
/*     */   {
/* 207 */     return (SMallTypeCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SMallTypeCfg get(int key)
/*     */   {
/* 212 */     return (SMallTypeCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMallTypeCfg> getOldAll()
/*     */   {
/* 217 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMallTypeCfg> getAll()
/*     */   {
/* 222 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SMallTypeCfg> newAll)
/*     */   {
/* 227 */     oldAll = all;
/* 228 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\mall\confbean\SMallTypeCfg.class
