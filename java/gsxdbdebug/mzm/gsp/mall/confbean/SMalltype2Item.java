...
/*     */ 
/*     */ public class SMalltype2Item implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SMalltype2Item> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SMalltype2Item> all = null;
/*     */   
/*     */   public int malltype;
/*  19 */   public HashMap<Integer, PriceMaxbuynum> itemid2pricenum = new HashMap();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.malltype = Integer.valueOf(rootElement.attributeValue("malltype")).intValue();
/*     */     
/*  25 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "itemid2pricenum");
...
/*  51 */             keyElem = elem;
/*     */           }
/*  53 */           else if ((valueElem == null) && (elem.getName().equalsIgnoreCase("mzm.gsp.mall.confbean.PriceMaxbuynum")))
/*     */           {
/*  55 */             valueElem = elem;
/*     */           }
/*     */         }
...
/*     */         }
/*     */         
/*  77 */         this.itemid2pricenum.put(Integer.valueOf(_k_), _v_);
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*     */   {
/*  84 */     _os_.marshal(this.malltype);
/*  85 */     _os_.compact_uint32(this.itemid2pricenum.size());
/*  86 */     for (java.util.Map.Entry<Integer, PriceMaxbuynum> _e_ : this.itemid2pricenum.entrySet())
/*     */     {
...
/*     */   {
/*  96 */     this.malltype = _os_.unmarshal_int();
/*  97 */     for (int _size_ = _os_.uncompact_uint32(); _size_ > 0; _size_--)
/*     */     {
/*     */ 
/* 100 */       int _k_ = _os_.unmarshal_int();
/*     */       
/* 102 */       PriceMaxbuynum _v_ = new PriceMaxbuynum();
/* 103 */       _v_.unmarshal(_os_);
/* 104 */       this.itemid2pricenum.put(Integer.valueOf(_k_), _v_);
/*     */     }
/* 106 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/* 111 */     String path = dir + "mzm.gsp.mall.confbean.SMalltype2Item.xml";
/*     */     
/*     */     try
/*     */     {
/* 115 */       all = new HashMap();
...
/* 124 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.mall.confbean.SMalltype2Item"))
/*     */         {
/*     */ 
/* 127 */           SMalltype2Item obj = new SMalltype2Item();
/* 128 */           obj.loadFromXml(elem);
/* 129 */           if (all.put(Integer.valueOf(obj.malltype), obj) != null) {
/* 130 */             throw new RuntimeException("duplicate key : " + obj.malltype);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SMalltype2Item> all)
/*     */   {
/* 141 */     String path = dir + "mzm.gsp.mall.confbean.SMalltype2Item.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 153 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.mall.confbean.SMalltype2Item"))
/*     */         {
/*     */ 
/* 156 */           SMalltype2Item obj = new SMalltype2Item();
/* 157 */           obj.loadFromXml(elem);
/* 158 */           if (all.put(Integer.valueOf(obj.malltype), obj) != null) {
/* 159 */             throw new RuntimeException("duplicate key : " + obj.malltype);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/* 170 */     all = new HashMap();
/*     */     
/* 172 */     String path = dir + "mzm.gsp.mall.confbean.SMalltype2Item.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 199 */           SMalltype2Item _v_ = new SMalltype2Item();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SMalltype2Item> all)
/*     */   {
/* 219 */     String path = dir + "mzm.gsp.mall.confbean.SMalltype2Item.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 246 */           SMalltype2Item _v_ = new SMalltype2Item();
...
/*     */ 
/*     */ 
/*     */   public static SMalltype2Item getOld(int key)
/*     */   {
/* 267 */     return (SMalltype2Item)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SMalltype2Item get(int key)
/*     */   {
/* 272 */     return (SMalltype2Item)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMalltype2Item> getOldAll()
/*     */   {
/* 277 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMalltype2Item> getAll()
/*     */   {
/* 282 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SMalltype2Item> newAll)
/*     */   {
/* 287 */     oldAll = all;
/* 288 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\mall\confbean\SMalltype2Item.class
