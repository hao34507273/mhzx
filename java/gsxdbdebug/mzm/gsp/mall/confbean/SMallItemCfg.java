...
/*     */ 
/*     */ public class SMallItemCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SMallItemCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SMallItemCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public int mallType;
/*     */   public int itemid;
...
/*  29 */     this.mallType = Integer.valueOf(rootElement.attributeValue("mallType")).intValue();
...
/*  32 */     this.primeprice = Integer.valueOf(rootElement.attributeValue("primeprice")).intValue();
...
/*  40 */     _os_.marshal(this.mallType);
/*  41 */     _os_.marshal(this.itemid);
/*  42 */     _os_.marshal(this.price);
/*  43 */     _os_.marshal(this.primeprice);
/*  44 */     _os_.marshal(this.maxbuynum);
/*  45 */     _os_.marshal(this.sort);
/*  46 */     return _os_;
/*     */   }
/*     */   
...
/*  52 */     this.mallType = _os_.unmarshal_int();
/*  53 */     this.itemid = _os_.unmarshal_int();
/*  54 */     this.price = _os_.unmarshal_int();
/*  55 */     this.primeprice = _os_.unmarshal_int();
/*  56 */     this.maxbuynum = _os_.unmarshal_int();
/*  57 */     this.sort = _os_.unmarshal_int();
/*  58 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  63 */     String path = dir + "mzm.gsp.mall.confbean.SMallItemCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  76 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.mall.confbean.SMallItemCfg"))
/*     */         {
/*     */ 
/*  79 */           SMallItemCfg obj = new SMallItemCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SMallItemCfg> all)
/*     */   {
/*  93 */     String path = dir + "mzm.gsp.mall.confbean.SMallItemCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 105 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.mall.confbean.SMallItemCfg"))
/*     */         {
/*     */ 
/* 108 */           SMallItemCfg obj = new SMallItemCfg();
...
/*     */     
/* 124 */     String path = dir + "mzm.gsp.mall.confbean.SMallItemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 151 */           SMallItemCfg _v_ = new SMallItemCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SMallItemCfg> all)
/*     */   {
/* 171 */     String path = dir + "mzm.gsp.mall.confbean.SMallItemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 198 */           SMallItemCfg _v_ = new SMallItemCfg();
...
/*     */ 
/*     */ 
/*     */   public static SMallItemCfg getOld(int key)
/*     */   {
/* 219 */     return (SMallItemCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SMallItemCfg get(int key)
/*     */   {
/* 224 */     return (SMallItemCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMallItemCfg> getOldAll()
/*     */   {
/* 229 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMallItemCfg> getAll()
/*     */   {
/* 234 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SMallItemCfg> newAll)
/*     */   {
/* 239 */     oldAll = all;
/* 240 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\mall\confbean\SMallItemCfg.class
