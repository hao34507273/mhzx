...
/*     */ 
/*     */ public class SShimenExchangeItemCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SShimenExchangeItemCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SShimenExchangeItemCfg> all = null;
/*     */   
/*     */   public int id;
...
/*  26 */     this.exchangeType = Integer.valueOf(rootElement.attributeValue("exchangeType")).intValue();
/*  27 */     this.itemid = Integer.valueOf(rootElement.attributeValue("itemid")).intValue();
/*  28 */     this.price = Integer.valueOf(rootElement.attributeValue("price")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  33 */     _os_.marshal(this.id);
/*  34 */     _os_.marshal(this.exchangeType);
...
/*  43 */     this.exchangeType = _os_.unmarshal_int();
...
/*     */   {
/*  51 */     String path = dir + "mzm.gsp.mall.confbean.SShimenExchangeItemCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  64 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.mall.confbean.SShimenExchangeItemCfg"))
/*     */         {
/*     */ 
/*  67 */           SShimenExchangeItemCfg obj = new SShimenExchangeItemCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SShimenExchangeItemCfg> all)
/*     */   {
/*  81 */     String path = dir + "mzm.gsp.mall.confbean.SShimenExchangeItemCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.mall.confbean.SShimenExchangeItemCfg"))
/*     */         {
/*     */ 
/*  96 */           SShimenExchangeItemCfg obj = new SShimenExchangeItemCfg();
...
/*     */     
/* 112 */     String path = dir + "mzm.gsp.mall.confbean.SShimenExchangeItemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 139 */           SShimenExchangeItemCfg _v_ = new SShimenExchangeItemCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SShimenExchangeItemCfg> all)
/*     */   {
/* 159 */     String path = dir + "mzm.gsp.mall.confbean.SShimenExchangeItemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 186 */           SShimenExchangeItemCfg _v_ = new SShimenExchangeItemCfg();
...
/*     */ 
/*     */ 
/*     */   public static SShimenExchangeItemCfg getOld(int key)
/*     */   {
/* 207 */     return (SShimenExchangeItemCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SShimenExchangeItemCfg get(int key)
/*     */   {
/* 212 */     return (SShimenExchangeItemCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SShimenExchangeItemCfg> getOldAll()
/*     */   {
/* 217 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SShimenExchangeItemCfg> getAll()
/*     */   {
/* 222 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SShimenExchangeItemCfg> newAll)
/*     */   {
/* 227 */     oldAll = all;
/* 228 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\mall\confbean\SShimenExchangeItemCfg.class
