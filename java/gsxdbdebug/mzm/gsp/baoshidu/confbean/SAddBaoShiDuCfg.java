/*     */ package mzm.gsp.baoshidu.confbean;
/*     */ 
...
/*     */ 
/*     */ public class SAddBaoShiDuCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SAddBaoShiDuCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SAddBaoShiDuCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public String templatename;
/*     */   public int level;
/*     */   public int add1BaoshiduNeedSilver;
/*     */   
...
/*  28 */     this.add1BaoshiduNeedSilver = Integer.valueOf(rootElement.attributeValue("add1BaoshiduNeedSilver")).intValue();
/*     */   }
/*     */   
...
/*  36 */     _os_.marshal(this.add1BaoshiduNeedSilver);
/*  37 */     return _os_;
/*     */   }
/*     */   
...
/*  45 */     this.add1BaoshiduNeedSilver = _os_.unmarshal_int();
/*  46 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  51 */     String path = dir + "mzm.gsp.baoshidu.confbean.SAddBaoShiDuCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  64 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.baoshidu.confbean.SAddBaoShiDuCfg"))
/*     */         {
/*     */ 
/*  67 */           SAddBaoShiDuCfg obj = new SAddBaoShiDuCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SAddBaoShiDuCfg> all)
/*     */   {
/*  81 */     String path = dir + "mzm.gsp.baoshidu.confbean.SAddBaoShiDuCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.baoshidu.confbean.SAddBaoShiDuCfg"))
/*     */         {
/*     */ 
/*  96 */           SAddBaoShiDuCfg obj = new SAddBaoShiDuCfg();
...
/*     */     
/* 112 */     String path = dir + "mzm.gsp.baoshidu.confbean.SAddBaoShiDuCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 139 */           SAddBaoShiDuCfg _v_ = new SAddBaoShiDuCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SAddBaoShiDuCfg> all)
/*     */   {
/* 159 */     String path = dir + "mzm.gsp.baoshidu.confbean.SAddBaoShiDuCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 186 */           SAddBaoShiDuCfg _v_ = new SAddBaoShiDuCfg();
...
/*     */ 
/*     */ 
/*     */   public static SAddBaoShiDuCfg getOld(int key)
/*     */   {
/* 207 */     return (SAddBaoShiDuCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SAddBaoShiDuCfg get(int key)
/*     */   {
/* 212 */     return (SAddBaoShiDuCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SAddBaoShiDuCfg> getOldAll()
/*     */   {
/* 217 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SAddBaoShiDuCfg> getAll()
/*     */   {
/* 222 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SAddBaoShiDuCfg> newAll)
/*     */   {
/* 227 */     oldAll = all;
/* 228 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\baoshidu\confbean\SAddBaoShiDuCfg.class
