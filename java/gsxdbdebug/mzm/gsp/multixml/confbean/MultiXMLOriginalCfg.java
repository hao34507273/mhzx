/*     */ package mzm.gsp.multixml.confbean;
/*     */ 
...
/*     */ 
/*     */ public class MultiXMLOriginalCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, MultiXMLOriginalCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, MultiXMLOriginalCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public int server_local_id;
/*     */   public int xml_data_type;
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  24 */     this.id = Integer.valueOf(rootElement.attributeValue("id")).intValue();
/*  25 */     this.server_local_id = Integer.valueOf(rootElement.attributeValue("server_local_id")).intValue();
/*  26 */     this.xml_data_type = Integer.valueOf(rootElement.attributeValue("xml_data_type")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  31 */     _os_.marshal(this.id);
/*  32 */     _os_.marshal(this.server_local_id);
/*  33 */     _os_.marshal(this.xml_data_type);
/*  34 */     return _os_;
/*     */   }
/*     */   
...
/*  40 */     this.server_local_id = _os_.unmarshal_int();
/*  41 */     this.xml_data_type = _os_.unmarshal_int();
/*  42 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  47 */     String path = dir + "mzm.gsp.multixml.confbean.MultiXMLOriginalCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  60 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.multixml.confbean.MultiXMLOriginalCfg"))
/*     */         {
/*     */ 
/*  63 */           MultiXMLOriginalCfg obj = new MultiXMLOriginalCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, MultiXMLOriginalCfg> all)
/*     */   {
/*  77 */     String path = dir + "mzm.gsp.multixml.confbean.MultiXMLOriginalCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  89 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.multixml.confbean.MultiXMLOriginalCfg"))
/*     */         {
/*     */ 
/*  92 */           MultiXMLOriginalCfg obj = new MultiXMLOriginalCfg();
...
/*     */     
/* 108 */     String path = dir + "mzm.gsp.multixml.confbean.MultiXMLOriginalCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 135 */           MultiXMLOriginalCfg _v_ = new MultiXMLOriginalCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, MultiXMLOriginalCfg> all)
/*     */   {
/* 155 */     String path = dir + "mzm.gsp.multixml.confbean.MultiXMLOriginalCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 182 */           MultiXMLOriginalCfg _v_ = new MultiXMLOriginalCfg();
...
/*     */ 
/*     */ 
/*     */   public static MultiXMLOriginalCfg getOld(int key)
/*     */   {
/* 203 */     return (MultiXMLOriginalCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static MultiXMLOriginalCfg get(int key)
/*     */   {
/* 208 */     return (MultiXMLOriginalCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, MultiXMLOriginalCfg> getOldAll()
/*     */   {
/* 213 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, MultiXMLOriginalCfg> getAll()
/*     */   {
/* 218 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, MultiXMLOriginalCfg> newAll)
/*     */   {
/* 223 */     oldAll = all;
/* 224 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\multixml\confbean\MultiXMLOriginalCfg.class
