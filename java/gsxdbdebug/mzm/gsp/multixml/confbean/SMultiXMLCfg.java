...
/*     */ 
/*     */ public class SMultiXMLCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SMultiXMLCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SMultiXMLCfg> all = null;
/*     */   
/*     */   public int id;
...
/*  24 */     this.xml_data_type = Integer.valueOf(rootElement.attributeValue("xml_data_type")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  29 */     _os_.marshal(this.id);
/*  30 */     _os_.marshal(this.xml_data_type);
/*  31 */     return _os_;
/*     */   }
/*     */   
...
/*  37 */     this.xml_data_type = _os_.unmarshal_int();
/*  38 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.multixml.confbean.SMultiXMLCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.multixml.confbean.SMultiXMLCfg"))
/*     */         {
/*     */ 
/*  59 */           SMultiXMLCfg obj = new SMultiXMLCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SMultiXMLCfg> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.multixml.confbean.SMultiXMLCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.multixml.confbean.SMultiXMLCfg"))
/*     */         {
/*     */ 
/*  88 */           SMultiXMLCfg obj = new SMultiXMLCfg();
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.multixml.confbean.SMultiXMLCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           SMultiXMLCfg _v_ = new SMultiXMLCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SMultiXMLCfg> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.multixml.confbean.SMultiXMLCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           SMultiXMLCfg _v_ = new SMultiXMLCfg();
...
/*     */ 
/*     */ 
/*     */   public static SMultiXMLCfg getOld(int key)
/*     */   {
/* 199 */     return (SMultiXMLCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SMultiXMLCfg get(int key)
/*     */   {
/* 204 */     return (SMultiXMLCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMultiXMLCfg> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMultiXMLCfg> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SMultiXMLCfg> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\multixml\confbean\SMultiXMLCfg.class
