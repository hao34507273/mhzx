...
/*     */ 
/*     */ public class SWorldAIParam implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SWorldAIParam> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SWorldAIParam> all = null;
/*     */   
/*     */   public int id;
/*     */   public String templatename;
/*     */   public String name;
/*     */   public int avaliableType;
/*     */   public int lowLimit;
...
/*  30 */     this.avaliableType = Integer.valueOf(rootElement.attributeValue("avaliableType")).intValue();
/*  31 */     this.lowLimit = Integer.valueOf(rootElement.attributeValue("lowLimit")).intValue();
/*  32 */     this.highLimit = Integer.valueOf(rootElement.attributeValue("highLimit")).intValue();
/*     */   }
/*     */   
...
/*  39 */     _os_.marshal(this.name, "UTF-8");
/*  40 */     _os_.marshal(this.avaliableType);
/*  41 */     _os_.marshal(this.lowLimit);
/*  42 */     _os_.marshal(this.highLimit);
/*  43 */     return _os_;
/*     */   }
/*     */   
...
/*  50 */     this.name = _os_.unmarshal_String("UTF-8");
/*  51 */     this.avaliableType = _os_.unmarshal_int();
/*  52 */     this.lowLimit = _os_.unmarshal_int();
/*  53 */     this.highLimit = _os_.unmarshal_int();
/*  54 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  59 */     String path = dir + "mzm.gsp.worldai.confbean.SWorldAIParam.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  72 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.worldai.confbean.SWorldAIParam"))
/*     */         {
/*     */ 
/*  75 */           SWorldAIParam obj = new SWorldAIParam();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SWorldAIParam> all)
/*     */   {
/*  89 */     String path = dir + "mzm.gsp.worldai.confbean.SWorldAIParam.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 101 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.worldai.confbean.SWorldAIParam"))
/*     */         {
/*     */ 
/* 104 */           SWorldAIParam obj = new SWorldAIParam();
...
/*     */     
/* 120 */     String path = dir + "mzm.gsp.worldai.confbean.SWorldAIParam.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 147 */           SWorldAIParam _v_ = new SWorldAIParam();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SWorldAIParam> all)
/*     */   {
/* 167 */     String path = dir + "mzm.gsp.worldai.confbean.SWorldAIParam.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 194 */           SWorldAIParam _v_ = new SWorldAIParam();
...
/*     */ 
/*     */ 
/*     */   public static SWorldAIParam getOld(int key)
/*     */   {
/* 215 */     return (SWorldAIParam)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SWorldAIParam get(int key)
/*     */   {
/* 220 */     return (SWorldAIParam)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SWorldAIParam> getOldAll()
/*     */   {
/* 225 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SWorldAIParam> getAll()
/*     */   {
/* 230 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SWorldAIParam> newAll)
/*     */   {
/* 235 */     oldAll = all;
/* 236 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\worldai\confbean\SWorldAIParam.class
