...
/*     */ 
/*     */ public class SActivityId2OperaCfgid implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SActivityId2OperaCfgid> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SActivityId2OperaCfgid> all = null;
/*     */   
...
/*  24 */     this.instanceCfgid = Integer.valueOf(rootElement.attributeValue("instanceCfgid")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  29 */     _os_.marshal(this.activityid);
/*  30 */     _os_.marshal(this.instanceCfgid);
/*  31 */     return _os_;
/*     */   }
/*     */   
/*     */   public OctetsStream unmarshal(OctetsStream _os_) throws com.goldhuman.Common.Marshal.MarshalException
/*     */   {
/*  36 */     this.activityid = _os_.unmarshal_int();
/*  37 */     this.instanceCfgid = _os_.unmarshal_int();
/*  38 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.instance.confbean.SActivityId2OperaCfgid.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.instance.confbean.SActivityId2OperaCfgid"))
/*     */         {
/*     */ 
/*  59 */           SActivityId2OperaCfgid obj = new SActivityId2OperaCfgid();
/*  60 */           obj.loadFromXml(elem);
/*  61 */           if (all.put(Integer.valueOf(obj.activityid), obj) != null) {
/*  62 */             throw new RuntimeException("duplicate key : " + obj.activityid);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SActivityId2OperaCfgid> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.instance.confbean.SActivityId2OperaCfgid.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.instance.confbean.SActivityId2OperaCfgid"))
/*     */         {
/*     */ 
/*  88 */           SActivityId2OperaCfgid obj = new SActivityId2OperaCfgid();
/*  89 */           obj.loadFromXml(elem);
/*  90 */           if (all.put(Integer.valueOf(obj.activityid), obj) != null) {
/*  91 */             throw new RuntimeException("duplicate key : " + obj.activityid);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.instance.confbean.SActivityId2OperaCfgid.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           SActivityId2OperaCfgid _v_ = new SActivityId2OperaCfgid();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SActivityId2OperaCfgid> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.instance.confbean.SActivityId2OperaCfgid.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           SActivityId2OperaCfgid _v_ = new SActivityId2OperaCfgid();
...
/*     */ 
/*     */ 
/*     */   public static SActivityId2OperaCfgid getOld(int key)
/*     */   {
/* 199 */     return (SActivityId2OperaCfgid)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SActivityId2OperaCfgid get(int key)
/*     */   {
/* 204 */     return (SActivityId2OperaCfgid)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SActivityId2OperaCfgid> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SActivityId2OperaCfgid> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SActivityId2OperaCfgid> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\instance\confbean\SActivityId2OperaCfgid.class
