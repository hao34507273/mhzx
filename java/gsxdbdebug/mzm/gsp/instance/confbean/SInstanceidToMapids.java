...
/*     */ 
/*     */ public class SInstanceidToMapids implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SInstanceidToMapids> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SInstanceidToMapids> all = null;
/*     */   
/*     */   public int instanceid;
/*  19 */   public java.util.HashSet<Integer> mapids = new java.util.HashSet();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.instanceid = Integer.valueOf(rootElement.attributeValue("instanceid")).intValue();
/*     */     
/*  25 */     Element collectionElement = util.XmlHelper.getVariableElement(rootElement, "mapids");
...
/*     */         }
/*     */         
/*  50 */         this.mapids.add(Integer.valueOf(_v_));
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*     */   {
/*  57 */     _os_.marshal(this.instanceid);
/*  58 */     _os_.compact_uint32(this.mapids.size());
/*  59 */     for (Integer _v_ : this.mapids)
/*     */     {
...
/*     */   {
/*  80 */     String path = dir + "mzm.gsp.instance.confbean.SInstanceidToMapids.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.instance.confbean.SInstanceidToMapids"))
/*     */         {
/*     */ 
/*  96 */           SInstanceidToMapids obj = new SInstanceidToMapids();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SInstanceidToMapids> all)
/*     */   {
/* 110 */     String path = dir + "mzm.gsp.instance.confbean.SInstanceidToMapids.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 122 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.instance.confbean.SInstanceidToMapids"))
/*     */         {
/*     */ 
/* 125 */           SInstanceidToMapids obj = new SInstanceidToMapids();
/* 126 */           obj.loadFromXml(elem);
/* 127 */           if (all.put(Integer.valueOf(obj.instanceid), obj) != null) {
/* 128 */             throw new RuntimeException("duplicate key : " + obj.instanceid);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 141 */     String path = dir + "mzm.gsp.instance.confbean.SInstanceidToMapids.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 168 */           SInstanceidToMapids _v_ = new SInstanceidToMapids();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SInstanceidToMapids> all)
/*     */   {
/* 188 */     String path = dir + "mzm.gsp.instance.confbean.SInstanceidToMapids.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 215 */           SInstanceidToMapids _v_ = new SInstanceidToMapids();
...
/*     */ 
/*     */ 
/*     */   public static SInstanceidToMapids getOld(int key)
/*     */   {
/* 236 */     return (SInstanceidToMapids)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SInstanceidToMapids get(int key)
/*     */   {
/* 241 */     return (SInstanceidToMapids)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SInstanceidToMapids> getOldAll()
/*     */   {
/* 246 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SInstanceidToMapids> getAll()
/*     */   {
/* 251 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SInstanceidToMapids> newAll)
/*     */   {
/* 256 */     oldAll = all;
/* 257 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\instance\confbean\SInstanceidToMapids.class
