...
/*     */ 
/*     */ public class SSingleInstanceMapCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SSingleInstanceMapCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SSingleInstanceMapCfg> all = null;
/*     */   
/*     */   public int instanceid;
/*  19 */   public HashMap<Integer, SingleInstanceData> process2CfgMap = new HashMap();
/*     */   
...
/*  51 */             keyElem = elem;
/*     */           }
/*  53 */           else if ((valueElem == null) && (elem.getName().equalsIgnoreCase("mzm.gsp.instance.confbean.SingleInstanceData")))
/*     */           {
/*  55 */             valueElem = elem;
/*     */           }
/*     */         }
...
/*     */         
/*     */         int _k_;
/*     */         SingleInstanceData _v_;
/*     */         try
/*     */         {
/*  68 */           _k_ = Integer.valueOf(keyElem.getText()).intValue();
/*  69 */           _v_ = new SingleInstanceData();
...
/*  86 */     for (java.util.Map.Entry<Integer, SingleInstanceData> _e_ : this.process2CfgMap.entrySet())
/*     */     {
...
/*     */       
/* 102 */       SingleInstanceData _v_ = new SingleInstanceData();
...
/*     */   {
/* 111 */     String path = dir + "mzm.gsp.instance.confbean.SSingleInstanceMapCfg.xml";
/*     */     
/*     */     try
/*     */     {
/* 115 */       all = new HashMap();
...
/* 124 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.instance.confbean.SSingleInstanceMapCfg"))
/*     */         {
/*     */ 
/* 127 */           SSingleInstanceMapCfg obj = new SSingleInstanceMapCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SSingleInstanceMapCfg> all)
/*     */   {
/* 141 */     String path = dir + "mzm.gsp.instance.confbean.SSingleInstanceMapCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 153 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.instance.confbean.SSingleInstanceMapCfg"))
/*     */         {
/*     */ 
/* 156 */           SSingleInstanceMapCfg obj = new SSingleInstanceMapCfg();
...
/* 170 */     all = new HashMap();
/*     */     
/* 172 */     String path = dir + "mzm.gsp.instance.confbean.SSingleInstanceMapCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 199 */           SSingleInstanceMapCfg _v_ = new SSingleInstanceMapCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SSingleInstanceMapCfg> all)
/*     */   {
/* 219 */     String path = dir + "mzm.gsp.instance.confbean.SSingleInstanceMapCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 246 */           SSingleInstanceMapCfg _v_ = new SSingleInstanceMapCfg();
...
/*     */ 
/*     */ 
/*     */   public static SSingleInstanceMapCfg getOld(int key)
/*     */   {
/* 267 */     return (SSingleInstanceMapCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SSingleInstanceMapCfg get(int key)
/*     */   {
/* 272 */     return (SSingleInstanceMapCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SSingleInstanceMapCfg> getOldAll()
/*     */   {
/* 277 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SSingleInstanceMapCfg> getAll()
/*     */   {
/* 282 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SSingleInstanceMapCfg> newAll)
/*     */   {
/* 287 */     oldAll = all;
/* 288 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\instance\confbean\SSingleInstanceMapCfg.class
