...
/*     */ 
/*     */ public class SDoudouCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SDoudouCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SDoudouCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public int weight;
...
/*  26 */     this.weight = Integer.valueOf(rootElement.attributeValue("weight")).intValue();
/*  27 */     this.fightCfgId = Integer.valueOf(rootElement.attributeValue("fightCfgId")).intValue();
/*  28 */     this.canDelete = Boolean.valueOf(rootElement.attributeValue("canDelete")).booleanValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  33 */     _os_.marshal(this.id);
/*  34 */     _os_.marshal(this.weight);
/*  35 */     _os_.marshal(this.fightCfgId);
/*  36 */     _os_.marshal(this.canDelete);
/*  37 */     return _os_;
/*     */   }
/*     */   
...
/*  43 */     this.weight = _os_.unmarshal_int();
/*  44 */     this.fightCfgId = _os_.unmarshal_int();
/*  45 */     this.canDelete = _os_.unmarshal_boolean();
/*  46 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  51 */     String path = dir + "mzm.gsp.hula.confbean.SDoudouCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  64 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.hula.confbean.SDoudouCfg"))
/*     */         {
/*     */ 
/*  67 */           SDoudouCfg obj = new SDoudouCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SDoudouCfg> all)
/*     */   {
/*  81 */     String path = dir + "mzm.gsp.hula.confbean.SDoudouCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.hula.confbean.SDoudouCfg"))
/*     */         {
/*     */ 
/*  96 */           SDoudouCfg obj = new SDoudouCfg();
...
/*     */     
/* 112 */     String path = dir + "mzm.gsp.hula.confbean.SDoudouCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 139 */           SDoudouCfg _v_ = new SDoudouCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SDoudouCfg> all)
/*     */   {
/* 159 */     String path = dir + "mzm.gsp.hula.confbean.SDoudouCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 186 */           SDoudouCfg _v_ = new SDoudouCfg();
...
/*     */ 
/*     */ 
/*     */   public static SDoudouCfg getOld(int key)
/*     */   {
/* 207 */     return (SDoudouCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SDoudouCfg get(int key)
/*     */   {
/* 212 */     return (SDoudouCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SDoudouCfg> getOldAll()
/*     */   {
/* 217 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SDoudouCfg> getAll()
/*     */   {
/* 222 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SDoudouCfg> newAll)
/*     */   {
/* 227 */     oldAll = all;
/* 228 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\hula\confbean\SDoudouCfg.class
