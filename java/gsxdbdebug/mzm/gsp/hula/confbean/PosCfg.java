...
/*     */ 
/*     */ public class PosCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, PosCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, PosCfg> all = null;
/*     */   
/*     */   public int seq;
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  22 */     this.seq = Integer.valueOf(rootElement.attributeValue("seq")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  27 */     _os_.marshal(this.seq);
/*  28 */     return _os_;
/*     */   }
/*     */   
/*     */   public OctetsStream unmarshal(OctetsStream _os_) throws com.goldhuman.Common.Marshal.MarshalException
/*     */   {
/*  33 */     this.seq = _os_.unmarshal_int();
/*  34 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  39 */     String path = dir + "mzm.gsp.hula.confbean.PosCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  52 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.hula.confbean.PosCfg"))
/*     */         {
/*     */ 
/*  55 */           PosCfg obj = new PosCfg();
/*  56 */           obj.loadFromXml(elem);
/*  57 */           if (all.put(Integer.valueOf(obj.seq), obj) != null) {
/*  58 */             throw new RuntimeException("duplicate key : " + obj.seq);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, PosCfg> all)
/*     */   {
/*  69 */     String path = dir + "mzm.gsp.hula.confbean.PosCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  81 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.hula.confbean.PosCfg"))
/*     */         {
/*     */ 
/*  84 */           PosCfg obj = new PosCfg();
/*  85 */           obj.loadFromXml(elem);
/*  86 */           if (all.put(Integer.valueOf(obj.seq), obj) != null) {
/*  87 */             throw new RuntimeException("duplicate key : " + obj.seq);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 100 */     String path = dir + "mzm.gsp.hula.confbean.PosCfg.bny";
/*     */     try
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, PosCfg> all)
/*     */   {
/* 147 */     String path = dir + "mzm.gsp.hula.confbean.PosCfg.bny";
/*     */     try
/*     */     {
...
/*     */ 
/*     */ 
/*     */   public static PosCfg getOld(int key)
/*     */   {
/* 195 */     return (PosCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static PosCfg get(int key)
/*     */   {
/* 200 */     return (PosCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, PosCfg> getOldAll()
/*     */   {
/* 205 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, PosCfg> getAll()
/*     */   {
/* 210 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, PosCfg> newAll)
/*     */   {
/* 215 */     oldAll = all;
/* 216 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\hula\confbean\PosCfg.class
