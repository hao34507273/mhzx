...
/*     */ 
/*     */ public class SPointAwardCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SPointAwardCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SPointAwardCfg> all = null;
/*     */   
/*     */   public int minpoint;
/*     */   public int rewardid;
/*     */   
...
/*     */   {
/*  23 */     this.minpoint = Integer.valueOf(rootElement.attributeValue("minpoint")).intValue();
/*  24 */     this.rewardid = Integer.valueOf(rootElement.attributeValue("rewardid")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  29 */     _os_.marshal(this.minpoint);
...
/*     */   {
/*  36 */     this.minpoint = _os_.unmarshal_int();
...
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.hula.confbean.SPointAwardCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.hula.confbean.SPointAwardCfg"))
/*     */         {
/*     */ 
/*  59 */           SPointAwardCfg obj = new SPointAwardCfg();
/*  60 */           obj.loadFromXml(elem);
/*  61 */           if (all.put(Integer.valueOf(obj.minpoint), obj) != null) {
/*  62 */             throw new RuntimeException("duplicate key : " + obj.minpoint);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SPointAwardCfg> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.hula.confbean.SPointAwardCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.hula.confbean.SPointAwardCfg"))
/*     */         {
/*     */ 
/*  88 */           SPointAwardCfg obj = new SPointAwardCfg();
/*  89 */           obj.loadFromXml(elem);
/*  90 */           if (all.put(Integer.valueOf(obj.minpoint), obj) != null) {
/*  91 */             throw new RuntimeException("duplicate key : " + obj.minpoint);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.hula.confbean.SPointAwardCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           SPointAwardCfg _v_ = new SPointAwardCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SPointAwardCfg> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.hula.confbean.SPointAwardCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           SPointAwardCfg _v_ = new SPointAwardCfg();
...
/*     */ 
/*     */ 
/*     */   public static SPointAwardCfg getOld(int key)
/*     */   {
/* 199 */     return (SPointAwardCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SPointAwardCfg get(int key)
/*     */   {
/* 204 */     return (SPointAwardCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPointAwardCfg> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPointAwardCfg> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SPointAwardCfg> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\hula\confbean\SPointAwardCfg.class
