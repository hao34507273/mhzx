...
/*     */ 
/*     */ public class SQingYuanAppelationCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SQingYuanAppelationCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SQingYuanAppelationCfg> all = null;
/*     */   
/*     */   public int appelationCfgId;
/*     */   public int id;
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.appelationCfgId = Integer.valueOf(rootElement.attributeValue("appelationCfgId")).intValue();
/*  24 */     this.id = Integer.valueOf(rootElement.attributeValue("id")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  29 */     _os_.marshal(this.appelationCfgId);
...
/*     */   {
/*  36 */     this.appelationCfgId = _os_.unmarshal_int();
...
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.qingyuan.confbean.SQingYuanAppelationCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.qingyuan.confbean.SQingYuanAppelationCfg"))
/*     */         {
/*     */ 
/*  59 */           SQingYuanAppelationCfg obj = new SQingYuanAppelationCfg();
/*  60 */           obj.loadFromXml(elem);
/*  61 */           if (all.put(Integer.valueOf(obj.appelationCfgId), obj) != null) {
/*  62 */             throw new RuntimeException("duplicate key : " + obj.appelationCfgId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SQingYuanAppelationCfg> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.qingyuan.confbean.SQingYuanAppelationCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.qingyuan.confbean.SQingYuanAppelationCfg"))
/*     */         {
/*     */ 
/*  88 */           SQingYuanAppelationCfg obj = new SQingYuanAppelationCfg();
/*  89 */           obj.loadFromXml(elem);
/*  90 */           if (all.put(Integer.valueOf(obj.appelationCfgId), obj) != null) {
/*  91 */             throw new RuntimeException("duplicate key : " + obj.appelationCfgId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.qingyuan.confbean.SQingYuanAppelationCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           SQingYuanAppelationCfg _v_ = new SQingYuanAppelationCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SQingYuanAppelationCfg> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.qingyuan.confbean.SQingYuanAppelationCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           SQingYuanAppelationCfg _v_ = new SQingYuanAppelationCfg();
...
/*     */ 
/*     */ 
/*     */   public static SQingYuanAppelationCfg getOld(int key)
/*     */   {
/* 199 */     return (SQingYuanAppelationCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SQingYuanAppelationCfg get(int key)
/*     */   {
/* 204 */     return (SQingYuanAppelationCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SQingYuanAppelationCfg> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SQingYuanAppelationCfg> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SQingYuanAppelationCfg> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\qingyuan\confbean\SQingYuanAppelationCfg.class
