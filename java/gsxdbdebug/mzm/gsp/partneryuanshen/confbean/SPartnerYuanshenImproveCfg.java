...
/*     */ 
/*     */ public class SPartnerYuanshenImproveCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SPartnerYuanshenImproveCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SPartnerYuanshenImproveCfg> all = null;
/*     */   
/*     */   public int position;
/*  19 */   public HashMap<Integer, SPartnerYuanshenImproveBean> level2bean = new HashMap();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.position = Integer.valueOf(rootElement.attributeValue("position")).intValue();
/*     */     
/*  25 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "level2bean");
...
/*  51 */             keyElem = elem;
/*     */           }
/*  53 */           else if ((valueElem == null) && (elem.getName().equalsIgnoreCase("mzm.gsp.partneryuanshen.confbean.SPartnerYuanshenImproveBean")))
/*     */           {
/*  55 */             valueElem = elem;
/*     */           }
/*     */         }
...
/*     */         
/*     */         int _k_;
/*     */         SPartnerYuanshenImproveBean _v_;
/*     */         try
/*     */         {
/*  68 */           _k_ = Integer.valueOf(keyElem.getText()).intValue();
/*  69 */           _v_ = new SPartnerYuanshenImproveBean();
...
/*     */         }
/*     */         
/*  77 */         this.level2bean.put(Integer.valueOf(_k_), _v_);
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*     */   {
/*  84 */     _os_.marshal(this.position);
/*  85 */     _os_.compact_uint32(this.level2bean.size());
/*  86 */     for (java.util.Map.Entry<Integer, SPartnerYuanshenImproveBean> _e_ : this.level2bean.entrySet())
/*     */     {
...
/*     */   {
/*  96 */     this.position = _os_.unmarshal_int();
/*  97 */     for (int _size_ = _os_.uncompact_uint32(); _size_ > 0; _size_--)
/*     */     {
/*     */ 
/* 100 */       int _k_ = _os_.unmarshal_int();
/*     */       
/* 102 */       SPartnerYuanshenImproveBean _v_ = new SPartnerYuanshenImproveBean();
/* 103 */       _v_.unmarshal(_os_);
/* 104 */       this.level2bean.put(Integer.valueOf(_k_), _v_);
/*     */     }
/* 106 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/* 111 */     String path = dir + "mzm.gsp.partneryuanshen.confbean.SPartnerYuanshenImproveCfg.xml";
/*     */     
/*     */     try
/*     */     {
/* 115 */       all = new HashMap();
...
/* 124 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.partneryuanshen.confbean.SPartnerYuanshenImproveCfg"))
/*     */         {
/*     */ 
/* 127 */           SPartnerYuanshenImproveCfg obj = new SPartnerYuanshenImproveCfg();
/* 128 */           obj.loadFromXml(elem);
/* 129 */           if (all.put(Integer.valueOf(obj.position), obj) != null) {
/* 130 */             throw new RuntimeException("duplicate key : " + obj.position);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SPartnerYuanshenImproveCfg> all)
/*     */   {
/* 141 */     String path = dir + "mzm.gsp.partneryuanshen.confbean.SPartnerYuanshenImproveCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 153 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.partneryuanshen.confbean.SPartnerYuanshenImproveCfg"))
/*     */         {
/*     */ 
/* 156 */           SPartnerYuanshenImproveCfg obj = new SPartnerYuanshenImproveCfg();
/* 157 */           obj.loadFromXml(elem);
/* 158 */           if (all.put(Integer.valueOf(obj.position), obj) != null) {
/* 159 */             throw new RuntimeException("duplicate key : " + obj.position);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/* 170 */     all = new HashMap();
/*     */     
/* 172 */     String path = dir + "mzm.gsp.partneryuanshen.confbean.SPartnerYuanshenImproveCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 199 */           SPartnerYuanshenImproveCfg _v_ = new SPartnerYuanshenImproveCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SPartnerYuanshenImproveCfg> all)
/*     */   {
/* 219 */     String path = dir + "mzm.gsp.partneryuanshen.confbean.SPartnerYuanshenImproveCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 246 */           SPartnerYuanshenImproveCfg _v_ = new SPartnerYuanshenImproveCfg();
...
/*     */ 
/*     */ 
/*     */   public static SPartnerYuanshenImproveCfg getOld(int key)
/*     */   {
/* 267 */     return (SPartnerYuanshenImproveCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SPartnerYuanshenImproveCfg get(int key)
/*     */   {
/* 272 */     return (SPartnerYuanshenImproveCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPartnerYuanshenImproveCfg> getOldAll()
/*     */   {
/* 277 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPartnerYuanshenImproveCfg> getAll()
/*     */   {
/* 282 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SPartnerYuanshenImproveCfg> newAll)
/*     */   {
/* 287 */     oldAll = all;
/* 288 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\partneryuanshen\confbean\SPartnerYuanshenImproveCfg.class
