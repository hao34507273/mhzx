...
/*     */ 
/*     */ public class SPartnerYuanshenConsts
/*     */ {
/*  13 */   private static volatile SPartnerYuanshenConsts oldInstance = null;
/*     */   
/*  15 */   private static SPartnerYuanshenConsts instance = new SPartnerYuanshenConsts();
/*     */   
/*     */   public int OPEN_LEVEL;
/*     */   
/*     */   public int FIGHT_SCORE_FACTOR;
/*     */   
/*     */   public static SPartnerYuanshenConsts getOldInstance()
/*     */   {
/*  23 */     return oldInstance;
/*     */   }
/*     */   
/*     */   public static SPartnerYuanshenConsts getInstance()
/*     */   {
/*  28 */     return instance;
/*     */   }
/*     */   
...
/*     */   {
/*  41 */     String path = dir + "mzm.gsp.partneryuanshen.confbean.SPartnerYuanshenConsts.xml";
/*     */     try
/*     */     {
...
/*  62 */       this.FIGHT_SCORE_FACTOR = Integer.valueOf(((Element)data.get("FIGHT_SCORE_FACTOR")).attributeValue("value")).intValue();
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*  71 */     String path = dir + "mzm.gsp.partneryuanshen.confbean.SPartnerYuanshenConsts.xml";
/*     */     try
/*     */     {
...
/*  92 */       this.FIGHT_SCORE_FACTOR = Integer.valueOf(((Element)data.get("FIGHT_SCORE_FACTOR")).attributeValue("value")).intValue();
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/* 103 */     String path = dir + "mzm.gsp.partneryuanshen.confbean.SPartnerYuanshenConsts.bny";
/*     */     try
/*     */     {
...
/* 119 */         this.FIGHT_SCORE_FACTOR = _os_.unmarshal_int();
/*     */       }
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*     */   {
/* 130 */     String path = dir + "mzm.gsp.partneryuanshen.confbean.SPartnerYuanshenConsts.bny";
/*     */     try
/*     */     {
...
/* 146 */         this.FIGHT_SCORE_FACTOR = _os_.unmarshal_int();
/*     */       }
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*     */   }
/*     */   
/*     */   public static void setInstance(SPartnerYuanshenConsts newInstance)
/*     */   {
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\partneryuanshen\confbean\SPartnerYuanshenConsts.class
