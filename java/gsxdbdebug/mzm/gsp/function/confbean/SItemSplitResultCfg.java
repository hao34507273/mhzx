...
/*     */ 
/*     */ public class SItemSplitResultCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SItemSplitResultCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SItemSplitResultCfg> all = null;
/*     */   
/*     */   public int id;
/*  19 */   public ArrayList<Integer> itemIds = new ArrayList();
/*  20 */   public ArrayList<Integer> itemNums = new ArrayList();
/*  21 */   public ArrayList<Boolean> bindItems = new ArrayList();
/*  22 */   public ArrayList<Integer> accumulatedWeights = new ArrayList();
/*     */   
...
/*     */     }
/*     */     
/*  86 */     Element collectionElement = util.XmlHelper.getVariableElement(rootElement, "bindItems");
...
/*  97 */       if (elem.getName().equalsIgnoreCase("boolean"))
/*     */       {
/*     */         boolean _v_;
/*     */         
/*     */ 
/*     */         try
/*     */         {
/* 104 */           _v_ = Boolean.valueOf(elem.getText()).booleanValue();
/*     */         }
/*     */         catch (Exception e)
/*     */         {
/*     */           continue;
/*     */         }
/*     */         
/* 111 */         this.bindItems.add(Boolean.valueOf(_v_));
/*     */       }
/*     */     }
/*     */     
/* 115 */     Element collectionElement = util.XmlHelper.getVariableElement(rootElement, "accumulatedWeights");
...
/*     */         }
/*     */         
/* 140 */         this.accumulatedWeights.add(Integer.valueOf(_v_));
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 158 */     _os_.compact_uint32(this.bindItems.size());
/* 159 */     for (Boolean _v_ : this.bindItems)
/*     */     {
/* 161 */       _os_.marshal(_v_.booleanValue());
/*     */     }
/* 163 */     _os_.compact_uint32(this.accumulatedWeights.size());
/* 164 */     for (Integer _v_ : this.accumulatedWeights)
/*     */     {
...
/*     */     {
/*     */ 
/* 189 */       boolean _v_ = _os_.unmarshal_boolean();
/* 190 */       this.bindItems.add(Boolean.valueOf(_v_));
/*     */     }
/* 192 */     for (int _size_ = _os_.uncompact_uint32(); _size_ > 0; _size_--)
/*     */     {
/*     */ 
/* 195 */       int _v_ = _os_.unmarshal_int();
/* 196 */       this.accumulatedWeights.add(Integer.valueOf(_v_));
/*     */     }
/* 198 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/* 203 */     String path = dir + "mzm.gsp.function.confbean.SItemSplitResultCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 216 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.function.confbean.SItemSplitResultCfg"))
/*     */         {
/*     */ 
/* 219 */           SItemSplitResultCfg obj = new SItemSplitResultCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SItemSplitResultCfg> all)
/*     */   {
/* 233 */     String path = dir + "mzm.gsp.function.confbean.SItemSplitResultCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 245 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.function.confbean.SItemSplitResultCfg"))
/*     */         {
/*     */ 
/* 248 */           SItemSplitResultCfg obj = new SItemSplitResultCfg();
...
/*     */     
/* 264 */     String path = dir + "mzm.gsp.function.confbean.SItemSplitResultCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 291 */           SItemSplitResultCfg _v_ = new SItemSplitResultCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SItemSplitResultCfg> all)
/*     */   {
/* 311 */     String path = dir + "mzm.gsp.function.confbean.SItemSplitResultCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 338 */           SItemSplitResultCfg _v_ = new SItemSplitResultCfg();
...
/*     */ 
/*     */ 
/*     */   public static SItemSplitResultCfg getOld(int key)
/*     */   {
/* 359 */     return (SItemSplitResultCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SItemSplitResultCfg get(int key)
/*     */   {
/* 364 */     return (SItemSplitResultCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SItemSplitResultCfg> getOldAll()
/*     */   {
/* 369 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SItemSplitResultCfg> getAll()
/*     */   {
/* 374 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SItemSplitResultCfg> newAll)
/*     */   {
/* 379 */     oldAll = all;
/* 380 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\function\confbean\SItemSplitResultCfg.class
