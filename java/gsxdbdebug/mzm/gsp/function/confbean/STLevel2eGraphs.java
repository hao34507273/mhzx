...
/*     */ 
/*     */ public class STLevel2eGraphs implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, STLevel2eGraphs> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, STLevel2eGraphs> all = null;
/*     */   
/*     */   public int level;
/*  19 */   public java.util.ArrayList<Integer> graphIds = new java.util.ArrayList();
/*     */   
...
/*     */   {
/*  68 */     this.level = _os_.unmarshal_int();
...
/*     */   {
/*  80 */     String path = dir + "mzm.gsp.function.confbean.STLevel2eGraphs.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.function.confbean.STLevel2eGraphs"))
/*     */         {
/*     */ 
/*  96 */           STLevel2eGraphs obj = new STLevel2eGraphs();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, STLevel2eGraphs> all)
/*     */   {
/* 110 */     String path = dir + "mzm.gsp.function.confbean.STLevel2eGraphs.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 122 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.function.confbean.STLevel2eGraphs"))
/*     */         {
/*     */ 
/* 125 */           STLevel2eGraphs obj = new STLevel2eGraphs();
...
/*     */     
/* 141 */     String path = dir + "mzm.gsp.function.confbean.STLevel2eGraphs.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 168 */           STLevel2eGraphs _v_ = new STLevel2eGraphs();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, STLevel2eGraphs> all)
/*     */   {
/* 188 */     String path = dir + "mzm.gsp.function.confbean.STLevel2eGraphs.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 215 */           STLevel2eGraphs _v_ = new STLevel2eGraphs();
...
/*     */ 
/*     */ 
/*     */   public static STLevel2eGraphs getOld(int key)
/*     */   {
/* 236 */     return (STLevel2eGraphs)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static STLevel2eGraphs get(int key)
/*     */   {
/* 241 */     return (STLevel2eGraphs)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, STLevel2eGraphs> getOldAll()
/*     */   {
/* 246 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, STLevel2eGraphs> getAll()
/*     */   {
/* 251 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, STLevel2eGraphs> newAll)
/*     */   {
/* 256 */     oldAll = all;
/* 257 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\function\confbean\STLevel2eGraphs.class
