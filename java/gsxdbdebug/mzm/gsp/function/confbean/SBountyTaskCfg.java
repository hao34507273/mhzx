...
/*     */ 
/*     */ public class SBountyTaskCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SBountyTaskCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SBountyTaskCfg> all = null;
/*     */   
/*     */   public int taskId;
/*     */   public int id;
/*     */   public int rank;
...
/*     */   {
/*  25 */     this.taskId = Integer.valueOf(rootElement.attributeValue("taskId")).intValue();
...
/*  28 */     this.tipStr = rootElement.attributeValue("tipStr");
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  33 */     _os_.marshal(this.taskId);
/*  34 */     _os_.marshal(this.id);
/*  35 */     _os_.marshal(this.rank);
/*  36 */     _os_.marshal(this.tipStr, "UTF-8");
/*  37 */     return _os_;
/*     */   }
/*     */   
/*     */   public OctetsStream unmarshal(OctetsStream _os_) throws com.goldhuman.Common.Marshal.MarshalException
/*     */   {
/*  42 */     this.taskId = _os_.unmarshal_int();
/*  43 */     this.id = _os_.unmarshal_int();
/*  44 */     this.rank = _os_.unmarshal_int();
/*  45 */     this.tipStr = _os_.unmarshal_String("UTF-8");
/*  46 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  51 */     String path = dir + "mzm.gsp.function.confbean.SBountyTaskCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  64 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.function.confbean.SBountyTaskCfg"))
/*     */         {
/*     */ 
/*  67 */           SBountyTaskCfg obj = new SBountyTaskCfg();
/*  68 */           obj.loadFromXml(elem);
/*  69 */           if (all.put(Integer.valueOf(obj.taskId), obj) != null) {
/*  70 */             throw new RuntimeException("duplicate key : " + obj.taskId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SBountyTaskCfg> all)
/*     */   {
/*  81 */     String path = dir + "mzm.gsp.function.confbean.SBountyTaskCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.function.confbean.SBountyTaskCfg"))
/*     */         {
/*     */ 
/*  96 */           SBountyTaskCfg obj = new SBountyTaskCfg();
/*  97 */           obj.loadFromXml(elem);
/*  98 */           if (all.put(Integer.valueOf(obj.taskId), obj) != null) {
/*  99 */             throw new RuntimeException("duplicate key : " + obj.taskId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 112 */     String path = dir + "mzm.gsp.function.confbean.SBountyTaskCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 139 */           SBountyTaskCfg _v_ = new SBountyTaskCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SBountyTaskCfg> all)
/*     */   {
/* 159 */     String path = dir + "mzm.gsp.function.confbean.SBountyTaskCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 186 */           SBountyTaskCfg _v_ = new SBountyTaskCfg();
...
/*     */ 
/*     */ 
/*     */   public static SBountyTaskCfg getOld(int key)
/*     */   {
/* 207 */     return (SBountyTaskCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SBountyTaskCfg get(int key)
/*     */   {
/* 212 */     return (SBountyTaskCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SBountyTaskCfg> getOldAll()
/*     */   {
/* 217 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SBountyTaskCfg> getAll()
/*     */   {
/* 222 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SBountyTaskCfg> newAll)
/*     */   {
/* 227 */     oldAll = all;
/* 228 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\function\confbean\SBountyTaskCfg.class
