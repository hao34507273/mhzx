...
/*     */ 
/*     */ public class STMakeUpQuestionCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, STMakeUpQuestionCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, STMakeUpQuestionCfg> all = null;
/*     */   
/*     */   public int activityId;
/*  19 */   public HashMap<Integer, Integer> questionInfos = new HashMap();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.activityId = Integer.valueOf(rootElement.attributeValue("activityId")).intValue();
/*     */     
/*  25 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "questionInfos");
...
/*     */         }
/*     */         
/*  76 */         this.questionInfos.put(Integer.valueOf(_k_), Integer.valueOf(_v_));
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*  84 */     _os_.compact_uint32(this.questionInfos.size());
/*  85 */     for (java.util.Map.Entry<Integer, Integer> _e_ : this.questionInfos.entrySet())
/*     */     {
...
/* 102 */       this.questionInfos.put(Integer.valueOf(_k_), Integer.valueOf(_v_));
/*     */     }
/* 104 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/* 109 */     String path = dir + "mzm.gsp.activity4.confbean.STMakeUpQuestionCfg.xml";
/*     */     
/*     */     try
/*     */     {
/* 113 */       all = new HashMap();
...
/* 122 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity4.confbean.STMakeUpQuestionCfg"))
/*     */         {
/*     */ 
/* 125 */           STMakeUpQuestionCfg obj = new STMakeUpQuestionCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, STMakeUpQuestionCfg> all)
/*     */   {
/* 139 */     String path = dir + "mzm.gsp.activity4.confbean.STMakeUpQuestionCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 151 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity4.confbean.STMakeUpQuestionCfg"))
/*     */         {
/*     */ 
/* 154 */           STMakeUpQuestionCfg obj = new STMakeUpQuestionCfg();
...
/* 168 */     all = new HashMap();
/*     */     
/* 170 */     String path = dir + "mzm.gsp.activity4.confbean.STMakeUpQuestionCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 197 */           STMakeUpQuestionCfg _v_ = new STMakeUpQuestionCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, STMakeUpQuestionCfg> all)
/*     */   {
/* 217 */     String path = dir + "mzm.gsp.activity4.confbean.STMakeUpQuestionCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 244 */           STMakeUpQuestionCfg _v_ = new STMakeUpQuestionCfg();
...
/*     */ 
/*     */ 
/*     */   public static STMakeUpQuestionCfg getOld(int key)
/*     */   {
/* 265 */     return (STMakeUpQuestionCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static STMakeUpQuestionCfg get(int key)
/*     */   {
/* 270 */     return (STMakeUpQuestionCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, STMakeUpQuestionCfg> getOldAll()
/*     */   {
/* 275 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, STMakeUpQuestionCfg> getAll()
/*     */   {
/* 280 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, STMakeUpQuestionCfg> newAll)
/*     */   {
/* 285 */     oldAll = all;
/* 286 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\activity4\confbean\STMakeUpQuestionCfg.class
