...
/*     */ 
/*     */ public class SFlowerParadeOcpGroupCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SFlowerParadeOcpGroupCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SFlowerParadeOcpGroupCfg> all = null;
/*     */   
/*     */   public int groupId;
/*  19 */   public HashMap<Integer, SFlowerParadeOcpCfg> ocpPradCfg = new HashMap();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.groupId = Integer.valueOf(rootElement.attributeValue("groupId")).intValue();
/*     */     
/*  25 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "ocpPradCfg");
...
/*  51 */             keyElem = elem;
/*     */           }
/*  53 */           else if ((valueElem == null) && (elem.getName().equalsIgnoreCase("mzm.gsp.activity4.confbean.SFlowerParadeOcpCfg")))
/*     */           {
/*  55 */             valueElem = elem;
/*     */           }
/*     */         }
...
/*     */         
/*     */         int _k_;
/*     */         SFlowerParadeOcpCfg _v_;
/*     */         try
/*     */         {
/*  68 */           _k_ = Integer.valueOf(keyElem.getText()).intValue();
/*  69 */           _v_ = new SFlowerParadeOcpCfg();
...
/*     */         }
/*     */         
/*  77 */         this.ocpPradCfg.put(Integer.valueOf(_k_), _v_);
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*  85 */     _os_.compact_uint32(this.ocpPradCfg.size());
/*  86 */     for (java.util.Map.Entry<Integer, SFlowerParadeOcpCfg> _e_ : this.ocpPradCfg.entrySet())
/*     */     {
...
/*     */       
/* 102 */       SFlowerParadeOcpCfg _v_ = new SFlowerParadeOcpCfg();
/* 103 */       _v_.unmarshal(_os_);
/* 104 */       this.ocpPradCfg.put(Integer.valueOf(_k_), _v_);
/*     */     }
/* 106 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/* 111 */     String path = dir + "mzm.gsp.activity4.confbean.SFlowerParadeOcpGroupCfg.xml";
/*     */     
/*     */     try
/*     */     {
/* 115 */       all = new HashMap();
...
/* 124 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity4.confbean.SFlowerParadeOcpGroupCfg"))
/*     */         {
/*     */ 
/* 127 */           SFlowerParadeOcpGroupCfg obj = new SFlowerParadeOcpGroupCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SFlowerParadeOcpGroupCfg> all)
/*     */   {
/* 141 */     String path = dir + "mzm.gsp.activity4.confbean.SFlowerParadeOcpGroupCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 153 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity4.confbean.SFlowerParadeOcpGroupCfg"))
/*     */         {
/*     */ 
/* 156 */           SFlowerParadeOcpGroupCfg obj = new SFlowerParadeOcpGroupCfg();
...
/* 170 */     all = new HashMap();
/*     */     
/* 172 */     String path = dir + "mzm.gsp.activity4.confbean.SFlowerParadeOcpGroupCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 199 */           SFlowerParadeOcpGroupCfg _v_ = new SFlowerParadeOcpGroupCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SFlowerParadeOcpGroupCfg> all)
/*     */   {
/* 219 */     String path = dir + "mzm.gsp.activity4.confbean.SFlowerParadeOcpGroupCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 246 */           SFlowerParadeOcpGroupCfg _v_ = new SFlowerParadeOcpGroupCfg();
...
/*     */ 
/*     */ 
/*     */   public static SFlowerParadeOcpGroupCfg getOld(int key)
/*     */   {
/* 267 */     return (SFlowerParadeOcpGroupCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SFlowerParadeOcpGroupCfg get(int key)
/*     */   {
/* 272 */     return (SFlowerParadeOcpGroupCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SFlowerParadeOcpGroupCfg> getOldAll()
/*     */   {
/* 277 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SFlowerParadeOcpGroupCfg> getAll()
/*     */   {
/* 282 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SFlowerParadeOcpGroupCfg> newAll)
/*     */   {
/* 287 */     oldAll = all;
/* 288 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\activity4\confbean\SFlowerParadeOcpGroupCfg.class
