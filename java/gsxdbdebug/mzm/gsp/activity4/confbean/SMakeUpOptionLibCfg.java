...
/*     */ 
/*     */ public class SMakeUpOptionLibCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SMakeUpOptionLibCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SMakeUpOptionLibCfg> all = null;
/*     */   
/*     */   public int id;
...
/*  25 */     this.questionLibId = Integer.valueOf(rootElement.attributeValue("questionLibId")).intValue();
/*  26 */     this.questionCfgId = Integer.valueOf(rootElement.attributeValue("questionCfgId")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  31 */     _os_.marshal(this.id);
/*  32 */     _os_.marshal(this.questionLibId);
/*  33 */     _os_.marshal(this.questionCfgId);
/*  34 */     return _os_;
/*     */   }
/*     */   
...
/*  40 */     this.questionLibId = _os_.unmarshal_int();
/*  41 */     this.questionCfgId = _os_.unmarshal_int();
/*  42 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  47 */     String path = dir + "mzm.gsp.activity4.confbean.SMakeUpOptionLibCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  60 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity4.confbean.SMakeUpOptionLibCfg"))
/*     */         {
/*     */ 
/*  63 */           SMakeUpOptionLibCfg obj = new SMakeUpOptionLibCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SMakeUpOptionLibCfg> all)
/*     */   {
/*  77 */     String path = dir + "mzm.gsp.activity4.confbean.SMakeUpOptionLibCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  89 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity4.confbean.SMakeUpOptionLibCfg"))
/*     */         {
/*     */ 
/*  92 */           SMakeUpOptionLibCfg obj = new SMakeUpOptionLibCfg();
...
/*     */     
/* 108 */     String path = dir + "mzm.gsp.activity4.confbean.SMakeUpOptionLibCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 135 */           SMakeUpOptionLibCfg _v_ = new SMakeUpOptionLibCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SMakeUpOptionLibCfg> all)
/*     */   {
/* 155 */     String path = dir + "mzm.gsp.activity4.confbean.SMakeUpOptionLibCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 182 */           SMakeUpOptionLibCfg _v_ = new SMakeUpOptionLibCfg();
...
/*     */ 
/*     */ 
/*     */   public static SMakeUpOptionLibCfg getOld(int key)
/*     */   {
/* 203 */     return (SMakeUpOptionLibCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SMakeUpOptionLibCfg get(int key)
/*     */   {
/* 208 */     return (SMakeUpOptionLibCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMakeUpOptionLibCfg> getOldAll()
/*     */   {
/* 213 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMakeUpOptionLibCfg> getAll()
/*     */   {
/* 218 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SMakeUpOptionLibCfg> newAll)
/*     */   {
/* 223 */     oldAll = all;
/* 224 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\activity4\confbean\SMakeUpOptionLibCfg.class
