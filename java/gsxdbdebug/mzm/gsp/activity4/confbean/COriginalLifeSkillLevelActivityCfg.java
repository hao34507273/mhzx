...
/*     */ 
/*     */ public class COriginalLifeSkillLevelActivityCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, COriginalLifeSkillLevelActivityCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, COriginalLifeSkillLevelActivityCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public int activityId;
/*     */   public int lifeSkillLevel;
/*  21 */   public java.util.LinkedList<Integer> showItemList = new java.util.LinkedList();
/*     */   
...
/*  27 */     this.lifeSkillLevel = Integer.valueOf(rootElement.attributeValue("lifeSkillLevel")).intValue();
/*     */     
/*  29 */     Element collectionElement = util.XmlHelper.getVariableElement(rootElement, "showItemList");
...
/*     */         }
/*     */         
/*  54 */         this.showItemList.add(Integer.valueOf(_v_));
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*  63 */     _os_.marshal(this.lifeSkillLevel);
/*  64 */     _os_.compact_uint32(this.showItemList.size());
/*  65 */     for (Integer _v_ : this.showItemList)
/*     */     {
...
/*  75 */     this.activityId = _os_.unmarshal_int();
/*  76 */     this.lifeSkillLevel = _os_.unmarshal_int();
/*  77 */     for (int _size_ = _os_.uncompact_uint32(); _size_ > 0; _size_--)
/*     */     {
/*     */ 
/*  80 */       int _v_ = _os_.unmarshal_int();
/*  81 */       this.showItemList.add(Integer.valueOf(_v_));
/*     */     }
/*  83 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/*  88 */     String path = dir + "mzm.gsp.activity4.confbean.COriginalLifeSkillLevelActivityCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 101 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity4.confbean.COriginalLifeSkillLevelActivityCfg"))
/*     */         {
/*     */ 
/* 104 */           COriginalLifeSkillLevelActivityCfg obj = new COriginalLifeSkillLevelActivityCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, COriginalLifeSkillLevelActivityCfg> all)
/*     */   {
/* 118 */     String path = dir + "mzm.gsp.activity4.confbean.COriginalLifeSkillLevelActivityCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 130 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity4.confbean.COriginalLifeSkillLevelActivityCfg"))
/*     */         {
/*     */ 
/* 133 */           COriginalLifeSkillLevelActivityCfg obj = new COriginalLifeSkillLevelActivityCfg();
...
/*     */     
/* 149 */     String path = dir + "mzm.gsp.activity4.confbean.COriginalLifeSkillLevelActivityCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 176 */           COriginalLifeSkillLevelActivityCfg _v_ = new COriginalLifeSkillLevelActivityCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, COriginalLifeSkillLevelActivityCfg> all)
/*     */   {
/* 196 */     String path = dir + "mzm.gsp.activity4.confbean.COriginalLifeSkillLevelActivityCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 223 */           COriginalLifeSkillLevelActivityCfg _v_ = new COriginalLifeSkillLevelActivityCfg();
...
/*     */ 
/*     */ 
/*     */   public static COriginalLifeSkillLevelActivityCfg getOld(int key)
/*     */   {
/* 244 */     return (COriginalLifeSkillLevelActivityCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static COriginalLifeSkillLevelActivityCfg get(int key)
/*     */   {
/* 249 */     return (COriginalLifeSkillLevelActivityCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, COriginalLifeSkillLevelActivityCfg> getOldAll()
/*     */   {
/* 254 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, COriginalLifeSkillLevelActivityCfg> getAll()
/*     */   {
/* 259 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, COriginalLifeSkillLevelActivityCfg> newAll)
/*     */   {
/* 264 */     oldAll = all;
/* 265 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\activity4\confbean\COriginalLifeSkillLevelActivityCfg.class
