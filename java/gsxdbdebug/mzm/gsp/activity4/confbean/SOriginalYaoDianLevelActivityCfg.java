...
/*     */ 
/*     */ public class SOriginalYaoDianLevelActivityCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SOriginalYaoDianLevelActivityCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SOriginalYaoDianLevelActivityCfg> all = null;
/*     */   
/*     */   public int id;
...
/*  30 */     this.yaodianLevel = Integer.valueOf(rootElement.attributeValue("yaodianLevel")).intValue();
/*  31 */     this.costType = Integer.valueOf(rootElement.attributeValue("costType")).intValue();
/*  32 */     this.costNum = Integer.valueOf(rootElement.attributeValue("costNum")).intValue();
/*  33 */     this.lifeSkillId = Integer.valueOf(rootElement.attributeValue("lifeSkillId")).intValue();
/*  34 */     this.maxNum = Integer.valueOf(rootElement.attributeValue("maxNum")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  39 */     _os_.marshal(this.id);
/*  40 */     _os_.marshal(this.activityId);
/*  41 */     _os_.marshal(this.yaodianLevel);
/*  42 */     _os_.marshal(this.costType);
/*  43 */     _os_.marshal(this.costNum);
/*  44 */     _os_.marshal(this.lifeSkillId);
...
/*  53 */     this.yaodianLevel = _os_.unmarshal_int();
/*  54 */     this.costType = _os_.unmarshal_int();
/*  55 */     this.costNum = _os_.unmarshal_int();
/*  56 */     this.lifeSkillId = _os_.unmarshal_int();
/*  57 */     this.maxNum = _os_.unmarshal_int();
/*  58 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  63 */     String path = dir + "mzm.gsp.activity4.confbean.SOriginalYaoDianLevelActivityCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  76 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity4.confbean.SOriginalYaoDianLevelActivityCfg"))
/*     */         {
/*     */ 
/*  79 */           SOriginalYaoDianLevelActivityCfg obj = new SOriginalYaoDianLevelActivityCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SOriginalYaoDianLevelActivityCfg> all)
/*     */   {
/*  93 */     String path = dir + "mzm.gsp.activity4.confbean.SOriginalYaoDianLevelActivityCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 105 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity4.confbean.SOriginalYaoDianLevelActivityCfg"))
/*     */         {
/*     */ 
/* 108 */           SOriginalYaoDianLevelActivityCfg obj = new SOriginalYaoDianLevelActivityCfg();
...
/*     */     
/* 124 */     String path = dir + "mzm.gsp.activity4.confbean.SOriginalYaoDianLevelActivityCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 151 */           SOriginalYaoDianLevelActivityCfg _v_ = new SOriginalYaoDianLevelActivityCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SOriginalYaoDianLevelActivityCfg> all)
/*     */   {
/* 171 */     String path = dir + "mzm.gsp.activity4.confbean.SOriginalYaoDianLevelActivityCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 198 */           SOriginalYaoDianLevelActivityCfg _v_ = new SOriginalYaoDianLevelActivityCfg();
...
/*     */ 
/*     */ 
/*     */   public static SOriginalYaoDianLevelActivityCfg getOld(int key)
/*     */   {
/* 219 */     return (SOriginalYaoDianLevelActivityCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SOriginalYaoDianLevelActivityCfg get(int key)
/*     */   {
/* 224 */     return (SOriginalYaoDianLevelActivityCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SOriginalYaoDianLevelActivityCfg> getOldAll()
/*     */   {
/* 229 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SOriginalYaoDianLevelActivityCfg> getAll()
/*     */   {
/* 234 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SOriginalYaoDianLevelActivityCfg> newAll)
/*     */   {
/* 239 */     oldAll = all;
/* 240 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\activity4\confbean\SOriginalYaoDianLevelActivityCfg.class
