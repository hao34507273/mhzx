...
/*     */ 
/*     */ public class SMakeUpQuestionCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SMakeUpQuestionCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SMakeUpQuestionCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public int answerId;
/*     */   
...
/*  24 */     this.answerId = Integer.valueOf(rootElement.attributeValue("answerId")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  29 */     _os_.marshal(this.id);
/*  30 */     _os_.marshal(this.answerId);
/*  31 */     return _os_;
/*     */   }
/*     */   
...
/*  37 */     this.answerId = _os_.unmarshal_int();
/*  38 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.activity4.confbean.SMakeUpQuestionCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity4.confbean.SMakeUpQuestionCfg"))
/*     */         {
/*     */ 
/*  59 */           SMakeUpQuestionCfg obj = new SMakeUpQuestionCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SMakeUpQuestionCfg> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.activity4.confbean.SMakeUpQuestionCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity4.confbean.SMakeUpQuestionCfg"))
/*     */         {
/*     */ 
/*  88 */           SMakeUpQuestionCfg obj = new SMakeUpQuestionCfg();
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.activity4.confbean.SMakeUpQuestionCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           SMakeUpQuestionCfg _v_ = new SMakeUpQuestionCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SMakeUpQuestionCfg> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.activity4.confbean.SMakeUpQuestionCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           SMakeUpQuestionCfg _v_ = new SMakeUpQuestionCfg();
...
/*     */ 
/*     */ 
/*     */   public static SMakeUpQuestionCfg getOld(int key)
/*     */   {
/* 199 */     return (SMakeUpQuestionCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SMakeUpQuestionCfg get(int key)
/*     */   {
/* 204 */     return (SMakeUpQuestionCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMakeUpQuestionCfg> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMakeUpQuestionCfg> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SMakeUpQuestionCfg> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\activity4\confbean\SMakeUpQuestionCfg.class
