...
/*     */ 
/*     */ public class SOriginalBandstandMusicCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SOriginalBandstandMusicCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SOriginalBandstandMusicCfg> all = null;
/*     */   
/*     */   public int id;
...
/*  27 */     this.musicName = rootElement.attributeValue("musicName");
/*  28 */     this.singerName = rootElement.attributeValue("singerName");
/*  29 */     this.albumName = rootElement.attributeValue("albumName");
/*  30 */     this.fragmentTypeId = Integer.valueOf(rootElement.attributeValue("fragmentTypeId")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  35 */     _os_.marshal(this.id);
/*  36 */     _os_.marshal(this.musicName, "UTF-8");
/*  37 */     _os_.marshal(this.singerName, "UTF-8");
/*  38 */     _os_.marshal(this.albumName, "UTF-8");
/*  39 */     _os_.marshal(this.fragmentTypeId);
/*  40 */     return _os_;
/*     */   }
/*     */   
...
/*  46 */     this.musicName = _os_.unmarshal_String("UTF-8");
/*  47 */     this.singerName = _os_.unmarshal_String("UTF-8");
/*  48 */     this.albumName = _os_.unmarshal_String("UTF-8");
/*  49 */     this.fragmentTypeId = _os_.unmarshal_int();
/*  50 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  55 */     String path = dir + "mzm.gsp.activity4.confbean.SOriginalBandstandMusicCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  68 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity4.confbean.SOriginalBandstandMusicCfg"))
/*     */         {
/*     */ 
/*  71 */           SOriginalBandstandMusicCfg obj = new SOriginalBandstandMusicCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SOriginalBandstandMusicCfg> all)
/*     */   {
/*  85 */     String path = dir + "mzm.gsp.activity4.confbean.SOriginalBandstandMusicCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  97 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity4.confbean.SOriginalBandstandMusicCfg"))
/*     */         {
/*     */ 
/* 100 */           SOriginalBandstandMusicCfg obj = new SOriginalBandstandMusicCfg();
...
/*     */     
/* 116 */     String path = dir + "mzm.gsp.activity4.confbean.SOriginalBandstandMusicCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 143 */           SOriginalBandstandMusicCfg _v_ = new SOriginalBandstandMusicCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SOriginalBandstandMusicCfg> all)
/*     */   {
/* 163 */     String path = dir + "mzm.gsp.activity4.confbean.SOriginalBandstandMusicCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 190 */           SOriginalBandstandMusicCfg _v_ = new SOriginalBandstandMusicCfg();
...
/*     */ 
/*     */ 
/*     */   public static SOriginalBandstandMusicCfg getOld(int key)
/*     */   {
/* 211 */     return (SOriginalBandstandMusicCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SOriginalBandstandMusicCfg get(int key)
/*     */   {
/* 216 */     return (SOriginalBandstandMusicCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SOriginalBandstandMusicCfg> getOldAll()
/*     */   {
/* 221 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SOriginalBandstandMusicCfg> getAll()
/*     */   {
/* 226 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SOriginalBandstandMusicCfg> newAll)
/*     */   {
/* 231 */     oldAll = all;
/* 232 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\activity4\confbean\SOriginalBandstandMusicCfg.class
