...
/*     */ 
/*     */ public class MakeUpConsts
/*     */ {
/*  13 */   private static volatile MakeUpConsts oldInstance = null;
/*     */   
/*  15 */   private static MakeUpConsts instance = new MakeUpConsts();
/*     */   
/*     */ 
/*     */   public int ACTIVITY_ID;
/*     */   
/*     */ 
/*     */   public static MakeUpConsts getOldInstance()
/*     */   {
/*  23 */     return oldInstance;
/*     */   }
/*     */   
/*     */   public static MakeUpConsts getInstance()
/*     */   {
/*  28 */     return instance;
/*     */   }
/*     */   
...
/*     */   {
/*  40 */     String path = dir + "mzm.gsp.activity4.confbean.MakeUpConsts.xml";
/*     */     try
/*     */     {
...
/*     */         }
/*     */       }
/*  60 */       this.ACTIVITY_ID = Integer.valueOf(((Element)data.get("ACTIVITY_ID")).attributeValue("value")).intValue();
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*  69 */     String path = dir + "mzm.gsp.activity4.confbean.MakeUpConsts.xml";
/*     */     try
/*     */     {
...
/*     */         }
/*     */       }
/*  89 */       this.ACTIVITY_ID = Integer.valueOf(((Element)data.get("ACTIVITY_ID")).attributeValue("value")).intValue();
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/* 100 */     String path = dir + "mzm.gsp.activity4.confbean.MakeUpConsts.bny";
/*     */     try
/*     */     {
...
/* 115 */         this.ACTIVITY_ID = _os_.unmarshal_int();
/*     */       }
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*     */   {
/* 126 */     String path = dir + "mzm.gsp.activity4.confbean.MakeUpConsts.bny";
/*     */     try
/*     */     {
...
/* 141 */         this.ACTIVITY_ID = _os_.unmarshal_int();
/*     */       }
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*     */   }
/*     */   
/*     */   public static void setInstance(MakeUpConsts newInstance)
/*     */   {
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\activity4\confbean\MakeUpConsts.class
