...
/*     */ 
/*     */ public class BandstandConsts
/*     */ {
/*  13 */   private static volatile BandstandConsts oldInstance = null;
/*     */   
/*  15 */   private static BandstandConsts instance = new BandstandConsts();
/*     */   
/*     */   public int EXIT_LOOP_NUM;
/*     */   
/*     */   public int WORD_SWITCH_INTERVAL;
/*     */   
/*     */   public static BandstandConsts getOldInstance()
/*     */   {
/*  23 */     return oldInstance;
/*     */   }
/*     */   
/*     */   public static BandstandConsts getInstance()
/*     */   {
/*  28 */     return instance;
/*     */   }
/*     */   
...
/*     */   {
/*  41 */     String path = dir + "mzm.gsp.activity4.confbean.BandstandConsts.xml";
/*     */     try
/*     */     {
...
/*     */         }
/*     */       }
/*  61 */       this.EXIT_LOOP_NUM = Integer.valueOf(((Element)data.get("EXIT_LOOP_NUM")).attributeValue("value")).intValue();
/*  62 */       this.WORD_SWITCH_INTERVAL = Integer.valueOf(((Element)data.get("WORD_SWITCH_INTERVAL")).attributeValue("value")).intValue();
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*  71 */     String path = dir + "mzm.gsp.activity4.confbean.BandstandConsts.xml";
/*     */     try
/*     */     {
...
/*     */         }
/*     */       }
/*  91 */       this.EXIT_LOOP_NUM = Integer.valueOf(((Element)data.get("EXIT_LOOP_NUM")).attributeValue("value")).intValue();
/*  92 */       this.WORD_SWITCH_INTERVAL = Integer.valueOf(((Element)data.get("WORD_SWITCH_INTERVAL")).attributeValue("value")).intValue();
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/* 103 */     String path = dir + "mzm.gsp.activity4.confbean.BandstandConsts.bny";
/*     */     try
/*     */     {
...
/* 118 */         this.EXIT_LOOP_NUM = _os_.unmarshal_int();
/* 119 */         this.WORD_SWITCH_INTERVAL = _os_.unmarshal_int();
/*     */       }
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*     */   {
/* 130 */     String path = dir + "mzm.gsp.activity4.confbean.BandstandConsts.bny";
/*     */     try
/*     */     {
...
/* 145 */         this.EXIT_LOOP_NUM = _os_.unmarshal_int();
/* 146 */         this.WORD_SWITCH_INTERVAL = _os_.unmarshal_int();
/*     */       }
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*     */   }
/*     */   
/*     */   public static void setInstance(BandstandConsts newInstance)
/*     */   {
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\activity4\confbean\BandstandConsts.class
