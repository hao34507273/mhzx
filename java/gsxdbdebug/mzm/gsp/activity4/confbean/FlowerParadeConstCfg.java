...
/*     */ 
/*     */ public class FlowerParadeConstCfg
/*     */ {
/*  13 */   private static volatile FlowerParadeConstCfg oldInstance = null;
/*     */   
/*  15 */   private static FlowerParadeConstCfg instance = new FlowerParadeConstCfg();
/*     */   
/*     */   public int activityId;
/*     */   public int maleId;
/*     */   public int femaleId;
/*     */   
/*     */   public static FlowerParadeConstCfg getOldInstance()
/*     */   {
/*  23 */     return oldInstance;
/*     */   }
/*     */   
/*     */   public static FlowerParadeConstCfg getInstance()
/*     */   {
/*  28 */     return instance;
/*     */   }
/*     */   
...
/*     */   {
/*  42 */     String path = dir + "mzm.gsp.activity4.confbean.FlowerParadeConstCfg.xml";
/*     */     try
/*     */     {
...
/*     */         }
/*     */       }
/*  62 */       this.activityId = Integer.valueOf(((Element)data.get("activityId")).attributeValue("value")).intValue();
/*  63 */       this.maleId = Integer.valueOf(((Element)data.get("maleId")).attributeValue("value")).intValue();
/*  64 */       this.femaleId = Integer.valueOf(((Element)data.get("femaleId")).attributeValue("value")).intValue();
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*  73 */     String path = dir + "mzm.gsp.activity4.confbean.FlowerParadeConstCfg.xml";
/*     */     try
/*     */     {
...
/*     */         }
/*     */       }
/*  93 */       this.activityId = Integer.valueOf(((Element)data.get("activityId")).attributeValue("value")).intValue();
/*  94 */       this.maleId = Integer.valueOf(((Element)data.get("maleId")).attributeValue("value")).intValue();
/*  95 */       this.femaleId = Integer.valueOf(((Element)data.get("femaleId")).attributeValue("value")).intValue();
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/* 106 */     String path = dir + "mzm.gsp.activity4.confbean.FlowerParadeConstCfg.bny";
/*     */     try
/*     */     {
...
/* 121 */         this.activityId = _os_.unmarshal_int();
/* 122 */         this.maleId = _os_.unmarshal_int();
/* 123 */         this.femaleId = _os_.unmarshal_int();
/*     */       }
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*     */   {
/* 134 */     String path = dir + "mzm.gsp.activity4.confbean.FlowerParadeConstCfg.bny";
/*     */     try
/*     */     {
...
/* 149 */         this.activityId = _os_.unmarshal_int();
/* 150 */         this.maleId = _os_.unmarshal_int();
/* 151 */         this.femaleId = _os_.unmarshal_int();
/*     */       }
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*     */   }
/*     */   
/*     */   public static void setInstance(FlowerParadeConstCfg newInstance)
/*     */   {
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\activity4\confbean\FlowerParadeConstCfg.class
