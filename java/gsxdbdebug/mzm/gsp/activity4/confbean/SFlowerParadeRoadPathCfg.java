...
/*     */ 
/*     */ public class SFlowerParadeRoadPathCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SFlowerParadeRoadPathCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SFlowerParadeRoadPathCfg> all = null;
/*     */   
/*     */   public int pathId;
/*  19 */   public java.util.ArrayList<FlowerParadePos> allPos = new java.util.ArrayList();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.pathId = Integer.valueOf(rootElement.attributeValue("pathId")).intValue();
/*     */     
/*  25 */     Element collectionElement = util.XmlHelper.getVariableElement(rootElement, "allPos");
...
/*  36 */       if (elem.getName().equalsIgnoreCase("mzm.gsp.activity4.confbean.FlowerParadePos"))
/*     */       {
/*     */         FlowerParadePos _v_;
/*     */         
/*     */ 
...
/*     */   {
/*  58 */     _os_.marshal(this.pathId);
/*  59 */     _os_.compact_uint32(this.allPos.size());
/*  60 */     for (FlowerParadePos _v_ : this.allPos)
/*     */     {
/*  62 */       _os_.marshal(_v_);
/*     */     }
/*  64 */     return _os_;
...
/*     */   {
/*  69 */     this.pathId = _os_.unmarshal_int();
/*  70 */     for (int _size_ = _os_.uncompact_uint32(); _size_ > 0; _size_--)
/*     */     {
/*     */ 
/*  73 */       FlowerParadePos _v_ = new FlowerParadePos();
/*  74 */       _v_.unmarshal(_os_);
/*  75 */       this.allPos.add(_v_);
/*     */     }
/*  77 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/*  82 */     String path = dir + "mzm.gsp.activity4.confbean.SFlowerParadeRoadPathCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  95 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity4.confbean.SFlowerParadeRoadPathCfg"))
/*     */         {
/*     */ 
/*  98 */           SFlowerParadeRoadPathCfg obj = new SFlowerParadeRoadPathCfg();
/*  99 */           obj.loadFromXml(elem);
/* 100 */           if (all.put(Integer.valueOf(obj.pathId), obj) != null) {
/* 101 */             throw new RuntimeException("duplicate key : " + obj.pathId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SFlowerParadeRoadPathCfg> all)
/*     */   {
/* 112 */     String path = dir + "mzm.gsp.activity4.confbean.SFlowerParadeRoadPathCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 124 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity4.confbean.SFlowerParadeRoadPathCfg"))
/*     */         {
/*     */ 
/* 127 */           SFlowerParadeRoadPathCfg obj = new SFlowerParadeRoadPathCfg();
/* 128 */           obj.loadFromXml(elem);
/* 129 */           if (all.put(Integer.valueOf(obj.pathId), obj) != null) {
/* 130 */             throw new RuntimeException("duplicate key : " + obj.pathId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 143 */     String path = dir + "mzm.gsp.activity4.confbean.SFlowerParadeRoadPathCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 170 */           SFlowerParadeRoadPathCfg _v_ = new SFlowerParadeRoadPathCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SFlowerParadeRoadPathCfg> all)
/*     */   {
/* 190 */     String path = dir + "mzm.gsp.activity4.confbean.SFlowerParadeRoadPathCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 217 */           SFlowerParadeRoadPathCfg _v_ = new SFlowerParadeRoadPathCfg();
...
/*     */ 
/*     */ 
/*     */   public static SFlowerParadeRoadPathCfg getOld(int key)
/*     */   {
/* 238 */     return (SFlowerParadeRoadPathCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SFlowerParadeRoadPathCfg get(int key)
/*     */   {
/* 243 */     return (SFlowerParadeRoadPathCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SFlowerParadeRoadPathCfg> getOldAll()
/*     */   {
/* 248 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SFlowerParadeRoadPathCfg> getAll()
/*     */   {
/* 253 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SFlowerParadeRoadPathCfg> newAll)
/*     */   {
/* 258 */     oldAll = all;
/* 259 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\activity4\confbean\SFlowerParadeRoadPathCfg.class
