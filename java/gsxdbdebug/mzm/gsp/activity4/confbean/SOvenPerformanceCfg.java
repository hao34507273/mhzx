...
/*     */ 
/*     */ public class SOvenPerformanceCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SOvenPerformanceCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SOvenPerformanceCfg> all = null;
/*     */   
/*     */   public int id;
...
/*  27 */     this.positionX = Integer.valueOf(rootElement.attributeValue("positionX")).intValue();
/*  28 */     this.positionY = Integer.valueOf(rootElement.attributeValue("positionY")).intValue();
/*     */   }
/*     */   
...
/*  35 */     _os_.marshal(this.positionX);
/*  36 */     _os_.marshal(this.positionY);
/*  37 */     return _os_;
/*     */   }
/*     */   
...
/*  44 */     this.positionX = _os_.unmarshal_int();
/*  45 */     this.positionY = _os_.unmarshal_int();
/*  46 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  51 */     String path = dir + "mzm.gsp.activity4.confbean.SOvenPerformanceCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  64 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity4.confbean.SOvenPerformanceCfg"))
/*     */         {
/*     */ 
/*  67 */           SOvenPerformanceCfg obj = new SOvenPerformanceCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SOvenPerformanceCfg> all)
/*     */   {
/*  81 */     String path = dir + "mzm.gsp.activity4.confbean.SOvenPerformanceCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity4.confbean.SOvenPerformanceCfg"))
/*     */         {
/*     */ 
/*  96 */           SOvenPerformanceCfg obj = new SOvenPerformanceCfg();
...
/*     */     
/* 112 */     String path = dir + "mzm.gsp.activity4.confbean.SOvenPerformanceCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 139 */           SOvenPerformanceCfg _v_ = new SOvenPerformanceCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SOvenPerformanceCfg> all)
/*     */   {
/* 159 */     String path = dir + "mzm.gsp.activity4.confbean.SOvenPerformanceCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 186 */           SOvenPerformanceCfg _v_ = new SOvenPerformanceCfg();
...
/*     */ 
/*     */ 
/*     */   public static SOvenPerformanceCfg getOld(int key)
/*     */   {
/* 207 */     return (SOvenPerformanceCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SOvenPerformanceCfg get(int key)
/*     */   {
/* 212 */     return (SOvenPerformanceCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SOvenPerformanceCfg> getOldAll()
/*     */   {
/* 217 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SOvenPerformanceCfg> getAll()
/*     */   {
/* 222 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SOvenPerformanceCfg> newAll)
/*     */   {
/* 227 */     oldAll = all;
/* 228 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\activity4\confbean\SOvenPerformanceCfg.class
