...
/*     */ 
/*     */ public class SMakeUpOptionCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SMakeUpOptionCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SMakeUpOptionCfg> all = null;
/*     */   
/*     */   public int id;
...
/*  26 */     this.optionName = rootElement.attributeValue("optionName");
/*  27 */     this.optionIcon = Integer.valueOf(rootElement.attributeValue("optionIcon")).intValue();
/*  28 */     this.changeBuffId = Integer.valueOf(rootElement.attributeValue("changeBuffId")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  33 */     _os_.marshal(this.id);
/*  34 */     _os_.marshal(this.optionName, "UTF-8");
/*  35 */     _os_.marshal(this.optionIcon);
/*  36 */     _os_.marshal(this.changeBuffId);
/*  37 */     return _os_;
/*     */   }
/*     */   
...
/*  43 */     this.optionName = _os_.unmarshal_String("UTF-8");
/*  44 */     this.optionIcon = _os_.unmarshal_int();
/*  45 */     this.changeBuffId = _os_.unmarshal_int();
/*  46 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  51 */     String path = dir + "mzm.gsp.activity4.confbean.SMakeUpOptionCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  64 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity4.confbean.SMakeUpOptionCfg"))
/*     */         {
/*     */ 
/*  67 */           SMakeUpOptionCfg obj = new SMakeUpOptionCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SMakeUpOptionCfg> all)
/*     */   {
/*  81 */     String path = dir + "mzm.gsp.activity4.confbean.SMakeUpOptionCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity4.confbean.SMakeUpOptionCfg"))
/*     */         {
/*     */ 
/*  96 */           SMakeUpOptionCfg obj = new SMakeUpOptionCfg();
...
/*     */     
/* 112 */     String path = dir + "mzm.gsp.activity4.confbean.SMakeUpOptionCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 139 */           SMakeUpOptionCfg _v_ = new SMakeUpOptionCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SMakeUpOptionCfg> all)
/*     */   {
/* 159 */     String path = dir + "mzm.gsp.activity4.confbean.SMakeUpOptionCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 186 */           SMakeUpOptionCfg _v_ = new SMakeUpOptionCfg();
...
/*     */ 
/*     */ 
/*     */   public static SMakeUpOptionCfg getOld(int key)
/*     */   {
/* 207 */     return (SMakeUpOptionCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SMakeUpOptionCfg get(int key)
/*     */   {
/* 212 */     return (SMakeUpOptionCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMakeUpOptionCfg> getOldAll()
/*     */   {
/* 217 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMakeUpOptionCfg> getAll()
/*     */   {
/* 222 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SMakeUpOptionCfg> newAll)
/*     */   {
/* 227 */     oldAll = all;
/* 228 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\activity4\confbean\SMakeUpOptionCfg.class
