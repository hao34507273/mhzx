...
/*     */ 
/*     */ public class STOvenPerformanceCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, STOvenPerformanceCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, STOvenPerformanceCfg> all = null;
/*     */   
/*     */   public int activityId;
/*  19 */   public java.util.HashSet<Integer> ovenCfgIds = new java.util.HashSet();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.activityId = Integer.valueOf(rootElement.attributeValue("activityId")).intValue();
/*     */     
/*  25 */     Element collectionElement = util.XmlHelper.getVariableElement(rootElement, "ovenCfgIds");
...
/*     */         }
/*     */         
/*  50 */         this.ovenCfgIds.add(Integer.valueOf(_v_));
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*  58 */     _os_.compact_uint32(this.ovenCfgIds.size());
/*  59 */     for (Integer _v_ : this.ovenCfgIds)
/*     */     {
...
/*  73 */       this.ovenCfgIds.add(Integer.valueOf(_v_));
/*     */     }
/*  75 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/*  80 */     String path = dir + "mzm.gsp.activity4.confbean.STOvenPerformanceCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity4.confbean.STOvenPerformanceCfg"))
/*     */         {
/*     */ 
/*  96 */           STOvenPerformanceCfg obj = new STOvenPerformanceCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, STOvenPerformanceCfg> all)
/*     */   {
/* 110 */     String path = dir + "mzm.gsp.activity4.confbean.STOvenPerformanceCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 122 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity4.confbean.STOvenPerformanceCfg"))
/*     */         {
/*     */ 
/* 125 */           STOvenPerformanceCfg obj = new STOvenPerformanceCfg();
...
/*     */     
/* 141 */     String path = dir + "mzm.gsp.activity4.confbean.STOvenPerformanceCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 168 */           STOvenPerformanceCfg _v_ = new STOvenPerformanceCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, STOvenPerformanceCfg> all)
/*     */   {
/* 188 */     String path = dir + "mzm.gsp.activity4.confbean.STOvenPerformanceCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 215 */           STOvenPerformanceCfg _v_ = new STOvenPerformanceCfg();
...
/*     */ 
/*     */ 
/*     */   public static STOvenPerformanceCfg getOld(int key)
/*     */   {
/* 236 */     return (STOvenPerformanceCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static STOvenPerformanceCfg get(int key)
/*     */   {
/* 241 */     return (STOvenPerformanceCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, STOvenPerformanceCfg> getOldAll()
/*     */   {
/* 246 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, STOvenPerformanceCfg> getAll()
/*     */   {
/* 251 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, STOvenPerformanceCfg> newAll)
/*     */   {
/* 256 */     oldAll = all;
/* 257 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\activity4\confbean\STOvenPerformanceCfg.class
