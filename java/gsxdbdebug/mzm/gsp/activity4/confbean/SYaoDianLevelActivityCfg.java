...
/*     */ 
/*     */ public class SYaoDianLevelActivityCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SYaoDianLevelActivityCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SYaoDianLevelActivityCfg> all = null;
/*     */   
/*     */   public int activityId;
/*  19 */   public TreeMap<Integer, SCreateAndCostInfo> yaodianLevel2CreateAndCostInfo = new TreeMap();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.activityId = Integer.valueOf(rootElement.attributeValue("activityId")).intValue();
/*     */     
/*  25 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "yaodianLevel2CreateAndCostInfo");
...
/*  51 */             keyElem = elem;
/*     */           }
/*  53 */           else if ((valueElem == null) && (elem.getName().equalsIgnoreCase("mzm.gsp.activity4.confbean.SCreateAndCostInfo")))
/*     */           {
/*  55 */             valueElem = elem;
/*     */           }
/*     */         }
...
/*     */         
/*     */         int _k_;
/*     */         SCreateAndCostInfo _v_;
/*     */         try
/*     */         {
/*  68 */           _k_ = Integer.valueOf(keyElem.getText()).intValue();
/*  69 */           _v_ = new SCreateAndCostInfo();
...
/*     */         }
/*     */         
/*  77 */         this.yaodianLevel2CreateAndCostInfo.put(Integer.valueOf(_k_), _v_);
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*  85 */     _os_.compact_uint32(this.yaodianLevel2CreateAndCostInfo.size());
/*  86 */     for (java.util.Map.Entry<Integer, SCreateAndCostInfo> _e_ : this.yaodianLevel2CreateAndCostInfo.entrySet())
/*     */     {
...
/*     */       
/* 102 */       SCreateAndCostInfo _v_ = new SCreateAndCostInfo();
/* 103 */       _v_.unmarshal(_os_);
/* 104 */       this.yaodianLevel2CreateAndCostInfo.put(Integer.valueOf(_k_), _v_);
/*     */     }
/* 106 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/* 111 */     String path = dir + "mzm.gsp.activity4.confbean.SYaoDianLevelActivityCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 124 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity4.confbean.SYaoDianLevelActivityCfg"))
/*     */         {
/*     */ 
/* 127 */           SYaoDianLevelActivityCfg obj = new SYaoDianLevelActivityCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SYaoDianLevelActivityCfg> all)
/*     */   {
/* 141 */     String path = dir + "mzm.gsp.activity4.confbean.SYaoDianLevelActivityCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 153 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity4.confbean.SYaoDianLevelActivityCfg"))
/*     */         {
/*     */ 
/* 156 */           SYaoDianLevelActivityCfg obj = new SYaoDianLevelActivityCfg();
...
/*     */     
/* 172 */     String path = dir + "mzm.gsp.activity4.confbean.SYaoDianLevelActivityCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 199 */           SYaoDianLevelActivityCfg _v_ = new SYaoDianLevelActivityCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SYaoDianLevelActivityCfg> all)
/*     */   {
/* 219 */     String path = dir + "mzm.gsp.activity4.confbean.SYaoDianLevelActivityCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 246 */           SYaoDianLevelActivityCfg _v_ = new SYaoDianLevelActivityCfg();
...
/*     */ 
/*     */ 
/*     */   public static SYaoDianLevelActivityCfg getOld(int key)
/*     */   {
/* 267 */     return (SYaoDianLevelActivityCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SYaoDianLevelActivityCfg get(int key)
/*     */   {
/* 272 */     return (SYaoDianLevelActivityCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SYaoDianLevelActivityCfg> getOldAll()
/*     */   {
/* 277 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SYaoDianLevelActivityCfg> getAll()
/*     */   {
/* 282 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SYaoDianLevelActivityCfg> newAll)
/*     */   {
/* 287 */     oldAll = all;
/* 288 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\activity4\confbean\SYaoDianLevelActivityCfg.class
