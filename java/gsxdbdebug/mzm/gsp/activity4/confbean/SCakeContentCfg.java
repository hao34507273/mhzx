...
/*     */ 
/*     */ public class SCakeContentCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SCakeContentCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SCakeContentCfg> all = null;
/*     */   
/*     */   public int id;
...
/*     */   public int superHitWeight;
/*     */   public int normalHitWeight;
/*     */   
...
/*  30 */     this.cakeName = rootElement.attributeValue("cakeName");
/*  31 */     this.range = Integer.valueOf(rootElement.attributeValue("range")).intValue();
/*  32 */     this.awardItemId = Integer.valueOf(rootElement.attributeValue("awardItemId")).intValue();
/*  33 */     this.superHitWeight = Integer.valueOf(rootElement.attributeValue("superHitWeight")).intValue();
/*  34 */     this.normalHitWeight = Integer.valueOf(rootElement.attributeValue("normalHitWeight")).intValue();
/*     */   }
/*     */   
...
/*  41 */     _os_.marshal(this.cakeName, "UTF-8");
/*  42 */     _os_.marshal(this.range);
/*  43 */     _os_.marshal(this.awardItemId);
/*  44 */     _os_.marshal(this.superHitWeight);
/*  45 */     _os_.marshal(this.normalHitWeight);
/*  46 */     return _os_;
/*     */   }
/*     */   
...
/*  53 */     this.cakeName = _os_.unmarshal_String("UTF-8");
/*  54 */     this.range = _os_.unmarshal_int();
/*  55 */     this.awardItemId = _os_.unmarshal_int();
/*  56 */     this.superHitWeight = _os_.unmarshal_int();
/*  57 */     this.normalHitWeight = _os_.unmarshal_int();
/*  58 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  63 */     String path = dir + "mzm.gsp.activity4.confbean.SCakeContentCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  76 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity4.confbean.SCakeContentCfg"))
/*     */         {
/*     */ 
/*  79 */           SCakeContentCfg obj = new SCakeContentCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SCakeContentCfg> all)
/*     */   {
/*  93 */     String path = dir + "mzm.gsp.activity4.confbean.SCakeContentCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 105 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity4.confbean.SCakeContentCfg"))
/*     */         {
/*     */ 
/* 108 */           SCakeContentCfg obj = new SCakeContentCfg();
...
/*     */     
/* 124 */     String path = dir + "mzm.gsp.activity4.confbean.SCakeContentCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 151 */           SCakeContentCfg _v_ = new SCakeContentCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SCakeContentCfg> all)
/*     */   {
/* 171 */     String path = dir + "mzm.gsp.activity4.confbean.SCakeContentCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 198 */           SCakeContentCfg _v_ = new SCakeContentCfg();
...
/*     */ 
/*     */ 
/*     */   public static SCakeContentCfg getOld(int key)
/*     */   {
/* 219 */     return (SCakeContentCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SCakeContentCfg get(int key)
/*     */   {
/* 224 */     return (SCakeContentCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SCakeContentCfg> getOldAll()
/*     */   {
/* 229 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SCakeContentCfg> getAll()
/*     */   {
/* 234 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SCakeContentCfg> newAll)
/*     */   {
/* 239 */     oldAll = all;
/* 240 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\activity4\confbean\SCakeContentCfg.class
