...
/*     */ 
/*     */ public class FactionMakeCakeConsts
/*     */ {
/*  13 */   private static volatile FactionMakeCakeConsts oldInstance = null;
/*     */   
/*  15 */   private static FactionMakeCakeConsts instance = new FactionMakeCakeConsts();
/*     */   
/*     */   public int ACTIVITY_ID;
/*     */   public int prepareModelId;
/*     */   public int cookModelId;
/*     */   
/*     */   public static FactionMakeCakeConsts getOldInstance()
/*     */   {
/*  23 */     return oldInstance;
/*     */   }
/*     */   
/*     */   public static FactionMakeCakeConsts getInstance()
/*     */   {
/*  28 */     return instance;
/*     */   }
/*     */   
...
/*     */   {
/*  42 */     String path = dir + "mzm.gsp.activity4.confbean.FactionMakeCakeConsts.xml";
/*     */     try
/*     */     {
...
/*     */         }
/*     */       }
/*  62 */       this.ACTIVITY_ID = Integer.valueOf(((Element)data.get("ACTIVITY_ID")).attributeValue("value")).intValue();
/*  63 */       this.prepareModelId = Integer.valueOf(((Element)data.get("prepareModelId")).attributeValue("value")).intValue();
/*  64 */       this.cookModelId = Integer.valueOf(((Element)data.get("cookModelId")).attributeValue("value")).intValue();
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*  73 */     String path = dir + "mzm.gsp.activity4.confbean.FactionMakeCakeConsts.xml";
/*     */     try
/*     */     {
...
/*     */         }
/*     */       }
/*  93 */       this.ACTIVITY_ID = Integer.valueOf(((Element)data.get("ACTIVITY_ID")).attributeValue("value")).intValue();
/*  94 */       this.prepareModelId = Integer.valueOf(((Element)data.get("prepareModelId")).attributeValue("value")).intValue();
/*  95 */       this.cookModelId = Integer.valueOf(((Element)data.get("cookModelId")).attributeValue("value")).intValue();
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/* 106 */     String path = dir + "mzm.gsp.activity4.confbean.FactionMakeCakeConsts.bny";
/*     */     try
/*     */     {
...
/* 121 */         this.ACTIVITY_ID = _os_.unmarshal_int();
/* 122 */         this.prepareModelId = _os_.unmarshal_int();
/* 123 */         this.cookModelId = _os_.unmarshal_int();
/*     */       }
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*     */   {
/* 134 */     String path = dir + "mzm.gsp.activity4.confbean.FactionMakeCakeConsts.bny";
/*     */     try
/*     */     {
...
/* 149 */         this.ACTIVITY_ID = _os_.unmarshal_int();
/* 150 */         this.prepareModelId = _os_.unmarshal_int();
/* 151 */         this.cookModelId = _os_.unmarshal_int();
/*     */       }
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*     */   }
/*     */   
/*     */   public static void setInstance(FactionMakeCakeConsts newInstance)
/*     */   {
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\activity4\confbean\FactionMakeCakeConsts.class
