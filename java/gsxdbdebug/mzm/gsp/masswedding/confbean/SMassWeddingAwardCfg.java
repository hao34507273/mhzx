...
/*     */ 
/*     */ public class SMassWeddingAwardCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SMassWeddingAwardCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SMassWeddingAwardCfg> all = null;
/*     */   
/*     */   public int rank;
...
/*  24 */     this.fixAwardid = Integer.valueOf(rootElement.attributeValue("fixAwardid")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  29 */     _os_.marshal(this.rank);
/*  30 */     _os_.marshal(this.fixAwardid);
/*  31 */     return _os_;
/*     */   }
/*     */   
...
/*  37 */     this.fixAwardid = _os_.unmarshal_int();
/*  38 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.masswedding.confbean.SMassWeddingAwardCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.masswedding.confbean.SMassWeddingAwardCfg"))
/*     */         {
/*     */ 
/*  59 */           SMassWeddingAwardCfg obj = new SMassWeddingAwardCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SMassWeddingAwardCfg> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.masswedding.confbean.SMassWeddingAwardCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.masswedding.confbean.SMassWeddingAwardCfg"))
/*     */         {
/*     */ 
/*  88 */           SMassWeddingAwardCfg obj = new SMassWeddingAwardCfg();
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.masswedding.confbean.SMassWeddingAwardCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           SMassWeddingAwardCfg _v_ = new SMassWeddingAwardCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SMassWeddingAwardCfg> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.masswedding.confbean.SMassWeddingAwardCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           SMassWeddingAwardCfg _v_ = new SMassWeddingAwardCfg();
...
/*     */ 
/*     */ 
/*     */   public static SMassWeddingAwardCfg getOld(int key)
/*     */   {
/* 199 */     return (SMassWeddingAwardCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SMassWeddingAwardCfg get(int key)
/*     */   {
/* 204 */     return (SMassWeddingAwardCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMassWeddingAwardCfg> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMassWeddingAwardCfg> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SMassWeddingAwardCfg> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\masswedding\confbean\SMassWeddingAwardCfg.class
