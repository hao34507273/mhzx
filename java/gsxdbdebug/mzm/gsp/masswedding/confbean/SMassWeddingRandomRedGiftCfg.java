...
/*     */ 
/*     */ public class SMassWeddingRandomRedGiftCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SMassWeddingRandomRedGiftCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SMassWeddingRandomRedGiftCfg> all = null;
/*     */   
/*     */   public int id;
/*  19 */   public TreeMap<Integer, Integer> rate2RedgiftCfgid = new TreeMap();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.id = Integer.valueOf(rootElement.attributeValue("id")).intValue();
/*     */     
/*  25 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "rate2RedgiftCfgid");
...
/*     */         }
/*     */         
/*  76 */         this.rate2RedgiftCfgid.put(Integer.valueOf(_k_), Integer.valueOf(_v_));
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*  84 */     _os_.compact_uint32(this.rate2RedgiftCfgid.size());
/*  85 */     for (java.util.Map.Entry<Integer, Integer> _e_ : this.rate2RedgiftCfgid.entrySet())
/*     */     {
...
/* 102 */       this.rate2RedgiftCfgid.put(Integer.valueOf(_k_), Integer.valueOf(_v_));
/*     */     }
/* 104 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/* 109 */     String path = dir + "mzm.gsp.masswedding.confbean.SMassWeddingRandomRedGiftCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 122 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.masswedding.confbean.SMassWeddingRandomRedGiftCfg"))
/*     */         {
/*     */ 
/* 125 */           SMassWeddingRandomRedGiftCfg obj = new SMassWeddingRandomRedGiftCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SMassWeddingRandomRedGiftCfg> all)
/*     */   {
/* 139 */     String path = dir + "mzm.gsp.masswedding.confbean.SMassWeddingRandomRedGiftCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 151 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.masswedding.confbean.SMassWeddingRandomRedGiftCfg"))
/*     */         {
/*     */ 
/* 154 */           SMassWeddingRandomRedGiftCfg obj = new SMassWeddingRandomRedGiftCfg();
...
/*     */     
/* 170 */     String path = dir + "mzm.gsp.masswedding.confbean.SMassWeddingRandomRedGiftCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 197 */           SMassWeddingRandomRedGiftCfg _v_ = new SMassWeddingRandomRedGiftCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SMassWeddingRandomRedGiftCfg> all)
/*     */   {
/* 217 */     String path = dir + "mzm.gsp.masswedding.confbean.SMassWeddingRandomRedGiftCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 244 */           SMassWeddingRandomRedGiftCfg _v_ = new SMassWeddingRandomRedGiftCfg();
...
/*     */ 
/*     */ 
/*     */   public static SMassWeddingRandomRedGiftCfg getOld(int key)
/*     */   {
/* 265 */     return (SMassWeddingRandomRedGiftCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SMassWeddingRandomRedGiftCfg get(int key)
/*     */   {
/* 270 */     return (SMassWeddingRandomRedGiftCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMassWeddingRandomRedGiftCfg> getOldAll()
/*     */   {
/* 275 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMassWeddingRandomRedGiftCfg> getAll()
/*     */   {
/* 280 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SMassWeddingRandomRedGiftCfg> newAll)
/*     */   {
/* 285 */     oldAll = all;
/* 286 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\masswedding\confbean\SMassWeddingRandomRedGiftCfg.class
