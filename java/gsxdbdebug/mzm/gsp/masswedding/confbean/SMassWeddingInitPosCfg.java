...
/*     */ 
/*     */ public class SMassWeddingInitPosCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SMassWeddingInitPosCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SMassWeddingInitPosCfg> all = null;
/*     */   
/*     */   public int num;
/*     */   public int x;
/*     */   public int y;
...
/*     */   {
/*  24 */     this.num = Integer.valueOf(rootElement.attributeValue("num")).intValue();
...
/*     */   {
/*  39 */     this.num = _os_.unmarshal_int();
...
/*     */   {
/*  47 */     String path = dir + "mzm.gsp.masswedding.confbean.SMassWeddingInitPosCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  60 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.masswedding.confbean.SMassWeddingInitPosCfg"))
/*     */         {
/*     */ 
/*  63 */           SMassWeddingInitPosCfg obj = new SMassWeddingInitPosCfg();
/*  64 */           obj.loadFromXml(elem);
/*  65 */           if (all.put(Integer.valueOf(obj.num), obj) != null) {
/*  66 */             throw new RuntimeException("duplicate key : " + obj.num);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SMassWeddingInitPosCfg> all)
/*     */   {
/*  77 */     String path = dir + "mzm.gsp.masswedding.confbean.SMassWeddingInitPosCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  89 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.masswedding.confbean.SMassWeddingInitPosCfg"))
/*     */         {
/*     */ 
/*  92 */           SMassWeddingInitPosCfg obj = new SMassWeddingInitPosCfg();
/*  93 */           obj.loadFromXml(elem);
/*  94 */           if (all.put(Integer.valueOf(obj.num), obj) != null) {
/*  95 */             throw new RuntimeException("duplicate key : " + obj.num);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 108 */     String path = dir + "mzm.gsp.masswedding.confbean.SMassWeddingInitPosCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 135 */           SMassWeddingInitPosCfg _v_ = new SMassWeddingInitPosCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SMassWeddingInitPosCfg> all)
/*     */   {
/* 155 */     String path = dir + "mzm.gsp.masswedding.confbean.SMassWeddingInitPosCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 182 */           SMassWeddingInitPosCfg _v_ = new SMassWeddingInitPosCfg();
...
/*     */ 
/*     */ 
/*     */   public static SMassWeddingInitPosCfg getOld(int key)
/*     */   {
/* 203 */     return (SMassWeddingInitPosCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SMassWeddingInitPosCfg get(int key)
/*     */   {
/* 208 */     return (SMassWeddingInitPosCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMassWeddingInitPosCfg> getOldAll()
/*     */   {
/* 213 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMassWeddingInitPosCfg> getAll()
/*     */   {
/* 218 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SMassWeddingInitPosCfg> newAll)
/*     */   {
/* 223 */     oldAll = all;
/* 224 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\masswedding\confbean\SMassWeddingInitPosCfg.class
