...
/*     */ 
/*     */ public class STempMassWeddingRandomRedGiftCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, STempMassWeddingRandomRedGiftCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, STempMassWeddingRandomRedGiftCfg> all = null;
/*     */   
/*     */   public int id;
/*  19 */   public HashMap<Integer, Integer> redGiftRandomMap = new HashMap();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.id = Integer.valueOf(rootElement.attributeValue("id")).intValue();
/*     */     
/*  25 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "redGiftRandomMap");
...
/*     */         }
/*     */         
/*  76 */         this.redGiftRandomMap.put(Integer.valueOf(_k_), Integer.valueOf(_v_));
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*     */   {
/*  83 */     _os_.marshal(this.id);
/*  84 */     _os_.compact_uint32(this.redGiftRandomMap.size());
/*  85 */     for (java.util.Map.Entry<Integer, Integer> _e_ : this.redGiftRandomMap.entrySet())
/*     */     {
...
/* 102 */       this.redGiftRandomMap.put(Integer.valueOf(_k_), Integer.valueOf(_v_));
/*     */     }
/* 104 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/* 109 */     String path = dir + "mzm.gsp.masswedding.confbean.STempMassWeddingRandomRedGiftCfg.xml";
/*     */     
/*     */     try
/*     */     {
/* 113 */       all = new HashMap();
...
/* 122 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.masswedding.confbean.STempMassWeddingRandomRedGiftCfg"))
/*     */         {
/*     */ 
/* 125 */           STempMassWeddingRandomRedGiftCfg obj = new STempMassWeddingRandomRedGiftCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, STempMassWeddingRandomRedGiftCfg> all)
/*     */   {
/* 139 */     String path = dir + "mzm.gsp.masswedding.confbean.STempMassWeddingRandomRedGiftCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 151 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.masswedding.confbean.STempMassWeddingRandomRedGiftCfg"))
/*     */         {
/*     */ 
/* 154 */           STempMassWeddingRandomRedGiftCfg obj = new STempMassWeddingRandomRedGiftCfg();
...
/* 168 */     all = new HashMap();
/*     */     
/* 170 */     String path = dir + "mzm.gsp.masswedding.confbean.STempMassWeddingRandomRedGiftCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 197 */           STempMassWeddingRandomRedGiftCfg _v_ = new STempMassWeddingRandomRedGiftCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, STempMassWeddingRandomRedGiftCfg> all)
/*     */   {
/* 217 */     String path = dir + "mzm.gsp.masswedding.confbean.STempMassWeddingRandomRedGiftCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 244 */           STempMassWeddingRandomRedGiftCfg _v_ = new STempMassWeddingRandomRedGiftCfg();
...
/*     */ 
/*     */ 
/*     */   public static STempMassWeddingRandomRedGiftCfg getOld(int key)
/*     */   {
/* 265 */     return (STempMassWeddingRandomRedGiftCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static STempMassWeddingRandomRedGiftCfg get(int key)
/*     */   {
/* 270 */     return (STempMassWeddingRandomRedGiftCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, STempMassWeddingRandomRedGiftCfg> getOldAll()
/*     */   {
/* 275 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, STempMassWeddingRandomRedGiftCfg> getAll()
/*     */   {
/* 280 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, STempMassWeddingRandomRedGiftCfg> newAll)
/*     */   {
/* 285 */     oldAll = all;
/* 286 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\masswedding\confbean\STempMassWeddingRandomRedGiftCfg.class
