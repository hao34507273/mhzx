...
/*     */ 
/*     */ public class SMassWeddingRedGiftCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SMassWeddingRedGiftCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SMassWeddingRedGiftCfg> all = null;
/*     */   
/*     */   public int id;
...
/*  24 */     this.awardpoolid = Integer.valueOf(rootElement.attributeValue("awardpoolid")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  29 */     _os_.marshal(this.id);
/*  30 */     _os_.marshal(this.awardpoolid);
/*  31 */     return _os_;
/*     */   }
/*     */   
...
/*  37 */     this.awardpoolid = _os_.unmarshal_int();
/*  38 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.masswedding.confbean.SMassWeddingRedGiftCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.masswedding.confbean.SMassWeddingRedGiftCfg"))
/*     */         {
/*     */ 
/*  59 */           SMassWeddingRedGiftCfg obj = new SMassWeddingRedGiftCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SMassWeddingRedGiftCfg> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.masswedding.confbean.SMassWeddingRedGiftCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.masswedding.confbean.SMassWeddingRedGiftCfg"))
/*     */         {
/*     */ 
/*  88 */           SMassWeddingRedGiftCfg obj = new SMassWeddingRedGiftCfg();
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.masswedding.confbean.SMassWeddingRedGiftCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           SMassWeddingRedGiftCfg _v_ = new SMassWeddingRedGiftCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SMassWeddingRedGiftCfg> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.masswedding.confbean.SMassWeddingRedGiftCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           SMassWeddingRedGiftCfg _v_ = new SMassWeddingRedGiftCfg();
...
/*     */ 
/*     */ 
/*     */   public static SMassWeddingRedGiftCfg getOld(int key)
/*     */   {
/* 199 */     return (SMassWeddingRedGiftCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SMassWeddingRedGiftCfg get(int key)
/*     */   {
/* 204 */     return (SMassWeddingRedGiftCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMassWeddingRedGiftCfg> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMassWeddingRedGiftCfg> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SMassWeddingRedGiftCfg> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\masswedding\confbean\SMassWeddingRedGiftCfg.class
