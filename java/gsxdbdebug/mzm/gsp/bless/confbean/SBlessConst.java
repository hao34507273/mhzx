...
/*     */ 
/*     */ public class SBlessConst
/*     */ {
/*  13 */   private static volatile SBlessConst oldInstance = null;
/*     */   
/*  15 */   private static SBlessConst instance = new SBlessConst();
/*     */   
/*     */ 
/*     */   public int HALF_ANNIVERSARY_ACTIVITY_CFG_ID;
/*     */   
/*     */ 
/*     */   public static SBlessConst getOldInstance()
/*     */   {
/*  23 */     return oldInstance;
/*     */   }
/*     */   
/*     */   public static SBlessConst getInstance()
/*     */   {
/*  28 */     return instance;
/*     */   }
/*     */   
...
/*     */   {
/*  40 */     String path = dir + "mzm.gsp.bless.confbean.SBlessConst.xml";
/*     */     try
/*     */     {
...
/*     */         }
/*     */       }
/*  60 */       this.HALF_ANNIVERSARY_ACTIVITY_CFG_ID = Integer.valueOf(((Element)data.get("HALF_ANNIVERSARY_ACTIVITY_CFG_ID")).attributeValue("value")).intValue();
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*  69 */     String path = dir + "mzm.gsp.bless.confbean.SBlessConst.xml";
/*     */     try
/*     */     {
...
/*     */         }
/*     */       }
/*  89 */       this.HALF_ANNIVERSARY_ACTIVITY_CFG_ID = Integer.valueOf(((Element)data.get("HALF_ANNIVERSARY_ACTIVITY_CFG_ID")).attributeValue("value")).intValue();
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/* 100 */     String path = dir + "mzm.gsp.bless.confbean.SBlessConst.bny";
/*     */     try
/*     */     {
...
/* 115 */         this.HALF_ANNIVERSARY_ACTIVITY_CFG_ID = _os_.unmarshal_int();
/*     */       }
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*     */   {
/* 126 */     String path = dir + "mzm.gsp.bless.confbean.SBlessConst.bny";
/*     */     try
/*     */     {
...
/* 141 */         this.HALF_ANNIVERSARY_ACTIVITY_CFG_ID = _os_.unmarshal_int();
/*     */       }
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*     */   }
/*     */   
/*     */   public static void setInstance(SBlessConst newInstance)
/*     */   {
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\bless\confbean\SBlessConst.class
