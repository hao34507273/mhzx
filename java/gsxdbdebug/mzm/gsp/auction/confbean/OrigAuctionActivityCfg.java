...
/*     */ 
/*     */ public class OrigAuctionActivityCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, OrigAuctionActivityCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, OrigAuctionActivityCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public int activityId;
/*     */   public int activityTimeIndex;
...
/*  27 */     this.activityTimeIndex = Integer.valueOf(rootElement.attributeValue("activityTimeIndex")).intValue();
...
/*  35 */     _os_.marshal(this.activityTimeIndex);
/*  36 */     _os_.marshal(this.turnTypeId);
/*  37 */     return _os_;
/*     */   }
/*     */   
...
/*  44 */     this.activityTimeIndex = _os_.unmarshal_int();
/*  45 */     this.turnTypeId = _os_.unmarshal_int();
/*  46 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  51 */     String path = dir + "mzm.gsp.auction.confbean.OrigAuctionActivityCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  64 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.auction.confbean.OrigAuctionActivityCfg"))
/*     */         {
/*     */ 
/*  67 */           OrigAuctionActivityCfg obj = new OrigAuctionActivityCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, OrigAuctionActivityCfg> all)
/*     */   {
/*  81 */     String path = dir + "mzm.gsp.auction.confbean.OrigAuctionActivityCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.auction.confbean.OrigAuctionActivityCfg"))
/*     */         {
/*     */ 
/*  96 */           OrigAuctionActivityCfg obj = new OrigAuctionActivityCfg();
...
/*     */     
/* 112 */     String path = dir + "mzm.gsp.auction.confbean.OrigAuctionActivityCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 139 */           OrigAuctionActivityCfg _v_ = new OrigAuctionActivityCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, OrigAuctionActivityCfg> all)
/*     */   {
/* 159 */     String path = dir + "mzm.gsp.auction.confbean.OrigAuctionActivityCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 186 */           OrigAuctionActivityCfg _v_ = new OrigAuctionActivityCfg();
...
/*     */ 
/*     */ 
/*     */   public static OrigAuctionActivityCfg getOld(int key)
/*     */   {
/* 207 */     return (OrigAuctionActivityCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static OrigAuctionActivityCfg get(int key)
/*     */   {
/* 212 */     return (OrigAuctionActivityCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, OrigAuctionActivityCfg> getOldAll()
/*     */   {
/* 217 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, OrigAuctionActivityCfg> getAll()
/*     */   {
/* 222 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, OrigAuctionActivityCfg> newAll)
/*     */   {
/* 227 */     oldAll = all;
/* 228 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\auction\confbean\OrigAuctionActivityCfg.class
