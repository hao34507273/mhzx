...
/*     */ 
/*     */ public class SAuctionItemCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SAuctionItemCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SAuctionItemCfg> all = null;
/*     */   
/*     */   public int itemSumTypeId;
/*  19 */   public TreeMap<Integer, SItemTypeInfo> serverLevel2itemTypeInfo = new TreeMap();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.itemSumTypeId = Integer.valueOf(rootElement.attributeValue("itemSumTypeId")).intValue();
/*     */     
/*  25 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "serverLevel2itemTypeInfo");
...
/*  51 */             keyElem = elem;
/*     */           }
/*  53 */           else if ((valueElem == null) && (elem.getName().equalsIgnoreCase("mzm.gsp.auction.confbean.SItemTypeInfo")))
/*     */           {
/*  55 */             valueElem = elem;
/*     */           }
/*     */         }
...
/*     */         }
/*     */         
/*  77 */         this.serverLevel2itemTypeInfo.put(Integer.valueOf(_k_), _v_);
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*     */   {
/*  84 */     _os_.marshal(this.itemSumTypeId);
/*  85 */     _os_.compact_uint32(this.serverLevel2itemTypeInfo.size());
/*  86 */     for (java.util.Map.Entry<Integer, SItemTypeInfo> _e_ : this.serverLevel2itemTypeInfo.entrySet())
/*     */     {
...
/*     */   {
/*  96 */     this.itemSumTypeId = _os_.unmarshal_int();
/*  97 */     for (int _size_ = _os_.uncompact_uint32(); _size_ > 0; _size_--)
/*     */     {
/*     */ 
/* 100 */       int _k_ = _os_.unmarshal_int();
/*     */       
/* 102 */       SItemTypeInfo _v_ = new SItemTypeInfo();
/* 103 */       _v_.unmarshal(_os_);
/* 104 */       this.serverLevel2itemTypeInfo.put(Integer.valueOf(_k_), _v_);
/*     */     }
/* 106 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/* 111 */     String path = dir + "mzm.gsp.auction.confbean.SAuctionItemCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 124 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.auction.confbean.SAuctionItemCfg"))
/*     */         {
/*     */ 
/* 127 */           SAuctionItemCfg obj = new SAuctionItemCfg();
/* 128 */           obj.loadFromXml(elem);
/* 129 */           if (all.put(Integer.valueOf(obj.itemSumTypeId), obj) != null) {
/* 130 */             throw new RuntimeException("duplicate key : " + obj.itemSumTypeId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SAuctionItemCfg> all)
/*     */   {
/* 141 */     String path = dir + "mzm.gsp.auction.confbean.SAuctionItemCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 153 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.auction.confbean.SAuctionItemCfg"))
/*     */         {
/*     */ 
/* 156 */           SAuctionItemCfg obj = new SAuctionItemCfg();
/* 157 */           obj.loadFromXml(elem);
/* 158 */           if (all.put(Integer.valueOf(obj.itemSumTypeId), obj) != null) {
/* 159 */             throw new RuntimeException("duplicate key : " + obj.itemSumTypeId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 172 */     String path = dir + "mzm.gsp.auction.confbean.SAuctionItemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 199 */           SAuctionItemCfg _v_ = new SAuctionItemCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SAuctionItemCfg> all)
/*     */   {
/* 219 */     String path = dir + "mzm.gsp.auction.confbean.SAuctionItemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 246 */           SAuctionItemCfg _v_ = new SAuctionItemCfg();
...
/*     */ 
/*     */ 
/*     */   public static SAuctionItemCfg getOld(int key)
/*     */   {
/* 267 */     return (SAuctionItemCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SAuctionItemCfg get(int key)
/*     */   {
/* 272 */     return (SAuctionItemCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SAuctionItemCfg> getOldAll()
/*     */   {
/* 277 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SAuctionItemCfg> getAll()
/*     */   {
/* 282 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SAuctionItemCfg> newAll)
/*     */   {
/* 287 */     oldAll = all;
/* 288 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\auction\confbean\SAuctionItemCfg.class
