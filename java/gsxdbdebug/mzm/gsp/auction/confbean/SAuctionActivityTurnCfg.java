...
/*     */ 
/*     */ public class SAuctionActivityTurnCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SAuctionActivityTurnCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SAuctionActivityTurnCfg> all = null;
/*     */   
/*     */   public int turnTypeId;
/*  19 */   public TreeMap<Integer, STurnInfo> turnIndex2turnInfo = new TreeMap();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.turnTypeId = Integer.valueOf(rootElement.attributeValue("turnTypeId")).intValue();
/*     */     
/*  25 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "turnIndex2turnInfo");
...
/*  51 */             keyElem = elem;
/*     */           }
/*  53 */           else if ((valueElem == null) && (elem.getName().equalsIgnoreCase("mzm.gsp.auction.confbean.STurnInfo")))
/*     */           {
/*  55 */             valueElem = elem;
/*     */           }
/*     */         }
...
/*     */         }
/*     */         
/*  77 */         this.turnIndex2turnInfo.put(Integer.valueOf(_k_), _v_);
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*     */   {
/*  84 */     _os_.marshal(this.turnTypeId);
/*  85 */     _os_.compact_uint32(this.turnIndex2turnInfo.size());
/*  86 */     for (java.util.Map.Entry<Integer, STurnInfo> _e_ : this.turnIndex2turnInfo.entrySet())
/*     */     {
...
/*     */   {
/*  96 */     this.turnTypeId = _os_.unmarshal_int();
/*  97 */     for (int _size_ = _os_.uncompact_uint32(); _size_ > 0; _size_--)
/*     */     {
/*     */ 
/* 100 */       int _k_ = _os_.unmarshal_int();
/*     */       
/* 102 */       STurnInfo _v_ = new STurnInfo();
/* 103 */       _v_.unmarshal(_os_);
/* 104 */       this.turnIndex2turnInfo.put(Integer.valueOf(_k_), _v_);
/*     */     }
/* 106 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/* 111 */     String path = dir + "mzm.gsp.auction.confbean.SAuctionActivityTurnCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 124 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.auction.confbean.SAuctionActivityTurnCfg"))
/*     */         {
/*     */ 
/* 127 */           SAuctionActivityTurnCfg obj = new SAuctionActivityTurnCfg();
/* 128 */           obj.loadFromXml(elem);
/* 129 */           if (all.put(Integer.valueOf(obj.turnTypeId), obj) != null) {
/* 130 */             throw new RuntimeException("duplicate key : " + obj.turnTypeId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SAuctionActivityTurnCfg> all)
/*     */   {
/* 141 */     String path = dir + "mzm.gsp.auction.confbean.SAuctionActivityTurnCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 153 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.auction.confbean.SAuctionActivityTurnCfg"))
/*     */         {
/*     */ 
/* 156 */           SAuctionActivityTurnCfg obj = new SAuctionActivityTurnCfg();
/* 157 */           obj.loadFromXml(elem);
/* 158 */           if (all.put(Integer.valueOf(obj.turnTypeId), obj) != null) {
/* 159 */             throw new RuntimeException("duplicate key : " + obj.turnTypeId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 172 */     String path = dir + "mzm.gsp.auction.confbean.SAuctionActivityTurnCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 199 */           SAuctionActivityTurnCfg _v_ = new SAuctionActivityTurnCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SAuctionActivityTurnCfg> all)
/*     */   {
/* 219 */     String path = dir + "mzm.gsp.auction.confbean.SAuctionActivityTurnCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 246 */           SAuctionActivityTurnCfg _v_ = new SAuctionActivityTurnCfg();
...
/*     */ 
/*     */ 
/*     */   public static SAuctionActivityTurnCfg getOld(int key)
/*     */   {
/* 267 */     return (SAuctionActivityTurnCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SAuctionActivityTurnCfg get(int key)
/*     */   {
/* 272 */     return (SAuctionActivityTurnCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SAuctionActivityTurnCfg> getOldAll()
/*     */   {
/* 277 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SAuctionActivityTurnCfg> getAll()
/*     */   {
/* 282 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SAuctionActivityTurnCfg> newAll)
/*     */   {
/* 287 */     oldAll = all;
/* 288 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\auction\confbean\SAuctionActivityTurnCfg.class
