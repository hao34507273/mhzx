...
/*     */ 
/*     */ public class SAuctionActivityCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SAuctionActivityCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SAuctionActivityCfg> all = null;
/*     */   
/*     */   public int activityId;
/*  19 */   public TreeMap<Integer, SAuctionActivityInfo> activityTimeIndex2activityInfo = new TreeMap();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.activityId = Integer.valueOf(rootElement.attributeValue("activityId")).intValue();
/*     */     
/*  25 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "activityTimeIndex2activityInfo");
...
/*  51 */             keyElem = elem;
/*     */           }
/*  53 */           else if ((valueElem == null) && (elem.getName().equalsIgnoreCase("mzm.gsp.auction.confbean.SAuctionActivityInfo")))
/*     */           {
/*  55 */             valueElem = elem;
/*     */           }
/*     */         }
...
/*     */         
/*     */         int _k_;
/*     */         SAuctionActivityInfo _v_;
/*     */         try
/*     */         {
/*  68 */           _k_ = Integer.valueOf(keyElem.getText()).intValue();
/*  69 */           _v_ = new SAuctionActivityInfo();
...
/*     */         }
/*     */         
/*  77 */         this.activityTimeIndex2activityInfo.put(Integer.valueOf(_k_), _v_);
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*  85 */     _os_.compact_uint32(this.activityTimeIndex2activityInfo.size());
/*  86 */     for (java.util.Map.Entry<Integer, SAuctionActivityInfo> _e_ : this.activityTimeIndex2activityInfo.entrySet())
/*     */     {
...
/*     */       
/* 102 */       SAuctionActivityInfo _v_ = new SAuctionActivityInfo();
/* 103 */       _v_.unmarshal(_os_);
/* 104 */       this.activityTimeIndex2activityInfo.put(Integer.valueOf(_k_), _v_);
/*     */     }
/* 106 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/* 111 */     String path = dir + "mzm.gsp.auction.confbean.SAuctionActivityCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 124 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.auction.confbean.SAuctionActivityCfg"))
/*     */         {
/*     */ 
/* 127 */           SAuctionActivityCfg obj = new SAuctionActivityCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SAuctionActivityCfg> all)
/*     */   {
/* 141 */     String path = dir + "mzm.gsp.auction.confbean.SAuctionActivityCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 153 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.auction.confbean.SAuctionActivityCfg"))
/*     */         {
/*     */ 
/* 156 */           SAuctionActivityCfg obj = new SAuctionActivityCfg();
...
/*     */     
/* 172 */     String path = dir + "mzm.gsp.auction.confbean.SAuctionActivityCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 199 */           SAuctionActivityCfg _v_ = new SAuctionActivityCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SAuctionActivityCfg> all)
/*     */   {
/* 219 */     String path = dir + "mzm.gsp.auction.confbean.SAuctionActivityCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 246 */           SAuctionActivityCfg _v_ = new SAuctionActivityCfg();
...
/*     */ 
/*     */ 
/*     */   public static SAuctionActivityCfg getOld(int key)
/*     */   {
/* 267 */     return (SAuctionActivityCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SAuctionActivityCfg get(int key)
/*     */   {
/* 272 */     return (SAuctionActivityCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SAuctionActivityCfg> getOldAll()
/*     */   {
/* 277 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SAuctionActivityCfg> getAll()
/*     */   {
/* 282 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SAuctionActivityCfg> newAll)
/*     */   {
/* 287 */     oldAll = all;
/* 288 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\auction\confbean\SAuctionActivityCfg.class
