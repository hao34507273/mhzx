...
/*    */ 
/*    */ public class SItemTypeInfo implements com.goldhuman.Common.Marshal.Marshal
/*    */ {
/*  9 */   public HashMap<Integer, SItemInfoList> itemTypeId2itemInfoList = new HashMap();
/*    */   
/*    */ 
/*    */   public void loadFromXml(Element rootElement)
/*    */   {
/* 14 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "itemTypeId2itemInfoList");
...
/* 40 */             keyElem = elem;
/*    */           }
/* 42 */           else if ((valueElem == null) && (elem.getName().equalsIgnoreCase("mzm.gsp.auction.confbean.SItemInfoList")))
/*    */           {
/* 44 */             valueElem = elem;
/*    */           }
/*    */         }
...
/*    */         }
/*    */         
/* 66 */         this.itemTypeId2itemInfoList.put(Integer.valueOf(_k_), _v_);
/*    */       }
/*    */     }
/*    */   }
/*    */   
...
/*    */   {
/* 73 */     _os_.compact_uint32(this.itemTypeId2itemInfoList.size());
/* 74 */     for (java.util.Map.Entry<Integer, SItemInfoList> _e_ : this.itemTypeId2itemInfoList.entrySet())
/*    */     {
...
/*    */       
/* 89 */       SItemInfoList _v_ = new SItemInfoList();
/* 90 */       _v_.unmarshal(_os_);
/* 91 */       this.itemTypeId2itemInfoList.put(Integer.valueOf(_k_), _v_);
/*    */     }
/* 93 */     return _os_;
/*    */   }
/*    */ }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\auction\confbean\SItemTypeInfo.class
