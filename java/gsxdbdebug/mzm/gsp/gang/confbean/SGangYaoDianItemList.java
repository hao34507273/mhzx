...
/*     */ 
/*     */ public class SGangYaoDianItemList implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SGangYaoDianItemList> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SGangYaoDianItemList> all = null;
/*     */   
/*     */   public int id;
...
/*     */   {
/*  80 */     String path = dir + "mzm.gsp.gang.confbean.SGangYaoDianItemList.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.gang.confbean.SGangYaoDianItemList"))
/*     */         {
/*     */ 
/*  96 */           SGangYaoDianItemList obj = new SGangYaoDianItemList();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SGangYaoDianItemList> all)
/*     */   {
/* 110 */     String path = dir + "mzm.gsp.gang.confbean.SGangYaoDianItemList.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 122 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.gang.confbean.SGangYaoDianItemList"))
/*     */         {
/*     */ 
/* 125 */           SGangYaoDianItemList obj = new SGangYaoDianItemList();
...
/*     */     
/* 141 */     String path = dir + "mzm.gsp.gang.confbean.SGangYaoDianItemList.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 168 */           SGangYaoDianItemList _v_ = new SGangYaoDianItemList();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SGangYaoDianItemList> all)
/*     */   {
/* 188 */     String path = dir + "mzm.gsp.gang.confbean.SGangYaoDianItemList.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 215 */           SGangYaoDianItemList _v_ = new SGangYaoDianItemList();
...
/*     */ 
/*     */ 
/*     */   public static SGangYaoDianItemList getOld(int key)
/*     */   {
/* 236 */     return (SGangYaoDianItemList)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SGangYaoDianItemList get(int key)
/*     */   {
/* 241 */     return (SGangYaoDianItemList)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SGangYaoDianItemList> getOldAll()
/*     */   {
/* 246 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SGangYaoDianItemList> getAll()
/*     */   {
/* 251 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SGangYaoDianItemList> newAll)
/*     */   {
/* 256 */     oldAll = all;
/* 257 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\gang\confbean\SGangYaoDianItemList.class
