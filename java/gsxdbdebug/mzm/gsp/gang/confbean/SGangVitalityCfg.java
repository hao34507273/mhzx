...
/*     */ 
/*     */ public class SGangVitalityCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SGangVitalityCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SGangVitalityCfg> all = null;
/*     */   
...
/*     */   {
/*  23 */     this.activeMin = Integer.valueOf(rootElement.attributeValue("activeMin")).intValue();
/*  24 */     this.vitality = Integer.valueOf(rootElement.attributeValue("vitality")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  29 */     _os_.marshal(this.activeMin);
/*  30 */     _os_.marshal(this.vitality);
/*  31 */     return _os_;
/*     */   }
/*     */   
/*     */   public OctetsStream unmarshal(OctetsStream _os_) throws com.goldhuman.Common.Marshal.MarshalException
/*     */   {
/*  36 */     this.activeMin = _os_.unmarshal_int();
/*  37 */     this.vitality = _os_.unmarshal_int();
/*  38 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.gang.confbean.SGangVitalityCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.gang.confbean.SGangVitalityCfg"))
/*     */         {
/*     */ 
/*  59 */           SGangVitalityCfg obj = new SGangVitalityCfg();
/*  60 */           obj.loadFromXml(elem);
/*  61 */           if (all.put(Integer.valueOf(obj.activeMin), obj) != null) {
/*  62 */             throw new RuntimeException("duplicate key : " + obj.activeMin);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SGangVitalityCfg> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.gang.confbean.SGangVitalityCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.gang.confbean.SGangVitalityCfg"))
/*     */         {
/*     */ 
/*  88 */           SGangVitalityCfg obj = new SGangVitalityCfg();
/*  89 */           obj.loadFromXml(elem);
/*  90 */           if (all.put(Integer.valueOf(obj.activeMin), obj) != null) {
/*  91 */             throw new RuntimeException("duplicate key : " + obj.activeMin);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.gang.confbean.SGangVitalityCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           SGangVitalityCfg _v_ = new SGangVitalityCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SGangVitalityCfg> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.gang.confbean.SGangVitalityCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           SGangVitalityCfg _v_ = new SGangVitalityCfg();
...
/*     */ 
/*     */ 
/*     */   public static SGangVitalityCfg getOld(int key)
/*     */   {
/* 199 */     return (SGangVitalityCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SGangVitalityCfg get(int key)
/*     */   {
/* 204 */     return (SGangVitalityCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SGangVitalityCfg> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SGangVitalityCfg> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SGangVitalityCfg> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\gang\confbean\SGangVitalityCfg.class
