...
/*     */ 
/*     */ public class SGangShuyuanCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SGangShuyuanCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SGangShuyuanCfg> all = null;
/*     */   
/*     */   public int level;
/*     */   public int maxSkillLevel;
/*     */   public int levelUpNeedMin;
/*     */   public int levelUpNeedMoney;
/*     */   public int maintainNeedMoney;
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  26 */     this.level = Integer.valueOf(rootElement.attributeValue("level")).intValue();
/*  27 */     this.maxSkillLevel = Integer.valueOf(rootElement.attributeValue("maxSkillLevel")).intValue();
/*  28 */     this.levelUpNeedMin = Integer.valueOf(rootElement.attributeValue("levelUpNeedMin")).intValue();
/*  29 */     this.levelUpNeedMoney = Integer.valueOf(rootElement.attributeValue("levelUpNeedMoney")).intValue();
/*  30 */     this.maintainNeedMoney = Integer.valueOf(rootElement.attributeValue("maintainNeedMoney")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  35 */     _os_.marshal(this.level);
/*  36 */     _os_.marshal(this.maxSkillLevel);
/*  37 */     _os_.marshal(this.levelUpNeedMin);
/*  38 */     _os_.marshal(this.levelUpNeedMoney);
/*  39 */     _os_.marshal(this.maintainNeedMoney);
/*  40 */     return _os_;
/*     */   }
/*     */   
...
/*  46 */     this.maxSkillLevel = _os_.unmarshal_int();
/*  47 */     this.levelUpNeedMin = _os_.unmarshal_int();
/*  48 */     this.levelUpNeedMoney = _os_.unmarshal_int();
/*  49 */     this.maintainNeedMoney = _os_.unmarshal_int();
/*  50 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  55 */     String path = dir + "mzm.gsp.gang.confbean.SGangShuyuanCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  68 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.gang.confbean.SGangShuyuanCfg"))
/*     */         {
/*     */ 
/*  71 */           SGangShuyuanCfg obj = new SGangShuyuanCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SGangShuyuanCfg> all)
/*     */   {
/*  85 */     String path = dir + "mzm.gsp.gang.confbean.SGangShuyuanCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  97 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.gang.confbean.SGangShuyuanCfg"))
/*     */         {
/*     */ 
/* 100 */           SGangShuyuanCfg obj = new SGangShuyuanCfg();
...
/*     */     
/* 116 */     String path = dir + "mzm.gsp.gang.confbean.SGangShuyuanCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 143 */           SGangShuyuanCfg _v_ = new SGangShuyuanCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SGangShuyuanCfg> all)
/*     */   {
/* 163 */     String path = dir + "mzm.gsp.gang.confbean.SGangShuyuanCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 190 */           SGangShuyuanCfg _v_ = new SGangShuyuanCfg();
...
/*     */ 
/*     */ 
/*     */   public static SGangShuyuanCfg getOld(int key)
/*     */   {
/* 211 */     return (SGangShuyuanCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SGangShuyuanCfg get(int key)
/*     */   {
/* 216 */     return (SGangShuyuanCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SGangShuyuanCfg> getOldAll()
/*     */   {
/* 221 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SGangShuyuanCfg> getAll()
/*     */   {
/* 226 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SGangShuyuanCfg> newAll)
/*     */   {
/* 231 */     oldAll = all;
/* 232 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\gang\confbean\SGangShuyuanCfg.class
