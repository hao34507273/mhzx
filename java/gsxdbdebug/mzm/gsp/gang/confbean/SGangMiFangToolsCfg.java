...
/*     */ 
/*     */ public class SGangMiFangToolsCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SGangMiFangToolsCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SGangMiFangToolsCfg> all = null;
/*     */   
/*     */   public int yaoDianLevel;
/*  19 */   public HashMap<Integer, SGangMiFangToolsCfgInfo> mifangInfo = new HashMap();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.yaoDianLevel = Integer.valueOf(rootElement.attributeValue("yaoDianLevel")).intValue();
/*     */     
/*  25 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "mifangInfo");
...
/*  51 */             keyElem = elem;
/*     */           }
/*  53 */           else if ((valueElem == null) && (elem.getName().equalsIgnoreCase("mzm.gsp.gang.confbean.SGangMiFangToolsCfgInfo")))
/*     */           {
/*  55 */             valueElem = elem;
/*     */           }
/*     */         }
...
/*     */         
/*     */         int _k_;
/*     */         SGangMiFangToolsCfgInfo _v_;
/*     */         try
/*     */         {
/*  68 */           _k_ = Integer.valueOf(keyElem.getText()).intValue();
/*  69 */           _v_ = new SGangMiFangToolsCfgInfo();
...
/*     */         }
/*     */         
/*  77 */         this.mifangInfo.put(Integer.valueOf(_k_), _v_);
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*     */   {
/*  84 */     _os_.marshal(this.yaoDianLevel);
/*  85 */     _os_.compact_uint32(this.mifangInfo.size());
/*  86 */     for (java.util.Map.Entry<Integer, SGangMiFangToolsCfgInfo> _e_ : this.mifangInfo.entrySet())
/*     */     {
...
/*     */   {
/*  96 */     this.yaoDianLevel = _os_.unmarshal_int();
/*  97 */     for (int _size_ = _os_.uncompact_uint32(); _size_ > 0; _size_--)
/*     */     {
/*     */ 
/* 100 */       int _k_ = _os_.unmarshal_int();
/*     */       
/* 102 */       SGangMiFangToolsCfgInfo _v_ = new SGangMiFangToolsCfgInfo();
/* 103 */       _v_.unmarshal(_os_);
/* 104 */       this.mifangInfo.put(Integer.valueOf(_k_), _v_);
/*     */     }
/* 106 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/* 111 */     String path = dir + "mzm.gsp.gang.confbean.SGangMiFangToolsCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 124 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.gang.confbean.SGangMiFangToolsCfg"))
/*     */         {
/*     */ 
/* 127 */           SGangMiFangToolsCfg obj = new SGangMiFangToolsCfg();
/* 128 */           obj.loadFromXml(elem);
/* 129 */           if (all.put(Integer.valueOf(obj.yaoDianLevel), obj) != null) {
/* 130 */             throw new RuntimeException("duplicate key : " + obj.yaoDianLevel);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SGangMiFangToolsCfg> all)
/*     */   {
/* 141 */     String path = dir + "mzm.gsp.gang.confbean.SGangMiFangToolsCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 153 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.gang.confbean.SGangMiFangToolsCfg"))
/*     */         {
/*     */ 
/* 156 */           SGangMiFangToolsCfg obj = new SGangMiFangToolsCfg();
/* 157 */           obj.loadFromXml(elem);
/* 158 */           if (all.put(Integer.valueOf(obj.yaoDianLevel), obj) != null) {
/* 159 */             throw new RuntimeException("duplicate key : " + obj.yaoDianLevel);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 172 */     String path = dir + "mzm.gsp.gang.confbean.SGangMiFangToolsCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 199 */           SGangMiFangToolsCfg _v_ = new SGangMiFangToolsCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SGangMiFangToolsCfg> all)
/*     */   {
/* 219 */     String path = dir + "mzm.gsp.gang.confbean.SGangMiFangToolsCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 246 */           SGangMiFangToolsCfg _v_ = new SGangMiFangToolsCfg();
...
/*     */ 
/*     */ 
/*     */   public static SGangMiFangToolsCfg getOld(int key)
/*     */   {
/* 267 */     return (SGangMiFangToolsCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SGangMiFangToolsCfg get(int key)
/*     */   {
/* 272 */     return (SGangMiFangToolsCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SGangMiFangToolsCfg> getOldAll()
/*     */   {
/* 277 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SGangMiFangToolsCfg> getAll()
/*     */   {
/* 282 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SGangMiFangToolsCfg> newAll)
/*     */   {
/* 287 */     oldAll = all;
/* 288 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\gang\confbean\SGangMiFangToolsCfg.class
