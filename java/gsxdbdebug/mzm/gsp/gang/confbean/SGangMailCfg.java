...
/*     */ 
/*     */ public class SGangMailCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SGangMailCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SGangMailCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public String templatename;
/*     */   public int mailId;
/*     */   public int dutyMaxLevel;
/*     */   public int dutyMinLevel;
/*     */   
...
/*  28 */     this.mailId = Integer.valueOf(rootElement.attributeValue("mailId")).intValue();
/*  29 */     this.dutyMaxLevel = Integer.valueOf(rootElement.attributeValue("dutyMaxLevel")).intValue();
/*  30 */     this.dutyMinLevel = Integer.valueOf(rootElement.attributeValue("dutyMinLevel")).intValue();
/*     */   }
/*     */   
...
/*  37 */     _os_.marshal(this.mailId);
/*  38 */     _os_.marshal(this.dutyMaxLevel);
/*  39 */     _os_.marshal(this.dutyMinLevel);
/*  40 */     return _os_;
/*     */   }
/*     */   
...
/*  47 */     this.mailId = _os_.unmarshal_int();
/*  48 */     this.dutyMaxLevel = _os_.unmarshal_int();
/*  49 */     this.dutyMinLevel = _os_.unmarshal_int();
/*  50 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  55 */     String path = dir + "mzm.gsp.gang.confbean.SGangMailCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  68 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.gang.confbean.SGangMailCfg"))
/*     */         {
/*     */ 
/*  71 */           SGangMailCfg obj = new SGangMailCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SGangMailCfg> all)
/*     */   {
/*  85 */     String path = dir + "mzm.gsp.gang.confbean.SGangMailCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  97 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.gang.confbean.SGangMailCfg"))
/*     */         {
/*     */ 
/* 100 */           SGangMailCfg obj = new SGangMailCfg();
...
/*     */     
/* 116 */     String path = dir + "mzm.gsp.gang.confbean.SGangMailCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 143 */           SGangMailCfg _v_ = new SGangMailCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SGangMailCfg> all)
/*     */   {
/* 163 */     String path = dir + "mzm.gsp.gang.confbean.SGangMailCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 190 */           SGangMailCfg _v_ = new SGangMailCfg();
...
/*     */ 
/*     */ 
/*     */   public static SGangMailCfg getOld(int key)
/*     */   {
/* 211 */     return (SGangMailCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SGangMailCfg get(int key)
/*     */   {
/* 216 */     return (SGangMailCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SGangMailCfg> getOldAll()
/*     */   {
/* 221 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SGangMailCfg> getAll()
/*     */   {
/* 226 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SGangMailCfg> newAll)
/*     */   {
/* 231 */     oldAll = all;
/* 232 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\gang\confbean\SGangMailCfg.class
