...
/*     */ 
/*     */ public class SGangPayCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SGangPayCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SGangPayCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public int gangMoneyCeil;
/*     */   public int ratio;
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  24 */     this.id = Integer.valueOf(rootElement.attributeValue("id")).intValue();
/*  25 */     this.gangMoneyCeil = Integer.valueOf(rootElement.attributeValue("gangMoneyCeil")).intValue();
/*  26 */     this.ratio = Integer.valueOf(rootElement.attributeValue("ratio")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  31 */     _os_.marshal(this.id);
/*  32 */     _os_.marshal(this.gangMoneyCeil);
/*  33 */     _os_.marshal(this.ratio);
/*  34 */     return _os_;
/*     */   }
/*     */   
...
/*  40 */     this.gangMoneyCeil = _os_.unmarshal_int();
/*  41 */     this.ratio = _os_.unmarshal_int();
/*  42 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  47 */     String path = dir + "mzm.gsp.gang.confbean.SGangPayCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  60 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.gang.confbean.SGangPayCfg"))
/*     */         {
/*     */ 
/*  63 */           SGangPayCfg obj = new SGangPayCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SGangPayCfg> all)
/*     */   {
/*  77 */     String path = dir + "mzm.gsp.gang.confbean.SGangPayCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  89 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.gang.confbean.SGangPayCfg"))
/*     */         {
/*     */ 
/*  92 */           SGangPayCfg obj = new SGangPayCfg();
...
/*     */     
/* 108 */     String path = dir + "mzm.gsp.gang.confbean.SGangPayCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 135 */           SGangPayCfg _v_ = new SGangPayCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SGangPayCfg> all)
/*     */   {
/* 155 */     String path = dir + "mzm.gsp.gang.confbean.SGangPayCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 182 */           SGangPayCfg _v_ = new SGangPayCfg();
...
/*     */ 
/*     */ 
/*     */   public static SGangPayCfg getOld(int key)
/*     */   {
/* 203 */     return (SGangPayCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SGangPayCfg get(int key)
/*     */   {
/* 208 */     return (SGangPayCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SGangPayCfg> getOldAll()
/*     */   {
/* 213 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SGangPayCfg> getAll()
/*     */   {
/* 218 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SGangPayCfg> newAll)
/*     */   {
/* 223 */     oldAll = all;
/* 224 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\gang\confbean\SGangPayCfg.class
