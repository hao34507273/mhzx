...
/*     */ 
/*     */ public class SGangBuildDonateCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SGangBuildDonateCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SGangBuildDonateCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public String templatename;
/*     */   public int donateSilver;
/*     */   public int redeemBangGong;
/*     */   public int removeLevelUpM;
/*     */   
...
/*  28 */     this.donateSilver = Integer.valueOf(rootElement.attributeValue("donateSilver")).intValue();
/*  29 */     this.redeemBangGong = Integer.valueOf(rootElement.attributeValue("redeemBangGong")).intValue();
/*  30 */     this.removeLevelUpM = Integer.valueOf(rootElement.attributeValue("removeLevelUpM")).intValue();
/*     */   }
/*     */   
...
/*  37 */     _os_.marshal(this.donateSilver);
/*  38 */     _os_.marshal(this.redeemBangGong);
/*  39 */     _os_.marshal(this.removeLevelUpM);
/*  40 */     return _os_;
/*     */   }
/*     */   
...
/*  47 */     this.donateSilver = _os_.unmarshal_int();
/*  48 */     this.redeemBangGong = _os_.unmarshal_int();
/*  49 */     this.removeLevelUpM = _os_.unmarshal_int();
/*  50 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  55 */     String path = dir + "mzm.gsp.gang.confbean.SGangBuildDonateCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  68 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.gang.confbean.SGangBuildDonateCfg"))
/*     */         {
/*     */ 
/*  71 */           SGangBuildDonateCfg obj = new SGangBuildDonateCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SGangBuildDonateCfg> all)
/*     */   {
/*  85 */     String path = dir + "mzm.gsp.gang.confbean.SGangBuildDonateCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  97 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.gang.confbean.SGangBuildDonateCfg"))
/*     */         {
/*     */ 
/* 100 */           SGangBuildDonateCfg obj = new SGangBuildDonateCfg();
...
/*     */     
/* 116 */     String path = dir + "mzm.gsp.gang.confbean.SGangBuildDonateCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 143 */           SGangBuildDonateCfg _v_ = new SGangBuildDonateCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SGangBuildDonateCfg> all)
/*     */   {
/* 163 */     String path = dir + "mzm.gsp.gang.confbean.SGangBuildDonateCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 190 */           SGangBuildDonateCfg _v_ = new SGangBuildDonateCfg();
...
/*     */ 
/*     */ 
/*     */   public static SGangBuildDonateCfg getOld(int key)
/*     */   {
/* 211 */     return (SGangBuildDonateCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SGangBuildDonateCfg get(int key)
/*     */   {
/* 216 */     return (SGangBuildDonateCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SGangBuildDonateCfg> getOldAll()
/*     */   {
/* 221 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SGangBuildDonateCfg> getAll()
/*     */   {
/* 226 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SGangBuildDonateCfg> newAll)
/*     */   {
/* 231 */     oldAll = all;
/* 232 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\gang\confbean\SGangBuildDonateCfg.class
