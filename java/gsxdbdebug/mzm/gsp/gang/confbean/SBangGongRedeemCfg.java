...
/*     */ 
/*     */ public class SBangGongRedeemCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SBangGongRedeemCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SBangGongRedeemCfg> all = null;
/*     */   
/*     */   public int id;
...
/*  27 */     this.costSilver = Integer.valueOf(rootElement.attributeValue("costSilver")).intValue();
/*  28 */     this.redeemBangGong = Integer.valueOf(rootElement.attributeValue("redeemBangGong")).intValue();
/*     */   }
/*     */   
...
/*  35 */     _os_.marshal(this.costSilver);
/*  36 */     _os_.marshal(this.redeemBangGong);
/*  37 */     return _os_;
/*     */   }
/*     */   
...
/*  44 */     this.costSilver = _os_.unmarshal_int();
/*  45 */     this.redeemBangGong = _os_.unmarshal_int();
/*  46 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  51 */     String path = dir + "mzm.gsp.gang.confbean.SBangGongRedeemCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  64 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.gang.confbean.SBangGongRedeemCfg"))
/*     */         {
/*     */ 
/*  67 */           SBangGongRedeemCfg obj = new SBangGongRedeemCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SBangGongRedeemCfg> all)
/*     */   {
/*  81 */     String path = dir + "mzm.gsp.gang.confbean.SBangGongRedeemCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.gang.confbean.SBangGongRedeemCfg"))
/*     */         {
/*     */ 
/*  96 */           SBangGongRedeemCfg obj = new SBangGongRedeemCfg();
...
/*     */     
/* 112 */     String path = dir + "mzm.gsp.gang.confbean.SBangGongRedeemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 139 */           SBangGongRedeemCfg _v_ = new SBangGongRedeemCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SBangGongRedeemCfg> all)
/*     */   {
/* 159 */     String path = dir + "mzm.gsp.gang.confbean.SBangGongRedeemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 186 */           SBangGongRedeemCfg _v_ = new SBangGongRedeemCfg();
...
/*     */ 
/*     */ 
/*     */   public static SBangGongRedeemCfg getOld(int key)
/*     */   {
/* 207 */     return (SBangGongRedeemCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SBangGongRedeemCfg get(int key)
/*     */   {
/* 212 */     return (SBangGongRedeemCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SBangGongRedeemCfg> getOldAll()
/*     */   {
/* 217 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SBangGongRedeemCfg> getAll()
/*     */   {
/* 222 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SBangGongRedeemCfg> newAll)
/*     */   {
/* 227 */     oldAll = all;
/* 228 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\gang\confbean\SBangGongRedeemCfg.class
