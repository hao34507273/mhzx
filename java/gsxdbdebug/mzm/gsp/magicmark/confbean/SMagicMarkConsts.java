...
/*     */ 
/*     */ public class SMagicMarkConsts
/*     */ {
/*  13 */   private static volatile SMagicMarkConsts oldInstance = null;
/*     */   
/*  15 */   private static SMagicMarkConsts instance = new SMagicMarkConsts();
/*     */   
/*     */   public int MAGIC_MARK_OPEN_LEVEL;
/*     */   
/*     */   public int OUT_DATE_MAIL_ID;
/*     */   
/*     */   public static SMagicMarkConsts getOldInstance()
/*     */   {
/*  23 */     return oldInstance;
/*     */   }
/*     */   
/*     */   public static SMagicMarkConsts getInstance()
/*     */   {
/*  28 */     return instance;
/*     */   }
/*     */   
...
/*     */   {
/*  41 */     String path = dir + "mzm.gsp.magicmark.confbean.SMagicMarkConsts.xml";
/*     */     try
/*     */     {
...
/*     */         }
/*     */       }
/*  61 */       this.MAGIC_MARK_OPEN_LEVEL = Integer.valueOf(((Element)data.get("MAGIC_MARK_OPEN_LEVEL")).attributeValue("value")).intValue();
/*  62 */       this.OUT_DATE_MAIL_ID = Integer.valueOf(((Element)data.get("OUT_DATE_MAIL_ID")).attributeValue("value")).intValue();
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*  71 */     String path = dir + "mzm.gsp.magicmark.confbean.SMagicMarkConsts.xml";
/*     */     try
/*     */     {
...
/*     */         }
/*     */       }
/*  91 */       this.MAGIC_MARK_OPEN_LEVEL = Integer.valueOf(((Element)data.get("MAGIC_MARK_OPEN_LEVEL")).attributeValue("value")).intValue();
/*  92 */       this.OUT_DATE_MAIL_ID = Integer.valueOf(((Element)data.get("OUT_DATE_MAIL_ID")).attributeValue("value")).intValue();
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/* 103 */     String path = dir + "mzm.gsp.magicmark.confbean.SMagicMarkConsts.bny";
/*     */     try
/*     */     {
...
/* 118 */         this.MAGIC_MARK_OPEN_LEVEL = _os_.unmarshal_int();
/* 119 */         this.OUT_DATE_MAIL_ID = _os_.unmarshal_int();
/*     */       }
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*     */   {
/* 130 */     String path = dir + "mzm.gsp.magicmark.confbean.SMagicMarkConsts.bny";
/*     */     try
/*     */     {
...
/* 145 */         this.MAGIC_MARK_OPEN_LEVEL = _os_.unmarshal_int();
/* 146 */         this.OUT_DATE_MAIL_ID = _os_.unmarshal_int();
/*     */       }
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*     */   }
/*     */   
/*     */   public static void setInstance(SMagicMarkConsts newInstance)
/*     */   {
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\magicmark\confbean\SMagicMarkConsts.class
