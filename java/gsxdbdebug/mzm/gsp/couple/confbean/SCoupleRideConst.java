/*     */ package mzm.gsp.couple.confbean;
/*     */ 
...
/*     */ 
/*     */ public class SCoupleRideConst
/*     */ {
/*  13 */   private static volatile SCoupleRideConst oldInstance = null;
/*     */   
/*  15 */   private static SCoupleRideConst instance = new SCoupleRideConst();
/*     */   
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   public static SCoupleRideConst getOldInstance()
/*     */   {
/*  23 */     return oldInstance;
/*     */   }
/*     */   
/*     */   public static SCoupleRideConst getInstance()
/*     */   {
/*  28 */     return instance;
/*     */   }
/*     */   
/*  31 */   public int defaultRefuseTime = 10;
/*  32 */   public int needLevel = 40;
/*     */   
...
/*     */   {
/*  41 */     String path = dir + "mzm.gsp.couple.confbean.SCoupleRideConst.xml";
/*     */     try
/*     */     {
...
/*     */         }
/*     */       }
/*  61 */       this.defaultRefuseTime = Integer.valueOf(((Element)data.get("defaultRefuseTime")).attributeValue("value")).intValue();
/*  62 */       this.needLevel = Integer.valueOf(((Element)data.get("needLevel")).attributeValue("value")).intValue();
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*  71 */     String path = dir + "mzm.gsp.couple.confbean.SCoupleRideConst.xml";
/*     */     try
/*     */     {
...
/*     */         }
/*     */       }
/*  91 */       this.defaultRefuseTime = Integer.valueOf(((Element)data.get("defaultRefuseTime")).attributeValue("value")).intValue();
/*  92 */       this.needLevel = Integer.valueOf(((Element)data.get("needLevel")).attributeValue("value")).intValue();
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/* 103 */     String path = dir + "mzm.gsp.couple.confbean.SCoupleRideConst.bny";
/*     */     try
/*     */     {
...
/* 118 */         this.defaultRefuseTime = _os_.unmarshal_int();
/* 119 */         this.needLevel = _os_.unmarshal_int();
/*     */       }
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*     */   {
/* 130 */     String path = dir + "mzm.gsp.couple.confbean.SCoupleRideConst.bny";
/*     */     try
/*     */     {
...
/* 145 */         this.defaultRefuseTime = _os_.unmarshal_int();
/* 146 */         this.needLevel = _os_.unmarshal_int();
/*     */       }
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*     */   }
/*     */   
/*     */   public static void setInstance(SCoupleRideConst newInstance)
/*     */   {
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\couple\confbean\SCoupleRideConst.class
