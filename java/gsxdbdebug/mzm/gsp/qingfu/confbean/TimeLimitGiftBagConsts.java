...
/*     */ 
/*     */ public class TimeLimitGiftBagConsts
/*     */ {
/*  13 */   private static volatile TimeLimitGiftBagConsts oldInstance = null;
/*     */   
/*  15 */   private static TimeLimitGiftBagConsts instance = new TimeLimitGiftBagConsts();
/*     */   
/*     */   public int GIFT_MAIL_ID;
/*     */   
/*     */   public int GIFT_HOVER_TIP_ID;
/*     */   
/*     */   public static TimeLimitGiftBagConsts getOldInstance()
/*     */   {
/*  23 */     return oldInstance;
/*     */   }
/*     */   
/*     */   public static TimeLimitGiftBagConsts getInstance()
/*     */   {
/*  28 */     return instance;
/*     */   }
/*     */   
...
/*     */   {
/*  41 */     String path = dir + "mzm.gsp.qingfu.confbean.TimeLimitGiftBagConsts.xml";
/*     */     try
/*     */     {
...
/*     */         }
/*     */       }
/*  61 */       this.GIFT_MAIL_ID = Integer.valueOf(((Element)data.get("GIFT_MAIL_ID")).attributeValue("value")).intValue();
/*  62 */       this.GIFT_HOVER_TIP_ID = Integer.valueOf(((Element)data.get("GIFT_HOVER_TIP_ID")).attributeValue("value")).intValue();
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*  71 */     String path = dir + "mzm.gsp.qingfu.confbean.TimeLimitGiftBagConsts.xml";
/*     */     try
/*     */     {
...
/*     */         }
/*     */       }
/*  91 */       this.GIFT_MAIL_ID = Integer.valueOf(((Element)data.get("GIFT_MAIL_ID")).attributeValue("value")).intValue();
/*  92 */       this.GIFT_HOVER_TIP_ID = Integer.valueOf(((Element)data.get("GIFT_HOVER_TIP_ID")).attributeValue("value")).intValue();
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/* 103 */     String path = dir + "mzm.gsp.qingfu.confbean.TimeLimitGiftBagConsts.bny";
/*     */     try
/*     */     {
...
/* 118 */         this.GIFT_MAIL_ID = _os_.unmarshal_int();
/* 119 */         this.GIFT_HOVER_TIP_ID = _os_.unmarshal_int();
/*     */       }
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*     */   {
/* 130 */     String path = dir + "mzm.gsp.qingfu.confbean.TimeLimitGiftBagConsts.bny";
/*     */     try
/*     */     {
...
/* 145 */         this.GIFT_MAIL_ID = _os_.unmarshal_int();
/* 146 */         this.GIFT_HOVER_TIP_ID = _os_.unmarshal_int();
/*     */       }
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*     */   }
/*     */   
/*     */   public static void setInstance(TimeLimitGiftBagConsts newInstance)
/*     */   {
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\qingfu\confbean\TimeLimitGiftBagConsts.class
