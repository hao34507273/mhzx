...
/*    */ 
/*    */ public class RMBGiftBagGenDayInfo implements com.goldhuman.Common.Marshal.Marshal
/*    */ {
/*  9 */   public HashMap<Integer, RMBGiftBagTierInfo> tiers = new HashMap();
/*    */   
/*    */ 
/*    */   public void loadFromXml(Element rootElement)
/*    */   {
/* 14 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "tiers");
...
/* 40 */             keyElem = elem;
/*    */           }
/* 42 */           else if ((valueElem == null) && (elem.getName().equalsIgnoreCase("mzm.gsp.qingfu.confbean.RMBGiftBagTierInfo")))
/*    */           {
/* 44 */             valueElem = elem;
/*    */           }
/*    */         }
...
/*    */         
/*    */         int _k_;
/*    */         RMBGiftBagTierInfo _v_;
/*    */         try
/*    */         {
/* 57 */           _k_ = Integer.valueOf(keyElem.getText()).intValue();
/* 58 */           _v_ = new RMBGiftBagTierInfo();
...
/*    */         }
/*    */         
/* 66 */         this.tiers.put(Integer.valueOf(_k_), _v_);
/*    */       }
/*    */     }
/*    */   }
/*    */   
...
/*    */   {
/* 73 */     _os_.compact_uint32(this.tiers.size());
/* 74 */     for (java.util.Map.Entry<Integer, RMBGiftBagTierInfo> _e_ : this.tiers.entrySet())
/*    */     {
...
/*    */       
/* 89 */       RMBGiftBagTierInfo _v_ = new RMBGiftBagTierInfo();
/* 90 */       _v_.unmarshal(_os_);
/* 91 */       this.tiers.put(Integer.valueOf(_k_), _v_);
/*    */     }
/* 93 */     return _os_;
/*    */   }
/*    */ }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\qingfu\confbean\RMBGiftBagGenDayInfo.class
