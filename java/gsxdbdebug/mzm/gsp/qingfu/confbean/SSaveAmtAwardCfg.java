...
/*     */ 
/*     */ public class SSaveAmtAwardCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SSaveAmtAwardCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SSaveAmtAwardCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public int send_award_mail_cfgid;
/*  20 */   public HashMap<Integer, SSaveAmtActivityAwardInfo> award_infos = new HashMap();
/*     */   
...
/*  53 */             keyElem = elem;
/*     */           }
/*  55 */           else if ((valueElem == null) && (elem.getName().equalsIgnoreCase("mzm.gsp.qingfu.confbean.SSaveAmtActivityAwardInfo")))
/*     */           {
/*  57 */             valueElem = elem;
/*     */           }
/*     */         }
...
/*     */         
/*     */         int _k_;
/*     */         SSaveAmtActivityAwardInfo _v_;
/*     */         try
/*     */         {
/*  70 */           _k_ = Integer.valueOf(keyElem.getText()).intValue();
/*  71 */           _v_ = new SSaveAmtActivityAwardInfo();
...
/*  89 */     for (java.util.Map.Entry<Integer, SSaveAmtActivityAwardInfo> _e_ : this.award_infos.entrySet())
/*     */     {
...
/*     */       
/* 106 */       SSaveAmtActivityAwardInfo _v_ = new SSaveAmtActivityAwardInfo();
...
/*     */   {
/* 115 */     String path = dir + "mzm.gsp.qingfu.confbean.SSaveAmtAwardCfg.xml";
/*     */     
/*     */     try
/*     */     {
/* 119 */       all = new HashMap();
...
/* 128 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.qingfu.confbean.SSaveAmtAwardCfg"))
/*     */         {
/*     */ 
/* 131 */           SSaveAmtAwardCfg obj = new SSaveAmtAwardCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SSaveAmtAwardCfg> all)
/*     */   {
/* 145 */     String path = dir + "mzm.gsp.qingfu.confbean.SSaveAmtAwardCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 157 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.qingfu.confbean.SSaveAmtAwardCfg"))
/*     */         {
/*     */ 
/* 160 */           SSaveAmtAwardCfg obj = new SSaveAmtAwardCfg();
...
/* 174 */     all = new HashMap();
/*     */     
/* 176 */     String path = dir + "mzm.gsp.qingfu.confbean.SSaveAmtAwardCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 203 */           SSaveAmtAwardCfg _v_ = new SSaveAmtAwardCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SSaveAmtAwardCfg> all)
/*     */   {
/* 223 */     String path = dir + "mzm.gsp.qingfu.confbean.SSaveAmtAwardCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 250 */           SSaveAmtAwardCfg _v_ = new SSaveAmtAwardCfg();
...
/*     */ 
/*     */ 
/*     */   public static SSaveAmtAwardCfg getOld(int key)
/*     */   {
/* 271 */     return (SSaveAmtAwardCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SSaveAmtAwardCfg get(int key)
/*     */   {
/* 276 */     return (SSaveAmtAwardCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SSaveAmtAwardCfg> getOldAll()
/*     */   {
/* 281 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SSaveAmtAwardCfg> getAll()
/*     */   {
/* 286 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SSaveAmtAwardCfg> newAll)
/*     */   {
/* 291 */     oldAll = all;
/* 292 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\qingfu\confbean\SSaveAmtAwardCfg.class
