...
/*     */ 
/*     */ public class SaveAmtAwardOriginalCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SaveAmtAwardOriginalCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SaveAmtAwardOriginalCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public String name;
/*     */   public String desc;
...
/*  32 */     this.save_amt_cond = Integer.valueOf(rootElement.attributeValue("save_amt_cond")).intValue();
...
/*  44 */     _os_.marshal(this.save_amt_cond);
...
/*  57 */     this.save_amt_cond = _os_.unmarshal_int();
...
/*     */   {
/*  67 */     String path = dir + "mzm.gsp.qingfu.confbean.SaveAmtAwardOriginalCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  80 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.qingfu.confbean.SaveAmtAwardOriginalCfg"))
/*     */         {
/*     */ 
/*  83 */           SaveAmtAwardOriginalCfg obj = new SaveAmtAwardOriginalCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SaveAmtAwardOriginalCfg> all)
/*     */   {
/*  97 */     String path = dir + "mzm.gsp.qingfu.confbean.SaveAmtAwardOriginalCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 109 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.qingfu.confbean.SaveAmtAwardOriginalCfg"))
/*     */         {
/*     */ 
/* 112 */           SaveAmtAwardOriginalCfg obj = new SaveAmtAwardOriginalCfg();
...
/*     */     
/* 128 */     String path = dir + "mzm.gsp.qingfu.confbean.SaveAmtAwardOriginalCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 155 */           SaveAmtAwardOriginalCfg _v_ = new SaveAmtAwardOriginalCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SaveAmtAwardOriginalCfg> all)
/*     */   {
/* 175 */     String path = dir + "mzm.gsp.qingfu.confbean.SaveAmtAwardOriginalCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 202 */           SaveAmtAwardOriginalCfg _v_ = new SaveAmtAwardOriginalCfg();
...
/*     */ 
/*     */ 
/*     */   public static SaveAmtAwardOriginalCfg getOld(int key)
/*     */   {
/* 223 */     return (SaveAmtAwardOriginalCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SaveAmtAwardOriginalCfg get(int key)
/*     */   {
/* 228 */     return (SaveAmtAwardOriginalCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SaveAmtAwardOriginalCfg> getOldAll()
/*     */   {
/* 233 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SaveAmtAwardOriginalCfg> getAll()
/*     */   {
/* 238 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SaveAmtAwardOriginalCfg> newAll)
/*     */   {
/* 243 */     oldAll = all;
/* 244 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\qingfu\confbean\SaveAmtAwardOriginalCfg.class
