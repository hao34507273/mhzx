...
/*     */ 
/*     */ public class SAccumTotalCostAwardCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SAccumTotalCostAwardCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SAccumTotalCostAwardCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public int send_award_mail_cfgid;
/*  20 */   public HashMap<Integer, SAccumTotalCostActivityAwardInfo> award_infos = new HashMap();
/*     */   
...
/*  53 */             keyElem = elem;
/*     */           }
/*  55 */           else if ((valueElem == null) && (elem.getName().equalsIgnoreCase("mzm.gsp.qingfu.confbean.SAccumTotalCostActivityAwardInfo")))
/*     */           {
/*  57 */             valueElem = elem;
/*     */           }
/*     */         }
...
/*     */         
/*     */         int _k_;
/*     */         SAccumTotalCostActivityAwardInfo _v_;
/*     */         try
/*     */         {
/*  70 */           _k_ = Integer.valueOf(keyElem.getText()).intValue();
/*  71 */           _v_ = new SAccumTotalCostActivityAwardInfo();
...
/*  89 */     for (java.util.Map.Entry<Integer, SAccumTotalCostActivityAwardInfo> _e_ : this.award_infos.entrySet())
/*     */     {
...
/*     */       
/* 106 */       SAccumTotalCostActivityAwardInfo _v_ = new SAccumTotalCostActivityAwardInfo();
...
/*     */   {
/* 115 */     String path = dir + "mzm.gsp.qingfu.confbean.SAccumTotalCostAwardCfg.xml";
/*     */     
/*     */     try
/*     */     {
/* 119 */       all = new HashMap();
...
/* 128 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.qingfu.confbean.SAccumTotalCostAwardCfg"))
/*     */         {
/*     */ 
/* 131 */           SAccumTotalCostAwardCfg obj = new SAccumTotalCostAwardCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SAccumTotalCostAwardCfg> all)
/*     */   {
/* 145 */     String path = dir + "mzm.gsp.qingfu.confbean.SAccumTotalCostAwardCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 157 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.qingfu.confbean.SAccumTotalCostAwardCfg"))
/*     */         {
/*     */ 
/* 160 */           SAccumTotalCostAwardCfg obj = new SAccumTotalCostAwardCfg();
...
/* 174 */     all = new HashMap();
/*     */     
/* 176 */     String path = dir + "mzm.gsp.qingfu.confbean.SAccumTotalCostAwardCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 203 */           SAccumTotalCostAwardCfg _v_ = new SAccumTotalCostAwardCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SAccumTotalCostAwardCfg> all)
/*     */   {
/* 223 */     String path = dir + "mzm.gsp.qingfu.confbean.SAccumTotalCostAwardCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 250 */           SAccumTotalCostAwardCfg _v_ = new SAccumTotalCostAwardCfg();
...
/*     */ 
/*     */ 
/*     */   public static SAccumTotalCostAwardCfg getOld(int key)
/*     */   {
/* 271 */     return (SAccumTotalCostAwardCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SAccumTotalCostAwardCfg get(int key)
/*     */   {
/* 276 */     return (SAccumTotalCostAwardCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SAccumTotalCostAwardCfg> getOldAll()
/*     */   {
/* 281 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SAccumTotalCostAwardCfg> getAll()
/*     */   {
/* 286 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SAccumTotalCostAwardCfg> newAll)
/*     */   {
/* 291 */     oldAll = all;
/* 292 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\qingfu\confbean\SAccumTotalCostAwardCfg.class
