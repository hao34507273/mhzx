...
/*     */ 
/*     */ public class LevelGrowthFundOriginalCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, LevelGrowthFundOriginalCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, LevelGrowthFundOriginalCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public String name;
/*     */   public String desc;
...
/*  32 */     this.level_cond = Integer.valueOf(rootElement.attributeValue("level_cond")).intValue();
...
/*  36 */     this.serviceId = Integer.valueOf(rootElement.attributeValue("serviceId")).intValue();
/*     */   }
/*     */   
...
/*  44 */     _os_.marshal(this.level_cond);
...
/*  57 */     this.level_cond = _os_.unmarshal_int();
/*  58 */     this.award_cfg_id = _os_.unmarshal_int();
/*  59 */     this.sort_id = _os_.unmarshal_int();
/*  60 */     this.activity_cfg_id = _os_.unmarshal_int();
/*  61 */     this.serviceId = _os_.unmarshal_int();
/*  62 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  67 */     String path = dir + "mzm.gsp.qingfu.confbean.LevelGrowthFundOriginalCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  80 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.qingfu.confbean.LevelGrowthFundOriginalCfg"))
/*     */         {
/*     */ 
/*  83 */           LevelGrowthFundOriginalCfg obj = new LevelGrowthFundOriginalCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, LevelGrowthFundOriginalCfg> all)
/*     */   {
/*  97 */     String path = dir + "mzm.gsp.qingfu.confbean.LevelGrowthFundOriginalCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 109 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.qingfu.confbean.LevelGrowthFundOriginalCfg"))
/*     */         {
/*     */ 
/* 112 */           LevelGrowthFundOriginalCfg obj = new LevelGrowthFundOriginalCfg();
...
/*     */     
/* 128 */     String path = dir + "mzm.gsp.qingfu.confbean.LevelGrowthFundOriginalCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 155 */           LevelGrowthFundOriginalCfg _v_ = new LevelGrowthFundOriginalCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, LevelGrowthFundOriginalCfg> all)
/*     */   {
/* 175 */     String path = dir + "mzm.gsp.qingfu.confbean.LevelGrowthFundOriginalCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 202 */           LevelGrowthFundOriginalCfg _v_ = new LevelGrowthFundOriginalCfg();
...
/*     */ 
/*     */ 
/*     */   public static LevelGrowthFundOriginalCfg getOld(int key)
/*     */   {
/* 223 */     return (LevelGrowthFundOriginalCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static LevelGrowthFundOriginalCfg get(int key)
/*     */   {
/* 228 */     return (LevelGrowthFundOriginalCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, LevelGrowthFundOriginalCfg> getOldAll()
/*     */   {
/* 233 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, LevelGrowthFundOriginalCfg> getAll()
/*     */   {
/* 238 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, LevelGrowthFundOriginalCfg> newAll)
/*     */   {
/* 243 */     oldAll = all;
/* 244 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\qingfu\confbean\LevelGrowthFundOriginalCfg.class
