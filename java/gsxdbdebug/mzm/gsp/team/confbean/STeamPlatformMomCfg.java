...
/*     */ 
/*     */ public class STeamPlatformMomCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, STeamPlatformMomCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, STeamPlatformMomCfg> all = null;
/*     */   
/*     */   public int id;
...
/*     */   public int newGuyNum;
/*  24 */   public java.util.ArrayList<Integer> occupationFristList = new java.util.ArrayList();
/*     */   public int occupationFristCount;
/*     */   public int activityCfgId;
/*     */   public boolean canAIMatch;
/*     */   
...
/*  34 */     this.matchType = Integer.valueOf(rootElement.attributeValue("matchType")).intValue();
/*  35 */     this.activityId = Integer.valueOf(rootElement.attributeValue("activityId")).intValue();
/*  36 */     this.newGuyNum = Integer.valueOf(rootElement.attributeValue("newGuyNum")).intValue();
/*     */     
/*  38 */     Element collectionElement = util.XmlHelper.getVariableElement(rootElement, "occupationFristList");
...
/*     */         }
/*     */         
/*  63 */         this.occupationFristList.add(Integer.valueOf(_v_));
/*     */       }
/*     */     }
/*  66 */     this.occupationFristCount = Integer.valueOf(rootElement.attributeValue("occupationFristCount")).intValue();
/*  67 */     this.activityCfgId = Integer.valueOf(rootElement.attributeValue("activityCfgId")).intValue();
/*  68 */     this.canAIMatch = Boolean.valueOf(rootElement.attributeValue("canAIMatch")).booleanValue();
/*     */   }
/*     */   
...
/*  75 */     _os_.marshal(this.name, "UTF-8");
/*  76 */     _os_.marshal(this.matchType);
/*  77 */     _os_.marshal(this.activityId);
/*  78 */     _os_.marshal(this.newGuyNum);
/*  79 */     _os_.compact_uint32(this.occupationFristList.size());
/*  80 */     for (Integer _v_ : this.occupationFristList)
/*     */     {
/*  82 */       _os_.marshal(_v_.intValue());
/*     */     }
/*  84 */     _os_.marshal(this.occupationFristCount);
/*  85 */     _os_.marshal(this.activityCfgId);
/*  86 */     _os_.marshal(this.canAIMatch);
/*  87 */     return _os_;
/*     */   }
/*     */   
...
/*  94 */     this.name = _os_.unmarshal_String("UTF-8");
/*  95 */     this.matchType = _os_.unmarshal_int();
/*  96 */     this.activityId = _os_.unmarshal_int();
/*  97 */     this.newGuyNum = _os_.unmarshal_int();
/*  98 */     for (int _size_ = _os_.uncompact_uint32(); _size_ > 0; _size_--)
/*     */     {
/*     */ 
/* 101 */       int _v_ = _os_.unmarshal_int();
/* 102 */       this.occupationFristList.add(Integer.valueOf(_v_));
/*     */     }
/* 104 */     this.occupationFristCount = _os_.unmarshal_int();
/* 105 */     this.activityCfgId = _os_.unmarshal_int();
/* 106 */     this.canAIMatch = _os_.unmarshal_boolean();
/* 107 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/* 112 */     String path = dir + "mzm.gsp.team.confbean.STeamPlatformMomCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 125 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.team.confbean.STeamPlatformMomCfg"))
/*     */         {
/*     */ 
/* 128 */           STeamPlatformMomCfg obj = new STeamPlatformMomCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, STeamPlatformMomCfg> all)
/*     */   {
/* 142 */     String path = dir + "mzm.gsp.team.confbean.STeamPlatformMomCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 154 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.team.confbean.STeamPlatformMomCfg"))
/*     */         {
/*     */ 
/* 157 */           STeamPlatformMomCfg obj = new STeamPlatformMomCfg();
...
/*     */     
/* 173 */     String path = dir + "mzm.gsp.team.confbean.STeamPlatformMomCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 200 */           STeamPlatformMomCfg _v_ = new STeamPlatformMomCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, STeamPlatformMomCfg> all)
/*     */   {
/* 220 */     String path = dir + "mzm.gsp.team.confbean.STeamPlatformMomCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 247 */           STeamPlatformMomCfg _v_ = new STeamPlatformMomCfg();
...
/*     */ 
/*     */ 
/*     */   public static STeamPlatformMomCfg getOld(int key)
/*     */   {
/* 268 */     return (STeamPlatformMomCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static STeamPlatformMomCfg get(int key)
/*     */   {
/* 273 */     return (STeamPlatformMomCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, STeamPlatformMomCfg> getOldAll()
/*     */   {
/* 278 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, STeamPlatformMomCfg> getAll()
/*     */   {
/* 283 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, STeamPlatformMomCfg> newAll)
/*     */   {
/* 288 */     oldAll = all;
/* 289 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\team\confbean\STeamPlatformMomCfg.class
