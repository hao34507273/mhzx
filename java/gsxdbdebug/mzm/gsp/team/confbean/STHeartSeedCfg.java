...
/*     */ 
/*     */ public class STHeartSeedCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, STHeartSeedCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, STHeartSeedCfg> all = null;
/*     */   
/*     */   public int lvMin;
/*  19 */   public HashMap<Integer, Integer> lvMax = new HashMap();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.lvMin = Integer.valueOf(rootElement.attributeValue("lvMin")).intValue();
/*     */     
/*  25 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "lvMax");
...
/*     */         }
/*     */         
/*  76 */         this.lvMax.put(Integer.valueOf(_k_), Integer.valueOf(_v_));
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*     */   {
/*  83 */     _os_.marshal(this.lvMin);
/*  84 */     _os_.compact_uint32(this.lvMax.size());
/*  85 */     for (java.util.Map.Entry<Integer, Integer> _e_ : this.lvMax.entrySet())
/*     */     {
...
/*     */   {
/*  95 */     this.lvMin = _os_.unmarshal_int();
...
/* 102 */       this.lvMax.put(Integer.valueOf(_k_), Integer.valueOf(_v_));
/*     */     }
/* 104 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/* 109 */     String path = dir + "mzm.gsp.team.confbean.STHeartSeedCfg.xml";
/*     */     
/*     */     try
/*     */     {
/* 113 */       all = new HashMap();
...
/* 122 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.team.confbean.STHeartSeedCfg"))
/*     */         {
/*     */ 
/* 125 */           STHeartSeedCfg obj = new STHeartSeedCfg();
/* 126 */           obj.loadFromXml(elem);
/* 127 */           if (all.put(Integer.valueOf(obj.lvMin), obj) != null) {
/* 128 */             throw new RuntimeException("duplicate key : " + obj.lvMin);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, STHeartSeedCfg> all)
/*     */   {
/* 139 */     String path = dir + "mzm.gsp.team.confbean.STHeartSeedCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 151 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.team.confbean.STHeartSeedCfg"))
/*     */         {
/*     */ 
/* 154 */           STHeartSeedCfg obj = new STHeartSeedCfg();
/* 155 */           obj.loadFromXml(elem);
/* 156 */           if (all.put(Integer.valueOf(obj.lvMin), obj) != null) {
/* 157 */             throw new RuntimeException("duplicate key : " + obj.lvMin);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/* 168 */     all = new HashMap();
/*     */     
/* 170 */     String path = dir + "mzm.gsp.team.confbean.STHeartSeedCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 197 */           STHeartSeedCfg _v_ = new STHeartSeedCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, STHeartSeedCfg> all)
/*     */   {
/* 217 */     String path = dir + "mzm.gsp.team.confbean.STHeartSeedCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 244 */           STHeartSeedCfg _v_ = new STHeartSeedCfg();
...
/*     */ 
/*     */ 
/*     */   public static STHeartSeedCfg getOld(int key)
/*     */   {
/* 265 */     return (STHeartSeedCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static STHeartSeedCfg get(int key)
/*     */   {
/* 270 */     return (STHeartSeedCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, STHeartSeedCfg> getOldAll()
/*     */   {
/* 275 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, STHeartSeedCfg> getAll()
/*     */   {
/* 280 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, STHeartSeedCfg> newAll)
/*     */   {
/* 285 */     oldAll = all;
/* 286 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\team\confbean\STHeartSeedCfg.class
