...
/*     */ 
/*     */ public class STeamHeartSeedCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, STeamHeartSeedCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, STeamHeartSeedCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public int lvMin;
/*     */   public int lvMax;
...
/*  26 */     this.lvMin = Integer.valueOf(rootElement.attributeValue("lvMin")).intValue();
/*  27 */     this.lvMax = Integer.valueOf(rootElement.attributeValue("lvMax")).intValue();
/*  28 */     this.ranSeed = Integer.valueOf(rootElement.attributeValue("ranSeed")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  33 */     _os_.marshal(this.id);
/*  34 */     _os_.marshal(this.lvMin);
/*  35 */     _os_.marshal(this.lvMax);
/*  36 */     _os_.marshal(this.ranSeed);
/*  37 */     return _os_;
/*     */   }
/*     */   
...
/*  43 */     this.lvMin = _os_.unmarshal_int();
/*  44 */     this.lvMax = _os_.unmarshal_int();
/*  45 */     this.ranSeed = _os_.unmarshal_int();
/*  46 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  51 */     String path = dir + "mzm.gsp.team.confbean.STeamHeartSeedCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  64 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.team.confbean.STeamHeartSeedCfg"))
/*     */         {
/*     */ 
/*  67 */           STeamHeartSeedCfg obj = new STeamHeartSeedCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, STeamHeartSeedCfg> all)
/*     */   {
/*  81 */     String path = dir + "mzm.gsp.team.confbean.STeamHeartSeedCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.team.confbean.STeamHeartSeedCfg"))
/*     */         {
/*     */ 
/*  96 */           STeamHeartSeedCfg obj = new STeamHeartSeedCfg();
...
/*     */     
/* 112 */     String path = dir + "mzm.gsp.team.confbean.STeamHeartSeedCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 139 */           STeamHeartSeedCfg _v_ = new STeamHeartSeedCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, STeamHeartSeedCfg> all)
/*     */   {
/* 159 */     String path = dir + "mzm.gsp.team.confbean.STeamHeartSeedCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 186 */           STeamHeartSeedCfg _v_ = new STeamHeartSeedCfg();
...
/*     */ 
/*     */ 
/*     */   public static STeamHeartSeedCfg getOld(int key)
/*     */   {
/* 207 */     return (STeamHeartSeedCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static STeamHeartSeedCfg get(int key)
/*     */   {
/* 212 */     return (STeamHeartSeedCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, STeamHeartSeedCfg> getOldAll()
/*     */   {
/* 217 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, STeamHeartSeedCfg> getAll()
/*     */   {
/* 222 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, STeamHeartSeedCfg> newAll)
/*     */   {
/* 227 */     oldAll = all;
/* 228 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\team\confbean\STeamHeartSeedCfg.class
