...
/*     */ 
/*     */ public class STeamPlatformChildCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, STeamPlatformChildCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, STeamPlatformChildCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public String templatename;
/*  20 */   public java.util.ArrayList<OpertionCfg> opertionCfgList = new java.util.ArrayList();
/*     */   
...
/*     */     
/*  27 */     Element collectionElement = util.XmlHelper.getVariableElement(rootElement, "opertionCfgList");
...
/*  38 */       if (elem.getName().equalsIgnoreCase("mzm.gsp.team.confbean.OpertionCfg"))
/*     */       {
/*     */         OpertionCfg _v_;
/*     */         
/*     */ 
...
/*     */         }
/*     */         
/*  53 */         this.opertionCfgList.add(_v_);
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*  62 */     _os_.compact_uint32(this.opertionCfgList.size());
/*  63 */     for (OpertionCfg _v_ : this.opertionCfgList)
/*     */     {
/*  65 */       _os_.marshal(_v_);
/*     */     }
/*  67 */     return _os_;
...
/*     */     {
/*     */ 
/*  77 */       OpertionCfg _v_ = new OpertionCfg();
/*  78 */       _v_.unmarshal(_os_);
/*  79 */       this.opertionCfgList.add(_v_);
/*     */     }
/*  81 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/*  86 */     String path = dir + "mzm.gsp.team.confbean.STeamPlatformChildCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  99 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.team.confbean.STeamPlatformChildCfg"))
/*     */         {
/*     */ 
/* 102 */           STeamPlatformChildCfg obj = new STeamPlatformChildCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, STeamPlatformChildCfg> all)
/*     */   {
/* 116 */     String path = dir + "mzm.gsp.team.confbean.STeamPlatformChildCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 128 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.team.confbean.STeamPlatformChildCfg"))
/*     */         {
/*     */ 
/* 131 */           STeamPlatformChildCfg obj = new STeamPlatformChildCfg();
...
/*     */     
/* 147 */     String path = dir + "mzm.gsp.team.confbean.STeamPlatformChildCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 174 */           STeamPlatformChildCfg _v_ = new STeamPlatformChildCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, STeamPlatformChildCfg> all)
/*     */   {
/* 194 */     String path = dir + "mzm.gsp.team.confbean.STeamPlatformChildCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 221 */           STeamPlatformChildCfg _v_ = new STeamPlatformChildCfg();
...
/*     */ 
/*     */ 
/*     */   public static STeamPlatformChildCfg getOld(int key)
/*     */   {
/* 242 */     return (STeamPlatformChildCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static STeamPlatformChildCfg get(int key)
/*     */   {
/* 247 */     return (STeamPlatformChildCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, STeamPlatformChildCfg> getOldAll()
/*     */   {
/* 252 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, STeamPlatformChildCfg> getAll()
/*     */   {
/* 257 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, STeamPlatformChildCfg> newAll)
/*     */   {
/* 262 */     oldAll = all;
/* 263 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\team\confbean\STeamPlatformChildCfg.class
