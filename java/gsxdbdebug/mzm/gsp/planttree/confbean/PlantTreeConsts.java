...
/*     */ 
/*     */ public class PlantTreeConsts
/*     */ {
/*  13 */   private static volatile PlantTreeConsts oldInstance = null;
/*     */   
/*  15 */   private static PlantTreeConsts instance = new PlantTreeConsts();
/*     */   
/*     */ 
/*     */   public int MAX_LOG_NUM;
/*     */   
/*     */ 
/*     */   public static PlantTreeConsts getOldInstance()
/*     */   {
/*  23 */     return oldInstance;
/*     */   }
/*     */   
/*     */   public static PlantTreeConsts getInstance()
/*     */   {
/*  28 */     return instance;
/*     */   }
/*     */   
...
/*     */   {
/*  40 */     String path = dir + "mzm.gsp.planttree.confbean.PlantTreeConsts.xml";
/*     */     try
/*     */     {
...
/*     */         }
/*     */       }
/*  60 */       this.MAX_LOG_NUM = Integer.valueOf(((Element)data.get("MAX_LOG_NUM")).attributeValue("value")).intValue();
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*  69 */     String path = dir + "mzm.gsp.planttree.confbean.PlantTreeConsts.xml";
/*     */     try
/*     */     {
...
/*     */         }
/*     */       }
/*  89 */       this.MAX_LOG_NUM = Integer.valueOf(((Element)data.get("MAX_LOG_NUM")).attributeValue("value")).intValue();
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/* 100 */     String path = dir + "mzm.gsp.planttree.confbean.PlantTreeConsts.bny";
/*     */     try
/*     */     {
...
/* 115 */         this.MAX_LOG_NUM = _os_.unmarshal_int();
/*     */       }
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*     */   {
/* 126 */     String path = dir + "mzm.gsp.planttree.confbean.PlantTreeConsts.bny";
/*     */     try
/*     */     {
...
/* 141 */         this.MAX_LOG_NUM = _os_.unmarshal_int();
/*     */       }
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*     */   }
/*     */   
/*     */   public static void setInstance(PlantTreeConsts newInstance)
/*     */   {
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\planttree\confbean\PlantTreeConsts.class
