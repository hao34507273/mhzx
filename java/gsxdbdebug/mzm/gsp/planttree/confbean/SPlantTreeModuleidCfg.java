...
/*     */ 
/*     */ public class SPlantTreeModuleidCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SPlantTreeModuleidCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SPlantTreeModuleidCfg> all = null;
/*     */   
/*     */   public int moduleid;
...
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.planttree.confbean.SPlantTreeModuleidCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.planttree.confbean.SPlantTreeModuleidCfg"))
/*     */         {
/*     */ 
/*  59 */           SPlantTreeModuleidCfg obj = new SPlantTreeModuleidCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SPlantTreeModuleidCfg> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.planttree.confbean.SPlantTreeModuleidCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.planttree.confbean.SPlantTreeModuleidCfg"))
/*     */         {
/*     */ 
/*  88 */           SPlantTreeModuleidCfg obj = new SPlantTreeModuleidCfg();
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.planttree.confbean.SPlantTreeModuleidCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           SPlantTreeModuleidCfg _v_ = new SPlantTreeModuleidCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SPlantTreeModuleidCfg> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.planttree.confbean.SPlantTreeModuleidCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           SPlantTreeModuleidCfg _v_ = new SPlantTreeModuleidCfg();
...
/*     */ 
/*     */ 
/*     */   public static SPlantTreeModuleidCfg getOld(int key)
/*     */   {
/* 199 */     return (SPlantTreeModuleidCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SPlantTreeModuleidCfg get(int key)
/*     */   {
/* 204 */     return (SPlantTreeModuleidCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPlantTreeModuleidCfg> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPlantTreeModuleidCfg> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SPlantTreeModuleidCfg> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\planttree\confbean\SPlantTreeModuleidCfg.class
