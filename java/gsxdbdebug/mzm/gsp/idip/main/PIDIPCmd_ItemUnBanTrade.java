...
/*    */ 
/*    */ public class PIDIPCmd_ItemUnBanTrade extends PIDIPCmd_GeneralCommandReq
/*    */ {
...
/*    */       {
/* 20 */         return new PIDIPCmd_ItemUnBanTrade(cmd);
/*    */       }
/*    */     };
/*    */   }
/*    */   
/*    */   public PIDIPCmd_ItemUnBanTrade(IDIPCmd_GeneralCommandReq cmd)
/*    */   {
/* 27 */     super(cmd);
/*    */   }
/*    */   
...
/*    */     {
/* 39 */       boolean result = mzm.gsp.item.main.ItemBanTrade.getInstance().unBanTrade(tradeType, id);
/*    */       
/* 41 */       if (result)
/*    */       {
...
/* 44 */         ((IDIPPacket_GeneralCommandRsp)((IDIPCmd_GeneralCommandReq)this.cmd).rsp).head.RetErrMsg = (((GeneralCommandRsp)((IDIPPacket_GeneralCommandRsp)((IDIPCmd_GeneralCommandReq)this.cmd).rsp).body).RetMsg = String.format("unBanTrade tradeType=%d, id=%d", new Object[] { Integer.valueOf(tradeType), Integer.valueOf(id) }));
/*    */ 
/*    */       }
/*    */       else
/*    */       {
...
/*    */     
/* 61 */     mzm.gsp.GameServer.logger().info(String.format("[idip]PIDIPCmd_ItemUnBanTrade.executeCmd@unban trade done|ret=%d|retMsg=%s|area_id=%d|plat_id=%d|partition=%d|tradeType=%d|id=%d", new Object[] { Integer.valueOf(((IDIPPacket_GeneralCommandRsp)((IDIPCmd_GeneralCommandReq)this.cmd).rsp).head.Result), ((IDIPPacket_GeneralCommandRsp)((IDIPCmd_GeneralCommandReq)this.cmd).rsp).head.RetErrMsg, Integer.valueOf(((GeneralCommandReq)((IDIPPacket_GeneralCommandReq)((IDIPCmd_GeneralCommandReq)this.cmd).req).body).AreaId), Byte.valueOf(((GeneralCommandReq)((IDIPPacket_GeneralCommandReq)((IDIPCmd_GeneralCommandReq)this.cmd).req).body).PlatId), Integer.valueOf(((GeneralCommandReq)((IDIPPacket_GeneralCommandReq)((IDIPCmd_GeneralCommandReq)this.cmd).req).body).Partition), Integer.valueOf(tradeType), Integer.valueOf(id) }));
/*    */     
/*    */ 
/*    */ 
/*    */ 
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\idip\main\PIDIPCmd_ItemUnBanTrade.class
