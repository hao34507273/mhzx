...
/*     */ 
/*     */ public class SChartCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SChartCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SChartCfg> all = null;
/*     */   
/*     */   public int id;
/*  19 */   public java.util.ArrayList<Integer> subTypeList = new java.util.ArrayList();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.id = Integer.valueOf(rootElement.attributeValue("id")).intValue();
/*     */     
/*  25 */     Element collectionElement = util.XmlHelper.getVariableElement(rootElement, "subTypeList");
...
/*     */         }
/*     */         
/*  50 */         this.subTypeList.add(Integer.valueOf(_v_));
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*  58 */     _os_.compact_uint32(this.subTypeList.size());
/*  59 */     for (Integer _v_ : this.subTypeList)
/*     */     {
...
/*  73 */       this.subTypeList.add(Integer.valueOf(_v_));
/*     */     }
/*  75 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/*  80 */     String path = dir + "mzm.gsp.chart.confbean.SChartCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.chart.confbean.SChartCfg"))
/*     */         {
/*     */ 
/*  96 */           SChartCfg obj = new SChartCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SChartCfg> all)
/*     */   {
/* 110 */     String path = dir + "mzm.gsp.chart.confbean.SChartCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 122 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.chart.confbean.SChartCfg"))
/*     */         {
/*     */ 
/* 125 */           SChartCfg obj = new SChartCfg();
...
/*     */     
/* 141 */     String path = dir + "mzm.gsp.chart.confbean.SChartCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 168 */           SChartCfg _v_ = new SChartCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SChartCfg> all)
/*     */   {
/* 188 */     String path = dir + "mzm.gsp.chart.confbean.SChartCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 215 */           SChartCfg _v_ = new SChartCfg();
...
/*     */ 
/*     */ 
/*     */   public static SChartCfg getOld(int key)
/*     */   {
/* 236 */     return (SChartCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SChartCfg get(int key)
/*     */   {
/* 241 */     return (SChartCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SChartCfg> getOldAll()
/*     */   {
/* 246 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SChartCfg> getAll()
/*     */   {
/* 251 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SChartCfg> newAll)
/*     */   {
/* 256 */     oldAll = all;
/* 257 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\chart\confbean\SChartCfg.class
