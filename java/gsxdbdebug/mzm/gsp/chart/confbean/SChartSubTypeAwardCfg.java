...
/*     */ 
/*     */ public class SChartSubTypeAwardCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SChartSubTypeAwardCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SChartSubTypeAwardCfg> all = null;
/*     */   
/*     */   public int chartType;
/*  19 */   public TreeMap<Integer, RankAwardBean> awardMap = new TreeMap();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.chartType = Integer.valueOf(rootElement.attributeValue("chartType")).intValue();
/*     */     
/*  25 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "awardMap");
...
/*  51 */             keyElem = elem;
/*     */           }
/*  53 */           else if ((valueElem == null) && (elem.getName().equalsIgnoreCase("mzm.gsp.chart.confbean.RankAwardBean")))
/*     */           {
/*  55 */             valueElem = elem;
/*     */           }
/*     */         }
...
/*     */         }
/*     */         
/*  77 */         this.awardMap.put(Integer.valueOf(_k_), _v_);
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*     */   {
/*  84 */     _os_.marshal(this.chartType);
/*  85 */     _os_.compact_uint32(this.awardMap.size());
/*  86 */     for (java.util.Map.Entry<Integer, RankAwardBean> _e_ : this.awardMap.entrySet())
/*     */     {
...
/*     */   {
/*  96 */     this.chartType = _os_.unmarshal_int();
/*  97 */     for (int _size_ = _os_.uncompact_uint32(); _size_ > 0; _size_--)
/*     */     {
/*     */ 
/* 100 */       int _k_ = _os_.unmarshal_int();
/*     */       
/* 102 */       RankAwardBean _v_ = new RankAwardBean();
/* 103 */       _v_.unmarshal(_os_);
/* 104 */       this.awardMap.put(Integer.valueOf(_k_), _v_);
/*     */     }
/* 106 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/* 111 */     String path = dir + "mzm.gsp.chart.confbean.SChartSubTypeAwardCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 124 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.chart.confbean.SChartSubTypeAwardCfg"))
/*     */         {
/*     */ 
/* 127 */           SChartSubTypeAwardCfg obj = new SChartSubTypeAwardCfg();
/* 128 */           obj.loadFromXml(elem);
/* 129 */           if (all.put(Integer.valueOf(obj.chartType), obj) != null) {
/* 130 */             throw new RuntimeException("duplicate key : " + obj.chartType);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SChartSubTypeAwardCfg> all)
/*     */   {
/* 141 */     String path = dir + "mzm.gsp.chart.confbean.SChartSubTypeAwardCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 153 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.chart.confbean.SChartSubTypeAwardCfg"))
/*     */         {
/*     */ 
/* 156 */           SChartSubTypeAwardCfg obj = new SChartSubTypeAwardCfg();
/* 157 */           obj.loadFromXml(elem);
/* 158 */           if (all.put(Integer.valueOf(obj.chartType), obj) != null) {
/* 159 */             throw new RuntimeException("duplicate key : " + obj.chartType);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 172 */     String path = dir + "mzm.gsp.chart.confbean.SChartSubTypeAwardCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 199 */           SChartSubTypeAwardCfg _v_ = new SChartSubTypeAwardCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SChartSubTypeAwardCfg> all)
/*     */   {
/* 219 */     String path = dir + "mzm.gsp.chart.confbean.SChartSubTypeAwardCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 246 */           SChartSubTypeAwardCfg _v_ = new SChartSubTypeAwardCfg();
...
/*     */ 
/*     */ 
/*     */   public static SChartSubTypeAwardCfg getOld(int key)
/*     */   {
/* 267 */     return (SChartSubTypeAwardCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SChartSubTypeAwardCfg get(int key)
/*     */   {
/* 272 */     return (SChartSubTypeAwardCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SChartSubTypeAwardCfg> getOldAll()
/*     */   {
/* 277 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SChartSubTypeAwardCfg> getAll()
/*     */   {
/* 282 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SChartSubTypeAwardCfg> newAll)
/*     */   {
/* 287 */     oldAll = all;
/* 288 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\chart\confbean\SChartSubTypeAwardCfg.class
