...
/*     */ 
/*     */ public class SChartTempSubTypeAwardCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SChartTempSubTypeAwardCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SChartTempSubTypeAwardCfg> all = null;
/*     */   
/*     */   public int id;
...
/*  28 */     this.chartType = Integer.valueOf(rootElement.attributeValue("chartType")).intValue();
...
/*  31 */     this.awardHonorid = Integer.valueOf(rootElement.attributeValue("awardHonorid")).intValue();
/*  32 */     this.rankMail = Integer.valueOf(rootElement.attributeValue("rankMail")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  37 */     _os_.marshal(this.id);
/*  38 */     _os_.marshal(this.chartType);
/*  39 */     _os_.marshal(this.rank);
/*  40 */     _os_.marshal(this.awardid);
/*  41 */     _os_.marshal(this.awardHonorid);
/*  42 */     _os_.marshal(this.rankMail);
/*  43 */     return _os_;
/*     */   }
/*     */   
...
/*  49 */     this.chartType = _os_.unmarshal_int();
/*  50 */     this.rank = _os_.unmarshal_int();
/*  51 */     this.awardid = _os_.unmarshal_int();
/*  52 */     this.awardHonorid = _os_.unmarshal_int();
/*  53 */     this.rankMail = _os_.unmarshal_int();
/*  54 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  59 */     String path = dir + "mzm.gsp.chart.confbean.SChartTempSubTypeAwardCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  72 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.chart.confbean.SChartTempSubTypeAwardCfg"))
/*     */         {
/*     */ 
/*  75 */           SChartTempSubTypeAwardCfg obj = new SChartTempSubTypeAwardCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SChartTempSubTypeAwardCfg> all)
/*     */   {
/*  89 */     String path = dir + "mzm.gsp.chart.confbean.SChartTempSubTypeAwardCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 101 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.chart.confbean.SChartTempSubTypeAwardCfg"))
/*     */         {
/*     */ 
/* 104 */           SChartTempSubTypeAwardCfg obj = new SChartTempSubTypeAwardCfg();
...
/*     */     
/* 120 */     String path = dir + "mzm.gsp.chart.confbean.SChartTempSubTypeAwardCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 147 */           SChartTempSubTypeAwardCfg _v_ = new SChartTempSubTypeAwardCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SChartTempSubTypeAwardCfg> all)
/*     */   {
/* 167 */     String path = dir + "mzm.gsp.chart.confbean.SChartTempSubTypeAwardCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 194 */           SChartTempSubTypeAwardCfg _v_ = new SChartTempSubTypeAwardCfg();
...
/*     */ 
/*     */ 
/*     */   public static SChartTempSubTypeAwardCfg getOld(int key)
/*     */   {
/* 215 */     return (SChartTempSubTypeAwardCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SChartTempSubTypeAwardCfg get(int key)
/*     */   {
/* 220 */     return (SChartTempSubTypeAwardCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SChartTempSubTypeAwardCfg> getOldAll()
/*     */   {
/* 225 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SChartTempSubTypeAwardCfg> getAll()
/*     */   {
/* 230 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SChartTempSubTypeAwardCfg> newAll)
/*     */   {
/* 235 */     oldAll = all;
/* 236 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\chart\confbean\SChartTempSubTypeAwardCfg.class
