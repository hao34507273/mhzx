...
/*     */ 
/*     */ public class SAFKDetectConsts
/*     */ {
/*  13 */   private static volatile SAFKDetectConsts oldInstance = null;
/*     */   
/*  15 */   private static SAFKDetectConsts instance = new SAFKDetectConsts();
/*     */   
/*     */ 
/*     */   public int DETECT_INTERVAL_IN_SECOND;
/*     */   
/*     */ 
/*     */   public static SAFKDetectConsts getOldInstance()
/*     */   {
/*  23 */     return oldInstance;
/*     */   }
/*     */   
/*     */   public static SAFKDetectConsts getInstance()
/*     */   {
/*  28 */     return instance;
/*     */   }
/*     */   
...
/*     */   {
/*  40 */     String path = dir + "mzm.gsp.afk.confbean.SAFKDetectConsts.xml";
/*     */     try
/*     */     {
...
/*     */         }
/*     */       }
/*  60 */       this.DETECT_INTERVAL_IN_SECOND = Integer.valueOf(((Element)data.get("DETECT_INTERVAL_IN_SECOND")).attributeValue("value")).intValue();
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*  69 */     String path = dir + "mzm.gsp.afk.confbean.SAFKDetectConsts.xml";
/*     */     try
/*     */     {
...
/*     */         }
/*     */       }
/*  89 */       this.DETECT_INTERVAL_IN_SECOND = Integer.valueOf(((Element)data.get("DETECT_INTERVAL_IN_SECOND")).attributeValue("value")).intValue();
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/* 100 */     String path = dir + "mzm.gsp.afk.confbean.SAFKDetectConsts.bny";
/*     */     try
/*     */     {
...
/* 115 */         this.DETECT_INTERVAL_IN_SECOND = _os_.unmarshal_int();
/*     */       }
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*     */   {
/* 126 */     String path = dir + "mzm.gsp.afk.confbean.SAFKDetectConsts.bny";
/*     */     try
/*     */     {
...
/* 141 */         this.DETECT_INTERVAL_IN_SECOND = _os_.unmarshal_int();
/*     */       }
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*     */   }
/*     */   
/*     */   public static void setInstance(SAFKDetectConsts newInstance)
/*     */   {
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\afk\confbean\SAFKDetectConsts.class
