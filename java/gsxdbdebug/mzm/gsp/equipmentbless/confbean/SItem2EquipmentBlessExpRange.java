...
/*    */ 
/*    */ public class SItem2EquipmentBlessExpRange implements com.goldhuman.Common.Marshal.Marshal
/*    */ {
/*  9 */   public HashMap<Integer, SEquipmentBlessExpRanges> item2range = new HashMap();
/*    */   
/*    */ 
/*    */   public void loadFromXml(Element rootElement)
/*    */   {
/* 14 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "item2range");
...
/* 40 */             keyElem = elem;
/*    */           }
/* 42 */           else if ((valueElem == null) && (elem.getName().equalsIgnoreCase("mzm.gsp.equipmentbless.confbean.SEquipmentBlessExpRanges")))
/*    */           {
/* 44 */             valueElem = elem;
/*    */           }
/*    */         }
...
/*    */         
/*    */         int _k_;
/*    */         SEquipmentBlessExpRanges _v_;
/*    */         try
/*    */         {
/* 57 */           _k_ = Integer.valueOf(keyElem.getText()).intValue();
/* 58 */           _v_ = new SEquipmentBlessExpRanges();
...
/*    */         }
/*    */         
/* 66 */         this.item2range.put(Integer.valueOf(_k_), _v_);
/*    */       }
/*    */     }
/*    */   }
/*    */   
...
/*    */   {
/* 73 */     _os_.compact_uint32(this.item2range.size());
/* 74 */     for (java.util.Map.Entry<Integer, SEquipmentBlessExpRanges> _e_ : this.item2range.entrySet())
/*    */     {
...
/*    */       
/* 89 */       SEquipmentBlessExpRanges _v_ = new SEquipmentBlessExpRanges();
/* 90 */       _v_.unmarshal(_os_);
/* 91 */       this.item2range.put(Integer.valueOf(_k_), _v_);
/*    */     }
/* 93 */     return _os_;
/*    */   }
/*    */ }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\equipmentbless\confbean\SItem2EquipmentBlessExpRange.class
