...
/*     */ 
/*     */ public class SEquipmentBlessExpCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SEquipmentBlessExpCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SEquipmentBlessExpCfg> all = null;
/*     */   
/*     */   public int blessLevel;
/*  19 */   public java.util.ArrayList<EquipmentBlessExpBean> position2bean = new java.util.ArrayList();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.blessLevel = Integer.valueOf(rootElement.attributeValue("blessLevel")).intValue();
/*     */     
/*  25 */     Element collectionElement = util.XmlHelper.getVariableElement(rootElement, "position2bean");
...
/*  36 */       if (elem.getName().equalsIgnoreCase("mzm.gsp.equipmentbless.confbean.EquipmentBlessExpBean"))
/*     */       {
/*     */         EquipmentBlessExpBean _v_;
/*     */         
/*     */ 
/*     */         try
/*     */         {
/*  43 */           _v_ = new EquipmentBlessExpBean();
...
/*  59 */     _os_.compact_uint32(this.position2bean.size());
/*  60 */     for (EquipmentBlessExpBean _v_ : this.position2bean)
/*     */     {
/*  62 */       _os_.marshal(_v_);
/*     */     }
/*  64 */     return _os_;
...
/*     */     {
/*     */ 
/*  73 */       EquipmentBlessExpBean _v_ = new EquipmentBlessExpBean();
/*  74 */       _v_.unmarshal(_os_);
/*  75 */       this.position2bean.add(_v_);
/*     */     }
/*  77 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/*  82 */     String path = dir + "mzm.gsp.equipmentbless.confbean.SEquipmentBlessExpCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  95 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.equipmentbless.confbean.SEquipmentBlessExpCfg"))
/*     */         {
/*     */ 
/*  98 */           SEquipmentBlessExpCfg obj = new SEquipmentBlessExpCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SEquipmentBlessExpCfg> all)
/*     */   {
/* 112 */     String path = dir + "mzm.gsp.equipmentbless.confbean.SEquipmentBlessExpCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 124 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.equipmentbless.confbean.SEquipmentBlessExpCfg"))
/*     */         {
/*     */ 
/* 127 */           SEquipmentBlessExpCfg obj = new SEquipmentBlessExpCfg();
...
/*     */     
/* 143 */     String path = dir + "mzm.gsp.equipmentbless.confbean.SEquipmentBlessExpCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 170 */           SEquipmentBlessExpCfg _v_ = new SEquipmentBlessExpCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SEquipmentBlessExpCfg> all)
/*     */   {
/* 190 */     String path = dir + "mzm.gsp.equipmentbless.confbean.SEquipmentBlessExpCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 217 */           SEquipmentBlessExpCfg _v_ = new SEquipmentBlessExpCfg();
...
/*     */ 
/*     */ 
/*     */   public static SEquipmentBlessExpCfg getOld(int key)
/*     */   {
/* 238 */     return (SEquipmentBlessExpCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SEquipmentBlessExpCfg get(int key)
/*     */   {
/* 243 */     return (SEquipmentBlessExpCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SEquipmentBlessExpCfg> getOldAll()
/*     */   {
/* 248 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SEquipmentBlessExpCfg> getAll()
/*     */   {
/* 253 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SEquipmentBlessExpCfg> newAll)
/*     */   {
/* 258 */     oldAll = all;
/* 259 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\equipmentbless\confbean\SEquipmentBlessExpCfg.class
