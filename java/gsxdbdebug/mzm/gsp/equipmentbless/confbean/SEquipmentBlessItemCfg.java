...
/*     */ 
/*     */ public class SEquipmentBlessItemCfg extends mzm.gsp.item.confbean.SItemCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  15 */   private static volatile Map<Integer, SEquipmentBlessItemCfg> oldAll = null;
/*     */   
/*  17 */   private static Map<Integer, SEquipmentBlessItemCfg> all = null;
/*     */   
/*     */   public int minBlessValue;
/*     */   public int maxBlessValue;
/*     */   
...
/*  37 */     this.minBlessValue = Integer.valueOf(rootElement.attributeValue("minBlessValue")).intValue();
/*  38 */     this.maxBlessValue = Integer.valueOf(rootElement.attributeValue("maxBlessValue")).intValue();
/*     */   }
/*     */   
...
/*  56 */     _os_.marshal(this.minBlessValue);
/*  57 */     _os_.marshal(this.maxBlessValue);
/*  58 */     return _os_;
/*     */   }
/*     */   
...
/*  76 */     this.minBlessValue = _os_.unmarshal_int();
/*  77 */     this.maxBlessValue = _os_.unmarshal_int();
/*  78 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  83 */     String path = dir + "mzm.gsp.equipmentbless.confbean.SEquipmentBlessItemCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  96 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.equipmentbless.confbean.SEquipmentBlessItemCfg"))
/*     */         {
/*     */ 
/*  99 */           SEquipmentBlessItemCfg obj = new SEquipmentBlessItemCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SEquipmentBlessItemCfg> all)
/*     */   {
/* 113 */     String path = dir + "mzm.gsp.equipmentbless.confbean.SEquipmentBlessItemCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 125 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.equipmentbless.confbean.SEquipmentBlessItemCfg"))
/*     */         {
/*     */ 
/* 128 */           SEquipmentBlessItemCfg obj = new SEquipmentBlessItemCfg();
...
/*     */     
/* 144 */     String path = dir + "mzm.gsp.equipmentbless.confbean.SEquipmentBlessItemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 171 */           SEquipmentBlessItemCfg _v_ = new SEquipmentBlessItemCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SEquipmentBlessItemCfg> all)
/*     */   {
/* 191 */     String path = dir + "mzm.gsp.equipmentbless.confbean.SEquipmentBlessItemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 218 */           SEquipmentBlessItemCfg _v_ = new SEquipmentBlessItemCfg();
...
/*     */   {
/* 237 */     for (Map.Entry<Integer, SEquipmentBlessItemCfg> entry : all.entrySet())
/*     */     {
/* 239 */       if (mzm.gsp.item.confbean.SItemCfg.get(((Integer)entry.getKey()).intValue()) != null)
/*     */       {
/* 241 */         throw new RuntimeException("load data failed, have complict key");
/*     */       }
/*     */       
/*     */ 
/* 245 */       mzm.gsp.item.confbean.SItemCfg.getAll().put(entry.getKey(), entry.getValue());
/*     */     }
/*     */   }
/*     */   
/*     */ 
/*     */   public static void handleData(Map<Integer, SEquipmentBlessItemCfg> all, Map<Integer, mzm.gsp.item.confbean.SItemCfg> parent)
/*     */   {
/* 252 */     for (Map.Entry<Integer, SEquipmentBlessItemCfg> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static SEquipmentBlessItemCfg getOld(int key)
/*     */   {
/* 267 */     return (SEquipmentBlessItemCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SEquipmentBlessItemCfg get(int key)
/*     */   {
/* 272 */     return (SEquipmentBlessItemCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SEquipmentBlessItemCfg> getOldAllSelf()
/*     */   {
/* 277 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SEquipmentBlessItemCfg> getAllSelf()
/*     */   {
/* 282 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SEquipmentBlessItemCfg> newAll)
/*     */   {
/* 287 */     oldAll = all;
/* 288 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\equipmentbless\confbean\SEquipmentBlessItemCfg.class
