...
/*     */ 
/*     */ public class SEquipmentBlessProbabilityRawCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SEquipmentBlessProbabilityRawCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SEquipmentBlessProbabilityRawCfg> all = null;
/*     */   
/*     */   public int id;
...
/*  27 */     this.blessLevel = Integer.valueOf(rootElement.attributeValue("blessLevel")).intValue();
/*  28 */     this.position = Integer.valueOf(rootElement.attributeValue("position")).intValue();
/*  29 */     this.itemId = Integer.valueOf(rootElement.attributeValue("itemId")).intValue();
/*  30 */     this.probability = Integer.valueOf(rootElement.attributeValue("probability")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  35 */     _os_.marshal(this.id);
/*  36 */     _os_.marshal(this.blessLevel);
/*  37 */     _os_.marshal(this.position);
/*  38 */     _os_.marshal(this.itemId);
/*  39 */     _os_.marshal(this.probability);
/*  40 */     return _os_;
/*     */   }
/*     */   
...
/*  46 */     this.blessLevel = _os_.unmarshal_int();
/*  47 */     this.position = _os_.unmarshal_int();
/*  48 */     this.itemId = _os_.unmarshal_int();
/*  49 */     this.probability = _os_.unmarshal_int();
/*  50 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  55 */     String path = dir + "mzm.gsp.equipmentbless.confbean.SEquipmentBlessProbabilityRawCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  68 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.equipmentbless.confbean.SEquipmentBlessProbabilityRawCfg"))
/*     */         {
/*     */ 
/*  71 */           SEquipmentBlessProbabilityRawCfg obj = new SEquipmentBlessProbabilityRawCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SEquipmentBlessProbabilityRawCfg> all)
/*     */   {
/*  85 */     String path = dir + "mzm.gsp.equipmentbless.confbean.SEquipmentBlessProbabilityRawCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  97 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.equipmentbless.confbean.SEquipmentBlessProbabilityRawCfg"))
/*     */         {
/*     */ 
/* 100 */           SEquipmentBlessProbabilityRawCfg obj = new SEquipmentBlessProbabilityRawCfg();
...
/*     */     
/* 116 */     String path = dir + "mzm.gsp.equipmentbless.confbean.SEquipmentBlessProbabilityRawCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 143 */           SEquipmentBlessProbabilityRawCfg _v_ = new SEquipmentBlessProbabilityRawCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SEquipmentBlessProbabilityRawCfg> all)
/*     */   {
/* 163 */     String path = dir + "mzm.gsp.equipmentbless.confbean.SEquipmentBlessProbabilityRawCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 190 */           SEquipmentBlessProbabilityRawCfg _v_ = new SEquipmentBlessProbabilityRawCfg();
...
/*     */ 
/*     */ 
/*     */   public static SEquipmentBlessProbabilityRawCfg getOld(int key)
/*     */   {
/* 211 */     return (SEquipmentBlessProbabilityRawCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SEquipmentBlessProbabilityRawCfg get(int key)
/*     */   {
/* 216 */     return (SEquipmentBlessProbabilityRawCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SEquipmentBlessProbabilityRawCfg> getOldAll()
/*     */   {
/* 221 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SEquipmentBlessProbabilityRawCfg> getAll()
/*     */   {
/* 226 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SEquipmentBlessProbabilityRawCfg> newAll)
/*     */   {
/* 231 */     oldAll = all;
/* 232 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\equipmentbless\confbean\SEquipmentBlessProbabilityRawCfg.class
