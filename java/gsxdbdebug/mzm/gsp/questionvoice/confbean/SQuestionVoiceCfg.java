...
/*     */ 
/*     */ public class SQuestionVoiceCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SQuestionVoiceCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SQuestionVoiceCfg> all = null;
/*     */   
/*     */   public int questionType;
/*  19 */   public TreeMap<Integer, SQuestionVoiceBean> id2CfgMap = new TreeMap();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.questionType = Integer.valueOf(rootElement.attributeValue("questionType")).intValue();
/*     */     
/*  25 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "id2CfgMap");
...
/*  51 */             keyElem = elem;
/*     */           }
/*  53 */           else if ((valueElem == null) && (elem.getName().equalsIgnoreCase("mzm.gsp.questionvoice.confbean.SQuestionVoiceBean")))
/*     */           {
/*  55 */             valueElem = elem;
/*     */           }
/*     */         }
...
/*     */         
/*     */         int _k_;
/*     */         SQuestionVoiceBean _v_;
/*     */         try
/*     */         {
/*  68 */           _k_ = Integer.valueOf(keyElem.getText()).intValue();
/*  69 */           _v_ = new SQuestionVoiceBean();
...
/*     */         }
/*     */         
/*  77 */         this.id2CfgMap.put(Integer.valueOf(_k_), _v_);
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*     */   {
/*  84 */     _os_.marshal(this.questionType);
/*  85 */     _os_.compact_uint32(this.id2CfgMap.size());
/*  86 */     for (java.util.Map.Entry<Integer, SQuestionVoiceBean> _e_ : this.id2CfgMap.entrySet())
/*     */     {
...
/*     */   {
/*  96 */     this.questionType = _os_.unmarshal_int();
/*  97 */     for (int _size_ = _os_.uncompact_uint32(); _size_ > 0; _size_--)
/*     */     {
/*     */ 
/* 100 */       int _k_ = _os_.unmarshal_int();
/*     */       
/* 102 */       SQuestionVoiceBean _v_ = new SQuestionVoiceBean();
/* 103 */       _v_.unmarshal(_os_);
/* 104 */       this.id2CfgMap.put(Integer.valueOf(_k_), _v_);
/*     */     }
/* 106 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/* 111 */     String path = dir + "mzm.gsp.questionvoice.confbean.SQuestionVoiceCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 124 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.questionvoice.confbean.SQuestionVoiceCfg"))
/*     */         {
/*     */ 
/* 127 */           SQuestionVoiceCfg obj = new SQuestionVoiceCfg();
/* 128 */           obj.loadFromXml(elem);
/* 129 */           if (all.put(Integer.valueOf(obj.questionType), obj) != null) {
/* 130 */             throw new RuntimeException("duplicate key : " + obj.questionType);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SQuestionVoiceCfg> all)
/*     */   {
/* 141 */     String path = dir + "mzm.gsp.questionvoice.confbean.SQuestionVoiceCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 153 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.questionvoice.confbean.SQuestionVoiceCfg"))
/*     */         {
/*     */ 
/* 156 */           SQuestionVoiceCfg obj = new SQuestionVoiceCfg();
/* 157 */           obj.loadFromXml(elem);
/* 158 */           if (all.put(Integer.valueOf(obj.questionType), obj) != null) {
/* 159 */             throw new RuntimeException("duplicate key : " + obj.questionType);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 172 */     String path = dir + "mzm.gsp.questionvoice.confbean.SQuestionVoiceCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 199 */           SQuestionVoiceCfg _v_ = new SQuestionVoiceCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SQuestionVoiceCfg> all)
/*     */   {
/* 219 */     String path = dir + "mzm.gsp.questionvoice.confbean.SQuestionVoiceCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 246 */           SQuestionVoiceCfg _v_ = new SQuestionVoiceCfg();
...
/*     */ 
/*     */ 
/*     */   public static SQuestionVoiceCfg getOld(int key)
/*     */   {
/* 267 */     return (SQuestionVoiceCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SQuestionVoiceCfg get(int key)
/*     */   {
/* 272 */     return (SQuestionVoiceCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SQuestionVoiceCfg> getOldAll()
/*     */   {
/* 277 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SQuestionVoiceCfg> getAll()
/*     */   {
/* 282 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SQuestionVoiceCfg> newAll)
/*     */   {
/* 287 */     oldAll = all;
/* 288 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\questionvoice\confbean\SQuestionVoiceCfg.class
