...
/*     */ 
/*     */ public class SOpenId2ActivityId implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SOpenId2ActivityId> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SOpenId2ActivityId> all = null;
/*     */   
/*     */   public int openId;
...
/*     */   {
/*  23 */     this.openId = Integer.valueOf(rootElement.attributeValue("openId")).intValue();
...
/*     */   {
/*  36 */     this.openId = _os_.unmarshal_int();
...
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.questionvoice.confbean.SOpenId2ActivityId.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.questionvoice.confbean.SOpenId2ActivityId"))
/*     */         {
/*     */ 
/*  59 */           SOpenId2ActivityId obj = new SOpenId2ActivityId();
/*  60 */           obj.loadFromXml(elem);
/*  61 */           if (all.put(Integer.valueOf(obj.openId), obj) != null) {
/*  62 */             throw new RuntimeException("duplicate key : " + obj.openId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SOpenId2ActivityId> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.questionvoice.confbean.SOpenId2ActivityId.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.questionvoice.confbean.SOpenId2ActivityId"))
/*     */         {
/*     */ 
/*  88 */           SOpenId2ActivityId obj = new SOpenId2ActivityId();
/*  89 */           obj.loadFromXml(elem);
/*  90 */           if (all.put(Integer.valueOf(obj.openId), obj) != null) {
/*  91 */             throw new RuntimeException("duplicate key : " + obj.openId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.questionvoice.confbean.SOpenId2ActivityId.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           SOpenId2ActivityId _v_ = new SOpenId2ActivityId();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SOpenId2ActivityId> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.questionvoice.confbean.SOpenId2ActivityId.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           SOpenId2ActivityId _v_ = new SOpenId2ActivityId();
...
/*     */ 
/*     */ 
/*     */   public static SOpenId2ActivityId getOld(int key)
/*     */   {
/* 199 */     return (SOpenId2ActivityId)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SOpenId2ActivityId get(int key)
/*     */   {
/* 204 */     return (SOpenId2ActivityId)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SOpenId2ActivityId> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SOpenId2ActivityId> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SOpenId2ActivityId> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\questionvoice\confbean\SOpenId2ActivityId.class
