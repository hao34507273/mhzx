...
/*     */ 
/*     */ public class SQuestionVoicePolicyCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SQuestionVoicePolicyCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SQuestionVoicePolicyCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public int choosepolicyId;
/*     */   public int righRewardPolicyGroupId;
/*     */   public int wrongRewardPolicyGroupId;
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  25 */     this.id = Integer.valueOf(rootElement.attributeValue("id")).intValue();
/*  26 */     this.choosepolicyId = Integer.valueOf(rootElement.attributeValue("choosepolicyId")).intValue();
/*  27 */     this.righRewardPolicyGroupId = Integer.valueOf(rootElement.attributeValue("righRewardPolicyGroupId")).intValue();
/*  28 */     this.wrongRewardPolicyGroupId = Integer.valueOf(rootElement.attributeValue("wrongRewardPolicyGroupId")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  33 */     _os_.marshal(this.id);
/*  34 */     _os_.marshal(this.choosepolicyId);
/*  35 */     _os_.marshal(this.righRewardPolicyGroupId);
/*  36 */     _os_.marshal(this.wrongRewardPolicyGroupId);
/*  37 */     return _os_;
/*     */   }
/*     */   
...
/*  43 */     this.choosepolicyId = _os_.unmarshal_int();
/*  44 */     this.righRewardPolicyGroupId = _os_.unmarshal_int();
/*  45 */     this.wrongRewardPolicyGroupId = _os_.unmarshal_int();
/*  46 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  51 */     String path = dir + "mzm.gsp.questionvoice.confbean.SQuestionVoicePolicyCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  64 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.questionvoice.confbean.SQuestionVoicePolicyCfg"))
/*     */         {
/*     */ 
/*  67 */           SQuestionVoicePolicyCfg obj = new SQuestionVoicePolicyCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SQuestionVoicePolicyCfg> all)
/*     */   {
/*  81 */     String path = dir + "mzm.gsp.questionvoice.confbean.SQuestionVoicePolicyCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.questionvoice.confbean.SQuestionVoicePolicyCfg"))
/*     */         {
/*     */ 
/*  96 */           SQuestionVoicePolicyCfg obj = new SQuestionVoicePolicyCfg();
...
/*     */     
/* 112 */     String path = dir + "mzm.gsp.questionvoice.confbean.SQuestionVoicePolicyCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 139 */           SQuestionVoicePolicyCfg _v_ = new SQuestionVoicePolicyCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SQuestionVoicePolicyCfg> all)
/*     */   {
/* 159 */     String path = dir + "mzm.gsp.questionvoice.confbean.SQuestionVoicePolicyCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 186 */           SQuestionVoicePolicyCfg _v_ = new SQuestionVoicePolicyCfg();
...
/*     */ 
/*     */ 
/*     */   public static SQuestionVoicePolicyCfg getOld(int key)
/*     */   {
/* 207 */     return (SQuestionVoicePolicyCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SQuestionVoicePolicyCfg get(int key)
/*     */   {
/* 212 */     return (SQuestionVoicePolicyCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SQuestionVoicePolicyCfg> getOldAll()
/*     */   {
/* 217 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SQuestionVoicePolicyCfg> getAll()
/*     */   {
/* 222 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SQuestionVoicePolicyCfg> newAll)
/*     */   {
/* 227 */     oldAll = all;
/* 228 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\questionvoice\confbean\SQuestionVoicePolicyCfg.class
