...
/*     */ 
/*     */ public class SModuleFunSwitchCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SModuleFunSwitchCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SModuleFunSwitchCfg> all = null;
/*     */   
/*     */   public int moduleid;
...
/*  24 */     this.isopen = Boolean.valueOf(rootElement.attributeValue("isopen")).booleanValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  29 */     _os_.marshal(this.moduleid);
/*  30 */     _os_.marshal(this.isopen);
/*  31 */     return _os_;
/*     */   }
/*     */   
...
/*  37 */     this.isopen = _os_.unmarshal_boolean();
/*  38 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.open.confbean.SModuleFunSwitchCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.open.confbean.SModuleFunSwitchCfg"))
/*     */         {
/*     */ 
/*  59 */           SModuleFunSwitchCfg obj = new SModuleFunSwitchCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SModuleFunSwitchCfg> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.open.confbean.SModuleFunSwitchCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.open.confbean.SModuleFunSwitchCfg"))
/*     */         {
/*     */ 
/*  88 */           SModuleFunSwitchCfg obj = new SModuleFunSwitchCfg();
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.open.confbean.SModuleFunSwitchCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           SModuleFunSwitchCfg _v_ = new SModuleFunSwitchCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SModuleFunSwitchCfg> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.open.confbean.SModuleFunSwitchCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           SModuleFunSwitchCfg _v_ = new SModuleFunSwitchCfg();
...
/*     */ 
/*     */ 
/*     */   public static SModuleFunSwitchCfg getOld(int key)
/*     */   {
/* 199 */     return (SModuleFunSwitchCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SModuleFunSwitchCfg get(int key)
/*     */   {
/* 204 */     return (SModuleFunSwitchCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SModuleFunSwitchCfg> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SModuleFunSwitchCfg> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SModuleFunSwitchCfg> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\open\confbean\SModuleFunSwitchCfg.class
