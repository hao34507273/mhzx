...
/*     */ 
/*     */ public class SGrayServerCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SGrayServerCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SGrayServerCfg> all = null;
/*     */   
/*     */   public int serverid;
...
/*     */   {
/*  23 */     this.serverid = Integer.valueOf(rootElement.attributeValue("serverid")).intValue();
/*  24 */     this.isvalid = Boolean.valueOf(rootElement.attributeValue("isvalid")).booleanValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  29 */     _os_.marshal(this.serverid);
/*  30 */     _os_.marshal(this.isvalid);
/*  31 */     return _os_;
/*     */   }
/*     */   
/*     */   public OctetsStream unmarshal(OctetsStream _os_) throws com.goldhuman.Common.Marshal.MarshalException
/*     */   {
/*  36 */     this.serverid = _os_.unmarshal_int();
/*  37 */     this.isvalid = _os_.unmarshal_boolean();
/*  38 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.open.confbean.SGrayServerCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.open.confbean.SGrayServerCfg"))
/*     */         {
/*     */ 
/*  59 */           SGrayServerCfg obj = new SGrayServerCfg();
/*  60 */           obj.loadFromXml(elem);
/*  61 */           if (all.put(Integer.valueOf(obj.serverid), obj) != null) {
/*  62 */             throw new RuntimeException("duplicate key : " + obj.serverid);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SGrayServerCfg> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.open.confbean.SGrayServerCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.open.confbean.SGrayServerCfg"))
/*     */         {
/*     */ 
/*  88 */           SGrayServerCfg obj = new SGrayServerCfg();
/*  89 */           obj.loadFromXml(elem);
/*  90 */           if (all.put(Integer.valueOf(obj.serverid), obj) != null) {
/*  91 */             throw new RuntimeException("duplicate key : " + obj.serverid);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.open.confbean.SGrayServerCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           SGrayServerCfg _v_ = new SGrayServerCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SGrayServerCfg> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.open.confbean.SGrayServerCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           SGrayServerCfg _v_ = new SGrayServerCfg();
...
/*     */ 
/*     */ 
/*     */   public static SGrayServerCfg getOld(int key)
/*     */   {
/* 199 */     return (SGrayServerCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SGrayServerCfg get(int key)
/*     */   {
/* 204 */     return (SGrayServerCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SGrayServerCfg> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SGrayServerCfg> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SGrayServerCfg> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\open\confbean\SGrayServerCfg.class
