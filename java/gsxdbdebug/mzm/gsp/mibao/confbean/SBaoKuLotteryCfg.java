...
/*     */ 
/*     */ public class SBaoKuLotteryCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SBaoKuLotteryCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SBaoKuLotteryCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public int costCurrencyType;
/*     */   public int costCurrencyNum;
/*     */   public int addScore;
/*     */   public int addLuckValue;
/*     */   public int awardPoolLotteryCfgId;
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  27 */     this.id = Integer.valueOf(rootElement.attributeValue("id")).intValue();
/*  28 */     this.costCurrencyType = Integer.valueOf(rootElement.attributeValue("costCurrencyType")).intValue();
/*  29 */     this.costCurrencyNum = Integer.valueOf(rootElement.attributeValue("costCurrencyNum")).intValue();
/*  30 */     this.addScore = Integer.valueOf(rootElement.attributeValue("addScore")).intValue();
/*  31 */     this.addLuckValue = Integer.valueOf(rootElement.attributeValue("addLuckValue")).intValue();
/*  32 */     this.awardPoolLotteryCfgId = Integer.valueOf(rootElement.attributeValue("awardPoolLotteryCfgId")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  37 */     _os_.marshal(this.id);
/*  38 */     _os_.marshal(this.costCurrencyType);
/*  39 */     _os_.marshal(this.costCurrencyNum);
/*  40 */     _os_.marshal(this.addScore);
/*  41 */     _os_.marshal(this.addLuckValue);
/*  42 */     _os_.marshal(this.awardPoolLotteryCfgId);
/*  43 */     return _os_;
/*     */   }
/*     */   
...
/*  49 */     this.costCurrencyType = _os_.unmarshal_int();
/*  50 */     this.costCurrencyNum = _os_.unmarshal_int();
/*  51 */     this.addScore = _os_.unmarshal_int();
/*  52 */     this.addLuckValue = _os_.unmarshal_int();
/*  53 */     this.awardPoolLotteryCfgId = _os_.unmarshal_int();
/*  54 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  59 */     String path = dir + "mzm.gsp.mibao.confbean.SBaoKuLotteryCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  72 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.mibao.confbean.SBaoKuLotteryCfg"))
/*     */         {
/*     */ 
/*  75 */           SBaoKuLotteryCfg obj = new SBaoKuLotteryCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SBaoKuLotteryCfg> all)
/*     */   {
/*  89 */     String path = dir + "mzm.gsp.mibao.confbean.SBaoKuLotteryCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 101 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.mibao.confbean.SBaoKuLotteryCfg"))
/*     */         {
/*     */ 
/* 104 */           SBaoKuLotteryCfg obj = new SBaoKuLotteryCfg();
...
/*     */     
/* 120 */     String path = dir + "mzm.gsp.mibao.confbean.SBaoKuLotteryCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 147 */           SBaoKuLotteryCfg _v_ = new SBaoKuLotteryCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SBaoKuLotteryCfg> all)
/*     */   {
/* 167 */     String path = dir + "mzm.gsp.mibao.confbean.SBaoKuLotteryCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 194 */           SBaoKuLotteryCfg _v_ = new SBaoKuLotteryCfg();
...
/*     */ 
/*     */ 
/*     */   public static SBaoKuLotteryCfg getOld(int key)
/*     */   {
/* 215 */     return (SBaoKuLotteryCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SBaoKuLotteryCfg get(int key)
/*     */   {
/* 220 */     return (SBaoKuLotteryCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SBaoKuLotteryCfg> getOldAll()
/*     */   {
/* 225 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SBaoKuLotteryCfg> getAll()
/*     */   {
/* 230 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SBaoKuLotteryCfg> newAll)
/*     */   {
/* 235 */     oldAll = all;
/* 236 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\mibao\confbean\SBaoKuLotteryCfg.class
