...
/*     */ 
/*     */ public class SMiBaoScoreCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SMiBaoScoreCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SMiBaoScoreCfg> all = null;
/*     */   
/*     */   public int cfgId;
...
/*  25 */     this.scoreValue = Integer.valueOf(rootElement.attributeValue("scoreValue")).intValue();
...
/*  32 */     _os_.marshal(this.scoreValue);
...
/*  40 */     this.scoreValue = _os_.unmarshal_int();
...
/*     */   {
/*  47 */     String path = dir + "mzm.gsp.mibao.confbean.SMiBaoScoreCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  60 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.mibao.confbean.SMiBaoScoreCfg"))
/*     */         {
/*     */ 
/*  63 */           SMiBaoScoreCfg obj = new SMiBaoScoreCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SMiBaoScoreCfg> all)
/*     */   {
/*  77 */     String path = dir + "mzm.gsp.mibao.confbean.SMiBaoScoreCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  89 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.mibao.confbean.SMiBaoScoreCfg"))
/*     */         {
/*     */ 
/*  92 */           SMiBaoScoreCfg obj = new SMiBaoScoreCfg();
...
/*     */     
/* 108 */     String path = dir + "mzm.gsp.mibao.confbean.SMiBaoScoreCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 135 */           SMiBaoScoreCfg _v_ = new SMiBaoScoreCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SMiBaoScoreCfg> all)
/*     */   {
/* 155 */     String path = dir + "mzm.gsp.mibao.confbean.SMiBaoScoreCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 182 */           SMiBaoScoreCfg _v_ = new SMiBaoScoreCfg();
...
/*     */ 
/*     */ 
/*     */   public static SMiBaoScoreCfg getOld(int key)
/*     */   {
/* 203 */     return (SMiBaoScoreCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SMiBaoScoreCfg get(int key)
/*     */   {
/* 208 */     return (SMiBaoScoreCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMiBaoScoreCfg> getOldAll()
/*     */   {
/* 213 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMiBaoScoreCfg> getAll()
/*     */   {
/* 218 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SMiBaoScoreCfg> newAll)
/*     */   {
/* 223 */     oldAll = all;
/* 224 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\mibao\confbean\SMiBaoScoreCfg.class
