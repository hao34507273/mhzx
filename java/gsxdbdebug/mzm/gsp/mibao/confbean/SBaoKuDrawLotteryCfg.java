...
/*     */ 
/*     */ public class SBaoKuDrawLotteryCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SBaoKuDrawLotteryCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SBaoKuDrawLotteryCfg> all = null;
/*     */   
/*     */   public int indexId;
/*     */   public int cfgId;
...
/*  26 */     this.lotteryCfgId = Integer.valueOf(rootElement.attributeValue("lotteryCfgId")).intValue();
/*     */   }
/*     */   
...
/*  33 */     _os_.marshal(this.lotteryCfgId);
/*  34 */     return _os_;
/*     */   }
/*     */   
...
/*  41 */     this.lotteryCfgId = _os_.unmarshal_int();
/*  42 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  47 */     String path = dir + "mzm.gsp.mibao.confbean.SBaoKuDrawLotteryCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  60 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.mibao.confbean.SBaoKuDrawLotteryCfg"))
/*     */         {
/*     */ 
/*  63 */           SBaoKuDrawLotteryCfg obj = new SBaoKuDrawLotteryCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SBaoKuDrawLotteryCfg> all)
/*     */   {
/*  77 */     String path = dir + "mzm.gsp.mibao.confbean.SBaoKuDrawLotteryCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  89 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.mibao.confbean.SBaoKuDrawLotteryCfg"))
/*     */         {
/*     */ 
/*  92 */           SBaoKuDrawLotteryCfg obj = new SBaoKuDrawLotteryCfg();
...
/*     */     
/* 108 */     String path = dir + "mzm.gsp.mibao.confbean.SBaoKuDrawLotteryCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 135 */           SBaoKuDrawLotteryCfg _v_ = new SBaoKuDrawLotteryCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SBaoKuDrawLotteryCfg> all)
/*     */   {
/* 155 */     String path = dir + "mzm.gsp.mibao.confbean.SBaoKuDrawLotteryCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 182 */           SBaoKuDrawLotteryCfg _v_ = new SBaoKuDrawLotteryCfg();
...
/*     */ 
/*     */ 
/*     */   public static SBaoKuDrawLotteryCfg getOld(int key)
/*     */   {
/* 203 */     return (SBaoKuDrawLotteryCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SBaoKuDrawLotteryCfg get(int key)
/*     */   {
/* 208 */     return (SBaoKuDrawLotteryCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SBaoKuDrawLotteryCfg> getOldAll()
/*     */   {
/* 213 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SBaoKuDrawLotteryCfg> getAll()
/*     */   {
/* 218 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SBaoKuDrawLotteryCfg> newAll)
/*     */   {
/* 223 */     oldAll = all;
/* 224 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\mibao\confbean\SBaoKuDrawLotteryCfg.class
