...
/*     */ 
/*     */ public class SBirthdayPrayRewardCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SBirthdayPrayRewardCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SBirthdayPrayRewardCfg> all = null;
/*     */   
/*     */   public int activityId;
/*  19 */   public HashMap<Integer, SBirthdayPrayRewardInfo> taskActivityId2RewardInfo = new HashMap();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.activityId = Integer.valueOf(rootElement.attributeValue("activityId")).intValue();
/*     */     
/*  25 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "taskActivityId2RewardInfo");
...
/*  51 */             keyElem = elem;
/*     */           }
/*  53 */           else if ((valueElem == null) && (elem.getName().equalsIgnoreCase("mzm.gsp.nationalholiday.confbean.SBirthdayPrayRewardInfo")))
/*     */           {
/*  55 */             valueElem = elem;
/*     */           }
/*     */         }
...
/*     */         
/*     */         int _k_;
/*     */         SBirthdayPrayRewardInfo _v_;
/*     */         try
/*     */         {
/*  68 */           _k_ = Integer.valueOf(keyElem.getText()).intValue();
/*  69 */           _v_ = new SBirthdayPrayRewardInfo();
...
/*     */         }
/*     */         
/*  77 */         this.taskActivityId2RewardInfo.put(Integer.valueOf(_k_), _v_);
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*  85 */     _os_.compact_uint32(this.taskActivityId2RewardInfo.size());
/*  86 */     for (java.util.Map.Entry<Integer, SBirthdayPrayRewardInfo> _e_ : this.taskActivityId2RewardInfo.entrySet())
/*     */     {
...
/*     */       
/* 102 */       SBirthdayPrayRewardInfo _v_ = new SBirthdayPrayRewardInfo();
/* 103 */       _v_.unmarshal(_os_);
/* 104 */       this.taskActivityId2RewardInfo.put(Integer.valueOf(_k_), _v_);
/*     */     }
/* 106 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/* 111 */     String path = dir + "mzm.gsp.nationalholiday.confbean.SBirthdayPrayRewardCfg.xml";
/*     */     
/*     */     try
/*     */     {
/* 115 */       all = new HashMap();
...
/* 124 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.nationalholiday.confbean.SBirthdayPrayRewardCfg"))
/*     */         {
/*     */ 
/* 127 */           SBirthdayPrayRewardCfg obj = new SBirthdayPrayRewardCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SBirthdayPrayRewardCfg> all)
/*     */   {
/* 141 */     String path = dir + "mzm.gsp.nationalholiday.confbean.SBirthdayPrayRewardCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 153 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.nationalholiday.confbean.SBirthdayPrayRewardCfg"))
/*     */         {
/*     */ 
/* 156 */           SBirthdayPrayRewardCfg obj = new SBirthdayPrayRewardCfg();
...
/* 170 */     all = new HashMap();
/*     */     
/* 172 */     String path = dir + "mzm.gsp.nationalholiday.confbean.SBirthdayPrayRewardCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 199 */           SBirthdayPrayRewardCfg _v_ = new SBirthdayPrayRewardCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SBirthdayPrayRewardCfg> all)
/*     */   {
/* 219 */     String path = dir + "mzm.gsp.nationalholiday.confbean.SBirthdayPrayRewardCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 246 */           SBirthdayPrayRewardCfg _v_ = new SBirthdayPrayRewardCfg();
...
/*     */ 
/*     */ 
/*     */   public static SBirthdayPrayRewardCfg getOld(int key)
/*     */   {
/* 267 */     return (SBirthdayPrayRewardCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SBirthdayPrayRewardCfg get(int key)
/*     */   {
/* 272 */     return (SBirthdayPrayRewardCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SBirthdayPrayRewardCfg> getOldAll()
/*     */   {
/* 277 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SBirthdayPrayRewardCfg> getAll()
/*     */   {
/* 282 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SBirthdayPrayRewardCfg> newAll)
/*     */   {
/* 287 */     oldAll = all;
/* 288 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\nationalholiday\confbean\SBirthdayPrayRewardCfg.class
