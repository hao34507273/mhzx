...
/*     */ 
/*     */ public class STaskActivityId2ActivityIdCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, STaskActivityId2ActivityIdCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, STaskActivityId2ActivityIdCfg> all = null;
/*     */   
...
/*     */   {
/*  23 */     this.taskActivityId = Integer.valueOf(rootElement.attributeValue("taskActivityId")).intValue();
/*  24 */     this.activityId = Integer.valueOf(rootElement.attributeValue("activityId")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  29 */     _os_.marshal(this.taskActivityId);
/*  30 */     _os_.marshal(this.activityId);
/*  31 */     return _os_;
/*     */   }
/*     */   
/*     */   public OctetsStream unmarshal(OctetsStream _os_) throws com.goldhuman.Common.Marshal.MarshalException
/*     */   {
/*  36 */     this.taskActivityId = _os_.unmarshal_int();
...
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.nationalholiday.confbean.STaskActivityId2ActivityIdCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.nationalholiday.confbean.STaskActivityId2ActivityIdCfg"))
/*     */         {
/*     */ 
/*  59 */           STaskActivityId2ActivityIdCfg obj = new STaskActivityId2ActivityIdCfg();
/*  60 */           obj.loadFromXml(elem);
/*  61 */           if (all.put(Integer.valueOf(obj.taskActivityId), obj) != null) {
/*  62 */             throw new RuntimeException("duplicate key : " + obj.taskActivityId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, STaskActivityId2ActivityIdCfg> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.nationalholiday.confbean.STaskActivityId2ActivityIdCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.nationalholiday.confbean.STaskActivityId2ActivityIdCfg"))
/*     */         {
/*     */ 
/*  88 */           STaskActivityId2ActivityIdCfg obj = new STaskActivityId2ActivityIdCfg();
/*  89 */           obj.loadFromXml(elem);
/*  90 */           if (all.put(Integer.valueOf(obj.taskActivityId), obj) != null) {
/*  91 */             throw new RuntimeException("duplicate key : " + obj.taskActivityId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.nationalholiday.confbean.STaskActivityId2ActivityIdCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           STaskActivityId2ActivityIdCfg _v_ = new STaskActivityId2ActivityIdCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, STaskActivityId2ActivityIdCfg> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.nationalholiday.confbean.STaskActivityId2ActivityIdCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           STaskActivityId2ActivityIdCfg _v_ = new STaskActivityId2ActivityIdCfg();
...
/*     */ 
/*     */ 
/*     */   public static STaskActivityId2ActivityIdCfg getOld(int key)
/*     */   {
/* 199 */     return (STaskActivityId2ActivityIdCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static STaskActivityId2ActivityIdCfg get(int key)
/*     */   {
/* 204 */     return (STaskActivityId2ActivityIdCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, STaskActivityId2ActivityIdCfg> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, STaskActivityId2ActivityIdCfg> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, STaskActivityId2ActivityIdCfg> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\nationalholiday\confbean\STaskActivityId2ActivityIdCfg.class
