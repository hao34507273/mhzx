...
/*     */ 
/*     */ public class SShowRewardRandomCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SShowRewardRandomCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SShowRewardRandomCfg> all = null;
/*     */   
/*     */   public int groupId;
/*     */   public int sumWight;
...
/*     */   {
/* 117 */     String path = dir + "mzm.gsp.nationalholiday.confbean.SShowRewardRandomCfg.xml";
/*     */     
/*     */     try
/*     */     {
/* 121 */       all = new HashMap();
...
/* 130 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.nationalholiday.confbean.SShowRewardRandomCfg"))
/*     */         {
/*     */ 
/* 133 */           SShowRewardRandomCfg obj = new SShowRewardRandomCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SShowRewardRandomCfg> all)
/*     */   {
/* 147 */     String path = dir + "mzm.gsp.nationalholiday.confbean.SShowRewardRandomCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 159 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.nationalholiday.confbean.SShowRewardRandomCfg"))
/*     */         {
/*     */ 
/* 162 */           SShowRewardRandomCfg obj = new SShowRewardRandomCfg();
...
/* 176 */     all = new HashMap();
/*     */     
/* 178 */     String path = dir + "mzm.gsp.nationalholiday.confbean.SShowRewardRandomCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 205 */           SShowRewardRandomCfg _v_ = new SShowRewardRandomCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SShowRewardRandomCfg> all)
/*     */   {
/* 225 */     String path = dir + "mzm.gsp.nationalholiday.confbean.SShowRewardRandomCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 252 */           SShowRewardRandomCfg _v_ = new SShowRewardRandomCfg();
...
/*     */ 
/*     */ 
/*     */   public static SShowRewardRandomCfg getOld(int key)
/*     */   {
/* 273 */     return (SShowRewardRandomCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SShowRewardRandomCfg get(int key)
/*     */   {
/* 278 */     return (SShowRewardRandomCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SShowRewardRandomCfg> getOldAll()
/*     */   {
/* 283 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SShowRewardRandomCfg> getAll()
/*     */   {
/* 288 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SShowRewardRandomCfg> newAll)
/*     */   {
/* 293 */     oldAll = all;
/* 294 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\nationalholiday\confbean\SShowRewardRandomCfg.class
