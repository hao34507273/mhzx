...
/*     */ 
/*     */ public class SPetArenaRankAwardCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SPetArenaRankAwardCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SPetArenaRankAwardCfg> all = null;
/*     */   
/*     */   public int minRank;
/*     */   public int maxRank;
/*     */   public int award;
...
/*  26 */     this.award = Integer.valueOf(rootElement.attributeValue("award")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  31 */     _os_.marshal(this.minRank);
/*  32 */     _os_.marshal(this.maxRank);
/*  33 */     _os_.marshal(this.award);
/*  34 */     return _os_;
/*     */   }
/*     */   
/*     */   public OctetsStream unmarshal(OctetsStream _os_) throws com.goldhuman.Common.Marshal.MarshalException
/*     */   {
/*  39 */     this.minRank = _os_.unmarshal_int();
/*  40 */     this.maxRank = _os_.unmarshal_int();
/*  41 */     this.award = _os_.unmarshal_int();
/*  42 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  47 */     String path = dir + "mzm.gsp.petarena.confbean.SPetArenaRankAwardCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  60 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.petarena.confbean.SPetArenaRankAwardCfg"))
/*     */         {
/*     */ 
/*  63 */           SPetArenaRankAwardCfg obj = new SPetArenaRankAwardCfg();
/*  64 */           obj.loadFromXml(elem);
/*  65 */           if (all.put(Integer.valueOf(obj.minRank), obj) != null) {
/*  66 */             throw new RuntimeException("duplicate key : " + obj.minRank);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SPetArenaRankAwardCfg> all)
/*     */   {
/*  77 */     String path = dir + "mzm.gsp.petarena.confbean.SPetArenaRankAwardCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  89 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.petarena.confbean.SPetArenaRankAwardCfg"))
/*     */         {
/*     */ 
/*  92 */           SPetArenaRankAwardCfg obj = new SPetArenaRankAwardCfg();
/*  93 */           obj.loadFromXml(elem);
/*  94 */           if (all.put(Integer.valueOf(obj.minRank), obj) != null) {
/*  95 */             throw new RuntimeException("duplicate key : " + obj.minRank);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 108 */     String path = dir + "mzm.gsp.petarena.confbean.SPetArenaRankAwardCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 135 */           SPetArenaRankAwardCfg _v_ = new SPetArenaRankAwardCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SPetArenaRankAwardCfg> all)
/*     */   {
/* 155 */     String path = dir + "mzm.gsp.petarena.confbean.SPetArenaRankAwardCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 182 */           SPetArenaRankAwardCfg _v_ = new SPetArenaRankAwardCfg();
...
/*     */ 
/*     */ 
/*     */   public static SPetArenaRankAwardCfg getOld(int key)
/*     */   {
/* 203 */     return (SPetArenaRankAwardCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SPetArenaRankAwardCfg get(int key)
/*     */   {
/* 208 */     return (SPetArenaRankAwardCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPetArenaRankAwardCfg> getOldAll()
/*     */   {
/* 213 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPetArenaRankAwardCfg> getAll()
/*     */   {
/* 218 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SPetArenaRankAwardCfg> newAll)
/*     */   {
/* 223 */     oldAll = all;
/* 224 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\petarena\confbean\SPetArenaRankAwardCfg.class
