...
/*     */ 
/*     */ public class SPetArenaAppellationCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SPetArenaAppellationCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SPetArenaAppellationCfg> all = null;
/*     */   
/*     */   public int rank;
...
/*  24 */     this.appellation = Integer.valueOf(rootElement.attributeValue("appellation")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  29 */     _os_.marshal(this.rank);
/*  30 */     _os_.marshal(this.appellation);
/*  31 */     return _os_;
/*     */   }
/*     */   
/*     */   public OctetsStream unmarshal(OctetsStream _os_) throws com.goldhuman.Common.Marshal.MarshalException
/*     */   {
/*  36 */     this.rank = _os_.unmarshal_int();
/*  37 */     this.appellation = _os_.unmarshal_int();
/*  38 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.petarena.confbean.SPetArenaAppellationCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.petarena.confbean.SPetArenaAppellationCfg"))
/*     */         {
/*     */ 
/*  59 */           SPetArenaAppellationCfg obj = new SPetArenaAppellationCfg();
/*  60 */           obj.loadFromXml(elem);
/*  61 */           if (all.put(Integer.valueOf(obj.rank), obj) != null) {
/*  62 */             throw new RuntimeException("duplicate key : " + obj.rank);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SPetArenaAppellationCfg> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.petarena.confbean.SPetArenaAppellationCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.petarena.confbean.SPetArenaAppellationCfg"))
/*     */         {
/*     */ 
/*  88 */           SPetArenaAppellationCfg obj = new SPetArenaAppellationCfg();
/*  89 */           obj.loadFromXml(elem);
/*  90 */           if (all.put(Integer.valueOf(obj.rank), obj) != null) {
/*  91 */             throw new RuntimeException("duplicate key : " + obj.rank);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.petarena.confbean.SPetArenaAppellationCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           SPetArenaAppellationCfg _v_ = new SPetArenaAppellationCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SPetArenaAppellationCfg> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.petarena.confbean.SPetArenaAppellationCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           SPetArenaAppellationCfg _v_ = new SPetArenaAppellationCfg();
...
/*     */ 
/*     */ 
/*     */   public static SPetArenaAppellationCfg getOld(int key)
/*     */   {
/* 199 */     return (SPetArenaAppellationCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SPetArenaAppellationCfg get(int key)
/*     */   {
/* 204 */     return (SPetArenaAppellationCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPetArenaAppellationCfg> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPetArenaAppellationCfg> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SPetArenaAppellationCfg> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\petarena\confbean\SPetArenaAppellationCfg.class
