...
/*     */ 
/*     */ public class SPetArenaRobotAttributeCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SPetArenaRobotAttributeCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SPetArenaRobotAttributeCfg> all = null;
/*     */   
/*     */   public int serverLevel;
/*  19 */   public HashMap<Integer, TypeToRobotPetInfo> typeids = new HashMap();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.serverLevel = Integer.valueOf(rootElement.attributeValue("serverLevel")).intValue();
/*     */     
/*  25 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "typeids");
...
/*  51 */             keyElem = elem;
/*     */           }
/*  53 */           else if ((valueElem == null) && (elem.getName().equalsIgnoreCase("mzm.gsp.petarena.confbean.TypeToRobotPetInfo")))
/*     */           {
/*  55 */             valueElem = elem;
/*     */           }
/*     */         }
...
/*     */         
/*     */         int _k_;
/*     */         TypeToRobotPetInfo _v_;
/*     */         try
/*     */         {
/*  68 */           _k_ = Integer.valueOf(keyElem.getText()).intValue();
/*  69 */           _v_ = new TypeToRobotPetInfo();
...
/*     */         }
/*     */         
/*  77 */         this.typeids.put(Integer.valueOf(_k_), _v_);
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*  85 */     _os_.compact_uint32(this.typeids.size());
/*  86 */     for (java.util.Map.Entry<Integer, TypeToRobotPetInfo> _e_ : this.typeids.entrySet())
/*     */     {
...
/*     */       
/* 102 */       TypeToRobotPetInfo _v_ = new TypeToRobotPetInfo();
/* 103 */       _v_.unmarshal(_os_);
/* 104 */       this.typeids.put(Integer.valueOf(_k_), _v_);
/*     */     }
/* 106 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/* 111 */     String path = dir + "mzm.gsp.petarena.confbean.SPetArenaRobotAttributeCfg.xml";
/*     */     
/*     */     try
/*     */     {
/* 115 */       all = new HashMap();
...
/* 124 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.petarena.confbean.SPetArenaRobotAttributeCfg"))
/*     */         {
/*     */ 
/* 127 */           SPetArenaRobotAttributeCfg obj = new SPetArenaRobotAttributeCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SPetArenaRobotAttributeCfg> all)
/*     */   {
/* 141 */     String path = dir + "mzm.gsp.petarena.confbean.SPetArenaRobotAttributeCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 153 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.petarena.confbean.SPetArenaRobotAttributeCfg"))
/*     */         {
/*     */ 
/* 156 */           SPetArenaRobotAttributeCfg obj = new SPetArenaRobotAttributeCfg();
...
/* 170 */     all = new HashMap();
/*     */     
/* 172 */     String path = dir + "mzm.gsp.petarena.confbean.SPetArenaRobotAttributeCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 199 */           SPetArenaRobotAttributeCfg _v_ = new SPetArenaRobotAttributeCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SPetArenaRobotAttributeCfg> all)
/*     */   {
/* 219 */     String path = dir + "mzm.gsp.petarena.confbean.SPetArenaRobotAttributeCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 246 */           SPetArenaRobotAttributeCfg _v_ = new SPetArenaRobotAttributeCfg();
...
/*     */ 
/*     */ 
/*     */   public static SPetArenaRobotAttributeCfg getOld(int key)
/*     */   {
/* 267 */     return (SPetArenaRobotAttributeCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SPetArenaRobotAttributeCfg get(int key)
/*     */   {
/* 272 */     return (SPetArenaRobotAttributeCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPetArenaRobotAttributeCfg> getOldAll()
/*     */   {
/* 277 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPetArenaRobotAttributeCfg> getAll()
/*     */   {
/* 282 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SPetArenaRobotAttributeCfg> newAll)
/*     */   {
/* 287 */     oldAll = all;
/* 288 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\petarena\confbean\SPetArenaRobotAttributeCfg.class
