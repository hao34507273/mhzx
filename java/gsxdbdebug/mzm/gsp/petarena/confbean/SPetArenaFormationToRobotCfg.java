...
/*     */ 
/*     */ public class SPetArenaFormationToRobotCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SPetArenaFormationToRobotCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SPetArenaFormationToRobotCfg> all = null;
/*     */   
/*     */   public int formationCfgid;
/*  19 */   public HashMap<Integer, PetTypeInfo> positions = new HashMap();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.formationCfgid = Integer.valueOf(rootElement.attributeValue("formationCfgid")).intValue();
/*     */     
/*  25 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "positions");
...
/*  51 */             keyElem = elem;
/*     */           }
/*  53 */           else if ((valueElem == null) && (elem.getName().equalsIgnoreCase("mzm.gsp.petarena.confbean.PetTypeInfo")))
/*     */           {
/*  55 */             valueElem = elem;
/*     */           }
/*     */         }
...
/*     */         }
/*     */         
/*  77 */         this.positions.put(Integer.valueOf(_k_), _v_);
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*     */   {
/*  84 */     _os_.marshal(this.formationCfgid);
/*  85 */     _os_.compact_uint32(this.positions.size());
/*  86 */     for (java.util.Map.Entry<Integer, PetTypeInfo> _e_ : this.positions.entrySet())
/*     */     {
...
/*     */   {
/*  96 */     this.formationCfgid = _os_.unmarshal_int();
/*  97 */     for (int _size_ = _os_.uncompact_uint32(); _size_ > 0; _size_--)
/*     */     {
/*     */ 
/* 100 */       int _k_ = _os_.unmarshal_int();
/*     */       
/* 102 */       PetTypeInfo _v_ = new PetTypeInfo();
/* 103 */       _v_.unmarshal(_os_);
/* 104 */       this.positions.put(Integer.valueOf(_k_), _v_);
/*     */     }
/* 106 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/* 111 */     String path = dir + "mzm.gsp.petarena.confbean.SPetArenaFormationToRobotCfg.xml";
/*     */     
/*     */     try
/*     */     {
/* 115 */       all = new HashMap();
...
/* 124 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.petarena.confbean.SPetArenaFormationToRobotCfg"))
/*     */         {
/*     */ 
/* 127 */           SPetArenaFormationToRobotCfg obj = new SPetArenaFormationToRobotCfg();
/* 128 */           obj.loadFromXml(elem);
/* 129 */           if (all.put(Integer.valueOf(obj.formationCfgid), obj) != null) {
/* 130 */             throw new RuntimeException("duplicate key : " + obj.formationCfgid);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SPetArenaFormationToRobotCfg> all)
/*     */   {
/* 141 */     String path = dir + "mzm.gsp.petarena.confbean.SPetArenaFormationToRobotCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 153 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.petarena.confbean.SPetArenaFormationToRobotCfg"))
/*     */         {
/*     */ 
/* 156 */           SPetArenaFormationToRobotCfg obj = new SPetArenaFormationToRobotCfg();
/* 157 */           obj.loadFromXml(elem);
/* 158 */           if (all.put(Integer.valueOf(obj.formationCfgid), obj) != null) {
/* 159 */             throw new RuntimeException("duplicate key : " + obj.formationCfgid);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/* 170 */     all = new HashMap();
/*     */     
/* 172 */     String path = dir + "mzm.gsp.petarena.confbean.SPetArenaFormationToRobotCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 199 */           SPetArenaFormationToRobotCfg _v_ = new SPetArenaFormationToRobotCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SPetArenaFormationToRobotCfg> all)
/*     */   {
/* 219 */     String path = dir + "mzm.gsp.petarena.confbean.SPetArenaFormationToRobotCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 246 */           SPetArenaFormationToRobotCfg _v_ = new SPetArenaFormationToRobotCfg();
...
/*     */ 
/*     */ 
/*     */   public static SPetArenaFormationToRobotCfg getOld(int key)
/*     */   {
/* 267 */     return (SPetArenaFormationToRobotCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SPetArenaFormationToRobotCfg get(int key)
/*     */   {
/* 272 */     return (SPetArenaFormationToRobotCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPetArenaFormationToRobotCfg> getOldAll()
/*     */   {
/* 277 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPetArenaFormationToRobotCfg> getAll()
/*     */   {
/* 282 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SPetArenaFormationToRobotCfg> newAll)
/*     */   {
/* 287 */     oldAll = all;
/* 288 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\petarena\confbean\SPetArenaFormationToRobotCfg.class
