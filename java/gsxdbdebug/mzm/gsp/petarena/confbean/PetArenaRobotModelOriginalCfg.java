...
/*     */ 
/*     */ public class PetArenaRobotModelOriginalCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, PetArenaRobotModelOriginalCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, PetArenaRobotModelOriginalCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public int typeid;
/*     */   public int weight;
...
/*  29 */     this.weight = Integer.valueOf(rootElement.attributeValue("weight")).intValue();
/*  30 */     this.monsterModelCfgid = Integer.valueOf(rootElement.attributeValue("monsterModelCfgid")).intValue();
/*  31 */     this.colorScheme = Integer.valueOf(rootElement.attributeValue("colorScheme")).intValue();
/*  32 */     this.modelFacadeCfgid = Integer.valueOf(rootElement.attributeValue("modelFacadeCfgid")).intValue();
/*     */   }
/*     */   
...
/*  39 */     _os_.marshal(this.weight);
/*  40 */     _os_.marshal(this.monsterModelCfgid);
/*  41 */     _os_.marshal(this.colorScheme);
/*  42 */     _os_.marshal(this.modelFacadeCfgid);
/*  43 */     return _os_;
/*     */   }
/*     */   
...
/*  50 */     this.weight = _os_.unmarshal_int();
/*  51 */     this.monsterModelCfgid = _os_.unmarshal_int();
/*  52 */     this.colorScheme = _os_.unmarshal_int();
/*  53 */     this.modelFacadeCfgid = _os_.unmarshal_int();
/*  54 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  59 */     String path = dir + "mzm.gsp.petarena.confbean.PetArenaRobotModelOriginalCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  72 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.petarena.confbean.PetArenaRobotModelOriginalCfg"))
/*     */         {
/*     */ 
/*  75 */           PetArenaRobotModelOriginalCfg obj = new PetArenaRobotModelOriginalCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, PetArenaRobotModelOriginalCfg> all)
/*     */   {
/*  89 */     String path = dir + "mzm.gsp.petarena.confbean.PetArenaRobotModelOriginalCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 101 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.petarena.confbean.PetArenaRobotModelOriginalCfg"))
/*     */         {
/*     */ 
/* 104 */           PetArenaRobotModelOriginalCfg obj = new PetArenaRobotModelOriginalCfg();
...
/*     */     
/* 120 */     String path = dir + "mzm.gsp.petarena.confbean.PetArenaRobotModelOriginalCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 147 */           PetArenaRobotModelOriginalCfg _v_ = new PetArenaRobotModelOriginalCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, PetArenaRobotModelOriginalCfg> all)
/*     */   {
/* 167 */     String path = dir + "mzm.gsp.petarena.confbean.PetArenaRobotModelOriginalCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 194 */           PetArenaRobotModelOriginalCfg _v_ = new PetArenaRobotModelOriginalCfg();
...
/*     */ 
/*     */ 
/*     */   public static PetArenaRobotModelOriginalCfg getOld(int key)
/*     */   {
/* 215 */     return (PetArenaRobotModelOriginalCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static PetArenaRobotModelOriginalCfg get(int key)
/*     */   {
/* 220 */     return (PetArenaRobotModelOriginalCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, PetArenaRobotModelOriginalCfg> getOldAll()
/*     */   {
/* 225 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, PetArenaRobotModelOriginalCfg> getAll()
/*     */   {
/* 230 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, PetArenaRobotModelOriginalCfg> newAll)
/*     */   {
/* 235 */     oldAll = all;
/* 236 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\petarena\confbean\PetArenaRobotModelOriginalCfg.class
