...
/*    */ 
/*    */ public class TypeToRobotPetInfo implements com.goldhuman.Common.Marshal.Marshal
/*    */ {
/*  9 */   public HashMap<Integer, RobotPetInfo> type2pet = new HashMap();
/*    */   
/*    */ 
/*    */   public void loadFromXml(Element rootElement)
/*    */   {
/* 14 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "type2pet");
...
/* 40 */             keyElem = elem;
/*    */           }
/* 42 */           else if ((valueElem == null) && (elem.getName().equalsIgnoreCase("mzm.gsp.petarena.confbean.RobotPetInfo")))
/*    */           {
/* 44 */             valueElem = elem;
/*    */           }
/*    */         }
...
/*    */         }
/*    */         
/* 66 */         this.type2pet.put(Integer.valueOf(_k_), _v_);
/*    */       }
/*    */     }
/*    */   }
/*    */   
...
/*    */   {
/* 73 */     _os_.compact_uint32(this.type2pet.size());
/* 74 */     for (java.util.Map.Entry<Integer, RobotPetInfo> _e_ : this.type2pet.entrySet())
/*    */     {
...
/*    */       
/* 89 */       RobotPetInfo _v_ = new RobotPetInfo();
/* 90 */       _v_.unmarshal(_os_);
/* 91 */       this.type2pet.put(Integer.valueOf(_k_), _v_);
/*    */     }
/* 93 */     return _os_;
/*    */   }
/*    */ }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\petarena\confbean\TypeToRobotPetInfo.class
