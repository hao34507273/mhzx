...
/*     */ 
/*     */ public class SPetArenaModifyCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SPetArenaModifyCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SPetArenaModifyCfg> all = null;
/*     */   
/*     */   public int count;
/*     */   public int modifyCfgid;
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.count = Integer.valueOf(rootElement.attributeValue("count")).intValue();
/*  24 */     this.modifyCfgid = Integer.valueOf(rootElement.attributeValue("modifyCfgid")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  29 */     _os_.marshal(this.count);
/*  30 */     _os_.marshal(this.modifyCfgid);
/*  31 */     return _os_;
/*     */   }
/*     */   
...
/*  37 */     this.modifyCfgid = _os_.unmarshal_int();
/*  38 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.petarena.confbean.SPetArenaModifyCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.petarena.confbean.SPetArenaModifyCfg"))
/*     */         {
/*     */ 
/*  59 */           SPetArenaModifyCfg obj = new SPetArenaModifyCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SPetArenaModifyCfg> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.petarena.confbean.SPetArenaModifyCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.petarena.confbean.SPetArenaModifyCfg"))
/*     */         {
/*     */ 
/*  88 */           SPetArenaModifyCfg obj = new SPetArenaModifyCfg();
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.petarena.confbean.SPetArenaModifyCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           SPetArenaModifyCfg _v_ = new SPetArenaModifyCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SPetArenaModifyCfg> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.petarena.confbean.SPetArenaModifyCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           SPetArenaModifyCfg _v_ = new SPetArenaModifyCfg();
...
/*     */ 
/*     */ 
/*     */   public static SPetArenaModifyCfg getOld(int key)
/*     */   {
/* 199 */     return (SPetArenaModifyCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SPetArenaModifyCfg get(int key)
/*     */   {
/* 204 */     return (SPetArenaModifyCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPetArenaModifyCfg> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPetArenaModifyCfg> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SPetArenaModifyCfg> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\petarena\confbean\SPetArenaModifyCfg.class
