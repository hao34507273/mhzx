...
/*    */ 
/*    */ public class CorpsDetailInfo implements Marshal
/*    */ {
/*    */   public CorpsBriefInfo corpsbriefinfo;
/*    */   public HashMap<Long, CorpsMemberDetailInfo> members;
/*    */   
/*    */   public CorpsDetailInfo()
/*    */   {
/* 15 */     this.corpsbriefinfo = new CorpsBriefInfo();
/* 16 */     this.members = new HashMap();
/*    */   }
/*    */   
/*    */   public CorpsDetailInfo(CorpsBriefInfo _corpsbriefinfo_, HashMap<Long, CorpsMemberDetailInfo> _members_) {
...
/* 26 */     for (Map.Entry<Long, CorpsMemberDetailInfo> _e_ : this.members.entrySet()) {
/* 27 */       if (!((CorpsMemberDetailInfo)_e_.getValue())._validator_()) return false;
/*    */     }
/* 29 */     return true;
/*    */   }
/*    */   
...
/* 35 */     for (Map.Entry<Long, CorpsMemberDetailInfo> _e_ : this.members.entrySet()) {
...
/* 47 */       CorpsMemberDetailInfo _v_ = new CorpsMemberDetailInfo();
...
/* 56 */     if ((_o1_ instanceof CorpsDetailInfo)) {
/* 57 */       CorpsDetailInfo _o_ = (CorpsDetailInfo)_o1_;
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\corps\CorpsDetailInfo.class
