...
/*    */ 
/*    */ public class CorpsSynInfo implements Marshal
/*    */ {
/*    */   public CorpsBriefInfo corpsbriefinfo;
/*    */   public HashMap<Long, CorpsMemberSynInfo> members;
/*    */   
/*    */   public CorpsSynInfo()
/*    */   {
...
/*    */   }
/*    */   
/*    */   public CorpsSynInfo(CorpsBriefInfo _corpsbriefinfo_, HashMap<Long, CorpsMemberSynInfo> _members_) {
...
/* 26 */     for (Map.Entry<Long, CorpsMemberSynInfo> _e_ : this.members.entrySet()) {
/* 27 */       if (!((CorpsMemberSynInfo)_e_.getValue())._validator_()) return false;
/*    */     }
/* 29 */     return true;
/*    */   }
/*    */   
...
/* 35 */     for (Map.Entry<Long, CorpsMemberSynInfo> _e_ : this.members.entrySet()) {
...
/* 47 */       CorpsMemberSynInfo _v_ = new CorpsMemberSynInfo();
...
/* 56 */     if ((_o1_ instanceof CorpsSynInfo)) {
/* 57 */       CorpsSynInfo _o_ = (CorpsSynInfo)_o1_;
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\corps\CorpsSynInfo.class
