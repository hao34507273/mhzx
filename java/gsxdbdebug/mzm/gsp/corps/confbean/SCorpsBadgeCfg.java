...
/*     */ 
/*     */ public class SCorpsBadgeCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SCorpsBadgeCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SCorpsBadgeCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public int iconId;
/*     */   
...
/*  24 */     this.iconId = Integer.valueOf(rootElement.attributeValue("iconId")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  29 */     _os_.marshal(this.id);
/*  30 */     _os_.marshal(this.iconId);
/*  31 */     return _os_;
/*     */   }
/*     */   
...
/*  37 */     this.iconId = _os_.unmarshal_int();
/*  38 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.corps.confbean.SCorpsBadgeCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.corps.confbean.SCorpsBadgeCfg"))
/*     */         {
/*     */ 
/*  59 */           SCorpsBadgeCfg obj = new SCorpsBadgeCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SCorpsBadgeCfg> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.corps.confbean.SCorpsBadgeCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.corps.confbean.SCorpsBadgeCfg"))
/*     */         {
/*     */ 
/*  88 */           SCorpsBadgeCfg obj = new SCorpsBadgeCfg();
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.corps.confbean.SCorpsBadgeCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           SCorpsBadgeCfg _v_ = new SCorpsBadgeCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SCorpsBadgeCfg> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.corps.confbean.SCorpsBadgeCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           SCorpsBadgeCfg _v_ = new SCorpsBadgeCfg();
...
/*     */ 
/*     */ 
/*     */   public static SCorpsBadgeCfg getOld(int key)
/*     */   {
/* 199 */     return (SCorpsBadgeCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SCorpsBadgeCfg get(int key)
/*     */   {
/* 204 */     return (SCorpsBadgeCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SCorpsBadgeCfg> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SCorpsBadgeCfg> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SCorpsBadgeCfg> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\corps\confbean\SCorpsBadgeCfg.class
