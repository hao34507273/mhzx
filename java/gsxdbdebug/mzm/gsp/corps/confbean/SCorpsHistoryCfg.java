...
/*     */ 
/*     */ public class SCorpsHistoryCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SCorpsHistoryCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SCorpsHistoryCfg> all = null;
/*     */   
/*     */   public int type;
/*     */   public boolean canDel;
/*     */   public String historyDescribe;
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  24 */     this.type = Integer.valueOf(rootElement.attributeValue("type")).intValue();
/*  25 */     this.canDel = Boolean.valueOf(rootElement.attributeValue("canDel")).booleanValue();
/*  26 */     this.historyDescribe = rootElement.attributeValue("historyDescribe");
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  31 */     _os_.marshal(this.type);
/*  32 */     _os_.marshal(this.canDel);
/*  33 */     _os_.marshal(this.historyDescribe, "UTF-8");
/*  34 */     return _os_;
/*     */   }
/*     */   
...
/*  40 */     this.canDel = _os_.unmarshal_boolean();
/*  41 */     this.historyDescribe = _os_.unmarshal_String("UTF-8");
/*  42 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  47 */     String path = dir + "mzm.gsp.corps.confbean.SCorpsHistoryCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  60 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.corps.confbean.SCorpsHistoryCfg"))
/*     */         {
/*     */ 
/*  63 */           SCorpsHistoryCfg obj = new SCorpsHistoryCfg();
/*  64 */           obj.loadFromXml(elem);
/*  65 */           if (all.put(Integer.valueOf(obj.type), obj) != null) {
/*  66 */             throw new RuntimeException("duplicate key : " + obj.type);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SCorpsHistoryCfg> all)
/*     */   {
/*  77 */     String path = dir + "mzm.gsp.corps.confbean.SCorpsHistoryCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  89 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.corps.confbean.SCorpsHistoryCfg"))
/*     */         {
/*     */ 
/*  92 */           SCorpsHistoryCfg obj = new SCorpsHistoryCfg();
/*  93 */           obj.loadFromXml(elem);
/*  94 */           if (all.put(Integer.valueOf(obj.type), obj) != null) {
/*  95 */             throw new RuntimeException("duplicate key : " + obj.type);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 108 */     String path = dir + "mzm.gsp.corps.confbean.SCorpsHistoryCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 135 */           SCorpsHistoryCfg _v_ = new SCorpsHistoryCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SCorpsHistoryCfg> all)
/*     */   {
/* 155 */     String path = dir + "mzm.gsp.corps.confbean.SCorpsHistoryCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 182 */           SCorpsHistoryCfg _v_ = new SCorpsHistoryCfg();
...
/*     */ 
/*     */ 
/*     */   public static SCorpsHistoryCfg getOld(int key)
/*     */   {
/* 203 */     return (SCorpsHistoryCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SCorpsHistoryCfg get(int key)
/*     */   {
/* 208 */     return (SCorpsHistoryCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SCorpsHistoryCfg> getOldAll()
/*     */   {
/* 213 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SCorpsHistoryCfg> getAll()
/*     */   {
/* 218 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SCorpsHistoryCfg> newAll)
/*     */   {
/* 223 */     oldAll = all;
/* 224 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\corps\confbean\SCorpsHistoryCfg.class
