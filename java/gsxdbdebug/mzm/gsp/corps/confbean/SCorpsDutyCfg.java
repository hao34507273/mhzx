...
/*     */ 
/*     */ public class SCorpsDutyCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SCorpsDutyCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SCorpsDutyCfg> all = null;
/*     */   
/*     */   public int duty;
...
/*     */   {
/*  23 */     this.duty = Integer.valueOf(rootElement.attributeValue("duty")).intValue();
/*  24 */     this.dutyName = rootElement.attributeValue("dutyName");
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  29 */     _os_.marshal(this.duty);
/*  30 */     _os_.marshal(this.dutyName, "UTF-8");
/*  31 */     return _os_;
/*     */   }
/*     */   
/*     */   public OctetsStream unmarshal(OctetsStream _os_) throws com.goldhuman.Common.Marshal.MarshalException
/*     */   {
/*  36 */     this.duty = _os_.unmarshal_int();
/*  37 */     this.dutyName = _os_.unmarshal_String("UTF-8");
/*  38 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.corps.confbean.SCorpsDutyCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.corps.confbean.SCorpsDutyCfg"))
/*     */         {
/*     */ 
/*  59 */           SCorpsDutyCfg obj = new SCorpsDutyCfg();
/*  60 */           obj.loadFromXml(elem);
/*  61 */           if (all.put(Integer.valueOf(obj.duty), obj) != null) {
/*  62 */             throw new RuntimeException("duplicate key : " + obj.duty);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SCorpsDutyCfg> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.corps.confbean.SCorpsDutyCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.corps.confbean.SCorpsDutyCfg"))
/*     */         {
/*     */ 
/*  88 */           SCorpsDutyCfg obj = new SCorpsDutyCfg();
/*  89 */           obj.loadFromXml(elem);
/*  90 */           if (all.put(Integer.valueOf(obj.duty), obj) != null) {
/*  91 */             throw new RuntimeException("duplicate key : " + obj.duty);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.corps.confbean.SCorpsDutyCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           SCorpsDutyCfg _v_ = new SCorpsDutyCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SCorpsDutyCfg> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.corps.confbean.SCorpsDutyCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           SCorpsDutyCfg _v_ = new SCorpsDutyCfg();
...
/*     */ 
/*     */ 
/*     */   public static SCorpsDutyCfg getOld(int key)
/*     */   {
/* 199 */     return (SCorpsDutyCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SCorpsDutyCfg get(int key)
/*     */   {
/* 204 */     return (SCorpsDutyCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SCorpsDutyCfg> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SCorpsDutyCfg> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SCorpsDutyCfg> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\corps\confbean\SCorpsDutyCfg.class
