...
/*     */ 
/*     */ public class SBackGameAwardCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SBackGameAwardCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SBackGameAwardCfg> all = null;
/*     */   
...
/*     */   {
/*  24 */     this.roleLevel = Integer.valueOf(rootElement.attributeValue("roleLevel")).intValue();
/*  25 */     this.silverValue = Integer.valueOf(rootElement.attributeValue("silverValue")).intValue();
/*  26 */     this.expValue = Integer.valueOf(rootElement.attributeValue("expValue")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  31 */     _os_.marshal(this.roleLevel);
/*  32 */     _os_.marshal(this.silverValue);
/*  33 */     _os_.marshal(this.expValue);
/*  34 */     return _os_;
/*     */   }
/*     */   
/*     */   public OctetsStream unmarshal(OctetsStream _os_) throws com.goldhuman.Common.Marshal.MarshalException
/*     */   {
/*  39 */     this.roleLevel = _os_.unmarshal_int();
/*  40 */     this.silverValue = _os_.unmarshal_int();
/*  41 */     this.expValue = _os_.unmarshal_int();
/*  42 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  47 */     String path = dir + "mzm.gsp.backgame.confbean.SBackGameAwardCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  60 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.backgame.confbean.SBackGameAwardCfg"))
/*     */         {
/*     */ 
/*  63 */           SBackGameAwardCfg obj = new SBackGameAwardCfg();
/*  64 */           obj.loadFromXml(elem);
/*  65 */           if (all.put(Integer.valueOf(obj.roleLevel), obj) != null) {
/*  66 */             throw new RuntimeException("duplicate key : " + obj.roleLevel);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SBackGameAwardCfg> all)
/*     */   {
/*  77 */     String path = dir + "mzm.gsp.backgame.confbean.SBackGameAwardCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  89 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.backgame.confbean.SBackGameAwardCfg"))
/*     */         {
/*     */ 
/*  92 */           SBackGameAwardCfg obj = new SBackGameAwardCfg();
/*  93 */           obj.loadFromXml(elem);
/*  94 */           if (all.put(Integer.valueOf(obj.roleLevel), obj) != null) {
/*  95 */             throw new RuntimeException("duplicate key : " + obj.roleLevel);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 108 */     String path = dir + "mzm.gsp.backgame.confbean.SBackGameAwardCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 135 */           SBackGameAwardCfg _v_ = new SBackGameAwardCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SBackGameAwardCfg> all)
/*     */   {
/* 155 */     String path = dir + "mzm.gsp.backgame.confbean.SBackGameAwardCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 182 */           SBackGameAwardCfg _v_ = new SBackGameAwardCfg();
...
/*     */ 
/*     */ 
/*     */   public static SBackGameAwardCfg getOld(int key)
/*     */   {
/* 203 */     return (SBackGameAwardCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SBackGameAwardCfg get(int key)
/*     */   {
/* 208 */     return (SBackGameAwardCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SBackGameAwardCfg> getOldAll()
/*     */   {
/* 213 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SBackGameAwardCfg> getAll()
/*     */   {
/* 218 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SBackGameAwardCfg> newAll)
/*     */   {
/* 223 */     oldAll = all;
/* 224 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\backgame\confbean\SBackGameAwardCfg.class
