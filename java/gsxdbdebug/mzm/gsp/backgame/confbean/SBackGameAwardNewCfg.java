...
/*     */ 
/*     */ public class SBackGameAwardNewCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SBackGameAwardNewCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SBackGameAwardNewCfg> all = null;
/*     */   
/*     */   public int day;
/*  19 */   public HashMap<Integer, Integer> serial_award_map = new HashMap();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.day = Integer.valueOf(rootElement.attributeValue("day")).intValue();
/*     */     
/*  25 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "serial_award_map");
...
/*     */         }
/*     */         
/*  76 */         this.serial_award_map.put(Integer.valueOf(_k_), Integer.valueOf(_v_));
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*     */   {
/*  83 */     _os_.marshal(this.day);
/*  84 */     _os_.compact_uint32(this.serial_award_map.size());
/*  85 */     for (java.util.Map.Entry<Integer, Integer> _e_ : this.serial_award_map.entrySet())
/*     */     {
...
/*     */   {
/*  95 */     this.day = _os_.unmarshal_int();
...
/* 102 */       this.serial_award_map.put(Integer.valueOf(_k_), Integer.valueOf(_v_));
/*     */     }
/* 104 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/* 109 */     String path = dir + "mzm.gsp.backgame.confbean.SBackGameAwardNewCfg.xml";
/*     */     
/*     */     try
/*     */     {
/* 113 */       all = new HashMap();
...
/* 122 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.backgame.confbean.SBackGameAwardNewCfg"))
/*     */         {
/*     */ 
/* 125 */           SBackGameAwardNewCfg obj = new SBackGameAwardNewCfg();
/* 126 */           obj.loadFromXml(elem);
/* 127 */           if (all.put(Integer.valueOf(obj.day), obj) != null) {
/* 128 */             throw new RuntimeException("duplicate key : " + obj.day);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SBackGameAwardNewCfg> all)
/*     */   {
/* 139 */     String path = dir + "mzm.gsp.backgame.confbean.SBackGameAwardNewCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 151 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.backgame.confbean.SBackGameAwardNewCfg"))
/*     */         {
/*     */ 
/* 154 */           SBackGameAwardNewCfg obj = new SBackGameAwardNewCfg();
/* 155 */           obj.loadFromXml(elem);
/* 156 */           if (all.put(Integer.valueOf(obj.day), obj) != null) {
/* 157 */             throw new RuntimeException("duplicate key : " + obj.day);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/* 168 */     all = new HashMap();
/*     */     
/* 170 */     String path = dir + "mzm.gsp.backgame.confbean.SBackGameAwardNewCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 197 */           SBackGameAwardNewCfg _v_ = new SBackGameAwardNewCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SBackGameAwardNewCfg> all)
/*     */   {
/* 217 */     String path = dir + "mzm.gsp.backgame.confbean.SBackGameAwardNewCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 244 */           SBackGameAwardNewCfg _v_ = new SBackGameAwardNewCfg();
...
/*     */ 
/*     */ 
/*     */   public static SBackGameAwardNewCfg getOld(int key)
/*     */   {
/* 265 */     return (SBackGameAwardNewCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SBackGameAwardNewCfg get(int key)
/*     */   {
/* 270 */     return (SBackGameAwardNewCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SBackGameAwardNewCfg> getOldAll()
/*     */   {
/* 275 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SBackGameAwardNewCfg> getAll()
/*     */   {
/* 280 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SBackGameAwardNewCfg> newAll)
/*     */   {
/* 285 */     oldAll = all;
/* 286 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\backgame\confbean\SBackGameAwardNewCfg.class
