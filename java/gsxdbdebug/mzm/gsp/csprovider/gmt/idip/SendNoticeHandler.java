...
/*     */       
/*  77 */       GameServer.logger().error(String.format("[gmt]SendNoticeHandler.execute@notice type invalid|noticeid=%d|notice_type=%d|display_type=%d|href_type=%d|href_text=%s|href_url=%s|send_type=%d|notice_title=%s|notice_content=%s|picture_url=%s|start_time=%d|end_time=%d|min_open_server_days=%d|max_open_server_days=%d|min_create_role_days=%d|max_create_role_days=%d|min_role_level=%d|max_role_level=%d|min_save_amt=%d|max_save_amt=%d|notice_tag=%d|badge=%d|notice_sortid=%d", new Object[] { Long.valueOf(noticeid), Integer.valueOf(noticeType), Integer.valueOf(displayType), Integer.valueOf(hrefType), hrefText, hrefUrl, Integer.valueOf(sendType), noticeTitle, noticeContent, pictureUrl, Long.valueOf(startTime), Long.valueOf(endTime), Integer.valueOf(minOpenServerDays), Integer.valueOf(maxOpenServerDays), Integer.valueOf(minCreateRoleDays), Integer.valueOf(maxCreateRoleDays), Integer.valueOf(minRoleLevel), Integer.valueOf(maxRoleLevel), Long.valueOf(minSaveAmt), Long.valueOf(maxSaveAmt), Integer.valueOf(noticeTag), Integer.valueOf(badge), Integer.valueOf(noticeSortId) }));
/*     */       
/*     */ 
/*     */ 
/*     */ 
...
/*     */       
/*  93 */       GameServer.logger().error(String.format("[gmt]SendNoticeHandler.execute@display type invalid|noticeid=%d|notice_type=%d|display_type=%d|href_type=%d|href_text=%s|href_url=%s|send_type=%d|notice_title=%s|notice_content=%s|picture_url=%s|start_time=%d|end_time=%d|min_open_server_days=%d|max_open_server_days=%d|min_create_role_days=%d|max_create_role_days=%d|min_role_level=%d|max_role_level=%d|min_save_amt=%d|max_save_amt=%d|notice_tag=%d|badge=%d|notice_sortid=%d", new Object[] { Long.valueOf(noticeid), Integer.valueOf(noticeType), Integer.valueOf(displayType), Integer.valueOf(hrefType), hrefText, hrefUrl, Integer.valueOf(sendType), noticeTitle, noticeContent, pictureUrl, Long.valueOf(startTime), Long.valueOf(endTime), Integer.valueOf(minOpenServerDays), Integer.valueOf(maxOpenServerDays), Integer.valueOf(minCreateRoleDays), Integer.valueOf(maxCreateRoleDays), Integer.valueOf(minRoleLevel), Integer.valueOf(maxRoleLevel), Long.valueOf(minSaveAmt), Long.valueOf(maxSaveAmt), Integer.valueOf(noticeTag), Integer.valueOf(badge), Integer.valueOf(noticeSortId) }));
/*     */       
/*     */ 
/*     */ 
/*     */ 
...
/*     */       
/* 109 */       GameServer.logger().error(String.format("[gmt]SendNoticeHandler.execute@href type invalid|noticeid=%d|notice_type=%d|display_type=%d|href_type=%d|href_text=%s|href_url=%s|send_type=%d|notice_title=%s|notice_content=%s|picture_url=%s|start_time=%d|end_time=%d|min_open_server_days=%d|max_open_server_days=%d|min_create_role_days=%d|max_create_role_days=%d|min_role_level=%d|max_role_level=%d|min_save_amt=%d|max_save_amt=%d|notice_tag=%d|badge=%d|notice_sortid=%d", new Object[] { Long.valueOf(noticeid), Integer.valueOf(noticeType), Integer.valueOf(displayType), Integer.valueOf(hrefType), hrefText, hrefUrl, Integer.valueOf(sendType), noticeTitle, noticeContent, pictureUrl, Long.valueOf(startTime), Long.valueOf(endTime), Integer.valueOf(minOpenServerDays), Integer.valueOf(maxOpenServerDays), Integer.valueOf(minCreateRoleDays), Integer.valueOf(maxCreateRoleDays), Integer.valueOf(minRoleLevel), Integer.valueOf(maxRoleLevel), Long.valueOf(minSaveAmt), Long.valueOf(maxSaveAmt), Integer.valueOf(noticeTag), Integer.valueOf(badge), Integer.valueOf(noticeSortId) }));
/*     */       
/*     */ 
/*     */ 
/*     */ 
...
/*     */       
/* 126 */       GameServer.logger().error(String.format("[gmt]SendNoticeHandler.execute@href text length invalid|noticeid=%d|notice_type=%d|display_type=%d|href_type=%d|href_text=%s|href_url=%s|send_type=%d|notice_title=%s|notice_content=%s|picture_url=%s|start_time=%d|end_time=%d|min_open_server_days=%d|max_open_server_days=%d|min_create_role_days=%d|max_create_role_days=%d|min_role_level=%d|max_role_level=%d|min_save_amt=%d|max_save_amt=%d|notice_tag=%d|badge=%d|notice_sortid=%d", new Object[] { Long.valueOf(noticeid), Integer.valueOf(noticeType), Integer.valueOf(displayType), Integer.valueOf(hrefType), hrefText, hrefUrl, Integer.valueOf(sendType), noticeTitle, noticeContent, pictureUrl, Long.valueOf(startTime), Long.valueOf(endTime), Integer.valueOf(minOpenServerDays), Integer.valueOf(maxOpenServerDays), Integer.valueOf(minCreateRoleDays), Integer.valueOf(maxCreateRoleDays), Integer.valueOf(minRoleLevel), Integer.valueOf(maxRoleLevel), Long.valueOf(minSaveAmt), Long.valueOf(maxSaveAmt), Integer.valueOf(noticeTag), Integer.valueOf(badge), Integer.valueOf(noticeSortId) }));
/*     */       
/*     */ 
/*     */ 
/*     */ 
...
/*     */       
/* 143 */       GameServer.logger().error(String.format("[gmt]SendNoticeHandler.execute@href url length invalid|noticeid=%d|notice_type=%d|display_type=%d|href_type=%d|href_text=%s|href_url=%s|send_type=%d|notice_title=%s|notice_content=%s|picture_url=%s|start_time=%d|end_time=%d|min_open_server_days=%d|max_open_server_days=%d|min_create_role_days=%d|max_create_role_days=%d|min_role_level=%d|max_role_level=%d|min_save_amt=%d|max_save_amt=%d|notice_tag=%d|badge=%d|notice_sortid=%d", new Object[] { Long.valueOf(noticeid), Integer.valueOf(noticeType), Integer.valueOf(displayType), Integer.valueOf(hrefType), hrefText, hrefUrl, Integer.valueOf(sendType), noticeTitle, noticeContent, pictureUrl, Long.valueOf(startTime), Long.valueOf(endTime), Integer.valueOf(minOpenServerDays), Integer.valueOf(maxOpenServerDays), Integer.valueOf(minCreateRoleDays), Integer.valueOf(maxCreateRoleDays), Integer.valueOf(minRoleLevel), Integer.valueOf(maxRoleLevel), Long.valueOf(minSaveAmt), Long.valueOf(maxSaveAmt), Integer.valueOf(noticeTag), Integer.valueOf(badge), Integer.valueOf(noticeSortId) }));
/*     */       
/*     */ 
/*     */ 
/*     */ 
...
/*     */       
/* 160 */       GameServer.logger().error(String.format("[gmt]SendNoticeHandler.execute@send type invalid|noticeid=%d|notice_type=%d|display_type=%d|href_type=%d|href_text=%s|href_url=%s|send_type=%d|notice_title=%s|notice_content=%s|picture_url=%s|start_time=%d|end_time=%d|min_open_server_days=%d|max_open_server_days=%d|min_create_role_days=%d|max_create_role_days=%d|min_role_level=%d|max_role_level=%d|min_save_amt=%d|max_save_amt=%d|notice_tag=%d|badge=%d|notice_sortid=%d", new Object[] { Long.valueOf(noticeid), Integer.valueOf(noticeType), Integer.valueOf(displayType), Integer.valueOf(hrefType), hrefText, hrefUrl, Integer.valueOf(sendType), noticeTitle, noticeContent, pictureUrl, Long.valueOf(startTime), Long.valueOf(endTime), Integer.valueOf(minOpenServerDays), Integer.valueOf(maxOpenServerDays), Integer.valueOf(minCreateRoleDays), Integer.valueOf(maxCreateRoleDays), Integer.valueOf(minRoleLevel), Integer.valueOf(maxRoleLevel), Long.valueOf(minSaveAmt), Long.valueOf(maxSaveAmt), Integer.valueOf(noticeTag), Integer.valueOf(badge), Integer.valueOf(noticeSortId) }));
/*     */       
/*     */ 
/*     */ 
/*     */ 
...
/*     */       
/* 177 */       GameServer.logger().error(String.format("[gmt]SendNoticeHandler.execute@title length invalid|noticeid=%d|notice_type=%d|display_type=%d|href_type=%d|href_text=%s|href_url=%s|send_type=%d|notice_title=%s|notice_content=%s|picture_url=%s|start_time=%d|end_time=%d|min_open_server_days=%d|max_open_server_days=%d|min_create_role_days=%d|max_create_role_days=%d|min_role_level=%d|max_role_level=%d|min_save_amt=%d|max_save_amt=%d|notice_tag=%d|badge=%d|notice_sortid=%d", new Object[] { Long.valueOf(noticeid), Integer.valueOf(noticeType), Integer.valueOf(displayType), Integer.valueOf(hrefType), hrefText, hrefUrl, Integer.valueOf(sendType), noticeTitle, noticeContent, pictureUrl, Long.valueOf(startTime), Long.valueOf(endTime), Integer.valueOf(minOpenServerDays), Integer.valueOf(maxOpenServerDays), Integer.valueOf(minCreateRoleDays), Integer.valueOf(maxCreateRoleDays), Integer.valueOf(minRoleLevel), Integer.valueOf(maxRoleLevel), Long.valueOf(minSaveAmt), Long.valueOf(maxSaveAmt), Integer.valueOf(noticeTag), Integer.valueOf(badge), Integer.valueOf(noticeSortId) }));
/*     */       
/*     */ 
/*     */ 
/*     */ 
...
/*     */       
/* 193 */       GameServer.logger().error(String.format("[gmt]SendNoticeHandler.execute@title length invalid|noticeid=%d|notice_type=%d|display_type=%d|href_type=%d|href_text=%s|href_url=%s|send_type=%d|notice_title=%s|notice_content=%s|picture_url=%s|start_time=%d|end_time=%d|min_open_server_days=%d|max_open_server_days=%d|min_create_role_days=%d|max_create_role_days=%d|min_role_level=%d|max_role_level=%d|min_save_amt=%d|max_save_amt=%d|notice_tag=%d|badge=%d|notice_sortid=%d", new Object[] { Long.valueOf(noticeid), Integer.valueOf(noticeType), Integer.valueOf(displayType), Integer.valueOf(hrefType), hrefText, hrefUrl, Integer.valueOf(sendType), noticeTitle, noticeContent, pictureUrl, Long.valueOf(startTime), Long.valueOf(endTime), Integer.valueOf(minOpenServerDays), Integer.valueOf(maxOpenServerDays), Integer.valueOf(minCreateRoleDays), Integer.valueOf(maxCreateRoleDays), Integer.valueOf(minRoleLevel), Integer.valueOf(maxRoleLevel), Long.valueOf(minSaveAmt), Long.valueOf(maxSaveAmt), Integer.valueOf(noticeTag), Integer.valueOf(badge), Integer.valueOf(noticeSortId) }));
/*     */       
/*     */ 
/*     */ 
/*     */ 
...
/*     */       
/* 210 */       GameServer.logger().error(String.format("[gmt]SendNoticeHandler.execute@content length invalid|noticeid=%d|notice_type=%d|display_type=%d|href_type=%d|href_text=%s|href_url=%s|send_type=%d|notice_title=%s|notice_content=%s|picture_url=%s|start_time=%d|end_time=%d|min_open_server_days=%d|max_open_server_days=%d|min_create_role_days=%d|max_create_role_days=%d|min_role_level=%d|max_role_level=%d|min_save_amt=%d|max_save_amt=%d|notice_tag=%d|badge=%d|notice_sortid=%d", new Object[] { Long.valueOf(noticeid), Integer.valueOf(noticeType), Integer.valueOf(displayType), Integer.valueOf(hrefType), hrefText, hrefUrl, Integer.valueOf(sendType), noticeTitle, noticeContent, pictureUrl, Long.valueOf(startTime), Long.valueOf(endTime), Integer.valueOf(minOpenServerDays), Integer.valueOf(maxOpenServerDays), Integer.valueOf(minCreateRoleDays), Integer.valueOf(maxCreateRoleDays), Integer.valueOf(minRoleLevel), Integer.valueOf(maxRoleLevel), Long.valueOf(minSaveAmt), Long.valueOf(maxSaveAmt), Integer.valueOf(noticeTag), Integer.valueOf(badge), Integer.valueOf(noticeSortId) }));
/*     */       
/*     */ 
/*     */ 
/*     */ 
...
/*     */       
/* 226 */       GameServer.logger().error(String.format("[gmt]SendNoticeHandler.execute@content length invalid|noticeid=%d|notice_type=%d|display_type=%d|href_type=%d|href_text=%s|href_url=%s|send_type=%d|notice_title=%s|notice_content=%s|picture_url=%s|start_time=%d|end_time=%d|min_open_server_days=%d|max_open_server_days=%d|min_create_role_days=%d|max_create_role_days=%d|min_role_level=%d|max_role_level=%d|min_save_amt=%d|max_save_amt=%d|notice_tag=%d|badge=%d|notice_sortid=%d", new Object[] { Long.valueOf(noticeid), Integer.valueOf(noticeType), Integer.valueOf(displayType), Integer.valueOf(hrefType), hrefText, hrefUrl, Integer.valueOf(sendType), noticeTitle, noticeContent, pictureUrl, Long.valueOf(startTime), Long.valueOf(endTime), Integer.valueOf(minOpenServerDays), Integer.valueOf(maxOpenServerDays), Integer.valueOf(minCreateRoleDays), Integer.valueOf(maxCreateRoleDays), Integer.valueOf(minRoleLevel), Integer.valueOf(maxRoleLevel), Long.valueOf(minSaveAmt), Long.valueOf(maxSaveAmt), Integer.valueOf(noticeTag), Integer.valueOf(badge), Integer.valueOf(noticeSortId) }));
/*     */       
/*     */ 
/*     */ 
/*     */ 
...
/*     */       
/* 243 */       GameServer.logger().error(String.format("[gmt]SendNoticeHandler.execute@picture url length invalid|noticeid=%d|notice_type=%d|display_type=%d|href_type=%d|href_text=%s|href_url=%s|send_type=%d|notice_title=%s|notice_content=%s|picture_url=%s|start_time=%d|end_time=%d|min_open_server_days=%d|max_open_server_days=%d|min_create_role_days=%d|max_create_role_days=%d|min_role_level=%d|max_role_level=%d|min_save_amt=%d|max_save_amt=%d|notice_tag=%d|badge=%d|notice_sortid=%d", new Object[] { Long.valueOf(noticeid), Integer.valueOf(noticeType), Integer.valueOf(displayType), Integer.valueOf(hrefType), hrefText, hrefUrl, Integer.valueOf(sendType), noticeTitle, noticeContent, pictureUrl, Long.valueOf(startTime), Long.valueOf(endTime), Integer.valueOf(minOpenServerDays), Integer.valueOf(maxOpenServerDays), Integer.valueOf(minCreateRoleDays), Integer.valueOf(maxCreateRoleDays), Integer.valueOf(minRoleLevel), Integer.valueOf(maxRoleLevel), Long.valueOf(minSaveAmt), Long.valueOf(maxSaveAmt), Integer.valueOf(noticeTag), Integer.valueOf(badge), Integer.valueOf(noticeSortId) }));
/*     */       
/*     */ 
/*     */ 
/*     */ 
...
/*     */       
/* 260 */       GameServer.logger().error(String.format("[gmt]SendNoticeHandler.execute@start time < 0|noticeid=%d|notice_type=%d|display_type=%d|href_type=%d|href_text=%s|href_url=%s|send_type=%d|notice_title=%s|notice_content=%s|picture_url=%s|start_time=%d|end_time=%d|min_open_server_days=%d|max_open_server_days=%d|min_create_role_days=%d|max_create_role_days=%d|min_role_level=%d|max_role_level=%d|min_save_amt=%d|max_save_amt=%d|notice_tag=%d|badge=%d|notice_sortid=%d", new Object[] { Long.valueOf(noticeid), Integer.valueOf(noticeType), Integer.valueOf(displayType), Integer.valueOf(hrefType), hrefText, hrefUrl, Integer.valueOf(sendType), noticeTitle, noticeContent, pictureUrl, Long.valueOf(startTime), Long.valueOf(endTime), Integer.valueOf(minOpenServerDays), Integer.valueOf(maxOpenServerDays), Integer.valueOf(minCreateRoleDays), Integer.valueOf(maxCreateRoleDays), Integer.valueOf(minRoleLevel), Integer.valueOf(maxRoleLevel), Long.valueOf(minSaveAmt), Long.valueOf(maxSaveAmt), Integer.valueOf(noticeTag), Integer.valueOf(badge), Integer.valueOf(noticeSortId) }));
/*     */       
/*     */ 
/*     */ 
/*     */ 
...
/*     */         
/* 279 */         GameServer.logger().error(String.format("[gmt]SendNoticeHandler.execute@end time invalid|noticeid=%d|notice_type=%d|display_type=%d|href_type=%d|href_text=%s|href_url=%s|send_type=%d|notice_title=%s|notice_content=%s|picture_url=%s|start_time=%d|end_time=%d|min_open_server_days=%d|max_open_server_days=%d|min_create_role_days=%d|max_create_role_days=%d|min_role_level=%d|max_role_level=%d|min_save_amt=%d|max_save_amt=%d|notice_tag=%d|badge=%d|notice_sortid=%d", new Object[] { Long.valueOf(noticeid), Integer.valueOf(noticeType), Integer.valueOf(displayType), Integer.valueOf(hrefType), hrefText, hrefUrl, Integer.valueOf(sendType), noticeTitle, noticeContent, pictureUrl, Long.valueOf(startTime), Long.valueOf(endTime), Integer.valueOf(minOpenServerDays), Integer.valueOf(maxOpenServerDays), Integer.valueOf(minCreateRoleDays), Integer.valueOf(maxCreateRoleDays), Integer.valueOf(minRoleLevel), Integer.valueOf(maxRoleLevel), Long.valueOf(minSaveAmt), Long.valueOf(maxSaveAmt), Integer.valueOf(noticeTag), Integer.valueOf(badge), Integer.valueOf(noticeSortId) }));
/*     */         
/*     */ 
/*     */ 
/*     */ 
...
/*     */         
/* 297 */         GameServer.logger().error(String.format("[gmt]SendNoticeHandler.execute@duration invalid|noticeid=%d|notice_type=%d|display_type=%d|href_type=%d|href_text=%s|href_url=%s|send_type=%d|notice_title=%s|notice_content=%s|picture_url=%s|start_time=%d|end_time=%d|min_open_server_days=%d|max_open_server_days=%d|min_create_role_days=%d|max_create_role_days=%d|min_role_level=%d|max_role_level=%d|min_save_amt=%d|max_save_amt=%d|notice_tag=%d|badge=%d|notice_sortid=%d", new Object[] { Long.valueOf(noticeid), Integer.valueOf(noticeType), Integer.valueOf(displayType), Integer.valueOf(hrefType), hrefText, hrefUrl, Integer.valueOf(sendType), noticeTitle, noticeContent, pictureUrl, Long.valueOf(startTime), Long.valueOf(endTime), Integer.valueOf(minOpenServerDays), Integer.valueOf(maxOpenServerDays), Integer.valueOf(minCreateRoleDays), Integer.valueOf(maxCreateRoleDays), Integer.valueOf(minRoleLevel), Integer.valueOf(maxRoleLevel), Long.valueOf(minSaveAmt), Long.valueOf(maxSaveAmt), Integer.valueOf(noticeTag), Integer.valueOf(badge), Integer.valueOf(noticeSortId) }));
/*     */         
/*     */ 
/*     */ 
/*     */ 
...
/*     */       
/* 315 */       GameServer.logger().error(String.format("[gmt]SendNoticeHandler.execute@open server days invalid|noticeid=%d|notice_type=%d|display_type=%d|href_type=%d|href_text=%s|href_url=%s|send_type=%d|notice_title=%s|notice_content=%s|picture_url=%s|start_time=%d|end_time=%d|min_open_server_days=%d|max_open_server_days=%d|min_create_role_days=%d|max_create_role_days=%d|min_role_level=%d|max_role_level=%d|min_save_amt=%d|max_save_amt=%d|notice_tag=%d|badge=%d|notice_sortid=%d", new Object[] { Long.valueOf(noticeid), Integer.valueOf(noticeType), Integer.valueOf(displayType), Integer.valueOf(hrefType), hrefText, hrefUrl, Integer.valueOf(sendType), noticeTitle, noticeContent, pictureUrl, Long.valueOf(startTime), Long.valueOf(endTime), Integer.valueOf(minOpenServerDays), Integer.valueOf(maxOpenServerDays), Integer.valueOf(minCreateRoleDays), Integer.valueOf(maxCreateRoleDays), Integer.valueOf(minRoleLevel), Integer.valueOf(maxRoleLevel), Long.valueOf(minSaveAmt), Long.valueOf(maxSaveAmt), Integer.valueOf(noticeTag), Integer.valueOf(badge), Integer.valueOf(noticeSortId) }));
/*     */       
/*     */ 
/*     */ 
/*     */ 
...
/*     */       
/* 332 */       GameServer.logger().error(String.format("[gmt]SendNoticeHandler.execute@create role days invalid|noticeid=%d|notice_type=%d|display_type=%d|href_type=%d|href_text=%s|href_url=%s|send_type=%d|notice_title=%s|notice_content=%s|picture_url=%s|start_time=%d|end_time=%d|min_open_server_days=%d|max_open_server_days=%d|min_create_role_days=%d|max_create_role_days=%d|min_role_level=%d|max_role_level=%d|min_save_amt=%d|max_save_amt=%d|notice_tag=%d|badge=%d|notice_sortid=%d", new Object[] { Long.valueOf(noticeid), Integer.valueOf(noticeType), Integer.valueOf(displayType), Integer.valueOf(hrefType), hrefText, hrefUrl, Integer.valueOf(sendType), noticeTitle, noticeContent, pictureUrl, Long.valueOf(startTime), Long.valueOf(endTime), Integer.valueOf(minOpenServerDays), Integer.valueOf(maxOpenServerDays), Integer.valueOf(minCreateRoleDays), Integer.valueOf(maxCreateRoleDays), Integer.valueOf(minRoleLevel), Integer.valueOf(maxRoleLevel), Long.valueOf(minSaveAmt), Long.valueOf(maxSaveAmt), Integer.valueOf(noticeTag), Integer.valueOf(badge), Integer.valueOf(noticeSortId) }));
/*     */       
/*     */ 
/*     */ 
/*     */ 
...
/*     */       
/* 349 */       GameServer.logger().error(String.format("[gmt]SendNoticeHandler.execute@role level invalid|noticeid=%d|notice_type=%d|display_type=%d|href_type=%d|href_text=%s|href_url=%s|send_type=%d|notice_title=%s|notice_content=%s|picture_url=%s|start_time=%d|end_time=%d|min_open_server_days=%d|max_open_server_days=%d|min_create_role_days=%d|max_create_role_days=%d|min_role_level=%d|max_role_level=%d|min_save_amt=%d|max_save_amt=%d|notice_tag=%d|badge=%d|notice_sortid=%d", new Object[] { Long.valueOf(noticeid), Integer.valueOf(noticeType), Integer.valueOf(displayType), Integer.valueOf(hrefType), hrefText, hrefUrl, Integer.valueOf(sendType), noticeTitle, noticeContent, pictureUrl, Long.valueOf(startTime), Long.valueOf(endTime), Integer.valueOf(minOpenServerDays), Integer.valueOf(maxOpenServerDays), Integer.valueOf(minCreateRoleDays), Integer.valueOf(maxCreateRoleDays), Integer.valueOf(minRoleLevel), Integer.valueOf(maxRoleLevel), Long.valueOf(minSaveAmt), Long.valueOf(maxSaveAmt), Integer.valueOf(noticeTag), Integer.valueOf(badge), Integer.valueOf(noticeSortId) }));
/*     */       
/*     */ 
/*     */ 
/*     */ 
...
/*     */       
/* 366 */       GameServer.logger().error(String.format("[gmt]SendNoticeHandler.execute@save amt invalid|noticeid=%d|notice_type=%d|display_type=%d|href_type=%d|href_text=%s|href_url=%s|send_type=%d|notice_title=%s|notice_content=%s|picture_url=%s|start_time=%d|end_time=%d|min_open_server_days=%d|max_open_server_days=%d|min_create_role_days=%d|max_create_role_days=%d|min_role_level=%d|max_role_level=%d|min_save_amt=%d|max_save_amt=%d|notice_tag=%d|badge=%d|notice_sortid=%d", new Object[] { Long.valueOf(noticeid), Integer.valueOf(noticeType), Integer.valueOf(displayType), Integer.valueOf(hrefType), hrefText, hrefUrl, Integer.valueOf(sendType), noticeTitle, noticeContent, pictureUrl, Long.valueOf(startTime), Long.valueOf(endTime), Integer.valueOf(minOpenServerDays), Integer.valueOf(maxOpenServerDays), Integer.valueOf(minCreateRoleDays), Integer.valueOf(maxCreateRoleDays), Integer.valueOf(minRoleLevel), Integer.valueOf(maxRoleLevel), Long.valueOf(minSaveAmt), Long.valueOf(maxSaveAmt), Integer.valueOf(noticeTag), Integer.valueOf(badge), Integer.valueOf(noticeSortId) }));
/*     */       
/*     */ 
/*     */ 
/*     */ 
...
/*     */       
/* 383 */       GameServer.logger().error(String.format("[gmt]SendNoticeHandler.execute@notice tag invalid|noticeid=%d|notice_type=%d|display_type=%d|href_type=%d|href_text=%s|href_url=%s|send_type=%d|notice_title=%s|notice_content=%s|picture_url=%s|start_time=%d|end_time=%d|min_open_server_days=%d|max_open_server_days=%d|min_create_role_days=%d|max_create_role_days=%d|min_role_level=%d|max_role_level=%d|min_save_amt=%d|max_save_amt=%d|notice_tag=%d|badge=%d|notice_sortid=%d", new Object[] { Long.valueOf(noticeid), Integer.valueOf(noticeType), Integer.valueOf(displayType), Integer.valueOf(hrefType), hrefText, hrefUrl, Integer.valueOf(sendType), noticeTitle, noticeContent, pictureUrl, Long.valueOf(startTime), Long.valueOf(endTime), Integer.valueOf(minOpenServerDays), Integer.valueOf(maxOpenServerDays), Integer.valueOf(minCreateRoleDays), Integer.valueOf(maxCreateRoleDays), Integer.valueOf(minRoleLevel), Integer.valueOf(maxRoleLevel), Long.valueOf(minSaveAmt), Long.valueOf(maxSaveAmt), Integer.valueOf(noticeTag), Integer.valueOf(badge), Integer.valueOf(noticeSortId) }));
/*     */       
/*     */ 
/*     */ 
/*     */ 
...
/*     */       
/* 400 */       GameServer.logger().error(String.format("[gmt]SendNoticeHandler.execute@notice sortid invalid|noticeid=%d|notice_type=%d|display_type=%d|href_type=%d|href_text=%s|href_url=%s|send_type=%d|notice_title=%s|notice_content=%s|picture_url=%s|start_time=%d|end_time=%d|min_open_server_days=%d|max_open_server_days=%d|min_create_role_days=%d|max_create_role_days=%d|min_role_level=%d|max_role_level=%d|min_save_amt=%d|max_save_amt=%d|notice_tag=%d|badge=%d|notice_sortid=%d", new Object[] { Long.valueOf(noticeid), Integer.valueOf(noticeType), Integer.valueOf(displayType), Integer.valueOf(hrefType), hrefText, hrefUrl, Integer.valueOf(sendType), noticeTitle, noticeContent, pictureUrl, Long.valueOf(startTime), Long.valueOf(endTime), Integer.valueOf(minOpenServerDays), Integer.valueOf(maxOpenServerDays), Integer.valueOf(minCreateRoleDays), Integer.valueOf(maxCreateRoleDays), Integer.valueOf(minRoleLevel), Integer.valueOf(maxRoleLevel), Long.valueOf(minSaveAmt), Long.valueOf(maxSaveAmt), Integer.valueOf(noticeTag), Integer.valueOf(badge), Integer.valueOf(noticeSortId) }));
/*     */       
/*     */ 
/*     */ 
/*     */ 
...
/*     */     }
/*     */     
/* 410 */     NoticeDataInfo notice = new NoticeDataInfo();
/* 411 */     notice.noticeType = noticeType;
/* 412 */     notice.displayType = displayType;
/* 413 */     notice.hrefType = hrefType;
/* 414 */     notice.hrefText = hrefText;
/* 415 */     notice.hrefUrl = hrefUrl;
/* 416 */     notice.sendType = sendType;
/* 417 */     notice.noticeTitle = noticeTitle;
/* 418 */     notice.noticeContent = noticeContent;
/* 419 */     notice.pictureUrl = pictureUrl;
/* 420 */     notice.startTime = startTime;
/* 421 */     notice.endTime = endTime;
/* 422 */     notice.minOpenServerDays = minOpenServerDays;
/* 423 */     notice.maxOpenServerDays = maxOpenServerDays;
/* 424 */     notice.minCreateRoleDays = minCreateRoleDays;
/* 425 */     notice.maxCreateRoleDays = maxCreateRoleDays;
/* 426 */     notice.minRoleLevel = minRoleLevel;
/* 427 */     notice.maxRoleLevel = maxRoleLevel;
/* 428 */     notice.minSaveAmt = minSaveAmt;
/* 429 */     notice.maxSaveAmt = maxSaveAmt;
/* 430 */     notice.noticeTag = noticeTag;
/* 431 */     notice.badge = (badge == 1);
/* 432 */     notice.noticeSortID = noticeSortId;
/* 433 */     notice.noticeId = noticeid;
/*     */     
/* 435 */     if (!NoticeInterface.addNotice(notice))
/*     */     {
/* 437 */       int retcode = Retcode.NOTICE_NOTICE_ID_DUPLICATED.value;
/* 438 */       rsp.retcode = retcode;
/* 439 */       Response response = IdipGmtUtil.getResponse(retcode, "noticeid duplicated");
/* 440 */       rsp.repdata.setString(response.toString(), GmtCmdManager.ENCODING);
/*     */       
/* 442 */       GameServer.logger().error(String.format("[gmt]SendNoticeHandler.execute@add notice failed|noticeid=%d|notice_type=%d|display_type=%d|href_type=%d|href_text=%s|href_url=%s|send_type=%d|notice_title=%s|notice_content=%s|picture_url=%s|start_time=%d|end_time=%d|min_open_server_days=%d|max_open_server_days=%d|min_create_role_days=%d|max_create_role_days=%d|min_role_level=%d|max_role_level=%d|min_save_amt=%d|max_save_amt=%d|notice_tag=%d|badge=%d|notice_sortid=%d", new Object[] { Long.valueOf(noticeid), Integer.valueOf(noticeType), Integer.valueOf(displayType), Integer.valueOf(hrefType), hrefText, hrefUrl, Integer.valueOf(sendType), noticeTitle, noticeContent, pictureUrl, Long.valueOf(startTime), Long.valueOf(endTime), Integer.valueOf(minOpenServerDays), Integer.valueOf(maxOpenServerDays), Integer.valueOf(minCreateRoleDays), Integer.valueOf(maxCreateRoleDays), Integer.valueOf(minRoleLevel), Integer.valueOf(maxRoleLevel), Long.valueOf(minSaveAmt), Long.valueOf(maxSaveAmt), Integer.valueOf(noticeTag), Integer.valueOf(badge), Integer.valueOf(noticeSortId) }));
/*     */       
/*     */ 
/*     */ 
/*     */ 
...
/*     */     
/* 468 */     GameServer.logger().info(String.format("[gmt]SendNoticeHandler.execute@add notice success|noticeid=%d|notice_type=%d|display_type=%d|href_type=%d|href_text=%s|href_url=%s|send_type=%d|notice_title=%s|notice_content=%s|picture_url=%s|start_time=%d|end_time=%d|min_open_server_days=%d|max_open_server_days=%d|min_create_role_days=%d|max_create_role_days=%d|min_role_level=%d|max_role_level=%d|min_save_amt=%d|max_save_amt=%d|notice_tag=%d|badge=%d|notice_sortid=%d", new Object[] { Long.valueOf(noticeid), Integer.valueOf(noticeType), Integer.valueOf(displayType), Integer.valueOf(hrefType), hrefText, hrefUrl, Integer.valueOf(sendType), noticeTitle, noticeContent, pictureUrl, Long.valueOf(startTime), Long.valueOf(endTime), Integer.valueOf(minOpenServerDays), Integer.valueOf(maxOpenServerDays), Integer.valueOf(minCreateRoleDays), Integer.valueOf(maxCreateRoleDays), Integer.valueOf(minRoleLevel), Integer.valueOf(maxRoleLevel), Long.valueOf(minSaveAmt), Long.valueOf(maxSaveAmt), Integer.valueOf(noticeTag), Integer.valueOf(badge), Integer.valueOf(noticeSortId) }));
/*     */   }
/*     */ }


/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\csprovider\gmt\idip\SendNoticeHandler.class
