...
/*     */ 
/*     */ public class SGrcGiftCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SGrcGiftCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SGrcGiftCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public int gift_count;
/*     */   public int send_max_times_everyday;
/*     */   public int receive_max_times_everyday;
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  25 */     this.id = Integer.valueOf(rootElement.attributeValue("id")).intValue();
/*  26 */     this.gift_count = Integer.valueOf(rootElement.attributeValue("gift_count")).intValue();
/*  27 */     this.send_max_times_everyday = Integer.valueOf(rootElement.attributeValue("send_max_times_everyday")).intValue();
/*  28 */     this.receive_max_times_everyday = Integer.valueOf(rootElement.attributeValue("receive_max_times_everyday")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  33 */     _os_.marshal(this.id);
/*  34 */     _os_.marshal(this.gift_count);
/*  35 */     _os_.marshal(this.send_max_times_everyday);
/*  36 */     _os_.marshal(this.receive_max_times_everyday);
/*  37 */     return _os_;
/*     */   }
/*     */   
...
/*  43 */     this.gift_count = _os_.unmarshal_int();
/*  44 */     this.send_max_times_everyday = _os_.unmarshal_int();
/*  45 */     this.receive_max_times_everyday = _os_.unmarshal_int();
/*  46 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  51 */     String path = dir + "mzm.gsp.grc.confbean.SGrcGiftCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  64 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.grc.confbean.SGrcGiftCfg"))
/*     */         {
/*     */ 
/*  67 */           SGrcGiftCfg obj = new SGrcGiftCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SGrcGiftCfg> all)
/*     */   {
/*  81 */     String path = dir + "mzm.gsp.grc.confbean.SGrcGiftCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.grc.confbean.SGrcGiftCfg"))
/*     */         {
/*     */ 
/*  96 */           SGrcGiftCfg obj = new SGrcGiftCfg();
...
/*     */     
/* 112 */     String path = dir + "mzm.gsp.grc.confbean.SGrcGiftCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 139 */           SGrcGiftCfg _v_ = new SGrcGiftCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SGrcGiftCfg> all)
/*     */   {
/* 159 */     String path = dir + "mzm.gsp.grc.confbean.SGrcGiftCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 186 */           SGrcGiftCfg _v_ = new SGrcGiftCfg();
...
/*     */ 
/*     */ 
/*     */   public static SGrcGiftCfg getOld(int key)
/*     */   {
/* 207 */     return (SGrcGiftCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SGrcGiftCfg get(int key)
/*     */   {
/* 212 */     return (SGrcGiftCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SGrcGiftCfg> getOldAll()
/*     */   {
/* 217 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SGrcGiftCfg> getAll()
/*     */   {
/* 222 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SGrcGiftCfg> newAll)
/*     */   {
/* 227 */     oldAll = all;
/* 228 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\grc\confbean\SGrcGiftCfg.class
