...
/*     */ 
/*     */ public class GrcGiftCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, GrcGiftCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, GrcGiftCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public String name;
...
/*  29 */     this.gift_type = Integer.valueOf(rootElement.attributeValue("gift_type")).intValue();
/*  30 */     this.gift_count = Integer.valueOf(rootElement.attributeValue("gift_count")).intValue();
/*  31 */     this.send_max_times_everyday = Integer.valueOf(rootElement.attributeValue("send_max_times_everyday")).intValue();
/*  32 */     this.receive_max_times_everyday = Integer.valueOf(rootElement.attributeValue("receive_max_times_everyday")).intValue();
/*     */   }
/*     */   
...
/*  40 */     _os_.marshal(this.gift_count);
/*  41 */     _os_.marshal(this.send_max_times_everyday);
/*  42 */     _os_.marshal(this.receive_max_times_everyday);
/*  43 */     return _os_;
/*     */   }
/*     */   
...
/*  51 */     this.gift_count = _os_.unmarshal_int();
/*  52 */     this.send_max_times_everyday = _os_.unmarshal_int();
/*  53 */     this.receive_max_times_everyday = _os_.unmarshal_int();
/*  54 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  59 */     String path = dir + "mzm.gsp.grc.confbean.GrcGiftCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  72 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.grc.confbean.GrcGiftCfg"))
/*     */         {
/*     */ 
/*  75 */           GrcGiftCfg obj = new GrcGiftCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, GrcGiftCfg> all)
/*     */   {
/*  89 */     String path = dir + "mzm.gsp.grc.confbean.GrcGiftCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 101 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.grc.confbean.GrcGiftCfg"))
/*     */         {
/*     */ 
/* 104 */           GrcGiftCfg obj = new GrcGiftCfg();
...
/*     */     
/* 120 */     String path = dir + "mzm.gsp.grc.confbean.GrcGiftCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 147 */           GrcGiftCfg _v_ = new GrcGiftCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, GrcGiftCfg> all)
/*     */   {
/* 167 */     String path = dir + "mzm.gsp.grc.confbean.GrcGiftCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 194 */           GrcGiftCfg _v_ = new GrcGiftCfg();
...
/*     */ 
/*     */ 
/*     */   public static GrcGiftCfg getOld(int key)
/*     */   {
/* 215 */     return (GrcGiftCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static GrcGiftCfg get(int key)
/*     */   {
/* 220 */     return (GrcGiftCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, GrcGiftCfg> getOldAll()
/*     */   {
/* 225 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, GrcGiftCfg> getAll()
/*     */   {
/* 230 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, GrcGiftCfg> newAll)
/*     */   {
/* 235 */     oldAll = all;
/* 236 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\grc\confbean\GrcGiftCfg.class
