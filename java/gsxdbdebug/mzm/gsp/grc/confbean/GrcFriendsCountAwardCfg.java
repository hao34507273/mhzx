...
/*     */ 
/*     */ public class GrcFriendsCountAwardCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, GrcFriendsCountAwardCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, GrcFriendsCountAwardCfg> all = null;
/*     */   
/*     */   public int id;
...
/*  26 */     this.serial_no = Integer.valueOf(rootElement.attributeValue("serial_no")).intValue();
/*  27 */     this.need_count = Integer.valueOf(rootElement.attributeValue("need_count")).intValue();
/*  28 */     this.award_cfg_id = Integer.valueOf(rootElement.attributeValue("award_cfg_id")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  33 */     _os_.marshal(this.id);
/*  34 */     _os_.marshal(this.serial_no);
/*  35 */     _os_.marshal(this.need_count);
/*  36 */     _os_.marshal(this.award_cfg_id);
/*  37 */     return _os_;
/*     */   }
/*     */   
...
/*  43 */     this.serial_no = _os_.unmarshal_int();
/*  44 */     this.need_count = _os_.unmarshal_int();
/*  45 */     this.award_cfg_id = _os_.unmarshal_int();
/*  46 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  51 */     String path = dir + "mzm.gsp.grc.confbean.GrcFriendsCountAwardCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  64 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.grc.confbean.GrcFriendsCountAwardCfg"))
/*     */         {
/*     */ 
/*  67 */           GrcFriendsCountAwardCfg obj = new GrcFriendsCountAwardCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, GrcFriendsCountAwardCfg> all)
/*     */   {
/*  81 */     String path = dir + "mzm.gsp.grc.confbean.GrcFriendsCountAwardCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.grc.confbean.GrcFriendsCountAwardCfg"))
/*     */         {
/*     */ 
/*  96 */           GrcFriendsCountAwardCfg obj = new GrcFriendsCountAwardCfg();
...
/*     */     
/* 112 */     String path = dir + "mzm.gsp.grc.confbean.GrcFriendsCountAwardCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 139 */           GrcFriendsCountAwardCfg _v_ = new GrcFriendsCountAwardCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, GrcFriendsCountAwardCfg> all)
/*     */   {
/* 159 */     String path = dir + "mzm.gsp.grc.confbean.GrcFriendsCountAwardCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 186 */           GrcFriendsCountAwardCfg _v_ = new GrcFriendsCountAwardCfg();
...
/*     */ 
/*     */ 
/*     */   public static GrcFriendsCountAwardCfg getOld(int key)
/*     */   {
/* 207 */     return (GrcFriendsCountAwardCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static GrcFriendsCountAwardCfg get(int key)
/*     */   {
/* 212 */     return (GrcFriendsCountAwardCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, GrcFriendsCountAwardCfg> getOldAll()
/*     */   {
/* 217 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, GrcFriendsCountAwardCfg> getAll()
/*     */   {
/* 222 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, GrcFriendsCountAwardCfg> newAll)
/*     */   {
/* 227 */     oldAll = all;
/* 228 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\grc\confbean\GrcFriendsCountAwardCfg.class
