...
/*     */ 
/*     */ public class SRecallFriendNumAwardCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SRecallFriendNumAwardCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SRecallFriendNumAwardCfg> all = null;
/*     */   
/*     */   public int serialNo;
/*     */   public int recallFriendNum;
/*     */   public int awardId;
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  24 */     this.serialNo = Integer.valueOf(rootElement.attributeValue("serialNo")).intValue();
/*  25 */     this.recallFriendNum = Integer.valueOf(rootElement.attributeValue("recallFriendNum")).intValue();
/*  26 */     this.awardId = Integer.valueOf(rootElement.attributeValue("awardId")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  31 */     _os_.marshal(this.serialNo);
/*  32 */     _os_.marshal(this.recallFriendNum);
...
/*     */   {
/*  39 */     this.serialNo = _os_.unmarshal_int();
/*  40 */     this.recallFriendNum = _os_.unmarshal_int();
...
/*     */   {
/*  47 */     String path = dir + "mzm.gsp.grc.confbean.SRecallFriendNumAwardCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  60 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.grc.confbean.SRecallFriendNumAwardCfg"))
/*     */         {
/*     */ 
/*  63 */           SRecallFriendNumAwardCfg obj = new SRecallFriendNumAwardCfg();
/*  64 */           obj.loadFromXml(elem);
/*  65 */           if (all.put(Integer.valueOf(obj.serialNo), obj) != null) {
/*  66 */             throw new RuntimeException("duplicate key : " + obj.serialNo);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SRecallFriendNumAwardCfg> all)
/*     */   {
/*  77 */     String path = dir + "mzm.gsp.grc.confbean.SRecallFriendNumAwardCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  89 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.grc.confbean.SRecallFriendNumAwardCfg"))
/*     */         {
/*     */ 
/*  92 */           SRecallFriendNumAwardCfg obj = new SRecallFriendNumAwardCfg();
/*  93 */           obj.loadFromXml(elem);
/*  94 */           if (all.put(Integer.valueOf(obj.serialNo), obj) != null) {
/*  95 */             throw new RuntimeException("duplicate key : " + obj.serialNo);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 108 */     String path = dir + "mzm.gsp.grc.confbean.SRecallFriendNumAwardCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 135 */           SRecallFriendNumAwardCfg _v_ = new SRecallFriendNumAwardCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SRecallFriendNumAwardCfg> all)
/*     */   {
/* 155 */     String path = dir + "mzm.gsp.grc.confbean.SRecallFriendNumAwardCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 182 */           SRecallFriendNumAwardCfg _v_ = new SRecallFriendNumAwardCfg();
...
/*     */ 
/*     */ 
/*     */   public static SRecallFriendNumAwardCfg getOld(int key)
/*     */   {
/* 203 */     return (SRecallFriendNumAwardCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SRecallFriendNumAwardCfg get(int key)
/*     */   {
/* 208 */     return (SRecallFriendNumAwardCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SRecallFriendNumAwardCfg> getOldAll()
/*     */   {
/* 213 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SRecallFriendNumAwardCfg> getAll()
/*     */   {
/* 218 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SRecallFriendNumAwardCfg> newAll)
/*     */   {
/* 223 */     oldAll = all;
/* 224 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\grc\confbean\SRecallFriendNumAwardCfg.class
