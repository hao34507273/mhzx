...
/*     */ 
/*     */ public class STMultiLineTaskModCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, STMultiLineTaskModCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, STMultiLineTaskModCfg> all = null;
/*     */   
/*     */   public int activityId;
/*  19 */   public HashMap<Integer, Integer> circle2modId = new HashMap();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.activityId = Integer.valueOf(rootElement.attributeValue("activityId")).intValue();
/*     */     
/*  25 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "circle2modId");
...
/*     */         }
/*     */         
/*  76 */         this.circle2modId.put(Integer.valueOf(_k_), Integer.valueOf(_v_));
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*  84 */     _os_.compact_uint32(this.circle2modId.size());
/*  85 */     for (java.util.Map.Entry<Integer, Integer> _e_ : this.circle2modId.entrySet())
/*     */     {
...
/* 102 */       this.circle2modId.put(Integer.valueOf(_k_), Integer.valueOf(_v_));
/*     */     }
/* 104 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/* 109 */     String path = dir + "mzm.gsp.activity3.confbean.STMultiLineTaskModCfg.xml";
/*     */     
/*     */     try
/*     */     {
/* 113 */       all = new HashMap();
...
/* 122 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity3.confbean.STMultiLineTaskModCfg"))
/*     */         {
/*     */ 
/* 125 */           STMultiLineTaskModCfg obj = new STMultiLineTaskModCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, STMultiLineTaskModCfg> all)
/*     */   {
/* 139 */     String path = dir + "mzm.gsp.activity3.confbean.STMultiLineTaskModCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 151 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity3.confbean.STMultiLineTaskModCfg"))
/*     */         {
/*     */ 
/* 154 */           STMultiLineTaskModCfg obj = new STMultiLineTaskModCfg();
...
/* 168 */     all = new HashMap();
/*     */     
/* 170 */     String path = dir + "mzm.gsp.activity3.confbean.STMultiLineTaskModCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 197 */           STMultiLineTaskModCfg _v_ = new STMultiLineTaskModCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, STMultiLineTaskModCfg> all)
/*     */   {
/* 217 */     String path = dir + "mzm.gsp.activity3.confbean.STMultiLineTaskModCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 244 */           STMultiLineTaskModCfg _v_ = new STMultiLineTaskModCfg();
...
/*     */ 
/*     */ 
/*     */   public static STMultiLineTaskModCfg getOld(int key)
/*     */   {
/* 265 */     return (STMultiLineTaskModCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static STMultiLineTaskModCfg get(int key)
/*     */   {
/* 270 */     return (STMultiLineTaskModCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, STMultiLineTaskModCfg> getOldAll()
/*     */   {
/* 275 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, STMultiLineTaskModCfg> getAll()
/*     */   {
/* 280 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, STMultiLineTaskModCfg> newAll)
/*     */   {
/* 285 */     oldAll = all;
/* 286 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\activity3\confbean\STMultiLineTaskModCfg.class
