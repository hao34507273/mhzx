...
/*     */ 
/*     */ public class SFireworkCollectCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SFireworkCollectCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SFireworkCollectCfg> all = null;
/*     */   
/*     */   public int id;
...
/*  28 */     this.triggerTime = Integer.valueOf(rootElement.attributeValue("triggerTime")).intValue();
...
/*  37 */     _os_.marshal(this.triggerTime);
/*  38 */     _os_.marshal(this.mapId);
/*  39 */     _os_.marshal(this.controllerId);
/*  40 */     return _os_;
/*     */   }
/*     */   
...
/*  47 */     this.triggerTime = _os_.unmarshal_int();
/*  48 */     this.mapId = _os_.unmarshal_int();
/*  49 */     this.controllerId = _os_.unmarshal_int();
/*  50 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  55 */     String path = dir + "mzm.gsp.activity3.confbean.SFireworkCollectCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  68 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity3.confbean.SFireworkCollectCfg"))
/*     */         {
/*     */ 
/*  71 */           SFireworkCollectCfg obj = new SFireworkCollectCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SFireworkCollectCfg> all)
/*     */   {
/*  85 */     String path = dir + "mzm.gsp.activity3.confbean.SFireworkCollectCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  97 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity3.confbean.SFireworkCollectCfg"))
/*     */         {
/*     */ 
/* 100 */           SFireworkCollectCfg obj = new SFireworkCollectCfg();
...
/*     */     
/* 116 */     String path = dir + "mzm.gsp.activity3.confbean.SFireworkCollectCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 143 */           SFireworkCollectCfg _v_ = new SFireworkCollectCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SFireworkCollectCfg> all)
/*     */   {
/* 163 */     String path = dir + "mzm.gsp.activity3.confbean.SFireworkCollectCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 190 */           SFireworkCollectCfg _v_ = new SFireworkCollectCfg();
...
/*     */ 
/*     */ 
/*     */   public static SFireworkCollectCfg getOld(int key)
/*     */   {
/* 211 */     return (SFireworkCollectCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SFireworkCollectCfg get(int key)
/*     */   {
/* 216 */     return (SFireworkCollectCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SFireworkCollectCfg> getOldAll()
/*     */   {
/* 221 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SFireworkCollectCfg> getAll()
/*     */   {
/* 226 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SFireworkCollectCfg> newAll)
/*     */   {
/* 231 */     oldAll = all;
/* 232 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\activity3\confbean\SFireworkCollectCfg.class
