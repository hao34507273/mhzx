...
/*     */ 
/*     */ public class SMultiLineTaskModCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SMultiLineTaskModCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SMultiLineTaskModCfg> all = null;
/*     */   
/*     */   public int id;
...
/*  27 */     this.ringNum = Integer.valueOf(rootElement.attributeValue("ringNum")).intValue();
/*  28 */     this.modId = Integer.valueOf(rootElement.attributeValue("modId")).intValue();
/*     */   }
/*     */   
...
/*  35 */     _os_.marshal(this.ringNum);
/*  36 */     _os_.marshal(this.modId);
/*  37 */     return _os_;
/*     */   }
/*     */   
...
/*  44 */     this.ringNum = _os_.unmarshal_int();
/*  45 */     this.modId = _os_.unmarshal_int();
/*  46 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  51 */     String path = dir + "mzm.gsp.activity3.confbean.SMultiLineTaskModCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  64 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity3.confbean.SMultiLineTaskModCfg"))
/*     */         {
/*     */ 
/*  67 */           SMultiLineTaskModCfg obj = new SMultiLineTaskModCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SMultiLineTaskModCfg> all)
/*     */   {
/*  81 */     String path = dir + "mzm.gsp.activity3.confbean.SMultiLineTaskModCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity3.confbean.SMultiLineTaskModCfg"))
/*     */         {
/*     */ 
/*  96 */           SMultiLineTaskModCfg obj = new SMultiLineTaskModCfg();
...
/*     */     
/* 112 */     String path = dir + "mzm.gsp.activity3.confbean.SMultiLineTaskModCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 139 */           SMultiLineTaskModCfg _v_ = new SMultiLineTaskModCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SMultiLineTaskModCfg> all)
/*     */   {
/* 159 */     String path = dir + "mzm.gsp.activity3.confbean.SMultiLineTaskModCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 186 */           SMultiLineTaskModCfg _v_ = new SMultiLineTaskModCfg();
...
/*     */ 
/*     */ 
/*     */   public static SMultiLineTaskModCfg getOld(int key)
/*     */   {
/* 207 */     return (SMultiLineTaskModCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SMultiLineTaskModCfg get(int key)
/*     */   {
/* 212 */     return (SMultiLineTaskModCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMultiLineTaskModCfg> getOldAll()
/*     */   {
/* 217 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMultiLineTaskModCfg> getAll()
/*     */   {
/* 222 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SMultiLineTaskModCfg> newAll)
/*     */   {
/* 227 */     oldAll = all;
/* 228 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\activity3\confbean\SMultiLineTaskModCfg.class
