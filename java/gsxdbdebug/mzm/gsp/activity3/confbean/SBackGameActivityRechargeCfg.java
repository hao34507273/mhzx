...
/*     */ 
/*     */ public class SBackGameActivityRechargeCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SBackGameActivityRechargeCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SBackGameActivityRechargeCfg> all = null;
/*     */   
/*     */   public int id;
...
/*  24 */     this.accumulateRechargeTypeId = Integer.valueOf(rootElement.attributeValue("accumulateRechargeTypeId")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  29 */     _os_.marshal(this.id);
/*  30 */     _os_.marshal(this.accumulateRechargeTypeId);
/*  31 */     return _os_;
/*     */   }
/*     */   
...
/*  37 */     this.accumulateRechargeTypeId = _os_.unmarshal_int();
/*  38 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.activity3.confbean.SBackGameActivityRechargeCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity3.confbean.SBackGameActivityRechargeCfg"))
/*     */         {
/*     */ 
/*  59 */           SBackGameActivityRechargeCfg obj = new SBackGameActivityRechargeCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SBackGameActivityRechargeCfg> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.activity3.confbean.SBackGameActivityRechargeCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity3.confbean.SBackGameActivityRechargeCfg"))
/*     */         {
/*     */ 
/*  88 */           SBackGameActivityRechargeCfg obj = new SBackGameActivityRechargeCfg();
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.activity3.confbean.SBackGameActivityRechargeCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           SBackGameActivityRechargeCfg _v_ = new SBackGameActivityRechargeCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SBackGameActivityRechargeCfg> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.activity3.confbean.SBackGameActivityRechargeCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           SBackGameActivityRechargeCfg _v_ = new SBackGameActivityRechargeCfg();
...
/*     */ 
/*     */ 
/*     */   public static SBackGameActivityRechargeCfg getOld(int key)
/*     */   {
/* 199 */     return (SBackGameActivityRechargeCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SBackGameActivityRechargeCfg get(int key)
/*     */   {
/* 204 */     return (SBackGameActivityRechargeCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SBackGameActivityRechargeCfg> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SBackGameActivityRechargeCfg> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SBackGameActivityRechargeCfg> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\activity3\confbean\SBackGameActivityRechargeCfg.class
