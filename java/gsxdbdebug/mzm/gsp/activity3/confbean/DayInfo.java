...
/*    */ 
/*    */ public class DayInfo implements com.goldhuman.Common.Marshal.Marshal
/*    */ {
/*  9 */   public HashMap<Integer, ServerInfo> day2ServerIds = new HashMap();
/*    */   
/*    */ 
/*    */   public void loadFromXml(Element rootElement)
/*    */   {
/* 14 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "day2ServerIds");
...
/* 40 */             keyElem = elem;
/*    */           }
/* 42 */           else if ((valueElem == null) && (elem.getName().equalsIgnoreCase("mzm.gsp.activity3.confbean.ServerInfo")))
/*    */           {
/* 44 */             valueElem = elem;
/*    */           }
/*    */         }
...
/*    */         }
/*    */         
/* 66 */         this.day2ServerIds.put(Integer.valueOf(_k_), _v_);
/*    */       }
/*    */     }
/*    */   }
/*    */   
...
/*    */   {
/* 73 */     _os_.compact_uint32(this.day2ServerIds.size());
/* 74 */     for (java.util.Map.Entry<Integer, ServerInfo> _e_ : this.day2ServerIds.entrySet())
/*    */     {
...
/*    */       
/* 89 */       ServerInfo _v_ = new ServerInfo();
/* 90 */       _v_.unmarshal(_os_);
/* 91 */       this.day2ServerIds.put(Integer.valueOf(_k_), _v_);
/*    */     }
/* 93 */     return _os_;
/*    */   }
/*    */ }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\activity3\confbean\DayInfo.class
