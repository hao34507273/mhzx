...
/*     */ 
/*     */ public class STSurpriseItemConCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, STSurpriseItemConCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, STSurpriseItemConCfg> all = null;
/*     */   
/*     */   public int libId;
/*  19 */   public HashMap<Integer, NeedItemInfo> needItemDatas = new HashMap();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.libId = Integer.valueOf(rootElement.attributeValue("libId")).intValue();
/*     */     
/*  25 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "needItemDatas");
...
/*  51 */             keyElem = elem;
/*     */           }
/*  53 */           else if ((valueElem == null) && (elem.getName().equalsIgnoreCase("mzm.gsp.activity3.confbean.NeedItemInfo")))
/*     */           {
/*  55 */             valueElem = elem;
/*     */           }
/*     */         }
...
/*     */         }
/*     */         
/*  77 */         this.needItemDatas.put(Integer.valueOf(_k_), _v_);
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*     */   {
/*  84 */     _os_.marshal(this.libId);
/*  85 */     _os_.compact_uint32(this.needItemDatas.size());
/*  86 */     for (java.util.Map.Entry<Integer, NeedItemInfo> _e_ : this.needItemDatas.entrySet())
/*     */     {
...
/*     */   {
/*  96 */     this.libId = _os_.unmarshal_int();
/*  97 */     for (int _size_ = _os_.uncompact_uint32(); _size_ > 0; _size_--)
/*     */     {
/*     */ 
/* 100 */       int _k_ = _os_.unmarshal_int();
/*     */       
/* 102 */       NeedItemInfo _v_ = new NeedItemInfo();
/* 103 */       _v_.unmarshal(_os_);
/* 104 */       this.needItemDatas.put(Integer.valueOf(_k_), _v_);
/*     */     }
/* 106 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/* 111 */     String path = dir + "mzm.gsp.activity3.confbean.STSurpriseItemConCfg.xml";
/*     */     
/*     */     try
/*     */     {
/* 115 */       all = new HashMap();
...
/* 124 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity3.confbean.STSurpriseItemConCfg"))
/*     */         {
/*     */ 
/* 127 */           STSurpriseItemConCfg obj = new STSurpriseItemConCfg();
/* 128 */           obj.loadFromXml(elem);
/* 129 */           if (all.put(Integer.valueOf(obj.libId), obj) != null) {
/* 130 */             throw new RuntimeException("duplicate key : " + obj.libId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, STSurpriseItemConCfg> all)
/*     */   {
/* 141 */     String path = dir + "mzm.gsp.activity3.confbean.STSurpriseItemConCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 153 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity3.confbean.STSurpriseItemConCfg"))
/*     */         {
/*     */ 
/* 156 */           STSurpriseItemConCfg obj = new STSurpriseItemConCfg();
/* 157 */           obj.loadFromXml(elem);
/* 158 */           if (all.put(Integer.valueOf(obj.libId), obj) != null) {
/* 159 */             throw new RuntimeException("duplicate key : " + obj.libId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/* 170 */     all = new HashMap();
/*     */     
/* 172 */     String path = dir + "mzm.gsp.activity3.confbean.STSurpriseItemConCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 199 */           STSurpriseItemConCfg _v_ = new STSurpriseItemConCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, STSurpriseItemConCfg> all)
/*     */   {
/* 219 */     String path = dir + "mzm.gsp.activity3.confbean.STSurpriseItemConCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 246 */           STSurpriseItemConCfg _v_ = new STSurpriseItemConCfg();
...
/*     */ 
/*     */ 
/*     */   public static STSurpriseItemConCfg getOld(int key)
/*     */   {
/* 267 */     return (STSurpriseItemConCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static STSurpriseItemConCfg get(int key)
/*     */   {
/* 272 */     return (STSurpriseItemConCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, STSurpriseItemConCfg> getOldAll()
/*     */   {
/* 277 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, STSurpriseItemConCfg> getAll()
/*     */   {
/* 282 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, STSurpriseItemConCfg> newAll)
/*     */   {
/* 287 */     oldAll = all;
/* 288 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\activity3\confbean\STSurpriseItemConCfg.class
