...
/*     */ 
/*     */ public class SurpriseConsts
/*     */ {
/*  13 */   private static volatile SurpriseConsts oldInstance = null;
/*     */   
/*  15 */   private static SurpriseConsts instance = new SurpriseConsts();
/*     */   
/*     */ 
/*     */   public int ACTIVE_TIP_EFFECT;
/*     */   
/*     */ 
/*     */   public static SurpriseConsts getOldInstance()
/*     */   {
/*  23 */     return oldInstance;
/*     */   }
/*     */   
/*     */   public static SurpriseConsts getInstance()
/*     */   {
/*  28 */     return instance;
/*     */   }
/*     */   
...
/*     */   {
/*  40 */     String path = dir + "mzm.gsp.activity3.confbean.SurpriseConsts.xml";
/*     */     try
/*     */     {
...
/*     */         }
/*     */       }
/*  60 */       this.ACTIVE_TIP_EFFECT = Integer.valueOf(((Element)data.get("ACTIVE_TIP_EFFECT")).attributeValue("value")).intValue();
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*  69 */     String path = dir + "mzm.gsp.activity3.confbean.SurpriseConsts.xml";
/*     */     try
/*     */     {
...
/*     */         }
/*     */       }
/*  89 */       this.ACTIVE_TIP_EFFECT = Integer.valueOf(((Element)data.get("ACTIVE_TIP_EFFECT")).attributeValue("value")).intValue();
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/* 100 */     String path = dir + "mzm.gsp.activity3.confbean.SurpriseConsts.bny";
/*     */     try
/*     */     {
...
/* 115 */         this.ACTIVE_TIP_EFFECT = _os_.unmarshal_int();
/*     */       }
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*     */   {
/* 126 */     String path = dir + "mzm.gsp.activity3.confbean.SurpriseConsts.bny";
/*     */     try
/*     */     {
...
/* 141 */         this.ACTIVE_TIP_EFFECT = _os_.unmarshal_int();
/*     */       }
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*     */   }
/*     */   
/*     */   public static void setInstance(SurpriseConsts newInstance)
/*     */   {
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\activity3\confbean\SurpriseConsts.class
