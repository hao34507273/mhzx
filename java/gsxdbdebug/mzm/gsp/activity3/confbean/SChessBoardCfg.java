...
/*     */ 
/*     */ public class SChessBoardCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SChessBoardCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SChessBoardCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public int typeId;
/*     */   public int row;
...
/*  27 */     this.row = Integer.valueOf(rootElement.attributeValue("row")).intValue();
/*  28 */     this.column = Integer.valueOf(rootElement.attributeValue("column")).intValue();
/*     */   }
/*     */   
...
/*  35 */     _os_.marshal(this.row);
/*  36 */     _os_.marshal(this.column);
/*  37 */     return _os_;
/*     */   }
/*     */   
...
/*  44 */     this.row = _os_.unmarshal_int();
/*  45 */     this.column = _os_.unmarshal_int();
/*  46 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  51 */     String path = dir + "mzm.gsp.activity3.confbean.SChessBoardCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  64 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity3.confbean.SChessBoardCfg"))
/*     */         {
/*     */ 
/*  67 */           SChessBoardCfg obj = new SChessBoardCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SChessBoardCfg> all)
/*     */   {
/*  81 */     String path = dir + "mzm.gsp.activity3.confbean.SChessBoardCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity3.confbean.SChessBoardCfg"))
/*     */         {
/*     */ 
/*  96 */           SChessBoardCfg obj = new SChessBoardCfg();
...
/*     */     
/* 112 */     String path = dir + "mzm.gsp.activity3.confbean.SChessBoardCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 139 */           SChessBoardCfg _v_ = new SChessBoardCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SChessBoardCfg> all)
/*     */   {
/* 159 */     String path = dir + "mzm.gsp.activity3.confbean.SChessBoardCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 186 */           SChessBoardCfg _v_ = new SChessBoardCfg();
...
/*     */ 
/*     */ 
/*     */   public static SChessBoardCfg getOld(int key)
/*     */   {
/* 207 */     return (SChessBoardCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SChessBoardCfg get(int key)
/*     */   {
/* 212 */     return (SChessBoardCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SChessBoardCfg> getOldAll()
/*     */   {
/* 217 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SChessBoardCfg> getAll()
/*     */   {
/* 222 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SChessBoardCfg> newAll)
/*     */   {
/* 227 */     oldAll = all;
/* 228 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\activity3\confbean\SChessBoardCfg.class
