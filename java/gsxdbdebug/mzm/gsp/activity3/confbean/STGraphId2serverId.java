...
/*     */ 
/*     */ public class STGraphId2serverId implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, STGraphId2serverId> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, STGraphId2serverId> all = null;
/*     */   
/*     */   public int graphId;
/*     */   public int serverId;
/*     */   
...
/*  24 */     this.serverId = Integer.valueOf(rootElement.attributeValue("serverId")).intValue();
/*     */   }
/*     */   
...
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.activity3.confbean.STGraphId2serverId.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity3.confbean.STGraphId2serverId"))
/*     */         {
/*     */ 
/*  59 */           STGraphId2serverId obj = new STGraphId2serverId();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, STGraphId2serverId> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.activity3.confbean.STGraphId2serverId.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity3.confbean.STGraphId2serverId"))
/*     */         {
/*     */ 
/*  88 */           STGraphId2serverId obj = new STGraphId2serverId();
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.activity3.confbean.STGraphId2serverId.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           STGraphId2serverId _v_ = new STGraphId2serverId();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, STGraphId2serverId> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.activity3.confbean.STGraphId2serverId.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           STGraphId2serverId _v_ = new STGraphId2serverId();
...
/*     */ 
/*     */ 
/*     */   public static STGraphId2serverId getOld(int key)
/*     */   {
/* 199 */     return (STGraphId2serverId)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static STGraphId2serverId get(int key)
/*     */   {
/* 204 */     return (STGraphId2serverId)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, STGraphId2serverId> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, STGraphId2serverId> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, STGraphId2serverId> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\activity3\confbean\STGraphId2serverId.class
