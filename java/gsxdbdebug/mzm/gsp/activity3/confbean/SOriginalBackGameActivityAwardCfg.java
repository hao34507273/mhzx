...
/*     */ 
/*     */ public class SOriginalBackGameActivityAwardCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SOriginalBackGameActivityAwardCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SOriginalBackGameActivityAwardCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public int awardTierTypeId;
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.id = Integer.valueOf(rootElement.attributeValue("id")).intValue();
/*  24 */     this.awardTierTypeId = Integer.valueOf(rootElement.attributeValue("awardTierTypeId")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  29 */     _os_.marshal(this.id);
/*  30 */     _os_.marshal(this.awardTierTypeId);
/*  31 */     return _os_;
/*     */   }
/*     */   
...
/*  37 */     this.awardTierTypeId = _os_.unmarshal_int();
/*  38 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.activity3.confbean.SOriginalBackGameActivityAwardCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity3.confbean.SOriginalBackGameActivityAwardCfg"))
/*     */         {
/*     */ 
/*  59 */           SOriginalBackGameActivityAwardCfg obj = new SOriginalBackGameActivityAwardCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SOriginalBackGameActivityAwardCfg> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.activity3.confbean.SOriginalBackGameActivityAwardCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity3.confbean.SOriginalBackGameActivityAwardCfg"))
/*     */         {
/*     */ 
/*  88 */           SOriginalBackGameActivityAwardCfg obj = new SOriginalBackGameActivityAwardCfg();
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.activity3.confbean.SOriginalBackGameActivityAwardCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           SOriginalBackGameActivityAwardCfg _v_ = new SOriginalBackGameActivityAwardCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SOriginalBackGameActivityAwardCfg> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.activity3.confbean.SOriginalBackGameActivityAwardCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           SOriginalBackGameActivityAwardCfg _v_ = new SOriginalBackGameActivityAwardCfg();
...
/*     */ 
/*     */ 
/*     */   public static SOriginalBackGameActivityAwardCfg getOld(int key)
/*     */   {
/* 199 */     return (SOriginalBackGameActivityAwardCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SOriginalBackGameActivityAwardCfg get(int key)
/*     */   {
/* 204 */     return (SOriginalBackGameActivityAwardCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SOriginalBackGameActivityAwardCfg> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SOriginalBackGameActivityAwardCfg> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SOriginalBackGameActivityAwardCfg> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\activity3\confbean\SOriginalBackGameActivityAwardCfg.class
