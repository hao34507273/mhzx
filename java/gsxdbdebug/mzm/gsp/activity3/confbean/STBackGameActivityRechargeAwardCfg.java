...
/*     */ 
/*     */ public class STBackGameActivityRechargeAwardCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, STBackGameActivityRechargeAwardCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, STBackGameActivityRechargeAwardCfg> all = null;
/*     */   
/*     */   public int rechargeAwardTypeId;
/*  19 */   public HashMap<Integer, Integer> manekiTokenCfgId2manekiTokenCount = new HashMap();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.rechargeAwardTypeId = Integer.valueOf(rootElement.attributeValue("rechargeAwardTypeId")).intValue();
/*     */     
/*  25 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "manekiTokenCfgId2manekiTokenCount");
...
/*     */         }
/*     */         
/*  76 */         this.manekiTokenCfgId2manekiTokenCount.put(Integer.valueOf(_k_), Integer.valueOf(_v_));
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*     */   {
/*  83 */     _os_.marshal(this.rechargeAwardTypeId);
/*  84 */     _os_.compact_uint32(this.manekiTokenCfgId2manekiTokenCount.size());
/*  85 */     for (java.util.Map.Entry<Integer, Integer> _e_ : this.manekiTokenCfgId2manekiTokenCount.entrySet())
/*     */     {
...
/*     */   {
/*  95 */     this.rechargeAwardTypeId = _os_.unmarshal_int();
...
/* 102 */       this.manekiTokenCfgId2manekiTokenCount.put(Integer.valueOf(_k_), Integer.valueOf(_v_));
/*     */     }
/* 104 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/* 109 */     String path = dir + "mzm.gsp.activity3.confbean.STBackGameActivityRechargeAwardCfg.xml";
/*     */     
/*     */     try
/*     */     {
/* 113 */       all = new HashMap();
...
/* 122 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity3.confbean.STBackGameActivityRechargeAwardCfg"))
/*     */         {
/*     */ 
/* 125 */           STBackGameActivityRechargeAwardCfg obj = new STBackGameActivityRechargeAwardCfg();
/* 126 */           obj.loadFromXml(elem);
/* 127 */           if (all.put(Integer.valueOf(obj.rechargeAwardTypeId), obj) != null) {
/* 128 */             throw new RuntimeException("duplicate key : " + obj.rechargeAwardTypeId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, STBackGameActivityRechargeAwardCfg> all)
/*     */   {
/* 139 */     String path = dir + "mzm.gsp.activity3.confbean.STBackGameActivityRechargeAwardCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 151 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity3.confbean.STBackGameActivityRechargeAwardCfg"))
/*     */         {
/*     */ 
/* 154 */           STBackGameActivityRechargeAwardCfg obj = new STBackGameActivityRechargeAwardCfg();
/* 155 */           obj.loadFromXml(elem);
/* 156 */           if (all.put(Integer.valueOf(obj.rechargeAwardTypeId), obj) != null) {
/* 157 */             throw new RuntimeException("duplicate key : " + obj.rechargeAwardTypeId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/* 168 */     all = new HashMap();
/*     */     
/* 170 */     String path = dir + "mzm.gsp.activity3.confbean.STBackGameActivityRechargeAwardCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 197 */           STBackGameActivityRechargeAwardCfg _v_ = new STBackGameActivityRechargeAwardCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, STBackGameActivityRechargeAwardCfg> all)
/*     */   {
/* 217 */     String path = dir + "mzm.gsp.activity3.confbean.STBackGameActivityRechargeAwardCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 244 */           STBackGameActivityRechargeAwardCfg _v_ = new STBackGameActivityRechargeAwardCfg();
...
/*     */ 
/*     */ 
/*     */   public static STBackGameActivityRechargeAwardCfg getOld(int key)
/*     */   {
/* 265 */     return (STBackGameActivityRechargeAwardCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static STBackGameActivityRechargeAwardCfg get(int key)
/*     */   {
/* 270 */     return (STBackGameActivityRechargeAwardCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, STBackGameActivityRechargeAwardCfg> getOldAll()
/*     */   {
/* 275 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, STBackGameActivityRechargeAwardCfg> getAll()
/*     */   {
/* 280 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, STBackGameActivityRechargeAwardCfg> newAll)
/*     */   {
/* 285 */     oldAll = all;
/* 286 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\activity3\confbean\STBackGameActivityRechargeAwardCfg.class
