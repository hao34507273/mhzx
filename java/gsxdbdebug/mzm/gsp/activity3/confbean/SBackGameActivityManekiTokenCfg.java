...
/*     */ 
/*     */ public class SBackGameActivityManekiTokenCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SBackGameActivityManekiTokenCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SBackGameActivityManekiTokenCfg> all = null;
/*     */   
/*     */   public int id;
...
/*  24 */     this.getYuanBaoCount = Integer.valueOf(rootElement.attributeValue("getYuanBaoCount")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  29 */     _os_.marshal(this.id);
/*  30 */     _os_.marshal(this.getYuanBaoCount);
/*  31 */     return _os_;
/*     */   }
/*     */   
...
/*  37 */     this.getYuanBaoCount = _os_.unmarshal_int();
/*  38 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.activity3.confbean.SBackGameActivityManekiTokenCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity3.confbean.SBackGameActivityManekiTokenCfg"))
/*     */         {
/*     */ 
/*  59 */           SBackGameActivityManekiTokenCfg obj = new SBackGameActivityManekiTokenCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SBackGameActivityManekiTokenCfg> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.activity3.confbean.SBackGameActivityManekiTokenCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity3.confbean.SBackGameActivityManekiTokenCfg"))
/*     */         {
/*     */ 
/*  88 */           SBackGameActivityManekiTokenCfg obj = new SBackGameActivityManekiTokenCfg();
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.activity3.confbean.SBackGameActivityManekiTokenCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           SBackGameActivityManekiTokenCfg _v_ = new SBackGameActivityManekiTokenCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SBackGameActivityManekiTokenCfg> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.activity3.confbean.SBackGameActivityManekiTokenCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           SBackGameActivityManekiTokenCfg _v_ = new SBackGameActivityManekiTokenCfg();
...
/*     */ 
/*     */ 
/*     */   public static SBackGameActivityManekiTokenCfg getOld(int key)
/*     */   {
/* 199 */     return (SBackGameActivityManekiTokenCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SBackGameActivityManekiTokenCfg get(int key)
/*     */   {
/* 204 */     return (SBackGameActivityManekiTokenCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SBackGameActivityManekiTokenCfg> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SBackGameActivityManekiTokenCfg> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SBackGameActivityManekiTokenCfg> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\activity3\confbean\SBackGameActivityManekiTokenCfg.class
