...
/*     */ 
/*     */ public class STFireworkCollectCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, STFireworkCollectCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, STFireworkCollectCfg> all = null;
/*     */   
/*     */   public int activityId;
/*  19 */   public java.util.HashSet<Integer> triggerInfos = new java.util.HashSet();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.activityId = Integer.valueOf(rootElement.attributeValue("activityId")).intValue();
/*     */     
/*  25 */     Element collectionElement = util.XmlHelper.getVariableElement(rootElement, "triggerInfos");
...
/*     */         }
/*     */         
/*  50 */         this.triggerInfos.add(Integer.valueOf(_v_));
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*  58 */     _os_.compact_uint32(this.triggerInfos.size());
/*  59 */     for (Integer _v_ : this.triggerInfos)
/*     */     {
...
/*  73 */       this.triggerInfos.add(Integer.valueOf(_v_));
/*     */     }
/*  75 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/*  80 */     String path = dir + "mzm.gsp.activity3.confbean.STFireworkCollectCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity3.confbean.STFireworkCollectCfg"))
/*     */         {
/*     */ 
/*  96 */           STFireworkCollectCfg obj = new STFireworkCollectCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, STFireworkCollectCfg> all)
/*     */   {
/* 110 */     String path = dir + "mzm.gsp.activity3.confbean.STFireworkCollectCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 122 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity3.confbean.STFireworkCollectCfg"))
/*     */         {
/*     */ 
/* 125 */           STFireworkCollectCfg obj = new STFireworkCollectCfg();
...
/*     */     
/* 141 */     String path = dir + "mzm.gsp.activity3.confbean.STFireworkCollectCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 168 */           STFireworkCollectCfg _v_ = new STFireworkCollectCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, STFireworkCollectCfg> all)
/*     */   {
/* 188 */     String path = dir + "mzm.gsp.activity3.confbean.STFireworkCollectCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 215 */           STFireworkCollectCfg _v_ = new STFireworkCollectCfg();
...
/*     */ 
/*     */ 
/*     */   public static STFireworkCollectCfg getOld(int key)
/*     */   {
/* 236 */     return (STFireworkCollectCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static STFireworkCollectCfg get(int key)
/*     */   {
/* 241 */     return (STFireworkCollectCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, STFireworkCollectCfg> getOldAll()
/*     */   {
/* 246 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, STFireworkCollectCfg> getAll()
/*     */   {
/* 251 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, STFireworkCollectCfg> newAll)
/*     */   {
/* 256 */     oldAll = all;
/* 257 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\activity3\confbean\STFireworkCollectCfg.class
