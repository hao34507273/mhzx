...
/*     */ 
/*     */ public class ChineseValentineConstCfg
/*     */ {
/*  13 */   private static volatile ChineseValentineConstCfg oldInstance = null;
/*     */   
/*  15 */   private static ChineseValentineConstCfg instance = new ChineseValentineConstCfg();
/*     */   
/*     */ 
/*     */   public int activityId;
/*     */   
/*     */ 
/*     */   public static ChineseValentineConstCfg getOldInstance()
/*     */   {
/*  23 */     return oldInstance;
/*     */   }
/*     */   
/*     */   public static ChineseValentineConstCfg getInstance()
/*     */   {
/*  28 */     return instance;
/*     */   }
/*     */   
...
/*     */   {
/*  40 */     String path = dir + "mzm.gsp.activity3.confbean.ChineseValentineConstCfg.xml";
/*     */     try
/*     */     {
...
/*     */         }
/*     */       }
/*  60 */       this.activityId = Integer.valueOf(((Element)data.get("activityId")).attributeValue("value")).intValue();
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*  69 */     String path = dir + "mzm.gsp.activity3.confbean.ChineseValentineConstCfg.xml";
/*     */     try
/*     */     {
...
/*     */         }
/*     */       }
/*  89 */       this.activityId = Integer.valueOf(((Element)data.get("activityId")).attributeValue("value")).intValue();
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/* 100 */     String path = dir + "mzm.gsp.activity3.confbean.ChineseValentineConstCfg.bny";
/*     */     try
/*     */     {
...
/* 115 */         this.activityId = _os_.unmarshal_int();
/*     */       }
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*     */   {
/* 126 */     String path = dir + "mzm.gsp.activity3.confbean.ChineseValentineConstCfg.bny";
/*     */     try
/*     */     {
...
/* 141 */         this.activityId = _os_.unmarshal_int();
/*     */       }
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*     */   }
/*     */   
/*     */   public static void setInstance(ChineseValentineConstCfg newInstance)
/*     */   {
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\activity3\confbean\ChineseValentineConstCfg.class
