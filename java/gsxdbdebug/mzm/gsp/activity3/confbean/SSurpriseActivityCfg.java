...
/*     */ 
/*     */ public class SSurpriseActivityCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SSurpriseActivityCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SSurpriseActivityCfg> all = null;
/*     */   
...
/*  25 */     this.switchid = Integer.valueOf(rootElement.attributeValue("switchid")).intValue();
/*  26 */     this.joinServerLevel = Integer.valueOf(rootElement.attributeValue("joinServerLevel")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  31 */     _os_.marshal(this.activityId);
/*  32 */     _os_.marshal(this.switchid);
/*  33 */     _os_.marshal(this.joinServerLevel);
/*  34 */     return _os_;
/*     */   }
/*     */   
...
/*  40 */     this.switchid = _os_.unmarshal_int();
/*  41 */     this.joinServerLevel = _os_.unmarshal_int();
/*  42 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  47 */     String path = dir + "mzm.gsp.activity3.confbean.SSurpriseActivityCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  60 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity3.confbean.SSurpriseActivityCfg"))
/*     */         {
/*     */ 
/*  63 */           SSurpriseActivityCfg obj = new SSurpriseActivityCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SSurpriseActivityCfg> all)
/*     */   {
/*  77 */     String path = dir + "mzm.gsp.activity3.confbean.SSurpriseActivityCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  89 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity3.confbean.SSurpriseActivityCfg"))
/*     */         {
/*     */ 
/*  92 */           SSurpriseActivityCfg obj = new SSurpriseActivityCfg();
...
/*     */     
/* 108 */     String path = dir + "mzm.gsp.activity3.confbean.SSurpriseActivityCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 135 */           SSurpriseActivityCfg _v_ = new SSurpriseActivityCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SSurpriseActivityCfg> all)
/*     */   {
/* 155 */     String path = dir + "mzm.gsp.activity3.confbean.SSurpriseActivityCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 182 */           SSurpriseActivityCfg _v_ = new SSurpriseActivityCfg();
...
/*     */ 
/*     */ 
/*     */   public static SSurpriseActivityCfg getOld(int key)
/*     */   {
/* 203 */     return (SSurpriseActivityCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SSurpriseActivityCfg get(int key)
/*     */   {
/* 208 */     return (SSurpriseActivityCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SSurpriseActivityCfg> getOldAll()
/*     */   {
/* 213 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SSurpriseActivityCfg> getAll()
/*     */   {
/* 218 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SSurpriseActivityCfg> newAll)
/*     */   {
/* 223 */     oldAll = all;
/* 224 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\activity3\confbean\SSurpriseActivityCfg.class
