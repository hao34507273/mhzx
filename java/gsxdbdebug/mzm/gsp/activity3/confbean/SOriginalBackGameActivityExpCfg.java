...
/*     */ 
/*     */ public class SOriginalBackGameActivityExpCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SOriginalBackGameActivityExpCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SOriginalBackGameActivityExpCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public int activityId;
/*     */   public int levelTierCfgTypeId;
/*     */   
...
/*  26 */     this.levelTierCfgTypeId = Integer.valueOf(rootElement.attributeValue("levelTierCfgTypeId")).intValue();
/*     */   }
/*     */   
...
/*  33 */     _os_.marshal(this.levelTierCfgTypeId);
/*  34 */     return _os_;
/*     */   }
/*     */   
...
/*  41 */     this.levelTierCfgTypeId = _os_.unmarshal_int();
/*  42 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  47 */     String path = dir + "mzm.gsp.activity3.confbean.SOriginalBackGameActivityExpCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  60 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity3.confbean.SOriginalBackGameActivityExpCfg"))
/*     */         {
/*     */ 
/*  63 */           SOriginalBackGameActivityExpCfg obj = new SOriginalBackGameActivityExpCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SOriginalBackGameActivityExpCfg> all)
/*     */   {
/*  77 */     String path = dir + "mzm.gsp.activity3.confbean.SOriginalBackGameActivityExpCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  89 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity3.confbean.SOriginalBackGameActivityExpCfg"))
/*     */         {
/*     */ 
/*  92 */           SOriginalBackGameActivityExpCfg obj = new SOriginalBackGameActivityExpCfg();
...
/*     */     
/* 108 */     String path = dir + "mzm.gsp.activity3.confbean.SOriginalBackGameActivityExpCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 135 */           SOriginalBackGameActivityExpCfg _v_ = new SOriginalBackGameActivityExpCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SOriginalBackGameActivityExpCfg> all)
/*     */   {
/* 155 */     String path = dir + "mzm.gsp.activity3.confbean.SOriginalBackGameActivityExpCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 182 */           SOriginalBackGameActivityExpCfg _v_ = new SOriginalBackGameActivityExpCfg();
...
/*     */ 
/*     */ 
/*     */   public static SOriginalBackGameActivityExpCfg getOld(int key)
/*     */   {
/* 203 */     return (SOriginalBackGameActivityExpCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SOriginalBackGameActivityExpCfg get(int key)
/*     */   {
/* 208 */     return (SOriginalBackGameActivityExpCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SOriginalBackGameActivityExpCfg> getOldAll()
/*     */   {
/* 213 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SOriginalBackGameActivityExpCfg> getAll()
/*     */   {
/* 218 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SOriginalBackGameActivityExpCfg> newAll)
/*     */   {
/* 223 */     oldAll = all;
/* 224 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\activity3\confbean\SOriginalBackGameActivityExpCfg.class
