...
/*     */ 
/*     */ public class SBackGameActivityExpCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SBackGameActivityExpCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SBackGameActivityExpCfg> all = null;
/*     */   
/*     */   public int id;
/*  19 */   public java.util.ArrayList<SBackGameActivityExpAwardLevelTier> expAwardLevelTiers = new java.util.ArrayList();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.id = Integer.valueOf(rootElement.attributeValue("id")).intValue();
/*     */     
/*  25 */     Element collectionElement = util.XmlHelper.getVariableElement(rootElement, "expAwardLevelTiers");
...
/*  36 */       if (elem.getName().equalsIgnoreCase("mzm.gsp.activity3.confbean.SBackGameActivityExpAwardLevelTier"))
/*     */       {
/*     */         SBackGameActivityExpAwardLevelTier _v_;
/*     */         
/*     */ 
/*     */         try
/*     */         {
/*  43 */           _v_ = new SBackGameActivityExpAwardLevelTier();
...
/*     */         }
/*     */         
/*  51 */         this.expAwardLevelTiers.add(_v_);
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*  59 */     _os_.compact_uint32(this.expAwardLevelTiers.size());
/*  60 */     for (SBackGameActivityExpAwardLevelTier _v_ : this.expAwardLevelTiers)
/*     */     {
/*  62 */       _os_.marshal(_v_);
/*     */     }
/*  64 */     return _os_;
...
/*     */     {
/*     */ 
/*  73 */       SBackGameActivityExpAwardLevelTier _v_ = new SBackGameActivityExpAwardLevelTier();
/*  74 */       _v_.unmarshal(_os_);
/*  75 */       this.expAwardLevelTiers.add(_v_);
/*     */     }
/*  77 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/*  82 */     String path = dir + "mzm.gsp.activity3.confbean.SBackGameActivityExpCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  95 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity3.confbean.SBackGameActivityExpCfg"))
/*     */         {
/*     */ 
/*  98 */           SBackGameActivityExpCfg obj = new SBackGameActivityExpCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SBackGameActivityExpCfg> all)
/*     */   {
/* 112 */     String path = dir + "mzm.gsp.activity3.confbean.SBackGameActivityExpCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 124 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity3.confbean.SBackGameActivityExpCfg"))
/*     */         {
/*     */ 
/* 127 */           SBackGameActivityExpCfg obj = new SBackGameActivityExpCfg();
...
/*     */     
/* 143 */     String path = dir + "mzm.gsp.activity3.confbean.SBackGameActivityExpCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 170 */           SBackGameActivityExpCfg _v_ = new SBackGameActivityExpCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SBackGameActivityExpCfg> all)
/*     */   {
/* 190 */     String path = dir + "mzm.gsp.activity3.confbean.SBackGameActivityExpCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 217 */           SBackGameActivityExpCfg _v_ = new SBackGameActivityExpCfg();
...
/*     */ 
/*     */ 
/*     */   public static SBackGameActivityExpCfg getOld(int key)
/*     */   {
/* 238 */     return (SBackGameActivityExpCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SBackGameActivityExpCfg get(int key)
/*     */   {
/* 243 */     return (SBackGameActivityExpCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SBackGameActivityExpCfg> getOldAll()
/*     */   {
/* 248 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SBackGameActivityExpCfg> getAll()
/*     */   {
/* 253 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SBackGameActivityExpCfg> newAll)
/*     */   {
/* 258 */     oldAll = all;
/* 259 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\activity3\confbean\SBackGameActivityExpCfg.class
