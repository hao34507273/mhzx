...
/*     */ 
/*     */ public class STSurpriseAchievementCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, STSurpriseAchievementCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, STSurpriseAchievementCfg> all = null;
/*     */   
/*     */   public int activityId;
/*  19 */   public java.util.HashSet<Integer> achievementIds = new java.util.HashSet();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.activityId = Integer.valueOf(rootElement.attributeValue("activityId")).intValue();
/*     */     
/*  25 */     Element collectionElement = util.XmlHelper.getVariableElement(rootElement, "achievementIds");
...
/*     */         }
/*     */         
/*  50 */         this.achievementIds.add(Integer.valueOf(_v_));
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*  58 */     _os_.compact_uint32(this.achievementIds.size());
/*  59 */     for (Integer _v_ : this.achievementIds)
/*     */     {
...
/*  73 */       this.achievementIds.add(Integer.valueOf(_v_));
/*     */     }
/*  75 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/*  80 */     String path = dir + "mzm.gsp.activity3.confbean.STSurpriseAchievementCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity3.confbean.STSurpriseAchievementCfg"))
/*     */         {
/*     */ 
/*  96 */           STSurpriseAchievementCfg obj = new STSurpriseAchievementCfg();
/*  97 */           obj.loadFromXml(elem);
/*  98 */           if (all.put(Integer.valueOf(obj.activityId), obj) != null) {
/*  99 */             throw new RuntimeException("duplicate key : " + obj.activityId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, STSurpriseAchievementCfg> all)
/*     */   {
/* 110 */     String path = dir + "mzm.gsp.activity3.confbean.STSurpriseAchievementCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 122 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity3.confbean.STSurpriseAchievementCfg"))
/*     */         {
/*     */ 
/* 125 */           STSurpriseAchievementCfg obj = new STSurpriseAchievementCfg();
...
/*     */     
/* 141 */     String path = dir + "mzm.gsp.activity3.confbean.STSurpriseAchievementCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 168 */           STSurpriseAchievementCfg _v_ = new STSurpriseAchievementCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, STSurpriseAchievementCfg> all)
/*     */   {
/* 188 */     String path = dir + "mzm.gsp.activity3.confbean.STSurpriseAchievementCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 215 */           STSurpriseAchievementCfg _v_ = new STSurpriseAchievementCfg();
...
/*     */ 
/*     */ 
/*     */   public static STSurpriseAchievementCfg getOld(int key)
/*     */   {
/* 236 */     return (STSurpriseAchievementCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static STSurpriseAchievementCfg get(int key)
/*     */   {
/* 241 */     return (STSurpriseAchievementCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, STSurpriseAchievementCfg> getOldAll()
/*     */   {
/* 246 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, STSurpriseAchievementCfg> getAll()
/*     */   {
/* 251 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, STSurpriseAchievementCfg> newAll)
/*     */   {
/* 256 */     oldAll = all;
/* 257 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\activity3\confbean\STSurpriseAchievementCfg.class
