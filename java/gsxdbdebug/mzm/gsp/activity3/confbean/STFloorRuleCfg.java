...
/*     */ 
/*     */ public class STFloorRuleCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, STFloorRuleCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, STFloorRuleCfg> all = null;
/*     */   
/*     */   public int activityId;
/*  19 */   public HashMap<Integer, FloorCfg> floorCfgs = new HashMap();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.activityId = Integer.valueOf(rootElement.attributeValue("activityId")).intValue();
/*     */     
/*  25 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "floorCfgs");
...
/*  51 */             keyElem = elem;
/*     */           }
/*  53 */           else if ((valueElem == null) && (elem.getName().equalsIgnoreCase("mzm.gsp.activity3.confbean.FloorCfg")))
/*     */           {
/*  55 */             valueElem = elem;
/*     */           }
/*     */         }
...
/*     */         }
/*     */         
/*  77 */         this.floorCfgs.put(Integer.valueOf(_k_), _v_);
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*  85 */     _os_.compact_uint32(this.floorCfgs.size());
/*  86 */     for (java.util.Map.Entry<Integer, FloorCfg> _e_ : this.floorCfgs.entrySet())
/*     */     {
...
/*     */       
/* 102 */       FloorCfg _v_ = new FloorCfg();
/* 103 */       _v_.unmarshal(_os_);
/* 104 */       this.floorCfgs.put(Integer.valueOf(_k_), _v_);
/*     */     }
/* 106 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/* 111 */     String path = dir + "mzm.gsp.activity3.confbean.STFloorRuleCfg.xml";
/*     */     
/*     */     try
/*     */     {
/* 115 */       all = new HashMap();
...
/* 124 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity3.confbean.STFloorRuleCfg"))
/*     */         {
/*     */ 
/* 127 */           STFloorRuleCfg obj = new STFloorRuleCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, STFloorRuleCfg> all)
/*     */   {
/* 141 */     String path = dir + "mzm.gsp.activity3.confbean.STFloorRuleCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 153 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity3.confbean.STFloorRuleCfg"))
/*     */         {
/*     */ 
/* 156 */           STFloorRuleCfg obj = new STFloorRuleCfg();
...
/* 170 */     all = new HashMap();
/*     */     
/* 172 */     String path = dir + "mzm.gsp.activity3.confbean.STFloorRuleCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 199 */           STFloorRuleCfg _v_ = new STFloorRuleCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, STFloorRuleCfg> all)
/*     */   {
/* 219 */     String path = dir + "mzm.gsp.activity3.confbean.STFloorRuleCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 246 */           STFloorRuleCfg _v_ = new STFloorRuleCfg();
...
/*     */ 
/*     */ 
/*     */   public static STFloorRuleCfg getOld(int key)
/*     */   {
/* 267 */     return (STFloorRuleCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static STFloorRuleCfg get(int key)
/*     */   {
/* 272 */     return (STFloorRuleCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, STFloorRuleCfg> getOldAll()
/*     */   {
/* 277 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, STFloorRuleCfg> getAll()
/*     */   {
/* 282 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, STFloorRuleCfg> newAll)
/*     */   {
/* 287 */     oldAll = all;
/* 288 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\activity3\confbean\STFloorRuleCfg.class
