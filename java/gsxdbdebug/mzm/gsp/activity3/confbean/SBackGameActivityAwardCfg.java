...
/*     */ 
/*     */ public class SBackGameActivityAwardCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SBackGameActivityAwardCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SBackGameActivityAwardCfg> all = null;
/*     */   
/*     */   public int id;
/*  19 */   public TreeMap<Integer, Integer> needRecharge2AwardTierId = new TreeMap();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.id = Integer.valueOf(rootElement.attributeValue("id")).intValue();
/*     */     
/*  25 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "needRecharge2AwardTierId");
...
/*     */         }
/*     */         
/*  76 */         this.needRecharge2AwardTierId.put(Integer.valueOf(_k_), Integer.valueOf(_v_));
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*  84 */     _os_.compact_uint32(this.needRecharge2AwardTierId.size());
/*  85 */     for (java.util.Map.Entry<Integer, Integer> _e_ : this.needRecharge2AwardTierId.entrySet())
/*     */     {
...
/* 102 */       this.needRecharge2AwardTierId.put(Integer.valueOf(_k_), Integer.valueOf(_v_));
/*     */     }
/* 104 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/* 109 */     String path = dir + "mzm.gsp.activity3.confbean.SBackGameActivityAwardCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 122 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity3.confbean.SBackGameActivityAwardCfg"))
/*     */         {
/*     */ 
/* 125 */           SBackGameActivityAwardCfg obj = new SBackGameActivityAwardCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SBackGameActivityAwardCfg> all)
/*     */   {
/* 139 */     String path = dir + "mzm.gsp.activity3.confbean.SBackGameActivityAwardCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 151 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity3.confbean.SBackGameActivityAwardCfg"))
/*     */         {
/*     */ 
/* 154 */           SBackGameActivityAwardCfg obj = new SBackGameActivityAwardCfg();
...
/*     */     
/* 170 */     String path = dir + "mzm.gsp.activity3.confbean.SBackGameActivityAwardCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 197 */           SBackGameActivityAwardCfg _v_ = new SBackGameActivityAwardCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SBackGameActivityAwardCfg> all)
/*     */   {
/* 217 */     String path = dir + "mzm.gsp.activity3.confbean.SBackGameActivityAwardCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 244 */           SBackGameActivityAwardCfg _v_ = new SBackGameActivityAwardCfg();
...
/*     */ 
/*     */ 
/*     */   public static SBackGameActivityAwardCfg getOld(int key)
/*     */   {
/* 265 */     return (SBackGameActivityAwardCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SBackGameActivityAwardCfg get(int key)
/*     */   {
/* 270 */     return (SBackGameActivityAwardCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SBackGameActivityAwardCfg> getOldAll()
/*     */   {
/* 275 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SBackGameActivityAwardCfg> getAll()
/*     */   {
/* 280 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SBackGameActivityAwardCfg> newAll)
/*     */   {
/* 285 */     oldAll = all;
/* 286 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\activity3\confbean\SBackGameActivityAwardCfg.class
