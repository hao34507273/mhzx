...
/*     */ 
/*     */ public class STActionPositionCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, STActionPositionCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, STActionPositionCfg> all = null;
/*     */   
/*     */   public int actionId;
/*  19 */   public java.util.HashSet<Integer> surpriseIds = new java.util.HashSet();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.actionId = Integer.valueOf(rootElement.attributeValue("actionId")).intValue();
/*     */     
/*  25 */     Element collectionElement = util.XmlHelper.getVariableElement(rootElement, "surpriseIds");
...
/*     */         }
/*     */         
/*  50 */         this.surpriseIds.add(Integer.valueOf(_v_));
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*     */   {
/*  57 */     _os_.marshal(this.actionId);
/*  58 */     _os_.compact_uint32(this.surpriseIds.size());
/*  59 */     for (Integer _v_ : this.surpriseIds)
/*     */     {
...
/*     */   {
/*  80 */     String path = dir + "mzm.gsp.activity3.confbean.STActionPositionCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity3.confbean.STActionPositionCfg"))
/*     */         {
/*     */ 
/*  96 */           STActionPositionCfg obj = new STActionPositionCfg();
/*  97 */           obj.loadFromXml(elem);
/*  98 */           if (all.put(Integer.valueOf(obj.actionId), obj) != null) {
/*  99 */             throw new RuntimeException("duplicate key : " + obj.actionId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, STActionPositionCfg> all)
/*     */   {
/* 110 */     String path = dir + "mzm.gsp.activity3.confbean.STActionPositionCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 122 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity3.confbean.STActionPositionCfg"))
/*     */         {
/*     */ 
/* 125 */           STActionPositionCfg obj = new STActionPositionCfg();
/* 126 */           obj.loadFromXml(elem);
/* 127 */           if (all.put(Integer.valueOf(obj.actionId), obj) != null) {
/* 128 */             throw new RuntimeException("duplicate key : " + obj.actionId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 141 */     String path = dir + "mzm.gsp.activity3.confbean.STActionPositionCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 168 */           STActionPositionCfg _v_ = new STActionPositionCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, STActionPositionCfg> all)
/*     */   {
/* 188 */     String path = dir + "mzm.gsp.activity3.confbean.STActionPositionCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 215 */           STActionPositionCfg _v_ = new STActionPositionCfg();
...
/*     */ 
/*     */ 
/*     */   public static STActionPositionCfg getOld(int key)
/*     */   {
/* 236 */     return (STActionPositionCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static STActionPositionCfg get(int key)
/*     */   {
/* 241 */     return (STActionPositionCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, STActionPositionCfg> getOldAll()
/*     */   {
/* 246 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, STActionPositionCfg> getAll()
/*     */   {
/* 251 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, STActionPositionCfg> newAll)
/*     */   {
/* 256 */     oldAll = all;
/* 257 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\activity3\confbean\STActionPositionCfg.class
