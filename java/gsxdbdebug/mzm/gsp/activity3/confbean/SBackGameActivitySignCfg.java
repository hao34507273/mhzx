...
/*     */ 
/*     */ public class SBackGameActivitySignCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SBackGameActivitySignCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SBackGameActivitySignCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public int levelTierTypeId;
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.id = Integer.valueOf(rootElement.attributeValue("id")).intValue();
/*  24 */     this.levelTierTypeId = Integer.valueOf(rootElement.attributeValue("levelTierTypeId")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  29 */     _os_.marshal(this.id);
/*  30 */     _os_.marshal(this.levelTierTypeId);
/*  31 */     return _os_;
/*     */   }
/*     */   
...
/*  37 */     this.levelTierTypeId = _os_.unmarshal_int();
/*  38 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.activity3.confbean.SBackGameActivitySignCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity3.confbean.SBackGameActivitySignCfg"))
/*     */         {
/*     */ 
/*  59 */           SBackGameActivitySignCfg obj = new SBackGameActivitySignCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SBackGameActivitySignCfg> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.activity3.confbean.SBackGameActivitySignCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity3.confbean.SBackGameActivitySignCfg"))
/*     */         {
/*     */ 
/*  88 */           SBackGameActivitySignCfg obj = new SBackGameActivitySignCfg();
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.activity3.confbean.SBackGameActivitySignCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           SBackGameActivitySignCfg _v_ = new SBackGameActivitySignCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SBackGameActivitySignCfg> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.activity3.confbean.SBackGameActivitySignCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           SBackGameActivitySignCfg _v_ = new SBackGameActivitySignCfg();
...
/*     */ 
/*     */ 
/*     */   public static SBackGameActivitySignCfg getOld(int key)
/*     */   {
/* 199 */     return (SBackGameActivitySignCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SBackGameActivitySignCfg get(int key)
/*     */   {
/* 204 */     return (SBackGameActivitySignCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SBackGameActivitySignCfg> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SBackGameActivitySignCfg> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SBackGameActivitySignCfg> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\activity3\confbean\SBackGameActivitySignCfg.class
