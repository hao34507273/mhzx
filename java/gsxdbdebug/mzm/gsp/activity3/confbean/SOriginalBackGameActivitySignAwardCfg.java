...
/*     */ 
/*     */ public class SOriginalBackGameActivitySignAwardCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SOriginalBackGameActivitySignAwardCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SOriginalBackGameActivitySignAwardCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public int typeId;
/*     */   public int index;
...
/*  26 */     this.typeId = Integer.valueOf(rootElement.attributeValue("typeId")).intValue();
/*  27 */     this.index = Integer.valueOf(rootElement.attributeValue("index")).intValue();
/*  28 */     this.awardId = Integer.valueOf(rootElement.attributeValue("awardId")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  33 */     _os_.marshal(this.id);
/*  34 */     _os_.marshal(this.typeId);
...
/*  43 */     this.typeId = _os_.unmarshal_int();
/*  44 */     this.index = _os_.unmarshal_int();
/*  45 */     this.awardId = _os_.unmarshal_int();
/*  46 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  51 */     String path = dir + "mzm.gsp.activity3.confbean.SOriginalBackGameActivitySignAwardCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  64 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity3.confbean.SOriginalBackGameActivitySignAwardCfg"))
/*     */         {
/*     */ 
/*  67 */           SOriginalBackGameActivitySignAwardCfg obj = new SOriginalBackGameActivitySignAwardCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SOriginalBackGameActivitySignAwardCfg> all)
/*     */   {
/*  81 */     String path = dir + "mzm.gsp.activity3.confbean.SOriginalBackGameActivitySignAwardCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity3.confbean.SOriginalBackGameActivitySignAwardCfg"))
/*     */         {
/*     */ 
/*  96 */           SOriginalBackGameActivitySignAwardCfg obj = new SOriginalBackGameActivitySignAwardCfg();
...
/*     */     
/* 112 */     String path = dir + "mzm.gsp.activity3.confbean.SOriginalBackGameActivitySignAwardCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 139 */           SOriginalBackGameActivitySignAwardCfg _v_ = new SOriginalBackGameActivitySignAwardCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SOriginalBackGameActivitySignAwardCfg> all)
/*     */   {
/* 159 */     String path = dir + "mzm.gsp.activity3.confbean.SOriginalBackGameActivitySignAwardCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 186 */           SOriginalBackGameActivitySignAwardCfg _v_ = new SOriginalBackGameActivitySignAwardCfg();
...
/*     */ 
/*     */ 
/*     */   public static SOriginalBackGameActivitySignAwardCfg getOld(int key)
/*     */   {
/* 207 */     return (SOriginalBackGameActivitySignAwardCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SOriginalBackGameActivitySignAwardCfg get(int key)
/*     */   {
/* 212 */     return (SOriginalBackGameActivitySignAwardCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SOriginalBackGameActivitySignAwardCfg> getOldAll()
/*     */   {
/* 217 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SOriginalBackGameActivitySignAwardCfg> getAll()
/*     */   {
/* 222 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SOriginalBackGameActivitySignAwardCfg> newAll)
/*     */   {
/* 227 */     oldAll = all;
/* 228 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\activity3\confbean\SOriginalBackGameActivitySignAwardCfg.class
