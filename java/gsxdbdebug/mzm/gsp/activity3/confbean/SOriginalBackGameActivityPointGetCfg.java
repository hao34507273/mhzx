...
/*     */ 
/*     */ public class SOriginalBackGameActivityPointGetCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SOriginalBackGameActivityPointGetCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SOriginalBackGameActivityPointGetCfg> all = null;
/*     */   
/*     */   public int id;
...
/*  27 */     this.pointGetCfgTypeId = Integer.valueOf(rootElement.attributeValue("pointGetCfgTypeId")).intValue();
/*  28 */     this.activityId = Integer.valueOf(rootElement.attributeValue("activityId")).intValue();
/*  29 */     this.activityMaxCount = Integer.valueOf(rootElement.attributeValue("activityMaxCount")).intValue();
/*  30 */     this.pointCountEachRun = Integer.valueOf(rootElement.attributeValue("pointCountEachRun")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  35 */     _os_.marshal(this.id);
/*  36 */     _os_.marshal(this.pointGetCfgTypeId);
/*  37 */     _os_.marshal(this.activityId);
/*  38 */     _os_.marshal(this.activityMaxCount);
/*  39 */     _os_.marshal(this.pointCountEachRun);
/*  40 */     return _os_;
/*     */   }
/*     */   
...
/*  46 */     this.pointGetCfgTypeId = _os_.unmarshal_int();
/*  47 */     this.activityId = _os_.unmarshal_int();
/*  48 */     this.activityMaxCount = _os_.unmarshal_int();
/*  49 */     this.pointCountEachRun = _os_.unmarshal_int();
/*  50 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  55 */     String path = dir + "mzm.gsp.activity3.confbean.SOriginalBackGameActivityPointGetCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  68 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity3.confbean.SOriginalBackGameActivityPointGetCfg"))
/*     */         {
/*     */ 
/*  71 */           SOriginalBackGameActivityPointGetCfg obj = new SOriginalBackGameActivityPointGetCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SOriginalBackGameActivityPointGetCfg> all)
/*     */   {
/*  85 */     String path = dir + "mzm.gsp.activity3.confbean.SOriginalBackGameActivityPointGetCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  97 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity3.confbean.SOriginalBackGameActivityPointGetCfg"))
/*     */         {
/*     */ 
/* 100 */           SOriginalBackGameActivityPointGetCfg obj = new SOriginalBackGameActivityPointGetCfg();
...
/*     */     
/* 116 */     String path = dir + "mzm.gsp.activity3.confbean.SOriginalBackGameActivityPointGetCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 143 */           SOriginalBackGameActivityPointGetCfg _v_ = new SOriginalBackGameActivityPointGetCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SOriginalBackGameActivityPointGetCfg> all)
/*     */   {
/* 163 */     String path = dir + "mzm.gsp.activity3.confbean.SOriginalBackGameActivityPointGetCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 190 */           SOriginalBackGameActivityPointGetCfg _v_ = new SOriginalBackGameActivityPointGetCfg();
...
/*     */ 
/*     */ 
/*     */   public static SOriginalBackGameActivityPointGetCfg getOld(int key)
/*     */   {
/* 211 */     return (SOriginalBackGameActivityPointGetCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SOriginalBackGameActivityPointGetCfg get(int key)
/*     */   {
/* 216 */     return (SOriginalBackGameActivityPointGetCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SOriginalBackGameActivityPointGetCfg> getOldAll()
/*     */   {
/* 221 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SOriginalBackGameActivityPointGetCfg> getAll()
/*     */   {
/* 226 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SOriginalBackGameActivityPointGetCfg> newAll)
/*     */   {
/* 231 */     oldAll = all;
/* 232 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\activity3\confbean\SOriginalBackGameActivityPointGetCfg.class
