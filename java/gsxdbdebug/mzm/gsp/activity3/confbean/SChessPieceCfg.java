...
/*     */ 
/*     */ public class SChessPieceCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SChessPieceCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SChessPieceCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public int typeId;
/*     */   public int index;
...
/*  28 */     this.count = Integer.valueOf(rootElement.attributeValue("count")).intValue();
/*     */   }
/*     */   
...
/*  45 */     this.count = _os_.unmarshal_int();
/*  46 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  51 */     String path = dir + "mzm.gsp.activity3.confbean.SChessPieceCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  64 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity3.confbean.SChessPieceCfg"))
/*     */         {
/*     */ 
/*  67 */           SChessPieceCfg obj = new SChessPieceCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SChessPieceCfg> all)
/*     */   {
/*  81 */     String path = dir + "mzm.gsp.activity3.confbean.SChessPieceCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity3.confbean.SChessPieceCfg"))
/*     */         {
/*     */ 
/*  96 */           SChessPieceCfg obj = new SChessPieceCfg();
...
/*     */     
/* 112 */     String path = dir + "mzm.gsp.activity3.confbean.SChessPieceCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 139 */           SChessPieceCfg _v_ = new SChessPieceCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SChessPieceCfg> all)
/*     */   {
/* 159 */     String path = dir + "mzm.gsp.activity3.confbean.SChessPieceCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 186 */           SChessPieceCfg _v_ = new SChessPieceCfg();
...
/*     */ 
/*     */ 
/*     */   public static SChessPieceCfg getOld(int key)
/*     */   {
/* 207 */     return (SChessPieceCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SChessPieceCfg get(int key)
/*     */   {
/* 212 */     return (SChessPieceCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SChessPieceCfg> getOldAll()
/*     */   {
/* 217 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SChessPieceCfg> getAll()
/*     */   {
/* 222 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SChessPieceCfg> newAll)
/*     */   {
/* 227 */     oldAll = all;
/* 228 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\activity3\confbean\SChessPieceCfg.class
