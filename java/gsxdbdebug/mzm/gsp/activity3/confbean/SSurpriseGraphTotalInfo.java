...
/*    */ 
/*    */ public class SSurpriseGraphTotalInfo implements com.goldhuman.Common.Marshal.Marshal
/*    */ {
/*  9 */   public HashMap<Integer, SSurpriseGraphInfo> graphInfos = new HashMap();
/*    */   
/*    */ 
/*    */   public void loadFromXml(Element rootElement)
/*    */   {
/* 14 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "graphInfos");
...
/* 40 */             keyElem = elem;
/*    */           }
/* 42 */           else if ((valueElem == null) && (elem.getName().equalsIgnoreCase("mzm.gsp.activity3.confbean.SSurpriseGraphInfo")))
/*    */           {
/* 44 */             valueElem = elem;
/*    */           }
/*    */         }
...
/*    */         
/*    */         int _k_;
/*    */         SSurpriseGraphInfo _v_;
/*    */         try
/*    */         {
/* 57 */           _k_ = Integer.valueOf(keyElem.getText()).intValue();
/* 58 */           _v_ = new SSurpriseGraphInfo();
...
/*    */         }
/*    */         
/* 66 */         this.graphInfos.put(Integer.valueOf(_k_), _v_);
/*    */       }
/*    */     }
/*    */   }
/*    */   
...
/*    */   {
/* 73 */     _os_.compact_uint32(this.graphInfos.size());
/* 74 */     for (java.util.Map.Entry<Integer, SSurpriseGraphInfo> _e_ : this.graphInfos.entrySet())
/*    */     {
...
/*    */       
/* 89 */       SSurpriseGraphInfo _v_ = new SSurpriseGraphInfo();
/* 90 */       _v_.unmarshal(_os_);
/* 91 */       this.graphInfos.put(Integer.valueOf(_k_), _v_);
/*    */     }
/* 93 */     return _os_;
/*    */   }
/*    */ }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\activity3\confbean\SSurpriseGraphTotalInfo.class
