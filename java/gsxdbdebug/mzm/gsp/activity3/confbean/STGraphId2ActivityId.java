...
/*     */ 
/*     */ public class STGraphId2ActivityId implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, STGraphId2ActivityId> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, STGraphId2ActivityId> all = null;
/*     */   
/*     */   public int graphId;
...
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.activity3.confbean.STGraphId2ActivityId.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity3.confbean.STGraphId2ActivityId"))
/*     */         {
/*     */ 
/*  59 */           STGraphId2ActivityId obj = new STGraphId2ActivityId();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, STGraphId2ActivityId> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.activity3.confbean.STGraphId2ActivityId.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity3.confbean.STGraphId2ActivityId"))
/*     */         {
/*     */ 
/*  88 */           STGraphId2ActivityId obj = new STGraphId2ActivityId();
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.activity3.confbean.STGraphId2ActivityId.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           STGraphId2ActivityId _v_ = new STGraphId2ActivityId();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, STGraphId2ActivityId> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.activity3.confbean.STGraphId2ActivityId.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           STGraphId2ActivityId _v_ = new STGraphId2ActivityId();
...
/*     */ 
/*     */ 
/*     */   public static STGraphId2ActivityId getOld(int key)
/*     */   {
/* 199 */     return (STGraphId2ActivityId)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static STGraphId2ActivityId get(int key)
/*     */   {
/* 204 */     return (STGraphId2ActivityId)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, STGraphId2ActivityId> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, STGraphId2ActivityId> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, STGraphId2ActivityId> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\activity3\confbean\STGraphId2ActivityId.class
