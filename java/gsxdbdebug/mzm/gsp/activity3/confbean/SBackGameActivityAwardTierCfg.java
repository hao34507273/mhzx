...
/*     */ 
/*     */ public class SBackGameActivityAwardTierCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SBackGameActivityAwardTierCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SBackGameActivityAwardTierCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public int typeId;
...
/*  28 */     this.needRecharge = Integer.valueOf(rootElement.attributeValue("needRecharge")).intValue();
/*  29 */     this.awardId = Integer.valueOf(rootElement.attributeValue("awardId")).intValue();
/*  30 */     this.buffId = Integer.valueOf(rootElement.attributeValue("buffId")).intValue();
/*     */   }
/*     */   
...
/*  37 */     _os_.marshal(this.needRecharge);
/*  38 */     _os_.marshal(this.awardId);
...
/*  47 */     this.needRecharge = _os_.unmarshal_int();
/*  48 */     this.awardId = _os_.unmarshal_int();
/*  49 */     this.buffId = _os_.unmarshal_int();
/*  50 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  55 */     String path = dir + "mzm.gsp.activity3.confbean.SBackGameActivityAwardTierCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  68 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity3.confbean.SBackGameActivityAwardTierCfg"))
/*     */         {
/*     */ 
/*  71 */           SBackGameActivityAwardTierCfg obj = new SBackGameActivityAwardTierCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SBackGameActivityAwardTierCfg> all)
/*     */   {
/*  85 */     String path = dir + "mzm.gsp.activity3.confbean.SBackGameActivityAwardTierCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  97 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity3.confbean.SBackGameActivityAwardTierCfg"))
/*     */         {
/*     */ 
/* 100 */           SBackGameActivityAwardTierCfg obj = new SBackGameActivityAwardTierCfg();
...
/*     */     
/* 116 */     String path = dir + "mzm.gsp.activity3.confbean.SBackGameActivityAwardTierCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 143 */           SBackGameActivityAwardTierCfg _v_ = new SBackGameActivityAwardTierCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SBackGameActivityAwardTierCfg> all)
/*     */   {
/* 163 */     String path = dir + "mzm.gsp.activity3.confbean.SBackGameActivityAwardTierCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 190 */           SBackGameActivityAwardTierCfg _v_ = new SBackGameActivityAwardTierCfg();
...
/*     */ 
/*     */ 
/*     */   public static SBackGameActivityAwardTierCfg getOld(int key)
/*     */   {
/* 211 */     return (SBackGameActivityAwardTierCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SBackGameActivityAwardTierCfg get(int key)
/*     */   {
/* 216 */     return (SBackGameActivityAwardTierCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SBackGameActivityAwardTierCfg> getOldAll()
/*     */   {
/* 221 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SBackGameActivityAwardTierCfg> getAll()
/*     */   {
/* 226 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SBackGameActivityAwardTierCfg> newAll)
/*     */   {
/* 231 */     oldAll = all;
/* 232 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\activity3\confbean\SBackGameActivityAwardTierCfg.class
