...
/*     */ 
/*     */ public class SSurpriseItemConCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SSurpriseItemConCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SSurpriseItemConCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public int libId;
/*     */   public int itemXId;
...
/*  26 */     this.itemXId = Integer.valueOf(rootElement.attributeValue("itemXId")).intValue();
/*     */   }
/*     */   
...
/*  41 */     this.itemXId = _os_.unmarshal_int();
/*  42 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  47 */     String path = dir + "mzm.gsp.activity3.confbean.SSurpriseItemConCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  60 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity3.confbean.SSurpriseItemConCfg"))
/*     */         {
/*     */ 
/*  63 */           SSurpriseItemConCfg obj = new SSurpriseItemConCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SSurpriseItemConCfg> all)
/*     */   {
/*  77 */     String path = dir + "mzm.gsp.activity3.confbean.SSurpriseItemConCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  89 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity3.confbean.SSurpriseItemConCfg"))
/*     */         {
/*     */ 
/*  92 */           SSurpriseItemConCfg obj = new SSurpriseItemConCfg();
...
/*     */     
/* 108 */     String path = dir + "mzm.gsp.activity3.confbean.SSurpriseItemConCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 135 */           SSurpriseItemConCfg _v_ = new SSurpriseItemConCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SSurpriseItemConCfg> all)
/*     */   {
/* 155 */     String path = dir + "mzm.gsp.activity3.confbean.SSurpriseItemConCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 182 */           SSurpriseItemConCfg _v_ = new SSurpriseItemConCfg();
...
/*     */ 
/*     */ 
/*     */   public static SSurpriseItemConCfg getOld(int key)
/*     */   {
/* 203 */     return (SSurpriseItemConCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SSurpriseItemConCfg get(int key)
/*     */   {
/* 208 */     return (SSurpriseItemConCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SSurpriseItemConCfg> getOldAll()
/*     */   {
/* 213 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SSurpriseItemConCfg> getAll()
/*     */   {
/* 218 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SSurpriseItemConCfg> newAll)
/*     */   {
/* 223 */     oldAll = all;
/* 224 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\activity3\confbean\SSurpriseItemConCfg.class
