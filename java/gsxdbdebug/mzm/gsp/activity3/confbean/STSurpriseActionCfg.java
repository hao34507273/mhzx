...
/*     */ 
/*     */ public class STSurpriseActionCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, STSurpriseActionCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, STSurpriseActionCfg> all = null;
/*     */   
/*     */   public int mapId;
/*  19 */   public HashMap<Integer, PositionActionInfo> positinX2Info = new HashMap();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.mapId = Integer.valueOf(rootElement.attributeValue("mapId")).intValue();
/*     */     
/*  25 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "positinX2Info");
...
/*  51 */             keyElem = elem;
/*     */           }
/*  53 */           else if ((valueElem == null) && (elem.getName().equalsIgnoreCase("mzm.gsp.activity3.confbean.PositionActionInfo")))
/*     */           {
/*  55 */             valueElem = elem;
/*     */           }
/*     */         }
...
/*     */         
/*     */         int _k_;
/*     */         PositionActionInfo _v_;
/*     */         try
/*     */         {
/*  68 */           _k_ = Integer.valueOf(keyElem.getText()).intValue();
/*  69 */           _v_ = new PositionActionInfo();
...
/*     */         }
/*     */         
/*  77 */         this.positinX2Info.put(Integer.valueOf(_k_), _v_);
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*     */   {
/*  84 */     _os_.marshal(this.mapId);
/*  85 */     _os_.compact_uint32(this.positinX2Info.size());
/*  86 */     for (java.util.Map.Entry<Integer, PositionActionInfo> _e_ : this.positinX2Info.entrySet())
/*     */     {
...
/*     */   {
/*  96 */     this.mapId = _os_.unmarshal_int();
/*  97 */     for (int _size_ = _os_.uncompact_uint32(); _size_ > 0; _size_--)
/*     */     {
/*     */ 
/* 100 */       int _k_ = _os_.unmarshal_int();
/*     */       
/* 102 */       PositionActionInfo _v_ = new PositionActionInfo();
/* 103 */       _v_.unmarshal(_os_);
/* 104 */       this.positinX2Info.put(Integer.valueOf(_k_), _v_);
/*     */     }
/* 106 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/* 111 */     String path = dir + "mzm.gsp.activity3.confbean.STSurpriseActionCfg.xml";
/*     */     
/*     */     try
/*     */     {
/* 115 */       all = new HashMap();
...
/* 124 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity3.confbean.STSurpriseActionCfg"))
/*     */         {
/*     */ 
/* 127 */           STSurpriseActionCfg obj = new STSurpriseActionCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, STSurpriseActionCfg> all)
/*     */   {
/* 141 */     String path = dir + "mzm.gsp.activity3.confbean.STSurpriseActionCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 153 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity3.confbean.STSurpriseActionCfg"))
/*     */         {
/*     */ 
/* 156 */           STSurpriseActionCfg obj = new STSurpriseActionCfg();
/* 157 */           obj.loadFromXml(elem);
/* 158 */           if (all.put(Integer.valueOf(obj.mapId), obj) != null) {
/* 159 */             throw new RuntimeException("duplicate key : " + obj.mapId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/* 170 */     all = new HashMap();
/*     */     
/* 172 */     String path = dir + "mzm.gsp.activity3.confbean.STSurpriseActionCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 199 */           STSurpriseActionCfg _v_ = new STSurpriseActionCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, STSurpriseActionCfg> all)
/*     */   {
/* 219 */     String path = dir + "mzm.gsp.activity3.confbean.STSurpriseActionCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 246 */           STSurpriseActionCfg _v_ = new STSurpriseActionCfg();
...
/*     */ 
/*     */ 
/*     */   public static STSurpriseActionCfg getOld(int key)
/*     */   {
/* 267 */     return (STSurpriseActionCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static STSurpriseActionCfg get(int key)
/*     */   {
/* 272 */     return (STSurpriseActionCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, STSurpriseActionCfg> getOldAll()
/*     */   {
/* 277 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, STSurpriseActionCfg> getAll()
/*     */   {
/* 282 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, STSurpriseActionCfg> newAll)
/*     */   {
/* 287 */     oldAll = all;
/* 288 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\activity3\confbean\STSurpriseActionCfg.class
