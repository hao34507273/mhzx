...
/*     */ 
/*     */ public class SNPCBuffCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SNPCBuffCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SNPCBuffCfg> all = null;
/*     */   
/*     */   public int serviceId;
/*     */   public boolean isTeamAll;
/*  20 */   public java.util.ArrayList<Integer> buffs = new java.util.ArrayList();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  24 */     this.serviceId = Integer.valueOf(rootElement.attributeValue("serviceId")).intValue();
/*  25 */     this.isTeamAll = Boolean.valueOf(rootElement.attributeValue("isTeamAll")).booleanValue();
/*     */     
/*  27 */     Element collectionElement = util.XmlHelper.getVariableElement(rootElement, "buffs");
...
/*     */         }
/*     */         
/*  52 */         this.buffs.add(Integer.valueOf(_v_));
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*     */   {
/*  59 */     _os_.marshal(this.serviceId);
/*  60 */     _os_.marshal(this.isTeamAll);
/*  61 */     _os_.compact_uint32(this.buffs.size());
/*  62 */     for (Integer _v_ : this.buffs)
/*     */     {
...
/*     */   {
/*  71 */     this.serviceId = _os_.unmarshal_int();
/*  72 */     this.isTeamAll = _os_.unmarshal_boolean();
/*  73 */     for (int _size_ = _os_.uncompact_uint32(); _size_ > 0; _size_--)
/*     */     {
/*     */ 
/*  76 */       int _v_ = _os_.unmarshal_int();
/*  77 */       this.buffs.add(Integer.valueOf(_v_));
/*     */     }
/*  79 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/*  84 */     String path = dir + "mzm.gsp.npc.confbean.SNPCBuffCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  97 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.npc.confbean.SNPCBuffCfg"))
/*     */         {
/*     */ 
/* 100 */           SNPCBuffCfg obj = new SNPCBuffCfg();
/* 101 */           obj.loadFromXml(elem);
/* 102 */           if (all.put(Integer.valueOf(obj.serviceId), obj) != null) {
/* 103 */             throw new RuntimeException("duplicate key : " + obj.serviceId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SNPCBuffCfg> all)
/*     */   {
/* 114 */     String path = dir + "mzm.gsp.npc.confbean.SNPCBuffCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 126 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.npc.confbean.SNPCBuffCfg"))
/*     */         {
/*     */ 
/* 129 */           SNPCBuffCfg obj = new SNPCBuffCfg();
/* 130 */           obj.loadFromXml(elem);
/* 131 */           if (all.put(Integer.valueOf(obj.serviceId), obj) != null) {
/* 132 */             throw new RuntimeException("duplicate key : " + obj.serviceId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 145 */     String path = dir + "mzm.gsp.npc.confbean.SNPCBuffCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 172 */           SNPCBuffCfg _v_ = new SNPCBuffCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SNPCBuffCfg> all)
/*     */   {
/* 192 */     String path = dir + "mzm.gsp.npc.confbean.SNPCBuffCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 219 */           SNPCBuffCfg _v_ = new SNPCBuffCfg();
...
/*     */ 
/*     */ 
/*     */   public static SNPCBuffCfg getOld(int key)
/*     */   {
/* 240 */     return (SNPCBuffCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SNPCBuffCfg get(int key)
/*     */   {
/* 245 */     return (SNPCBuffCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SNPCBuffCfg> getOldAll()
/*     */   {
/* 250 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SNPCBuffCfg> getAll()
/*     */   {
/* 255 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SNPCBuffCfg> newAll)
/*     */   {
/* 260 */     oldAll = all;
/* 261 */     all = newAll;
/*     */   }
