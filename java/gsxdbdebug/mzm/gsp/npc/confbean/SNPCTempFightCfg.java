...
/*     */ 
/*     */ public class SNPCTempFightCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SNPCTempFightCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SNPCTempFightCfg> all = null;
/*     */   
/*     */   public int serviceId;
/*  19 */   public HashMap<Integer, Integer> fightMap = new HashMap();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.serviceId = Integer.valueOf(rootElement.attributeValue("serviceId")).intValue();
/*     */     
/*  25 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "fightMap");
...
/*     */         }
/*     */         
/*  76 */         this.fightMap.put(Integer.valueOf(_k_), Integer.valueOf(_v_));
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*     */   {
/*  83 */     _os_.marshal(this.serviceId);
/*  84 */     _os_.compact_uint32(this.fightMap.size());
/*  85 */     for (java.util.Map.Entry<Integer, Integer> _e_ : this.fightMap.entrySet())
/*     */     {
...
/*     */   {
/*  95 */     this.serviceId = _os_.unmarshal_int();
...
/* 102 */       this.fightMap.put(Integer.valueOf(_k_), Integer.valueOf(_v_));
/*     */     }
/* 104 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/* 109 */     String path = dir + "mzm.gsp.npc.confbean.SNPCTempFightCfg.xml";
/*     */     
/*     */     try
/*     */     {
/* 113 */       all = new HashMap();
...
/* 122 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.npc.confbean.SNPCTempFightCfg"))
/*     */         {
/*     */ 
/* 125 */           SNPCTempFightCfg obj = new SNPCTempFightCfg();
/* 126 */           obj.loadFromXml(elem);
/* 127 */           if (all.put(Integer.valueOf(obj.serviceId), obj) != null) {
/* 128 */             throw new RuntimeException("duplicate key : " + obj.serviceId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SNPCTempFightCfg> all)
/*     */   {
/* 139 */     String path = dir + "mzm.gsp.npc.confbean.SNPCTempFightCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 151 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.npc.confbean.SNPCTempFightCfg"))
/*     */         {
/*     */ 
/* 154 */           SNPCTempFightCfg obj = new SNPCTempFightCfg();
/* 155 */           obj.loadFromXml(elem);
/* 156 */           if (all.put(Integer.valueOf(obj.serviceId), obj) != null) {
/* 157 */             throw new RuntimeException("duplicate key : " + obj.serviceId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/* 168 */     all = new HashMap();
/*     */     
/* 170 */     String path = dir + "mzm.gsp.npc.confbean.SNPCTempFightCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 197 */           SNPCTempFightCfg _v_ = new SNPCTempFightCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SNPCTempFightCfg> all)
/*     */   {
/* 217 */     String path = dir + "mzm.gsp.npc.confbean.SNPCTempFightCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 244 */           SNPCTempFightCfg _v_ = new SNPCTempFightCfg();
...
/*     */ 
/*     */ 
/*     */   public static SNPCTempFightCfg getOld(int key)
/*     */   {
/* 265 */     return (SNPCTempFightCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SNPCTempFightCfg get(int key)
/*     */   {
/* 270 */     return (SNPCTempFightCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SNPCTempFightCfg> getOldAll()
/*     */   {
/* 275 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SNPCTempFightCfg> getAll()
/*     */   {
/* 280 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SNPCTempFightCfg> newAll)
/*     */   {
/* 285 */     oldAll = all;
/* 286 */     all = newAll;
/*     */   }
