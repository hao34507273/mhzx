...
/*     */ 
/*     */ public class SNPCFightCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SNPCFightCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SNPCFightCfg> all = null;
/*     */   
...
/*     */   {
/* 109 */     String path = dir + "mzm.gsp.npc.confbean.SNPCFightCfg.xml";
/*     */     
/*     */     try
/*     */     {
/* 113 */       all = new HashMap();
...
/* 122 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.npc.confbean.SNPCFightCfg"))
/*     */         {
/*     */ 
/* 125 */           SNPCFightCfg obj = new SNPCFightCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SNPCFightCfg> all)
/*     */   {
/* 139 */     String path = dir + "mzm.gsp.npc.confbean.SNPCFightCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 151 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.npc.confbean.SNPCFightCfg"))
/*     */         {
/*     */ 
/* 154 */           SNPCFightCfg obj = new SNPCFightCfg();
...
/* 168 */     all = new HashMap();
/*     */     
/* 170 */     String path = dir + "mzm.gsp.npc.confbean.SNPCFightCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 197 */           SNPCFightCfg _v_ = new SNPCFightCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SNPCFightCfg> all)
/*     */   {
/* 217 */     String path = dir + "mzm.gsp.npc.confbean.SNPCFightCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 244 */           SNPCFightCfg _v_ = new SNPCFightCfg();
...
/*     */ 
/*     */ 
/*     */   public static SNPCFightCfg getOld(int key)
/*     */   {
/* 265 */     return (SNPCFightCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SNPCFightCfg get(int key)
/*     */   {
/* 270 */     return (SNPCFightCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SNPCFightCfg> getOldAll()
/*     */   {
/* 275 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SNPCFightCfg> getAll()
/*     */   {
/* 280 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SNPCFightCfg> newAll)
/*     */   {
/* 285 */     oldAll = all;
/* 286 */     all = newAll;
/*     */   }
