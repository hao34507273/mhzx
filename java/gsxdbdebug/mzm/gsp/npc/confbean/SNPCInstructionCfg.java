...
/*     */ 
/*     */ public class SNPCInstructionCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SNPCInstructionCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SNPCInstructionCfg> all = null;
/*     */   
/*     */   public int id;
...
/*  30 */     _os_.marshal(this.serviceId);
/*  31 */     return _os_;
/*     */   }
/*     */   
...
/*  37 */     this.serviceId = _os_.unmarshal_int();
/*  38 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.npc.confbean.SNPCInstructionCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.npc.confbean.SNPCInstructionCfg"))
/*     */         {
/*     */ 
/*  59 */           SNPCInstructionCfg obj = new SNPCInstructionCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SNPCInstructionCfg> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.npc.confbean.SNPCInstructionCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.npc.confbean.SNPCInstructionCfg"))
/*     */         {
/*     */ 
/*  88 */           SNPCInstructionCfg obj = new SNPCInstructionCfg();
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.npc.confbean.SNPCInstructionCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           SNPCInstructionCfg _v_ = new SNPCInstructionCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SNPCInstructionCfg> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.npc.confbean.SNPCInstructionCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           SNPCInstructionCfg _v_ = new SNPCInstructionCfg();
...
/*     */ 
/*     */ 
/*     */   public static SNPCInstructionCfg getOld(int key)
/*     */   {
/* 199 */     return (SNPCInstructionCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SNPCInstructionCfg get(int key)
/*     */   {
/* 204 */     return (SNPCInstructionCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SNPCInstructionCfg> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SNPCInstructionCfg> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SNPCInstructionCfg> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
