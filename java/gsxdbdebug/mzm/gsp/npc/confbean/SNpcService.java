...
/*     */ 
/*     */ public class SNpcService implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SNpcService> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SNpcService> all = null;
/*     */   
/*     */   public int id;
/*     */   public int serviceType;
/*     */   public int conditonGroupId;
/*     */   public int weight;
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  25 */     this.id = Integer.valueOf(rootElement.attributeValue("id")).intValue();
/*  26 */     this.serviceType = Integer.valueOf(rootElement.attributeValue("serviceType")).intValue();
/*  27 */     this.conditonGroupId = Integer.valueOf(rootElement.attributeValue("conditonGroupId")).intValue();
...
/*  34 */     _os_.marshal(this.serviceType);
/*  35 */     _os_.marshal(this.conditonGroupId);
...
/*  43 */     this.serviceType = _os_.unmarshal_int();
/*  44 */     this.conditonGroupId = _os_.unmarshal_int();
...
/*     */   {
/*  51 */     String path = dir + "mzm.gsp.npc.confbean.SNpcService.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  64 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.npc.confbean.SNpcService"))
/*     */         {
/*     */ 
/*  67 */           SNpcService obj = new SNpcService();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SNpcService> all)
/*     */   {
/*  81 */     String path = dir + "mzm.gsp.npc.confbean.SNpcService.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.npc.confbean.SNpcService"))
/*     */         {
/*     */ 
/*  96 */           SNpcService obj = new SNpcService();
...
/*     */     
/* 112 */     String path = dir + "mzm.gsp.npc.confbean.SNpcService.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 139 */           SNpcService _v_ = new SNpcService();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SNpcService> all)
/*     */   {
/* 159 */     String path = dir + "mzm.gsp.npc.confbean.SNpcService.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 186 */           SNpcService _v_ = new SNpcService();
...
/*     */ 
/*     */ 
/*     */   public static SNpcService getOld(int key)
/*     */   {
/* 207 */     return (SNpcService)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SNpcService get(int key)
/*     */   {
/* 212 */     return (SNpcService)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SNpcService> getOldAll()
/*     */   {
/* 217 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SNpcService> getAll()
/*     */   {
/* 222 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SNpcService> newAll)
/*     */   {
/* 227 */     oldAll = all;
/* 228 */     all = newAll;
/*     */   }
