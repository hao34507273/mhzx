...
/*     */ 
/*     */ public class SExpressionParam implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SExpressionParam> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SExpressionParam> all = null;
/*     */   
/*     */   public int id;
...
/*     */   {
/*  84 */     String path = dir + "mzm.gsp.occupation.confbean.SExpressionParam.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  97 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.occupation.confbean.SExpressionParam"))
/*     */         {
/*     */ 
/* 100 */           SExpressionParam obj = new SExpressionParam();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SExpressionParam> all)
/*     */   {
/* 114 */     String path = dir + "mzm.gsp.occupation.confbean.SExpressionParam.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 126 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.occupation.confbean.SExpressionParam"))
/*     */         {
/*     */ 
/* 129 */           SExpressionParam obj = new SExpressionParam();
...
/*     */     
/* 145 */     String path = dir + "mzm.gsp.occupation.confbean.SExpressionParam.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 172 */           SExpressionParam _v_ = new SExpressionParam();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SExpressionParam> all)
/*     */   {
/* 192 */     String path = dir + "mzm.gsp.occupation.confbean.SExpressionParam.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 219 */           SExpressionParam _v_ = new SExpressionParam();
...
/*     */ 
/*     */ 
/*     */   public static SExpressionParam getOld(int key)
/*     */   {
/* 240 */     return (SExpressionParam)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SExpressionParam get(int key)
/*     */   {
/* 245 */     return (SExpressionParam)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SExpressionParam> getOldAll()
/*     */   {
/* 250 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SExpressionParam> getAll()
/*     */   {
/* 255 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SExpressionParam> newAll)
/*     */   {
/* 260 */     oldAll = all;
/* 261 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\occupation\confbean\SExpressionParam.class
