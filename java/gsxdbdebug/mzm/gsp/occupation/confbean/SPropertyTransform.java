...
/*     */ 
/*     */ public class SPropertyTransform implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SPropertyTransform> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SPropertyTransform> all = null;
/*     */   
/*     */   public int id;
/*     */   public int baseProp;
...
/*  26 */     this.baseProp = Integer.valueOf(rootElement.attributeValue("baseProp")).intValue();
/*  27 */     this.fightProp = Integer.valueOf(rootElement.attributeValue("fightProp")).intValue();
/*  28 */     this.transformValue = Double.valueOf(rootElement.attributeValue("transformValue")).doubleValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  33 */     _os_.marshal(this.id);
/*  34 */     _os_.marshal(this.baseProp);
/*  35 */     _os_.marshal(this.fightProp);
/*  36 */     _os_.marshal(this.transformValue);
/*  37 */     return _os_;
/*     */   }
/*     */   
...
/*  43 */     this.baseProp = _os_.unmarshal_int();
/*  44 */     this.fightProp = _os_.unmarshal_int();
/*  45 */     this.transformValue = _os_.unmarshal_float();
/*  46 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  51 */     String path = dir + "mzm.gsp.occupation.confbean.SPropertyTransform.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  64 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.occupation.confbean.SPropertyTransform"))
/*     */         {
/*     */ 
/*  67 */           SPropertyTransform obj = new SPropertyTransform();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SPropertyTransform> all)
/*     */   {
/*  81 */     String path = dir + "mzm.gsp.occupation.confbean.SPropertyTransform.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.occupation.confbean.SPropertyTransform"))
/*     */         {
/*     */ 
/*  96 */           SPropertyTransform obj = new SPropertyTransform();
...
/*     */     
/* 112 */     String path = dir + "mzm.gsp.occupation.confbean.SPropertyTransform.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 139 */           SPropertyTransform _v_ = new SPropertyTransform();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SPropertyTransform> all)
/*     */   {
/* 159 */     String path = dir + "mzm.gsp.occupation.confbean.SPropertyTransform.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 186 */           SPropertyTransform _v_ = new SPropertyTransform();
...
/*     */ 
/*     */ 
/*     */   public static SPropertyTransform getOld(int key)
/*     */   {
/* 207 */     return (SPropertyTransform)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SPropertyTransform get(int key)
/*     */   {
/* 212 */     return (SPropertyTransform)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPropertyTransform> getOldAll()
/*     */   {
/* 217 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPropertyTransform> getAll()
/*     */   {
/* 222 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SPropertyTransform> newAll)
/*     */   {
/* 227 */     oldAll = all;
/* 228 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\occupation\confbean\SPropertyTransform.class
