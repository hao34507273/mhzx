...
/*     */ 
/*     */ public class SRoleLevelUpExp implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SRoleLevelUpExp> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SRoleLevelUpExp> all = null;
/*     */   
/*     */   public int id;
...
/*  25 */     this.upToLevel = Integer.valueOf(rootElement.attributeValue("upToLevel")).intValue();
/*  26 */     this.needExp = Integer.valueOf(rootElement.attributeValue("needExp")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  31 */     _os_.marshal(this.id);
/*  32 */     _os_.marshal(this.upToLevel);
/*  33 */     _os_.marshal(this.needExp);
/*  34 */     return _os_;
/*     */   }
/*     */   
...
/*  40 */     this.upToLevel = _os_.unmarshal_int();
/*  41 */     this.needExp = _os_.unmarshal_int();
/*  42 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  47 */     String path = dir + "mzm.gsp.occupation.confbean.SRoleLevelUpExp.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  60 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.occupation.confbean.SRoleLevelUpExp"))
/*     */         {
/*     */ 
/*  63 */           SRoleLevelUpExp obj = new SRoleLevelUpExp();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SRoleLevelUpExp> all)
/*     */   {
/*  77 */     String path = dir + "mzm.gsp.occupation.confbean.SRoleLevelUpExp.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  89 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.occupation.confbean.SRoleLevelUpExp"))
/*     */         {
/*     */ 
/*  92 */           SRoleLevelUpExp obj = new SRoleLevelUpExp();
...
/*     */     
/* 108 */     String path = dir + "mzm.gsp.occupation.confbean.SRoleLevelUpExp.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 135 */           SRoleLevelUpExp _v_ = new SRoleLevelUpExp();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SRoleLevelUpExp> all)
/*     */   {
/* 155 */     String path = dir + "mzm.gsp.occupation.confbean.SRoleLevelUpExp.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 182 */           SRoleLevelUpExp _v_ = new SRoleLevelUpExp();
...
/*     */ 
/*     */ 
/*     */   public static SRoleLevelUpExp getOld(int key)
/*     */   {
/* 203 */     return (SRoleLevelUpExp)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SRoleLevelUpExp get(int key)
/*     */   {
/* 208 */     return (SRoleLevelUpExp)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SRoleLevelUpExp> getOldAll()
/*     */   {
/* 213 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SRoleLevelUpExp> getAll()
/*     */   {
/* 218 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SRoleLevelUpExp> newAll)
/*     */   {
/* 223 */     oldAll = all;
/* 224 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\occupation\confbean\SRoleLevelUpExp.class
