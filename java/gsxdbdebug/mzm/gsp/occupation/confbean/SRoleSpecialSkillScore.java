...
/*     */ 
/*     */ public class SRoleSpecialSkillScore implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SRoleSpecialSkillScore> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SRoleSpecialSkillScore> all = null;
/*     */   
/*     */   public int id;
...
/*  27 */     this.skillId = Integer.valueOf(rootElement.attributeValue("skillId")).intValue();
...
/*  44 */     this.skillId = _os_.unmarshal_int();
...
/*     */   {
/*  51 */     String path = dir + "mzm.gsp.occupation.confbean.SRoleSpecialSkillScore.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  64 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.occupation.confbean.SRoleSpecialSkillScore"))
/*     */         {
/*     */ 
/*  67 */           SRoleSpecialSkillScore obj = new SRoleSpecialSkillScore();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SRoleSpecialSkillScore> all)
/*     */   {
/*  81 */     String path = dir + "mzm.gsp.occupation.confbean.SRoleSpecialSkillScore.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.occupation.confbean.SRoleSpecialSkillScore"))
/*     */         {
/*     */ 
/*  96 */           SRoleSpecialSkillScore obj = new SRoleSpecialSkillScore();
...
/*     */     
/* 112 */     String path = dir + "mzm.gsp.occupation.confbean.SRoleSpecialSkillScore.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 139 */           SRoleSpecialSkillScore _v_ = new SRoleSpecialSkillScore();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SRoleSpecialSkillScore> all)
/*     */   {
/* 159 */     String path = dir + "mzm.gsp.occupation.confbean.SRoleSpecialSkillScore.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 186 */           SRoleSpecialSkillScore _v_ = new SRoleSpecialSkillScore();
...
/*     */ 
/*     */ 
/*     */   public static SRoleSpecialSkillScore getOld(int key)
/*     */   {
/* 207 */     return (SRoleSpecialSkillScore)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SRoleSpecialSkillScore get(int key)
/*     */   {
/* 212 */     return (SRoleSpecialSkillScore)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SRoleSpecialSkillScore> getOldAll()
/*     */   {
/* 217 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SRoleSpecialSkillScore> getAll()
/*     */   {
/* 222 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SRoleSpecialSkillScore> newAll)
/*     */   {
/* 227 */     oldAll = all;
/* 228 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\occupation\confbean\SRoleSpecialSkillScore.class
