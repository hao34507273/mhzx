...
/*     */ 
/*     */ public class STrumpetCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, STrumpetCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, STrumpetCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public int itemid;
...
/*  26 */     this.yuanbao_num = Integer.valueOf(rootElement.attributeValue("yuanbao_num")).intValue();
/*     */   }
/*     */   
...
/*  33 */     _os_.marshal(this.yuanbao_num);
/*  34 */     return _os_;
/*     */   }
/*     */   
...
/*  41 */     this.yuanbao_num = _os_.unmarshal_int();
/*  42 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  47 */     String path = dir + "mzm.gsp.chat.confbean.STrumpetCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  60 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.chat.confbean.STrumpetCfg"))
/*     */         {
/*     */ 
/*  63 */           STrumpetCfg obj = new STrumpetCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, STrumpetCfg> all)
/*     */   {
/*  77 */     String path = dir + "mzm.gsp.chat.confbean.STrumpetCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  89 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.chat.confbean.STrumpetCfg"))
/*     */         {
/*     */ 
/*  92 */           STrumpetCfg obj = new STrumpetCfg();
...
/*     */     
/* 108 */     String path = dir + "mzm.gsp.chat.confbean.STrumpetCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 135 */           STrumpetCfg _v_ = new STrumpetCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, STrumpetCfg> all)
/*     */   {
/* 155 */     String path = dir + "mzm.gsp.chat.confbean.STrumpetCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 182 */           STrumpetCfg _v_ = new STrumpetCfg();
...
/*     */ 
/*     */ 
/*     */   public static STrumpetCfg getOld(int key)
/*     */   {
/* 203 */     return (STrumpetCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static STrumpetCfg get(int key)
/*     */   {
/* 208 */     return (STrumpetCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, STrumpetCfg> getOldAll()
/*     */   {
/* 213 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, STrumpetCfg> getAll()
/*     */   {
/* 218 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, STrumpetCfg> newAll)
/*     */   {
/* 223 */     oldAll = all;
/* 224 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\chat\confbean\STrumpetCfg.class
