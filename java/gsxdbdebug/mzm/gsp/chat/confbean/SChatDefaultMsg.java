...
/*     */ 
/*     */ public class SChatDefaultMsg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SChatDefaultMsg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SChatDefaultMsg> all = null;
/*     */   
/*     */   public int id;
...
/*  26 */     this.msg = rootElement.attributeValue("msg");
/*     */   }
/*     */   
...
/*  33 */     _os_.marshal(this.msg, "UTF-8");
/*  34 */     return _os_;
/*     */   }
/*     */   
...
/*  41 */     this.msg = _os_.unmarshal_String("UTF-8");
/*  42 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  47 */     String path = dir + "mzm.gsp.chat.confbean.SChatDefaultMsg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  60 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.chat.confbean.SChatDefaultMsg"))
/*     */         {
/*     */ 
/*  63 */           SChatDefaultMsg obj = new SChatDefaultMsg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SChatDefaultMsg> all)
/*     */   {
/*  77 */     String path = dir + "mzm.gsp.chat.confbean.SChatDefaultMsg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  89 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.chat.confbean.SChatDefaultMsg"))
/*     */         {
/*     */ 
/*  92 */           SChatDefaultMsg obj = new SChatDefaultMsg();
...
/*     */     
/* 108 */     String path = dir + "mzm.gsp.chat.confbean.SChatDefaultMsg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 135 */           SChatDefaultMsg _v_ = new SChatDefaultMsg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SChatDefaultMsg> all)
/*     */   {
/* 155 */     String path = dir + "mzm.gsp.chat.confbean.SChatDefaultMsg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 182 */           SChatDefaultMsg _v_ = new SChatDefaultMsg();
...
/*     */ 
/*     */ 
/*     */   public static SChatDefaultMsg getOld(int key)
/*     */   {
/* 203 */     return (SChatDefaultMsg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SChatDefaultMsg get(int key)
/*     */   {
/* 208 */     return (SChatDefaultMsg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SChatDefaultMsg> getOldAll()
/*     */   {
/* 213 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SChatDefaultMsg> getAll()
/*     */   {
/* 218 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SChatDefaultMsg> newAll)
/*     */   {
/* 223 */     oldAll = all;
/* 224 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\chat\confbean\SChatDefaultMsg.class
