...
/*     */ 
/*     */ 
/*     */ public class SCrossBattleSelectionPanelInfo
/*     */   extends __SCrossBattleSelectionPanelInfo__
/*     */ {
/*     */   public static final int PROTOCOL_TYPE = 12616996;
/*     */   public byte is_five_role_team;
/*     */   public byte is_in_one_corps;
/*     */   public byte is_can_take_part_in_selection;
...
/*     */ 
/*     */ 
/*     */   public SCrossBattleSelectionPanelInfo() {}
/*     */   
/*     */ 
/*     */ 
/*     */   public SCrossBattleSelectionPanelInfo(byte _is_five_role_team_, byte _is_in_one_corps_, byte _is_can_take_part_in_selection_, byte _is_role_same_with_sign_up_)
/*     */   {
/*  39 */     this.is_five_role_team = _is_five_role_team_;
/*  40 */     this.is_in_one_corps = _is_in_one_corps_;
/*  41 */     this.is_can_take_part_in_selection = _is_can_take_part_in_selection_;
...
/*  52 */     _os_.marshal(this.is_can_take_part_in_selection);
...
/*  60 */     this.is_can_take_part_in_selection = _os_.unmarshal_byte();
...
/*  70 */     if ((_o1_ instanceof SCrossBattleSelectionPanelInfo)) {
/*  71 */       SCrossBattleSelectionPanelInfo _o_ = (SCrossBattleSelectionPanelInfo)_o1_;
...
/*  74 */       if (this.is_can_take_part_in_selection != _o_.is_can_take_part_in_selection) return false;
...
/*  85 */     _h_ += this.is_can_take_part_in_selection;
...
/*  95 */     _sb_.append(this.is_can_take_part_in_selection).append(",");
/*  96 */     _sb_.append(this.is_role_same_with_sign_up).append(",");
/*  97 */     _sb_.append(")");
/*  98 */     return _sb_.toString();
/*     */   }
/*     */   
/*     */   public int compareTo(SCrossBattleSelectionPanelInfo _o_) {
...
/* 108 */     _c_ = this.is_can_take_part_in_selection - _o_.is_can_take_part_in_selection;
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\crossbattle\SCrossBattleSelectionPanelInfo.class
