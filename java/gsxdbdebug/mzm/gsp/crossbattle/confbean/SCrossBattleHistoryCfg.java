...
/*     */ 
/*     */ public class SCrossBattleHistoryCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SCrossBattleHistoryCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SCrossBattleHistoryCfg> all = null;
/*     */   
/*     */   public int session;
...
/*     */   {
/*  23 */     this.session = Integer.valueOf(rootElement.attributeValue("session")).intValue();
...
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.crossbattle.confbean.SCrossBattleHistoryCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.crossbattle.confbean.SCrossBattleHistoryCfg"))
/*     */         {
/*     */ 
/*  59 */           SCrossBattleHistoryCfg obj = new SCrossBattleHistoryCfg();
/*  60 */           obj.loadFromXml(elem);
/*  61 */           if (all.put(Integer.valueOf(obj.session), obj) != null) {
/*  62 */             throw new RuntimeException("duplicate key : " + obj.session);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SCrossBattleHistoryCfg> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.crossbattle.confbean.SCrossBattleHistoryCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.crossbattle.confbean.SCrossBattleHistoryCfg"))
/*     */         {
/*     */ 
/*  88 */           SCrossBattleHistoryCfg obj = new SCrossBattleHistoryCfg();
/*  89 */           obj.loadFromXml(elem);
/*  90 */           if (all.put(Integer.valueOf(obj.session), obj) != null) {
/*  91 */             throw new RuntimeException("duplicate key : " + obj.session);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.crossbattle.confbean.SCrossBattleHistoryCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           SCrossBattleHistoryCfg _v_ = new SCrossBattleHistoryCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SCrossBattleHistoryCfg> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.crossbattle.confbean.SCrossBattleHistoryCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           SCrossBattleHistoryCfg _v_ = new SCrossBattleHistoryCfg();
...
/*     */ 
/*     */ 
/*     */   public static SCrossBattleHistoryCfg getOld(int key)
/*     */   {
/* 199 */     return (SCrossBattleHistoryCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SCrossBattleHistoryCfg get(int key)
/*     */   {
/* 204 */     return (SCrossBattleHistoryCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SCrossBattleHistoryCfg> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SCrossBattleHistoryCfg> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SCrossBattleHistoryCfg> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\crossbattle\confbean\SCrossBattleHistoryCfg.class
