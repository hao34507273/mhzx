...
/*     */ 
/*     */ public class SCrossBattleFinalMatchCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SCrossBattleFinalMatchCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SCrossBattleFinalMatchCfg> all = null;
/*     */   
/*     */   public int id;
/*  19 */   public java.util.ArrayList<FinalMatchBean> final_match_list = new java.util.ArrayList();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.id = Integer.valueOf(rootElement.attributeValue("id")).intValue();
/*     */     
/*  25 */     Element collectionElement = util.XmlHelper.getVariableElement(rootElement, "final_match_list");
...
/*  36 */       if (elem.getName().equalsIgnoreCase("mzm.gsp.crossbattle.confbean.FinalMatchBean"))
/*     */       {
/*     */         FinalMatchBean _v_;
/*     */         
/*     */ 
...
/*     */         }
/*     */         
/*  51 */         this.final_match_list.add(_v_);
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*  59 */     _os_.compact_uint32(this.final_match_list.size());
/*  60 */     for (FinalMatchBean _v_ : this.final_match_list)
/*     */     {
/*  62 */       _os_.marshal(_v_);
/*     */     }
/*  64 */     return _os_;
...
/*     */     {
/*     */ 
/*  73 */       FinalMatchBean _v_ = new FinalMatchBean();
/*  74 */       _v_.unmarshal(_os_);
/*  75 */       this.final_match_list.add(_v_);
/*     */     }
/*  77 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/*  82 */     String path = dir + "mzm.gsp.crossbattle.confbean.SCrossBattleFinalMatchCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  95 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.crossbattle.confbean.SCrossBattleFinalMatchCfg"))
/*     */         {
/*     */ 
/*  98 */           SCrossBattleFinalMatchCfg obj = new SCrossBattleFinalMatchCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SCrossBattleFinalMatchCfg> all)
/*     */   {
/* 112 */     String path = dir + "mzm.gsp.crossbattle.confbean.SCrossBattleFinalMatchCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 124 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.crossbattle.confbean.SCrossBattleFinalMatchCfg"))
/*     */         {
/*     */ 
/* 127 */           SCrossBattleFinalMatchCfg obj = new SCrossBattleFinalMatchCfg();
...
/*     */     
/* 143 */     String path = dir + "mzm.gsp.crossbattle.confbean.SCrossBattleFinalMatchCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 170 */           SCrossBattleFinalMatchCfg _v_ = new SCrossBattleFinalMatchCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SCrossBattleFinalMatchCfg> all)
/*     */   {
/* 190 */     String path = dir + "mzm.gsp.crossbattle.confbean.SCrossBattleFinalMatchCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 217 */           SCrossBattleFinalMatchCfg _v_ = new SCrossBattleFinalMatchCfg();
...
/*     */ 
/*     */ 
/*     */   public static SCrossBattleFinalMatchCfg getOld(int key)
/*     */   {
/* 238 */     return (SCrossBattleFinalMatchCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SCrossBattleFinalMatchCfg get(int key)
/*     */   {
/* 243 */     return (SCrossBattleFinalMatchCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SCrossBattleFinalMatchCfg> getOldAll()
/*     */   {
/* 248 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SCrossBattleFinalMatchCfg> getAll()
/*     */   {
/* 253 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SCrossBattleFinalMatchCfg> newAll)
/*     */   {
/* 258 */     oldAll = all;
/* 259 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\crossbattle\confbean\SCrossBattleFinalMatchCfg.class
