...
/*     */ 
/*     */ public class SCrossBattleKnockOutCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SCrossBattleKnockOutCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SCrossBattleKnockOutCfg> all = null;
/*     */   
/*     */   public int activity_cfg_id;
/*  19 */   public HashMap<Integer, KnockOutCfg> knockOutTypeCfgMap = new HashMap();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.activity_cfg_id = Integer.valueOf(rootElement.attributeValue("activity_cfg_id")).intValue();
/*     */     
/*  25 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "knockOutTypeCfgMap");
...
/*  51 */             keyElem = elem;
/*     */           }
/*  53 */           else if ((valueElem == null) && (elem.getName().equalsIgnoreCase("mzm.gsp.crossbattle.confbean.KnockOutCfg")))
/*     */           {
/*  55 */             valueElem = elem;
/*     */           }
/*     */         }
...
/*     */         }
/*     */         
/*  77 */         this.knockOutTypeCfgMap.put(Integer.valueOf(_k_), _v_);
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*  85 */     _os_.compact_uint32(this.knockOutTypeCfgMap.size());
/*  86 */     for (java.util.Map.Entry<Integer, KnockOutCfg> _e_ : this.knockOutTypeCfgMap.entrySet())
/*     */     {
...
/*     */       
/* 102 */       KnockOutCfg _v_ = new KnockOutCfg();
/* 103 */       _v_.unmarshal(_os_);
/* 104 */       this.knockOutTypeCfgMap.put(Integer.valueOf(_k_), _v_);
/*     */     }
/* 106 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/* 111 */     String path = dir + "mzm.gsp.crossbattle.confbean.SCrossBattleKnockOutCfg.xml";
/*     */     
/*     */     try
/*     */     {
/* 115 */       all = new HashMap();
...
/* 124 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.crossbattle.confbean.SCrossBattleKnockOutCfg"))
/*     */         {
/*     */ 
/* 127 */           SCrossBattleKnockOutCfg obj = new SCrossBattleKnockOutCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SCrossBattleKnockOutCfg> all)
/*     */   {
/* 141 */     String path = dir + "mzm.gsp.crossbattle.confbean.SCrossBattleKnockOutCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 153 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.crossbattle.confbean.SCrossBattleKnockOutCfg"))
/*     */         {
/*     */ 
/* 156 */           SCrossBattleKnockOutCfg obj = new SCrossBattleKnockOutCfg();
...
/* 170 */     all = new HashMap();
/*     */     
/* 172 */     String path = dir + "mzm.gsp.crossbattle.confbean.SCrossBattleKnockOutCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 199 */           SCrossBattleKnockOutCfg _v_ = new SCrossBattleKnockOutCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SCrossBattleKnockOutCfg> all)
/*     */   {
/* 219 */     String path = dir + "mzm.gsp.crossbattle.confbean.SCrossBattleKnockOutCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 246 */           SCrossBattleKnockOutCfg _v_ = new SCrossBattleKnockOutCfg();
...
/*     */ 
/*     */ 
/*     */   public static SCrossBattleKnockOutCfg getOld(int key)
/*     */   {
/* 267 */     return (SCrossBattleKnockOutCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SCrossBattleKnockOutCfg get(int key)
/*     */   {
/* 272 */     return (SCrossBattleKnockOutCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SCrossBattleKnockOutCfg> getOldAll()
/*     */   {
/* 277 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SCrossBattleKnockOutCfg> getAll()
/*     */   {
/* 282 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SCrossBattleKnockOutCfg> newAll)
/*     */   {
/* 287 */     oldAll = all;
/* 288 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\crossbattle\confbean\SCrossBattleKnockOutCfg.class
