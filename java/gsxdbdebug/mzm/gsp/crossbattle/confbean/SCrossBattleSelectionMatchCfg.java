...
/*     */ 
/*     */ public class SCrossBattleSelectionMatchCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SCrossBattleSelectionMatchCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SCrossBattleSelectionMatchCfg> all = null;
/*     */   
/*     */   public int id;
/*  19 */   public java.util.ArrayList<SelectionMatchBean> selection_match_list = new java.util.ArrayList();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.id = Integer.valueOf(rootElement.attributeValue("id")).intValue();
/*     */     
/*  25 */     Element collectionElement = util.XmlHelper.getVariableElement(rootElement, "selection_match_list");
...
/*  36 */       if (elem.getName().equalsIgnoreCase("mzm.gsp.crossbattle.confbean.SelectionMatchBean"))
/*     */       {
/*     */         SelectionMatchBean _v_;
/*     */         
/*     */ 
/*     */         try
/*     */         {
/*  43 */           _v_ = new SelectionMatchBean();
...
/*     */         }
/*     */         
/*  51 */         this.selection_match_list.add(_v_);
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*  59 */     _os_.compact_uint32(this.selection_match_list.size());
/*  60 */     for (SelectionMatchBean _v_ : this.selection_match_list)
/*     */     {
/*  62 */       _os_.marshal(_v_);
/*     */     }
/*  64 */     return _os_;
...
/*     */     {
/*     */ 
/*  73 */       SelectionMatchBean _v_ = new SelectionMatchBean();
/*  74 */       _v_.unmarshal(_os_);
/*  75 */       this.selection_match_list.add(_v_);
/*     */     }
/*  77 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/*  82 */     String path = dir + "mzm.gsp.crossbattle.confbean.SCrossBattleSelectionMatchCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  95 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.crossbattle.confbean.SCrossBattleSelectionMatchCfg"))
/*     */         {
/*     */ 
/*  98 */           SCrossBattleSelectionMatchCfg obj = new SCrossBattleSelectionMatchCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SCrossBattleSelectionMatchCfg> all)
/*     */   {
/* 112 */     String path = dir + "mzm.gsp.crossbattle.confbean.SCrossBattleSelectionMatchCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 124 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.crossbattle.confbean.SCrossBattleSelectionMatchCfg"))
/*     */         {
/*     */ 
/* 127 */           SCrossBattleSelectionMatchCfg obj = new SCrossBattleSelectionMatchCfg();
...
/*     */     
/* 143 */     String path = dir + "mzm.gsp.crossbattle.confbean.SCrossBattleSelectionMatchCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 170 */           SCrossBattleSelectionMatchCfg _v_ = new SCrossBattleSelectionMatchCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SCrossBattleSelectionMatchCfg> all)
/*     */   {
/* 190 */     String path = dir + "mzm.gsp.crossbattle.confbean.SCrossBattleSelectionMatchCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 217 */           SCrossBattleSelectionMatchCfg _v_ = new SCrossBattleSelectionMatchCfg();
...
/*     */ 
/*     */ 
/*     */   public static SCrossBattleSelectionMatchCfg getOld(int key)
/*     */   {
/* 238 */     return (SCrossBattleSelectionMatchCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SCrossBattleSelectionMatchCfg get(int key)
/*     */   {
/* 243 */     return (SCrossBattleSelectionMatchCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SCrossBattleSelectionMatchCfg> getOldAll()
/*     */   {
/* 248 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SCrossBattleSelectionMatchCfg> getAll()
/*     */   {
/* 253 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SCrossBattleSelectionMatchCfg> newAll)
/*     */   {
/* 258 */     oldAll = all;
/* 259 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\crossbattle\confbean\SCrossBattleSelectionMatchCfg.class
