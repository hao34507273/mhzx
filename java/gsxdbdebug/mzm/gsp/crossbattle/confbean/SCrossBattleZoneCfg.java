...
/*     */ 
/*     */ public class SCrossBattleZoneCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SCrossBattleZoneCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SCrossBattleZoneCfg> all = null;
/*     */   
/*     */   public int zoneType;
/*     */   public String name;
/*     */   
...
/*     */   {
/*  23 */     this.zoneType = Integer.valueOf(rootElement.attributeValue("zoneType")).intValue();
/*  24 */     this.name = rootElement.attributeValue("name");
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  29 */     _os_.marshal(this.zoneType);
/*  30 */     _os_.marshal(this.name, "UTF-8");
/*  31 */     return _os_;
/*     */   }
/*     */   
/*     */   public OctetsStream unmarshal(OctetsStream _os_) throws com.goldhuman.Common.Marshal.MarshalException
/*     */   {
/*  36 */     this.zoneType = _os_.unmarshal_int();
/*  37 */     this.name = _os_.unmarshal_String("UTF-8");
/*  38 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.crossbattle.confbean.SCrossBattleZoneCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.crossbattle.confbean.SCrossBattleZoneCfg"))
/*     */         {
/*     */ 
/*  59 */           SCrossBattleZoneCfg obj = new SCrossBattleZoneCfg();
/*  60 */           obj.loadFromXml(elem);
/*  61 */           if (all.put(Integer.valueOf(obj.zoneType), obj) != null) {
/*  62 */             throw new RuntimeException("duplicate key : " + obj.zoneType);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SCrossBattleZoneCfg> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.crossbattle.confbean.SCrossBattleZoneCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.crossbattle.confbean.SCrossBattleZoneCfg"))
/*     */         {
/*     */ 
/*  88 */           SCrossBattleZoneCfg obj = new SCrossBattleZoneCfg();
/*  89 */           obj.loadFromXml(elem);
/*  90 */           if (all.put(Integer.valueOf(obj.zoneType), obj) != null) {
/*  91 */             throw new RuntimeException("duplicate key : " + obj.zoneType);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.crossbattle.confbean.SCrossBattleZoneCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           SCrossBattleZoneCfg _v_ = new SCrossBattleZoneCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SCrossBattleZoneCfg> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.crossbattle.confbean.SCrossBattleZoneCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           SCrossBattleZoneCfg _v_ = new SCrossBattleZoneCfg();
...
/*     */ 
/*     */ 
/*     */   public static SCrossBattleZoneCfg getOld(int key)
/*     */   {
/* 199 */     return (SCrossBattleZoneCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SCrossBattleZoneCfg get(int key)
/*     */   {
/* 204 */     return (SCrossBattleZoneCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SCrossBattleZoneCfg> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SCrossBattleZoneCfg> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SCrossBattleZoneCfg> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\crossbattle\confbean\SCrossBattleZoneCfg.class
