...
/*     */ 
/*     */ public class SCrossBattlePointConst
/*     */ {
/*  13 */   private static volatile SCrossBattlePointConst oldInstance = null;
/*     */   
/*  15 */   private static SCrossBattlePointConst instance = new SCrossBattlePointConst();
/*     */   
/*     */ 
/*     */   public int ZONE_NUM;
/*     */   
/*     */ 
/*     */   public static SCrossBattlePointConst getOldInstance()
/*     */   {
/*  23 */     return oldInstance;
/*     */   }
/*     */   
/*     */   public static SCrossBattlePointConst getInstance()
/*     */   {
/*  28 */     return instance;
/*     */   }
/*     */   
...
/*     */   {
/*  40 */     String path = dir + "mzm.gsp.crossbattle.confbean.SCrossBattlePointConst.xml";
/*     */     try
/*     */     {
...
/*     */         }
/*     */       }
/*  60 */       this.ZONE_NUM = Integer.valueOf(((Element)data.get("ZONE_NUM")).attributeValue("value")).intValue();
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*  69 */     String path = dir + "mzm.gsp.crossbattle.confbean.SCrossBattlePointConst.xml";
/*     */     try
/*     */     {
...
/*     */         }
/*     */       }
/*  89 */       this.ZONE_NUM = Integer.valueOf(((Element)data.get("ZONE_NUM")).attributeValue("value")).intValue();
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/* 100 */     String path = dir + "mzm.gsp.crossbattle.confbean.SCrossBattlePointConst.bny";
/*     */     try
/*     */     {
...
/* 115 */         this.ZONE_NUM = _os_.unmarshal_int();
/*     */       }
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*     */   {
/* 126 */     String path = dir + "mzm.gsp.crossbattle.confbean.SCrossBattlePointConst.bny";
/*     */     try
/*     */     {
...
/* 141 */         this.ZONE_NUM = _os_.unmarshal_int();
/*     */       }
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*     */   }
/*     */   
/*     */   public static void setInstance(SCrossBattlePointConst newInstance)
/*     */   {
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\crossbattle\confbean\SCrossBattlePointConst.class
