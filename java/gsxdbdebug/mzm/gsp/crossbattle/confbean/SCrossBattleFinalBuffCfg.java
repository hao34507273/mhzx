...
/*     */ 
/*     */ public class SCrossBattleFinalBuffCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SCrossBattleFinalBuffCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SCrossBattleFinalBuffCfg> all = null;
/*     */   
/*     */   public int id;
/*  19 */   public java.util.HashSet<Integer> buff_id_set = new java.util.HashSet();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.id = Integer.valueOf(rootElement.attributeValue("id")).intValue();
/*     */     
/*  25 */     Element collectionElement = util.XmlHelper.getVariableElement(rootElement, "buff_id_set");
...
/*     */         }
/*     */         
/*  50 */         this.buff_id_set.add(Integer.valueOf(_v_));
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*  58 */     _os_.compact_uint32(this.buff_id_set.size());
/*  59 */     for (Integer _v_ : this.buff_id_set)
/*     */     {
...
/*  73 */       this.buff_id_set.add(Integer.valueOf(_v_));
/*     */     }
/*  75 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/*  80 */     String path = dir + "mzm.gsp.crossbattle.confbean.SCrossBattleFinalBuffCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.crossbattle.confbean.SCrossBattleFinalBuffCfg"))
/*     */         {
/*     */ 
/*  96 */           SCrossBattleFinalBuffCfg obj = new SCrossBattleFinalBuffCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SCrossBattleFinalBuffCfg> all)
/*     */   {
/* 110 */     String path = dir + "mzm.gsp.crossbattle.confbean.SCrossBattleFinalBuffCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 122 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.crossbattle.confbean.SCrossBattleFinalBuffCfg"))
/*     */         {
/*     */ 
/* 125 */           SCrossBattleFinalBuffCfg obj = new SCrossBattleFinalBuffCfg();
...
/*     */     
/* 141 */     String path = dir + "mzm.gsp.crossbattle.confbean.SCrossBattleFinalBuffCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 168 */           SCrossBattleFinalBuffCfg _v_ = new SCrossBattleFinalBuffCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SCrossBattleFinalBuffCfg> all)
/*     */   {
/* 188 */     String path = dir + "mzm.gsp.crossbattle.confbean.SCrossBattleFinalBuffCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 215 */           SCrossBattleFinalBuffCfg _v_ = new SCrossBattleFinalBuffCfg();
...
/*     */ 
/*     */ 
/*     */   public static SCrossBattleFinalBuffCfg getOld(int key)
/*     */   {
/* 236 */     return (SCrossBattleFinalBuffCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SCrossBattleFinalBuffCfg get(int key)
/*     */   {
/* 241 */     return (SCrossBattleFinalBuffCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SCrossBattleFinalBuffCfg> getOldAll()
/*     */   {
/* 246 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SCrossBattleFinalBuffCfg> getAll()
/*     */   {
/* 251 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SCrossBattleFinalBuffCfg> newAll)
/*     */   {
/* 256 */     oldAll = all;
/* 257 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\crossbattle\confbean\SCrossBattleFinalBuffCfg.class
