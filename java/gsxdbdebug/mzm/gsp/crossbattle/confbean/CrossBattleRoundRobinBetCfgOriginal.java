...
/*     */ 
/*     */ public class CrossBattleRoundRobinBetCfgOriginal implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, CrossBattleRoundRobinBetCfgOriginal> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, CrossBattleRoundRobinBetCfgOriginal> all = null;
/*     */   
/*     */   public int id;
...
/*  43 */     this.win_rate_of_return = Double.valueOf(rootElement.attributeValue("win_rate_of_return")).doubleValue();
/*  44 */     this.lose_rate_of_return = Double.valueOf(rootElement.attributeValue("lose_rate_of_return")).doubleValue();
/*  45 */     this.tie_rate_of_return = Double.valueOf(rootElement.attributeValue("tie_rate_of_return")).doubleValue();
/*  46 */     this.bet_cost_type = Integer.valueOf(rootElement.attributeValue("bet_cost_type")).intValue();
...
/*  61 */     _os_.marshal(this.win_rate_of_return);
/*  62 */     _os_.marshal(this.lose_rate_of_return);
/*  63 */     _os_.marshal(this.tie_rate_of_return);
/*  64 */     _os_.marshal(this.bet_cost_type);
...
/*  80 */     this.win_rate_of_return = _os_.unmarshal_float();
/*  81 */     this.lose_rate_of_return = _os_.unmarshal_float();
/*  82 */     this.tie_rate_of_return = _os_.unmarshal_float();
/*  83 */     this.bet_cost_type = _os_.unmarshal_int();
...
/*     */   {
/*  91 */     String path = dir + "mzm.gsp.crossbattle.confbean.CrossBattleRoundRobinBetCfgOriginal.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 104 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.crossbattle.confbean.CrossBattleRoundRobinBetCfgOriginal"))
/*     */         {
/*     */ 
/* 107 */           CrossBattleRoundRobinBetCfgOriginal obj = new CrossBattleRoundRobinBetCfgOriginal();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, CrossBattleRoundRobinBetCfgOriginal> all)
/*     */   {
/* 121 */     String path = dir + "mzm.gsp.crossbattle.confbean.CrossBattleRoundRobinBetCfgOriginal.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 133 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.crossbattle.confbean.CrossBattleRoundRobinBetCfgOriginal"))
/*     */         {
/*     */ 
/* 136 */           CrossBattleRoundRobinBetCfgOriginal obj = new CrossBattleRoundRobinBetCfgOriginal();
...
/*     */     
/* 152 */     String path = dir + "mzm.gsp.crossbattle.confbean.CrossBattleRoundRobinBetCfgOriginal.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 179 */           CrossBattleRoundRobinBetCfgOriginal _v_ = new CrossBattleRoundRobinBetCfgOriginal();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, CrossBattleRoundRobinBetCfgOriginal> all)
/*     */   {
/* 199 */     String path = dir + "mzm.gsp.crossbattle.confbean.CrossBattleRoundRobinBetCfgOriginal.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 226 */           CrossBattleRoundRobinBetCfgOriginal _v_ = new CrossBattleRoundRobinBetCfgOriginal();
...
/*     */ 
/*     */ 
/*     */   public static CrossBattleRoundRobinBetCfgOriginal getOld(int key)
/*     */   {
/* 247 */     return (CrossBattleRoundRobinBetCfgOriginal)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static CrossBattleRoundRobinBetCfgOriginal get(int key)
/*     */   {
/* 252 */     return (CrossBattleRoundRobinBetCfgOriginal)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, CrossBattleRoundRobinBetCfgOriginal> getOldAll()
/*     */   {
/* 257 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, CrossBattleRoundRobinBetCfgOriginal> getAll()
/*     */   {
/* 262 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, CrossBattleRoundRobinBetCfgOriginal> newAll)
/*     */   {
/* 267 */     oldAll = all;
/* 268 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\crossbattle\confbean\CrossBattleRoundRobinBetCfgOriginal.class
