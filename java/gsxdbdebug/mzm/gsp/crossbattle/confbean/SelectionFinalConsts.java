...
/*     */ 
/*     */ public class SelectionFinalConsts
/*     */ {
/*  13 */   private static volatile SelectionFinalConsts oldInstance = null;
/*     */   
/*  15 */   private static SelectionFinalConsts instance = new SelectionFinalConsts();
/*     */   
/*     */ 
/*     */   public int return_own_server_leave_seconds;
/*     */   
/*     */ 
/*     */   public static SelectionFinalConsts getOldInstance()
/*     */   {
/*  23 */     return oldInstance;
/*     */   }
/*     */   
/*     */   public static SelectionFinalConsts getInstance()
/*     */   {
/*  28 */     return instance;
/*     */   }
/*     */   
...
/*     */   {
/*  40 */     String path = dir + "mzm.gsp.crossbattle.confbean.SelectionFinalConsts.xml";
/*     */     try
/*     */     {
...
/*     */         }
/*     */       }
/*  60 */       this.return_own_server_leave_seconds = Integer.valueOf(((Element)data.get("return_own_server_leave_seconds")).attributeValue("value")).intValue();
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*  69 */     String path = dir + "mzm.gsp.crossbattle.confbean.SelectionFinalConsts.xml";
/*     */     try
/*     */     {
...
/*     */         }
/*     */       }
/*  89 */       this.return_own_server_leave_seconds = Integer.valueOf(((Element)data.get("return_own_server_leave_seconds")).attributeValue("value")).intValue();
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/* 100 */     String path = dir + "mzm.gsp.crossbattle.confbean.SelectionFinalConsts.bny";
/*     */     try
/*     */     {
...
/* 115 */         this.return_own_server_leave_seconds = _os_.unmarshal_int();
/*     */       }
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*     */   {
/* 126 */     String path = dir + "mzm.gsp.crossbattle.confbean.SelectionFinalConsts.bny";
/*     */     try
/*     */     {
...
/* 141 */         this.return_own_server_leave_seconds = _os_.unmarshal_int();
/*     */       }
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*     */   }
/*     */   
/*     */   public static void setInstance(SelectionFinalConsts newInstance)
/*     */   {
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\crossbattle\confbean\SelectionFinalConsts.class
