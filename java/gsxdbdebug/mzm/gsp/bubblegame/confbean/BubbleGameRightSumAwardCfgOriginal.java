...
/*     */ 
/*     */ public class BubbleGameRightSumAwardCfgOriginal implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, BubbleGameRightSumAwardCfgOriginal> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, BubbleGameRightSumAwardCfgOriginal> all = null;
/*     */   
/*     */   public int id;
/*     */   public String name;
/*     */   public String desc;
...
/*     */   {
/*  59 */     String path = dir + "mzm.gsp.bubblegame.confbean.BubbleGameRightSumAwardCfgOriginal.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  72 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.bubblegame.confbean.BubbleGameRightSumAwardCfgOriginal"))
/*     */         {
/*     */ 
/*  75 */           BubbleGameRightSumAwardCfgOriginal obj = new BubbleGameRightSumAwardCfgOriginal();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, BubbleGameRightSumAwardCfgOriginal> all)
/*     */   {
/*  89 */     String path = dir + "mzm.gsp.bubblegame.confbean.BubbleGameRightSumAwardCfgOriginal.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 101 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.bubblegame.confbean.BubbleGameRightSumAwardCfgOriginal"))
/*     */         {
/*     */ 
/* 104 */           BubbleGameRightSumAwardCfgOriginal obj = new BubbleGameRightSumAwardCfgOriginal();
...
/*     */     
/* 120 */     String path = dir + "mzm.gsp.bubblegame.confbean.BubbleGameRightSumAwardCfgOriginal.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 147 */           BubbleGameRightSumAwardCfgOriginal _v_ = new BubbleGameRightSumAwardCfgOriginal();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, BubbleGameRightSumAwardCfgOriginal> all)
/*     */   {
/* 167 */     String path = dir + "mzm.gsp.bubblegame.confbean.BubbleGameRightSumAwardCfgOriginal.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 194 */           BubbleGameRightSumAwardCfgOriginal _v_ = new BubbleGameRightSumAwardCfgOriginal();
...
/*     */ 
/*     */ 
/*     */   public static BubbleGameRightSumAwardCfgOriginal getOld(int key)
/*     */   {
/* 215 */     return (BubbleGameRightSumAwardCfgOriginal)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static BubbleGameRightSumAwardCfgOriginal get(int key)
/*     */   {
/* 220 */     return (BubbleGameRightSumAwardCfgOriginal)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, BubbleGameRightSumAwardCfgOriginal> getOldAll()
/*     */   {
/* 225 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, BubbleGameRightSumAwardCfgOriginal> getAll()
/*     */   {
/* 230 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, BubbleGameRightSumAwardCfgOriginal> newAll)
/*     */   {
/* 235 */     oldAll = all;
/* 236 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\bubblegame\confbean\BubbleGameRightSumAwardCfgOriginal.class
