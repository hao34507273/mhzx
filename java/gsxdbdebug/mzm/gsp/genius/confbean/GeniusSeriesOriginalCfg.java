...
/*     */ 
/*     */ public class GeniusSeriesOriginalCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, GeniusSeriesOriginalCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, GeniusSeriesOriginalCfg> all = null;
/*     */   
/*     */   public int id;
...
/*  26 */     this.occupationType = Integer.valueOf(rootElement.attributeValue("occupationType")).intValue();
/*  27 */     this.defaultOpen = Integer.valueOf(rootElement.attributeValue("defaultOpen")).intValue();
/*  28 */     this.uiName = rootElement.attributeValue("uiName");
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  33 */     _os_.marshal(this.id);
/*  34 */     _os_.marshal(this.occupationType);
/*  35 */     _os_.marshal(this.defaultOpen);
/*  36 */     _os_.marshal(this.uiName, "UTF-8");
/*  37 */     return _os_;
/*     */   }
/*     */   
...
/*  43 */     this.occupationType = _os_.unmarshal_int();
/*  44 */     this.defaultOpen = _os_.unmarshal_int();
/*  45 */     this.uiName = _os_.unmarshal_String("UTF-8");
/*  46 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  51 */     String path = dir + "mzm.gsp.genius.confbean.GeniusSeriesOriginalCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  64 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.genius.confbean.GeniusSeriesOriginalCfg"))
/*     */         {
/*     */ 
/*  67 */           GeniusSeriesOriginalCfg obj = new GeniusSeriesOriginalCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, GeniusSeriesOriginalCfg> all)
/*     */   {
/*  81 */     String path = dir + "mzm.gsp.genius.confbean.GeniusSeriesOriginalCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.genius.confbean.GeniusSeriesOriginalCfg"))
/*     */         {
/*     */ 
/*  96 */           GeniusSeriesOriginalCfg obj = new GeniusSeriesOriginalCfg();
...
/*     */     
/* 112 */     String path = dir + "mzm.gsp.genius.confbean.GeniusSeriesOriginalCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 139 */           GeniusSeriesOriginalCfg _v_ = new GeniusSeriesOriginalCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, GeniusSeriesOriginalCfg> all)
/*     */   {
/* 159 */     String path = dir + "mzm.gsp.genius.confbean.GeniusSeriesOriginalCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 186 */           GeniusSeriesOriginalCfg _v_ = new GeniusSeriesOriginalCfg();
...
/*     */ 
/*     */ 
/*     */   public static GeniusSeriesOriginalCfg getOld(int key)
/*     */   {
/* 207 */     return (GeniusSeriesOriginalCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static GeniusSeriesOriginalCfg get(int key)
/*     */   {
/* 212 */     return (GeniusSeriesOriginalCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, GeniusSeriesOriginalCfg> getOldAll()
/*     */   {
/* 217 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, GeniusSeriesOriginalCfg> getAll()
/*     */   {
/* 222 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, GeniusSeriesOriginalCfg> newAll)
/*     */   {
/* 227 */     oldAll = all;
/* 228 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\genius\confbean\GeniusSeriesOriginalCfg.class
