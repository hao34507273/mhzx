...
/*     */ 
/*     */ public class SGeniusSkillToSourceCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SGeniusSkillToSourceCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SGeniusSkillToSourceCfg> all = null;
/*     */   
/*     */   public int skillCfgid;
/*  19 */   public HashMap<Integer, Integer> series = new HashMap();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.skillCfgid = Integer.valueOf(rootElement.attributeValue("skillCfgid")).intValue();
/*     */     
...
/*     */         }
/*     */         
/*  76 */         this.series.put(Integer.valueOf(_k_), Integer.valueOf(_v_));
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*     */   {
/*  83 */     _os_.marshal(this.skillCfgid);
/*  84 */     _os_.compact_uint32(this.series.size());
/*  85 */     for (java.util.Map.Entry<Integer, Integer> _e_ : this.series.entrySet())
/*     */     {
...
/*     */   {
/*  95 */     this.skillCfgid = _os_.unmarshal_int();
...
/* 102 */       this.series.put(Integer.valueOf(_k_), Integer.valueOf(_v_));
/*     */     }
/* 104 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/* 109 */     String path = dir + "mzm.gsp.genius.confbean.SGeniusSkillToSourceCfg.xml";
/*     */     
/*     */     try
/*     */     {
/* 113 */       all = new HashMap();
...
/* 122 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.genius.confbean.SGeniusSkillToSourceCfg"))
/*     */         {
/*     */ 
/* 125 */           SGeniusSkillToSourceCfg obj = new SGeniusSkillToSourceCfg();
/* 126 */           obj.loadFromXml(elem);
/* 127 */           if (all.put(Integer.valueOf(obj.skillCfgid), obj) != null) {
/* 128 */             throw new RuntimeException("duplicate key : " + obj.skillCfgid);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SGeniusSkillToSourceCfg> all)
/*     */   {
/* 139 */     String path = dir + "mzm.gsp.genius.confbean.SGeniusSkillToSourceCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 151 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.genius.confbean.SGeniusSkillToSourceCfg"))
/*     */         {
/*     */ 
/* 154 */           SGeniusSkillToSourceCfg obj = new SGeniusSkillToSourceCfg();
/* 155 */           obj.loadFromXml(elem);
/* 156 */           if (all.put(Integer.valueOf(obj.skillCfgid), obj) != null) {
/* 157 */             throw new RuntimeException("duplicate key : " + obj.skillCfgid);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/* 168 */     all = new HashMap();
/*     */     
/* 170 */     String path = dir + "mzm.gsp.genius.confbean.SGeniusSkillToSourceCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 197 */           SGeniusSkillToSourceCfg _v_ = new SGeniusSkillToSourceCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SGeniusSkillToSourceCfg> all)
/*     */   {
/* 217 */     String path = dir + "mzm.gsp.genius.confbean.SGeniusSkillToSourceCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 244 */           SGeniusSkillToSourceCfg _v_ = new SGeniusSkillToSourceCfg();
...
/*     */ 
/*     */ 
/*     */   public static SGeniusSkillToSourceCfg getOld(int key)
/*     */   {
/* 265 */     return (SGeniusSkillToSourceCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SGeniusSkillToSourceCfg get(int key)
/*     */   {
/* 270 */     return (SGeniusSkillToSourceCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SGeniusSkillToSourceCfg> getOldAll()
/*     */   {
/* 275 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SGeniusSkillToSourceCfg> getAll()
/*     */   {
/* 280 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SGeniusSkillToSourceCfg> newAll)
/*     */   {
/* 285 */     oldAll = all;
/* 286 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\genius\confbean\SGeniusSkillToSourceCfg.class
