...
/*     */ 
/*     */ public class SGeniusSeriesCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SGeniusSeriesCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SGeniusSeriesCfg> all = null;
/*     */   
/*     */   public int occupationType;
/*  19 */   public HashMap<Integer, GeniusSeriesBean> series = new HashMap();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.occupationType = Integer.valueOf(rootElement.attributeValue("occupationType")).intValue();
/*     */     
/*  25 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "series");
...
/*  51 */             keyElem = elem;
/*     */           }
/*  53 */           else if ((valueElem == null) && (elem.getName().equalsIgnoreCase("mzm.gsp.genius.confbean.GeniusSeriesBean")))
/*     */           {
/*  55 */             valueElem = elem;
/*     */           }
/*     */         }
...
/*     */         
/*     */         int _k_;
/*     */         GeniusSeriesBean _v_;
/*     */         try
/*     */         {
/*  68 */           _k_ = Integer.valueOf(keyElem.getText()).intValue();
/*  69 */           _v_ = new GeniusSeriesBean();
...
/*     */         }
/*     */         
/*  77 */         this.series.put(Integer.valueOf(_k_), _v_);
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*     */   {
/*  84 */     _os_.marshal(this.occupationType);
/*  85 */     _os_.compact_uint32(this.series.size());
/*  86 */     for (java.util.Map.Entry<Integer, GeniusSeriesBean> _e_ : this.series.entrySet())
/*     */     {
...
/*     */   {
/*  96 */     this.occupationType = _os_.unmarshal_int();
/*  97 */     for (int _size_ = _os_.uncompact_uint32(); _size_ > 0; _size_--)
/*     */     {
/*     */ 
/* 100 */       int _k_ = _os_.unmarshal_int();
/*     */       
/* 102 */       GeniusSeriesBean _v_ = new GeniusSeriesBean();
/* 103 */       _v_.unmarshal(_os_);
/* 104 */       this.series.put(Integer.valueOf(_k_), _v_);
/*     */     }
/* 106 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/* 111 */     String path = dir + "mzm.gsp.genius.confbean.SGeniusSeriesCfg.xml";
/*     */     
/*     */     try
/*     */     {
/* 115 */       all = new HashMap();
...
/* 124 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.genius.confbean.SGeniusSeriesCfg"))
/*     */         {
/*     */ 
/* 127 */           SGeniusSeriesCfg obj = new SGeniusSeriesCfg();
/* 128 */           obj.loadFromXml(elem);
/* 129 */           if (all.put(Integer.valueOf(obj.occupationType), obj) != null) {
/* 130 */             throw new RuntimeException("duplicate key : " + obj.occupationType);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SGeniusSeriesCfg> all)
/*     */   {
/* 141 */     String path = dir + "mzm.gsp.genius.confbean.SGeniusSeriesCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 153 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.genius.confbean.SGeniusSeriesCfg"))
/*     */         {
/*     */ 
/* 156 */           SGeniusSeriesCfg obj = new SGeniusSeriesCfg();
/* 157 */           obj.loadFromXml(elem);
/* 158 */           if (all.put(Integer.valueOf(obj.occupationType), obj) != null) {
/* 159 */             throw new RuntimeException("duplicate key : " + obj.occupationType);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/* 170 */     all = new HashMap();
/*     */     
/* 172 */     String path = dir + "mzm.gsp.genius.confbean.SGeniusSeriesCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 199 */           SGeniusSeriesCfg _v_ = new SGeniusSeriesCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SGeniusSeriesCfg> all)
/*     */   {
/* 219 */     String path = dir + "mzm.gsp.genius.confbean.SGeniusSeriesCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 246 */           SGeniusSeriesCfg _v_ = new SGeniusSeriesCfg();
...
/*     */ 
/*     */ 
/*     */   public static SGeniusSeriesCfg getOld(int key)
/*     */   {
/* 267 */     return (SGeniusSeriesCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SGeniusSeriesCfg get(int key)
/*     */   {
/* 272 */     return (SGeniusSeriesCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SGeniusSeriesCfg> getOldAll()
/*     */   {
/* 277 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SGeniusSeriesCfg> getAll()
/*     */   {
/* 282 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SGeniusSeriesCfg> newAll)
/*     */   {
/* 287 */     oldAll = all;
/* 288 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\genius\confbean\SGeniusSeriesCfg.class
