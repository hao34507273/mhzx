...
/*     */ 
/*     */ public class SPetSoulCfgPos2Level implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SPetSoulCfgPos2Level> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SPetSoulCfgPos2Level> all = null;
/*     */   
/*     */   public int pos;
/*  19 */   public HashMap<Integer, Integer> level2id = new HashMap();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.pos = Integer.valueOf(rootElement.attributeValue("pos")).intValue();
/*     */     
/*  25 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "level2id");
...
/*     */         }
/*     */         
/*  76 */         this.level2id.put(Integer.valueOf(_k_), Integer.valueOf(_v_));
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*     */   {
/*  83 */     _os_.marshal(this.pos);
/*  84 */     _os_.compact_uint32(this.level2id.size());
/*  85 */     for (java.util.Map.Entry<Integer, Integer> _e_ : this.level2id.entrySet())
/*     */     {
...
/*     */   {
/*  95 */     this.pos = _os_.unmarshal_int();
...
/* 102 */       this.level2id.put(Integer.valueOf(_k_), Integer.valueOf(_v_));
/*     */     }
/* 104 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/* 109 */     String path = dir + "mzm.gsp.petsoul.confbean.SPetSoulCfgPos2Level.xml";
/*     */     
/*     */     try
/*     */     {
/* 113 */       all = new HashMap();
...
/* 122 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.petsoul.confbean.SPetSoulCfgPos2Level"))
/*     */         {
/*     */ 
/* 125 */           SPetSoulCfgPos2Level obj = new SPetSoulCfgPos2Level();
/* 126 */           obj.loadFromXml(elem);
/* 127 */           if (all.put(Integer.valueOf(obj.pos), obj) != null) {
/* 128 */             throw new RuntimeException("duplicate key : " + obj.pos);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SPetSoulCfgPos2Level> all)
/*     */   {
/* 139 */     String path = dir + "mzm.gsp.petsoul.confbean.SPetSoulCfgPos2Level.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 151 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.petsoul.confbean.SPetSoulCfgPos2Level"))
/*     */         {
/*     */ 
/* 154 */           SPetSoulCfgPos2Level obj = new SPetSoulCfgPos2Level();
/* 155 */           obj.loadFromXml(elem);
/* 156 */           if (all.put(Integer.valueOf(obj.pos), obj) != null) {
/* 157 */             throw new RuntimeException("duplicate key : " + obj.pos);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/* 168 */     all = new HashMap();
/*     */     
/* 170 */     String path = dir + "mzm.gsp.petsoul.confbean.SPetSoulCfgPos2Level.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 197 */           SPetSoulCfgPos2Level _v_ = new SPetSoulCfgPos2Level();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SPetSoulCfgPos2Level> all)
/*     */   {
/* 217 */     String path = dir + "mzm.gsp.petsoul.confbean.SPetSoulCfgPos2Level.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 244 */           SPetSoulCfgPos2Level _v_ = new SPetSoulCfgPos2Level();
...
/*     */ 
/*     */ 
/*     */   public static SPetSoulCfgPos2Level getOld(int key)
/*     */   {
/* 265 */     return (SPetSoulCfgPos2Level)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SPetSoulCfgPos2Level get(int key)
/*     */   {
/* 270 */     return (SPetSoulCfgPos2Level)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPetSoulCfgPos2Level> getOldAll()
/*     */   {
/* 275 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPetSoulCfgPos2Level> getAll()
/*     */   {
/* 280 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SPetSoulCfgPos2Level> newAll)
/*     */   {
/* 285 */     oldAll = all;
/* 286 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\petsoul\confbean\SPetSoulCfgPos2Level.class
