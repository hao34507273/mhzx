...
/*     */ 
/*     */ public class SDrawCarnivalBigAwardCountMaxCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SDrawCarnivalBigAwardCountMaxCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SDrawCarnivalBigAwardCountMaxCfg> all = null;
/*     */   
/*     */   public int countTypeId;
/*  19 */   public TreeMap<Integer, Integer> drawYuanBaoAccumulateCount2bigAwardCountMax = new TreeMap();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.countTypeId = Integer.valueOf(rootElement.attributeValue("countTypeId")).intValue();
/*     */     
/*  25 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "drawYuanBaoAccumulateCount2bigAwardCountMax");
...
/*     */         }
/*     */         
/*  76 */         this.drawYuanBaoAccumulateCount2bigAwardCountMax.put(Integer.valueOf(_k_), Integer.valueOf(_v_));
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*     */   {
/*  83 */     _os_.marshal(this.countTypeId);
/*  84 */     _os_.compact_uint32(this.drawYuanBaoAccumulateCount2bigAwardCountMax.size());
/*  85 */     for (java.util.Map.Entry<Integer, Integer> _e_ : this.drawYuanBaoAccumulateCount2bigAwardCountMax.entrySet())
/*     */     {
...
/*     */   {
/*  95 */     this.countTypeId = _os_.unmarshal_int();
...
/* 102 */       this.drawYuanBaoAccumulateCount2bigAwardCountMax.put(Integer.valueOf(_k_), Integer.valueOf(_v_));
/*     */     }
/* 104 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/* 109 */     String path = dir + "mzm.gsp.drawcarnival.confbean.SDrawCarnivalBigAwardCountMaxCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 122 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.drawcarnival.confbean.SDrawCarnivalBigAwardCountMaxCfg"))
/*     */         {
/*     */ 
/* 125 */           SDrawCarnivalBigAwardCountMaxCfg obj = new SDrawCarnivalBigAwardCountMaxCfg();
/* 126 */           obj.loadFromXml(elem);
/* 127 */           if (all.put(Integer.valueOf(obj.countTypeId), obj) != null) {
/* 128 */             throw new RuntimeException("duplicate key : " + obj.countTypeId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SDrawCarnivalBigAwardCountMaxCfg> all)
/*     */   {
/* 139 */     String path = dir + "mzm.gsp.drawcarnival.confbean.SDrawCarnivalBigAwardCountMaxCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 151 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.drawcarnival.confbean.SDrawCarnivalBigAwardCountMaxCfg"))
/*     */         {
/*     */ 
/* 154 */           SDrawCarnivalBigAwardCountMaxCfg obj = new SDrawCarnivalBigAwardCountMaxCfg();
/* 155 */           obj.loadFromXml(elem);
/* 156 */           if (all.put(Integer.valueOf(obj.countTypeId), obj) != null) {
/* 157 */             throw new RuntimeException("duplicate key : " + obj.countTypeId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 170 */     String path = dir + "mzm.gsp.drawcarnival.confbean.SDrawCarnivalBigAwardCountMaxCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 197 */           SDrawCarnivalBigAwardCountMaxCfg _v_ = new SDrawCarnivalBigAwardCountMaxCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SDrawCarnivalBigAwardCountMaxCfg> all)
/*     */   {
/* 217 */     String path = dir + "mzm.gsp.drawcarnival.confbean.SDrawCarnivalBigAwardCountMaxCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 244 */           SDrawCarnivalBigAwardCountMaxCfg _v_ = new SDrawCarnivalBigAwardCountMaxCfg();
...
/*     */ 
/*     */ 
/*     */   public static SDrawCarnivalBigAwardCountMaxCfg getOld(int key)
/*     */   {
/* 265 */     return (SDrawCarnivalBigAwardCountMaxCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SDrawCarnivalBigAwardCountMaxCfg get(int key)
/*     */   {
/* 270 */     return (SDrawCarnivalBigAwardCountMaxCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SDrawCarnivalBigAwardCountMaxCfg> getOldAll()
/*     */   {
/* 275 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SDrawCarnivalBigAwardCountMaxCfg> getAll()
/*     */   {
/* 280 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SDrawCarnivalBigAwardCountMaxCfg> newAll)
/*     */   {
/* 285 */     oldAll = all;
/* 286 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\drawcarnival\confbean\SDrawCarnivalBigAwardCountMaxCfg.class
