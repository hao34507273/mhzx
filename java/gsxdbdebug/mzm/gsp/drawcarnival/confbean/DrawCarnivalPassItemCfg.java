...
/*     */ 
/*     */ public class DrawCarnivalPassItemCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, DrawCarnivalPassItemCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, DrawCarnivalPassItemCfg> all = null;
/*     */   
/*     */   public int passTypeId;
/*  19 */   public java.util.ArrayList<Integer> itemCfgIdList = new java.util.ArrayList();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.passTypeId = Integer.valueOf(rootElement.attributeValue("passTypeId")).intValue();
/*     */     
/*  25 */     Element collectionElement = util.XmlHelper.getVariableElement(rootElement, "itemCfgIdList");
...
/*     */         }
/*     */         
/*  50 */         this.itemCfgIdList.add(Integer.valueOf(_v_));
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*     */   {
/*  57 */     _os_.marshal(this.passTypeId);
/*  58 */     _os_.compact_uint32(this.itemCfgIdList.size());
/*  59 */     for (Integer _v_ : this.itemCfgIdList)
/*     */     {
...
/*     */   {
/*  80 */     String path = dir + "mzm.gsp.drawcarnival.confbean.DrawCarnivalPassItemCfg.xml";
/*     */     
/*     */     try
/*     */     {
/*  84 */       all = new java.util.TreeMap();
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.drawcarnival.confbean.DrawCarnivalPassItemCfg"))
/*     */         {
/*     */ 
/*  96 */           DrawCarnivalPassItemCfg obj = new DrawCarnivalPassItemCfg();
/*  97 */           obj.loadFromXml(elem);
/*  98 */           if (all.put(Integer.valueOf(obj.passTypeId), obj) != null) {
/*  99 */             throw new RuntimeException("duplicate key : " + obj.passTypeId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, DrawCarnivalPassItemCfg> all)
/*     */   {
/* 110 */     String path = dir + "mzm.gsp.drawcarnival.confbean.DrawCarnivalPassItemCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 122 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.drawcarnival.confbean.DrawCarnivalPassItemCfg"))
/*     */         {
/*     */ 
/* 125 */           DrawCarnivalPassItemCfg obj = new DrawCarnivalPassItemCfg();
/* 126 */           obj.loadFromXml(elem);
/* 127 */           if (all.put(Integer.valueOf(obj.passTypeId), obj) != null) {
/* 128 */             throw new RuntimeException("duplicate key : " + obj.passTypeId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   {
/* 139 */     all = new java.util.TreeMap();
/*     */     
/* 141 */     String path = dir + "mzm.gsp.drawcarnival.confbean.DrawCarnivalPassItemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 168 */           DrawCarnivalPassItemCfg _v_ = new DrawCarnivalPassItemCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, DrawCarnivalPassItemCfg> all)
/*     */   {
/* 188 */     String path = dir + "mzm.gsp.drawcarnival.confbean.DrawCarnivalPassItemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 215 */           DrawCarnivalPassItemCfg _v_ = new DrawCarnivalPassItemCfg();
...
/*     */ 
/*     */ 
/*     */   public static DrawCarnivalPassItemCfg getOld(int key)
/*     */   {
/* 236 */     return (DrawCarnivalPassItemCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static DrawCarnivalPassItemCfg get(int key)
/*     */   {
/* 241 */     return (DrawCarnivalPassItemCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, DrawCarnivalPassItemCfg> getOldAll()
/*     */   {
/* 246 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, DrawCarnivalPassItemCfg> getAll()
/*     */   {
/* 251 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, DrawCarnivalPassItemCfg> newAll)
/*     */   {
/* 256 */     oldAll = all;
/* 257 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\drawcarnival\confbean\DrawCarnivalPassItemCfg.class
