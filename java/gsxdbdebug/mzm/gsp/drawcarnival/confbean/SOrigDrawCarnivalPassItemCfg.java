...
/*     */ 
/*     */ public class SOrigDrawCarnivalPassItemCfg extends mzm.gsp.item.confbean.SItemCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  15 */   private static volatile Map<Integer, SOrigDrawCarnivalPassItemCfg> oldAll = null;
/*     */   
/*  17 */   private static Map<Integer, SOrigDrawCarnivalPassItemCfg> all = null;
/*     */   
...
/*  36 */     this.passTypeId = Integer.valueOf(rootElement.attributeValue("passTypeId")).intValue();
/*     */   }
/*     */   
...
/*  54 */     _os_.marshal(this.passTypeId);
/*  55 */     return _os_;
/*     */   }
/*     */   
...
/*  73 */     this.passTypeId = _os_.unmarshal_int();
/*  74 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  79 */     String path = dir + "mzm.gsp.drawcarnival.confbean.SOrigDrawCarnivalPassItemCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  92 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.drawcarnival.confbean.SOrigDrawCarnivalPassItemCfg"))
/*     */         {
/*     */ 
/*  95 */           SOrigDrawCarnivalPassItemCfg obj = new SOrigDrawCarnivalPassItemCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SOrigDrawCarnivalPassItemCfg> all)
/*     */   {
/* 109 */     String path = dir + "mzm.gsp.drawcarnival.confbean.SOrigDrawCarnivalPassItemCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 121 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.drawcarnival.confbean.SOrigDrawCarnivalPassItemCfg"))
/*     */         {
/*     */ 
/* 124 */           SOrigDrawCarnivalPassItemCfg obj = new SOrigDrawCarnivalPassItemCfg();
...
/*     */     
/* 140 */     String path = dir + "mzm.gsp.drawcarnival.confbean.SOrigDrawCarnivalPassItemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 167 */           SOrigDrawCarnivalPassItemCfg _v_ = new SOrigDrawCarnivalPassItemCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SOrigDrawCarnivalPassItemCfg> all)
/*     */   {
/* 187 */     String path = dir + "mzm.gsp.drawcarnival.confbean.SOrigDrawCarnivalPassItemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 214 */           SOrigDrawCarnivalPassItemCfg _v_ = new SOrigDrawCarnivalPassItemCfg();
...
/*     */   {
/* 233 */     for (Map.Entry<Integer, SOrigDrawCarnivalPassItemCfg> entry : all.entrySet())
/*     */     {
/* 235 */       if (mzm.gsp.item.confbean.SItemCfg.get(((Integer)entry.getKey()).intValue()) != null)
/*     */       {
/* 237 */         throw new RuntimeException("load data failed, have complict key");
/*     */       }
/*     */       
/*     */ 
/* 241 */       mzm.gsp.item.confbean.SItemCfg.getAll().put(entry.getKey(), entry.getValue());
/*     */     }
/*     */   }
/*     */   
/*     */ 
/*     */   public static void handleData(Map<Integer, SOrigDrawCarnivalPassItemCfg> all, Map<Integer, mzm.gsp.item.confbean.SItemCfg> parent)
/*     */   {
/* 248 */     for (Map.Entry<Integer, SOrigDrawCarnivalPassItemCfg> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static SOrigDrawCarnivalPassItemCfg getOld(int key)
/*     */   {
/* 263 */     return (SOrigDrawCarnivalPassItemCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SOrigDrawCarnivalPassItemCfg get(int key)
/*     */   {
/* 268 */     return (SOrigDrawCarnivalPassItemCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SOrigDrawCarnivalPassItemCfg> getOldAllSelf()
/*     */   {
/* 273 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SOrigDrawCarnivalPassItemCfg> getAllSelf()
/*     */   {
/* 278 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SOrigDrawCarnivalPassItemCfg> newAll)
/*     */   {
/* 283 */     oldAll = all;
/* 284 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\drawcarnival\confbean\SOrigDrawCarnivalPassItemCfg.class
