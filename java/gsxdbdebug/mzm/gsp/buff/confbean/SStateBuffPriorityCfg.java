...
/*     */ 
/*     */ public class SStateBuffPriorityCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SStateBuffPriorityCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SStateBuffPriorityCfg> all = null;
/*     */   
/*     */   public int buffid;
/*     */   public int priority;
/*     */   
...
/*     */   {
/*  23 */     this.buffid = Integer.valueOf(rootElement.attributeValue("buffid")).intValue();
/*  24 */     this.priority = Integer.valueOf(rootElement.attributeValue("priority")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  29 */     _os_.marshal(this.buffid);
/*  30 */     _os_.marshal(this.priority);
/*  31 */     return _os_;
/*     */   }
/*     */   
/*     */   public OctetsStream unmarshal(OctetsStream _os_) throws com.goldhuman.Common.Marshal.MarshalException
/*     */   {
/*  36 */     this.buffid = _os_.unmarshal_int();
/*  37 */     this.priority = _os_.unmarshal_int();
/*  38 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.buff.confbean.SStateBuffPriorityCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.buff.confbean.SStateBuffPriorityCfg"))
/*     */         {
/*     */ 
/*  59 */           SStateBuffPriorityCfg obj = new SStateBuffPriorityCfg();
/*  60 */           obj.loadFromXml(elem);
/*  61 */           if (all.put(Integer.valueOf(obj.buffid), obj) != null) {
/*  62 */             throw new RuntimeException("duplicate key : " + obj.buffid);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SStateBuffPriorityCfg> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.buff.confbean.SStateBuffPriorityCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.buff.confbean.SStateBuffPriorityCfg"))
/*     */         {
/*     */ 
/*  88 */           SStateBuffPriorityCfg obj = new SStateBuffPriorityCfg();
/*  89 */           obj.loadFromXml(elem);
/*  90 */           if (all.put(Integer.valueOf(obj.buffid), obj) != null) {
/*  91 */             throw new RuntimeException("duplicate key : " + obj.buffid);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.buff.confbean.SStateBuffPriorityCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           SStateBuffPriorityCfg _v_ = new SStateBuffPriorityCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SStateBuffPriorityCfg> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.buff.confbean.SStateBuffPriorityCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           SStateBuffPriorityCfg _v_ = new SStateBuffPriorityCfg();
...
/*     */ 
/*     */ 
/*     */   public static SStateBuffPriorityCfg getOld(int key)
/*     */   {
/* 199 */     return (SStateBuffPriorityCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SStateBuffPriorityCfg get(int key)
/*     */   {
/* 204 */     return (SStateBuffPriorityCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SStateBuffPriorityCfg> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SStateBuffPriorityCfg> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SStateBuffPriorityCfg> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\buff\confbean\SStateBuffPriorityCfg.class
