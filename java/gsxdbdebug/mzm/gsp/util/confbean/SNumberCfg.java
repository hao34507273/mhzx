...
/*     */ 
/*     */ public class SNumberCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SNumberCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SNumberCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public int number;
/*     */   public String name;
...
/*  25 */     this.number = Integer.valueOf(rootElement.attributeValue("number")).intValue();
...
/*  40 */     this.number = _os_.unmarshal_int();
...
/*     */   {
/*  47 */     String path = dir + "mzm.gsp.util.confbean.SNumberCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  60 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.util.confbean.SNumberCfg"))
/*     */         {
/*     */ 
/*  63 */           SNumberCfg obj = new SNumberCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SNumberCfg> all)
/*     */   {
/*  77 */     String path = dir + "mzm.gsp.util.confbean.SNumberCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  89 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.util.confbean.SNumberCfg"))
/*     */         {
/*     */ 
/*  92 */           SNumberCfg obj = new SNumberCfg();
...
/*     */     
/* 108 */     String path = dir + "mzm.gsp.util.confbean.SNumberCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 135 */           SNumberCfg _v_ = new SNumberCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SNumberCfg> all)
/*     */   {
/* 155 */     String path = dir + "mzm.gsp.util.confbean.SNumberCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 182 */           SNumberCfg _v_ = new SNumberCfg();
...
/*     */ 
/*     */ 
/*     */   public static SNumberCfg getOld(int key)
/*     */   {
/* 203 */     return (SNumberCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SNumberCfg get(int key)
/*     */   {
/* 208 */     return (SNumberCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SNumberCfg> getOldAll()
/*     */   {
/* 213 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SNumberCfg> getAll()
/*     */   {
/* 218 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SNumberCfg> newAll)
/*     */   {
/* 223 */     oldAll = all;
/* 224 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\util\confbean\SNumberCfg.class
