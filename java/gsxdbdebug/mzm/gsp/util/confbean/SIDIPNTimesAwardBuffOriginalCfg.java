...
/*     */ 
/*     */ public class SIDIPNTimesAwardBuffOriginalCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SIDIPNTimesAwardBuffOriginalCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SIDIPNTimesAwardBuffOriginalCfg> all = null;
/*     */   
/*     */   public int id;
...
/*  27 */     this.idipId = Integer.valueOf(rootElement.attributeValue("idipId")).intValue();
/*  28 */     this.buffId = Integer.valueOf(rootElement.attributeValue("buffId")).intValue();
/*     */   }
/*     */   
...
/*  35 */     _os_.marshal(this.idipId);
/*  36 */     _os_.marshal(this.buffId);
/*  37 */     return _os_;
/*     */   }
/*     */   
...
/*  44 */     this.idipId = _os_.unmarshal_int();
...
/*     */   {
/*  51 */     String path = dir + "mzm.gsp.util.confbean.SIDIPNTimesAwardBuffOriginalCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  64 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.util.confbean.SIDIPNTimesAwardBuffOriginalCfg"))
/*     */         {
/*     */ 
/*  67 */           SIDIPNTimesAwardBuffOriginalCfg obj = new SIDIPNTimesAwardBuffOriginalCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SIDIPNTimesAwardBuffOriginalCfg> all)
/*     */   {
/*  81 */     String path = dir + "mzm.gsp.util.confbean.SIDIPNTimesAwardBuffOriginalCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.util.confbean.SIDIPNTimesAwardBuffOriginalCfg"))
/*     */         {
/*     */ 
/*  96 */           SIDIPNTimesAwardBuffOriginalCfg obj = new SIDIPNTimesAwardBuffOriginalCfg();
...
/*     */     
/* 112 */     String path = dir + "mzm.gsp.util.confbean.SIDIPNTimesAwardBuffOriginalCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 139 */           SIDIPNTimesAwardBuffOriginalCfg _v_ = new SIDIPNTimesAwardBuffOriginalCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SIDIPNTimesAwardBuffOriginalCfg> all)
/*     */   {
/* 159 */     String path = dir + "mzm.gsp.util.confbean.SIDIPNTimesAwardBuffOriginalCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 186 */           SIDIPNTimesAwardBuffOriginalCfg _v_ = new SIDIPNTimesAwardBuffOriginalCfg();
...
/*     */ 
/*     */ 
/*     */   public static SIDIPNTimesAwardBuffOriginalCfg getOld(int key)
/*     */   {
/* 207 */     return (SIDIPNTimesAwardBuffOriginalCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SIDIPNTimesAwardBuffOriginalCfg get(int key)
/*     */   {
/* 212 */     return (SIDIPNTimesAwardBuffOriginalCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SIDIPNTimesAwardBuffOriginalCfg> getOldAll()
/*     */   {
/* 217 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SIDIPNTimesAwardBuffOriginalCfg> getAll()
/*     */   {
/* 222 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SIDIPNTimesAwardBuffOriginalCfg> newAll)
/*     */   {
/* 227 */     oldAll = all;
/* 228 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\util\confbean\SIDIPNTimesAwardBuffOriginalCfg.class
