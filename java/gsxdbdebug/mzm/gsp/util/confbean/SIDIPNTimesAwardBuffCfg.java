...
/*     */ 
/*     */ public class SIDIPNTimesAwardBuffCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SIDIPNTimesAwardBuffCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SIDIPNTimesAwardBuffCfg> all = null;
/*     */   
/*     */   public int idipId;
/*     */   public int buffId;
/*     */   
...
/*     */   {
/*  23 */     this.idipId = Integer.valueOf(rootElement.attributeValue("idipId")).intValue();
/*  24 */     this.buffId = Integer.valueOf(rootElement.attributeValue("buffId")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  29 */     _os_.marshal(this.idipId);
/*  30 */     _os_.marshal(this.buffId);
/*  31 */     return _os_;
/*     */   }
/*     */   
/*     */   public OctetsStream unmarshal(OctetsStream _os_) throws com.goldhuman.Common.Marshal.MarshalException
/*     */   {
/*  36 */     this.idipId = _os_.unmarshal_int();
/*  37 */     this.buffId = _os_.unmarshal_int();
/*  38 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.util.confbean.SIDIPNTimesAwardBuffCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.util.confbean.SIDIPNTimesAwardBuffCfg"))
/*     */         {
/*     */ 
/*  59 */           SIDIPNTimesAwardBuffCfg obj = new SIDIPNTimesAwardBuffCfg();
/*  60 */           obj.loadFromXml(elem);
/*  61 */           if (all.put(Integer.valueOf(obj.idipId), obj) != null) {
/*  62 */             throw new RuntimeException("duplicate key : " + obj.idipId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SIDIPNTimesAwardBuffCfg> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.util.confbean.SIDIPNTimesAwardBuffCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.util.confbean.SIDIPNTimesAwardBuffCfg"))
/*     */         {
/*     */ 
/*  88 */           SIDIPNTimesAwardBuffCfg obj = new SIDIPNTimesAwardBuffCfg();
/*  89 */           obj.loadFromXml(elem);
/*  90 */           if (all.put(Integer.valueOf(obj.idipId), obj) != null) {
/*  91 */             throw new RuntimeException("duplicate key : " + obj.idipId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.util.confbean.SIDIPNTimesAwardBuffCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           SIDIPNTimesAwardBuffCfg _v_ = new SIDIPNTimesAwardBuffCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SIDIPNTimesAwardBuffCfg> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.util.confbean.SIDIPNTimesAwardBuffCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           SIDIPNTimesAwardBuffCfg _v_ = new SIDIPNTimesAwardBuffCfg();
...
/*     */ 
/*     */ 
/*     */   public static SIDIPNTimesAwardBuffCfg getOld(int key)
/*     */   {
/* 199 */     return (SIDIPNTimesAwardBuffCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SIDIPNTimesAwardBuffCfg get(int key)
/*     */   {
/* 204 */     return (SIDIPNTimesAwardBuffCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SIDIPNTimesAwardBuffCfg> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SIDIPNTimesAwardBuffCfg> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SIDIPNTimesAwardBuffCfg> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\util\confbean\SIDIPNTimesAwardBuffCfg.class
