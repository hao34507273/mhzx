...
/*     */ 
/*     */ public class SChangeFashionCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SChangeFashionCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SChangeFashionCfg> all = null;
/*     */   
/*     */   public int id;
...
/*  25 */     this.changeType = Integer.valueOf(rootElement.attributeValue("changeType")).intValue();
/*  26 */     this.modelCfgid = Integer.valueOf(rootElement.attributeValue("modelCfgid")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  31 */     _os_.marshal(this.id);
/*  32 */     _os_.marshal(this.changeType);
/*  33 */     _os_.marshal(this.modelCfgid);
/*  34 */     return _os_;
/*     */   }
/*     */   
...
/*  40 */     this.changeType = _os_.unmarshal_int();
/*  41 */     this.modelCfgid = _os_.unmarshal_int();
/*  42 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  47 */     String path = dir + "mzm.gsp.util.confbean.SChangeFashionCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  60 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.util.confbean.SChangeFashionCfg"))
/*     */         {
/*     */ 
/*  63 */           SChangeFashionCfg obj = new SChangeFashionCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SChangeFashionCfg> all)
/*     */   {
/*  77 */     String path = dir + "mzm.gsp.util.confbean.SChangeFashionCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  89 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.util.confbean.SChangeFashionCfg"))
/*     */         {
/*     */ 
/*  92 */           SChangeFashionCfg obj = new SChangeFashionCfg();
...
/*     */     
/* 108 */     String path = dir + "mzm.gsp.util.confbean.SChangeFashionCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 135 */           SChangeFashionCfg _v_ = new SChangeFashionCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SChangeFashionCfg> all)
/*     */   {
/* 155 */     String path = dir + "mzm.gsp.util.confbean.SChangeFashionCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 182 */           SChangeFashionCfg _v_ = new SChangeFashionCfg();
...
/*     */ 
/*     */ 
/*     */   public static SChangeFashionCfg getOld(int key)
/*     */   {
/* 203 */     return (SChangeFashionCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SChangeFashionCfg get(int key)
/*     */   {
/* 208 */     return (SChangeFashionCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SChangeFashionCfg> getOldAll()
/*     */   {
/* 213 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SChangeFashionCfg> getAll()
/*     */   {
/* 218 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SChangeFashionCfg> newAll)
/*     */   {
/* 223 */     oldAll = all;
/* 224 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\util\confbean\SChangeFashionCfg.class
