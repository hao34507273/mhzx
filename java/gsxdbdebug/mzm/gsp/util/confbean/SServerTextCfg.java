...
/*     */ 
/*     */ public class SServerTextCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SServerTextCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SServerTextCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public String text;
/*     */   
...
/*  24 */     this.text = rootElement.attributeValue("text");
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  29 */     _os_.marshal(this.id);
/*  30 */     _os_.marshal(this.text, "UTF-8");
/*  31 */     return _os_;
/*     */   }
/*     */   
...
/*  37 */     this.text = _os_.unmarshal_String("UTF-8");
/*  38 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.util.confbean.SServerTextCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.util.confbean.SServerTextCfg"))
/*     */         {
/*     */ 
/*  59 */           SServerTextCfg obj = new SServerTextCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SServerTextCfg> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.util.confbean.SServerTextCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.util.confbean.SServerTextCfg"))
/*     */         {
/*     */ 
/*  88 */           SServerTextCfg obj = new SServerTextCfg();
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.util.confbean.SServerTextCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           SServerTextCfg _v_ = new SServerTextCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SServerTextCfg> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.util.confbean.SServerTextCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           SServerTextCfg _v_ = new SServerTextCfg();
...
/*     */ 
/*     */ 
/*     */   public static SServerTextCfg getOld(int key)
/*     */   {
/* 199 */     return (SServerTextCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SServerTextCfg get(int key)
/*     */   {
/* 204 */     return (SServerTextCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SServerTextCfg> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SServerTextCfg> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SServerTextCfg> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\util\confbean\SServerTextCfg.class
