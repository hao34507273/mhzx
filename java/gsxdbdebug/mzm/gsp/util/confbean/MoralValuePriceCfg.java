...
/*     */ 
/*     */ public class MoralValuePriceCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, MoralValuePriceCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, MoralValuePriceCfg> all = null;
/*     */   
...
/*     */   {
/*  23 */     this.threshold = Integer.valueOf(rootElement.attributeValue("threshold")).intValue();
/*  24 */     this.yuanbao = Integer.valueOf(rootElement.attributeValue("yuanbao")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  29 */     _os_.marshal(this.threshold);
/*  30 */     _os_.marshal(this.yuanbao);
/*  31 */     return _os_;
/*     */   }
/*     */   
/*     */   public OctetsStream unmarshal(OctetsStream _os_) throws com.goldhuman.Common.Marshal.MarshalException
/*     */   {
/*  36 */     this.threshold = _os_.unmarshal_int();
/*  37 */     this.yuanbao = _os_.unmarshal_int();
/*  38 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.util.confbean.MoralValuePriceCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.util.confbean.MoralValuePriceCfg"))
/*     */         {
/*     */ 
/*  59 */           MoralValuePriceCfg obj = new MoralValuePriceCfg();
/*  60 */           obj.loadFromXml(elem);
/*  61 */           if (all.put(Integer.valueOf(obj.threshold), obj) != null) {
/*  62 */             throw new RuntimeException("duplicate key : " + obj.threshold);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, MoralValuePriceCfg> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.util.confbean.MoralValuePriceCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.util.confbean.MoralValuePriceCfg"))
/*     */         {
/*     */ 
/*  88 */           MoralValuePriceCfg obj = new MoralValuePriceCfg();
/*  89 */           obj.loadFromXml(elem);
/*  90 */           if (all.put(Integer.valueOf(obj.threshold), obj) != null) {
/*  91 */             throw new RuntimeException("duplicate key : " + obj.threshold);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.util.confbean.MoralValuePriceCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           MoralValuePriceCfg _v_ = new MoralValuePriceCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, MoralValuePriceCfg> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.util.confbean.MoralValuePriceCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           MoralValuePriceCfg _v_ = new MoralValuePriceCfg();
...
/*     */ 
/*     */ 
/*     */   public static MoralValuePriceCfg getOld(int key)
/*     */   {
/* 199 */     return (MoralValuePriceCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static MoralValuePriceCfg get(int key)
/*     */   {
/* 204 */     return (MoralValuePriceCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, MoralValuePriceCfg> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, MoralValuePriceCfg> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, MoralValuePriceCfg> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\util\confbean\MoralValuePriceCfg.class
