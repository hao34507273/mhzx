...
/*     */ 
/*     */ public class SGreetingCard2Activity implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SGreetingCard2Activity> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SGreetingCard2Activity> all = null;
/*     */   
...
/*     */   {
/*  29 */     _os_.marshal(this.cardCfgId);
...
/*     */   {
/*  36 */     this.cardCfgId = _os_.unmarshal_int();
...
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.gratefuldelivery.confbean.SGreetingCard2Activity.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.gratefuldelivery.confbean.SGreetingCard2Activity"))
/*     */         {
/*     */ 
/*  59 */           SGreetingCard2Activity obj = new SGreetingCard2Activity();
/*  60 */           obj.loadFromXml(elem);
/*  61 */           if (all.put(Integer.valueOf(obj.cardCfgId), obj) != null) {
/*  62 */             throw new RuntimeException("duplicate key : " + obj.cardCfgId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SGreetingCard2Activity> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.gratefuldelivery.confbean.SGreetingCard2Activity.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.gratefuldelivery.confbean.SGreetingCard2Activity"))
/*     */         {
/*     */ 
/*  88 */           SGreetingCard2Activity obj = new SGreetingCard2Activity();
/*  89 */           obj.loadFromXml(elem);
/*  90 */           if (all.put(Integer.valueOf(obj.cardCfgId), obj) != null) {
/*  91 */             throw new RuntimeException("duplicate key : " + obj.cardCfgId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.gratefuldelivery.confbean.SGreetingCard2Activity.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           SGreetingCard2Activity _v_ = new SGreetingCard2Activity();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SGreetingCard2Activity> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.gratefuldelivery.confbean.SGreetingCard2Activity.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           SGreetingCard2Activity _v_ = new SGreetingCard2Activity();
...
/*     */ 
/*     */ 
/*     */   public static SGreetingCard2Activity getOld(int key)
/*     */   {
/* 199 */     return (SGreetingCard2Activity)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SGreetingCard2Activity get(int key)
/*     */   {
/* 204 */     return (SGreetingCard2Activity)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SGreetingCard2Activity> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SGreetingCard2Activity> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SGreetingCard2Activity> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\gratefuldelivery\confbean\SGreetingCard2Activity.class
