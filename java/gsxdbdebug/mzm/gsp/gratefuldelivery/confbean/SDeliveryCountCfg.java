...
/*     */ 
/*     */ public class SDeliveryCountCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SDeliveryCountCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SDeliveryCountCfg> all = null;
/*     */   
/*     */   public int id;
...
/*  29 */     this.stage = Integer.valueOf(rootElement.attributeValue("stage")).intValue();
/*  30 */     this.deliveryCount = Integer.valueOf(rootElement.attributeValue("deliveryCount")).intValue();
/*  31 */     this.rewardId = Integer.valueOf(rootElement.attributeValue("rewardId")).intValue();
/*  32 */     this.iconId = Integer.valueOf(rootElement.attributeValue("iconId")).intValue();
/*     */   }
/*     */   
...
/*  39 */     _os_.marshal(this.stage);
/*  40 */     _os_.marshal(this.deliveryCount);
/*  41 */     _os_.marshal(this.rewardId);
/*  42 */     _os_.marshal(this.iconId);
/*  43 */     return _os_;
/*     */   }
/*     */   
...
/*  50 */     this.stage = _os_.unmarshal_int();
/*  51 */     this.deliveryCount = _os_.unmarshal_int();
/*  52 */     this.rewardId = _os_.unmarshal_int();
/*  53 */     this.iconId = _os_.unmarshal_int();
/*  54 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  59 */     String path = dir + "mzm.gsp.gratefuldelivery.confbean.SDeliveryCountCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  72 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.gratefuldelivery.confbean.SDeliveryCountCfg"))
/*     */         {
/*     */ 
/*  75 */           SDeliveryCountCfg obj = new SDeliveryCountCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SDeliveryCountCfg> all)
/*     */   {
/*  89 */     String path = dir + "mzm.gsp.gratefuldelivery.confbean.SDeliveryCountCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 101 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.gratefuldelivery.confbean.SDeliveryCountCfg"))
/*     */         {
/*     */ 
/* 104 */           SDeliveryCountCfg obj = new SDeliveryCountCfg();
...
/*     */     
/* 120 */     String path = dir + "mzm.gsp.gratefuldelivery.confbean.SDeliveryCountCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 147 */           SDeliveryCountCfg _v_ = new SDeliveryCountCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SDeliveryCountCfg> all)
/*     */   {
/* 167 */     String path = dir + "mzm.gsp.gratefuldelivery.confbean.SDeliveryCountCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 194 */           SDeliveryCountCfg _v_ = new SDeliveryCountCfg();
...
/*     */ 
/*     */ 
/*     */   public static SDeliveryCountCfg getOld(int key)
/*     */   {
/* 215 */     return (SDeliveryCountCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SDeliveryCountCfg get(int key)
/*     */   {
/* 220 */     return (SDeliveryCountCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SDeliveryCountCfg> getOldAll()
/*     */   {
/* 225 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SDeliveryCountCfg> getAll()
/*     */   {
/* 230 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SDeliveryCountCfg> newAll)
/*     */   {
/* 235 */     oldAll = all;
/* 236 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\gratefuldelivery\confbean\SDeliveryCountCfg.class
