...
/*     */ 
/*     */ public class SDeliveryStageCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SDeliveryStageCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SDeliveryStageCfg> all = null;
/*     */   
/*     */   public int activityId;
/*  19 */   public java.util.ArrayList<SStageInformation> stages = new java.util.ArrayList();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.activityId = Integer.valueOf(rootElement.attributeValue("activityId")).intValue();
/*     */     
/*  25 */     Element collectionElement = util.XmlHelper.getVariableElement(rootElement, "stages");
...
/*  36 */       if (elem.getName().equalsIgnoreCase("mzm.gsp.gratefuldelivery.confbean.SStageInformation"))
/*     */       {
/*     */         SStageInformation _v_;
/*     */         
/*     */ 
/*     */         try
/*     */         {
/*  43 */           _v_ = new SStageInformation();
...
/*  59 */     _os_.compact_uint32(this.stages.size());
/*  60 */     for (SStageInformation _v_ : this.stages)
/*     */     {
/*  62 */       _os_.marshal(_v_);
/*     */     }
/*  64 */     return _os_;
...
/*     */     {
/*     */ 
/*  73 */       SStageInformation _v_ = new SStageInformation();
/*  74 */       _v_.unmarshal(_os_);
/*  75 */       this.stages.add(_v_);
/*     */     }
/*  77 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/*  82 */     String path = dir + "mzm.gsp.gratefuldelivery.confbean.SDeliveryStageCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  95 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.gratefuldelivery.confbean.SDeliveryStageCfg"))
/*     */         {
/*     */ 
/*  98 */           SDeliveryStageCfg obj = new SDeliveryStageCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SDeliveryStageCfg> all)
/*     */   {
/* 112 */     String path = dir + "mzm.gsp.gratefuldelivery.confbean.SDeliveryStageCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 124 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.gratefuldelivery.confbean.SDeliveryStageCfg"))
/*     */         {
/*     */ 
/* 127 */           SDeliveryStageCfg obj = new SDeliveryStageCfg();
...
/*     */     
/* 143 */     String path = dir + "mzm.gsp.gratefuldelivery.confbean.SDeliveryStageCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 170 */           SDeliveryStageCfg _v_ = new SDeliveryStageCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SDeliveryStageCfg> all)
/*     */   {
/* 190 */     String path = dir + "mzm.gsp.gratefuldelivery.confbean.SDeliveryStageCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 217 */           SDeliveryStageCfg _v_ = new SDeliveryStageCfg();
...
/*     */ 
/*     */ 
/*     */   public static SDeliveryStageCfg getOld(int key)
/*     */   {
/* 238 */     return (SDeliveryStageCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SDeliveryStageCfg get(int key)
/*     */   {
/* 243 */     return (SDeliveryStageCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SDeliveryStageCfg> getOldAll()
/*     */   {
/* 248 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SDeliveryStageCfg> getAll()
/*     */   {
/* 253 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SDeliveryStageCfg> newAll)
/*     */   {
/* 258 */     oldAll = all;
/* 259 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\gratefuldelivery\confbean\SDeliveryStageCfg.class
