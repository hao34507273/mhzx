...
/*     */ 
/*     */ public class SDarknessMonster implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SDarknessMonster> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SDarknessMonster> all = null;
/*     */   
/*     */   public int id;
...
/*  24 */     this.monsterFightTableId = Integer.valueOf(rootElement.attributeValue("monsterFightTableId")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  29 */     _os_.marshal(this.id);
/*  30 */     _os_.marshal(this.monsterFightTableId);
/*  31 */     return _os_;
/*     */   }
/*     */   
...
/*  37 */     this.monsterFightTableId = _os_.unmarshal_int();
/*  38 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.monster.confbean.SDarknessMonster.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.monster.confbean.SDarknessMonster"))
/*     */         {
/*     */ 
/*  59 */           SDarknessMonster obj = new SDarknessMonster();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SDarknessMonster> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.monster.confbean.SDarknessMonster.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.monster.confbean.SDarknessMonster"))
/*     */         {
/*     */ 
/*  88 */           SDarknessMonster obj = new SDarknessMonster();
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.monster.confbean.SDarknessMonster.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           SDarknessMonster _v_ = new SDarknessMonster();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SDarknessMonster> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.monster.confbean.SDarknessMonster.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           SDarknessMonster _v_ = new SDarknessMonster();
...
/*     */ 
/*     */ 
/*     */   public static SDarknessMonster getOld(int key)
/*     */   {
/* 199 */     return (SDarknessMonster)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SDarknessMonster get(int key)
/*     */   {
/* 204 */     return (SDarknessMonster)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SDarknessMonster> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SDarknessMonster> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SDarknessMonster> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\monster\confbean\SDarknessMonster.class
