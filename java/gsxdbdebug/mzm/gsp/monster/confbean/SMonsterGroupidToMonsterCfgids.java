...
/*     */ 
/*     */ public class SMonsterGroupidToMonsterCfgids implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SMonsterGroupidToMonsterCfgids> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SMonsterGroupidToMonsterCfgids> all = null;
/*     */   
/*     */   public int groupid;
/*  19 */   public java.util.LinkedList<Integer> monsterCfgids = new java.util.LinkedList();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.groupid = Integer.valueOf(rootElement.attributeValue("groupid")).intValue();
/*     */     
/*  25 */     Element collectionElement = util.XmlHelper.getVariableElement(rootElement, "monsterCfgids");
...
/*     */         }
/*     */         
/*  50 */         this.monsterCfgids.add(Integer.valueOf(_v_));
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*  58 */     _os_.compact_uint32(this.monsterCfgids.size());
/*  59 */     for (Integer _v_ : this.monsterCfgids)
/*     */     {
...
/*     */   {
/*  80 */     String path = dir + "mzm.gsp.monster.confbean.SMonsterGroupidToMonsterCfgids.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.monster.confbean.SMonsterGroupidToMonsterCfgids"))
/*     */         {
/*     */ 
/*  96 */           SMonsterGroupidToMonsterCfgids obj = new SMonsterGroupidToMonsterCfgids();
/*  97 */           obj.loadFromXml(elem);
/*  98 */           if (all.put(Integer.valueOf(obj.groupid), obj) != null) {
/*  99 */             throw new RuntimeException("duplicate key : " + obj.groupid);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SMonsterGroupidToMonsterCfgids> all)
/*     */   {
/* 110 */     String path = dir + "mzm.gsp.monster.confbean.SMonsterGroupidToMonsterCfgids.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 122 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.monster.confbean.SMonsterGroupidToMonsterCfgids"))
/*     */         {
/*     */ 
/* 125 */           SMonsterGroupidToMonsterCfgids obj = new SMonsterGroupidToMonsterCfgids();
/* 126 */           obj.loadFromXml(elem);
/* 127 */           if (all.put(Integer.valueOf(obj.groupid), obj) != null) {
/* 128 */             throw new RuntimeException("duplicate key : " + obj.groupid);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 141 */     String path = dir + "mzm.gsp.monster.confbean.SMonsterGroupidToMonsterCfgids.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 168 */           SMonsterGroupidToMonsterCfgids _v_ = new SMonsterGroupidToMonsterCfgids();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SMonsterGroupidToMonsterCfgids> all)
/*     */   {
/* 188 */     String path = dir + "mzm.gsp.monster.confbean.SMonsterGroupidToMonsterCfgids.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 215 */           SMonsterGroupidToMonsterCfgids _v_ = new SMonsterGroupidToMonsterCfgids();
...
/*     */ 
/*     */ 
/*     */   public static SMonsterGroupidToMonsterCfgids getOld(int key)
/*     */   {
/* 236 */     return (SMonsterGroupidToMonsterCfgids)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SMonsterGroupidToMonsterCfgids get(int key)
/*     */   {
/* 241 */     return (SMonsterGroupidToMonsterCfgids)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMonsterGroupidToMonsterCfgids> getOldAll()
/*     */   {
/* 246 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMonsterGroupidToMonsterCfgids> getAll()
/*     */   {
/* 251 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SMonsterGroupidToMonsterCfgids> newAll)
/*     */   {
/* 256 */     oldAll = all;
/* 257 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\monster\confbean\SMonsterGroupidToMonsterCfgids.class
