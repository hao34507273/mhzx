...
/*     */ 
/*     */ public class SMonsterGroupCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SMonsterGroupCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SMonsterGroupCfg> all = null;
/*     */   
/*     */   public int id;
/*  19 */   public java.util.HashSet<Integer> monsterids = new java.util.HashSet();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.id = Integer.valueOf(rootElement.attributeValue("id")).intValue();
/*     */     
/*  25 */     Element collectionElement = util.XmlHelper.getVariableElement(rootElement, "monsterids");
...
/*     */         }
/*     */         
/*  50 */         this.monsterids.add(Integer.valueOf(_v_));
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*  58 */     _os_.compact_uint32(this.monsterids.size());
/*  59 */     for (Integer _v_ : this.monsterids)
/*     */     {
...
/*  73 */       this.monsterids.add(Integer.valueOf(_v_));
/*     */     }
/*  75 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/*  80 */     String path = dir + "mzm.gsp.monster.confbean.SMonsterGroupCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.monster.confbean.SMonsterGroupCfg"))
/*     */         {
/*     */ 
/*  96 */           SMonsterGroupCfg obj = new SMonsterGroupCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SMonsterGroupCfg> all)
/*     */   {
/* 110 */     String path = dir + "mzm.gsp.monster.confbean.SMonsterGroupCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 122 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.monster.confbean.SMonsterGroupCfg"))
/*     */         {
/*     */ 
/* 125 */           SMonsterGroupCfg obj = new SMonsterGroupCfg();
...
/*     */     
/* 141 */     String path = dir + "mzm.gsp.monster.confbean.SMonsterGroupCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 168 */           SMonsterGroupCfg _v_ = new SMonsterGroupCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SMonsterGroupCfg> all)
/*     */   {
/* 188 */     String path = dir + "mzm.gsp.monster.confbean.SMonsterGroupCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 215 */           SMonsterGroupCfg _v_ = new SMonsterGroupCfg();
...
/*     */ 
/*     */ 
/*     */   public static SMonsterGroupCfg getOld(int key)
/*     */   {
/* 236 */     return (SMonsterGroupCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SMonsterGroupCfg get(int key)
/*     */   {
/* 241 */     return (SMonsterGroupCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMonsterGroupCfg> getOldAll()
/*     */   {
/* 246 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMonsterGroupCfg> getAll()
/*     */   {
/* 251 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SMonsterGroupCfg> newAll)
/*     */   {
/* 256 */     oldAll = all;
/* 257 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\monster\confbean\SMonsterGroupCfg.class
