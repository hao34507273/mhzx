...
/*     */ 
/*     */ public class SBasicMonsterCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SBasicMonsterCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SBasicMonsterCfg> all = null;
/*     */   
/*     */   public int propertyTierId;
/*  19 */   public HashMap<Integer, BasicMonsterConfigInfo> levels = new HashMap();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.propertyTierId = Integer.valueOf(rootElement.attributeValue("propertyTierId")).intValue();
/*     */     
/*  25 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "levels");
...
/*  51 */             keyElem = elem;
/*     */           }
/*  53 */           else if ((valueElem == null) && (elem.getName().equalsIgnoreCase("mzm.gsp.monster.confbean.BasicMonsterConfigInfo")))
/*     */           {
/*  55 */             valueElem = elem;
/*     */           }
/*     */         }
...
/*     */         
/*     */         int _k_;
/*     */         BasicMonsterConfigInfo _v_;
/*     */         try
/*     */         {
/*  68 */           _k_ = Integer.valueOf(keyElem.getText()).intValue();
/*  69 */           _v_ = new BasicMonsterConfigInfo();
...
/*     */         }
/*     */         
/*  77 */         this.levels.put(Integer.valueOf(_k_), _v_);
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*     */   {
/*  84 */     _os_.marshal(this.propertyTierId);
/*  85 */     _os_.compact_uint32(this.levels.size());
/*  86 */     for (java.util.Map.Entry<Integer, BasicMonsterConfigInfo> _e_ : this.levels.entrySet())
/*     */     {
...
/*     */   {
/*  96 */     this.propertyTierId = _os_.unmarshal_int();
/*  97 */     for (int _size_ = _os_.uncompact_uint32(); _size_ > 0; _size_--)
/*     */     {
/*     */ 
/* 100 */       int _k_ = _os_.unmarshal_int();
/*     */       
/* 102 */       BasicMonsterConfigInfo _v_ = new BasicMonsterConfigInfo();
/* 103 */       _v_.unmarshal(_os_);
/* 104 */       this.levels.put(Integer.valueOf(_k_), _v_);
/*     */     }
/* 106 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/* 111 */     String path = dir + "mzm.gsp.monster.confbean.SBasicMonsterCfg.xml";
/*     */     
/*     */     try
/*     */     {
/* 115 */       all = new HashMap();
...
/* 124 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.monster.confbean.SBasicMonsterCfg"))
/*     */         {
/*     */ 
/* 127 */           SBasicMonsterCfg obj = new SBasicMonsterCfg();
/* 128 */           obj.loadFromXml(elem);
/* 129 */           if (all.put(Integer.valueOf(obj.propertyTierId), obj) != null) {
/* 130 */             throw new RuntimeException("duplicate key : " + obj.propertyTierId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SBasicMonsterCfg> all)
/*     */   {
/* 141 */     String path = dir + "mzm.gsp.monster.confbean.SBasicMonsterCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 153 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.monster.confbean.SBasicMonsterCfg"))
/*     */         {
/*     */ 
/* 156 */           SBasicMonsterCfg obj = new SBasicMonsterCfg();
/* 157 */           obj.loadFromXml(elem);
/* 158 */           if (all.put(Integer.valueOf(obj.propertyTierId), obj) != null) {
/* 159 */             throw new RuntimeException("duplicate key : " + obj.propertyTierId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/* 170 */     all = new HashMap();
/*     */     
/* 172 */     String path = dir + "mzm.gsp.monster.confbean.SBasicMonsterCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 199 */           SBasicMonsterCfg _v_ = new SBasicMonsterCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SBasicMonsterCfg> all)
/*     */   {
/* 219 */     String path = dir + "mzm.gsp.monster.confbean.SBasicMonsterCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 246 */           SBasicMonsterCfg _v_ = new SBasicMonsterCfg();
...
/*     */ 
/*     */ 
/*     */   public static SBasicMonsterCfg getOld(int key)
/*     */   {
/* 267 */     return (SBasicMonsterCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SBasicMonsterCfg get(int key)
/*     */   {
/* 272 */     return (SBasicMonsterCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SBasicMonsterCfg> getOldAll()
/*     */   {
/* 277 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SBasicMonsterCfg> getAll()
/*     */   {
/* 282 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SBasicMonsterCfg> newAll)
/*     */   {
/* 287 */     oldAll = all;
/* 288 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\monster\confbean\SBasicMonsterCfg.class
