/*     */ package mzm.gsp.chatbubble.confbean;
/*     */ 
...
/*     */ 
/*     */ public class SChatBubbleItemCfg extends mzm.gsp.item.confbean.SItemCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  15 */   private static volatile Map<Integer, SChatBubbleItemCfg> oldAll = null;
/*     */   
/*  17 */   private static Map<Integer, SChatBubbleItemCfg> all = null;
/*     */   
...
/*  36 */     this.chatBubbleCfgId = Integer.valueOf(rootElement.attributeValue("chatBubbleCfgId")).intValue();
/*     */   }
/*     */   
...
/*  54 */     _os_.marshal(this.chatBubbleCfgId);
/*  55 */     return _os_;
/*     */   }
/*     */   
...
/*  73 */     this.chatBubbleCfgId = _os_.unmarshal_int();
/*  74 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  79 */     String path = dir + "mzm.gsp.chatbubble.confbean.SChatBubbleItemCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  92 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.chatbubble.confbean.SChatBubbleItemCfg"))
/*     */         {
/*     */ 
/*  95 */           SChatBubbleItemCfg obj = new SChatBubbleItemCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SChatBubbleItemCfg> all)
/*     */   {
/* 109 */     String path = dir + "mzm.gsp.chatbubble.confbean.SChatBubbleItemCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 121 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.chatbubble.confbean.SChatBubbleItemCfg"))
/*     */         {
/*     */ 
/* 124 */           SChatBubbleItemCfg obj = new SChatBubbleItemCfg();
...
/*     */     
/* 140 */     String path = dir + "mzm.gsp.chatbubble.confbean.SChatBubbleItemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 167 */           SChatBubbleItemCfg _v_ = new SChatBubbleItemCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SChatBubbleItemCfg> all)
/*     */   {
/* 187 */     String path = dir + "mzm.gsp.chatbubble.confbean.SChatBubbleItemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 214 */           SChatBubbleItemCfg _v_ = new SChatBubbleItemCfg();
...
/*     */   {
/* 233 */     for (Map.Entry<Integer, SChatBubbleItemCfg> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static void handleData(Map<Integer, SChatBubbleItemCfg> all, Map<Integer, mzm.gsp.item.confbean.SItemCfg> parent)
/*     */   {
/* 248 */     for (Map.Entry<Integer, SChatBubbleItemCfg> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static SChatBubbleItemCfg getOld(int key)
/*     */   {
/* 263 */     return (SChatBubbleItemCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SChatBubbleItemCfg get(int key)
/*     */   {
/* 268 */     return (SChatBubbleItemCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SChatBubbleItemCfg> getOldAllSelf()
/*     */   {
/* 273 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SChatBubbleItemCfg> getAllSelf()
/*     */   {
/* 278 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SChatBubbleItemCfg> newAll)
/*     */   {
/* 283 */     oldAll = all;
/* 284 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\chatbubble\confbean\SChatBubbleItemCfg.class
