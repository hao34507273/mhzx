...
/*     */ 
/*     */ public class SChatBubbleCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SChatBubbleCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SChatBubbleCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public String name;
/*     */   public int gender;
...
/*  29 */     this.gender = Integer.valueOf(rootElement.attributeValue("gender")).intValue();
/*  30 */     this.menpai = Integer.valueOf(rootElement.attributeValue("menpai")).intValue();
/*  31 */     this.duration = Integer.valueOf(rootElement.attributeValue("duration")).intValue();
/*  32 */     this.showType = Integer.valueOf(rootElement.attributeValue("showType")).intValue();
/*     */   }
/*     */   
...
/*  39 */     _os_.marshal(this.gender);
/*  40 */     _os_.marshal(this.menpai);
/*  41 */     _os_.marshal(this.duration);
/*  42 */     _os_.marshal(this.showType);
/*  43 */     return _os_;
/*     */   }
/*     */   
...
/*  50 */     this.gender = _os_.unmarshal_int();
/*  51 */     this.menpai = _os_.unmarshal_int();
/*  52 */     this.duration = _os_.unmarshal_int();
/*  53 */     this.showType = _os_.unmarshal_int();
/*  54 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  59 */     String path = dir + "mzm.gsp.chatbubble.confbean.SChatBubbleCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  72 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.chatbubble.confbean.SChatBubbleCfg"))
/*     */         {
/*     */ 
/*  75 */           SChatBubbleCfg obj = new SChatBubbleCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SChatBubbleCfg> all)
/*     */   {
/*  89 */     String path = dir + "mzm.gsp.chatbubble.confbean.SChatBubbleCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 101 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.chatbubble.confbean.SChatBubbleCfg"))
/*     */         {
/*     */ 
/* 104 */           SChatBubbleCfg obj = new SChatBubbleCfg();
...
/*     */     
/* 120 */     String path = dir + "mzm.gsp.chatbubble.confbean.SChatBubbleCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 147 */           SChatBubbleCfg _v_ = new SChatBubbleCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SChatBubbleCfg> all)
/*     */   {
/* 167 */     String path = dir + "mzm.gsp.chatbubble.confbean.SChatBubbleCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 194 */           SChatBubbleCfg _v_ = new SChatBubbleCfg();
...
/*     */ 
/*     */ 
/*     */   public static SChatBubbleCfg getOld(int key)
/*     */   {
/* 215 */     return (SChatBubbleCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SChatBubbleCfg get(int key)
/*     */   {
/* 220 */     return (SChatBubbleCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SChatBubbleCfg> getOldAll()
/*     */   {
/* 225 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SChatBubbleCfg> getAll()
/*     */   {
/* 230 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SChatBubbleCfg> newAll)
/*     */   {
/* 235 */     oldAll = all;
/* 236 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\chatbubble\confbean\SChatBubbleCfg.class
