...
/*     */ 
/*     */ public class ChatBubbleConsts
/*     */ {
/*  13 */   private static volatile ChatBubbleConsts oldInstance = null;
/*     */   
/*  15 */   private static ChatBubbleConsts instance = new ChatBubbleConsts();
/*     */   public int minRoleLevel;
/*     */   public int expireMailId;
/*     */   public int defaultChatBubbleCfgId;
/*     */   public int minDisplayCount;
/*     */   
/*     */   public static ChatBubbleConsts getOldInstance()
/*     */   {
/*  23 */     return oldInstance;
/*     */   }
/*     */   
/*     */   public static ChatBubbleConsts getInstance()
/*     */   {
/*  28 */     return instance;
/*     */   }
/*     */   
...
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.chatbubble.confbean.ChatBubbleConsts.xml";
/*     */     try
/*     */     {
...
/*     */         }
/*     */       }
/*  63 */       this.minRoleLevel = Integer.valueOf(((Element)data.get("minRoleLevel")).attributeValue("value")).intValue();
/*  64 */       this.expireMailId = Integer.valueOf(((Element)data.get("expireMailId")).attributeValue("value")).intValue();
/*  65 */       this.defaultChatBubbleCfgId = Integer.valueOf(((Element)data.get("defaultChatBubbleCfgId")).attributeValue("value")).intValue();
/*  66 */       this.minDisplayCount = Integer.valueOf(((Element)data.get("minDisplayCount")).attributeValue("value")).intValue();
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*  75 */     String path = dir + "mzm.gsp.chatbubble.confbean.ChatBubbleConsts.xml";
/*     */     try
/*     */     {
...
/*     */         }
/*     */       }
/*  95 */       this.minRoleLevel = Integer.valueOf(((Element)data.get("minRoleLevel")).attributeValue("value")).intValue();
/*  96 */       this.expireMailId = Integer.valueOf(((Element)data.get("expireMailId")).attributeValue("value")).intValue();
/*  97 */       this.defaultChatBubbleCfgId = Integer.valueOf(((Element)data.get("defaultChatBubbleCfgId")).attributeValue("value")).intValue();
/*  98 */       this.minDisplayCount = Integer.valueOf(((Element)data.get("minDisplayCount")).attributeValue("value")).intValue();
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/* 109 */     String path = dir + "mzm.gsp.chatbubble.confbean.ChatBubbleConsts.bny";
/*     */     try
/*     */     {
...
/* 124 */         this.minRoleLevel = _os_.unmarshal_int();
/* 125 */         this.expireMailId = _os_.unmarshal_int();
/* 126 */         this.defaultChatBubbleCfgId = _os_.unmarshal_int();
/* 127 */         this.minDisplayCount = _os_.unmarshal_int();
/*     */       }
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*     */   {
/* 138 */     String path = dir + "mzm.gsp.chatbubble.confbean.ChatBubbleConsts.bny";
/*     */     try
/*     */     {
...
/* 153 */         this.minRoleLevel = _os_.unmarshal_int();
/* 154 */         this.expireMailId = _os_.unmarshal_int();
/* 155 */         this.defaultChatBubbleCfgId = _os_.unmarshal_int();
/* 156 */         this.minDisplayCount = _os_.unmarshal_int();
/*     */       }
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*     */   }
/*     */   
/*     */   public static void setInstance(ChatBubbleConsts newInstance)
/*     */   {
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\chatbubble\confbean\ChatBubbleConsts.class
