...
/*     */ 
/*     */ public class STQingYunZhiCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, STQingYunZhiCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, STQingYunZhiCfg> all = null;
/*     */   
/*     */   public int challengeType;
/*  19 */   public HashMap<Integer, STSection2Data> chapterNum = new HashMap();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.challengeType = Integer.valueOf(rootElement.attributeValue("challengeType")).intValue();
/*     */     
/*  25 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "chapterNum");
...
/*  51 */             keyElem = elem;
/*     */           }
/*  53 */           else if ((valueElem == null) && (elem.getName().equalsIgnoreCase("mzm.gsp.qingyunzhi.confbean.STSection2Data")))
/*     */           {
/*  55 */             valueElem = elem;
/*     */           }
/*     */         }
...
/*     */         }
/*     */         
/*  77 */         this.chapterNum.put(Integer.valueOf(_k_), _v_);
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*     */   {
/*  84 */     _os_.marshal(this.challengeType);
/*  85 */     _os_.compact_uint32(this.chapterNum.size());
/*  86 */     for (java.util.Map.Entry<Integer, STSection2Data> _e_ : this.chapterNum.entrySet())
/*     */     {
...
/*     */   {
/*  96 */     this.challengeType = _os_.unmarshal_int();
/*  97 */     for (int _size_ = _os_.uncompact_uint32(); _size_ > 0; _size_--)
/*     */     {
/*     */ 
/* 100 */       int _k_ = _os_.unmarshal_int();
/*     */       
/* 102 */       STSection2Data _v_ = new STSection2Data();
/* 103 */       _v_.unmarshal(_os_);
/* 104 */       this.chapterNum.put(Integer.valueOf(_k_), _v_);
/*     */     }
/* 106 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/* 111 */     String path = dir + "mzm.gsp.qingyunzhi.confbean.STQingYunZhiCfg.xml";
/*     */     
/*     */     try
/*     */     {
/* 115 */       all = new HashMap();
...
/* 124 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.qingyunzhi.confbean.STQingYunZhiCfg"))
/*     */         {
/*     */ 
/* 127 */           STQingYunZhiCfg obj = new STQingYunZhiCfg();
/* 128 */           obj.loadFromXml(elem);
/* 129 */           if (all.put(Integer.valueOf(obj.challengeType), obj) != null) {
/* 130 */             throw new RuntimeException("duplicate key : " + obj.challengeType);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, STQingYunZhiCfg> all)
/*     */   {
/* 141 */     String path = dir + "mzm.gsp.qingyunzhi.confbean.STQingYunZhiCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 153 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.qingyunzhi.confbean.STQingYunZhiCfg"))
/*     */         {
/*     */ 
/* 156 */           STQingYunZhiCfg obj = new STQingYunZhiCfg();
/* 157 */           obj.loadFromXml(elem);
/* 158 */           if (all.put(Integer.valueOf(obj.challengeType), obj) != null) {
/* 159 */             throw new RuntimeException("duplicate key : " + obj.challengeType);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/* 170 */     all = new HashMap();
/*     */     
/* 172 */     String path = dir + "mzm.gsp.qingyunzhi.confbean.STQingYunZhiCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 199 */           STQingYunZhiCfg _v_ = new STQingYunZhiCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, STQingYunZhiCfg> all)
/*     */   {
/* 219 */     String path = dir + "mzm.gsp.qingyunzhi.confbean.STQingYunZhiCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 246 */           STQingYunZhiCfg _v_ = new STQingYunZhiCfg();
...
/*     */ 
/*     */ 
/*     */   public static STQingYunZhiCfg getOld(int key)
/*     */   {
/* 267 */     return (STQingYunZhiCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static STQingYunZhiCfg get(int key)
/*     */   {
/* 272 */     return (STQingYunZhiCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, STQingYunZhiCfg> getOldAll()
/*     */   {
/* 277 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, STQingYunZhiCfg> getAll()
/*     */   {
/* 282 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, STQingYunZhiCfg> newAll)
/*     */   {
/* 287 */     oldAll = all;
/* 288 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\qingyunzhi\confbean\STQingYunZhiCfg.class
