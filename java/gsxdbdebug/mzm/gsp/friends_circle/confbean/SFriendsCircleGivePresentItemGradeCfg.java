...
/*     */ 
/*     */ public class SFriendsCircleGivePresentItemGradeCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SFriendsCircleGivePresentItemGradeCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SFriendsCircleGivePresentItemGradeCfg> all = null;
/*     */   
/*     */   public int item_cfg_id;
/*  19 */   public HashMap<Integer, Integer> grade_map = new HashMap();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.item_cfg_id = Integer.valueOf(rootElement.attributeValue("item_cfg_id")).intValue();
/*     */     
/*  25 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "grade_map");
...
/*     */         }
/*     */         
/*  76 */         this.grade_map.put(Integer.valueOf(_k_), Integer.valueOf(_v_));
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*     */   {
/*  83 */     _os_.marshal(this.item_cfg_id);
/*  84 */     _os_.compact_uint32(this.grade_map.size());
/*  85 */     for (java.util.Map.Entry<Integer, Integer> _e_ : this.grade_map.entrySet())
/*     */     {
...
/*     */   {
/*  95 */     this.item_cfg_id = _os_.unmarshal_int();
...
/* 102 */       this.grade_map.put(Integer.valueOf(_k_), Integer.valueOf(_v_));
/*     */     }
/* 104 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/* 109 */     String path = dir + "mzm.gsp.friends_circle.confbean.SFriendsCircleGivePresentItemGradeCfg.xml";
/*     */     
/*     */     try
/*     */     {
/* 113 */       all = new HashMap();
...
/* 122 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.friends_circle.confbean.SFriendsCircleGivePresentItemGradeCfg"))
/*     */         {
/*     */ 
/* 125 */           SFriendsCircleGivePresentItemGradeCfg obj = new SFriendsCircleGivePresentItemGradeCfg();
/* 126 */           obj.loadFromXml(elem);
/* 127 */           if (all.put(Integer.valueOf(obj.item_cfg_id), obj) != null) {
/* 128 */             throw new RuntimeException("duplicate key : " + obj.item_cfg_id);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SFriendsCircleGivePresentItemGradeCfg> all)
/*     */   {
/* 139 */     String path = dir + "mzm.gsp.friends_circle.confbean.SFriendsCircleGivePresentItemGradeCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 151 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.friends_circle.confbean.SFriendsCircleGivePresentItemGradeCfg"))
/*     */         {
/*     */ 
/* 154 */           SFriendsCircleGivePresentItemGradeCfg obj = new SFriendsCircleGivePresentItemGradeCfg();
/* 155 */           obj.loadFromXml(elem);
/* 156 */           if (all.put(Integer.valueOf(obj.item_cfg_id), obj) != null) {
/* 157 */             throw new RuntimeException("duplicate key : " + obj.item_cfg_id);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/* 168 */     all = new HashMap();
/*     */     
/* 170 */     String path = dir + "mzm.gsp.friends_circle.confbean.SFriendsCircleGivePresentItemGradeCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 197 */           SFriendsCircleGivePresentItemGradeCfg _v_ = new SFriendsCircleGivePresentItemGradeCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SFriendsCircleGivePresentItemGradeCfg> all)
/*     */   {
/* 217 */     String path = dir + "mzm.gsp.friends_circle.confbean.SFriendsCircleGivePresentItemGradeCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 244 */           SFriendsCircleGivePresentItemGradeCfg _v_ = new SFriendsCircleGivePresentItemGradeCfg();
...
/*     */ 
/*     */ 
/*     */   public static SFriendsCircleGivePresentItemGradeCfg getOld(int key)
/*     */   {
/* 265 */     return (SFriendsCircleGivePresentItemGradeCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SFriendsCircleGivePresentItemGradeCfg get(int key)
/*     */   {
/* 270 */     return (SFriendsCircleGivePresentItemGradeCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SFriendsCircleGivePresentItemGradeCfg> getOldAll()
/*     */   {
/* 275 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SFriendsCircleGivePresentItemGradeCfg> getAll()
/*     */   {
/* 280 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SFriendsCircleGivePresentItemGradeCfg> newAll)
/*     */   {
/* 285 */     oldAll = all;
/* 286 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\friends_circle\confbean\SFriendsCircleGivePresentItemGradeCfg.class
