...
/*     */ 
/*     */ public class SConstellationCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SConstellationCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SConstellationCfg> all = null;
/*     */   
/*     */   public int constellation;
/*  19 */   public java.util.ArrayList<String> fortunes = new java.util.ArrayList();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.constellation = Integer.valueOf(rootElement.attributeValue("constellation")).intValue();
/*     */     
/*  25 */     Element collectionElement = util.XmlHelper.getVariableElement(rootElement, "fortunes");
...
/*  36 */       if (elem.getName().equalsIgnoreCase("string"))
/*     */       {
/*     */         String _v_;
/*     */         
/*     */ 
...
/*     */   {
/*  57 */     _os_.marshal(this.constellation);
/*  58 */     _os_.compact_uint32(this.fortunes.size());
/*  59 */     for (String _v_ : this.fortunes)
/*     */     {
/*  61 */       _os_.marshal(_v_, "UTF-8");
/*     */     }
/*  63 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/*  68 */     this.constellation = _os_.unmarshal_int();
/*  69 */     for (int _size_ = _os_.uncompact_uint32(); _size_ > 0; _size_--)
/*     */     {
/*     */ 
/*  72 */       String _v_ = _os_.unmarshal_String("UTF-8");
/*  73 */       this.fortunes.add(_v_);
/*     */     }
/*  75 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/*  80 */     String path = dir + "mzm.gsp.constellation.confbean.SConstellationCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.constellation.confbean.SConstellationCfg"))
/*     */         {
/*     */ 
/*  96 */           SConstellationCfg obj = new SConstellationCfg();
/*  97 */           obj.loadFromXml(elem);
/*  98 */           if (all.put(Integer.valueOf(obj.constellation), obj) != null) {
/*  99 */             throw new RuntimeException("duplicate key : " + obj.constellation);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SConstellationCfg> all)
/*     */   {
/* 110 */     String path = dir + "mzm.gsp.constellation.confbean.SConstellationCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 122 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.constellation.confbean.SConstellationCfg"))
/*     */         {
/*     */ 
/* 125 */           SConstellationCfg obj = new SConstellationCfg();
/* 126 */           obj.loadFromXml(elem);
/* 127 */           if (all.put(Integer.valueOf(obj.constellation), obj) != null) {
/* 128 */             throw new RuntimeException("duplicate key : " + obj.constellation);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 141 */     String path = dir + "mzm.gsp.constellation.confbean.SConstellationCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 168 */           SConstellationCfg _v_ = new SConstellationCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SConstellationCfg> all)
/*     */   {
/* 188 */     String path = dir + "mzm.gsp.constellation.confbean.SConstellationCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 215 */           SConstellationCfg _v_ = new SConstellationCfg();
...
/*     */ 
/*     */ 
/*     */   public static SConstellationCfg getOld(int key)
/*     */   {
/* 236 */     return (SConstellationCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SConstellationCfg get(int key)
/*     */   {
/* 241 */     return (SConstellationCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SConstellationCfg> getOldAll()
/*     */   {
/* 246 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SConstellationCfg> getAll()
/*     */   {
/* 251 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SConstellationCfg> newAll)
/*     */   {
/* 256 */     oldAll = all;
/* 257 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\constellation\confbean\SConstellationCfg.class
