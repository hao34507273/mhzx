...
/*    */ 
/*    */ public class SCreateInfo implements com.goldhuman.Common.Marshal.Marshal
/*    */ {
/*  9 */   public HashMap<Integer, SCreateCostInfo> createItemId2CreateCostInfo = new HashMap();
/*    */   
/*    */ 
/*    */   public void loadFromXml(Element rootElement)
/*    */   {
/* 14 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "createItemId2CreateCostInfo");
...
/* 40 */             keyElem = elem;
/*    */           }
/* 42 */           else if ((valueElem == null) && (elem.getName().equalsIgnoreCase("mzm.gsp.midautumnholiday.confbean.SCreateCostInfo")))
/*    */           {
/* 44 */             valueElem = elem;
/*    */           }
/*    */         }
...
/*    */         }
/*    */         
/* 66 */         this.createItemId2CreateCostInfo.put(Integer.valueOf(_k_), _v_);
/*    */       }
/*    */     }
/*    */   }
/*    */   
...
/*    */   {
/* 73 */     _os_.compact_uint32(this.createItemId2CreateCostInfo.size());
/* 74 */     for (java.util.Map.Entry<Integer, SCreateCostInfo> _e_ : this.createItemId2CreateCostInfo.entrySet())
/*    */     {
...
/*    */       
/* 89 */       SCreateCostInfo _v_ = new SCreateCostInfo();
/* 90 */       _v_.unmarshal(_os_);
/* 91 */       this.createItemId2CreateCostInfo.put(Integer.valueOf(_k_), _v_);
/*    */     }
/* 93 */     return _os_;
/*    */   }
/*    */ }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\midautumnholiday\confbean\SCreateInfo.class
