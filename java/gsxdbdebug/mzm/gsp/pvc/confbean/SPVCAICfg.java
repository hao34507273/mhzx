...
/*     */ 
/*     */ public class SPVCAICfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SPVCAICfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SPVCAICfg> all = null;
/*     */   
...
/*  24 */     this.aiName = rootElement.attributeValue("aiName");
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  29 */     _os_.marshal(this.occupation);
/*  30 */     _os_.marshal(this.aiName, "UTF-8");
/*  31 */     return _os_;
/*     */   }
/*     */   
...
/*  37 */     this.aiName = _os_.unmarshal_String("UTF-8");
/*  38 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.pvc.confbean.SPVCAICfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.pvc.confbean.SPVCAICfg"))
/*     */         {
/*     */ 
/*  59 */           SPVCAICfg obj = new SPVCAICfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SPVCAICfg> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.pvc.confbean.SPVCAICfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.pvc.confbean.SPVCAICfg"))
/*     */         {
/*     */ 
/*  88 */           SPVCAICfg obj = new SPVCAICfg();
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.pvc.confbean.SPVCAICfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           SPVCAICfg _v_ = new SPVCAICfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SPVCAICfg> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.pvc.confbean.SPVCAICfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           SPVCAICfg _v_ = new SPVCAICfg();
...
/*     */ 
/*     */ 
/*     */   public static SPVCAICfg getOld(int key)
/*     */   {
/* 199 */     return (SPVCAICfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SPVCAICfg get(int key)
/*     */   {
/* 204 */     return (SPVCAICfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPVCAICfg> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPVCAICfg> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SPVCAICfg> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\pvc\confbean\SPVCAICfg.class
