...
/*     */ 
/*     */ public class SPVCCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SPVCCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SPVCCfg> all = null;
/*     */   
/*     */   public int id;
/*  19 */   public HashMap<Integer, Integer> proRateMap = new HashMap();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.id = Integer.valueOf(rootElement.attributeValue("id")).intValue();
/*     */     
/*  25 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "proRateMap");
...
/*     */         }
/*     */         
/*  76 */         this.proRateMap.put(Integer.valueOf(_k_), Integer.valueOf(_v_));
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*  84 */     _os_.compact_uint32(this.proRateMap.size());
/*  85 */     for (java.util.Map.Entry<Integer, Integer> _e_ : this.proRateMap.entrySet())
/*     */     {
...
/* 102 */       this.proRateMap.put(Integer.valueOf(_k_), Integer.valueOf(_v_));
/*     */     }
/* 104 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/* 109 */     String path = dir + "mzm.gsp.pvc.confbean.SPVCCfg.xml";
/*     */     
/*     */     try
/*     */     {
/* 113 */       all = new HashMap();
...
/* 122 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.pvc.confbean.SPVCCfg"))
/*     */         {
/*     */ 
/* 125 */           SPVCCfg obj = new SPVCCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SPVCCfg> all)
/*     */   {
/* 139 */     String path = dir + "mzm.gsp.pvc.confbean.SPVCCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 151 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.pvc.confbean.SPVCCfg"))
/*     */         {
/*     */ 
/* 154 */           SPVCCfg obj = new SPVCCfg();
...
/* 168 */     all = new HashMap();
/*     */     
/* 170 */     String path = dir + "mzm.gsp.pvc.confbean.SPVCCfg.bny";
/*     */     try
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SPVCCfg> all)
/*     */   {
/* 217 */     String path = dir + "mzm.gsp.pvc.confbean.SPVCCfg.bny";
/*     */     try
/*     */     {
...
/*     */ 
/*     */ 
/*     */   public static SPVCCfg getOld(int key)
/*     */   {
/* 265 */     return (SPVCCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SPVCCfg get(int key)
/*     */   {
/* 270 */     return (SPVCCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPVCCfg> getOldAll()
/*     */   {
/* 275 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPVCCfg> getAll()
/*     */   {
/* 280 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SPVCCfg> newAll)
/*     */   {
/* 285 */     oldAll = all;
/* 286 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\pvc\confbean\SPVCCfg.class
