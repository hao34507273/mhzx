...
/*     */ 
/*     */ public class SXiaoHuiKuaiPaoGridWeightCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SXiaoHuiKuaiPaoGridWeightCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SXiaoHuiKuaiPaoGridWeightCfg> all = null;
/*     */   
/*     */   public int id;
...
/*  29 */     this.itemWeight = Integer.valueOf(rootElement.attributeValue("itemWeight")).intValue();
/*  30 */     this.yuanBaoWeight = Integer.valueOf(rootElement.attributeValue("yuanBaoWeight")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  35 */     _os_.marshal(this.id);
/*  36 */     _os_.marshal(this.activityId);
/*  37 */     _os_.marshal(this.index);
/*  38 */     _os_.marshal(this.itemWeight);
/*  39 */     _os_.marshal(this.yuanBaoWeight);
/*  40 */     return _os_;
/*     */   }
/*     */   
...
/*  46 */     this.activityId = _os_.unmarshal_int();
/*  47 */     this.index = _os_.unmarshal_int();
/*  48 */     this.itemWeight = _os_.unmarshal_int();
/*  49 */     this.yuanBaoWeight = _os_.unmarshal_int();
/*  50 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  55 */     String path = dir + "mzm.gsp.xiaohuikuaipao.confbean.SXiaoHuiKuaiPaoGridWeightCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  68 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.xiaohuikuaipao.confbean.SXiaoHuiKuaiPaoGridWeightCfg"))
/*     */         {
/*     */ 
/*  71 */           SXiaoHuiKuaiPaoGridWeightCfg obj = new SXiaoHuiKuaiPaoGridWeightCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SXiaoHuiKuaiPaoGridWeightCfg> all)
/*     */   {
/*  85 */     String path = dir + "mzm.gsp.xiaohuikuaipao.confbean.SXiaoHuiKuaiPaoGridWeightCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  97 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.xiaohuikuaipao.confbean.SXiaoHuiKuaiPaoGridWeightCfg"))
/*     */         {
/*     */ 
/* 100 */           SXiaoHuiKuaiPaoGridWeightCfg obj = new SXiaoHuiKuaiPaoGridWeightCfg();
...
/*     */     
/* 116 */     String path = dir + "mzm.gsp.xiaohuikuaipao.confbean.SXiaoHuiKuaiPaoGridWeightCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 143 */           SXiaoHuiKuaiPaoGridWeightCfg _v_ = new SXiaoHuiKuaiPaoGridWeightCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SXiaoHuiKuaiPaoGridWeightCfg> all)
/*     */   {
/* 163 */     String path = dir + "mzm.gsp.xiaohuikuaipao.confbean.SXiaoHuiKuaiPaoGridWeightCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 190 */           SXiaoHuiKuaiPaoGridWeightCfg _v_ = new SXiaoHuiKuaiPaoGridWeightCfg();
...
/*     */ 
/*     */ 
/*     */   public static SXiaoHuiKuaiPaoGridWeightCfg getOld(int key)
/*     */   {
/* 211 */     return (SXiaoHuiKuaiPaoGridWeightCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SXiaoHuiKuaiPaoGridWeightCfg get(int key)
/*     */   {
/* 216 */     return (SXiaoHuiKuaiPaoGridWeightCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SXiaoHuiKuaiPaoGridWeightCfg> getOldAll()
/*     */   {
/* 221 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SXiaoHuiKuaiPaoGridWeightCfg> getAll()
/*     */   {
/* 226 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SXiaoHuiKuaiPaoGridWeightCfg> newAll)
/*     */   {
/* 231 */     oldAll = all;
/* 232 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\xiaohuikuaipao\confbean\SXiaoHuiKuaiPaoGridWeightCfg.class
