...
/*     */ 
/*     */ public class XiaoHuiKuaiPaoInnerModelCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, XiaoHuiKuaiPaoInnerModelCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, XiaoHuiKuaiPaoInnerModelCfg> all = null;
/*     */   
/*     */   public int id;
...
/*  30 */     this.modelId = Integer.valueOf(rootElement.attributeValue("modelId")).intValue();
/*  31 */     this.scale = Integer.valueOf(rootElement.attributeValue("scale")).intValue();
/*  32 */     this.modelAngle = Integer.valueOf(rootElement.attributeValue("modelAngle")).intValue();
/*     */   }
/*     */   
...
/*  39 */     _os_.marshal(this.itemId);
/*  40 */     _os_.marshal(this.modelId);
/*  41 */     _os_.marshal(this.scale);
/*  42 */     _os_.marshal(this.modelAngle);
/*  43 */     return _os_;
/*     */   }
/*     */   
...
/*  51 */     this.modelId = _os_.unmarshal_int();
/*  52 */     this.scale = _os_.unmarshal_int();
/*  53 */     this.modelAngle = _os_.unmarshal_int();
/*  54 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  59 */     String path = dir + "mzm.gsp.xiaohuikuaipao.confbean.XiaoHuiKuaiPaoInnerModelCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  72 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.xiaohuikuaipao.confbean.XiaoHuiKuaiPaoInnerModelCfg"))
/*     */         {
/*     */ 
/*  75 */           XiaoHuiKuaiPaoInnerModelCfg obj = new XiaoHuiKuaiPaoInnerModelCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, XiaoHuiKuaiPaoInnerModelCfg> all)
/*     */   {
/*  89 */     String path = dir + "mzm.gsp.xiaohuikuaipao.confbean.XiaoHuiKuaiPaoInnerModelCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 101 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.xiaohuikuaipao.confbean.XiaoHuiKuaiPaoInnerModelCfg"))
/*     */         {
/*     */ 
/* 104 */           XiaoHuiKuaiPaoInnerModelCfg obj = new XiaoHuiKuaiPaoInnerModelCfg();
...
/*     */     
/* 120 */     String path = dir + "mzm.gsp.xiaohuikuaipao.confbean.XiaoHuiKuaiPaoInnerModelCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 147 */           XiaoHuiKuaiPaoInnerModelCfg _v_ = new XiaoHuiKuaiPaoInnerModelCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, XiaoHuiKuaiPaoInnerModelCfg> all)
/*     */   {
/* 167 */     String path = dir + "mzm.gsp.xiaohuikuaipao.confbean.XiaoHuiKuaiPaoInnerModelCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 194 */           XiaoHuiKuaiPaoInnerModelCfg _v_ = new XiaoHuiKuaiPaoInnerModelCfg();
...
/*     */ 
/*     */ 
/*     */   public static XiaoHuiKuaiPaoInnerModelCfg getOld(int key)
/*     */   {
/* 215 */     return (XiaoHuiKuaiPaoInnerModelCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static XiaoHuiKuaiPaoInnerModelCfg get(int key)
/*     */   {
/* 220 */     return (XiaoHuiKuaiPaoInnerModelCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, XiaoHuiKuaiPaoInnerModelCfg> getOldAll()
/*     */   {
/* 225 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, XiaoHuiKuaiPaoInnerModelCfg> getAll()
/*     */   {
/* 230 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, XiaoHuiKuaiPaoInnerModelCfg> newAll)
/*     */   {
/* 235 */     oldAll = all;
/* 236 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\xiaohuikuaipao\confbean\XiaoHuiKuaiPaoInnerModelCfg.class
