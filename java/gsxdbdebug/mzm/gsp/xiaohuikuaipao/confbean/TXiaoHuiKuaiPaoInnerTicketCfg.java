...
/*     */ 
/*     */ public class TXiaoHuiKuaiPaoInnerTicketCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, TXiaoHuiKuaiPaoInnerTicketCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, TXiaoHuiKuaiPaoInnerTicketCfg> all = null;
/*     */   
/*     */   public int activityId;
/*  19 */   public TreeMap<Integer, XiaoHuiKuaiPaoInnerTicketInfo> accTurnCount2innerTicketInfo = new TreeMap();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.activityId = Integer.valueOf(rootElement.attributeValue("activityId")).intValue();
/*     */     
/*  25 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "accTurnCount2innerTicketInfo");
...
/*  51 */             keyElem = elem;
/*     */           }
/*  53 */           else if ((valueElem == null) && (elem.getName().equalsIgnoreCase("mzm.gsp.xiaohuikuaipao.confbean.XiaoHuiKuaiPaoInnerTicketInfo")))
/*     */           {
/*  55 */             valueElem = elem;
/*     */           }
/*     */         }
...
/*     */         
/*     */         int _k_;
/*     */         XiaoHuiKuaiPaoInnerTicketInfo _v_;
/*     */         try
/*     */         {
/*  68 */           _k_ = Integer.valueOf(keyElem.getText()).intValue();
/*  69 */           _v_ = new XiaoHuiKuaiPaoInnerTicketInfo();
...
/*     */         }
/*     */         
/*  77 */         this.accTurnCount2innerTicketInfo.put(Integer.valueOf(_k_), _v_);
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*     */   {
/*  84 */     _os_.marshal(this.activityId);
/*  85 */     _os_.compact_uint32(this.accTurnCount2innerTicketInfo.size());
/*  86 */     for (java.util.Map.Entry<Integer, XiaoHuiKuaiPaoInnerTicketInfo> _e_ : this.accTurnCount2innerTicketInfo.entrySet())
/*     */     {
...
/*     */   {
/*  96 */     this.activityId = _os_.unmarshal_int();
/*  97 */     for (int _size_ = _os_.uncompact_uint32(); _size_ > 0; _size_--)
/*     */     {
/*     */ 
/* 100 */       int _k_ = _os_.unmarshal_int();
/*     */       
/* 102 */       XiaoHuiKuaiPaoInnerTicketInfo _v_ = new XiaoHuiKuaiPaoInnerTicketInfo();
/* 103 */       _v_.unmarshal(_os_);
/* 104 */       this.accTurnCount2innerTicketInfo.put(Integer.valueOf(_k_), _v_);
/*     */     }
/* 106 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/* 111 */     String path = dir + "mzm.gsp.xiaohuikuaipao.confbean.TXiaoHuiKuaiPaoInnerTicketCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 124 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.xiaohuikuaipao.confbean.TXiaoHuiKuaiPaoInnerTicketCfg"))
/*     */         {
/*     */ 
/* 127 */           TXiaoHuiKuaiPaoInnerTicketCfg obj = new TXiaoHuiKuaiPaoInnerTicketCfg();
/* 128 */           obj.loadFromXml(elem);
/* 129 */           if (all.put(Integer.valueOf(obj.activityId), obj) != null) {
/* 130 */             throw new RuntimeException("duplicate key : " + obj.activityId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, TXiaoHuiKuaiPaoInnerTicketCfg> all)
/*     */   {
/* 141 */     String path = dir + "mzm.gsp.xiaohuikuaipao.confbean.TXiaoHuiKuaiPaoInnerTicketCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 153 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.xiaohuikuaipao.confbean.TXiaoHuiKuaiPaoInnerTicketCfg"))
/*     */         {
/*     */ 
/* 156 */           TXiaoHuiKuaiPaoInnerTicketCfg obj = new TXiaoHuiKuaiPaoInnerTicketCfg();
/* 157 */           obj.loadFromXml(elem);
/* 158 */           if (all.put(Integer.valueOf(obj.activityId), obj) != null) {
/* 159 */             throw new RuntimeException("duplicate key : " + obj.activityId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 172 */     String path = dir + "mzm.gsp.xiaohuikuaipao.confbean.TXiaoHuiKuaiPaoInnerTicketCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 199 */           TXiaoHuiKuaiPaoInnerTicketCfg _v_ = new TXiaoHuiKuaiPaoInnerTicketCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, TXiaoHuiKuaiPaoInnerTicketCfg> all)
/*     */   {
/* 219 */     String path = dir + "mzm.gsp.xiaohuikuaipao.confbean.TXiaoHuiKuaiPaoInnerTicketCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 246 */           TXiaoHuiKuaiPaoInnerTicketCfg _v_ = new TXiaoHuiKuaiPaoInnerTicketCfg();
...
/*     */ 
/*     */ 
/*     */   public static TXiaoHuiKuaiPaoInnerTicketCfg getOld(int key)
/*     */   {
/* 267 */     return (TXiaoHuiKuaiPaoInnerTicketCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static TXiaoHuiKuaiPaoInnerTicketCfg get(int key)
/*     */   {
/* 272 */     return (TXiaoHuiKuaiPaoInnerTicketCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, TXiaoHuiKuaiPaoInnerTicketCfg> getOldAll()
/*     */   {
/* 277 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, TXiaoHuiKuaiPaoInnerTicketCfg> getAll()
/*     */   {
/* 282 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, TXiaoHuiKuaiPaoInnerTicketCfg> newAll)
/*     */   {
/* 287 */     oldAll = all;
/* 288 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\xiaohuikuaipao\confbean\TXiaoHuiKuaiPaoInnerTicketCfg.class
