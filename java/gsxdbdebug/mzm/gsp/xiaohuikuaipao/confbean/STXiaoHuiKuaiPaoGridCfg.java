...
/*     */ 
/*     */ public class STXiaoHuiKuaiPaoGridCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, STXiaoHuiKuaiPaoGridCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, STXiaoHuiKuaiPaoGridCfg> all = null;
/*     */   
/*     */   public int activityId;
/*  19 */   public TreeMap<Integer, SXiaoHuiKuaiPaoGridInfo> index2gridInfo = new TreeMap();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.activityId = Integer.valueOf(rootElement.attributeValue("activityId")).intValue();
/*     */     
/*  25 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "index2gridInfo");
...
/*  51 */             keyElem = elem;
/*     */           }
/*  53 */           else if ((valueElem == null) && (elem.getName().equalsIgnoreCase("mzm.gsp.xiaohuikuaipao.confbean.SXiaoHuiKuaiPaoGridInfo")))
/*     */           {
/*  55 */             valueElem = elem;
/*     */           }
/*     */         }
...
/*     */         
/*     */         int _k_;
/*     */         SXiaoHuiKuaiPaoGridInfo _v_;
/*     */         try
/*     */         {
/*  68 */           _k_ = Integer.valueOf(keyElem.getText()).intValue();
/*  69 */           _v_ = new SXiaoHuiKuaiPaoGridInfo();
...
/*     */         }
/*     */         
/*  77 */         this.index2gridInfo.put(Integer.valueOf(_k_), _v_);
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*  85 */     _os_.compact_uint32(this.index2gridInfo.size());
/*  86 */     for (java.util.Map.Entry<Integer, SXiaoHuiKuaiPaoGridInfo> _e_ : this.index2gridInfo.entrySet())
/*     */     {
...
/*     */       
/* 102 */       SXiaoHuiKuaiPaoGridInfo _v_ = new SXiaoHuiKuaiPaoGridInfo();
/* 103 */       _v_.unmarshal(_os_);
/* 104 */       this.index2gridInfo.put(Integer.valueOf(_k_), _v_);
/*     */     }
/* 106 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/* 111 */     String path = dir + "mzm.gsp.xiaohuikuaipao.confbean.STXiaoHuiKuaiPaoGridCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 124 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.xiaohuikuaipao.confbean.STXiaoHuiKuaiPaoGridCfg"))
/*     */         {
/*     */ 
/* 127 */           STXiaoHuiKuaiPaoGridCfg obj = new STXiaoHuiKuaiPaoGridCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, STXiaoHuiKuaiPaoGridCfg> all)
/*     */   {
/* 141 */     String path = dir + "mzm.gsp.xiaohuikuaipao.confbean.STXiaoHuiKuaiPaoGridCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 153 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.xiaohuikuaipao.confbean.STXiaoHuiKuaiPaoGridCfg"))
/*     */         {
/*     */ 
/* 156 */           STXiaoHuiKuaiPaoGridCfg obj = new STXiaoHuiKuaiPaoGridCfg();
...
/*     */     
/* 172 */     String path = dir + "mzm.gsp.xiaohuikuaipao.confbean.STXiaoHuiKuaiPaoGridCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 199 */           STXiaoHuiKuaiPaoGridCfg _v_ = new STXiaoHuiKuaiPaoGridCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, STXiaoHuiKuaiPaoGridCfg> all)
/*     */   {
/* 219 */     String path = dir + "mzm.gsp.xiaohuikuaipao.confbean.STXiaoHuiKuaiPaoGridCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 246 */           STXiaoHuiKuaiPaoGridCfg _v_ = new STXiaoHuiKuaiPaoGridCfg();
...
/*     */ 
/*     */ 
/*     */   public static STXiaoHuiKuaiPaoGridCfg getOld(int key)
/*     */   {
/* 267 */     return (STXiaoHuiKuaiPaoGridCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static STXiaoHuiKuaiPaoGridCfg get(int key)
/*     */   {
/* 272 */     return (STXiaoHuiKuaiPaoGridCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, STXiaoHuiKuaiPaoGridCfg> getOldAll()
/*     */   {
/* 277 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, STXiaoHuiKuaiPaoGridCfg> getAll()
/*     */   {
/* 282 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, STXiaoHuiKuaiPaoGridCfg> newAll)
/*     */   {
/* 287 */     oldAll = all;
/* 288 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\xiaohuikuaipao\confbean\STXiaoHuiKuaiPaoGridCfg.class
