...
/*     */ 
/*     */ public class XiaoHuiKuaiPaoInnerTicketCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, XiaoHuiKuaiPaoInnerTicketCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, XiaoHuiKuaiPaoInnerTicketCfg> all = null;
/*     */   
/*     */   public int id;
...
/*  27 */     this.accumulateTurnCount = Integer.valueOf(rootElement.attributeValue("accumulateTurnCount")).intValue();
/*  28 */     this.ticketCount = Integer.valueOf(rootElement.attributeValue("ticketCount")).intValue();
/*     */   }
/*     */   
...
/*  35 */     _os_.marshal(this.accumulateTurnCount);
/*  36 */     _os_.marshal(this.ticketCount);
/*  37 */     return _os_;
/*     */   }
/*     */   
...
/*  44 */     this.accumulateTurnCount = _os_.unmarshal_int();
/*  45 */     this.ticketCount = _os_.unmarshal_int();
/*  46 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  51 */     String path = dir + "mzm.gsp.xiaohuikuaipao.confbean.XiaoHuiKuaiPaoInnerTicketCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  64 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.xiaohuikuaipao.confbean.XiaoHuiKuaiPaoInnerTicketCfg"))
/*     */         {
/*     */ 
/*  67 */           XiaoHuiKuaiPaoInnerTicketCfg obj = new XiaoHuiKuaiPaoInnerTicketCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, XiaoHuiKuaiPaoInnerTicketCfg> all)
/*     */   {
/*  81 */     String path = dir + "mzm.gsp.xiaohuikuaipao.confbean.XiaoHuiKuaiPaoInnerTicketCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.xiaohuikuaipao.confbean.XiaoHuiKuaiPaoInnerTicketCfg"))
/*     */         {
/*     */ 
/*  96 */           XiaoHuiKuaiPaoInnerTicketCfg obj = new XiaoHuiKuaiPaoInnerTicketCfg();
...
/*     */     
/* 112 */     String path = dir + "mzm.gsp.xiaohuikuaipao.confbean.XiaoHuiKuaiPaoInnerTicketCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 139 */           XiaoHuiKuaiPaoInnerTicketCfg _v_ = new XiaoHuiKuaiPaoInnerTicketCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, XiaoHuiKuaiPaoInnerTicketCfg> all)
/*     */   {
/* 159 */     String path = dir + "mzm.gsp.xiaohuikuaipao.confbean.XiaoHuiKuaiPaoInnerTicketCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 186 */           XiaoHuiKuaiPaoInnerTicketCfg _v_ = new XiaoHuiKuaiPaoInnerTicketCfg();
...
/*     */ 
/*     */ 
/*     */   public static XiaoHuiKuaiPaoInnerTicketCfg getOld(int key)
/*     */   {
/* 207 */     return (XiaoHuiKuaiPaoInnerTicketCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static XiaoHuiKuaiPaoInnerTicketCfg get(int key)
/*     */   {
/* 212 */     return (XiaoHuiKuaiPaoInnerTicketCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, XiaoHuiKuaiPaoInnerTicketCfg> getOldAll()
/*     */   {
/* 217 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, XiaoHuiKuaiPaoInnerTicketCfg> getAll()
/*     */   {
/* 222 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, XiaoHuiKuaiPaoInnerTicketCfg> newAll)
/*     */   {
/* 227 */     oldAll = all;
/* 228 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\xiaohuikuaipao\confbean\XiaoHuiKuaiPaoInnerTicketCfg.class
