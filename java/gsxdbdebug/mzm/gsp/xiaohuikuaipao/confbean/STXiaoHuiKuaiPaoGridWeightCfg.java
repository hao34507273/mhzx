...
/*     */ 
/*     */ public class STXiaoHuiKuaiPaoGridWeightCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, STXiaoHuiKuaiPaoGridWeightCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, STXiaoHuiKuaiPaoGridWeightCfg> all = null;
/*     */   
/*     */   public int activityId;
/*  19 */   public TreeMap<Integer, SXiaoHuiKuaiPaoGridWeightInfo> index2gridWeightInfo = new TreeMap();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.activityId = Integer.valueOf(rootElement.attributeValue("activityId")).intValue();
/*     */     
/*  25 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "index2gridWeightInfo");
...
/*  51 */             keyElem = elem;
/*     */           }
/*  53 */           else if ((valueElem == null) && (elem.getName().equalsIgnoreCase("mzm.gsp.xiaohuikuaipao.confbean.SXiaoHuiKuaiPaoGridWeightInfo")))
/*     */           {
/*  55 */             valueElem = elem;
/*     */           }
/*     */         }
...
/*     */         
/*     */         int _k_;
/*     */         SXiaoHuiKuaiPaoGridWeightInfo _v_;
/*     */         try
/*     */         {
/*  68 */           _k_ = Integer.valueOf(keyElem.getText()).intValue();
/*  69 */           _v_ = new SXiaoHuiKuaiPaoGridWeightInfo();
...
/*     */         }
/*     */         
/*  77 */         this.index2gridWeightInfo.put(Integer.valueOf(_k_), _v_);
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*  85 */     _os_.compact_uint32(this.index2gridWeightInfo.size());
/*  86 */     for (java.util.Map.Entry<Integer, SXiaoHuiKuaiPaoGridWeightInfo> _e_ : this.index2gridWeightInfo.entrySet())
/*     */     {
...
/*     */       
/* 102 */       SXiaoHuiKuaiPaoGridWeightInfo _v_ = new SXiaoHuiKuaiPaoGridWeightInfo();
/* 103 */       _v_.unmarshal(_os_);
/* 104 */       this.index2gridWeightInfo.put(Integer.valueOf(_k_), _v_);
/*     */     }
/* 106 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/* 111 */     String path = dir + "mzm.gsp.xiaohuikuaipao.confbean.STXiaoHuiKuaiPaoGridWeightCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 124 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.xiaohuikuaipao.confbean.STXiaoHuiKuaiPaoGridWeightCfg"))
/*     */         {
/*     */ 
/* 127 */           STXiaoHuiKuaiPaoGridWeightCfg obj = new STXiaoHuiKuaiPaoGridWeightCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, STXiaoHuiKuaiPaoGridWeightCfg> all)
/*     */   {
/* 141 */     String path = dir + "mzm.gsp.xiaohuikuaipao.confbean.STXiaoHuiKuaiPaoGridWeightCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 153 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.xiaohuikuaipao.confbean.STXiaoHuiKuaiPaoGridWeightCfg"))
/*     */         {
/*     */ 
/* 156 */           STXiaoHuiKuaiPaoGridWeightCfg obj = new STXiaoHuiKuaiPaoGridWeightCfg();
...
/*     */     
/* 172 */     String path = dir + "mzm.gsp.xiaohuikuaipao.confbean.STXiaoHuiKuaiPaoGridWeightCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 199 */           STXiaoHuiKuaiPaoGridWeightCfg _v_ = new STXiaoHuiKuaiPaoGridWeightCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, STXiaoHuiKuaiPaoGridWeightCfg> all)
/*     */   {
/* 219 */     String path = dir + "mzm.gsp.xiaohuikuaipao.confbean.STXiaoHuiKuaiPaoGridWeightCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 246 */           STXiaoHuiKuaiPaoGridWeightCfg _v_ = new STXiaoHuiKuaiPaoGridWeightCfg();
...
/*     */ 
/*     */ 
/*     */   public static STXiaoHuiKuaiPaoGridWeightCfg getOld(int key)
/*     */   {
/* 267 */     return (STXiaoHuiKuaiPaoGridWeightCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static STXiaoHuiKuaiPaoGridWeightCfg get(int key)
/*     */   {
/* 272 */     return (STXiaoHuiKuaiPaoGridWeightCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, STXiaoHuiKuaiPaoGridWeightCfg> getOldAll()
/*     */   {
/* 277 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, STXiaoHuiKuaiPaoGridWeightCfg> getAll()
/*     */   {
/* 282 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, STXiaoHuiKuaiPaoGridWeightCfg> newAll)
/*     */   {
/* 287 */     oldAll = all;
/* 288 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\xiaohuikuaipao\confbean\STXiaoHuiKuaiPaoGridWeightCfg.class
