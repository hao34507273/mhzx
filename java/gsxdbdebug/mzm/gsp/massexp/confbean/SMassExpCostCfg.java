...
/*     */ 
/*     */ public class SMassExpCostCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SMassExpCostCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SMassExpCostCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public int minLevel;
/*     */   public int maxLevel;
...
/*  27 */     this.minLevel = Integer.valueOf(rootElement.attributeValue("minLevel")).intValue();
/*  28 */     this.maxLevel = Integer.valueOf(rootElement.attributeValue("maxLevel")).intValue();
/*  29 */     this.moneyType = Integer.valueOf(rootElement.attributeValue("moneyType")).intValue();
/*  30 */     this.cost = Integer.valueOf(rootElement.attributeValue("cost")).intValue();
/*     */   }
/*     */   
...
/*  37 */     _os_.marshal(this.maxLevel);
/*  38 */     _os_.marshal(this.moneyType);
/*  39 */     _os_.marshal(this.cost);
/*  40 */     return _os_;
/*     */   }
/*     */   
...
/*  46 */     this.minLevel = _os_.unmarshal_int();
/*  47 */     this.maxLevel = _os_.unmarshal_int();
/*  48 */     this.moneyType = _os_.unmarshal_int();
/*  49 */     this.cost = _os_.unmarshal_int();
/*  50 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  55 */     String path = dir + "mzm.gsp.massexp.confbean.SMassExpCostCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  68 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.massexp.confbean.SMassExpCostCfg"))
/*     */         {
/*     */ 
/*  71 */           SMassExpCostCfg obj = new SMassExpCostCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SMassExpCostCfg> all)
/*     */   {
/*  85 */     String path = dir + "mzm.gsp.massexp.confbean.SMassExpCostCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  97 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.massexp.confbean.SMassExpCostCfg"))
/*     */         {
/*     */ 
/* 100 */           SMassExpCostCfg obj = new SMassExpCostCfg();
...
/*     */     
/* 116 */     String path = dir + "mzm.gsp.massexp.confbean.SMassExpCostCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 143 */           SMassExpCostCfg _v_ = new SMassExpCostCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SMassExpCostCfg> all)
/*     */   {
/* 163 */     String path = dir + "mzm.gsp.massexp.confbean.SMassExpCostCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 190 */           SMassExpCostCfg _v_ = new SMassExpCostCfg();
...
/*     */ 
/*     */ 
/*     */   public static SMassExpCostCfg getOld(int key)
/*     */   {
/* 211 */     return (SMassExpCostCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SMassExpCostCfg get(int key)
/*     */   {
/* 216 */     return (SMassExpCostCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMassExpCostCfg> getOldAll()
/*     */   {
/* 221 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMassExpCostCfg> getAll()
/*     */   {
/* 226 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SMassExpCostCfg> newAll)
/*     */   {
/* 231 */     oldAll = all;
/* 232 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\massexp\confbean\SMassExpCostCfg.class
