...
/*     */ 
/*     */ public class SMassExpLevelModifierCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SMassExpLevelModifierCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SMassExpLevelModifierCfg> all = null;
/*     */   
...
/*  24 */     this.levelModifier = Integer.valueOf(rootElement.attributeValue("levelModifier")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  29 */     _os_.marshal(this.serverLevel);
/*  30 */     _os_.marshal(this.levelModifier);
/*  31 */     return _os_;
/*     */   }
/*     */   
/*     */   public OctetsStream unmarshal(OctetsStream _os_) throws com.goldhuman.Common.Marshal.MarshalException
/*     */   {
/*  36 */     this.serverLevel = _os_.unmarshal_int();
/*  37 */     this.levelModifier = _os_.unmarshal_int();
/*  38 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.massexp.confbean.SMassExpLevelModifierCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.massexp.confbean.SMassExpLevelModifierCfg"))
/*     */         {
/*     */ 
/*  59 */           SMassExpLevelModifierCfg obj = new SMassExpLevelModifierCfg();
/*  60 */           obj.loadFromXml(elem);
/*  61 */           if (all.put(Integer.valueOf(obj.serverLevel), obj) != null) {
/*  62 */             throw new RuntimeException("duplicate key : " + obj.serverLevel);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SMassExpLevelModifierCfg> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.massexp.confbean.SMassExpLevelModifierCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.massexp.confbean.SMassExpLevelModifierCfg"))
/*     */         {
/*     */ 
/*  88 */           SMassExpLevelModifierCfg obj = new SMassExpLevelModifierCfg();
/*  89 */           obj.loadFromXml(elem);
/*  90 */           if (all.put(Integer.valueOf(obj.serverLevel), obj) != null) {
/*  91 */             throw new RuntimeException("duplicate key : " + obj.serverLevel);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.massexp.confbean.SMassExpLevelModifierCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           SMassExpLevelModifierCfg _v_ = new SMassExpLevelModifierCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SMassExpLevelModifierCfg> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.massexp.confbean.SMassExpLevelModifierCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           SMassExpLevelModifierCfg _v_ = new SMassExpLevelModifierCfg();
...
/*     */ 
/*     */ 
/*     */   public static SMassExpLevelModifierCfg getOld(int key)
/*     */   {
/* 199 */     return (SMassExpLevelModifierCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SMassExpLevelModifierCfg get(int key)
/*     */   {
/* 204 */     return (SMassExpLevelModifierCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMassExpLevelModifierCfg> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMassExpLevelModifierCfg> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SMassExpLevelModifierCfg> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\massexp\confbean\SMassExpLevelModifierCfg.class
