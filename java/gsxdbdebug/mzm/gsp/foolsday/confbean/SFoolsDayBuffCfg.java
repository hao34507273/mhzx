...
/*     */ 
/*     */ public class SFoolsDayBuffCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SFoolsDayBuffCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SFoolsDayBuffCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public int buff_id;
...
/*  26 */     this.buff_id = Integer.valueOf(rootElement.attributeValue("buff_id")).intValue();
/*  27 */     this.probability = Integer.valueOf(rootElement.attributeValue("probability")).intValue();
/*  28 */     this.cost_vigor = Integer.valueOf(rootElement.attributeValue("cost_vigor")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  33 */     _os_.marshal(this.id);
/*  34 */     _os_.marshal(this.buff_id);
/*  35 */     _os_.marshal(this.probability);
/*  36 */     _os_.marshal(this.cost_vigor);
/*  37 */     return _os_;
/*     */   }
/*     */   
...
/*  43 */     this.buff_id = _os_.unmarshal_int();
/*  44 */     this.probability = _os_.unmarshal_int();
/*  45 */     this.cost_vigor = _os_.unmarshal_int();
/*  46 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  51 */     String path = dir + "mzm.gsp.foolsday.confbean.SFoolsDayBuffCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  64 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.foolsday.confbean.SFoolsDayBuffCfg"))
/*     */         {
/*     */ 
/*  67 */           SFoolsDayBuffCfg obj = new SFoolsDayBuffCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SFoolsDayBuffCfg> all)
/*     */   {
/*  81 */     String path = dir + "mzm.gsp.foolsday.confbean.SFoolsDayBuffCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.foolsday.confbean.SFoolsDayBuffCfg"))
/*     */         {
/*     */ 
/*  96 */           SFoolsDayBuffCfg obj = new SFoolsDayBuffCfg();
...
/*     */     
/* 112 */     String path = dir + "mzm.gsp.foolsday.confbean.SFoolsDayBuffCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 139 */           SFoolsDayBuffCfg _v_ = new SFoolsDayBuffCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SFoolsDayBuffCfg> all)
/*     */   {
/* 159 */     String path = dir + "mzm.gsp.foolsday.confbean.SFoolsDayBuffCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 186 */           SFoolsDayBuffCfg _v_ = new SFoolsDayBuffCfg();
...
/*     */ 
/*     */ 
/*     */   public static SFoolsDayBuffCfg getOld(int key)
/*     */   {
/* 207 */     return (SFoolsDayBuffCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SFoolsDayBuffCfg get(int key)
/*     */   {
/* 212 */     return (SFoolsDayBuffCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SFoolsDayBuffCfg> getOldAll()
/*     */   {
/* 217 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SFoolsDayBuffCfg> getAll()
/*     */   {
/* 222 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SFoolsDayBuffCfg> newAll)
/*     */   {
/* 227 */     oldAll = all;
/* 228 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\foolsday\confbean\SFoolsDayBuffCfg.class
