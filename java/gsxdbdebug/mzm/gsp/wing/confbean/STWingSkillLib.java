...
/*     */ 
/*     */ public class STWingSkillLib implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, STWingSkillLib> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, STWingSkillLib> all = null;
/*     */   
/*     */   public int skillInfoId;
/*     */   public int weightSum;
/*  20 */   public HashMap<Integer, Integer> skillInfos = new HashMap();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  24 */     this.skillInfoId = Integer.valueOf(rootElement.attributeValue("skillInfoId")).intValue();
/*  25 */     this.weightSum = Integer.valueOf(rootElement.attributeValue("weightSum")).intValue();
/*     */     
/*  27 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "skillInfos");
...
/*     */         }
/*     */         
/*  78 */         this.skillInfos.put(Integer.valueOf(_k_), Integer.valueOf(_v_));
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*     */   {
/*  85 */     _os_.marshal(this.skillInfoId);
/*  86 */     _os_.marshal(this.weightSum);
/*  87 */     _os_.compact_uint32(this.skillInfos.size());
/*  88 */     for (java.util.Map.Entry<Integer, Integer> _e_ : this.skillInfos.entrySet())
/*     */     {
...
/*     */   {
/*  98 */     this.skillInfoId = _os_.unmarshal_int();
...
/* 106 */       this.skillInfos.put(Integer.valueOf(_k_), Integer.valueOf(_v_));
/*     */     }
/* 108 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/* 113 */     String path = dir + "mzm.gsp.wing.confbean.STWingSkillLib.xml";
/*     */     
/*     */     try
/*     */     {
/* 117 */       all = new HashMap();
...
/* 126 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.wing.confbean.STWingSkillLib"))
/*     */         {
/*     */ 
/* 129 */           STWingSkillLib obj = new STWingSkillLib();
/* 130 */           obj.loadFromXml(elem);
/* 131 */           if (all.put(Integer.valueOf(obj.skillInfoId), obj) != null) {
/* 132 */             throw new RuntimeException("duplicate key : " + obj.skillInfoId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, STWingSkillLib> all)
/*     */   {
/* 143 */     String path = dir + "mzm.gsp.wing.confbean.STWingSkillLib.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 155 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.wing.confbean.STWingSkillLib"))
/*     */         {
/*     */ 
/* 158 */           STWingSkillLib obj = new STWingSkillLib();
/* 159 */           obj.loadFromXml(elem);
/* 160 */           if (all.put(Integer.valueOf(obj.skillInfoId), obj) != null) {
/* 161 */             throw new RuntimeException("duplicate key : " + obj.skillInfoId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/* 172 */     all = new HashMap();
/*     */     
/* 174 */     String path = dir + "mzm.gsp.wing.confbean.STWingSkillLib.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 201 */           STWingSkillLib _v_ = new STWingSkillLib();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, STWingSkillLib> all)
/*     */   {
/* 221 */     String path = dir + "mzm.gsp.wing.confbean.STWingSkillLib.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 248 */           STWingSkillLib _v_ = new STWingSkillLib();
...
/*     */ 
/*     */ 
/*     */   public static STWingSkillLib getOld(int key)
/*     */   {
/* 269 */     return (STWingSkillLib)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static STWingSkillLib get(int key)
/*     */   {
/* 274 */     return (STWingSkillLib)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, STWingSkillLib> getOldAll()
/*     */   {
/* 279 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, STWingSkillLib> getAll()
/*     */   {
/* 284 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, STWingSkillLib> newAll)
/*     */   {
/* 289 */     oldAll = all;
/* 290 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\wing\confbean\STWingSkillLib.class
