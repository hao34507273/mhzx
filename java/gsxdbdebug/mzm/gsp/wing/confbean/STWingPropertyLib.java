...
/*     */ 
/*     */ public class STWingPropertyLib implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, STWingPropertyLib> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, STWingPropertyLib> all = null;
/*     */   
/*     */   public int proInfoId;
/*  19 */   public java.util.ArrayList<STRanProInfos> ranInfos = new java.util.ArrayList();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.proInfoId = Integer.valueOf(rootElement.attributeValue("proInfoId")).intValue();
/*     */     
/*  25 */     Element collectionElement = util.XmlHelper.getVariableElement(rootElement, "ranInfos");
...
/*  36 */       if (elem.getName().equalsIgnoreCase("mzm.gsp.wing.confbean.STRanProInfos"))
/*     */       {
/*     */         STRanProInfos _v_;
/*     */         
/*     */ 
...
/*     */   {
/*  58 */     _os_.marshal(this.proInfoId);
/*  59 */     _os_.compact_uint32(this.ranInfos.size());
/*  60 */     for (STRanProInfos _v_ : this.ranInfos)
/*     */     {
/*  62 */       _os_.marshal(_v_);
/*     */     }
/*  64 */     return _os_;
...
/*     */   {
/*  69 */     this.proInfoId = _os_.unmarshal_int();
/*  70 */     for (int _size_ = _os_.uncompact_uint32(); _size_ > 0; _size_--)
/*     */     {
/*     */ 
/*  73 */       STRanProInfos _v_ = new STRanProInfos();
/*  74 */       _v_.unmarshal(_os_);
/*  75 */       this.ranInfos.add(_v_);
/*     */     }
/*  77 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/*  82 */     String path = dir + "mzm.gsp.wing.confbean.STWingPropertyLib.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  95 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.wing.confbean.STWingPropertyLib"))
/*     */         {
/*     */ 
/*  98 */           STWingPropertyLib obj = new STWingPropertyLib();
/*  99 */           obj.loadFromXml(elem);
/* 100 */           if (all.put(Integer.valueOf(obj.proInfoId), obj) != null) {
/* 101 */             throw new RuntimeException("duplicate key : " + obj.proInfoId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, STWingPropertyLib> all)
/*     */   {
/* 112 */     String path = dir + "mzm.gsp.wing.confbean.STWingPropertyLib.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 124 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.wing.confbean.STWingPropertyLib"))
/*     */         {
/*     */ 
/* 127 */           STWingPropertyLib obj = new STWingPropertyLib();
/* 128 */           obj.loadFromXml(elem);
/* 129 */           if (all.put(Integer.valueOf(obj.proInfoId), obj) != null) {
/* 130 */             throw new RuntimeException("duplicate key : " + obj.proInfoId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 143 */     String path = dir + "mzm.gsp.wing.confbean.STWingPropertyLib.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 170 */           STWingPropertyLib _v_ = new STWingPropertyLib();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, STWingPropertyLib> all)
/*     */   {
/* 190 */     String path = dir + "mzm.gsp.wing.confbean.STWingPropertyLib.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 217 */           STWingPropertyLib _v_ = new STWingPropertyLib();
...
/*     */ 
/*     */ 
/*     */   public static STWingPropertyLib getOld(int key)
/*     */   {
/* 238 */     return (STWingPropertyLib)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static STWingPropertyLib get(int key)
/*     */   {
/* 243 */     return (STWingPropertyLib)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, STWingPropertyLib> getOldAll()
/*     */   {
/* 248 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, STWingPropertyLib> getAll()
/*     */   {
/* 253 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, STWingPropertyLib> newAll)
/*     */   {
/* 258 */     oldAll = all;
/* 259 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\wing\confbean\STWingPropertyLib.class
