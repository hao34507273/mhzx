...
/*     */ 
/*     */ public class SWingLvUpCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SWingLvUpCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SWingLvUpCfg> all = null;
/*     */   
/*     */   public int level;
/*     */   public int id;
/*     */   public int needrank;
...
/*     */   {
/*  25 */     this.level = Integer.valueOf(rootElement.attributeValue("level")).intValue();
/*  26 */     this.id = Integer.valueOf(rootElement.attributeValue("id")).intValue();
/*  27 */     this.needrank = Integer.valueOf(rootElement.attributeValue("needrank")).intValue();
/*  28 */     this.needExp = Integer.valueOf(rootElement.attributeValue("needExp")).intValue();
/*     */   }
/*     */   
...
/*  35 */     _os_.marshal(this.needrank);
/*  36 */     _os_.marshal(this.needExp);
/*  37 */     return _os_;
/*     */   }
/*     */   
...
/*  44 */     this.needrank = _os_.unmarshal_int();
/*  45 */     this.needExp = _os_.unmarshal_int();
/*  46 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  51 */     String path = dir + "mzm.gsp.wing.confbean.SWingLvUpCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  64 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.wing.confbean.SWingLvUpCfg"))
/*     */         {
/*     */ 
/*  67 */           SWingLvUpCfg obj = new SWingLvUpCfg();
/*  68 */           obj.loadFromXml(elem);
/*  69 */           if (all.put(Integer.valueOf(obj.level), obj) != null) {
/*  70 */             throw new RuntimeException("duplicate key : " + obj.level);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SWingLvUpCfg> all)
/*     */   {
/*  81 */     String path = dir + "mzm.gsp.wing.confbean.SWingLvUpCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.wing.confbean.SWingLvUpCfg"))
/*     */         {
/*     */ 
/*  96 */           SWingLvUpCfg obj = new SWingLvUpCfg();
/*  97 */           obj.loadFromXml(elem);
/*  98 */           if (all.put(Integer.valueOf(obj.level), obj) != null) {
/*  99 */             throw new RuntimeException("duplicate key : " + obj.level);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 112 */     String path = dir + "mzm.gsp.wing.confbean.SWingLvUpCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 139 */           SWingLvUpCfg _v_ = new SWingLvUpCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SWingLvUpCfg> all)
/*     */   {
/* 159 */     String path = dir + "mzm.gsp.wing.confbean.SWingLvUpCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 186 */           SWingLvUpCfg _v_ = new SWingLvUpCfg();
...
/*     */ 
/*     */ 
/*     */   public static SWingLvUpCfg getOld(int key)
/*     */   {
/* 207 */     return (SWingLvUpCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SWingLvUpCfg get(int key)
/*     */   {
/* 212 */     return (SWingLvUpCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SWingLvUpCfg> getOldAll()
/*     */   {
/* 217 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SWingLvUpCfg> getAll()
/*     */   {
/* 222 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SWingLvUpCfg> newAll)
/*     */   {
/* 227 */     oldAll = all;
/* 228 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\wing\confbean\SWingLvUpCfg.class
