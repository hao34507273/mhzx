...
/*     */ 
/*     */ public class SWingPropertyLib implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SWingPropertyLib> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SWingPropertyLib> all = null;
/*     */   
/*     */   public int id;
/*     */   public int proInfoId;
/*  20 */   public java.util.ArrayList<RanProInfo> ranProInfos = new java.util.ArrayList();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  24 */     this.id = Integer.valueOf(rootElement.attributeValue("id")).intValue();
/*  25 */     this.proInfoId = Integer.valueOf(rootElement.attributeValue("proInfoId")).intValue();
/*     */     
/*  27 */     Element collectionElement = util.XmlHelper.getVariableElement(rootElement, "ranProInfos");
...
/*  38 */       if (elem.getName().equalsIgnoreCase("mzm.gsp.wing.confbean.RanProInfo"))
/*     */       {
/*     */         RanProInfo _v_;
/*     */         
/*     */ 
...
/*  61 */     _os_.marshal(this.proInfoId);
/*  62 */     _os_.compact_uint32(this.ranProInfos.size());
/*  63 */     for (RanProInfo _v_ : this.ranProInfos)
/*     */     {
/*  65 */       _os_.marshal(_v_);
/*     */     }
/*  67 */     return _os_;
...
/*  73 */     this.proInfoId = _os_.unmarshal_int();
/*  74 */     for (int _size_ = _os_.uncompact_uint32(); _size_ > 0; _size_--)
/*     */     {
/*     */ 
/*  77 */       RanProInfo _v_ = new RanProInfo();
/*  78 */       _v_.unmarshal(_os_);
/*  79 */       this.ranProInfos.add(_v_);
/*     */     }
/*  81 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/*  86 */     String path = dir + "mzm.gsp.wing.confbean.SWingPropertyLib.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  99 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.wing.confbean.SWingPropertyLib"))
/*     */         {
/*     */ 
/* 102 */           SWingPropertyLib obj = new SWingPropertyLib();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SWingPropertyLib> all)
/*     */   {
/* 116 */     String path = dir + "mzm.gsp.wing.confbean.SWingPropertyLib.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 128 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.wing.confbean.SWingPropertyLib"))
/*     */         {
/*     */ 
/* 131 */           SWingPropertyLib obj = new SWingPropertyLib();
...
/*     */     
/* 147 */     String path = dir + "mzm.gsp.wing.confbean.SWingPropertyLib.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 174 */           SWingPropertyLib _v_ = new SWingPropertyLib();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SWingPropertyLib> all)
/*     */   {
/* 194 */     String path = dir + "mzm.gsp.wing.confbean.SWingPropertyLib.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 221 */           SWingPropertyLib _v_ = new SWingPropertyLib();
...
/*     */ 
/*     */ 
/*     */   public static SWingPropertyLib getOld(int key)
/*     */   {
/* 242 */     return (SWingPropertyLib)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SWingPropertyLib get(int key)
/*     */   {
/* 247 */     return (SWingPropertyLib)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SWingPropertyLib> getOldAll()
/*     */   {
/* 252 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SWingPropertyLib> getAll()
/*     */   {
/* 257 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SWingPropertyLib> newAll)
/*     */   {
/* 262 */     oldAll = all;
/* 263 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\wing\confbean\SWingPropertyLib.class
