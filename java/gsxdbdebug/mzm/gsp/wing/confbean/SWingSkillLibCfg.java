...
/*     */ 
/*     */ public class SWingSkillLibCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SWingSkillLibCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SWingSkillLibCfg> all = null;
/*     */   
/*     */   public int id;
...
/*  26 */     this.skillLibId = Integer.valueOf(rootElement.attributeValue("skillLibId")).intValue();
...
/*  34 */     _os_.marshal(this.skillLibId);
...
/*  43 */     this.skillLibId = _os_.unmarshal_int();
...
/*     */   {
/*  51 */     String path = dir + "mzm.gsp.wing.confbean.SWingSkillLibCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  64 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.wing.confbean.SWingSkillLibCfg"))
/*     */         {
/*     */ 
/*  67 */           SWingSkillLibCfg obj = new SWingSkillLibCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SWingSkillLibCfg> all)
/*     */   {
/*  81 */     String path = dir + "mzm.gsp.wing.confbean.SWingSkillLibCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.wing.confbean.SWingSkillLibCfg"))
/*     */         {
/*     */ 
/*  96 */           SWingSkillLibCfg obj = new SWingSkillLibCfg();
...
/*     */     
/* 112 */     String path = dir + "mzm.gsp.wing.confbean.SWingSkillLibCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 139 */           SWingSkillLibCfg _v_ = new SWingSkillLibCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SWingSkillLibCfg> all)
/*     */   {
/* 159 */     String path = dir + "mzm.gsp.wing.confbean.SWingSkillLibCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 186 */           SWingSkillLibCfg _v_ = new SWingSkillLibCfg();
...
/*     */ 
/*     */ 
/*     */   public static SWingSkillLibCfg getOld(int key)
/*     */   {
/* 207 */     return (SWingSkillLibCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SWingSkillLibCfg get(int key)
/*     */   {
/* 212 */     return (SWingSkillLibCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SWingSkillLibCfg> getOldAll()
/*     */   {
/* 217 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SWingSkillLibCfg> getAll()
/*     */   {
/* 222 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SWingSkillLibCfg> newAll)
/*     */   {
/* 227 */     oldAll = all;
/* 228 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\wing\confbean\SWingSkillLibCfg.class
