...
/*     */ 
/*     */ public class STRank2Levels implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, STRank2Levels> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, STRank2Levels> all = null;
/*     */   
/*     */   public int rank;
/*  19 */   public java.util.ArrayList<Integer> levels = new java.util.ArrayList();
/*     */   
...
/*     */         }
/*     */         
/*  50 */         this.levels.add(Integer.valueOf(_v_));
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*  58 */     _os_.compact_uint32(this.levels.size());
/*  59 */     for (Integer _v_ : this.levels)
/*     */     {
...
/*  73 */       this.levels.add(Integer.valueOf(_v_));
/*     */     }
/*  75 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/*  80 */     String path = dir + "mzm.gsp.wing.confbean.STRank2Levels.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.wing.confbean.STRank2Levels"))
/*     */         {
/*     */ 
/*  96 */           STRank2Levels obj = new STRank2Levels();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, STRank2Levels> all)
/*     */   {
/* 110 */     String path = dir + "mzm.gsp.wing.confbean.STRank2Levels.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 122 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.wing.confbean.STRank2Levels"))
/*     */         {
/*     */ 
/* 125 */           STRank2Levels obj = new STRank2Levels();
...
/*     */     
/* 141 */     String path = dir + "mzm.gsp.wing.confbean.STRank2Levels.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 168 */           STRank2Levels _v_ = new STRank2Levels();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, STRank2Levels> all)
/*     */   {
/* 188 */     String path = dir + "mzm.gsp.wing.confbean.STRank2Levels.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 215 */           STRank2Levels _v_ = new STRank2Levels();
...
/*     */ 
/*     */ 
/*     */   public static STRank2Levels getOld(int key)
/*     */   {
/* 236 */     return (STRank2Levels)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static STRank2Levels get(int key)
/*     */   {
/* 241 */     return (STRank2Levels)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, STRank2Levels> getOldAll()
/*     */   {
/* 246 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, STRank2Levels> getAll()
/*     */   {
/* 251 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, STRank2Levels> newAll)
/*     */   {
/* 256 */     oldAll = all;
/* 257 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\wing\confbean\STRank2Levels.class
