...
/*     */ 
/*     */ public class SWingDyeLib implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SWingDyeLib> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SWingDyeLib> all = null;
/*     */   
/*     */   public int id;
/*  19 */   public java.util.ArrayList<WingDyeid2Rate> dyeids = new java.util.ArrayList();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.id = Integer.valueOf(rootElement.attributeValue("id")).intValue();
/*     */     
/*  25 */     Element collectionElement = util.XmlHelper.getVariableElement(rootElement, "dyeids");
...
/*  36 */       if (elem.getName().equalsIgnoreCase("mzm.gsp.wing.confbean.WingDyeid2Rate"))
/*     */       {
/*     */         WingDyeid2Rate _v_;
/*     */         
/*     */ 
...
/*  59 */     _os_.compact_uint32(this.dyeids.size());
/*  60 */     for (WingDyeid2Rate _v_ : this.dyeids)
/*     */     {
/*  62 */       _os_.marshal(_v_);
/*     */     }
/*  64 */     return _os_;
...
/*     */     {
/*     */ 
/*  73 */       WingDyeid2Rate _v_ = new WingDyeid2Rate();
/*  74 */       _v_.unmarshal(_os_);
/*  75 */       this.dyeids.add(_v_);
/*     */     }
/*  77 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/*  82 */     String path = dir + "mzm.gsp.wing.confbean.SWingDyeLib.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  95 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.wing.confbean.SWingDyeLib"))
/*     */         {
/*     */ 
/*  98 */           SWingDyeLib obj = new SWingDyeLib();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SWingDyeLib> all)
/*     */   {
/* 112 */     String path = dir + "mzm.gsp.wing.confbean.SWingDyeLib.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 124 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.wing.confbean.SWingDyeLib"))
/*     */         {
/*     */ 
/* 127 */           SWingDyeLib obj = new SWingDyeLib();
...
/*     */     
/* 143 */     String path = dir + "mzm.gsp.wing.confbean.SWingDyeLib.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 170 */           SWingDyeLib _v_ = new SWingDyeLib();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SWingDyeLib> all)
/*     */   {
/* 190 */     String path = dir + "mzm.gsp.wing.confbean.SWingDyeLib.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 217 */           SWingDyeLib _v_ = new SWingDyeLib();
...
/*     */ 
/*     */ 
/*     */   public static SWingDyeLib getOld(int key)
/*     */   {
/* 238 */     return (SWingDyeLib)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SWingDyeLib get(int key)
/*     */   {
/* 243 */     return (SWingDyeLib)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SWingDyeLib> getOldAll()
/*     */   {
/* 248 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SWingDyeLib> getAll()
/*     */   {
/* 253 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SWingDyeLib> newAll)
/*     */   {
/* 258 */     oldAll = all;
/* 259 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\wing\confbean\SWingDyeLib.class
