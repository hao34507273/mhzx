...
/*     */ 
/*     */ public class SWingCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SWingCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SWingCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public int dyeLibId;
/*     */   public int dyeid;
...
/*  25 */     this.dyeLibId = Integer.valueOf(rootElement.attributeValue("dyeLibId")).intValue();
/*  26 */     this.dyeid = Integer.valueOf(rootElement.attributeValue("dyeid")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  31 */     _os_.marshal(this.id);
/*  32 */     _os_.marshal(this.dyeLibId);
/*  33 */     _os_.marshal(this.dyeid);
/*  34 */     return _os_;
/*     */   }
/*     */   
...
/*  40 */     this.dyeLibId = _os_.unmarshal_int();
/*  41 */     this.dyeid = _os_.unmarshal_int();
/*  42 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  47 */     String path = dir + "mzm.gsp.wing.confbean.SWingCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  60 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.wing.confbean.SWingCfg"))
/*     */         {
/*     */ 
/*  63 */           SWingCfg obj = new SWingCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SWingCfg> all)
/*     */   {
/*  77 */     String path = dir + "mzm.gsp.wing.confbean.SWingCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  89 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.wing.confbean.SWingCfg"))
/*     */         {
/*     */ 
/*  92 */           SWingCfg obj = new SWingCfg();
...
/*     */     
/* 108 */     String path = dir + "mzm.gsp.wing.confbean.SWingCfg.bny";
/*     */     try
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SWingCfg> all)
/*     */   {
/* 155 */     String path = dir + "mzm.gsp.wing.confbean.SWingCfg.bny";
/*     */     try
/*     */     {
...
/*     */ 
/*     */ 
/*     */   public static SWingCfg getOld(int key)
/*     */   {
/* 203 */     return (SWingCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SWingCfg get(int key)
/*     */   {
/* 208 */     return (SWingCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SWingCfg> getOldAll()
/*     */   {
/* 213 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SWingCfg> getAll()
/*     */   {
/* 218 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SWingCfg> newAll)
/*     */   {
/* 223 */     oldAll = all;
/* 224 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\wing\confbean\SWingCfg.class
