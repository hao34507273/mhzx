...
/*     */ 
/*     */ public class Swinglevel2PropertyPhase implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, Swinglevel2PropertyPhase> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, Swinglevel2PropertyPhase> all = null;
/*     */   
/*     */   public int level;
/*  19 */   public HashMap<Integer, PhaseValue> peroperty2PhaseValue = new HashMap();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.level = Integer.valueOf(rootElement.attributeValue("level")).intValue();
/*     */     
/*  25 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "peroperty2PhaseValue");
...
/*  51 */             keyElem = elem;
/*     */           }
/*  53 */           else if ((valueElem == null) && (elem.getName().equalsIgnoreCase("mzm.gsp.wing.confbean.PhaseValue")))
/*     */           {
/*  55 */             valueElem = elem;
/*     */           }
/*     */         }
...
/*     */         }
/*     */         
/*  77 */         this.peroperty2PhaseValue.put(Integer.valueOf(_k_), _v_);
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*     */   {
/*  84 */     _os_.marshal(this.level);
/*  85 */     _os_.compact_uint32(this.peroperty2PhaseValue.size());
/*  86 */     for (java.util.Map.Entry<Integer, PhaseValue> _e_ : this.peroperty2PhaseValue.entrySet())
/*     */     {
...
/*     */   {
/*  96 */     this.level = _os_.unmarshal_int();
/*  97 */     for (int _size_ = _os_.uncompact_uint32(); _size_ > 0; _size_--)
/*     */     {
/*     */ 
/* 100 */       int _k_ = _os_.unmarshal_int();
/*     */       
/* 102 */       PhaseValue _v_ = new PhaseValue();
/* 103 */       _v_.unmarshal(_os_);
/* 104 */       this.peroperty2PhaseValue.put(Integer.valueOf(_k_), _v_);
/*     */     }
/* 106 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/* 111 */     String path = dir + "mzm.gsp.wing.confbean.Swinglevel2PropertyPhase.xml";
/*     */     
/*     */     try
/*     */     {
/* 115 */       all = new HashMap();
...
/* 124 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.wing.confbean.Swinglevel2PropertyPhase"))
/*     */         {
/*     */ 
/* 127 */           Swinglevel2PropertyPhase obj = new Swinglevel2PropertyPhase();
/* 128 */           obj.loadFromXml(elem);
/* 129 */           if (all.put(Integer.valueOf(obj.level), obj) != null) {
/* 130 */             throw new RuntimeException("duplicate key : " + obj.level);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, Swinglevel2PropertyPhase> all)
/*     */   {
/* 141 */     String path = dir + "mzm.gsp.wing.confbean.Swinglevel2PropertyPhase.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 153 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.wing.confbean.Swinglevel2PropertyPhase"))
/*     */         {
/*     */ 
/* 156 */           Swinglevel2PropertyPhase obj = new Swinglevel2PropertyPhase();
/* 157 */           obj.loadFromXml(elem);
/* 158 */           if (all.put(Integer.valueOf(obj.level), obj) != null) {
/* 159 */             throw new RuntimeException("duplicate key : " + obj.level);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/* 170 */     all = new HashMap();
/*     */     
/* 172 */     String path = dir + "mzm.gsp.wing.confbean.Swinglevel2PropertyPhase.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 199 */           Swinglevel2PropertyPhase _v_ = new Swinglevel2PropertyPhase();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, Swinglevel2PropertyPhase> all)
/*     */   {
/* 219 */     String path = dir + "mzm.gsp.wing.confbean.Swinglevel2PropertyPhase.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 246 */           Swinglevel2PropertyPhase _v_ = new Swinglevel2PropertyPhase();
...
/*     */ 
/*     */ 
/*     */   public static Swinglevel2PropertyPhase getOld(int key)
/*     */   {
/* 267 */     return (Swinglevel2PropertyPhase)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Swinglevel2PropertyPhase get(int key)
/*     */   {
/* 272 */     return (Swinglevel2PropertyPhase)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, Swinglevel2PropertyPhase> getOldAll()
/*     */   {
/* 277 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, Swinglevel2PropertyPhase> getAll()
/*     */   {
/* 282 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, Swinglevel2PropertyPhase> newAll)
/*     */   {
/* 287 */     oldAll = all;
/* 288 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\wing\confbean\Swinglevel2PropertyPhase.class
