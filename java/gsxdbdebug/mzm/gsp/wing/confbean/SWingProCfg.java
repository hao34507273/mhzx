...
/*     */ 
/*     */ public class SWingProCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SWingProCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SWingProCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public int proType;
/*     */   public int proValue;
...
/*  26 */     this.proType = Integer.valueOf(rootElement.attributeValue("proType")).intValue();
/*  27 */     this.proValue = Integer.valueOf(rootElement.attributeValue("proValue")).intValue();
/*  28 */     this.proColor = Integer.valueOf(rootElement.attributeValue("proColor")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  33 */     _os_.marshal(this.id);
/*  34 */     _os_.marshal(this.proType);
/*  35 */     _os_.marshal(this.proValue);
/*  36 */     _os_.marshal(this.proColor);
/*  37 */     return _os_;
/*     */   }
/*     */   
...
/*  43 */     this.proType = _os_.unmarshal_int();
/*  44 */     this.proValue = _os_.unmarshal_int();
/*  45 */     this.proColor = _os_.unmarshal_int();
/*  46 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  51 */     String path = dir + "mzm.gsp.wing.confbean.SWingProCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  64 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.wing.confbean.SWingProCfg"))
/*     */         {
/*     */ 
/*  67 */           SWingProCfg obj = new SWingProCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SWingProCfg> all)
/*     */   {
/*  81 */     String path = dir + "mzm.gsp.wing.confbean.SWingProCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.wing.confbean.SWingProCfg"))
/*     */         {
/*     */ 
/*  96 */           SWingProCfg obj = new SWingProCfg();
...
/*     */     
/* 112 */     String path = dir + "mzm.gsp.wing.confbean.SWingProCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 139 */           SWingProCfg _v_ = new SWingProCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SWingProCfg> all)
/*     */   {
/* 159 */     String path = dir + "mzm.gsp.wing.confbean.SWingProCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 186 */           SWingProCfg _v_ = new SWingProCfg();
...
/*     */ 
/*     */ 
/*     */   public static SWingProCfg getOld(int key)
/*     */   {
/* 207 */     return (SWingProCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SWingProCfg get(int key)
/*     */   {
/* 212 */     return (SWingProCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SWingProCfg> getOldAll()
/*     */   {
/* 217 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SWingProCfg> getAll()
/*     */   {
/* 222 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SWingProCfg> newAll)
/*     */   {
/* 227 */     oldAll = all;
/* 228 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\wing\confbean\SWingProCfg.class
