...
/*     */ 
/*     */ public class SRecommandPriceCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SRecommandPriceCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SRecommandPriceCfg> all = null;
/*     */   
/*     */   public int id;
...
/*  30 */     this.maxServerLevel = Integer.valueOf(rootElement.attributeValue("maxServerLevel")).intValue();
/*  31 */     this.minServerLevel = Integer.valueOf(rootElement.attributeValue("minServerLevel")).intValue();
/*  32 */     this.recommandPrice = Integer.valueOf(rootElement.attributeValue("recommandPrice")).intValue();
/*     */   }
/*     */   
...
/*  40 */     _os_.marshal(this.maxServerLevel);
/*  41 */     _os_.marshal(this.minServerLevel);
/*  42 */     _os_.marshal(this.recommandPrice);
/*  43 */     return _os_;
/*     */   }
/*     */   
...
/*  51 */     this.maxServerLevel = _os_.unmarshal_int();
/*  52 */     this.minServerLevel = _os_.unmarshal_int();
/*  53 */     this.recommandPrice = _os_.unmarshal_int();
/*  54 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  59 */     String path = dir + "mzm.gsp.shanghui.confbean.SRecommandPriceCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  72 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.shanghui.confbean.SRecommandPriceCfg"))
/*     */         {
/*     */ 
/*  75 */           SRecommandPriceCfg obj = new SRecommandPriceCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SRecommandPriceCfg> all)
/*     */   {
/*  89 */     String path = dir + "mzm.gsp.shanghui.confbean.SRecommandPriceCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 101 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.shanghui.confbean.SRecommandPriceCfg"))
/*     */         {
/*     */ 
/* 104 */           SRecommandPriceCfg obj = new SRecommandPriceCfg();
...
/*     */     
/* 120 */     String path = dir + "mzm.gsp.shanghui.confbean.SRecommandPriceCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 147 */           SRecommandPriceCfg _v_ = new SRecommandPriceCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SRecommandPriceCfg> all)
/*     */   {
/* 167 */     String path = dir + "mzm.gsp.shanghui.confbean.SRecommandPriceCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 194 */           SRecommandPriceCfg _v_ = new SRecommandPriceCfg();
...
/*     */ 
/*     */ 
/*     */   public static SRecommandPriceCfg getOld(int key)
/*     */   {
/* 215 */     return (SRecommandPriceCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SRecommandPriceCfg get(int key)
/*     */   {
/* 220 */     return (SRecommandPriceCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SRecommandPriceCfg> getOldAll()
/*     */   {
/* 225 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SRecommandPriceCfg> getAll()
/*     */   {
/* 230 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SRecommandPriceCfg> newAll)
/*     */   {
/* 235 */     oldAll = all;
/* 236 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\shanghui\confbean\SRecommandPriceCfg.class
