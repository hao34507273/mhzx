...
/*     */ 
/*     */ public class SShangHuiCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SShangHuiCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SShangHuiCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public String templatename;
/*     */   public String BigTypeName;
/*  21 */   public java.util.LinkedList<Integer> SubTypeIdList = new java.util.LinkedList();
/*     */   
...
/*  27 */     this.BigTypeName = rootElement.attributeValue("BigTypeName");
/*     */     
/*  29 */     Element collectionElement = util.XmlHelper.getVariableElement(rootElement, "SubTypeIdList");
...
/*     */         }
/*     */         
/*  54 */         this.SubTypeIdList.add(Integer.valueOf(_v_));
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*  63 */     _os_.marshal(this.BigTypeName, "UTF-8");
/*  64 */     _os_.compact_uint32(this.SubTypeIdList.size());
/*  65 */     for (Integer _v_ : this.SubTypeIdList)
/*     */     {
...
/*  76 */     this.BigTypeName = _os_.unmarshal_String("UTF-8");
/*  77 */     for (int _size_ = _os_.uncompact_uint32(); _size_ > 0; _size_--)
/*     */     {
/*     */ 
/*  80 */       int _v_ = _os_.unmarshal_int();
/*  81 */       this.SubTypeIdList.add(Integer.valueOf(_v_));
/*     */     }
/*  83 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/*  88 */     String path = dir + "mzm.gsp.shanghui.confbean.SShangHuiCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 101 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.shanghui.confbean.SShangHuiCfg"))
/*     */         {
/*     */ 
/* 104 */           SShangHuiCfg obj = new SShangHuiCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SShangHuiCfg> all)
/*     */   {
/* 118 */     String path = dir + "mzm.gsp.shanghui.confbean.SShangHuiCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 130 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.shanghui.confbean.SShangHuiCfg"))
/*     */         {
/*     */ 
/* 133 */           SShangHuiCfg obj = new SShangHuiCfg();
...
/*     */     
/* 149 */     String path = dir + "mzm.gsp.shanghui.confbean.SShangHuiCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 176 */           SShangHuiCfg _v_ = new SShangHuiCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SShangHuiCfg> all)
/*     */   {
/* 196 */     String path = dir + "mzm.gsp.shanghui.confbean.SShangHuiCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 223 */           SShangHuiCfg _v_ = new SShangHuiCfg();
...
/*     */ 
/*     */ 
/*     */   public static SShangHuiCfg getOld(int key)
/*     */   {
/* 244 */     return (SShangHuiCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SShangHuiCfg get(int key)
/*     */   {
/* 249 */     return (SShangHuiCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SShangHuiCfg> getOldAll()
/*     */   {
/* 254 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SShangHuiCfg> getAll()
/*     */   {
/* 259 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SShangHuiCfg> newAll)
/*     */   {
/* 264 */     oldAll = all;
/* 265 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\shanghui\confbean\SShangHuiCfg.class
