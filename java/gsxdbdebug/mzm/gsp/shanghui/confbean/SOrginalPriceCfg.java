...
/*     */ 
/*     */ public class SOrginalPriceCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SOrginalPriceCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SOrginalPriceCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public String name;
/*     */   public int itemId;
/*     */   public int lastLevelItemId;
...
/*  29 */     this.lastLevelItemId = Integer.valueOf(rootElement.attributeValue("lastLevelItemId")).intValue();
/*  30 */     this.priceRate = Double.valueOf(rootElement.attributeValue("priceRate")).doubleValue();
/*     */   }
/*     */   
...
/*  38 */     _os_.marshal(this.lastLevelItemId);
/*  39 */     _os_.marshal(this.priceRate);
/*  40 */     return _os_;
/*     */   }
/*     */   
...
/*  47 */     this.itemId = _os_.unmarshal_int();
/*  48 */     this.lastLevelItemId = _os_.unmarshal_int();
/*  49 */     this.priceRate = _os_.unmarshal_float();
/*  50 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  55 */     String path = dir + "mzm.gsp.shanghui.confbean.SOrginalPriceCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  68 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.shanghui.confbean.SOrginalPriceCfg"))
/*     */         {
/*     */ 
/*  71 */           SOrginalPriceCfg obj = new SOrginalPriceCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SOrginalPriceCfg> all)
/*     */   {
/*  85 */     String path = dir + "mzm.gsp.shanghui.confbean.SOrginalPriceCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  97 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.shanghui.confbean.SOrginalPriceCfg"))
/*     */         {
/*     */ 
/* 100 */           SOrginalPriceCfg obj = new SOrginalPriceCfg();
...
/*     */     
/* 116 */     String path = dir + "mzm.gsp.shanghui.confbean.SOrginalPriceCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 143 */           SOrginalPriceCfg _v_ = new SOrginalPriceCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SOrginalPriceCfg> all)
/*     */   {
/* 163 */     String path = dir + "mzm.gsp.shanghui.confbean.SOrginalPriceCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 190 */           SOrginalPriceCfg _v_ = new SOrginalPriceCfg();
...
/*     */ 
/*     */ 
/*     */   public static SOrginalPriceCfg getOld(int key)
/*     */   {
/* 211 */     return (SOrginalPriceCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SOrginalPriceCfg get(int key)
/*     */   {
/* 216 */     return (SOrginalPriceCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SOrginalPriceCfg> getOldAll()
/*     */   {
/* 221 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SOrginalPriceCfg> getAll()
/*     */   {
/* 226 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SOrginalPriceCfg> newAll)
/*     */   {
/* 231 */     oldAll = all;
/* 232 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\shanghui\confbean\SOrginalPriceCfg.class
