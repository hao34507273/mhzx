...
/*     */ 
/*     */ public class STItem2RecommandPriceCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, STItem2RecommandPriceCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, STItem2RecommandPriceCfg> all = null;
/*     */   
/*     */   public int itemId;
/*  19 */   public java.util.HashSet<Integer> recommandPriceCfgIds = new java.util.HashSet();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.itemId = Integer.valueOf(rootElement.attributeValue("itemId")).intValue();
/*     */     
/*  25 */     Element collectionElement = util.XmlHelper.getVariableElement(rootElement, "recommandPriceCfgIds");
...
/*     */         }
/*     */         
/*  50 */         this.recommandPriceCfgIds.add(Integer.valueOf(_v_));
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*  58 */     _os_.compact_uint32(this.recommandPriceCfgIds.size());
/*  59 */     for (Integer _v_ : this.recommandPriceCfgIds)
/*     */     {
...
/*  73 */       this.recommandPriceCfgIds.add(Integer.valueOf(_v_));
/*     */     }
/*  75 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/*  80 */     String path = dir + "mzm.gsp.shanghui.confbean.STItem2RecommandPriceCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.shanghui.confbean.STItem2RecommandPriceCfg"))
/*     */         {
/*     */ 
/*  96 */           STItem2RecommandPriceCfg obj = new STItem2RecommandPriceCfg();
/*  97 */           obj.loadFromXml(elem);
/*  98 */           if (all.put(Integer.valueOf(obj.itemId), obj) != null) {
/*  99 */             throw new RuntimeException("duplicate key : " + obj.itemId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, STItem2RecommandPriceCfg> all)
/*     */   {
/* 110 */     String path = dir + "mzm.gsp.shanghui.confbean.STItem2RecommandPriceCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 122 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.shanghui.confbean.STItem2RecommandPriceCfg"))
/*     */         {
/*     */ 
/* 125 */           STItem2RecommandPriceCfg obj = new STItem2RecommandPriceCfg();
/* 126 */           obj.loadFromXml(elem);
/* 127 */           if (all.put(Integer.valueOf(obj.itemId), obj) != null) {
/* 128 */             throw new RuntimeException("duplicate key : " + obj.itemId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 141 */     String path = dir + "mzm.gsp.shanghui.confbean.STItem2RecommandPriceCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 168 */           STItem2RecommandPriceCfg _v_ = new STItem2RecommandPriceCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, STItem2RecommandPriceCfg> all)
/*     */   {
/* 188 */     String path = dir + "mzm.gsp.shanghui.confbean.STItem2RecommandPriceCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 215 */           STItem2RecommandPriceCfg _v_ = new STItem2RecommandPriceCfg();
...
/*     */ 
/*     */ 
/*     */   public static STItem2RecommandPriceCfg getOld(int key)
/*     */   {
/* 236 */     return (STItem2RecommandPriceCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static STItem2RecommandPriceCfg get(int key)
/*     */   {
/* 241 */     return (STItem2RecommandPriceCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, STItem2RecommandPriceCfg> getOldAll()
/*     */   {
/* 246 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, STItem2RecommandPriceCfg> getAll()
/*     */   {
/* 251 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, STItem2RecommandPriceCfg> newAll)
/*     */   {
/* 256 */     oldAll = all;
/* 257 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\shanghui\confbean\STItem2RecommandPriceCfg.class
