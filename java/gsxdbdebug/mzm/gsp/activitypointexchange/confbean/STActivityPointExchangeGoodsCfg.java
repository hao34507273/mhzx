...
/*     */ 
/*     */ public class STActivityPointExchangeGoodsCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, STActivityPointExchangeGoodsCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, STActivityPointExchangeGoodsCfg> all = null;
/*     */   
/*     */   public int goodsCfgTypeId;
/*  19 */   public HashMap<Integer, SPointExchangeGoodsInfo> id2pointExchangeGoodsInfo = new HashMap();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.goodsCfgTypeId = Integer.valueOf(rootElement.attributeValue("goodsCfgTypeId")).intValue();
/*     */     
/*  25 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "id2pointExchangeGoodsInfo");
...
/*  51 */             keyElem = elem;
/*     */           }
/*  53 */           else if ((valueElem == null) && (elem.getName().equalsIgnoreCase("mzm.gsp.activitypointexchange.confbean.SPointExchangeGoodsInfo")))
/*     */           {
/*  55 */             valueElem = elem;
/*     */           }
/*     */         }
...
/*     */         
/*     */         int _k_;
/*     */         SPointExchangeGoodsInfo _v_;
/*     */         try
/*     */         {
/*  68 */           _k_ = Integer.valueOf(keyElem.getText()).intValue();
/*  69 */           _v_ = new SPointExchangeGoodsInfo();
...
/*     */         }
/*     */         
/*  77 */         this.id2pointExchangeGoodsInfo.put(Integer.valueOf(_k_), _v_);
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*     */   {
/*  84 */     _os_.marshal(this.goodsCfgTypeId);
/*  85 */     _os_.compact_uint32(this.id2pointExchangeGoodsInfo.size());
/*  86 */     for (java.util.Map.Entry<Integer, SPointExchangeGoodsInfo> _e_ : this.id2pointExchangeGoodsInfo.entrySet())
/*     */     {
...
/*     */   {
/*  96 */     this.goodsCfgTypeId = _os_.unmarshal_int();
/*  97 */     for (int _size_ = _os_.uncompact_uint32(); _size_ > 0; _size_--)
/*     */     {
/*     */ 
/* 100 */       int _k_ = _os_.unmarshal_int();
/*     */       
/* 102 */       SPointExchangeGoodsInfo _v_ = new SPointExchangeGoodsInfo();
/* 103 */       _v_.unmarshal(_os_);
/* 104 */       this.id2pointExchangeGoodsInfo.put(Integer.valueOf(_k_), _v_);
/*     */     }
/* 106 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/* 111 */     String path = dir + "mzm.gsp.activitypointexchange.confbean.STActivityPointExchangeGoodsCfg.xml";
/*     */     
/*     */     try
/*     */     {
/* 115 */       all = new HashMap();
...
/* 124 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activitypointexchange.confbean.STActivityPointExchangeGoodsCfg"))
/*     */         {
/*     */ 
/* 127 */           STActivityPointExchangeGoodsCfg obj = new STActivityPointExchangeGoodsCfg();
/* 128 */           obj.loadFromXml(elem);
/* 129 */           if (all.put(Integer.valueOf(obj.goodsCfgTypeId), obj) != null) {
/* 130 */             throw new RuntimeException("duplicate key : " + obj.goodsCfgTypeId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, STActivityPointExchangeGoodsCfg> all)
/*     */   {
/* 141 */     String path = dir + "mzm.gsp.activitypointexchange.confbean.STActivityPointExchangeGoodsCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 153 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activitypointexchange.confbean.STActivityPointExchangeGoodsCfg"))
/*     */         {
/*     */ 
/* 156 */           STActivityPointExchangeGoodsCfg obj = new STActivityPointExchangeGoodsCfg();
/* 157 */           obj.loadFromXml(elem);
/* 158 */           if (all.put(Integer.valueOf(obj.goodsCfgTypeId), obj) != null) {
/* 159 */             throw new RuntimeException("duplicate key : " + obj.goodsCfgTypeId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/* 170 */     all = new HashMap();
/*     */     
/* 172 */     String path = dir + "mzm.gsp.activitypointexchange.confbean.STActivityPointExchangeGoodsCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 199 */           STActivityPointExchangeGoodsCfg _v_ = new STActivityPointExchangeGoodsCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, STActivityPointExchangeGoodsCfg> all)
/*     */   {
/* 219 */     String path = dir + "mzm.gsp.activitypointexchange.confbean.STActivityPointExchangeGoodsCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 246 */           STActivityPointExchangeGoodsCfg _v_ = new STActivityPointExchangeGoodsCfg();
...
/*     */ 
/*     */ 
/*     */   public static STActivityPointExchangeGoodsCfg getOld(int key)
/*     */   {
/* 267 */     return (STActivityPointExchangeGoodsCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static STActivityPointExchangeGoodsCfg get(int key)
/*     */   {
/* 272 */     return (STActivityPointExchangeGoodsCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, STActivityPointExchangeGoodsCfg> getOldAll()
/*     */   {
/* 277 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, STActivityPointExchangeGoodsCfg> getAll()
/*     */   {
/* 282 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, STActivityPointExchangeGoodsCfg> newAll)
/*     */   {
/* 287 */     oldAll = all;
/* 288 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\activitypointexchange\confbean\STActivityPointExchangeGoodsCfg.class
