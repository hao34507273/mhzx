...
/*     */ 
/*     */ public class TActivityPointExchangeActivityCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, TActivityPointExchangeActivityCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, TActivityPointExchangeActivityCfg> all = null;
/*     */   
/*     */   public int activityId;
/*     */   public int activitySwitchId;
/*  20 */   public java.util.ArrayList<Integer> mallCfgIds = new java.util.ArrayList();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  24 */     this.activityId = Integer.valueOf(rootElement.attributeValue("activityId")).intValue();
/*  25 */     this.activitySwitchId = Integer.valueOf(rootElement.attributeValue("activitySwitchId")).intValue();
/*     */     
/*  27 */     Element collectionElement = util.XmlHelper.getVariableElement(rootElement, "mallCfgIds");
...
/*     */         }
/*     */         
/*  52 */         this.mallCfgIds.add(Integer.valueOf(_v_));
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*  60 */     _os_.marshal(this.activitySwitchId);
/*  61 */     _os_.compact_uint32(this.mallCfgIds.size());
/*  62 */     for (Integer _v_ : this.mallCfgIds)
/*     */     {
...
/*  72 */     this.activitySwitchId = _os_.unmarshal_int();
/*  73 */     for (int _size_ = _os_.uncompact_uint32(); _size_ > 0; _size_--)
/*     */     {
/*     */ 
/*  76 */       int _v_ = _os_.unmarshal_int();
/*  77 */       this.mallCfgIds.add(Integer.valueOf(_v_));
/*     */     }
/*  79 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/*  84 */     String path = dir + "mzm.gsp.activitypointexchange.confbean.TActivityPointExchangeActivityCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  97 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activitypointexchange.confbean.TActivityPointExchangeActivityCfg"))
/*     */         {
/*     */ 
/* 100 */           TActivityPointExchangeActivityCfg obj = new TActivityPointExchangeActivityCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, TActivityPointExchangeActivityCfg> all)
/*     */   {
/* 114 */     String path = dir + "mzm.gsp.activitypointexchange.confbean.TActivityPointExchangeActivityCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 126 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activitypointexchange.confbean.TActivityPointExchangeActivityCfg"))
/*     */         {
/*     */ 
/* 129 */           TActivityPointExchangeActivityCfg obj = new TActivityPointExchangeActivityCfg();
...
/*     */     
/* 145 */     String path = dir + "mzm.gsp.activitypointexchange.confbean.TActivityPointExchangeActivityCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 172 */           TActivityPointExchangeActivityCfg _v_ = new TActivityPointExchangeActivityCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, TActivityPointExchangeActivityCfg> all)
/*     */   {
/* 192 */     String path = dir + "mzm.gsp.activitypointexchange.confbean.TActivityPointExchangeActivityCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 219 */           TActivityPointExchangeActivityCfg _v_ = new TActivityPointExchangeActivityCfg();
...
/*     */ 
/*     */ 
/*     */   public static TActivityPointExchangeActivityCfg getOld(int key)
/*     */   {
/* 240 */     return (TActivityPointExchangeActivityCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static TActivityPointExchangeActivityCfg get(int key)
/*     */   {
/* 245 */     return (TActivityPointExchangeActivityCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, TActivityPointExchangeActivityCfg> getOldAll()
/*     */   {
/* 250 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, TActivityPointExchangeActivityCfg> getAll()
/*     */   {
/* 255 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, TActivityPointExchangeActivityCfg> newAll)
/*     */   {
/* 260 */     oldAll = all;
/* 261 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\activitypointexchange\confbean\TActivityPointExchangeActivityCfg.class
