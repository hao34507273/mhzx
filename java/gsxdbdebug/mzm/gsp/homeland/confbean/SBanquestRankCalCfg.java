...
/*     */ 
/*     */ public class SBanquestRankCalCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SBanquestRankCalCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SBanquestRankCalCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public int rank;
/*     */   public int scoreLow;
...
/*     */   public int controllerLibId;
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  28 */     this.id = Integer.valueOf(rootElement.attributeValue("id")).intValue();
/*  29 */     this.rank = Integer.valueOf(rootElement.attributeValue("rank")).intValue();
/*  30 */     this.scoreLow = Integer.valueOf(rootElement.attributeValue("scoreLow")).intValue();
/*  31 */     this.scoreHigh = Integer.valueOf(rootElement.attributeValue("scoreHigh")).intValue();
/*  32 */     this.dishesController = Integer.valueOf(rootElement.attributeValue("dishesController")).intValue();
/*  33 */     this.deshesLibId = Integer.valueOf(rootElement.attributeValue("deshesLibId")).intValue();
/*  34 */     this.controllerLibId = Integer.valueOf(rootElement.attributeValue("controllerLibId")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  39 */     _os_.marshal(this.id);
/*  40 */     _os_.marshal(this.rank);
/*  41 */     _os_.marshal(this.scoreLow);
/*  42 */     _os_.marshal(this.scoreHigh);
/*  43 */     _os_.marshal(this.dishesController);
/*  44 */     _os_.marshal(this.deshesLibId);
/*  45 */     _os_.marshal(this.controllerLibId);
/*  46 */     return _os_;
/*     */   }
/*     */   
...
/*  53 */     this.scoreLow = _os_.unmarshal_int();
/*  54 */     this.scoreHigh = _os_.unmarshal_int();
/*  55 */     this.dishesController = _os_.unmarshal_int();
/*  56 */     this.deshesLibId = _os_.unmarshal_int();
/*  57 */     this.controllerLibId = _os_.unmarshal_int();
/*  58 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  63 */     String path = dir + "mzm.gsp.homeland.confbean.SBanquestRankCalCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  76 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.homeland.confbean.SBanquestRankCalCfg"))
/*     */         {
/*     */ 
/*  79 */           SBanquestRankCalCfg obj = new SBanquestRankCalCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SBanquestRankCalCfg> all)
/*     */   {
/*  93 */     String path = dir + "mzm.gsp.homeland.confbean.SBanquestRankCalCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 105 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.homeland.confbean.SBanquestRankCalCfg"))
/*     */         {
/*     */ 
/* 108 */           SBanquestRankCalCfg obj = new SBanquestRankCalCfg();
...
/*     */     
/* 124 */     String path = dir + "mzm.gsp.homeland.confbean.SBanquestRankCalCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 151 */           SBanquestRankCalCfg _v_ = new SBanquestRankCalCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SBanquestRankCalCfg> all)
/*     */   {
/* 171 */     String path = dir + "mzm.gsp.homeland.confbean.SBanquestRankCalCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 198 */           SBanquestRankCalCfg _v_ = new SBanquestRankCalCfg();
...
/*     */ 
/*     */ 
/*     */   public static SBanquestRankCalCfg getOld(int key)
/*     */   {
/* 219 */     return (SBanquestRankCalCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SBanquestRankCalCfg get(int key)
/*     */   {
/* 224 */     return (SBanquestRankCalCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SBanquestRankCalCfg> getOldAll()
/*     */   {
/* 229 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SBanquestRankCalCfg> getAll()
/*     */   {
/* 234 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SBanquestRankCalCfg> newAll)
/*     */   {
/* 239 */     oldAll = all;
/* 240 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\homeland\confbean\SBanquestRankCalCfg.class
