...
/*     */ 
/*     */ public class SMysteryVisitorProbabilityCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SMysteryVisitorProbabilityCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SMysteryVisitorProbabilityCfg> all = null;
/*     */   
/*     */   public int courdyard_aesthetics_degree;
/*  19 */   public TreeMap<Integer, Integer> probability_infos = new TreeMap();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.courdyard_aesthetics_degree = Integer.valueOf(rootElement.attributeValue("courdyard_aesthetics_degree")).intValue();
/*     */     
/*  25 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "probability_infos");
...
/*     */         }
/*     */         
/*  76 */         this.probability_infos.put(Integer.valueOf(_k_), Integer.valueOf(_v_));
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*     */   {
/*  83 */     _os_.marshal(this.courdyard_aesthetics_degree);
/*  84 */     _os_.compact_uint32(this.probability_infos.size());
/*  85 */     for (java.util.Map.Entry<Integer, Integer> _e_ : this.probability_infos.entrySet())
/*     */     {
...
/*     */   {
/*  95 */     this.courdyard_aesthetics_degree = _os_.unmarshal_int();
...
/* 102 */       this.probability_infos.put(Integer.valueOf(_k_), Integer.valueOf(_v_));
/*     */     }
/* 104 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/* 109 */     String path = dir + "mzm.gsp.homeland.confbean.SMysteryVisitorProbabilityCfg.xml";
/*     */     
/*     */     try
/*     */     {
/* 113 */       all = new TreeMap();
...
/* 122 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.homeland.confbean.SMysteryVisitorProbabilityCfg"))
/*     */         {
/*     */ 
/* 125 */           SMysteryVisitorProbabilityCfg obj = new SMysteryVisitorProbabilityCfg();
/* 126 */           obj.loadFromXml(elem);
/* 127 */           if (all.put(Integer.valueOf(obj.courdyard_aesthetics_degree), obj) != null) {
/* 128 */             throw new RuntimeException("duplicate key : " + obj.courdyard_aesthetics_degree);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SMysteryVisitorProbabilityCfg> all)
/*     */   {
/* 139 */     String path = dir + "mzm.gsp.homeland.confbean.SMysteryVisitorProbabilityCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 151 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.homeland.confbean.SMysteryVisitorProbabilityCfg"))
/*     */         {
/*     */ 
/* 154 */           SMysteryVisitorProbabilityCfg obj = new SMysteryVisitorProbabilityCfg();
/* 155 */           obj.loadFromXml(elem);
/* 156 */           if (all.put(Integer.valueOf(obj.courdyard_aesthetics_degree), obj) != null) {
/* 157 */             throw new RuntimeException("duplicate key : " + obj.courdyard_aesthetics_degree);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/* 168 */     all = new TreeMap();
/*     */     
/* 170 */     String path = dir + "mzm.gsp.homeland.confbean.SMysteryVisitorProbabilityCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 197 */           SMysteryVisitorProbabilityCfg _v_ = new SMysteryVisitorProbabilityCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SMysteryVisitorProbabilityCfg> all)
/*     */   {
/* 217 */     String path = dir + "mzm.gsp.homeland.confbean.SMysteryVisitorProbabilityCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 244 */           SMysteryVisitorProbabilityCfg _v_ = new SMysteryVisitorProbabilityCfg();
...
/*     */ 
/*     */ 
/*     */   public static SMysteryVisitorProbabilityCfg getOld(int key)
/*     */   {
/* 265 */     return (SMysteryVisitorProbabilityCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SMysteryVisitorProbabilityCfg get(int key)
/*     */   {
/* 270 */     return (SMysteryVisitorProbabilityCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMysteryVisitorProbabilityCfg> getOldAll()
/*     */   {
/* 275 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMysteryVisitorProbabilityCfg> getAll()
/*     */   {
/* 280 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SMysteryVisitorProbabilityCfg> newAll)
/*     */   {
/* 285 */     oldAll = all;
/* 286 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\homeland\confbean\SMysteryVisitorProbabilityCfg.class
