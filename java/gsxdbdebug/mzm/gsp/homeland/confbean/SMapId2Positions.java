...
/*     */ 
/*     */ public class SMapId2Positions implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SMapId2Positions> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SMapId2Positions> all = null;
/*     */   
/*     */   public int mapid;
/*  19 */   public java.util.ArrayList<ChildPos> childPositions = new java.util.ArrayList();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.mapid = Integer.valueOf(rootElement.attributeValue("mapid")).intValue();
/*     */     
/*  25 */     Element collectionElement = util.XmlHelper.getVariableElement(rootElement, "childPositions");
...
/*  36 */       if (elem.getName().equalsIgnoreCase("mzm.gsp.homeland.confbean.ChildPos"))
/*     */       {
/*     */         ChildPos _v_;
/*     */         
/*     */ 
...
/*     */         }
/*     */         
/*  51 */         this.childPositions.add(_v_);
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*     */   {
/*  58 */     _os_.marshal(this.mapid);
/*  59 */     _os_.compact_uint32(this.childPositions.size());
/*  60 */     for (ChildPos _v_ : this.childPositions)
/*     */     {
/*  62 */       _os_.marshal(_v_);
/*     */     }
/*  64 */     return _os_;
...
/*     */     {
/*     */ 
/*  73 */       ChildPos _v_ = new ChildPos();
/*  74 */       _v_.unmarshal(_os_);
/*  75 */       this.childPositions.add(_v_);
/*     */     }
/*  77 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/*  82 */     String path = dir + "mzm.gsp.homeland.confbean.SMapId2Positions.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  95 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.homeland.confbean.SMapId2Positions"))
/*     */         {
/*     */ 
/*  98 */           SMapId2Positions obj = new SMapId2Positions();
/*  99 */           obj.loadFromXml(elem);
/* 100 */           if (all.put(Integer.valueOf(obj.mapid), obj) != null) {
/* 101 */             throw new RuntimeException("duplicate key : " + obj.mapid);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SMapId2Positions> all)
/*     */   {
/* 112 */     String path = dir + "mzm.gsp.homeland.confbean.SMapId2Positions.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 124 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.homeland.confbean.SMapId2Positions"))
/*     */         {
/*     */ 
/* 127 */           SMapId2Positions obj = new SMapId2Positions();
/* 128 */           obj.loadFromXml(elem);
/* 129 */           if (all.put(Integer.valueOf(obj.mapid), obj) != null) {
/* 130 */             throw new RuntimeException("duplicate key : " + obj.mapid);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 143 */     String path = dir + "mzm.gsp.homeland.confbean.SMapId2Positions.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 170 */           SMapId2Positions _v_ = new SMapId2Positions();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SMapId2Positions> all)
/*     */   {
/* 190 */     String path = dir + "mzm.gsp.homeland.confbean.SMapId2Positions.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 217 */           SMapId2Positions _v_ = new SMapId2Positions();
...
/*     */ 
/*     */ 
/*     */   public static SMapId2Positions getOld(int key)
/*     */   {
/* 238 */     return (SMapId2Positions)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SMapId2Positions get(int key)
/*     */   {
/* 243 */     return (SMapId2Positions)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMapId2Positions> getOldAll()
/*     */   {
/* 248 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMapId2Positions> getAll()
/*     */   {
/* 253 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SMapId2Positions> newAll)
/*     */   {
/* 258 */     oldAll = all;
/* 259 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\homeland\confbean\SMapId2Positions.class
