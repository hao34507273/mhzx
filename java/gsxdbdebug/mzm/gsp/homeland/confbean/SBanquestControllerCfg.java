...
/*     */ 
/*     */ public class SBanquestControllerCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SBanquestControllerCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SBanquestControllerCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public int deshLibId;
/*     */   public int controllerId;
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  24 */     this.id = Integer.valueOf(rootElement.attributeValue("id")).intValue();
/*  25 */     this.deshLibId = Integer.valueOf(rootElement.attributeValue("deshLibId")).intValue();
/*  26 */     this.controllerId = Integer.valueOf(rootElement.attributeValue("controllerId")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  31 */     _os_.marshal(this.id);
/*  32 */     _os_.marshal(this.deshLibId);
/*  33 */     _os_.marshal(this.controllerId);
/*  34 */     return _os_;
/*     */   }
/*     */   
...
/*  40 */     this.deshLibId = _os_.unmarshal_int();
/*  41 */     this.controllerId = _os_.unmarshal_int();
/*  42 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  47 */     String path = dir + "mzm.gsp.homeland.confbean.SBanquestControllerCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  60 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.homeland.confbean.SBanquestControllerCfg"))
/*     */         {
/*     */ 
/*  63 */           SBanquestControllerCfg obj = new SBanquestControllerCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SBanquestControllerCfg> all)
/*     */   {
/*  77 */     String path = dir + "mzm.gsp.homeland.confbean.SBanquestControllerCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  89 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.homeland.confbean.SBanquestControllerCfg"))
/*     */         {
/*     */ 
/*  92 */           SBanquestControllerCfg obj = new SBanquestControllerCfg();
...
/*     */     
/* 108 */     String path = dir + "mzm.gsp.homeland.confbean.SBanquestControllerCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 135 */           SBanquestControllerCfg _v_ = new SBanquestControllerCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SBanquestControllerCfg> all)
/*     */   {
/* 155 */     String path = dir + "mzm.gsp.homeland.confbean.SBanquestControllerCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 182 */           SBanquestControllerCfg _v_ = new SBanquestControllerCfg();
...
/*     */ 
/*     */ 
/*     */   public static SBanquestControllerCfg getOld(int key)
/*     */   {
/* 203 */     return (SBanquestControllerCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SBanquestControllerCfg get(int key)
/*     */   {
/* 208 */     return (SBanquestControllerCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SBanquestControllerCfg> getOldAll()
/*     */   {
/* 213 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SBanquestControllerCfg> getAll()
/*     */   {
/* 218 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SBanquestControllerCfg> newAll)
/*     */   {
/* 223 */     oldAll = all;
/* 224 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\homeland\confbean\SBanquestControllerCfg.class
