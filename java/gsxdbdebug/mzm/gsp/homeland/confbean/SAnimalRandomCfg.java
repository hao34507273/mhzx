...
/*     */ 
/*     */ public class SAnimalRandomCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SAnimalRandomCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SAnimalRandomCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public int weightSum;
/*  20 */   public java.util.ArrayList<SAnimalWightInfo> animals = new java.util.ArrayList();
/*     */   
...
/*     */     
/*  27 */     Element collectionElement = util.XmlHelper.getVariableElement(rootElement, "animals");
...
/*  38 */       if (elem.getName().equalsIgnoreCase("mzm.gsp.homeland.confbean.SAnimalWightInfo"))
/*     */       {
/*     */         SAnimalWightInfo _v_;
/*     */         
/*     */ 
/*     */         try
/*     */         {
/*  45 */           _v_ = new SAnimalWightInfo();
...
/*  62 */     _os_.compact_uint32(this.animals.size());
/*  63 */     for (SAnimalWightInfo _v_ : this.animals)
/*     */     {
/*  65 */       _os_.marshal(_v_);
/*     */     }
/*  67 */     return _os_;
...
/*     */     {
/*     */ 
/*  77 */       SAnimalWightInfo _v_ = new SAnimalWightInfo();
/*  78 */       _v_.unmarshal(_os_);
/*  79 */       this.animals.add(_v_);
/*     */     }
/*  81 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/*  86 */     String path = dir + "mzm.gsp.homeland.confbean.SAnimalRandomCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  99 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.homeland.confbean.SAnimalRandomCfg"))
/*     */         {
/*     */ 
/* 102 */           SAnimalRandomCfg obj = new SAnimalRandomCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SAnimalRandomCfg> all)
/*     */   {
/* 116 */     String path = dir + "mzm.gsp.homeland.confbean.SAnimalRandomCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 128 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.homeland.confbean.SAnimalRandomCfg"))
/*     */         {
/*     */ 
/* 131 */           SAnimalRandomCfg obj = new SAnimalRandomCfg();
...
/*     */     
/* 147 */     String path = dir + "mzm.gsp.homeland.confbean.SAnimalRandomCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 174 */           SAnimalRandomCfg _v_ = new SAnimalRandomCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SAnimalRandomCfg> all)
/*     */   {
/* 194 */     String path = dir + "mzm.gsp.homeland.confbean.SAnimalRandomCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 221 */           SAnimalRandomCfg _v_ = new SAnimalRandomCfg();
...
/*     */ 
/*     */ 
/*     */   public static SAnimalRandomCfg getOld(int key)
/*     */   {
/* 242 */     return (SAnimalRandomCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SAnimalRandomCfg get(int key)
/*     */   {
/* 247 */     return (SAnimalRandomCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SAnimalRandomCfg> getOldAll()
/*     */   {
/* 252 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SAnimalRandomCfg> getAll()
/*     */   {
/* 257 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SAnimalRandomCfg> newAll)
/*     */   {
/* 262 */     oldAll = all;
/* 263 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\homeland\confbean\SAnimalRandomCfg.class
