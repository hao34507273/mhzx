...
/*     */ 
/*     */ public class SHomelandStyleCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SHomelandStyleCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SHomelandStyleCfg> all = null;
/*     */   
/*     */   public int id;
...
/*     */   {
/*  82 */     String path = dir + "mzm.gsp.homeland.confbean.SHomelandStyleCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  95 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.homeland.confbean.SHomelandStyleCfg"))
/*     */         {
/*     */ 
/*  98 */           SHomelandStyleCfg obj = new SHomelandStyleCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SHomelandStyleCfg> all)
/*     */   {
/* 112 */     String path = dir + "mzm.gsp.homeland.confbean.SHomelandStyleCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 124 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.homeland.confbean.SHomelandStyleCfg"))
/*     */         {
/*     */ 
/* 127 */           SHomelandStyleCfg obj = new SHomelandStyleCfg();
...
/*     */     
/* 143 */     String path = dir + "mzm.gsp.homeland.confbean.SHomelandStyleCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 170 */           SHomelandStyleCfg _v_ = new SHomelandStyleCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SHomelandStyleCfg> all)
/*     */   {
/* 190 */     String path = dir + "mzm.gsp.homeland.confbean.SHomelandStyleCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 217 */           SHomelandStyleCfg _v_ = new SHomelandStyleCfg();
...
/*     */ 
/*     */ 
/*     */   public static SHomelandStyleCfg getOld(int key)
/*     */   {
/* 238 */     return (SHomelandStyleCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SHomelandStyleCfg get(int key)
/*     */   {
/* 243 */     return (SHomelandStyleCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SHomelandStyleCfg> getOldAll()
/*     */   {
/* 248 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SHomelandStyleCfg> getAll()
/*     */   {
/* 253 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SHomelandStyleCfg> newAll)
/*     */   {
/* 258 */     oldAll = all;
/* 259 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\homeland\confbean\SHomelandStyleCfg.class
