...
/*     */ 
/*     */ public class SHomelandResourceCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SHomelandResourceCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SHomelandResourceCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public String path;
/*     */   
...
/*  24 */     this.path = rootElement.attributeValue("path");
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  29 */     _os_.marshal(this.id);
/*  30 */     _os_.marshal(this.path, "UTF-8");
/*  31 */     return _os_;
/*     */   }
/*     */   
...
/*  37 */     this.path = _os_.unmarshal_String("UTF-8");
/*  38 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.homeland.confbean.SHomelandResourceCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.homeland.confbean.SHomelandResourceCfg"))
/*     */         {
/*     */ 
/*  59 */           SHomelandResourceCfg obj = new SHomelandResourceCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SHomelandResourceCfg> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.homeland.confbean.SHomelandResourceCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.homeland.confbean.SHomelandResourceCfg"))
/*     */         {
/*     */ 
/*  88 */           SHomelandResourceCfg obj = new SHomelandResourceCfg();
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.homeland.confbean.SHomelandResourceCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           SHomelandResourceCfg _v_ = new SHomelandResourceCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SHomelandResourceCfg> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.homeland.confbean.SHomelandResourceCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           SHomelandResourceCfg _v_ = new SHomelandResourceCfg();
...
/*     */ 
/*     */ 
/*     */   public static SHomelandResourceCfg getOld(int key)
/*     */   {
/* 199 */     return (SHomelandResourceCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SHomelandResourceCfg get(int key)
/*     */   {
/* 204 */     return (SHomelandResourceCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SHomelandResourceCfg> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SHomelandResourceCfg> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SHomelandResourceCfg> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\homeland\confbean\SHomelandResourceCfg.class
