...
/*     */ 
/*     */ public class SEmbryoCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SEmbryoCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SEmbryoCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public String name;
/*     */   public int days;
...
/*  27 */     this.days = Integer.valueOf(rootElement.attributeValue("days")).intValue();
/*  28 */     this.randomGroup = Integer.valueOf(rootElement.attributeValue("randomGroup")).intValue();
/*     */   }
/*     */   
...
/*  35 */     _os_.marshal(this.days);
/*  36 */     _os_.marshal(this.randomGroup);
/*  37 */     return _os_;
/*     */   }
/*     */   
...
/*  44 */     this.days = _os_.unmarshal_int();
/*  45 */     this.randomGroup = _os_.unmarshal_int();
/*  46 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  51 */     String path = dir + "mzm.gsp.homeland.confbean.SEmbryoCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  64 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.homeland.confbean.SEmbryoCfg"))
/*     */         {
/*     */ 
/*  67 */           SEmbryoCfg obj = new SEmbryoCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SEmbryoCfg> all)
/*     */   {
/*  81 */     String path = dir + "mzm.gsp.homeland.confbean.SEmbryoCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.homeland.confbean.SEmbryoCfg"))
/*     */         {
/*     */ 
/*  96 */           SEmbryoCfg obj = new SEmbryoCfg();
...
/*     */     
/* 112 */     String path = dir + "mzm.gsp.homeland.confbean.SEmbryoCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 139 */           SEmbryoCfg _v_ = new SEmbryoCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SEmbryoCfg> all)
/*     */   {
/* 159 */     String path = dir + "mzm.gsp.homeland.confbean.SEmbryoCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 186 */           SEmbryoCfg _v_ = new SEmbryoCfg();
...
/*     */ 
/*     */ 
/*     */   public static SEmbryoCfg getOld(int key)
/*     */   {
/* 207 */     return (SEmbryoCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SEmbryoCfg get(int key)
/*     */   {
/* 212 */     return (SEmbryoCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SEmbryoCfg> getOldAll()
/*     */   {
/* 217 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SEmbryoCfg> getAll()
/*     */   {
/* 222 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SEmbryoCfg> newAll)
/*     */   {
/* 227 */     oldAll = all;
/* 228 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\homeland\confbean\SEmbryoCfg.class
