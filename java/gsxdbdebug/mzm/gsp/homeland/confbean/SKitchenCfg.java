...
/*     */ 
/*     */ public class SKitchenCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SKitchenCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SKitchenCfg> all = null;
/*     */   
/*     */   public int level;
/*     */   public int id;
...
/*     */   {
/*  63 */     String path = dir + "mzm.gsp.homeland.confbean.SKitchenCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  76 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.homeland.confbean.SKitchenCfg"))
/*     */         {
/*     */ 
/*  79 */           SKitchenCfg obj = new SKitchenCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SKitchenCfg> all)
/*     */   {
/*  93 */     String path = dir + "mzm.gsp.homeland.confbean.SKitchenCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 105 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.homeland.confbean.SKitchenCfg"))
/*     */         {
/*     */ 
/* 108 */           SKitchenCfg obj = new SKitchenCfg();
...
/*     */     
/* 124 */     String path = dir + "mzm.gsp.homeland.confbean.SKitchenCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 151 */           SKitchenCfg _v_ = new SKitchenCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SKitchenCfg> all)
/*     */   {
/* 171 */     String path = dir + "mzm.gsp.homeland.confbean.SKitchenCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 198 */           SKitchenCfg _v_ = new SKitchenCfg();
...
/*     */ 
/*     */ 
/*     */   public static SKitchenCfg getOld(int key)
/*     */   {
/* 219 */     return (SKitchenCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SKitchenCfg get(int key)
/*     */   {
/* 224 */     return (SKitchenCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SKitchenCfg> getOldAll()
/*     */   {
/* 229 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SKitchenCfg> getAll()
/*     */   {
/* 234 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SKitchenCfg> newAll)
/*     */   {
/* 239 */     oldAll = all;
/* 240 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\homeland\confbean\SKitchenCfg.class
