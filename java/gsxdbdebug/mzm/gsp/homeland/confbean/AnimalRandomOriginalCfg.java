...
/*     */ 
/*     */ public class AnimalRandomOriginalCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, AnimalRandomOriginalCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, AnimalRandomOriginalCfg> all = null;
/*     */   
/*     */   public int id;
...
/*  26 */     this.randomGroup = Integer.valueOf(rootElement.attributeValue("randomGroup")).intValue();
/*  27 */     this.animalCfgid = Integer.valueOf(rootElement.attributeValue("animalCfgid")).intValue();
...
/*  34 */     _os_.marshal(this.randomGroup);
/*  35 */     _os_.marshal(this.animalCfgid);
...
/*  43 */     this.randomGroup = _os_.unmarshal_int();
/*  44 */     this.animalCfgid = _os_.unmarshal_int();
...
/*     */   {
/*  51 */     String path = dir + "mzm.gsp.homeland.confbean.AnimalRandomOriginalCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  64 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.homeland.confbean.AnimalRandomOriginalCfg"))
/*     */         {
/*     */ 
/*  67 */           AnimalRandomOriginalCfg obj = new AnimalRandomOriginalCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, AnimalRandomOriginalCfg> all)
/*     */   {
/*  81 */     String path = dir + "mzm.gsp.homeland.confbean.AnimalRandomOriginalCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.homeland.confbean.AnimalRandomOriginalCfg"))
/*     */         {
/*     */ 
/*  96 */           AnimalRandomOriginalCfg obj = new AnimalRandomOriginalCfg();
...
/*     */     
/* 112 */     String path = dir + "mzm.gsp.homeland.confbean.AnimalRandomOriginalCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 139 */           AnimalRandomOriginalCfg _v_ = new AnimalRandomOriginalCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, AnimalRandomOriginalCfg> all)
/*     */   {
/* 159 */     String path = dir + "mzm.gsp.homeland.confbean.AnimalRandomOriginalCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 186 */           AnimalRandomOriginalCfg _v_ = new AnimalRandomOriginalCfg();
...
/*     */ 
/*     */ 
/*     */   public static AnimalRandomOriginalCfg getOld(int key)
/*     */   {
/* 207 */     return (AnimalRandomOriginalCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static AnimalRandomOriginalCfg get(int key)
/*     */   {
/* 212 */     return (AnimalRandomOriginalCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, AnimalRandomOriginalCfg> getOldAll()
/*     */   {
/* 217 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, AnimalRandomOriginalCfg> getAll()
/*     */   {
/* 222 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, AnimalRandomOriginalCfg> newAll)
/*     */   {
/* 227 */     oldAll = all;
/* 228 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\homeland\confbean\AnimalRandomOriginalCfg.class
