...
/*     */ 
/*     */ public class SPetRoomCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SPetRoomCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SPetRoomCfg> all = null;
/*     */   
/*     */   public int level;
/*     */   public int id;
...
/*  33 */     this.dayTrainCount = Integer.valueOf(rootElement.attributeValue("dayTrainCount")).intValue();
/*  34 */     this.addExpNum = Integer.valueOf(rootElement.attributeValue("addExpNum")).intValue();
/*     */   }
/*     */   
...
/*  44 */     _os_.marshal(this.dayTrainCount);
/*  45 */     _os_.marshal(this.addExpNum);
/*  46 */     return _os_;
/*     */   }
/*     */   
...
/*  56 */     this.dayTrainCount = _os_.unmarshal_int();
/*  57 */     this.addExpNum = _os_.unmarshal_int();
/*  58 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  63 */     String path = dir + "mzm.gsp.homeland.confbean.SPetRoomCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  76 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.homeland.confbean.SPetRoomCfg"))
/*     */         {
/*     */ 
/*  79 */           SPetRoomCfg obj = new SPetRoomCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SPetRoomCfg> all)
/*     */   {
/*  93 */     String path = dir + "mzm.gsp.homeland.confbean.SPetRoomCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 105 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.homeland.confbean.SPetRoomCfg"))
/*     */         {
/*     */ 
/* 108 */           SPetRoomCfg obj = new SPetRoomCfg();
...
/*     */     
/* 124 */     String path = dir + "mzm.gsp.homeland.confbean.SPetRoomCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 151 */           SPetRoomCfg _v_ = new SPetRoomCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SPetRoomCfg> all)
/*     */   {
/* 171 */     String path = dir + "mzm.gsp.homeland.confbean.SPetRoomCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 198 */           SPetRoomCfg _v_ = new SPetRoomCfg();
...
/*     */ 
/*     */ 
/*     */   public static SPetRoomCfg getOld(int key)
/*     */   {
/* 219 */     return (SPetRoomCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SPetRoomCfg get(int key)
/*     */   {
/* 224 */     return (SPetRoomCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPetRoomCfg> getOldAll()
/*     */   {
/* 229 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPetRoomCfg> getAll()
/*     */   {
/* 234 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SPetRoomCfg> newAll)
/*     */   {
/* 239 */     oldAll = all;
/* 240 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\homeland\confbean\SPetRoomCfg.class
