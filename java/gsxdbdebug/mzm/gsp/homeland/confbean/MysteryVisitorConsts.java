...
/*     */ 
/*     */ public class MysteryVisitorConsts
/*     */ {
/*  13 */   private static volatile MysteryVisitorConsts oldInstance = null;
/*     */   
/*  15 */   private static MysteryVisitorConsts instance = new MysteryVisitorConsts();
/*     */   
/*     */   public int ACTIVITY_CFG_ID;
/*     */   
/*     */   public int REMIND_MAIL_CFG_ID;
/*     */   
/*     */   public static MysteryVisitorConsts getOldInstance()
/*     */   {
/*  23 */     return oldInstance;
/*     */   }
/*     */   
/*     */   public static MysteryVisitorConsts getInstance()
/*     */   {
/*  28 */     return instance;
/*     */   }
/*     */   
...
/*     */   {
/*  41 */     String path = dir + "mzm.gsp.homeland.confbean.MysteryVisitorConsts.xml";
/*     */     try
/*     */     {
...
/*  62 */       this.REMIND_MAIL_CFG_ID = Integer.valueOf(((Element)data.get("REMIND_MAIL_CFG_ID")).attributeValue("value")).intValue();
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*  71 */     String path = dir + "mzm.gsp.homeland.confbean.MysteryVisitorConsts.xml";
/*     */     try
/*     */     {
...
/*  92 */       this.REMIND_MAIL_CFG_ID = Integer.valueOf(((Element)data.get("REMIND_MAIL_CFG_ID")).attributeValue("value")).intValue();
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/* 103 */     String path = dir + "mzm.gsp.homeland.confbean.MysteryVisitorConsts.bny";
/*     */     try
/*     */     {
...
/* 119 */         this.REMIND_MAIL_CFG_ID = _os_.unmarshal_int();
/*     */       }
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*     */   {
/* 130 */     String path = dir + "mzm.gsp.homeland.confbean.MysteryVisitorConsts.bny";
/*     */     try
/*     */     {
...
/* 146 */         this.REMIND_MAIL_CFG_ID = _os_.unmarshal_int();
/*     */       }
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*     */   }
/*     */   
/*     */   public static void setInstance(MysteryVisitorConsts newInstance)
/*     */   {
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\homeland\confbean\MysteryVisitorConsts.class
