...
/*     */ 
/*     */ public class MysteryVisitorNPCIdCfgOriginal implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, MysteryVisitorNPCIdCfgOriginal> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, MysteryVisitorNPCIdCfgOriginal> all = null;
/*     */   
/*     */   public int id;
...
/*  26 */     this.npc_lib_id = Integer.valueOf(rootElement.attributeValue("npc_lib_id")).intValue();
/*  27 */     this.map_cfg_id = Integer.valueOf(rootElement.attributeValue("map_cfg_id")).intValue();
...
/*  34 */     _os_.marshal(this.npc_lib_id);
/*  35 */     _os_.marshal(this.map_cfg_id);
/*  36 */     _os_.marshal(this.npc_id);
/*  37 */     return _os_;
/*     */   }
/*     */   
...
/*  43 */     this.npc_lib_id = _os_.unmarshal_int();
/*  44 */     this.map_cfg_id = _os_.unmarshal_int();
/*  45 */     this.npc_id = _os_.unmarshal_int();
/*  46 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  51 */     String path = dir + "mzm.gsp.homeland.confbean.MysteryVisitorNPCIdCfgOriginal.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  64 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.homeland.confbean.MysteryVisitorNPCIdCfgOriginal"))
/*     */         {
/*     */ 
/*  67 */           MysteryVisitorNPCIdCfgOriginal obj = new MysteryVisitorNPCIdCfgOriginal();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, MysteryVisitorNPCIdCfgOriginal> all)
/*     */   {
/*  81 */     String path = dir + "mzm.gsp.homeland.confbean.MysteryVisitorNPCIdCfgOriginal.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.homeland.confbean.MysteryVisitorNPCIdCfgOriginal"))
/*     */         {
/*     */ 
/*  96 */           MysteryVisitorNPCIdCfgOriginal obj = new MysteryVisitorNPCIdCfgOriginal();
...
/*     */     
/* 112 */     String path = dir + "mzm.gsp.homeland.confbean.MysteryVisitorNPCIdCfgOriginal.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 139 */           MysteryVisitorNPCIdCfgOriginal _v_ = new MysteryVisitorNPCIdCfgOriginal();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, MysteryVisitorNPCIdCfgOriginal> all)
/*     */   {
/* 159 */     String path = dir + "mzm.gsp.homeland.confbean.MysteryVisitorNPCIdCfgOriginal.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 186 */           MysteryVisitorNPCIdCfgOriginal _v_ = new MysteryVisitorNPCIdCfgOriginal();
...
/*     */ 
/*     */ 
/*     */   public static MysteryVisitorNPCIdCfgOriginal getOld(int key)
/*     */   {
/* 207 */     return (MysteryVisitorNPCIdCfgOriginal)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static MysteryVisitorNPCIdCfgOriginal get(int key)
/*     */   {
/* 212 */     return (MysteryVisitorNPCIdCfgOriginal)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, MysteryVisitorNPCIdCfgOriginal> getOldAll()
/*     */   {
/* 217 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, MysteryVisitorNPCIdCfgOriginal> getAll()
/*     */   {
/* 222 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, MysteryVisitorNPCIdCfgOriginal> newAll)
/*     */   {
/* 227 */     oldAll = all;
/* 228 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\homeland\confbean\MysteryVisitorNPCIdCfgOriginal.class
