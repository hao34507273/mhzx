...
/*     */ 
/*     */ public class GroundResourceCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, GroundResourceCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, GroundResourceCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public int itemId;
/*     */   
...
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.homeland.confbean.GroundResourceCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.homeland.confbean.GroundResourceCfg"))
/*     */         {
/*     */ 
/*  59 */           GroundResourceCfg obj = new GroundResourceCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, GroundResourceCfg> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.homeland.confbean.GroundResourceCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.homeland.confbean.GroundResourceCfg"))
/*     */         {
/*     */ 
/*  88 */           GroundResourceCfg obj = new GroundResourceCfg();
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.homeland.confbean.GroundResourceCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           GroundResourceCfg _v_ = new GroundResourceCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, GroundResourceCfg> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.homeland.confbean.GroundResourceCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           GroundResourceCfg _v_ = new GroundResourceCfg();
...
/*     */ 
/*     */ 
/*     */   public static GroundResourceCfg getOld(int key)
/*     */   {
/* 199 */     return (GroundResourceCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static GroundResourceCfg get(int key)
/*     */   {
/* 204 */     return (GroundResourceCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, GroundResourceCfg> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, GroundResourceCfg> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, GroundResourceCfg> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\homeland\confbean\GroundResourceCfg.class
