...
/*     */ 
/*     */ public class SMysteryVisitorCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SMysteryVisitorCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SMysteryVisitorCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public int type;
/*     */   public int award_id;
...
/*     */   {
/*  47 */     String path = dir + "mzm.gsp.homeland.confbean.SMysteryVisitorCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  60 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.homeland.confbean.SMysteryVisitorCfg"))
/*     */         {
/*     */ 
/*  63 */           SMysteryVisitorCfg obj = new SMysteryVisitorCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SMysteryVisitorCfg> all)
/*     */   {
/*  77 */     String path = dir + "mzm.gsp.homeland.confbean.SMysteryVisitorCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  89 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.homeland.confbean.SMysteryVisitorCfg"))
/*     */         {
/*     */ 
/*  92 */           SMysteryVisitorCfg obj = new SMysteryVisitorCfg();
...
/*     */     
/* 108 */     String path = dir + "mzm.gsp.homeland.confbean.SMysteryVisitorCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 135 */           SMysteryVisitorCfg _v_ = new SMysteryVisitorCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SMysteryVisitorCfg> all)
/*     */   {
/* 155 */     String path = dir + "mzm.gsp.homeland.confbean.SMysteryVisitorCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 182 */           SMysteryVisitorCfg _v_ = new SMysteryVisitorCfg();
...
/*     */ 
/*     */ 
/*     */   public static SMysteryVisitorCfg getOld(int key)
/*     */   {
/* 203 */     return (SMysteryVisitorCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SMysteryVisitorCfg get(int key)
/*     */   {
/* 208 */     return (SMysteryVisitorCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMysteryVisitorCfg> getOldAll()
/*     */   {
/* 213 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMysteryVisitorCfg> getAll()
/*     */   {
/* 218 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SMysteryVisitorCfg> newAll)
/*     */   {
/* 223 */     oldAll = all;
/* 224 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\homeland\confbean\SMysteryVisitorCfg.class
