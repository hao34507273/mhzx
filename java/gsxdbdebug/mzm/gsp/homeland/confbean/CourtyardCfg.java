...
/*     */ 
/*     */ public class CourtyardCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, CourtyardCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, CourtyardCfg> all = null;
/*     */   
/*     */   public int mapId;
/*     */   public int id;
...
/*     */   {
/* 125 */     String path = dir + "mzm.gsp.homeland.confbean.CourtyardCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 138 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.homeland.confbean.CourtyardCfg"))
/*     */         {
/*     */ 
/* 141 */           CourtyardCfg obj = new CourtyardCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, CourtyardCfg> all)
/*     */   {
/* 155 */     String path = dir + "mzm.gsp.homeland.confbean.CourtyardCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 167 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.homeland.confbean.CourtyardCfg"))
/*     */         {
/*     */ 
/* 170 */           CourtyardCfg obj = new CourtyardCfg();
...
/*     */     
/* 186 */     String path = dir + "mzm.gsp.homeland.confbean.CourtyardCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 213 */           CourtyardCfg _v_ = new CourtyardCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, CourtyardCfg> all)
/*     */   {
/* 233 */     String path = dir + "mzm.gsp.homeland.confbean.CourtyardCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 260 */           CourtyardCfg _v_ = new CourtyardCfg();
...
/*     */ 
/*     */ 
/*     */   public static CourtyardCfg getOld(int key)
/*     */   {
/* 281 */     return (CourtyardCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static CourtyardCfg get(int key)
/*     */   {
/* 286 */     return (CourtyardCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, CourtyardCfg> getOldAll()
/*     */   {
/* 291 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, CourtyardCfg> getAll()
/*     */   {
/* 296 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, CourtyardCfg> newAll)
/*     */   {
/* 301 */     oldAll = all;
/* 302 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\homeland\confbean\CourtyardCfg.class
