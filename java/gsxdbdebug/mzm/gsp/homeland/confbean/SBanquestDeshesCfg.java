...
/*     */ 
/*     */ public class SBanquestDeshesCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SBanquestDeshesCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SBanquestDeshesCfg> all = null;
/*     */   
/*     */   public int id;
...
/*  26 */     this.mapItemCfgId = Integer.valueOf(rootElement.attributeValue("mapItemCfgId")).intValue();
/*     */   }
/*     */   
...
/*  33 */     _os_.marshal(this.mapItemCfgId);
/*  34 */     return _os_;
/*     */   }
/*     */   
...
/*  41 */     this.mapItemCfgId = _os_.unmarshal_int();
/*  42 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  47 */     String path = dir + "mzm.gsp.homeland.confbean.SBanquestDeshesCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  60 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.homeland.confbean.SBanquestDeshesCfg"))
/*     */         {
/*     */ 
/*  63 */           SBanquestDeshesCfg obj = new SBanquestDeshesCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SBanquestDeshesCfg> all)
/*     */   {
/*  77 */     String path = dir + "mzm.gsp.homeland.confbean.SBanquestDeshesCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  89 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.homeland.confbean.SBanquestDeshesCfg"))
/*     */         {
/*     */ 
/*  92 */           SBanquestDeshesCfg obj = new SBanquestDeshesCfg();
...
/*     */     
/* 108 */     String path = dir + "mzm.gsp.homeland.confbean.SBanquestDeshesCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 135 */           SBanquestDeshesCfg _v_ = new SBanquestDeshesCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SBanquestDeshesCfg> all)
/*     */   {
/* 155 */     String path = dir + "mzm.gsp.homeland.confbean.SBanquestDeshesCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 182 */           SBanquestDeshesCfg _v_ = new SBanquestDeshesCfg();
...
/*     */ 
/*     */ 
/*     */   public static SBanquestDeshesCfg getOld(int key)
/*     */   {
/* 203 */     return (SBanquestDeshesCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SBanquestDeshesCfg get(int key)
/*     */   {
/* 208 */     return (SBanquestDeshesCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SBanquestDeshesCfg> getOldAll()
/*     */   {
/* 213 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SBanquestDeshesCfg> getAll()
/*     */   {
/* 218 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SBanquestDeshesCfg> newAll)
/*     */   {
/* 223 */     oldAll = all;
/* 224 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\homeland\confbean\SBanquestDeshesCfg.class
