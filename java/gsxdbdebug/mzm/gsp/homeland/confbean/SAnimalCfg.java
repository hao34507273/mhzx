...
/*     */ 
/*     */ public class SAnimalCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SAnimalCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SAnimalCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public String name;
/*     */   public int starType;
...
/*  29 */     this.starType = Integer.valueOf(rootElement.attributeValue("starType")).intValue();
/*  30 */     this.awardCfgid = Integer.valueOf(rootElement.attributeValue("awardCfgid")).intValue();
/*  31 */     this.mateCd = Integer.valueOf(rootElement.attributeValue("mateCd")).intValue();
/*  32 */     this.life = Integer.valueOf(rootElement.attributeValue("life")).intValue();
/*     */   }
/*     */   
...
/*  39 */     _os_.marshal(this.starType);
/*  40 */     _os_.marshal(this.awardCfgid);
/*  41 */     _os_.marshal(this.mateCd);
/*  42 */     _os_.marshal(this.life);
/*  43 */     return _os_;
/*     */   }
/*     */   
...
/*  50 */     this.starType = _os_.unmarshal_int();
/*  51 */     this.awardCfgid = _os_.unmarshal_int();
/*  52 */     this.mateCd = _os_.unmarshal_int();
/*  53 */     this.life = _os_.unmarshal_int();
/*  54 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  59 */     String path = dir + "mzm.gsp.homeland.confbean.SAnimalCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  72 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.homeland.confbean.SAnimalCfg"))
/*     */         {
/*     */ 
/*  75 */           SAnimalCfg obj = new SAnimalCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SAnimalCfg> all)
/*     */   {
/*  89 */     String path = dir + "mzm.gsp.homeland.confbean.SAnimalCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 101 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.homeland.confbean.SAnimalCfg"))
/*     */         {
/*     */ 
/* 104 */           SAnimalCfg obj = new SAnimalCfg();
...
/*     */     
/* 120 */     String path = dir + "mzm.gsp.homeland.confbean.SAnimalCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 147 */           SAnimalCfg _v_ = new SAnimalCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SAnimalCfg> all)
/*     */   {
/* 167 */     String path = dir + "mzm.gsp.homeland.confbean.SAnimalCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 194 */           SAnimalCfg _v_ = new SAnimalCfg();
...
/*     */ 
/*     */ 
/*     */   public static SAnimalCfg getOld(int key)
/*     */   {
/* 215 */     return (SAnimalCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SAnimalCfg get(int key)
/*     */   {
/* 220 */     return (SAnimalCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SAnimalCfg> getOldAll()
/*     */   {
/* 225 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SAnimalCfg> getAll()
/*     */   {
/* 230 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SAnimalCfg> newAll)
/*     */   {
/* 235 */     oldAll = all;
/* 236 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\homeland\confbean\SAnimalCfg.class
