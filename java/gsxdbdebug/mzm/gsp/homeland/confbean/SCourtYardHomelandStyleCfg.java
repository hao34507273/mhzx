...
/*     */ 
/*     */ public class SCourtYardHomelandStyleCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SCourtYardHomelandStyleCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SCourtYardHomelandStyleCfg> all = null;
/*     */   
/*     */   public int id;
/*  19 */   public java.util.ArrayList<FurnitureNum2Point> furnitureNum2point = new java.util.ArrayList();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.id = Integer.valueOf(rootElement.attributeValue("id")).intValue();
/*     */     
/*  25 */     Element collectionElement = util.XmlHelper.getVariableElement(rootElement, "furnitureNum2point");
...
/*  36 */       if (elem.getName().equalsIgnoreCase("mzm.gsp.homeland.confbean.FurnitureNum2Point"))
/*     */       {
/*     */         FurnitureNum2Point _v_;
/*     */         
/*     */ 
/*     */         try
/*     */         {
/*  43 */           _v_ = new FurnitureNum2Point();
...
/*     */         }
/*     */         
/*  51 */         this.furnitureNum2point.add(_v_);
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*  59 */     _os_.compact_uint32(this.furnitureNum2point.size());
/*  60 */     for (FurnitureNum2Point _v_ : this.furnitureNum2point)
/*     */     {
/*  62 */       _os_.marshal(_v_);
/*     */     }
/*  64 */     return _os_;
...
/*     */     {
/*     */ 
/*  73 */       FurnitureNum2Point _v_ = new FurnitureNum2Point();
/*  74 */       _v_.unmarshal(_os_);
/*  75 */       this.furnitureNum2point.add(_v_);
/*     */     }
/*  77 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/*  82 */     String path = dir + "mzm.gsp.homeland.confbean.SCourtYardHomelandStyleCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  95 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.homeland.confbean.SCourtYardHomelandStyleCfg"))
/*     */         {
/*     */ 
/*  98 */           SCourtYardHomelandStyleCfg obj = new SCourtYardHomelandStyleCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SCourtYardHomelandStyleCfg> all)
/*     */   {
/* 112 */     String path = dir + "mzm.gsp.homeland.confbean.SCourtYardHomelandStyleCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 124 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.homeland.confbean.SCourtYardHomelandStyleCfg"))
/*     */         {
/*     */ 
/* 127 */           SCourtYardHomelandStyleCfg obj = new SCourtYardHomelandStyleCfg();
...
/*     */     
/* 143 */     String path = dir + "mzm.gsp.homeland.confbean.SCourtYardHomelandStyleCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 170 */           SCourtYardHomelandStyleCfg _v_ = new SCourtYardHomelandStyleCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SCourtYardHomelandStyleCfg> all)
/*     */   {
/* 190 */     String path = dir + "mzm.gsp.homeland.confbean.SCourtYardHomelandStyleCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 217 */           SCourtYardHomelandStyleCfg _v_ = new SCourtYardHomelandStyleCfg();
...
/*     */ 
/*     */ 
/*     */   public static SCourtYardHomelandStyleCfg getOld(int key)
/*     */   {
/* 238 */     return (SCourtYardHomelandStyleCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SCourtYardHomelandStyleCfg get(int key)
/*     */   {
/* 243 */     return (SCourtYardHomelandStyleCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SCourtYardHomelandStyleCfg> getOldAll()
/*     */   {
/* 248 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SCourtYardHomelandStyleCfg> getAll()
/*     */   {
/* 253 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SCourtYardHomelandStyleCfg> newAll)
/*     */   {
/* 258 */     oldAll = all;
/* 259 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\homeland\confbean\SCourtYardHomelandStyleCfg.class
