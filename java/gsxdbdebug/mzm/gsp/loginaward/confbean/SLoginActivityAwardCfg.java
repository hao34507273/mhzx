...
/*     */ 
/*     */ public class SLoginActivityAwardCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SLoginActivityAwardCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SLoginActivityAwardCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public int mailCfgId;
/*  20 */   public HashMap<Integer, SLoginActivityAwardInfo> awardInfos = new HashMap();
/*     */   
...
/*  53 */             keyElem = elem;
/*     */           }
/*  55 */           else if ((valueElem == null) && (elem.getName().equalsIgnoreCase("mzm.gsp.loginaward.confbean.SLoginActivityAwardInfo")))
/*     */           {
/*  57 */             valueElem = elem;
/*     */           }
/*     */         }
...
/*     */         
/*     */         int _k_;
/*     */         SLoginActivityAwardInfo _v_;
/*     */         try
/*     */         {
/*  70 */           _k_ = Integer.valueOf(keyElem.getText()).intValue();
/*  71 */           _v_ = new SLoginActivityAwardInfo();
...
/*  89 */     for (java.util.Map.Entry<Integer, SLoginActivityAwardInfo> _e_ : this.awardInfos.entrySet())
/*     */     {
...
/*     */       
/* 106 */       SLoginActivityAwardInfo _v_ = new SLoginActivityAwardInfo();
...
/*     */   {
/* 115 */     String path = dir + "mzm.gsp.loginaward.confbean.SLoginActivityAwardCfg.xml";
/*     */     
/*     */     try
/*     */     {
/* 119 */       all = new HashMap();
...
/* 128 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.loginaward.confbean.SLoginActivityAwardCfg"))
/*     */         {
/*     */ 
/* 131 */           SLoginActivityAwardCfg obj = new SLoginActivityAwardCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SLoginActivityAwardCfg> all)
/*     */   {
/* 145 */     String path = dir + "mzm.gsp.loginaward.confbean.SLoginActivityAwardCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 157 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.loginaward.confbean.SLoginActivityAwardCfg"))
/*     */         {
/*     */ 
/* 160 */           SLoginActivityAwardCfg obj = new SLoginActivityAwardCfg();
...
/* 174 */     all = new HashMap();
/*     */     
/* 176 */     String path = dir + "mzm.gsp.loginaward.confbean.SLoginActivityAwardCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 203 */           SLoginActivityAwardCfg _v_ = new SLoginActivityAwardCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SLoginActivityAwardCfg> all)
/*     */   {
/* 223 */     String path = dir + "mzm.gsp.loginaward.confbean.SLoginActivityAwardCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 250 */           SLoginActivityAwardCfg _v_ = new SLoginActivityAwardCfg();
...
/*     */ 
/*     */ 
/*     */   public static SLoginActivityAwardCfg getOld(int key)
/*     */   {
/* 271 */     return (SLoginActivityAwardCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SLoginActivityAwardCfg get(int key)
/*     */   {
/* 276 */     return (SLoginActivityAwardCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SLoginActivityAwardCfg> getOldAll()
/*     */   {
/* 281 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SLoginActivityAwardCfg> getAll()
/*     */   {
/* 286 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SLoginActivityAwardCfg> newAll)
/*     */   {
/* 291 */     oldAll = all;
/* 292 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\loginaward\confbean\SLoginActivityAwardCfg.class
