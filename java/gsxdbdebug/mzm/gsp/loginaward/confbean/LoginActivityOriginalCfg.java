...
/*     */ 
/*     */ public class LoginActivityOriginalCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, LoginActivityOriginalCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, LoginActivityOriginalCfg> all = null;
/*     */   
/*     */   public int id;
...
/*  30 */     this.loginDay = Integer.valueOf(rootElement.attributeValue("loginDay")).intValue();
...
/*  51 */     this.loginDay = _os_.unmarshal_int();
...
/*     */   {
/*  59 */     String path = dir + "mzm.gsp.loginaward.confbean.LoginActivityOriginalCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  72 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.loginaward.confbean.LoginActivityOriginalCfg"))
/*     */         {
/*     */ 
/*  75 */           LoginActivityOriginalCfg obj = new LoginActivityOriginalCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, LoginActivityOriginalCfg> all)
/*     */   {
/*  89 */     String path = dir + "mzm.gsp.loginaward.confbean.LoginActivityOriginalCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 101 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.loginaward.confbean.LoginActivityOriginalCfg"))
/*     */         {
/*     */ 
/* 104 */           LoginActivityOriginalCfg obj = new LoginActivityOriginalCfg();
...
/*     */     
/* 120 */     String path = dir + "mzm.gsp.loginaward.confbean.LoginActivityOriginalCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 147 */           LoginActivityOriginalCfg _v_ = new LoginActivityOriginalCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, LoginActivityOriginalCfg> all)
/*     */   {
/* 167 */     String path = dir + "mzm.gsp.loginaward.confbean.LoginActivityOriginalCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 194 */           LoginActivityOriginalCfg _v_ = new LoginActivityOriginalCfg();
...
/*     */ 
/*     */ 
/*     */   public static LoginActivityOriginalCfg getOld(int key)
/*     */   {
/* 215 */     return (LoginActivityOriginalCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static LoginActivityOriginalCfg get(int key)
/*     */   {
/* 220 */     return (LoginActivityOriginalCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, LoginActivityOriginalCfg> getOldAll()
/*     */   {
/* 225 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, LoginActivityOriginalCfg> getAll()
/*     */   {
/* 230 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, LoginActivityOriginalCfg> newAll)
/*     */   {
/* 235 */     oldAll = all;
/* 236 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\loginaward\confbean\LoginActivityOriginalCfg.class
