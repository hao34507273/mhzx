...
/*     */ 
/*     */ public class LoginSignActivityOriginalCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, LoginSignActivityOriginalCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, LoginSignActivityOriginalCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public int sortId;
...
/*  26 */     this.sortId = Integer.valueOf(rootElement.attributeValue("sortId")).intValue();
/*  27 */     this.awardCfgId = Integer.valueOf(rootElement.attributeValue("awardCfgId")).intValue();
...
/*  34 */     _os_.marshal(this.sortId);
/*  35 */     _os_.marshal(this.awardCfgId);
/*  36 */     _os_.marshal(this.activityCfgid);
/*  37 */     return _os_;
/*     */   }
/*     */   
...
/*  43 */     this.sortId = _os_.unmarshal_int();
/*  44 */     this.awardCfgId = _os_.unmarshal_int();
...
/*     */   {
/*  51 */     String path = dir + "mzm.gsp.loginaward.confbean.LoginSignActivityOriginalCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  64 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.loginaward.confbean.LoginSignActivityOriginalCfg"))
/*     */         {
/*     */ 
/*  67 */           LoginSignActivityOriginalCfg obj = new LoginSignActivityOriginalCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, LoginSignActivityOriginalCfg> all)
/*     */   {
/*  81 */     String path = dir + "mzm.gsp.loginaward.confbean.LoginSignActivityOriginalCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.loginaward.confbean.LoginSignActivityOriginalCfg"))
/*     */         {
/*     */ 
/*  96 */           LoginSignActivityOriginalCfg obj = new LoginSignActivityOriginalCfg();
...
/*     */     
/* 112 */     String path = dir + "mzm.gsp.loginaward.confbean.LoginSignActivityOriginalCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 139 */           LoginSignActivityOriginalCfg _v_ = new LoginSignActivityOriginalCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, LoginSignActivityOriginalCfg> all)
/*     */   {
/* 159 */     String path = dir + "mzm.gsp.loginaward.confbean.LoginSignActivityOriginalCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 186 */           LoginSignActivityOriginalCfg _v_ = new LoginSignActivityOriginalCfg();
...
/*     */ 
/*     */ 
/*     */   public static LoginSignActivityOriginalCfg getOld(int key)
/*     */   {
/* 207 */     return (LoginSignActivityOriginalCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static LoginSignActivityOriginalCfg get(int key)
/*     */   {
/* 212 */     return (LoginSignActivityOriginalCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, LoginSignActivityOriginalCfg> getOldAll()
/*     */   {
/* 217 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, LoginSignActivityOriginalCfg> getAll()
/*     */   {
/* 222 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, LoginSignActivityOriginalCfg> newAll)
/*     */   {
/* 227 */     oldAll = all;
/* 228 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\loginaward\confbean\LoginSignActivityOriginalCfg.class
