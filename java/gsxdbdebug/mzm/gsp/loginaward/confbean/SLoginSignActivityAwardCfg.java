...
/*     */ 
/*     */ public class SLoginSignActivityAwardCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SLoginSignActivityAwardCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SLoginSignActivityAwardCfg> all = null;
/*     */   
/*     */   public int id;
/*  19 */   public HashMap<Integer, SLoginSignActivityAwardInfo> awardInfos = new HashMap();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.id = Integer.valueOf(rootElement.attributeValue("id")).intValue();
/*     */     
/*  25 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "awardInfos");
...
/*  51 */             keyElem = elem;
/*     */           }
/*  53 */           else if ((valueElem == null) && (elem.getName().equalsIgnoreCase("mzm.gsp.loginaward.confbean.SLoginSignActivityAwardInfo")))
/*     */           {
/*  55 */             valueElem = elem;
/*     */           }
/*     */         }
...
/*     */         
/*     */         int _k_;
/*     */         SLoginSignActivityAwardInfo _v_;
/*     */         try
/*     */         {
/*  68 */           _k_ = Integer.valueOf(keyElem.getText()).intValue();
/*  69 */           _v_ = new SLoginSignActivityAwardInfo();
...
/*     */         }
/*     */         
/*  77 */         this.awardInfos.put(Integer.valueOf(_k_), _v_);
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*  85 */     _os_.compact_uint32(this.awardInfos.size());
/*  86 */     for (java.util.Map.Entry<Integer, SLoginSignActivityAwardInfo> _e_ : this.awardInfos.entrySet())
/*     */     {
...
/*     */       
/* 102 */       SLoginSignActivityAwardInfo _v_ = new SLoginSignActivityAwardInfo();
/* 103 */       _v_.unmarshal(_os_);
/* 104 */       this.awardInfos.put(Integer.valueOf(_k_), _v_);
/*     */     }
/* 106 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/* 111 */     String path = dir + "mzm.gsp.loginaward.confbean.SLoginSignActivityAwardCfg.xml";
/*     */     
/*     */     try
/*     */     {
/* 115 */       all = new HashMap();
...
/* 124 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.loginaward.confbean.SLoginSignActivityAwardCfg"))
/*     */         {
/*     */ 
/* 127 */           SLoginSignActivityAwardCfg obj = new SLoginSignActivityAwardCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SLoginSignActivityAwardCfg> all)
/*     */   {
/* 141 */     String path = dir + "mzm.gsp.loginaward.confbean.SLoginSignActivityAwardCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 153 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.loginaward.confbean.SLoginSignActivityAwardCfg"))
/*     */         {
/*     */ 
/* 156 */           SLoginSignActivityAwardCfg obj = new SLoginSignActivityAwardCfg();
...
/* 170 */     all = new HashMap();
/*     */     
/* 172 */     String path = dir + "mzm.gsp.loginaward.confbean.SLoginSignActivityAwardCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 199 */           SLoginSignActivityAwardCfg _v_ = new SLoginSignActivityAwardCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SLoginSignActivityAwardCfg> all)
/*     */   {
/* 219 */     String path = dir + "mzm.gsp.loginaward.confbean.SLoginSignActivityAwardCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 246 */           SLoginSignActivityAwardCfg _v_ = new SLoginSignActivityAwardCfg();
...
/*     */ 
/*     */ 
/*     */   public static SLoginSignActivityAwardCfg getOld(int key)
/*     */   {
/* 267 */     return (SLoginSignActivityAwardCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SLoginSignActivityAwardCfg get(int key)
/*     */   {
/* 272 */     return (SLoginSignActivityAwardCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SLoginSignActivityAwardCfg> getOldAll()
/*     */   {
/* 277 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SLoginSignActivityAwardCfg> getAll()
/*     */   {
/* 282 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SLoginSignActivityAwardCfg> newAll)
/*     */   {
/* 287 */     oldAll = all;
/* 288 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\loginaward\confbean\SLoginSignActivityAwardCfg.class
