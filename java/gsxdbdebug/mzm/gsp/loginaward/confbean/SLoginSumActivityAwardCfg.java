...
/*     */ 
/*     */ public class SLoginSumActivityAwardCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SLoginSumActivityAwardCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SLoginSumActivityAwardCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public int mailCfgId;
/*  20 */   public HashMap<Integer, SLoginSumActivityAwardInfo> awardInfos = new HashMap();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  24 */     this.id = Integer.valueOf(rootElement.attributeValue("id")).intValue();
/*  25 */     this.mailCfgId = Integer.valueOf(rootElement.attributeValue("mailCfgId")).intValue();
/*     */     
/*  27 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "awardInfos");
...
/*  53 */             keyElem = elem;
/*     */           }
/*  55 */           else if ((valueElem == null) && (elem.getName().equalsIgnoreCase("mzm.gsp.loginaward.confbean.SLoginSumActivityAwardInfo")))
/*     */           {
/*  57 */             valueElem = elem;
/*     */           }
/*     */         }
...
/*     */         
/*     */         int _k_;
/*     */         SLoginSumActivityAwardInfo _v_;
/*     */         try
/*     */         {
/*  70 */           _k_ = Integer.valueOf(keyElem.getText()).intValue();
/*  71 */           _v_ = new SLoginSumActivityAwardInfo();
...
/*     */         }
/*     */         
/*  79 */         this.awardInfos.put(Integer.valueOf(_k_), _v_);
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*  87 */     _os_.marshal(this.mailCfgId);
/*  88 */     _os_.compact_uint32(this.awardInfos.size());
/*  89 */     for (java.util.Map.Entry<Integer, SLoginSumActivityAwardInfo> _e_ : this.awardInfos.entrySet())
/*     */     {
...
/* 100 */     this.mailCfgId = _os_.unmarshal_int();
/* 101 */     for (int _size_ = _os_.uncompact_uint32(); _size_ > 0; _size_--)
/*     */     {
/*     */ 
/* 104 */       int _k_ = _os_.unmarshal_int();
/*     */       
/* 106 */       SLoginSumActivityAwardInfo _v_ = new SLoginSumActivityAwardInfo();
/* 107 */       _v_.unmarshal(_os_);
/* 108 */       this.awardInfos.put(Integer.valueOf(_k_), _v_);
/*     */     }
/* 110 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/* 115 */     String path = dir + "mzm.gsp.loginaward.confbean.SLoginSumActivityAwardCfg.xml";
/*     */     
/*     */     try
/*     */     {
/* 119 */       all = new HashMap();
...
/* 128 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.loginaward.confbean.SLoginSumActivityAwardCfg"))
/*     */         {
/*     */ 
/* 131 */           SLoginSumActivityAwardCfg obj = new SLoginSumActivityAwardCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SLoginSumActivityAwardCfg> all)
/*     */   {
/* 145 */     String path = dir + "mzm.gsp.loginaward.confbean.SLoginSumActivityAwardCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 157 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.loginaward.confbean.SLoginSumActivityAwardCfg"))
/*     */         {
/*     */ 
/* 160 */           SLoginSumActivityAwardCfg obj = new SLoginSumActivityAwardCfg();
...
/* 174 */     all = new HashMap();
/*     */     
/* 176 */     String path = dir + "mzm.gsp.loginaward.confbean.SLoginSumActivityAwardCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 203 */           SLoginSumActivityAwardCfg _v_ = new SLoginSumActivityAwardCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SLoginSumActivityAwardCfg> all)
/*     */   {
/* 223 */     String path = dir + "mzm.gsp.loginaward.confbean.SLoginSumActivityAwardCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 250 */           SLoginSumActivityAwardCfg _v_ = new SLoginSumActivityAwardCfg();
...
/*     */ 
/*     */ 
/*     */   public static SLoginSumActivityAwardCfg getOld(int key)
/*     */   {
/* 271 */     return (SLoginSumActivityAwardCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SLoginSumActivityAwardCfg get(int key)
/*     */   {
/* 276 */     return (SLoginSumActivityAwardCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SLoginSumActivityAwardCfg> getOldAll()
/*     */   {
/* 281 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SLoginSumActivityAwardCfg> getAll()
/*     */   {
/* 286 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SLoginSumActivityAwardCfg> newAll)
/*     */   {
/* 291 */     oldAll = all;
/* 292 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\loginaward\confbean\SLoginSumActivityAwardCfg.class
