...
/*     */ 
/*     */ public class SCommonPropertyName implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SCommonPropertyName> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SCommonPropertyName> all = null;
/*     */   
/*     */   public int propValue;
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  22 */     this.propValue = Integer.valueOf(rootElement.attributeValue("propValue")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  27 */     _os_.marshal(this.propValue);
/*  28 */     return _os_;
/*     */   }
/*     */   
/*     */   public OctetsStream unmarshal(OctetsStream _os_) throws com.goldhuman.Common.Marshal.MarshalException
/*     */   {
/*  33 */     this.propValue = _os_.unmarshal_int();
/*  34 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  39 */     String path = dir + "mzm.gsp.common.confbean.SCommonPropertyName.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  52 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.common.confbean.SCommonPropertyName"))
/*     */         {
/*     */ 
/*  55 */           SCommonPropertyName obj = new SCommonPropertyName();
/*  56 */           obj.loadFromXml(elem);
/*  57 */           if (all.put(Integer.valueOf(obj.propValue), obj) != null) {
/*  58 */             throw new RuntimeException("duplicate key : " + obj.propValue);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SCommonPropertyName> all)
/*     */   {
/*  69 */     String path = dir + "mzm.gsp.common.confbean.SCommonPropertyName.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  81 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.common.confbean.SCommonPropertyName"))
/*     */         {
/*     */ 
/*  84 */           SCommonPropertyName obj = new SCommonPropertyName();
/*  85 */           obj.loadFromXml(elem);
/*  86 */           if (all.put(Integer.valueOf(obj.propValue), obj) != null) {
/*  87 */             throw new RuntimeException("duplicate key : " + obj.propValue);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 100 */     String path = dir + "mzm.gsp.common.confbean.SCommonPropertyName.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 127 */           SCommonPropertyName _v_ = new SCommonPropertyName();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SCommonPropertyName> all)
/*     */   {
/* 147 */     String path = dir + "mzm.gsp.common.confbean.SCommonPropertyName.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 174 */           SCommonPropertyName _v_ = new SCommonPropertyName();
...
/*     */ 
/*     */ 
/*     */   public static SCommonPropertyName getOld(int key)
/*     */   {
/* 195 */     return (SCommonPropertyName)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SCommonPropertyName get(int key)
/*     */   {
/* 200 */     return (SCommonPropertyName)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SCommonPropertyName> getOldAll()
/*     */   {
/* 205 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SCommonPropertyName> getAll()
/*     */   {
/* 210 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SCommonPropertyName> newAll)
/*     */   {
/* 215 */     oldAll = all;
/* 216 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\common\confbean\SCommonPropertyName.class
