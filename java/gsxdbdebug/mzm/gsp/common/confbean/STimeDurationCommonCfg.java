...
/*     */ 
/*     */ public class STimeDurationCommonCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, STimeDurationCommonCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, STimeDurationCommonCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public int timeCommonCfgId;
/*     */   public int lastDay;
/*     */   public int lastHour;
...
/*  27 */     this.timeCommonCfgId = Integer.valueOf(rootElement.attributeValue("timeCommonCfgId")).intValue();
/*  28 */     this.lastDay = Integer.valueOf(rootElement.attributeValue("lastDay")).intValue();
/*  29 */     this.lastHour = Integer.valueOf(rootElement.attributeValue("lastHour")).intValue();
/*  30 */     this.lastMinute = Integer.valueOf(rootElement.attributeValue("lastMinute")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  35 */     _os_.marshal(this.id);
/*  36 */     _os_.marshal(this.timeCommonCfgId);
/*  37 */     _os_.marshal(this.lastDay);
/*  38 */     _os_.marshal(this.lastHour);
/*  39 */     _os_.marshal(this.lastMinute);
/*  40 */     return _os_;
/*     */   }
/*     */   
...
/*  46 */     this.timeCommonCfgId = _os_.unmarshal_int();
/*  47 */     this.lastDay = _os_.unmarshal_int();
/*  48 */     this.lastHour = _os_.unmarshal_int();
/*  49 */     this.lastMinute = _os_.unmarshal_int();
/*  50 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  55 */     String path = dir + "mzm.gsp.common.confbean.STimeDurationCommonCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  68 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.common.confbean.STimeDurationCommonCfg"))
/*     */         {
/*     */ 
/*  71 */           STimeDurationCommonCfg obj = new STimeDurationCommonCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, STimeDurationCommonCfg> all)
/*     */   {
/*  85 */     String path = dir + "mzm.gsp.common.confbean.STimeDurationCommonCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  97 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.common.confbean.STimeDurationCommonCfg"))
/*     */         {
/*     */ 
/* 100 */           STimeDurationCommonCfg obj = new STimeDurationCommonCfg();
...
/*     */     
/* 116 */     String path = dir + "mzm.gsp.common.confbean.STimeDurationCommonCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 143 */           STimeDurationCommonCfg _v_ = new STimeDurationCommonCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, STimeDurationCommonCfg> all)
/*     */   {
/* 163 */     String path = dir + "mzm.gsp.common.confbean.STimeDurationCommonCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 190 */           STimeDurationCommonCfg _v_ = new STimeDurationCommonCfg();
...
/*     */ 
/*     */ 
/*     */   public static STimeDurationCommonCfg getOld(int key)
/*     */   {
/* 211 */     return (STimeDurationCommonCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static STimeDurationCommonCfg get(int key)
/*     */   {
/* 216 */     return (STimeDurationCommonCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, STimeDurationCommonCfg> getOldAll()
/*     */   {
/* 221 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, STimeDurationCommonCfg> getAll()
/*     */   {
/* 226 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, STimeDurationCommonCfg> newAll)
/*     */   {
/* 231 */     oldAll = all;
/* 232 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\common\confbean\STimeDurationCommonCfg.class
