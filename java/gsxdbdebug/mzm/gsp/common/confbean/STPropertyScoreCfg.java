...
/*     */ 
/*     */ public class STPropertyScoreCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, STPropertyScoreCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, STPropertyScoreCfg> all = null;
/*     */   
/*     */   public int propertyType;
/*  19 */   public HashMap<Integer, Double> occ2factor = new HashMap();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.propertyType = Integer.valueOf(rootElement.attributeValue("propertyType")).intValue();
/*     */     
/*  25 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "occ2factor");
...
/*     */         }
/*     */         
/*  76 */         this.occ2factor.put(Integer.valueOf(_k_), Double.valueOf(_v_));
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*     */   {
/*  83 */     _os_.marshal(this.propertyType);
/*  84 */     _os_.compact_uint32(this.occ2factor.size());
/*  85 */     for (java.util.Map.Entry<Integer, Double> _e_ : this.occ2factor.entrySet())
/*     */     {
...
/*     */   {
/*  95 */     this.propertyType = _os_.unmarshal_int();
...
/* 102 */       this.occ2factor.put(Integer.valueOf(_k_), Double.valueOf(_v_));
/*     */     }
/* 104 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/* 109 */     String path = dir + "mzm.gsp.common.confbean.STPropertyScoreCfg.xml";
/*     */     
/*     */     try
/*     */     {
/* 113 */       all = new HashMap();
...
/* 122 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.common.confbean.STPropertyScoreCfg"))
/*     */         {
/*     */ 
/* 125 */           STPropertyScoreCfg obj = new STPropertyScoreCfg();
/* 126 */           obj.loadFromXml(elem);
/* 127 */           if (all.put(Integer.valueOf(obj.propertyType), obj) != null) {
/* 128 */             throw new RuntimeException("duplicate key : " + obj.propertyType);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, STPropertyScoreCfg> all)
/*     */   {
/* 139 */     String path = dir + "mzm.gsp.common.confbean.STPropertyScoreCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 151 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.common.confbean.STPropertyScoreCfg"))
/*     */         {
/*     */ 
/* 154 */           STPropertyScoreCfg obj = new STPropertyScoreCfg();
/* 155 */           obj.loadFromXml(elem);
/* 156 */           if (all.put(Integer.valueOf(obj.propertyType), obj) != null) {
/* 157 */             throw new RuntimeException("duplicate key : " + obj.propertyType);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/* 168 */     all = new HashMap();
/*     */     
/* 170 */     String path = dir + "mzm.gsp.common.confbean.STPropertyScoreCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 197 */           STPropertyScoreCfg _v_ = new STPropertyScoreCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, STPropertyScoreCfg> all)
/*     */   {
/* 217 */     String path = dir + "mzm.gsp.common.confbean.STPropertyScoreCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 244 */           STPropertyScoreCfg _v_ = new STPropertyScoreCfg();
...
/*     */ 
/*     */ 
/*     */   public static STPropertyScoreCfg getOld(int key)
/*     */   {
/* 265 */     return (STPropertyScoreCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static STPropertyScoreCfg get(int key)
/*     */   {
/* 270 */     return (STPropertyScoreCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, STPropertyScoreCfg> getOldAll()
/*     */   {
/* 275 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, STPropertyScoreCfg> getAll()
/*     */   {
/* 280 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, STPropertyScoreCfg> newAll)
/*     */   {
/* 285 */     oldAll = all;
/* 286 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\common\confbean\STPropertyScoreCfg.class
