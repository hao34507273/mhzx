...
/*     */ 
/*     */ public class SProRandomCountCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SProRandomCountCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SProRandomCountCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public String templatename;
/*  20 */   public java.util.ArrayList<ProRatebean> proRates = new java.util.ArrayList();
/*     */   
...
/*     */     
/*  27 */     Element collectionElement = util.XmlHelper.getVariableElement(rootElement, "proRates");
...
/*  38 */       if (elem.getName().equalsIgnoreCase("mzm.gsp.common.confbean.ProRatebean"))
/*     */       {
/*     */         ProRatebean _v_;
/*     */         
/*     */ 
...
/*  62 */     _os_.compact_uint32(this.proRates.size());
/*  63 */     for (ProRatebean _v_ : this.proRates)
/*     */     {
/*  65 */       _os_.marshal(_v_);
/*     */     }
/*  67 */     return _os_;
...
/*     */     {
/*     */ 
/*  77 */       ProRatebean _v_ = new ProRatebean();
/*  78 */       _v_.unmarshal(_os_);
/*  79 */       this.proRates.add(_v_);
/*     */     }
/*  81 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/*  86 */     String path = dir + "mzm.gsp.common.confbean.SProRandomCountCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  99 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.common.confbean.SProRandomCountCfg"))
/*     */         {
/*     */ 
/* 102 */           SProRandomCountCfg obj = new SProRandomCountCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SProRandomCountCfg> all)
/*     */   {
/* 116 */     String path = dir + "mzm.gsp.common.confbean.SProRandomCountCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 128 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.common.confbean.SProRandomCountCfg"))
/*     */         {
/*     */ 
/* 131 */           SProRandomCountCfg obj = new SProRandomCountCfg();
...
/*     */     
/* 147 */     String path = dir + "mzm.gsp.common.confbean.SProRandomCountCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 174 */           SProRandomCountCfg _v_ = new SProRandomCountCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SProRandomCountCfg> all)
/*     */   {
/* 194 */     String path = dir + "mzm.gsp.common.confbean.SProRandomCountCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 221 */           SProRandomCountCfg _v_ = new SProRandomCountCfg();
...
/*     */ 
/*     */ 
/*     */   public static SProRandomCountCfg getOld(int key)
/*     */   {
/* 242 */     return (SProRandomCountCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SProRandomCountCfg get(int key)
/*     */   {
/* 247 */     return (SProRandomCountCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SProRandomCountCfg> getOldAll()
/*     */   {
/* 252 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SProRandomCountCfg> getAll()
/*     */   {
/* 257 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SProRandomCountCfg> newAll)
/*     */   {
/* 262 */     oldAll = all;
/* 263 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\common\confbean\SProRandomCountCfg.class
