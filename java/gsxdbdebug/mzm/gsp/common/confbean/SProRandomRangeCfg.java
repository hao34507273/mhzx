...
/*     */ 
/*     */ public class SProRandomRangeCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SProRandomRangeCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SProRandomRangeCfg> all = null;
/*     */   
/*     */   public int id;
/*  19 */   public java.util.ArrayList<Range2weight> range2weights = new java.util.ArrayList();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.id = Integer.valueOf(rootElement.attributeValue("id")).intValue();
/*     */     
/*  25 */     Element collectionElement = util.XmlHelper.getVariableElement(rootElement, "range2weights");
...
/*  36 */       if (elem.getName().equalsIgnoreCase("mzm.gsp.common.confbean.Range2weight"))
/*     */       {
/*     */         Range2weight _v_;
/*     */         
/*     */ 
...
/*  59 */     _os_.compact_uint32(this.range2weights.size());
/*  60 */     for (Range2weight _v_ : this.range2weights)
/*     */     {
/*  62 */       _os_.marshal(_v_);
/*     */     }
/*  64 */     return _os_;
...
/*     */     {
/*     */ 
/*  73 */       Range2weight _v_ = new Range2weight();
/*  74 */       _v_.unmarshal(_os_);
/*  75 */       this.range2weights.add(_v_);
/*     */     }
/*  77 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/*  82 */     String path = dir + "mzm.gsp.common.confbean.SProRandomRangeCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  95 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.common.confbean.SProRandomRangeCfg"))
/*     */         {
/*     */ 
/*  98 */           SProRandomRangeCfg obj = new SProRandomRangeCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SProRandomRangeCfg> all)
/*     */   {
/* 112 */     String path = dir + "mzm.gsp.common.confbean.SProRandomRangeCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 124 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.common.confbean.SProRandomRangeCfg"))
/*     */         {
/*     */ 
/* 127 */           SProRandomRangeCfg obj = new SProRandomRangeCfg();
...
/*     */     
/* 143 */     String path = dir + "mzm.gsp.common.confbean.SProRandomRangeCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 170 */           SProRandomRangeCfg _v_ = new SProRandomRangeCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SProRandomRangeCfg> all)
/*     */   {
/* 190 */     String path = dir + "mzm.gsp.common.confbean.SProRandomRangeCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 217 */           SProRandomRangeCfg _v_ = new SProRandomRangeCfg();
...
/*     */ 
/*     */ 
/*     */   public static SProRandomRangeCfg getOld(int key)
/*     */   {
/* 238 */     return (SProRandomRangeCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SProRandomRangeCfg get(int key)
/*     */   {
/* 243 */     return (SProRandomRangeCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SProRandomRangeCfg> getOldAll()
/*     */   {
/* 248 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SProRandomRangeCfg> getAll()
/*     */   {
/* 253 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SProRandomRangeCfg> newAll)
/*     */   {
/* 258 */     oldAll = all;
/* 259 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\common\confbean\SProRandomRangeCfg.class
