...
/*     */ 
/*     */ public class SEquipHunColorCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SEquipHunColorCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SEquipHunColorCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public int color;
/*     */   public int minRate;
...
/*  26 */     this.color = Integer.valueOf(rootElement.attributeValue("color")).intValue();
/*  27 */     this.minRate = Integer.valueOf(rootElement.attributeValue("minRate")).intValue();
/*  28 */     this.maxRate = Integer.valueOf(rootElement.attributeValue("maxRate")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  33 */     _os_.marshal(this.id);
/*  34 */     _os_.marshal(this.color);
/*  35 */     _os_.marshal(this.minRate);
/*  36 */     _os_.marshal(this.maxRate);
/*  37 */     return _os_;
/*     */   }
/*     */   
...
/*  43 */     this.color = _os_.unmarshal_int();
/*  44 */     this.minRate = _os_.unmarshal_int();
/*  45 */     this.maxRate = _os_.unmarshal_int();
/*  46 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  51 */     String path = dir + "mzm.gsp.common.confbean.SEquipHunColorCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  64 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.common.confbean.SEquipHunColorCfg"))
/*     */         {
/*     */ 
/*  67 */           SEquipHunColorCfg obj = new SEquipHunColorCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SEquipHunColorCfg> all)
/*     */   {
/*  81 */     String path = dir + "mzm.gsp.common.confbean.SEquipHunColorCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.common.confbean.SEquipHunColorCfg"))
/*     */         {
/*     */ 
/*  96 */           SEquipHunColorCfg obj = new SEquipHunColorCfg();
...
/*     */     
/* 112 */     String path = dir + "mzm.gsp.common.confbean.SEquipHunColorCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 139 */           SEquipHunColorCfg _v_ = new SEquipHunColorCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SEquipHunColorCfg> all)
/*     */   {
/* 159 */     String path = dir + "mzm.gsp.common.confbean.SEquipHunColorCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 186 */           SEquipHunColorCfg _v_ = new SEquipHunColorCfg();
...
/*     */ 
/*     */ 
/*     */   public static SEquipHunColorCfg getOld(int key)
/*     */   {
/* 207 */     return (SEquipHunColorCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SEquipHunColorCfg get(int key)
/*     */   {
/* 212 */     return (SEquipHunColorCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SEquipHunColorCfg> getOldAll()
/*     */   {
/* 217 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SEquipHunColorCfg> getAll()
/*     */   {
/* 222 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SEquipHunColorCfg> newAll)
/*     */   {
/* 227 */     oldAll = all;
/* 228 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\common\confbean\SEquipHunColorCfg.class
