...
/*     */ 
/*     */ public class STimePointCommonCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, STimePointCommonCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, STimePointCommonCfg> all = null;
/*     */   
/*     */   public int id;
...
/*  28 */     this.start_year = Integer.valueOf(rootElement.attributeValue("start_year")).intValue();
/*  29 */     this.start_month = Integer.valueOf(rootElement.attributeValue("start_month")).intValue();
/*  30 */     this.start_day = Integer.valueOf(rootElement.attributeValue("start_day")).intValue();
/*  31 */     this.start_hour = Integer.valueOf(rootElement.attributeValue("start_hour")).intValue();
/*  32 */     this.start_minute = Integer.valueOf(rootElement.attributeValue("start_minute")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  37 */     _os_.marshal(this.id);
/*  38 */     _os_.marshal(this.start_year);
/*  39 */     _os_.marshal(this.start_month);
/*  40 */     _os_.marshal(this.start_day);
/*  41 */     _os_.marshal(this.start_hour);
/*  42 */     _os_.marshal(this.start_minute);
/*  43 */     return _os_;
/*     */   }
/*     */   
...
/*  49 */     this.start_year = _os_.unmarshal_int();
/*  50 */     this.start_month = _os_.unmarshal_int();
/*  51 */     this.start_day = _os_.unmarshal_int();
/*  52 */     this.start_hour = _os_.unmarshal_int();
/*  53 */     this.start_minute = _os_.unmarshal_int();
/*  54 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  59 */     String path = dir + "mzm.gsp.common.confbean.STimePointCommonCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  72 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.common.confbean.STimePointCommonCfg"))
/*     */         {
/*     */ 
/*  75 */           STimePointCommonCfg obj = new STimePointCommonCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, STimePointCommonCfg> all)
/*     */   {
/*  89 */     String path = dir + "mzm.gsp.common.confbean.STimePointCommonCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 101 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.common.confbean.STimePointCommonCfg"))
/*     */         {
/*     */ 
/* 104 */           STimePointCommonCfg obj = new STimePointCommonCfg();
...
/*     */     
/* 120 */     String path = dir + "mzm.gsp.common.confbean.STimePointCommonCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 147 */           STimePointCommonCfg _v_ = new STimePointCommonCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, STimePointCommonCfg> all)
/*     */   {
/* 167 */     String path = dir + "mzm.gsp.common.confbean.STimePointCommonCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 194 */           STimePointCommonCfg _v_ = new STimePointCommonCfg();
...
/*     */ 
/*     */ 
/*     */   public static STimePointCommonCfg getOld(int key)
/*     */   {
/* 215 */     return (STimePointCommonCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static STimePointCommonCfg get(int key)
/*     */   {
/* 220 */     return (STimePointCommonCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, STimePointCommonCfg> getOldAll()
/*     */   {
/* 225 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, STimePointCommonCfg> getAll()
/*     */   {
/* 230 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, STimePointCommonCfg> newAll)
/*     */   {
/* 235 */     oldAll = all;
/* 236 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\common\confbean\STimePointCommonCfg.class
