...
/*     */ 
/*     */ public class SFightValueConst
/*     */ {
/*  13 */   private static volatile SFightValueConst oldInstance = null;
/*     */   
/*  15 */   private static SFightValueConst instance = new SFightValueConst();
/*     */   
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   public static SFightValueConst getOldInstance()
/*     */   {
/*  23 */     return oldInstance;
/*     */   }
/*     */   
/*     */   public static SFightValueConst getInstance()
/*     */   {
/*  28 */     return instance;
/*     */   }
/*     */   
/*  31 */   public double BASIC_PRO_SCORE = 1.0D;
/*     */   
...
/*     */   {
/*  40 */     String path = dir + "mzm.gsp.common.confbean.SFightValueConst.xml";
/*     */     try
/*     */     {
...
/*     */         }
/*     */       }
/*  60 */       this.BASIC_PRO_SCORE = Double.valueOf(((Element)data.get("BASIC_PRO_SCORE")).attributeValue("value")).doubleValue();
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*  69 */     String path = dir + "mzm.gsp.common.confbean.SFightValueConst.xml";
/*     */     try
/*     */     {
...
/*     */         }
/*     */       }
/*  89 */       this.BASIC_PRO_SCORE = Double.valueOf(((Element)data.get("BASIC_PRO_SCORE")).attributeValue("value")).doubleValue();
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/* 100 */     String path = dir + "mzm.gsp.common.confbean.SFightValueConst.bny";
/*     */     try
/*     */     {
...
/* 115 */         this.BASIC_PRO_SCORE = _os_.unmarshal_float();
/*     */       }
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*     */   {
/* 126 */     String path = dir + "mzm.gsp.common.confbean.SFightValueConst.bny";
/*     */     try
/*     */     {
...
/* 141 */         this.BASIC_PRO_SCORE = _os_.unmarshal_float();
/*     */       }
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*     */   }
/*     */   
/*     */   public static void setInstance(SFightValueConst newInstance)
/*     */   {
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\common\confbean\SFightValueConst.class
