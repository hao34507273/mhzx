...
/*     */ 
/*     */ public class SPropertyScoreCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SPropertyScoreCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SPropertyScoreCfg> all = null;
/*     */   
/*     */   public int id;
...
/*  28 */     this.propertyType = Integer.valueOf(rootElement.attributeValue("propertyType")).intValue();
/*  29 */     this.occupationType = Integer.valueOf(rootElement.attributeValue("occupationType")).intValue();
/*  30 */     this.factor = Double.valueOf(rootElement.attributeValue("factor")).doubleValue();
/*     */   }
/*     */   
...
/*  38 */     _os_.marshal(this.occupationType);
/*  39 */     _os_.marshal(this.factor);
/*  40 */     return _os_;
/*     */   }
/*     */   
...
/*  48 */     this.occupationType = _os_.unmarshal_int();
/*  49 */     this.factor = _os_.unmarshal_float();
/*  50 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  55 */     String path = dir + "mzm.gsp.common.confbean.SPropertyScoreCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  68 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.common.confbean.SPropertyScoreCfg"))
/*     */         {
/*     */ 
/*  71 */           SPropertyScoreCfg obj = new SPropertyScoreCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SPropertyScoreCfg> all)
/*     */   {
/*  85 */     String path = dir + "mzm.gsp.common.confbean.SPropertyScoreCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  97 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.common.confbean.SPropertyScoreCfg"))
/*     */         {
/*     */ 
/* 100 */           SPropertyScoreCfg obj = new SPropertyScoreCfg();
...
/*     */     
/* 116 */     String path = dir + "mzm.gsp.common.confbean.SPropertyScoreCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 143 */           SPropertyScoreCfg _v_ = new SPropertyScoreCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SPropertyScoreCfg> all)
/*     */   {
/* 163 */     String path = dir + "mzm.gsp.common.confbean.SPropertyScoreCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 190 */           SPropertyScoreCfg _v_ = new SPropertyScoreCfg();
...
/*     */ 
/*     */ 
/*     */   public static SPropertyScoreCfg getOld(int key)
/*     */   {
/* 211 */     return (SPropertyScoreCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SPropertyScoreCfg get(int key)
/*     */   {
/* 216 */     return (SPropertyScoreCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPropertyScoreCfg> getOldAll()
/*     */   {
/* 221 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPropertyScoreCfg> getAll()
/*     */   {
/* 226 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SPropertyScoreCfg> newAll)
/*     */   {
/* 231 */     oldAll = all;
/* 232 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\common\confbean\SPropertyScoreCfg.class
