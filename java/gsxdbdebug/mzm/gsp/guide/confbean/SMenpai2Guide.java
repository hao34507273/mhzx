...
/*     */ 
/*     */ public class SMenpai2Guide implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SMenpai2Guide> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SMenpai2Guide> all = null;
/*     */   
/*     */   public int ocp;
/*     */   public int guide;
/*     */   
...
/*  24 */     this.guide = Integer.valueOf(rootElement.attributeValue("guide")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  29 */     _os_.marshal(this.ocp);
/*  30 */     _os_.marshal(this.guide);
/*  31 */     return _os_;
/*     */   }
/*     */   
...
/*  37 */     this.guide = _os_.unmarshal_int();
/*  38 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.guide.confbean.SMenpai2Guide.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.guide.confbean.SMenpai2Guide"))
/*     */         {
/*     */ 
/*  59 */           SMenpai2Guide obj = new SMenpai2Guide();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SMenpai2Guide> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.guide.confbean.SMenpai2Guide.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.guide.confbean.SMenpai2Guide"))
/*     */         {
/*     */ 
/*  88 */           SMenpai2Guide obj = new SMenpai2Guide();
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.guide.confbean.SMenpai2Guide.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           SMenpai2Guide _v_ = new SMenpai2Guide();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SMenpai2Guide> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.guide.confbean.SMenpai2Guide.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           SMenpai2Guide _v_ = new SMenpai2Guide();
...
/*     */ 
/*     */ 
/*     */   public static SMenpai2Guide getOld(int key)
/*     */   {
/* 199 */     return (SMenpai2Guide)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SMenpai2Guide get(int key)
/*     */   {
/* 204 */     return (SMenpai2Guide)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMenpai2Guide> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMenpai2Guide> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SMenpai2Guide> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\guide\confbean\SMenpai2Guide.class
