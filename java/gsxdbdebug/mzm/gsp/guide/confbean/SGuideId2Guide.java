...
/*     */ 
/*     */ public class SGuideId2Guide implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SGuideId2Guide> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SGuideId2Guide> all = null;
/*     */   
/*     */   public int guideid;
...
/*     */   {
/*  23 */     this.guideid = Integer.valueOf(rootElement.attributeValue("guideid")).intValue();
/*     */     
...
/*     */   {
/*  68 */     this.guideid = _os_.unmarshal_int();
...
/*     */   {
/*  80 */     String path = dir + "mzm.gsp.guide.confbean.SGuideId2Guide.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.guide.confbean.SGuideId2Guide"))
/*     */         {
/*     */ 
/*  96 */           SGuideId2Guide obj = new SGuideId2Guide();
/*  97 */           obj.loadFromXml(elem);
/*  98 */           if (all.put(Integer.valueOf(obj.guideid), obj) != null) {
/*  99 */             throw new RuntimeException("duplicate key : " + obj.guideid);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SGuideId2Guide> all)
/*     */   {
/* 110 */     String path = dir + "mzm.gsp.guide.confbean.SGuideId2Guide.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 122 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.guide.confbean.SGuideId2Guide"))
/*     */         {
/*     */ 
/* 125 */           SGuideId2Guide obj = new SGuideId2Guide();
/* 126 */           obj.loadFromXml(elem);
/* 127 */           if (all.put(Integer.valueOf(obj.guideid), obj) != null) {
/* 128 */             throw new RuntimeException("duplicate key : " + obj.guideid);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 141 */     String path = dir + "mzm.gsp.guide.confbean.SGuideId2Guide.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 168 */           SGuideId2Guide _v_ = new SGuideId2Guide();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SGuideId2Guide> all)
/*     */   {
/* 188 */     String path = dir + "mzm.gsp.guide.confbean.SGuideId2Guide.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 215 */           SGuideId2Guide _v_ = new SGuideId2Guide();
...
/*     */ 
/*     */ 
/*     */   public static SGuideId2Guide getOld(int key)
/*     */   {
/* 236 */     return (SGuideId2Guide)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SGuideId2Guide get(int key)
/*     */   {
/* 241 */     return (SGuideId2Guide)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SGuideId2Guide> getOldAll()
/*     */   {
/* 246 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SGuideId2Guide> getAll()
/*     */   {
/* 251 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SGuideId2Guide> newAll)
/*     */   {
/* 256 */     oldAll = all;
/* 257 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\guide\confbean\SGuideId2Guide.class
