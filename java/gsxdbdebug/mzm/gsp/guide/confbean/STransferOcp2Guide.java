...
/*     */ 
/*     */ public class STransferOcp2Guide implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, STransferOcp2Guide> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, STransferOcp2Guide> all = null;
/*     */   
/*     */   public int guideid;
/*     */   
...
/*     */   {
/*  39 */     String path = dir + "mzm.gsp.guide.confbean.STransferOcp2Guide.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  52 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.guide.confbean.STransferOcp2Guide"))
/*     */         {
/*     */ 
/*  55 */           STransferOcp2Guide obj = new STransferOcp2Guide();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, STransferOcp2Guide> all)
/*     */   {
/*  69 */     String path = dir + "mzm.gsp.guide.confbean.STransferOcp2Guide.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  81 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.guide.confbean.STransferOcp2Guide"))
/*     */         {
/*     */ 
/*  84 */           STransferOcp2Guide obj = new STransferOcp2Guide();
...
/*     */     
/* 100 */     String path = dir + "mzm.gsp.guide.confbean.STransferOcp2Guide.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 127 */           STransferOcp2Guide _v_ = new STransferOcp2Guide();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, STransferOcp2Guide> all)
/*     */   {
/* 147 */     String path = dir + "mzm.gsp.guide.confbean.STransferOcp2Guide.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 174 */           STransferOcp2Guide _v_ = new STransferOcp2Guide();
...
/*     */ 
/*     */ 
/*     */   public static STransferOcp2Guide getOld(int key)
/*     */   {
/* 195 */     return (STransferOcp2Guide)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static STransferOcp2Guide get(int key)
/*     */   {
/* 200 */     return (STransferOcp2Guide)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, STransferOcp2Guide> getOldAll()
/*     */   {
/* 205 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, STransferOcp2Guide> getAll()
/*     */   {
/* 210 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, STransferOcp2Guide> newAll)
/*     */   {
/* 215 */     oldAll = all;
/* 216 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\guide\confbean\STransferOcp2Guide.class
