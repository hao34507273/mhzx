...
/*     */ 
/*     */ public class SJoinGangGuide implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SJoinGangGuide> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SJoinGangGuide> all = null;
/*     */   
/*     */   public int guideid;
/*     */   
...
/*     */   {
/*  39 */     String path = dir + "mzm.gsp.guide.confbean.SJoinGangGuide.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  52 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.guide.confbean.SJoinGangGuide"))
/*     */         {
/*     */ 
/*  55 */           SJoinGangGuide obj = new SJoinGangGuide();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SJoinGangGuide> all)
/*     */   {
/*  69 */     String path = dir + "mzm.gsp.guide.confbean.SJoinGangGuide.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  81 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.guide.confbean.SJoinGangGuide"))
/*     */         {
/*     */ 
/*  84 */           SJoinGangGuide obj = new SJoinGangGuide();
...
/*     */     
/* 100 */     String path = dir + "mzm.gsp.guide.confbean.SJoinGangGuide.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 127 */           SJoinGangGuide _v_ = new SJoinGangGuide();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SJoinGangGuide> all)
/*     */   {
/* 147 */     String path = dir + "mzm.gsp.guide.confbean.SJoinGangGuide.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 174 */           SJoinGangGuide _v_ = new SJoinGangGuide();
...
/*     */ 
/*     */ 
/*     */   public static SJoinGangGuide getOld(int key)
/*     */   {
/* 195 */     return (SJoinGangGuide)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SJoinGangGuide get(int key)
/*     */   {
/* 200 */     return (SJoinGangGuide)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SJoinGangGuide> getOldAll()
/*     */   {
/* 205 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SJoinGangGuide> getAll()
/*     */   {
/* 210 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SJoinGangGuide> newAll)
/*     */   {
/* 215 */     oldAll = all;
/* 216 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\guide\confbean\SJoinGangGuide.class
