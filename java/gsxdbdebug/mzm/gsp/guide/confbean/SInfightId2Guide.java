...
/*     */ 
/*     */ public class SInfightId2Guide implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SInfightId2Guide> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SInfightId2Guide> all = null;
/*     */   
/*     */   public int fightid;
...
/*     */   {
/*  80 */     String path = dir + "mzm.gsp.guide.confbean.SInfightId2Guide.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.guide.confbean.SInfightId2Guide"))
/*     */         {
/*     */ 
/*  96 */           SInfightId2Guide obj = new SInfightId2Guide();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SInfightId2Guide> all)
/*     */   {
/* 110 */     String path = dir + "mzm.gsp.guide.confbean.SInfightId2Guide.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 122 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.guide.confbean.SInfightId2Guide"))
/*     */         {
/*     */ 
/* 125 */           SInfightId2Guide obj = new SInfightId2Guide();
...
/*     */     
/* 141 */     String path = dir + "mzm.gsp.guide.confbean.SInfightId2Guide.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 168 */           SInfightId2Guide _v_ = new SInfightId2Guide();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SInfightId2Guide> all)
/*     */   {
/* 188 */     String path = dir + "mzm.gsp.guide.confbean.SInfightId2Guide.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 215 */           SInfightId2Guide _v_ = new SInfightId2Guide();
...
/*     */ 
/*     */ 
/*     */   public static SInfightId2Guide getOld(int key)
/*     */   {
/* 236 */     return (SInfightId2Guide)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SInfightId2Guide get(int key)
/*     */   {
/* 241 */     return (SInfightId2Guide)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SInfightId2Guide> getOldAll()
/*     */   {
/* 246 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SInfightId2Guide> getAll()
/*     */   {
/* 251 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SInfightId2Guide> newAll)
/*     */   {
/* 256 */     oldAll = all;
/* 257 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\guide\confbean\SInfightId2Guide.class
