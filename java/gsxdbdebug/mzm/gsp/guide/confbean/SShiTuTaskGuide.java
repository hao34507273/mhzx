...
/*     */ 
/*     */ public class SShiTuTaskGuide implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SShiTuTaskGuide> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SShiTuTaskGuide> all = null;
/*     */   
/*     */   public int guideid;
/*     */   
...
/*     */   {
/*  39 */     String path = dir + "mzm.gsp.guide.confbean.SShiTuTaskGuide.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  52 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.guide.confbean.SShiTuTaskGuide"))
/*     */         {
/*     */ 
/*  55 */           SShiTuTaskGuide obj = new SShiTuTaskGuide();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SShiTuTaskGuide> all)
/*     */   {
/*  69 */     String path = dir + "mzm.gsp.guide.confbean.SShiTuTaskGuide.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  81 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.guide.confbean.SShiTuTaskGuide"))
/*     */         {
/*     */ 
/*  84 */           SShiTuTaskGuide obj = new SShiTuTaskGuide();
...
/*     */     
/* 100 */     String path = dir + "mzm.gsp.guide.confbean.SShiTuTaskGuide.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 127 */           SShiTuTaskGuide _v_ = new SShiTuTaskGuide();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SShiTuTaskGuide> all)
/*     */   {
/* 147 */     String path = dir + "mzm.gsp.guide.confbean.SShiTuTaskGuide.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 174 */           SShiTuTaskGuide _v_ = new SShiTuTaskGuide();
...
/*     */ 
/*     */ 
/*     */   public static SShiTuTaskGuide getOld(int key)
/*     */   {
/* 195 */     return (SShiTuTaskGuide)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SShiTuTaskGuide get(int key)
/*     */   {
/* 200 */     return (SShiTuTaskGuide)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SShiTuTaskGuide> getOldAll()
/*     */   {
/* 205 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SShiTuTaskGuide> getAll()
/*     */   {
/* 210 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SShiTuTaskGuide> newAll)
/*     */   {
/* 215 */     oldAll = all;
/* 216 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\guide\confbean\SShiTuTaskGuide.class
