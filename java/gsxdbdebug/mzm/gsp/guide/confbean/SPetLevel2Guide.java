...
/*     */ 
/*     */ public class SPetLevel2Guide implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SPetLevel2Guide> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SPetLevel2Guide> all = null;
/*     */   
/*     */   public int petlevel;
...
/*     */   {
/*  23 */     this.petlevel = Integer.valueOf(rootElement.attributeValue("petlevel")).intValue();
/*     */     
...
/*     */   {
/*  68 */     this.petlevel = _os_.unmarshal_int();
...
/*     */   {
/*  80 */     String path = dir + "mzm.gsp.guide.confbean.SPetLevel2Guide.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.guide.confbean.SPetLevel2Guide"))
/*     */         {
/*     */ 
/*  96 */           SPetLevel2Guide obj = new SPetLevel2Guide();
/*  97 */           obj.loadFromXml(elem);
/*  98 */           if (all.put(Integer.valueOf(obj.petlevel), obj) != null) {
/*  99 */             throw new RuntimeException("duplicate key : " + obj.petlevel);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SPetLevel2Guide> all)
/*     */   {
/* 110 */     String path = dir + "mzm.gsp.guide.confbean.SPetLevel2Guide.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 122 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.guide.confbean.SPetLevel2Guide"))
/*     */         {
/*     */ 
/* 125 */           SPetLevel2Guide obj = new SPetLevel2Guide();
/* 126 */           obj.loadFromXml(elem);
/* 127 */           if (all.put(Integer.valueOf(obj.petlevel), obj) != null) {
/* 128 */             throw new RuntimeException("duplicate key : " + obj.petlevel);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 141 */     String path = dir + "mzm.gsp.guide.confbean.SPetLevel2Guide.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 168 */           SPetLevel2Guide _v_ = new SPetLevel2Guide();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SPetLevel2Guide> all)
/*     */   {
/* 188 */     String path = dir + "mzm.gsp.guide.confbean.SPetLevel2Guide.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 215 */           SPetLevel2Guide _v_ = new SPetLevel2Guide();
...
/*     */ 
/*     */ 
/*     */   public static SPetLevel2Guide getOld(int key)
/*     */   {
/* 236 */     return (SPetLevel2Guide)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SPetLevel2Guide get(int key)
/*     */   {
/* 241 */     return (SPetLevel2Guide)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPetLevel2Guide> getOldAll()
/*     */   {
/* 246 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPetLevel2Guide> getAll()
/*     */   {
/* 251 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SPetLevel2Guide> newAll)
/*     */   {
/* 256 */     oldAll = all;
/* 257 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\guide\confbean\SPetLevel2Guide.class
