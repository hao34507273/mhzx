...
/*     */ 
/*     */ public class STaskid2Guide implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, STaskid2Guide> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, STaskid2Guide> all = null;
/*     */   
/*     */   public int taskid;
...
/*     */   {
/*  68 */     this.taskid = _os_.unmarshal_int();
...
/*     */   {
/*  80 */     String path = dir + "mzm.gsp.guide.confbean.STaskid2Guide.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.guide.confbean.STaskid2Guide"))
/*     */         {
/*     */ 
/*  96 */           STaskid2Guide obj = new STaskid2Guide();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, STaskid2Guide> all)
/*     */   {
/* 110 */     String path = dir + "mzm.gsp.guide.confbean.STaskid2Guide.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 122 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.guide.confbean.STaskid2Guide"))
/*     */         {
/*     */ 
/* 125 */           STaskid2Guide obj = new STaskid2Guide();
...
/*     */     
/* 141 */     String path = dir + "mzm.gsp.guide.confbean.STaskid2Guide.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 168 */           STaskid2Guide _v_ = new STaskid2Guide();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, STaskid2Guide> all)
/*     */   {
/* 188 */     String path = dir + "mzm.gsp.guide.confbean.STaskid2Guide.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 215 */           STaskid2Guide _v_ = new STaskid2Guide();
...
/*     */ 
/*     */ 
/*     */   public static STaskid2Guide getOld(int key)
/*     */   {
/* 236 */     return (STaskid2Guide)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static STaskid2Guide get(int key)
/*     */   {
/* 241 */     return (STaskid2Guide)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, STaskid2Guide> getOldAll()
/*     */   {
/* 246 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, STaskid2Guide> getAll()
/*     */   {
/* 251 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, STaskid2Guide> newAll)
/*     */   {
/* 256 */     oldAll = all;
/* 257 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\guide\confbean\STaskid2Guide.class
