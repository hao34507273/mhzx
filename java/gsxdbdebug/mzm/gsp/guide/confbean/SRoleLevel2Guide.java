...
/*     */ 
/*     */ public class SRoleLevel2Guide implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SRoleLevel2Guide> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SRoleLevel2Guide> all = null;
/*     */   
...
/*     */   {
/*  23 */     this.rolelevel = Integer.valueOf(rootElement.attributeValue("rolelevel")).intValue();
/*     */     
...
/*     */   {
/*  57 */     _os_.marshal(this.rolelevel);
...
/*     */   {
/*  68 */     this.rolelevel = _os_.unmarshal_int();
...
/*     */   {
/*  80 */     String path = dir + "mzm.gsp.guide.confbean.SRoleLevel2Guide.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.guide.confbean.SRoleLevel2Guide"))
/*     */         {
/*     */ 
/*  96 */           SRoleLevel2Guide obj = new SRoleLevel2Guide();
/*  97 */           obj.loadFromXml(elem);
/*  98 */           if (all.put(Integer.valueOf(obj.rolelevel), obj) != null) {
/*  99 */             throw new RuntimeException("duplicate key : " + obj.rolelevel);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SRoleLevel2Guide> all)
/*     */   {
/* 110 */     String path = dir + "mzm.gsp.guide.confbean.SRoleLevel2Guide.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 122 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.guide.confbean.SRoleLevel2Guide"))
/*     */         {
/*     */ 
/* 125 */           SRoleLevel2Guide obj = new SRoleLevel2Guide();
/* 126 */           obj.loadFromXml(elem);
/* 127 */           if (all.put(Integer.valueOf(obj.rolelevel), obj) != null) {
/* 128 */             throw new RuntimeException("duplicate key : " + obj.rolelevel);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 141 */     String path = dir + "mzm.gsp.guide.confbean.SRoleLevel2Guide.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 168 */           SRoleLevel2Guide _v_ = new SRoleLevel2Guide();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SRoleLevel2Guide> all)
/*     */   {
/* 188 */     String path = dir + "mzm.gsp.guide.confbean.SRoleLevel2Guide.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 215 */           SRoleLevel2Guide _v_ = new SRoleLevel2Guide();
...
/*     */ 
/*     */ 
/*     */   public static SRoleLevel2Guide getOld(int key)
/*     */   {
/* 236 */     return (SRoleLevel2Guide)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SRoleLevel2Guide get(int key)
/*     */   {
/* 241 */     return (SRoleLevel2Guide)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SRoleLevel2Guide> getOldAll()
/*     */   {
/* 246 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SRoleLevel2Guide> getAll()
/*     */   {
/* 251 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SRoleLevel2Guide> newAll)
/*     */   {
/* 256 */     oldAll = all;
/* 257 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\guide\confbean\SRoleLevel2Guide.class
