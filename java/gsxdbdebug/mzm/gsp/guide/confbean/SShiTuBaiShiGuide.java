...
/*     */ 
/*     */ public class SShiTuBaiShiGuide implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SShiTuBaiShiGuide> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SShiTuBaiShiGuide> all = null;
/*     */   
/*     */   public int guideid;
/*     */   
...
/*     */   {
/*  39 */     String path = dir + "mzm.gsp.guide.confbean.SShiTuBaiShiGuide.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  52 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.guide.confbean.SShiTuBaiShiGuide"))
/*     */         {
/*     */ 
/*  55 */           SShiTuBaiShiGuide obj = new SShiTuBaiShiGuide();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SShiTuBaiShiGuide> all)
/*     */   {
/*  69 */     String path = dir + "mzm.gsp.guide.confbean.SShiTuBaiShiGuide.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  81 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.guide.confbean.SShiTuBaiShiGuide"))
/*     */         {
/*     */ 
/*  84 */           SShiTuBaiShiGuide obj = new SShiTuBaiShiGuide();
...
/*     */     
/* 100 */     String path = dir + "mzm.gsp.guide.confbean.SShiTuBaiShiGuide.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 127 */           SShiTuBaiShiGuide _v_ = new SShiTuBaiShiGuide();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SShiTuBaiShiGuide> all)
/*     */   {
/* 147 */     String path = dir + "mzm.gsp.guide.confbean.SShiTuBaiShiGuide.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 174 */           SShiTuBaiShiGuide _v_ = new SShiTuBaiShiGuide();
...
/*     */ 
/*     */ 
/*     */   public static SShiTuBaiShiGuide getOld(int key)
/*     */   {
/* 195 */     return (SShiTuBaiShiGuide)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SShiTuBaiShiGuide get(int key)
/*     */   {
/* 200 */     return (SShiTuBaiShiGuide)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SShiTuBaiShiGuide> getOldAll()
/*     */   {
/* 205 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SShiTuBaiShiGuide> getAll()
/*     */   {
/* 210 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SShiTuBaiShiGuide> newAll)
/*     */   {
/* 215 */     oldAll = all;
/* 216 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\guide\confbean\SShiTuBaiShiGuide.class
