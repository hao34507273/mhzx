...
/*     */ 
/*     */ public class SNonConGuide implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SNonConGuide> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SNonConGuide> all = null;
/*     */   
/*     */   public int guideid;
/*     */   
...
/*     */   {
/*  39 */     String path = dir + "mzm.gsp.guide.confbean.SNonConGuide.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  52 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.guide.confbean.SNonConGuide"))
/*     */         {
/*     */ 
/*  55 */           SNonConGuide obj = new SNonConGuide();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SNonConGuide> all)
/*     */   {
/*  69 */     String path = dir + "mzm.gsp.guide.confbean.SNonConGuide.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  81 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.guide.confbean.SNonConGuide"))
/*     */         {
/*     */ 
/*  84 */           SNonConGuide obj = new SNonConGuide();
...
/*     */     
/* 100 */     String path = dir + "mzm.gsp.guide.confbean.SNonConGuide.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 127 */           SNonConGuide _v_ = new SNonConGuide();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SNonConGuide> all)
/*     */   {
/* 147 */     String path = dir + "mzm.gsp.guide.confbean.SNonConGuide.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 174 */           SNonConGuide _v_ = new SNonConGuide();
...
/*     */ 
/*     */ 
/*     */   public static SNonConGuide getOld(int key)
/*     */   {
/* 195 */     return (SNonConGuide)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SNonConGuide get(int key)
/*     */   {
/* 200 */     return (SNonConGuide)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SNonConGuide> getOldAll()
/*     */   {
/* 205 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SNonConGuide> getAll()
/*     */   {
/* 210 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SNonConGuide> newAll)
/*     */   {
/* 215 */     oldAll = all;
/* 216 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\guide\confbean\SNonConGuide.class
