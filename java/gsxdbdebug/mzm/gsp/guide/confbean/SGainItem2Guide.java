...
/*     */ 
/*     */ public class SGainItem2Guide implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SGainItem2Guide> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SGainItem2Guide> all = null;
/*     */   
/*     */   public int itemid;
...
/*     */   {
/*  80 */     String path = dir + "mzm.gsp.guide.confbean.SGainItem2Guide.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.guide.confbean.SGainItem2Guide"))
/*     */         {
/*     */ 
/*  96 */           SGainItem2Guide obj = new SGainItem2Guide();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SGainItem2Guide> all)
/*     */   {
/* 110 */     String path = dir + "mzm.gsp.guide.confbean.SGainItem2Guide.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 122 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.guide.confbean.SGainItem2Guide"))
/*     */         {
/*     */ 
/* 125 */           SGainItem2Guide obj = new SGainItem2Guide();
...
/*     */     
/* 141 */     String path = dir + "mzm.gsp.guide.confbean.SGainItem2Guide.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 168 */           SGainItem2Guide _v_ = new SGainItem2Guide();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SGainItem2Guide> all)
/*     */   {
/* 188 */     String path = dir + "mzm.gsp.guide.confbean.SGainItem2Guide.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 215 */           SGainItem2Guide _v_ = new SGainItem2Guide();
...
/*     */ 
/*     */ 
/*     */   public static SGainItem2Guide getOld(int key)
/*     */   {
/* 236 */     return (SGainItem2Guide)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SGainItem2Guide get(int key)
/*     */   {
/* 241 */     return (SGainItem2Guide)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SGainItem2Guide> getOldAll()
/*     */   {
/* 246 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SGainItem2Guide> getAll()
/*     */   {
/* 251 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SGainItem2Guide> newAll)
/*     */   {
/* 256 */     oldAll = all;
/* 257 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\guide\confbean\SGainItem2Guide.class
