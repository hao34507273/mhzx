...
/*     */ 
/*     */ public class SActivity2ParamGuide implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SActivity2ParamGuide> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SActivity2ParamGuide> all = null;
/*     */   
/*     */   public int activityid;
/*  19 */   public HashMap<Integer, Param2guideids> param2guideids = new HashMap();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.activityid = Integer.valueOf(rootElement.attributeValue("activityid")).intValue();
/*     */     
/*  25 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "param2guideids");
...
/*  51 */             keyElem = elem;
/*     */           }
/*  53 */           else if ((valueElem == null) && (elem.getName().equalsIgnoreCase("mzm.gsp.guide.confbean.Param2guideids")))
/*     */           {
/*  55 */             valueElem = elem;
/*     */           }
/*     */         }
...
/*     */         }
/*     */         
/*  77 */         this.param2guideids.put(Integer.valueOf(_k_), _v_);
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*  85 */     _os_.compact_uint32(this.param2guideids.size());
/*  86 */     for (java.util.Map.Entry<Integer, Param2guideids> _e_ : this.param2guideids.entrySet())
/*     */     {
...
/*     */       
/* 102 */       Param2guideids _v_ = new Param2guideids();
/* 103 */       _v_.unmarshal(_os_);
/* 104 */       this.param2guideids.put(Integer.valueOf(_k_), _v_);
/*     */     }
/* 106 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/* 111 */     String path = dir + "mzm.gsp.guide.confbean.SActivity2ParamGuide.xml";
/*     */     
/*     */     try
/*     */     {
/* 115 */       all = new HashMap();
...
/* 124 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.guide.confbean.SActivity2ParamGuide"))
/*     */         {
/*     */ 
/* 127 */           SActivity2ParamGuide obj = new SActivity2ParamGuide();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SActivity2ParamGuide> all)
/*     */   {
/* 141 */     String path = dir + "mzm.gsp.guide.confbean.SActivity2ParamGuide.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 153 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.guide.confbean.SActivity2ParamGuide"))
/*     */         {
/*     */ 
/* 156 */           SActivity2ParamGuide obj = new SActivity2ParamGuide();
...
/* 170 */     all = new HashMap();
/*     */     
/* 172 */     String path = dir + "mzm.gsp.guide.confbean.SActivity2ParamGuide.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 199 */           SActivity2ParamGuide _v_ = new SActivity2ParamGuide();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SActivity2ParamGuide> all)
/*     */   {
/* 219 */     String path = dir + "mzm.gsp.guide.confbean.SActivity2ParamGuide.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 246 */           SActivity2ParamGuide _v_ = new SActivity2ParamGuide();
...
/*     */ 
/*     */ 
/*     */   public static SActivity2ParamGuide getOld(int key)
/*     */   {
/* 267 */     return (SActivity2ParamGuide)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SActivity2ParamGuide get(int key)
/*     */   {
/* 272 */     return (SActivity2ParamGuide)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SActivity2ParamGuide> getOldAll()
/*     */   {
/* 277 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SActivity2ParamGuide> getAll()
/*     */   {
/* 282 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SActivity2ParamGuide> newAll)
/*     */   {
/* 287 */     oldAll = all;
/* 288 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\guide\confbean\SActivity2ParamGuide.class
