...
/* 39 */       return false;
/*    */     }
/* 41 */     Integer I_id = parseInt((String)this.m_arguments.get(index++));
/* 42 */     if (I_id == null) {
/* 43 */       return false;
/*    */     }
/* 45 */     this.id = I_id.intValue();
/*    */     
...
/*    */   protected void run()
/*    */   {
/* 65 */     ControllerInterface.collectController(this.roleId, this.id);
/*    */   }
/*    */ }


/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\gm\main\Cmd_stopcontrol.class
