...
/*    */ 
/*    */ 
/*    */ public class Cmd_add_inner_save_amt
/*    */   extends CmdBase
/*    */ {
/*    */   private long roleId;
/*    */   private int amt;
...
/* 39 */       return false;
/*    */     }
/* 41 */     Integer I_amt = parseInt((String)this.m_arguments.get(index++));
/* 42 */     if (I_amt == null) {
/* 43 */       return false;
/*    */     }
/* 45 */     this.amt = I_amt.intValue();
/*    */     
...
/*    */   protected void run()
/*    */   {
/* 65 */     Procedure.execute(new PGM_AddInnerSaveAmt(this.m_gmRole.getRoleid(), this.roleId, this.amt));
/*    */   }
/*    */ }


/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\gm\main\Cmd_add_inner_save_amt.class
