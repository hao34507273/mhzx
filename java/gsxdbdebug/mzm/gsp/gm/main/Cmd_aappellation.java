...
/* 39 */       return false;
/*    */     }
/* 41 */     Integer I_appellationId = parseInt((String)this.m_arguments.get(index++));
/* 42 */     if (I_appellationId == null) {
/* 43 */       return false;
/*    */     }
/* 45 */     this.appellationId = I_appellationId.intValue();
/*    */     
...
/*    */   protected void run()
/*    */   {
/* 65 */     Role.addRoleProcedure(this.roleId, new PGM_AddAppellation(this.roleId, this.appellationId));
/*    */   }
/*    */ }


/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\gm\main\Cmd_aappellation.class
