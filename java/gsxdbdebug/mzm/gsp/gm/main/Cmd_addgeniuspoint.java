...
/*    */ 
/*    */ 
/*    */ public class Cmd_addgeniuspoint
/*    */   extends CmdBase
/*    */ {
/*    */   private long roleId;
/*    */   private int point;
...
/* 39 */       return false;
/*    */     }
/* 41 */     Integer I_point = parseInt((String)this.m_arguments.get(index++));
/* 42 */     if (I_point == null) {
/* 43 */       return false;
/*    */     }
/* 45 */     this.point = I_point.intValue();
/*    */     
...
/*    */   protected void run()
/*    */   {
/* 66 */     new PGM_AddGeniusPoint(this.m_gmRole.getRoleid(), this.roleId, this.point).execute();
/*    */   }
/*    */ }


/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\gm\main\Cmd_addgeniuspoint.class
