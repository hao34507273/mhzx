...
/*    */ 
/*    */ 
/*    */ public class Cmd_addskillnumpet
/*    */   extends CmdBase
/*    */ {
/*    */   private long roleId;
...
/* 49 */       return false;
/*    */     }
/* 51 */     Integer I_skillNum = parseInt((String)this.m_arguments.get(index++));
/* 52 */     if (I_skillNum == null) {
/* 53 */       return false;
/*    */     }
/* 55 */     this.skillNum = I_skillNum.intValue();
/*    */     
...
/*    */   protected void run()
/*    */   {
/* 76 */     new PGM_AddSkillNumPet(this.roleId, this.petCfgId, this.skillNum).execute();
/*    */   }
/*    */ }


/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\gm\main\Cmd_addskillnumpet.class
