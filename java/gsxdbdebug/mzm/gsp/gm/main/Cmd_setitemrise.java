...
/*    */ import mzm.gsp.Role;
/*    */ import mzm.gsp.shanghui.main.PGM_ChangeItemFlowRate;
/*    */ import xtable.Name2roleid;
/*    */ 
/*    */ 
/*    */ 
/*    */ 
/*    */ public class Cmd_setitemrise
/*    */   extends CmdBase
/*    */ {
/*    */   private long roleId;
/*    */   private int itemId;
...
/* 49 */       return false;
/*    */     }
/* 51 */     Integer I_rise = parseInt((String)this.m_arguments.get(index++));
/* 52 */     if (I_rise == null) {
/* 53 */       return false;
/*    */     }
/* 55 */     this.rise = I_rise.intValue();
/*    */     
...
/*    */   protected void run()
/*    */   {
/* 75 */     new PGM_ChangeItemFlowRate(this.roleId, this.itemId, this.rise).execute();
/*    */   }
/*    */ }


/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\gm\main\Cmd_setitemrise.class
