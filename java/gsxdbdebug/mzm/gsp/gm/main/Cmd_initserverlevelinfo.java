...
/*    */ 
/*    */ 
/*    */ public class Cmd_initserverlevelinfo
/*    */   extends CmdBase
/*    */ {
/*    */   private long roleId;
...
/* 39 */       return false;
/*    */     }
/* 41 */     this.initTime = ((String)this.m_arguments.get(index++));
...
/*    */   protected void run()
/*    */   {
/* 60 */     new PRestServerLevelTime(this.roleId, this.initTime).execute();
/*    */   }
/*    */ }


/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\gm\main\Cmd_initserverlevelinfo.class
