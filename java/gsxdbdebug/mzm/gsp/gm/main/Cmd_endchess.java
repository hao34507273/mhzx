...
/*    */ import mzm.gsp.Role;
/*    */ import mzm.gsp.chess.main.PGM_EndChess;
/*    */ import xtable.Name2roleid;
/*    */ 
/*    */ 
/*    */ 
/*    */ 
/*    */ public class Cmd_endchess
/*    */   extends CmdBase
/*    */ {
/*    */   private long roleId;
/*    */   private int result;
...
/* 39 */       return false;
/*    */     }
/* 41 */     Integer I_result = parseInt((String)this.m_arguments.get(index++));
/* 42 */     if (I_result == null) {
/* 43 */       return false;
/*    */     }
/* 45 */     this.result = I_result.intValue();
/*    */     
...
/*    */   protected void run()
/*    */   {
/* 66 */     new PGM_EndChess(this.roleId, this.result).execute();
/*    */   }
/*    */ }


/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\gm\main\Cmd_endchess.class
