...
/*    */ 
/*    */ public class Cmd_seimprovestage extends CmdBase
/*    */ {
/*    */   private long roleId;
/*    */   private int bagId;
/*    */   private int grid;
...
/*    */   protected void run()
/*    */   {
/* 86 */     new mzm.gsp.superequipment.main.RGMSuperEquipmentImproveStage(this.m_gmRole.getRoleid(), this.roleId, this.bagId, this.grid, this.useYuanbao != 0).execute();
/*    */   }
/*    */ }


/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\gm\main\Cmd_seimprovestage.class
