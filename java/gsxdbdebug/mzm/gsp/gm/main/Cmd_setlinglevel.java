...
/* 51 */       return false;
/*    */     }
/* 53 */     Integer I_level = parseInt((String)this.m_arguments.get(index++));
/* 54 */     if (I_level == null) {
/* 55 */       return false;
/*    */     }
/* 57 */     this.level = I_level.intValue();
/*    */     
...
/*    */         throws Exception
/*    */       {
/* 84 */         PGM_CheckLingLevel.setLingLevel(Cmd_setlinglevel.this.m_gmRole.getRoleid(), Cmd_setlinglevel.this.roleId, Cmd_setlinglevel.this.uuid, Cmd_setlinglevel.this.level);
/* 85 */         return true;
/*    */       }
/*    */     }.execute();
/*    */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\gm\main\Cmd_setlinglevel.class
