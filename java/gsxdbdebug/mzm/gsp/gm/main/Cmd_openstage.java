...
/*    */ import mzm.gsp.Role;
/*    */ import mzm.gsp.activity.main.PGM_OpenStage;
/*    */ import xtable.Name2roleid;
/*    */ 
/*    */ 
/*    */ 
/*    */ 
/*    */ public class Cmd_openstage
/*    */   extends CmdBase
/*    */ {
/*    */   private long roleId;
...
/* 49 */       return false;
/*    */     }
/* 51 */     Integer I_stage = parseInt((String)this.m_arguments.get(index++));
/* 52 */     if (I_stage == null) {
/* 53 */       return false;
/*    */     }
/* 55 */     this.stage = I_stage.intValue();
/*    */     
...
/*    */   protected void run()
/*    */   {
/* 76 */     Role.addRoleProcedure(this.roleId, new PGM_OpenStage(this.roleId, this.activityId, this.stage));
/*    */   }
/*    */ }


/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\gm\main\Cmd_openstage.class
