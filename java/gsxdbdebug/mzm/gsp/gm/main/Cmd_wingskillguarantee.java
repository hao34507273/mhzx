...
/*    */ import mzm.gsp.Role;
/*    */ import mzm.gsp.wing.main2.PGM_wingskillguarantee;
/*    */ import xtable.Name2roleid;
/*    */ 
/*    */ 
/*    */ 
/*    */ 
/*    */ public class Cmd_wingskillguarantee
/*    */   extends CmdBase
/*    */ {
/*    */   private long roleId;
/*    */   private int wingId;
...
/* 49 */       return false;
/*    */     }
/* 51 */     Integer I_guaranteeTimes = parseInt((String)this.m_arguments.get(index++));
/* 52 */     if (I_guaranteeTimes == null) {
/* 53 */       return false;
/*    */     }
/* 55 */     this.guaranteeTimes = I_guaranteeTimes.intValue();
/*    */     
...
/*    */   protected void run()
/*    */   {
/* 75 */     new PGM_wingskillguarantee(this.roleId, this.wingId, this.guaranteeTimes).execute();
/*    */   }
/*    */ }


/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\gm\main\Cmd_wingskillguarantee.class
