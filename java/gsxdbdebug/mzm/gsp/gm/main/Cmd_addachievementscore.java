...
/*    */ import mzm.gsp.Role;
/*    */ import mzm.gsp.achievement.main.PGM_AddAchievementScore;
...
/*    */ 
/*    */ 
/*    */ public class Cmd_addachievementscore
/*    */   extends CmdBase
/*    */ {
/*    */   private long roleId;
...
/* 51 */       return false;
/*    */     }
/* 53 */     Integer I_score = parseInt((String)this.m_arguments.get(index++));
/* 54 */     if (I_score == null) {
/* 55 */       return false;
/*    */     }
/* 57 */     this.score = I_score.intValue();
/*    */     
...
/*    */   protected void run()
/*    */   {
/* 78 */     new PGM_AddAchievementScore(this.roleId, this.activityId, this.score).execute();
/*    */   }
/*    */ }


/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\gm\main\Cmd_addachievementscore.class
