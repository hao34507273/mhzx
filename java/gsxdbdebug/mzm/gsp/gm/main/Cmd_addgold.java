...
/* 40 */       return false;
/*    */     }
/* 42 */     Integer I_number = parseInt((String)this.m_arguments.get(index++));
/* 43 */     if (I_number == null) {
/* 44 */       return false;
/*    */     }
/* 46 */     this.number = I_number.intValue();
/*    */     
...
/*    */   protected void run()
/*    */   {
/* 66 */     Role.addRoleProcedure(this.roleId, new PGMAddGold(this.roleId, this.number));
/*    */   }
/*    */ }


/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\gm\main\Cmd_addgold.class
