...
/*    */ import mzm.gsp.Role;
/*    */ import mzm.gsp.awardpool.main.PGM_PoolType;
/*    */ import xtable.Name2roleid;
/*    */ 
/*    */ 
/*    */ 
/*    */ 
/*    */ public class Cmd_pooltype
/*    */   extends CmdBase
/*    */ {
/*    */   private long roleId;
/*    */   private int typeid;
...
/* 39 */       return false;
/*    */     }
/* 41 */     Integer I_typeid = parseInt((String)this.m_arguments.get(index++));
/* 42 */     if (I_typeid == null) {
/* 43 */       return false;
/*    */     }
/* 45 */     this.typeid = I_typeid.intValue();
/*    */     
...
/*    */   protected void run()
/*    */   {
/* 66 */     new PGM_PoolType(this.roleId, this.typeid).execute();
/*    */   }
/*    */ }


/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\gm\main\Cmd_pooltype.class
