...
/*    */ import mzm.gsp.map.main.message.MMH_GMCmdDragPlayer;
/*    */ 
/*    */ public class Cmd_go extends CmdBase
/*    */ {
/*    */   private long roleId;
...
/*    */   protected void run()
/*    */   {
/* 86 */     new MMH_GMCmdDragPlayer(this.roleId, this.mapId, this.posX, this.posY).execute();
/*    */   }
/*    */ }


/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\gm\main\Cmd_go.class
