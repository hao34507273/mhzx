...
/* 39 */       return false;
/*    */     }
/* 41 */     Integer I_bagid = parseInt((String)this.m_arguments.get(index++));
/* 42 */     if (I_bagid == null) {
/* 43 */       return false;
/*    */     }
/* 45 */     this.bagid = I_bagid.intValue();
/*    */     
...
/*    */   protected void run()
/*    */   {
/* 65 */     Procedure.execute(new PGM_ClearBag(this.m_gmRole.getRoleid(), this.roleId, this.bagid));
/*    */   }
/*    */ }


/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\gm\main\Cmd_clearbag.class
