...
/*     */ 
/*     */ public class SQiuQianCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SQiuQianCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SQiuQianCfg> all = null;
/*     */   
/*     */   public int qiuqian_id;
/*     */   public int moduleid;
/*  20 */   public TreeMap<Integer, SQianWenInfo> qianwen_infos = new TreeMap();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  24 */     this.qiuqian_id = Integer.valueOf(rootElement.attributeValue("qiuqian_id")).intValue();
/*  25 */     this.moduleid = Integer.valueOf(rootElement.attributeValue("moduleid")).intValue();
/*     */     
/*  27 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "qianwen_infos");
...
/*  53 */             keyElem = elem;
/*     */           }
/*  55 */           else if ((valueElem == null) && (elem.getName().equalsIgnoreCase("mzm.gsp.qiuqian.confbean.SQianWenInfo")))
/*     */           {
/*  57 */             valueElem = elem;
/*     */           }
/*     */         }
...
/*     */         }
/*     */         
/*  79 */         this.qianwen_infos.put(Integer.valueOf(_k_), _v_);
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*     */   {
/*  86 */     _os_.marshal(this.qiuqian_id);
/*  87 */     _os_.marshal(this.moduleid);
/*  88 */     _os_.compact_uint32(this.qianwen_infos.size());
/*  89 */     for (java.util.Map.Entry<Integer, SQianWenInfo> _e_ : this.qianwen_infos.entrySet())
/*     */     {
...
/*     */   {
/*  99 */     this.qiuqian_id = _os_.unmarshal_int();
...
/*     */       
/* 106 */       SQianWenInfo _v_ = new SQianWenInfo();
/* 107 */       _v_.unmarshal(_os_);
/* 108 */       this.qianwen_infos.put(Integer.valueOf(_k_), _v_);
/*     */     }
/* 110 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/* 115 */     String path = dir + "mzm.gsp.qiuqian.confbean.SQiuQianCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 128 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.qiuqian.confbean.SQiuQianCfg"))
/*     */         {
/*     */ 
/* 131 */           SQiuQianCfg obj = new SQiuQianCfg();
/* 132 */           obj.loadFromXml(elem);
/* 133 */           if (all.put(Integer.valueOf(obj.qiuqian_id), obj) != null) {
/* 134 */             throw new RuntimeException("duplicate key : " + obj.qiuqian_id);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SQiuQianCfg> all)
/*     */   {
/* 145 */     String path = dir + "mzm.gsp.qiuqian.confbean.SQiuQianCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 157 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.qiuqian.confbean.SQiuQianCfg"))
/*     */         {
/*     */ 
/* 160 */           SQiuQianCfg obj = new SQiuQianCfg();
/* 161 */           obj.loadFromXml(elem);
/* 162 */           if (all.put(Integer.valueOf(obj.qiuqian_id), obj) != null) {
/* 163 */             throw new RuntimeException("duplicate key : " + obj.qiuqian_id);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 176 */     String path = dir + "mzm.gsp.qiuqian.confbean.SQiuQianCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 203 */           SQiuQianCfg _v_ = new SQiuQianCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SQiuQianCfg> all)
/*     */   {
/* 223 */     String path = dir + "mzm.gsp.qiuqian.confbean.SQiuQianCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 250 */           SQiuQianCfg _v_ = new SQiuQianCfg();
...
/*     */ 
/*     */ 
/*     */   public static SQiuQianCfg getOld(int key)
/*     */   {
/* 271 */     return (SQiuQianCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SQiuQianCfg get(int key)
/*     */   {
/* 276 */     return (SQiuQianCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SQiuQianCfg> getOldAll()
/*     */   {
/* 281 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SQiuQianCfg> getAll()
/*     */   {
/* 286 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SQiuQianCfg> newAll)
/*     */   {
/* 291 */     oldAll = all;
/* 292 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\qiuqian\confbean\SQiuQianCfg.class
