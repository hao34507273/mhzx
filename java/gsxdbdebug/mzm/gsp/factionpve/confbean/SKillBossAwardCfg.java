...
/*     */ 
/*     */ public class SKillBossAwardCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SKillBossAwardCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SKillBossAwardCfg> all = null;
/*     */   
/*     */   public int bossid;
...
/*     */   {
/*  24 */     this.bossid = Integer.valueOf(rootElement.attributeValue("bossid")).intValue();
/*  25 */     this.bossNumber = Integer.valueOf(rootElement.attributeValue("bossNumber")).intValue();
/*  26 */     this.awardid = Integer.valueOf(rootElement.attributeValue("awardid")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  31 */     _os_.marshal(this.bossid);
/*  32 */     _os_.marshal(this.bossNumber);
...
/*     */   {
/*  39 */     this.bossid = _os_.unmarshal_int();
/*  40 */     this.bossNumber = _os_.unmarshal_int();
...
/*     */   {
/*  47 */     String path = dir + "mzm.gsp.factionpve.confbean.SKillBossAwardCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  60 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.factionpve.confbean.SKillBossAwardCfg"))
/*     */         {
/*     */ 
/*  63 */           SKillBossAwardCfg obj = new SKillBossAwardCfg();
/*  64 */           obj.loadFromXml(elem);
/*  65 */           if (all.put(Integer.valueOf(obj.bossid), obj) != null) {
/*  66 */             throw new RuntimeException("duplicate key : " + obj.bossid);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SKillBossAwardCfg> all)
/*     */   {
/*  77 */     String path = dir + "mzm.gsp.factionpve.confbean.SKillBossAwardCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  89 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.factionpve.confbean.SKillBossAwardCfg"))
/*     */         {
/*     */ 
/*  92 */           SKillBossAwardCfg obj = new SKillBossAwardCfg();
/*  93 */           obj.loadFromXml(elem);
/*  94 */           if (all.put(Integer.valueOf(obj.bossid), obj) != null) {
/*  95 */             throw new RuntimeException("duplicate key : " + obj.bossid);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 108 */     String path = dir + "mzm.gsp.factionpve.confbean.SKillBossAwardCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 135 */           SKillBossAwardCfg _v_ = new SKillBossAwardCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SKillBossAwardCfg> all)
/*     */   {
/* 155 */     String path = dir + "mzm.gsp.factionpve.confbean.SKillBossAwardCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 182 */           SKillBossAwardCfg _v_ = new SKillBossAwardCfg();
...
/*     */ 
/*     */ 
/*     */   public static SKillBossAwardCfg getOld(int key)
/*     */   {
/* 203 */     return (SKillBossAwardCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SKillBossAwardCfg get(int key)
/*     */   {
/* 208 */     return (SKillBossAwardCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SKillBossAwardCfg> getOldAll()
/*     */   {
/* 213 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SKillBossAwardCfg> getAll()
/*     */   {
/* 218 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SKillBossAwardCfg> newAll)
/*     */   {
/* 223 */     oldAll = all;
/* 224 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\factionpve\confbean\SKillBossAwardCfg.class
