...
/*     */ 
/*     */ public class ServerLevelConsts
/*     */ {
/*  13 */   private static volatile ServerLevelConsts oldInstance = null;
/*     */   
/*  15 */   private static ServerLevelConsts instance = new ServerLevelConsts();
/*     */   
/*     */ 
/*     */   public int CRITICAL_SERVER_LEVEL;
/*     */   
/*     */ 
/*     */   public static ServerLevelConsts getOldInstance()
/*     */   {
/*  23 */     return oldInstance;
/*     */   }
/*     */   
/*     */   public static ServerLevelConsts getInstance()
/*     */   {
/*  28 */     return instance;
/*     */   }
/*     */   
...
/*     */   {
/*  40 */     String path = dir + "mzm.gsp.serverconf.confbean.ServerLevelConsts.xml";
/*     */     try
/*     */     {
...
/*     */         }
/*     */       }
/*  60 */       this.CRITICAL_SERVER_LEVEL = Integer.valueOf(((Element)data.get("CRITICAL_SERVER_LEVEL")).attributeValue("value")).intValue();
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*  69 */     String path = dir + "mzm.gsp.serverconf.confbean.ServerLevelConsts.xml";
/*     */     try
/*     */     {
...
/*     */         }
/*     */       }
/*  89 */       this.CRITICAL_SERVER_LEVEL = Integer.valueOf(((Element)data.get("CRITICAL_SERVER_LEVEL")).attributeValue("value")).intValue();
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/* 100 */     String path = dir + "mzm.gsp.serverconf.confbean.ServerLevelConsts.bny";
/*     */     try
/*     */     {
...
/* 115 */         this.CRITICAL_SERVER_LEVEL = _os_.unmarshal_int();
/*     */       }
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*     */   {
/* 126 */     String path = dir + "mzm.gsp.serverconf.confbean.ServerLevelConsts.bny";
/*     */     try
/*     */     {
...
/* 141 */         this.CRITICAL_SERVER_LEVEL = _os_.unmarshal_int();
/*     */       }
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*     */   }
/*     */   
/*     */   public static void setInstance(ServerLevelConsts newInstance)
/*     */   {
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\serverconf\confbean\ServerLevelConsts.class
