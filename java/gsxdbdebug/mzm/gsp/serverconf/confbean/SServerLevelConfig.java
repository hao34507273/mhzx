...
/*     */ 
/*     */ public class SServerLevelConfig implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SServerLevelConfig> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SServerLevelConfig> all = null;
/*     */   
/*     */   public int level;
/*     */   public int id;
/*     */   public int duration;
...
/*     */   {
/*  47 */     String path = dir + "mzm.gsp.serverconf.confbean.SServerLevelConfig.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  60 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.serverconf.confbean.SServerLevelConfig"))
/*     */         {
/*     */ 
/*  63 */           SServerLevelConfig obj = new SServerLevelConfig();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SServerLevelConfig> all)
/*     */   {
/*  77 */     String path = dir + "mzm.gsp.serverconf.confbean.SServerLevelConfig.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  89 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.serverconf.confbean.SServerLevelConfig"))
/*     */         {
/*     */ 
/*  92 */           SServerLevelConfig obj = new SServerLevelConfig();
...
/*     */     
/* 108 */     String path = dir + "mzm.gsp.serverconf.confbean.SServerLevelConfig.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 135 */           SServerLevelConfig _v_ = new SServerLevelConfig();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SServerLevelConfig> all)
/*     */   {
/* 155 */     String path = dir + "mzm.gsp.serverconf.confbean.SServerLevelConfig.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 182 */           SServerLevelConfig _v_ = new SServerLevelConfig();
...
/*     */ 
/*     */ 
/*     */   public static SServerLevelConfig getOld(int key)
/*     */   {
/* 203 */     return (SServerLevelConfig)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SServerLevelConfig get(int key)
/*     */   {
/* 208 */     return (SServerLevelConfig)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SServerLevelConfig> getOldAll()
/*     */   {
/* 213 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SServerLevelConfig> getAll()
/*     */   {
/* 218 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SServerLevelConfig> newAll)
/*     */   {
/* 223 */     oldAll = all;
/* 224 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\serverconf\confbean\SServerLevelConfig.class
