...
/*     */ 
/*     */ public class SRelatedBossCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SRelatedBossCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SRelatedBossCfg> all = null;
/*     */   
/*     */   public int mapBoss;
/*  19 */   public java.util.HashSet<Integer> relatedMapMonsters = new java.util.HashSet();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.mapBoss = Integer.valueOf(rootElement.attributeValue("mapBoss")).intValue();
/*     */     
/*  25 */     Element collectionElement = util.XmlHelper.getVariableElement(rootElement, "relatedMapMonsters");
...
/*     */         }
/*     */         
/*  50 */         this.relatedMapMonsters.add(Integer.valueOf(_v_));
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*     */   {
/*  57 */     _os_.marshal(this.mapBoss);
/*  58 */     _os_.compact_uint32(this.relatedMapMonsters.size());
/*  59 */     for (Integer _v_ : this.relatedMapMonsters)
/*     */     {
...
/*     */   {
/*  68 */     this.mapBoss = _os_.unmarshal_int();
/*  69 */     for (int _size_ = _os_.uncompact_uint32(); _size_ > 0; _size_--)
/*     */     {
/*     */ 
/*  72 */       int _v_ = _os_.unmarshal_int();
/*  73 */       this.relatedMapMonsters.add(Integer.valueOf(_v_));
/*     */     }
/*  75 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/*  80 */     String path = dir + "mzm.gsp.relatedboss.confbean.SRelatedBossCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.relatedboss.confbean.SRelatedBossCfg"))
/*     */         {
/*     */ 
/*  96 */           SRelatedBossCfg obj = new SRelatedBossCfg();
/*  97 */           obj.loadFromXml(elem);
/*  98 */           if (all.put(Integer.valueOf(obj.mapBoss), obj) != null) {
/*  99 */             throw new RuntimeException("duplicate key : " + obj.mapBoss);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SRelatedBossCfg> all)
/*     */   {
/* 110 */     String path = dir + "mzm.gsp.relatedboss.confbean.SRelatedBossCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 122 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.relatedboss.confbean.SRelatedBossCfg"))
/*     */         {
/*     */ 
/* 125 */           SRelatedBossCfg obj = new SRelatedBossCfg();
/* 126 */           obj.loadFromXml(elem);
/* 127 */           if (all.put(Integer.valueOf(obj.mapBoss), obj) != null) {
/* 128 */             throw new RuntimeException("duplicate key : " + obj.mapBoss);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 141 */     String path = dir + "mzm.gsp.relatedboss.confbean.SRelatedBossCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 168 */           SRelatedBossCfg _v_ = new SRelatedBossCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SRelatedBossCfg> all)
/*     */   {
/* 188 */     String path = dir + "mzm.gsp.relatedboss.confbean.SRelatedBossCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 215 */           SRelatedBossCfg _v_ = new SRelatedBossCfg();
...
/*     */ 
/*     */ 
/*     */   public static SRelatedBossCfg getOld(int key)
/*     */   {
/* 236 */     return (SRelatedBossCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SRelatedBossCfg get(int key)
/*     */   {
/* 241 */     return (SRelatedBossCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SRelatedBossCfg> getOldAll()
/*     */   {
/* 246 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SRelatedBossCfg> getAll()
/*     */   {
/* 251 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SRelatedBossCfg> newAll)
/*     */   {
/* 256 */     oldAll = all;
/* 257 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\relatedboss\confbean\SRelatedBossCfg.class
