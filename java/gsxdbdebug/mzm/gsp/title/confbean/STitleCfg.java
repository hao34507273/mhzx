...
/*     */ 
/*     */ public class STitleCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, STitleCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, STitleCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public String templateName;
/*     */   public String titleName;
/*     */   public String getMethod;
/*     */   public int titleOutTime;
...
/*  29 */     this.titleName = rootElement.attributeValue("titleName");
/*  30 */     this.getMethod = rootElement.attributeValue("getMethod");
/*  31 */     this.titleOutTime = Integer.valueOf(rootElement.attributeValue("titleOutTime")).intValue();
/*  32 */     this.titleLimit = Integer.valueOf(rootElement.attributeValue("titleLimit")).intValue();
/*     */   }
/*     */   
...
/*  39 */     _os_.marshal(this.titleName, "UTF-8");
/*  40 */     _os_.marshal(this.getMethod, "UTF-8");
/*  41 */     _os_.marshal(this.titleOutTime);
/*  42 */     _os_.marshal(this.titleLimit);
/*  43 */     return _os_;
/*     */   }
/*     */   
...
/*  50 */     this.titleName = _os_.unmarshal_String("UTF-8");
/*  51 */     this.getMethod = _os_.unmarshal_String("UTF-8");
/*  52 */     this.titleOutTime = _os_.unmarshal_int();
/*  53 */     this.titleLimit = _os_.unmarshal_int();
/*  54 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  59 */     String path = dir + "mzm.gsp.title.confbean.STitleCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  72 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.title.confbean.STitleCfg"))
/*     */         {
/*     */ 
/*  75 */           STitleCfg obj = new STitleCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, STitleCfg> all)
/*     */   {
/*  89 */     String path = dir + "mzm.gsp.title.confbean.STitleCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 101 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.title.confbean.STitleCfg"))
/*     */         {
/*     */ 
/* 104 */           STitleCfg obj = new STitleCfg();
...
/*     */     
/* 120 */     String path = dir + "mzm.gsp.title.confbean.STitleCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 147 */           STitleCfg _v_ = new STitleCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, STitleCfg> all)
/*     */   {
/* 167 */     String path = dir + "mzm.gsp.title.confbean.STitleCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 194 */           STitleCfg _v_ = new STitleCfg();
...
/*     */ 
/*     */ 
/*     */   public static STitleCfg getOld(int key)
/*     */   {
/* 215 */     return (STitleCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static STitleCfg get(int key)
/*     */   {
/* 220 */     return (STitleCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, STitleCfg> getOldAll()
/*     */   {
/* 225 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, STitleCfg> getAll()
/*     */   {
/* 230 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, STitleCfg> newAll)
/*     */   {
/* 235 */     oldAll = all;
/* 236 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\title\confbean\STitleCfg.class
