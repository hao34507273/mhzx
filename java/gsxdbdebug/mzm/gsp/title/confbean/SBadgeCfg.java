...
/*     */ 
/*     */ public class SBadgeCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SBadgeCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SBadgeCfg> all = null;
/*     */   
/*     */   public int id;
...
/*  26 */     this.badgeLimit = Integer.valueOf(rootElement.attributeValue("badgeLimit")).intValue();
/*     */   }
/*     */   
...
/*  33 */     _os_.marshal(this.badgeLimit);
/*  34 */     return _os_;
/*     */   }
/*     */   
...
/*  41 */     this.badgeLimit = _os_.unmarshal_int();
/*  42 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  47 */     String path = dir + "mzm.gsp.title.confbean.SBadgeCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  60 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.title.confbean.SBadgeCfg"))
/*     */         {
/*     */ 
/*  63 */           SBadgeCfg obj = new SBadgeCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SBadgeCfg> all)
/*     */   {
/*  77 */     String path = dir + "mzm.gsp.title.confbean.SBadgeCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  89 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.title.confbean.SBadgeCfg"))
/*     */         {
/*     */ 
/*  92 */           SBadgeCfg obj = new SBadgeCfg();
...
/*     */     
/* 108 */     String path = dir + "mzm.gsp.title.confbean.SBadgeCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 135 */           SBadgeCfg _v_ = new SBadgeCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SBadgeCfg> all)
/*     */   {
/* 155 */     String path = dir + "mzm.gsp.title.confbean.SBadgeCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 182 */           SBadgeCfg _v_ = new SBadgeCfg();
...
/*     */ 
/*     */ 
/*     */   public static SBadgeCfg getOld(int key)
/*     */   {
/* 203 */     return (SBadgeCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SBadgeCfg get(int key)
/*     */   {
/* 208 */     return (SBadgeCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SBadgeCfg> getOldAll()
/*     */   {
/* 213 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SBadgeCfg> getAll()
/*     */   {
/* 218 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SBadgeCfg> newAll)
/*     */   {
/* 223 */     oldAll = all;
/* 224 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\title\confbean\SBadgeCfg.class
