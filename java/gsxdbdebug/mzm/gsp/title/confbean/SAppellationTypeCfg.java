...
/*     */ 
/*     */ public class SAppellationTypeCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SAppellationTypeCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SAppellationTypeCfg> all = null;
/*     */   
/*     */   public int id;
...
/*  27 */     this.bigAppellation = Integer.valueOf(rootElement.attributeValue("bigAppellation")).intValue();
...
/*  35 */     _os_.marshal(this.bigAppellation);
...
/*  44 */     this.bigAppellation = _os_.unmarshal_int();
...
/*     */   {
/*  51 */     String path = dir + "mzm.gsp.title.confbean.SAppellationTypeCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  64 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.title.confbean.SAppellationTypeCfg"))
/*     */         {
/*     */ 
/*  67 */           SAppellationTypeCfg obj = new SAppellationTypeCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SAppellationTypeCfg> all)
/*     */   {
/*  81 */     String path = dir + "mzm.gsp.title.confbean.SAppellationTypeCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.title.confbean.SAppellationTypeCfg"))
/*     */         {
/*     */ 
/*  96 */           SAppellationTypeCfg obj = new SAppellationTypeCfg();
...
/*     */     
/* 112 */     String path = dir + "mzm.gsp.title.confbean.SAppellationTypeCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 139 */           SAppellationTypeCfg _v_ = new SAppellationTypeCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SAppellationTypeCfg> all)
/*     */   {
/* 159 */     String path = dir + "mzm.gsp.title.confbean.SAppellationTypeCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 186 */           SAppellationTypeCfg _v_ = new SAppellationTypeCfg();
...
/*     */ 
/*     */ 
/*     */   public static SAppellationTypeCfg getOld(int key)
/*     */   {
/* 207 */     return (SAppellationTypeCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SAppellationTypeCfg get(int key)
/*     */   {
/* 212 */     return (SAppellationTypeCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SAppellationTypeCfg> getOldAll()
/*     */   {
/* 217 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SAppellationTypeCfg> getAll()
/*     */   {
/* 222 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SAppellationTypeCfg> newAll)
/*     */   {
/* 227 */     oldAll = all;
/* 228 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\title\confbean\SAppellationTypeCfg.class
