...
/*     */ {
/*  13 */   private static volatile TitleConsts oldInstance = null;
/*     */   
/*  15 */   private static TitleConsts instance = new TitleConsts();
/*     */   
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   public static TitleConsts getOldInstance()
/*     */   {
/*  23 */     return oldInstance;
/*     */   }
/*     */   
/*     */   public static TitleConsts getInstance()
/*     */   {
/*  28 */     return instance;
/*     */   }
/*     */   
/*  31 */   public int TITLE_ICON_ID = 1;
/*  32 */   public int APPELLATION_ICON_ID = 2;
/*  33 */   public int BADGE_TIP = 701600000;
/*     */   
...
/*     */   {
/*  42 */     String path = dir + "mzm.gsp.title.confbean.TitleConsts.xml";
/*     */     try
/*     */     {
...
/*     */         }
/*     */       }
/*  62 */       this.TITLE_ICON_ID = Integer.valueOf(((Element)data.get("TITLE_ICON_ID")).attributeValue("value")).intValue();
/*  63 */       this.APPELLATION_ICON_ID = Integer.valueOf(((Element)data.get("APPELLATION_ICON_ID")).attributeValue("value")).intValue();
/*  64 */       this.BADGE_TIP = Integer.valueOf(((Element)data.get("BADGE_TIP")).attributeValue("value")).intValue();
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*  73 */     String path = dir + "mzm.gsp.title.confbean.TitleConsts.xml";
/*     */     try
/*     */     {
...
/*     */         }
/*     */       }
/*  93 */       this.TITLE_ICON_ID = Integer.valueOf(((Element)data.get("TITLE_ICON_ID")).attributeValue("value")).intValue();
/*  94 */       this.APPELLATION_ICON_ID = Integer.valueOf(((Element)data.get("APPELLATION_ICON_ID")).attributeValue("value")).intValue();
/*  95 */       this.BADGE_TIP = Integer.valueOf(((Element)data.get("BADGE_TIP")).attributeValue("value")).intValue();
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/* 106 */     String path = dir + "mzm.gsp.title.confbean.TitleConsts.bny";
/*     */     try
/*     */     {
...
/* 121 */         this.TITLE_ICON_ID = _os_.unmarshal_int();
/* 122 */         this.APPELLATION_ICON_ID = _os_.unmarshal_int();
/* 123 */         this.BADGE_TIP = _os_.unmarshal_int();
/*     */       }
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*     */   {
/* 134 */     String path = dir + "mzm.gsp.title.confbean.TitleConsts.bny";
/*     */     try
/*     */     {
...
/* 149 */         this.TITLE_ICON_ID = _os_.unmarshal_int();
/* 150 */         this.APPELLATION_ICON_ID = _os_.unmarshal_int();
/* 151 */         this.BADGE_TIP = _os_.unmarshal_int();
/*     */       }
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*     */   }
/*     */   
/*     */   public static void setInstance(TitleConsts newInstance)
/*     */   {
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\title\confbean\TitleConsts.class
