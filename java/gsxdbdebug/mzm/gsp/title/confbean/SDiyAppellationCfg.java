...
/*     */ 
/*     */ public class SDiyAppellationCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SDiyAppellationCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SDiyAppellationCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public String templateName;
/*     */   public int diyAppellationType;
/*     */   public String appellationTemplate;
/*     */   
...
/*  27 */     this.diyAppellationType = Integer.valueOf(rootElement.attributeValue("diyAppellationType")).intValue();
/*  28 */     this.appellationTemplate = rootElement.attributeValue("appellationTemplate");
/*     */   }
/*     */   
...
/*  35 */     _os_.marshal(this.diyAppellationType);
/*  36 */     _os_.marshal(this.appellationTemplate, "UTF-8");
/*  37 */     return _os_;
/*     */   }
/*     */   
...
/*  44 */     this.diyAppellationType = _os_.unmarshal_int();
/*  45 */     this.appellationTemplate = _os_.unmarshal_String("UTF-8");
/*  46 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  51 */     String path = dir + "mzm.gsp.title.confbean.SDiyAppellationCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  64 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.title.confbean.SDiyAppellationCfg"))
/*     */         {
/*     */ 
/*  67 */           SDiyAppellationCfg obj = new SDiyAppellationCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SDiyAppellationCfg> all)
/*     */   {
/*  81 */     String path = dir + "mzm.gsp.title.confbean.SDiyAppellationCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.title.confbean.SDiyAppellationCfg"))
/*     */         {
/*     */ 
/*  96 */           SDiyAppellationCfg obj = new SDiyAppellationCfg();
...
/*     */     
/* 112 */     String path = dir + "mzm.gsp.title.confbean.SDiyAppellationCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 139 */           SDiyAppellationCfg _v_ = new SDiyAppellationCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SDiyAppellationCfg> all)
/*     */   {
/* 159 */     String path = dir + "mzm.gsp.title.confbean.SDiyAppellationCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 186 */           SDiyAppellationCfg _v_ = new SDiyAppellationCfg();
...
/*     */ 
/*     */ 
/*     */   public static SDiyAppellationCfg getOld(int key)
/*     */   {
/* 207 */     return (SDiyAppellationCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SDiyAppellationCfg get(int key)
/*     */   {
/* 212 */     return (SDiyAppellationCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SDiyAppellationCfg> getOldAll()
/*     */   {
/* 217 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SDiyAppellationCfg> getAll()
/*     */   {
/* 222 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SDiyAppellationCfg> newAll)
/*     */   {
/* 227 */     oldAll = all;
/* 228 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\title\confbean\SDiyAppellationCfg.class
