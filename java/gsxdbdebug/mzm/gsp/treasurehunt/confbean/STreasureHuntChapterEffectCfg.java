...
/*     */ 
/*     */ public class STreasureHuntChapterEffectCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, STreasureHuntChapterEffectCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, STreasureHuntChapterEffectCfg> all = null;
/*     */   
/*     */   public int class_id;
/*  19 */   public HashMap<Integer, ChapterEffect> treasure_hunt_effect_cfg_map = new HashMap();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.class_id = Integer.valueOf(rootElement.attributeValue("class_id")).intValue();
/*     */     
/*  25 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "treasure_hunt_effect_cfg_map");
...
/*  51 */             keyElem = elem;
/*     */           }
/*  53 */           else if ((valueElem == null) && (elem.getName().equalsIgnoreCase("mzm.gsp.treasurehunt.confbean.ChapterEffect")))
/*     */           {
/*  55 */             valueElem = elem;
/*     */           }
/*     */         }
...
/*     */         }
/*     */         
/*  77 */         this.treasure_hunt_effect_cfg_map.put(Integer.valueOf(_k_), _v_);
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*  85 */     _os_.compact_uint32(this.treasure_hunt_effect_cfg_map.size());
/*  86 */     for (java.util.Map.Entry<Integer, ChapterEffect> _e_ : this.treasure_hunt_effect_cfg_map.entrySet())
/*     */     {
...
/*     */   {
/*  96 */     this.class_id = _os_.unmarshal_int();
/*  97 */     for (int _size_ = _os_.uncompact_uint32(); _size_ > 0; _size_--)
/*     */     {
/*     */ 
/* 100 */       int _k_ = _os_.unmarshal_int();
/*     */       
/* 102 */       ChapterEffect _v_ = new ChapterEffect();
/* 103 */       _v_.unmarshal(_os_);
/* 104 */       this.treasure_hunt_effect_cfg_map.put(Integer.valueOf(_k_), _v_);
/*     */     }
/* 106 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/* 111 */     String path = dir + "mzm.gsp.treasurehunt.confbean.STreasureHuntChapterEffectCfg.xml";
/*     */     
/*     */     try
/*     */     {
/* 115 */       all = new HashMap();
...
/* 124 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.treasurehunt.confbean.STreasureHuntChapterEffectCfg"))
/*     */         {
/*     */ 
/* 127 */           STreasureHuntChapterEffectCfg obj = new STreasureHuntChapterEffectCfg();
/* 128 */           obj.loadFromXml(elem);
/* 129 */           if (all.put(Integer.valueOf(obj.class_id), obj) != null) {
/* 130 */             throw new RuntimeException("duplicate key : " + obj.class_id);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, STreasureHuntChapterEffectCfg> all)
/*     */   {
/* 141 */     String path = dir + "mzm.gsp.treasurehunt.confbean.STreasureHuntChapterEffectCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 153 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.treasurehunt.confbean.STreasureHuntChapterEffectCfg"))
/*     */         {
/*     */ 
/* 156 */           STreasureHuntChapterEffectCfg obj = new STreasureHuntChapterEffectCfg();
/* 157 */           obj.loadFromXml(elem);
/* 158 */           if (all.put(Integer.valueOf(obj.class_id), obj) != null) {
/* 159 */             throw new RuntimeException("duplicate key : " + obj.class_id);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/* 170 */     all = new HashMap();
/*     */     
/* 172 */     String path = dir + "mzm.gsp.treasurehunt.confbean.STreasureHuntChapterEffectCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 199 */           STreasureHuntChapterEffectCfg _v_ = new STreasureHuntChapterEffectCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, STreasureHuntChapterEffectCfg> all)
/*     */   {
/* 219 */     String path = dir + "mzm.gsp.treasurehunt.confbean.STreasureHuntChapterEffectCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 246 */           STreasureHuntChapterEffectCfg _v_ = new STreasureHuntChapterEffectCfg();
...
/*     */ 
/*     */ 
/*     */   public static STreasureHuntChapterEffectCfg getOld(int key)
/*     */   {
/* 267 */     return (STreasureHuntChapterEffectCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static STreasureHuntChapterEffectCfg get(int key)
/*     */   {
/* 272 */     return (STreasureHuntChapterEffectCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, STreasureHuntChapterEffectCfg> getOldAll()
/*     */   {
/* 277 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, STreasureHuntChapterEffectCfg> getAll()
/*     */   {
/* 282 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, STreasureHuntChapterEffectCfg> newAll)
/*     */   {
/* 287 */     oldAll = all;
/* 288 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\treasurehunt\confbean\STreasureHuntChapterEffectCfg.class
