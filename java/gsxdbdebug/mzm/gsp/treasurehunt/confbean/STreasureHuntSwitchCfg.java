...
/*     */ 
/*     */ public class STreasureHuntSwitchCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, STreasureHuntSwitchCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, STreasureHuntSwitchCfg> all = null;
/*     */   
...
/*     */   {
/*  23 */     this.switch_type = Integer.valueOf(rootElement.attributeValue("switch_type")).intValue();
/*  24 */     this.activity_cfg_id = Integer.valueOf(rootElement.attributeValue("activity_cfg_id")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  29 */     _os_.marshal(this.switch_type);
...
/*     */   {
/*  36 */     this.switch_type = _os_.unmarshal_int();
...
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.treasurehunt.confbean.STreasureHuntSwitchCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.treasurehunt.confbean.STreasureHuntSwitchCfg"))
/*     */         {
/*     */ 
/*  59 */           STreasureHuntSwitchCfg obj = new STreasureHuntSwitchCfg();
/*  60 */           obj.loadFromXml(elem);
/*  61 */           if (all.put(Integer.valueOf(obj.switch_type), obj) != null) {
/*  62 */             throw new RuntimeException("duplicate key : " + obj.switch_type);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, STreasureHuntSwitchCfg> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.treasurehunt.confbean.STreasureHuntSwitchCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.treasurehunt.confbean.STreasureHuntSwitchCfg"))
/*     */         {
/*     */ 
/*  88 */           STreasureHuntSwitchCfg obj = new STreasureHuntSwitchCfg();
/*  89 */           obj.loadFromXml(elem);
/*  90 */           if (all.put(Integer.valueOf(obj.switch_type), obj) != null) {
/*  91 */             throw new RuntimeException("duplicate key : " + obj.switch_type);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.treasurehunt.confbean.STreasureHuntSwitchCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           STreasureHuntSwitchCfg _v_ = new STreasureHuntSwitchCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, STreasureHuntSwitchCfg> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.treasurehunt.confbean.STreasureHuntSwitchCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           STreasureHuntSwitchCfg _v_ = new STreasureHuntSwitchCfg();
...
/*     */ 
/*     */ 
/*     */   public static STreasureHuntSwitchCfg getOld(int key)
/*     */   {
/* 199 */     return (STreasureHuntSwitchCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static STreasureHuntSwitchCfg get(int key)
/*     */   {
/* 204 */     return (STreasureHuntSwitchCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, STreasureHuntSwitchCfg> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, STreasureHuntSwitchCfg> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, STreasureHuntSwitchCfg> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\treasurehunt\confbean\STreasureHuntSwitchCfg.class
