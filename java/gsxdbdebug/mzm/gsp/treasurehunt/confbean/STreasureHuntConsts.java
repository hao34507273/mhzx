...
/*     */ 
/*     */ public class STreasureHuntConsts
/*     */ {
/*  13 */   private static volatile STreasureHuntConsts oldInstance = null;
/*     */   
/*  15 */   private static STreasureHuntConsts instance = new STreasureHuntConsts();
/*     */   
/*     */ 
/*     */   public int christmas_treasure_hunt_activity_cfg_id;
/*     */   
/*     */ 
/*     */   public static STreasureHuntConsts getOldInstance()
/*     */   {
/*  23 */     return oldInstance;
/*     */   }
/*     */   
/*     */   public static STreasureHuntConsts getInstance()
/*     */   {
/*  28 */     return instance;
/*     */   }
/*     */   
...
/*     */   {
/*  40 */     String path = dir + "mzm.gsp.treasurehunt.confbean.STreasureHuntConsts.xml";
/*     */     try
/*     */     {
...
/*     */         }
/*     */       }
/*  60 */       this.christmas_treasure_hunt_activity_cfg_id = Integer.valueOf(((Element)data.get("christmas_treasure_hunt_activity_cfg_id")).attributeValue("value")).intValue();
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*  69 */     String path = dir + "mzm.gsp.treasurehunt.confbean.STreasureHuntConsts.xml";
/*     */     try
/*     */     {
...
/*     */         }
/*     */       }
/*  89 */       this.christmas_treasure_hunt_activity_cfg_id = Integer.valueOf(((Element)data.get("christmas_treasure_hunt_activity_cfg_id")).attributeValue("value")).intValue();
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/* 100 */     String path = dir + "mzm.gsp.treasurehunt.confbean.STreasureHuntConsts.bny";
/*     */     try
/*     */     {
...
/* 115 */         this.christmas_treasure_hunt_activity_cfg_id = _os_.unmarshal_int();
/*     */       }
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*     */   {
/* 126 */     String path = dir + "mzm.gsp.treasurehunt.confbean.STreasureHuntConsts.bny";
/*     */     try
/*     */     {
...
/* 141 */         this.christmas_treasure_hunt_activity_cfg_id = _os_.unmarshal_int();
/*     */       }
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*     */   }
/*     */   
/*     */   public static void setInstance(STreasureHuntConsts newInstance)
/*     */   {
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\treasurehunt\confbean\STreasureHuntConsts.class
