...
/*    */ 
/*    */ public class Times2eventType implements com.goldhuman.Common.Marshal.Marshal
/*    */ {
/*  9 */   public HashMap<Integer, TriggerEvent> times2eventType = new HashMap();
/*    */   
/*    */ 
/*    */   public void loadFromXml(Element rootElement)
/*    */   {
/* 14 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "times2eventType");
...
/* 40 */             keyElem = elem;
/*    */           }
/* 42 */           else if ((valueElem == null) && (elem.getName().equalsIgnoreCase("mzm.gsp.lonngboatrace.confbean.TriggerEvent")))
/*    */           {
/* 44 */             valueElem = elem;
/*    */           }
/*    */         }
...
/*    */         }
/*    */         
/* 66 */         this.times2eventType.put(Integer.valueOf(_k_), _v_);
/*    */       }
/*    */     }
/*    */   }
/*    */   
...
/*    */   {
/* 73 */     _os_.compact_uint32(this.times2eventType.size());
/* 74 */     for (java.util.Map.Entry<Integer, TriggerEvent> _e_ : this.times2eventType.entrySet())
/*    */     {
...
/*    */       
/* 89 */       TriggerEvent _v_ = new TriggerEvent();
/* 90 */       _v_.unmarshal(_os_);
/* 91 */       this.times2eventType.put(Integer.valueOf(_k_), _v_);
/*    */     }
/* 93 */     return _os_;
/*    */   }
/*    */ }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\lonngboatrace\confbean\Times2eventType.class
