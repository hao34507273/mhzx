...
/*     */ 
/*     */ public class STLonngBoatRaceEventCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, STLonngBoatRaceEventCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, STLonngBoatRaceEventCfg> all = null;
/*     */   
/*     */   public int id;
/*  19 */   public HashMap<Integer, EventId2Event> eventTypeId2Events = new HashMap();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.id = Integer.valueOf(rootElement.attributeValue("id")).intValue();
/*     */     
/*  25 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "eventTypeId2Events");
...
/*  51 */             keyElem = elem;
/*     */           }
/*  53 */           else if ((valueElem == null) && (elem.getName().equalsIgnoreCase("mzm.gsp.lonngboatrace.confbean.EventId2Event")))
/*     */           {
/*  55 */             valueElem = elem;
/*     */           }
/*     */         }
...
/*     */         }
/*     */         
/*  77 */         this.eventTypeId2Events.put(Integer.valueOf(_k_), _v_);
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*  85 */     _os_.compact_uint32(this.eventTypeId2Events.size());
/*  86 */     for (java.util.Map.Entry<Integer, EventId2Event> _e_ : this.eventTypeId2Events.entrySet())
/*     */     {
...
/*     */       
/* 102 */       EventId2Event _v_ = new EventId2Event();
/* 103 */       _v_.unmarshal(_os_);
/* 104 */       this.eventTypeId2Events.put(Integer.valueOf(_k_), _v_);
/*     */     }
/* 106 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/* 111 */     String path = dir + "mzm.gsp.lonngboatrace.confbean.STLonngBoatRaceEventCfg.xml";
/*     */     
/*     */     try
/*     */     {
/* 115 */       all = new HashMap();
...
/* 124 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.lonngboatrace.confbean.STLonngBoatRaceEventCfg"))
/*     */         {
/*     */ 
/* 127 */           STLonngBoatRaceEventCfg obj = new STLonngBoatRaceEventCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, STLonngBoatRaceEventCfg> all)
/*     */   {
/* 141 */     String path = dir + "mzm.gsp.lonngboatrace.confbean.STLonngBoatRaceEventCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 153 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.lonngboatrace.confbean.STLonngBoatRaceEventCfg"))
/*     */         {
/*     */ 
/* 156 */           STLonngBoatRaceEventCfg obj = new STLonngBoatRaceEventCfg();
...
/* 170 */     all = new HashMap();
/*     */     
/* 172 */     String path = dir + "mzm.gsp.lonngboatrace.confbean.STLonngBoatRaceEventCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 199 */           STLonngBoatRaceEventCfg _v_ = new STLonngBoatRaceEventCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, STLonngBoatRaceEventCfg> all)
/*     */   {
/* 219 */     String path = dir + "mzm.gsp.lonngboatrace.confbean.STLonngBoatRaceEventCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 246 */           STLonngBoatRaceEventCfg _v_ = new STLonngBoatRaceEventCfg();
...
/*     */ 
/*     */ 
/*     */   public static STLonngBoatRaceEventCfg getOld(int key)
/*     */   {
/* 267 */     return (STLonngBoatRaceEventCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static STLonngBoatRaceEventCfg get(int key)
/*     */   {
/* 272 */     return (STLonngBoatRaceEventCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, STLonngBoatRaceEventCfg> getOldAll()
/*     */   {
/* 277 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, STLonngBoatRaceEventCfg> getAll()
/*     */   {
/* 282 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, STLonngBoatRaceEventCfg> newAll)
/*     */   {
/* 287 */     oldAll = all;
/* 288 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\lonngboatrace\confbean\STLonngBoatRaceEventCfg.class
