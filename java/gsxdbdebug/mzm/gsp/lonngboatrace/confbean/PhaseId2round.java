...
/*    */ 
/*    */ public class PhaseId2round implements com.goldhuman.Common.Marshal.Marshal
/*    */ {
/*  9 */   public HashMap<Integer, Round2times> phaseId2round = new HashMap();
/*    */   
/*    */ 
/*    */   public void loadFromXml(Element rootElement)
/*    */   {
/* 14 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "phaseId2round");
...
/* 40 */             keyElem = elem;
/*    */           }
/* 42 */           else if ((valueElem == null) && (elem.getName().equalsIgnoreCase("mzm.gsp.lonngboatrace.confbean.Round2times")))
/*    */           {
/* 44 */             valueElem = elem;
/*    */           }
/*    */         }
...
/*    */         }
/*    */         
/* 66 */         this.phaseId2round.put(Integer.valueOf(_k_), _v_);
/*    */       }
/*    */     }
/*    */   }
/*    */   
...
/*    */   {
/* 73 */     _os_.compact_uint32(this.phaseId2round.size());
/* 74 */     for (java.util.Map.Entry<Integer, Round2times> _e_ : this.phaseId2round.entrySet())
/*    */     {
...
/*    */       
/* 89 */       Round2times _v_ = new Round2times();
/* 90 */       _v_.unmarshal(_os_);
/* 91 */       this.phaseId2round.put(Integer.valueOf(_k_), _v_);
/*    */     }
/* 93 */     return _os_;
/*    */   }
/*    */ }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\lonngboatrace\confbean\PhaseId2round.class
