...
/*     */ 
/*     */ public class STLonngBoatRaceEventTriggerCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, STLonngBoatRaceEventTriggerCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, STLonngBoatRaceEventTriggerCfg> all = null;
/*     */   
/*     */   public int id;
/*  19 */   public HashMap<Integer, PhaseId2round> raceId2phaseId = new HashMap();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.id = Integer.valueOf(rootElement.attributeValue("id")).intValue();
/*     */     
/*  25 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "raceId2phaseId");
...
/*  51 */             keyElem = elem;
/*     */           }
/*  53 */           else if ((valueElem == null) && (elem.getName().equalsIgnoreCase("mzm.gsp.lonngboatrace.confbean.PhaseId2round")))
/*     */           {
/*  55 */             valueElem = elem;
/*     */           }
/*     */         }
...
/*     */         }
/*     */         
/*  77 */         this.raceId2phaseId.put(Integer.valueOf(_k_), _v_);
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*     */   {
/*  84 */     _os_.marshal(this.id);
/*  85 */     _os_.compact_uint32(this.raceId2phaseId.size());
/*  86 */     for (java.util.Map.Entry<Integer, PhaseId2round> _e_ : this.raceId2phaseId.entrySet())
/*     */     {
...
/*     */       
/* 102 */       PhaseId2round _v_ = new PhaseId2round();
/* 103 */       _v_.unmarshal(_os_);
/* 104 */       this.raceId2phaseId.put(Integer.valueOf(_k_), _v_);
/*     */     }
/* 106 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/* 111 */     String path = dir + "mzm.gsp.lonngboatrace.confbean.STLonngBoatRaceEventTriggerCfg.xml";
/*     */     
/*     */     try
/*     */     {
/* 115 */       all = new HashMap();
...
/* 124 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.lonngboatrace.confbean.STLonngBoatRaceEventTriggerCfg"))
/*     */         {
/*     */ 
/* 127 */           STLonngBoatRaceEventTriggerCfg obj = new STLonngBoatRaceEventTriggerCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, STLonngBoatRaceEventTriggerCfg> all)
/*     */   {
/* 141 */     String path = dir + "mzm.gsp.lonngboatrace.confbean.STLonngBoatRaceEventTriggerCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 153 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.lonngboatrace.confbean.STLonngBoatRaceEventTriggerCfg"))
/*     */         {
/*     */ 
/* 156 */           STLonngBoatRaceEventTriggerCfg obj = new STLonngBoatRaceEventTriggerCfg();
...
/* 170 */     all = new HashMap();
/*     */     
/* 172 */     String path = dir + "mzm.gsp.lonngboatrace.confbean.STLonngBoatRaceEventTriggerCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 199 */           STLonngBoatRaceEventTriggerCfg _v_ = new STLonngBoatRaceEventTriggerCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, STLonngBoatRaceEventTriggerCfg> all)
/*     */   {
/* 219 */     String path = dir + "mzm.gsp.lonngboatrace.confbean.STLonngBoatRaceEventTriggerCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 246 */           STLonngBoatRaceEventTriggerCfg _v_ = new STLonngBoatRaceEventTriggerCfg();
...
/*     */ 
/*     */ 
/*     */   public static STLonngBoatRaceEventTriggerCfg getOld(int key)
/*     */   {
/* 267 */     return (STLonngBoatRaceEventTriggerCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static STLonngBoatRaceEventTriggerCfg get(int key)
/*     */   {
/* 272 */     return (STLonngBoatRaceEventTriggerCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, STLonngBoatRaceEventTriggerCfg> getOldAll()
/*     */   {
/* 277 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, STLonngBoatRaceEventTriggerCfg> getAll()
/*     */   {
/* 282 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, STLonngBoatRaceEventTriggerCfg> newAll)
/*     */   {
/* 287 */     oldAll = all;
/* 288 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\lonngboatrace\confbean\STLonngBoatRaceEventTriggerCfg.class
