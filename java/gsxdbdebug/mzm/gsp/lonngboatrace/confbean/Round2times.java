...
/*    */ 
/*    */ public class Round2times implements com.goldhuman.Common.Marshal.Marshal
/*    */ {
/*  9 */   public HashMap<Integer, Times2eventType> round2times = new HashMap();
/*    */   
/*    */ 
/*    */   public void loadFromXml(Element rootElement)
/*    */   {
/* 14 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "round2times");
...
/* 40 */             keyElem = elem;
/*    */           }
/* 42 */           else if ((valueElem == null) && (elem.getName().equalsIgnoreCase("mzm.gsp.lonngboatrace.confbean.Times2eventType")))
/*    */           {
/* 44 */             valueElem = elem;
/*    */           }
/*    */         }
...
/*    */         }
/*    */         
/* 66 */         this.round2times.put(Integer.valueOf(_k_), _v_);
/*    */       }
/*    */     }
/*    */   }
/*    */   
...
/*    */   {
/* 73 */     _os_.compact_uint32(this.round2times.size());
/* 74 */     for (java.util.Map.Entry<Integer, Times2eventType> _e_ : this.round2times.entrySet())
/*    */     {
...
/*    */       
/* 89 */       Times2eventType _v_ = new Times2eventType();
/* 90 */       _v_.unmarshal(_os_);
/* 91 */       this.round2times.put(Integer.valueOf(_k_), _v_);
/*    */     }
/* 93 */     return _os_;
/*    */   }
/*    */ }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\lonngboatrace\confbean\Round2times.class
