...
/*     */ 
/*     */ public class LonngBoatRaceConsoleCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, LonngBoatRaceConsoleCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, LonngBoatRaceConsoleCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public int raceId;
...
/*  26 */     this.raceId = Integer.valueOf(rootElement.attributeValue("raceId")).intValue();
/*  27 */     this.commandType = Integer.valueOf(rootElement.attributeValue("commandType")).intValue();
/*  28 */     this.commandName = rootElement.attributeValue("commandName");
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  33 */     _os_.marshal(this.id);
/*  34 */     _os_.marshal(this.raceId);
/*  35 */     _os_.marshal(this.commandType);
/*  36 */     _os_.marshal(this.commandName, "UTF-8");
/*  37 */     return _os_;
/*     */   }
/*     */   
...
/*  43 */     this.raceId = _os_.unmarshal_int();
/*  44 */     this.commandType = _os_.unmarshal_int();
/*  45 */     this.commandName = _os_.unmarshal_String("UTF-8");
/*  46 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  51 */     String path = dir + "mzm.gsp.lonngboatrace.confbean.LonngBoatRaceConsoleCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  64 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.lonngboatrace.confbean.LonngBoatRaceConsoleCfg"))
/*     */         {
/*     */ 
/*  67 */           LonngBoatRaceConsoleCfg obj = new LonngBoatRaceConsoleCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, LonngBoatRaceConsoleCfg> all)
/*     */   {
/*  81 */     String path = dir + "mzm.gsp.lonngboatrace.confbean.LonngBoatRaceConsoleCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.lonngboatrace.confbean.LonngBoatRaceConsoleCfg"))
/*     */         {
/*     */ 
/*  96 */           LonngBoatRaceConsoleCfg obj = new LonngBoatRaceConsoleCfg();
...
/*     */     
/* 112 */     String path = dir + "mzm.gsp.lonngboatrace.confbean.LonngBoatRaceConsoleCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 139 */           LonngBoatRaceConsoleCfg _v_ = new LonngBoatRaceConsoleCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, LonngBoatRaceConsoleCfg> all)
/*     */   {
/* 159 */     String path = dir + "mzm.gsp.lonngboatrace.confbean.LonngBoatRaceConsoleCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 186 */           LonngBoatRaceConsoleCfg _v_ = new LonngBoatRaceConsoleCfg();
...
/*     */ 
/*     */ 
/*     */   public static LonngBoatRaceConsoleCfg getOld(int key)
/*     */   {
/* 207 */     return (LonngBoatRaceConsoleCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static LonngBoatRaceConsoleCfg get(int key)
/*     */   {
/* 212 */     return (LonngBoatRaceConsoleCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, LonngBoatRaceConsoleCfg> getOldAll()
/*     */   {
/* 217 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, LonngBoatRaceConsoleCfg> getAll()
/*     */   {
/* 222 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, LonngBoatRaceConsoleCfg> newAll)
/*     */   {
/* 227 */     oldAll = all;
/* 228 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\lonngboatrace\confbean\LonngBoatRaceConsoleCfg.class
