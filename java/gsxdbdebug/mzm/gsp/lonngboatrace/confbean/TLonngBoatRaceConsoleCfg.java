...
/*     */ 
/*     */ public class TLonngBoatRaceConsoleCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, TLonngBoatRaceConsoleCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, TLonngBoatRaceConsoleCfg> all = null;
/*     */   
/*     */   public int raceId;
/*  19 */   public java.util.ArrayList<Command> commandList = new java.util.ArrayList();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.raceId = Integer.valueOf(rootElement.attributeValue("raceId")).intValue();
/*     */     
/*  25 */     Element collectionElement = util.XmlHelper.getVariableElement(rootElement, "commandList");
...
/*  36 */       if (elem.getName().equalsIgnoreCase("mzm.gsp.lonngboatrace.confbean.Command"))
/*     */       {
/*     */         Command _v_;
/*     */         
/*     */ 
...
/*     */   {
/*  58 */     _os_.marshal(this.raceId);
/*  59 */     _os_.compact_uint32(this.commandList.size());
/*  60 */     for (Command _v_ : this.commandList)
/*     */     {
/*  62 */       _os_.marshal(_v_);
/*     */     }
/*  64 */     return _os_;
...
/*     */     {
/*     */ 
/*  73 */       Command _v_ = new Command();
/*  74 */       _v_.unmarshal(_os_);
/*  75 */       this.commandList.add(_v_);
/*     */     }
/*  77 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/*  82 */     String path = dir + "mzm.gsp.lonngboatrace.confbean.TLonngBoatRaceConsoleCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  95 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.lonngboatrace.confbean.TLonngBoatRaceConsoleCfg"))
/*     */         {
/*     */ 
/*  98 */           TLonngBoatRaceConsoleCfg obj = new TLonngBoatRaceConsoleCfg();
/*  99 */           obj.loadFromXml(elem);
/* 100 */           if (all.put(Integer.valueOf(obj.raceId), obj) != null) {
/* 101 */             throw new RuntimeException("duplicate key : " + obj.raceId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, TLonngBoatRaceConsoleCfg> all)
/*     */   {
/* 112 */     String path = dir + "mzm.gsp.lonngboatrace.confbean.TLonngBoatRaceConsoleCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 124 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.lonngboatrace.confbean.TLonngBoatRaceConsoleCfg"))
/*     */         {
/*     */ 
/* 127 */           TLonngBoatRaceConsoleCfg obj = new TLonngBoatRaceConsoleCfg();
/* 128 */           obj.loadFromXml(elem);
/* 129 */           if (all.put(Integer.valueOf(obj.raceId), obj) != null) {
/* 130 */             throw new RuntimeException("duplicate key : " + obj.raceId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 143 */     String path = dir + "mzm.gsp.lonngboatrace.confbean.TLonngBoatRaceConsoleCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 170 */           TLonngBoatRaceConsoleCfg _v_ = new TLonngBoatRaceConsoleCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, TLonngBoatRaceConsoleCfg> all)
/*     */   {
/* 190 */     String path = dir + "mzm.gsp.lonngboatrace.confbean.TLonngBoatRaceConsoleCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 217 */           TLonngBoatRaceConsoleCfg _v_ = new TLonngBoatRaceConsoleCfg();
...
/*     */ 
/*     */ 
/*     */   public static TLonngBoatRaceConsoleCfg getOld(int key)
/*     */   {
/* 238 */     return (TLonngBoatRaceConsoleCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static TLonngBoatRaceConsoleCfg get(int key)
/*     */   {
/* 243 */     return (TLonngBoatRaceConsoleCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, TLonngBoatRaceConsoleCfg> getOldAll()
/*     */   {
/* 248 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, TLonngBoatRaceConsoleCfg> getAll()
/*     */   {
/* 253 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, TLonngBoatRaceConsoleCfg> newAll)
/*     */   {
/* 258 */     oldAll = all;
/* 259 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\lonngboatrace\confbean\TLonngBoatRaceConsoleCfg.class
