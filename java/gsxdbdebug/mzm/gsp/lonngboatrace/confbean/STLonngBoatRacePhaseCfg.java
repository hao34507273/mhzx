...
/*     */ 
/*     */ public class STLonngBoatRacePhaseCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, STLonngBoatRacePhaseCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, STLonngBoatRacePhaseCfg> all = null;
/*     */   
/*     */   public int id;
/*  19 */   public HashMap<Integer, PhaseNo2phase> raceId2phaseNos = new HashMap();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.id = Integer.valueOf(rootElement.attributeValue("id")).intValue();
/*     */     
/*  25 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "raceId2phaseNos");
...
/*  51 */             keyElem = elem;
/*     */           }
/*  53 */           else if ((valueElem == null) && (elem.getName().equalsIgnoreCase("mzm.gsp.lonngboatrace.confbean.PhaseNo2phase")))
/*     */           {
/*  55 */             valueElem = elem;
/*     */           }
/*     */         }
...
/*     */         }
/*     */         
/*  77 */         this.raceId2phaseNos.put(Integer.valueOf(_k_), _v_);
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*  85 */     _os_.compact_uint32(this.raceId2phaseNos.size());
/*  86 */     for (java.util.Map.Entry<Integer, PhaseNo2phase> _e_ : this.raceId2phaseNos.entrySet())
/*     */     {
...
/*     */       
/* 102 */       PhaseNo2phase _v_ = new PhaseNo2phase();
/* 103 */       _v_.unmarshal(_os_);
/* 104 */       this.raceId2phaseNos.put(Integer.valueOf(_k_), _v_);
/*     */     }
/* 106 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/* 111 */     String path = dir + "mzm.gsp.lonngboatrace.confbean.STLonngBoatRacePhaseCfg.xml";
/*     */     
/*     */     try
/*     */     {
/* 115 */       all = new HashMap();
...
/* 124 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.lonngboatrace.confbean.STLonngBoatRacePhaseCfg"))
/*     */         {
/*     */ 
/* 127 */           STLonngBoatRacePhaseCfg obj = new STLonngBoatRacePhaseCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, STLonngBoatRacePhaseCfg> all)
/*     */   {
/* 141 */     String path = dir + "mzm.gsp.lonngboatrace.confbean.STLonngBoatRacePhaseCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 153 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.lonngboatrace.confbean.STLonngBoatRacePhaseCfg"))
/*     */         {
/*     */ 
/* 156 */           STLonngBoatRacePhaseCfg obj = new STLonngBoatRacePhaseCfg();
...
/* 170 */     all = new HashMap();
/*     */     
/* 172 */     String path = dir + "mzm.gsp.lonngboatrace.confbean.STLonngBoatRacePhaseCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 199 */           STLonngBoatRacePhaseCfg _v_ = new STLonngBoatRacePhaseCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, STLonngBoatRacePhaseCfg> all)
/*     */   {
/* 219 */     String path = dir + "mzm.gsp.lonngboatrace.confbean.STLonngBoatRacePhaseCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 246 */           STLonngBoatRacePhaseCfg _v_ = new STLonngBoatRacePhaseCfg();
...
/*     */ 
/*     */ 
/*     */   public static STLonngBoatRacePhaseCfg getOld(int key)
/*     */   {
/* 267 */     return (STLonngBoatRacePhaseCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static STLonngBoatRacePhaseCfg get(int key)
/*     */   {
/* 272 */     return (STLonngBoatRacePhaseCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, STLonngBoatRacePhaseCfg> getOldAll()
/*     */   {
/* 277 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, STLonngBoatRacePhaseCfg> getAll()
/*     */   {
/* 282 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, STLonngBoatRacePhaseCfg> newAll)
/*     */   {
/* 287 */     oldAll = all;
/* 288 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\lonngboatrace\confbean\STLonngBoatRacePhaseCfg.class
