...
/*     */ 
/*     */ public class SLonngBoatRaceEventCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SLonngBoatRaceEventCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SLonngBoatRaceEventCfg> all = null;
/*     */   
/*     */   public int id;
...
/*  26 */     this.eventTypeId = Integer.valueOf(rootElement.attributeValue("eventTypeId")).intValue();
/*  27 */     this.weight = Integer.valueOf(rootElement.attributeValue("weight")).intValue();
/*  28 */     this.delta = Double.valueOf(rootElement.attributeValue("delta")).doubleValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  33 */     _os_.marshal(this.id);
/*  34 */     _os_.marshal(this.eventTypeId);
/*  35 */     _os_.marshal(this.weight);
/*  36 */     _os_.marshal(this.delta);
/*  37 */     return _os_;
/*     */   }
/*     */   
...
/*  43 */     this.eventTypeId = _os_.unmarshal_int();
/*  44 */     this.weight = _os_.unmarshal_int();
/*  45 */     this.delta = _os_.unmarshal_float();
/*  46 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  51 */     String path = dir + "mzm.gsp.lonngboatrace.confbean.SLonngBoatRaceEventCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  64 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.lonngboatrace.confbean.SLonngBoatRaceEventCfg"))
/*     */         {
/*     */ 
/*  67 */           SLonngBoatRaceEventCfg obj = new SLonngBoatRaceEventCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SLonngBoatRaceEventCfg> all)
/*     */   {
/*  81 */     String path = dir + "mzm.gsp.lonngboatrace.confbean.SLonngBoatRaceEventCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.lonngboatrace.confbean.SLonngBoatRaceEventCfg"))
/*     */         {
/*     */ 
/*  96 */           SLonngBoatRaceEventCfg obj = new SLonngBoatRaceEventCfg();
...
/*     */     
/* 112 */     String path = dir + "mzm.gsp.lonngboatrace.confbean.SLonngBoatRaceEventCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 139 */           SLonngBoatRaceEventCfg _v_ = new SLonngBoatRaceEventCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SLonngBoatRaceEventCfg> all)
/*     */   {
/* 159 */     String path = dir + "mzm.gsp.lonngboatrace.confbean.SLonngBoatRaceEventCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 186 */           SLonngBoatRaceEventCfg _v_ = new SLonngBoatRaceEventCfg();
...
/*     */ 
/*     */ 
/*     */   public static SLonngBoatRaceEventCfg getOld(int key)
/*     */   {
/* 207 */     return (SLonngBoatRaceEventCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SLonngBoatRaceEventCfg get(int key)
/*     */   {
/* 212 */     return (SLonngBoatRaceEventCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SLonngBoatRaceEventCfg> getOldAll()
/*     */   {
/* 217 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SLonngBoatRaceEventCfg> getAll()
/*     */   {
/* 222 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SLonngBoatRaceEventCfg> newAll)
/*     */   {
/* 227 */     oldAll = all;
/* 228 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\lonngboatrace\confbean\SLonngBoatRaceEventCfg.class
