...
/*     */ 
/*     */ public class STAwardId2gemCfgIds implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, STAwardId2gemCfgIds> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, STAwardId2gemCfgIds> all = null;
/*     */   
/*     */   public int awardId;
/*  19 */   public java.util.ArrayList<Integer> gemCfgIds = new java.util.ArrayList();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.awardId = Integer.valueOf(rootElement.attributeValue("awardId")).intValue();
/*     */     
/*  25 */     Element collectionElement = util.XmlHelper.getVariableElement(rootElement, "gemCfgIds");
...
/*     */         }
/*     */         
/*  50 */         this.gemCfgIds.add(Integer.valueOf(_v_));
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*     */   {
/*  57 */     _os_.marshal(this.awardId);
/*  58 */     _os_.compact_uint32(this.gemCfgIds.size());
/*  59 */     for (Integer _v_ : this.gemCfgIds)
/*     */     {
...
/*  73 */       this.gemCfgIds.add(Integer.valueOf(_v_));
/*     */     }
/*  75 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/*  80 */     String path = dir + "mzm.gsp.award.confbean.STAwardId2gemCfgIds.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.award.confbean.STAwardId2gemCfgIds"))
/*     */         {
/*     */ 
/*  96 */           STAwardId2gemCfgIds obj = new STAwardId2gemCfgIds();
/*  97 */           obj.loadFromXml(elem);
/*  98 */           if (all.put(Integer.valueOf(obj.awardId), obj) != null) {
/*  99 */             throw new RuntimeException("duplicate key : " + obj.awardId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, STAwardId2gemCfgIds> all)
/*     */   {
/* 110 */     String path = dir + "mzm.gsp.award.confbean.STAwardId2gemCfgIds.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 122 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.award.confbean.STAwardId2gemCfgIds"))
/*     */         {
/*     */ 
/* 125 */           STAwardId2gemCfgIds obj = new STAwardId2gemCfgIds();
/* 126 */           obj.loadFromXml(elem);
/* 127 */           if (all.put(Integer.valueOf(obj.awardId), obj) != null) {
/* 128 */             throw new RuntimeException("duplicate key : " + obj.awardId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 141 */     String path = dir + "mzm.gsp.award.confbean.STAwardId2gemCfgIds.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 168 */           STAwardId2gemCfgIds _v_ = new STAwardId2gemCfgIds();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, STAwardId2gemCfgIds> all)
/*     */   {
/* 188 */     String path = dir + "mzm.gsp.award.confbean.STAwardId2gemCfgIds.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 215 */           STAwardId2gemCfgIds _v_ = new STAwardId2gemCfgIds();
...
/*     */ 
/*     */ 
/*     */   public static STAwardId2gemCfgIds getOld(int key)
/*     */   {
/* 236 */     return (STAwardId2gemCfgIds)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static STAwardId2gemCfgIds get(int key)
/*     */   {
/* 241 */     return (STAwardId2gemCfgIds)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, STAwardId2gemCfgIds> getOldAll()
/*     */   {
/* 246 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, STAwardId2gemCfgIds> getAll()
/*     */   {
/* 251 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, STAwardId2gemCfgIds> newAll)
/*     */   {
/* 256 */     oldAll = all;
/* 257 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\award\confbean\STAwardId2gemCfgIds.class
