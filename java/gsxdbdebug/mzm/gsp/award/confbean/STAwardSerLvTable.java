...
/*     */ 
/*     */ public class STAwardSerLvTable implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, STAwardSerLvTable> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, STAwardSerLvTable> all = null;
/*     */   
/*     */   public int type;
/*  19 */   public HashMap<Integer, SAwardSerLvCfgs> effLv2cfgs = new HashMap();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.type = Integer.valueOf(rootElement.attributeValue("type")).intValue();
/*     */     
/*  25 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "effLv2cfgs");
...
/*  51 */             keyElem = elem;
/*     */           }
/*  53 */           else if ((valueElem == null) && (elem.getName().equalsIgnoreCase("mzm.gsp.award.confbean.SAwardSerLvCfgs")))
/*     */           {
/*  55 */             valueElem = elem;
/*     */           }
/*     */         }
...
/*     */         }
/*     */         
/*  77 */         this.effLv2cfgs.put(Integer.valueOf(_k_), _v_);
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*  85 */     _os_.compact_uint32(this.effLv2cfgs.size());
/*  86 */     for (java.util.Map.Entry<Integer, SAwardSerLvCfgs> _e_ : this.effLv2cfgs.entrySet())
/*     */     {
...
/*     */       
/* 102 */       SAwardSerLvCfgs _v_ = new SAwardSerLvCfgs();
/* 103 */       _v_.unmarshal(_os_);
/* 104 */       this.effLv2cfgs.put(Integer.valueOf(_k_), _v_);
/*     */     }
/* 106 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/* 111 */     String path = dir + "mzm.gsp.award.confbean.STAwardSerLvTable.xml";
/*     */     
/*     */     try
/*     */     {
/* 115 */       all = new HashMap();
...
/* 124 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.award.confbean.STAwardSerLvTable"))
/*     */         {
/*     */ 
/* 127 */           STAwardSerLvTable obj = new STAwardSerLvTable();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, STAwardSerLvTable> all)
/*     */   {
/* 141 */     String path = dir + "mzm.gsp.award.confbean.STAwardSerLvTable.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 153 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.award.confbean.STAwardSerLvTable"))
/*     */         {
/*     */ 
/* 156 */           STAwardSerLvTable obj = new STAwardSerLvTable();
...
/* 170 */     all = new HashMap();
/*     */     
/* 172 */     String path = dir + "mzm.gsp.award.confbean.STAwardSerLvTable.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 199 */           STAwardSerLvTable _v_ = new STAwardSerLvTable();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, STAwardSerLvTable> all)
/*     */   {
/* 219 */     String path = dir + "mzm.gsp.award.confbean.STAwardSerLvTable.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 246 */           STAwardSerLvTable _v_ = new STAwardSerLvTable();
...
/*     */ 
/*     */ 
/*     */   public static STAwardSerLvTable getOld(int key)
/*     */   {
/* 267 */     return (STAwardSerLvTable)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static STAwardSerLvTable get(int key)
/*     */   {
/* 272 */     return (STAwardSerLvTable)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, STAwardSerLvTable> getOldAll()
/*     */   {
/* 277 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, STAwardSerLvTable> getAll()
/*     */   {
/* 282 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, STAwardSerLvTable> newAll)
/*     */   {
/* 287 */     oldAll = all;
/* 288 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\award\confbean\STAwardSerLvTable.class
