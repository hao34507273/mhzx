...
/*     */ 
/*     */ public class STAward implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, STAward> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, STAward> all = null;
/*     */   
/*     */   public int awardId;
/*     */   public int sAwardId;
/*     */   
...
/*  24 */     this.sAwardId = Integer.valueOf(rootElement.attributeValue("sAwardId")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  29 */     _os_.marshal(this.awardId);
/*  30 */     _os_.marshal(this.sAwardId);
/*  31 */     return _os_;
/*     */   }
/*     */   
/*     */   public OctetsStream unmarshal(OctetsStream _os_) throws com.goldhuman.Common.Marshal.MarshalException
/*     */   {
/*  36 */     this.awardId = _os_.unmarshal_int();
/*  37 */     this.sAwardId = _os_.unmarshal_int();
/*  38 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.award.confbean.STAward.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.award.confbean.STAward"))
/*     */         {
/*     */ 
/*  59 */           STAward obj = new STAward();
/*  60 */           obj.loadFromXml(elem);
/*  61 */           if (all.put(Integer.valueOf(obj.awardId), obj) != null) {
/*  62 */             throw new RuntimeException("duplicate key : " + obj.awardId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, STAward> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.award.confbean.STAward.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.award.confbean.STAward"))
/*     */         {
/*     */ 
/*  88 */           STAward obj = new STAward();
/*  89 */           obj.loadFromXml(elem);
/*  90 */           if (all.put(Integer.valueOf(obj.awardId), obj) != null) {
/*  91 */             throw new RuntimeException("duplicate key : " + obj.awardId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.award.confbean.STAward.bny";
/*     */     try
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, STAward> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.award.confbean.STAward.bny";
/*     */     try
/*     */     {
...
/*     */ 
/*     */ 
/*     */   public static STAward getOld(int key)
/*     */   {
/* 199 */     return (STAward)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static STAward get(int key)
/*     */   {
/* 204 */     return (STAward)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, STAward> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, STAward> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, STAward> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\award\confbean\STAward.class
