...
/*     */ 
/*     */ public class STAwardServerLevel_son2 implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, STAwardServerLevel_son2> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, STAwardServerLevel_son2> all = null;
/*     */   
/*     */   public int effectLevel;
/*  19 */   public java.util.ArrayList<ServerLevelModify> awardServerLevels = new java.util.ArrayList();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.effectLevel = Integer.valueOf(rootElement.attributeValue("effectLevel")).intValue();
/*     */     
/*  25 */     Element collectionElement = util.XmlHelper.getVariableElement(rootElement, "awardServerLevels");
...
/*  36 */       if (elem.getName().equalsIgnoreCase("mzm.gsp.award.confbean.ServerLevelModify"))
/*     */       {
...
/*     */         }
/*     */         
/*  51 */         this.awardServerLevels.add(_v_);
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*     */   {
/*  58 */     _os_.marshal(this.effectLevel);
/*  59 */     _os_.compact_uint32(this.awardServerLevels.size());
/*  60 */     for (ServerLevelModify _v_ : this.awardServerLevels)
/*     */     {
/*  62 */       _os_.marshal(_v_);
/*     */     }
/*  64 */     return _os_;
...
/*     */   {
/*  69 */     this.effectLevel = _os_.unmarshal_int();
/*  70 */     for (int _size_ = _os_.uncompact_uint32(); _size_ > 0; _size_--)
/*     */     {
/*     */ 
/*  73 */       ServerLevelModify _v_ = new ServerLevelModify();
/*  74 */       _v_.unmarshal(_os_);
/*  75 */       this.awardServerLevels.add(_v_);
/*     */     }
/*  77 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/*  82 */     String path = dir + "mzm.gsp.award.confbean.STAwardServerLevel_son2.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  95 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.award.confbean.STAwardServerLevel_son2"))
/*     */         {
/*     */ 
/*  98 */           STAwardServerLevel_son2 obj = new STAwardServerLevel_son2();
/*  99 */           obj.loadFromXml(elem);
/* 100 */           if (all.put(Integer.valueOf(obj.effectLevel), obj) != null) {
/* 101 */             throw new RuntimeException("duplicate key : " + obj.effectLevel);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, STAwardServerLevel_son2> all)
/*     */   {
/* 112 */     String path = dir + "mzm.gsp.award.confbean.STAwardServerLevel_son2.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 124 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.award.confbean.STAwardServerLevel_son2"))
/*     */         {
/*     */ 
/* 127 */           STAwardServerLevel_son2 obj = new STAwardServerLevel_son2();
/* 128 */           obj.loadFromXml(elem);
/* 129 */           if (all.put(Integer.valueOf(obj.effectLevel), obj) != null) {
/* 130 */             throw new RuntimeException("duplicate key : " + obj.effectLevel);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 143 */     String path = dir + "mzm.gsp.award.confbean.STAwardServerLevel_son2.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 170 */           STAwardServerLevel_son2 _v_ = new STAwardServerLevel_son2();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, STAwardServerLevel_son2> all)
/*     */   {
/* 190 */     String path = dir + "mzm.gsp.award.confbean.STAwardServerLevel_son2.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 217 */           STAwardServerLevel_son2 _v_ = new STAwardServerLevel_son2();
...
/*     */ 
/*     */ 
/*     */   public static STAwardServerLevel_son2 getOld(int key)
/*     */   {
/* 238 */     return (STAwardServerLevel_son2)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static STAwardServerLevel_son2 get(int key)
/*     */   {
/* 243 */     return (STAwardServerLevel_son2)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, STAwardServerLevel_son2> getOldAll()
/*     */   {
/* 248 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, STAwardServerLevel_son2> getAll()
/*     */   {
/* 253 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, STAwardServerLevel_son2> newAll)
/*     */   {
/* 258 */     oldAll = all;
/* 259 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\award\confbean\STAwardServerLevel_son2.class
