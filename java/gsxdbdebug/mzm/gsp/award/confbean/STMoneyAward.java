...
/*     */ 
/*     */ public class STMoneyAward implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, STMoneyAward> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, STMoneyAward> all = null;
/*     */   
/*     */   public int moneyAwardId;
/*  19 */   public java.util.ArrayList<Integer> sAwardMoneyIds = new java.util.ArrayList();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.moneyAwardId = Integer.valueOf(rootElement.attributeValue("moneyAwardId")).intValue();
/*     */     
/*  25 */     Element collectionElement = util.XmlHelper.getVariableElement(rootElement, "sAwardMoneyIds");
...
/*     */         }
/*     */         
/*  50 */         this.sAwardMoneyIds.add(Integer.valueOf(_v_));
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*     */   {
/*  57 */     _os_.marshal(this.moneyAwardId);
/*  58 */     _os_.compact_uint32(this.sAwardMoneyIds.size());
/*  59 */     for (Integer _v_ : this.sAwardMoneyIds)
/*     */     {
...
/*     */   {
/*  68 */     this.moneyAwardId = _os_.unmarshal_int();
/*  69 */     for (int _size_ = _os_.uncompact_uint32(); _size_ > 0; _size_--)
/*     */     {
/*     */ 
/*  72 */       int _v_ = _os_.unmarshal_int();
/*  73 */       this.sAwardMoneyIds.add(Integer.valueOf(_v_));
/*     */     }
/*  75 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/*  80 */     String path = dir + "mzm.gsp.award.confbean.STMoneyAward.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.award.confbean.STMoneyAward"))
/*     */         {
/*     */ 
/*  96 */           STMoneyAward obj = new STMoneyAward();
/*  97 */           obj.loadFromXml(elem);
/*  98 */           if (all.put(Integer.valueOf(obj.moneyAwardId), obj) != null) {
/*  99 */             throw new RuntimeException("duplicate key : " + obj.moneyAwardId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, STMoneyAward> all)
/*     */   {
/* 110 */     String path = dir + "mzm.gsp.award.confbean.STMoneyAward.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 122 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.award.confbean.STMoneyAward"))
/*     */         {
/*     */ 
/* 125 */           STMoneyAward obj = new STMoneyAward();
/* 126 */           obj.loadFromXml(elem);
/* 127 */           if (all.put(Integer.valueOf(obj.moneyAwardId), obj) != null) {
/* 128 */             throw new RuntimeException("duplicate key : " + obj.moneyAwardId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 141 */     String path = dir + "mzm.gsp.award.confbean.STMoneyAward.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 168 */           STMoneyAward _v_ = new STMoneyAward();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, STMoneyAward> all)
/*     */   {
/* 188 */     String path = dir + "mzm.gsp.award.confbean.STMoneyAward.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 215 */           STMoneyAward _v_ = new STMoneyAward();
...
/*     */ 
/*     */ 
/*     */   public static STMoneyAward getOld(int key)
/*     */   {
/* 236 */     return (STMoneyAward)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static STMoneyAward get(int key)
/*     */   {
/* 241 */     return (STMoneyAward)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, STMoneyAward> getOldAll()
/*     */   {
/* 246 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, STMoneyAward> getAll()
/*     */   {
/* 251 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, STMoneyAward> newAll)
/*     */   {
/* 256 */     oldAll = all;
/* 257 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\award\confbean\STMoneyAward.class
