...
/*     */ 
/*     */ public class OfflineExpAward implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, OfflineExpAward> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, OfflineExpAward> all = null;
/*     */   
/*     */   public int id;
...
/*  30 */     this.expPerMinute = Integer.valueOf(rootElement.attributeValue("expPerMinute")).intValue();
/*     */   }
/*     */   
...
/*  39 */     _os_.marshal(this.expPerMinute);
/*  40 */     return _os_;
/*     */   }
/*     */   
...
/*  49 */     this.expPerMinute = _os_.unmarshal_int();
/*  50 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  55 */     String path = dir + "mzm.gsp.award.confbean.OfflineExpAward.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  68 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.award.confbean.OfflineExpAward"))
/*     */         {
/*     */ 
/*  71 */           OfflineExpAward obj = new OfflineExpAward();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, OfflineExpAward> all)
/*     */   {
/*  85 */     String path = dir + "mzm.gsp.award.confbean.OfflineExpAward.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  97 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.award.confbean.OfflineExpAward"))
/*     */         {
/*     */ 
/* 100 */           OfflineExpAward obj = new OfflineExpAward();
...
/*     */     
/* 116 */     String path = dir + "mzm.gsp.award.confbean.OfflineExpAward.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 143 */           OfflineExpAward _v_ = new OfflineExpAward();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, OfflineExpAward> all)
/*     */   {
/* 163 */     String path = dir + "mzm.gsp.award.confbean.OfflineExpAward.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 190 */           OfflineExpAward _v_ = new OfflineExpAward();
...
/*     */ 
/*     */ 
/*     */   public static OfflineExpAward getOld(int key)
/*     */   {
/* 211 */     return (OfflineExpAward)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static OfflineExpAward get(int key)
/*     */   {
/* 216 */     return (OfflineExpAward)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, OfflineExpAward> getOldAll()
/*     */   {
/* 221 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, OfflineExpAward> getAll()
/*     */   {
/* 226 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, OfflineExpAward> newAll)
/*     */   {
/* 231 */     oldAll = all;
/* 232 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\award\confbean\OfflineExpAward.class
