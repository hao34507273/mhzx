...
/*     */ 
/*     */ public class STAwardGemCfgIds implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, STAwardGemCfgIds> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, STAwardGemCfgIds> all = null;
/*     */   
/*     */   public int gemCfgId;
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  22 */     this.gemCfgId = Integer.valueOf(rootElement.attributeValue("gemCfgId")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  27 */     _os_.marshal(this.gemCfgId);
/*  28 */     return _os_;
/*     */   }
/*     */   
/*     */   public OctetsStream unmarshal(OctetsStream _os_) throws com.goldhuman.Common.Marshal.MarshalException
/*     */   {
/*  33 */     this.gemCfgId = _os_.unmarshal_int();
/*  34 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  39 */     String path = dir + "mzm.gsp.award.confbean.STAwardGemCfgIds.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  52 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.award.confbean.STAwardGemCfgIds"))
/*     */         {
/*     */ 
/*  55 */           STAwardGemCfgIds obj = new STAwardGemCfgIds();
/*  56 */           obj.loadFromXml(elem);
/*  57 */           if (all.put(Integer.valueOf(obj.gemCfgId), obj) != null) {
/*  58 */             throw new RuntimeException("duplicate key : " + obj.gemCfgId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, STAwardGemCfgIds> all)
/*     */   {
/*  69 */     String path = dir + "mzm.gsp.award.confbean.STAwardGemCfgIds.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  81 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.award.confbean.STAwardGemCfgIds"))
/*     */         {
/*     */ 
/*  84 */           STAwardGemCfgIds obj = new STAwardGemCfgIds();
/*  85 */           obj.loadFromXml(elem);
/*  86 */           if (all.put(Integer.valueOf(obj.gemCfgId), obj) != null) {
/*  87 */             throw new RuntimeException("duplicate key : " + obj.gemCfgId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 100 */     String path = dir + "mzm.gsp.award.confbean.STAwardGemCfgIds.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 127 */           STAwardGemCfgIds _v_ = new STAwardGemCfgIds();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, STAwardGemCfgIds> all)
/*     */   {
/* 147 */     String path = dir + "mzm.gsp.award.confbean.STAwardGemCfgIds.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 174 */           STAwardGemCfgIds _v_ = new STAwardGemCfgIds();
...
/*     */ 
/*     */ 
/*     */   public static STAwardGemCfgIds getOld(int key)
/*     */   {
/* 195 */     return (STAwardGemCfgIds)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static STAwardGemCfgIds get(int key)
/*     */   {
/* 200 */     return (STAwardGemCfgIds)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, STAwardGemCfgIds> getOldAll()
/*     */   {
/* 205 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, STAwardGemCfgIds> getAll()
/*     */   {
/* 210 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, STAwardGemCfgIds> newAll)
/*     */   {
/* 215 */     oldAll = all;
/* 216 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\award\confbean\STAwardGemCfgIds.class
