...
/*     */ 
/*     */ public class STExpAward implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, STExpAward> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, STExpAward> all = null;
/*     */   
/*     */   public int expAwardId;
/*  19 */   public java.util.ArrayList<Integer> sAwardExpIds = new java.util.ArrayList();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.expAwardId = Integer.valueOf(rootElement.attributeValue("expAwardId")).intValue();
/*     */     
/*  25 */     Element collectionElement = util.XmlHelper.getVariableElement(rootElement, "sAwardExpIds");
...
/*     */         }
/*     */         
/*  50 */         this.sAwardExpIds.add(Integer.valueOf(_v_));
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*     */   {
/*  57 */     _os_.marshal(this.expAwardId);
/*  58 */     _os_.compact_uint32(this.sAwardExpIds.size());
/*  59 */     for (Integer _v_ : this.sAwardExpIds)
/*     */     {
...
/*     */   {
/*  80 */     String path = dir + "mzm.gsp.award.confbean.STExpAward.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.award.confbean.STExpAward"))
/*     */         {
/*     */ 
/*  96 */           STExpAward obj = new STExpAward();
/*  97 */           obj.loadFromXml(elem);
/*  98 */           if (all.put(Integer.valueOf(obj.expAwardId), obj) != null) {
/*  99 */             throw new RuntimeException("duplicate key : " + obj.expAwardId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, STExpAward> all)
/*     */   {
/* 110 */     String path = dir + "mzm.gsp.award.confbean.STExpAward.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 122 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.award.confbean.STExpAward"))
/*     */         {
/*     */ 
/* 125 */           STExpAward obj = new STExpAward();
/* 126 */           obj.loadFromXml(elem);
/* 127 */           if (all.put(Integer.valueOf(obj.expAwardId), obj) != null) {
/* 128 */             throw new RuntimeException("duplicate key : " + obj.expAwardId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 141 */     String path = dir + "mzm.gsp.award.confbean.STExpAward.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 168 */           STExpAward _v_ = new STExpAward();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, STExpAward> all)
/*     */   {
/* 188 */     String path = dir + "mzm.gsp.award.confbean.STExpAward.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 215 */           STExpAward _v_ = new STExpAward();
...
/*     */ 
/*     */ 
/*     */   public static STExpAward getOld(int key)
/*     */   {
/* 236 */     return (STExpAward)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static STExpAward get(int key)
/*     */   {
/* 241 */     return (STExpAward)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, STExpAward> getOldAll()
/*     */   {
/* 246 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, STExpAward> getAll()
/*     */   {
/* 251 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, STExpAward> newAll)
/*     */   {
/* 256 */     oldAll = all;
/* 257 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\award\confbean\STExpAward.class
