...
/*     */ 
/*     */ public class SAwardItemContent implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SAwardItemContent> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SAwardItemContent> all = null;
/*     */   
/*     */   public int id;
/*     */   public String templatename;
/*  20 */   public java.util.ArrayList<ItemdropMod> itemdropModList = new java.util.ArrayList();
/*     */   
...
/*     */     
/*  27 */     Element collectionElement = util.XmlHelper.getVariableElement(rootElement, "itemdropModList");
...
/*  38 */       if (elem.getName().equalsIgnoreCase("mzm.gsp.award.confbean.ItemdropMod"))
/*     */       {
/*     */         ItemdropMod _v_;
/*     */         
/*     */ 
...
/*     */         }
/*     */         
/*  53 */         this.itemdropModList.add(_v_);
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*  62 */     _os_.compact_uint32(this.itemdropModList.size());
/*  63 */     for (ItemdropMod _v_ : this.itemdropModList)
/*     */     {
/*  65 */       _os_.marshal(_v_);
/*     */     }
/*  67 */     return _os_;
...
/*     */     {
/*     */ 
/*  77 */       ItemdropMod _v_ = new ItemdropMod();
/*  78 */       _v_.unmarshal(_os_);
/*  79 */       this.itemdropModList.add(_v_);
/*     */     }
/*  81 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/*  86 */     String path = dir + "mzm.gsp.award.confbean.SAwardItemContent.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  99 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.award.confbean.SAwardItemContent"))
/*     */         {
/*     */ 
/* 102 */           SAwardItemContent obj = new SAwardItemContent();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SAwardItemContent> all)
/*     */   {
/* 116 */     String path = dir + "mzm.gsp.award.confbean.SAwardItemContent.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 128 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.award.confbean.SAwardItemContent"))
/*     */         {
/*     */ 
/* 131 */           SAwardItemContent obj = new SAwardItemContent();
...
/*     */     
/* 147 */     String path = dir + "mzm.gsp.award.confbean.SAwardItemContent.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 174 */           SAwardItemContent _v_ = new SAwardItemContent();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SAwardItemContent> all)
/*     */   {
/* 194 */     String path = dir + "mzm.gsp.award.confbean.SAwardItemContent.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 221 */           SAwardItemContent _v_ = new SAwardItemContent();
...
/*     */ 
/*     */ 
/*     */   public static SAwardItemContent getOld(int key)
/*     */   {
/* 242 */     return (SAwardItemContent)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SAwardItemContent get(int key)
/*     */   {
/* 247 */     return (SAwardItemContent)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SAwardItemContent> getOldAll()
/*     */   {
/* 252 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SAwardItemContent> getAll()
/*     */   {
/* 257 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SAwardItemContent> newAll)
/*     */   {
/* 262 */     oldAll = all;
/* 263 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\award\confbean\SAwardItemContent.class
