...
/*     */ 
/*     */ public class STimeDropItemCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, STimeDropItemCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, STimeDropItemCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public int itemId;
/*     */   public int singleGainNumMax;
/*     */   public int globalGainNumMax;
/*     */   public int count;
/*     */   
...
/*  28 */     this.singleGainNumMax = Integer.valueOf(rootElement.attributeValue("singleGainNumMax")).intValue();
/*  29 */     this.globalGainNumMax = Integer.valueOf(rootElement.attributeValue("globalGainNumMax")).intValue();
/*  30 */     this.count = Integer.valueOf(rootElement.attributeValue("count")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  35 */     _os_.marshal(this.id);
/*  36 */     _os_.marshal(this.itemId);
/*  37 */     _os_.marshal(this.singleGainNumMax);
/*  38 */     _os_.marshal(this.globalGainNumMax);
/*  39 */     _os_.marshal(this.count);
/*  40 */     return _os_;
/*     */   }
/*     */   
...
/*  46 */     this.itemId = _os_.unmarshal_int();
/*  47 */     this.singleGainNumMax = _os_.unmarshal_int();
/*  48 */     this.globalGainNumMax = _os_.unmarshal_int();
...
/*     */   {
/*  55 */     String path = dir + "mzm.gsp.award.confbean.STimeDropItemCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  68 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.award.confbean.STimeDropItemCfg"))
/*     */         {
/*     */ 
/*  71 */           STimeDropItemCfg obj = new STimeDropItemCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, STimeDropItemCfg> all)
/*     */   {
/*  85 */     String path = dir + "mzm.gsp.award.confbean.STimeDropItemCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  97 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.award.confbean.STimeDropItemCfg"))
/*     */         {
/*     */ 
/* 100 */           STimeDropItemCfg obj = new STimeDropItemCfg();
...
/*     */     
/* 116 */     String path = dir + "mzm.gsp.award.confbean.STimeDropItemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 143 */           STimeDropItemCfg _v_ = new STimeDropItemCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, STimeDropItemCfg> all)
/*     */   {
/* 163 */     String path = dir + "mzm.gsp.award.confbean.STimeDropItemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 190 */           STimeDropItemCfg _v_ = new STimeDropItemCfg();
...
/*     */ 
/*     */ 
/*     */   public static STimeDropItemCfg getOld(int key)
/*     */   {
/* 211 */     return (STimeDropItemCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static STimeDropItemCfg get(int key)
/*     */   {
/* 216 */     return (STimeDropItemCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, STimeDropItemCfg> getOldAll()
/*     */   {
/* 221 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, STimeDropItemCfg> getAll()
/*     */   {
/* 226 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, STimeDropItemCfg> newAll)
/*     */   {
/* 231 */     oldAll = all;
/* 232 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\award\confbean\STimeDropItemCfg.class
