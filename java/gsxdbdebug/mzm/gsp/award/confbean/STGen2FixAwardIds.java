...
/*    */ 
/*    */ public class STGen2FixAwardIds implements com.goldhuman.Common.Marshal.Marshal
/*    */ {
/*  9 */   public HashMap<Integer, Integer> gender2FixAwardCfgId = new HashMap();
/*    */   
/*    */ 
/*    */   public void loadFromXml(Element rootElement)
/*    */   {
/* 14 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "gender2FixAwardCfgId");
...
/*    */         }
/*    */         
/* 65 */         this.gender2FixAwardCfgId.put(Integer.valueOf(_k_), Integer.valueOf(_v_));
/*    */       }
/*    */     }
/*    */   }
/*    */   
...
/*    */   {
/* 72 */     _os_.compact_uint32(this.gender2FixAwardCfgId.size());
/* 73 */     for (java.util.Map.Entry<Integer, Integer> _e_ : this.gender2FixAwardCfgId.entrySet())
/*    */     {
...
/* 89 */       this.gender2FixAwardCfgId.put(Integer.valueOf(_k_), Integer.valueOf(_v_));
/*    */     }
/* 91 */     return _os_;
/*    */   }
/*    */ }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\award\confbean\STGen2FixAwardIds.class
