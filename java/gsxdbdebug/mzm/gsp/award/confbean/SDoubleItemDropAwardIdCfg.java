...
/*     */ 
/*     */ public class SDoubleItemDropAwardIdCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SDoubleItemDropAwardIdCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SDoubleItemDropAwardIdCfg> all = null;
/*     */   
/*     */   public int award_id;
/*     */   public int id;
/*     */   
...
/*     */   {
/*  23 */     this.award_id = Integer.valueOf(rootElement.attributeValue("award_id")).intValue();
/*  24 */     this.id = Integer.valueOf(rootElement.attributeValue("id")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  29 */     _os_.marshal(this.award_id);
...
/*     */   {
/*  36 */     this.award_id = _os_.unmarshal_int();
...
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.award.confbean.SDoubleItemDropAwardIdCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.award.confbean.SDoubleItemDropAwardIdCfg"))
/*     */         {
/*     */ 
/*  59 */           SDoubleItemDropAwardIdCfg obj = new SDoubleItemDropAwardIdCfg();
/*  60 */           obj.loadFromXml(elem);
/*  61 */           if (all.put(Integer.valueOf(obj.award_id), obj) != null) {
/*  62 */             throw new RuntimeException("duplicate key : " + obj.award_id);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SDoubleItemDropAwardIdCfg> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.award.confbean.SDoubleItemDropAwardIdCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.award.confbean.SDoubleItemDropAwardIdCfg"))
/*     */         {
/*     */ 
/*  88 */           SDoubleItemDropAwardIdCfg obj = new SDoubleItemDropAwardIdCfg();
/*  89 */           obj.loadFromXml(elem);
/*  90 */           if (all.put(Integer.valueOf(obj.award_id), obj) != null) {
/*  91 */             throw new RuntimeException("duplicate key : " + obj.award_id);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.award.confbean.SDoubleItemDropAwardIdCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           SDoubleItemDropAwardIdCfg _v_ = new SDoubleItemDropAwardIdCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SDoubleItemDropAwardIdCfg> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.award.confbean.SDoubleItemDropAwardIdCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           SDoubleItemDropAwardIdCfg _v_ = new SDoubleItemDropAwardIdCfg();
...
/*     */ 
/*     */ 
/*     */   public static SDoubleItemDropAwardIdCfg getOld(int key)
/*     */   {
/* 199 */     return (SDoubleItemDropAwardIdCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SDoubleItemDropAwardIdCfg get(int key)
/*     */   {
/* 204 */     return (SDoubleItemDropAwardIdCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SDoubleItemDropAwardIdCfg> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SDoubleItemDropAwardIdCfg> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SDoubleItemDropAwardIdCfg> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\award\confbean\SDoubleItemDropAwardIdCfg.class
