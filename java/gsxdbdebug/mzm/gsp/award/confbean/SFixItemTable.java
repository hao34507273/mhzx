...
/*     */ 
/*     */ public class SFixItemTable implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SFixItemTable> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SFixItemTable> all = null;
/*     */   
/*     */   public int id;
/*  19 */   public java.util.ArrayList<FixItemBean> itemList = new java.util.ArrayList();
/*     */   
...
/*  36 */       if (elem.getName().equalsIgnoreCase("mzm.gsp.award.confbean.FixItemBean"))
/*     */       {
/*     */         FixItemBean _v_;
/*     */         
/*     */ 
...
/*  59 */     _os_.compact_uint32(this.itemList.size());
/*  60 */     for (FixItemBean _v_ : this.itemList)
/*     */     {
/*  62 */       _os_.marshal(_v_);
/*     */     }
/*  64 */     return _os_;
...
/*     */     {
/*     */ 
/*  73 */       FixItemBean _v_ = new FixItemBean();
/*  74 */       _v_.unmarshal(_os_);
/*  75 */       this.itemList.add(_v_);
/*     */     }
/*  77 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/*  82 */     String path = dir + "mzm.gsp.award.confbean.SFixItemTable.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  95 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.award.confbean.SFixItemTable"))
/*     */         {
/*     */ 
/*  98 */           SFixItemTable obj = new SFixItemTable();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SFixItemTable> all)
/*     */   {
/* 112 */     String path = dir + "mzm.gsp.award.confbean.SFixItemTable.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 124 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.award.confbean.SFixItemTable"))
/*     */         {
/*     */ 
/* 127 */           SFixItemTable obj = new SFixItemTable();
...
/*     */     
/* 143 */     String path = dir + "mzm.gsp.award.confbean.SFixItemTable.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 170 */           SFixItemTable _v_ = new SFixItemTable();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SFixItemTable> all)
/*     */   {
/* 190 */     String path = dir + "mzm.gsp.award.confbean.SFixItemTable.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 217 */           SFixItemTable _v_ = new SFixItemTable();
...
/*     */ 
/*     */ 
/*     */   public static SFixItemTable getOld(int key)
/*     */   {
/* 238 */     return (SFixItemTable)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SFixItemTable get(int key)
/*     */   {
/* 243 */     return (SFixItemTable)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SFixItemTable> getOldAll()
/*     */   {
/* 248 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SFixItemTable> getAll()
/*     */   {
/* 253 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SFixItemTable> newAll)
/*     */   {
/* 258 */     oldAll = all;
/* 259 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\award\confbean\SFixItemTable.class
