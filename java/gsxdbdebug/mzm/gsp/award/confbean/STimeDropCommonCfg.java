...
/*     */ 
/*     */ public class STimeDropCommonCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, STimeDropCommonCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, STimeDropCommonCfg> all = null;
/*     */   
/*     */   public int id;
...
/*  26 */     this.dropLibId = Integer.valueOf(rootElement.attributeValue("dropLibId")).intValue();
/*  27 */     this.itemDropId = Integer.valueOf(rootElement.attributeValue("itemDropId")).intValue();
...
/*  34 */     _os_.marshal(this.dropLibId);
/*  35 */     _os_.marshal(this.itemDropId);
...
/*  43 */     this.dropLibId = _os_.unmarshal_int();
/*  44 */     this.itemDropId = _os_.unmarshal_int();
...
/*     */   {
/*  51 */     String path = dir + "mzm.gsp.award.confbean.STimeDropCommonCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  64 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.award.confbean.STimeDropCommonCfg"))
/*     */         {
/*     */ 
/*  67 */           STimeDropCommonCfg obj = new STimeDropCommonCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, STimeDropCommonCfg> all)
/*     */   {
/*  81 */     String path = dir + "mzm.gsp.award.confbean.STimeDropCommonCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.award.confbean.STimeDropCommonCfg"))
/*     */         {
/*     */ 
/*  96 */           STimeDropCommonCfg obj = new STimeDropCommonCfg();
...
/*     */     
/* 112 */     String path = dir + "mzm.gsp.award.confbean.STimeDropCommonCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 139 */           STimeDropCommonCfg _v_ = new STimeDropCommonCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, STimeDropCommonCfg> all)
/*     */   {
/* 159 */     String path = dir + "mzm.gsp.award.confbean.STimeDropCommonCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 186 */           STimeDropCommonCfg _v_ = new STimeDropCommonCfg();
...
/*     */ 
/*     */ 
/*     */   public static STimeDropCommonCfg getOld(int key)
/*     */   {
/* 207 */     return (STimeDropCommonCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static STimeDropCommonCfg get(int key)
/*     */   {
/* 212 */     return (STimeDropCommonCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, STimeDropCommonCfg> getOldAll()
/*     */   {
/* 217 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, STimeDropCommonCfg> getAll()
/*     */   {
/* 222 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, STimeDropCommonCfg> newAll)
/*     */   {
/* 227 */     oldAll = all;
/* 228 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\award\confbean\STimeDropCommonCfg.class
