...
/*     */ 
/*     */ public class SAwardServerLevel implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SAwardServerLevel> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SAwardServerLevel> all = null;
/*     */   
...
/*     */   {
/*  82 */     String path = dir + "mzm.gsp.award.confbean.SAwardServerLevel.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  95 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.award.confbean.SAwardServerLevel"))
/*     */         {
/*     */ 
/*  98 */           SAwardServerLevel obj = new SAwardServerLevel();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SAwardServerLevel> all)
/*     */   {
/* 112 */     String path = dir + "mzm.gsp.award.confbean.SAwardServerLevel.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 124 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.award.confbean.SAwardServerLevel"))
/*     */         {
/*     */ 
/* 127 */           SAwardServerLevel obj = new SAwardServerLevel();
...
/*     */     
/* 143 */     String path = dir + "mzm.gsp.award.confbean.SAwardServerLevel.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 170 */           SAwardServerLevel _v_ = new SAwardServerLevel();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SAwardServerLevel> all)
/*     */   {
/* 190 */     String path = dir + "mzm.gsp.award.confbean.SAwardServerLevel.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 217 */           SAwardServerLevel _v_ = new SAwardServerLevel();
...
/*     */ 
/*     */ 
/*     */   public static SAwardServerLevel getOld(int key)
/*     */   {
/* 238 */     return (SAwardServerLevel)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SAwardServerLevel get(int key)
/*     */   {
/* 243 */     return (SAwardServerLevel)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SAwardServerLevel> getOldAll()
/*     */   {
/* 248 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SAwardServerLevel> getAll()
/*     */   {
/* 253 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SAwardServerLevel> newAll)
/*     */   {
/* 258 */     oldAll = all;
/* 259 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\award\confbean\SAwardServerLevel.class
