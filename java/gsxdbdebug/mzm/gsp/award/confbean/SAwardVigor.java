...
/*     */ 
/*     */ public class SAwardVigor implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SAwardVigor> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SAwardVigor> all = null;
/*     */   
/*     */   public int id;
...
/*  29 */     this.awardType = Integer.valueOf(rootElement.attributeValue("awardType")).intValue();
...
/*  32 */     this.awardVigor = Integer.valueOf(rootElement.attributeValue("awardVigor")).intValue();
/*     */   }
/*     */   
...
/*  39 */     _os_.marshal(this.awardType);
/*  40 */     _os_.marshal(this.levelMin);
/*  41 */     _os_.marshal(this.levelMax);
/*  42 */     _os_.marshal(this.awardVigor);
/*  43 */     return _os_;
/*     */   }
/*     */   
...
/*  50 */     this.awardType = _os_.unmarshal_int();
/*  51 */     this.levelMin = _os_.unmarshal_int();
/*  52 */     this.levelMax = _os_.unmarshal_int();
/*  53 */     this.awardVigor = _os_.unmarshal_int();
/*  54 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  59 */     String path = dir + "mzm.gsp.award.confbean.SAwardVigor.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  72 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.award.confbean.SAwardVigor"))
/*     */         {
/*     */ 
/*  75 */           SAwardVigor obj = new SAwardVigor();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SAwardVigor> all)
/*     */   {
/*  89 */     String path = dir + "mzm.gsp.award.confbean.SAwardVigor.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 101 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.award.confbean.SAwardVigor"))
/*     */         {
/*     */ 
/* 104 */           SAwardVigor obj = new SAwardVigor();
...
/*     */     
/* 120 */     String path = dir + "mzm.gsp.award.confbean.SAwardVigor.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 147 */           SAwardVigor _v_ = new SAwardVigor();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SAwardVigor> all)
/*     */   {
/* 167 */     String path = dir + "mzm.gsp.award.confbean.SAwardVigor.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 194 */           SAwardVigor _v_ = new SAwardVigor();
...
/*     */ 
/*     */ 
/*     */   public static SAwardVigor getOld(int key)
/*     */   {
/* 215 */     return (SAwardVigor)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SAwardVigor get(int key)
/*     */   {
/* 220 */     return (SAwardVigor)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SAwardVigor> getOldAll()
/*     */   {
/* 225 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SAwardVigor> getAll()
/*     */   {
/* 230 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SAwardVigor> newAll)
/*     */   {
/* 235 */     oldAll = all;
/* 236 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\award\confbean\SAwardVigor.class
