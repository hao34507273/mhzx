...
/*     */ 
/*     */ public class STTokenOwnCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, STTokenOwnCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, STTokenOwnCfg> all = null;
/*     */   
...
/*     */   {
/*  24 */     this.tokenType = Integer.valueOf(rootElement.attributeValue("tokenType")).intValue();
/*  25 */     this.tokenName = rootElement.attributeValue("tokenName");
/*  26 */     this.ownMax = Integer.valueOf(rootElement.attributeValue("ownMax")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  31 */     _os_.marshal(this.tokenType);
/*  32 */     _os_.marshal(this.tokenName, "UTF-8");
/*  33 */     _os_.marshal(this.ownMax);
/*  34 */     return _os_;
/*     */   }
/*     */   
/*     */   public OctetsStream unmarshal(OctetsStream _os_) throws com.goldhuman.Common.Marshal.MarshalException
/*     */   {
/*  39 */     this.tokenType = _os_.unmarshal_int();
/*  40 */     this.tokenName = _os_.unmarshal_String("UTF-8");
/*  41 */     this.ownMax = _os_.unmarshal_int();
/*  42 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  47 */     String path = dir + "mzm.gsp.award.confbean.STTokenOwnCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  60 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.award.confbean.STTokenOwnCfg"))
/*     */         {
/*     */ 
/*  63 */           STTokenOwnCfg obj = new STTokenOwnCfg();
/*  64 */           obj.loadFromXml(elem);
/*  65 */           if (all.put(Integer.valueOf(obj.tokenType), obj) != null) {
/*  66 */             throw new RuntimeException("duplicate key : " + obj.tokenType);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, STTokenOwnCfg> all)
/*     */   {
/*  77 */     String path = dir + "mzm.gsp.award.confbean.STTokenOwnCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  89 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.award.confbean.STTokenOwnCfg"))
/*     */         {
/*     */ 
/*  92 */           STTokenOwnCfg obj = new STTokenOwnCfg();
/*  93 */           obj.loadFromXml(elem);
/*  94 */           if (all.put(Integer.valueOf(obj.tokenType), obj) != null) {
/*  95 */             throw new RuntimeException("duplicate key : " + obj.tokenType);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 108 */     String path = dir + "mzm.gsp.award.confbean.STTokenOwnCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 135 */           STTokenOwnCfg _v_ = new STTokenOwnCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, STTokenOwnCfg> all)
/*     */   {
/* 155 */     String path = dir + "mzm.gsp.award.confbean.STTokenOwnCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 182 */           STTokenOwnCfg _v_ = new STTokenOwnCfg();
...
/*     */ 
/*     */ 
/*     */   public static STTokenOwnCfg getOld(int key)
/*     */   {
/* 203 */     return (STTokenOwnCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static STTokenOwnCfg get(int key)
/*     */   {
/* 208 */     return (STTokenOwnCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, STTokenOwnCfg> getOldAll()
/*     */   {
/* 213 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, STTokenOwnCfg> getAll()
/*     */   {
/* 218 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, STTokenOwnCfg> newAll)
/*     */   {
/* 223 */     oldAll = all;
/* 224 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\award\confbean\STTokenOwnCfg.class
