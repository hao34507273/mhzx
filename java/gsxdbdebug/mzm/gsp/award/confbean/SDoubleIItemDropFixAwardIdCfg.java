...
/*     */ 
/*     */ public class SDoubleIItemDropFixAwardIdCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SDoubleIItemDropFixAwardIdCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SDoubleIItemDropFixAwardIdCfg> all = null;
/*     */   
...
/*     */   {
/*  23 */     this.fix_award_id = Integer.valueOf(rootElement.attributeValue("fix_award_id")).intValue();
/*  24 */     this.id = Integer.valueOf(rootElement.attributeValue("id")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  29 */     _os_.marshal(this.fix_award_id);
/*  30 */     _os_.marshal(this.id);
/*  31 */     return _os_;
/*     */   }
/*     */   
/*     */   public OctetsStream unmarshal(OctetsStream _os_) throws com.goldhuman.Common.Marshal.MarshalException
/*     */   {
/*  36 */     this.fix_award_id = _os_.unmarshal_int();
...
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.award.confbean.SDoubleIItemDropFixAwardIdCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.award.confbean.SDoubleIItemDropFixAwardIdCfg"))
/*     */         {
/*     */ 
/*  59 */           SDoubleIItemDropFixAwardIdCfg obj = new SDoubleIItemDropFixAwardIdCfg();
/*  60 */           obj.loadFromXml(elem);
/*  61 */           if (all.put(Integer.valueOf(obj.fix_award_id), obj) != null) {
/*  62 */             throw new RuntimeException("duplicate key : " + obj.fix_award_id);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SDoubleIItemDropFixAwardIdCfg> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.award.confbean.SDoubleIItemDropFixAwardIdCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.award.confbean.SDoubleIItemDropFixAwardIdCfg"))
/*     */         {
/*     */ 
/*  88 */           SDoubleIItemDropFixAwardIdCfg obj = new SDoubleIItemDropFixAwardIdCfg();
/*  89 */           obj.loadFromXml(elem);
/*  90 */           if (all.put(Integer.valueOf(obj.fix_award_id), obj) != null) {
/*  91 */             throw new RuntimeException("duplicate key : " + obj.fix_award_id);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.award.confbean.SDoubleIItemDropFixAwardIdCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           SDoubleIItemDropFixAwardIdCfg _v_ = new SDoubleIItemDropFixAwardIdCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SDoubleIItemDropFixAwardIdCfg> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.award.confbean.SDoubleIItemDropFixAwardIdCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           SDoubleIItemDropFixAwardIdCfg _v_ = new SDoubleIItemDropFixAwardIdCfg();
...
/*     */ 
/*     */ 
/*     */   public static SDoubleIItemDropFixAwardIdCfg getOld(int key)
/*     */   {
/* 199 */     return (SDoubleIItemDropFixAwardIdCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SDoubleIItemDropFixAwardIdCfg get(int key)
/*     */   {
/* 204 */     return (SDoubleIItemDropFixAwardIdCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SDoubleIItemDropFixAwardIdCfg> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SDoubleIItemDropFixAwardIdCfg> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SDoubleIItemDropFixAwardIdCfg> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\award\confbean\SDoubleIItemDropFixAwardIdCfg.class
