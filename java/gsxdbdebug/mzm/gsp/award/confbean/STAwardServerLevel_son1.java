...
/*     */ 
/*     */ public class STAwardServerLevel_son1 implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, STAwardServerLevel_son1> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, STAwardServerLevel_son1> all = null;
/*     */   
...
/*     */   {
/*  82 */     String path = dir + "mzm.gsp.award.confbean.STAwardServerLevel_son1.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  95 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.award.confbean.STAwardServerLevel_son1"))
/*     */         {
/*     */ 
/*  98 */           STAwardServerLevel_son1 obj = new STAwardServerLevel_son1();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, STAwardServerLevel_son1> all)
/*     */   {
/* 112 */     String path = dir + "mzm.gsp.award.confbean.STAwardServerLevel_son1.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 124 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.award.confbean.STAwardServerLevel_son1"))
/*     */         {
/*     */ 
/* 127 */           STAwardServerLevel_son1 obj = new STAwardServerLevel_son1();
...
/*     */     
/* 143 */     String path = dir + "mzm.gsp.award.confbean.STAwardServerLevel_son1.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 170 */           STAwardServerLevel_son1 _v_ = new STAwardServerLevel_son1();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, STAwardServerLevel_son1> all)
/*     */   {
/* 190 */     String path = dir + "mzm.gsp.award.confbean.STAwardServerLevel_son1.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 217 */           STAwardServerLevel_son1 _v_ = new STAwardServerLevel_son1();
...
/*     */ 
/*     */ 
/*     */   public static STAwardServerLevel_son1 getOld(int key)
/*     */   {
/* 238 */     return (STAwardServerLevel_son1)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static STAwardServerLevel_son1 get(int key)
/*     */   {
/* 243 */     return (STAwardServerLevel_son1)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, STAwardServerLevel_son1> getOldAll()
/*     */   {
/* 248 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, STAwardServerLevel_son1> getAll()
/*     */   {
/* 253 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, STAwardServerLevel_son1> newAll)
/*     */   {
/* 258 */     oldAll = all;
/* 259 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\award\confbean\STAwardServerLevel_son1.class
