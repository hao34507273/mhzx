...
/*     */ 
/*     */ public class STMoneyOwnCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, STMoneyOwnCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, STMoneyOwnCfg> all = null;
/*     */   
...
/*     */   {
/*  24 */     this.moneyType = Integer.valueOf(rootElement.attributeValue("moneyType")).intValue();
/*  25 */     this.moneyName = rootElement.attributeValue("moneyName");
/*  26 */     this.ownMax = Integer.valueOf(rootElement.attributeValue("ownMax")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  31 */     _os_.marshal(this.moneyType);
/*  32 */     _os_.marshal(this.moneyName, "UTF-8");
...
/*  40 */     this.moneyName = _os_.unmarshal_String("UTF-8");
...
/*     */   {
/*  47 */     String path = dir + "mzm.gsp.award.confbean.STMoneyOwnCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  60 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.award.confbean.STMoneyOwnCfg"))
/*     */         {
/*     */ 
/*  63 */           STMoneyOwnCfg obj = new STMoneyOwnCfg();
/*  64 */           obj.loadFromXml(elem);
/*  65 */           if (all.put(Integer.valueOf(obj.moneyType), obj) != null) {
/*  66 */             throw new RuntimeException("duplicate key : " + obj.moneyType);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, STMoneyOwnCfg> all)
/*     */   {
/*  77 */     String path = dir + "mzm.gsp.award.confbean.STMoneyOwnCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  89 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.award.confbean.STMoneyOwnCfg"))
/*     */         {
/*     */ 
/*  92 */           STMoneyOwnCfg obj = new STMoneyOwnCfg();
/*  93 */           obj.loadFromXml(elem);
/*  94 */           if (all.put(Integer.valueOf(obj.moneyType), obj) != null) {
/*  95 */             throw new RuntimeException("duplicate key : " + obj.moneyType);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 108 */     String path = dir + "mzm.gsp.award.confbean.STMoneyOwnCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 135 */           STMoneyOwnCfg _v_ = new STMoneyOwnCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, STMoneyOwnCfg> all)
/*     */   {
/* 155 */     String path = dir + "mzm.gsp.award.confbean.STMoneyOwnCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 182 */           STMoneyOwnCfg _v_ = new STMoneyOwnCfg();
...
/*     */ 
/*     */ 
/*     */   public static STMoneyOwnCfg getOld(int key)
/*     */   {
/* 203 */     return (STMoneyOwnCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static STMoneyOwnCfg get(int key)
/*     */   {
/* 208 */     return (STMoneyOwnCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, STMoneyOwnCfg> getOldAll()
/*     */   {
/* 213 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, STMoneyOwnCfg> getAll()
/*     */   {
/* 218 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, STMoneyOwnCfg> newAll)
/*     */   {
/* 223 */     oldAll = all;
/* 224 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\award\confbean\STMoneyOwnCfg.class
