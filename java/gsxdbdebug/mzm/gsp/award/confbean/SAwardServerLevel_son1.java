...
/*     */ 
/*     */ public class SAwardServerLevel_son1 extends SAwardServerLevel_father implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  15 */   private static volatile Map<Integer, SAwardServerLevel_son1> oldAll = null;
/*     */   
/*  17 */   private static Map<Integer, SAwardServerLevel_son1> all = null;
/*     */   
/*     */ 
...
/*     */   {
/*  60 */     String path = dir + "mzm.gsp.award.confbean.SAwardServerLevel_son1.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  73 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.award.confbean.SAwardServerLevel_son1"))
/*     */         {
/*     */ 
/*  76 */           SAwardServerLevel_son1 obj = new SAwardServerLevel_son1();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SAwardServerLevel_son1> all)
/*     */   {
/*  90 */     String path = dir + "mzm.gsp.award.confbean.SAwardServerLevel_son1.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 102 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.award.confbean.SAwardServerLevel_son1"))
/*     */         {
/*     */ 
/* 105 */           SAwardServerLevel_son1 obj = new SAwardServerLevel_son1();
...
/*     */     
/* 121 */     String path = dir + "mzm.gsp.award.confbean.SAwardServerLevel_son1.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 148 */           SAwardServerLevel_son1 _v_ = new SAwardServerLevel_son1();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SAwardServerLevel_son1> all)
/*     */   {
/* 168 */     String path = dir + "mzm.gsp.award.confbean.SAwardServerLevel_son1.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 195 */           SAwardServerLevel_son1 _v_ = new SAwardServerLevel_son1();
...
/*     */   {
/* 214 */     for (Map.Entry<Integer, SAwardServerLevel_son1> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static void handleData(Map<Integer, SAwardServerLevel_son1> all, Map<Integer, SAwardServerLevel_father> parent)
/*     */   {
/* 229 */     for (Map.Entry<Integer, SAwardServerLevel_son1> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static SAwardServerLevel_son1 getOld(int key)
/*     */   {
/* 244 */     return (SAwardServerLevel_son1)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SAwardServerLevel_son1 get(int key)
/*     */   {
/* 249 */     return (SAwardServerLevel_son1)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SAwardServerLevel_son1> getOldAllSelf()
/*     */   {
/* 254 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SAwardServerLevel_son1> getAllSelf()
/*     */   {
/* 259 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SAwardServerLevel_son1> newAll)
/*     */   {
/* 264 */     oldAll = all;
/* 265 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\award\confbean\SAwardServerLevel_son1.class
