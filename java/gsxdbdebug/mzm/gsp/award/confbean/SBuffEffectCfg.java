...
/*     */ 
/*     */ public class SBuffEffectCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SBuffEffectCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SBuffEffectCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public String templatename;
/*  20 */   public java.util.ArrayList<AddCfgBean> addCfgBeanList = new java.util.ArrayList();
/*     */   
...
/*     */     
/*  27 */     Element collectionElement = util.XmlHelper.getVariableElement(rootElement, "addCfgBeanList");
...
/*  38 */       if (elem.getName().equalsIgnoreCase("mzm.gsp.award.confbean.AddCfgBean"))
/*     */       {
/*     */         AddCfgBean _v_;
/*     */         
/*     */ 
...
/*     */         }
/*     */         
/*  53 */         this.addCfgBeanList.add(_v_);
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*  62 */     _os_.compact_uint32(this.addCfgBeanList.size());
/*  63 */     for (AddCfgBean _v_ : this.addCfgBeanList)
/*     */     {
/*  65 */       _os_.marshal(_v_);
/*     */     }
/*  67 */     return _os_;
...
/*     */     {
/*     */ 
/*  77 */       AddCfgBean _v_ = new AddCfgBean();
/*  78 */       _v_.unmarshal(_os_);
/*  79 */       this.addCfgBeanList.add(_v_);
/*     */     }
/*  81 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/*  86 */     String path = dir + "mzm.gsp.award.confbean.SBuffEffectCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  99 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.award.confbean.SBuffEffectCfg"))
/*     */         {
/*     */ 
/* 102 */           SBuffEffectCfg obj = new SBuffEffectCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SBuffEffectCfg> all)
/*     */   {
/* 116 */     String path = dir + "mzm.gsp.award.confbean.SBuffEffectCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 128 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.award.confbean.SBuffEffectCfg"))
/*     */         {
/*     */ 
/* 131 */           SBuffEffectCfg obj = new SBuffEffectCfg();
...
/*     */     
/* 147 */     String path = dir + "mzm.gsp.award.confbean.SBuffEffectCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 174 */           SBuffEffectCfg _v_ = new SBuffEffectCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SBuffEffectCfg> all)
/*     */   {
/* 194 */     String path = dir + "mzm.gsp.award.confbean.SBuffEffectCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 221 */           SBuffEffectCfg _v_ = new SBuffEffectCfg();
...
/*     */ 
/*     */ 
/*     */   public static SBuffEffectCfg getOld(int key)
/*     */   {
/* 242 */     return (SBuffEffectCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SBuffEffectCfg get(int key)
/*     */   {
/* 247 */     return (SBuffEffectCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SBuffEffectCfg> getOldAll()
/*     */   {
/* 252 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SBuffEffectCfg> getAll()
/*     */   {
/* 257 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SBuffEffectCfg> newAll)
/*     */   {
/* 262 */     oldAll = all;
/* 263 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\award\confbean\SBuffEffectCfg.class
