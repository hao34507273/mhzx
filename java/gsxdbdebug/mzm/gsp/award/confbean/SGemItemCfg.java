...
/*     */ 
/*     */ public class SGemItemCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SGemItemCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SGemItemCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public int libId;
...
/*  27 */     this.gemItemId = Integer.valueOf(rootElement.attributeValue("gemItemId")).intValue();
...
/*  35 */     _os_.marshal(this.gemItemId);
...
/*  44 */     this.gemItemId = _os_.unmarshal_int();
...
/*     */   {
/*  51 */     String path = dir + "mzm.gsp.award.confbean.SGemItemCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  64 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.award.confbean.SGemItemCfg"))
/*     */         {
/*     */ 
/*  67 */           SGemItemCfg obj = new SGemItemCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SGemItemCfg> all)
/*     */   {
/*  81 */     String path = dir + "mzm.gsp.award.confbean.SGemItemCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.award.confbean.SGemItemCfg"))
/*     */         {
/*     */ 
/*  96 */           SGemItemCfg obj = new SGemItemCfg();
...
/*     */     
/* 112 */     String path = dir + "mzm.gsp.award.confbean.SGemItemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 139 */           SGemItemCfg _v_ = new SGemItemCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SGemItemCfg> all)
/*     */   {
/* 159 */     String path = dir + "mzm.gsp.award.confbean.SGemItemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 186 */           SGemItemCfg _v_ = new SGemItemCfg();
...
/*     */ 
/*     */ 
/*     */   public static SGemItemCfg getOld(int key)
/*     */   {
/* 207 */     return (SGemItemCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SGemItemCfg get(int key)
/*     */   {
/* 212 */     return (SGemItemCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SGemItemCfg> getOldAll()
/*     */   {
/* 217 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SGemItemCfg> getAll()
/*     */   {
/* 222 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SGemItemCfg> newAll)
/*     */   {
/* 227 */     oldAll = all;
/* 228 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\award\confbean\SGemItemCfg.class
