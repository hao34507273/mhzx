...
/*     */ 
/*     */ public class SArenaCampCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SArenaCampCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SArenaCampCfg> all = null;
/*     */   
/*     */   public int camp;
/*     */   public String name;
/*     */   
...
/*     */   {
/*  23 */     this.camp = Integer.valueOf(rootElement.attributeValue("camp")).intValue();
/*  24 */     this.name = rootElement.attributeValue("name");
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  29 */     _os_.marshal(this.camp);
...
/*     */   {
/*  36 */     this.camp = _os_.unmarshal_int();
...
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.arena.confbean.SArenaCampCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.arena.confbean.SArenaCampCfg"))
/*     */         {
/*     */ 
/*  59 */           SArenaCampCfg obj = new SArenaCampCfg();
/*  60 */           obj.loadFromXml(elem);
/*  61 */           if (all.put(Integer.valueOf(obj.camp), obj) != null) {
/*  62 */             throw new RuntimeException("duplicate key : " + obj.camp);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SArenaCampCfg> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.arena.confbean.SArenaCampCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.arena.confbean.SArenaCampCfg"))
/*     */         {
/*     */ 
/*  88 */           SArenaCampCfg obj = new SArenaCampCfg();
/*  89 */           obj.loadFromXml(elem);
/*  90 */           if (all.put(Integer.valueOf(obj.camp), obj) != null) {
/*  91 */             throw new RuntimeException("duplicate key : " + obj.camp);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.arena.confbean.SArenaCampCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           SArenaCampCfg _v_ = new SArenaCampCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SArenaCampCfg> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.arena.confbean.SArenaCampCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           SArenaCampCfg _v_ = new SArenaCampCfg();
...
/*     */ 
/*     */ 
/*     */   public static SArenaCampCfg getOld(int key)
/*     */   {
/* 199 */     return (SArenaCampCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SArenaCampCfg get(int key)
/*     */   {
/* 204 */     return (SArenaCampCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SArenaCampCfg> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SArenaCampCfg> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SArenaCampCfg> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\arena\confbean\SArenaCampCfg.class
