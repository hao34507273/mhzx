...
/*     */ 
/*     */ public class SCircleTaskModify implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SCircleTaskModify> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SCircleTaskModify> all = null;
/*     */   
/*     */   public int id;
/*     */   public String templatename;
/*     */   public int circleCount;
/*     */   public int modifyTableId;
/*     */   
...
/*  27 */     this.circleCount = Integer.valueOf(rootElement.attributeValue("circleCount")).intValue();
/*  28 */     this.modifyTableId = Integer.valueOf(rootElement.attributeValue("modifyTableId")).intValue();
/*     */   }
/*     */   
...
/*  35 */     _os_.marshal(this.circleCount);
/*  36 */     _os_.marshal(this.modifyTableId);
/*  37 */     return _os_;
/*     */   }
/*     */   
...
/*  44 */     this.circleCount = _os_.unmarshal_int();
/*  45 */     this.modifyTableId = _os_.unmarshal_int();
/*  46 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  51 */     String path = dir + "mzm.gsp.circletask.confbean.SCircleTaskModify.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  64 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.circletask.confbean.SCircleTaskModify"))
/*     */         {
/*     */ 
/*  67 */           SCircleTaskModify obj = new SCircleTaskModify();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SCircleTaskModify> all)
/*     */   {
/*  81 */     String path = dir + "mzm.gsp.circletask.confbean.SCircleTaskModify.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.circletask.confbean.SCircleTaskModify"))
/*     */         {
/*     */ 
/*  96 */           SCircleTaskModify obj = new SCircleTaskModify();
...
/*     */     
/* 112 */     String path = dir + "mzm.gsp.circletask.confbean.SCircleTaskModify.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 139 */           SCircleTaskModify _v_ = new SCircleTaskModify();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SCircleTaskModify> all)
/*     */   {
/* 159 */     String path = dir + "mzm.gsp.circletask.confbean.SCircleTaskModify.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 186 */           SCircleTaskModify _v_ = new SCircleTaskModify();
...
/*     */ 
/*     */ 
/*     */   public static SCircleTaskModify getOld(int key)
/*     */   {
/* 207 */     return (SCircleTaskModify)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SCircleTaskModify get(int key)
/*     */   {
/* 212 */     return (SCircleTaskModify)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SCircleTaskModify> getOldAll()
/*     */   {
/* 217 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SCircleTaskModify> getAll()
/*     */   {
/* 222 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SCircleTaskModify> newAll)
/*     */   {
/* 227 */     oldAll = all;
/* 228 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\circletask\confbean\SCircleTaskModify.class
