...
/*     */ 
/*     */ public class SCircleTaskLengendDropCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SCircleTaskLengendDropCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SCircleTaskLengendDropCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public String templatename;
/*     */   public int finishNeedSamePriceId;
/*     */   public int dropNeedSamePriceId;
/*     */   
...
/*  27 */     this.finishNeedSamePriceId = Integer.valueOf(rootElement.attributeValue("finishNeedSamePriceId")).intValue();
/*  28 */     this.dropNeedSamePriceId = Integer.valueOf(rootElement.attributeValue("dropNeedSamePriceId")).intValue();
/*     */   }
/*     */   
...
/*  35 */     _os_.marshal(this.finishNeedSamePriceId);
/*  36 */     _os_.marshal(this.dropNeedSamePriceId);
/*  37 */     return _os_;
/*     */   }
/*     */   
...
/*  44 */     this.finishNeedSamePriceId = _os_.unmarshal_int();
/*  45 */     this.dropNeedSamePriceId = _os_.unmarshal_int();
/*  46 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  51 */     String path = dir + "mzm.gsp.circletask.confbean.SCircleTaskLengendDropCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  64 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.circletask.confbean.SCircleTaskLengendDropCfg"))
/*     */         {
/*     */ 
/*  67 */           SCircleTaskLengendDropCfg obj = new SCircleTaskLengendDropCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SCircleTaskLengendDropCfg> all)
/*     */   {
/*  81 */     String path = dir + "mzm.gsp.circletask.confbean.SCircleTaskLengendDropCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.circletask.confbean.SCircleTaskLengendDropCfg"))
/*     */         {
/*     */ 
/*  96 */           SCircleTaskLengendDropCfg obj = new SCircleTaskLengendDropCfg();
...
/*     */     
/* 112 */     String path = dir + "mzm.gsp.circletask.confbean.SCircleTaskLengendDropCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 139 */           SCircleTaskLengendDropCfg _v_ = new SCircleTaskLengendDropCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SCircleTaskLengendDropCfg> all)
/*     */   {
/* 159 */     String path = dir + "mzm.gsp.circletask.confbean.SCircleTaskLengendDropCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 186 */           SCircleTaskLengendDropCfg _v_ = new SCircleTaskLengendDropCfg();
...
/*     */ 
/*     */ 
/*     */   public static SCircleTaskLengendDropCfg getOld(int key)
/*     */   {
/* 207 */     return (SCircleTaskLengendDropCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SCircleTaskLengendDropCfg get(int key)
/*     */   {
/* 212 */     return (SCircleTaskLengendDropCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SCircleTaskLengendDropCfg> getOldAll()
/*     */   {
/* 217 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SCircleTaskLengendDropCfg> getAll()
/*     */   {
/* 222 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SCircleTaskLengendDropCfg> newAll)
/*     */   {
/* 227 */     oldAll = all;
/* 228 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\circletask\confbean\SCircleTaskLengendDropCfg.class
