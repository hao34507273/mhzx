...
/*     */ 
/*     */ public class SCircleTaskCostConf implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SCircleTaskCostConf> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SCircleTaskCostConf> all = null;
/*     */   
/*     */   public int id;
/*     */   public String templatename;
/*     */   public int renXingCount;
/*     */   public int needXiaYi;
...
/*  28 */     this.renXingCount = Integer.valueOf(rootElement.attributeValue("renXingCount")).intValue();
/*  29 */     this.needXiaYi = Integer.valueOf(rootElement.attributeValue("needXiaYi")).intValue();
/*  30 */     this.needYuanBao = Integer.valueOf(rootElement.attributeValue("needYuanBao")).intValue();
/*     */   }
/*     */   
...
/*  37 */     _os_.marshal(this.renXingCount);
/*  38 */     _os_.marshal(this.needXiaYi);
/*  39 */     _os_.marshal(this.needYuanBao);
/*  40 */     return _os_;
/*     */   }
/*     */   
...
/*  47 */     this.renXingCount = _os_.unmarshal_int();
/*  48 */     this.needXiaYi = _os_.unmarshal_int();
/*  49 */     this.needYuanBao = _os_.unmarshal_int();
/*  50 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  55 */     String path = dir + "mzm.gsp.circletask.confbean.SCircleTaskCostConf.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  68 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.circletask.confbean.SCircleTaskCostConf"))
/*     */         {
/*     */ 
/*  71 */           SCircleTaskCostConf obj = new SCircleTaskCostConf();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SCircleTaskCostConf> all)
/*     */   {
/*  85 */     String path = dir + "mzm.gsp.circletask.confbean.SCircleTaskCostConf.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  97 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.circletask.confbean.SCircleTaskCostConf"))
/*     */         {
/*     */ 
/* 100 */           SCircleTaskCostConf obj = new SCircleTaskCostConf();
...
/*     */     
/* 116 */     String path = dir + "mzm.gsp.circletask.confbean.SCircleTaskCostConf.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 143 */           SCircleTaskCostConf _v_ = new SCircleTaskCostConf();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SCircleTaskCostConf> all)
/*     */   {
/* 163 */     String path = dir + "mzm.gsp.circletask.confbean.SCircleTaskCostConf.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 190 */           SCircleTaskCostConf _v_ = new SCircleTaskCostConf();
...
/*     */ 
/*     */ 
/*     */   public static SCircleTaskCostConf getOld(int key)
/*     */   {
/* 211 */     return (SCircleTaskCostConf)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SCircleTaskCostConf get(int key)
/*     */   {
/* 216 */     return (SCircleTaskCostConf)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SCircleTaskCostConf> getOldAll()
/*     */   {
/* 221 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SCircleTaskCostConf> getAll()
/*     */   {
/* 226 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SCircleTaskCostConf> newAll)
/*     */   {
/* 231 */     oldAll = all;
/* 232 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\circletask\confbean\SCircleTaskCostConf.class
