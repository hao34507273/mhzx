...
/*     */ 
/*     */ public class SWuShiAwardCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SWuShiAwardCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SWuShiAwardCfg> all = null;
/*     */   
/*     */   public int stage;
...
/*     */   {
/*  24 */     this.stage = Integer.valueOf(rootElement.attributeValue("stage")).intValue();
/*  25 */     this.fixAwardId = Integer.valueOf(rootElement.attributeValue("fixAwardId")).intValue();
/*  26 */     this.mailId = Integer.valueOf(rootElement.attributeValue("mailId")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  31 */     _os_.marshal(this.stage);
/*  32 */     _os_.marshal(this.fixAwardId);
/*  33 */     _os_.marshal(this.mailId);
/*  34 */     return _os_;
/*     */   }
/*     */   
/*     */   public OctetsStream unmarshal(OctetsStream _os_) throws com.goldhuman.Common.Marshal.MarshalException
/*     */   {
/*  39 */     this.stage = _os_.unmarshal_int();
/*  40 */     this.fixAwardId = _os_.unmarshal_int();
/*  41 */     this.mailId = _os_.unmarshal_int();
/*  42 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  47 */     String path = dir + "mzm.gsp.superequipment.wushi.confbean.SWuShiAwardCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  60 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.superequipment.wushi.confbean.SWuShiAwardCfg"))
/*     */         {
/*     */ 
/*  63 */           SWuShiAwardCfg obj = new SWuShiAwardCfg();
/*  64 */           obj.loadFromXml(elem);
/*  65 */           if (all.put(Integer.valueOf(obj.stage), obj) != null) {
/*  66 */             throw new RuntimeException("duplicate key : " + obj.stage);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SWuShiAwardCfg> all)
/*     */   {
/*  77 */     String path = dir + "mzm.gsp.superequipment.wushi.confbean.SWuShiAwardCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  89 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.superequipment.wushi.confbean.SWuShiAwardCfg"))
/*     */         {
/*     */ 
/*  92 */           SWuShiAwardCfg obj = new SWuShiAwardCfg();
/*  93 */           obj.loadFromXml(elem);
/*  94 */           if (all.put(Integer.valueOf(obj.stage), obj) != null) {
/*  95 */             throw new RuntimeException("duplicate key : " + obj.stage);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 108 */     String path = dir + "mzm.gsp.superequipment.wushi.confbean.SWuShiAwardCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 135 */           SWuShiAwardCfg _v_ = new SWuShiAwardCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SWuShiAwardCfg> all)
/*     */   {
/* 155 */     String path = dir + "mzm.gsp.superequipment.wushi.confbean.SWuShiAwardCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 182 */           SWuShiAwardCfg _v_ = new SWuShiAwardCfg();
...
/*     */ 
/*     */ 
/*     */   public static SWuShiAwardCfg getOld(int key)
/*     */   {
/* 203 */     return (SWuShiAwardCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SWuShiAwardCfg get(int key)
/*     */   {
/* 208 */     return (SWuShiAwardCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SWuShiAwardCfg> getOldAll()
/*     */   {
/* 213 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SWuShiAwardCfg> getAll()
/*     */   {
/* 218 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SWuShiAwardCfg> newAll)
/*     */   {
/* 223 */     oldAll = all;
/* 224 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\superequipment\wushi\confbean\SWuShiAwardCfg.class
