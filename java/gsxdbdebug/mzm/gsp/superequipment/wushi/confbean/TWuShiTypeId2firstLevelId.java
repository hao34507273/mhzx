...
/*     */ 
/*     */ public class TWuShiTypeId2firstLevelId implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, TWuShiTypeId2firstLevelId> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, TWuShiTypeId2firstLevelId> all = null;
/*     */   
/*     */   public int typeId;
...
/*  24 */     this.firstLevelId = Integer.valueOf(rootElement.attributeValue("firstLevelId")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  29 */     _os_.marshal(this.typeId);
/*  30 */     _os_.marshal(this.firstLevelId);
/*  31 */     return _os_;
/*     */   }
/*     */   
/*     */   public OctetsStream unmarshal(OctetsStream _os_) throws com.goldhuman.Common.Marshal.MarshalException
/*     */   {
/*  36 */     this.typeId = _os_.unmarshal_int();
/*  37 */     this.firstLevelId = _os_.unmarshal_int();
/*  38 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.superequipment.wushi.confbean.TWuShiTypeId2firstLevelId.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.superequipment.wushi.confbean.TWuShiTypeId2firstLevelId"))
/*     */         {
/*     */ 
/*  59 */           TWuShiTypeId2firstLevelId obj = new TWuShiTypeId2firstLevelId();
/*  60 */           obj.loadFromXml(elem);
/*  61 */           if (all.put(Integer.valueOf(obj.typeId), obj) != null) {
/*  62 */             throw new RuntimeException("duplicate key : " + obj.typeId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, TWuShiTypeId2firstLevelId> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.superequipment.wushi.confbean.TWuShiTypeId2firstLevelId.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.superequipment.wushi.confbean.TWuShiTypeId2firstLevelId"))
/*     */         {
/*     */ 
/*  88 */           TWuShiTypeId2firstLevelId obj = new TWuShiTypeId2firstLevelId();
/*  89 */           obj.loadFromXml(elem);
/*  90 */           if (all.put(Integer.valueOf(obj.typeId), obj) != null) {
/*  91 */             throw new RuntimeException("duplicate key : " + obj.typeId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.superequipment.wushi.confbean.TWuShiTypeId2firstLevelId.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           TWuShiTypeId2firstLevelId _v_ = new TWuShiTypeId2firstLevelId();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, TWuShiTypeId2firstLevelId> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.superequipment.wushi.confbean.TWuShiTypeId2firstLevelId.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           TWuShiTypeId2firstLevelId _v_ = new TWuShiTypeId2firstLevelId();
...
/*     */ 
/*     */ 
/*     */   public static TWuShiTypeId2firstLevelId getOld(int key)
/*     */   {
/* 199 */     return (TWuShiTypeId2firstLevelId)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static TWuShiTypeId2firstLevelId get(int key)
/*     */   {
/* 204 */     return (TWuShiTypeId2firstLevelId)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, TWuShiTypeId2firstLevelId> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, TWuShiTypeId2firstLevelId> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, TWuShiTypeId2firstLevelId> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\superequipment\wushi\confbean\TWuShiTypeId2firstLevelId.class
