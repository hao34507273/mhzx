...
/*     */ 
/*     */ public class SSuperEquipmentConsts
/*     */ {
/*  13 */   private static volatile SSuperEquipmentConsts oldInstance = null;
/*     */   
/*  15 */   private static SSuperEquipmentConsts instance = new SSuperEquipmentConsts();
/*     */   
/*     */   public int OPEN_ROLE_LEVEL;
/*     */   public int OPEN_SERVER_LEVEL;
/*     */   public int MAX_SUPER_EQUIPMENT_STAGE;
/*     */   
/*     */   public static SSuperEquipmentConsts getOldInstance()
/*     */   {
/*  23 */     return oldInstance;
/*     */   }
/*     */   
/*     */   public static SSuperEquipmentConsts getInstance()
/*     */   {
/*  28 */     return instance;
/*     */   }
/*     */   
...
/*     */   {
/*  42 */     String path = dir + "mzm.gsp.superequipment.confbean.SSuperEquipmentConsts.xml";
/*     */     try
/*     */     {
...
/*     */         }
/*     */       }
/*  62 */       this.OPEN_ROLE_LEVEL = Integer.valueOf(((Element)data.get("OPEN_ROLE_LEVEL")).attributeValue("value")).intValue();
/*  63 */       this.OPEN_SERVER_LEVEL = Integer.valueOf(((Element)data.get("OPEN_SERVER_LEVEL")).attributeValue("value")).intValue();
/*  64 */       this.MAX_SUPER_EQUIPMENT_STAGE = Integer.valueOf(((Element)data.get("MAX_SUPER_EQUIPMENT_STAGE")).attributeValue("value")).intValue();
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*  73 */     String path = dir + "mzm.gsp.superequipment.confbean.SSuperEquipmentConsts.xml";
/*     */     try
/*     */     {
...
/*     */         }
/*     */       }
/*  93 */       this.OPEN_ROLE_LEVEL = Integer.valueOf(((Element)data.get("OPEN_ROLE_LEVEL")).attributeValue("value")).intValue();
/*  94 */       this.OPEN_SERVER_LEVEL = Integer.valueOf(((Element)data.get("OPEN_SERVER_LEVEL")).attributeValue("value")).intValue();
/*  95 */       this.MAX_SUPER_EQUIPMENT_STAGE = Integer.valueOf(((Element)data.get("MAX_SUPER_EQUIPMENT_STAGE")).attributeValue("value")).intValue();
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/* 106 */     String path = dir + "mzm.gsp.superequipment.confbean.SSuperEquipmentConsts.bny";
/*     */     try
/*     */     {
...
/* 121 */         this.OPEN_ROLE_LEVEL = _os_.unmarshal_int();
/* 122 */         this.OPEN_SERVER_LEVEL = _os_.unmarshal_int();
/* 123 */         this.MAX_SUPER_EQUIPMENT_STAGE = _os_.unmarshal_int();
/*     */       }
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*     */   {
/* 134 */     String path = dir + "mzm.gsp.superequipment.confbean.SSuperEquipmentConsts.bny";
/*     */     try
/*     */     {
...
/* 149 */         this.OPEN_ROLE_LEVEL = _os_.unmarshal_int();
/* 150 */         this.OPEN_SERVER_LEVEL = _os_.unmarshal_int();
/* 151 */         this.MAX_SUPER_EQUIPMENT_STAGE = _os_.unmarshal_int();
/*     */       }
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*     */   }
/*     */   
/*     */   public static void setInstance(SSuperEquipmentConsts newInstance)
/*     */   {
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\superequipment\confbean\SSuperEquipmentConsts.class
