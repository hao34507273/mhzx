...
/*     */ 
/*     */ public class SInteractiveTaskTypeCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SInteractiveTaskTypeCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SInteractiveTaskTypeCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public int mapid;
...
/*  28 */     this.maxFinishTime = Integer.valueOf(rootElement.attributeValue("maxFinishTime")).intValue();
/*  29 */     this.moneyType = Integer.valueOf(rootElement.attributeValue("moneyType")).intValue();
/*  30 */     this.moneyNum = Integer.valueOf(rootElement.attributeValue("moneyNum")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  35 */     _os_.marshal(this.id);
/*  36 */     _os_.marshal(this.mapid);
/*  37 */     _os_.marshal(this.maxFinishTime);
/*  38 */     _os_.marshal(this.moneyType);
/*  39 */     _os_.marshal(this.moneyNum);
/*  40 */     return _os_;
/*     */   }
/*     */   
...
/*  46 */     this.mapid = _os_.unmarshal_int();
/*  47 */     this.maxFinishTime = _os_.unmarshal_int();
/*  48 */     this.moneyType = _os_.unmarshal_int();
/*  49 */     this.moneyNum = _os_.unmarshal_int();
/*  50 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  55 */     String path = dir + "mzm.gsp.interactivetask.confbean.SInteractiveTaskTypeCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  68 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.interactivetask.confbean.SInteractiveTaskTypeCfg"))
/*     */         {
/*     */ 
/*  71 */           SInteractiveTaskTypeCfg obj = new SInteractiveTaskTypeCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SInteractiveTaskTypeCfg> all)
/*     */   {
/*  85 */     String path = dir + "mzm.gsp.interactivetask.confbean.SInteractiveTaskTypeCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  97 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.interactivetask.confbean.SInteractiveTaskTypeCfg"))
/*     */         {
/*     */ 
/* 100 */           SInteractiveTaskTypeCfg obj = new SInteractiveTaskTypeCfg();
...
/*     */     
/* 116 */     String path = dir + "mzm.gsp.interactivetask.confbean.SInteractiveTaskTypeCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 143 */           SInteractiveTaskTypeCfg _v_ = new SInteractiveTaskTypeCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SInteractiveTaskTypeCfg> all)
/*     */   {
/* 163 */     String path = dir + "mzm.gsp.interactivetask.confbean.SInteractiveTaskTypeCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 190 */           SInteractiveTaskTypeCfg _v_ = new SInteractiveTaskTypeCfg();
...
/*     */ 
/*     */ 
/*     */   public static SInteractiveTaskTypeCfg getOld(int key)
/*     */   {
/* 211 */     return (SInteractiveTaskTypeCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SInteractiveTaskTypeCfg get(int key)
/*     */   {
/* 216 */     return (SInteractiveTaskTypeCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SInteractiveTaskTypeCfg> getOldAll()
/*     */   {
/* 221 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SInteractiveTaskTypeCfg> getAll()
/*     */   {
/* 226 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SInteractiveTaskTypeCfg> newAll)
/*     */   {
/* 231 */     oldAll = all;
/* 232 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\interactivetask\confbean\SInteractiveTaskTypeCfg.class
