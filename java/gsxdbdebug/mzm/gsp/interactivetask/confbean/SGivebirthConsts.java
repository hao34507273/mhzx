...
/*     */ 
/*     */ public class SGivebirthConsts
/*     */ {
/*  13 */   private static volatile SGivebirthConsts oldInstance = null;
/*     */   
/*  15 */   private static SGivebirthConsts instance = new SGivebirthConsts();
/*     */   
/*     */ 
/*     */   public int TASK_TYPE_ID;
/*     */   
/*     */ 
/*     */   public static SGivebirthConsts getOldInstance()
/*     */   {
/*  23 */     return oldInstance;
/*     */   }
/*     */   
/*     */   public static SGivebirthConsts getInstance()
/*     */   {
/*  28 */     return instance;
/*     */   }
/*     */   
...
/*     */   {
/*  40 */     String path = dir + "mzm.gsp.interactivetask.confbean.SGivebirthConsts.xml";
/*     */     try
/*     */     {
...
/*     */         }
/*     */       }
/*  60 */       this.TASK_TYPE_ID = Integer.valueOf(((Element)data.get("TASK_TYPE_ID")).attributeValue("value")).intValue();
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*  69 */     String path = dir + "mzm.gsp.interactivetask.confbean.SGivebirthConsts.xml";
/*     */     try
/*     */     {
...
/*     */         }
/*     */       }
/*  89 */       this.TASK_TYPE_ID = Integer.valueOf(((Element)data.get("TASK_TYPE_ID")).attributeValue("value")).intValue();
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/* 100 */     String path = dir + "mzm.gsp.interactivetask.confbean.SGivebirthConsts.bny";
/*     */     try
/*     */     {
...
/* 115 */         this.TASK_TYPE_ID = _os_.unmarshal_int();
/*     */       }
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*     */   {
/* 126 */     String path = dir + "mzm.gsp.interactivetask.confbean.SGivebirthConsts.bny";
/*     */     try
/*     */     {
...
/* 141 */         this.TASK_TYPE_ID = _os_.unmarshal_int();
/*     */       }
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*     */   }
/*     */   
/*     */   public static void setInstance(SGivebirthConsts newInstance)
/*     */   {
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\interactivetask\confbean\SGivebirthConsts.class
