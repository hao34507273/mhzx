...
/*     */ 
/*     */ public class SGraphid2typeid implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SGraphid2typeid> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SGraphid2typeid> all = null;
/*     */   
/*     */   public int graphid;
/*     */   public int typeid;
/*     */   
...
/*  37 */     this.typeid = _os_.unmarshal_int();
/*  38 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.interactivetask.confbean.SGraphid2typeid.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.interactivetask.confbean.SGraphid2typeid"))
/*     */         {
/*     */ 
/*  59 */           SGraphid2typeid obj = new SGraphid2typeid();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SGraphid2typeid> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.interactivetask.confbean.SGraphid2typeid.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.interactivetask.confbean.SGraphid2typeid"))
/*     */         {
/*     */ 
/*  88 */           SGraphid2typeid obj = new SGraphid2typeid();
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.interactivetask.confbean.SGraphid2typeid.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           SGraphid2typeid _v_ = new SGraphid2typeid();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SGraphid2typeid> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.interactivetask.confbean.SGraphid2typeid.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           SGraphid2typeid _v_ = new SGraphid2typeid();
...
/*     */ 
/*     */ 
/*     */   public static SGraphid2typeid getOld(int key)
/*     */   {
/* 199 */     return (SGraphid2typeid)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SGraphid2typeid get(int key)
/*     */   {
/* 204 */     return (SGraphid2typeid)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SGraphid2typeid> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SGraphid2typeid> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SGraphid2typeid> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\interactivetask\confbean\SGraphid2typeid.class
