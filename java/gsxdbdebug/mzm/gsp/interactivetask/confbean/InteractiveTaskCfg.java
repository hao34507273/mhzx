...
/*     */ 
/*     */ public class InteractiveTaskCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, InteractiveTaskCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, InteractiveTaskCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public String name;
/*     */   public int graphid;
...
/*  30 */     this.seq = Integer.valueOf(rootElement.attributeValue("seq")).intValue();
...
/*  39 */     _os_.marshal(this.graphid);
/*  40 */     _os_.marshal(this.seq);
...
/*     */   {
/*  59 */     String path = dir + "mzm.gsp.interactivetask.confbean.InteractiveTaskCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  72 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.interactivetask.confbean.InteractiveTaskCfg"))
/*     */         {
/*     */ 
/*  75 */           InteractiveTaskCfg obj = new InteractiveTaskCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, InteractiveTaskCfg> all)
/*     */   {
/*  89 */     String path = dir + "mzm.gsp.interactivetask.confbean.InteractiveTaskCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 101 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.interactivetask.confbean.InteractiveTaskCfg"))
/*     */         {
/*     */ 
/* 104 */           InteractiveTaskCfg obj = new InteractiveTaskCfg();
...
/*     */     
/* 120 */     String path = dir + "mzm.gsp.interactivetask.confbean.InteractiveTaskCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 147 */           InteractiveTaskCfg _v_ = new InteractiveTaskCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, InteractiveTaskCfg> all)
/*     */   {
/* 167 */     String path = dir + "mzm.gsp.interactivetask.confbean.InteractiveTaskCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 194 */           InteractiveTaskCfg _v_ = new InteractiveTaskCfg();
...
/*     */ 
/*     */ 
/*     */   public static InteractiveTaskCfg getOld(int key)
/*     */   {
/* 215 */     return (InteractiveTaskCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static InteractiveTaskCfg get(int key)
/*     */   {
/* 220 */     return (InteractiveTaskCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, InteractiveTaskCfg> getOldAll()
/*     */   {
/* 225 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, InteractiveTaskCfg> getAll()
/*     */   {
/* 230 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, InteractiveTaskCfg> newAll)
/*     */   {
/* 235 */     oldAll = all;
/* 236 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\interactivetask\confbean\InteractiveTaskCfg.class
