/*     */ package mzm.gsp.interactivetask.confbean;
/*     */ 
...
/*     */ 
/*     */ public class SInteractiveTaskCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SInteractiveTaskCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SInteractiveTaskCfg> all = null;
/*     */   
/*     */   public int typeid;
...
/*  25 */     this.hasSeq = Boolean.valueOf(rootElement.attributeValue("hasSeq")).booleanValue();
/*     */     
/*  27 */     Element collectionElement = util.XmlHelper.getVariableElement(rootElement, "graphids");
...
/*     */         }
/*     */         
/*  52 */         this.graphids.add(Integer.valueOf(_v_));
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*     */   {
/*  59 */     _os_.marshal(this.typeid);
/*  60 */     _os_.marshal(this.hasSeq);
/*  61 */     _os_.compact_uint32(this.graphids.size());
/*  62 */     for (Integer _v_ : this.graphids)
/*     */     {
...
/*     */   {
/*  71 */     this.typeid = _os_.unmarshal_int();
/*  72 */     this.hasSeq = _os_.unmarshal_boolean();
/*  73 */     for (int _size_ = _os_.uncompact_uint32(); _size_ > 0; _size_--)
/*     */     {
/*     */ 
/*  76 */       int _v_ = _os_.unmarshal_int();
/*  77 */       this.graphids.add(Integer.valueOf(_v_));
/*     */     }
/*  79 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/*  84 */     String path = dir + "mzm.gsp.interactivetask.confbean.SInteractiveTaskCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  97 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.interactivetask.confbean.SInteractiveTaskCfg"))
/*     */         {
/*     */ 
/* 100 */           SInteractiveTaskCfg obj = new SInteractiveTaskCfg();
/* 101 */           obj.loadFromXml(elem);
/* 102 */           if (all.put(Integer.valueOf(obj.typeid), obj) != null) {
/* 103 */             throw new RuntimeException("duplicate key : " + obj.typeid);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SInteractiveTaskCfg> all)
/*     */   {
/* 114 */     String path = dir + "mzm.gsp.interactivetask.confbean.SInteractiveTaskCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 126 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.interactivetask.confbean.SInteractiveTaskCfg"))
/*     */         {
/*     */ 
/* 129 */           SInteractiveTaskCfg obj = new SInteractiveTaskCfg();
/* 130 */           obj.loadFromXml(elem);
/* 131 */           if (all.put(Integer.valueOf(obj.typeid), obj) != null) {
/* 132 */             throw new RuntimeException("duplicate key : " + obj.typeid);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 145 */     String path = dir + "mzm.gsp.interactivetask.confbean.SInteractiveTaskCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 172 */           SInteractiveTaskCfg _v_ = new SInteractiveTaskCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SInteractiveTaskCfg> all)
/*     */   {
/* 192 */     String path = dir + "mzm.gsp.interactivetask.confbean.SInteractiveTaskCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 219 */           SInteractiveTaskCfg _v_ = new SInteractiveTaskCfg();
...
/*     */ 
/*     */ 
/*     */   public static SInteractiveTaskCfg getOld(int key)
/*     */   {
/* 240 */     return (SInteractiveTaskCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SInteractiveTaskCfg get(int key)
/*     */   {
/* 245 */     return (SInteractiveTaskCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SInteractiveTaskCfg> getOldAll()
/*     */   {
/* 250 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SInteractiveTaskCfg> getAll()
/*     */   {
/* 255 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SInteractiveTaskCfg> newAll)
/*     */   {
/* 260 */     oldAll = all;
/* 261 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\interactivetask\confbean\SInteractiveTaskCfg.class
