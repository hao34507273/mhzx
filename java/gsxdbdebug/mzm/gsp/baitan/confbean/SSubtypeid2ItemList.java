...
/*     */ 
/*     */ public class SSubtypeid2ItemList implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SSubtypeid2ItemList> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SSubtypeid2ItemList> all = null;
/*     */   
/*     */   public int id;
/*  19 */   public java.util.ArrayList<Integer> itemlist = new java.util.ArrayList();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.id = Integer.valueOf(rootElement.attributeValue("id")).intValue();
/*     */     
/*  25 */     Element collectionElement = util.XmlHelper.getVariableElement(rootElement, "itemlist");
...
/*     */         }
/*     */         
/*  50 */         this.itemlist.add(Integer.valueOf(_v_));
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*  58 */     _os_.compact_uint32(this.itemlist.size());
/*  59 */     for (Integer _v_ : this.itemlist)
/*     */     {
...
/*  73 */       this.itemlist.add(Integer.valueOf(_v_));
/*     */     }
/*  75 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/*  80 */     String path = dir + "mzm.gsp.baitan.confbean.SSubtypeid2ItemList.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.baitan.confbean.SSubtypeid2ItemList"))
/*     */         {
/*     */ 
/*  96 */           SSubtypeid2ItemList obj = new SSubtypeid2ItemList();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SSubtypeid2ItemList> all)
/*     */   {
/* 110 */     String path = dir + "mzm.gsp.baitan.confbean.SSubtypeid2ItemList.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 122 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.baitan.confbean.SSubtypeid2ItemList"))
/*     */         {
/*     */ 
/* 125 */           SSubtypeid2ItemList obj = new SSubtypeid2ItemList();
...
/*     */     
/* 141 */     String path = dir + "mzm.gsp.baitan.confbean.SSubtypeid2ItemList.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 168 */           SSubtypeid2ItemList _v_ = new SSubtypeid2ItemList();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SSubtypeid2ItemList> all)
/*     */   {
/* 188 */     String path = dir + "mzm.gsp.baitan.confbean.SSubtypeid2ItemList.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 215 */           SSubtypeid2ItemList _v_ = new SSubtypeid2ItemList();
...
/*     */ 
/*     */ 
/*     */   public static SSubtypeid2ItemList getOld(int key)
/*     */   {
/* 236 */     return (SSubtypeid2ItemList)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SSubtypeid2ItemList get(int key)
/*     */   {
/* 241 */     return (SSubtypeid2ItemList)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SSubtypeid2ItemList> getOldAll()
/*     */   {
/* 246 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SSubtypeid2ItemList> getAll()
/*     */   {
/* 251 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SSubtypeid2ItemList> newAll)
/*     */   {
/* 256 */     oldAll = all;
/* 257 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\baitan\confbean\SSubtypeid2ItemList.class
