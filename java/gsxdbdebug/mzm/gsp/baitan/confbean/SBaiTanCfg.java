...
/*     */ 
/*     */ public class SBaiTanCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SBaiTanCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SBaiTanCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public int ItemGroupSeq;
/*  20 */   public java.util.ArrayList<Integer> subTypeIdList = new java.util.ArrayList();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  24 */     this.id = Integer.valueOf(rootElement.attributeValue("id")).intValue();
/*  25 */     this.ItemGroupSeq = Integer.valueOf(rootElement.attributeValue("ItemGroupSeq")).intValue();
/*     */     
/*  27 */     Element collectionElement = util.XmlHelper.getVariableElement(rootElement, "subTypeIdList");
...
/*     */         }
/*     */         
/*  52 */         this.subTypeIdList.add(Integer.valueOf(_v_));
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*  60 */     _os_.marshal(this.ItemGroupSeq);
/*  61 */     _os_.compact_uint32(this.subTypeIdList.size());
/*  62 */     for (Integer _v_ : this.subTypeIdList)
/*     */     {
...
/*  72 */     this.ItemGroupSeq = _os_.unmarshal_int();
/*  73 */     for (int _size_ = _os_.uncompact_uint32(); _size_ > 0; _size_--)
/*     */     {
/*     */ 
/*  76 */       int _v_ = _os_.unmarshal_int();
/*  77 */       this.subTypeIdList.add(Integer.valueOf(_v_));
/*     */     }
/*  79 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/*  84 */     String path = dir + "mzm.gsp.baitan.confbean.SBaiTanCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  97 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.baitan.confbean.SBaiTanCfg"))
/*     */         {
/*     */ 
/* 100 */           SBaiTanCfg obj = new SBaiTanCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SBaiTanCfg> all)
/*     */   {
/* 114 */     String path = dir + "mzm.gsp.baitan.confbean.SBaiTanCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 126 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.baitan.confbean.SBaiTanCfg"))
/*     */         {
/*     */ 
/* 129 */           SBaiTanCfg obj = new SBaiTanCfg();
...
/*     */     
/* 145 */     String path = dir + "mzm.gsp.baitan.confbean.SBaiTanCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 172 */           SBaiTanCfg _v_ = new SBaiTanCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SBaiTanCfg> all)
/*     */   {
/* 192 */     String path = dir + "mzm.gsp.baitan.confbean.SBaiTanCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 219 */           SBaiTanCfg _v_ = new SBaiTanCfg();
...
/*     */ 
/*     */ 
/*     */   public static SBaiTanCfg getOld(int key)
/*     */   {
/* 240 */     return (SBaiTanCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SBaiTanCfg get(int key)
/*     */   {
/* 245 */     return (SBaiTanCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SBaiTanCfg> getOldAll()
/*     */   {
/* 250 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SBaiTanCfg> getAll()
/*     */   {
/* 255 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SBaiTanCfg> newAll)
/*     */   {
/* 260 */     oldAll = all;
/* 261 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\baitan\confbean\SBaiTanCfg.class
