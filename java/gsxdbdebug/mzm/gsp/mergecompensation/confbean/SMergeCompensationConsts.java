/*     */ package mzm.gsp.mergecompensation.confbean;
/*     */ 
...
/*     */ 
/*     */ public class SMergeCompensationConsts
/*     */ {
/*  13 */   private static volatile SMergeCompensationConsts oldInstance = null;
/*     */   
/*  15 */   private static SMergeCompensationConsts instance = new SMergeCompensationConsts();
/*     */   
/*     */   public int A_MAIL_CFG_ID;
/*     */   public int B_MAIL_CFG_ID;
/*     */   public int MERGE_OPERATION_TIME_IN_HOUR;
/*     */   
/*     */   public static SMergeCompensationConsts getOldInstance()
/*     */   {
/*  23 */     return oldInstance;
/*     */   }
/*     */   
/*     */   public static SMergeCompensationConsts getInstance()
/*     */   {
/*  28 */     return instance;
/*     */   }
/*     */   
...
/*     */   {
/*  42 */     String path = dir + "mzm.gsp.mergecompensation.confbean.SMergeCompensationConsts.xml";
/*     */     try
/*     */     {
...
/*     */         }
/*     */       }
/*  62 */       this.A_MAIL_CFG_ID = Integer.valueOf(((Element)data.get("A_MAIL_CFG_ID")).attributeValue("value")).intValue();
/*  63 */       this.B_MAIL_CFG_ID = Integer.valueOf(((Element)data.get("B_MAIL_CFG_ID")).attributeValue("value")).intValue();
/*  64 */       this.MERGE_OPERATION_TIME_IN_HOUR = Integer.valueOf(((Element)data.get("MERGE_OPERATION_TIME_IN_HOUR")).attributeValue("value")).intValue();
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*  73 */     String path = dir + "mzm.gsp.mergecompensation.confbean.SMergeCompensationConsts.xml";
/*     */     try
/*     */     {
...
/*     */         }
/*     */       }
/*  93 */       this.A_MAIL_CFG_ID = Integer.valueOf(((Element)data.get("A_MAIL_CFG_ID")).attributeValue("value")).intValue();
/*  94 */       this.B_MAIL_CFG_ID = Integer.valueOf(((Element)data.get("B_MAIL_CFG_ID")).attributeValue("value")).intValue();
/*  95 */       this.MERGE_OPERATION_TIME_IN_HOUR = Integer.valueOf(((Element)data.get("MERGE_OPERATION_TIME_IN_HOUR")).attributeValue("value")).intValue();
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/* 106 */     String path = dir + "mzm.gsp.mergecompensation.confbean.SMergeCompensationConsts.bny";
/*     */     try
/*     */     {
...
/* 121 */         this.A_MAIL_CFG_ID = _os_.unmarshal_int();
/* 122 */         this.B_MAIL_CFG_ID = _os_.unmarshal_int();
/* 123 */         this.MERGE_OPERATION_TIME_IN_HOUR = _os_.unmarshal_int();
/*     */       }
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*     */   {
/* 134 */     String path = dir + "mzm.gsp.mergecompensation.confbean.SMergeCompensationConsts.bny";
/*     */     try
/*     */     {
...
/* 149 */         this.A_MAIL_CFG_ID = _os_.unmarshal_int();
/* 150 */         this.B_MAIL_CFG_ID = _os_.unmarshal_int();
/* 151 */         this.MERGE_OPERATION_TIME_IN_HOUR = _os_.unmarshal_int();
/*     */       }
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*     */   }
/*     */   
/*     */   public static void setInstance(SMergeCompensationConsts newInstance)
/*     */   {
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\mergecompensation\confbean\SMergeCompensationConsts.class
