...
/*     */ 
/*     */ public class SChessItemAwardCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SChessItemAwardCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SChessItemAwardCfg> all = null;
/*     */   
/*     */   public int cell_num;
/*     */   public int award_pool_class_id;
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.cell_num = Integer.valueOf(rootElement.attributeValue("cell_num")).intValue();
/*  24 */     this.award_pool_class_id = Integer.valueOf(rootElement.attributeValue("award_pool_class_id")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  29 */     _os_.marshal(this.cell_num);
/*  30 */     _os_.marshal(this.award_pool_class_id);
/*  31 */     return _os_;
/*     */   }
/*     */   
/*     */   public OctetsStream unmarshal(OctetsStream _os_) throws com.goldhuman.Common.Marshal.MarshalException
/*     */   {
/*  36 */     this.cell_num = _os_.unmarshal_int();
/*  37 */     this.award_pool_class_id = _os_.unmarshal_int();
/*  38 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.signprecious.confbean.SChessItemAwardCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.signprecious.confbean.SChessItemAwardCfg"))
/*     */         {
/*     */ 
/*  59 */           SChessItemAwardCfg obj = new SChessItemAwardCfg();
/*  60 */           obj.loadFromXml(elem);
/*  61 */           if (all.put(Integer.valueOf(obj.cell_num), obj) != null) {
/*  62 */             throw new RuntimeException("duplicate key : " + obj.cell_num);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SChessItemAwardCfg> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.signprecious.confbean.SChessItemAwardCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.signprecious.confbean.SChessItemAwardCfg"))
/*     */         {
/*     */ 
/*  88 */           SChessItemAwardCfg obj = new SChessItemAwardCfg();
/*  89 */           obj.loadFromXml(elem);
/*  90 */           if (all.put(Integer.valueOf(obj.cell_num), obj) != null) {
/*  91 */             throw new RuntimeException("duplicate key : " + obj.cell_num);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.signprecious.confbean.SChessItemAwardCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           SChessItemAwardCfg _v_ = new SChessItemAwardCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SChessItemAwardCfg> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.signprecious.confbean.SChessItemAwardCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           SChessItemAwardCfg _v_ = new SChessItemAwardCfg();
...
/*     */ 
/*     */ 
/*     */   public static SChessItemAwardCfg getOld(int key)
/*     */   {
/* 199 */     return (SChessItemAwardCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SChessItemAwardCfg get(int key)
/*     */   {
/* 204 */     return (SChessItemAwardCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SChessItemAwardCfg> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SChessItemAwardCfg> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SChessItemAwardCfg> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\signprecious\confbean\SChessItemAwardCfg.class
