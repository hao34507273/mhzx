...
/*     */ 
/*     */ public class SChessBoxBuffAwardOriginalCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SChessBoxBuffAwardOriginalCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SChessBoxBuffAwardOriginalCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public int cell_award_type;
/*     */   public int buff_id;
/*     */   public int buff_id_rate;
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  25 */     this.id = Integer.valueOf(rootElement.attributeValue("id")).intValue();
/*  26 */     this.cell_award_type = Integer.valueOf(rootElement.attributeValue("cell_award_type")).intValue();
/*  27 */     this.buff_id = Integer.valueOf(rootElement.attributeValue("buff_id")).intValue();
/*  28 */     this.buff_id_rate = Integer.valueOf(rootElement.attributeValue("buff_id_rate")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  33 */     _os_.marshal(this.id);
/*  34 */     _os_.marshal(this.cell_award_type);
/*  35 */     _os_.marshal(this.buff_id);
/*  36 */     _os_.marshal(this.buff_id_rate);
/*  37 */     return _os_;
/*     */   }
/*     */   
...
/*  43 */     this.cell_award_type = _os_.unmarshal_int();
/*  44 */     this.buff_id = _os_.unmarshal_int();
/*  45 */     this.buff_id_rate = _os_.unmarshal_int();
/*  46 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  51 */     String path = dir + "mzm.gsp.signprecious.confbean.SChessBoxBuffAwardOriginalCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  64 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.signprecious.confbean.SChessBoxBuffAwardOriginalCfg"))
/*     */         {
/*     */ 
/*  67 */           SChessBoxBuffAwardOriginalCfg obj = new SChessBoxBuffAwardOriginalCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SChessBoxBuffAwardOriginalCfg> all)
/*     */   {
/*  81 */     String path = dir + "mzm.gsp.signprecious.confbean.SChessBoxBuffAwardOriginalCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.signprecious.confbean.SChessBoxBuffAwardOriginalCfg"))
/*     */         {
/*     */ 
/*  96 */           SChessBoxBuffAwardOriginalCfg obj = new SChessBoxBuffAwardOriginalCfg();
...
/*     */     
/* 112 */     String path = dir + "mzm.gsp.signprecious.confbean.SChessBoxBuffAwardOriginalCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 139 */           SChessBoxBuffAwardOriginalCfg _v_ = new SChessBoxBuffAwardOriginalCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SChessBoxBuffAwardOriginalCfg> all)
/*     */   {
/* 159 */     String path = dir + "mzm.gsp.signprecious.confbean.SChessBoxBuffAwardOriginalCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 186 */           SChessBoxBuffAwardOriginalCfg _v_ = new SChessBoxBuffAwardOriginalCfg();
...
/*     */ 
/*     */ 
/*     */   public static SChessBoxBuffAwardOriginalCfg getOld(int key)
/*     */   {
/* 207 */     return (SChessBoxBuffAwardOriginalCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SChessBoxBuffAwardOriginalCfg get(int key)
/*     */   {
/* 212 */     return (SChessBoxBuffAwardOriginalCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SChessBoxBuffAwardOriginalCfg> getOldAll()
/*     */   {
/* 217 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SChessBoxBuffAwardOriginalCfg> getAll()
/*     */   {
/* 222 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SChessBoxBuffAwardOriginalCfg> newAll)
/*     */   {
/* 227 */     oldAll = all;
/* 228 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\signprecious\confbean\SChessBoxBuffAwardOriginalCfg.class
