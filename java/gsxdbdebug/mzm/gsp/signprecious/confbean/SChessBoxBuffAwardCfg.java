...
/*     */ 
/*     */ public class SChessBoxBuffAwardCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SChessBoxBuffAwardCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SChessBoxBuffAwardCfg> all = null;
/*     */   
/*     */   public int cell_award_type;
/*  19 */   public TreeMap<Integer, Integer> random_map = new TreeMap();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.cell_award_type = Integer.valueOf(rootElement.attributeValue("cell_award_type")).intValue();
/*     */     
/*  25 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "random_map");
...
/*     */         }
/*     */         
/*  76 */         this.random_map.put(Integer.valueOf(_k_), Integer.valueOf(_v_));
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*     */   {
/*  83 */     _os_.marshal(this.cell_award_type);
/*  84 */     _os_.compact_uint32(this.random_map.size());
/*  85 */     for (java.util.Map.Entry<Integer, Integer> _e_ : this.random_map.entrySet())
/*     */     {
...
/*     */   {
/*  95 */     this.cell_award_type = _os_.unmarshal_int();
...
/* 102 */       this.random_map.put(Integer.valueOf(_k_), Integer.valueOf(_v_));
/*     */     }
/* 104 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/* 109 */     String path = dir + "mzm.gsp.signprecious.confbean.SChessBoxBuffAwardCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 122 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.signprecious.confbean.SChessBoxBuffAwardCfg"))
/*     */         {
/*     */ 
/* 125 */           SChessBoxBuffAwardCfg obj = new SChessBoxBuffAwardCfg();
/* 126 */           obj.loadFromXml(elem);
/* 127 */           if (all.put(Integer.valueOf(obj.cell_award_type), obj) != null) {
/* 128 */             throw new RuntimeException("duplicate key : " + obj.cell_award_type);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SChessBoxBuffAwardCfg> all)
/*     */   {
/* 139 */     String path = dir + "mzm.gsp.signprecious.confbean.SChessBoxBuffAwardCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 151 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.signprecious.confbean.SChessBoxBuffAwardCfg"))
/*     */         {
/*     */ 
/* 154 */           SChessBoxBuffAwardCfg obj = new SChessBoxBuffAwardCfg();
/* 155 */           obj.loadFromXml(elem);
/* 156 */           if (all.put(Integer.valueOf(obj.cell_award_type), obj) != null) {
/* 157 */             throw new RuntimeException("duplicate key : " + obj.cell_award_type);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 170 */     String path = dir + "mzm.gsp.signprecious.confbean.SChessBoxBuffAwardCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 197 */           SChessBoxBuffAwardCfg _v_ = new SChessBoxBuffAwardCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SChessBoxBuffAwardCfg> all)
/*     */   {
/* 217 */     String path = dir + "mzm.gsp.signprecious.confbean.SChessBoxBuffAwardCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 244 */           SChessBoxBuffAwardCfg _v_ = new SChessBoxBuffAwardCfg();
...
/*     */ 
/*     */ 
/*     */   public static SChessBoxBuffAwardCfg getOld(int key)
/*     */   {
/* 265 */     return (SChessBoxBuffAwardCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SChessBoxBuffAwardCfg get(int key)
/*     */   {
/* 270 */     return (SChessBoxBuffAwardCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SChessBoxBuffAwardCfg> getOldAll()
/*     */   {
/* 275 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SChessBoxBuffAwardCfg> getAll()
/*     */   {
/* 280 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SChessBoxBuffAwardCfg> newAll)
/*     */   {
/* 285 */     oldAll = all;
/* 286 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\signprecious\confbean\SChessBoxBuffAwardCfg.class
