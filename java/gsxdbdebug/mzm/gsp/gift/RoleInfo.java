...
/*    */   }
/*    */   
/*    */   public RoleInfo(long _roleid_, String _rolename_, int _gender_, int _occupationid_, int _avatarid_, int _avatar_frame_id_, int _level_) {
...
/* 27 */     this.avatar_frame_id = _avatar_frame_id_;
...
/* 41 */     _os_.marshal(this.avatar_frame_id);
...
/* 52 */     this.avatar_frame_id = _os_.unmarshal_int();
...
/* 66 */       if (this.avatar_frame_id != _o_.avatar_frame_id) return false;
...
/* 93 */     _sb_.append(this.avatar_frame_id).append(",");
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\gift\RoleInfo.class
