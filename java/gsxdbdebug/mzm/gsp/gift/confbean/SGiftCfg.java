...
/*     */ 
/*     */ public class SGiftCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SGiftCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SGiftCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public int giftType;
...
/*  26 */     this.giftType = Integer.valueOf(rootElement.attributeValue("giftType")).intValue();
...
/*  34 */     _os_.marshal(this.giftType);
/*  35 */     _os_.marshal(this.moneyType);
/*  36 */     _os_.marshal(this.moneyNum);
/*  37 */     return _os_;
/*     */   }
/*     */   
...
/*  43 */     this.giftType = _os_.unmarshal_int();
/*  44 */     this.moneyType = _os_.unmarshal_int();
/*  45 */     this.moneyNum = _os_.unmarshal_int();
/*  46 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  51 */     String path = dir + "mzm.gsp.gift.confbean.SGiftCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  64 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.gift.confbean.SGiftCfg"))
/*     */         {
/*     */ 
/*  67 */           SGiftCfg obj = new SGiftCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SGiftCfg> all)
/*     */   {
/*  81 */     String path = dir + "mzm.gsp.gift.confbean.SGiftCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.gift.confbean.SGiftCfg"))
/*     */         {
/*     */ 
/*  96 */           SGiftCfg obj = new SGiftCfg();
...
/*     */     
/* 112 */     String path = dir + "mzm.gsp.gift.confbean.SGiftCfg.bny";
/*     */     try
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SGiftCfg> all)
/*     */   {
/* 159 */     String path = dir + "mzm.gsp.gift.confbean.SGiftCfg.bny";
/*     */     try
/*     */     {
...
/*     */ 
/*     */ 
/*     */   public static SGiftCfg getOld(int key)
/*     */   {
/* 207 */     return (SGiftCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SGiftCfg get(int key)
/*     */   {
/* 212 */     return (SGiftCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SGiftCfg> getOldAll()
/*     */   {
/* 217 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SGiftCfg> getAll()
/*     */   {
/* 222 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SGiftCfg> newAll)
/*     */   {
/* 227 */     oldAll = all;
/* 228 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\gift\confbean\SGiftCfg.class
