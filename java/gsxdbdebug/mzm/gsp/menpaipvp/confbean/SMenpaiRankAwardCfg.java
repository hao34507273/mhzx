...
/*     */ 
/*     */ public class SMenpaiRankAwardCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SMenpaiRankAwardCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SMenpaiRankAwardCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public int menpai;
/*     */   public int rank;
/*  21 */   public java.util.ArrayList<MenpaiRankAward> award = new java.util.ArrayList();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  25 */     this.id = Integer.valueOf(rootElement.attributeValue("id")).intValue();
/*  26 */     this.menpai = Integer.valueOf(rootElement.attributeValue("menpai")).intValue();
/*  27 */     this.rank = Integer.valueOf(rootElement.attributeValue("rank")).intValue();
/*     */     
/*  29 */     Element collectionElement = util.XmlHelper.getVariableElement(rootElement, "award");
...
/*  40 */       if (elem.getName().equalsIgnoreCase("mzm.gsp.menpaipvp.confbean.MenpaiRankAward"))
/*     */       {
/*     */         MenpaiRankAward _v_;
/*     */         
/*     */ 
...
/*  63 */     _os_.marshal(this.menpai);
/*  64 */     _os_.marshal(this.rank);
/*  65 */     _os_.compact_uint32(this.award.size());
/*  66 */     for (MenpaiRankAward _v_ : this.award)
/*     */     {
/*  68 */       _os_.marshal(_v_);
/*     */     }
/*  70 */     return _os_;
...
/*     */   {
/*  90 */     String path = dir + "mzm.gsp.menpaipvp.confbean.SMenpaiRankAwardCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 103 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.menpaipvp.confbean.SMenpaiRankAwardCfg"))
/*     */         {
/*     */ 
/* 106 */           SMenpaiRankAwardCfg obj = new SMenpaiRankAwardCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SMenpaiRankAwardCfg> all)
/*     */   {
/* 120 */     String path = dir + "mzm.gsp.menpaipvp.confbean.SMenpaiRankAwardCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 132 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.menpaipvp.confbean.SMenpaiRankAwardCfg"))
/*     */         {
/*     */ 
/* 135 */           SMenpaiRankAwardCfg obj = new SMenpaiRankAwardCfg();
...
/*     */     
/* 151 */     String path = dir + "mzm.gsp.menpaipvp.confbean.SMenpaiRankAwardCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           SMenpaiRankAwardCfg _v_ = new SMenpaiRankAwardCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SMenpaiRankAwardCfg> all)
/*     */   {
/* 198 */     String path = dir + "mzm.gsp.menpaipvp.confbean.SMenpaiRankAwardCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 225 */           SMenpaiRankAwardCfg _v_ = new SMenpaiRankAwardCfg();
...
/*     */ 
/*     */ 
/*     */   public static SMenpaiRankAwardCfg getOld(int key)
/*     */   {
/* 246 */     return (SMenpaiRankAwardCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SMenpaiRankAwardCfg get(int key)
/*     */   {
/* 251 */     return (SMenpaiRankAwardCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMenpaiRankAwardCfg> getOldAll()
/*     */   {
/* 256 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMenpaiRankAwardCfg> getAll()
/*     */   {
/* 261 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SMenpaiRankAwardCfg> newAll)
/*     */   {
/* 266 */     oldAll = all;
/* 267 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\menpaipvp\confbean\SMenpaiRankAwardCfg.class
