...
/*     */ 
/*     */ public class SMenpaiCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SMenpaiCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SMenpaiCfg> all = null;
/*     */   
/*     */   public int menpai;
/*     */   public int mapid;
/*     */   public int npcid;
...
/*     */   {
/*  25 */     this.menpai = Integer.valueOf(rootElement.attributeValue("menpai")).intValue();
...
/*  28 */     this.appellation = Integer.valueOf(rootElement.attributeValue("appellation")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  33 */     _os_.marshal(this.menpai);
/*  34 */     _os_.marshal(this.mapid);
/*  35 */     _os_.marshal(this.npcid);
/*  36 */     _os_.marshal(this.appellation);
/*  37 */     return _os_;
/*     */   }
/*     */   
/*     */   public OctetsStream unmarshal(OctetsStream _os_) throws com.goldhuman.Common.Marshal.MarshalException
/*     */   {
/*  42 */     this.menpai = _os_.unmarshal_int();
/*  43 */     this.mapid = _os_.unmarshal_int();
/*  44 */     this.npcid = _os_.unmarshal_int();
/*  45 */     this.appellation = _os_.unmarshal_int();
/*  46 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  51 */     String path = dir + "mzm.gsp.menpaipvp.confbean.SMenpaiCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  64 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.menpaipvp.confbean.SMenpaiCfg"))
/*     */         {
/*     */ 
/*  67 */           SMenpaiCfg obj = new SMenpaiCfg();
/*  68 */           obj.loadFromXml(elem);
/*  69 */           if (all.put(Integer.valueOf(obj.menpai), obj) != null) {
/*  70 */             throw new RuntimeException("duplicate key : " + obj.menpai);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SMenpaiCfg> all)
/*     */   {
/*  81 */     String path = dir + "mzm.gsp.menpaipvp.confbean.SMenpaiCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.menpaipvp.confbean.SMenpaiCfg"))
/*     */         {
/*     */ 
/*  96 */           SMenpaiCfg obj = new SMenpaiCfg();
/*  97 */           obj.loadFromXml(elem);
/*  98 */           if (all.put(Integer.valueOf(obj.menpai), obj) != null) {
/*  99 */             throw new RuntimeException("duplicate key : " + obj.menpai);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 112 */     String path = dir + "mzm.gsp.menpaipvp.confbean.SMenpaiCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 139 */           SMenpaiCfg _v_ = new SMenpaiCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SMenpaiCfg> all)
/*     */   {
/* 159 */     String path = dir + "mzm.gsp.menpaipvp.confbean.SMenpaiCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 186 */           SMenpaiCfg _v_ = new SMenpaiCfg();
...
/*     */ 
/*     */ 
/*     */   public static SMenpaiCfg getOld(int key)
/*     */   {
/* 207 */     return (SMenpaiCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SMenpaiCfg get(int key)
/*     */   {
/* 212 */     return (SMenpaiCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMenpaiCfg> getOldAll()
/*     */   {
/* 217 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMenpaiCfg> getAll()
/*     */   {
/* 222 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SMenpaiCfg> newAll)
/*     */   {
/* 227 */     oldAll = all;
/* 228 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\menpaipvp\confbean\SMenpaiCfg.class
