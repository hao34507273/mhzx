...
/*     */ 
/*     */ public class PreparePregnancyConsts
/*     */ {
/*  13 */   private static volatile PreparePregnancyConsts oldInstance = null;
/*     */   
/*  15 */   private static PreparePregnancyConsts instance = new PreparePregnancyConsts();
/*     */   
/*     */   public int ACTIVITY_CFG_ID;
/*     */   public int BUBBLE_GAME_ID;
/*     */   public int INVITE_TIMEOUT_TIME;
/*     */   
/*     */   public static PreparePregnancyConsts getOldInstance()
/*     */   {
/*  23 */     return oldInstance;
/*     */   }
/*     */   
/*     */   public static PreparePregnancyConsts getInstance()
/*     */   {
/*  28 */     return instance;
/*     */   }
/*     */   
...
/*     */   {
/*  42 */     String path = dir + "mzm.gsp.children.confbean.PreparePregnancyConsts.xml";
/*     */     try
/*     */     {
...
/*     */         }
/*     */       }
/*  62 */       this.ACTIVITY_CFG_ID = Integer.valueOf(((Element)data.get("ACTIVITY_CFG_ID")).attributeValue("value")).intValue();
/*  63 */       this.BUBBLE_GAME_ID = Integer.valueOf(((Element)data.get("BUBBLE_GAME_ID")).attributeValue("value")).intValue();
/*  64 */       this.INVITE_TIMEOUT_TIME = Integer.valueOf(((Element)data.get("INVITE_TIMEOUT_TIME")).attributeValue("value")).intValue();
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*  73 */     String path = dir + "mzm.gsp.children.confbean.PreparePregnancyConsts.xml";
/*     */     try
/*     */     {
...
/*  94 */       this.BUBBLE_GAME_ID = Integer.valueOf(((Element)data.get("BUBBLE_GAME_ID")).attributeValue("value")).intValue();
/*  95 */       this.INVITE_TIMEOUT_TIME = Integer.valueOf(((Element)data.get("INVITE_TIMEOUT_TIME")).attributeValue("value")).intValue();
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/* 106 */     String path = dir + "mzm.gsp.children.confbean.PreparePregnancyConsts.bny";
/*     */     try
/*     */     {
...
/* 121 */         this.ACTIVITY_CFG_ID = _os_.unmarshal_int();
/* 122 */         this.BUBBLE_GAME_ID = _os_.unmarshal_int();
/* 123 */         this.INVITE_TIMEOUT_TIME = _os_.unmarshal_int();
/*     */       }
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*     */   {
/* 134 */     String path = dir + "mzm.gsp.children.confbean.PreparePregnancyConsts.bny";
/*     */     try
/*     */     {
...
/* 150 */         this.BUBBLE_GAME_ID = _os_.unmarshal_int();
/* 151 */         this.INVITE_TIMEOUT_TIME = _os_.unmarshal_int();
/*     */       }
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*     */   }
/*     */   
/*     */   public static void setInstance(PreparePregnancyConsts newInstance)
/*     */   {
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\children\confbean\PreparePregnancyConsts.class
