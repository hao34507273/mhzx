...
/*     */ 
/*     */ public class SChildrenFightProp2BasePropTransform implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SChildrenFightProp2BasePropTransform> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SChildrenFightProp2BasePropTransform> all = null;
/*     */   
/*     */   public int fightProp;
/*  19 */   public HashMap<Integer, Double> baseProp2Factor = new HashMap();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.fightProp = Integer.valueOf(rootElement.attributeValue("fightProp")).intValue();
/*     */     
/*  25 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "baseProp2Factor");
...
/*     */         }
/*     */         
/*  76 */         this.baseProp2Factor.put(Integer.valueOf(_k_), Double.valueOf(_v_));
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*     */   {
/*  83 */     _os_.marshal(this.fightProp);
/*  84 */     _os_.compact_uint32(this.baseProp2Factor.size());
/*  85 */     for (java.util.Map.Entry<Integer, Double> _e_ : this.baseProp2Factor.entrySet())
/*     */     {
...
/*     */   {
/*  95 */     this.fightProp = _os_.unmarshal_int();
...
/* 102 */       this.baseProp2Factor.put(Integer.valueOf(_k_), Double.valueOf(_v_));
/*     */     }
/* 104 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/* 109 */     String path = dir + "mzm.gsp.children.confbean.SChildrenFightProp2BasePropTransform.xml";
/*     */     
/*     */     try
/*     */     {
/* 113 */       all = new HashMap();
...
/* 122 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.children.confbean.SChildrenFightProp2BasePropTransform"))
/*     */         {
/*     */ 
/* 125 */           SChildrenFightProp2BasePropTransform obj = new SChildrenFightProp2BasePropTransform();
/* 126 */           obj.loadFromXml(elem);
/* 127 */           if (all.put(Integer.valueOf(obj.fightProp), obj) != null) {
/* 128 */             throw new RuntimeException("duplicate key : " + obj.fightProp);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SChildrenFightProp2BasePropTransform> all)
/*     */   {
/* 139 */     String path = dir + "mzm.gsp.children.confbean.SChildrenFightProp2BasePropTransform.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 151 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.children.confbean.SChildrenFightProp2BasePropTransform"))
/*     */         {
/*     */ 
/* 154 */           SChildrenFightProp2BasePropTransform obj = new SChildrenFightProp2BasePropTransform();
/* 155 */           obj.loadFromXml(elem);
/* 156 */           if (all.put(Integer.valueOf(obj.fightProp), obj) != null) {
/* 157 */             throw new RuntimeException("duplicate key : " + obj.fightProp);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/* 168 */     all = new HashMap();
/*     */     
/* 170 */     String path = dir + "mzm.gsp.children.confbean.SChildrenFightProp2BasePropTransform.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 197 */           SChildrenFightProp2BasePropTransform _v_ = new SChildrenFightProp2BasePropTransform();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SChildrenFightProp2BasePropTransform> all)
/*     */   {
/* 217 */     String path = dir + "mzm.gsp.children.confbean.SChildrenFightProp2BasePropTransform.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 244 */           SChildrenFightProp2BasePropTransform _v_ = new SChildrenFightProp2BasePropTransform();
...
/*     */ 
/*     */ 
/*     */   public static SChildrenFightProp2BasePropTransform getOld(int key)
/*     */   {
/* 265 */     return (SChildrenFightProp2BasePropTransform)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SChildrenFightProp2BasePropTransform get(int key)
/*     */   {
/* 270 */     return (SChildrenFightProp2BasePropTransform)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SChildrenFightProp2BasePropTransform> getOldAll()
/*     */   {
/* 275 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SChildrenFightProp2BasePropTransform> getAll()
/*     */   {
/* 280 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SChildrenFightProp2BasePropTransform> newAll)
/*     */   {
/* 285 */     oldAll = all;
/* 286 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\children\confbean\SChildrenFightProp2BasePropTransform.class
