...
/*     */ 
/*     */ public class SChildrenOccupationSkillIndexCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SChildrenOccupationSkillIndexCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SChildrenOccupationSkillIndexCfg> all = null;
/*     */   
/*     */   public int occupation;
/*  19 */   public HashMap<Integer, Integer> index2Skill = new HashMap();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.occupation = Integer.valueOf(rootElement.attributeValue("occupation")).intValue();
/*     */     
/*  25 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "index2Skill");
...
/*     */         }
/*     */         
/*  76 */         this.index2Skill.put(Integer.valueOf(_k_), Integer.valueOf(_v_));
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*  84 */     _os_.compact_uint32(this.index2Skill.size());
/*  85 */     for (java.util.Map.Entry<Integer, Integer> _e_ : this.index2Skill.entrySet())
/*     */     {
...
/*     */   {
/*  95 */     this.occupation = _os_.unmarshal_int();
...
/* 102 */       this.index2Skill.put(Integer.valueOf(_k_), Integer.valueOf(_v_));
/*     */     }
/* 104 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/* 109 */     String path = dir + "mzm.gsp.children.confbean.SChildrenOccupationSkillIndexCfg.xml";
/*     */     
/*     */     try
/*     */     {
/* 113 */       all = new HashMap();
...
/* 122 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.children.confbean.SChildrenOccupationSkillIndexCfg"))
/*     */         {
/*     */ 
/* 125 */           SChildrenOccupationSkillIndexCfg obj = new SChildrenOccupationSkillIndexCfg();
/* 126 */           obj.loadFromXml(elem);
/* 127 */           if (all.put(Integer.valueOf(obj.occupation), obj) != null) {
/* 128 */             throw new RuntimeException("duplicate key : " + obj.occupation);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SChildrenOccupationSkillIndexCfg> all)
/*     */   {
/* 139 */     String path = dir + "mzm.gsp.children.confbean.SChildrenOccupationSkillIndexCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 151 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.children.confbean.SChildrenOccupationSkillIndexCfg"))
/*     */         {
/*     */ 
/* 154 */           SChildrenOccupationSkillIndexCfg obj = new SChildrenOccupationSkillIndexCfg();
/* 155 */           obj.loadFromXml(elem);
/* 156 */           if (all.put(Integer.valueOf(obj.occupation), obj) != null) {
/* 157 */             throw new RuntimeException("duplicate key : " + obj.occupation);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/* 168 */     all = new HashMap();
/*     */     
/* 170 */     String path = dir + "mzm.gsp.children.confbean.SChildrenOccupationSkillIndexCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 197 */           SChildrenOccupationSkillIndexCfg _v_ = new SChildrenOccupationSkillIndexCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SChildrenOccupationSkillIndexCfg> all)
/*     */   {
/* 217 */     String path = dir + "mzm.gsp.children.confbean.SChildrenOccupationSkillIndexCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 244 */           SChildrenOccupationSkillIndexCfg _v_ = new SChildrenOccupationSkillIndexCfg();
...
/*     */ 
/*     */ 
/*     */   public static SChildrenOccupationSkillIndexCfg getOld(int key)
/*     */   {
/* 265 */     return (SChildrenOccupationSkillIndexCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SChildrenOccupationSkillIndexCfg get(int key)
/*     */   {
/* 270 */     return (SChildrenOccupationSkillIndexCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SChildrenOccupationSkillIndexCfg> getOldAll()
/*     */   {
/* 275 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SChildrenOccupationSkillIndexCfg> getAll()
/*     */   {
/* 280 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SChildrenOccupationSkillIndexCfg> newAll)
/*     */   {
/* 285 */     oldAll = all;
/* 286 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\children\confbean\SChildrenOccupationSkillIndexCfg.class
