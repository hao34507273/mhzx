...
/*     */ 
/*     */ public class SChildrenOccupationSkillLevelUpCostCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SChildrenOccupationSkillLevelUpCostCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SChildrenOccupationSkillLevelUpCostCfg> all = null;
/*     */   
/*     */   public int classid;
/*  19 */   public HashMap<Integer, Integer> skillLv2Count = new HashMap();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.classid = Integer.valueOf(rootElement.attributeValue("classid")).intValue();
/*     */     
/*  25 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "skillLv2Count");
...
/*     */         }
/*     */         
/*  76 */         this.skillLv2Count.put(Integer.valueOf(_k_), Integer.valueOf(_v_));
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*     */   {
/*  83 */     _os_.marshal(this.classid);
/*  84 */     _os_.compact_uint32(this.skillLv2Count.size());
/*  85 */     for (java.util.Map.Entry<Integer, Integer> _e_ : this.skillLv2Count.entrySet())
/*     */     {
...
/*     */   {
/*  95 */     this.classid = _os_.unmarshal_int();
...
/* 102 */       this.skillLv2Count.put(Integer.valueOf(_k_), Integer.valueOf(_v_));
/*     */     }
/* 104 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/* 109 */     String path = dir + "mzm.gsp.children.confbean.SChildrenOccupationSkillLevelUpCostCfg.xml";
/*     */     
/*     */     try
/*     */     {
/* 113 */       all = new HashMap();
...
/* 122 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.children.confbean.SChildrenOccupationSkillLevelUpCostCfg"))
/*     */         {
/*     */ 
/* 125 */           SChildrenOccupationSkillLevelUpCostCfg obj = new SChildrenOccupationSkillLevelUpCostCfg();
/* 126 */           obj.loadFromXml(elem);
/* 127 */           if (all.put(Integer.valueOf(obj.classid), obj) != null) {
/* 128 */             throw new RuntimeException("duplicate key : " + obj.classid);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SChildrenOccupationSkillLevelUpCostCfg> all)
/*     */   {
/* 139 */     String path = dir + "mzm.gsp.children.confbean.SChildrenOccupationSkillLevelUpCostCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 151 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.children.confbean.SChildrenOccupationSkillLevelUpCostCfg"))
/*     */         {
/*     */ 
/* 154 */           SChildrenOccupationSkillLevelUpCostCfg obj = new SChildrenOccupationSkillLevelUpCostCfg();
/* 155 */           obj.loadFromXml(elem);
/* 156 */           if (all.put(Integer.valueOf(obj.classid), obj) != null) {
/* 157 */             throw new RuntimeException("duplicate key : " + obj.classid);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/* 168 */     all = new HashMap();
/*     */     
/* 170 */     String path = dir + "mzm.gsp.children.confbean.SChildrenOccupationSkillLevelUpCostCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 197 */           SChildrenOccupationSkillLevelUpCostCfg _v_ = new SChildrenOccupationSkillLevelUpCostCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SChildrenOccupationSkillLevelUpCostCfg> all)
/*     */   {
/* 217 */     String path = dir + "mzm.gsp.children.confbean.SChildrenOccupationSkillLevelUpCostCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 244 */           SChildrenOccupationSkillLevelUpCostCfg _v_ = new SChildrenOccupationSkillLevelUpCostCfg();
...
/*     */ 
/*     */ 
/*     */   public static SChildrenOccupationSkillLevelUpCostCfg getOld(int key)
/*     */   {
/* 265 */     return (SChildrenOccupationSkillLevelUpCostCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SChildrenOccupationSkillLevelUpCostCfg get(int key)
/*     */   {
/* 270 */     return (SChildrenOccupationSkillLevelUpCostCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SChildrenOccupationSkillLevelUpCostCfg> getOldAll()
/*     */   {
/* 275 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SChildrenOccupationSkillLevelUpCostCfg> getAll()
/*     */   {
/* 280 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SChildrenOccupationSkillLevelUpCostCfg> newAll)
/*     */   {
/* 285 */     oldAll = all;
/* 286 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\children\confbean\SChildrenOccupationSkillLevelUpCostCfg.class
