...
/*     */ 
/*     */ public class SQualityCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SQualityCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SQualityCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public int interestType;
/*     */   public int interest;
/*  21 */   public java.util.ArrayList<QualityInfo> qualities = new java.util.ArrayList();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  25 */     this.id = Integer.valueOf(rootElement.attributeValue("id")).intValue();
/*  26 */     this.interestType = Integer.valueOf(rootElement.attributeValue("interestType")).intValue();
/*  27 */     this.interest = Integer.valueOf(rootElement.attributeValue("interest")).intValue();
/*     */     
/*  29 */     Element collectionElement = util.XmlHelper.getVariableElement(rootElement, "qualities");
...
/*  40 */       if (elem.getName().equalsIgnoreCase("mzm.gsp.children.confbean.QualityInfo"))
/*     */       {
/*     */         QualityInfo _v_;
/*     */         
/*     */ 
...
/*  63 */     _os_.marshal(this.interestType);
/*  64 */     _os_.marshal(this.interest);
/*  65 */     _os_.compact_uint32(this.qualities.size());
/*  66 */     for (QualityInfo _v_ : this.qualities)
/*     */     {
/*  68 */       _os_.marshal(_v_);
/*     */     }
/*  70 */     return _os_;
...
/*  76 */     this.interestType = _os_.unmarshal_int();
/*  77 */     this.interest = _os_.unmarshal_int();
/*  78 */     for (int _size_ = _os_.uncompact_uint32(); _size_ > 0; _size_--)
/*     */     {
/*     */ 
/*  81 */       QualityInfo _v_ = new QualityInfo();
/*  82 */       _v_.unmarshal(_os_);
/*  83 */       this.qualities.add(_v_);
/*     */     }
/*  85 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/*  90 */     String path = dir + "mzm.gsp.children.confbean.SQualityCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 103 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.children.confbean.SQualityCfg"))
/*     */         {
/*     */ 
/* 106 */           SQualityCfg obj = new SQualityCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SQualityCfg> all)
/*     */   {
/* 120 */     String path = dir + "mzm.gsp.children.confbean.SQualityCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 132 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.children.confbean.SQualityCfg"))
/*     */         {
/*     */ 
/* 135 */           SQualityCfg obj = new SQualityCfg();
...
/*     */     
/* 151 */     String path = dir + "mzm.gsp.children.confbean.SQualityCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           SQualityCfg _v_ = new SQualityCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SQualityCfg> all)
/*     */   {
/* 198 */     String path = dir + "mzm.gsp.children.confbean.SQualityCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 225 */           SQualityCfg _v_ = new SQualityCfg();
...
/*     */ 
/*     */ 
/*     */   public static SQualityCfg getOld(int key)
/*     */   {
/* 246 */     return (SQualityCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SQualityCfg get(int key)
/*     */   {
/* 251 */     return (SQualityCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SQualityCfg> getOldAll()
/*     */   {
/* 256 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SQualityCfg> getAll()
/*     */   {
/* 261 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SQualityCfg> newAll)
/*     */   {
/* 266 */     oldAll = all;
/* 267 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\children\confbean\SQualityCfg.class
