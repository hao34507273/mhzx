...
/*     */ 
/*     */ public class SChildrenEquipLevelCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SChildrenEquipLevelCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SChildrenEquipLevelCfg> all = null;
/*     */   
/*     */   public int levelTypeid;
/*  19 */   public HashMap<Integer, ChildrenEquipLevelBean> level2EquipLevelBean = new HashMap();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.levelTypeid = Integer.valueOf(rootElement.attributeValue("levelTypeid")).intValue();
/*     */     
/*  25 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "level2EquipLevelBean");
...
/*  51 */             keyElem = elem;
/*     */           }
/*  53 */           else if ((valueElem == null) && (elem.getName().equalsIgnoreCase("mzm.gsp.children.confbean.ChildrenEquipLevelBean")))
/*     */           {
/*  55 */             valueElem = elem;
/*     */           }
/*     */         }
...
/*     */         
/*     */         int _k_;
/*     */         ChildrenEquipLevelBean _v_;
/*     */         try
/*     */         {
/*  68 */           _k_ = Integer.valueOf(keyElem.getText()).intValue();
/*  69 */           _v_ = new ChildrenEquipLevelBean();
...
/*     */         }
/*     */         
/*  77 */         this.level2EquipLevelBean.put(Integer.valueOf(_k_), _v_);
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*     */   {
/*  84 */     _os_.marshal(this.levelTypeid);
/*  85 */     _os_.compact_uint32(this.level2EquipLevelBean.size());
/*  86 */     for (java.util.Map.Entry<Integer, ChildrenEquipLevelBean> _e_ : this.level2EquipLevelBean.entrySet())
/*     */     {
...
/*     */   {
/*  96 */     this.levelTypeid = _os_.unmarshal_int();
/*  97 */     for (int _size_ = _os_.uncompact_uint32(); _size_ > 0; _size_--)
/*     */     {
/*     */ 
/* 100 */       int _k_ = _os_.unmarshal_int();
/*     */       
/* 102 */       ChildrenEquipLevelBean _v_ = new ChildrenEquipLevelBean();
/* 103 */       _v_.unmarshal(_os_);
/* 104 */       this.level2EquipLevelBean.put(Integer.valueOf(_k_), _v_);
/*     */     }
/* 106 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/* 111 */     String path = dir + "mzm.gsp.children.confbean.SChildrenEquipLevelCfg.xml";
/*     */     
/*     */     try
/*     */     {
/* 115 */       all = new HashMap();
...
/* 124 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.children.confbean.SChildrenEquipLevelCfg"))
/*     */         {
/*     */ 
/* 127 */           SChildrenEquipLevelCfg obj = new SChildrenEquipLevelCfg();
/* 128 */           obj.loadFromXml(elem);
/* 129 */           if (all.put(Integer.valueOf(obj.levelTypeid), obj) != null) {
/* 130 */             throw new RuntimeException("duplicate key : " + obj.levelTypeid);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SChildrenEquipLevelCfg> all)
/*     */   {
/* 141 */     String path = dir + "mzm.gsp.children.confbean.SChildrenEquipLevelCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 153 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.children.confbean.SChildrenEquipLevelCfg"))
/*     */         {
/*     */ 
/* 156 */           SChildrenEquipLevelCfg obj = new SChildrenEquipLevelCfg();
/* 157 */           obj.loadFromXml(elem);
/* 158 */           if (all.put(Integer.valueOf(obj.levelTypeid), obj) != null) {
/* 159 */             throw new RuntimeException("duplicate key : " + obj.levelTypeid);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/* 170 */     all = new HashMap();
/*     */     
/* 172 */     String path = dir + "mzm.gsp.children.confbean.SChildrenEquipLevelCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 199 */           SChildrenEquipLevelCfg _v_ = new SChildrenEquipLevelCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SChildrenEquipLevelCfg> all)
/*     */   {
/* 219 */     String path = dir + "mzm.gsp.children.confbean.SChildrenEquipLevelCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 246 */           SChildrenEquipLevelCfg _v_ = new SChildrenEquipLevelCfg();
...
/*     */ 
/*     */ 
/*     */   public static SChildrenEquipLevelCfg getOld(int key)
/*     */   {
/* 267 */     return (SChildrenEquipLevelCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SChildrenEquipLevelCfg get(int key)
/*     */   {
/* 272 */     return (SChildrenEquipLevelCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SChildrenEquipLevelCfg> getOldAll()
/*     */   {
/* 277 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SChildrenEquipLevelCfg> getAll()
/*     */   {
/* 282 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SChildrenEquipLevelCfg> newAll)
/*     */   {
/* 287 */     oldAll = all;
/* 288 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\children\confbean\SChildrenEquipLevelCfg.class
