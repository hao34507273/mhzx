...
/*     */ 
/*     */ public class SChildrenUnLockSkillCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SChildrenUnLockSkillCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SChildrenUnLockSkillCfg> all = null;
/*     */   
/*     */   public int id;
/*  19 */   public java.util.ArrayList<UnLockSkillCost> unLockSkillCostList = new java.util.ArrayList();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.id = Integer.valueOf(rootElement.attributeValue("id")).intValue();
/*     */     
/*  25 */     Element collectionElement = util.XmlHelper.getVariableElement(rootElement, "unLockSkillCostList");
...
/*  36 */       if (elem.getName().equalsIgnoreCase("mzm.gsp.children.confbean.UnLockSkillCost"))
/*     */       {
/*     */         UnLockSkillCost _v_;
/*     */         
/*     */ 
...
/*     */         }
/*     */         
/*  51 */         this.unLockSkillCostList.add(_v_);
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*  59 */     _os_.compact_uint32(this.unLockSkillCostList.size());
/*  60 */     for (UnLockSkillCost _v_ : this.unLockSkillCostList)
/*     */     {
/*  62 */       _os_.marshal(_v_);
/*     */     }
/*  64 */     return _os_;
...
/*     */     {
/*     */ 
/*  73 */       UnLockSkillCost _v_ = new UnLockSkillCost();
/*  74 */       _v_.unmarshal(_os_);
/*  75 */       this.unLockSkillCostList.add(_v_);
/*     */     }
/*  77 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/*  82 */     String path = dir + "mzm.gsp.children.confbean.SChildrenUnLockSkillCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  95 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.children.confbean.SChildrenUnLockSkillCfg"))
/*     */         {
/*     */ 
/*  98 */           SChildrenUnLockSkillCfg obj = new SChildrenUnLockSkillCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SChildrenUnLockSkillCfg> all)
/*     */   {
/* 112 */     String path = dir + "mzm.gsp.children.confbean.SChildrenUnLockSkillCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 124 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.children.confbean.SChildrenUnLockSkillCfg"))
/*     */         {
/*     */ 
/* 127 */           SChildrenUnLockSkillCfg obj = new SChildrenUnLockSkillCfg();
...
/*     */     
/* 143 */     String path = dir + "mzm.gsp.children.confbean.SChildrenUnLockSkillCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 170 */           SChildrenUnLockSkillCfg _v_ = new SChildrenUnLockSkillCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SChildrenUnLockSkillCfg> all)
/*     */   {
/* 190 */     String path = dir + "mzm.gsp.children.confbean.SChildrenUnLockSkillCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 217 */           SChildrenUnLockSkillCfg _v_ = new SChildrenUnLockSkillCfg();
...
/*     */ 
/*     */ 
/*     */   public static SChildrenUnLockSkillCfg getOld(int key)
/*     */   {
/* 238 */     return (SChildrenUnLockSkillCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SChildrenUnLockSkillCfg get(int key)
/*     */   {
/* 243 */     return (SChildrenUnLockSkillCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SChildrenUnLockSkillCfg> getOldAll()
/*     */   {
/* 248 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SChildrenUnLockSkillCfg> getAll()
/*     */   {
/* 253 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SChildrenUnLockSkillCfg> newAll)
/*     */   {
/* 258 */     oldAll = all;
/* 259 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\children\confbean\SChildrenUnLockSkillCfg.class
