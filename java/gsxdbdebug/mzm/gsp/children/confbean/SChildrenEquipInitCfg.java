...
/*     */ 
/*     */ public class SChildrenEquipInitCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SChildrenEquipInitCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SChildrenEquipInitCfg> all = null;
/*     */   
/*     */   public int childCfgid;
/*  19 */   public java.util.ArrayList<Integer> equipids = new java.util.ArrayList();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.childCfgid = Integer.valueOf(rootElement.attributeValue("childCfgid")).intValue();
/*     */     
/*  25 */     Element collectionElement = util.XmlHelper.getVariableElement(rootElement, "equipids");
...
/*     */         }
/*     */         
/*  50 */         this.equipids.add(Integer.valueOf(_v_));
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*     */   {
/*  57 */     _os_.marshal(this.childCfgid);
/*  58 */     _os_.compact_uint32(this.equipids.size());
/*  59 */     for (Integer _v_ : this.equipids)
/*     */     {
...
/*     */   {
/*  80 */     String path = dir + "mzm.gsp.children.confbean.SChildrenEquipInitCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.children.confbean.SChildrenEquipInitCfg"))
/*     */         {
/*     */ 
/*  96 */           SChildrenEquipInitCfg obj = new SChildrenEquipInitCfg();
/*  97 */           obj.loadFromXml(elem);
/*  98 */           if (all.put(Integer.valueOf(obj.childCfgid), obj) != null) {
/*  99 */             throw new RuntimeException("duplicate key : " + obj.childCfgid);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SChildrenEquipInitCfg> all)
/*     */   {
/* 110 */     String path = dir + "mzm.gsp.children.confbean.SChildrenEquipInitCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 122 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.children.confbean.SChildrenEquipInitCfg"))
/*     */         {
/*     */ 
/* 125 */           SChildrenEquipInitCfg obj = new SChildrenEquipInitCfg();
/* 126 */           obj.loadFromXml(elem);
/* 127 */           if (all.put(Integer.valueOf(obj.childCfgid), obj) != null) {
/* 128 */             throw new RuntimeException("duplicate key : " + obj.childCfgid);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 141 */     String path = dir + "mzm.gsp.children.confbean.SChildrenEquipInitCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 168 */           SChildrenEquipInitCfg _v_ = new SChildrenEquipInitCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SChildrenEquipInitCfg> all)
/*     */   {
/* 188 */     String path = dir + "mzm.gsp.children.confbean.SChildrenEquipInitCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 215 */           SChildrenEquipInitCfg _v_ = new SChildrenEquipInitCfg();
...
/*     */ 
/*     */ 
/*     */   public static SChildrenEquipInitCfg getOld(int key)
/*     */   {
/* 236 */     return (SChildrenEquipInitCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SChildrenEquipInitCfg get(int key)
/*     */   {
/* 241 */     return (SChildrenEquipInitCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SChildrenEquipInitCfg> getOldAll()
/*     */   {
/* 246 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SChildrenEquipInitCfg> getAll()
/*     */   {
/* 251 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SChildrenEquipInitCfg> newAll)
/*     */   {
/* 256 */     oldAll = all;
/* 257 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\children\confbean\SChildrenEquipInitCfg.class
