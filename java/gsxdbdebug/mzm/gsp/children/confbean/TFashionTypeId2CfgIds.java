...
/*     */ 
/*     */ public class TFashionTypeId2CfgIds implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, TFashionTypeId2CfgIds> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, TFashionTypeId2CfgIds> all = null;
/*     */   
/*     */   public int typeId;
/*  19 */   public java.util.ArrayList<Integer> cfgIds = new java.util.ArrayList();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.typeId = Integer.valueOf(rootElement.attributeValue("typeId")).intValue();
/*     */     
/*  25 */     Element collectionElement = util.XmlHelper.getVariableElement(rootElement, "cfgIds");
...
/*     */         }
/*     */         
/*  50 */         this.cfgIds.add(Integer.valueOf(_v_));
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*  58 */     _os_.compact_uint32(this.cfgIds.size());
/*  59 */     for (Integer _v_ : this.cfgIds)
/*     */     {
...
/*  73 */       this.cfgIds.add(Integer.valueOf(_v_));
/*     */     }
/*  75 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/*  80 */     String path = dir + "mzm.gsp.children.confbean.TFashionTypeId2CfgIds.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.children.confbean.TFashionTypeId2CfgIds"))
/*     */         {
/*     */ 
/*  96 */           TFashionTypeId2CfgIds obj = new TFashionTypeId2CfgIds();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, TFashionTypeId2CfgIds> all)
/*     */   {
/* 110 */     String path = dir + "mzm.gsp.children.confbean.TFashionTypeId2CfgIds.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 122 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.children.confbean.TFashionTypeId2CfgIds"))
/*     */         {
/*     */ 
/* 125 */           TFashionTypeId2CfgIds obj = new TFashionTypeId2CfgIds();
...
/*     */     
/* 141 */     String path = dir + "mzm.gsp.children.confbean.TFashionTypeId2CfgIds.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 168 */           TFashionTypeId2CfgIds _v_ = new TFashionTypeId2CfgIds();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, TFashionTypeId2CfgIds> all)
/*     */   {
/* 188 */     String path = dir + "mzm.gsp.children.confbean.TFashionTypeId2CfgIds.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 215 */           TFashionTypeId2CfgIds _v_ = new TFashionTypeId2CfgIds();
...
/*     */ 
/*     */ 
/*     */   public static TFashionTypeId2CfgIds getOld(int key)
/*     */   {
/* 236 */     return (TFashionTypeId2CfgIds)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static TFashionTypeId2CfgIds get(int key)
/*     */   {
/* 241 */     return (TFashionTypeId2CfgIds)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, TFashionTypeId2CfgIds> getOldAll()
/*     */   {
/* 246 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, TFashionTypeId2CfgIds> getAll()
/*     */   {
/* 251 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, TFashionTypeId2CfgIds> newAll)
/*     */   {
/* 256 */     oldAll = all;
/* 257 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\children\confbean\TFashionTypeId2CfgIds.class
