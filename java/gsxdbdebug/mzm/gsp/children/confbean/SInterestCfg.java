...
/*     */ 
/*     */ public class SInterestCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SInterestCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SInterestCfg> all = null;
/*     */   
...
/*     */   {
/*  23 */     this.interestType = Integer.valueOf(rootElement.attributeValue("interestType")).intValue();
/*  24 */     this.limit = Integer.valueOf(rootElement.attributeValue("limit")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  29 */     _os_.marshal(this.interestType);
/*  30 */     _os_.marshal(this.limit);
/*  31 */     return _os_;
/*     */   }
/*     */   
/*     */   public OctetsStream unmarshal(OctetsStream _os_) throws com.goldhuman.Common.Marshal.MarshalException
/*     */   {
/*  36 */     this.interestType = _os_.unmarshal_int();
/*  37 */     this.limit = _os_.unmarshal_int();
/*  38 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.children.confbean.SInterestCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.children.confbean.SInterestCfg"))
/*     */         {
/*     */ 
/*  59 */           SInterestCfg obj = new SInterestCfg();
/*  60 */           obj.loadFromXml(elem);
/*  61 */           if (all.put(Integer.valueOf(obj.interestType), obj) != null) {
/*  62 */             throw new RuntimeException("duplicate key : " + obj.interestType);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SInterestCfg> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.children.confbean.SInterestCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.children.confbean.SInterestCfg"))
/*     */         {
/*     */ 
/*  88 */           SInterestCfg obj = new SInterestCfg();
/*  89 */           obj.loadFromXml(elem);
/*  90 */           if (all.put(Integer.valueOf(obj.interestType), obj) != null) {
/*  91 */             throw new RuntimeException("duplicate key : " + obj.interestType);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.children.confbean.SInterestCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           SInterestCfg _v_ = new SInterestCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SInterestCfg> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.children.confbean.SInterestCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           SInterestCfg _v_ = new SInterestCfg();
...
/*     */ 
/*     */ 
/*     */   public static SInterestCfg getOld(int key)
/*     */   {
/* 199 */     return (SInterestCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SInterestCfg get(int key)
/*     */   {
/* 204 */     return (SInterestCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SInterestCfg> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SInterestCfg> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SInterestCfg> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\children\confbean\SInterestCfg.class
