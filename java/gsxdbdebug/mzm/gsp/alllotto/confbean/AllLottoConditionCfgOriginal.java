...
/*     */ 
/*     */ public class AllLottoConditionCfgOriginal implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, AllLottoConditionCfgOriginal> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, AllLottoConditionCfgOriginal> all = null;
/*     */   
/*     */   public int id;
...
/*  27 */     this.activity_cfg_id = Integer.valueOf(rootElement.attributeValue("activity_cfg_id")).intValue();
/*  28 */     this.sortid = Integer.valueOf(rootElement.attributeValue("sortid")).intValue();
/*  29 */     this.condition_type = Integer.valueOf(rootElement.attributeValue("condition_type")).intValue();
/*  30 */     this.condition_value = Integer.valueOf(rootElement.attributeValue("condition_value")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  35 */     _os_.marshal(this.id);
/*  36 */     _os_.marshal(this.activity_cfg_id);
/*  37 */     _os_.marshal(this.sortid);
/*  38 */     _os_.marshal(this.condition_type);
/*  39 */     _os_.marshal(this.condition_value);
/*  40 */     return _os_;
/*     */   }
/*     */   
...
/*  46 */     this.activity_cfg_id = _os_.unmarshal_int();
/*  47 */     this.sortid = _os_.unmarshal_int();
/*  48 */     this.condition_type = _os_.unmarshal_int();
/*  49 */     this.condition_value = _os_.unmarshal_int();
/*  50 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  55 */     String path = dir + "mzm.gsp.alllotto.confbean.AllLottoConditionCfgOriginal.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  68 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.alllotto.confbean.AllLottoConditionCfgOriginal"))
/*     */         {
/*     */ 
/*  71 */           AllLottoConditionCfgOriginal obj = new AllLottoConditionCfgOriginal();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, AllLottoConditionCfgOriginal> all)
/*     */   {
/*  85 */     String path = dir + "mzm.gsp.alllotto.confbean.AllLottoConditionCfgOriginal.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  97 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.alllotto.confbean.AllLottoConditionCfgOriginal"))
/*     */         {
/*     */ 
/* 100 */           AllLottoConditionCfgOriginal obj = new AllLottoConditionCfgOriginal();
...
/*     */     
/* 116 */     String path = dir + "mzm.gsp.alllotto.confbean.AllLottoConditionCfgOriginal.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 143 */           AllLottoConditionCfgOriginal _v_ = new AllLottoConditionCfgOriginal();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, AllLottoConditionCfgOriginal> all)
/*     */   {
/* 163 */     String path = dir + "mzm.gsp.alllotto.confbean.AllLottoConditionCfgOriginal.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 190 */           AllLottoConditionCfgOriginal _v_ = new AllLottoConditionCfgOriginal();
...
/*     */ 
/*     */ 
/*     */   public static AllLottoConditionCfgOriginal getOld(int key)
/*     */   {
/* 211 */     return (AllLottoConditionCfgOriginal)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static AllLottoConditionCfgOriginal get(int key)
/*     */   {
/* 216 */     return (AllLottoConditionCfgOriginal)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, AllLottoConditionCfgOriginal> getOldAll()
/*     */   {
/* 221 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, AllLottoConditionCfgOriginal> getAll()
/*     */   {
/* 226 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, AllLottoConditionCfgOriginal> newAll)
/*     */   {
/* 231 */     oldAll = all;
/* 232 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\alllotto\confbean\AllLottoConditionCfgOriginal.class
