...
/*     */ 
/*     */ public class LeGouShangChengConsts
/*     */ {
/*  13 */   private static volatile LeGouShangChengConsts oldInstance = null;
/*     */   
/*  15 */   private static LeGouShangChengConsts instance = new LeGouShangChengConsts();
/*     */   
/*     */   public int roleMinLevel;
/*     */   
/*     */   public int dayCount;
/*     */   
/*     */   public static LeGouShangChengConsts getOldInstance()
/*     */   {
/*  23 */     return oldInstance;
/*     */   }
/*     */   
/*     */   public static LeGouShangChengConsts getInstance()
/*     */   {
/*  28 */     return instance;
/*     */   }
/*     */   
...
/*     */   {
/*  41 */     String path = dir + "mzm.gsp.legoushangcheng.confbean.LeGouShangChengConsts.xml";
/*     */     try
/*     */     {
...
/*     */         }
/*     */       }
/*  61 */       this.roleMinLevel = Integer.valueOf(((Element)data.get("roleMinLevel")).attributeValue("value")).intValue();
/*  62 */       this.dayCount = Integer.valueOf(((Element)data.get("dayCount")).attributeValue("value")).intValue();
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*  71 */     String path = dir + "mzm.gsp.legoushangcheng.confbean.LeGouShangChengConsts.xml";
/*     */     try
/*     */     {
...
/*     */         }
/*     */       }
/*  91 */       this.roleMinLevel = Integer.valueOf(((Element)data.get("roleMinLevel")).attributeValue("value")).intValue();
/*  92 */       this.dayCount = Integer.valueOf(((Element)data.get("dayCount")).attributeValue("value")).intValue();
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/* 103 */     String path = dir + "mzm.gsp.legoushangcheng.confbean.LeGouShangChengConsts.bny";
/*     */     try
/*     */     {
...
/* 118 */         this.roleMinLevel = _os_.unmarshal_int();
/* 119 */         this.dayCount = _os_.unmarshal_int();
/*     */       }
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*     */   {
/* 130 */     String path = dir + "mzm.gsp.legoushangcheng.confbean.LeGouShangChengConsts.bny";
/*     */     try
/*     */     {
...
/* 145 */         this.roleMinLevel = _os_.unmarshal_int();
/* 146 */         this.dayCount = _os_.unmarshal_int();
/*     */       }
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*     */   }
/*     */   
/*     */   public static void setInstance(LeGouShangChengConsts newInstance)
/*     */   {
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\legoushangcheng\confbean\LeGouShangChengConsts.class
