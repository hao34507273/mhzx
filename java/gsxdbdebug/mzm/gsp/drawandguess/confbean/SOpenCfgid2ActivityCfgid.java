...
/*     */ 
/*     */ public class SOpenCfgid2ActivityCfgid implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SOpenCfgid2ActivityCfgid> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SOpenCfgid2ActivityCfgid> all = null;
/*     */   
...
/*     */   {
/*  23 */     this.openCfgid = Integer.valueOf(rootElement.attributeValue("openCfgid")).intValue();
/*  24 */     this.activityCfgid = Integer.valueOf(rootElement.attributeValue("activityCfgid")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  29 */     _os_.marshal(this.openCfgid);
/*  30 */     _os_.marshal(this.activityCfgid);
/*  31 */     return _os_;
/*     */   }
/*     */   
/*     */   public OctetsStream unmarshal(OctetsStream _os_) throws com.goldhuman.Common.Marshal.MarshalException
/*     */   {
/*  36 */     this.openCfgid = _os_.unmarshal_int();
/*  37 */     this.activityCfgid = _os_.unmarshal_int();
/*  38 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.drawandguess.confbean.SOpenCfgid2ActivityCfgid.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.drawandguess.confbean.SOpenCfgid2ActivityCfgid"))
/*     */         {
/*     */ 
/*  59 */           SOpenCfgid2ActivityCfgid obj = new SOpenCfgid2ActivityCfgid();
/*  60 */           obj.loadFromXml(elem);
/*  61 */           if (all.put(Integer.valueOf(obj.openCfgid), obj) != null) {
/*  62 */             throw new RuntimeException("duplicate key : " + obj.openCfgid);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SOpenCfgid2ActivityCfgid> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.drawandguess.confbean.SOpenCfgid2ActivityCfgid.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.drawandguess.confbean.SOpenCfgid2ActivityCfgid"))
/*     */         {
/*     */ 
/*  88 */           SOpenCfgid2ActivityCfgid obj = new SOpenCfgid2ActivityCfgid();
/*  89 */           obj.loadFromXml(elem);
/*  90 */           if (all.put(Integer.valueOf(obj.openCfgid), obj) != null) {
/*  91 */             throw new RuntimeException("duplicate key : " + obj.openCfgid);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.drawandguess.confbean.SOpenCfgid2ActivityCfgid.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           SOpenCfgid2ActivityCfgid _v_ = new SOpenCfgid2ActivityCfgid();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SOpenCfgid2ActivityCfgid> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.drawandguess.confbean.SOpenCfgid2ActivityCfgid.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           SOpenCfgid2ActivityCfgid _v_ = new SOpenCfgid2ActivityCfgid();
...
/*     */ 
/*     */ 
/*     */   public static SOpenCfgid2ActivityCfgid getOld(int key)
/*     */   {
/* 199 */     return (SOpenCfgid2ActivityCfgid)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SOpenCfgid2ActivityCfgid get(int key)
/*     */   {
/* 204 */     return (SOpenCfgid2ActivityCfgid)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SOpenCfgid2ActivityCfgid> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SOpenCfgid2ActivityCfgid> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SOpenCfgid2ActivityCfgid> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\drawandguess\confbean\SOpenCfgid2ActivityCfgid.class
