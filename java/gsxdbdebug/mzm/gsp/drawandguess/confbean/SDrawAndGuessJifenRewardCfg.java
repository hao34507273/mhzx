...
/*     */ 
/*     */ public class SDrawAndGuessJifenRewardCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SDrawAndGuessJifenRewardCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SDrawAndGuessJifenRewardCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public int libId;
/*     */   public int maxJifen;
...
/*  27 */     this.maxJifen = Integer.valueOf(rootElement.attributeValue("maxJifen")).intValue();
/*  28 */     this.awardCfgid = Integer.valueOf(rootElement.attributeValue("awardCfgid")).intValue();
/*     */   }
/*     */   
...
/*  35 */     _os_.marshal(this.maxJifen);
/*  36 */     _os_.marshal(this.awardCfgid);
/*  37 */     return _os_;
/*     */   }
/*     */   
...
/*  44 */     this.maxJifen = _os_.unmarshal_int();
/*  45 */     this.awardCfgid = _os_.unmarshal_int();
/*  46 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  51 */     String path = dir + "mzm.gsp.drawandguess.confbean.SDrawAndGuessJifenRewardCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  64 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.drawandguess.confbean.SDrawAndGuessJifenRewardCfg"))
/*     */         {
/*     */ 
/*  67 */           SDrawAndGuessJifenRewardCfg obj = new SDrawAndGuessJifenRewardCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SDrawAndGuessJifenRewardCfg> all)
/*     */   {
/*  81 */     String path = dir + "mzm.gsp.drawandguess.confbean.SDrawAndGuessJifenRewardCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.drawandguess.confbean.SDrawAndGuessJifenRewardCfg"))
/*     */         {
/*     */ 
/*  96 */           SDrawAndGuessJifenRewardCfg obj = new SDrawAndGuessJifenRewardCfg();
...
/*     */     
/* 112 */     String path = dir + "mzm.gsp.drawandguess.confbean.SDrawAndGuessJifenRewardCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 139 */           SDrawAndGuessJifenRewardCfg _v_ = new SDrawAndGuessJifenRewardCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SDrawAndGuessJifenRewardCfg> all)
/*     */   {
/* 159 */     String path = dir + "mzm.gsp.drawandguess.confbean.SDrawAndGuessJifenRewardCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 186 */           SDrawAndGuessJifenRewardCfg _v_ = new SDrawAndGuessJifenRewardCfg();
...
/*     */ 
/*     */ 
/*     */   public static SDrawAndGuessJifenRewardCfg getOld(int key)
/*     */   {
/* 207 */     return (SDrawAndGuessJifenRewardCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SDrawAndGuessJifenRewardCfg get(int key)
/*     */   {
/* 212 */     return (SDrawAndGuessJifenRewardCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SDrawAndGuessJifenRewardCfg> getOldAll()
/*     */   {
/* 217 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SDrawAndGuessJifenRewardCfg> getAll()
/*     */   {
/* 222 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SDrawAndGuessJifenRewardCfg> newAll)
/*     */   {
/* 227 */     oldAll = all;
/* 228 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\drawandguess\confbean\SDrawAndGuessJifenRewardCfg.class
