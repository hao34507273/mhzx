...
/*     */ 
/*     */ public class SLibid2JifenRewardsCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SLibid2JifenRewardsCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SLibid2JifenRewardsCfg> all = null;
/*     */   
/*     */   public int libId;
/*  19 */   public TreeMap<Integer, Integer> jifen2Award = new TreeMap();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.libId = Integer.valueOf(rootElement.attributeValue("libId")).intValue();
/*     */     
/*  25 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "jifen2Award");
...
/*     */         }
/*     */         
/*  76 */         this.jifen2Award.put(Integer.valueOf(_k_), Integer.valueOf(_v_));
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*     */   {
/*  83 */     _os_.marshal(this.libId);
/*  84 */     _os_.compact_uint32(this.jifen2Award.size());
/*  85 */     for (java.util.Map.Entry<Integer, Integer> _e_ : this.jifen2Award.entrySet())
/*     */     {
...
/*     */   {
/*  95 */     this.libId = _os_.unmarshal_int();
...
/* 102 */       this.jifen2Award.put(Integer.valueOf(_k_), Integer.valueOf(_v_));
/*     */     }
/* 104 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/* 109 */     String path = dir + "mzm.gsp.drawandguess.confbean.SLibid2JifenRewardsCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 122 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.drawandguess.confbean.SLibid2JifenRewardsCfg"))
/*     */         {
/*     */ 
/* 125 */           SLibid2JifenRewardsCfg obj = new SLibid2JifenRewardsCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SLibid2JifenRewardsCfg> all)
/*     */   {
/* 139 */     String path = dir + "mzm.gsp.drawandguess.confbean.SLibid2JifenRewardsCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 151 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.drawandguess.confbean.SLibid2JifenRewardsCfg"))
/*     */         {
/*     */ 
/* 154 */           SLibid2JifenRewardsCfg obj = new SLibid2JifenRewardsCfg();
/* 155 */           obj.loadFromXml(elem);
/* 156 */           if (all.put(Integer.valueOf(obj.libId), obj) != null) {
/* 157 */             throw new RuntimeException("duplicate key : " + obj.libId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 170 */     String path = dir + "mzm.gsp.drawandguess.confbean.SLibid2JifenRewardsCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 197 */           SLibid2JifenRewardsCfg _v_ = new SLibid2JifenRewardsCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SLibid2JifenRewardsCfg> all)
/*     */   {
/* 217 */     String path = dir + "mzm.gsp.drawandguess.confbean.SLibid2JifenRewardsCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 244 */           SLibid2JifenRewardsCfg _v_ = new SLibid2JifenRewardsCfg();
...
/*     */ 
/*     */ 
/*     */   public static SLibid2JifenRewardsCfg getOld(int key)
/*     */   {
/* 265 */     return (SLibid2JifenRewardsCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SLibid2JifenRewardsCfg get(int key)
/*     */   {
/* 270 */     return (SLibid2JifenRewardsCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SLibid2JifenRewardsCfg> getOldAll()
/*     */   {
/* 275 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SLibid2JifenRewardsCfg> getAll()
/*     */   {
/* 280 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SLibid2JifenRewardsCfg> newAll)
/*     */   {
/* 285 */     oldAll = all;
/* 286 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\drawandguess\confbean\SLibid2JifenRewardsCfg.class
