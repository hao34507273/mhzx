...
/*     */ 
/*     */ public class SDrawAndGuessQuestionCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SDrawAndGuessQuestionCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SDrawAndGuessQuestionCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public int libId;
...
/*  25 */     this.libId = Integer.valueOf(rootElement.attributeValue("libId")).intValue();
/*  26 */     this.answer = rootElement.attributeValue("answer");
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  31 */     _os_.marshal(this.id);
/*  32 */     _os_.marshal(this.libId);
/*  33 */     _os_.marshal(this.answer, "UTF-8");
/*  34 */     return _os_;
/*     */   }
/*     */   
...
/*  40 */     this.libId = _os_.unmarshal_int();
/*  41 */     this.answer = _os_.unmarshal_String("UTF-8");
/*  42 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  47 */     String path = dir + "mzm.gsp.drawandguess.confbean.SDrawAndGuessQuestionCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  60 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.drawandguess.confbean.SDrawAndGuessQuestionCfg"))
/*     */         {
/*     */ 
/*  63 */           SDrawAndGuessQuestionCfg obj = new SDrawAndGuessQuestionCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SDrawAndGuessQuestionCfg> all)
/*     */   {
/*  77 */     String path = dir + "mzm.gsp.drawandguess.confbean.SDrawAndGuessQuestionCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  89 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.drawandguess.confbean.SDrawAndGuessQuestionCfg"))
/*     */         {
/*     */ 
/*  92 */           SDrawAndGuessQuestionCfg obj = new SDrawAndGuessQuestionCfg();
...
/*     */     
/* 108 */     String path = dir + "mzm.gsp.drawandguess.confbean.SDrawAndGuessQuestionCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 135 */           SDrawAndGuessQuestionCfg _v_ = new SDrawAndGuessQuestionCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SDrawAndGuessQuestionCfg> all)
/*     */   {
/* 155 */     String path = dir + "mzm.gsp.drawandguess.confbean.SDrawAndGuessQuestionCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 182 */           SDrawAndGuessQuestionCfg _v_ = new SDrawAndGuessQuestionCfg();
...
/*     */ 
/*     */ 
/*     */   public static SDrawAndGuessQuestionCfg getOld(int key)
/*     */   {
/* 203 */     return (SDrawAndGuessQuestionCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SDrawAndGuessQuestionCfg get(int key)
/*     */   {
/* 208 */     return (SDrawAndGuessQuestionCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SDrawAndGuessQuestionCfg> getOldAll()
/*     */   {
/* 213 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SDrawAndGuessQuestionCfg> getAll()
/*     */   {
/* 218 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SDrawAndGuessQuestionCfg> newAll)
/*     */   {
/* 223 */     oldAll = all;
/* 224 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\drawandguess\confbean\SDrawAndGuessQuestionCfg.class
