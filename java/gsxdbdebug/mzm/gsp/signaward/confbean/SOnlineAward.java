...
/*     */ 
/*     */ public class SOnlineAward implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SOnlineAward> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SOnlineAward> all = null;
/*     */   
/*     */   public int time;
/*     */   public int id;
...
/*     */   {
/*  24 */     this.time = Integer.valueOf(rootElement.attributeValue("time")).intValue();
...
/*     */   {
/*  72 */     this.time = _os_.unmarshal_int();
...
/*     */   {
/*  86 */     String path = dir + "mzm.gsp.signaward.confbean.SOnlineAward.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  99 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.signaward.confbean.SOnlineAward"))
/*     */         {
/*     */ 
/* 102 */           SOnlineAward obj = new SOnlineAward();
/* 103 */           obj.loadFromXml(elem);
/* 104 */           if (all.put(Integer.valueOf(obj.time), obj) != null) {
/* 105 */             throw new RuntimeException("duplicate key : " + obj.time);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SOnlineAward> all)
/*     */   {
/* 116 */     String path = dir + "mzm.gsp.signaward.confbean.SOnlineAward.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 128 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.signaward.confbean.SOnlineAward"))
/*     */         {
/*     */ 
/* 131 */           SOnlineAward obj = new SOnlineAward();
/* 132 */           obj.loadFromXml(elem);
/* 133 */           if (all.put(Integer.valueOf(obj.time), obj) != null) {
/* 134 */             throw new RuntimeException("duplicate key : " + obj.time);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 147 */     String path = dir + "mzm.gsp.signaward.confbean.SOnlineAward.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 174 */           SOnlineAward _v_ = new SOnlineAward();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SOnlineAward> all)
/*     */   {
/* 194 */     String path = dir + "mzm.gsp.signaward.confbean.SOnlineAward.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 221 */           SOnlineAward _v_ = new SOnlineAward();
...
/*     */ 
/*     */ 
/*     */   public static SOnlineAward getOld(int key)
/*     */   {
/* 242 */     return (SOnlineAward)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SOnlineAward get(int key)
/*     */   {
/* 247 */     return (SOnlineAward)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SOnlineAward> getOldAll()
/*     */   {
/* 252 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SOnlineAward> getAll()
/*     */   {
/* 257 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SOnlineAward> newAll)
/*     */   {
/* 262 */     oldAll = all;
/* 263 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\signaward\confbean\SOnlineAward.class
