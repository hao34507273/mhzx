...
/*     */ 
/*     */ public class SGiftBagAward implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SGiftBagAward> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SGiftBagAward> all = null;
/*     */   
/*     */   public int id;
/*     */   public int gifttype;
/*     */   public int sort;
...
/*  25 */     this.gifttype = Integer.valueOf(rootElement.attributeValue("gifttype")).intValue();
/*  26 */     this.sort = Integer.valueOf(rootElement.attributeValue("sort")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  31 */     _os_.marshal(this.id);
/*  32 */     _os_.marshal(this.gifttype);
/*  33 */     _os_.marshal(this.sort);
/*  34 */     return _os_;
/*     */   }
/*     */   
...
/*  40 */     this.gifttype = _os_.unmarshal_int();
/*  41 */     this.sort = _os_.unmarshal_int();
/*  42 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  47 */     String path = dir + "mzm.gsp.signaward.confbean.SGiftBagAward.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  60 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.signaward.confbean.SGiftBagAward"))
/*     */         {
/*     */ 
/*  63 */           SGiftBagAward obj = new SGiftBagAward();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SGiftBagAward> all)
/*     */   {
/*  77 */     String path = dir + "mzm.gsp.signaward.confbean.SGiftBagAward.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  89 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.signaward.confbean.SGiftBagAward"))
/*     */         {
/*     */ 
/*  92 */           SGiftBagAward obj = new SGiftBagAward();
...
/*     */     
/* 108 */     String path = dir + "mzm.gsp.signaward.confbean.SGiftBagAward.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 135 */           SGiftBagAward _v_ = new SGiftBagAward();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SGiftBagAward> all)
/*     */   {
/* 155 */     String path = dir + "mzm.gsp.signaward.confbean.SGiftBagAward.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 182 */           SGiftBagAward _v_ = new SGiftBagAward();
...
/*     */ 
/*     */ 
/*     */   public static SGiftBagAward getOld(int key)
/*     */   {
/* 203 */     return (SGiftBagAward)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SGiftBagAward get(int key)
/*     */   {
/* 208 */     return (SGiftBagAward)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SGiftBagAward> getOldAll()
/*     */   {
/* 213 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SGiftBagAward> getAll()
/*     */   {
/* 218 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SGiftBagAward> newAll)
/*     */   {
/* 223 */     oldAll = all;
/* 224 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\signaward\confbean\SGiftBagAward.class
