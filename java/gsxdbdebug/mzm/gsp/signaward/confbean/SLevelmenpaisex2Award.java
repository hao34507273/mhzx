...
/*     */ 
/*     */ public class SLevelmenpaisex2Award implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SLevelmenpaisex2Award> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SLevelmenpaisex2Award> all = null;
/*     */   
/*     */   public int lms;
/*     */   public int id;
/*  20 */   public java.util.ArrayList<ItemId2Count> itemIdCountList = new java.util.ArrayList();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  24 */     this.lms = Integer.valueOf(rootElement.attributeValue("lms")).intValue();
/*  25 */     this.id = Integer.valueOf(rootElement.attributeValue("id")).intValue();
/*     */     
/*  27 */     Element collectionElement = util.XmlHelper.getVariableElement(rootElement, "itemIdCountList");
...
/*  38 */       if (elem.getName().equalsIgnoreCase("mzm.gsp.signaward.confbean.ItemId2Count"))
/*     */       {
/*     */         ItemId2Count _v_;
/*     */         
/*     */ 
...
/*     */         }
/*     */         
/*  53 */         this.itemIdCountList.add(_v_);
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*     */   {
/*  60 */     _os_.marshal(this.lms);
/*  61 */     _os_.marshal(this.id);
/*  62 */     _os_.compact_uint32(this.itemIdCountList.size());
/*  63 */     for (ItemId2Count _v_ : this.itemIdCountList)
/*     */     {
/*  65 */       _os_.marshal(_v_);
/*     */     }
/*  67 */     return _os_;
...
/*     */   {
/*  72 */     this.lms = _os_.unmarshal_int();
/*  73 */     this.id = _os_.unmarshal_int();
/*  74 */     for (int _size_ = _os_.uncompact_uint32(); _size_ > 0; _size_--)
/*     */     {
/*     */ 
/*  77 */       ItemId2Count _v_ = new ItemId2Count();
/*  78 */       _v_.unmarshal(_os_);
/*  79 */       this.itemIdCountList.add(_v_);
/*     */     }
/*  81 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/*  86 */     String path = dir + "mzm.gsp.signaward.confbean.SLevelmenpaisex2Award.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  99 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.signaward.confbean.SLevelmenpaisex2Award"))
/*     */         {
/*     */ 
/* 102 */           SLevelmenpaisex2Award obj = new SLevelmenpaisex2Award();
/* 103 */           obj.loadFromXml(elem);
/* 104 */           if (all.put(Integer.valueOf(obj.lms), obj) != null) {
/* 105 */             throw new RuntimeException("duplicate key : " + obj.lms);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SLevelmenpaisex2Award> all)
/*     */   {
/* 116 */     String path = dir + "mzm.gsp.signaward.confbean.SLevelmenpaisex2Award.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 128 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.signaward.confbean.SLevelmenpaisex2Award"))
/*     */         {
/*     */ 
/* 131 */           SLevelmenpaisex2Award obj = new SLevelmenpaisex2Award();
/* 132 */           obj.loadFromXml(elem);
/* 133 */           if (all.put(Integer.valueOf(obj.lms), obj) != null) {
/* 134 */             throw new RuntimeException("duplicate key : " + obj.lms);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 147 */     String path = dir + "mzm.gsp.signaward.confbean.SLevelmenpaisex2Award.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 174 */           SLevelmenpaisex2Award _v_ = new SLevelmenpaisex2Award();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SLevelmenpaisex2Award> all)
/*     */   {
/* 194 */     String path = dir + "mzm.gsp.signaward.confbean.SLevelmenpaisex2Award.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 221 */           SLevelmenpaisex2Award _v_ = new SLevelmenpaisex2Award();
...
/*     */ 
/*     */ 
/*     */   public static SLevelmenpaisex2Award getOld(int key)
/*     */   {
/* 242 */     return (SLevelmenpaisex2Award)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SLevelmenpaisex2Award get(int key)
/*     */   {
/* 247 */     return (SLevelmenpaisex2Award)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SLevelmenpaisex2Award> getOldAll()
/*     */   {
/* 252 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SLevelmenpaisex2Award> getAll()
/*     */   {
/* 257 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SLevelmenpaisex2Award> newAll)
/*     */   {
/* 262 */     oldAll = all;
/* 263 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\signaward\confbean\SLevelmenpaisex2Award.class
