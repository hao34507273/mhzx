...
/*     */ 
/*     */ public class Date2SignAward implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, Date2SignAward> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, Date2SignAward> all = null;
/*     */   
/*     */   public int ymd;
/*     */   public int id;
/*     */   public int itemid;
...
/*     */   {
/*  25 */     this.ymd = Integer.valueOf(rootElement.attributeValue("ymd")).intValue();
...
/*     */   {
/*  42 */     this.ymd = _os_.unmarshal_int();
...
/*     */   {
/*  51 */     String path = dir + "mzm.gsp.signaward.confbean.Date2SignAward.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  64 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.signaward.confbean.Date2SignAward"))
/*     */         {
/*     */ 
/*  67 */           Date2SignAward obj = new Date2SignAward();
/*  68 */           obj.loadFromXml(elem);
/*  69 */           if (all.put(Integer.valueOf(obj.ymd), obj) != null) {
/*  70 */             throw new RuntimeException("duplicate key : " + obj.ymd);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, Date2SignAward> all)
/*     */   {
/*  81 */     String path = dir + "mzm.gsp.signaward.confbean.Date2SignAward.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.signaward.confbean.Date2SignAward"))
/*     */         {
/*     */ 
/*  96 */           Date2SignAward obj = new Date2SignAward();
/*  97 */           obj.loadFromXml(elem);
/*  98 */           if (all.put(Integer.valueOf(obj.ymd), obj) != null) {
/*  99 */             throw new RuntimeException("duplicate key : " + obj.ymd);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 112 */     String path = dir + "mzm.gsp.signaward.confbean.Date2SignAward.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 139 */           Date2SignAward _v_ = new Date2SignAward();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, Date2SignAward> all)
/*     */   {
/* 159 */     String path = dir + "mzm.gsp.signaward.confbean.Date2SignAward.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 186 */           Date2SignAward _v_ = new Date2SignAward();
...
/*     */ 
/*     */ 
/*     */   public static Date2SignAward getOld(int key)
/*     */   {
/* 207 */     return (Date2SignAward)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Date2SignAward get(int key)
/*     */   {
/* 212 */     return (Date2SignAward)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, Date2SignAward> getOldAll()
/*     */   {
/* 217 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, Date2SignAward> getAll()
/*     */   {
/* 222 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, Date2SignAward> newAll)
/*     */   {
/* 227 */     oldAll = all;
/* 228 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\signaward\confbean\Date2SignAward.class
