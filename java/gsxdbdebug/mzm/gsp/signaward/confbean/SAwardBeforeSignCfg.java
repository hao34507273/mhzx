...
/*     */ 
/*     */ public class SAwardBeforeSignCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SAwardBeforeSignCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SAwardBeforeSignCfg> all = null;
/*     */   
/*     */   public int day;
/*     */   public int id;
/*     */   public int rewardid;
...
/*     */   {
/*  24 */     this.day = Integer.valueOf(rootElement.attributeValue("day")).intValue();
...
/*     */   {
/*  39 */     this.day = _os_.unmarshal_int();
...
/*     */   {
/*  47 */     String path = dir + "mzm.gsp.signaward.confbean.SAwardBeforeSignCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  60 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.signaward.confbean.SAwardBeforeSignCfg"))
/*     */         {
/*     */ 
/*  63 */           SAwardBeforeSignCfg obj = new SAwardBeforeSignCfg();
/*  64 */           obj.loadFromXml(elem);
/*  65 */           if (all.put(Integer.valueOf(obj.day), obj) != null) {
/*  66 */             throw new RuntimeException("duplicate key : " + obj.day);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SAwardBeforeSignCfg> all)
/*     */   {
/*  77 */     String path = dir + "mzm.gsp.signaward.confbean.SAwardBeforeSignCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  89 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.signaward.confbean.SAwardBeforeSignCfg"))
/*     */         {
/*     */ 
/*  92 */           SAwardBeforeSignCfg obj = new SAwardBeforeSignCfg();
/*  93 */           obj.loadFromXml(elem);
/*  94 */           if (all.put(Integer.valueOf(obj.day), obj) != null) {
/*  95 */             throw new RuntimeException("duplicate key : " + obj.day);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 108 */     String path = dir + "mzm.gsp.signaward.confbean.SAwardBeforeSignCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 135 */           SAwardBeforeSignCfg _v_ = new SAwardBeforeSignCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SAwardBeforeSignCfg> all)
/*     */   {
/* 155 */     String path = dir + "mzm.gsp.signaward.confbean.SAwardBeforeSignCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 182 */           SAwardBeforeSignCfg _v_ = new SAwardBeforeSignCfg();
...
/*     */ 
/*     */ 
/*     */   public static SAwardBeforeSignCfg getOld(int key)
/*     */   {
/* 203 */     return (SAwardBeforeSignCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SAwardBeforeSignCfg get(int key)
/*     */   {
/* 208 */     return (SAwardBeforeSignCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SAwardBeforeSignCfg> getOldAll()
/*     */   {
/* 213 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SAwardBeforeSignCfg> getAll()
/*     */   {
/* 218 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SAwardBeforeSignCfg> newAll)
/*     */   {
/* 223 */     oldAll = all;
/* 224 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\signaward\confbean\SAwardBeforeSignCfg.class
