...
/*     */ 
/*     */ public class SLoginAward implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SLoginAward> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SLoginAward> all = null;
/*     */   
...
/*     */   {
/*  24 */     this.logincount = Integer.valueOf(rootElement.attributeValue("logincount")).intValue();
...
/*     */   {
/*  60 */     _os_.marshal(this.logincount);
...
/*     */   {
/*  72 */     this.logincount = _os_.unmarshal_int();
...
/*     */   {
/*  86 */     String path = dir + "mzm.gsp.signaward.confbean.SLoginAward.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  99 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.signaward.confbean.SLoginAward"))
/*     */         {
/*     */ 
/* 102 */           SLoginAward obj = new SLoginAward();
/* 103 */           obj.loadFromXml(elem);
/* 104 */           if (all.put(Integer.valueOf(obj.logincount), obj) != null) {
/* 105 */             throw new RuntimeException("duplicate key : " + obj.logincount);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SLoginAward> all)
/*     */   {
/* 116 */     String path = dir + "mzm.gsp.signaward.confbean.SLoginAward.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 128 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.signaward.confbean.SLoginAward"))
/*     */         {
/*     */ 
/* 131 */           SLoginAward obj = new SLoginAward();
/* 132 */           obj.loadFromXml(elem);
/* 133 */           if (all.put(Integer.valueOf(obj.logincount), obj) != null) {
/* 134 */             throw new RuntimeException("duplicate key : " + obj.logincount);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 147 */     String path = dir + "mzm.gsp.signaward.confbean.SLoginAward.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 174 */           SLoginAward _v_ = new SLoginAward();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SLoginAward> all)
/*     */   {
/* 194 */     String path = dir + "mzm.gsp.signaward.confbean.SLoginAward.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 221 */           SLoginAward _v_ = new SLoginAward();
...
/*     */ 
/*     */ 
/*     */   public static SLoginAward getOld(int key)
/*     */   {
/* 242 */     return (SLoginAward)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SLoginAward get(int key)
/*     */   {
/* 247 */     return (SLoginAward)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SLoginAward> getOldAll()
/*     */   {
/* 252 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SLoginAward> getAll()
/*     */   {
/* 257 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SLoginAward> newAll)
/*     */   {
/* 262 */     oldAll = all;
/* 263 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\signaward\confbean\SLoginAward.class
