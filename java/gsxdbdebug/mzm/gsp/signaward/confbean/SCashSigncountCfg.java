...
/*     */ 
/*     */ public class SCashSigncountCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SCashSigncountCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SCashSigncountCfg> all = null;
/*     */   
...
/*     */   {
/*  24 */     this.yuanbaonum = Integer.valueOf(rootElement.attributeValue("yuanbaonum")).intValue();
/*  25 */     this.id = Integer.valueOf(rootElement.attributeValue("id")).intValue();
/*  26 */     this.signcount = Integer.valueOf(rootElement.attributeValue("signcount")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  31 */     _os_.marshal(this.yuanbaonum);
/*  32 */     _os_.marshal(this.id);
/*  33 */     _os_.marshal(this.signcount);
/*  34 */     return _os_;
/*     */   }
/*     */   
/*     */   public OctetsStream unmarshal(OctetsStream _os_) throws com.goldhuman.Common.Marshal.MarshalException
/*     */   {
/*  39 */     this.yuanbaonum = _os_.unmarshal_int();
/*  40 */     this.id = _os_.unmarshal_int();
/*  41 */     this.signcount = _os_.unmarshal_int();
/*  42 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  47 */     String path = dir + "mzm.gsp.signaward.confbean.SCashSigncountCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  60 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.signaward.confbean.SCashSigncountCfg"))
/*     */         {
/*     */ 
/*  63 */           SCashSigncountCfg obj = new SCashSigncountCfg();
/*  64 */           obj.loadFromXml(elem);
/*  65 */           if (all.put(Integer.valueOf(obj.yuanbaonum), obj) != null) {
/*  66 */             throw new RuntimeException("duplicate key : " + obj.yuanbaonum);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SCashSigncountCfg> all)
/*     */   {
/*  77 */     String path = dir + "mzm.gsp.signaward.confbean.SCashSigncountCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  89 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.signaward.confbean.SCashSigncountCfg"))
/*     */         {
/*     */ 
/*  92 */           SCashSigncountCfg obj = new SCashSigncountCfg();
/*  93 */           obj.loadFromXml(elem);
/*  94 */           if (all.put(Integer.valueOf(obj.yuanbaonum), obj) != null) {
/*  95 */             throw new RuntimeException("duplicate key : " + obj.yuanbaonum);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 108 */     String path = dir + "mzm.gsp.signaward.confbean.SCashSigncountCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 135 */           SCashSigncountCfg _v_ = new SCashSigncountCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SCashSigncountCfg> all)
/*     */   {
/* 155 */     String path = dir + "mzm.gsp.signaward.confbean.SCashSigncountCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 182 */           SCashSigncountCfg _v_ = new SCashSigncountCfg();
...
/*     */ 
/*     */ 
/*     */   public static SCashSigncountCfg getOld(int key)
/*     */   {
/* 203 */     return (SCashSigncountCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SCashSigncountCfg get(int key)
/*     */   {
/* 208 */     return (SCashSigncountCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SCashSigncountCfg> getOldAll()
/*     */   {
/* 213 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SCashSigncountCfg> getAll()
/*     */   {
/* 218 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SCashSigncountCfg> newAll)
/*     */   {
/* 223 */     oldAll = all;
/* 224 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\signaward\confbean\SCashSigncountCfg.class
