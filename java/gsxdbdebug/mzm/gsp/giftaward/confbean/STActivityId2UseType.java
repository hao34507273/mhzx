...
/*     */ 
/*     */ public class STActivityId2UseType implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, STActivityId2UseType> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, STActivityId2UseType> all = null;
/*     */   
...
/*  24 */     this.useType = Integer.valueOf(rootElement.attributeValue("useType")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  29 */     _os_.marshal(this.activityId);
/*  30 */     _os_.marshal(this.useType);
/*  31 */     return _os_;
/*     */   }
/*     */   
...
/*  37 */     this.useType = _os_.unmarshal_int();
/*  38 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.giftaward.confbean.STActivityId2UseType.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.giftaward.confbean.STActivityId2UseType"))
/*     */         {
/*     */ 
/*  59 */           STActivityId2UseType obj = new STActivityId2UseType();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, STActivityId2UseType> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.giftaward.confbean.STActivityId2UseType.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.giftaward.confbean.STActivityId2UseType"))
/*     */         {
/*     */ 
/*  88 */           STActivityId2UseType obj = new STActivityId2UseType();
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.giftaward.confbean.STActivityId2UseType.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           STActivityId2UseType _v_ = new STActivityId2UseType();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, STActivityId2UseType> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.giftaward.confbean.STActivityId2UseType.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           STActivityId2UseType _v_ = new STActivityId2UseType();
...
/*     */ 
/*     */ 
/*     */   public static STActivityId2UseType getOld(int key)
/*     */   {
/* 199 */     return (STActivityId2UseType)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static STActivityId2UseType get(int key)
/*     */   {
/* 204 */     return (STActivityId2UseType)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, STActivityId2UseType> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, STActivityId2UseType> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, STActivityId2UseType> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\giftaward\confbean\STActivityId2UseType.class
