...
/*     */ 
/*     */ public class SNewClientBagGiftCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SNewClientBagGiftCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SNewClientBagGiftCfg> all = null;
/*     */   
/*     */   public int id;
...
/*  24 */     this.awardMailId = Integer.valueOf(rootElement.attributeValue("awardMailId")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  29 */     _os_.marshal(this.id);
/*  30 */     _os_.marshal(this.awardMailId);
/*  31 */     return _os_;
/*     */   }
/*     */   
...
/*  37 */     this.awardMailId = _os_.unmarshal_int();
/*  38 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.giftaward.confbean.SNewClientBagGiftCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.giftaward.confbean.SNewClientBagGiftCfg"))
/*     */         {
/*     */ 
/*  59 */           SNewClientBagGiftCfg obj = new SNewClientBagGiftCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SNewClientBagGiftCfg> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.giftaward.confbean.SNewClientBagGiftCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.giftaward.confbean.SNewClientBagGiftCfg"))
/*     */         {
/*     */ 
/*  88 */           SNewClientBagGiftCfg obj = new SNewClientBagGiftCfg();
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.giftaward.confbean.SNewClientBagGiftCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           SNewClientBagGiftCfg _v_ = new SNewClientBagGiftCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SNewClientBagGiftCfg> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.giftaward.confbean.SNewClientBagGiftCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           SNewClientBagGiftCfg _v_ = new SNewClientBagGiftCfg();
...
/*     */ 
/*     */ 
/*     */   public static SNewClientBagGiftCfg getOld(int key)
/*     */   {
/* 199 */     return (SNewClientBagGiftCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SNewClientBagGiftCfg get(int key)
/*     */   {
/* 204 */     return (SNewClientBagGiftCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SNewClientBagGiftCfg> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SNewClientBagGiftCfg> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SNewClientBagGiftCfg> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\giftaward\confbean\SNewClientBagGiftCfg.class
