/*     */ package mzm.gsp.music.confbean;
/*     */ 
...
/*     */ 
/*     */ public class STaskVoiceCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, STaskVoiceCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, STaskVoiceCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public String templatename;
/*     */   public int taskVoiceId;
/*     */   public int voiceId;
...
/*  28 */     this.taskVoiceId = Integer.valueOf(rootElement.attributeValue("taskVoiceId")).intValue();
/*  29 */     this.voiceId = Integer.valueOf(rootElement.attributeValue("voiceId")).intValue();
/*  30 */     this.voiceDes = rootElement.attributeValue("voiceDes");
/*     */   }
/*     */   
...
/*  37 */     _os_.marshal(this.taskVoiceId);
/*  38 */     _os_.marshal(this.voiceId);
/*  39 */     _os_.marshal(this.voiceDes, "UTF-8");
/*  40 */     return _os_;
/*     */   }
/*     */   
...
/*  47 */     this.taskVoiceId = _os_.unmarshal_int();
/*  48 */     this.voiceId = _os_.unmarshal_int();
/*  49 */     this.voiceDes = _os_.unmarshal_String("UTF-8");
/*  50 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  55 */     String path = dir + "mzm.gsp.music.confbean.STaskVoiceCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  68 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.music.confbean.STaskVoiceCfg"))
/*     */         {
/*     */ 
/*  71 */           STaskVoiceCfg obj = new STaskVoiceCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, STaskVoiceCfg> all)
/*     */   {
/*  85 */     String path = dir + "mzm.gsp.music.confbean.STaskVoiceCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  97 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.music.confbean.STaskVoiceCfg"))
/*     */         {
/*     */ 
/* 100 */           STaskVoiceCfg obj = new STaskVoiceCfg();
...
/*     */     
/* 116 */     String path = dir + "mzm.gsp.music.confbean.STaskVoiceCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 143 */           STaskVoiceCfg _v_ = new STaskVoiceCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, STaskVoiceCfg> all)
/*     */   {
/* 163 */     String path = dir + "mzm.gsp.music.confbean.STaskVoiceCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 190 */           STaskVoiceCfg _v_ = new STaskVoiceCfg();
...
/*     */ 
/*     */ 
/*     */   public static STaskVoiceCfg getOld(int key)
/*     */   {
/* 211 */     return (STaskVoiceCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static STaskVoiceCfg get(int key)
/*     */   {
/* 216 */     return (STaskVoiceCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, STaskVoiceCfg> getOldAll()
/*     */   {
/* 221 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, STaskVoiceCfg> getAll()
/*     */   {
/* 226 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, STaskVoiceCfg> newAll)
/*     */   {
/* 231 */     oldAll = all;
/* 232 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\music\confbean\STaskVoiceCfg.class
