...
/*     */ 
/*     */ public class SMusicCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SMusicCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SMusicCfg> all = null;
/*     */   
/*     */   public int id;
...
/*  26 */     this.musicFilePath = rootElement.attributeValue("musicFilePath");
/*     */   }
/*     */   
...
/*  33 */     _os_.marshal(this.musicFilePath, "UTF-8");
/*  34 */     return _os_;
/*     */   }
/*     */   
...
/*  41 */     this.musicFilePath = _os_.unmarshal_String("UTF-8");
/*  42 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  47 */     String path = dir + "mzm.gsp.music.confbean.SMusicCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  60 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.music.confbean.SMusicCfg"))
/*     */         {
/*     */ 
/*  63 */           SMusicCfg obj = new SMusicCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SMusicCfg> all)
/*     */   {
/*  77 */     String path = dir + "mzm.gsp.music.confbean.SMusicCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  89 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.music.confbean.SMusicCfg"))
/*     */         {
/*     */ 
/*  92 */           SMusicCfg obj = new SMusicCfg();
...
/*     */     
/* 108 */     String path = dir + "mzm.gsp.music.confbean.SMusicCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 135 */           SMusicCfg _v_ = new SMusicCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SMusicCfg> all)
/*     */   {
/* 155 */     String path = dir + "mzm.gsp.music.confbean.SMusicCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 182 */           SMusicCfg _v_ = new SMusicCfg();
...
/*     */ 
/*     */ 
/*     */   public static SMusicCfg getOld(int key)
/*     */   {
/* 203 */     return (SMusicCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SMusicCfg get(int key)
/*     */   {
/* 208 */     return (SMusicCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMusicCfg> getOldAll()
/*     */   {
/* 213 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMusicCfg> getAll()
/*     */   {
/* 218 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SMusicCfg> newAll)
/*     */   {
/* 223 */     oldAll = all;
/* 224 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\music\confbean\SMusicCfg.class
