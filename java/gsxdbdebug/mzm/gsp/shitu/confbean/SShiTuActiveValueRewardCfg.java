...
/*     */ 
/*     */ public class SShiTuActiveValueRewardCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SShiTuActiveValueRewardCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SShiTuActiveValueRewardCfg> all = null;
/*     */   
/*     */   public int award_type_id;
/*  19 */   public TreeMap<Integer, SShiTuActiveAwardIndex2RewardCfg> role_level2CfgMap = new TreeMap();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.award_type_id = Integer.valueOf(rootElement.attributeValue("award_type_id")).intValue();
/*     */     
/*  25 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "role_level2CfgMap");
...
/*  51 */             keyElem = elem;
/*     */           }
/*  53 */           else if ((valueElem == null) && (elem.getName().equalsIgnoreCase("mzm.gsp.shitu.confbean.SShiTuActiveAwardIndex2RewardCfg")))
/*     */           {
/*  55 */             valueElem = elem;
/*     */           }
/*     */         }
...
/*     */         
/*     */         int _k_;
/*     */         SShiTuActiveAwardIndex2RewardCfg _v_;
/*     */         try
/*     */         {
/*  68 */           _k_ = Integer.valueOf(keyElem.getText()).intValue();
/*  69 */           _v_ = new SShiTuActiveAwardIndex2RewardCfg();
...
/*     */         }
/*     */         
/*  77 */         this.role_level2CfgMap.put(Integer.valueOf(_k_), _v_);
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*     */   {
/*  84 */     _os_.marshal(this.award_type_id);
/*  85 */     _os_.compact_uint32(this.role_level2CfgMap.size());
/*  86 */     for (java.util.Map.Entry<Integer, SShiTuActiveAwardIndex2RewardCfg> _e_ : this.role_level2CfgMap.entrySet())
/*     */     {
...
/*     */   {
/*  96 */     this.award_type_id = _os_.unmarshal_int();
/*  97 */     for (int _size_ = _os_.uncompact_uint32(); _size_ > 0; _size_--)
/*     */     {
/*     */ 
/* 100 */       int _k_ = _os_.unmarshal_int();
/*     */       
/* 102 */       SShiTuActiveAwardIndex2RewardCfg _v_ = new SShiTuActiveAwardIndex2RewardCfg();
/* 103 */       _v_.unmarshal(_os_);
/* 104 */       this.role_level2CfgMap.put(Integer.valueOf(_k_), _v_);
/*     */     }
/* 106 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/* 111 */     String path = dir + "mzm.gsp.shitu.confbean.SShiTuActiveValueRewardCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 124 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.shitu.confbean.SShiTuActiveValueRewardCfg"))
/*     */         {
/*     */ 
/* 127 */           SShiTuActiveValueRewardCfg obj = new SShiTuActiveValueRewardCfg();
/* 128 */           obj.loadFromXml(elem);
/* 129 */           if (all.put(Integer.valueOf(obj.award_type_id), obj) != null) {
/* 130 */             throw new RuntimeException("duplicate key : " + obj.award_type_id);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SShiTuActiveValueRewardCfg> all)
/*     */   {
/* 141 */     String path = dir + "mzm.gsp.shitu.confbean.SShiTuActiveValueRewardCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 153 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.shitu.confbean.SShiTuActiveValueRewardCfg"))
/*     */         {
/*     */ 
/* 156 */           SShiTuActiveValueRewardCfg obj = new SShiTuActiveValueRewardCfg();
/* 157 */           obj.loadFromXml(elem);
/* 158 */           if (all.put(Integer.valueOf(obj.award_type_id), obj) != null) {
/* 159 */             throw new RuntimeException("duplicate key : " + obj.award_type_id);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 172 */     String path = dir + "mzm.gsp.shitu.confbean.SShiTuActiveValueRewardCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 199 */           SShiTuActiveValueRewardCfg _v_ = new SShiTuActiveValueRewardCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SShiTuActiveValueRewardCfg> all)
/*     */   {
/* 219 */     String path = dir + "mzm.gsp.shitu.confbean.SShiTuActiveValueRewardCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 246 */           SShiTuActiveValueRewardCfg _v_ = new SShiTuActiveValueRewardCfg();
...
/*     */ 
/*     */ 
/*     */   public static SShiTuActiveValueRewardCfg getOld(int key)
/*     */   {
/* 267 */     return (SShiTuActiveValueRewardCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SShiTuActiveValueRewardCfg get(int key)
/*     */   {
/* 272 */     return (SShiTuActiveValueRewardCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SShiTuActiveValueRewardCfg> getOldAll()
/*     */   {
/* 277 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SShiTuActiveValueRewardCfg> getAll()
/*     */   {
/* 282 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SShiTuActiveValueRewardCfg> newAll)
/*     */   {
/* 287 */     oldAll = all;
/* 288 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\shitu\confbean\SShiTuActiveValueRewardCfg.class
