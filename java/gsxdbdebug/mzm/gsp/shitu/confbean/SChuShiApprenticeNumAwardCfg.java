...
/*     */ 
/*     */ public class SChuShiApprenticeNumAwardCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SChuShiApprenticeNumAwardCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SChuShiApprenticeNumAwardCfg> all = null;
/*     */   
/*     */   public int cfgId;
/*     */   public int chuShiApprenticeNum;
/*     */   public int awardId;
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  24 */     this.cfgId = Integer.valueOf(rootElement.attributeValue("cfgId")).intValue();
/*  25 */     this.chuShiApprenticeNum = Integer.valueOf(rootElement.attributeValue("chuShiApprenticeNum")).intValue();
...
/*  32 */     _os_.marshal(this.chuShiApprenticeNum);
...
/*     */   {
/*  39 */     this.cfgId = _os_.unmarshal_int();
/*  40 */     this.chuShiApprenticeNum = _os_.unmarshal_int();
...
/*     */   {
/*  47 */     String path = dir + "mzm.gsp.shitu.confbean.SChuShiApprenticeNumAwardCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  60 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.shitu.confbean.SChuShiApprenticeNumAwardCfg"))
/*     */         {
/*     */ 
/*  63 */           SChuShiApprenticeNumAwardCfg obj = new SChuShiApprenticeNumAwardCfg();
/*  64 */           obj.loadFromXml(elem);
/*  65 */           if (all.put(Integer.valueOf(obj.cfgId), obj) != null) {
/*  66 */             throw new RuntimeException("duplicate key : " + obj.cfgId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SChuShiApprenticeNumAwardCfg> all)
/*     */   {
/*  77 */     String path = dir + "mzm.gsp.shitu.confbean.SChuShiApprenticeNumAwardCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  89 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.shitu.confbean.SChuShiApprenticeNumAwardCfg"))
/*     */         {
/*     */ 
/*  92 */           SChuShiApprenticeNumAwardCfg obj = new SChuShiApprenticeNumAwardCfg();
/*  93 */           obj.loadFromXml(elem);
/*  94 */           if (all.put(Integer.valueOf(obj.cfgId), obj) != null) {
/*  95 */             throw new RuntimeException("duplicate key : " + obj.cfgId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 108 */     String path = dir + "mzm.gsp.shitu.confbean.SChuShiApprenticeNumAwardCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 135 */           SChuShiApprenticeNumAwardCfg _v_ = new SChuShiApprenticeNumAwardCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SChuShiApprenticeNumAwardCfg> all)
/*     */   {
/* 155 */     String path = dir + "mzm.gsp.shitu.confbean.SChuShiApprenticeNumAwardCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 182 */           SChuShiApprenticeNumAwardCfg _v_ = new SChuShiApprenticeNumAwardCfg();
...
/*     */ 
/*     */ 
/*     */   public static SChuShiApprenticeNumAwardCfg getOld(int key)
/*     */   {
/* 203 */     return (SChuShiApprenticeNumAwardCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SChuShiApprenticeNumAwardCfg get(int key)
/*     */   {
/* 208 */     return (SChuShiApprenticeNumAwardCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SChuShiApprenticeNumAwardCfg> getOldAll()
/*     */   {
/* 213 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SChuShiApprenticeNumAwardCfg> getAll()
/*     */   {
/* 218 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SChuShiApprenticeNumAwardCfg> newAll)
/*     */   {
/* 223 */     oldAll = all;
/* 224 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\shitu\confbean\SChuShiApprenticeNumAwardCfg.class
