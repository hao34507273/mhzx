...
/*    */ 
/*    */ public class SShiTuActiveAwardIndex2RewardCfg implements com.goldhuman.Common.Marshal.Marshal
/*    */ {
/*  9 */   public HashMap<Integer, SShiTuActiveValueRewardBean> award_indexCfgMap = new HashMap();
/*    */   
/*    */ 
/*    */   public void loadFromXml(Element rootElement)
/*    */   {
/* 14 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "award_indexCfgMap");
...
/* 40 */             keyElem = elem;
/*    */           }
/* 42 */           else if ((valueElem == null) && (elem.getName().equalsIgnoreCase("mzm.gsp.shitu.confbean.SShiTuActiveValueRewardBean")))
/*    */           {
/* 44 */             valueElem = elem;
/*    */           }
/*    */         }
...
/*    */         
/*    */         int _k_;
/*    */         SShiTuActiveValueRewardBean _v_;
/*    */         try
/*    */         {
/* 57 */           _k_ = Integer.valueOf(keyElem.getText()).intValue();
/* 58 */           _v_ = new SShiTuActiveValueRewardBean();
...
/*    */         }
/*    */         
/* 66 */         this.award_indexCfgMap.put(Integer.valueOf(_k_), _v_);
/*    */       }
/*    */     }
/*    */   }
/*    */   
...
/*    */   {
/* 73 */     _os_.compact_uint32(this.award_indexCfgMap.size());
/* 74 */     for (java.util.Map.Entry<Integer, SShiTuActiveValueRewardBean> _e_ : this.award_indexCfgMap.entrySet())
/*    */     {
...
/*    */       
/* 89 */       SShiTuActiveValueRewardBean _v_ = new SShiTuActiveValueRewardBean();
/* 90 */       _v_.unmarshal(_os_);
/* 91 */       this.award_indexCfgMap.put(Integer.valueOf(_k_), _v_);
/*    */     }
/* 93 */     return _os_;
/*    */   }
/*    */ }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\shitu\confbean\SShiTuActiveAwardIndex2RewardCfg.class
