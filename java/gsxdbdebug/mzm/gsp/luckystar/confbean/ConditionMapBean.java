...
/*    */ 
/*    */ public class ConditionMapBean implements com.goldhuman.Common.Marshal.Marshal
/*    */ {
/*  9 */   public HashMap<Integer, ConditionValueBean> conditionValueMap = new HashMap();
/*    */   
/*    */ 
/*    */   public void loadFromXml(Element rootElement)
/*    */   {
/* 14 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "conditionValueMap");
...
/* 40 */             keyElem = elem;
/*    */           }
/* 42 */           else if ((valueElem == null) && (elem.getName().equalsIgnoreCase("mzm.gsp.luckystar.confbean.ConditionValueBean")))
/*    */           {
/* 44 */             valueElem = elem;
/*    */           }
/*    */         }
...
/*    */         
/*    */         int _k_;
/*    */         ConditionValueBean _v_;
/*    */         try
/*    */         {
/* 57 */           _k_ = Integer.valueOf(keyElem.getText()).intValue();
/* 58 */           _v_ = new ConditionValueBean();
...
/*    */         }
/*    */         
/* 66 */         this.conditionValueMap.put(Integer.valueOf(_k_), _v_);
/*    */       }
/*    */     }
/*    */   }
/*    */   
...
/*    */   {
/* 73 */     _os_.compact_uint32(this.conditionValueMap.size());
/* 74 */     for (java.util.Map.Entry<Integer, ConditionValueBean> _e_ : this.conditionValueMap.entrySet())
/*    */     {
...
/*    */       
/* 89 */       ConditionValueBean _v_ = new ConditionValueBean();
/* 90 */       _v_.unmarshal(_os_);
/* 91 */       this.conditionValueMap.put(Integer.valueOf(_k_), _v_);
/*    */     }
/* 93 */     return _os_;
/*    */   }
/*    */ }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\luckystar\confbean\ConditionMapBean.class
