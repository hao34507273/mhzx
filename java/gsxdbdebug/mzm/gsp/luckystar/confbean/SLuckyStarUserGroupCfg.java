...
/*     */ 
/*     */ public class SLuckyStarUserGroupCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SLuckyStarUserGroupCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SLuckyStarUserGroupCfg> all = null;
/*     */   
/*     */   public int activity_cfg_id;
/*  19 */   public TreeMap<Integer, ConditionMapBean> luckyStarUserGroupMap = new TreeMap();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.activity_cfg_id = Integer.valueOf(rootElement.attributeValue("activity_cfg_id")).intValue();
/*     */     
/*  25 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "luckyStarUserGroupMap");
...
/*  51 */             keyElem = elem;
/*     */           }
/*  53 */           else if ((valueElem == null) && (elem.getName().equalsIgnoreCase("mzm.gsp.luckystar.confbean.ConditionMapBean")))
/*     */           {
/*  55 */             valueElem = elem;
/*     */           }
/*     */         }
...
/*     */         
/*     */         int _k_;
/*     */         ConditionMapBean _v_;
/*     */         try
/*     */         {
/*  68 */           _k_ = Integer.valueOf(keyElem.getText()).intValue();
/*  69 */           _v_ = new ConditionMapBean();
...
/*     */         }
/*     */         
/*  77 */         this.luckyStarUserGroupMap.put(Integer.valueOf(_k_), _v_);
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*  85 */     _os_.compact_uint32(this.luckyStarUserGroupMap.size());
/*  86 */     for (java.util.Map.Entry<Integer, ConditionMapBean> _e_ : this.luckyStarUserGroupMap.entrySet())
/*     */     {
...
/*     */       
/* 102 */       ConditionMapBean _v_ = new ConditionMapBean();
/* 103 */       _v_.unmarshal(_os_);
/* 104 */       this.luckyStarUserGroupMap.put(Integer.valueOf(_k_), _v_);
/*     */     }
/* 106 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/* 111 */     String path = dir + "mzm.gsp.luckystar.confbean.SLuckyStarUserGroupCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 124 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.luckystar.confbean.SLuckyStarUserGroupCfg"))
/*     */         {
/*     */ 
/* 127 */           SLuckyStarUserGroupCfg obj = new SLuckyStarUserGroupCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SLuckyStarUserGroupCfg> all)
/*     */   {
/* 141 */     String path = dir + "mzm.gsp.luckystar.confbean.SLuckyStarUserGroupCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 153 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.luckystar.confbean.SLuckyStarUserGroupCfg"))
/*     */         {
/*     */ 
/* 156 */           SLuckyStarUserGroupCfg obj = new SLuckyStarUserGroupCfg();
...
/*     */     
/* 172 */     String path = dir + "mzm.gsp.luckystar.confbean.SLuckyStarUserGroupCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 199 */           SLuckyStarUserGroupCfg _v_ = new SLuckyStarUserGroupCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SLuckyStarUserGroupCfg> all)
/*     */   {
/* 219 */     String path = dir + "mzm.gsp.luckystar.confbean.SLuckyStarUserGroupCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 246 */           SLuckyStarUserGroupCfg _v_ = new SLuckyStarUserGroupCfg();
...
/*     */ 
/*     */ 
/*     */   public static SLuckyStarUserGroupCfg getOld(int key)
/*     */   {
/* 267 */     return (SLuckyStarUserGroupCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SLuckyStarUserGroupCfg get(int key)
/*     */   {
/* 272 */     return (SLuckyStarUserGroupCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SLuckyStarUserGroupCfg> getOldAll()
/*     */   {
/* 277 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SLuckyStarUserGroupCfg> getAll()
/*     */   {
/* 282 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SLuckyStarUserGroupCfg> newAll)
/*     */   {
/* 287 */     oldAll = all;
/* 288 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\luckystar\confbean\SLuckyStarUserGroupCfg.class
