...
/*     */ 
/*     */ public class SLuckyStarConsts
/*     */ {
/*  13 */   private static volatile SLuckyStarConsts oldInstance = null;
/*     */   
/*  15 */   private static SLuckyStarConsts instance = new SLuckyStarConsts();
/*     */   
/*     */   public int GIFT_MAX_NUM;
/*     */   public int LUCKY_STAR_ACTIVITY_CFG_ID;
/*     */   public int LUCKY_STAR_BUY_NEED_ACTIVE_VALUE;
/*     */   
/*     */   public static SLuckyStarConsts getOldInstance()
/*     */   {
/*  23 */     return oldInstance;
/*     */   }
/*     */   
/*     */   public static SLuckyStarConsts getInstance()
/*     */   {
/*  28 */     return instance;
/*     */   }
/*     */   
...
/*     */   {
/*  42 */     String path = dir + "mzm.gsp.luckystar.confbean.SLuckyStarConsts.xml";
/*     */     try
/*     */     {
...
/*     */         }
/*     */       }
/*  62 */       this.GIFT_MAX_NUM = Integer.valueOf(((Element)data.get("GIFT_MAX_NUM")).attributeValue("value")).intValue();
/*  63 */       this.LUCKY_STAR_ACTIVITY_CFG_ID = Integer.valueOf(((Element)data.get("LUCKY_STAR_ACTIVITY_CFG_ID")).attributeValue("value")).intValue();
/*  64 */       this.LUCKY_STAR_BUY_NEED_ACTIVE_VALUE = Integer.valueOf(((Element)data.get("LUCKY_STAR_BUY_NEED_ACTIVE_VALUE")).attributeValue("value")).intValue();
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*  73 */     String path = dir + "mzm.gsp.luckystar.confbean.SLuckyStarConsts.xml";
/*     */     try
/*     */     {
...
/*     */         }
/*     */       }
/*  93 */       this.GIFT_MAX_NUM = Integer.valueOf(((Element)data.get("GIFT_MAX_NUM")).attributeValue("value")).intValue();
/*  94 */       this.LUCKY_STAR_ACTIVITY_CFG_ID = Integer.valueOf(((Element)data.get("LUCKY_STAR_ACTIVITY_CFG_ID")).attributeValue("value")).intValue();
/*  95 */       this.LUCKY_STAR_BUY_NEED_ACTIVE_VALUE = Integer.valueOf(((Element)data.get("LUCKY_STAR_BUY_NEED_ACTIVE_VALUE")).attributeValue("value")).intValue();
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/* 106 */     String path = dir + "mzm.gsp.luckystar.confbean.SLuckyStarConsts.bny";
/*     */     try
/*     */     {
...
/* 121 */         this.GIFT_MAX_NUM = _os_.unmarshal_int();
/* 122 */         this.LUCKY_STAR_ACTIVITY_CFG_ID = _os_.unmarshal_int();
/* 123 */         this.LUCKY_STAR_BUY_NEED_ACTIVE_VALUE = _os_.unmarshal_int();
/*     */       }
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*     */   {
/* 134 */     String path = dir + "mzm.gsp.luckystar.confbean.SLuckyStarConsts.bny";
/*     */     try
/*     */     {
...
/* 149 */         this.GIFT_MAX_NUM = _os_.unmarshal_int();
/* 150 */         this.LUCKY_STAR_ACTIVITY_CFG_ID = _os_.unmarshal_int();
/* 151 */         this.LUCKY_STAR_BUY_NEED_ACTIVE_VALUE = _os_.unmarshal_int();
/*     */       }
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*     */   }
/*     */   
/*     */   public static void setInstance(SLuckyStarConsts newInstance)
/*     */   {
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\luckystar\confbean\SLuckyStarConsts.class
