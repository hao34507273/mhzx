...
/*     */ 
/*     */ public class AxeActivityModuleidCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, AxeActivityModuleidCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, AxeActivityModuleidCfg> all = null;
/*     */   
/*     */   public int moduleid;
...
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.axe.confbean.AxeActivityModuleidCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.axe.confbean.AxeActivityModuleidCfg"))
/*     */         {
/*     */ 
/*  59 */           AxeActivityModuleidCfg obj = new AxeActivityModuleidCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, AxeActivityModuleidCfg> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.axe.confbean.AxeActivityModuleidCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.axe.confbean.AxeActivityModuleidCfg"))
/*     */         {
/*     */ 
/*  88 */           AxeActivityModuleidCfg obj = new AxeActivityModuleidCfg();
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.axe.confbean.AxeActivityModuleidCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           AxeActivityModuleidCfg _v_ = new AxeActivityModuleidCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, AxeActivityModuleidCfg> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.axe.confbean.AxeActivityModuleidCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           AxeActivityModuleidCfg _v_ = new AxeActivityModuleidCfg();
...
/*     */ 
/*     */ 
/*     */   public static AxeActivityModuleidCfg getOld(int key)
/*     */   {
/* 199 */     return (AxeActivityModuleidCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static AxeActivityModuleidCfg get(int key)
/*     */   {
/* 204 */     return (AxeActivityModuleidCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, AxeActivityModuleidCfg> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, AxeActivityModuleidCfg> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, AxeActivityModuleidCfg> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\axe\confbean\AxeActivityModuleidCfg.class
