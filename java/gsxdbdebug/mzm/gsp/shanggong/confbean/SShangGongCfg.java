...
/*     */ 
/*     */ public class SShangGongCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SShangGongCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SShangGongCfg> all = null;
/*     */   
/*     */   public int shanggong_id;
/*     */   public int moduleid;
/*  20 */   public HashMap<Integer, SGongPinInfo> gongpin_infos = new HashMap();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  24 */     this.shanggong_id = Integer.valueOf(rootElement.attributeValue("shanggong_id")).intValue();
/*  25 */     this.moduleid = Integer.valueOf(rootElement.attributeValue("moduleid")).intValue();
/*     */     
/*  27 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "gongpin_infos");
...
/*  53 */             keyElem = elem;
/*     */           }
/*  55 */           else if ((valueElem == null) && (elem.getName().equalsIgnoreCase("mzm.gsp.shanggong.confbean.SGongPinInfo")))
/*     */           {
/*  57 */             valueElem = elem;
/*     */           }
/*     */         }
...
/*     */         }
/*     */         
/*  79 */         this.gongpin_infos.put(Integer.valueOf(_k_), _v_);
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*     */   {
/*  86 */     _os_.marshal(this.shanggong_id);
/*  87 */     _os_.marshal(this.moduleid);
/*  88 */     _os_.compact_uint32(this.gongpin_infos.size());
/*  89 */     for (java.util.Map.Entry<Integer, SGongPinInfo> _e_ : this.gongpin_infos.entrySet())
/*     */     {
...
/*     */   {
/*  99 */     this.shanggong_id = _os_.unmarshal_int();
...
/*     */       
/* 106 */       SGongPinInfo _v_ = new SGongPinInfo();
/* 107 */       _v_.unmarshal(_os_);
/* 108 */       this.gongpin_infos.put(Integer.valueOf(_k_), _v_);
/*     */     }
/* 110 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/* 115 */     String path = dir + "mzm.gsp.shanggong.confbean.SShangGongCfg.xml";
/*     */     
/*     */     try
/*     */     {
/* 119 */       all = new HashMap();
...
/* 128 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.shanggong.confbean.SShangGongCfg"))
/*     */         {
/*     */ 
/* 131 */           SShangGongCfg obj = new SShangGongCfg();
/* 132 */           obj.loadFromXml(elem);
/* 133 */           if (all.put(Integer.valueOf(obj.shanggong_id), obj) != null) {
/* 134 */             throw new RuntimeException("duplicate key : " + obj.shanggong_id);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SShangGongCfg> all)
/*     */   {
/* 145 */     String path = dir + "mzm.gsp.shanggong.confbean.SShangGongCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 157 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.shanggong.confbean.SShangGongCfg"))
/*     */         {
/*     */ 
/* 160 */           SShangGongCfg obj = new SShangGongCfg();
/* 161 */           obj.loadFromXml(elem);
/* 162 */           if (all.put(Integer.valueOf(obj.shanggong_id), obj) != null) {
/* 163 */             throw new RuntimeException("duplicate key : " + obj.shanggong_id);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/* 174 */     all = new HashMap();
/*     */     
/* 176 */     String path = dir + "mzm.gsp.shanggong.confbean.SShangGongCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 203 */           SShangGongCfg _v_ = new SShangGongCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SShangGongCfg> all)
/*     */   {
/* 223 */     String path = dir + "mzm.gsp.shanggong.confbean.SShangGongCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 250 */           SShangGongCfg _v_ = new SShangGongCfg();
...
/*     */ 
/*     */ 
/*     */   public static SShangGongCfg getOld(int key)
/*     */   {
/* 271 */     return (SShangGongCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SShangGongCfg get(int key)
/*     */   {
/* 276 */     return (SShangGongCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SShangGongCfg> getOldAll()
/*     */   {
/* 281 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SShangGongCfg> getAll()
/*     */   {
/* 286 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SShangGongCfg> newAll)
/*     */   {
/* 291 */     oldAll = all;
/* 292 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\shanggong\confbean\SShangGongCfg.class
