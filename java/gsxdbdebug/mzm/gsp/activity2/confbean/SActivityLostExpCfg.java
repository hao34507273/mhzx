...
/*     */ 
/*     */ public class SActivityLostExpCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SActivityLostExpCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SActivityLostExpCfg> all = null;
/*     */   
...
/*  26 */     this.finishCount = Integer.valueOf(rootElement.attributeValue("finishCount")).intValue();
/*     */   }
/*     */   
...
/*  33 */     _os_.marshal(this.finishCount);
/*  34 */     return _os_;
/*     */   }
/*     */   
...
/*  41 */     this.finishCount = _os_.unmarshal_int();
/*  42 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  47 */     String path = dir + "mzm.gsp.activity2.confbean.SActivityLostExpCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  60 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity2.confbean.SActivityLostExpCfg"))
/*     */         {
/*     */ 
/*  63 */           SActivityLostExpCfg obj = new SActivityLostExpCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SActivityLostExpCfg> all)
/*     */   {
/*  77 */     String path = dir + "mzm.gsp.activity2.confbean.SActivityLostExpCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  89 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity2.confbean.SActivityLostExpCfg"))
/*     */         {
/*     */ 
/*  92 */           SActivityLostExpCfg obj = new SActivityLostExpCfg();
...
/*     */     
/* 108 */     String path = dir + "mzm.gsp.activity2.confbean.SActivityLostExpCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 135 */           SActivityLostExpCfg _v_ = new SActivityLostExpCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SActivityLostExpCfg> all)
/*     */   {
/* 155 */     String path = dir + "mzm.gsp.activity2.confbean.SActivityLostExpCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 182 */           SActivityLostExpCfg _v_ = new SActivityLostExpCfg();
...
/*     */ 
/*     */ 
/*     */   public static SActivityLostExpCfg getOld(int key)
/*     */   {
/* 203 */     return (SActivityLostExpCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SActivityLostExpCfg get(int key)
/*     */   {
/* 208 */     return (SActivityLostExpCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SActivityLostExpCfg> getOldAll()
/*     */   {
/* 213 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SActivityLostExpCfg> getAll()
/*     */   {
/* 218 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SActivityLostExpCfg> newAll)
/*     */   {
/* 223 */     oldAll = all;
/* 224 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\activity2\confbean\SActivityLostExpCfg.class
