...
/*     */ 
/*     */ public class STMournCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, STMournCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, STMournCfg> all = null;
/*     */   
/*     */   public int graphId;
/*     */   public int mournId;
/*     */   
...
/*  24 */     this.mournId = Integer.valueOf(rootElement.attributeValue("mournId")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  29 */     _os_.marshal(this.graphId);
/*  30 */     _os_.marshal(this.mournId);
/*  31 */     return _os_;
/*     */   }
/*     */   
...
/*  37 */     this.mournId = _os_.unmarshal_int();
/*  38 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.activity2.confbean.STMournCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity2.confbean.STMournCfg"))
/*     */         {
/*     */ 
/*  59 */           STMournCfg obj = new STMournCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, STMournCfg> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.activity2.confbean.STMournCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity2.confbean.STMournCfg"))
/*     */         {
/*     */ 
/*  88 */           STMournCfg obj = new STMournCfg();
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.activity2.confbean.STMournCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           STMournCfg _v_ = new STMournCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, STMournCfg> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.activity2.confbean.STMournCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           STMournCfg _v_ = new STMournCfg();
...
/*     */ 
/*     */ 
/*     */   public static STMournCfg getOld(int key)
/*     */   {
/* 199 */     return (STMournCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static STMournCfg get(int key)
/*     */   {
/* 204 */     return (STMournCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, STMournCfg> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, STMournCfg> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, STMournCfg> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\activity2\confbean\STMournCfg.class
