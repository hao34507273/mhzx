...
/*     */ 
/*     */ public class SMemoryCompetitionMappingOriginalCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SMemoryCompetitionMappingOriginalCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SMemoryCompetitionMappingOriginalCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public int mapping_type_id;
/*     */   public int mapping_value;
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  24 */     this.id = Integer.valueOf(rootElement.attributeValue("id")).intValue();
/*  25 */     this.mapping_type_id = Integer.valueOf(rootElement.attributeValue("mapping_type_id")).intValue();
/*  26 */     this.mapping_value = Integer.valueOf(rootElement.attributeValue("mapping_value")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  31 */     _os_.marshal(this.id);
/*  32 */     _os_.marshal(this.mapping_type_id);
/*  33 */     _os_.marshal(this.mapping_value);
/*  34 */     return _os_;
/*     */   }
/*     */   
...
/*  40 */     this.mapping_type_id = _os_.unmarshal_int();
/*  41 */     this.mapping_value = _os_.unmarshal_int();
/*  42 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  47 */     String path = dir + "mzm.gsp.activity2.confbean.SMemoryCompetitionMappingOriginalCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  60 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity2.confbean.SMemoryCompetitionMappingOriginalCfg"))
/*     */         {
/*     */ 
/*  63 */           SMemoryCompetitionMappingOriginalCfg obj = new SMemoryCompetitionMappingOriginalCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SMemoryCompetitionMappingOriginalCfg> all)
/*     */   {
/*  77 */     String path = dir + "mzm.gsp.activity2.confbean.SMemoryCompetitionMappingOriginalCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  89 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity2.confbean.SMemoryCompetitionMappingOriginalCfg"))
/*     */         {
/*     */ 
/*  92 */           SMemoryCompetitionMappingOriginalCfg obj = new SMemoryCompetitionMappingOriginalCfg();
...
/*     */     
/* 108 */     String path = dir + "mzm.gsp.activity2.confbean.SMemoryCompetitionMappingOriginalCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 135 */           SMemoryCompetitionMappingOriginalCfg _v_ = new SMemoryCompetitionMappingOriginalCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SMemoryCompetitionMappingOriginalCfg> all)
/*     */   {
/* 155 */     String path = dir + "mzm.gsp.activity2.confbean.SMemoryCompetitionMappingOriginalCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 182 */           SMemoryCompetitionMappingOriginalCfg _v_ = new SMemoryCompetitionMappingOriginalCfg();
...
/*     */ 
/*     */ 
/*     */   public static SMemoryCompetitionMappingOriginalCfg getOld(int key)
/*     */   {
/* 203 */     return (SMemoryCompetitionMappingOriginalCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SMemoryCompetitionMappingOriginalCfg get(int key)
/*     */   {
/* 208 */     return (SMemoryCompetitionMappingOriginalCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMemoryCompetitionMappingOriginalCfg> getOldAll()
/*     */   {
/* 213 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMemoryCompetitionMappingOriginalCfg> getAll()
/*     */   {
/* 218 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SMemoryCompetitionMappingOriginalCfg> newAll)
/*     */   {
/* 223 */     oldAll = all;
/* 224 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\activity2\confbean\SMemoryCompetitionMappingOriginalCfg.class
