...
/*     */ 
/*     */ public class SVisibleMonsterSwitchCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SVisibleMonsterSwitchCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SVisibleMonsterSwitchCfg> all = null;
/*     */   
...
/*     */   {
/*  23 */     this.idip_module_switch_id = Integer.valueOf(rootElement.attributeValue("idip_module_switch_id")).intValue();
/*  24 */     this.activity_cfg_id = Integer.valueOf(rootElement.attributeValue("activity_cfg_id")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  29 */     _os_.marshal(this.idip_module_switch_id);
...
/*     */   {
/*  36 */     this.idip_module_switch_id = _os_.unmarshal_int();
...
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.activity2.confbean.SVisibleMonsterSwitchCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity2.confbean.SVisibleMonsterSwitchCfg"))
/*     */         {
/*     */ 
/*  59 */           SVisibleMonsterSwitchCfg obj = new SVisibleMonsterSwitchCfg();
/*  60 */           obj.loadFromXml(elem);
/*  61 */           if (all.put(Integer.valueOf(obj.idip_module_switch_id), obj) != null) {
/*  62 */             throw new RuntimeException("duplicate key : " + obj.idip_module_switch_id);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SVisibleMonsterSwitchCfg> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.activity2.confbean.SVisibleMonsterSwitchCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity2.confbean.SVisibleMonsterSwitchCfg"))
/*     */         {
/*     */ 
/*  88 */           SVisibleMonsterSwitchCfg obj = new SVisibleMonsterSwitchCfg();
/*  89 */           obj.loadFromXml(elem);
/*  90 */           if (all.put(Integer.valueOf(obj.idip_module_switch_id), obj) != null) {
/*  91 */             throw new RuntimeException("duplicate key : " + obj.idip_module_switch_id);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.activity2.confbean.SVisibleMonsterSwitchCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           SVisibleMonsterSwitchCfg _v_ = new SVisibleMonsterSwitchCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SVisibleMonsterSwitchCfg> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.activity2.confbean.SVisibleMonsterSwitchCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           SVisibleMonsterSwitchCfg _v_ = new SVisibleMonsterSwitchCfg();
...
/*     */ 
/*     */ 
/*     */   public static SVisibleMonsterSwitchCfg getOld(int key)
/*     */   {
/* 199 */     return (SVisibleMonsterSwitchCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SVisibleMonsterSwitchCfg get(int key)
/*     */   {
/* 204 */     return (SVisibleMonsterSwitchCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SVisibleMonsterSwitchCfg> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SVisibleMonsterSwitchCfg> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SVisibleMonsterSwitchCfg> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\activity2\confbean\SVisibleMonsterSwitchCfg.class
