...
/*     */ 
/*     */ public class MournConsts
/*     */ {
/*  13 */   private static volatile MournConsts oldInstance = null;
/*     */   
/*  15 */   private static MournConsts instance = new MournConsts();
/*     */   
/*     */   public int activityId;
/*     */   public int npcId;
/*     */   public int npcServiceId;
/*     */   
/*     */   public static MournConsts getOldInstance()
/*     */   {
/*  23 */     return oldInstance;
/*     */   }
/*     */   
/*     */   public static MournConsts getInstance()
/*     */   {
/*  28 */     return instance;
/*     */   }
/*     */   
/*     */ 
/*     */   public int questionGraphId;
/*     */   
/*     */   public int questionAwardId;
/*     */   
/*     */   public int countMax;
/*     */   
...
/*     */   {
/*  46 */     String path = dir + "mzm.gsp.activity2.confbean.MournConsts.xml";
/*     */     try
/*     */     {
...
/*  68 */       this.npcServiceId = Integer.valueOf(((Element)data.get("npcServiceId")).attributeValue("value")).intValue();
/*  69 */       this.questionGraphId = Integer.valueOf(((Element)data.get("questionGraphId")).attributeValue("value")).intValue();
/*  70 */       this.questionAwardId = Integer.valueOf(((Element)data.get("questionAwardId")).attributeValue("value")).intValue();
/*  71 */       this.countMax = Integer.valueOf(((Element)data.get("countMax")).attributeValue("value")).intValue();
/*  72 */       this.controller = Integer.valueOf(((Element)data.get("controller")).attributeValue("value")).intValue();
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*  81 */     String path = dir + "mzm.gsp.activity2.confbean.MournConsts.xml";
/*     */     try
/*     */     {
...
/* 103 */       this.npcServiceId = Integer.valueOf(((Element)data.get("npcServiceId")).attributeValue("value")).intValue();
/* 104 */       this.questionGraphId = Integer.valueOf(((Element)data.get("questionGraphId")).attributeValue("value")).intValue();
/* 105 */       this.questionAwardId = Integer.valueOf(((Element)data.get("questionAwardId")).attributeValue("value")).intValue();
/* 106 */       this.countMax = Integer.valueOf(((Element)data.get("countMax")).attributeValue("value")).intValue();
/* 107 */       this.controller = Integer.valueOf(((Element)data.get("controller")).attributeValue("value")).intValue();
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/* 118 */     String path = dir + "mzm.gsp.activity2.confbean.MournConsts.bny";
/*     */     try
/*     */     {
...
/* 135 */         this.npcServiceId = _os_.unmarshal_int();
/* 136 */         this.questionGraphId = _os_.unmarshal_int();
/* 137 */         this.questionAwardId = _os_.unmarshal_int();
/* 138 */         this.countMax = _os_.unmarshal_int();
...
/*     */   {
/* 150 */     String path = dir + "mzm.gsp.activity2.confbean.MournConsts.bny";
/*     */     try
/*     */     {
...
/* 167 */         this.npcServiceId = _os_.unmarshal_int();
/* 168 */         this.questionGraphId = _os_.unmarshal_int();
/* 169 */         this.questionAwardId = _os_.unmarshal_int();
/* 170 */         this.countMax = _os_.unmarshal_int();
/* 171 */         this.controller = _os_.unmarshal_int();
/*     */       }
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*     */   }
/*     */   
/*     */   public static void setInstance(MournConsts newInstance)
/*     */   {
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\activity2\confbean\MournConsts.class
