...
/*     */ 
/*     */ public class SMemoryCompetitionMappingCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SMemoryCompetitionMappingCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SMemoryCompetitionMappingCfg> all = null;
/*     */   
/*     */   public int mapping_type_id;
/*  19 */   public java.util.ArrayList<Integer> mapping_value_list = new java.util.ArrayList();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.mapping_type_id = Integer.valueOf(rootElement.attributeValue("mapping_type_id")).intValue();
/*     */     
/*  25 */     Element collectionElement = util.XmlHelper.getVariableElement(rootElement, "mapping_value_list");
...
/*     */         }
/*     */         
/*  50 */         this.mapping_value_list.add(Integer.valueOf(_v_));
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*     */   {
/*  57 */     _os_.marshal(this.mapping_type_id);
/*  58 */     _os_.compact_uint32(this.mapping_value_list.size());
/*  59 */     for (Integer _v_ : this.mapping_value_list)
/*     */     {
...
/*     */   {
/*  68 */     this.mapping_type_id = _os_.unmarshal_int();
/*  69 */     for (int _size_ = _os_.uncompact_uint32(); _size_ > 0; _size_--)
/*     */     {
/*     */ 
/*  72 */       int _v_ = _os_.unmarshal_int();
/*  73 */       this.mapping_value_list.add(Integer.valueOf(_v_));
/*     */     }
/*  75 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/*  80 */     String path = dir + "mzm.gsp.activity2.confbean.SMemoryCompetitionMappingCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity2.confbean.SMemoryCompetitionMappingCfg"))
/*     */         {
/*     */ 
/*  96 */           SMemoryCompetitionMappingCfg obj = new SMemoryCompetitionMappingCfg();
/*  97 */           obj.loadFromXml(elem);
/*  98 */           if (all.put(Integer.valueOf(obj.mapping_type_id), obj) != null) {
/*  99 */             throw new RuntimeException("duplicate key : " + obj.mapping_type_id);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SMemoryCompetitionMappingCfg> all)
/*     */   {
/* 110 */     String path = dir + "mzm.gsp.activity2.confbean.SMemoryCompetitionMappingCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 122 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity2.confbean.SMemoryCompetitionMappingCfg"))
/*     */         {
/*     */ 
/* 125 */           SMemoryCompetitionMappingCfg obj = new SMemoryCompetitionMappingCfg();
/* 126 */           obj.loadFromXml(elem);
/* 127 */           if (all.put(Integer.valueOf(obj.mapping_type_id), obj) != null) {
/* 128 */             throw new RuntimeException("duplicate key : " + obj.mapping_type_id);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 141 */     String path = dir + "mzm.gsp.activity2.confbean.SMemoryCompetitionMappingCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 168 */           SMemoryCompetitionMappingCfg _v_ = new SMemoryCompetitionMappingCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SMemoryCompetitionMappingCfg> all)
/*     */   {
/* 188 */     String path = dir + "mzm.gsp.activity2.confbean.SMemoryCompetitionMappingCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 215 */           SMemoryCompetitionMappingCfg _v_ = new SMemoryCompetitionMappingCfg();
...
/*     */ 
/*     */ 
/*     */   public static SMemoryCompetitionMappingCfg getOld(int key)
/*     */   {
/* 236 */     return (SMemoryCompetitionMappingCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SMemoryCompetitionMappingCfg get(int key)
/*     */   {
/* 241 */     return (SMemoryCompetitionMappingCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMemoryCompetitionMappingCfg> getOldAll()
/*     */   {
/* 246 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMemoryCompetitionMappingCfg> getAll()
/*     */   {
/* 251 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SMemoryCompetitionMappingCfg> newAll)
/*     */   {
/* 256 */     oldAll = all;
/* 257 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\activity2\confbean\SMemoryCompetitionMappingCfg.class
