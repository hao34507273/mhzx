...
/*     */ 
/*     */ public class LostExpConst
/*     */ {
/*  13 */   private static volatile LostExpConst oldInstance = null;
/*     */   
/*  15 */   private static LostExpConst instance = new LostExpConst();
/*     */   public int activityid;
/*     */   public int collectExpInterval;
/*     */   public int remainExpRet;
/*     */   public int getLostExpTipMailId;
/*     */   
/*     */   public static LostExpConst getOldInstance()
/*     */   {
/*  23 */     return oldInstance;
/*     */   }
/*     */   
/*     */   public static LostExpConst getInstance()
/*     */   {
/*  28 */     return instance;
/*     */   }
/*     */   
...
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.activity2.confbean.LostExpConst.xml";
/*     */     try
/*     */     {
...
/*     */         }
/*     */       }
/*  63 */       this.activityid = Integer.valueOf(((Element)data.get("activityid")).attributeValue("value")).intValue();
/*  64 */       this.collectExpInterval = Integer.valueOf(((Element)data.get("collectExpInterval")).attributeValue("value")).intValue();
/*  65 */       this.remainExpRet = Integer.valueOf(((Element)data.get("remainExpRet")).attributeValue("value")).intValue();
/*  66 */       this.getLostExpTipMailId = Integer.valueOf(((Element)data.get("getLostExpTipMailId")).attributeValue("value")).intValue();
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*  75 */     String path = dir + "mzm.gsp.activity2.confbean.LostExpConst.xml";
/*     */     try
/*     */     {
...
/*     */         }
/*     */       }
/*  95 */       this.activityid = Integer.valueOf(((Element)data.get("activityid")).attributeValue("value")).intValue();
/*  96 */       this.collectExpInterval = Integer.valueOf(((Element)data.get("collectExpInterval")).attributeValue("value")).intValue();
/*  97 */       this.remainExpRet = Integer.valueOf(((Element)data.get("remainExpRet")).attributeValue("value")).intValue();
/*  98 */       this.getLostExpTipMailId = Integer.valueOf(((Element)data.get("getLostExpTipMailId")).attributeValue("value")).intValue();
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/* 109 */     String path = dir + "mzm.gsp.activity2.confbean.LostExpConst.bny";
/*     */     try
/*     */     {
...
/* 124 */         this.activityid = _os_.unmarshal_int();
/* 125 */         this.collectExpInterval = _os_.unmarshal_int();
/* 126 */         this.remainExpRet = _os_.unmarshal_int();
/* 127 */         this.getLostExpTipMailId = _os_.unmarshal_int();
/*     */       }
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*     */   {
/* 138 */     String path = dir + "mzm.gsp.activity2.confbean.LostExpConst.bny";
/*     */     try
/*     */     {
...
/* 153 */         this.activityid = _os_.unmarshal_int();
/* 154 */         this.collectExpInterval = _os_.unmarshal_int();
/* 155 */         this.remainExpRet = _os_.unmarshal_int();
/* 156 */         this.getLostExpTipMailId = _os_.unmarshal_int();
/*     */       }
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*     */   }
/*     */   
/*     */   public static void setInstance(LostExpConst newInstance)
/*     */   {
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\activity2\confbean\LostExpConst.class
