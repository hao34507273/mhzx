...
/*     */ 
/*     */ public class SMournCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SMournCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SMournCfg> all = null;
/*     */   
/*     */   public int id;
...
/*  28 */     this.deadName = rootElement.attributeValue("deadName");
/*  29 */     this.modelId = Integer.valueOf(rootElement.attributeValue("modelId")).intValue();
/*  30 */     this.story = rootElement.attributeValue("story");
/*  31 */     this.graphId = Integer.valueOf(rootElement.attributeValue("graphId")).intValue();
...
/*  38 */     _os_.marshal(this.deadName, "UTF-8");
/*  39 */     _os_.marshal(this.modelId);
/*  40 */     _os_.marshal(this.story, "UTF-8");
/*  41 */     _os_.marshal(this.graphId);
...
/*  49 */     this.deadName = _os_.unmarshal_String("UTF-8");
/*  50 */     this.modelId = _os_.unmarshal_int();
/*  51 */     this.story = _os_.unmarshal_String("UTF-8");
/*  52 */     this.graphId = _os_.unmarshal_int();
/*  53 */     this.awardId = _os_.unmarshal_int();
/*  54 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  59 */     String path = dir + "mzm.gsp.activity2.confbean.SMournCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  72 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity2.confbean.SMournCfg"))
/*     */         {
/*     */ 
/*  75 */           SMournCfg obj = new SMournCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SMournCfg> all)
/*     */   {
/*  89 */     String path = dir + "mzm.gsp.activity2.confbean.SMournCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 101 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.activity2.confbean.SMournCfg"))
/*     */         {
/*     */ 
/* 104 */           SMournCfg obj = new SMournCfg();
...
/*     */     
/* 120 */     String path = dir + "mzm.gsp.activity2.confbean.SMournCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 147 */           SMournCfg _v_ = new SMournCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SMournCfg> all)
/*     */   {
/* 167 */     String path = dir + "mzm.gsp.activity2.confbean.SMournCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 194 */           SMournCfg _v_ = new SMournCfg();
...
/*     */ 
/*     */ 
/*     */   public static SMournCfg getOld(int key)
/*     */   {
/* 215 */     return (SMournCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SMournCfg get(int key)
/*     */   {
/* 220 */     return (SMournCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMournCfg> getOldAll()
/*     */   {
/* 225 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMournCfg> getAll()
/*     */   {
/* 230 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SMournCfg> newAll)
/*     */   {
/* 235 */     oldAll = all;
/* 236 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\activity2\confbean\SMournCfg.class
