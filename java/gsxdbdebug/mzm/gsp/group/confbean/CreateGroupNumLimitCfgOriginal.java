...
/*     */ 
/*     */ public class CreateGroupNumLimitCfgOriginal implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, CreateGroupNumLimitCfgOriginal> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, CreateGroupNumLimitCfgOriginal> all = null;
/*     */   
/*     */   public int id;
/*     */   public int level_lower_limit;
/*     */   public int level_upper_limit;
/*     */   public int create_group_max_num;
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  25 */     this.id = Integer.valueOf(rootElement.attributeValue("id")).intValue();
/*  26 */     this.level_lower_limit = Integer.valueOf(rootElement.attributeValue("level_lower_limit")).intValue();
/*  27 */     this.level_upper_limit = Integer.valueOf(rootElement.attributeValue("level_upper_limit")).intValue();
/*  28 */     this.create_group_max_num = Integer.valueOf(rootElement.attributeValue("create_group_max_num")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  33 */     _os_.marshal(this.id);
/*  34 */     _os_.marshal(this.level_lower_limit);
/*  35 */     _os_.marshal(this.level_upper_limit);
/*  36 */     _os_.marshal(this.create_group_max_num);
/*  37 */     return _os_;
/*     */   }
/*     */   
...
/*  43 */     this.level_lower_limit = _os_.unmarshal_int();
/*  44 */     this.level_upper_limit = _os_.unmarshal_int();
/*  45 */     this.create_group_max_num = _os_.unmarshal_int();
/*  46 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  51 */     String path = dir + "mzm.gsp.group.confbean.CreateGroupNumLimitCfgOriginal.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  64 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.group.confbean.CreateGroupNumLimitCfgOriginal"))
/*     */         {
/*     */ 
/*  67 */           CreateGroupNumLimitCfgOriginal obj = new CreateGroupNumLimitCfgOriginal();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, CreateGroupNumLimitCfgOriginal> all)
/*     */   {
/*  81 */     String path = dir + "mzm.gsp.group.confbean.CreateGroupNumLimitCfgOriginal.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.group.confbean.CreateGroupNumLimitCfgOriginal"))
/*     */         {
/*     */ 
/*  96 */           CreateGroupNumLimitCfgOriginal obj = new CreateGroupNumLimitCfgOriginal();
...
/*     */     
/* 112 */     String path = dir + "mzm.gsp.group.confbean.CreateGroupNumLimitCfgOriginal.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 139 */           CreateGroupNumLimitCfgOriginal _v_ = new CreateGroupNumLimitCfgOriginal();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, CreateGroupNumLimitCfgOriginal> all)
/*     */   {
/* 159 */     String path = dir + "mzm.gsp.group.confbean.CreateGroupNumLimitCfgOriginal.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 186 */           CreateGroupNumLimitCfgOriginal _v_ = new CreateGroupNumLimitCfgOriginal();
...
/*     */ 
/*     */ 
/*     */   public static CreateGroupNumLimitCfgOriginal getOld(int key)
/*     */   {
/* 207 */     return (CreateGroupNumLimitCfgOriginal)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static CreateGroupNumLimitCfgOriginal get(int key)
/*     */   {
/* 212 */     return (CreateGroupNumLimitCfgOriginal)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, CreateGroupNumLimitCfgOriginal> getOldAll()
/*     */   {
/* 217 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, CreateGroupNumLimitCfgOriginal> getAll()
/*     */   {
/* 222 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, CreateGroupNumLimitCfgOriginal> newAll)
/*     */   {
/* 227 */     oldAll = all;
/* 228 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\group\confbean\CreateGroupNumLimitCfgOriginal.class
