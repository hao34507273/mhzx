...
/*     */ 
/*     */ public class WorldGoalItemCfgOriginal implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, WorldGoalItemCfgOriginal> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, WorldGoalItemCfgOriginal> all = null;
/*     */   
/*     */   public int id;
/*     */   public int item_id;
/*     */   public int point;
...
/*  27 */     this.point = Integer.valueOf(rootElement.attributeValue("point")).intValue();
...
/*  43 */     this.item_id = _os_.unmarshal_int();
/*  44 */     this.point = _os_.unmarshal_int();
...
/*     */   {
/*  51 */     String path = dir + "mzm.gsp.worldgoal.confbean.WorldGoalItemCfgOriginal.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  64 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.worldgoal.confbean.WorldGoalItemCfgOriginal"))
/*     */         {
/*     */ 
/*  67 */           WorldGoalItemCfgOriginal obj = new WorldGoalItemCfgOriginal();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, WorldGoalItemCfgOriginal> all)
/*     */   {
/*  81 */     String path = dir + "mzm.gsp.worldgoal.confbean.WorldGoalItemCfgOriginal.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.worldgoal.confbean.WorldGoalItemCfgOriginal"))
/*     */         {
/*     */ 
/*  96 */           WorldGoalItemCfgOriginal obj = new WorldGoalItemCfgOriginal();
...
/*     */     
/* 112 */     String path = dir + "mzm.gsp.worldgoal.confbean.WorldGoalItemCfgOriginal.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 139 */           WorldGoalItemCfgOriginal _v_ = new WorldGoalItemCfgOriginal();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, WorldGoalItemCfgOriginal> all)
/*     */   {
/* 159 */     String path = dir + "mzm.gsp.worldgoal.confbean.WorldGoalItemCfgOriginal.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 186 */           WorldGoalItemCfgOriginal _v_ = new WorldGoalItemCfgOriginal();
...
/*     */ 
/*     */ 
/*     */   public static WorldGoalItemCfgOriginal getOld(int key)
/*     */   {
/* 207 */     return (WorldGoalItemCfgOriginal)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static WorldGoalItemCfgOriginal get(int key)
/*     */   {
/* 212 */     return (WorldGoalItemCfgOriginal)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, WorldGoalItemCfgOriginal> getOldAll()
/*     */   {
/* 217 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, WorldGoalItemCfgOriginal> getAll()
/*     */   {
/* 222 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, WorldGoalItemCfgOriginal> newAll)
/*     */   {
/* 227 */     oldAll = all;
/* 228 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\worldgoal\confbean\WorldGoalItemCfgOriginal.class
