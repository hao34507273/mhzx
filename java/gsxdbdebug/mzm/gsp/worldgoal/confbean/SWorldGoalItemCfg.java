...
/*     */ 
/*     */ public class SWorldGoalItemCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SWorldGoalItemCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SWorldGoalItemCfg> all = null;
/*     */   
/*     */   public int item_id;
/*     */   public int point;
/*     */   public int award_id;
...
/*     */   {
/*  24 */     this.item_id = Integer.valueOf(rootElement.attributeValue("item_id")).intValue();
/*  25 */     this.point = Integer.valueOf(rootElement.attributeValue("point")).intValue();
/*  26 */     this.award_id = Integer.valueOf(rootElement.attributeValue("award_id")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  31 */     _os_.marshal(this.item_id);
/*  32 */     _os_.marshal(this.point);
...
/*     */   {
/*  39 */     this.item_id = _os_.unmarshal_int();
/*  40 */     this.point = _os_.unmarshal_int();
/*  41 */     this.award_id = _os_.unmarshal_int();
/*  42 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  47 */     String path = dir + "mzm.gsp.worldgoal.confbean.SWorldGoalItemCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  60 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.worldgoal.confbean.SWorldGoalItemCfg"))
/*     */         {
/*     */ 
/*  63 */           SWorldGoalItemCfg obj = new SWorldGoalItemCfg();
/*  64 */           obj.loadFromXml(elem);
/*  65 */           if (all.put(Integer.valueOf(obj.item_id), obj) != null) {
/*  66 */             throw new RuntimeException("duplicate key : " + obj.item_id);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SWorldGoalItemCfg> all)
/*     */   {
/*  77 */     String path = dir + "mzm.gsp.worldgoal.confbean.SWorldGoalItemCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  89 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.worldgoal.confbean.SWorldGoalItemCfg"))
/*     */         {
/*     */ 
/*  92 */           SWorldGoalItemCfg obj = new SWorldGoalItemCfg();
/*  93 */           obj.loadFromXml(elem);
/*  94 */           if (all.put(Integer.valueOf(obj.item_id), obj) != null) {
/*  95 */             throw new RuntimeException("duplicate key : " + obj.item_id);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 108 */     String path = dir + "mzm.gsp.worldgoal.confbean.SWorldGoalItemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 135 */           SWorldGoalItemCfg _v_ = new SWorldGoalItemCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SWorldGoalItemCfg> all)
/*     */   {
/* 155 */     String path = dir + "mzm.gsp.worldgoal.confbean.SWorldGoalItemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 182 */           SWorldGoalItemCfg _v_ = new SWorldGoalItemCfg();
...
/*     */ 
/*     */ 
/*     */   public static SWorldGoalItemCfg getOld(int key)
/*     */   {
/* 203 */     return (SWorldGoalItemCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SWorldGoalItemCfg get(int key)
/*     */   {
/* 208 */     return (SWorldGoalItemCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SWorldGoalItemCfg> getOldAll()
/*     */   {
/* 213 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SWorldGoalItemCfg> getAll()
/*     */   {
/* 218 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SWorldGoalItemCfg> newAll)
/*     */   {
/* 223 */     oldAll = all;
/* 224 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\worldgoal\confbean\SWorldGoalItemCfg.class
