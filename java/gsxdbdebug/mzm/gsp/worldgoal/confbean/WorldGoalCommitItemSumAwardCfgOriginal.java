...
/*     */ 
/*     */ public class WorldGoalCommitItemSumAwardCfgOriginal implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, WorldGoalCommitItemSumAwardCfgOriginal> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, WorldGoalCommitItemSumAwardCfgOriginal> all = null;
/*     */   
/*     */   public int id;
...
/*  27 */     this.trigger_num = Integer.valueOf(rootElement.attributeValue("trigger_num")).intValue();
...
/*  35 */     _os_.marshal(this.trigger_num);
/*  36 */     _os_.marshal(this.award_id);
/*  37 */     return _os_;
/*     */   }
/*     */   
...
/*  43 */     this.activity_cfg_id = _os_.unmarshal_int();
/*  44 */     this.trigger_num = _os_.unmarshal_int();
...
/*     */   {
/*  51 */     String path = dir + "mzm.gsp.worldgoal.confbean.WorldGoalCommitItemSumAwardCfgOriginal.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  64 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.worldgoal.confbean.WorldGoalCommitItemSumAwardCfgOriginal"))
/*     */         {
/*     */ 
/*  67 */           WorldGoalCommitItemSumAwardCfgOriginal obj = new WorldGoalCommitItemSumAwardCfgOriginal();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, WorldGoalCommitItemSumAwardCfgOriginal> all)
/*     */   {
/*  81 */     String path = dir + "mzm.gsp.worldgoal.confbean.WorldGoalCommitItemSumAwardCfgOriginal.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.worldgoal.confbean.WorldGoalCommitItemSumAwardCfgOriginal"))
/*     */         {
/*     */ 
/*  96 */           WorldGoalCommitItemSumAwardCfgOriginal obj = new WorldGoalCommitItemSumAwardCfgOriginal();
...
/*     */     
/* 112 */     String path = dir + "mzm.gsp.worldgoal.confbean.WorldGoalCommitItemSumAwardCfgOriginal.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 139 */           WorldGoalCommitItemSumAwardCfgOriginal _v_ = new WorldGoalCommitItemSumAwardCfgOriginal();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, WorldGoalCommitItemSumAwardCfgOriginal> all)
/*     */   {
/* 159 */     String path = dir + "mzm.gsp.worldgoal.confbean.WorldGoalCommitItemSumAwardCfgOriginal.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 186 */           WorldGoalCommitItemSumAwardCfgOriginal _v_ = new WorldGoalCommitItemSumAwardCfgOriginal();
...
/*     */ 
/*     */ 
/*     */   public static WorldGoalCommitItemSumAwardCfgOriginal getOld(int key)
/*     */   {
/* 207 */     return (WorldGoalCommitItemSumAwardCfgOriginal)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static WorldGoalCommitItemSumAwardCfgOriginal get(int key)
/*     */   {
/* 212 */     return (WorldGoalCommitItemSumAwardCfgOriginal)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, WorldGoalCommitItemSumAwardCfgOriginal> getOldAll()
/*     */   {
/* 217 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, WorldGoalCommitItemSumAwardCfgOriginal> getAll()
/*     */   {
/* 222 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, WorldGoalCommitItemSumAwardCfgOriginal> newAll)
/*     */   {
/* 227 */     oldAll = all;
/* 228 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\worldgoal\confbean\WorldGoalCommitItemSumAwardCfgOriginal.class
