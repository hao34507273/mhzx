...
/*     */ 
/*     */ public class SWorldGoalCommitItemSumAwardCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SWorldGoalCommitItemSumAwardCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SWorldGoalCommitItemSumAwardCfg> all = null;
/*     */   
/*     */   public int activity_cfg_id;
/*  19 */   public TreeMap<Integer, Integer> trigger_nums = new TreeMap();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.activity_cfg_id = Integer.valueOf(rootElement.attributeValue("activity_cfg_id")).intValue();
/*     */     
/*  25 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "trigger_nums");
...
/*     */         }
/*     */         
/*  76 */         this.trigger_nums.put(Integer.valueOf(_k_), Integer.valueOf(_v_));
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*     */   {
/*  83 */     _os_.marshal(this.activity_cfg_id);
/*  84 */     _os_.compact_uint32(this.trigger_nums.size());
/*  85 */     for (java.util.Map.Entry<Integer, Integer> _e_ : this.trigger_nums.entrySet())
/*     */     {
...
/* 102 */       this.trigger_nums.put(Integer.valueOf(_k_), Integer.valueOf(_v_));
/*     */     }
/* 104 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/* 109 */     String path = dir + "mzm.gsp.worldgoal.confbean.SWorldGoalCommitItemSumAwardCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 122 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.worldgoal.confbean.SWorldGoalCommitItemSumAwardCfg"))
/*     */         {
/*     */ 
/* 125 */           SWorldGoalCommitItemSumAwardCfg obj = new SWorldGoalCommitItemSumAwardCfg();
/* 126 */           obj.loadFromXml(elem);
/* 127 */           if (all.put(Integer.valueOf(obj.activity_cfg_id), obj) != null) {
/* 128 */             throw new RuntimeException("duplicate key : " + obj.activity_cfg_id);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SWorldGoalCommitItemSumAwardCfg> all)
/*     */   {
/* 139 */     String path = dir + "mzm.gsp.worldgoal.confbean.SWorldGoalCommitItemSumAwardCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 151 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.worldgoal.confbean.SWorldGoalCommitItemSumAwardCfg"))
/*     */         {
/*     */ 
/* 154 */           SWorldGoalCommitItemSumAwardCfg obj = new SWorldGoalCommitItemSumAwardCfg();
/* 155 */           obj.loadFromXml(elem);
/* 156 */           if (all.put(Integer.valueOf(obj.activity_cfg_id), obj) != null) {
/* 157 */             throw new RuntimeException("duplicate key : " + obj.activity_cfg_id);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 170 */     String path = dir + "mzm.gsp.worldgoal.confbean.SWorldGoalCommitItemSumAwardCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 197 */           SWorldGoalCommitItemSumAwardCfg _v_ = new SWorldGoalCommitItemSumAwardCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SWorldGoalCommitItemSumAwardCfg> all)
/*     */   {
/* 217 */     String path = dir + "mzm.gsp.worldgoal.confbean.SWorldGoalCommitItemSumAwardCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 244 */           SWorldGoalCommitItemSumAwardCfg _v_ = new SWorldGoalCommitItemSumAwardCfg();
...
/*     */ 
/*     */ 
/*     */   public static SWorldGoalCommitItemSumAwardCfg getOld(int key)
/*     */   {
/* 265 */     return (SWorldGoalCommitItemSumAwardCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SWorldGoalCommitItemSumAwardCfg get(int key)
/*     */   {
/* 270 */     return (SWorldGoalCommitItemSumAwardCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SWorldGoalCommitItemSumAwardCfg> getOldAll()
/*     */   {
/* 275 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SWorldGoalCommitItemSumAwardCfg> getAll()
/*     */   {
/* 280 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SWorldGoalCommitItemSumAwardCfg> newAll)
/*     */   {
/* 285 */     oldAll = all;
/* 286 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\worldgoal\confbean\SWorldGoalCommitItemSumAwardCfg.class
