...
/*     */ 
/*     */ public class SWorldGoalModuleidCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SWorldGoalModuleidCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SWorldGoalModuleidCfg> all = null;
/*     */   
/*     */   public int mudule_id;
/*     */   public int activity_cfg_id;
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.mudule_id = Integer.valueOf(rootElement.attributeValue("mudule_id")).intValue();
/*  24 */     this.activity_cfg_id = Integer.valueOf(rootElement.attributeValue("activity_cfg_id")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  29 */     _os_.marshal(this.mudule_id);
...
/*     */   {
/*  36 */     this.mudule_id = _os_.unmarshal_int();
...
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.worldgoal.confbean.SWorldGoalModuleidCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.worldgoal.confbean.SWorldGoalModuleidCfg"))
/*     */         {
/*     */ 
/*  59 */           SWorldGoalModuleidCfg obj = new SWorldGoalModuleidCfg();
/*  60 */           obj.loadFromXml(elem);
/*  61 */           if (all.put(Integer.valueOf(obj.mudule_id), obj) != null) {
/*  62 */             throw new RuntimeException("duplicate key : " + obj.mudule_id);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SWorldGoalModuleidCfg> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.worldgoal.confbean.SWorldGoalModuleidCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.worldgoal.confbean.SWorldGoalModuleidCfg"))
/*     */         {
/*     */ 
/*  88 */           SWorldGoalModuleidCfg obj = new SWorldGoalModuleidCfg();
/*  89 */           obj.loadFromXml(elem);
/*  90 */           if (all.put(Integer.valueOf(obj.mudule_id), obj) != null) {
/*  91 */             throw new RuntimeException("duplicate key : " + obj.mudule_id);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.worldgoal.confbean.SWorldGoalModuleidCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           SWorldGoalModuleidCfg _v_ = new SWorldGoalModuleidCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SWorldGoalModuleidCfg> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.worldgoal.confbean.SWorldGoalModuleidCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           SWorldGoalModuleidCfg _v_ = new SWorldGoalModuleidCfg();
...
/*     */ 
/*     */ 
/*     */   public static SWorldGoalModuleidCfg getOld(int key)
/*     */   {
/* 199 */     return (SWorldGoalModuleidCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SWorldGoalModuleidCfg get(int key)
/*     */   {
/* 204 */     return (SWorldGoalModuleidCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SWorldGoalModuleidCfg> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SWorldGoalModuleidCfg> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SWorldGoalModuleidCfg> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\worldgoal\confbean\SWorldGoalModuleidCfg.class
