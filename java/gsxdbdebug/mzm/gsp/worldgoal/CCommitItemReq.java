...
/*     */ import mzm.gsp.Role;
/*     */ import mzm.gsp.worldgoal.main.PCommitItemReq;
/*     */ 
/*     */ 
/*     */ public class CCommitItemReq
/*     */   extends __CCommitItemReq__
/*     */ {
/*     */   public static final int PROTOCOL_TYPE = 12594437;
/*     */   public int position;
...
/*  21 */     if (roleid < 0L)
/*  22 */       return;
/*  23 */     Role.addRoleProcedure(roleid, new PCommitItemReq(roleid, this.position, this.activity_cfg_id, this.npc_id, this.entity_instance_id));
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */ 
/*     */ 
/*     */   public CCommitItemReq()
/*     */   {
/*  40 */     this.position = 1;
/*     */   }
/*     */   
/*     */   public CCommitItemReq(int _position_, int _activity_cfg_id_, int _npc_id_, long _entity_instance_id_) {
...
/*  75 */     if ((_o1_ instanceof CCommitItemReq)) {
/*  76 */       CCommitItemReq _o_ = (CCommitItemReq)_o1_;
...
/*     */   }
/*     */   
/*     */   public int compareTo(CCommitItemReq _o_) {
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\worldgoal\CCommitItemReq.class
