...
/*     */ 
/*     */ public class STYuanCostCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, STYuanCostCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, STYuanCostCfg> all = null;
/*     */   
/*     */   public int costId;
/*  19 */   public HashMap<Integer, Integer> yuanLv2needNum = new HashMap();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.costId = Integer.valueOf(rootElement.attributeValue("costId")).intValue();
/*     */     
/*  25 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "yuanLv2needNum");
...
/*     */         }
/*     */         
/*  76 */         this.yuanLv2needNum.put(Integer.valueOf(_k_), Integer.valueOf(_v_));
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*     */   {
/*  83 */     _os_.marshal(this.costId);
/*  84 */     _os_.compact_uint32(this.yuanLv2needNum.size());
/*  85 */     for (java.util.Map.Entry<Integer, Integer> _e_ : this.yuanLv2needNum.entrySet())
/*     */     {
...
/*     */   {
/*  95 */     this.costId = _os_.unmarshal_int();
...
/* 102 */       this.yuanLv2needNum.put(Integer.valueOf(_k_), Integer.valueOf(_v_));
/*     */     }
/* 104 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/* 109 */     String path = dir + "mzm.gsp.partner.confbean.STYuanCostCfg.xml";
/*     */     
/*     */     try
/*     */     {
/* 113 */       all = new HashMap();
...
/* 122 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.partner.confbean.STYuanCostCfg"))
/*     */         {
/*     */ 
/* 125 */           STYuanCostCfg obj = new STYuanCostCfg();
/* 126 */           obj.loadFromXml(elem);
/* 127 */           if (all.put(Integer.valueOf(obj.costId), obj) != null) {
/* 128 */             throw new RuntimeException("duplicate key : " + obj.costId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, STYuanCostCfg> all)
/*     */   {
/* 139 */     String path = dir + "mzm.gsp.partner.confbean.STYuanCostCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 151 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.partner.confbean.STYuanCostCfg"))
/*     */         {
/*     */ 
/* 154 */           STYuanCostCfg obj = new STYuanCostCfg();
/* 155 */           obj.loadFromXml(elem);
/* 156 */           if (all.put(Integer.valueOf(obj.costId), obj) != null) {
/* 157 */             throw new RuntimeException("duplicate key : " + obj.costId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/* 168 */     all = new HashMap();
/*     */     
/* 170 */     String path = dir + "mzm.gsp.partner.confbean.STYuanCostCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 197 */           STYuanCostCfg _v_ = new STYuanCostCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, STYuanCostCfg> all)
/*     */   {
/* 217 */     String path = dir + "mzm.gsp.partner.confbean.STYuanCostCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 244 */           STYuanCostCfg _v_ = new STYuanCostCfg();
...
/*     */ 
/*     */ 
/*     */   public static STYuanCostCfg getOld(int key)
/*     */   {
/* 265 */     return (STYuanCostCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static STYuanCostCfg get(int key)
/*     */   {
/* 270 */     return (STYuanCostCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, STYuanCostCfg> getOldAll()
/*     */   {
/* 275 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, STYuanCostCfg> getAll()
/*     */   {
/* 280 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, STYuanCostCfg> newAll)
/*     */   {
/* 285 */     oldAll = all;
/* 286 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\partner\confbean\STYuanCostCfg.class
