...
/*     */ 
/*     */ public class SLoveLibCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SLoveLibCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SLoveLibCfg> all = null;
/*     */   
/*     */   public int id;
/*  19 */   public java.util.ArrayList<LoveId2Weight> LoveId2WeightList = new java.util.ArrayList();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.id = Integer.valueOf(rootElement.attributeValue("id")).intValue();
/*     */     
/*  25 */     Element collectionElement = util.XmlHelper.getVariableElement(rootElement, "LoveId2WeightList");
...
/*  36 */       if (elem.getName().equalsIgnoreCase("mzm.gsp.partner.confbean.LoveId2Weight"))
/*     */       {
/*     */         LoveId2Weight _v_;
/*     */         
/*     */ 
...
/*     */         }
/*     */         
/*  51 */         this.LoveId2WeightList.add(_v_);
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*  59 */     _os_.compact_uint32(this.LoveId2WeightList.size());
/*  60 */     for (LoveId2Weight _v_ : this.LoveId2WeightList)
/*     */     {
/*  62 */       _os_.marshal(_v_);
/*     */     }
/*  64 */     return _os_;
...
/*     */     {
/*     */ 
/*  73 */       LoveId2Weight _v_ = new LoveId2Weight();
/*  74 */       _v_.unmarshal(_os_);
/*  75 */       this.LoveId2WeightList.add(_v_);
/*     */     }
/*  77 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/*  82 */     String path = dir + "mzm.gsp.partner.confbean.SLoveLibCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  95 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.partner.confbean.SLoveLibCfg"))
/*     */         {
/*     */ 
/*  98 */           SLoveLibCfg obj = new SLoveLibCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SLoveLibCfg> all)
/*     */   {
/* 112 */     String path = dir + "mzm.gsp.partner.confbean.SLoveLibCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 124 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.partner.confbean.SLoveLibCfg"))
/*     */         {
/*     */ 
/* 127 */           SLoveLibCfg obj = new SLoveLibCfg();
...
/*     */     
/* 143 */     String path = dir + "mzm.gsp.partner.confbean.SLoveLibCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 170 */           SLoveLibCfg _v_ = new SLoveLibCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SLoveLibCfg> all)
/*     */   {
/* 190 */     String path = dir + "mzm.gsp.partner.confbean.SLoveLibCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 217 */           SLoveLibCfg _v_ = new SLoveLibCfg();
...
/*     */ 
/*     */ 
/*     */   public static SLoveLibCfg getOld(int key)
/*     */   {
/* 238 */     return (SLoveLibCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SLoveLibCfg get(int key)
/*     */   {
/* 243 */     return (SLoveLibCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SLoveLibCfg> getOldAll()
/*     */   {
/* 248 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SLoveLibCfg> getAll()
/*     */   {
/* 253 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SLoveLibCfg> newAll)
/*     */   {
/* 258 */     oldAll = all;
/* 259 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\partner\confbean\SLoveLibCfg.class
