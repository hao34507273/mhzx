...
/*     */ 
/*     */ public class SPartnerRankCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SPartnerRankCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SPartnerRankCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public int rankId;
/*     */   public int yuanLv;
...
/*  26 */     this.rankId = Integer.valueOf(rootElement.attributeValue("rankId")).intValue();
/*  27 */     this.yuanLv = Integer.valueOf(rootElement.attributeValue("yuanLv")).intValue();
/*  28 */     this.rankData = Integer.valueOf(rootElement.attributeValue("rankData")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  33 */     _os_.marshal(this.id);
/*  34 */     _os_.marshal(this.rankId);
/*  35 */     _os_.marshal(this.yuanLv);
/*  36 */     _os_.marshal(this.rankData);
/*  37 */     return _os_;
/*     */   }
/*     */   
...
/*  43 */     this.rankId = _os_.unmarshal_int();
/*  44 */     this.yuanLv = _os_.unmarshal_int();
/*  45 */     this.rankData = _os_.unmarshal_int();
/*  46 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  51 */     String path = dir + "mzm.gsp.partner.confbean.SPartnerRankCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  64 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.partner.confbean.SPartnerRankCfg"))
/*     */         {
/*     */ 
/*  67 */           SPartnerRankCfg obj = new SPartnerRankCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SPartnerRankCfg> all)
/*     */   {
/*  81 */     String path = dir + "mzm.gsp.partner.confbean.SPartnerRankCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.partner.confbean.SPartnerRankCfg"))
/*     */         {
/*     */ 
/*  96 */           SPartnerRankCfg obj = new SPartnerRankCfg();
...
/*     */     
/* 112 */     String path = dir + "mzm.gsp.partner.confbean.SPartnerRankCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 139 */           SPartnerRankCfg _v_ = new SPartnerRankCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SPartnerRankCfg> all)
/*     */   {
/* 159 */     String path = dir + "mzm.gsp.partner.confbean.SPartnerRankCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 186 */           SPartnerRankCfg _v_ = new SPartnerRankCfg();
...
/*     */ 
/*     */ 
/*     */   public static SPartnerRankCfg getOld(int key)
/*     */   {
/* 207 */     return (SPartnerRankCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SPartnerRankCfg get(int key)
/*     */   {
/* 212 */     return (SPartnerRankCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPartnerRankCfg> getOldAll()
/*     */   {
/* 217 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPartnerRankCfg> getAll()
/*     */   {
/* 222 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SPartnerRankCfg> newAll)
/*     */   {
/* 227 */     oldAll = all;
/* 228 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\partner\confbean\SPartnerRankCfg.class
