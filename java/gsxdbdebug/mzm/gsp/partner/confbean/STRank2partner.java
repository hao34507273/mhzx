...
/*     */ 
/*     */ public class STRank2partner implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, STRank2partner> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, STRank2partner> all = null;
/*     */   
/*     */   public int rank;
/*  19 */   public java.util.ArrayList<Integer> partnerIds = new java.util.ArrayList();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.rank = Integer.valueOf(rootElement.attributeValue("rank")).intValue();
/*     */     
/*  25 */     Element collectionElement = util.XmlHelper.getVariableElement(rootElement, "partnerIds");
...
/*     */         }
/*     */         
/*  50 */         this.partnerIds.add(Integer.valueOf(_v_));
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*  58 */     _os_.compact_uint32(this.partnerIds.size());
/*  59 */     for (Integer _v_ : this.partnerIds)
/*     */     {
...
/*  73 */       this.partnerIds.add(Integer.valueOf(_v_));
/*     */     }
/*  75 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/*  80 */     String path = dir + "mzm.gsp.partner.confbean.STRank2partner.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.partner.confbean.STRank2partner"))
/*     */         {
/*     */ 
/*  96 */           STRank2partner obj = new STRank2partner();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, STRank2partner> all)
/*     */   {
/* 110 */     String path = dir + "mzm.gsp.partner.confbean.STRank2partner.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 122 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.partner.confbean.STRank2partner"))
/*     */         {
/*     */ 
/* 125 */           STRank2partner obj = new STRank2partner();
...
/*     */     
/* 141 */     String path = dir + "mzm.gsp.partner.confbean.STRank2partner.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 168 */           STRank2partner _v_ = new STRank2partner();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, STRank2partner> all)
/*     */   {
/* 188 */     String path = dir + "mzm.gsp.partner.confbean.STRank2partner.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 215 */           STRank2partner _v_ = new STRank2partner();
...
/*     */ 
/*     */ 
/*     */   public static STRank2partner getOld(int key)
/*     */   {
/* 236 */     return (STRank2partner)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static STRank2partner get(int key)
/*     */   {
/* 241 */     return (STRank2partner)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, STRank2partner> getOldAll()
/*     */   {
/* 246 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, STRank2partner> getAll()
/*     */   {
/* 251 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, STRank2partner> newAll)
/*     */   {
/* 256 */     oldAll = all;
/* 257 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\partner\confbean\STRank2partner.class
