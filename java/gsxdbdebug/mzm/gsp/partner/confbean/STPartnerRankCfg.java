...
/*     */ 
/*     */ public class STPartnerRankCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, STPartnerRankCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, STPartnerRankCfg> all = null;
/*     */   
/*     */   public int rankId;
/*  19 */   public HashMap<Integer, Integer> yuanLv2rankCfgId = new HashMap();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.rankId = Integer.valueOf(rootElement.attributeValue("rankId")).intValue();
/*     */     
/*  25 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "yuanLv2rankCfgId");
...
/*     */         }
/*     */         
/*  76 */         this.yuanLv2rankCfgId.put(Integer.valueOf(_k_), Integer.valueOf(_v_));
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*     */   {
/*  83 */     _os_.marshal(this.rankId);
/*  84 */     _os_.compact_uint32(this.yuanLv2rankCfgId.size());
/*  85 */     for (java.util.Map.Entry<Integer, Integer> _e_ : this.yuanLv2rankCfgId.entrySet())
/*     */     {
...
/*     */   {
/*  95 */     this.rankId = _os_.unmarshal_int();
...
/* 102 */       this.yuanLv2rankCfgId.put(Integer.valueOf(_k_), Integer.valueOf(_v_));
/*     */     }
/* 104 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/* 109 */     String path = dir + "mzm.gsp.partner.confbean.STPartnerRankCfg.xml";
/*     */     
/*     */     try
/*     */     {
/* 113 */       all = new HashMap();
...
/* 122 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.partner.confbean.STPartnerRankCfg"))
/*     */         {
/*     */ 
/* 125 */           STPartnerRankCfg obj = new STPartnerRankCfg();
/* 126 */           obj.loadFromXml(elem);
/* 127 */           if (all.put(Integer.valueOf(obj.rankId), obj) != null) {
/* 128 */             throw new RuntimeException("duplicate key : " + obj.rankId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, STPartnerRankCfg> all)
/*     */   {
/* 139 */     String path = dir + "mzm.gsp.partner.confbean.STPartnerRankCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 151 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.partner.confbean.STPartnerRankCfg"))
/*     */         {
/*     */ 
/* 154 */           STPartnerRankCfg obj = new STPartnerRankCfg();
/* 155 */           obj.loadFromXml(elem);
/* 156 */           if (all.put(Integer.valueOf(obj.rankId), obj) != null) {
/* 157 */             throw new RuntimeException("duplicate key : " + obj.rankId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/* 168 */     all = new HashMap();
/*     */     
/* 170 */     String path = dir + "mzm.gsp.partner.confbean.STPartnerRankCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 197 */           STPartnerRankCfg _v_ = new STPartnerRankCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, STPartnerRankCfg> all)
/*     */   {
/* 217 */     String path = dir + "mzm.gsp.partner.confbean.STPartnerRankCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 244 */           STPartnerRankCfg _v_ = new STPartnerRankCfg();
...
/*     */ 
/*     */ 
/*     */   public static STPartnerRankCfg getOld(int key)
/*     */   {
/* 265 */     return (STPartnerRankCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static STPartnerRankCfg get(int key)
/*     */   {
/* 270 */     return (STPartnerRankCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, STPartnerRankCfg> getOldAll()
/*     */   {
/* 275 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, STPartnerRankCfg> getAll()
/*     */   {
/* 280 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, STPartnerRankCfg> newAll)
/*     */   {
/* 285 */     oldAll = all;
/* 286 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\partner\confbean\STPartnerRankCfg.class
