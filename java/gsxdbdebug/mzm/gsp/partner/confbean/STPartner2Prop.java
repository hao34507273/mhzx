...
/*     */ 
/*     */ public class STPartner2Prop implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, STPartner2Prop> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, STPartner2Prop> all = null;
/*     */   
/*     */   public int partnerId;
/*  19 */   public HashMap<Integer, STPropPerLevel> level2value = new HashMap();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.partnerId = Integer.valueOf(rootElement.attributeValue("partnerId")).intValue();
/*     */     
/*  25 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "level2value");
...
/*  51 */             keyElem = elem;
/*     */           }
/*  53 */           else if ((valueElem == null) && (elem.getName().equalsIgnoreCase("mzm.gsp.partner.confbean.STPropPerLevel")))
/*     */           {
/*  55 */             valueElem = elem;
/*     */           }
/*     */         }
...
/*     */         }
/*     */         
/*  77 */         this.level2value.put(Integer.valueOf(_k_), _v_);
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*     */   {
/*  84 */     _os_.marshal(this.partnerId);
/*  85 */     _os_.compact_uint32(this.level2value.size());
/*  86 */     for (java.util.Map.Entry<Integer, STPropPerLevel> _e_ : this.level2value.entrySet())
/*     */     {
...
/*     */   {
/*  96 */     this.partnerId = _os_.unmarshal_int();
/*  97 */     for (int _size_ = _os_.uncompact_uint32(); _size_ > 0; _size_--)
/*     */     {
/*     */ 
/* 100 */       int _k_ = _os_.unmarshal_int();
/*     */       
/* 102 */       STPropPerLevel _v_ = new STPropPerLevel();
/* 103 */       _v_.unmarshal(_os_);
/* 104 */       this.level2value.put(Integer.valueOf(_k_), _v_);
/*     */     }
/* 106 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/* 111 */     String path = dir + "mzm.gsp.partner.confbean.STPartner2Prop.xml";
/*     */     
/*     */     try
/*     */     {
/* 115 */       all = new HashMap();
...
/* 124 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.partner.confbean.STPartner2Prop"))
/*     */         {
/*     */ 
/* 127 */           STPartner2Prop obj = new STPartner2Prop();
/* 128 */           obj.loadFromXml(elem);
/* 129 */           if (all.put(Integer.valueOf(obj.partnerId), obj) != null) {
/* 130 */             throw new RuntimeException("duplicate key : " + obj.partnerId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, STPartner2Prop> all)
/*     */   {
/* 141 */     String path = dir + "mzm.gsp.partner.confbean.STPartner2Prop.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 153 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.partner.confbean.STPartner2Prop"))
/*     */         {
/*     */ 
/* 156 */           STPartner2Prop obj = new STPartner2Prop();
/* 157 */           obj.loadFromXml(elem);
/* 158 */           if (all.put(Integer.valueOf(obj.partnerId), obj) != null) {
/* 159 */             throw new RuntimeException("duplicate key : " + obj.partnerId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/* 170 */     all = new HashMap();
/*     */     
/* 172 */     String path = dir + "mzm.gsp.partner.confbean.STPartner2Prop.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 199 */           STPartner2Prop _v_ = new STPartner2Prop();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, STPartner2Prop> all)
/*     */   {
/* 219 */     String path = dir + "mzm.gsp.partner.confbean.STPartner2Prop.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 246 */           STPartner2Prop _v_ = new STPartner2Prop();
...
/*     */ 
/*     */ 
/*     */   public static STPartner2Prop getOld(int key)
/*     */   {
/* 267 */     return (STPartner2Prop)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static STPartner2Prop get(int key)
/*     */   {
/* 272 */     return (STPartner2Prop)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, STPartner2Prop> getOldAll()
/*     */   {
/* 277 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, STPartner2Prop> getAll()
/*     */   {
/* 282 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, STPartner2Prop> newAll)
/*     */   {
/* 287 */     oldAll = all;
/* 288 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\partner\confbean\STPartner2Prop.class
