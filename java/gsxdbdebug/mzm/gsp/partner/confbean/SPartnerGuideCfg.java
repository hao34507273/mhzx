...
/*     */ 
/*     */ public class SPartnerGuideCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SPartnerGuideCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SPartnerGuideCfg> all = null;
/*     */   
/*     */   public int id;
...
/*  28 */     this.partnerId = Integer.valueOf(rootElement.attributeValue("partnerId")).intValue();
...
/*  37 */     _os_.marshal(this.partnerId);
/*  38 */     _os_.marshal(this.graphId);
/*  39 */     _os_.marshal(this.taskId);
/*  40 */     return _os_;
/*     */   }
/*     */   
...
/*  47 */     this.partnerId = _os_.unmarshal_int();
/*  48 */     this.graphId = _os_.unmarshal_int();
/*  49 */     this.taskId = _os_.unmarshal_int();
/*  50 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  55 */     String path = dir + "mzm.gsp.partner.confbean.SPartnerGuideCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  68 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.partner.confbean.SPartnerGuideCfg"))
/*     */         {
/*     */ 
/*  71 */           SPartnerGuideCfg obj = new SPartnerGuideCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SPartnerGuideCfg> all)
/*     */   {
/*  85 */     String path = dir + "mzm.gsp.partner.confbean.SPartnerGuideCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  97 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.partner.confbean.SPartnerGuideCfg"))
/*     */         {
/*     */ 
/* 100 */           SPartnerGuideCfg obj = new SPartnerGuideCfg();
...
/*     */     
/* 116 */     String path = dir + "mzm.gsp.partner.confbean.SPartnerGuideCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 143 */           SPartnerGuideCfg _v_ = new SPartnerGuideCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SPartnerGuideCfg> all)
/*     */   {
/* 163 */     String path = dir + "mzm.gsp.partner.confbean.SPartnerGuideCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 190 */           SPartnerGuideCfg _v_ = new SPartnerGuideCfg();
...
/*     */ 
/*     */ 
/*     */   public static SPartnerGuideCfg getOld(int key)
/*     */   {
/* 211 */     return (SPartnerGuideCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SPartnerGuideCfg get(int key)
/*     */   {
/* 216 */     return (SPartnerGuideCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPartnerGuideCfg> getOldAll()
/*     */   {
/* 221 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPartnerGuideCfg> getAll()
/*     */   {
/* 226 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SPartnerGuideCfg> newAll)
/*     */   {
/* 231 */     oldAll = all;
/* 232 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\partner\confbean\SPartnerGuideCfg.class
