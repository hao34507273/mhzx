...
/*     */ 
/*     */ public class SPartner2PropertyChange implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SPartner2PropertyChange> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SPartner2PropertyChange> all = null;
/*     */   
/*     */   public int id;
/*     */   public String templateName;
/*     */   public int LV1Property;
/*     */   public int LV2Property;
...
/*  28 */     this.LV1Property = Integer.valueOf(rootElement.attributeValue("LV1Property")).intValue();
/*  29 */     this.LV2Property = Integer.valueOf(rootElement.attributeValue("LV2Property")).intValue();
/*  30 */     this.effectValue = Double.valueOf(rootElement.attributeValue("effectValue")).doubleValue();
/*     */   }
/*     */   
...
/*  37 */     _os_.marshal(this.LV1Property);
/*  38 */     _os_.marshal(this.LV2Property);
/*  39 */     _os_.marshal(this.effectValue);
/*  40 */     return _os_;
/*     */   }
/*     */   
...
/*  47 */     this.LV1Property = _os_.unmarshal_int();
/*  48 */     this.LV2Property = _os_.unmarshal_int();
/*  49 */     this.effectValue = _os_.unmarshal_float();
/*  50 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  55 */     String path = dir + "mzm.gsp.partner.confbean.SPartner2PropertyChange.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  68 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.partner.confbean.SPartner2PropertyChange"))
/*     */         {
/*     */ 
/*  71 */           SPartner2PropertyChange obj = new SPartner2PropertyChange();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SPartner2PropertyChange> all)
/*     */   {
/*  85 */     String path = dir + "mzm.gsp.partner.confbean.SPartner2PropertyChange.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  97 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.partner.confbean.SPartner2PropertyChange"))
/*     */         {
/*     */ 
/* 100 */           SPartner2PropertyChange obj = new SPartner2PropertyChange();
...
/*     */     
/* 116 */     String path = dir + "mzm.gsp.partner.confbean.SPartner2PropertyChange.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 143 */           SPartner2PropertyChange _v_ = new SPartner2PropertyChange();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SPartner2PropertyChange> all)
/*     */   {
/* 163 */     String path = dir + "mzm.gsp.partner.confbean.SPartner2PropertyChange.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 190 */           SPartner2PropertyChange _v_ = new SPartner2PropertyChange();
...
/*     */ 
/*     */ 
/*     */   public static SPartner2PropertyChange getOld(int key)
/*     */   {
/* 211 */     return (SPartner2PropertyChange)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SPartner2PropertyChange get(int key)
/*     */   {
/* 216 */     return (SPartner2PropertyChange)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPartner2PropertyChange> getOldAll()
/*     */   {
/* 221 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPartner2PropertyChange> getAll()
/*     */   {
/* 226 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SPartner2PropertyChange> newAll)
/*     */   {
/* 231 */     oldAll = all;
/* 232 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\partner\confbean\SPartner2PropertyChange.class
