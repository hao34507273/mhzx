...
/*     */ 
/*     */ public class SRankInfo implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SRankInfo> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SRankInfo> all = null;
/*     */   
/*     */   public int id;
/*     */   public int rankEnum;
/*     */   public int color;
...
/*  26 */     this.rankEnum = Integer.valueOf(rootElement.attributeValue("rankEnum")).intValue();
/*  27 */     this.color = Integer.valueOf(rootElement.attributeValue("color")).intValue();
/*  28 */     this.rankValue = Double.valueOf(rootElement.attributeValue("rankValue")).doubleValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  33 */     _os_.marshal(this.id);
/*  34 */     _os_.marshal(this.rankEnum);
/*  35 */     _os_.marshal(this.color);
/*  36 */     _os_.marshal(this.rankValue);
/*  37 */     return _os_;
/*     */   }
/*     */   
...
/*  43 */     this.rankEnum = _os_.unmarshal_int();
/*  44 */     this.color = _os_.unmarshal_int();
/*  45 */     this.rankValue = _os_.unmarshal_float();
/*  46 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  51 */     String path = dir + "mzm.gsp.partner.confbean.SRankInfo.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  64 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.partner.confbean.SRankInfo"))
/*     */         {
/*     */ 
/*  67 */           SRankInfo obj = new SRankInfo();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SRankInfo> all)
/*     */   {
/*  81 */     String path = dir + "mzm.gsp.partner.confbean.SRankInfo.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.partner.confbean.SRankInfo"))
/*     */         {
/*     */ 
/*  96 */           SRankInfo obj = new SRankInfo();
...
/*     */     
/* 112 */     String path = dir + "mzm.gsp.partner.confbean.SRankInfo.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 139 */           SRankInfo _v_ = new SRankInfo();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SRankInfo> all)
/*     */   {
/* 159 */     String path = dir + "mzm.gsp.partner.confbean.SRankInfo.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 186 */           SRankInfo _v_ = new SRankInfo();
...
/*     */ 
/*     */ 
/*     */   public static SRankInfo getOld(int key)
/*     */   {
/* 207 */     return (SRankInfo)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SRankInfo get(int key)
/*     */   {
/* 212 */     return (SRankInfo)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SRankInfo> getOldAll()
/*     */   {
/* 217 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SRankInfo> getAll()
/*     */   {
/* 222 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SRankInfo> newAll)
/*     */   {
/* 227 */     oldAll = all;
/* 228 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\partner\confbean\SRankInfo.class
