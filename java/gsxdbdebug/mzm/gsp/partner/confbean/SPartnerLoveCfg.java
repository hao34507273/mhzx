...
/*     */ 
/*     */ public class SPartnerLoveCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SPartnerLoveCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SPartnerLoveCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public String templateName;
/*  20 */   public java.util.ArrayList<LoveId2Rate> LoveId2RateList = new java.util.ArrayList();
/*     */   
...
/*     */     
/*  27 */     Element collectionElement = util.XmlHelper.getVariableElement(rootElement, "LoveId2RateList");
...
/*  38 */       if (elem.getName().equalsIgnoreCase("mzm.gsp.partner.confbean.LoveId2Rate"))
/*     */       {
/*     */         LoveId2Rate _v_;
/*     */         
/*     */ 
...
/*     */         }
/*     */         
/*  53 */         this.LoveId2RateList.add(_v_);
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*  62 */     _os_.compact_uint32(this.LoveId2RateList.size());
/*  63 */     for (LoveId2Rate _v_ : this.LoveId2RateList)
/*     */     {
/*  65 */       _os_.marshal(_v_);
/*     */     }
/*  67 */     return _os_;
...
/*     */     {
/*     */ 
/*  77 */       LoveId2Rate _v_ = new LoveId2Rate();
/*  78 */       _v_.unmarshal(_os_);
/*  79 */       this.LoveId2RateList.add(_v_);
/*     */     }
/*  81 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/*  86 */     String path = dir + "mzm.gsp.partner.confbean.SPartnerLoveCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  99 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.partner.confbean.SPartnerLoveCfg"))
/*     */         {
/*     */ 
/* 102 */           SPartnerLoveCfg obj = new SPartnerLoveCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SPartnerLoveCfg> all)
/*     */   {
/* 116 */     String path = dir + "mzm.gsp.partner.confbean.SPartnerLoveCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 128 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.partner.confbean.SPartnerLoveCfg"))
/*     */         {
/*     */ 
/* 131 */           SPartnerLoveCfg obj = new SPartnerLoveCfg();
...
/*     */     
/* 147 */     String path = dir + "mzm.gsp.partner.confbean.SPartnerLoveCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 174 */           SPartnerLoveCfg _v_ = new SPartnerLoveCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SPartnerLoveCfg> all)
/*     */   {
/* 194 */     String path = dir + "mzm.gsp.partner.confbean.SPartnerLoveCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 221 */           SPartnerLoveCfg _v_ = new SPartnerLoveCfg();
...
/*     */ 
/*     */ 
/*     */   public static SPartnerLoveCfg getOld(int key)
/*     */   {
/* 242 */     return (SPartnerLoveCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SPartnerLoveCfg get(int key)
/*     */   {
/* 247 */     return (SPartnerLoveCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPartnerLoveCfg> getOldAll()
/*     */   {
/* 252 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPartnerLoveCfg> getAll()
/*     */   {
/* 257 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SPartnerLoveCfg> newAll)
/*     */   {
/* 262 */     oldAll = all;
/* 263 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\partner\confbean\SPartnerLoveCfg.class
