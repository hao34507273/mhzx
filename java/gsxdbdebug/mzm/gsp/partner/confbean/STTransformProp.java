...
/*     */ 
/*     */ public class STTransformProp implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, STTransformProp> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, STTransformProp> all = null;
/*     */   
...
/*     */   {
/* 109 */     String path = dir + "mzm.gsp.partner.confbean.STTransformProp.xml";
/*     */     
/*     */     try
/*     */     {
/* 113 */       all = new HashMap();
...
/* 122 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.partner.confbean.STTransformProp"))
/*     */         {
/*     */ 
/* 125 */           STTransformProp obj = new STTransformProp();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, STTransformProp> all)
/*     */   {
/* 139 */     String path = dir + "mzm.gsp.partner.confbean.STTransformProp.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 151 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.partner.confbean.STTransformProp"))
/*     */         {
/*     */ 
/* 154 */           STTransformProp obj = new STTransformProp();
...
/* 168 */     all = new HashMap();
/*     */     
/* 170 */     String path = dir + "mzm.gsp.partner.confbean.STTransformProp.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 197 */           STTransformProp _v_ = new STTransformProp();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, STTransformProp> all)
/*     */   {
/* 217 */     String path = dir + "mzm.gsp.partner.confbean.STTransformProp.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 244 */           STTransformProp _v_ = new STTransformProp();
...
/*     */ 
/*     */ 
/*     */   public static STTransformProp getOld(int key)
/*     */   {
/* 265 */     return (STTransformProp)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static STTransformProp get(int key)
/*     */   {
/* 270 */     return (STTransformProp)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, STTransformProp> getOldAll()
/*     */   {
/* 275 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, STTransformProp> getAll()
/*     */   {
/* 280 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, STTransformProp> newAll)
/*     */   {
/* 285 */     oldAll = all;
/* 286 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\partner\confbean\STTransformProp.class
