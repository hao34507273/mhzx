...
/*     */ 
/*     */ public class STTask2partner implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, STTask2partner> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, STTask2partner> all = null;
/*     */   
/*     */   public int taskId;
/*  19 */   public HashMap<Integer, Integer> graphId2partner = new HashMap();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.taskId = Integer.valueOf(rootElement.attributeValue("taskId")).intValue();
/*     */     
/*  25 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "graphId2partner");
...
/*     */         }
/*     */         
/*  76 */         this.graphId2partner.put(Integer.valueOf(_k_), Integer.valueOf(_v_));
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*     */   {
/*  83 */     _os_.marshal(this.taskId);
/*  84 */     _os_.compact_uint32(this.graphId2partner.size());
/*  85 */     for (java.util.Map.Entry<Integer, Integer> _e_ : this.graphId2partner.entrySet())
/*     */     {
...
/*     */   {
/*  95 */     this.taskId = _os_.unmarshal_int();
...
/* 102 */       this.graphId2partner.put(Integer.valueOf(_k_), Integer.valueOf(_v_));
/*     */     }
/* 104 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/* 109 */     String path = dir + "mzm.gsp.partner.confbean.STTask2partner.xml";
/*     */     
/*     */     try
/*     */     {
/* 113 */       all = new HashMap();
...
/* 122 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.partner.confbean.STTask2partner"))
/*     */         {
/*     */ 
/* 125 */           STTask2partner obj = new STTask2partner();
/* 126 */           obj.loadFromXml(elem);
/* 127 */           if (all.put(Integer.valueOf(obj.taskId), obj) != null) {
/* 128 */             throw new RuntimeException("duplicate key : " + obj.taskId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, STTask2partner> all)
/*     */   {
/* 139 */     String path = dir + "mzm.gsp.partner.confbean.STTask2partner.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 151 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.partner.confbean.STTask2partner"))
/*     */         {
/*     */ 
/* 154 */           STTask2partner obj = new STTask2partner();
/* 155 */           obj.loadFromXml(elem);
/* 156 */           if (all.put(Integer.valueOf(obj.taskId), obj) != null) {
/* 157 */             throw new RuntimeException("duplicate key : " + obj.taskId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/* 168 */     all = new HashMap();
/*     */     
/* 170 */     String path = dir + "mzm.gsp.partner.confbean.STTask2partner.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 197 */           STTask2partner _v_ = new STTask2partner();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, STTask2partner> all)
/*     */   {
/* 217 */     String path = dir + "mzm.gsp.partner.confbean.STTask2partner.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 244 */           STTask2partner _v_ = new STTask2partner();
...
/*     */ 
/*     */ 
/*     */   public static STTask2partner getOld(int key)
/*     */   {
/* 265 */     return (STTask2partner)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static STTask2partner get(int key)
/*     */   {
/* 270 */     return (STTask2partner)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, STTask2partner> getOldAll()
/*     */   {
/* 275 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, STTask2partner> getAll()
/*     */   {
/* 280 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, STTask2partner> newAll)
/*     */   {
/* 285 */     oldAll = all;
/* 286 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\partner\confbean\STTask2partner.class
