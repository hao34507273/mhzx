...
/*     */ 
/*     */ public class SYuanCostCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SYuanCostCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SYuanCostCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public int costId;
/*     */   public int yuanLv;
...
/*  28 */     this.needNum = Integer.valueOf(rootElement.attributeValue("needNum")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  33 */     _os_.marshal(this.id);
/*  34 */     _os_.marshal(this.costId);
/*  35 */     _os_.marshal(this.yuanLv);
/*  36 */     _os_.marshal(this.needNum);
/*  37 */     return _os_;
/*     */   }
/*     */   
...
/*  43 */     this.costId = _os_.unmarshal_int();
/*  44 */     this.yuanLv = _os_.unmarshal_int();
/*  45 */     this.needNum = _os_.unmarshal_int();
/*  46 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  51 */     String path = dir + "mzm.gsp.partner.confbean.SYuanCostCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  64 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.partner.confbean.SYuanCostCfg"))
/*     */         {
/*     */ 
/*  67 */           SYuanCostCfg obj = new SYuanCostCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SYuanCostCfg> all)
/*     */   {
/*  81 */     String path = dir + "mzm.gsp.partner.confbean.SYuanCostCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.partner.confbean.SYuanCostCfg"))
/*     */         {
/*     */ 
/*  96 */           SYuanCostCfg obj = new SYuanCostCfg();
...
/*     */     
/* 112 */     String path = dir + "mzm.gsp.partner.confbean.SYuanCostCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 139 */           SYuanCostCfg _v_ = new SYuanCostCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SYuanCostCfg> all)
/*     */   {
/* 159 */     String path = dir + "mzm.gsp.partner.confbean.SYuanCostCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 186 */           SYuanCostCfg _v_ = new SYuanCostCfg();
...
/*     */ 
/*     */ 
/*     */   public static SYuanCostCfg getOld(int key)
/*     */   {
/* 207 */     return (SYuanCostCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SYuanCostCfg get(int key)
/*     */   {
/* 212 */     return (SYuanCostCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SYuanCostCfg> getOldAll()
/*     */   {
/* 217 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SYuanCostCfg> getAll()
/*     */   {
/* 222 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SYuanCostCfg> newAll)
/*     */   {
/* 227 */     oldAll = all;
/* 228 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\partner\confbean\SYuanCostCfg.class
