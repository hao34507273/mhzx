...
/*     */ 
/*     */ public class SPartnerYuanShenCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SPartnerYuanShenCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SPartnerYuanShenCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public int costId;
/*     */   public int costItemId;
/*  21 */   public java.util.ArrayList<Integer> pasSkillIds = new java.util.ArrayList();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  25 */     this.id = Integer.valueOf(rootElement.attributeValue("id")).intValue();
/*  26 */     this.costId = Integer.valueOf(rootElement.attributeValue("costId")).intValue();
/*  27 */     this.costItemId = Integer.valueOf(rootElement.attributeValue("costItemId")).intValue();
/*     */     
/*  29 */     Element collectionElement = util.XmlHelper.getVariableElement(rootElement, "pasSkillIds");
...
/*     */         }
/*     */         
/*  54 */         this.pasSkillIds.add(Integer.valueOf(_v_));
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*  62 */     _os_.marshal(this.costId);
/*  63 */     _os_.marshal(this.costItemId);
/*  64 */     _os_.compact_uint32(this.pasSkillIds.size());
/*  65 */     for (Integer _v_ : this.pasSkillIds)
/*     */     {
...
/*  75 */     this.costId = _os_.unmarshal_int();
/*  76 */     this.costItemId = _os_.unmarshal_int();
/*  77 */     for (int _size_ = _os_.uncompact_uint32(); _size_ > 0; _size_--)
/*     */     {
/*     */ 
/*  80 */       int _v_ = _os_.unmarshal_int();
/*  81 */       this.pasSkillIds.add(Integer.valueOf(_v_));
/*     */     }
/*  83 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/*  88 */     String path = dir + "mzm.gsp.partner.confbean.SPartnerYuanShenCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 101 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.partner.confbean.SPartnerYuanShenCfg"))
/*     */         {
/*     */ 
/* 104 */           SPartnerYuanShenCfg obj = new SPartnerYuanShenCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SPartnerYuanShenCfg> all)
/*     */   {
/* 118 */     String path = dir + "mzm.gsp.partner.confbean.SPartnerYuanShenCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 130 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.partner.confbean.SPartnerYuanShenCfg"))
/*     */         {
/*     */ 
/* 133 */           SPartnerYuanShenCfg obj = new SPartnerYuanShenCfg();
...
/*     */     
/* 149 */     String path = dir + "mzm.gsp.partner.confbean.SPartnerYuanShenCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 176 */           SPartnerYuanShenCfg _v_ = new SPartnerYuanShenCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SPartnerYuanShenCfg> all)
/*     */   {
/* 196 */     String path = dir + "mzm.gsp.partner.confbean.SPartnerYuanShenCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 223 */           SPartnerYuanShenCfg _v_ = new SPartnerYuanShenCfg();
...
/*     */ 
/*     */ 
/*     */   public static SPartnerYuanShenCfg getOld(int key)
/*     */   {
/* 244 */     return (SPartnerYuanShenCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SPartnerYuanShenCfg get(int key)
/*     */   {
/* 249 */     return (SPartnerYuanShenCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPartnerYuanShenCfg> getOldAll()
/*     */   {
/* 254 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPartnerYuanShenCfg> getAll()
/*     */   {
/* 259 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SPartnerYuanShenCfg> newAll)
/*     */   {
/* 264 */     oldAll = all;
/* 265 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\partner\confbean\SPartnerYuanShenCfg.class
