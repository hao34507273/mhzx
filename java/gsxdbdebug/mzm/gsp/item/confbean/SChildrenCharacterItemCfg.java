...
/*     */ 
/*     */ public class SChildrenCharacterItemCfg extends SItemCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  15 */   private static volatile Map<Integer, SChildrenCharacterItemCfg> oldAll = null;
/*     */   
/*  17 */   private static Map<Integer, SChildrenCharacterItemCfg> all = null;
/*     */   
...
/*  36 */     this.addCharacter = Integer.valueOf(rootElement.attributeValue("addCharacter")).intValue();
/*     */   }
/*     */   
...
/*  54 */     _os_.marshal(this.addCharacter);
/*  55 */     return _os_;
/*     */   }
/*     */   
...
/*  73 */     this.addCharacter = _os_.unmarshal_int();
/*  74 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  79 */     String path = dir + "mzm.gsp.item.confbean.SChildrenCharacterItemCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  92 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SChildrenCharacterItemCfg"))
/*     */         {
/*     */ 
/*  95 */           SChildrenCharacterItemCfg obj = new SChildrenCharacterItemCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SChildrenCharacterItemCfg> all)
/*     */   {
/* 109 */     String path = dir + "mzm.gsp.item.confbean.SChildrenCharacterItemCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 121 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SChildrenCharacterItemCfg"))
/*     */         {
/*     */ 
/* 124 */           SChildrenCharacterItemCfg obj = new SChildrenCharacterItemCfg();
...
/*     */     
/* 140 */     String path = dir + "mzm.gsp.item.confbean.SChildrenCharacterItemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 167 */           SChildrenCharacterItemCfg _v_ = new SChildrenCharacterItemCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SChildrenCharacterItemCfg> all)
/*     */   {
/* 187 */     String path = dir + "mzm.gsp.item.confbean.SChildrenCharacterItemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 214 */           SChildrenCharacterItemCfg _v_ = new SChildrenCharacterItemCfg();
...
/*     */   {
/* 233 */     for (Map.Entry<Integer, SChildrenCharacterItemCfg> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static void handleData(Map<Integer, SChildrenCharacterItemCfg> all, Map<Integer, SItemCfg> parent)
/*     */   {
/* 248 */     for (Map.Entry<Integer, SChildrenCharacterItemCfg> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static SChildrenCharacterItemCfg getOld(int key)
/*     */   {
/* 263 */     return (SChildrenCharacterItemCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SChildrenCharacterItemCfg get(int key)
/*     */   {
/* 268 */     return (SChildrenCharacterItemCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SChildrenCharacterItemCfg> getOldAllSelf()
/*     */   {
/* 273 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SChildrenCharacterItemCfg> getAllSelf()
/*     */   {
/* 278 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SChildrenCharacterItemCfg> newAll)
/*     */   {
/* 283 */     oldAll = all;
/* 284 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\item\confbean\SChildrenCharacterItemCfg.class
