...
/*     */ 
/*     */ public class SRidderItem extends SItemCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  15 */   private static volatile Map<Integer, SRidderItem> oldAll = null;
/*     */   
/*  17 */   private static Map<Integer, SRidderItem> all = null;
/*     */   
/*     */   public int ridderid;
/*     */   
...
/*  36 */     this.ridderid = Integer.valueOf(rootElement.attributeValue("ridderid")).intValue();
/*     */   }
/*     */   
...
/*  73 */     this.ridderid = _os_.unmarshal_int();
/*  74 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  79 */     String path = dir + "mzm.gsp.item.confbean.SRidderItem.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  92 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SRidderItem"))
/*     */         {
/*     */ 
/*  95 */           SRidderItem obj = new SRidderItem();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SRidderItem> all)
/*     */   {
/* 109 */     String path = dir + "mzm.gsp.item.confbean.SRidderItem.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 121 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SRidderItem"))
/*     */         {
/*     */ 
/* 124 */           SRidderItem obj = new SRidderItem();
...
/*     */     
/* 140 */     String path = dir + "mzm.gsp.item.confbean.SRidderItem.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 167 */           SRidderItem _v_ = new SRidderItem();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SRidderItem> all)
/*     */   {
/* 187 */     String path = dir + "mzm.gsp.item.confbean.SRidderItem.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 214 */           SRidderItem _v_ = new SRidderItem();
...
/*     */   {
/* 233 */     for (Map.Entry<Integer, SRidderItem> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static void handleData(Map<Integer, SRidderItem> all, Map<Integer, SItemCfg> parent)
/*     */   {
/* 248 */     for (Map.Entry<Integer, SRidderItem> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static SRidderItem getOld(int key)
/*     */   {
/* 263 */     return (SRidderItem)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SRidderItem get(int key)
/*     */   {
/* 268 */     return (SRidderItem)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SRidderItem> getOldAllSelf()
/*     */   {
/* 273 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SRidderItem> getAllSelf()
/*     */   {
/* 278 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SRidderItem> newAll)
/*     */   {
/* 283 */     oldAll = all;
/* 284 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\item\confbean\SRidderItem.class
