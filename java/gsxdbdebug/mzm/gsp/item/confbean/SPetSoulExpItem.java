...
/*     */ 
/*     */ public class SPetSoulExpItem extends SItemCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  15 */   private static volatile Map<Integer, SPetSoulExpItem> oldAll = null;
/*     */   
/*  17 */   private static Map<Integer, SPetSoulExpItem> all = null;
/*     */   
...
/*     */   {
/*  79 */     String path = dir + "mzm.gsp.item.confbean.SPetSoulExpItem.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  92 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SPetSoulExpItem"))
/*     */         {
/*     */ 
/*  95 */           SPetSoulExpItem obj = new SPetSoulExpItem();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SPetSoulExpItem> all)
/*     */   {
/* 109 */     String path = dir + "mzm.gsp.item.confbean.SPetSoulExpItem.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 121 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SPetSoulExpItem"))
/*     */         {
/*     */ 
/* 124 */           SPetSoulExpItem obj = new SPetSoulExpItem();
...
/*     */     
/* 140 */     String path = dir + "mzm.gsp.item.confbean.SPetSoulExpItem.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 167 */           SPetSoulExpItem _v_ = new SPetSoulExpItem();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SPetSoulExpItem> all)
/*     */   {
/* 187 */     String path = dir + "mzm.gsp.item.confbean.SPetSoulExpItem.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 214 */           SPetSoulExpItem _v_ = new SPetSoulExpItem();
...
/*     */   {
/* 233 */     for (Map.Entry<Integer, SPetSoulExpItem> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static void handleData(Map<Integer, SPetSoulExpItem> all, Map<Integer, SItemCfg> parent)
/*     */   {
/* 248 */     for (Map.Entry<Integer, SPetSoulExpItem> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static SPetSoulExpItem getOld(int key)
/*     */   {
/* 263 */     return (SPetSoulExpItem)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SPetSoulExpItem get(int key)
/*     */   {
/* 268 */     return (SPetSoulExpItem)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPetSoulExpItem> getOldAllSelf()
/*     */   {
/* 273 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPetSoulExpItem> getAllSelf()
/*     */   {
/* 278 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SPetSoulExpItem> newAll)
/*     */   {
/* 283 */     oldAll = all;
/* 284 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\item\confbean\SPetSoulExpItem.class
