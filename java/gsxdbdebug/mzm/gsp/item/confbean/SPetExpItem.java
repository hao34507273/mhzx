...
/*     */ 
/*     */ public class SPetExpItem extends SItemCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  15 */   private static volatile Map<Integer, SPetExpItem> oldAll = null;
/*     */   
/*  17 */   private static Map<Integer, SPetExpItem> all = null;
/*     */   
/*     */   public int lowExpLimit;
...
/*  37 */     this.lowExpLimit = Integer.valueOf(rootElement.attributeValue("lowExpLimit")).intValue();
/*  38 */     this.maxExpLimit = Integer.valueOf(rootElement.attributeValue("maxExpLimit")).intValue();
/*     */   }
/*     */   
...
/*  56 */     _os_.marshal(this.lowExpLimit);
/*  57 */     _os_.marshal(this.maxExpLimit);
/*  58 */     return _os_;
/*     */   }
/*     */   
...
/*  76 */     this.lowExpLimit = _os_.unmarshal_int();
/*  77 */     this.maxExpLimit = _os_.unmarshal_int();
/*  78 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  83 */     String path = dir + "mzm.gsp.item.confbean.SPetExpItem.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  96 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SPetExpItem"))
/*     */         {
/*     */ 
/*  99 */           SPetExpItem obj = new SPetExpItem();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SPetExpItem> all)
/*     */   {
/* 113 */     String path = dir + "mzm.gsp.item.confbean.SPetExpItem.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 125 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SPetExpItem"))
/*     */         {
/*     */ 
/* 128 */           SPetExpItem obj = new SPetExpItem();
...
/*     */     
/* 144 */     String path = dir + "mzm.gsp.item.confbean.SPetExpItem.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 171 */           SPetExpItem _v_ = new SPetExpItem();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SPetExpItem> all)
/*     */   {
/* 191 */     String path = dir + "mzm.gsp.item.confbean.SPetExpItem.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 218 */           SPetExpItem _v_ = new SPetExpItem();
...
/*     */   {
/* 237 */     for (Map.Entry<Integer, SPetExpItem> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static void handleData(Map<Integer, SPetExpItem> all, Map<Integer, SItemCfg> parent)
/*     */   {
/* 252 */     for (Map.Entry<Integer, SPetExpItem> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static SPetExpItem getOld(int key)
/*     */   {
/* 267 */     return (SPetExpItem)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SPetExpItem get(int key)
/*     */   {
/* 272 */     return (SPetExpItem)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPetExpItem> getOldAllSelf()
/*     */   {
/* 277 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPetExpItem> getAllSelf()
/*     */   {
/* 282 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SPetExpItem> newAll)
/*     */   {
/* 287 */     oldAll = all;
/* 288 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\item\confbean\SPetExpItem.class
