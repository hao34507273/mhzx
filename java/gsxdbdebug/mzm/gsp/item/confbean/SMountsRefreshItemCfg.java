...
/*     */ 
/*     */ public class SMountsRefreshItemCfg extends SItemCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  15 */   private static volatile Map<Integer, SMountsRefreshItemCfg> oldAll = null;
/*     */   
/*  17 */   private static Map<Integer, SMountsRefreshItemCfg> all = null;
/*     */   
/*     */ 
...
/*     */   {
/*  75 */     String path = dir + "mzm.gsp.item.confbean.SMountsRefreshItemCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  88 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SMountsRefreshItemCfg"))
/*     */         {
/*     */ 
/*  91 */           SMountsRefreshItemCfg obj = new SMountsRefreshItemCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SMountsRefreshItemCfg> all)
/*     */   {
/* 105 */     String path = dir + "mzm.gsp.item.confbean.SMountsRefreshItemCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 117 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SMountsRefreshItemCfg"))
/*     */         {
/*     */ 
/* 120 */           SMountsRefreshItemCfg obj = new SMountsRefreshItemCfg();
...
/*     */     
/* 136 */     String path = dir + "mzm.gsp.item.confbean.SMountsRefreshItemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 163 */           SMountsRefreshItemCfg _v_ = new SMountsRefreshItemCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SMountsRefreshItemCfg> all)
/*     */   {
/* 183 */     String path = dir + "mzm.gsp.item.confbean.SMountsRefreshItemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 210 */           SMountsRefreshItemCfg _v_ = new SMountsRefreshItemCfg();
...
/*     */   {
/* 229 */     for (Map.Entry<Integer, SMountsRefreshItemCfg> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static void handleData(Map<Integer, SMountsRefreshItemCfg> all, Map<Integer, SItemCfg> parent)
/*     */   {
/* 244 */     for (Map.Entry<Integer, SMountsRefreshItemCfg> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static SMountsRefreshItemCfg getOld(int key)
/*     */   {
/* 259 */     return (SMountsRefreshItemCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SMountsRefreshItemCfg get(int key)
/*     */   {
/* 264 */     return (SMountsRefreshItemCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMountsRefreshItemCfg> getOldAllSelf()
/*     */   {
/* 269 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMountsRefreshItemCfg> getAllSelf()
/*     */   {
/* 274 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SMountsRefreshItemCfg> newAll)
/*     */   {
/* 279 */     oldAll = all;
/* 280 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\item\confbean\SMountsRefreshItemCfg.class
