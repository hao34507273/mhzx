...
/*     */ 
/*     */ public class SPetDecorateItemCfg extends SItemCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  15 */   private static volatile Map<Integer, SPetDecorateItemCfg> oldAll = null;
/*     */   
/*  17 */   private static Map<Integer, SPetDecorateItemCfg> all = null;
/*     */   
/*     */   public int petCatchLevel;
/*     */   public int addRealAptMaxLimit;
/*     */   
...
/*  37 */     this.petCatchLevel = Integer.valueOf(rootElement.attributeValue("petCatchLevel")).intValue();
/*  38 */     this.addRealAptMaxLimit = Integer.valueOf(rootElement.attributeValue("addRealAptMaxLimit")).intValue();
/*     */   }
/*     */   
...
/*  56 */     _os_.marshal(this.petCatchLevel);
/*  57 */     _os_.marshal(this.addRealAptMaxLimit);
/*  58 */     return _os_;
/*     */   }
/*     */   
...
/*  76 */     this.petCatchLevel = _os_.unmarshal_int();
/*  77 */     this.addRealAptMaxLimit = _os_.unmarshal_int();
/*  78 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  83 */     String path = dir + "mzm.gsp.item.confbean.SPetDecorateItemCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  96 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SPetDecorateItemCfg"))
/*     */         {
/*     */ 
/*  99 */           SPetDecorateItemCfg obj = new SPetDecorateItemCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SPetDecorateItemCfg> all)
/*     */   {
/* 113 */     String path = dir + "mzm.gsp.item.confbean.SPetDecorateItemCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 125 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SPetDecorateItemCfg"))
/*     */         {
/*     */ 
/* 128 */           SPetDecorateItemCfg obj = new SPetDecorateItemCfg();
...
/*     */     
/* 144 */     String path = dir + "mzm.gsp.item.confbean.SPetDecorateItemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 171 */           SPetDecorateItemCfg _v_ = new SPetDecorateItemCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SPetDecorateItemCfg> all)
/*     */   {
/* 191 */     String path = dir + "mzm.gsp.item.confbean.SPetDecorateItemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 218 */           SPetDecorateItemCfg _v_ = new SPetDecorateItemCfg();
...
/*     */   {
/* 237 */     for (Map.Entry<Integer, SPetDecorateItemCfg> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static void handleData(Map<Integer, SPetDecorateItemCfg> all, Map<Integer, SItemCfg> parent)
/*     */   {
/* 252 */     for (Map.Entry<Integer, SPetDecorateItemCfg> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static SPetDecorateItemCfg getOld(int key)
/*     */   {
/* 267 */     return (SPetDecorateItemCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SPetDecorateItemCfg get(int key)
/*     */   {
/* 272 */     return (SPetDecorateItemCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPetDecorateItemCfg> getOldAllSelf()
/*     */   {
/* 277 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPetDecorateItemCfg> getAllSelf()
/*     */   {
/* 282 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SPetDecorateItemCfg> newAll)
/*     */   {
/* 287 */     oldAll = all;
/* 288 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\item\confbean\SPetDecorateItemCfg.class
