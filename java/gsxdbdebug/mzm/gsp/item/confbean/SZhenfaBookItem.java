...
/*     */ 
/*     */ public class SZhenfaBookItem extends SItemCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  15 */   private static volatile Map<Integer, SZhenfaBookItem> oldAll = null;
/*     */   
/*  17 */   private static Map<Integer, SZhenfaBookItem> all = null;
/*     */   
/*     */   public int zhenfaId;
/*     */   public int addExpNum;
/*     */   public int extraAddExpNum;
/*     */   
...
/*  38 */     this.zhenfaId = Integer.valueOf(rootElement.attributeValue("zhenfaId")).intValue();
/*  39 */     this.addExpNum = Integer.valueOf(rootElement.attributeValue("addExpNum")).intValue();
/*  40 */     this.extraAddExpNum = Integer.valueOf(rootElement.attributeValue("extraAddExpNum")).intValue();
/*     */   }
/*     */   
...
/*  58 */     _os_.marshal(this.zhenfaId);
/*  59 */     _os_.marshal(this.addExpNum);
/*  60 */     _os_.marshal(this.extraAddExpNum);
/*  61 */     return _os_;
/*     */   }
/*     */   
...
/*  79 */     this.zhenfaId = _os_.unmarshal_int();
/*  80 */     this.addExpNum = _os_.unmarshal_int();
/*  81 */     this.extraAddExpNum = _os_.unmarshal_int();
/*  82 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  87 */     String path = dir + "mzm.gsp.item.confbean.SZhenfaBookItem.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 100 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SZhenfaBookItem"))
/*     */         {
/*     */ 
/* 103 */           SZhenfaBookItem obj = new SZhenfaBookItem();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SZhenfaBookItem> all)
/*     */   {
/* 117 */     String path = dir + "mzm.gsp.item.confbean.SZhenfaBookItem.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 129 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SZhenfaBookItem"))
/*     */         {
/*     */ 
/* 132 */           SZhenfaBookItem obj = new SZhenfaBookItem();
...
/*     */     
/* 148 */     String path = dir + "mzm.gsp.item.confbean.SZhenfaBookItem.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 175 */           SZhenfaBookItem _v_ = new SZhenfaBookItem();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SZhenfaBookItem> all)
/*     */   {
/* 195 */     String path = dir + "mzm.gsp.item.confbean.SZhenfaBookItem.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 222 */           SZhenfaBookItem _v_ = new SZhenfaBookItem();
...
/*     */   {
/* 241 */     for (Map.Entry<Integer, SZhenfaBookItem> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static void handleData(Map<Integer, SZhenfaBookItem> all, Map<Integer, SItemCfg> parent)
/*     */   {
/* 256 */     for (Map.Entry<Integer, SZhenfaBookItem> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static SZhenfaBookItem getOld(int key)
/*     */   {
/* 271 */     return (SZhenfaBookItem)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SZhenfaBookItem get(int key)
/*     */   {
/* 276 */     return (SZhenfaBookItem)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SZhenfaBookItem> getOldAllSelf()
/*     */   {
/* 281 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SZhenfaBookItem> getAllSelf()
/*     */   {
/* 286 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SZhenfaBookItem> newAll)
/*     */   {
/* 291 */     oldAll = all;
/* 292 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\item\confbean\SZhenfaBookItem.class
