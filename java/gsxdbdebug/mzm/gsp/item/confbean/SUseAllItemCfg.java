...
/*     */ 
/*     */ public class SUseAllItemCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SUseAllItemCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SUseAllItemCfg> all = null;
/*     */   
/*     */   public int itemid;
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  22 */     this.itemid = Integer.valueOf(rootElement.attributeValue("itemid")).intValue();
/*     */   }
/*     */   
...
/*     */   {
/*  39 */     String path = dir + "mzm.gsp.item.confbean.SUseAllItemCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  52 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SUseAllItemCfg"))
/*     */         {
/*     */ 
/*  55 */           SUseAllItemCfg obj = new SUseAllItemCfg();
/*  56 */           obj.loadFromXml(elem);
/*  57 */           if (all.put(Integer.valueOf(obj.itemid), obj) != null) {
/*  58 */             throw new RuntimeException("duplicate key : " + obj.itemid);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SUseAllItemCfg> all)
/*     */   {
/*  69 */     String path = dir + "mzm.gsp.item.confbean.SUseAllItemCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  81 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SUseAllItemCfg"))
/*     */         {
/*     */ 
/*  84 */           SUseAllItemCfg obj = new SUseAllItemCfg();
/*  85 */           obj.loadFromXml(elem);
/*  86 */           if (all.put(Integer.valueOf(obj.itemid), obj) != null) {
/*  87 */             throw new RuntimeException("duplicate key : " + obj.itemid);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 100 */     String path = dir + "mzm.gsp.item.confbean.SUseAllItemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 127 */           SUseAllItemCfg _v_ = new SUseAllItemCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SUseAllItemCfg> all)
/*     */   {
/* 147 */     String path = dir + "mzm.gsp.item.confbean.SUseAllItemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 174 */           SUseAllItemCfg _v_ = new SUseAllItemCfg();
...
/*     */ 
/*     */ 
/*     */   public static SUseAllItemCfg getOld(int key)
/*     */   {
/* 195 */     return (SUseAllItemCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SUseAllItemCfg get(int key)
/*     */   {
/* 200 */     return (SUseAllItemCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SUseAllItemCfg> getOldAll()
/*     */   {
/* 205 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SUseAllItemCfg> getAll()
/*     */   {
/* 210 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SUseAllItemCfg> newAll)
/*     */   {
/* 215 */     oldAll = all;
/* 216 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\item\confbean\SUseAllItemCfg.class
