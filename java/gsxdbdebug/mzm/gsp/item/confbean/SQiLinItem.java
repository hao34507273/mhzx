...
/*     */ 
/*     */ public class SQiLinItem extends SItemCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  15 */   private static volatile Map<Integer, SQiLinItem> oldAll = null;
/*     */   
/*  17 */   private static Map<Integer, SQiLinItem> all = null;
/*     */   
/*  19 */   public java.util.ArrayList<StrengthLevel2SucRate> level2Rate = new java.util.ArrayList();
/*     */   
...
/*     */     
/*  37 */     Element collectionElement = util.XmlHelper.getVariableElement(rootElement, "level2Rate");
...
/*  48 */       if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.StrengthLevel2SucRate"))
/*     */       {
/*     */         StrengthLevel2SucRate _v_;
/*     */         
/*     */ 
/*     */         try
/*     */         {
/*  55 */           _v_ = new StrengthLevel2SucRate();
...
/*  83 */     _os_.compact_uint32(this.level2Rate.size());
/*  84 */     for (StrengthLevel2SucRate _v_ : this.level2Rate)
/*     */     {
/*  86 */       _os_.marshal(_v_);
/*     */     }
/*  88 */     return _os_;
...
/*     */     {
/*     */ 
/* 109 */       StrengthLevel2SucRate _v_ = new StrengthLevel2SucRate();
/* 110 */       _v_.unmarshal(_os_);
/* 111 */       this.level2Rate.add(_v_);
/*     */     }
/* 113 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/* 118 */     String path = dir + "mzm.gsp.item.confbean.SQiLinItem.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 131 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SQiLinItem"))
/*     */         {
/*     */ 
/* 134 */           SQiLinItem obj = new SQiLinItem();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SQiLinItem> all)
/*     */   {
/* 148 */     String path = dir + "mzm.gsp.item.confbean.SQiLinItem.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 160 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SQiLinItem"))
/*     */         {
/*     */ 
/* 163 */           SQiLinItem obj = new SQiLinItem();
...
/*     */     
/* 179 */     String path = dir + "mzm.gsp.item.confbean.SQiLinItem.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 206 */           SQiLinItem _v_ = new SQiLinItem();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SQiLinItem> all)
/*     */   {
/* 226 */     String path = dir + "mzm.gsp.item.confbean.SQiLinItem.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 253 */           SQiLinItem _v_ = new SQiLinItem();
...
/*     */   {
/* 272 */     for (Map.Entry<Integer, SQiLinItem> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static void handleData(Map<Integer, SQiLinItem> all, Map<Integer, SItemCfg> parent)
/*     */   {
/* 287 */     for (Map.Entry<Integer, SQiLinItem> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static SQiLinItem getOld(int key)
/*     */   {
/* 302 */     return (SQiLinItem)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SQiLinItem get(int key)
/*     */   {
/* 307 */     return (SQiLinItem)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SQiLinItem> getOldAllSelf()
/*     */   {
/* 312 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SQiLinItem> getAllSelf()
/*     */   {
/* 317 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SQiLinItem> newAll)
/*     */   {
/* 322 */     oldAll = all;
/* 323 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\item\confbean\SQiLinItem.class
