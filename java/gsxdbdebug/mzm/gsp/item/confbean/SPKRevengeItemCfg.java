...
/*     */ 
/*     */ public class SPKRevengeItemCfg extends SItemCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  15 */   private static volatile Map<Integer, SPKRevengeItemCfg> oldAll = null;
/*     */   
/*  17 */   private static Map<Integer, SPKRevengeItemCfg> all = null;
/*     */   
...
/*  36 */     this.maxQueryTime = Integer.valueOf(rootElement.attributeValue("maxQueryTime")).intValue();
/*     */   }
/*     */   
...
/*  54 */     _os_.marshal(this.maxQueryTime);
/*  55 */     return _os_;
/*     */   }
/*     */   
...
/*  73 */     this.maxQueryTime = _os_.unmarshal_int();
/*  74 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  79 */     String path = dir + "mzm.gsp.item.confbean.SPKRevengeItemCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  92 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SPKRevengeItemCfg"))
/*     */         {
/*     */ 
/*  95 */           SPKRevengeItemCfg obj = new SPKRevengeItemCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SPKRevengeItemCfg> all)
/*     */   {
/* 109 */     String path = dir + "mzm.gsp.item.confbean.SPKRevengeItemCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 121 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SPKRevengeItemCfg"))
/*     */         {
/*     */ 
/* 124 */           SPKRevengeItemCfg obj = new SPKRevengeItemCfg();
...
/*     */     
/* 140 */     String path = dir + "mzm.gsp.item.confbean.SPKRevengeItemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 167 */           SPKRevengeItemCfg _v_ = new SPKRevengeItemCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SPKRevengeItemCfg> all)
/*     */   {
/* 187 */     String path = dir + "mzm.gsp.item.confbean.SPKRevengeItemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 214 */           SPKRevengeItemCfg _v_ = new SPKRevengeItemCfg();
...
/*     */   {
/* 233 */     for (Map.Entry<Integer, SPKRevengeItemCfg> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static void handleData(Map<Integer, SPKRevengeItemCfg> all, Map<Integer, SItemCfg> parent)
/*     */   {
/* 248 */     for (Map.Entry<Integer, SPKRevengeItemCfg> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static SPKRevengeItemCfg getOld(int key)
/*     */   {
/* 263 */     return (SPKRevengeItemCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SPKRevengeItemCfg get(int key)
/*     */   {
/* 268 */     return (SPKRevengeItemCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPKRevengeItemCfg> getOldAllSelf()
/*     */   {
/* 273 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPKRevengeItemCfg> getAllSelf()
/*     */   {
/* 278 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SPKRevengeItemCfg> newAll)
/*     */   {
/* 283 */     oldAll = all;
/* 284 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\item\confbean\SPKRevengeItemCfg.class
