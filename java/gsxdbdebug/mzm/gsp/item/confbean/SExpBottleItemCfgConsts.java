...
/*     */ 
/*     */ public class SExpBottleItemCfgConsts
/*     */ {
/*  13 */   private static volatile SExpBottleItemCfgConsts oldInstance = null;
/*     */   
/*  15 */   private static SExpBottleItemCfgConsts instance = new SExpBottleItemCfgConsts();
/*     */   
/*     */   public int exp_max;
/*     */   public int every_award_get_exp_rate;
/*     */   public int exp_min;
/*     */   
/*     */   public static SExpBottleItemCfgConsts getOldInstance()
/*     */   {
/*  23 */     return oldInstance;
/*     */   }
/*     */   
/*     */   public static SExpBottleItemCfgConsts getInstance()
/*     */   {
/*  28 */     return instance;
/*     */   }
/*     */   
...
/*     */   {
/*  42 */     String path = dir + "mzm.gsp.item.confbean.SExpBottleItemCfgConsts.xml";
/*     */     try
/*     */     {
...
/*     */         }
/*     */       }
/*  62 */       this.exp_max = Integer.valueOf(((Element)data.get("exp_max")).attributeValue("value")).intValue();
/*  63 */       this.every_award_get_exp_rate = Integer.valueOf(((Element)data.get("every_award_get_exp_rate")).attributeValue("value")).intValue();
/*  64 */       this.exp_min = Integer.valueOf(((Element)data.get("exp_min")).attributeValue("value")).intValue();
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*  73 */     String path = dir + "mzm.gsp.item.confbean.SExpBottleItemCfgConsts.xml";
/*     */     try
/*     */     {
...
/*     */         }
/*     */       }
/*  93 */       this.exp_max = Integer.valueOf(((Element)data.get("exp_max")).attributeValue("value")).intValue();
/*  94 */       this.every_award_get_exp_rate = Integer.valueOf(((Element)data.get("every_award_get_exp_rate")).attributeValue("value")).intValue();
/*  95 */       this.exp_min = Integer.valueOf(((Element)data.get("exp_min")).attributeValue("value")).intValue();
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/* 106 */     String path = dir + "mzm.gsp.item.confbean.SExpBottleItemCfgConsts.bny";
/*     */     try
/*     */     {
...
/* 121 */         this.exp_max = _os_.unmarshal_int();
/* 122 */         this.every_award_get_exp_rate = _os_.unmarshal_int();
/* 123 */         this.exp_min = _os_.unmarshal_int();
/*     */       }
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*     */   {
/* 134 */     String path = dir + "mzm.gsp.item.confbean.SExpBottleItemCfgConsts.bny";
/*     */     try
/*     */     {
...
/* 149 */         this.exp_max = _os_.unmarshal_int();
/* 150 */         this.every_award_get_exp_rate = _os_.unmarshal_int();
/* 151 */         this.exp_min = _os_.unmarshal_int();
/*     */       }
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/*     */   }
/*     */   
/*     */   public static void setInstance(SExpBottleItemCfgConsts newInstance)
/*     */   {
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\item\confbean\SExpBottleItemCfgConsts.class
