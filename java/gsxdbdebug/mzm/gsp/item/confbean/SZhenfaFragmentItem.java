...
/*     */ 
/*     */ public class SZhenfaFragmentItem extends SItemCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  15 */   private static volatile Map<Integer, SZhenfaFragmentItem> oldAll = null;
/*     */   
/*  17 */   private static Map<Integer, SZhenfaFragmentItem> all = null;
/*     */   
...
/*  36 */     this.addExpNum = Integer.valueOf(rootElement.attributeValue("addExpNum")).intValue();
/*     */   }
/*     */   
...
/*  54 */     _os_.marshal(this.addExpNum);
/*  55 */     return _os_;
/*     */   }
/*     */   
...
/*  73 */     this.addExpNum = _os_.unmarshal_int();
/*  74 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  79 */     String path = dir + "mzm.gsp.item.confbean.SZhenfaFragmentItem.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  92 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SZhenfaFragmentItem"))
/*     */         {
/*     */ 
/*  95 */           SZhenfaFragmentItem obj = new SZhenfaFragmentItem();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SZhenfaFragmentItem> all)
/*     */   {
/* 109 */     String path = dir + "mzm.gsp.item.confbean.SZhenfaFragmentItem.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 121 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SZhenfaFragmentItem"))
/*     */         {
/*     */ 
/* 124 */           SZhenfaFragmentItem obj = new SZhenfaFragmentItem();
...
/*     */     
/* 140 */     String path = dir + "mzm.gsp.item.confbean.SZhenfaFragmentItem.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 167 */           SZhenfaFragmentItem _v_ = new SZhenfaFragmentItem();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SZhenfaFragmentItem> all)
/*     */   {
/* 187 */     String path = dir + "mzm.gsp.item.confbean.SZhenfaFragmentItem.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 214 */           SZhenfaFragmentItem _v_ = new SZhenfaFragmentItem();
...
/*     */   {
/* 233 */     for (Map.Entry<Integer, SZhenfaFragmentItem> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static void handleData(Map<Integer, SZhenfaFragmentItem> all, Map<Integer, SItemCfg> parent)
/*     */   {
/* 248 */     for (Map.Entry<Integer, SZhenfaFragmentItem> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static SZhenfaFragmentItem getOld(int key)
/*     */   {
/* 263 */     return (SZhenfaFragmentItem)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SZhenfaFragmentItem get(int key)
/*     */   {
/* 268 */     return (SZhenfaFragmentItem)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SZhenfaFragmentItem> getOldAllSelf()
/*     */   {
/* 273 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SZhenfaFragmentItem> getAllSelf()
/*     */   {
/* 278 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SZhenfaFragmentItem> newAll)
/*     */   {
/* 283 */     oldAll = all;
/* 284 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\item\confbean\SZhenfaFragmentItem.class
