...
/*     */ 
/*     */ public class EquipItemid2NeedItems implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, EquipItemid2NeedItems> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, EquipItemid2NeedItems> all = null;
/*     */   
/*     */   public int id;
/*  19 */   public java.util.ArrayList<NeedItemId2Num> needItemList = new java.util.ArrayList();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.id = Integer.valueOf(rootElement.attributeValue("id")).intValue();
/*     */     
/*  25 */     Element collectionElement = util.XmlHelper.getVariableElement(rootElement, "needItemList");
...
/*  36 */       if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.NeedItemId2Num"))
/*     */       {
/*     */         NeedItemId2Num _v_;
/*     */         
/*     */ 
...
/*  59 */     _os_.compact_uint32(this.needItemList.size());
/*  60 */     for (NeedItemId2Num _v_ : this.needItemList)
/*     */     {
/*  62 */       _os_.marshal(_v_);
/*     */     }
/*  64 */     return _os_;
...
/*     */     {
/*     */ 
/*  73 */       NeedItemId2Num _v_ = new NeedItemId2Num();
/*  74 */       _v_.unmarshal(_os_);
/*  75 */       this.needItemList.add(_v_);
/*     */     }
/*  77 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/*  82 */     String path = dir + "mzm.gsp.item.confbean.EquipItemid2NeedItems.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  95 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.EquipItemid2NeedItems"))
/*     */         {
/*     */ 
/*  98 */           EquipItemid2NeedItems obj = new EquipItemid2NeedItems();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, EquipItemid2NeedItems> all)
/*     */   {
/* 112 */     String path = dir + "mzm.gsp.item.confbean.EquipItemid2NeedItems.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 124 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.EquipItemid2NeedItems"))
/*     */         {
/*     */ 
/* 127 */           EquipItemid2NeedItems obj = new EquipItemid2NeedItems();
...
/*     */     
/* 143 */     String path = dir + "mzm.gsp.item.confbean.EquipItemid2NeedItems.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 170 */           EquipItemid2NeedItems _v_ = new EquipItemid2NeedItems();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, EquipItemid2NeedItems> all)
/*     */   {
/* 190 */     String path = dir + "mzm.gsp.item.confbean.EquipItemid2NeedItems.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 217 */           EquipItemid2NeedItems _v_ = new EquipItemid2NeedItems();
...
/*     */ 
/*     */ 
/*     */   public static EquipItemid2NeedItems getOld(int key)
/*     */   {
/* 238 */     return (EquipItemid2NeedItems)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static EquipItemid2NeedItems get(int key)
/*     */   {
/* 243 */     return (EquipItemid2NeedItems)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, EquipItemid2NeedItems> getOldAll()
/*     */   {
/* 248 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, EquipItemid2NeedItems> getAll()
/*     */   {
/* 253 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, EquipItemid2NeedItems> newAll)
/*     */   {
/* 258 */     oldAll = all;
/* 259 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\item\confbean\EquipItemid2NeedItems.class
