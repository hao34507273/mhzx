...
/*     */ 
/*     */ public class SFriendsCircleDressUpItemCfg extends SItemCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  15 */   private static volatile Map<Integer, SFriendsCircleDressUpItemCfg> oldAll = null;
/*     */   
/*  17 */   private static Map<Integer, SFriendsCircleDressUpItemCfg> all = null;
/*     */   
/*     */   public int dress_up_resource_id;
...
/*  38 */     this.dress_up_resource_id = Integer.valueOf(rootElement.attributeValue("dress_up_resource_id")).intValue();
/*  39 */     this.ornament_type = Integer.valueOf(rootElement.attributeValue("ornament_type")).intValue();
/*  40 */     this.show_index = Integer.valueOf(rootElement.attributeValue("show_index")).intValue();
/*     */   }
/*     */   
...
/*  58 */     _os_.marshal(this.dress_up_resource_id);
/*  59 */     _os_.marshal(this.ornament_type);
/*  60 */     _os_.marshal(this.show_index);
/*  61 */     return _os_;
/*     */   }
/*     */   
...
/*  79 */     this.dress_up_resource_id = _os_.unmarshal_int();
/*  80 */     this.ornament_type = _os_.unmarshal_int();
/*  81 */     this.show_index = _os_.unmarshal_int();
/*  82 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  87 */     String path = dir + "mzm.gsp.item.confbean.SFriendsCircleDressUpItemCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 100 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SFriendsCircleDressUpItemCfg"))
/*     */         {
/*     */ 
/* 103 */           SFriendsCircleDressUpItemCfg obj = new SFriendsCircleDressUpItemCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SFriendsCircleDressUpItemCfg> all)
/*     */   {
/* 117 */     String path = dir + "mzm.gsp.item.confbean.SFriendsCircleDressUpItemCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 129 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SFriendsCircleDressUpItemCfg"))
/*     */         {
/*     */ 
/* 132 */           SFriendsCircleDressUpItemCfg obj = new SFriendsCircleDressUpItemCfg();
...
/*     */     
/* 148 */     String path = dir + "mzm.gsp.item.confbean.SFriendsCircleDressUpItemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 175 */           SFriendsCircleDressUpItemCfg _v_ = new SFriendsCircleDressUpItemCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SFriendsCircleDressUpItemCfg> all)
/*     */   {
/* 195 */     String path = dir + "mzm.gsp.item.confbean.SFriendsCircleDressUpItemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 222 */           SFriendsCircleDressUpItemCfg _v_ = new SFriendsCircleDressUpItemCfg();
...
/*     */   {
/* 241 */     for (Map.Entry<Integer, SFriendsCircleDressUpItemCfg> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static void handleData(Map<Integer, SFriendsCircleDressUpItemCfg> all, Map<Integer, SItemCfg> parent)
/*     */   {
/* 256 */     for (Map.Entry<Integer, SFriendsCircleDressUpItemCfg> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static SFriendsCircleDressUpItemCfg getOld(int key)
/*     */   {
/* 271 */     return (SFriendsCircleDressUpItemCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SFriendsCircleDressUpItemCfg get(int key)
/*     */   {
/* 276 */     return (SFriendsCircleDressUpItemCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SFriendsCircleDressUpItemCfg> getOldAllSelf()
/*     */   {
/* 281 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SFriendsCircleDressUpItemCfg> getAllSelf()
/*     */   {
/* 286 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SFriendsCircleDressUpItemCfg> newAll)
/*     */   {
/* 291 */     oldAll = all;
/* 292 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\item\confbean\SFriendsCircleDressUpItemCfg.class
