...
/*     */ 
/*     */ public class SEquipSkillCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SEquipSkillCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SEquipSkillCfg> all = null;
/*     */   
/*     */   public int id;
...
/*     */   {
/*  82 */     String path = dir + "mzm.gsp.item.confbean.SEquipSkillCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  95 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SEquipSkillCfg"))
/*     */         {
/*     */ 
/*  98 */           SEquipSkillCfg obj = new SEquipSkillCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SEquipSkillCfg> all)
/*     */   {
/* 112 */     String path = dir + "mzm.gsp.item.confbean.SEquipSkillCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 124 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SEquipSkillCfg"))
/*     */         {
/*     */ 
/* 127 */           SEquipSkillCfg obj = new SEquipSkillCfg();
...
/*     */     
/* 143 */     String path = dir + "mzm.gsp.item.confbean.SEquipSkillCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 170 */           SEquipSkillCfg _v_ = new SEquipSkillCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SEquipSkillCfg> all)
/*     */   {
/* 190 */     String path = dir + "mzm.gsp.item.confbean.SEquipSkillCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 217 */           SEquipSkillCfg _v_ = new SEquipSkillCfg();
...
/*     */ 
/*     */ 
/*     */   public static SEquipSkillCfg getOld(int key)
/*     */   {
/* 238 */     return (SEquipSkillCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SEquipSkillCfg get(int key)
/*     */   {
/* 243 */     return (SEquipSkillCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SEquipSkillCfg> getOldAll()
/*     */   {
/* 248 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SEquipSkillCfg> getAll()
/*     */   {
/* 253 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SEquipSkillCfg> newAll)
/*     */   {
/* 258 */     oldAll = all;
/* 259 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\item\confbean\SEquipSkillCfg.class
