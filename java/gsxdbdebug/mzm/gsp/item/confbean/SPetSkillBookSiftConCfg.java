...
/*     */ 
/*     */ public class SPetSkillBookSiftConCfg extends SItemSiftConCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  15 */   private static volatile Map<Integer, SPetSkillBookSiftConCfg> oldAll = null;
/*     */   
/*  17 */   private static Map<Integer, SPetSkillBookSiftConCfg> all = null;
/*     */   
...
/*  27 */     this.itemPhase = Integer.valueOf(rootElement.attributeValue("itemPhase")).intValue();
/*  28 */     this.skillPhase = Integer.valueOf(rootElement.attributeValue("skillPhase")).intValue();
...
/*  36 */     _os_.marshal(this.itemPhase);
/*  37 */     _os_.marshal(this.skillPhase);
...
/*  46 */     this.itemPhase = _os_.unmarshal_int();
/*  47 */     this.skillPhase = _os_.unmarshal_int();
...
/*     */   {
/*  54 */     String path = dir + "mzm.gsp.item.confbean.SPetSkillBookSiftConCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  67 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SPetSkillBookSiftConCfg"))
/*     */         {
/*     */ 
/*  70 */           SPetSkillBookSiftConCfg obj = new SPetSkillBookSiftConCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SPetSkillBookSiftConCfg> all)
/*     */   {
/*  84 */     String path = dir + "mzm.gsp.item.confbean.SPetSkillBookSiftConCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  96 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SPetSkillBookSiftConCfg"))
/*     */         {
/*     */ 
/*  99 */           SPetSkillBookSiftConCfg obj = new SPetSkillBookSiftConCfg();
...
/*     */     
/* 115 */     String path = dir + "mzm.gsp.item.confbean.SPetSkillBookSiftConCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 142 */           SPetSkillBookSiftConCfg _v_ = new SPetSkillBookSiftConCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SPetSkillBookSiftConCfg> all)
/*     */   {
/* 162 */     String path = dir + "mzm.gsp.item.confbean.SPetSkillBookSiftConCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 189 */           SPetSkillBookSiftConCfg _v_ = new SPetSkillBookSiftConCfg();
...
/*     */   {
/* 208 */     for (Map.Entry<Integer, SPetSkillBookSiftConCfg> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static void handleData(Map<Integer, SPetSkillBookSiftConCfg> all, Map<Integer, SItemSiftConCfg> parent)
/*     */   {
/* 223 */     for (Map.Entry<Integer, SPetSkillBookSiftConCfg> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static SPetSkillBookSiftConCfg getOld(int key)
/*     */   {
/* 238 */     return (SPetSkillBookSiftConCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SPetSkillBookSiftConCfg get(int key)
/*     */   {
/* 243 */     return (SPetSkillBookSiftConCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPetSkillBookSiftConCfg> getOldAllSelf()
/*     */   {
/* 248 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPetSkillBookSiftConCfg> getAllSelf()
/*     */   {
/* 253 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SPetSkillBookSiftConCfg> newAll)
/*     */   {
/* 258 */     oldAll = all;
/* 259 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\item\confbean\SPetSkillBookSiftConCfg.class
