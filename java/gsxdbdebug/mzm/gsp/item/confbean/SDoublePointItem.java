...
/*     */ 
/*     */ public class SDoublePointItem extends SItemCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  15 */   private static volatile Map<Integer, SDoublePointItem> oldAll = null;
/*     */   
/*  17 */   private static Map<Integer, SDoublePointItem> all = null;
/*     */   
...
/*  37 */     this.addPointNum = Integer.valueOf(rootElement.attributeValue("addPointNum")).intValue();
/*  38 */     this.maxUseCount = Integer.valueOf(rootElement.attributeValue("maxUseCount")).intValue();
/*     */   }
/*     */   
...
/*  56 */     _os_.marshal(this.addPointNum);
/*  57 */     _os_.marshal(this.maxUseCount);
/*  58 */     return _os_;
/*     */   }
/*     */   
...
/*  76 */     this.addPointNum = _os_.unmarshal_int();
/*  77 */     this.maxUseCount = _os_.unmarshal_int();
/*  78 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  83 */     String path = dir + "mzm.gsp.item.confbean.SDoublePointItem.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  96 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SDoublePointItem"))
/*     */         {
/*     */ 
/*  99 */           SDoublePointItem obj = new SDoublePointItem();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SDoublePointItem> all)
/*     */   {
/* 113 */     String path = dir + "mzm.gsp.item.confbean.SDoublePointItem.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 125 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SDoublePointItem"))
/*     */         {
/*     */ 
/* 128 */           SDoublePointItem obj = new SDoublePointItem();
...
/*     */     
/* 144 */     String path = dir + "mzm.gsp.item.confbean.SDoublePointItem.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 171 */           SDoublePointItem _v_ = new SDoublePointItem();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SDoublePointItem> all)
/*     */   {
/* 191 */     String path = dir + "mzm.gsp.item.confbean.SDoublePointItem.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 218 */           SDoublePointItem _v_ = new SDoublePointItem();
...
/*     */   {
/* 237 */     for (Map.Entry<Integer, SDoublePointItem> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static void handleData(Map<Integer, SDoublePointItem> all, Map<Integer, SItemCfg> parent)
/*     */   {
/* 252 */     for (Map.Entry<Integer, SDoublePointItem> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static SDoublePointItem getOld(int key)
/*     */   {
/* 267 */     return (SDoublePointItem)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SDoublePointItem get(int key)
/*     */   {
/* 272 */     return (SDoublePointItem)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SDoublePointItem> getOldAllSelf()
/*     */   {
/* 277 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SDoublePointItem> getAllSelf()
/*     */   {
/* 282 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SDoublePointItem> newAll)
/*     */   {
/* 287 */     oldAll = all;
/* 288 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\item\confbean\SDoublePointItem.class
