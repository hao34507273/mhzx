...
/*     */ 
/*     */ public class SMoneybagItem extends SItemCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  15 */   private static volatile Map<Integer, SMoneybagItem> oldAll = null;
/*     */   
/*  17 */   private static Map<Integer, SMoneybagItem> all = null;
/*     */   
...
/*  36 */     this.currencytype = Integer.valueOf(rootElement.attributeValue("currencytype")).intValue();
/*     */   }
/*     */   
...
/*  54 */     _os_.marshal(this.currencytype);
/*  55 */     return _os_;
/*     */   }
/*     */   
...
/*  73 */     this.currencytype = _os_.unmarshal_int();
/*  74 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  79 */     String path = dir + "mzm.gsp.item.confbean.SMoneybagItem.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  92 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SMoneybagItem"))
/*     */         {
/*     */ 
/*  95 */           SMoneybagItem obj = new SMoneybagItem();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SMoneybagItem> all)
/*     */   {
/* 109 */     String path = dir + "mzm.gsp.item.confbean.SMoneybagItem.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 121 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SMoneybagItem"))
/*     */         {
/*     */ 
/* 124 */           SMoneybagItem obj = new SMoneybagItem();
...
/*     */     
/* 140 */     String path = dir + "mzm.gsp.item.confbean.SMoneybagItem.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 167 */           SMoneybagItem _v_ = new SMoneybagItem();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SMoneybagItem> all)
/*     */   {
/* 187 */     String path = dir + "mzm.gsp.item.confbean.SMoneybagItem.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 214 */           SMoneybagItem _v_ = new SMoneybagItem();
...
/*     */   {
/* 233 */     for (Map.Entry<Integer, SMoneybagItem> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static void handleData(Map<Integer, SMoneybagItem> all, Map<Integer, SItemCfg> parent)
/*     */   {
/* 248 */     for (Map.Entry<Integer, SMoneybagItem> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static SMoneybagItem getOld(int key)
/*     */   {
/* 263 */     return (SMoneybagItem)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SMoneybagItem get(int key)
/*     */   {
/* 268 */     return (SMoneybagItem)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMoneybagItem> getOldAllSelf()
/*     */   {
/* 273 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMoneybagItem> getAllSelf()
/*     */   {
/* 278 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SMoneybagItem> newAll)
/*     */   {
/* 283 */     oldAll = all;
/* 284 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\item\confbean\SMoneybagItem.class
