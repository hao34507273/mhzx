...
/*     */ 
/*     */ public class SCatItemCfg extends SItemCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  15 */   private static volatile Map<Integer, SCatItemCfg> oldAll = null;
/*     */   
/*  17 */   private static Map<Integer, SCatItemCfg> all = null;
/*     */   
/*     */   public int homelandCatCfgid;
/*     */   
...
/*  36 */     this.homelandCatCfgid = Integer.valueOf(rootElement.attributeValue("homelandCatCfgid")).intValue();
/*     */   }
/*     */   
...
/*  54 */     _os_.marshal(this.homelandCatCfgid);
/*  55 */     return _os_;
/*     */   }
/*     */   
...
/*  73 */     this.homelandCatCfgid = _os_.unmarshal_int();
/*  74 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  79 */     String path = dir + "mzm.gsp.item.confbean.SCatItemCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  92 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SCatItemCfg"))
/*     */         {
/*     */ 
/*  95 */           SCatItemCfg obj = new SCatItemCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SCatItemCfg> all)
/*     */   {
/* 109 */     String path = dir + "mzm.gsp.item.confbean.SCatItemCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 121 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SCatItemCfg"))
/*     */         {
/*     */ 
/* 124 */           SCatItemCfg obj = new SCatItemCfg();
...
/*     */     
/* 140 */     String path = dir + "mzm.gsp.item.confbean.SCatItemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 167 */           SCatItemCfg _v_ = new SCatItemCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SCatItemCfg> all)
/*     */   {
/* 187 */     String path = dir + "mzm.gsp.item.confbean.SCatItemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 214 */           SCatItemCfg _v_ = new SCatItemCfg();
...
/*     */   {
/* 233 */     for (Map.Entry<Integer, SCatItemCfg> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static void handleData(Map<Integer, SCatItemCfg> all, Map<Integer, SItemCfg> parent)
/*     */   {
/* 248 */     for (Map.Entry<Integer, SCatItemCfg> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static SCatItemCfg getOld(int key)
/*     */   {
/* 263 */     return (SCatItemCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SCatItemCfg get(int key)
/*     */   {
/* 268 */     return (SCatItemCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SCatItemCfg> getOldAllSelf()
/*     */   {
/* 273 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SCatItemCfg> getAllSelf()
/*     */   {
/* 278 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SCatItemCfg> newAll)
/*     */   {
/* 283 */     oldAll = all;
/* 284 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\item\confbean\SCatItemCfg.class
