...
/*     */ 
/*     */ public class SUseGiftbagItemCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SUseGiftbagItemCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SUseGiftbagItemCfg> all = null;
/*     */   
/*     */   public int itemid;
/*     */   public int id;
/*     */   
...
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.item.confbean.SUseGiftbagItemCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SUseGiftbagItemCfg"))
/*     */         {
/*     */ 
/*  59 */           SUseGiftbagItemCfg obj = new SUseGiftbagItemCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SUseGiftbagItemCfg> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.item.confbean.SUseGiftbagItemCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SUseGiftbagItemCfg"))
/*     */         {
/*     */ 
/*  88 */           SUseGiftbagItemCfg obj = new SUseGiftbagItemCfg();
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.item.confbean.SUseGiftbagItemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           SUseGiftbagItemCfg _v_ = new SUseGiftbagItemCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SUseGiftbagItemCfg> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.item.confbean.SUseGiftbagItemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           SUseGiftbagItemCfg _v_ = new SUseGiftbagItemCfg();
...
/*     */ 
/*     */ 
/*     */   public static SUseGiftbagItemCfg getOld(int key)
/*     */   {
/* 199 */     return (SUseGiftbagItemCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SUseGiftbagItemCfg get(int key)
/*     */   {
/* 204 */     return (SUseGiftbagItemCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SUseGiftbagItemCfg> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SUseGiftbagItemCfg> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SUseGiftbagItemCfg> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\item\confbean\SUseGiftbagItemCfg.class
