...
/*     */ 
/*     */ public class SPetFightFormationItemCfg extends SItemCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  15 */   private static volatile Map<Integer, SPetFightFormationItemCfg> oldAll = null;
/*     */   
/*  17 */   private static Map<Integer, SPetFightFormationItemCfg> all = null;
/*     */   
...
/*  37 */     this.formationId = Integer.valueOf(rootElement.attributeValue("formationId")).intValue();
/*  38 */     this.exp = Integer.valueOf(rootElement.attributeValue("exp")).intValue();
/*     */   }
/*     */   
...
/*  56 */     _os_.marshal(this.formationId);
/*  57 */     _os_.marshal(this.exp);
/*  58 */     return _os_;
/*     */   }
/*     */   
...
/*  76 */     this.formationId = _os_.unmarshal_int();
/*  77 */     this.exp = _os_.unmarshal_int();
/*  78 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  83 */     String path = dir + "mzm.gsp.item.confbean.SPetFightFormationItemCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  96 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SPetFightFormationItemCfg"))
/*     */         {
/*     */ 
/*  99 */           SPetFightFormationItemCfg obj = new SPetFightFormationItemCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SPetFightFormationItemCfg> all)
/*     */   {
/* 113 */     String path = dir + "mzm.gsp.item.confbean.SPetFightFormationItemCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 125 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SPetFightFormationItemCfg"))
/*     */         {
/*     */ 
/* 128 */           SPetFightFormationItemCfg obj = new SPetFightFormationItemCfg();
...
/*     */     
/* 144 */     String path = dir + "mzm.gsp.item.confbean.SPetFightFormationItemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 171 */           SPetFightFormationItemCfg _v_ = new SPetFightFormationItemCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SPetFightFormationItemCfg> all)
/*     */   {
/* 191 */     String path = dir + "mzm.gsp.item.confbean.SPetFightFormationItemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 218 */           SPetFightFormationItemCfg _v_ = new SPetFightFormationItemCfg();
...
/*     */   {
/* 237 */     for (Map.Entry<Integer, SPetFightFormationItemCfg> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static void handleData(Map<Integer, SPetFightFormationItemCfg> all, Map<Integer, SItemCfg> parent)
/*     */   {
/* 252 */     for (Map.Entry<Integer, SPetFightFormationItemCfg> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static SPetFightFormationItemCfg getOld(int key)
/*     */   {
/* 267 */     return (SPetFightFormationItemCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SPetFightFormationItemCfg get(int key)
/*     */   {
/* 272 */     return (SPetFightFormationItemCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPetFightFormationItemCfg> getOldAllSelf()
/*     */   {
/* 277 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPetFightFormationItemCfg> getAllSelf()
/*     */   {
/* 282 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SPetFightFormationItemCfg> newAll)
/*     */   {
/* 287 */     oldAll = all;
/* 288 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\item\confbean\SPetFightFormationItemCfg.class
