...
/*     */ 
/*     */ public class SMoneybagAwardCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SMoneybagAwardCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SMoneybagAwardCfg> all = null;
/*     */   
/*     */   public int id;
...
/*  26 */     this.currencytype = Integer.valueOf(rootElement.attributeValue("currencytype")).intValue();
/*  27 */     this.serverlevel = Integer.valueOf(rootElement.attributeValue("serverlevel")).intValue();
...
/*  34 */     _os_.marshal(this.currencytype);
/*  35 */     _os_.marshal(this.serverlevel);
/*  36 */     _os_.marshal(this.num);
/*  37 */     return _os_;
/*     */   }
/*     */   
...
/*  43 */     this.currencytype = _os_.unmarshal_int();
/*  44 */     this.serverlevel = _os_.unmarshal_int();
/*  45 */     this.num = _os_.unmarshal_int();
/*  46 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  51 */     String path = dir + "mzm.gsp.item.confbean.SMoneybagAwardCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  64 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SMoneybagAwardCfg"))
/*     */         {
/*     */ 
/*  67 */           SMoneybagAwardCfg obj = new SMoneybagAwardCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SMoneybagAwardCfg> all)
/*     */   {
/*  81 */     String path = dir + "mzm.gsp.item.confbean.SMoneybagAwardCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SMoneybagAwardCfg"))
/*     */         {
/*     */ 
/*  96 */           SMoneybagAwardCfg obj = new SMoneybagAwardCfg();
...
/*     */     
/* 112 */     String path = dir + "mzm.gsp.item.confbean.SMoneybagAwardCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 139 */           SMoneybagAwardCfg _v_ = new SMoneybagAwardCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SMoneybagAwardCfg> all)
/*     */   {
/* 159 */     String path = dir + "mzm.gsp.item.confbean.SMoneybagAwardCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 186 */           SMoneybagAwardCfg _v_ = new SMoneybagAwardCfg();
...
/*     */ 
/*     */ 
/*     */   public static SMoneybagAwardCfg getOld(int key)
/*     */   {
/* 207 */     return (SMoneybagAwardCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SMoneybagAwardCfg get(int key)
/*     */   {
/* 212 */     return (SMoneybagAwardCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMoneybagAwardCfg> getOldAll()
/*     */   {
/* 217 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMoneybagAwardCfg> getAll()
/*     */   {
/* 222 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SMoneybagAwardCfg> newAll)
/*     */   {
/* 227 */     oldAll = all;
/* 228 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\item\confbean\SMoneybagAwardCfg.class
