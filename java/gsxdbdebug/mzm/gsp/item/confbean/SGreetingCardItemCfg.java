...
/*     */ 
/*     */ public class SGreetingCardItemCfg extends SItemCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  15 */   private static volatile Map<Integer, SGreetingCardItemCfg> oldAll = null;
/*     */   
/*  17 */   private static Map<Integer, SGreetingCardItemCfg> all = null;
/*     */   
/*     */   public int rewardId;
/*     */   
...
/*  36 */     this.rewardId = Integer.valueOf(rootElement.attributeValue("rewardId")).intValue();
/*     */   }
/*     */   
...
/*  73 */     this.rewardId = _os_.unmarshal_int();
/*  74 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  79 */     String path = dir + "mzm.gsp.item.confbean.SGreetingCardItemCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  92 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SGreetingCardItemCfg"))
/*     */         {
/*     */ 
/*  95 */           SGreetingCardItemCfg obj = new SGreetingCardItemCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SGreetingCardItemCfg> all)
/*     */   {
/* 109 */     String path = dir + "mzm.gsp.item.confbean.SGreetingCardItemCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 121 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SGreetingCardItemCfg"))
/*     */         {
/*     */ 
/* 124 */           SGreetingCardItemCfg obj = new SGreetingCardItemCfg();
...
/*     */     
/* 140 */     String path = dir + "mzm.gsp.item.confbean.SGreetingCardItemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 167 */           SGreetingCardItemCfg _v_ = new SGreetingCardItemCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SGreetingCardItemCfg> all)
/*     */   {
/* 187 */     String path = dir + "mzm.gsp.item.confbean.SGreetingCardItemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 214 */           SGreetingCardItemCfg _v_ = new SGreetingCardItemCfg();
...
/*     */   {
/* 233 */     for (Map.Entry<Integer, SGreetingCardItemCfg> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static void handleData(Map<Integer, SGreetingCardItemCfg> all, Map<Integer, SItemCfg> parent)
/*     */   {
/* 248 */     for (Map.Entry<Integer, SGreetingCardItemCfg> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static SGreetingCardItemCfg getOld(int key)
/*     */   {
/* 263 */     return (SGreetingCardItemCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SGreetingCardItemCfg get(int key)
/*     */   {
/* 268 */     return (SGreetingCardItemCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SGreetingCardItemCfg> getOldAllSelf()
/*     */   {
/* 273 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SGreetingCardItemCfg> getAllSelf()
/*     */   {
/* 278 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SGreetingCardItemCfg> newAll)
/*     */   {
/* 283 */     oldAll = all;
/* 284 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\item\confbean\SGreetingCardItemCfg.class
