...
/*     */ 
/*     */ public class SGeniusStoneItemCfg extends SItemCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  15 */   private static volatile Map<Integer, SGeniusStoneItemCfg> oldAll = null;
/*     */   
/*  17 */   private static Map<Integer, SGeniusStoneItemCfg> all = null;
/*     */   
/*     */   public int addGeniusPoint;
/*     */   
...
/*  36 */     this.addGeniusPoint = Integer.valueOf(rootElement.attributeValue("addGeniusPoint")).intValue();
/*     */   }
/*     */   
...
/*  54 */     _os_.marshal(this.addGeniusPoint);
/*  55 */     return _os_;
/*     */   }
/*     */   
...
/*  73 */     this.addGeniusPoint = _os_.unmarshal_int();
/*  74 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  79 */     String path = dir + "mzm.gsp.item.confbean.SGeniusStoneItemCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  92 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SGeniusStoneItemCfg"))
/*     */         {
/*     */ 
/*  95 */           SGeniusStoneItemCfg obj = new SGeniusStoneItemCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SGeniusStoneItemCfg> all)
/*     */   {
/* 109 */     String path = dir + "mzm.gsp.item.confbean.SGeniusStoneItemCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 121 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SGeniusStoneItemCfg"))
/*     */         {
/*     */ 
/* 124 */           SGeniusStoneItemCfg obj = new SGeniusStoneItemCfg();
...
/*     */     
/* 140 */     String path = dir + "mzm.gsp.item.confbean.SGeniusStoneItemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 167 */           SGeniusStoneItemCfg _v_ = new SGeniusStoneItemCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SGeniusStoneItemCfg> all)
/*     */   {
/* 187 */     String path = dir + "mzm.gsp.item.confbean.SGeniusStoneItemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 214 */           SGeniusStoneItemCfg _v_ = new SGeniusStoneItemCfg();
...
/*     */   {
/* 233 */     for (Map.Entry<Integer, SGeniusStoneItemCfg> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static void handleData(Map<Integer, SGeniusStoneItemCfg> all, Map<Integer, SItemCfg> parent)
/*     */   {
/* 248 */     for (Map.Entry<Integer, SGeniusStoneItemCfg> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static SGeniusStoneItemCfg getOld(int key)
/*     */   {
/* 263 */     return (SGeniusStoneItemCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SGeniusStoneItemCfg get(int key)
/*     */   {
/* 268 */     return (SGeniusStoneItemCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SGeniusStoneItemCfg> getOldAllSelf()
/*     */   {
/* 273 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SGeniusStoneItemCfg> getAllSelf()
/*     */   {
/* 278 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SGeniusStoneItemCfg> newAll)
/*     */   {
/* 283 */     oldAll = all;
/* 284 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\item\confbean\SGeniusStoneItemCfg.class
