...
/*     */ 
/*     */ public class SFireWorksItem extends SItemCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  15 */   private static volatile Map<Integer, SFireWorksItem> oldAll = null;
/*     */   
/*  17 */   private static Map<Integer, SFireWorksItem> all = null;
/*     */   
/*     */ 
...
/*     */   {
/*  75 */     String path = dir + "mzm.gsp.item.confbean.SFireWorksItem.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  88 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SFireWorksItem"))
/*     */         {
/*     */ 
/*  91 */           SFireWorksItem obj = new SFireWorksItem();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SFireWorksItem> all)
/*     */   {
/* 105 */     String path = dir + "mzm.gsp.item.confbean.SFireWorksItem.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 117 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SFireWorksItem"))
/*     */         {
/*     */ 
/* 120 */           SFireWorksItem obj = new SFireWorksItem();
...
/*     */     
/* 136 */     String path = dir + "mzm.gsp.item.confbean.SFireWorksItem.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 163 */           SFireWorksItem _v_ = new SFireWorksItem();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SFireWorksItem> all)
/*     */   {
/* 183 */     String path = dir + "mzm.gsp.item.confbean.SFireWorksItem.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 210 */           SFireWorksItem _v_ = new SFireWorksItem();
...
/*     */   {
/* 229 */     for (Map.Entry<Integer, SFireWorksItem> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static void handleData(Map<Integer, SFireWorksItem> all, Map<Integer, SItemCfg> parent)
/*     */   {
/* 244 */     for (Map.Entry<Integer, SFireWorksItem> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static SFireWorksItem getOld(int key)
/*     */   {
/* 259 */     return (SFireWorksItem)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SFireWorksItem get(int key)
/*     */   {
/* 264 */     return (SFireWorksItem)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SFireWorksItem> getOldAllSelf()
/*     */   {
/* 269 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SFireWorksItem> getAllSelf()
/*     */   {
/* 274 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SFireWorksItem> newAll)
/*     */   {
/* 279 */     oldAll = all;
/* 280 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\item\confbean\SFireWorksItem.class
