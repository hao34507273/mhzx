...
/*     */ 
/*     */ public class SRoleExpItem extends SItemCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  15 */   private static volatile Map<Integer, SRoleExpItem> oldAll = null;
/*     */   
/*  17 */   private static Map<Integer, SRoleExpItem> all = null;
/*     */   
/*     */   public int rewardid;
...
/*  37 */     this.rewardid = Integer.valueOf(rootElement.attributeValue("rewardid")).intValue();
...
/*  76 */     this.rewardid = _os_.unmarshal_int();
...
/*     */   {
/*  83 */     String path = dir + "mzm.gsp.item.confbean.SRoleExpItem.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  96 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SRoleExpItem"))
/*     */         {
/*     */ 
/*  99 */           SRoleExpItem obj = new SRoleExpItem();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SRoleExpItem> all)
/*     */   {
/* 113 */     String path = dir + "mzm.gsp.item.confbean.SRoleExpItem.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 125 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SRoleExpItem"))
/*     */         {
/*     */ 
/* 128 */           SRoleExpItem obj = new SRoleExpItem();
...
/*     */     
/* 144 */     String path = dir + "mzm.gsp.item.confbean.SRoleExpItem.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 171 */           SRoleExpItem _v_ = new SRoleExpItem();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SRoleExpItem> all)
/*     */   {
/* 191 */     String path = dir + "mzm.gsp.item.confbean.SRoleExpItem.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 218 */           SRoleExpItem _v_ = new SRoleExpItem();
...
/*     */   {
/* 237 */     for (Map.Entry<Integer, SRoleExpItem> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static void handleData(Map<Integer, SRoleExpItem> all, Map<Integer, SItemCfg> parent)
/*     */   {
/* 252 */     for (Map.Entry<Integer, SRoleExpItem> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static SRoleExpItem getOld(int key)
/*     */   {
/* 267 */     return (SRoleExpItem)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SRoleExpItem get(int key)
/*     */   {
/* 272 */     return (SRoleExpItem)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SRoleExpItem> getOldAllSelf()
/*     */   {
/* 277 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SRoleExpItem> getAllSelf()
/*     */   {
/* 282 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SRoleExpItem> newAll)
/*     */   {
/* 287 */     oldAll = all;
/* 288 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\item\confbean\SRoleExpItem.class
