...
/*     */ 
/*     */ public class SItemShortCutCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SItemShortCutCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SItemShortCutCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public int itemId;
/*     */   
...
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.item.confbean.SItemShortCutCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SItemShortCutCfg"))
/*     */         {
/*     */ 
/*  59 */           SItemShortCutCfg obj = new SItemShortCutCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SItemShortCutCfg> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.item.confbean.SItemShortCutCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SItemShortCutCfg"))
/*     */         {
/*     */ 
/*  88 */           SItemShortCutCfg obj = new SItemShortCutCfg();
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.item.confbean.SItemShortCutCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           SItemShortCutCfg _v_ = new SItemShortCutCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SItemShortCutCfg> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.item.confbean.SItemShortCutCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           SItemShortCutCfg _v_ = new SItemShortCutCfg();
...
/*     */ 
/*     */ 
/*     */   public static SItemShortCutCfg getOld(int key)
/*     */   {
/* 199 */     return (SItemShortCutCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SItemShortCutCfg get(int key)
/*     */   {
/* 204 */     return (SItemShortCutCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SItemShortCutCfg> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SItemShortCutCfg> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SItemShortCutCfg> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\item\confbean\SItemShortCutCfg.class
