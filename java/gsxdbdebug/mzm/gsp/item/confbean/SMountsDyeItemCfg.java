...
/*     */ 
/*     */ public class SMountsDyeItemCfg extends SItemCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  15 */   private static volatile Map<Integer, SMountsDyeItemCfg> oldAll = null;
/*     */   
/*  17 */   private static Map<Integer, SMountsDyeItemCfg> all = null;
/*     */   
/*     */ 
...
/*     */   {
/*  75 */     String path = dir + "mzm.gsp.item.confbean.SMountsDyeItemCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  88 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SMountsDyeItemCfg"))
/*     */         {
/*     */ 
/*  91 */           SMountsDyeItemCfg obj = new SMountsDyeItemCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SMountsDyeItemCfg> all)
/*     */   {
/* 105 */     String path = dir + "mzm.gsp.item.confbean.SMountsDyeItemCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 117 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SMountsDyeItemCfg"))
/*     */         {
/*     */ 
/* 120 */           SMountsDyeItemCfg obj = new SMountsDyeItemCfg();
...
/*     */     
/* 136 */     String path = dir + "mzm.gsp.item.confbean.SMountsDyeItemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 163 */           SMountsDyeItemCfg _v_ = new SMountsDyeItemCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SMountsDyeItemCfg> all)
/*     */   {
/* 183 */     String path = dir + "mzm.gsp.item.confbean.SMountsDyeItemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 210 */           SMountsDyeItemCfg _v_ = new SMountsDyeItemCfg();
...
/*     */   {
/* 229 */     for (Map.Entry<Integer, SMountsDyeItemCfg> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static void handleData(Map<Integer, SMountsDyeItemCfg> all, Map<Integer, SItemCfg> parent)
/*     */   {
/* 244 */     for (Map.Entry<Integer, SMountsDyeItemCfg> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static SMountsDyeItemCfg getOld(int key)
/*     */   {
/* 259 */     return (SMountsDyeItemCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SMountsDyeItemCfg get(int key)
/*     */   {
/* 264 */     return (SMountsDyeItemCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMountsDyeItemCfg> getOldAllSelf()
/*     */   {
/* 269 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMountsDyeItemCfg> getAllSelf()
/*     */   {
/* 274 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SMountsDyeItemCfg> newAll)
/*     */   {
/* 279 */     oldAll = all;
/* 280 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\item\confbean\SMountsDyeItemCfg.class
