...
/*     */ 
/*     */ public class SItemSiftConCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SItemSiftConCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SItemSiftConCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public int itemType;
/*     */   
...
/*  37 */     this.itemType = _os_.unmarshal_int();
/*  38 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.item.confbean.SItemSiftConCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SItemSiftConCfg"))
/*     */         {
/*     */ 
/*  59 */           SItemSiftConCfg obj = new SItemSiftConCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SItemSiftConCfg> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.item.confbean.SItemSiftConCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SItemSiftConCfg"))
/*     */         {
/*     */ 
/*  88 */           SItemSiftConCfg obj = new SItemSiftConCfg();
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.item.confbean.SItemSiftConCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           SItemSiftConCfg _v_ = new SItemSiftConCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SItemSiftConCfg> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.item.confbean.SItemSiftConCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           SItemSiftConCfg _v_ = new SItemSiftConCfg();
...
/*     */ 
/*     */ 
/*     */   public static SItemSiftConCfg getOld(int key)
/*     */   {
/* 199 */     return (SItemSiftConCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SItemSiftConCfg get(int key)
/*     */   {
/* 204 */     return (SItemSiftConCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SItemSiftConCfg> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SItemSiftConCfg> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SItemSiftConCfg> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\item\confbean\SItemSiftConCfg.class
