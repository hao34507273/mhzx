...
/*     */ 
/*     */ public class SEquipModelCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SEquipModelCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SEquipModelCfg> all = null;
/*     */   
/*     */   public int id;
...
/*  24 */     this.resPath = rootElement.attributeValue("resPath");
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  29 */     _os_.marshal(this.id);
/*  30 */     _os_.marshal(this.resPath, "UTF-8");
/*  31 */     return _os_;
/*     */   }
/*     */   
...
/*  37 */     this.resPath = _os_.unmarshal_String("UTF-8");
/*  38 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.item.confbean.SEquipModelCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SEquipModelCfg"))
/*     */         {
/*     */ 
/*  59 */           SEquipModelCfg obj = new SEquipModelCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SEquipModelCfg> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.item.confbean.SEquipModelCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SEquipModelCfg"))
/*     */         {
/*     */ 
/*  88 */           SEquipModelCfg obj = new SEquipModelCfg();
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.item.confbean.SEquipModelCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           SEquipModelCfg _v_ = new SEquipModelCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SEquipModelCfg> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.item.confbean.SEquipModelCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           SEquipModelCfg _v_ = new SEquipModelCfg();
...
/*     */ 
/*     */ 
/*     */   public static SEquipModelCfg getOld(int key)
/*     */   {
/* 199 */     return (SEquipModelCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SEquipModelCfg get(int key)
/*     */   {
/* 204 */     return (SEquipModelCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SEquipModelCfg> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SEquipModelCfg> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SEquipModelCfg> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\item\confbean\SEquipModelCfg.class
