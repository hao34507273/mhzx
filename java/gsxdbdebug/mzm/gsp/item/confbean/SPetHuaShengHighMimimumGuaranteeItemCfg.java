...
/*     */ 
/*     */ public class SPetHuaShengHighMimimumGuaranteeItemCfg extends SItemCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  15 */   private static volatile Map<Integer, SPetHuaShengHighMimimumGuaranteeItemCfg> oldAll = null;
/*     */   
/*  17 */   private static Map<Integer, SPetHuaShengHighMimimumGuaranteeItemCfg> all = null;
/*     */   
/*     */ 
...
/*     */   {
/*  75 */     String path = dir + "mzm.gsp.item.confbean.SPetHuaShengHighMimimumGuaranteeItemCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  88 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SPetHuaShengHighMimimumGuaranteeItemCfg"))
/*     */         {
/*     */ 
/*  91 */           SPetHuaShengHighMimimumGuaranteeItemCfg obj = new SPetHuaShengHighMimimumGuaranteeItemCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SPetHuaShengHighMimimumGuaranteeItemCfg> all)
/*     */   {
/* 105 */     String path = dir + "mzm.gsp.item.confbean.SPetHuaShengHighMimimumGuaranteeItemCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 117 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SPetHuaShengHighMimimumGuaranteeItemCfg"))
/*     */         {
/*     */ 
/* 120 */           SPetHuaShengHighMimimumGuaranteeItemCfg obj = new SPetHuaShengHighMimimumGuaranteeItemCfg();
...
/*     */     
/* 136 */     String path = dir + "mzm.gsp.item.confbean.SPetHuaShengHighMimimumGuaranteeItemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 163 */           SPetHuaShengHighMimimumGuaranteeItemCfg _v_ = new SPetHuaShengHighMimimumGuaranteeItemCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SPetHuaShengHighMimimumGuaranteeItemCfg> all)
/*     */   {
/* 183 */     String path = dir + "mzm.gsp.item.confbean.SPetHuaShengHighMimimumGuaranteeItemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 210 */           SPetHuaShengHighMimimumGuaranteeItemCfg _v_ = new SPetHuaShengHighMimimumGuaranteeItemCfg();
...
/*     */   {
/* 229 */     for (Map.Entry<Integer, SPetHuaShengHighMimimumGuaranteeItemCfg> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static void handleData(Map<Integer, SPetHuaShengHighMimimumGuaranteeItemCfg> all, Map<Integer, SItemCfg> parent)
/*     */   {
/* 244 */     for (Map.Entry<Integer, SPetHuaShengHighMimimumGuaranteeItemCfg> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static SPetHuaShengHighMimimumGuaranteeItemCfg getOld(int key)
/*     */   {
/* 259 */     return (SPetHuaShengHighMimimumGuaranteeItemCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SPetHuaShengHighMimimumGuaranteeItemCfg get(int key)
/*     */   {
/* 264 */     return (SPetHuaShengHighMimimumGuaranteeItemCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPetHuaShengHighMimimumGuaranteeItemCfg> getOldAllSelf()
/*     */   {
/* 269 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPetHuaShengHighMimimumGuaranteeItemCfg> getAllSelf()
/*     */   {
/* 274 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SPetHuaShengHighMimimumGuaranteeItemCfg> newAll)
/*     */   {
/* 279 */     oldAll = all;
/* 280 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\item\confbean\SPetHuaShengHighMimimumGuaranteeItemCfg.class
