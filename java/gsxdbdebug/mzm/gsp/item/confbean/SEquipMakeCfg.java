...
/*     */ 
/*     */ public class SEquipMakeCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SEquipMakeCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SEquipMakeCfg> all = null;
/*     */   
/*     */   public int id;
...
/*  27 */     this.eqpId = Integer.valueOf(rootElement.attributeValue("eqpId")).intValue();
/*  28 */     this.makeCfgId = Integer.valueOf(rootElement.attributeValue("makeCfgId")).intValue();
/*     */   }
/*     */   
...
/*  35 */     _os_.marshal(this.eqpId);
/*  36 */     _os_.marshal(this.makeCfgId);
/*  37 */     return _os_;
/*     */   }
/*     */   
...
/*  44 */     this.eqpId = _os_.unmarshal_int();
/*  45 */     this.makeCfgId = _os_.unmarshal_int();
/*  46 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  51 */     String path = dir + "mzm.gsp.item.confbean.SEquipMakeCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  64 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SEquipMakeCfg"))
/*     */         {
/*     */ 
/*  67 */           SEquipMakeCfg obj = new SEquipMakeCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SEquipMakeCfg> all)
/*     */   {
/*  81 */     String path = dir + "mzm.gsp.item.confbean.SEquipMakeCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SEquipMakeCfg"))
/*     */         {
/*     */ 
/*  96 */           SEquipMakeCfg obj = new SEquipMakeCfg();
...
/*     */     
/* 112 */     String path = dir + "mzm.gsp.item.confbean.SEquipMakeCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 139 */           SEquipMakeCfg _v_ = new SEquipMakeCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SEquipMakeCfg> all)
/*     */   {
/* 159 */     String path = dir + "mzm.gsp.item.confbean.SEquipMakeCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 186 */           SEquipMakeCfg _v_ = new SEquipMakeCfg();
...
/*     */ 
/*     */ 
/*     */   public static SEquipMakeCfg getOld(int key)
/*     */   {
/* 207 */     return (SEquipMakeCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SEquipMakeCfg get(int key)
/*     */   {
/* 212 */     return (SEquipMakeCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SEquipMakeCfg> getOldAll()
/*     */   {
/* 217 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SEquipMakeCfg> getAll()
/*     */   {
/* 222 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SEquipMakeCfg> newAll)
/*     */   {
/* 227 */     oldAll = all;
/* 228 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\item\confbean\SEquipMakeCfg.class
