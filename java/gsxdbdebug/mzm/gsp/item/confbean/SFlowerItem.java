...
/*     */ 
/*     */ public class SFlowerItem extends SItemCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  15 */   private static volatile Map<Integer, SFlowerItem> oldAll = null;
/*     */   
/*  17 */   private static Map<Integer, SFlowerItem> all = null;
/*     */   
...
/*  40 */     this.addIntimacyNum = Integer.valueOf(rootElement.attributeValue("addIntimacyNum")).intValue();
/*  41 */     this.rankPoint = Integer.valueOf(rootElement.attributeValue("rankPoint")).intValue();
/*  42 */     this.effectid = Integer.valueOf(rootElement.attributeValue("effectid")).intValue();
/*  43 */     this.isbulletin = Boolean.valueOf(rootElement.attributeValue("isbulletin")).booleanValue();
/*  44 */     this.isservereffect = Boolean.valueOf(rootElement.attributeValue("isservereffect")).booleanValue();
/*     */   }
/*     */   
...
/*  62 */     _os_.marshal(this.addIntimacyNum);
/*  63 */     _os_.marshal(this.rankPoint);
/*  64 */     _os_.marshal(this.effectid);
/*  65 */     _os_.marshal(this.isbulletin);
/*  66 */     _os_.marshal(this.isservereffect);
/*  67 */     return _os_;
/*     */   }
/*     */   
...
/*  85 */     this.addIntimacyNum = _os_.unmarshal_int();
/*  86 */     this.rankPoint = _os_.unmarshal_int();
/*  87 */     this.effectid = _os_.unmarshal_int();
/*  88 */     this.isbulletin = _os_.unmarshal_boolean();
/*  89 */     this.isservereffect = _os_.unmarshal_boolean();
/*  90 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  95 */     String path = dir + "mzm.gsp.item.confbean.SFlowerItem.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 108 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SFlowerItem"))
/*     */         {
/*     */ 
/* 111 */           SFlowerItem obj = new SFlowerItem();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SFlowerItem> all)
/*     */   {
/* 125 */     String path = dir + "mzm.gsp.item.confbean.SFlowerItem.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 137 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SFlowerItem"))
/*     */         {
/*     */ 
/* 140 */           SFlowerItem obj = new SFlowerItem();
...
/*     */     
/* 156 */     String path = dir + "mzm.gsp.item.confbean.SFlowerItem.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 183 */           SFlowerItem _v_ = new SFlowerItem();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SFlowerItem> all)
/*     */   {
/* 203 */     String path = dir + "mzm.gsp.item.confbean.SFlowerItem.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 230 */           SFlowerItem _v_ = new SFlowerItem();
...
/*     */   {
/* 249 */     for (Map.Entry<Integer, SFlowerItem> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static void handleData(Map<Integer, SFlowerItem> all, Map<Integer, SItemCfg> parent)
/*     */   {
/* 264 */     for (Map.Entry<Integer, SFlowerItem> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static SFlowerItem getOld(int key)
/*     */   {
/* 279 */     return (SFlowerItem)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SFlowerItem get(int key)
/*     */   {
/* 284 */     return (SFlowerItem)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SFlowerItem> getOldAllSelf()
/*     */   {
/* 289 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SFlowerItem> getAllSelf()
/*     */   {
/* 294 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SFlowerItem> newAll)
/*     */   {
/* 299 */     oldAll = all;
/* 300 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\item\confbean\SFlowerItem.class
