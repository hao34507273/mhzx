...
/*     */ 
/*     */ public class SGiveItemNumCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SGiveItemNumCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SGiveItemNumCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public int minLevelDelta;
/*     */   public int maxLevelDelta;
/*     */   public int giveNum;
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  25 */     this.id = Integer.valueOf(rootElement.attributeValue("id")).intValue();
/*  26 */     this.minLevelDelta = Integer.valueOf(rootElement.attributeValue("minLevelDelta")).intValue();
/*  27 */     this.maxLevelDelta = Integer.valueOf(rootElement.attributeValue("maxLevelDelta")).intValue();
/*  28 */     this.giveNum = Integer.valueOf(rootElement.attributeValue("giveNum")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  33 */     _os_.marshal(this.id);
/*  34 */     _os_.marshal(this.minLevelDelta);
/*  35 */     _os_.marshal(this.maxLevelDelta);
/*  36 */     _os_.marshal(this.giveNum);
/*  37 */     return _os_;
/*     */   }
/*     */   
...
/*  43 */     this.minLevelDelta = _os_.unmarshal_int();
/*  44 */     this.maxLevelDelta = _os_.unmarshal_int();
/*  45 */     this.giveNum = _os_.unmarshal_int();
/*  46 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  51 */     String path = dir + "mzm.gsp.item.confbean.SGiveItemNumCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  64 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SGiveItemNumCfg"))
/*     */         {
/*     */ 
/*  67 */           SGiveItemNumCfg obj = new SGiveItemNumCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SGiveItemNumCfg> all)
/*     */   {
/*  81 */     String path = dir + "mzm.gsp.item.confbean.SGiveItemNumCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SGiveItemNumCfg"))
/*     */         {
/*     */ 
/*  96 */           SGiveItemNumCfg obj = new SGiveItemNumCfg();
...
/*     */     
/* 112 */     String path = dir + "mzm.gsp.item.confbean.SGiveItemNumCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 139 */           SGiveItemNumCfg _v_ = new SGiveItemNumCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SGiveItemNumCfg> all)
/*     */   {
/* 159 */     String path = dir + "mzm.gsp.item.confbean.SGiveItemNumCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 186 */           SGiveItemNumCfg _v_ = new SGiveItemNumCfg();
...
/*     */ 
/*     */ 
/*     */   public static SGiveItemNumCfg getOld(int key)
/*     */   {
/* 207 */     return (SGiveItemNumCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SGiveItemNumCfg get(int key)
/*     */   {
/* 212 */     return (SGiveItemNumCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SGiveItemNumCfg> getOldAll()
/*     */   {
/* 217 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SGiveItemNumCfg> getAll()
/*     */   {
/* 222 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SGiveItemNumCfg> newAll)
/*     */   {
/* 227 */     oldAll = all;
/* 228 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\item\confbean\SGiveItemNumCfg.class
