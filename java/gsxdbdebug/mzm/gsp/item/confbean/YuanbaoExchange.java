...
/*    */ 
/*    */ public class YuanbaoExchange implements com.goldhuman.Common.Marshal.Marshal
/*    */ {
/*  9 */   public HashMap<Integer, Integer> yuanbao2value = new HashMap();
/*    */   
/*    */ 
/*    */   public void loadFromXml(Element rootElement)
/*    */   {
/* 14 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "yuanbao2value");
...
/*    */         }
/*    */         
/* 65 */         this.yuanbao2value.put(Integer.valueOf(_k_), Integer.valueOf(_v_));
/*    */       }
/*    */     }
/*    */   }
/*    */   
...
/*    */   {
/* 72 */     _os_.compact_uint32(this.yuanbao2value.size());
/* 73 */     for (java.util.Map.Entry<Integer, Integer> _e_ : this.yuanbao2value.entrySet())
/*    */     {
...
/* 89 */       this.yuanbao2value.put(Integer.valueOf(_k_), Integer.valueOf(_v_));
/*    */     }
/* 91 */     return _os_;
/*    */   }
/*    */ }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\item\confbean\YuanbaoExchange.class
