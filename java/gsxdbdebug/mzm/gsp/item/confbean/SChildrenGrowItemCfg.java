...
/*     */ 
/*     */ public class SChildrenGrowItemCfg extends SItemCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  15 */   private static volatile Map<Integer, SChildrenGrowItemCfg> oldAll = null;
/*     */   
/*  17 */   private static Map<Integer, SChildrenGrowItemCfg> all = null;
/*     */   
/*     */   public int growRateMin;
/*     */   public int growRateMax;
...
/*  38 */     this.growRateMin = Integer.valueOf(rootElement.attributeValue("growRateMin")).intValue();
/*  39 */     this.growRateMax = Integer.valueOf(rootElement.attributeValue("growRateMax")).intValue();
/*  40 */     this.addUseCount = Boolean.valueOf(rootElement.attributeValue("addUseCount")).booleanValue();
/*     */   }
/*     */   
...
/*  58 */     _os_.marshal(this.growRateMin);
/*  59 */     _os_.marshal(this.growRateMax);
/*  60 */     _os_.marshal(this.addUseCount);
/*  61 */     return _os_;
/*     */   }
/*     */   
...
/*  79 */     this.growRateMin = _os_.unmarshal_int();
/*  80 */     this.growRateMax = _os_.unmarshal_int();
/*  81 */     this.addUseCount = _os_.unmarshal_boolean();
/*  82 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  87 */     String path = dir + "mzm.gsp.item.confbean.SChildrenGrowItemCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 100 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SChildrenGrowItemCfg"))
/*     */         {
/*     */ 
/* 103 */           SChildrenGrowItemCfg obj = new SChildrenGrowItemCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SChildrenGrowItemCfg> all)
/*     */   {
/* 117 */     String path = dir + "mzm.gsp.item.confbean.SChildrenGrowItemCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 129 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SChildrenGrowItemCfg"))
/*     */         {
/*     */ 
/* 132 */           SChildrenGrowItemCfg obj = new SChildrenGrowItemCfg();
...
/*     */     
/* 148 */     String path = dir + "mzm.gsp.item.confbean.SChildrenGrowItemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 175 */           SChildrenGrowItemCfg _v_ = new SChildrenGrowItemCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SChildrenGrowItemCfg> all)
/*     */   {
/* 195 */     String path = dir + "mzm.gsp.item.confbean.SChildrenGrowItemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 222 */           SChildrenGrowItemCfg _v_ = new SChildrenGrowItemCfg();
...
/*     */   {
/* 241 */     for (Map.Entry<Integer, SChildrenGrowItemCfg> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static void handleData(Map<Integer, SChildrenGrowItemCfg> all, Map<Integer, SItemCfg> parent)
/*     */   {
/* 256 */     for (Map.Entry<Integer, SChildrenGrowItemCfg> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static SChildrenGrowItemCfg getOld(int key)
/*     */   {
/* 271 */     return (SChildrenGrowItemCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SChildrenGrowItemCfg get(int key)
/*     */   {
/* 276 */     return (SChildrenGrowItemCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SChildrenGrowItemCfg> getOldAllSelf()
/*     */   {
/* 281 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SChildrenGrowItemCfg> getAllSelf()
/*     */   {
/* 286 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SChildrenGrowItemCfg> newAll)
/*     */   {
/* 291 */     oldAll = all;
/* 292 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\item\confbean\SChildrenGrowItemCfg.class
