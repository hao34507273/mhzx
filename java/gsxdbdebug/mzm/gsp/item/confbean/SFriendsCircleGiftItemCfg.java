...
/*     */ 
/*     */ public class SFriendsCircleGiftItemCfg extends SItemCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  15 */   private static volatile Map<Integer, SFriendsCircleGiftItemCfg> oldAll = null;
/*     */   
/*  17 */   private static Map<Integer, SFriendsCircleGiftItemCfg> all = null;
/*     */   
/*     */ 
...
/*     */   {
/*  75 */     String path = dir + "mzm.gsp.item.confbean.SFriendsCircleGiftItemCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  88 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SFriendsCircleGiftItemCfg"))
/*     */         {
/*     */ 
/*  91 */           SFriendsCircleGiftItemCfg obj = new SFriendsCircleGiftItemCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SFriendsCircleGiftItemCfg> all)
/*     */   {
/* 105 */     String path = dir + "mzm.gsp.item.confbean.SFriendsCircleGiftItemCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 117 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SFriendsCircleGiftItemCfg"))
/*     */         {
/*     */ 
/* 120 */           SFriendsCircleGiftItemCfg obj = new SFriendsCircleGiftItemCfg();
...
/*     */     
/* 136 */     String path = dir + "mzm.gsp.item.confbean.SFriendsCircleGiftItemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 163 */           SFriendsCircleGiftItemCfg _v_ = new SFriendsCircleGiftItemCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SFriendsCircleGiftItemCfg> all)
/*     */   {
/* 183 */     String path = dir + "mzm.gsp.item.confbean.SFriendsCircleGiftItemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 210 */           SFriendsCircleGiftItemCfg _v_ = new SFriendsCircleGiftItemCfg();
...
/*     */   {
/* 229 */     for (Map.Entry<Integer, SFriendsCircleGiftItemCfg> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static void handleData(Map<Integer, SFriendsCircleGiftItemCfg> all, Map<Integer, SItemCfg> parent)
/*     */   {
/* 244 */     for (Map.Entry<Integer, SFriendsCircleGiftItemCfg> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static SFriendsCircleGiftItemCfg getOld(int key)
/*     */   {
/* 259 */     return (SFriendsCircleGiftItemCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SFriendsCircleGiftItemCfg get(int key)
/*     */   {
/* 264 */     return (SFriendsCircleGiftItemCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SFriendsCircleGiftItemCfg> getOldAllSelf()
/*     */   {
/* 269 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SFriendsCircleGiftItemCfg> getAllSelf()
/*     */   {
/* 274 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SFriendsCircleGiftItemCfg> newAll)
/*     */   {
/* 279 */     oldAll = all;
/* 280 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\item\confbean\SFriendsCircleGiftItemCfg.class
