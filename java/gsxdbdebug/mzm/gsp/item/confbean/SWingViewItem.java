...
/*     */ 
/*     */ public class SWingViewItem extends SItemCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  15 */   private static volatile Map<Integer, SWingViewItem> oldAll = null;
/*     */   
/*  17 */   private static Map<Integer, SWingViewItem> all = null;
/*     */   
/*     */   public int wingId;
/*     */   
...
/*  36 */     this.wingId = Integer.valueOf(rootElement.attributeValue("wingId")).intValue();
/*     */   }
/*     */   
...
/*  73 */     this.wingId = _os_.unmarshal_int();
/*  74 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  79 */     String path = dir + "mzm.gsp.item.confbean.SWingViewItem.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  92 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SWingViewItem"))
/*     */         {
/*     */ 
/*  95 */           SWingViewItem obj = new SWingViewItem();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SWingViewItem> all)
/*     */   {
/* 109 */     String path = dir + "mzm.gsp.item.confbean.SWingViewItem.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 121 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SWingViewItem"))
/*     */         {
/*     */ 
/* 124 */           SWingViewItem obj = new SWingViewItem();
...
/*     */     
/* 140 */     String path = dir + "mzm.gsp.item.confbean.SWingViewItem.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 167 */           SWingViewItem _v_ = new SWingViewItem();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SWingViewItem> all)
/*     */   {
/* 187 */     String path = dir + "mzm.gsp.item.confbean.SWingViewItem.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 214 */           SWingViewItem _v_ = new SWingViewItem();
...
/*     */   {
/* 233 */     for (Map.Entry<Integer, SWingViewItem> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static void handleData(Map<Integer, SWingViewItem> all, Map<Integer, SItemCfg> parent)
/*     */   {
/* 248 */     for (Map.Entry<Integer, SWingViewItem> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static SWingViewItem getOld(int key)
/*     */   {
/* 263 */     return (SWingViewItem)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SWingViewItem get(int key)
/*     */   {
/* 268 */     return (SWingViewItem)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SWingViewItem> getOldAllSelf()
/*     */   {
/* 273 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SWingViewItem> getAllSelf()
/*     */   {
/* 278 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SWingViewItem> newAll)
/*     */   {
/* 283 */     oldAll = all;
/* 284 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\item\confbean\SWingViewItem.class
