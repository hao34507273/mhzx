...
/*     */ 
/*     */ public class SCakeItemCfg extends SItemCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  15 */   private static volatile Map<Integer, SCakeItemCfg> oldAll = null;
/*     */   
/*  17 */   private static Map<Integer, SCakeItemCfg> all = null;
/*     */   
/*     */   public int awardId;
/*     */   public int doubleAwardRet;
/*     */   
...
/*  38 */     this.doubleAwardRet = Integer.valueOf(rootElement.attributeValue("doubleAwardRet")).intValue();
/*     */   }
/*     */   
...
/*  57 */     _os_.marshal(this.doubleAwardRet);
/*  58 */     return _os_;
/*     */   }
/*     */   
...
/*  76 */     this.awardId = _os_.unmarshal_int();
/*  77 */     this.doubleAwardRet = _os_.unmarshal_int();
/*  78 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  83 */     String path = dir + "mzm.gsp.item.confbean.SCakeItemCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  96 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SCakeItemCfg"))
/*     */         {
/*     */ 
/*  99 */           SCakeItemCfg obj = new SCakeItemCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SCakeItemCfg> all)
/*     */   {
/* 113 */     String path = dir + "mzm.gsp.item.confbean.SCakeItemCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 125 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SCakeItemCfg"))
/*     */         {
/*     */ 
/* 128 */           SCakeItemCfg obj = new SCakeItemCfg();
...
/*     */     
/* 144 */     String path = dir + "mzm.gsp.item.confbean.SCakeItemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 171 */           SCakeItemCfg _v_ = new SCakeItemCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SCakeItemCfg> all)
/*     */   {
/* 191 */     String path = dir + "mzm.gsp.item.confbean.SCakeItemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 218 */           SCakeItemCfg _v_ = new SCakeItemCfg();
...
/*     */   {
/* 237 */     for (Map.Entry<Integer, SCakeItemCfg> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static void handleData(Map<Integer, SCakeItemCfg> all, Map<Integer, SItemCfg> parent)
/*     */   {
/* 252 */     for (Map.Entry<Integer, SCakeItemCfg> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static SCakeItemCfg getOld(int key)
/*     */   {
/* 267 */     return (SCakeItemCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SCakeItemCfg get(int key)
/*     */   {
/* 272 */     return (SCakeItemCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SCakeItemCfg> getOldAllSelf()
/*     */   {
/* 277 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SCakeItemCfg> getAllSelf()
/*     */   {
/* 282 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SCakeItemCfg> newAll)
/*     */   {
/* 287 */     oldAll = all;
/* 288 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\item\confbean\SCakeItemCfg.class
