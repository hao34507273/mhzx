...
/*     */ 
/*     */ public class SExpCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SExpCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SExpCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public int expType;
/*     */   
...
/*  24 */     this.expType = Integer.valueOf(rootElement.attributeValue("expType")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  29 */     _os_.marshal(this.id);
/*  30 */     _os_.marshal(this.expType);
/*  31 */     return _os_;
/*     */   }
/*     */   
...
/*  37 */     this.expType = _os_.unmarshal_int();
/*  38 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.item.confbean.SExpCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SExpCfg"))
/*     */         {
/*     */ 
/*  59 */           SExpCfg obj = new SExpCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SExpCfg> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.item.confbean.SExpCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SExpCfg"))
/*     */         {
/*     */ 
/*  88 */           SExpCfg obj = new SExpCfg();
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.item.confbean.SExpCfg.bny";
/*     */     try
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SExpCfg> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.item.confbean.SExpCfg.bny";
/*     */     try
/*     */     {
...
/*     */ 
/*     */ 
/*     */   public static SExpCfg getOld(int key)
/*     */   {
/* 199 */     return (SExpCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SExpCfg get(int key)
/*     */   {
/* 204 */     return (SExpCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SExpCfg> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SExpCfg> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SExpCfg> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\item\confbean\SExpCfg.class
