...
/*     */ 
/*     */ public class SPetGrowItem extends SItemCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  15 */   private static volatile Map<Integer, SPetGrowItem> oldAll = null;
/*     */   
/*  17 */   private static Map<Integer, SPetGrowItem> all = null;
/*     */   
/*     */   public int addGrowValueMinLimit;
/*     */   public int addGrowValueMaxLimit;
/*     */   
...
/*  37 */     this.addGrowValueMinLimit = Integer.valueOf(rootElement.attributeValue("addGrowValueMinLimit")).intValue();
/*  38 */     this.addGrowValueMaxLimit = Integer.valueOf(rootElement.attributeValue("addGrowValueMaxLimit")).intValue();
/*     */   }
/*     */   
...
/*  56 */     _os_.marshal(this.addGrowValueMinLimit);
/*  57 */     _os_.marshal(this.addGrowValueMaxLimit);
/*  58 */     return _os_;
/*     */   }
/*     */   
...
/*  76 */     this.addGrowValueMinLimit = _os_.unmarshal_int();
/*  77 */     this.addGrowValueMaxLimit = _os_.unmarshal_int();
/*  78 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  83 */     String path = dir + "mzm.gsp.item.confbean.SPetGrowItem.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  96 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SPetGrowItem"))
/*     */         {
/*     */ 
/*  99 */           SPetGrowItem obj = new SPetGrowItem();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SPetGrowItem> all)
/*     */   {
/* 113 */     String path = dir + "mzm.gsp.item.confbean.SPetGrowItem.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 125 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SPetGrowItem"))
/*     */         {
/*     */ 
/* 128 */           SPetGrowItem obj = new SPetGrowItem();
...
/*     */     
/* 144 */     String path = dir + "mzm.gsp.item.confbean.SPetGrowItem.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 171 */           SPetGrowItem _v_ = new SPetGrowItem();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SPetGrowItem> all)
/*     */   {
/* 191 */     String path = dir + "mzm.gsp.item.confbean.SPetGrowItem.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 218 */           SPetGrowItem _v_ = new SPetGrowItem();
...
/*     */   {
/* 237 */     for (Map.Entry<Integer, SPetGrowItem> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static void handleData(Map<Integer, SPetGrowItem> all, Map<Integer, SItemCfg> parent)
/*     */   {
/* 252 */     for (Map.Entry<Integer, SPetGrowItem> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static SPetGrowItem getOld(int key)
/*     */   {
/* 267 */     return (SPetGrowItem)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SPetGrowItem get(int key)
/*     */   {
/* 272 */     return (SPetGrowItem)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPetGrowItem> getOldAllSelf()
/*     */   {
/* 277 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPetGrowItem> getAllSelf()
/*     */   {
/* 282 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SPetGrowItem> newAll)
/*     */   {
/* 287 */     oldAll = all;
/* 288 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\item\confbean\SPetGrowItem.class
