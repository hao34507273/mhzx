...
/*     */ 
/*     */ public class SChildrenSpecialSkillItemCfg extends SItemCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  15 */   private static volatile Map<Integer, SChildrenSpecialSkillItemCfg> oldAll = null;
/*     */   
/*  17 */   private static Map<Integer, SChildrenSpecialSkillItemCfg> all = null;
/*     */   
/*     */   public int skillid;
/*     */   
...
/*  73 */     this.skillid = _os_.unmarshal_int();
/*  74 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  79 */     String path = dir + "mzm.gsp.item.confbean.SChildrenSpecialSkillItemCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  92 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SChildrenSpecialSkillItemCfg"))
/*     */         {
/*     */ 
/*  95 */           SChildrenSpecialSkillItemCfg obj = new SChildrenSpecialSkillItemCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SChildrenSpecialSkillItemCfg> all)
/*     */   {
/* 109 */     String path = dir + "mzm.gsp.item.confbean.SChildrenSpecialSkillItemCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 121 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SChildrenSpecialSkillItemCfg"))
/*     */         {
/*     */ 
/* 124 */           SChildrenSpecialSkillItemCfg obj = new SChildrenSpecialSkillItemCfg();
...
/*     */     
/* 140 */     String path = dir + "mzm.gsp.item.confbean.SChildrenSpecialSkillItemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 167 */           SChildrenSpecialSkillItemCfg _v_ = new SChildrenSpecialSkillItemCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SChildrenSpecialSkillItemCfg> all)
/*     */   {
/* 187 */     String path = dir + "mzm.gsp.item.confbean.SChildrenSpecialSkillItemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 214 */           SChildrenSpecialSkillItemCfg _v_ = new SChildrenSpecialSkillItemCfg();
...
/*     */   {
/* 233 */     for (Map.Entry<Integer, SChildrenSpecialSkillItemCfg> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static void handleData(Map<Integer, SChildrenSpecialSkillItemCfg> all, Map<Integer, SItemCfg> parent)
/*     */   {
/* 248 */     for (Map.Entry<Integer, SChildrenSpecialSkillItemCfg> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static SChildrenSpecialSkillItemCfg getOld(int key)
/*     */   {
/* 263 */     return (SChildrenSpecialSkillItemCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SChildrenSpecialSkillItemCfg get(int key)
/*     */   {
/* 268 */     return (SChildrenSpecialSkillItemCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SChildrenSpecialSkillItemCfg> getOldAllSelf()
/*     */   {
/* 273 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SChildrenSpecialSkillItemCfg> getAllSelf()
/*     */   {
/* 278 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SChildrenSpecialSkillItemCfg> newAll)
/*     */   {
/* 283 */     oldAll = all;
/* 284 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\item\confbean\SChildrenSpecialSkillItemCfg.class
