...
/*     */ 
/*     */ public class SAdulthoodChildrenCompensateItemCfg extends SItemCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  15 */   private static volatile Map<Integer, SAdulthoodChildrenCompensateItemCfg> oldAll = null;
/*     */   
/*  17 */   private static Map<Integer, SAdulthoodChildrenCompensateItemCfg> all = null;
/*     */   
/*     */   public int compensate_cfg_id;
/*     */   
...
/*  36 */     this.compensate_cfg_id = Integer.valueOf(rootElement.attributeValue("compensate_cfg_id")).intValue();
/*     */   }
/*     */   
...
/*  54 */     _os_.marshal(this.compensate_cfg_id);
/*  55 */     return _os_;
/*     */   }
/*     */   
...
/*  73 */     this.compensate_cfg_id = _os_.unmarshal_int();
/*  74 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  79 */     String path = dir + "mzm.gsp.item.confbean.SAdulthoodChildrenCompensateItemCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  92 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SAdulthoodChildrenCompensateItemCfg"))
/*     */         {
/*     */ 
/*  95 */           SAdulthoodChildrenCompensateItemCfg obj = new SAdulthoodChildrenCompensateItemCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SAdulthoodChildrenCompensateItemCfg> all)
/*     */   {
/* 109 */     String path = dir + "mzm.gsp.item.confbean.SAdulthoodChildrenCompensateItemCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 121 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SAdulthoodChildrenCompensateItemCfg"))
/*     */         {
/*     */ 
/* 124 */           SAdulthoodChildrenCompensateItemCfg obj = new SAdulthoodChildrenCompensateItemCfg();
...
/*     */     
/* 140 */     String path = dir + "mzm.gsp.item.confbean.SAdulthoodChildrenCompensateItemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 167 */           SAdulthoodChildrenCompensateItemCfg _v_ = new SAdulthoodChildrenCompensateItemCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SAdulthoodChildrenCompensateItemCfg> all)
/*     */   {
/* 187 */     String path = dir + "mzm.gsp.item.confbean.SAdulthoodChildrenCompensateItemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 214 */           SAdulthoodChildrenCompensateItemCfg _v_ = new SAdulthoodChildrenCompensateItemCfg();
...
/*     */   {
/* 233 */     for (Map.Entry<Integer, SAdulthoodChildrenCompensateItemCfg> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static void handleData(Map<Integer, SAdulthoodChildrenCompensateItemCfg> all, Map<Integer, SItemCfg> parent)
/*     */   {
/* 248 */     for (Map.Entry<Integer, SAdulthoodChildrenCompensateItemCfg> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static SAdulthoodChildrenCompensateItemCfg getOld(int key)
/*     */   {
/* 263 */     return (SAdulthoodChildrenCompensateItemCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SAdulthoodChildrenCompensateItemCfg get(int key)
/*     */   {
/* 268 */     return (SAdulthoodChildrenCompensateItemCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SAdulthoodChildrenCompensateItemCfg> getOldAllSelf()
/*     */   {
/* 273 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SAdulthoodChildrenCompensateItemCfg> getAllSelf()
/*     */   {
/* 278 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SAdulthoodChildrenCompensateItemCfg> newAll)
/*     */   {
/* 283 */     oldAll = all;
/* 284 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\item\confbean\SAdulthoodChildrenCompensateItemCfg.class
