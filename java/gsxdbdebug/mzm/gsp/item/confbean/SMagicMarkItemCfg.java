...
/*     */ 
/*     */ public class SMagicMarkItemCfg extends SItemCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  15 */   private static volatile Map<Integer, SMagicMarkItemCfg> oldAll = null;
/*     */   
/*  17 */   private static Map<Integer, SMagicMarkItemCfg> all = null;
/*     */   
...
/*  37 */     this.magicType = Integer.valueOf(rootElement.attributeValue("magicType")).intValue();
/*  38 */     this.lastHour = Integer.valueOf(rootElement.attributeValue("lastHour")).intValue();
/*     */   }
/*     */   
...
/*  56 */     _os_.marshal(this.magicType);
/*  57 */     _os_.marshal(this.lastHour);
/*  58 */     return _os_;
/*     */   }
/*     */   
...
/*  76 */     this.magicType = _os_.unmarshal_int();
/*  77 */     this.lastHour = _os_.unmarshal_int();
/*  78 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  83 */     String path = dir + "mzm.gsp.item.confbean.SMagicMarkItemCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  96 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SMagicMarkItemCfg"))
/*     */         {
/*     */ 
/*  99 */           SMagicMarkItemCfg obj = new SMagicMarkItemCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SMagicMarkItemCfg> all)
/*     */   {
/* 113 */     String path = dir + "mzm.gsp.item.confbean.SMagicMarkItemCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 125 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SMagicMarkItemCfg"))
/*     */         {
/*     */ 
/* 128 */           SMagicMarkItemCfg obj = new SMagicMarkItemCfg();
...
/*     */     
/* 144 */     String path = dir + "mzm.gsp.item.confbean.SMagicMarkItemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 171 */           SMagicMarkItemCfg _v_ = new SMagicMarkItemCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SMagicMarkItemCfg> all)
/*     */   {
/* 191 */     String path = dir + "mzm.gsp.item.confbean.SMagicMarkItemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 218 */           SMagicMarkItemCfg _v_ = new SMagicMarkItemCfg();
...
/*     */   {
/* 237 */     for (Map.Entry<Integer, SMagicMarkItemCfg> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static void handleData(Map<Integer, SMagicMarkItemCfg> all, Map<Integer, SItemCfg> parent)
/*     */   {
/* 252 */     for (Map.Entry<Integer, SMagicMarkItemCfg> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static SMagicMarkItemCfg getOld(int key)
/*     */   {
/* 267 */     return (SMagicMarkItemCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SMagicMarkItemCfg get(int key)
/*     */   {
/* 272 */     return (SMagicMarkItemCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMagicMarkItemCfg> getOldAllSelf()
/*     */   {
/* 277 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMagicMarkItemCfg> getAllSelf()
/*     */   {
/* 282 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SMagicMarkItemCfg> newAll)
/*     */   {
/* 287 */     oldAll = all;
/* 288 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\item\confbean\SMagicMarkItemCfg.class
