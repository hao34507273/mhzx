...
/*     */ 
/*     */ public class SServerlevel2YuanbaoExchange implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SServerlevel2YuanbaoExchange> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SServerlevel2YuanbaoExchange> all = null;
/*     */   
/*     */   public int serverlevel;
/*  19 */   public HashMap<Integer, YuanbaoExchange> type2YuanbaoExchange = new HashMap();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.serverlevel = Integer.valueOf(rootElement.attributeValue("serverlevel")).intValue();
/*     */     
/*  25 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "type2YuanbaoExchange");
...
/*  51 */             keyElem = elem;
/*     */           }
/*  53 */           else if ((valueElem == null) && (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.YuanbaoExchange")))
/*     */           {
/*  55 */             valueElem = elem;
/*     */           }
/*     */         }
...
/*     */         }
/*     */         
/*  77 */         this.type2YuanbaoExchange.put(Integer.valueOf(_k_), _v_);
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*  85 */     _os_.compact_uint32(this.type2YuanbaoExchange.size());
/*  86 */     for (java.util.Map.Entry<Integer, YuanbaoExchange> _e_ : this.type2YuanbaoExchange.entrySet())
/*     */     {
...
/*     */   {
/*  96 */     this.serverlevel = _os_.unmarshal_int();
/*  97 */     for (int _size_ = _os_.uncompact_uint32(); _size_ > 0; _size_--)
/*     */     {
/*     */ 
/* 100 */       int _k_ = _os_.unmarshal_int();
/*     */       
/* 102 */       YuanbaoExchange _v_ = new YuanbaoExchange();
/* 103 */       _v_.unmarshal(_os_);
/* 104 */       this.type2YuanbaoExchange.put(Integer.valueOf(_k_), _v_);
/*     */     }
/* 106 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/* 111 */     String path = dir + "mzm.gsp.item.confbean.SServerlevel2YuanbaoExchange.xml";
/*     */     
/*     */     try
/*     */     {
/* 115 */       all = new HashMap();
...
/* 124 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SServerlevel2YuanbaoExchange"))
/*     */         {
/*     */ 
/* 127 */           SServerlevel2YuanbaoExchange obj = new SServerlevel2YuanbaoExchange();
/* 128 */           obj.loadFromXml(elem);
/* 129 */           if (all.put(Integer.valueOf(obj.serverlevel), obj) != null) {
/* 130 */             throw new RuntimeException("duplicate key : " + obj.serverlevel);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SServerlevel2YuanbaoExchange> all)
/*     */   {
/* 141 */     String path = dir + "mzm.gsp.item.confbean.SServerlevel2YuanbaoExchange.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 153 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SServerlevel2YuanbaoExchange"))
/*     */         {
/*     */ 
/* 156 */           SServerlevel2YuanbaoExchange obj = new SServerlevel2YuanbaoExchange();
/* 157 */           obj.loadFromXml(elem);
/* 158 */           if (all.put(Integer.valueOf(obj.serverlevel), obj) != null) {
/* 159 */             throw new RuntimeException("duplicate key : " + obj.serverlevel);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/* 170 */     all = new HashMap();
/*     */     
/* 172 */     String path = dir + "mzm.gsp.item.confbean.SServerlevel2YuanbaoExchange.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 199 */           SServerlevel2YuanbaoExchange _v_ = new SServerlevel2YuanbaoExchange();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SServerlevel2YuanbaoExchange> all)
/*     */   {
/* 219 */     String path = dir + "mzm.gsp.item.confbean.SServerlevel2YuanbaoExchange.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 246 */           SServerlevel2YuanbaoExchange _v_ = new SServerlevel2YuanbaoExchange();
...
/*     */ 
/*     */ 
/*     */   public static SServerlevel2YuanbaoExchange getOld(int key)
/*     */   {
/* 267 */     return (SServerlevel2YuanbaoExchange)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SServerlevel2YuanbaoExchange get(int key)
/*     */   {
/* 272 */     return (SServerlevel2YuanbaoExchange)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SServerlevel2YuanbaoExchange> getOldAll()
/*     */   {
/* 277 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SServerlevel2YuanbaoExchange> getAll()
/*     */   {
/* 282 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SServerlevel2YuanbaoExchange> newAll)
/*     */   {
/* 287 */     oldAll = all;
/* 288 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\item\confbean\SServerlevel2YuanbaoExchange.class
