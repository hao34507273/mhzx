...
/*     */ 
/*     */ public class SAxeItemCfg extends SItemCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  15 */   private static volatile Map<Integer, SAxeItemCfg> oldAll = null;
/*     */   
/*  17 */   private static Map<Integer, SAxeItemCfg> all = null;
/*     */   
...
/*  36 */     this.fix_award_id = Integer.valueOf(rootElement.attributeValue("fix_award_id")).intValue();
/*     */   }
/*     */   
...
/*  54 */     _os_.marshal(this.fix_award_id);
/*  55 */     return _os_;
/*     */   }
/*     */   
...
/*  73 */     this.fix_award_id = _os_.unmarshal_int();
/*  74 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  79 */     String path = dir + "mzm.gsp.item.confbean.SAxeItemCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  92 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SAxeItemCfg"))
/*     */         {
/*     */ 
/*  95 */           SAxeItemCfg obj = new SAxeItemCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SAxeItemCfg> all)
/*     */   {
/* 109 */     String path = dir + "mzm.gsp.item.confbean.SAxeItemCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 121 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SAxeItemCfg"))
/*     */         {
/*     */ 
/* 124 */           SAxeItemCfg obj = new SAxeItemCfg();
...
/*     */     
/* 140 */     String path = dir + "mzm.gsp.item.confbean.SAxeItemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 167 */           SAxeItemCfg _v_ = new SAxeItemCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SAxeItemCfg> all)
/*     */   {
/* 187 */     String path = dir + "mzm.gsp.item.confbean.SAxeItemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 214 */           SAxeItemCfg _v_ = new SAxeItemCfg();
...
/*     */   {
/* 233 */     for (Map.Entry<Integer, SAxeItemCfg> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static void handleData(Map<Integer, SAxeItemCfg> all, Map<Integer, SItemCfg> parent)
/*     */   {
/* 248 */     for (Map.Entry<Integer, SAxeItemCfg> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static SAxeItemCfg getOld(int key)
/*     */   {
/* 263 */     return (SAxeItemCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SAxeItemCfg get(int key)
/*     */   {
/* 268 */     return (SAxeItemCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SAxeItemCfg> getOldAllSelf()
/*     */   {
/* 273 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SAxeItemCfg> getAllSelf()
/*     */   {
/* 278 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SAxeItemCfg> newAll)
/*     */   {
/* 283 */     oldAll = all;
/* 284 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\item\confbean\SAxeItemCfg.class
