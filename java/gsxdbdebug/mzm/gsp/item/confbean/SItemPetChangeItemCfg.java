...
/*     */ 
/*     */ public class SItemPetChangeItemCfg extends SItemCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  15 */   private static volatile Map<Integer, SItemPetChangeItemCfg> oldAll = null;
/*     */   
/*  17 */   private static Map<Integer, SItemPetChangeItemCfg> all = null;
/*     */   
/*     */   public int modelId;
/*     */   public int colorId;
/*     */   public int modelFigureCfgId;
/*  22 */   public java.util.ArrayList<Integer> cannotUseList = new java.util.ArrayList();
/*     */   
...
/*  39 */     this.modelId = Integer.valueOf(rootElement.attributeValue("modelId")).intValue();
/*  40 */     this.colorId = Integer.valueOf(rootElement.attributeValue("colorId")).intValue();
/*  41 */     this.modelFigureCfgId = Integer.valueOf(rootElement.attributeValue("modelFigureCfgId")).intValue();
/*     */     
/*  43 */     Element collectionElement = util.XmlHelper.getVariableElement(rootElement, "cannotUseList");
...
/*     */         }
/*     */         
/*  68 */         this.cannotUseList.add(Integer.valueOf(_v_));
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*  88 */     _os_.marshal(this.modelId);
/*  89 */     _os_.marshal(this.colorId);
/*  90 */     _os_.marshal(this.modelFigureCfgId);
/*  91 */     _os_.compact_uint32(this.cannotUseList.size());
/*  92 */     for (Integer _v_ : this.cannotUseList)
/*     */     {
...
/* 115 */     this.colorId = _os_.unmarshal_int();
/* 116 */     this.modelFigureCfgId = _os_.unmarshal_int();
/* 117 */     for (int _size_ = _os_.uncompact_uint32(); _size_ > 0; _size_--)
/*     */     {
/*     */ 
/* 120 */       int _v_ = _os_.unmarshal_int();
/* 121 */       this.cannotUseList.add(Integer.valueOf(_v_));
/*     */     }
/* 123 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/* 128 */     String path = dir + "mzm.gsp.item.confbean.SItemPetChangeItemCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 141 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SItemPetChangeItemCfg"))
/*     */         {
/*     */ 
/* 144 */           SItemPetChangeItemCfg obj = new SItemPetChangeItemCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SItemPetChangeItemCfg> all)
/*     */   {
/* 158 */     String path = dir + "mzm.gsp.item.confbean.SItemPetChangeItemCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 170 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SItemPetChangeItemCfg"))
/*     */         {
/*     */ 
/* 173 */           SItemPetChangeItemCfg obj = new SItemPetChangeItemCfg();
...
/*     */     
/* 189 */     String path = dir + "mzm.gsp.item.confbean.SItemPetChangeItemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 216 */           SItemPetChangeItemCfg _v_ = new SItemPetChangeItemCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SItemPetChangeItemCfg> all)
/*     */   {
/* 236 */     String path = dir + "mzm.gsp.item.confbean.SItemPetChangeItemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 263 */           SItemPetChangeItemCfg _v_ = new SItemPetChangeItemCfg();
...
/*     */   {
/* 282 */     for (Map.Entry<Integer, SItemPetChangeItemCfg> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static void handleData(Map<Integer, SItemPetChangeItemCfg> all, Map<Integer, SItemCfg> parent)
/*     */   {
/* 297 */     for (Map.Entry<Integer, SItemPetChangeItemCfg> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static SItemPetChangeItemCfg getOld(int key)
/*     */   {
/* 312 */     return (SItemPetChangeItemCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SItemPetChangeItemCfg get(int key)
/*     */   {
/* 317 */     return (SItemPetChangeItemCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SItemPetChangeItemCfg> getOldAllSelf()
/*     */   {
/* 322 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SItemPetChangeItemCfg> getAllSelf()
/*     */   {
/* 327 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SItemPetChangeItemCfg> newAll)
/*     */   {
/* 332 */     oldAll = all;
/* 333 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\item\confbean\SItemPetChangeItemCfg.class
