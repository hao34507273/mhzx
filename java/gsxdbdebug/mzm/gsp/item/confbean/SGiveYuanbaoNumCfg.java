...
/*     */ 
/*     */ public class SGiveYuanbaoNumCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SGiveYuanbaoNumCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SGiveYuanbaoNumCfg> all = null;
/*     */   
/*     */   public int id;
...
/*  26 */     this.minYuanbao = Integer.valueOf(rootElement.attributeValue("minYuanbao")).intValue();
/*  27 */     this.maxYuanbao = Integer.valueOf(rootElement.attributeValue("maxYuanbao")).intValue();
/*  28 */     this.totalYuanbao = Integer.valueOf(rootElement.attributeValue("totalYuanbao")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  33 */     _os_.marshal(this.id);
/*  34 */     _os_.marshal(this.minYuanbao);
/*  35 */     _os_.marshal(this.maxYuanbao);
/*  36 */     _os_.marshal(this.totalYuanbao);
/*  37 */     return _os_;
/*     */   }
/*     */   
...
/*  43 */     this.minYuanbao = _os_.unmarshal_int();
/*  44 */     this.maxYuanbao = _os_.unmarshal_int();
/*  45 */     this.totalYuanbao = _os_.unmarshal_int();
/*  46 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  51 */     String path = dir + "mzm.gsp.item.confbean.SGiveYuanbaoNumCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  64 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SGiveYuanbaoNumCfg"))
/*     */         {
/*     */ 
/*  67 */           SGiveYuanbaoNumCfg obj = new SGiveYuanbaoNumCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SGiveYuanbaoNumCfg> all)
/*     */   {
/*  81 */     String path = dir + "mzm.gsp.item.confbean.SGiveYuanbaoNumCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SGiveYuanbaoNumCfg"))
/*     */         {
/*     */ 
/*  96 */           SGiveYuanbaoNumCfg obj = new SGiveYuanbaoNumCfg();
...
/*     */     
/* 112 */     String path = dir + "mzm.gsp.item.confbean.SGiveYuanbaoNumCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 139 */           SGiveYuanbaoNumCfg _v_ = new SGiveYuanbaoNumCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SGiveYuanbaoNumCfg> all)
/*     */   {
/* 159 */     String path = dir + "mzm.gsp.item.confbean.SGiveYuanbaoNumCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 186 */           SGiveYuanbaoNumCfg _v_ = new SGiveYuanbaoNumCfg();
...
/*     */ 
/*     */ 
/*     */   public static SGiveYuanbaoNumCfg getOld(int key)
/*     */   {
/* 207 */     return (SGiveYuanbaoNumCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SGiveYuanbaoNumCfg get(int key)
/*     */   {
/* 212 */     return (SGiveYuanbaoNumCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SGiveYuanbaoNumCfg> getOldAll()
/*     */   {
/* 217 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SGiveYuanbaoNumCfg> getAll()
/*     */   {
/* 222 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SGiveYuanbaoNumCfg> newAll)
/*     */   {
/* 227 */     oldAll = all;
/* 228 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\item\confbean\SGiveYuanbaoNumCfg.class
