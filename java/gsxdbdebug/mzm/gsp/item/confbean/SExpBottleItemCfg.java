...
/*     */ 
/*     */ public class SExpBottleItemCfg extends SItemCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  15 */   private static volatile Map<Integer, SExpBottleItemCfg> oldAll = null;
/*     */   
/*  17 */   private static Map<Integer, SExpBottleItemCfg> all = null;
/*     */   
/*     */   public int exp_bottle_award_type;
/*     */   public int award_id;
/*     */   public int get_total_exp_rate;
...
/*  39 */     this.exp_bottle_award_type = Integer.valueOf(rootElement.attributeValue("exp_bottle_award_type")).intValue();
/*  40 */     this.award_id = Integer.valueOf(rootElement.attributeValue("award_id")).intValue();
/*  41 */     this.get_total_exp_rate = Integer.valueOf(rootElement.attributeValue("get_total_exp_rate")).intValue();
/*  42 */     this.server_level_diff_days = Integer.valueOf(rootElement.attributeValue("server_level_diff_days")).intValue();
/*     */   }
/*     */   
...
/*  60 */     _os_.marshal(this.exp_bottle_award_type);
/*  61 */     _os_.marshal(this.award_id);
/*  62 */     _os_.marshal(this.get_total_exp_rate);
/*  63 */     _os_.marshal(this.server_level_diff_days);
/*  64 */     return _os_;
/*     */   }
/*     */   
...
/*  82 */     this.exp_bottle_award_type = _os_.unmarshal_int();
/*  83 */     this.award_id = _os_.unmarshal_int();
/*  84 */     this.get_total_exp_rate = _os_.unmarshal_int();
/*  85 */     this.server_level_diff_days = _os_.unmarshal_int();
/*  86 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  91 */     String path = dir + "mzm.gsp.item.confbean.SExpBottleItemCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 104 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SExpBottleItemCfg"))
/*     */         {
/*     */ 
/* 107 */           SExpBottleItemCfg obj = new SExpBottleItemCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SExpBottleItemCfg> all)
/*     */   {
/* 121 */     String path = dir + "mzm.gsp.item.confbean.SExpBottleItemCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 133 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SExpBottleItemCfg"))
/*     */         {
/*     */ 
/* 136 */           SExpBottleItemCfg obj = new SExpBottleItemCfg();
...
/*     */     
/* 152 */     String path = dir + "mzm.gsp.item.confbean.SExpBottleItemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 179 */           SExpBottleItemCfg _v_ = new SExpBottleItemCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SExpBottleItemCfg> all)
/*     */   {
/* 199 */     String path = dir + "mzm.gsp.item.confbean.SExpBottleItemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 226 */           SExpBottleItemCfg _v_ = new SExpBottleItemCfg();
...
/*     */   {
/* 245 */     for (Map.Entry<Integer, SExpBottleItemCfg> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static void handleData(Map<Integer, SExpBottleItemCfg> all, Map<Integer, SItemCfg> parent)
/*     */   {
/* 260 */     for (Map.Entry<Integer, SExpBottleItemCfg> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static SExpBottleItemCfg getOld(int key)
/*     */   {
/* 275 */     return (SExpBottleItemCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SExpBottleItemCfg get(int key)
/*     */   {
/* 280 */     return (SExpBottleItemCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SExpBottleItemCfg> getOldAllSelf()
/*     */   {
/* 285 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SExpBottleItemCfg> getAllSelf()
/*     */   {
/* 290 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SExpBottleItemCfg> newAll)
/*     */   {
/* 295 */     oldAll = all;
/* 296 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\item\confbean\SExpBottleItemCfg.class
