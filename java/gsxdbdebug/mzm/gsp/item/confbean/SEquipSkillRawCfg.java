...
/*     */ 
/*     */ public class SEquipSkillRawCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SEquipSkillRawCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SEquipSkillRawCfg> all = null;
/*     */   
/*     */   public int id;
/*  19 */   public java.util.ArrayList<EquipSkillWeight> skills = new java.util.ArrayList();
/*     */   
...
/*  36 */       if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.EquipSkillWeight"))
/*     */       {
/*     */         EquipSkillWeight _v_;
/*     */         
/*     */ 
/*     */         try
/*     */         {
/*  43 */           _v_ = new EquipSkillWeight();
...
/*  59 */     _os_.compact_uint32(this.skills.size());
/*  60 */     for (EquipSkillWeight _v_ : this.skills)
/*     */     {
/*  62 */       _os_.marshal(_v_);
/*     */     }
/*  64 */     return _os_;
...
/*     */     {
/*     */ 
/*  73 */       EquipSkillWeight _v_ = new EquipSkillWeight();
/*  74 */       _v_.unmarshal(_os_);
/*  75 */       this.skills.add(_v_);
/*     */     }
/*  77 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/*  82 */     String path = dir + "mzm.gsp.item.confbean.SEquipSkillRawCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  95 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SEquipSkillRawCfg"))
/*     */         {
/*     */ 
/*  98 */           SEquipSkillRawCfg obj = new SEquipSkillRawCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SEquipSkillRawCfg> all)
/*     */   {
/* 112 */     String path = dir + "mzm.gsp.item.confbean.SEquipSkillRawCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 124 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SEquipSkillRawCfg"))
/*     */         {
/*     */ 
/* 127 */           SEquipSkillRawCfg obj = new SEquipSkillRawCfg();
...
/*     */     
/* 143 */     String path = dir + "mzm.gsp.item.confbean.SEquipSkillRawCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 170 */           SEquipSkillRawCfg _v_ = new SEquipSkillRawCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SEquipSkillRawCfg> all)
/*     */   {
/* 190 */     String path = dir + "mzm.gsp.item.confbean.SEquipSkillRawCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 217 */           SEquipSkillRawCfg _v_ = new SEquipSkillRawCfg();
...
/*     */ 
/*     */ 
/*     */   public static SEquipSkillRawCfg getOld(int key)
/*     */   {
/* 238 */     return (SEquipSkillRawCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SEquipSkillRawCfg get(int key)
/*     */   {
/* 243 */     return (SEquipSkillRawCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SEquipSkillRawCfg> getOldAll()
/*     */   {
/* 248 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SEquipSkillRawCfg> getAll()
/*     */   {
/* 253 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SEquipSkillRawCfg> newAll)
/*     */   {
/* 258 */     oldAll = all;
/* 259 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\item\confbean\SEquipSkillRawCfg.class
