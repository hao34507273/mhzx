...
/*     */ 
/*     */ public class SFivePreciousItem extends SItemCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  15 */   private static volatile Map<Integer, SFivePreciousItem> oldAll = null;
/*     */   
/*  17 */   private static Map<Integer, SFivePreciousItem> all = null;
/*     */   
/*     */   public int npcid;
...
/*  40 */     this.exchangeid = Integer.valueOf(rootElement.attributeValue("exchangeid")).intValue();
/*  41 */     this.npcservice = Integer.valueOf(rootElement.attributeValue("npcservice")).intValue();
/*  42 */     this.isuseyuanbao = Boolean.valueOf(rootElement.attributeValue("isuseyuanbao")).booleanValue();
/*     */   }
/*     */   
...
/*  61 */     _os_.marshal(this.exchangeid);
/*  62 */     _os_.marshal(this.npcservice);
/*  63 */     _os_.marshal(this.isuseyuanbao);
/*  64 */     return _os_;
/*     */   }
/*     */   
...
/*  83 */     this.exchangeid = _os_.unmarshal_int();
/*  84 */     this.npcservice = _os_.unmarshal_int();
/*  85 */     this.isuseyuanbao = _os_.unmarshal_boolean();
/*  86 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  91 */     String path = dir + "mzm.gsp.item.confbean.SFivePreciousItem.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 104 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SFivePreciousItem"))
/*     */         {
/*     */ 
/* 107 */           SFivePreciousItem obj = new SFivePreciousItem();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SFivePreciousItem> all)
/*     */   {
/* 121 */     String path = dir + "mzm.gsp.item.confbean.SFivePreciousItem.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 133 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SFivePreciousItem"))
/*     */         {
/*     */ 
/* 136 */           SFivePreciousItem obj = new SFivePreciousItem();
...
/*     */     
/* 152 */     String path = dir + "mzm.gsp.item.confbean.SFivePreciousItem.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 179 */           SFivePreciousItem _v_ = new SFivePreciousItem();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SFivePreciousItem> all)
/*     */   {
/* 199 */     String path = dir + "mzm.gsp.item.confbean.SFivePreciousItem.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 226 */           SFivePreciousItem _v_ = new SFivePreciousItem();
...
/*     */   {
/* 245 */     for (Map.Entry<Integer, SFivePreciousItem> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static void handleData(Map<Integer, SFivePreciousItem> all, Map<Integer, SItemCfg> parent)
/*     */   {
/* 260 */     for (Map.Entry<Integer, SFivePreciousItem> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static SFivePreciousItem getOld(int key)
/*     */   {
/* 275 */     return (SFivePreciousItem)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SFivePreciousItem get(int key)
/*     */   {
/* 280 */     return (SFivePreciousItem)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SFivePreciousItem> getOldAllSelf()
/*     */   {
/* 285 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SFivePreciousItem> getAllSelf()
/*     */   {
/* 290 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SFivePreciousItem> newAll)
/*     */   {
/* 295 */     oldAll = all;
/* 296 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\item\confbean\SFivePreciousItem.class
