...
/*     */ 
/*     */ public class SMountsItemCfg extends SItemCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  15 */   private static volatile Map<Integer, SMountsItemCfg> oldAll = null;
/*     */   
/*  17 */   private static Map<Integer, SMountsItemCfg> all = null;
/*     */   
...
/*     */   {
/*  83 */     String path = dir + "mzm.gsp.item.confbean.SMountsItemCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  96 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SMountsItemCfg"))
/*     */         {
/*     */ 
/*  99 */           SMountsItemCfg obj = new SMountsItemCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SMountsItemCfg> all)
/*     */   {
/* 113 */     String path = dir + "mzm.gsp.item.confbean.SMountsItemCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 125 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SMountsItemCfg"))
/*     */         {
/*     */ 
/* 128 */           SMountsItemCfg obj = new SMountsItemCfg();
...
/*     */     
/* 144 */     String path = dir + "mzm.gsp.item.confbean.SMountsItemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 171 */           SMountsItemCfg _v_ = new SMountsItemCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SMountsItemCfg> all)
/*     */   {
/* 191 */     String path = dir + "mzm.gsp.item.confbean.SMountsItemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 218 */           SMountsItemCfg _v_ = new SMountsItemCfg();
...
/*     */   {
/* 237 */     for (Map.Entry<Integer, SMountsItemCfg> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static void handleData(Map<Integer, SMountsItemCfg> all, Map<Integer, SItemCfg> parent)
/*     */   {
/* 252 */     for (Map.Entry<Integer, SMountsItemCfg> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static SMountsItemCfg getOld(int key)
/*     */   {
/* 267 */     return (SMountsItemCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SMountsItemCfg get(int key)
/*     */   {
/* 272 */     return (SMountsItemCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMountsItemCfg> getOldAllSelf()
/*     */   {
/* 277 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMountsItemCfg> getAllSelf()
/*     */   {
/* 282 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SMountsItemCfg> newAll)
/*     */   {
/* 287 */     oldAll = all;
/* 288 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\item\confbean\SMountsItemCfg.class
