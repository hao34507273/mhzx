...
/*     */ 
/*     */ public class SBagItemCompoundCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SBagItemCompoundCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SBagItemCompoundCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public int itemId;
/*     */   public int makeCfgId;
...
/*  27 */     this.makeCfgId = Integer.valueOf(rootElement.attributeValue("makeCfgId")).intValue();
/*  28 */     this.canCompoundAll = Boolean.valueOf(rootElement.attributeValue("canCompoundAll")).booleanValue();
/*     */   }
/*     */   
...
/*  35 */     _os_.marshal(this.makeCfgId);
/*  36 */     _os_.marshal(this.canCompoundAll);
/*  37 */     return _os_;
/*     */   }
/*     */   
...
/*  44 */     this.makeCfgId = _os_.unmarshal_int();
/*  45 */     this.canCompoundAll = _os_.unmarshal_boolean();
/*  46 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  51 */     String path = dir + "mzm.gsp.item.confbean.SBagItemCompoundCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  64 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SBagItemCompoundCfg"))
/*     */         {
/*     */ 
/*  67 */           SBagItemCompoundCfg obj = new SBagItemCompoundCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SBagItemCompoundCfg> all)
/*     */   {
/*  81 */     String path = dir + "mzm.gsp.item.confbean.SBagItemCompoundCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SBagItemCompoundCfg"))
/*     */         {
/*     */ 
/*  96 */           SBagItemCompoundCfg obj = new SBagItemCompoundCfg();
...
/*     */     
/* 112 */     String path = dir + "mzm.gsp.item.confbean.SBagItemCompoundCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 139 */           SBagItemCompoundCfg _v_ = new SBagItemCompoundCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SBagItemCompoundCfg> all)
/*     */   {
/* 159 */     String path = dir + "mzm.gsp.item.confbean.SBagItemCompoundCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 186 */           SBagItemCompoundCfg _v_ = new SBagItemCompoundCfg();
...
/*     */ 
/*     */ 
/*     */   public static SBagItemCompoundCfg getOld(int key)
/*     */   {
/* 207 */     return (SBagItemCompoundCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SBagItemCompoundCfg get(int key)
/*     */   {
/* 212 */     return (SBagItemCompoundCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SBagItemCompoundCfg> getOldAll()
/*     */   {
/* 217 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SBagItemCompoundCfg> getAll()
/*     */   {
/* 222 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SBagItemCompoundCfg> newAll)
/*     */   {
/* 227 */     oldAll = all;
/* 228 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\item\confbean\SBagItemCompoundCfg.class
