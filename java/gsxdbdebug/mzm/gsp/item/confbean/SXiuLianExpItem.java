...
/*     */ 
/*     */ public class SXiuLianExpItem extends SItemCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  15 */   private static volatile Map<Integer, SXiuLianExpItem> oldAll = null;
/*     */   
/*  17 */   private static Map<Integer, SXiuLianExpItem> all = null;
/*     */   
...
/*     */   {
/*  79 */     String path = dir + "mzm.gsp.item.confbean.SXiuLianExpItem.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  92 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SXiuLianExpItem"))
/*     */         {
/*     */ 
/*  95 */           SXiuLianExpItem obj = new SXiuLianExpItem();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SXiuLianExpItem> all)
/*     */   {
/* 109 */     String path = dir + "mzm.gsp.item.confbean.SXiuLianExpItem.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 121 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SXiuLianExpItem"))
/*     */         {
/*     */ 
/* 124 */           SXiuLianExpItem obj = new SXiuLianExpItem();
...
/*     */     
/* 140 */     String path = dir + "mzm.gsp.item.confbean.SXiuLianExpItem.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 167 */           SXiuLianExpItem _v_ = new SXiuLianExpItem();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SXiuLianExpItem> all)
/*     */   {
/* 187 */     String path = dir + "mzm.gsp.item.confbean.SXiuLianExpItem.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 214 */           SXiuLianExpItem _v_ = new SXiuLianExpItem();
...
/*     */   {
/* 233 */     for (Map.Entry<Integer, SXiuLianExpItem> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static void handleData(Map<Integer, SXiuLianExpItem> all, Map<Integer, SItemCfg> parent)
/*     */   {
/* 248 */     for (Map.Entry<Integer, SXiuLianExpItem> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static SXiuLianExpItem getOld(int key)
/*     */   {
/* 263 */     return (SXiuLianExpItem)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SXiuLianExpItem get(int key)
/*     */   {
/* 268 */     return (SXiuLianExpItem)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SXiuLianExpItem> getOldAllSelf()
/*     */   {
/* 273 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SXiuLianExpItem> getAllSelf()
/*     */   {
/* 278 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SXiuLianExpItem> newAll)
/*     */   {
/* 283 */     oldAll = all;
/* 284 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\item\confbean\SXiuLianExpItem.class
