...
/*     */ 
/*     */ public class SMountsChipItem extends SItemCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  15 */   private static volatile Map<Integer, SMountsChipItem> oldAll = null;
/*     */   
/*  17 */   private static Map<Integer, SMountsChipItem> all = null;
/*     */   
/*     */   public int addMountsScore;
...
/*  37 */     this.addMountsScore = Integer.valueOf(rootElement.attributeValue("addMountsScore")).intValue();
/*  38 */     this.mountsType = Integer.valueOf(rootElement.attributeValue("mountsType")).intValue();
/*     */   }
/*     */   
...
/*  56 */     _os_.marshal(this.addMountsScore);
/*  57 */     _os_.marshal(this.mountsType);
/*  58 */     return _os_;
/*     */   }
/*     */   
...
/*  76 */     this.addMountsScore = _os_.unmarshal_int();
/*  77 */     this.mountsType = _os_.unmarshal_int();
/*  78 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  83 */     String path = dir + "mzm.gsp.item.confbean.SMountsChipItem.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  96 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SMountsChipItem"))
/*     */         {
/*     */ 
/*  99 */           SMountsChipItem obj = new SMountsChipItem();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SMountsChipItem> all)
/*     */   {
/* 113 */     String path = dir + "mzm.gsp.item.confbean.SMountsChipItem.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 125 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SMountsChipItem"))
/*     */         {
/*     */ 
/* 128 */           SMountsChipItem obj = new SMountsChipItem();
...
/*     */     
/* 144 */     String path = dir + "mzm.gsp.item.confbean.SMountsChipItem.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 171 */           SMountsChipItem _v_ = new SMountsChipItem();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SMountsChipItem> all)
/*     */   {
/* 191 */     String path = dir + "mzm.gsp.item.confbean.SMountsChipItem.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 218 */           SMountsChipItem _v_ = new SMountsChipItem();
...
/*     */   {
/* 237 */     for (Map.Entry<Integer, SMountsChipItem> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static void handleData(Map<Integer, SMountsChipItem> all, Map<Integer, SItemCfg> parent)
/*     */   {
/* 252 */     for (Map.Entry<Integer, SMountsChipItem> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static SMountsChipItem getOld(int key)
/*     */   {
/* 267 */     return (SMountsChipItem)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SMountsChipItem get(int key)
/*     */   {
/* 272 */     return (SMountsChipItem)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMountsChipItem> getOldAllSelf()
/*     */   {
/* 277 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMountsChipItem> getAllSelf()
/*     */   {
/* 282 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SMountsChipItem> newAll)
/*     */   {
/* 287 */     oldAll = all;
/* 288 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\item\confbean\SMountsChipItem.class
