...
/*     */ 
/*     */ public class SMountsStarLifeItemCfg extends SItemCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  15 */   private static volatile Map<Integer, SMountsStarLifeItemCfg> oldAll = null;
/*     */   
/*  17 */   private static Map<Integer, SMountsStarLifeItemCfg> all = null;
/*     */   
/*     */ 
...
/*     */   {
/*  75 */     String path = dir + "mzm.gsp.item.confbean.SMountsStarLifeItemCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  88 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SMountsStarLifeItemCfg"))
/*     */         {
/*     */ 
/*  91 */           SMountsStarLifeItemCfg obj = new SMountsStarLifeItemCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SMountsStarLifeItemCfg> all)
/*     */   {
/* 105 */     String path = dir + "mzm.gsp.item.confbean.SMountsStarLifeItemCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 117 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SMountsStarLifeItemCfg"))
/*     */         {
/*     */ 
/* 120 */           SMountsStarLifeItemCfg obj = new SMountsStarLifeItemCfg();
...
/*     */     
/* 136 */     String path = dir + "mzm.gsp.item.confbean.SMountsStarLifeItemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 163 */           SMountsStarLifeItemCfg _v_ = new SMountsStarLifeItemCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SMountsStarLifeItemCfg> all)
/*     */   {
/* 183 */     String path = dir + "mzm.gsp.item.confbean.SMountsStarLifeItemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 210 */           SMountsStarLifeItemCfg _v_ = new SMountsStarLifeItemCfg();
...
/*     */   {
/* 229 */     for (Map.Entry<Integer, SMountsStarLifeItemCfg> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static void handleData(Map<Integer, SMountsStarLifeItemCfg> all, Map<Integer, SItemCfg> parent)
/*     */   {
/* 244 */     for (Map.Entry<Integer, SMountsStarLifeItemCfg> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static SMountsStarLifeItemCfg getOld(int key)
/*     */   {
/* 259 */     return (SMountsStarLifeItemCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SMountsStarLifeItemCfg get(int key)
/*     */   {
/* 264 */     return (SMountsStarLifeItemCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMountsStarLifeItemCfg> getOldAllSelf()
/*     */   {
/* 269 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMountsStarLifeItemCfg> getAllSelf()
/*     */   {
/* 274 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SMountsStarLifeItemCfg> newAll)
/*     */   {
/* 279 */     oldAll = all;
/* 280 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\item\confbean\SMountsStarLifeItemCfg.class
