...
/*     */ 
/*     */ public class SFlopLotteryItemCfg extends SItemCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  15 */   private static volatile Map<Integer, SFlopLotteryItemCfg> oldAll = null;
/*     */   
/*  17 */   private static Map<Integer, SFlopLotteryItemCfg> all = null;
/*     */   
...
/*  36 */     this.flopLotteryMainCfgId = Integer.valueOf(rootElement.attributeValue("flopLotteryMainCfgId")).intValue();
/*     */   }
/*     */   
...
/*  54 */     _os_.marshal(this.flopLotteryMainCfgId);
/*  55 */     return _os_;
/*     */   }
/*     */   
...
/*  73 */     this.flopLotteryMainCfgId = _os_.unmarshal_int();
/*  74 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  79 */     String path = dir + "mzm.gsp.item.confbean.SFlopLotteryItemCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  92 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SFlopLotteryItemCfg"))
/*     */         {
/*     */ 
/*  95 */           SFlopLotteryItemCfg obj = new SFlopLotteryItemCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SFlopLotteryItemCfg> all)
/*     */   {
/* 109 */     String path = dir + "mzm.gsp.item.confbean.SFlopLotteryItemCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 121 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SFlopLotteryItemCfg"))
/*     */         {
/*     */ 
/* 124 */           SFlopLotteryItemCfg obj = new SFlopLotteryItemCfg();
...
/*     */     
/* 140 */     String path = dir + "mzm.gsp.item.confbean.SFlopLotteryItemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 167 */           SFlopLotteryItemCfg _v_ = new SFlopLotteryItemCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SFlopLotteryItemCfg> all)
/*     */   {
/* 187 */     String path = dir + "mzm.gsp.item.confbean.SFlopLotteryItemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 214 */           SFlopLotteryItemCfg _v_ = new SFlopLotteryItemCfg();
...
/*     */   {
/* 233 */     for (Map.Entry<Integer, SFlopLotteryItemCfg> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static void handleData(Map<Integer, SFlopLotteryItemCfg> all, Map<Integer, SItemCfg> parent)
/*     */   {
/* 248 */     for (Map.Entry<Integer, SFlopLotteryItemCfg> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static SFlopLotteryItemCfg getOld(int key)
/*     */   {
/* 263 */     return (SFlopLotteryItemCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SFlopLotteryItemCfg get(int key)
/*     */   {
/* 268 */     return (SFlopLotteryItemCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SFlopLotteryItemCfg> getOldAllSelf()
/*     */   {
/* 273 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SFlopLotteryItemCfg> getAllSelf()
/*     */   {
/* 278 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SFlopLotteryItemCfg> newAll)
/*     */   {
/* 283 */     oldAll = all;
/* 284 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\item\confbean\SFlopLotteryItemCfg.class
