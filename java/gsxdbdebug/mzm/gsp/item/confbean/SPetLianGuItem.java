...
/*     */ 
/*     */ public class SPetLianGuItem extends SItemCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  15 */   private static volatile Map<Integer, SPetLianGuItem> oldAll = null;
/*     */   
/*  17 */   private static Map<Integer, SPetLianGuItem> all = null;
/*     */   
/*     */   public int expectAddRate;
/*     */   public int floatExpectRate;
/*     */   public int floatMaxNum;
/*     */   public int minAddNum;
/*     */   
...
/*  39 */     this.expectAddRate = Integer.valueOf(rootElement.attributeValue("expectAddRate")).intValue();
/*  40 */     this.floatExpectRate = Integer.valueOf(rootElement.attributeValue("floatExpectRate")).intValue();
/*  41 */     this.floatMaxNum = Integer.valueOf(rootElement.attributeValue("floatMaxNum")).intValue();
/*  42 */     this.minAddNum = Integer.valueOf(rootElement.attributeValue("minAddNum")).intValue();
/*     */   }
/*     */   
...
/*  60 */     _os_.marshal(this.expectAddRate);
/*  61 */     _os_.marshal(this.floatExpectRate);
/*  62 */     _os_.marshal(this.floatMaxNum);
/*  63 */     _os_.marshal(this.minAddNum);
/*  64 */     return _os_;
/*     */   }
/*     */   
...
/*  82 */     this.expectAddRate = _os_.unmarshal_int();
/*  83 */     this.floatExpectRate = _os_.unmarshal_int();
/*  84 */     this.floatMaxNum = _os_.unmarshal_int();
/*  85 */     this.minAddNum = _os_.unmarshal_int();
/*  86 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  91 */     String path = dir + "mzm.gsp.item.confbean.SPetLianGuItem.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 104 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SPetLianGuItem"))
/*     */         {
/*     */ 
/* 107 */           SPetLianGuItem obj = new SPetLianGuItem();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SPetLianGuItem> all)
/*     */   {
/* 121 */     String path = dir + "mzm.gsp.item.confbean.SPetLianGuItem.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 133 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SPetLianGuItem"))
/*     */         {
/*     */ 
/* 136 */           SPetLianGuItem obj = new SPetLianGuItem();
...
/*     */     
/* 152 */     String path = dir + "mzm.gsp.item.confbean.SPetLianGuItem.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 179 */           SPetLianGuItem _v_ = new SPetLianGuItem();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SPetLianGuItem> all)
/*     */   {
/* 199 */     String path = dir + "mzm.gsp.item.confbean.SPetLianGuItem.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 226 */           SPetLianGuItem _v_ = new SPetLianGuItem();
...
/*     */   {
/* 245 */     for (Map.Entry<Integer, SPetLianGuItem> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static void handleData(Map<Integer, SPetLianGuItem> all, Map<Integer, SItemCfg> parent)
/*     */   {
/* 260 */     for (Map.Entry<Integer, SPetLianGuItem> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static SPetLianGuItem getOld(int key)
/*     */   {
/* 275 */     return (SPetLianGuItem)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SPetLianGuItem get(int key)
/*     */   {
/* 280 */     return (SPetLianGuItem)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPetLianGuItem> getOldAllSelf()
/*     */   {
/* 285 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPetLianGuItem> getAllSelf()
/*     */   {
/* 290 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SPetLianGuItem> newAll)
/*     */   {
/* 295 */     oldAll = all;
/* 296 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\item\confbean\SPetLianGuItem.class
