...
/*     */ 
/*     */ public class SPetXilianItem extends SItemCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  15 */   private static volatile Map<Integer, SPetXilianItem> oldAll = null;
/*     */   
/*  17 */   private static Map<Integer, SPetXilianItem> all = null;
/*     */   
/*     */   public int xilianItemLevel;
/*     */   
...
/*  36 */     this.xilianItemLevel = Integer.valueOf(rootElement.attributeValue("xilianItemLevel")).intValue();
/*     */   }
/*     */   
...
/*  54 */     _os_.marshal(this.xilianItemLevel);
/*  55 */     return _os_;
/*     */   }
/*     */   
...
/*  73 */     this.xilianItemLevel = _os_.unmarshal_int();
/*  74 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  79 */     String path = dir + "mzm.gsp.item.confbean.SPetXilianItem.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  92 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SPetXilianItem"))
/*     */         {
/*     */ 
/*  95 */           SPetXilianItem obj = new SPetXilianItem();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SPetXilianItem> all)
/*     */   {
/* 109 */     String path = dir + "mzm.gsp.item.confbean.SPetXilianItem.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 121 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SPetXilianItem"))
/*     */         {
/*     */ 
/* 124 */           SPetXilianItem obj = new SPetXilianItem();
...
/*     */     
/* 140 */     String path = dir + "mzm.gsp.item.confbean.SPetXilianItem.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 167 */           SPetXilianItem _v_ = new SPetXilianItem();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SPetXilianItem> all)
/*     */   {
/* 187 */     String path = dir + "mzm.gsp.item.confbean.SPetXilianItem.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 214 */           SPetXilianItem _v_ = new SPetXilianItem();
...
/*     */   {
/* 233 */     for (Map.Entry<Integer, SPetXilianItem> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static void handleData(Map<Integer, SPetXilianItem> all, Map<Integer, SItemCfg> parent)
/*     */   {
/* 248 */     for (Map.Entry<Integer, SPetXilianItem> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static SPetXilianItem getOld(int key)
/*     */   {
/* 263 */     return (SPetXilianItem)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SPetXilianItem get(int key)
/*     */   {
/* 268 */     return (SPetXilianItem)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPetXilianItem> getOldAllSelf()
/*     */   {
/* 273 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPetXilianItem> getAllSelf()
/*     */   {
/* 278 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SPetXilianItem> newAll)
/*     */   {
/* 283 */     oldAll = all;
/* 284 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\item\confbean\SPetXilianItem.class
