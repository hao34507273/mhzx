...
/*     */ 
/*     */ public class SChildrenEquipItemCfg extends SItemCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  15 */   private static volatile Map<Integer, SChildrenEquipItemCfg> oldAll = null;
/*     */   
/*  17 */   private static Map<Integer, SChildrenEquipItemCfg> all = null;
/*     */   
/*     */   public int wearPos;
...
/*  38 */     this.wearPos = Integer.valueOf(rootElement.attributeValue("wearPos")).intValue();
/*  39 */     this.levelTypeid = Integer.valueOf(rootElement.attributeValue("levelTypeid")).intValue();
/*  40 */     this.stageTypeid = Integer.valueOf(rootElement.attributeValue("stageTypeid")).intValue();
/*     */   }
/*     */   
...
/*  58 */     _os_.marshal(this.wearPos);
/*  59 */     _os_.marshal(this.levelTypeid);
/*  60 */     _os_.marshal(this.stageTypeid);
/*  61 */     return _os_;
/*     */   }
/*     */   
...
/*  79 */     this.wearPos = _os_.unmarshal_int();
/*  80 */     this.levelTypeid = _os_.unmarshal_int();
/*  81 */     this.stageTypeid = _os_.unmarshal_int();
/*  82 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  87 */     String path = dir + "mzm.gsp.item.confbean.SChildrenEquipItemCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 100 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SChildrenEquipItemCfg"))
/*     */         {
/*     */ 
/* 103 */           SChildrenEquipItemCfg obj = new SChildrenEquipItemCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SChildrenEquipItemCfg> all)
/*     */   {
/* 117 */     String path = dir + "mzm.gsp.item.confbean.SChildrenEquipItemCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 129 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SChildrenEquipItemCfg"))
/*     */         {
/*     */ 
/* 132 */           SChildrenEquipItemCfg obj = new SChildrenEquipItemCfg();
...
/*     */     
/* 148 */     String path = dir + "mzm.gsp.item.confbean.SChildrenEquipItemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 175 */           SChildrenEquipItemCfg _v_ = new SChildrenEquipItemCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SChildrenEquipItemCfg> all)
/*     */   {
/* 195 */     String path = dir + "mzm.gsp.item.confbean.SChildrenEquipItemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 222 */           SChildrenEquipItemCfg _v_ = new SChildrenEquipItemCfg();
...
/*     */   {
/* 241 */     for (Map.Entry<Integer, SChildrenEquipItemCfg> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static void handleData(Map<Integer, SChildrenEquipItemCfg> all, Map<Integer, SItemCfg> parent)
/*     */   {
/* 256 */     for (Map.Entry<Integer, SChildrenEquipItemCfg> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static SChildrenEquipItemCfg getOld(int key)
/*     */   {
/* 271 */     return (SChildrenEquipItemCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SChildrenEquipItemCfg get(int key)
/*     */   {
/* 276 */     return (SChildrenEquipItemCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SChildrenEquipItemCfg> getOldAllSelf()
/*     */   {
/* 281 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SChildrenEquipItemCfg> getAllSelf()
/*     */   {
/* 286 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SChildrenEquipItemCfg> newAll)
/*     */   {
/* 291 */     oldAll = all;
/* 292 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\item\confbean\SChildrenEquipItemCfg.class
