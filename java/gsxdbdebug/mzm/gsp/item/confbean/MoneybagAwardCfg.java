...
/*     */ 
/*     */ public class MoneybagAwardCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, MoneybagAwardCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, MoneybagAwardCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public int num;
/*     */   
...
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.item.confbean.MoneybagAwardCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.MoneybagAwardCfg"))
/*     */         {
/*     */ 
/*  59 */           MoneybagAwardCfg obj = new MoneybagAwardCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, MoneybagAwardCfg> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.item.confbean.MoneybagAwardCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.MoneybagAwardCfg"))
/*     */         {
/*     */ 
/*  88 */           MoneybagAwardCfg obj = new MoneybagAwardCfg();
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.item.confbean.MoneybagAwardCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           MoneybagAwardCfg _v_ = new MoneybagAwardCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, MoneybagAwardCfg> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.item.confbean.MoneybagAwardCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           MoneybagAwardCfg _v_ = new MoneybagAwardCfg();
...
/*     */ 
/*     */ 
/*     */   public static MoneybagAwardCfg getOld(int key)
/*     */   {
/* 199 */     return (MoneybagAwardCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static MoneybagAwardCfg get(int key)
/*     */   {
/* 204 */     return (MoneybagAwardCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, MoneybagAwardCfg> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, MoneybagAwardCfg> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, MoneybagAwardCfg> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\item\confbean\MoneybagAwardCfg.class
