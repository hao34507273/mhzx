...
/*     */ 
/*     */ public class SFabaoArtifactItemCfg extends SItemCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  15 */   private static volatile Map<Integer, SFabaoArtifactItemCfg> oldAll = null;
/*     */   
/*  17 */   private static Map<Integer, SFabaoArtifactItemCfg> all = null;
/*     */   
/*     */   public int artifactCfgId;
...
/*  37 */     this.artifactCfgId = Integer.valueOf(rootElement.attributeValue("artifactCfgId")).intValue();
/*  38 */     this.validDuration = Integer.valueOf(rootElement.attributeValue("validDuration")).intValue();
/*     */   }
/*     */   
...
/*  56 */     _os_.marshal(this.artifactCfgId);
/*  57 */     _os_.marshal(this.validDuration);
/*  58 */     return _os_;
/*     */   }
/*     */   
...
/*  76 */     this.artifactCfgId = _os_.unmarshal_int();
/*  77 */     this.validDuration = _os_.unmarshal_int();
/*  78 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  83 */     String path = dir + "mzm.gsp.item.confbean.SFabaoArtifactItemCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  96 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SFabaoArtifactItemCfg"))
/*     */         {
/*     */ 
/*  99 */           SFabaoArtifactItemCfg obj = new SFabaoArtifactItemCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SFabaoArtifactItemCfg> all)
/*     */   {
/* 113 */     String path = dir + "mzm.gsp.item.confbean.SFabaoArtifactItemCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 125 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SFabaoArtifactItemCfg"))
/*     */         {
/*     */ 
/* 128 */           SFabaoArtifactItemCfg obj = new SFabaoArtifactItemCfg();
...
/*     */     
/* 144 */     String path = dir + "mzm.gsp.item.confbean.SFabaoArtifactItemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 171 */           SFabaoArtifactItemCfg _v_ = new SFabaoArtifactItemCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SFabaoArtifactItemCfg> all)
/*     */   {
/* 191 */     String path = dir + "mzm.gsp.item.confbean.SFabaoArtifactItemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 218 */           SFabaoArtifactItemCfg _v_ = new SFabaoArtifactItemCfg();
...
/*     */   {
/* 237 */     for (Map.Entry<Integer, SFabaoArtifactItemCfg> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static void handleData(Map<Integer, SFabaoArtifactItemCfg> all, Map<Integer, SItemCfg> parent)
/*     */   {
/* 252 */     for (Map.Entry<Integer, SFabaoArtifactItemCfg> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static SFabaoArtifactItemCfg getOld(int key)
/*     */   {
/* 267 */     return (SFabaoArtifactItemCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SFabaoArtifactItemCfg get(int key)
/*     */   {
/* 272 */     return (SFabaoArtifactItemCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SFabaoArtifactItemCfg> getOldAllSelf()
/*     */   {
/* 277 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SFabaoArtifactItemCfg> getAllSelf()
/*     */   {
/* 282 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SFabaoArtifactItemCfg> newAll)
/*     */   {
/* 287 */     oldAll = all;
/* 288 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\item\confbean\SFabaoArtifactItemCfg.class
