...
/*     */ 
/*     */ public class SItemSellAllCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SItemSellAllCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SItemSellAllCfg> all = null;
/*     */   
/*     */   public int itemId;
/*     */   public int id;
/*     */   
...
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.item.confbean.SItemSellAllCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SItemSellAllCfg"))
/*     */         {
/*     */ 
/*  59 */           SItemSellAllCfg obj = new SItemSellAllCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SItemSellAllCfg> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.item.confbean.SItemSellAllCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SItemSellAllCfg"))
/*     */         {
/*     */ 
/*  88 */           SItemSellAllCfg obj = new SItemSellAllCfg();
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.item.confbean.SItemSellAllCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           SItemSellAllCfg _v_ = new SItemSellAllCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SItemSellAllCfg> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.item.confbean.SItemSellAllCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           SItemSellAllCfg _v_ = new SItemSellAllCfg();
...
/*     */ 
/*     */ 
/*     */   public static SItemSellAllCfg getOld(int key)
/*     */   {
/* 199 */     return (SItemSellAllCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SItemSellAllCfg get(int key)
/*     */   {
/* 204 */     return (SItemSellAllCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SItemSellAllCfg> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SItemSellAllCfg> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SItemSellAllCfg> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\item\confbean\SItemSellAllCfg.class
