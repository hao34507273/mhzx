...
/*     */ 
/*     */ public class ItemId2ExchangeCfgId implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, ItemId2ExchangeCfgId> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, ItemId2ExchangeCfgId> all = null;
/*     */   
/*     */   public int id;
...
/*  24 */     this.exchangecfgid = Integer.valueOf(rootElement.attributeValue("exchangecfgid")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  29 */     _os_.marshal(this.id);
/*  30 */     _os_.marshal(this.exchangecfgid);
/*  31 */     return _os_;
/*     */   }
/*     */   
...
/*  37 */     this.exchangecfgid = _os_.unmarshal_int();
/*  38 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.item.confbean.ItemId2ExchangeCfgId.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.ItemId2ExchangeCfgId"))
/*     */         {
/*     */ 
/*  59 */           ItemId2ExchangeCfgId obj = new ItemId2ExchangeCfgId();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, ItemId2ExchangeCfgId> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.item.confbean.ItemId2ExchangeCfgId.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.ItemId2ExchangeCfgId"))
/*     */         {
/*     */ 
/*  88 */           ItemId2ExchangeCfgId obj = new ItemId2ExchangeCfgId();
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.item.confbean.ItemId2ExchangeCfgId.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           ItemId2ExchangeCfgId _v_ = new ItemId2ExchangeCfgId();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, ItemId2ExchangeCfgId> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.item.confbean.ItemId2ExchangeCfgId.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           ItemId2ExchangeCfgId _v_ = new ItemId2ExchangeCfgId();
...
/*     */ 
/*     */ 
/*     */   public static ItemId2ExchangeCfgId getOld(int key)
/*     */   {
/* 199 */     return (ItemId2ExchangeCfgId)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static ItemId2ExchangeCfgId get(int key)
/*     */   {
/* 204 */     return (ItemId2ExchangeCfgId)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, ItemId2ExchangeCfgId> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, ItemId2ExchangeCfgId> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, ItemId2ExchangeCfgId> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\item\confbean\ItemId2ExchangeCfgId.class
