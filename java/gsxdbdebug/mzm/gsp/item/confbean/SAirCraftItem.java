...
/*     */ 
/*     */ public class SAirCraftItem extends SItemCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  15 */   private static volatile Map<Integer, SAirCraftItem> oldAll = null;
/*     */   
/*  17 */   private static Map<Integer, SAirCraftItem> all = null;
/*     */   
...
/*  36 */     this.aircraftid = Integer.valueOf(rootElement.attributeValue("aircraftid")).intValue();
/*     */   }
/*     */   
...
/*  54 */     _os_.marshal(this.aircraftid);
/*  55 */     return _os_;
/*     */   }
/*     */   
...
/*  73 */     this.aircraftid = _os_.unmarshal_int();
/*  74 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  79 */     String path = dir + "mzm.gsp.item.confbean.SAirCraftItem.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  92 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SAirCraftItem"))
/*     */         {
/*     */ 
/*  95 */           SAirCraftItem obj = new SAirCraftItem();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SAirCraftItem> all)
/*     */   {
/* 109 */     String path = dir + "mzm.gsp.item.confbean.SAirCraftItem.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 121 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SAirCraftItem"))
/*     */         {
/*     */ 
/* 124 */           SAirCraftItem obj = new SAirCraftItem();
...
/*     */     
/* 140 */     String path = dir + "mzm.gsp.item.confbean.SAirCraftItem.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 167 */           SAirCraftItem _v_ = new SAirCraftItem();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SAirCraftItem> all)
/*     */   {
/* 187 */     String path = dir + "mzm.gsp.item.confbean.SAirCraftItem.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 214 */           SAirCraftItem _v_ = new SAirCraftItem();
...
/*     */   {
/* 233 */     for (Map.Entry<Integer, SAirCraftItem> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static void handleData(Map<Integer, SAirCraftItem> all, Map<Integer, SItemCfg> parent)
/*     */   {
/* 248 */     for (Map.Entry<Integer, SAirCraftItem> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static SAirCraftItem getOld(int key)
/*     */   {
/* 263 */     return (SAirCraftItem)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SAirCraftItem get(int key)
/*     */   {
/* 268 */     return (SAirCraftItem)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SAirCraftItem> getOldAllSelf()
/*     */   {
/* 273 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SAirCraftItem> getAllSelf()
/*     */   {
/* 278 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SAirCraftItem> newAll)
/*     */   {
/* 283 */     oldAll = all;
/* 284 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\item\confbean\SAirCraftItem.class
