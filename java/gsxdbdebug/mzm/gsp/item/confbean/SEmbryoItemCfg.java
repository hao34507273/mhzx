...
/*     */ 
/*     */ public class SEmbryoItemCfg extends SItemCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  15 */   private static volatile Map<Integer, SEmbryoItemCfg> oldAll = null;
/*     */   
/*  17 */   private static Map<Integer, SEmbryoItemCfg> all = null;
/*     */   
/*     */   public int embryoCfgid;
/*     */   
...
/*  36 */     this.embryoCfgid = Integer.valueOf(rootElement.attributeValue("embryoCfgid")).intValue();
/*     */   }
/*     */   
...
/*  54 */     _os_.marshal(this.embryoCfgid);
/*  55 */     return _os_;
/*     */   }
/*     */   
...
/*  73 */     this.embryoCfgid = _os_.unmarshal_int();
/*  74 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  79 */     String path = dir + "mzm.gsp.item.confbean.SEmbryoItemCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  92 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SEmbryoItemCfg"))
/*     */         {
/*     */ 
/*  95 */           SEmbryoItemCfg obj = new SEmbryoItemCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SEmbryoItemCfg> all)
/*     */   {
/* 109 */     String path = dir + "mzm.gsp.item.confbean.SEmbryoItemCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 121 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SEmbryoItemCfg"))
/*     */         {
/*     */ 
/* 124 */           SEmbryoItemCfg obj = new SEmbryoItemCfg();
...
/*     */     
/* 140 */     String path = dir + "mzm.gsp.item.confbean.SEmbryoItemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 167 */           SEmbryoItemCfg _v_ = new SEmbryoItemCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SEmbryoItemCfg> all)
/*     */   {
/* 187 */     String path = dir + "mzm.gsp.item.confbean.SEmbryoItemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 214 */           SEmbryoItemCfg _v_ = new SEmbryoItemCfg();
...
/*     */   {
/* 233 */     for (Map.Entry<Integer, SEmbryoItemCfg> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static void handleData(Map<Integer, SEmbryoItemCfg> all, Map<Integer, SItemCfg> parent)
/*     */   {
/* 248 */     for (Map.Entry<Integer, SEmbryoItemCfg> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static SEmbryoItemCfg getOld(int key)
/*     */   {
/* 263 */     return (SEmbryoItemCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SEmbryoItemCfg get(int key)
/*     */   {
/* 268 */     return (SEmbryoItemCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SEmbryoItemCfg> getOldAllSelf()
/*     */   {
/* 273 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SEmbryoItemCfg> getAllSelf()
/*     */   {
/* 278 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SEmbryoItemCfg> newAll)
/*     */   {
/* 283 */     oldAll = all;
/* 284 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\item\confbean\SEmbryoItemCfg.class
