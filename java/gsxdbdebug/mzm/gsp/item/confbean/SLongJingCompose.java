...
/*     */ 
/*     */ public class SLongJingCompose implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SLongJingCompose> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SLongJingCompose> all = null;
/*     */   
/*     */   public int longjingid;
/*     */   public int beforeLongjingid;
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.longjingid = Integer.valueOf(rootElement.attributeValue("longjingid")).intValue();
/*  24 */     this.beforeLongjingid = Integer.valueOf(rootElement.attributeValue("beforeLongjingid")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  29 */     _os_.marshal(this.longjingid);
/*  30 */     _os_.marshal(this.beforeLongjingid);
/*  31 */     return _os_;
/*     */   }
/*     */   
...
/*  37 */     this.beforeLongjingid = _os_.unmarshal_int();
/*  38 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.item.confbean.SLongJingCompose.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SLongJingCompose"))
/*     */         {
/*     */ 
/*  59 */           SLongJingCompose obj = new SLongJingCompose();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SLongJingCompose> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.item.confbean.SLongJingCompose.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SLongJingCompose"))
/*     */         {
/*     */ 
/*  88 */           SLongJingCompose obj = new SLongJingCompose();
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.item.confbean.SLongJingCompose.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           SLongJingCompose _v_ = new SLongJingCompose();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SLongJingCompose> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.item.confbean.SLongJingCompose.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           SLongJingCompose _v_ = new SLongJingCompose();
...
/*     */ 
/*     */ 
/*     */   public static SLongJingCompose getOld(int key)
/*     */   {
/* 199 */     return (SLongJingCompose)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SLongJingCompose get(int key)
/*     */   {
/* 204 */     return (SLongJingCompose)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SLongJingCompose> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SLongJingCompose> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SLongJingCompose> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\item\confbean\SLongJingCompose.class
