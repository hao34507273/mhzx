...
/*     */ 
/*     */ public class SChainedGiftBagChainCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SChainedGiftBagChainCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SChainedGiftBagChainCfg> all = null;
/*     */   
/*     */   public int chain;
/*  19 */   public HashMap<Integer, Integer> sn2id = new HashMap();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.chain = Integer.valueOf(rootElement.attributeValue("chain")).intValue();
/*     */     
/*  25 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "sn2id");
...
/*     */         }
/*     */         
/*  76 */         this.sn2id.put(Integer.valueOf(_k_), Integer.valueOf(_v_));
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*     */   {
/*  83 */     _os_.marshal(this.chain);
/*  84 */     _os_.compact_uint32(this.sn2id.size());
/*  85 */     for (java.util.Map.Entry<Integer, Integer> _e_ : this.sn2id.entrySet())
/*     */     {
...
/*     */   {
/*  95 */     this.chain = _os_.unmarshal_int();
...
/* 102 */       this.sn2id.put(Integer.valueOf(_k_), Integer.valueOf(_v_));
/*     */     }
/* 104 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/* 109 */     String path = dir + "mzm.gsp.item.confbean.SChainedGiftBagChainCfg.xml";
/*     */     
/*     */     try
/*     */     {
/* 113 */       all = new HashMap();
...
/* 122 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SChainedGiftBagChainCfg"))
/*     */         {
/*     */ 
/* 125 */           SChainedGiftBagChainCfg obj = new SChainedGiftBagChainCfg();
/* 126 */           obj.loadFromXml(elem);
/* 127 */           if (all.put(Integer.valueOf(obj.chain), obj) != null) {
/* 128 */             throw new RuntimeException("duplicate key : " + obj.chain);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SChainedGiftBagChainCfg> all)
/*     */   {
/* 139 */     String path = dir + "mzm.gsp.item.confbean.SChainedGiftBagChainCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 151 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SChainedGiftBagChainCfg"))
/*     */         {
/*     */ 
/* 154 */           SChainedGiftBagChainCfg obj = new SChainedGiftBagChainCfg();
/* 155 */           obj.loadFromXml(elem);
/* 156 */           if (all.put(Integer.valueOf(obj.chain), obj) != null) {
/* 157 */             throw new RuntimeException("duplicate key : " + obj.chain);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/* 168 */     all = new HashMap();
/*     */     
/* 170 */     String path = dir + "mzm.gsp.item.confbean.SChainedGiftBagChainCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 197 */           SChainedGiftBagChainCfg _v_ = new SChainedGiftBagChainCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SChainedGiftBagChainCfg> all)
/*     */   {
/* 217 */     String path = dir + "mzm.gsp.item.confbean.SChainedGiftBagChainCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 244 */           SChainedGiftBagChainCfg _v_ = new SChainedGiftBagChainCfg();
...
/*     */ 
/*     */ 
/*     */   public static SChainedGiftBagChainCfg getOld(int key)
/*     */   {
/* 265 */     return (SChainedGiftBagChainCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SChainedGiftBagChainCfg get(int key)
/*     */   {
/* 270 */     return (SChainedGiftBagChainCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SChainedGiftBagChainCfg> getOldAll()
/*     */   {
/* 275 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SChainedGiftBagChainCfg> getAll()
/*     */   {
/* 280 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SChainedGiftBagChainCfg> newAll)
/*     */   {
/* 285 */     oldAll = all;
/* 286 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\item\confbean\SChainedGiftBagChainCfg.class
