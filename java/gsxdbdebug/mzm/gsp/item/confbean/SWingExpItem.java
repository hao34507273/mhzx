...
/*     */ 
/*     */ public class SWingExpItem extends SItemCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  15 */   private static volatile Map<Integer, SWingExpItem> oldAll = null;
/*     */   
/*  17 */   private static Map<Integer, SWingExpItem> all = null;
/*     */   
...
/*     */   {
/*  79 */     String path = dir + "mzm.gsp.item.confbean.SWingExpItem.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  92 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SWingExpItem"))
/*     */         {
/*     */ 
/*  95 */           SWingExpItem obj = new SWingExpItem();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SWingExpItem> all)
/*     */   {
/* 109 */     String path = dir + "mzm.gsp.item.confbean.SWingExpItem.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 121 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SWingExpItem"))
/*     */         {
/*     */ 
/* 124 */           SWingExpItem obj = new SWingExpItem();
...
/*     */     
/* 140 */     String path = dir + "mzm.gsp.item.confbean.SWingExpItem.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 167 */           SWingExpItem _v_ = new SWingExpItem();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SWingExpItem> all)
/*     */   {
/* 187 */     String path = dir + "mzm.gsp.item.confbean.SWingExpItem.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 214 */           SWingExpItem _v_ = new SWingExpItem();
...
/*     */   {
/* 233 */     for (Map.Entry<Integer, SWingExpItem> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static void handleData(Map<Integer, SWingExpItem> all, Map<Integer, SItemCfg> parent)
/*     */   {
/* 248 */     for (Map.Entry<Integer, SWingExpItem> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static SWingExpItem getOld(int key)
/*     */   {
/* 263 */     return (SWingExpItem)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SWingExpItem get(int key)
/*     */   {
/* 268 */     return (SWingExpItem)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SWingExpItem> getOldAllSelf()
/*     */   {
/* 273 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SWingExpItem> getAllSelf()
/*     */   {
/* 278 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SWingExpItem> newAll)
/*     */   {
/* 283 */     oldAll = all;
/* 284 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\item\confbean\SWingExpItem.class
