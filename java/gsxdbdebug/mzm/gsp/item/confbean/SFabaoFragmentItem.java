...
/*     */ 
/*     */ public class SFabaoFragmentItem extends SItemCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  15 */   private static volatile Map<Integer, SFabaoFragmentItem> oldAll = null;
/*     */   
/*  17 */   private static Map<Integer, SFabaoFragmentItem> all = null;
/*     */   
/*     */   public int rankExp;
...
/*  37 */     this.rankExp = Integer.valueOf(rootElement.attributeValue("rankExp")).intValue();
/*  38 */     this.fabaoType = Integer.valueOf(rootElement.attributeValue("fabaoType")).intValue();
/*     */   }
/*     */   
...
/*  56 */     _os_.marshal(this.rankExp);
/*  57 */     _os_.marshal(this.fabaoType);
/*  58 */     return _os_;
/*     */   }
/*     */   
...
/*  76 */     this.rankExp = _os_.unmarshal_int();
/*  77 */     this.fabaoType = _os_.unmarshal_int();
/*  78 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  83 */     String path = dir + "mzm.gsp.item.confbean.SFabaoFragmentItem.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  96 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SFabaoFragmentItem"))
/*     */         {
/*     */ 
/*  99 */           SFabaoFragmentItem obj = new SFabaoFragmentItem();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SFabaoFragmentItem> all)
/*     */   {
/* 113 */     String path = dir + "mzm.gsp.item.confbean.SFabaoFragmentItem.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 125 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SFabaoFragmentItem"))
/*     */         {
/*     */ 
/* 128 */           SFabaoFragmentItem obj = new SFabaoFragmentItem();
...
/*     */     
/* 144 */     String path = dir + "mzm.gsp.item.confbean.SFabaoFragmentItem.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 171 */           SFabaoFragmentItem _v_ = new SFabaoFragmentItem();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SFabaoFragmentItem> all)
/*     */   {
/* 191 */     String path = dir + "mzm.gsp.item.confbean.SFabaoFragmentItem.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 218 */           SFabaoFragmentItem _v_ = new SFabaoFragmentItem();
...
/*     */   {
/* 237 */     for (Map.Entry<Integer, SFabaoFragmentItem> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static void handleData(Map<Integer, SFabaoFragmentItem> all, Map<Integer, SItemCfg> parent)
/*     */   {
/* 252 */     for (Map.Entry<Integer, SFabaoFragmentItem> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static SFabaoFragmentItem getOld(int key)
/*     */   {
/* 267 */     return (SFabaoFragmentItem)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SFabaoFragmentItem get(int key)
/*     */   {
/* 272 */     return (SFabaoFragmentItem)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SFabaoFragmentItem> getOldAllSelf()
/*     */   {
/* 277 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SFabaoFragmentItem> getAllSelf()
/*     */   {
/* 282 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SFabaoFragmentItem> newAll)
/*     */   {
/* 287 */     oldAll = all;
/* 288 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\item\confbean\SFabaoFragmentItem.class
