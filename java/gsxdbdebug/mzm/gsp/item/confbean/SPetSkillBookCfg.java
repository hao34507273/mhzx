...
/*     */ 
/*     */ public class SPetSkillBookCfg extends SItemCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  15 */   private static volatile Map<Integer, SPetSkillBookCfg> oldAll = null;
/*     */   
/*  17 */   private static Map<Integer, SPetSkillBookCfg> all = null;
/*     */   
/*     */   public int skillId;
...
/*  38 */     this.skillId = Integer.valueOf(rootElement.attributeValue("skillId")).intValue();
/*  39 */     this.itemPhase = Integer.valueOf(rootElement.attributeValue("itemPhase")).intValue();
/*  40 */     this.skillPhase = Integer.valueOf(rootElement.attributeValue("skillPhase")).intValue();
/*     */   }
/*     */   
...
/*  58 */     _os_.marshal(this.skillId);
/*  59 */     _os_.marshal(this.itemPhase);
/*  60 */     _os_.marshal(this.skillPhase);
/*  61 */     return _os_;
/*     */   }
/*     */   
...
/*  79 */     this.skillId = _os_.unmarshal_int();
/*  80 */     this.itemPhase = _os_.unmarshal_int();
/*  81 */     this.skillPhase = _os_.unmarshal_int();
/*  82 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  87 */     String path = dir + "mzm.gsp.item.confbean.SPetSkillBookCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 100 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SPetSkillBookCfg"))
/*     */         {
/*     */ 
/* 103 */           SPetSkillBookCfg obj = new SPetSkillBookCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SPetSkillBookCfg> all)
/*     */   {
/* 117 */     String path = dir + "mzm.gsp.item.confbean.SPetSkillBookCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 129 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SPetSkillBookCfg"))
/*     */         {
/*     */ 
/* 132 */           SPetSkillBookCfg obj = new SPetSkillBookCfg();
...
/*     */     
/* 148 */     String path = dir + "mzm.gsp.item.confbean.SPetSkillBookCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 175 */           SPetSkillBookCfg _v_ = new SPetSkillBookCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SPetSkillBookCfg> all)
/*     */   {
/* 195 */     String path = dir + "mzm.gsp.item.confbean.SPetSkillBookCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 222 */           SPetSkillBookCfg _v_ = new SPetSkillBookCfg();
...
/*     */   {
/* 241 */     for (Map.Entry<Integer, SPetSkillBookCfg> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static void handleData(Map<Integer, SPetSkillBookCfg> all, Map<Integer, SItemCfg> parent)
/*     */   {
/* 256 */     for (Map.Entry<Integer, SPetSkillBookCfg> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static SPetSkillBookCfg getOld(int key)
/*     */   {
/* 271 */     return (SPetSkillBookCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SPetSkillBookCfg get(int key)
/*     */   {
/* 276 */     return (SPetSkillBookCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPetSkillBookCfg> getOldAllSelf()
/*     */   {
/* 281 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPetSkillBookCfg> getAllSelf()
/*     */   {
/* 286 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SPetSkillBookCfg> newAll)
/*     */   {
/* 291 */     oldAll = all;
/* 292 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\item\confbean\SPetSkillBookCfg.class
