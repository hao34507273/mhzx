...
/*     */ 
/*     */ public class SEquipMakeItemCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SEquipMakeItemCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SEquipMakeItemCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public int goldNum;
...
/*     */   {
/* 137 */     String path = dir + "mzm.gsp.item.confbean.SEquipMakeItemCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 150 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SEquipMakeItemCfg"))
/*     */         {
/*     */ 
/* 153 */           SEquipMakeItemCfg obj = new SEquipMakeItemCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SEquipMakeItemCfg> all)
/*     */   {
/* 167 */     String path = dir + "mzm.gsp.item.confbean.SEquipMakeItemCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 179 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SEquipMakeItemCfg"))
/*     */         {
/*     */ 
/* 182 */           SEquipMakeItemCfg obj = new SEquipMakeItemCfg();
...
/*     */     
/* 198 */     String path = dir + "mzm.gsp.item.confbean.SEquipMakeItemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 225 */           SEquipMakeItemCfg _v_ = new SEquipMakeItemCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SEquipMakeItemCfg> all)
/*     */   {
/* 245 */     String path = dir + "mzm.gsp.item.confbean.SEquipMakeItemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 272 */           SEquipMakeItemCfg _v_ = new SEquipMakeItemCfg();
...
/*     */ 
/*     */ 
/*     */   public static SEquipMakeItemCfg getOld(int key)
/*     */   {
/* 293 */     return (SEquipMakeItemCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SEquipMakeItemCfg get(int key)
/*     */   {
/* 298 */     return (SEquipMakeItemCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SEquipMakeItemCfg> getOldAll()
/*     */   {
/* 303 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SEquipMakeItemCfg> getAll()
/*     */   {
/* 308 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SEquipMakeItemCfg> newAll)
/*     */   {
/* 313 */     oldAll = all;
/* 314 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\item\confbean\SEquipMakeItemCfg.class
