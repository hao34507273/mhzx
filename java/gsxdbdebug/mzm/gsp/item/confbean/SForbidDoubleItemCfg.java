...
/*     */ 
/*     */ public class SForbidDoubleItemCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SForbidDoubleItemCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SForbidDoubleItemCfg> all = null;
/*     */   
/*     */   public int item_id;
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  22 */     this.item_id = Integer.valueOf(rootElement.attributeValue("item_id")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  27 */     _os_.marshal(this.item_id);
/*  28 */     return _os_;
/*     */   }
/*     */   
/*     */   public OctetsStream unmarshal(OctetsStream _os_) throws com.goldhuman.Common.Marshal.MarshalException
/*     */   {
/*  33 */     this.item_id = _os_.unmarshal_int();
/*  34 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  39 */     String path = dir + "mzm.gsp.item.confbean.SForbidDoubleItemCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  52 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SForbidDoubleItemCfg"))
/*     */         {
/*     */ 
/*  55 */           SForbidDoubleItemCfg obj = new SForbidDoubleItemCfg();
/*  56 */           obj.loadFromXml(elem);
/*  57 */           if (all.put(Integer.valueOf(obj.item_id), obj) != null) {
/*  58 */             throw new RuntimeException("duplicate key : " + obj.item_id);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SForbidDoubleItemCfg> all)
/*     */   {
/*  69 */     String path = dir + "mzm.gsp.item.confbean.SForbidDoubleItemCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  81 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SForbidDoubleItemCfg"))
/*     */         {
/*     */ 
/*  84 */           SForbidDoubleItemCfg obj = new SForbidDoubleItemCfg();
/*  85 */           obj.loadFromXml(elem);
/*  86 */           if (all.put(Integer.valueOf(obj.item_id), obj) != null) {
/*  87 */             throw new RuntimeException("duplicate key : " + obj.item_id);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 100 */     String path = dir + "mzm.gsp.item.confbean.SForbidDoubleItemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 127 */           SForbidDoubleItemCfg _v_ = new SForbidDoubleItemCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SForbidDoubleItemCfg> all)
/*     */   {
/* 147 */     String path = dir + "mzm.gsp.item.confbean.SForbidDoubleItemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 174 */           SForbidDoubleItemCfg _v_ = new SForbidDoubleItemCfg();
...
/*     */ 
/*     */ 
/*     */   public static SForbidDoubleItemCfg getOld(int key)
/*     */   {
/* 195 */     return (SForbidDoubleItemCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SForbidDoubleItemCfg get(int key)
/*     */   {
/* 200 */     return (SForbidDoubleItemCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SForbidDoubleItemCfg> getOldAll()
/*     */   {
/* 205 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SForbidDoubleItemCfg> getAll()
/*     */   {
/* 210 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SForbidDoubleItemCfg> newAll)
/*     */   {
/* 215 */     oldAll = all;
/* 216 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\item\confbean\SForbidDoubleItemCfg.class
