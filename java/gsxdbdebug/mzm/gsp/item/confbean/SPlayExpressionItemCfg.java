...
/*     */ 
/*     */ public class SPlayExpressionItemCfg extends SItemCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  15 */   private static volatile Map<Integer, SPlayExpressionItemCfg> oldAll = null;
/*     */   
/*  17 */   private static Map<Integer, SPlayExpressionItemCfg> all = null;
/*     */   
...
/*  36 */     this.expressionAction = Integer.valueOf(rootElement.attributeValue("expressionAction")).intValue();
/*     */   }
/*     */   
...
/*  54 */     _os_.marshal(this.expressionAction);
/*  55 */     return _os_;
/*     */   }
/*     */   
...
/*  73 */     this.expressionAction = _os_.unmarshal_int();
/*  74 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  79 */     String path = dir + "mzm.gsp.item.confbean.SPlayExpressionItemCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  92 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SPlayExpressionItemCfg"))
/*     */         {
/*     */ 
/*  95 */           SPlayExpressionItemCfg obj = new SPlayExpressionItemCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SPlayExpressionItemCfg> all)
/*     */   {
/* 109 */     String path = dir + "mzm.gsp.item.confbean.SPlayExpressionItemCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 121 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SPlayExpressionItemCfg"))
/*     */         {
/*     */ 
/* 124 */           SPlayExpressionItemCfg obj = new SPlayExpressionItemCfg();
...
/*     */     
/* 140 */     String path = dir + "mzm.gsp.item.confbean.SPlayExpressionItemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 167 */           SPlayExpressionItemCfg _v_ = new SPlayExpressionItemCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SPlayExpressionItemCfg> all)
/*     */   {
/* 187 */     String path = dir + "mzm.gsp.item.confbean.SPlayExpressionItemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 214 */           SPlayExpressionItemCfg _v_ = new SPlayExpressionItemCfg();
...
/*     */   {
/* 233 */     for (Map.Entry<Integer, SPlayExpressionItemCfg> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static void handleData(Map<Integer, SPlayExpressionItemCfg> all, Map<Integer, SItemCfg> parent)
/*     */   {
/* 248 */     for (Map.Entry<Integer, SPlayExpressionItemCfg> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static SPlayExpressionItemCfg getOld(int key)
/*     */   {
/* 263 */     return (SPlayExpressionItemCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SPlayExpressionItemCfg get(int key)
/*     */   {
/* 268 */     return (SPlayExpressionItemCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPlayExpressionItemCfg> getOldAllSelf()
/*     */   {
/* 273 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPlayExpressionItemCfg> getAllSelf()
/*     */   {
/* 278 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SPlayExpressionItemCfg> newAll)
/*     */   {
/* 283 */     oldAll = all;
/* 284 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\item\confbean\SPlayExpressionItemCfg.class
