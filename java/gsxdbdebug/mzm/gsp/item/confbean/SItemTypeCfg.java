...
/*     */ 
/*     */ public class SItemTypeCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SItemTypeCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SItemTypeCfg> all = null;
/*     */   
/*     */   public int itemType;
/*     */   public int id;
/*     */   public int bagsort;
...
/*  28 */     this.bagsort = Integer.valueOf(rootElement.attributeValue("bagsort")).intValue();
/*  29 */     this.canGive = Boolean.valueOf(rootElement.attributeValue("canGive")).booleanValue();
/*  30 */     this.typegroup = Integer.valueOf(rootElement.attributeValue("typegroup")).intValue();
/*     */   }
/*     */   
...
/*  37 */     _os_.marshal(this.bagsort);
/*  38 */     _os_.marshal(this.canGive);
/*  39 */     _os_.marshal(this.typegroup);
/*  40 */     return _os_;
/*     */   }
/*     */   
...
/*  47 */     this.bagsort = _os_.unmarshal_int();
/*  48 */     this.canGive = _os_.unmarshal_boolean();
/*  49 */     this.typegroup = _os_.unmarshal_int();
/*  50 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  55 */     String path = dir + "mzm.gsp.item.confbean.SItemTypeCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  68 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SItemTypeCfg"))
/*     */         {
/*     */ 
/*  71 */           SItemTypeCfg obj = new SItemTypeCfg();
/*  72 */           obj.loadFromXml(elem);
/*  73 */           if (all.put(Integer.valueOf(obj.itemType), obj) != null) {
/*  74 */             throw new RuntimeException("duplicate key : " + obj.itemType);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SItemTypeCfg> all)
/*     */   {
/*  85 */     String path = dir + "mzm.gsp.item.confbean.SItemTypeCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  97 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SItemTypeCfg"))
/*     */         {
/*     */ 
/* 100 */           SItemTypeCfg obj = new SItemTypeCfg();
/* 101 */           obj.loadFromXml(elem);
/* 102 */           if (all.put(Integer.valueOf(obj.itemType), obj) != null) {
/* 103 */             throw new RuntimeException("duplicate key : " + obj.itemType);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 116 */     String path = dir + "mzm.gsp.item.confbean.SItemTypeCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 143 */           SItemTypeCfg _v_ = new SItemTypeCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SItemTypeCfg> all)
/*     */   {
/* 163 */     String path = dir + "mzm.gsp.item.confbean.SItemTypeCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 190 */           SItemTypeCfg _v_ = new SItemTypeCfg();
...
/*     */ 
/*     */ 
/*     */   public static SItemTypeCfg getOld(int key)
/*     */   {
/* 211 */     return (SItemTypeCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SItemTypeCfg get(int key)
/*     */   {
/* 216 */     return (SItemTypeCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SItemTypeCfg> getOldAll()
/*     */   {
/* 221 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SItemTypeCfg> getAll()
/*     */   {
/* 226 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SItemTypeCfg> newAll)
/*     */   {
/* 231 */     oldAll = all;
/* 232 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\item\confbean\SItemTypeCfg.class
