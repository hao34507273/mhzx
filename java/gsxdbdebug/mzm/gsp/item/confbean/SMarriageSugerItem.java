...
/*     */ 
/*     */ public class SMarriageSugerItem extends SItemCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  15 */   private static volatile Map<Integer, SMarriageSugerItem> oldAll = null;
/*     */   
/*  17 */   private static Map<Integer, SMarriageSugerItem> all = null;
/*     */   
/*     */   public int awardpoolTypeid;
/*     */   public int carrymax;
/*     */   public int useCount;
/*     */   
...
/*  38 */     this.awardpoolTypeid = Integer.valueOf(rootElement.attributeValue("awardpoolTypeid")).intValue();
/*  39 */     this.carrymax = Integer.valueOf(rootElement.attributeValue("carrymax")).intValue();
/*  40 */     this.useCount = Integer.valueOf(rootElement.attributeValue("useCount")).intValue();
/*     */   }
/*     */   
...
/*  58 */     _os_.marshal(this.awardpoolTypeid);
/*  59 */     _os_.marshal(this.carrymax);
/*  60 */     _os_.marshal(this.useCount);
/*  61 */     return _os_;
/*     */   }
/*     */   
...
/*  79 */     this.awardpoolTypeid = _os_.unmarshal_int();
/*  80 */     this.carrymax = _os_.unmarshal_int();
/*  81 */     this.useCount = _os_.unmarshal_int();
/*  82 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  87 */     String path = dir + "mzm.gsp.item.confbean.SMarriageSugerItem.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 100 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SMarriageSugerItem"))
/*     */         {
/*     */ 
/* 103 */           SMarriageSugerItem obj = new SMarriageSugerItem();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SMarriageSugerItem> all)
/*     */   {
/* 117 */     String path = dir + "mzm.gsp.item.confbean.SMarriageSugerItem.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 129 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SMarriageSugerItem"))
/*     */         {
/*     */ 
/* 132 */           SMarriageSugerItem obj = new SMarriageSugerItem();
...
/*     */     
/* 148 */     String path = dir + "mzm.gsp.item.confbean.SMarriageSugerItem.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 175 */           SMarriageSugerItem _v_ = new SMarriageSugerItem();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SMarriageSugerItem> all)
/*     */   {
/* 195 */     String path = dir + "mzm.gsp.item.confbean.SMarriageSugerItem.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 222 */           SMarriageSugerItem _v_ = new SMarriageSugerItem();
...
/*     */   {
/* 241 */     for (Map.Entry<Integer, SMarriageSugerItem> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static void handleData(Map<Integer, SMarriageSugerItem> all, Map<Integer, SItemCfg> parent)
/*     */   {
/* 256 */     for (Map.Entry<Integer, SMarriageSugerItem> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static SMarriageSugerItem getOld(int key)
/*     */   {
/* 271 */     return (SMarriageSugerItem)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SMarriageSugerItem get(int key)
/*     */   {
/* 276 */     return (SMarriageSugerItem)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMarriageSugerItem> getOldAllSelf()
/*     */   {
/* 281 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMarriageSugerItem> getAllSelf()
/*     */   {
/* 286 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SMarriageSugerItem> newAll)
/*     */   {
/* 291 */     oldAll = all;
/* 292 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\item\confbean\SMarriageSugerItem.class
