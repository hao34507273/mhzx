...
/*     */ 
/*     */ public class SPetLifeItem extends SItemCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  15 */   private static volatile Map<Integer, SPetLifeItem> oldAll = null;
/*     */   
/*  17 */   private static Map<Integer, SPetLifeItem> all = null;
/*     */   
/*     */   public int petMinLifeLimit;
/*     */   public int petMaxLifeLimit;
/*     */   public int itemPro;
/*     */   
...
/*  38 */     this.petMinLifeLimit = Integer.valueOf(rootElement.attributeValue("petMinLifeLimit")).intValue();
/*  39 */     this.petMaxLifeLimit = Integer.valueOf(rootElement.attributeValue("petMaxLifeLimit")).intValue();
/*  40 */     this.itemPro = Integer.valueOf(rootElement.attributeValue("itemPro")).intValue();
/*     */   }
/*     */   
...
/*  58 */     _os_.marshal(this.petMinLifeLimit);
/*  59 */     _os_.marshal(this.petMaxLifeLimit);
/*  60 */     _os_.marshal(this.itemPro);
/*  61 */     return _os_;
/*     */   }
/*     */   
...
/*  79 */     this.petMinLifeLimit = _os_.unmarshal_int();
/*  80 */     this.petMaxLifeLimit = _os_.unmarshal_int();
/*  81 */     this.itemPro = _os_.unmarshal_int();
/*  82 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  87 */     String path = dir + "mzm.gsp.item.confbean.SPetLifeItem.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 100 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SPetLifeItem"))
/*     */         {
/*     */ 
/* 103 */           SPetLifeItem obj = new SPetLifeItem();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SPetLifeItem> all)
/*     */   {
/* 117 */     String path = dir + "mzm.gsp.item.confbean.SPetLifeItem.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 129 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SPetLifeItem"))
/*     */         {
/*     */ 
/* 132 */           SPetLifeItem obj = new SPetLifeItem();
...
/*     */     
/* 148 */     String path = dir + "mzm.gsp.item.confbean.SPetLifeItem.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 175 */           SPetLifeItem _v_ = new SPetLifeItem();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SPetLifeItem> all)
/*     */   {
/* 195 */     String path = dir + "mzm.gsp.item.confbean.SPetLifeItem.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 222 */           SPetLifeItem _v_ = new SPetLifeItem();
...
/*     */   {
/* 241 */     for (Map.Entry<Integer, SPetLifeItem> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static void handleData(Map<Integer, SPetLifeItem> all, Map<Integer, SItemCfg> parent)
/*     */   {
/* 256 */     for (Map.Entry<Integer, SPetLifeItem> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static SPetLifeItem getOld(int key)
/*     */   {
/* 271 */     return (SPetLifeItem)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SPetLifeItem get(int key)
/*     */   {
/* 276 */     return (SPetLifeItem)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPetLifeItem> getOldAllSelf()
/*     */   {
/* 281 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPetLifeItem> getAllSelf()
/*     */   {
/* 286 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SPetLifeItem> newAll)
/*     */   {
/* 291 */     oldAll = all;
/* 292 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\item\confbean\SPetLifeItem.class
