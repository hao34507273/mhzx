...
/*     */ 
/*     */ public class SDoubleItemCfg extends SItemCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  15 */   private static volatile Map<Integer, SDoubleItemCfg> oldAll = null;
/*     */   
/*  17 */   private static Map<Integer, SDoubleItemCfg> all = null;
/*     */   
...
/*  36 */     this.total_times = Integer.valueOf(rootElement.attributeValue("total_times")).intValue();
/*     */   }
/*     */   
...
/*  54 */     _os_.marshal(this.total_times);
/*  55 */     return _os_;
/*     */   }
/*     */   
...
/*  73 */     this.total_times = _os_.unmarshal_int();
/*  74 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  79 */     String path = dir + "mzm.gsp.item.confbean.SDoubleItemCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  92 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SDoubleItemCfg"))
/*     */         {
/*     */ 
/*  95 */           SDoubleItemCfg obj = new SDoubleItemCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SDoubleItemCfg> all)
/*     */   {
/* 109 */     String path = dir + "mzm.gsp.item.confbean.SDoubleItemCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 121 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SDoubleItemCfg"))
/*     */         {
/*     */ 
/* 124 */           SDoubleItemCfg obj = new SDoubleItemCfg();
...
/*     */     
/* 140 */     String path = dir + "mzm.gsp.item.confbean.SDoubleItemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 167 */           SDoubleItemCfg _v_ = new SDoubleItemCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SDoubleItemCfg> all)
/*     */   {
/* 187 */     String path = dir + "mzm.gsp.item.confbean.SDoubleItemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 214 */           SDoubleItemCfg _v_ = new SDoubleItemCfg();
...
/*     */   {
/* 233 */     for (Map.Entry<Integer, SDoubleItemCfg> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static void handleData(Map<Integer, SDoubleItemCfg> all, Map<Integer, SItemCfg> parent)
/*     */   {
/* 248 */     for (Map.Entry<Integer, SDoubleItemCfg> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static SDoubleItemCfg getOld(int key)
/*     */   {
/* 263 */     return (SDoubleItemCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SDoubleItemCfg get(int key)
/*     */   {
/* 268 */     return (SDoubleItemCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SDoubleItemCfg> getOldAllSelf()
/*     */   {
/* 273 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SDoubleItemCfg> getAllSelf()
/*     */   {
/* 278 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SDoubleItemCfg> newAll)
/*     */   {
/* 283 */     oldAll = all;
/* 284 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\item\confbean\SDoubleItemCfg.class
