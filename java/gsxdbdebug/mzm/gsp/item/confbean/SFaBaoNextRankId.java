...
/*     */ 
/*     */ public class SFaBaoNextRankId implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SFaBaoNextRankId> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SFaBaoNextRankId> all = null;
/*     */   
/*     */   public int fabaoid;
/*     */   public int nextRankFabaoid;
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.fabaoid = Integer.valueOf(rootElement.attributeValue("fabaoid")).intValue();
/*  24 */     this.nextRankFabaoid = Integer.valueOf(rootElement.attributeValue("nextRankFabaoid")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  29 */     _os_.marshal(this.fabaoid);
/*  30 */     _os_.marshal(this.nextRankFabaoid);
/*  31 */     return _os_;
/*     */   }
/*     */   
/*     */   public OctetsStream unmarshal(OctetsStream _os_) throws com.goldhuman.Common.Marshal.MarshalException
/*     */   {
/*  36 */     this.fabaoid = _os_.unmarshal_int();
/*  37 */     this.nextRankFabaoid = _os_.unmarshal_int();
/*  38 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.item.confbean.SFaBaoNextRankId.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SFaBaoNextRankId"))
/*     */         {
/*     */ 
/*  59 */           SFaBaoNextRankId obj = new SFaBaoNextRankId();
/*  60 */           obj.loadFromXml(elem);
/*  61 */           if (all.put(Integer.valueOf(obj.fabaoid), obj) != null) {
/*  62 */             throw new RuntimeException("duplicate key : " + obj.fabaoid);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SFaBaoNextRankId> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.item.confbean.SFaBaoNextRankId.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SFaBaoNextRankId"))
/*     */         {
/*     */ 
/*  88 */           SFaBaoNextRankId obj = new SFaBaoNextRankId();
/*  89 */           obj.loadFromXml(elem);
/*  90 */           if (all.put(Integer.valueOf(obj.fabaoid), obj) != null) {
/*  91 */             throw new RuntimeException("duplicate key : " + obj.fabaoid);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.item.confbean.SFaBaoNextRankId.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           SFaBaoNextRankId _v_ = new SFaBaoNextRankId();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SFaBaoNextRankId> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.item.confbean.SFaBaoNextRankId.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           SFaBaoNextRankId _v_ = new SFaBaoNextRankId();
...
/*     */ 
/*     */ 
/*     */   public static SFaBaoNextRankId getOld(int key)
/*     */   {
/* 199 */     return (SFaBaoNextRankId)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SFaBaoNextRankId get(int key)
/*     */   {
/* 204 */     return (SFaBaoNextRankId)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SFaBaoNextRankId> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SFaBaoNextRankId> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SFaBaoNextRankId> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\item\confbean\SFaBaoNextRankId.class
