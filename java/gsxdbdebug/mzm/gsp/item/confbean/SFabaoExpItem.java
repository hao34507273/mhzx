...
/*     */ 
/*     */ public class SFabaoExpItem extends SItemCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  15 */   private static volatile Map<Integer, SFabaoExpItem> oldAll = null;
/*     */   
/*  17 */   private static Map<Integer, SFabaoExpItem> all = null;
/*     */   
/*     */   public int exp;
/*     */   
...
/*     */   {
/*  79 */     String path = dir + "mzm.gsp.item.confbean.SFabaoExpItem.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  92 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SFabaoExpItem"))
/*     */         {
/*     */ 
/*  95 */           SFabaoExpItem obj = new SFabaoExpItem();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SFabaoExpItem> all)
/*     */   {
/* 109 */     String path = dir + "mzm.gsp.item.confbean.SFabaoExpItem.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 121 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SFabaoExpItem"))
/*     */         {
/*     */ 
/* 124 */           SFabaoExpItem obj = new SFabaoExpItem();
...
/*     */     
/* 140 */     String path = dir + "mzm.gsp.item.confbean.SFabaoExpItem.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 167 */           SFabaoExpItem _v_ = new SFabaoExpItem();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SFabaoExpItem> all)
/*     */   {
/* 187 */     String path = dir + "mzm.gsp.item.confbean.SFabaoExpItem.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 214 */           SFabaoExpItem _v_ = new SFabaoExpItem();
...
/*     */   {
/* 233 */     for (Map.Entry<Integer, SFabaoExpItem> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static void handleData(Map<Integer, SFabaoExpItem> all, Map<Integer, SItemCfg> parent)
/*     */   {
/* 248 */     for (Map.Entry<Integer, SFabaoExpItem> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static SFabaoExpItem getOld(int key)
/*     */   {
/* 263 */     return (SFabaoExpItem)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SFabaoExpItem get(int key)
/*     */   {
/* 268 */     return (SFabaoExpItem)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SFabaoExpItem> getOldAllSelf()
/*     */   {
/* 273 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SFabaoExpItem> getAllSelf()
/*     */   {
/* 278 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SFabaoExpItem> newAll)
/*     */   {
/* 283 */     oldAll = all;
/* 284 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\item\confbean\SFabaoExpItem.class
