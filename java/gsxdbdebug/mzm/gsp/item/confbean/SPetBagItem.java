...
/*     */ 
/*     */ public class SPetBagItem extends SItemCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  15 */   private static volatile Map<Integer, SPetBagItem> oldAll = null;
/*     */   
/*  17 */   private static Map<Integer, SPetBagItem> all = null;
/*     */   
/*     */   public int petId;
/*     */   public int petLevel;
/*     */   
...
/*  37 */     this.petId = Integer.valueOf(rootElement.attributeValue("petId")).intValue();
/*  38 */     this.petLevel = Integer.valueOf(rootElement.attributeValue("petLevel")).intValue();
/*     */   }
/*     */   
...
/*  76 */     this.petId = _os_.unmarshal_int();
/*  77 */     this.petLevel = _os_.unmarshal_int();
/*  78 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  83 */     String path = dir + "mzm.gsp.item.confbean.SPetBagItem.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  96 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SPetBagItem"))
/*     */         {
/*     */ 
/*  99 */           SPetBagItem obj = new SPetBagItem();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SPetBagItem> all)
/*     */   {
/* 113 */     String path = dir + "mzm.gsp.item.confbean.SPetBagItem.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 125 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SPetBagItem"))
/*     */         {
/*     */ 
/* 128 */           SPetBagItem obj = new SPetBagItem();
...
/*     */     
/* 144 */     String path = dir + "mzm.gsp.item.confbean.SPetBagItem.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 171 */           SPetBagItem _v_ = new SPetBagItem();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SPetBagItem> all)
/*     */   {
/* 191 */     String path = dir + "mzm.gsp.item.confbean.SPetBagItem.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 218 */           SPetBagItem _v_ = new SPetBagItem();
...
/*     */   {
/* 237 */     for (Map.Entry<Integer, SPetBagItem> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static void handleData(Map<Integer, SPetBagItem> all, Map<Integer, SItemCfg> parent)
/*     */   {
/* 252 */     for (Map.Entry<Integer, SPetBagItem> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static SPetBagItem getOld(int key)
/*     */   {
/* 267 */     return (SPetBagItem)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SPetBagItem get(int key)
/*     */   {
/* 272 */     return (SPetBagItem)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPetBagItem> getOldAllSelf()
/*     */   {
/* 277 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPetBagItem> getAllSelf()
/*     */   {
/* 282 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SPetBagItem> newAll)
/*     */   {
/* 287 */     oldAll = all;
/* 288 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\item\confbean\SPetBagItem.class
