...
/*     */ 
/*     */ public class SSelectItemBagCfg extends SItemCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  15 */   private static volatile Map<Integer, SSelectItemBagCfg> oldAll = null;
/*     */   
/*  17 */   private static Map<Integer, SSelectItemBagCfg> all = null;
/*     */   
/*  19 */   public java.util.ArrayList<SelectBagItemNum> items = new java.util.ArrayList();
/*     */   
...
/*     */     
/*  37 */     Element collectionElement = util.XmlHelper.getVariableElement(rootElement, "items");
...
/*  48 */       if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SelectBagItemNum"))
/*     */       {
/*     */         SelectBagItemNum _v_;
/*     */         
/*     */ 
/*     */         try
/*     */         {
/*  55 */           _v_ = new SelectBagItemNum();
...
/*  83 */     _os_.compact_uint32(this.items.size());
/*  84 */     for (SelectBagItemNum _v_ : this.items)
/*     */     {
/*  86 */       _os_.marshal(_v_);
/*     */     }
/*  88 */     return _os_;
...
/*     */     {
/*     */ 
/* 109 */       SelectBagItemNum _v_ = new SelectBagItemNum();
/* 110 */       _v_.unmarshal(_os_);
/* 111 */       this.items.add(_v_);
/*     */     }
/* 113 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/* 118 */     String path = dir + "mzm.gsp.item.confbean.SSelectItemBagCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 131 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SSelectItemBagCfg"))
/*     */         {
/*     */ 
/* 134 */           SSelectItemBagCfg obj = new SSelectItemBagCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SSelectItemBagCfg> all)
/*     */   {
/* 148 */     String path = dir + "mzm.gsp.item.confbean.SSelectItemBagCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 160 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SSelectItemBagCfg"))
/*     */         {
/*     */ 
/* 163 */           SSelectItemBagCfg obj = new SSelectItemBagCfg();
...
/*     */     
/* 179 */     String path = dir + "mzm.gsp.item.confbean.SSelectItemBagCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 206 */           SSelectItemBagCfg _v_ = new SSelectItemBagCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SSelectItemBagCfg> all)
/*     */   {
/* 226 */     String path = dir + "mzm.gsp.item.confbean.SSelectItemBagCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 253 */           SSelectItemBagCfg _v_ = new SSelectItemBagCfg();
...
/*     */   {
/* 272 */     for (Map.Entry<Integer, SSelectItemBagCfg> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static void handleData(Map<Integer, SSelectItemBagCfg> all, Map<Integer, SItemCfg> parent)
/*     */   {
/* 287 */     for (Map.Entry<Integer, SSelectItemBagCfg> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static SSelectItemBagCfg getOld(int key)
/*     */   {
/* 302 */     return (SSelectItemBagCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SSelectItemBagCfg get(int key)
/*     */   {
/* 307 */     return (SSelectItemBagCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SSelectItemBagCfg> getOldAllSelf()
/*     */   {
/* 312 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SSelectItemBagCfg> getAllSelf()
/*     */   {
/* 317 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SSelectItemBagCfg> newAll)
/*     */   {
/* 322 */     oldAll = all;
/* 323 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\item\confbean\SSelectItemBagCfg.class
