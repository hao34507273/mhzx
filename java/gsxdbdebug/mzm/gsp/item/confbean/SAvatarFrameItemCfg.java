...
/*     */ 
/*     */ public class SAvatarFrameItemCfg extends SItemCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  15 */   private static volatile Map<Integer, SAvatarFrameItemCfg> oldAll = null;
/*     */   
/*  17 */   private static Map<Integer, SAvatarFrameItemCfg> all = null;
/*     */   
...
/*  37 */     this.avatarFrameId = Integer.valueOf(rootElement.attributeValue("avatarFrameId")).intValue();
/*  38 */     this.duration = Integer.valueOf(rootElement.attributeValue("duration")).intValue();
/*     */   }
/*     */   
...
/*  56 */     _os_.marshal(this.avatarFrameId);
/*  57 */     _os_.marshal(this.duration);
/*  58 */     return _os_;
/*     */   }
/*     */   
...
/*  76 */     this.avatarFrameId = _os_.unmarshal_int();
/*  77 */     this.duration = _os_.unmarshal_int();
/*  78 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  83 */     String path = dir + "mzm.gsp.item.confbean.SAvatarFrameItemCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  96 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SAvatarFrameItemCfg"))
/*     */         {
/*     */ 
/*  99 */           SAvatarFrameItemCfg obj = new SAvatarFrameItemCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SAvatarFrameItemCfg> all)
/*     */   {
/* 113 */     String path = dir + "mzm.gsp.item.confbean.SAvatarFrameItemCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 125 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SAvatarFrameItemCfg"))
/*     */         {
/*     */ 
/* 128 */           SAvatarFrameItemCfg obj = new SAvatarFrameItemCfg();
...
/*     */     
/* 144 */     String path = dir + "mzm.gsp.item.confbean.SAvatarFrameItemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 171 */           SAvatarFrameItemCfg _v_ = new SAvatarFrameItemCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SAvatarFrameItemCfg> all)
/*     */   {
/* 191 */     String path = dir + "mzm.gsp.item.confbean.SAvatarFrameItemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 218 */           SAvatarFrameItemCfg _v_ = new SAvatarFrameItemCfg();
...
/*     */   {
/* 237 */     for (Map.Entry<Integer, SAvatarFrameItemCfg> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static void handleData(Map<Integer, SAvatarFrameItemCfg> all, Map<Integer, SItemCfg> parent)
/*     */   {
/* 252 */     for (Map.Entry<Integer, SAvatarFrameItemCfg> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static SAvatarFrameItemCfg getOld(int key)
/*     */   {
/* 267 */     return (SAvatarFrameItemCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SAvatarFrameItemCfg get(int key)
/*     */   {
/* 272 */     return (SAvatarFrameItemCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SAvatarFrameItemCfg> getOldAllSelf()
/*     */   {
/* 277 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SAvatarFrameItemCfg> getAllSelf()
/*     */   {
/* 282 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SAvatarFrameItemCfg> newAll)
/*     */   {
/* 287 */     oldAll = all;
/* 288 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\item\confbean\SAvatarFrameItemCfg.class
