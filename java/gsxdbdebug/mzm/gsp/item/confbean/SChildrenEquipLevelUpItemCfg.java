...
/*     */ 
/*     */ public class SChildrenEquipLevelUpItemCfg extends SItemCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  15 */   private static volatile Map<Integer, SChildrenEquipLevelUpItemCfg> oldAll = null;
/*     */   
/*  17 */   private static Map<Integer, SChildrenEquipLevelUpItemCfg> all = null;
/*     */   
/*     */   public int exp;
/*     */   
...
/*     */   {
/*  79 */     String path = dir + "mzm.gsp.item.confbean.SChildrenEquipLevelUpItemCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  92 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SChildrenEquipLevelUpItemCfg"))
/*     */         {
/*     */ 
/*  95 */           SChildrenEquipLevelUpItemCfg obj = new SChildrenEquipLevelUpItemCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SChildrenEquipLevelUpItemCfg> all)
/*     */   {
/* 109 */     String path = dir + "mzm.gsp.item.confbean.SChildrenEquipLevelUpItemCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 121 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.item.confbean.SChildrenEquipLevelUpItemCfg"))
/*     */         {
/*     */ 
/* 124 */           SChildrenEquipLevelUpItemCfg obj = new SChildrenEquipLevelUpItemCfg();
...
/*     */     
/* 140 */     String path = dir + "mzm.gsp.item.confbean.SChildrenEquipLevelUpItemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 167 */           SChildrenEquipLevelUpItemCfg _v_ = new SChildrenEquipLevelUpItemCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SChildrenEquipLevelUpItemCfg> all)
/*     */   {
/* 187 */     String path = dir + "mzm.gsp.item.confbean.SChildrenEquipLevelUpItemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 214 */           SChildrenEquipLevelUpItemCfg _v_ = new SChildrenEquipLevelUpItemCfg();
...
/*     */   {
/* 233 */     for (Map.Entry<Integer, SChildrenEquipLevelUpItemCfg> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static void handleData(Map<Integer, SChildrenEquipLevelUpItemCfg> all, Map<Integer, SItemCfg> parent)
/*     */   {
/* 248 */     for (Map.Entry<Integer, SChildrenEquipLevelUpItemCfg> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static SChildrenEquipLevelUpItemCfg getOld(int key)
/*     */   {
/* 263 */     return (SChildrenEquipLevelUpItemCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SChildrenEquipLevelUpItemCfg get(int key)
/*     */   {
/* 268 */     return (SChildrenEquipLevelUpItemCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SChildrenEquipLevelUpItemCfg> getOldAllSelf()
/*     */   {
/* 273 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SChildrenEquipLevelUpItemCfg> getAllSelf()
/*     */   {
/* 278 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SChildrenEquipLevelUpItemCfg> newAll)
/*     */   {
/* 283 */     oldAll = all;
/* 284 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\item\confbean\SChildrenEquipLevelUpItemCfg.class
