...
/*    */ 
/*    */ 
/*    */ public class EquipColorSiftCon
/*    */   extends AbsSiftCondition
/*    */ {
/*    */   private static final int conId = 205;
/* 20 */   protected List<Integer> conditionParams = new ArrayList();
/*    */   
/*    */   protected EquipColorSiftCon(List<Integer> conditionParams) throws Exception
/*    */   {
...
/*    */   {
/* 33 */     if ((obj instanceof EquipColorSiftCon)) {
/* 34 */       EquipColorSiftCon condition = (EquipColorSiftCon)obj;
...
/* 67 */       if (itemEquipCfg.namecolor == ((Integer)this.conditionParams.get(i)).intValue()) {
/* 68 */         return true;
/*    */       }
/*    */     }
/* 71 */     return false;
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\item\main\sift\condition\EquipColorSiftCon.class
