...
/*     */ 
/*     */ public class SAvatarFrameSortTmpCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SAvatarFrameSortTmpCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SAvatarFrameSortTmpCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public int sort;
/*     */   public int display;
...
/*  25 */     this.sort = Integer.valueOf(rootElement.attributeValue("sort")).intValue();
/*  26 */     this.display = Integer.valueOf(rootElement.attributeValue("display")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  31 */     _os_.marshal(this.id);
/*  32 */     _os_.marshal(this.sort);
/*  33 */     _os_.marshal(this.display);
/*  34 */     return _os_;
/*     */   }
/*     */   
...
/*  40 */     this.sort = _os_.unmarshal_int();
/*  41 */     this.display = _os_.unmarshal_int();
/*  42 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  47 */     String path = dir + "mzm.gsp.avatar.confbean.SAvatarFrameSortTmpCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  60 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.avatar.confbean.SAvatarFrameSortTmpCfg"))
/*     */         {
/*     */ 
/*  63 */           SAvatarFrameSortTmpCfg obj = new SAvatarFrameSortTmpCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SAvatarFrameSortTmpCfg> all)
/*     */   {
/*  77 */     String path = dir + "mzm.gsp.avatar.confbean.SAvatarFrameSortTmpCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  89 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.avatar.confbean.SAvatarFrameSortTmpCfg"))
/*     */         {
/*     */ 
/*  92 */           SAvatarFrameSortTmpCfg obj = new SAvatarFrameSortTmpCfg();
...
/*     */     
/* 108 */     String path = dir + "mzm.gsp.avatar.confbean.SAvatarFrameSortTmpCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 135 */           SAvatarFrameSortTmpCfg _v_ = new SAvatarFrameSortTmpCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SAvatarFrameSortTmpCfg> all)
/*     */   {
/* 155 */     String path = dir + "mzm.gsp.avatar.confbean.SAvatarFrameSortTmpCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 182 */           SAvatarFrameSortTmpCfg _v_ = new SAvatarFrameSortTmpCfg();
...
/*     */ 
/*     */ 
/*     */   public static SAvatarFrameSortTmpCfg getOld(int key)
/*     */   {
/* 203 */     return (SAvatarFrameSortTmpCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SAvatarFrameSortTmpCfg get(int key)
/*     */   {
/* 208 */     return (SAvatarFrameSortTmpCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SAvatarFrameSortTmpCfg> getOldAll()
/*     */   {
/* 213 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SAvatarFrameSortTmpCfg> getAll()
/*     */   {
/* 218 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SAvatarFrameSortTmpCfg> newAll)
/*     */   {
/* 223 */     oldAll = all;
/* 224 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\avatar\confbean\SAvatarFrameSortTmpCfg.class
