...
/*     */ 
/*     */ public class SAvatarSortTmpCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SAvatarSortTmpCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SAvatarSortTmpCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public int sort;
/*     */   public int display;
...
/*     */   {
/*  47 */     String path = dir + "mzm.gsp.avatar.confbean.SAvatarSortTmpCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  60 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.avatar.confbean.SAvatarSortTmpCfg"))
/*     */         {
/*     */ 
/*  63 */           SAvatarSortTmpCfg obj = new SAvatarSortTmpCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SAvatarSortTmpCfg> all)
/*     */   {
/*  77 */     String path = dir + "mzm.gsp.avatar.confbean.SAvatarSortTmpCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  89 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.avatar.confbean.SAvatarSortTmpCfg"))
/*     */         {
/*     */ 
/*  92 */           SAvatarSortTmpCfg obj = new SAvatarSortTmpCfg();
...
/*     */     
/* 108 */     String path = dir + "mzm.gsp.avatar.confbean.SAvatarSortTmpCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 135 */           SAvatarSortTmpCfg _v_ = new SAvatarSortTmpCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SAvatarSortTmpCfg> all)
/*     */   {
/* 155 */     String path = dir + "mzm.gsp.avatar.confbean.SAvatarSortTmpCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 182 */           SAvatarSortTmpCfg _v_ = new SAvatarSortTmpCfg();
...
/*     */ 
/*     */ 
/*     */   public static SAvatarSortTmpCfg getOld(int key)
/*     */   {
/* 203 */     return (SAvatarSortTmpCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SAvatarSortTmpCfg get(int key)
/*     */   {
/* 208 */     return (SAvatarSortTmpCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SAvatarSortTmpCfg> getOldAll()
/*     */   {
/* 213 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SAvatarSortTmpCfg> getAll()
/*     */   {
/* 218 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SAvatarSortTmpCfg> newAll)
/*     */   {
/* 223 */     oldAll = all;
/* 224 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\avatar\confbean\SAvatarSortTmpCfg.class
