...
/*     */ 
/*     */ public class SAvatarFrameCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SAvatarFrameCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SAvatarFrameCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public String name;
...
/*     */   {
/*  94 */     String path = dir + "mzm.gsp.avatar.confbean.SAvatarFrameCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 107 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.avatar.confbean.SAvatarFrameCfg"))
/*     */         {
/*     */ 
/* 110 */           SAvatarFrameCfg obj = new SAvatarFrameCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SAvatarFrameCfg> all)
/*     */   {
/* 124 */     String path = dir + "mzm.gsp.avatar.confbean.SAvatarFrameCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 136 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.avatar.confbean.SAvatarFrameCfg"))
/*     */         {
/*     */ 
/* 139 */           SAvatarFrameCfg obj = new SAvatarFrameCfg();
...
/*     */     
/* 155 */     String path = dir + "mzm.gsp.avatar.confbean.SAvatarFrameCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 182 */           SAvatarFrameCfg _v_ = new SAvatarFrameCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SAvatarFrameCfg> all)
/*     */   {
/* 202 */     String path = dir + "mzm.gsp.avatar.confbean.SAvatarFrameCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 229 */           SAvatarFrameCfg _v_ = new SAvatarFrameCfg();
...
/*     */ 
/*     */ 
/*     */   public static SAvatarFrameCfg getOld(int key)
/*     */   {
/* 250 */     return (SAvatarFrameCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SAvatarFrameCfg get(int key)
/*     */   {
/* 255 */     return (SAvatarFrameCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SAvatarFrameCfg> getOldAll()
/*     */   {
/* 260 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SAvatarFrameCfg> getAll()
/*     */   {
/* 265 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SAvatarFrameCfg> newAll)
/*     */   {
/* 270 */     oldAll = all;
/* 271 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\avatar\confbean\SAvatarFrameCfg.class
