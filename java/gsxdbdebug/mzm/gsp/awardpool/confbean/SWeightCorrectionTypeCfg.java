...
/*     */ 
/*     */ public class SWeightCorrectionTypeCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SWeightCorrectionTypeCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SWeightCorrectionTypeCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public String templatename;
/*     */   public int weightCorrectionClearType;
/*     */   public int weightCorrectionClearWeeklyDay;
/*     */   public int weightCorrectionClearMonthlyDay;
/*     */   
...
/*  28 */     this.weightCorrectionClearType = Integer.valueOf(rootElement.attributeValue("weightCorrectionClearType")).intValue();
/*  29 */     this.weightCorrectionClearWeeklyDay = Integer.valueOf(rootElement.attributeValue("weightCorrectionClearWeeklyDay")).intValue();
/*  30 */     this.weightCorrectionClearMonthlyDay = Integer.valueOf(rootElement.attributeValue("weightCorrectionClearMonthlyDay")).intValue();
/*     */   }
/*     */   
...
/*  37 */     _os_.marshal(this.weightCorrectionClearType);
/*  38 */     _os_.marshal(this.weightCorrectionClearWeeklyDay);
/*  39 */     _os_.marshal(this.weightCorrectionClearMonthlyDay);
/*  40 */     return _os_;
/*     */   }
/*     */   
...
/*  47 */     this.weightCorrectionClearType = _os_.unmarshal_int();
/*  48 */     this.weightCorrectionClearWeeklyDay = _os_.unmarshal_int();
/*  49 */     this.weightCorrectionClearMonthlyDay = _os_.unmarshal_int();
/*  50 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  55 */     String path = dir + "mzm.gsp.awardpool.confbean.SWeightCorrectionTypeCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  68 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.awardpool.confbean.SWeightCorrectionTypeCfg"))
/*     */         {
/*     */ 
/*  71 */           SWeightCorrectionTypeCfg obj = new SWeightCorrectionTypeCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SWeightCorrectionTypeCfg> all)
/*     */   {
/*  85 */     String path = dir + "mzm.gsp.awardpool.confbean.SWeightCorrectionTypeCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  97 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.awardpool.confbean.SWeightCorrectionTypeCfg"))
/*     */         {
/*     */ 
/* 100 */           SWeightCorrectionTypeCfg obj = new SWeightCorrectionTypeCfg();
...
/*     */     
/* 116 */     String path = dir + "mzm.gsp.awardpool.confbean.SWeightCorrectionTypeCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 143 */           SWeightCorrectionTypeCfg _v_ = new SWeightCorrectionTypeCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SWeightCorrectionTypeCfg> all)
/*     */   {
/* 163 */     String path = dir + "mzm.gsp.awardpool.confbean.SWeightCorrectionTypeCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 190 */           SWeightCorrectionTypeCfg _v_ = new SWeightCorrectionTypeCfg();
...
/*     */ 
/*     */ 
/*     */   public static SWeightCorrectionTypeCfg getOld(int key)
/*     */   {
/* 211 */     return (SWeightCorrectionTypeCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SWeightCorrectionTypeCfg get(int key)
/*     */   {
/* 216 */     return (SWeightCorrectionTypeCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SWeightCorrectionTypeCfg> getOldAll()
/*     */   {
/* 221 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SWeightCorrectionTypeCfg> getAll()
/*     */   {
/* 226 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SWeightCorrectionTypeCfg> newAll)
/*     */   {
/* 231 */     oldAll = all;
/* 232 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\awardpool\confbean\SWeightCorrectionTypeCfg.class
