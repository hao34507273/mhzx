...
/*     */ 
/*     */ public class FlopLotteryAwardPoolCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, FlopLotteryAwardPoolCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, FlopLotteryAwardPoolCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public int typeId;
...
/*  29 */     this.awardPoolSumId = Integer.valueOf(rootElement.attributeValue("awardPoolSumId")).intValue();
...
/*  32 */     this.moneyCount = Integer.valueOf(rootElement.attributeValue("moneyCount")).intValue();
/*     */   }
/*     */   
...
/*  39 */     _os_.marshal(this.awardPoolSumId);
/*  40 */     _os_.marshal(this.index);
/*  41 */     _os_.marshal(this.moneyType);
/*  42 */     _os_.marshal(this.moneyCount);
/*  43 */     return _os_;
/*     */   }
/*     */   
...
/*  50 */     this.awardPoolSumId = _os_.unmarshal_int();
/*  51 */     this.index = _os_.unmarshal_int();
/*  52 */     this.moneyType = _os_.unmarshal_int();
/*  53 */     this.moneyCount = _os_.unmarshal_int();
/*  54 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  59 */     String path = dir + "mzm.gsp.awardpool.confbean.FlopLotteryAwardPoolCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  72 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.awardpool.confbean.FlopLotteryAwardPoolCfg"))
/*     */         {
/*     */ 
/*  75 */           FlopLotteryAwardPoolCfg obj = new FlopLotteryAwardPoolCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, FlopLotteryAwardPoolCfg> all)
/*     */   {
/*  89 */     String path = dir + "mzm.gsp.awardpool.confbean.FlopLotteryAwardPoolCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 101 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.awardpool.confbean.FlopLotteryAwardPoolCfg"))
/*     */         {
/*     */ 
/* 104 */           FlopLotteryAwardPoolCfg obj = new FlopLotteryAwardPoolCfg();
...
/*     */     
/* 120 */     String path = dir + "mzm.gsp.awardpool.confbean.FlopLotteryAwardPoolCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 147 */           FlopLotteryAwardPoolCfg _v_ = new FlopLotteryAwardPoolCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, FlopLotteryAwardPoolCfg> all)
/*     */   {
/* 167 */     String path = dir + "mzm.gsp.awardpool.confbean.FlopLotteryAwardPoolCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 194 */           FlopLotteryAwardPoolCfg _v_ = new FlopLotteryAwardPoolCfg();
...
/*     */ 
/*     */ 
/*     */   public static FlopLotteryAwardPoolCfg getOld(int key)
/*     */   {
/* 215 */     return (FlopLotteryAwardPoolCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static FlopLotteryAwardPoolCfg get(int key)
/*     */   {
/* 220 */     return (FlopLotteryAwardPoolCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, FlopLotteryAwardPoolCfg> getOldAll()
/*     */   {
/* 225 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, FlopLotteryAwardPoolCfg> getAll()
/*     */   {
/* 230 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, FlopLotteryAwardPoolCfg> newAll)
/*     */   {
/* 235 */     oldAll = all;
/* 236 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\awardpool\confbean\FlopLotteryAwardPoolCfg.class
