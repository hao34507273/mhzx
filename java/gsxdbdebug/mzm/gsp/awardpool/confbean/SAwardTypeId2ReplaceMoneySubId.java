...
/*     */ 
/*     */ public class SAwardTypeId2ReplaceMoneySubId implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SAwardTypeId2ReplaceMoneySubId> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SAwardTypeId2ReplaceMoneySubId> all = null;
/*     */   
/*     */   public int awardTypeId;
/*  19 */   public java.util.ArrayList<Integer> replaceMoneySubIds = new java.util.ArrayList();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.awardTypeId = Integer.valueOf(rootElement.attributeValue("awardTypeId")).intValue();
/*     */     
/*  25 */     Element collectionElement = util.XmlHelper.getVariableElement(rootElement, "replaceMoneySubIds");
...
/*     */         }
/*     */         
/*  50 */         this.replaceMoneySubIds.add(Integer.valueOf(_v_));
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*  58 */     _os_.compact_uint32(this.replaceMoneySubIds.size());
/*  59 */     for (Integer _v_ : this.replaceMoneySubIds)
/*     */     {
...
/*  73 */       this.replaceMoneySubIds.add(Integer.valueOf(_v_));
/*     */     }
/*  75 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/*  80 */     String path = dir + "mzm.gsp.awardpool.confbean.SAwardTypeId2ReplaceMoneySubId.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.awardpool.confbean.SAwardTypeId2ReplaceMoneySubId"))
/*     */         {
/*     */ 
/*  96 */           SAwardTypeId2ReplaceMoneySubId obj = new SAwardTypeId2ReplaceMoneySubId();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SAwardTypeId2ReplaceMoneySubId> all)
/*     */   {
/* 110 */     String path = dir + "mzm.gsp.awardpool.confbean.SAwardTypeId2ReplaceMoneySubId.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 122 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.awardpool.confbean.SAwardTypeId2ReplaceMoneySubId"))
/*     */         {
/*     */ 
/* 125 */           SAwardTypeId2ReplaceMoneySubId obj = new SAwardTypeId2ReplaceMoneySubId();
...
/*     */     
/* 141 */     String path = dir + "mzm.gsp.awardpool.confbean.SAwardTypeId2ReplaceMoneySubId.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 168 */           SAwardTypeId2ReplaceMoneySubId _v_ = new SAwardTypeId2ReplaceMoneySubId();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SAwardTypeId2ReplaceMoneySubId> all)
/*     */   {
/* 188 */     String path = dir + "mzm.gsp.awardpool.confbean.SAwardTypeId2ReplaceMoneySubId.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 215 */           SAwardTypeId2ReplaceMoneySubId _v_ = new SAwardTypeId2ReplaceMoneySubId();
...
/*     */ 
/*     */ 
/*     */   public static SAwardTypeId2ReplaceMoneySubId getOld(int key)
/*     */   {
/* 236 */     return (SAwardTypeId2ReplaceMoneySubId)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SAwardTypeId2ReplaceMoneySubId get(int key)
/*     */   {
/* 241 */     return (SAwardTypeId2ReplaceMoneySubId)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SAwardTypeId2ReplaceMoneySubId> getOldAll()
/*     */   {
/* 246 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SAwardTypeId2ReplaceMoneySubId> getAll()
/*     */   {
/* 251 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SAwardTypeId2ReplaceMoneySubId> newAll)
/*     */   {
/* 256 */     oldAll = all;
/* 257 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\awardpool\confbean\SAwardTypeId2ReplaceMoneySubId.class
