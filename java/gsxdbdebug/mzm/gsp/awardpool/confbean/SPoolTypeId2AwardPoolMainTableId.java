...
/*     */ 
/*     */ public class SPoolTypeId2AwardPoolMainTableId implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SPoolTypeId2AwardPoolMainTableId> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SPoolTypeId2AwardPoolMainTableId> all = null;
/*     */   
/*     */   public int poolTypeId;
/*  19 */   public java.util.ArrayList<Integer> mainTableIds = new java.util.ArrayList();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.poolTypeId = Integer.valueOf(rootElement.attributeValue("poolTypeId")).intValue();
/*     */     
/*  25 */     Element collectionElement = util.XmlHelper.getVariableElement(rootElement, "mainTableIds");
...
/*     */         }
/*     */         
/*  50 */         this.mainTableIds.add(Integer.valueOf(_v_));
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*     */   {
/*  57 */     _os_.marshal(this.poolTypeId);
/*  58 */     _os_.compact_uint32(this.mainTableIds.size());
/*  59 */     for (Integer _v_ : this.mainTableIds)
/*     */     {
...
/*     */   {
/*  80 */     String path = dir + "mzm.gsp.awardpool.confbean.SPoolTypeId2AwardPoolMainTableId.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.awardpool.confbean.SPoolTypeId2AwardPoolMainTableId"))
/*     */         {
/*     */ 
/*  96 */           SPoolTypeId2AwardPoolMainTableId obj = new SPoolTypeId2AwardPoolMainTableId();
/*  97 */           obj.loadFromXml(elem);
/*  98 */           if (all.put(Integer.valueOf(obj.poolTypeId), obj) != null) {
/*  99 */             throw new RuntimeException("duplicate key : " + obj.poolTypeId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SPoolTypeId2AwardPoolMainTableId> all)
/*     */   {
/* 110 */     String path = dir + "mzm.gsp.awardpool.confbean.SPoolTypeId2AwardPoolMainTableId.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 122 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.awardpool.confbean.SPoolTypeId2AwardPoolMainTableId"))
/*     */         {
/*     */ 
/* 125 */           SPoolTypeId2AwardPoolMainTableId obj = new SPoolTypeId2AwardPoolMainTableId();
/* 126 */           obj.loadFromXml(elem);
/* 127 */           if (all.put(Integer.valueOf(obj.poolTypeId), obj) != null) {
/* 128 */             throw new RuntimeException("duplicate key : " + obj.poolTypeId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 141 */     String path = dir + "mzm.gsp.awardpool.confbean.SPoolTypeId2AwardPoolMainTableId.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 168 */           SPoolTypeId2AwardPoolMainTableId _v_ = new SPoolTypeId2AwardPoolMainTableId();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SPoolTypeId2AwardPoolMainTableId> all)
/*     */   {
/* 188 */     String path = dir + "mzm.gsp.awardpool.confbean.SPoolTypeId2AwardPoolMainTableId.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 215 */           SPoolTypeId2AwardPoolMainTableId _v_ = new SPoolTypeId2AwardPoolMainTableId();
...
/*     */ 
/*     */ 
/*     */   public static SPoolTypeId2AwardPoolMainTableId getOld(int key)
/*     */   {
/* 236 */     return (SPoolTypeId2AwardPoolMainTableId)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SPoolTypeId2AwardPoolMainTableId get(int key)
/*     */   {
/* 241 */     return (SPoolTypeId2AwardPoolMainTableId)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPoolTypeId2AwardPoolMainTableId> getOldAll()
/*     */   {
/* 246 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPoolTypeId2AwardPoolMainTableId> getAll()
/*     */   {
/* 251 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SPoolTypeId2AwardPoolMainTableId> newAll)
/*     */   {
/* 256 */     oldAll = all;
/* 257 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\awardpool\confbean\SPoolTypeId2AwardPoolMainTableId.class
