...
/*     */ 
/*     */ public class SItemPoolSub implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SItemPoolSub> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SItemPoolSub> all = null;
/*     */   
/*     */   public int id;
...
/*  35 */     this.preciousCfgId = Integer.valueOf(rootElement.attributeValue("preciousCfgId")).intValue();
/*  36 */     this.weightCorrectionCfgId = Integer.valueOf(rootElement.attributeValue("weightCorrectionCfgId")).intValue();
/*     */   }
/*     */   
...
/*  45 */     _os_.marshal(this.awardTypeId);
/*  46 */     _os_.marshal(this.weight);
/*  47 */     _os_.marshal(this.preciousCfgId);
/*  48 */     _os_.marshal(this.weightCorrectionCfgId);
/*  49 */     return _os_;
/*     */   }
/*     */   
...
/*  58 */     this.awardTypeId = _os_.unmarshal_int();
/*  59 */     this.weight = _os_.unmarshal_int();
/*  60 */     this.preciousCfgId = _os_.unmarshal_int();
/*  61 */     this.weightCorrectionCfgId = _os_.unmarshal_int();
/*  62 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  67 */     String path = dir + "mzm.gsp.awardpool.confbean.SItemPoolSub.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  80 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.awardpool.confbean.SItemPoolSub"))
/*     */         {
/*     */ 
/*  83 */           SItemPoolSub obj = new SItemPoolSub();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SItemPoolSub> all)
/*     */   {
/*  97 */     String path = dir + "mzm.gsp.awardpool.confbean.SItemPoolSub.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 109 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.awardpool.confbean.SItemPoolSub"))
/*     */         {
/*     */ 
/* 112 */           SItemPoolSub obj = new SItemPoolSub();
...
/*     */     
/* 128 */     String path = dir + "mzm.gsp.awardpool.confbean.SItemPoolSub.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 155 */           SItemPoolSub _v_ = new SItemPoolSub();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SItemPoolSub> all)
/*     */   {
/* 175 */     String path = dir + "mzm.gsp.awardpool.confbean.SItemPoolSub.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 202 */           SItemPoolSub _v_ = new SItemPoolSub();
...
/*     */ 
/*     */ 
/*     */   public static SItemPoolSub getOld(int key)
/*     */   {
/* 223 */     return (SItemPoolSub)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SItemPoolSub get(int key)
/*     */   {
/* 228 */     return (SItemPoolSub)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SItemPoolSub> getOldAll()
/*     */   {
/* 233 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SItemPoolSub> getAll()
/*     */   {
/* 238 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SItemPoolSub> newAll)
/*     */   {
/* 243 */     oldAll = all;
/* 244 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\awardpool\confbean\SItemPoolSub.class
