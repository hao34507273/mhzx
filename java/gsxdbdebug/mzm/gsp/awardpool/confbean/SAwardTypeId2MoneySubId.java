...
/*     */ 
/*     */ public class SAwardTypeId2MoneySubId implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SAwardTypeId2MoneySubId> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SAwardTypeId2MoneySubId> all = null;
/*     */   
/*     */   public int awardTypeId;
/*  19 */   public java.util.ArrayList<Integer> moneySubIds = new java.util.ArrayList();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.awardTypeId = Integer.valueOf(rootElement.attributeValue("awardTypeId")).intValue();
/*     */     
/*  25 */     Element collectionElement = util.XmlHelper.getVariableElement(rootElement, "moneySubIds");
...
/*     */         }
/*     */         
/*  50 */         this.moneySubIds.add(Integer.valueOf(_v_));
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*  58 */     _os_.compact_uint32(this.moneySubIds.size());
/*  59 */     for (Integer _v_ : this.moneySubIds)
/*     */     {
...
/*  73 */       this.moneySubIds.add(Integer.valueOf(_v_));
/*     */     }
/*  75 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/*  80 */     String path = dir + "mzm.gsp.awardpool.confbean.SAwardTypeId2MoneySubId.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.awardpool.confbean.SAwardTypeId2MoneySubId"))
/*     */         {
/*     */ 
/*  96 */           SAwardTypeId2MoneySubId obj = new SAwardTypeId2MoneySubId();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SAwardTypeId2MoneySubId> all)
/*     */   {
/* 110 */     String path = dir + "mzm.gsp.awardpool.confbean.SAwardTypeId2MoneySubId.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 122 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.awardpool.confbean.SAwardTypeId2MoneySubId"))
/*     */         {
/*     */ 
/* 125 */           SAwardTypeId2MoneySubId obj = new SAwardTypeId2MoneySubId();
...
/*     */     
/* 141 */     String path = dir + "mzm.gsp.awardpool.confbean.SAwardTypeId2MoneySubId.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 168 */           SAwardTypeId2MoneySubId _v_ = new SAwardTypeId2MoneySubId();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SAwardTypeId2MoneySubId> all)
/*     */   {
/* 188 */     String path = dir + "mzm.gsp.awardpool.confbean.SAwardTypeId2MoneySubId.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 215 */           SAwardTypeId2MoneySubId _v_ = new SAwardTypeId2MoneySubId();
...
/*     */ 
/*     */ 
/*     */   public static SAwardTypeId2MoneySubId getOld(int key)
/*     */   {
/* 236 */     return (SAwardTypeId2MoneySubId)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SAwardTypeId2MoneySubId get(int key)
/*     */   {
/* 241 */     return (SAwardTypeId2MoneySubId)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SAwardTypeId2MoneySubId> getOldAll()
/*     */   {
/* 246 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SAwardTypeId2MoneySubId> getAll()
/*     */   {
/* 251 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SAwardTypeId2MoneySubId> newAll)
/*     */   {
/* 256 */     oldAll = all;
/* 257 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\awardpool\confbean\SAwardTypeId2MoneySubId.class
