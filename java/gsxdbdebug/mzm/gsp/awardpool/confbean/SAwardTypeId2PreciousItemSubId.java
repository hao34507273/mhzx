...
/*     */ 
/*     */ public class SAwardTypeId2PreciousItemSubId implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SAwardTypeId2PreciousItemSubId> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SAwardTypeId2PreciousItemSubId> all = null;
/*     */   
/*     */   public int awardTypeId;
/*  19 */   public java.util.ArrayList<Integer> itemSubIds = new java.util.ArrayList();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.awardTypeId = Integer.valueOf(rootElement.attributeValue("awardTypeId")).intValue();
/*     */     
/*  25 */     Element collectionElement = util.XmlHelper.getVariableElement(rootElement, "itemSubIds");
...
/*     */         }
/*     */         
/*  50 */         this.itemSubIds.add(Integer.valueOf(_v_));
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*  58 */     _os_.compact_uint32(this.itemSubIds.size());
/*  59 */     for (Integer _v_ : this.itemSubIds)
/*     */     {
...
/*  73 */       this.itemSubIds.add(Integer.valueOf(_v_));
/*     */     }
/*  75 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/*  80 */     String path = dir + "mzm.gsp.awardpool.confbean.SAwardTypeId2PreciousItemSubId.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.awardpool.confbean.SAwardTypeId2PreciousItemSubId"))
/*     */         {
/*     */ 
/*  96 */           SAwardTypeId2PreciousItemSubId obj = new SAwardTypeId2PreciousItemSubId();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SAwardTypeId2PreciousItemSubId> all)
/*     */   {
/* 110 */     String path = dir + "mzm.gsp.awardpool.confbean.SAwardTypeId2PreciousItemSubId.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 122 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.awardpool.confbean.SAwardTypeId2PreciousItemSubId"))
/*     */         {
/*     */ 
/* 125 */           SAwardTypeId2PreciousItemSubId obj = new SAwardTypeId2PreciousItemSubId();
...
/*     */     
/* 141 */     String path = dir + "mzm.gsp.awardpool.confbean.SAwardTypeId2PreciousItemSubId.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 168 */           SAwardTypeId2PreciousItemSubId _v_ = new SAwardTypeId2PreciousItemSubId();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SAwardTypeId2PreciousItemSubId> all)
/*     */   {
/* 188 */     String path = dir + "mzm.gsp.awardpool.confbean.SAwardTypeId2PreciousItemSubId.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 215 */           SAwardTypeId2PreciousItemSubId _v_ = new SAwardTypeId2PreciousItemSubId();
...
/*     */ 
/*     */ 
/*     */   public static SAwardTypeId2PreciousItemSubId getOld(int key)
/*     */   {
/* 236 */     return (SAwardTypeId2PreciousItemSubId)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SAwardTypeId2PreciousItemSubId get(int key)
/*     */   {
/* 241 */     return (SAwardTypeId2PreciousItemSubId)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SAwardTypeId2PreciousItemSubId> getOldAll()
/*     */   {
/* 246 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SAwardTypeId2PreciousItemSubId> getAll()
/*     */   {
/* 251 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SAwardTypeId2PreciousItemSubId> newAll)
/*     */   {
/* 256 */     oldAll = all;
/* 257 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\awardpool\confbean\SAwardTypeId2PreciousItemSubId.class
