...
/*     */ 
/*     */ public class SControllerPoolSub implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SControllerPoolSub> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SControllerPoolSub> all = null;
/*     */   
/*     */   public int id;
/*     */   public String templatename;
/*     */   public int controllerIconId;
...
/*  29 */     this.controllerIconId = Integer.valueOf(rootElement.attributeValue("controllerIconId")).intValue();
/*  30 */     this.controllerId = Integer.valueOf(rootElement.attributeValue("controllerId")).intValue();
/*  31 */     this.awardTypeId = Integer.valueOf(rootElement.attributeValue("awardTypeId")).intValue();
...
/*  39 */     _os_.marshal(this.controllerIconId);
/*  40 */     _os_.marshal(this.controllerId);
/*  41 */     _os_.marshal(this.awardTypeId);
...
/*  50 */     this.controllerIconId = _os_.unmarshal_int();
/*  51 */     this.controllerId = _os_.unmarshal_int();
/*  52 */     this.awardTypeId = _os_.unmarshal_int();
...
/*     */   {
/*  59 */     String path = dir + "mzm.gsp.awardpool.confbean.SControllerPoolSub.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  72 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.awardpool.confbean.SControllerPoolSub"))
/*     */         {
/*     */ 
/*  75 */           SControllerPoolSub obj = new SControllerPoolSub();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SControllerPoolSub> all)
/*     */   {
/*  89 */     String path = dir + "mzm.gsp.awardpool.confbean.SControllerPoolSub.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 101 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.awardpool.confbean.SControllerPoolSub"))
/*     */         {
/*     */ 
/* 104 */           SControllerPoolSub obj = new SControllerPoolSub();
...
/*     */     
/* 120 */     String path = dir + "mzm.gsp.awardpool.confbean.SControllerPoolSub.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 147 */           SControllerPoolSub _v_ = new SControllerPoolSub();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SControllerPoolSub> all)
/*     */   {
/* 167 */     String path = dir + "mzm.gsp.awardpool.confbean.SControllerPoolSub.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 194 */           SControllerPoolSub _v_ = new SControllerPoolSub();
...
/*     */ 
/*     */ 
/*     */   public static SControllerPoolSub getOld(int key)
/*     */   {
/* 215 */     return (SControllerPoolSub)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SControllerPoolSub get(int key)
/*     */   {
/* 220 */     return (SControllerPoolSub)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SControllerPoolSub> getOldAll()
/*     */   {
/* 225 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SControllerPoolSub> getAll()
/*     */   {
/* 230 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SControllerPoolSub> newAll)
/*     */   {
/* 235 */     oldAll = all;
/* 236 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\awardpool\confbean\SControllerPoolSub.class
