...
/*     */ 
/*     */ public class TFlopLotteryAwardPoolCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, TFlopLotteryAwardPoolCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, TFlopLotteryAwardPoolCfg> all = null;
/*     */   
/*     */   public int typeId;
/*  19 */   public java.util.ArrayList<FlopLotteryAwardPool> flopLotteryAwardPools = new java.util.ArrayList();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.typeId = Integer.valueOf(rootElement.attributeValue("typeId")).intValue();
/*     */     
/*  25 */     Element collectionElement = util.XmlHelper.getVariableElement(rootElement, "flopLotteryAwardPools");
...
/*  36 */       if (elem.getName().equalsIgnoreCase("mzm.gsp.awardpool.confbean.FlopLotteryAwardPool"))
/*     */       {
/*     */         FlopLotteryAwardPool _v_;
/*     */         
/*     */ 
/*     */         try
/*     */         {
/*  43 */           _v_ = new FlopLotteryAwardPool();
...
/*     */         }
/*     */         
/*  51 */         this.flopLotteryAwardPools.add(_v_);
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*  59 */     _os_.compact_uint32(this.flopLotteryAwardPools.size());
/*  60 */     for (FlopLotteryAwardPool _v_ : this.flopLotteryAwardPools)
/*     */     {
/*  62 */       _os_.marshal(_v_);
/*     */     }
/*  64 */     return _os_;
...
/*     */     {
/*     */ 
/*  73 */       FlopLotteryAwardPool _v_ = new FlopLotteryAwardPool();
/*  74 */       _v_.unmarshal(_os_);
/*  75 */       this.flopLotteryAwardPools.add(_v_);
/*     */     }
/*  77 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/*  82 */     String path = dir + "mzm.gsp.awardpool.confbean.TFlopLotteryAwardPoolCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  95 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.awardpool.confbean.TFlopLotteryAwardPoolCfg"))
/*     */         {
/*     */ 
/*  98 */           TFlopLotteryAwardPoolCfg obj = new TFlopLotteryAwardPoolCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, TFlopLotteryAwardPoolCfg> all)
/*     */   {
/* 112 */     String path = dir + "mzm.gsp.awardpool.confbean.TFlopLotteryAwardPoolCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 124 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.awardpool.confbean.TFlopLotteryAwardPoolCfg"))
/*     */         {
/*     */ 
/* 127 */           TFlopLotteryAwardPoolCfg obj = new TFlopLotteryAwardPoolCfg();
...
/*     */     
/* 143 */     String path = dir + "mzm.gsp.awardpool.confbean.TFlopLotteryAwardPoolCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 170 */           TFlopLotteryAwardPoolCfg _v_ = new TFlopLotteryAwardPoolCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, TFlopLotteryAwardPoolCfg> all)
/*     */   {
/* 190 */     String path = dir + "mzm.gsp.awardpool.confbean.TFlopLotteryAwardPoolCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 217 */           TFlopLotteryAwardPoolCfg _v_ = new TFlopLotteryAwardPoolCfg();
...
/*     */ 
/*     */ 
/*     */   public static TFlopLotteryAwardPoolCfg getOld(int key)
/*     */   {
/* 238 */     return (TFlopLotteryAwardPoolCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static TFlopLotteryAwardPoolCfg get(int key)
/*     */   {
/* 243 */     return (TFlopLotteryAwardPoolCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, TFlopLotteryAwardPoolCfg> getOldAll()
/*     */   {
/* 248 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, TFlopLotteryAwardPoolCfg> getAll()
/*     */   {
/* 253 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, TFlopLotteryAwardPoolCfg> newAll)
/*     */   {
/* 258 */     oldAll = all;
/* 259 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\awardpool\confbean\TFlopLotteryAwardPoolCfg.class
