...
/*     */ 
/*     */ public class SAwardTypeId2ExpSubId implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SAwardTypeId2ExpSubId> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SAwardTypeId2ExpSubId> all = null;
/*     */   
/*     */   public int awardTypeId;
/*  19 */   public java.util.ArrayList<Integer> expSubIds = new java.util.ArrayList();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.awardTypeId = Integer.valueOf(rootElement.attributeValue("awardTypeId")).intValue();
/*     */     
/*  25 */     Element collectionElement = util.XmlHelper.getVariableElement(rootElement, "expSubIds");
...
/*     */         }
/*     */         
/*  50 */         this.expSubIds.add(Integer.valueOf(_v_));
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*  58 */     _os_.compact_uint32(this.expSubIds.size());
/*  59 */     for (Integer _v_ : this.expSubIds)
/*     */     {
...
/*  73 */       this.expSubIds.add(Integer.valueOf(_v_));
/*     */     }
/*  75 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/*  80 */     String path = dir + "mzm.gsp.awardpool.confbean.SAwardTypeId2ExpSubId.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.awardpool.confbean.SAwardTypeId2ExpSubId"))
/*     */         {
/*     */ 
/*  96 */           SAwardTypeId2ExpSubId obj = new SAwardTypeId2ExpSubId();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SAwardTypeId2ExpSubId> all)
/*     */   {
/* 110 */     String path = dir + "mzm.gsp.awardpool.confbean.SAwardTypeId2ExpSubId.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 122 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.awardpool.confbean.SAwardTypeId2ExpSubId"))
/*     */         {
/*     */ 
/* 125 */           SAwardTypeId2ExpSubId obj = new SAwardTypeId2ExpSubId();
...
/*     */     
/* 141 */     String path = dir + "mzm.gsp.awardpool.confbean.SAwardTypeId2ExpSubId.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 168 */           SAwardTypeId2ExpSubId _v_ = new SAwardTypeId2ExpSubId();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SAwardTypeId2ExpSubId> all)
/*     */   {
/* 188 */     String path = dir + "mzm.gsp.awardpool.confbean.SAwardTypeId2ExpSubId.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 215 */           SAwardTypeId2ExpSubId _v_ = new SAwardTypeId2ExpSubId();
...
/*     */ 
/*     */ 
/*     */   public static SAwardTypeId2ExpSubId getOld(int key)
/*     */   {
/* 236 */     return (SAwardTypeId2ExpSubId)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SAwardTypeId2ExpSubId get(int key)
/*     */   {
/* 241 */     return (SAwardTypeId2ExpSubId)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SAwardTypeId2ExpSubId> getOldAll()
/*     */   {
/* 246 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SAwardTypeId2ExpSubId> getAll()
/*     */   {
/* 251 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SAwardTypeId2ExpSubId> newAll)
/*     */   {
/* 256 */     oldAll = all;
/* 257 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\awardpool\confbean\SAwardTypeId2ExpSubId.class
