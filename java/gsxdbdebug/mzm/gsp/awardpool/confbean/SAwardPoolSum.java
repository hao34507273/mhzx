...
/*     */ 
/*     */ public class SAwardPoolSum implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SAwardPoolSum> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SAwardPoolSum> all = null;
/*     */   
/*     */   public int id;
...
/*  28 */     this.awardTypeId = Integer.valueOf(rootElement.attributeValue("awardTypeId")).intValue();
/*  29 */     this.isFilterRepeat = Boolean.valueOf(rootElement.attributeValue("isFilterRepeat")).booleanValue();
/*  30 */     this.initNum = Integer.valueOf(rootElement.attributeValue("initNum")).intValue();
/*  31 */     this.resultNum = Integer.valueOf(rootElement.attributeValue("resultNum")).intValue();
/*  32 */     this.weightCorrectionTypeCfgId = Integer.valueOf(rootElement.attributeValue("weightCorrectionTypeCfgId")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  37 */     _os_.marshal(this.id);
/*  38 */     _os_.marshal(this.awardTypeId);
/*  39 */     _os_.marshal(this.isFilterRepeat);
/*  40 */     _os_.marshal(this.initNum);
/*  41 */     _os_.marshal(this.resultNum);
/*  42 */     _os_.marshal(this.weightCorrectionTypeCfgId);
/*  43 */     return _os_;
/*     */   }
/*     */   
...
/*  49 */     this.awardTypeId = _os_.unmarshal_int();
/*  50 */     this.isFilterRepeat = _os_.unmarshal_boolean();
/*  51 */     this.initNum = _os_.unmarshal_int();
/*  52 */     this.resultNum = _os_.unmarshal_int();
/*  53 */     this.weightCorrectionTypeCfgId = _os_.unmarshal_int();
/*  54 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  59 */     String path = dir + "mzm.gsp.awardpool.confbean.SAwardPoolSum.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  72 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.awardpool.confbean.SAwardPoolSum"))
/*     */         {
/*     */ 
/*  75 */           SAwardPoolSum obj = new SAwardPoolSum();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SAwardPoolSum> all)
/*     */   {
/*  89 */     String path = dir + "mzm.gsp.awardpool.confbean.SAwardPoolSum.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 101 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.awardpool.confbean.SAwardPoolSum"))
/*     */         {
/*     */ 
/* 104 */           SAwardPoolSum obj = new SAwardPoolSum();
...
/*     */     
/* 120 */     String path = dir + "mzm.gsp.awardpool.confbean.SAwardPoolSum.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 147 */           SAwardPoolSum _v_ = new SAwardPoolSum();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SAwardPoolSum> all)
/*     */   {
/* 167 */     String path = dir + "mzm.gsp.awardpool.confbean.SAwardPoolSum.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 194 */           SAwardPoolSum _v_ = new SAwardPoolSum();
...
/*     */ 
/*     */ 
/*     */   public static SAwardPoolSum getOld(int key)
/*     */   {
/* 215 */     return (SAwardPoolSum)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SAwardPoolSum get(int key)
/*     */   {
/* 220 */     return (SAwardPoolSum)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SAwardPoolSum> getOldAll()
/*     */   {
/* 225 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SAwardPoolSum> getAll()
/*     */   {
/* 230 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SAwardPoolSum> newAll)
/*     */   {
/* 235 */     oldAll = all;
/* 236 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\awardpool\confbean\SAwardPoolSum.class
