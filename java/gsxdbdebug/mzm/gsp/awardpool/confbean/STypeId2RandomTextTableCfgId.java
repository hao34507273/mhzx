...
/*     */ 
/*     */ public class STypeId2RandomTextTableCfgId implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, STypeId2RandomTextTableCfgId> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, STypeId2RandomTextTableCfgId> all = null;
/*     */   
/*     */   public int typeId;
/*  19 */   public java.util.ArrayList<Integer> randomTextTableCfgIds = new java.util.ArrayList();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.typeId = Integer.valueOf(rootElement.attributeValue("typeId")).intValue();
/*     */     
/*  25 */     Element collectionElement = util.XmlHelper.getVariableElement(rootElement, "randomTextTableCfgIds");
...
/*     */         }
/*     */         
/*  50 */         this.randomTextTableCfgIds.add(Integer.valueOf(_v_));
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*  58 */     _os_.compact_uint32(this.randomTextTableCfgIds.size());
/*  59 */     for (Integer _v_ : this.randomTextTableCfgIds)
/*     */     {
...
/*  73 */       this.randomTextTableCfgIds.add(Integer.valueOf(_v_));
/*     */     }
/*  75 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/*  80 */     String path = dir + "mzm.gsp.awardpool.confbean.STypeId2RandomTextTableCfgId.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.awardpool.confbean.STypeId2RandomTextTableCfgId"))
/*     */         {
/*     */ 
/*  96 */           STypeId2RandomTextTableCfgId obj = new STypeId2RandomTextTableCfgId();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, STypeId2RandomTextTableCfgId> all)
/*     */   {
/* 110 */     String path = dir + "mzm.gsp.awardpool.confbean.STypeId2RandomTextTableCfgId.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 122 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.awardpool.confbean.STypeId2RandomTextTableCfgId"))
/*     */         {
/*     */ 
/* 125 */           STypeId2RandomTextTableCfgId obj = new STypeId2RandomTextTableCfgId();
...
/*     */     
/* 141 */     String path = dir + "mzm.gsp.awardpool.confbean.STypeId2RandomTextTableCfgId.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 168 */           STypeId2RandomTextTableCfgId _v_ = new STypeId2RandomTextTableCfgId();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, STypeId2RandomTextTableCfgId> all)
/*     */   {
/* 188 */     String path = dir + "mzm.gsp.awardpool.confbean.STypeId2RandomTextTableCfgId.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 215 */           STypeId2RandomTextTableCfgId _v_ = new STypeId2RandomTextTableCfgId();
...
/*     */ 
/*     */ 
/*     */   public static STypeId2RandomTextTableCfgId getOld(int key)
/*     */   {
/* 236 */     return (STypeId2RandomTextTableCfgId)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static STypeId2RandomTextTableCfgId get(int key)
/*     */   {
/* 241 */     return (STypeId2RandomTextTableCfgId)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, STypeId2RandomTextTableCfgId> getOldAll()
/*     */   {
/* 246 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, STypeId2RandomTextTableCfgId> getAll()
/*     */   {
/* 251 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, STypeId2RandomTextTableCfgId> newAll)
/*     */   {
/* 256 */     oldAll = all;
/* 257 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\awardpool\confbean\STypeId2RandomTextTableCfgId.class
