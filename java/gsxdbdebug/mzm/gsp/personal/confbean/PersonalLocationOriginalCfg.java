...
/*     */ 
/*     */ public class PersonalLocationOriginalCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, PersonalLocationOriginalCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, PersonalLocationOriginalCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public int optionId;
/*     */   
...
/*  24 */     this.optionId = Integer.valueOf(rootElement.attributeValue("optionId")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  29 */     _os_.marshal(this.id);
/*  30 */     _os_.marshal(this.optionId);
/*  31 */     return _os_;
/*     */   }
/*     */   
...
/*  37 */     this.optionId = _os_.unmarshal_int();
/*  38 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.personal.confbean.PersonalLocationOriginalCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.personal.confbean.PersonalLocationOriginalCfg"))
/*     */         {
/*     */ 
/*  59 */           PersonalLocationOriginalCfg obj = new PersonalLocationOriginalCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, PersonalLocationOriginalCfg> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.personal.confbean.PersonalLocationOriginalCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.personal.confbean.PersonalLocationOriginalCfg"))
/*     */         {
/*     */ 
/*  88 */           PersonalLocationOriginalCfg obj = new PersonalLocationOriginalCfg();
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.personal.confbean.PersonalLocationOriginalCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           PersonalLocationOriginalCfg _v_ = new PersonalLocationOriginalCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, PersonalLocationOriginalCfg> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.personal.confbean.PersonalLocationOriginalCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           PersonalLocationOriginalCfg _v_ = new PersonalLocationOriginalCfg();
...
/*     */ 
/*     */ 
/*     */   public static PersonalLocationOriginalCfg getOld(int key)
/*     */   {
/* 199 */     return (PersonalLocationOriginalCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static PersonalLocationOriginalCfg get(int key)
/*     */   {
/* 204 */     return (PersonalLocationOriginalCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, PersonalLocationOriginalCfg> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, PersonalLocationOriginalCfg> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, PersonalLocationOriginalCfg> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\personal\confbean\PersonalLocationOriginalCfg.class
