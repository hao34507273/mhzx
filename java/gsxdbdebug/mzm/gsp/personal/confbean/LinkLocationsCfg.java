...
/*     */ 
/*     */ public class LinkLocationsCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, LinkLocationsCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, LinkLocationsCfg> all = null;
/*     */   
/*     */   public int locationId;
/*  19 */   public java.util.ArrayList<Integer> locationCfgIds = new java.util.ArrayList();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.locationId = Integer.valueOf(rootElement.attributeValue("locationId")).intValue();
/*     */     
/*  25 */     Element collectionElement = util.XmlHelper.getVariableElement(rootElement, "locationCfgIds");
...
/*     */         }
/*     */         
/*  50 */         this.locationCfgIds.add(Integer.valueOf(_v_));
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*     */   {
/*  57 */     _os_.marshal(this.locationId);
/*  58 */     _os_.compact_uint32(this.locationCfgIds.size());
/*  59 */     for (Integer _v_ : this.locationCfgIds)
/*     */     {
...
/*     */   {
/*  80 */     String path = dir + "mzm.gsp.personal.confbean.LinkLocationsCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.personal.confbean.LinkLocationsCfg"))
/*     */         {
/*     */ 
/*  96 */           LinkLocationsCfg obj = new LinkLocationsCfg();
/*  97 */           obj.loadFromXml(elem);
/*  98 */           if (all.put(Integer.valueOf(obj.locationId), obj) != null) {
/*  99 */             throw new RuntimeException("duplicate key : " + obj.locationId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, LinkLocationsCfg> all)
/*     */   {
/* 110 */     String path = dir + "mzm.gsp.personal.confbean.LinkLocationsCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 122 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.personal.confbean.LinkLocationsCfg"))
/*     */         {
/*     */ 
/* 125 */           LinkLocationsCfg obj = new LinkLocationsCfg();
/* 126 */           obj.loadFromXml(elem);
/* 127 */           if (all.put(Integer.valueOf(obj.locationId), obj) != null) {
/* 128 */             throw new RuntimeException("duplicate key : " + obj.locationId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 141 */     String path = dir + "mzm.gsp.personal.confbean.LinkLocationsCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 168 */           LinkLocationsCfg _v_ = new LinkLocationsCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, LinkLocationsCfg> all)
/*     */   {
/* 188 */     String path = dir + "mzm.gsp.personal.confbean.LinkLocationsCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 215 */           LinkLocationsCfg _v_ = new LinkLocationsCfg();
...
/*     */ 
/*     */ 
/*     */   public static LinkLocationsCfg getOld(int key)
/*     */   {
/* 236 */     return (LinkLocationsCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static LinkLocationsCfg get(int key)
/*     */   {
/* 241 */     return (LinkLocationsCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, LinkLocationsCfg> getOldAll()
/*     */   {
/* 246 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, LinkLocationsCfg> getAll()
/*     */   {
/* 251 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, LinkLocationsCfg> newAll)
/*     */   {
/* 256 */     oldAll = all;
/* 257 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\personal\confbean\LinkLocationsCfg.class
