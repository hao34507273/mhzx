...
/*     */ 
/*     */ public class PersonalHeadImageCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, PersonalHeadImageCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, PersonalHeadImageCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public int imageId;
/*     */   
...
/*  24 */     this.imageId = Integer.valueOf(rootElement.attributeValue("imageId")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  29 */     _os_.marshal(this.id);
/*  30 */     _os_.marshal(this.imageId);
/*  31 */     return _os_;
/*     */   }
/*     */   
...
/*  37 */     this.imageId = _os_.unmarshal_int();
/*  38 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.personal.confbean.PersonalHeadImageCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.personal.confbean.PersonalHeadImageCfg"))
/*     */         {
/*     */ 
/*  59 */           PersonalHeadImageCfg obj = new PersonalHeadImageCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, PersonalHeadImageCfg> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.personal.confbean.PersonalHeadImageCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.personal.confbean.PersonalHeadImageCfg"))
/*     */         {
/*     */ 
/*  88 */           PersonalHeadImageCfg obj = new PersonalHeadImageCfg();
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.personal.confbean.PersonalHeadImageCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           PersonalHeadImageCfg _v_ = new PersonalHeadImageCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, PersonalHeadImageCfg> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.personal.confbean.PersonalHeadImageCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           PersonalHeadImageCfg _v_ = new PersonalHeadImageCfg();
...
/*     */ 
/*     */ 
/*     */   public static PersonalHeadImageCfg getOld(int key)
/*     */   {
/* 199 */     return (PersonalHeadImageCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static PersonalHeadImageCfg get(int key)
/*     */   {
/* 204 */     return (PersonalHeadImageCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, PersonalHeadImageCfg> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, PersonalHeadImageCfg> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, PersonalHeadImageCfg> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\personal\confbean\PersonalHeadImageCfg.class
