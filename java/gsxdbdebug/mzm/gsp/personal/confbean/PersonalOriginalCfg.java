...
/*     */ 
/*     */ public class PersonalOriginalCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, PersonalOriginalCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, PersonalOriginalCfg> all = null;
/*     */   
/*     */   public int id;
...
/*  26 */     this.fieldType = Integer.valueOf(rootElement.attributeValue("fieldType")).intValue();
/*  27 */     this.textMaxLen = Integer.valueOf(rootElement.attributeValue("textMaxLen")).intValue();
/*  28 */     this.optionId = Integer.valueOf(rootElement.attributeValue("optionId")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  33 */     _os_.marshal(this.id);
/*  34 */     _os_.marshal(this.fieldType);
/*  35 */     _os_.marshal(this.textMaxLen);
/*  36 */     _os_.marshal(this.optionId);
/*  37 */     return _os_;
/*     */   }
/*     */   
...
/*  43 */     this.fieldType = _os_.unmarshal_int();
/*  44 */     this.textMaxLen = _os_.unmarshal_int();
/*  45 */     this.optionId = _os_.unmarshal_int();
/*  46 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  51 */     String path = dir + "mzm.gsp.personal.confbean.PersonalOriginalCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  64 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.personal.confbean.PersonalOriginalCfg"))
/*     */         {
/*     */ 
/*  67 */           PersonalOriginalCfg obj = new PersonalOriginalCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, PersonalOriginalCfg> all)
/*     */   {
/*  81 */     String path = dir + "mzm.gsp.personal.confbean.PersonalOriginalCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.personal.confbean.PersonalOriginalCfg"))
/*     */         {
/*     */ 
/*  96 */           PersonalOriginalCfg obj = new PersonalOriginalCfg();
...
/*     */     
/* 112 */     String path = dir + "mzm.gsp.personal.confbean.PersonalOriginalCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 139 */           PersonalOriginalCfg _v_ = new PersonalOriginalCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, PersonalOriginalCfg> all)
/*     */   {
/* 159 */     String path = dir + "mzm.gsp.personal.confbean.PersonalOriginalCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 186 */           PersonalOriginalCfg _v_ = new PersonalOriginalCfg();
...
/*     */ 
/*     */ 
/*     */   public static PersonalOriginalCfg getOld(int key)
/*     */   {
/* 207 */     return (PersonalOriginalCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static PersonalOriginalCfg get(int key)
/*     */   {
/* 212 */     return (PersonalOriginalCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, PersonalOriginalCfg> getOldAll()
/*     */   {
/* 217 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, PersonalOriginalCfg> getAll()
/*     */   {
/* 222 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, PersonalOriginalCfg> newAll)
/*     */   {
/* 227 */     oldAll = all;
/* 228 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\personal\confbean\PersonalOriginalCfg.class
