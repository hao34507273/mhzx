...
/*     */ 
/*     */ public class PersonalFieldPrecentOriginalCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, PersonalFieldPrecentOriginalCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, PersonalFieldPrecentOriginalCfg> all = null;
/*     */   
/*     */   public int id;
...
/*  25 */     this.fieldType = Integer.valueOf(rootElement.attributeValue("fieldType")).intValue();
/*  26 */     this.precent = Integer.valueOf(rootElement.attributeValue("precent")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  31 */     _os_.marshal(this.id);
/*  32 */     _os_.marshal(this.fieldType);
/*  33 */     _os_.marshal(this.precent);
/*  34 */     return _os_;
/*     */   }
/*     */   
...
/*  40 */     this.fieldType = _os_.unmarshal_int();
/*  41 */     this.precent = _os_.unmarshal_int();
/*  42 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  47 */     String path = dir + "mzm.gsp.personal.confbean.PersonalFieldPrecentOriginalCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  60 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.personal.confbean.PersonalFieldPrecentOriginalCfg"))
/*     */         {
/*     */ 
/*  63 */           PersonalFieldPrecentOriginalCfg obj = new PersonalFieldPrecentOriginalCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, PersonalFieldPrecentOriginalCfg> all)
/*     */   {
/*  77 */     String path = dir + "mzm.gsp.personal.confbean.PersonalFieldPrecentOriginalCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  89 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.personal.confbean.PersonalFieldPrecentOriginalCfg"))
/*     */         {
/*     */ 
/*  92 */           PersonalFieldPrecentOriginalCfg obj = new PersonalFieldPrecentOriginalCfg();
...
/*     */     
/* 108 */     String path = dir + "mzm.gsp.personal.confbean.PersonalFieldPrecentOriginalCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 135 */           PersonalFieldPrecentOriginalCfg _v_ = new PersonalFieldPrecentOriginalCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, PersonalFieldPrecentOriginalCfg> all)
/*     */   {
/* 155 */     String path = dir + "mzm.gsp.personal.confbean.PersonalFieldPrecentOriginalCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 182 */           PersonalFieldPrecentOriginalCfg _v_ = new PersonalFieldPrecentOriginalCfg();
...
/*     */ 
/*     */ 
/*     */   public static PersonalFieldPrecentOriginalCfg getOld(int key)
/*     */   {
/* 203 */     return (PersonalFieldPrecentOriginalCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static PersonalFieldPrecentOriginalCfg get(int key)
/*     */   {
/* 208 */     return (PersonalFieldPrecentOriginalCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, PersonalFieldPrecentOriginalCfg> getOldAll()
/*     */   {
/* 213 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, PersonalFieldPrecentOriginalCfg> getAll()
/*     */   {
/* 218 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, PersonalFieldPrecentOriginalCfg> newAll)
/*     */   {
/* 223 */     oldAll = all;
/* 224 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\personal\confbean\PersonalFieldPrecentOriginalCfg.class
