...
/*     */ 
/*     */ public class SPersonalOptionCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SPersonalOptionCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SPersonalOptionCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public int optionId;
...
/*  25 */     this.optionId = Integer.valueOf(rootElement.attributeValue("optionId")).intValue();
/*  26 */     this.linkOptionId = Integer.valueOf(rootElement.attributeValue("linkOptionId")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  31 */     _os_.marshal(this.id);
/*  32 */     _os_.marshal(this.optionId);
/*  33 */     _os_.marshal(this.linkOptionId);
/*  34 */     return _os_;
/*     */   }
/*     */   
...
/*  40 */     this.optionId = _os_.unmarshal_int();
/*  41 */     this.linkOptionId = _os_.unmarshal_int();
/*  42 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  47 */     String path = dir + "mzm.gsp.personal.confbean.SPersonalOptionCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  60 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.personal.confbean.SPersonalOptionCfg"))
/*     */         {
/*     */ 
/*  63 */           SPersonalOptionCfg obj = new SPersonalOptionCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SPersonalOptionCfg> all)
/*     */   {
/*  77 */     String path = dir + "mzm.gsp.personal.confbean.SPersonalOptionCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  89 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.personal.confbean.SPersonalOptionCfg"))
/*     */         {
/*     */ 
/*  92 */           SPersonalOptionCfg obj = new SPersonalOptionCfg();
...
/*     */     
/* 108 */     String path = dir + "mzm.gsp.personal.confbean.SPersonalOptionCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 135 */           SPersonalOptionCfg _v_ = new SPersonalOptionCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SPersonalOptionCfg> all)
/*     */   {
/* 155 */     String path = dir + "mzm.gsp.personal.confbean.SPersonalOptionCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 182 */           SPersonalOptionCfg _v_ = new SPersonalOptionCfg();
...
/*     */ 
/*     */ 
/*     */   public static SPersonalOptionCfg getOld(int key)
/*     */   {
/* 203 */     return (SPersonalOptionCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SPersonalOptionCfg get(int key)
/*     */   {
/* 208 */     return (SPersonalOptionCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPersonalOptionCfg> getOldAll()
/*     */   {
/* 213 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPersonalOptionCfg> getAll()
/*     */   {
/* 218 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SPersonalOptionCfg> newAll)
/*     */   {
/* 223 */     oldAll = all;
/* 224 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\personal\confbean\SPersonalOptionCfg.class
