...
/*     */ 
/*     */ public class SBagidExpendcount2Itemcount implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SBagidExpendcount2Itemcount> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SBagidExpendcount2Itemcount> all = null;
/*     */   
/*     */   public int bagId;
/*  19 */   public HashMap<Integer, Integer> expendcount2itemcount = new HashMap();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.bagId = Integer.valueOf(rootElement.attributeValue("bagId")).intValue();
/*     */     
/*  25 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "expendcount2itemcount");
...
/*     */         }
/*     */         
/*  76 */         this.expendcount2itemcount.put(Integer.valueOf(_k_), Integer.valueOf(_v_));
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*     */   {
/*  83 */     _os_.marshal(this.bagId);
/*  84 */     _os_.compact_uint32(this.expendcount2itemcount.size());
/*  85 */     for (java.util.Map.Entry<Integer, Integer> _e_ : this.expendcount2itemcount.entrySet())
/*     */     {
...
/*     */   {
/*  95 */     this.bagId = _os_.unmarshal_int();
...
/* 102 */       this.expendcount2itemcount.put(Integer.valueOf(_k_), Integer.valueOf(_v_));
/*     */     }
/* 104 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/* 109 */     String path = dir + "mzm.gsp.bag.confbean.SBagidExpendcount2Itemcount.xml";
/*     */     
/*     */     try
/*     */     {
/* 113 */       all = new HashMap();
...
/* 122 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.bag.confbean.SBagidExpendcount2Itemcount"))
/*     */         {
/*     */ 
/* 125 */           SBagidExpendcount2Itemcount obj = new SBagidExpendcount2Itemcount();
/* 126 */           obj.loadFromXml(elem);
/* 127 */           if (all.put(Integer.valueOf(obj.bagId), obj) != null) {
/* 128 */             throw new RuntimeException("duplicate key : " + obj.bagId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SBagidExpendcount2Itemcount> all)
/*     */   {
/* 139 */     String path = dir + "mzm.gsp.bag.confbean.SBagidExpendcount2Itemcount.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 151 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.bag.confbean.SBagidExpendcount2Itemcount"))
/*     */         {
/*     */ 
/* 154 */           SBagidExpendcount2Itemcount obj = new SBagidExpendcount2Itemcount();
/* 155 */           obj.loadFromXml(elem);
/* 156 */           if (all.put(Integer.valueOf(obj.bagId), obj) != null) {
/* 157 */             throw new RuntimeException("duplicate key : " + obj.bagId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/* 168 */     all = new HashMap();
/*     */     
/* 170 */     String path = dir + "mzm.gsp.bag.confbean.SBagidExpendcount2Itemcount.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 197 */           SBagidExpendcount2Itemcount _v_ = new SBagidExpendcount2Itemcount();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SBagidExpendcount2Itemcount> all)
/*     */   {
/* 217 */     String path = dir + "mzm.gsp.bag.confbean.SBagidExpendcount2Itemcount.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 244 */           SBagidExpendcount2Itemcount _v_ = new SBagidExpendcount2Itemcount();
...
/*     */ 
/*     */ 
/*     */   public static SBagidExpendcount2Itemcount getOld(int key)
/*     */   {
/* 265 */     return (SBagidExpendcount2Itemcount)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SBagidExpendcount2Itemcount get(int key)
/*     */   {
/* 270 */     return (SBagidExpendcount2Itemcount)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SBagidExpendcount2Itemcount> getOldAll()
/*     */   {
/* 275 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SBagidExpendcount2Itemcount> getAll()
/*     */   {
/* 280 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SBagidExpendcount2Itemcount> newAll)
/*     */   {
/* 285 */     oldAll = all;
/* 286 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\bag\confbean\SBagidExpendcount2Itemcount.class
