...
/*     */ 
/*     */ public class ItemType2BagCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, ItemType2BagCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, ItemType2BagCfg> all = null;
/*     */   
/*     */   public int itemType;
/*     */   public int id;
/*     */   public int bagId;
...
/*     */   {
/*  24 */     this.itemType = Integer.valueOf(rootElement.attributeValue("itemType")).intValue();
/*  25 */     this.id = Integer.valueOf(rootElement.attributeValue("id")).intValue();
/*  26 */     this.bagId = Integer.valueOf(rootElement.attributeValue("bagId")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  31 */     _os_.marshal(this.itemType);
...
/*     */   {
/*  39 */     this.itemType = _os_.unmarshal_int();
/*  40 */     this.id = _os_.unmarshal_int();
/*  41 */     this.bagId = _os_.unmarshal_int();
/*  42 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  47 */     String path = dir + "mzm.gsp.bag.confbean.ItemType2BagCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  60 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.bag.confbean.ItemType2BagCfg"))
/*     */         {
/*     */ 
/*  63 */           ItemType2BagCfg obj = new ItemType2BagCfg();
/*  64 */           obj.loadFromXml(elem);
/*  65 */           if (all.put(Integer.valueOf(obj.itemType), obj) != null) {
/*  66 */             throw new RuntimeException("duplicate key : " + obj.itemType);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, ItemType2BagCfg> all)
/*     */   {
/*  77 */     String path = dir + "mzm.gsp.bag.confbean.ItemType2BagCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  89 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.bag.confbean.ItemType2BagCfg"))
/*     */         {
/*     */ 
/*  92 */           ItemType2BagCfg obj = new ItemType2BagCfg();
/*  93 */           obj.loadFromXml(elem);
/*  94 */           if (all.put(Integer.valueOf(obj.itemType), obj) != null) {
/*  95 */             throw new RuntimeException("duplicate key : " + obj.itemType);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 108 */     String path = dir + "mzm.gsp.bag.confbean.ItemType2BagCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 135 */           ItemType2BagCfg _v_ = new ItemType2BagCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, ItemType2BagCfg> all)
/*     */   {
/* 155 */     String path = dir + "mzm.gsp.bag.confbean.ItemType2BagCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 182 */           ItemType2BagCfg _v_ = new ItemType2BagCfg();
...
/*     */ 
/*     */ 
/*     */   public static ItemType2BagCfg getOld(int key)
/*     */   {
/* 203 */     return (ItemType2BagCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static ItemType2BagCfg get(int key)
/*     */   {
/* 208 */     return (ItemType2BagCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, ItemType2BagCfg> getOldAll()
/*     */   {
/* 213 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, ItemType2BagCfg> getAll()
/*     */   {
/* 218 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, ItemType2BagCfg> newAll)
/*     */   {
/* 223 */     oldAll = all;
/* 224 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\bag\confbean\ItemType2BagCfg.class
