...
/*     */ 
/*     */ public class SBagExpendCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SBagExpendCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SBagExpendCfg> all = null;
/*     */   
/*     */   public int id;
...
/*  28 */     this.bagId = Integer.valueOf(rootElement.attributeValue("bagId")).intValue();
/*  29 */     this.expendCount = Integer.valueOf(rootElement.attributeValue("expendCount")).intValue();
/*  30 */     this.itemCount = Integer.valueOf(rootElement.attributeValue("itemCount")).intValue();
/*     */   }
/*     */   
...
/*  37 */     _os_.marshal(this.bagId);
/*  38 */     _os_.marshal(this.expendCount);
/*  39 */     _os_.marshal(this.itemCount);
/*  40 */     return _os_;
/*     */   }
/*     */   
...
/*  47 */     this.bagId = _os_.unmarshal_int();
/*  48 */     this.expendCount = _os_.unmarshal_int();
/*  49 */     this.itemCount = _os_.unmarshal_int();
/*  50 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  55 */     String path = dir + "mzm.gsp.bag.confbean.SBagExpendCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  68 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.bag.confbean.SBagExpendCfg"))
/*     */         {
/*     */ 
/*  71 */           SBagExpendCfg obj = new SBagExpendCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SBagExpendCfg> all)
/*     */   {
/*  85 */     String path = dir + "mzm.gsp.bag.confbean.SBagExpendCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  97 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.bag.confbean.SBagExpendCfg"))
/*     */         {
/*     */ 
/* 100 */           SBagExpendCfg obj = new SBagExpendCfg();
...
/*     */     
/* 116 */     String path = dir + "mzm.gsp.bag.confbean.SBagExpendCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 143 */           SBagExpendCfg _v_ = new SBagExpendCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SBagExpendCfg> all)
/*     */   {
/* 163 */     String path = dir + "mzm.gsp.bag.confbean.SBagExpendCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 190 */           SBagExpendCfg _v_ = new SBagExpendCfg();
...
/*     */ 
/*     */ 
/*     */   public static SBagExpendCfg getOld(int key)
/*     */   {
/* 211 */     return (SBagExpendCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SBagExpendCfg get(int key)
/*     */   {
/* 216 */     return (SBagExpendCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SBagExpendCfg> getOldAll()
/*     */   {
/* 221 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SBagExpendCfg> getAll()
/*     */   {
/* 226 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SBagExpendCfg> newAll)
/*     */   {
/* 231 */     oldAll = all;
/* 232 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\bag\confbean\SBagExpendCfg.class
