...
/*     */ 
/*     */ public class SFightOperateCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SFightOperateCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SFightOperateCfg> all = null;
/*     */   
...
/*     */   {
/*  23 */     this.operateType = Integer.valueOf(rootElement.attributeValue("operateType")).intValue();
/*  24 */     this.priority = Integer.valueOf(rootElement.attributeValue("priority")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  29 */     _os_.marshal(this.operateType);
...
/*     */   {
/*  36 */     this.operateType = _os_.unmarshal_int();
...
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.fight.confbean.SFightOperateCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.fight.confbean.SFightOperateCfg"))
/*     */         {
/*     */ 
/*  59 */           SFightOperateCfg obj = new SFightOperateCfg();
/*  60 */           obj.loadFromXml(elem);
/*  61 */           if (all.put(Integer.valueOf(obj.operateType), obj) != null) {
/*  62 */             throw new RuntimeException("duplicate key : " + obj.operateType);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SFightOperateCfg> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.fight.confbean.SFightOperateCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.fight.confbean.SFightOperateCfg"))
/*     */         {
/*     */ 
/*  88 */           SFightOperateCfg obj = new SFightOperateCfg();
/*  89 */           obj.loadFromXml(elem);
/*  90 */           if (all.put(Integer.valueOf(obj.operateType), obj) != null) {
/*  91 */             throw new RuntimeException("duplicate key : " + obj.operateType);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.fight.confbean.SFightOperateCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           SFightOperateCfg _v_ = new SFightOperateCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SFightOperateCfg> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.fight.confbean.SFightOperateCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           SFightOperateCfg _v_ = new SFightOperateCfg();
...
/*     */ 
/*     */ 
/*     */   public static SFightOperateCfg getOld(int key)
/*     */   {
/* 199 */     return (SFightOperateCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SFightOperateCfg get(int key)
/*     */   {
/* 204 */     return (SFightOperateCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SFightOperateCfg> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SFightOperateCfg> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SFightOperateCfg> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\fight\confbean\SFightOperateCfg.class
