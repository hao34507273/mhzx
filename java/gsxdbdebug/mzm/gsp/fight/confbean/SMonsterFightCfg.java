...
/*     */ 
/*     */ public class SMonsterFightCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SMonsterFightCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SMonsterFightCfg> all = null;
/*     */   
/*     */   public int id;
...
/*     */   {
/*  82 */     String path = dir + "mzm.gsp.fight.confbean.SMonsterFightCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  95 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.fight.confbean.SMonsterFightCfg"))
/*     */         {
/*     */ 
/*  98 */           SMonsterFightCfg obj = new SMonsterFightCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SMonsterFightCfg> all)
/*     */   {
/* 112 */     String path = dir + "mzm.gsp.fight.confbean.SMonsterFightCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 124 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.fight.confbean.SMonsterFightCfg"))
/*     */         {
/*     */ 
/* 127 */           SMonsterFightCfg obj = new SMonsterFightCfg();
...
/*     */     
/* 143 */     String path = dir + "mzm.gsp.fight.confbean.SMonsterFightCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 170 */           SMonsterFightCfg _v_ = new SMonsterFightCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SMonsterFightCfg> all)
/*     */   {
/* 190 */     String path = dir + "mzm.gsp.fight.confbean.SMonsterFightCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 217 */           SMonsterFightCfg _v_ = new SMonsterFightCfg();
...
/*     */ 
/*     */ 
/*     */   public static SMonsterFightCfg getOld(int key)
/*     */   {
/* 238 */     return (SMonsterFightCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SMonsterFightCfg get(int key)
/*     */   {
/* 243 */     return (SMonsterFightCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMonsterFightCfg> getOldAll()
/*     */   {
/* 248 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMonsterFightCfg> getAll()
/*     */   {
/* 253 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SMonsterFightCfg> newAll)
/*     */   {
/* 258 */     oldAll = all;
/* 259 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\fight\confbean\SMonsterFightCfg.class
