...
/*     */ 
/*     */ public class SFightCommandCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SFightCommandCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SFightCommandCfg> all = null;
/*     */   
/*     */   public int id;
...
/*  25 */     this.commandType = Integer.valueOf(rootElement.attributeValue("commandType")).intValue();
/*  26 */     this.content = rootElement.attributeValue("content");
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  31 */     _os_.marshal(this.id);
/*  32 */     _os_.marshal(this.commandType);
/*  33 */     _os_.marshal(this.content, "UTF-8");
/*  34 */     return _os_;
/*     */   }
/*     */   
...
/*  40 */     this.commandType = _os_.unmarshal_int();
/*  41 */     this.content = _os_.unmarshal_String("UTF-8");
/*  42 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  47 */     String path = dir + "mzm.gsp.fight.confbean.SFightCommandCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  60 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.fight.confbean.SFightCommandCfg"))
/*     */         {
/*     */ 
/*  63 */           SFightCommandCfg obj = new SFightCommandCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SFightCommandCfg> all)
/*     */   {
/*  77 */     String path = dir + "mzm.gsp.fight.confbean.SFightCommandCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  89 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.fight.confbean.SFightCommandCfg"))
/*     */         {
/*     */ 
/*  92 */           SFightCommandCfg obj = new SFightCommandCfg();
...
/*     */     
/* 108 */     String path = dir + "mzm.gsp.fight.confbean.SFightCommandCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 135 */           SFightCommandCfg _v_ = new SFightCommandCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SFightCommandCfg> all)
/*     */   {
/* 155 */     String path = dir + "mzm.gsp.fight.confbean.SFightCommandCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 182 */           SFightCommandCfg _v_ = new SFightCommandCfg();
...
/*     */ 
/*     */ 
/*     */   public static SFightCommandCfg getOld(int key)
/*     */   {
/* 203 */     return (SFightCommandCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SFightCommandCfg get(int key)
/*     */   {
/* 208 */     return (SFightCommandCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SFightCommandCfg> getOldAll()
/*     */   {
/* 213 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SFightCommandCfg> getAll()
/*     */   {
/* 218 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SFightCommandCfg> newAll)
/*     */   {
/* 223 */     oldAll = all;
/* 224 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\fight\confbean\SFightCommandCfg.class
