...
/*     */ 
/*     */ public class SFightSkillLogCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SFightSkillLogCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SFightSkillLogCfg> all = null;
/*     */   
/*     */   public int battleType;
/*  19 */   public java.util.LinkedList<Integer> skillLogIds = new java.util.LinkedList();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.battleType = Integer.valueOf(rootElement.attributeValue("battleType")).intValue();
/*     */     
/*  25 */     Element collectionElement = util.XmlHelper.getVariableElement(rootElement, "skillLogIds");
...
/*     */         }
/*     */         
/*  50 */         this.skillLogIds.add(Integer.valueOf(_v_));
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*     */   {
/*  57 */     _os_.marshal(this.battleType);
/*  58 */     _os_.compact_uint32(this.skillLogIds.size());
/*  59 */     for (Integer _v_ : this.skillLogIds)
/*     */     {
...
/*     */   {
/*  80 */     String path = dir + "mzm.gsp.fight.confbean.SFightSkillLogCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.fight.confbean.SFightSkillLogCfg"))
/*     */         {
/*     */ 
/*  96 */           SFightSkillLogCfg obj = new SFightSkillLogCfg();
/*  97 */           obj.loadFromXml(elem);
/*  98 */           if (all.put(Integer.valueOf(obj.battleType), obj) != null) {
/*  99 */             throw new RuntimeException("duplicate key : " + obj.battleType);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SFightSkillLogCfg> all)
/*     */   {
/* 110 */     String path = dir + "mzm.gsp.fight.confbean.SFightSkillLogCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 122 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.fight.confbean.SFightSkillLogCfg"))
/*     */         {
/*     */ 
/* 125 */           SFightSkillLogCfg obj = new SFightSkillLogCfg();
/* 126 */           obj.loadFromXml(elem);
/* 127 */           if (all.put(Integer.valueOf(obj.battleType), obj) != null) {
/* 128 */             throw new RuntimeException("duplicate key : " + obj.battleType);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 141 */     String path = dir + "mzm.gsp.fight.confbean.SFightSkillLogCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 168 */           SFightSkillLogCfg _v_ = new SFightSkillLogCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SFightSkillLogCfg> all)
/*     */   {
/* 188 */     String path = dir + "mzm.gsp.fight.confbean.SFightSkillLogCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 215 */           SFightSkillLogCfg _v_ = new SFightSkillLogCfg();
...
/*     */ 
/*     */ 
/*     */   public static SFightSkillLogCfg getOld(int key)
/*     */   {
/* 236 */     return (SFightSkillLogCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SFightSkillLogCfg get(int key)
/*     */   {
/* 241 */     return (SFightSkillLogCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SFightSkillLogCfg> getOldAll()
/*     */   {
/* 246 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SFightSkillLogCfg> getAll()
/*     */   {
/* 251 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SFightSkillLogCfg> newAll)
/*     */   {
/* 256 */     oldAll = all;
/* 257 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\fight\confbean\SFightSkillLogCfg.class
