...
/*     */ 
/*     */ public class SLostHpToAngerCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SLostHpToAngerCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SLostHpToAngerCfg> all = null;
/*     */   
/*     */   public int lostHpRateMax;
/*     */   public int anger;
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.lostHpRateMax = Integer.valueOf(rootElement.attributeValue("lostHpRateMax")).intValue();
/*  24 */     this.anger = Integer.valueOf(rootElement.attributeValue("anger")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  29 */     _os_.marshal(this.lostHpRateMax);
/*  30 */     _os_.marshal(this.anger);
/*  31 */     return _os_;
/*     */   }
/*     */   
/*     */   public OctetsStream unmarshal(OctetsStream _os_) throws com.goldhuman.Common.Marshal.MarshalException
/*     */   {
/*  36 */     this.lostHpRateMax = _os_.unmarshal_int();
/*  37 */     this.anger = _os_.unmarshal_int();
/*  38 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.fight.confbean.SLostHpToAngerCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.fight.confbean.SLostHpToAngerCfg"))
/*     */         {
/*     */ 
/*  59 */           SLostHpToAngerCfg obj = new SLostHpToAngerCfg();
/*  60 */           obj.loadFromXml(elem);
/*  61 */           if (all.put(Integer.valueOf(obj.lostHpRateMax), obj) != null) {
/*  62 */             throw new RuntimeException("duplicate key : " + obj.lostHpRateMax);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SLostHpToAngerCfg> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.fight.confbean.SLostHpToAngerCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.fight.confbean.SLostHpToAngerCfg"))
/*     */         {
/*     */ 
/*  88 */           SLostHpToAngerCfg obj = new SLostHpToAngerCfg();
/*  89 */           obj.loadFromXml(elem);
/*  90 */           if (all.put(Integer.valueOf(obj.lostHpRateMax), obj) != null) {
/*  91 */             throw new RuntimeException("duplicate key : " + obj.lostHpRateMax);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.fight.confbean.SLostHpToAngerCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           SLostHpToAngerCfg _v_ = new SLostHpToAngerCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SLostHpToAngerCfg> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.fight.confbean.SLostHpToAngerCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           SLostHpToAngerCfg _v_ = new SLostHpToAngerCfg();
...
/*     */ 
/*     */ 
/*     */   public static SLostHpToAngerCfg getOld(int key)
/*     */   {
/* 199 */     return (SLostHpToAngerCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SLostHpToAngerCfg get(int key)
/*     */   {
/* 204 */     return (SLostHpToAngerCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SLostHpToAngerCfg> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SLostHpToAngerCfg> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SLostHpToAngerCfg> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\fight\confbean\SLostHpToAngerCfg.class
