...
/*     */ 
/*     */ public class SSkillLogCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SSkillLogCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SSkillLogCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public String classname;
/*  20 */   public java.util.LinkedList<Integer> params = new java.util.LinkedList();
/*     */   
...
/*     */         }
/*     */         
/*  52 */         this.params.add(Integer.valueOf(_v_));
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*  62 */     for (Integer _v_ : this.params)
/*     */     {
...
/*  77 */       this.params.add(Integer.valueOf(_v_));
/*     */     }
/*  79 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/*  84 */     String path = dir + "mzm.gsp.fight.confbean.SSkillLogCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  97 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.fight.confbean.SSkillLogCfg"))
/*     */         {
/*     */ 
/* 100 */           SSkillLogCfg obj = new SSkillLogCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SSkillLogCfg> all)
/*     */   {
/* 114 */     String path = dir + "mzm.gsp.fight.confbean.SSkillLogCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 126 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.fight.confbean.SSkillLogCfg"))
/*     */         {
/*     */ 
/* 129 */           SSkillLogCfg obj = new SSkillLogCfg();
...
/*     */     
/* 145 */     String path = dir + "mzm.gsp.fight.confbean.SSkillLogCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 172 */           SSkillLogCfg _v_ = new SSkillLogCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SSkillLogCfg> all)
/*     */   {
/* 192 */     String path = dir + "mzm.gsp.fight.confbean.SSkillLogCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 219 */           SSkillLogCfg _v_ = new SSkillLogCfg();
...
/*     */ 
/*     */ 
/*     */   public static SSkillLogCfg getOld(int key)
/*     */   {
/* 240 */     return (SSkillLogCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SSkillLogCfg get(int key)
/*     */   {
/* 245 */     return (SSkillLogCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SSkillLogCfg> getOldAll()
/*     */   {
/* 250 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SSkillLogCfg> getAll()
/*     */   {
/* 255 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SSkillLogCfg> newAll)
/*     */   {
/* 260 */     oldAll = all;
/* 261 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\fight\confbean\SSkillLogCfg.class
