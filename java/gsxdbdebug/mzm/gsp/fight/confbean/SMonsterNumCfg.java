...
/*     */ 
/*     */ public class SMonsterNumCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SMonsterNumCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SMonsterNumCfg> all = null;
/*     */   
/*     */   public int id;
...
/*     */   {
/*  80 */     String path = dir + "mzm.gsp.fight.confbean.SMonsterNumCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.fight.confbean.SMonsterNumCfg"))
/*     */         {
/*     */ 
/*  96 */           SMonsterNumCfg obj = new SMonsterNumCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SMonsterNumCfg> all)
/*     */   {
/* 110 */     String path = dir + "mzm.gsp.fight.confbean.SMonsterNumCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 122 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.fight.confbean.SMonsterNumCfg"))
/*     */         {
/*     */ 
/* 125 */           SMonsterNumCfg obj = new SMonsterNumCfg();
...
/*     */     
/* 141 */     String path = dir + "mzm.gsp.fight.confbean.SMonsterNumCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 168 */           SMonsterNumCfg _v_ = new SMonsterNumCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SMonsterNumCfg> all)
/*     */   {
/* 188 */     String path = dir + "mzm.gsp.fight.confbean.SMonsterNumCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 215 */           SMonsterNumCfg _v_ = new SMonsterNumCfg();
...
/*     */ 
/*     */ 
/*     */   public static SMonsterNumCfg getOld(int key)
/*     */   {
/* 236 */     return (SMonsterNumCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SMonsterNumCfg get(int key)
/*     */   {
/* 241 */     return (SMonsterNumCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMonsterNumCfg> getOldAll()
/*     */   {
/* 246 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMonsterNumCfg> getAll()
/*     */   {
/* 251 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SMonsterNumCfg> newAll)
/*     */   {
/* 256 */     oldAll = all;
/* 257 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\fight\confbean\SMonsterNumCfg.class
