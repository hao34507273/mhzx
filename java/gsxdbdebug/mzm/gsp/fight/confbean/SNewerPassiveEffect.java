...
/*     */ 
/*     */ public class SNewerPassiveEffect implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SNewerPassiveEffect> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SNewerPassiveEffect> all = null;
/*     */   
/*     */   public int subLevel;
...
/*     */   {
/*  23 */     this.subLevel = Integer.valueOf(rootElement.attributeValue("subLevel")).intValue();
/*  24 */     this.passiveEffectid = Integer.valueOf(rootElement.attributeValue("passiveEffectid")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  29 */     _os_.marshal(this.subLevel);
/*  30 */     _os_.marshal(this.passiveEffectid);
/*  31 */     return _os_;
/*     */   }
/*     */   
/*     */   public OctetsStream unmarshal(OctetsStream _os_) throws com.goldhuman.Common.Marshal.MarshalException
/*     */   {
/*  36 */     this.subLevel = _os_.unmarshal_int();
/*  37 */     this.passiveEffectid = _os_.unmarshal_int();
/*  38 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.fight.confbean.SNewerPassiveEffect.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.fight.confbean.SNewerPassiveEffect"))
/*     */         {
/*     */ 
/*  59 */           SNewerPassiveEffect obj = new SNewerPassiveEffect();
/*  60 */           obj.loadFromXml(elem);
/*  61 */           if (all.put(Integer.valueOf(obj.subLevel), obj) != null) {
/*  62 */             throw new RuntimeException("duplicate key : " + obj.subLevel);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SNewerPassiveEffect> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.fight.confbean.SNewerPassiveEffect.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.fight.confbean.SNewerPassiveEffect"))
/*     */         {
/*     */ 
/*  88 */           SNewerPassiveEffect obj = new SNewerPassiveEffect();
/*  89 */           obj.loadFromXml(elem);
/*  90 */           if (all.put(Integer.valueOf(obj.subLevel), obj) != null) {
/*  91 */             throw new RuntimeException("duplicate key : " + obj.subLevel);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.fight.confbean.SNewerPassiveEffect.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           SNewerPassiveEffect _v_ = new SNewerPassiveEffect();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SNewerPassiveEffect> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.fight.confbean.SNewerPassiveEffect.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           SNewerPassiveEffect _v_ = new SNewerPassiveEffect();
...
/*     */ 
/*     */ 
/*     */   public static SNewerPassiveEffect getOld(int key)
/*     */   {
/* 199 */     return (SNewerPassiveEffect)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SNewerPassiveEffect get(int key)
/*     */   {
/* 204 */     return (SNewerPassiveEffect)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SNewerPassiveEffect> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SNewerPassiveEffect> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SNewerPassiveEffect> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\fight\confbean\SNewerPassiveEffect.class
