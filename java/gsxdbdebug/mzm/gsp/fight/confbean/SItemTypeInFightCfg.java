...
/*     */ 
/*     */ public class SItemTypeInFightCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SItemTypeInFightCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SItemTypeInFightCfg> all = null;
/*     */   
/*     */   public int type;
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  22 */     this.type = Integer.valueOf(rootElement.attributeValue("type")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  27 */     _os_.marshal(this.type);
/*  28 */     return _os_;
/*     */   }
/*     */   
/*     */   public OctetsStream unmarshal(OctetsStream _os_) throws com.goldhuman.Common.Marshal.MarshalException
/*     */   {
/*  33 */     this.type = _os_.unmarshal_int();
/*  34 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  39 */     String path = dir + "mzm.gsp.fight.confbean.SItemTypeInFightCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  52 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.fight.confbean.SItemTypeInFightCfg"))
/*     */         {
/*     */ 
/*  55 */           SItemTypeInFightCfg obj = new SItemTypeInFightCfg();
/*  56 */           obj.loadFromXml(elem);
/*  57 */           if (all.put(Integer.valueOf(obj.type), obj) != null) {
/*  58 */             throw new RuntimeException("duplicate key : " + obj.type);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SItemTypeInFightCfg> all)
/*     */   {
/*  69 */     String path = dir + "mzm.gsp.fight.confbean.SItemTypeInFightCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  81 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.fight.confbean.SItemTypeInFightCfg"))
/*     */         {
/*     */ 
/*  84 */           SItemTypeInFightCfg obj = new SItemTypeInFightCfg();
/*  85 */           obj.loadFromXml(elem);
/*  86 */           if (all.put(Integer.valueOf(obj.type), obj) != null) {
/*  87 */             throw new RuntimeException("duplicate key : " + obj.type);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 100 */     String path = dir + "mzm.gsp.fight.confbean.SItemTypeInFightCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 127 */           SItemTypeInFightCfg _v_ = new SItemTypeInFightCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SItemTypeInFightCfg> all)
/*     */   {
/* 147 */     String path = dir + "mzm.gsp.fight.confbean.SItemTypeInFightCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 174 */           SItemTypeInFightCfg _v_ = new SItemTypeInFightCfg();
...
/*     */ 
/*     */ 
/*     */   public static SItemTypeInFightCfg getOld(int key)
/*     */   {
/* 195 */     return (SItemTypeInFightCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SItemTypeInFightCfg get(int key)
/*     */   {
/* 200 */     return (SItemTypeInFightCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SItemTypeInFightCfg> getOldAll()
/*     */   {
/* 205 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SItemTypeInFightCfg> getAll()
/*     */   {
/* 210 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SItemTypeInFightCfg> newAll)
/*     */   {
/* 215 */     oldAll = all;
/* 216 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\fight\confbean\SItemTypeInFightCfg.class
