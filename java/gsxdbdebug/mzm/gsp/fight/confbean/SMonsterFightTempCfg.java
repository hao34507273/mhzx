...
/*     */ 
/*     */ public class SMonsterFightTempCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SMonsterFightTempCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SMonsterFightTempCfg> all = null;
/*     */   
/*     */   public int id;
/*  19 */   public java.util.ArrayList<MonsterProb> monsterProbs = new java.util.ArrayList();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.id = Integer.valueOf(rootElement.attributeValue("id")).intValue();
/*     */     
/*  25 */     Element collectionElement = util.XmlHelper.getVariableElement(rootElement, "monsterProbs");
...
/*  36 */       if (elem.getName().equalsIgnoreCase("mzm.gsp.fight.confbean.MonsterProb"))
/*     */       {
/*     */         MonsterProb _v_;
/*     */         
/*     */ 
...
/*  59 */     _os_.compact_uint32(this.monsterProbs.size());
/*  60 */     for (MonsterProb _v_ : this.monsterProbs)
/*     */     {
/*  62 */       _os_.marshal(_v_);
/*     */     }
/*  64 */     return _os_;
...
/*     */     {
/*     */ 
/*  73 */       MonsterProb _v_ = new MonsterProb();
/*  74 */       _v_.unmarshal(_os_);
/*  75 */       this.monsterProbs.add(_v_);
/*     */     }
/*  77 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/*  82 */     String path = dir + "mzm.gsp.fight.confbean.SMonsterFightTempCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  95 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.fight.confbean.SMonsterFightTempCfg"))
/*     */         {
/*     */ 
/*  98 */           SMonsterFightTempCfg obj = new SMonsterFightTempCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SMonsterFightTempCfg> all)
/*     */   {
/* 112 */     String path = dir + "mzm.gsp.fight.confbean.SMonsterFightTempCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 124 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.fight.confbean.SMonsterFightTempCfg"))
/*     */         {
/*     */ 
/* 127 */           SMonsterFightTempCfg obj = new SMonsterFightTempCfg();
...
/*     */     
/* 143 */     String path = dir + "mzm.gsp.fight.confbean.SMonsterFightTempCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 170 */           SMonsterFightTempCfg _v_ = new SMonsterFightTempCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SMonsterFightTempCfg> all)
/*     */   {
/* 190 */     String path = dir + "mzm.gsp.fight.confbean.SMonsterFightTempCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 217 */           SMonsterFightTempCfg _v_ = new SMonsterFightTempCfg();
...
/*     */ 
/*     */ 
/*     */   public static SMonsterFightTempCfg getOld(int key)
/*     */   {
/* 238 */     return (SMonsterFightTempCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SMonsterFightTempCfg get(int key)
/*     */   {
/* 243 */     return (SMonsterFightTempCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMonsterFightTempCfg> getOldAll()
/*     */   {
/* 248 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMonsterFightTempCfg> getAll()
/*     */   {
/* 253 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SMonsterFightTempCfg> newAll)
/*     */   {
/* 258 */     oldAll = all;
/* 259 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\fight\confbean\SMonsterFightTempCfg.class
