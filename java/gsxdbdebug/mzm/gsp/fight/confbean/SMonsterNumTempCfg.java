...
/*     */ 
/*     */ public class SMonsterNumTempCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SMonsterNumTempCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SMonsterNumTempCfg> all = null;
/*     */   
/*     */   public int id;
/*  19 */   public java.util.ArrayList<Integer> probs = new java.util.ArrayList();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.id = Integer.valueOf(rootElement.attributeValue("id")).intValue();
/*     */     
/*  25 */     Element collectionElement = util.XmlHelper.getVariableElement(rootElement, "probs");
...
/*     */         }
/*     */         
/*  50 */         this.probs.add(Integer.valueOf(_v_));
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*  58 */     _os_.compact_uint32(this.probs.size());
/*  59 */     for (Integer _v_ : this.probs)
/*     */     {
...
/*  73 */       this.probs.add(Integer.valueOf(_v_));
/*     */     }
/*  75 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/*  80 */     String path = dir + "mzm.gsp.fight.confbean.SMonsterNumTempCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.fight.confbean.SMonsterNumTempCfg"))
/*     */         {
/*     */ 
/*  96 */           SMonsterNumTempCfg obj = new SMonsterNumTempCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SMonsterNumTempCfg> all)
/*     */   {
/* 110 */     String path = dir + "mzm.gsp.fight.confbean.SMonsterNumTempCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 122 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.fight.confbean.SMonsterNumTempCfg"))
/*     */         {
/*     */ 
/* 125 */           SMonsterNumTempCfg obj = new SMonsterNumTempCfg();
...
/*     */     
/* 141 */     String path = dir + "mzm.gsp.fight.confbean.SMonsterNumTempCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 168 */           SMonsterNumTempCfg _v_ = new SMonsterNumTempCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SMonsterNumTempCfg> all)
/*     */   {
/* 188 */     String path = dir + "mzm.gsp.fight.confbean.SMonsterNumTempCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 215 */           SMonsterNumTempCfg _v_ = new SMonsterNumTempCfg();
...
/*     */ 
/*     */ 
/*     */   public static SMonsterNumTempCfg getOld(int key)
/*     */   {
/* 236 */     return (SMonsterNumTempCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SMonsterNumTempCfg get(int key)
/*     */   {
/* 241 */     return (SMonsterNumTempCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMonsterNumTempCfg> getOldAll()
/*     */   {
/* 246 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SMonsterNumTempCfg> getAll()
/*     */   {
/* 251 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SMonsterNumTempCfg> newAll)
/*     */   {
/* 256 */     oldAll = all;
/* 257 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\fight\confbean\SMonsterNumTempCfg.class
