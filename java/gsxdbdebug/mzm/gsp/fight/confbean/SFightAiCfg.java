...
/*     */ 
/*     */ public class SFightAiCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SFightAiCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SFightAiCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public String classname;
/*     */   public boolean isBossAi;
/*  21 */   public java.util.ArrayList<String> parameters = new java.util.ArrayList();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  25 */     this.id = Integer.valueOf(rootElement.attributeValue("id")).intValue();
/*  26 */     this.classname = rootElement.attributeValue("classname");
/*  27 */     this.isBossAi = Boolean.valueOf(rootElement.attributeValue("isBossAi")).booleanValue();
/*     */     
/*  29 */     Element collectionElement = util.XmlHelper.getVariableElement(rootElement, "parameters");
...
/*  62 */     _os_.marshal(this.classname, "UTF-8");
/*  63 */     _os_.marshal(this.isBossAi);
/*  64 */     _os_.compact_uint32(this.parameters.size());
/*  65 */     for (String _v_ : this.parameters)
/*     */     {
...
/*  75 */     this.classname = _os_.unmarshal_String("UTF-8");
/*  76 */     this.isBossAi = _os_.unmarshal_boolean();
/*  77 */     for (int _size_ = _os_.uncompact_uint32(); _size_ > 0; _size_--)
/*     */     {
/*     */ 
/*  80 */       String _v_ = _os_.unmarshal_String("UTF-8");
/*  81 */       this.parameters.add(_v_);
/*     */     }
/*  83 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/*  88 */     String path = dir + "mzm.gsp.fight.confbean.SFightAiCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 101 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.fight.confbean.SFightAiCfg"))
/*     */         {
/*     */ 
/* 104 */           SFightAiCfg obj = new SFightAiCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SFightAiCfg> all)
/*     */   {
/* 118 */     String path = dir + "mzm.gsp.fight.confbean.SFightAiCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 130 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.fight.confbean.SFightAiCfg"))
/*     */         {
/*     */ 
/* 133 */           SFightAiCfg obj = new SFightAiCfg();
...
/*     */     
/* 149 */     String path = dir + "mzm.gsp.fight.confbean.SFightAiCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 176 */           SFightAiCfg _v_ = new SFightAiCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SFightAiCfg> all)
/*     */   {
/* 196 */     String path = dir + "mzm.gsp.fight.confbean.SFightAiCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 223 */           SFightAiCfg _v_ = new SFightAiCfg();
...
/*     */ 
/*     */ 
/*     */   public static SFightAiCfg getOld(int key)
/*     */   {
/* 244 */     return (SFightAiCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SFightAiCfg get(int key)
/*     */   {
/* 249 */     return (SFightAiCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SFightAiCfg> getOldAll()
/*     */   {
/* 254 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SFightAiCfg> getAll()
/*     */   {
/* 259 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SFightAiCfg> newAll)
/*     */   {
/* 264 */     oldAll = all;
/* 265 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\fight\confbean\SFightAiCfg.class
