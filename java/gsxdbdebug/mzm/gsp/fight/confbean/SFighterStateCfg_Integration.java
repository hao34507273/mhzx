...
/*     */ 
/*     */ public class SFighterStateCfg_Integration implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SFighterStateCfg_Integration> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SFighterStateCfg_Integration> all = null;
/*     */   
/*     */   public int id;
/*     */   public int groupId;
/*     */   public int state;
...
/*  26 */     this.groupId = Integer.valueOf(rootElement.attributeValue("groupId")).intValue();
/*  27 */     this.state = Integer.valueOf(rootElement.attributeValue("state")).intValue();
...
/*  34 */     _os_.marshal(this.groupId);
/*  35 */     _os_.marshal(this.state);
/*  36 */     _os_.marshal(this.skillId);
/*  37 */     return _os_;
/*     */   }
/*     */   
...
/*  43 */     this.groupId = _os_.unmarshal_int();
...
/*     */   {
/*  51 */     String path = dir + "mzm.gsp.fight.confbean.SFighterStateCfg_Integration.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  64 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.fight.confbean.SFighterStateCfg_Integration"))
/*     */         {
/*     */ 
/*  67 */           SFighterStateCfg_Integration obj = new SFighterStateCfg_Integration();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SFighterStateCfg_Integration> all)
/*     */   {
/*  81 */     String path = dir + "mzm.gsp.fight.confbean.SFighterStateCfg_Integration.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.fight.confbean.SFighterStateCfg_Integration"))
/*     */         {
/*     */ 
/*  96 */           SFighterStateCfg_Integration obj = new SFighterStateCfg_Integration();
...
/*     */     
/* 112 */     String path = dir + "mzm.gsp.fight.confbean.SFighterStateCfg_Integration.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 139 */           SFighterStateCfg_Integration _v_ = new SFighterStateCfg_Integration();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SFighterStateCfg_Integration> all)
/*     */   {
/* 159 */     String path = dir + "mzm.gsp.fight.confbean.SFighterStateCfg_Integration.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 186 */           SFighterStateCfg_Integration _v_ = new SFighterStateCfg_Integration();
...
/*     */ 
/*     */ 
/*     */   public static SFighterStateCfg_Integration getOld(int key)
/*     */   {
/* 207 */     return (SFighterStateCfg_Integration)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SFighterStateCfg_Integration get(int key)
/*     */   {
/* 212 */     return (SFighterStateCfg_Integration)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SFighterStateCfg_Integration> getOldAll()
/*     */   {
/* 217 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SFighterStateCfg_Integration> getAll()
/*     */   {
/* 222 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SFighterStateCfg_Integration> newAll)
/*     */   {
/* 227 */     oldAll = all;
/* 228 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\fight\confbean\SFighterStateCfg_Integration.class
