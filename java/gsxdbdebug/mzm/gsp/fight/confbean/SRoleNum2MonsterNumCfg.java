...
/*     */ 
/*     */ public class SRoleNum2MonsterNumCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SRoleNum2MonsterNumCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SRoleNum2MonsterNumCfg> all = null;
/*     */   
/*     */   public int id;
/*  19 */   public java.util.ArrayList<Integer> monsterNumCfgs = new java.util.ArrayList();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.id = Integer.valueOf(rootElement.attributeValue("id")).intValue();
/*     */     
/*  25 */     Element collectionElement = util.XmlHelper.getVariableElement(rootElement, "monsterNumCfgs");
...
/*     */         }
/*     */         
/*  50 */         this.monsterNumCfgs.add(Integer.valueOf(_v_));
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*  58 */     _os_.compact_uint32(this.monsterNumCfgs.size());
/*  59 */     for (Integer _v_ : this.monsterNumCfgs)
/*     */     {
...
/*  73 */       this.monsterNumCfgs.add(Integer.valueOf(_v_));
/*     */     }
/*  75 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/*  80 */     String path = dir + "mzm.gsp.fight.confbean.SRoleNum2MonsterNumCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.fight.confbean.SRoleNum2MonsterNumCfg"))
/*     */         {
/*     */ 
/*  96 */           SRoleNum2MonsterNumCfg obj = new SRoleNum2MonsterNumCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SRoleNum2MonsterNumCfg> all)
/*     */   {
/* 110 */     String path = dir + "mzm.gsp.fight.confbean.SRoleNum2MonsterNumCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 122 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.fight.confbean.SRoleNum2MonsterNumCfg"))
/*     */         {
/*     */ 
/* 125 */           SRoleNum2MonsterNumCfg obj = new SRoleNum2MonsterNumCfg();
...
/*     */     
/* 141 */     String path = dir + "mzm.gsp.fight.confbean.SRoleNum2MonsterNumCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 168 */           SRoleNum2MonsterNumCfg _v_ = new SRoleNum2MonsterNumCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SRoleNum2MonsterNumCfg> all)
/*     */   {
/* 188 */     String path = dir + "mzm.gsp.fight.confbean.SRoleNum2MonsterNumCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 215 */           SRoleNum2MonsterNumCfg _v_ = new SRoleNum2MonsterNumCfg();
...
/*     */ 
/*     */ 
/*     */   public static SRoleNum2MonsterNumCfg getOld(int key)
/*     */   {
/* 236 */     return (SRoleNum2MonsterNumCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SRoleNum2MonsterNumCfg get(int key)
/*     */   {
/* 241 */     return (SRoleNum2MonsterNumCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SRoleNum2MonsterNumCfg> getOldAll()
/*     */   {
/* 246 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SRoleNum2MonsterNumCfg> getAll()
/*     */   {
/* 251 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SRoleNum2MonsterNumCfg> newAll)
/*     */   {
/* 256 */     oldAll = all;
/* 257 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\fight\confbean\SRoleNum2MonsterNumCfg.class
