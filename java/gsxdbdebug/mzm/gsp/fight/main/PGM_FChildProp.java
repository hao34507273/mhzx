...
/*    */ 
/*    */ public class PGM_FChildProp extends LogicProcedure
/*    */ {
/*    */   private final long gmRoleid;
/*    */   private final long roleid;
/*    */   
/*    */   public PGM_FChildProp(long gmRoleid, long roleid)
/*    */   {
...
/* 32 */       if ((fighter.isChild()) && ((fighter instanceof FighterChild))) {
/* 33 */         FighterChild fighterChild = (FighterChild)fighter;
/* 34 */         if (fighterChild.getOwnerid() == this.roleid) {
/* 35 */           Map<Integer, Integer> propMap = fighter.getFinalPropMap();
/* 36 */           String retResult = PropertyManager.getPropCHNInfo(propMap);
/* 37 */           GmManager.getInstance().sendResultToGM(this.gmRoleid, String.format("子女战斗内属性为:\n%s\r\n乱敏浮动万分比为:%d", new Object[] { retResult, Integer.valueOf(fighter.getExtra(FighterExtra.Speed_Fluctuate_Rate)) }));
/*    */           
/*    */ 
/*    */ 
/* 41 */           return true;
...
/*    */       }
/*    */     }
/* 45 */     GmManager.getInstance().sendResultToGM(this.gmRoleid, "当前结果中没有玩家子女");
/* 46 */     return true;
/*    */   }
/*    */ }


/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\fight\main\PGM_FChildProp.class
