...
/*    */ 
/*    */ public class PGM_FighterProp extends LogicProcedure
/*    */ {
/*    */   private final long gmRoleid;
/*    */   private final long roleid;
/*    */   
/*    */   public PGM_FighterProp(long gmRoleid, long roleid)
/*    */   {
...
/* 32 */       if ((fighter.isRole()) && ((fighter instanceof FighterRole))) {
/* 33 */         FighterRole fighterRole = (FighterRole)fighter;
/* 34 */         if (fighterRole.getRoleid() == this.roleid) {
/* 35 */           Map<Integer, Integer> propMap = fighter.getFinalPropMap();
/* 36 */           String retResult = PropertyManager.getPropCHNInfo(propMap);
/* 37 */           GmManager.getInstance().sendResultToGM(this.gmRoleid, String.format("玩家战斗内属性为:\n%s\r\n乱敏浮动万分比为:%d", new Object[] { retResult, Integer.valueOf(fighter.getExtra(FighterExtra.Speed_Fluctuate_Rate)) }));
/*    */           
/*    */ 
/*    */ 
/* 41 */           return true;
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\fight\main\PGM_FighterProp.class
