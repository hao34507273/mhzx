...
/*     */ 
/*     */ 
/*     */ public class SSynRoleChildSkillInfo
/*     */   extends __SSynRoleChildSkillInfo__
/*     */ {
/*     */   public static final int PROTOCOL_TYPE = 12594213;
/*     */   public long fight_uuid;
/*     */   public long childrenuuid;
...
/*     */ 
/*     */ 
/*     */   public SSynRoleChildSkillInfo()
/*     */   {
/*  36 */     this.skillmap = new HashMap();
/*     */   }
/*     */   
/*     */   public SSynRoleChildSkillInfo(long _fight_uuid_, long _childrenuuid_, HashMap<Integer, Integer> _skillmap_, int _seq_) {
/*  40 */     this.fight_uuid = _fight_uuid_;
/*  41 */     this.childrenuuid = _childrenuuid_;
...
/*  52 */     _os_.marshal(this.childrenuuid);
...
/*  64 */     this.childrenuuid = _os_.unmarshal_long();
...
/*  81 */     if ((_o1_ instanceof SSynRoleChildSkillInfo)) {
/*  82 */       SSynRoleChildSkillInfo _o_ = (SSynRoleChildSkillInfo)_o1_;
/*  83 */       if (this.fight_uuid != _o_.fight_uuid) return false;
/*  84 */       if (this.childrenuuid != _o_.childrenuuid) return false;
...
/* 105 */     _sb_.append(this.childrenuuid).append(",");
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\fight\SSynRoleChildSkillInfo.class
