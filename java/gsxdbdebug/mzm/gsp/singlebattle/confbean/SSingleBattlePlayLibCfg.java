...
/*     */ 
/*     */ public class SSingleBattlePlayLibCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SSingleBattlePlayLibCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SSingleBattlePlayLibCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public int playLibId;
/*     */   public int type;
/*     */   public int playCfgId;
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  25 */     this.id = Integer.valueOf(rootElement.attributeValue("id")).intValue();
/*  26 */     this.playLibId = Integer.valueOf(rootElement.attributeValue("playLibId")).intValue();
/*  27 */     this.type = Integer.valueOf(rootElement.attributeValue("type")).intValue();
/*  28 */     this.playCfgId = Integer.valueOf(rootElement.attributeValue("playCfgId")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  33 */     _os_.marshal(this.id);
/*  34 */     _os_.marshal(this.playLibId);
/*  35 */     _os_.marshal(this.type);
/*  36 */     _os_.marshal(this.playCfgId);
/*  37 */     return _os_;
/*     */   }
/*     */   
...
/*  43 */     this.playLibId = _os_.unmarshal_int();
/*  44 */     this.type = _os_.unmarshal_int();
/*  45 */     this.playCfgId = _os_.unmarshal_int();
/*  46 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  51 */     String path = dir + "mzm.gsp.singlebattle.confbean.SSingleBattlePlayLibCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  64 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.singlebattle.confbean.SSingleBattlePlayLibCfg"))
/*     */         {
/*     */ 
/*  67 */           SSingleBattlePlayLibCfg obj = new SSingleBattlePlayLibCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SSingleBattlePlayLibCfg> all)
/*     */   {
/*  81 */     String path = dir + "mzm.gsp.singlebattle.confbean.SSingleBattlePlayLibCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.singlebattle.confbean.SSingleBattlePlayLibCfg"))
/*     */         {
/*     */ 
/*  96 */           SSingleBattlePlayLibCfg obj = new SSingleBattlePlayLibCfg();
...
/*     */     
/* 112 */     String path = dir + "mzm.gsp.singlebattle.confbean.SSingleBattlePlayLibCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 139 */           SSingleBattlePlayLibCfg _v_ = new SSingleBattlePlayLibCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SSingleBattlePlayLibCfg> all)
/*     */   {
/* 159 */     String path = dir + "mzm.gsp.singlebattle.confbean.SSingleBattlePlayLibCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 186 */           SSingleBattlePlayLibCfg _v_ = new SSingleBattlePlayLibCfg();
...
/*     */ 
/*     */ 
/*     */   public static SSingleBattlePlayLibCfg getOld(int key)
/*     */   {
/* 207 */     return (SSingleBattlePlayLibCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SSingleBattlePlayLibCfg get(int key)
/*     */   {
/* 212 */     return (SSingleBattlePlayLibCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SSingleBattlePlayLibCfg> getOldAll()
/*     */   {
/* 217 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SSingleBattlePlayLibCfg> getAll()
/*     */   {
/* 222 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SSingleBattlePlayLibCfg> newAll)
/*     */   {
/* 227 */     oldAll = all;
/* 228 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\singlebattle\confbean\SSingleBattlePlayLibCfg.class
