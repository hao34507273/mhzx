...
/*     */ 
/*     */ public class BuffCfgid2InfoCfgidCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, BuffCfgid2InfoCfgidCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, BuffCfgid2InfoCfgidCfg> all = null;
/*     */   
...
/*  24 */     this.buff_info_cfg_id = Integer.valueOf(rootElement.attributeValue("buff_info_cfg_id")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  29 */     _os_.marshal(this.buff_cfg_id);
/*  30 */     _os_.marshal(this.buff_info_cfg_id);
/*  31 */     return _os_;
/*     */   }
/*     */   
/*     */   public OctetsStream unmarshal(OctetsStream _os_) throws com.goldhuman.Common.Marshal.MarshalException
/*     */   {
/*  36 */     this.buff_cfg_id = _os_.unmarshal_int();
/*  37 */     this.buff_info_cfg_id = _os_.unmarshal_int();
/*  38 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.singlebattle.confbean.BuffCfgid2InfoCfgidCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.singlebattle.confbean.BuffCfgid2InfoCfgidCfg"))
/*     */         {
/*     */ 
/*  59 */           BuffCfgid2InfoCfgidCfg obj = new BuffCfgid2InfoCfgidCfg();
/*  60 */           obj.loadFromXml(elem);
/*  61 */           if (all.put(Integer.valueOf(obj.buff_cfg_id), obj) != null) {
/*  62 */             throw new RuntimeException("duplicate key : " + obj.buff_cfg_id);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, BuffCfgid2InfoCfgidCfg> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.singlebattle.confbean.BuffCfgid2InfoCfgidCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.singlebattle.confbean.BuffCfgid2InfoCfgidCfg"))
/*     */         {
/*     */ 
/*  88 */           BuffCfgid2InfoCfgidCfg obj = new BuffCfgid2InfoCfgidCfg();
/*  89 */           obj.loadFromXml(elem);
/*  90 */           if (all.put(Integer.valueOf(obj.buff_cfg_id), obj) != null) {
/*  91 */             throw new RuntimeException("duplicate key : " + obj.buff_cfg_id);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.singlebattle.confbean.BuffCfgid2InfoCfgidCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           BuffCfgid2InfoCfgidCfg _v_ = new BuffCfgid2InfoCfgidCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, BuffCfgid2InfoCfgidCfg> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.singlebattle.confbean.BuffCfgid2InfoCfgidCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           BuffCfgid2InfoCfgidCfg _v_ = new BuffCfgid2InfoCfgidCfg();
...
/*     */ 
/*     */ 
/*     */   public static BuffCfgid2InfoCfgidCfg getOld(int key)
/*     */   {
/* 199 */     return (BuffCfgid2InfoCfgidCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static BuffCfgid2InfoCfgidCfg get(int key)
/*     */   {
/* 204 */     return (BuffCfgid2InfoCfgidCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, BuffCfgid2InfoCfgidCfg> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, BuffCfgid2InfoCfgidCfg> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, BuffCfgid2InfoCfgidCfg> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\singlebattle\confbean\BuffCfgid2InfoCfgidCfg.class
