...
/*     */ 
/*     */ public class SGatherItemCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SGatherItemCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SGatherItemCfg> all = null;
/*     */   
/*     */   public int id;
...
/*  27 */     this.gatherItemname = rootElement.attributeValue("gatherItemname");
/*  28 */     this.gatherInterval = Integer.valueOf(rootElement.attributeValue("gatherInterval")).intValue();
/*  29 */     this.source = Integer.valueOf(rootElement.attributeValue("source")).intValue();
...
/*  36 */     _os_.marshal(this.gatherItemname, "UTF-8");
/*  37 */     _os_.marshal(this.gatherInterval);
/*  38 */     _os_.marshal(this.source);
/*  39 */     _os_.marshal(this.modelId);
/*  40 */     return _os_;
/*     */   }
/*     */   
...
/*  46 */     this.gatherItemname = _os_.unmarshal_String("UTF-8");
/*  47 */     this.gatherInterval = _os_.unmarshal_int();
/*  48 */     this.source = _os_.unmarshal_int();
/*  49 */     this.modelId = _os_.unmarshal_int();
/*  50 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  55 */     String path = dir + "mzm.gsp.singlebattle.confbean.SGatherItemCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  68 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.singlebattle.confbean.SGatherItemCfg"))
/*     */         {
/*     */ 
/*  71 */           SGatherItemCfg obj = new SGatherItemCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SGatherItemCfg> all)
/*     */   {
/*  85 */     String path = dir + "mzm.gsp.singlebattle.confbean.SGatherItemCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  97 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.singlebattle.confbean.SGatherItemCfg"))
/*     */         {
/*     */ 
/* 100 */           SGatherItemCfg obj = new SGatherItemCfg();
...
/*     */     
/* 116 */     String path = dir + "mzm.gsp.singlebattle.confbean.SGatherItemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 143 */           SGatherItemCfg _v_ = new SGatherItemCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SGatherItemCfg> all)
/*     */   {
/* 163 */     String path = dir + "mzm.gsp.singlebattle.confbean.SGatherItemCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 190 */           SGatherItemCfg _v_ = new SGatherItemCfg();
...
/*     */ 
/*     */ 
/*     */   public static SGatherItemCfg getOld(int key)
/*     */   {
/* 211 */     return (SGatherItemCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SGatherItemCfg get(int key)
/*     */   {
/* 216 */     return (SGatherItemCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SGatherItemCfg> getOldAll()
/*     */   {
/* 221 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SGatherItemCfg> getAll()
/*     */   {
/* 226 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SGatherItemCfg> newAll)
/*     */   {
/* 231 */     oldAll = all;
/* 232 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\singlebattle\confbean\SGatherItemCfg.class
