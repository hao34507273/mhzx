...
/*     */ 
/*     */ public class STSingleBattlePlayLibCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, STSingleBattlePlayLibCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, STSingleBattlePlayLibCfg> all = null;
/*     */   
/*     */   public int playLibId;
/*  19 */   public HashMap<Integer, Integer> type2cfgId = new HashMap();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.playLibId = Integer.valueOf(rootElement.attributeValue("playLibId")).intValue();
/*     */     
/*  25 */     Element mapTypeElement = util.XmlHelper.getVariableElement(rootElement, "type2cfgId");
...
/*     */         }
/*     */         
/*  76 */         this.type2cfgId.put(Integer.valueOf(_k_), Integer.valueOf(_v_));
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*     */   {
/*  83 */     _os_.marshal(this.playLibId);
/*  84 */     _os_.compact_uint32(this.type2cfgId.size());
/*  85 */     for (java.util.Map.Entry<Integer, Integer> _e_ : this.type2cfgId.entrySet())
/*     */     {
...
/*     */   {
/*  95 */     this.playLibId = _os_.unmarshal_int();
...
/* 102 */       this.type2cfgId.put(Integer.valueOf(_k_), Integer.valueOf(_v_));
/*     */     }
/* 104 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/* 109 */     String path = dir + "mzm.gsp.singlebattle.confbean.STSingleBattlePlayLibCfg.xml";
/*     */     
/*     */     try
/*     */     {
/* 113 */       all = new HashMap();
...
/* 122 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.singlebattle.confbean.STSingleBattlePlayLibCfg"))
/*     */         {
/*     */ 
/* 125 */           STSingleBattlePlayLibCfg obj = new STSingleBattlePlayLibCfg();
/* 126 */           obj.loadFromXml(elem);
/* 127 */           if (all.put(Integer.valueOf(obj.playLibId), obj) != null) {
/* 128 */             throw new RuntimeException("duplicate key : " + obj.playLibId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, STSingleBattlePlayLibCfg> all)
/*     */   {
/* 139 */     String path = dir + "mzm.gsp.singlebattle.confbean.STSingleBattlePlayLibCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 151 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.singlebattle.confbean.STSingleBattlePlayLibCfg"))
/*     */         {
/*     */ 
/* 154 */           STSingleBattlePlayLibCfg obj = new STSingleBattlePlayLibCfg();
/* 155 */           obj.loadFromXml(elem);
/* 156 */           if (all.put(Integer.valueOf(obj.playLibId), obj) != null) {
/* 157 */             throw new RuntimeException("duplicate key : " + obj.playLibId);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/* 168 */     all = new HashMap();
/*     */     
/* 170 */     String path = dir + "mzm.gsp.singlebattle.confbean.STSingleBattlePlayLibCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 197 */           STSingleBattlePlayLibCfg _v_ = new STSingleBattlePlayLibCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, STSingleBattlePlayLibCfg> all)
/*     */   {
/* 217 */     String path = dir + "mzm.gsp.singlebattle.confbean.STSingleBattlePlayLibCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 244 */           STSingleBattlePlayLibCfg _v_ = new STSingleBattlePlayLibCfg();
...
/*     */ 
/*     */ 
/*     */   public static STSingleBattlePlayLibCfg getOld(int key)
/*     */   {
/* 265 */     return (STSingleBattlePlayLibCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static STSingleBattlePlayLibCfg get(int key)
/*     */   {
/* 270 */     return (STSingleBattlePlayLibCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, STSingleBattlePlayLibCfg> getOldAll()
/*     */   {
/* 275 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, STSingleBattlePlayLibCfg> getAll()
/*     */   {
/* 280 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, STSingleBattlePlayLibCfg> newAll)
/*     */   {
/* 285 */     oldAll = all;
/* 286 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\singlebattle\confbean\STSingleBattlePlayLibCfg.class
