...
/*     */ 
/*     */ public class STPersonalTaskCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, STPersonalTaskCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, STPersonalTaskCfg> all = null;
/*     */   
/*     */   public int id;
...
/*     */   {
/*  80 */     String path = dir + "mzm.gsp.singlebattle.confbean.STPersonalTaskCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.singlebattle.confbean.STPersonalTaskCfg"))
/*     */         {
/*     */ 
/*  96 */           STPersonalTaskCfg obj = new STPersonalTaskCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, STPersonalTaskCfg> all)
/*     */   {
/* 110 */     String path = dir + "mzm.gsp.singlebattle.confbean.STPersonalTaskCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 122 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.singlebattle.confbean.STPersonalTaskCfg"))
/*     */         {
/*     */ 
/* 125 */           STPersonalTaskCfg obj = new STPersonalTaskCfg();
...
/*     */     
/* 141 */     String path = dir + "mzm.gsp.singlebattle.confbean.STPersonalTaskCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 168 */           STPersonalTaskCfg _v_ = new STPersonalTaskCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, STPersonalTaskCfg> all)
/*     */   {
/* 188 */     String path = dir + "mzm.gsp.singlebattle.confbean.STPersonalTaskCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 215 */           STPersonalTaskCfg _v_ = new STPersonalTaskCfg();
...
/*     */ 
/*     */ 
/*     */   public static STPersonalTaskCfg getOld(int key)
/*     */   {
/* 236 */     return (STPersonalTaskCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static STPersonalTaskCfg get(int key)
/*     */   {
/* 241 */     return (STPersonalTaskCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, STPersonalTaskCfg> getOldAll()
/*     */   {
/* 246 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, STPersonalTaskCfg> getAll()
/*     */   {
/* 251 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, STPersonalTaskCfg> newAll)
/*     */   {
/* 256 */     oldAll = all;
/* 257 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\singlebattle\confbean\STPersonalTaskCfg.class
