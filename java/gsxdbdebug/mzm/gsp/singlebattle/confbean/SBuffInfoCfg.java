...
/*     */ 
/*     */ public class SBuffInfoCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SBuffInfoCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SBuffInfoCfg> all = null;
/*     */   
/*     */   public int id;
...
/*  25 */     this.buff_cfg_id = Integer.valueOf(rootElement.attributeValue("buff_cfg_id")).intValue();
...
/*  40 */     this.buff_cfg_id = _os_.unmarshal_int();
...
/*     */   {
/*  47 */     String path = dir + "mzm.gsp.singlebattle.confbean.SBuffInfoCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  60 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.singlebattle.confbean.SBuffInfoCfg"))
/*     */         {
/*     */ 
/*  63 */           SBuffInfoCfg obj = new SBuffInfoCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SBuffInfoCfg> all)
/*     */   {
/*  77 */     String path = dir + "mzm.gsp.singlebattle.confbean.SBuffInfoCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  89 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.singlebattle.confbean.SBuffInfoCfg"))
/*     */         {
/*     */ 
/*  92 */           SBuffInfoCfg obj = new SBuffInfoCfg();
...
/*     */     
/* 108 */     String path = dir + "mzm.gsp.singlebattle.confbean.SBuffInfoCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 135 */           SBuffInfoCfg _v_ = new SBuffInfoCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SBuffInfoCfg> all)
/*     */   {
/* 155 */     String path = dir + "mzm.gsp.singlebattle.confbean.SBuffInfoCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 182 */           SBuffInfoCfg _v_ = new SBuffInfoCfg();
...
/*     */ 
/*     */ 
/*     */   public static SBuffInfoCfg getOld(int key)
/*     */   {
/* 203 */     return (SBuffInfoCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SBuffInfoCfg get(int key)
/*     */   {
/* 208 */     return (SBuffInfoCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SBuffInfoCfg> getOldAll()
/*     */   {
/* 213 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SBuffInfoCfg> getAll()
/*     */   {
/* 218 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SBuffInfoCfg> newAll)
/*     */   {
/* 223 */     oldAll = all;
/* 224 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\singlebattle\confbean\SBuffInfoCfg.class
