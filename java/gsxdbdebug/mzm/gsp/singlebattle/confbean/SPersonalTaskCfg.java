...
/*     */ 
/*     */ public class SPersonalTaskCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SPersonalTaskCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SPersonalTaskCfg> all = null;
/*     */   
/*     */   public int id;
...
/*  24 */     this.taskLibId = Integer.valueOf(rootElement.attributeValue("taskLibId")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  29 */     _os_.marshal(this.id);
/*  30 */     _os_.marshal(this.taskLibId);
/*  31 */     return _os_;
/*     */   }
/*     */   
...
/*  37 */     this.taskLibId = _os_.unmarshal_int();
/*  38 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.singlebattle.confbean.SPersonalTaskCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.singlebattle.confbean.SPersonalTaskCfg"))
/*     */         {
/*     */ 
/*  59 */           SPersonalTaskCfg obj = new SPersonalTaskCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SPersonalTaskCfg> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.singlebattle.confbean.SPersonalTaskCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.singlebattle.confbean.SPersonalTaskCfg"))
/*     */         {
/*     */ 
/*  88 */           SPersonalTaskCfg obj = new SPersonalTaskCfg();
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.singlebattle.confbean.SPersonalTaskCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           SPersonalTaskCfg _v_ = new SPersonalTaskCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SPersonalTaskCfg> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.singlebattle.confbean.SPersonalTaskCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           SPersonalTaskCfg _v_ = new SPersonalTaskCfg();
...
/*     */ 
/*     */ 
/*     */   public static SPersonalTaskCfg getOld(int key)
/*     */   {
/* 199 */     return (SPersonalTaskCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SPersonalTaskCfg get(int key)
/*     */   {
/* 204 */     return (SPersonalTaskCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPersonalTaskCfg> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SPersonalTaskCfg> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SPersonalTaskCfg> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\singlebattle\confbean\SPersonalTaskCfg.class
