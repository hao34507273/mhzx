...
/*     */ 
/*     */ public class AntiAFKCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, AntiAFKCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, AntiAFKCfg> all = null;
/*     */   
/*     */   public int id;
...
/*  24 */     this.afk_detect_cfg_id = Integer.valueOf(rootElement.attributeValue("afk_detect_cfg_id")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  29 */     _os_.marshal(this.id);
/*  30 */     _os_.marshal(this.afk_detect_cfg_id);
/*  31 */     return _os_;
/*     */   }
/*     */   
...
/*  37 */     this.afk_detect_cfg_id = _os_.unmarshal_int();
/*  38 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.singlebattle.confbean.AntiAFKCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.singlebattle.confbean.AntiAFKCfg"))
/*     */         {
/*     */ 
/*  59 */           AntiAFKCfg obj = new AntiAFKCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, AntiAFKCfg> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.singlebattle.confbean.AntiAFKCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.singlebattle.confbean.AntiAFKCfg"))
/*     */         {
/*     */ 
/*  88 */           AntiAFKCfg obj = new AntiAFKCfg();
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.singlebattle.confbean.AntiAFKCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           AntiAFKCfg _v_ = new AntiAFKCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, AntiAFKCfg> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.singlebattle.confbean.AntiAFKCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           AntiAFKCfg _v_ = new AntiAFKCfg();
...
/*     */ 
/*     */ 
/*     */   public static AntiAFKCfg getOld(int key)
/*     */   {
/* 199 */     return (AntiAFKCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static AntiAFKCfg get(int key)
/*     */   {
/* 204 */     return (AntiAFKCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, AntiAFKCfg> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, AntiAFKCfg> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, AntiAFKCfg> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\singlebattle\confbean\AntiAFKCfg.class
