...
/*     */ 
/*     */ public class SCampCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SCampCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SCampCfg> all = null;
/*     */   
/*     */   public int id;
...
/*  26 */     this.campName = rootElement.attributeValue("campName");
/*  27 */     this.enterX = Integer.valueOf(rootElement.attributeValue("enterX")).intValue();
/*  28 */     this.enterY = Integer.valueOf(rootElement.attributeValue("enterY")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  33 */     _os_.marshal(this.id);
/*  34 */     _os_.marshal(this.campName, "UTF-8");
/*  35 */     _os_.marshal(this.enterX);
/*  36 */     _os_.marshal(this.enterY);
/*  37 */     return _os_;
/*     */   }
/*     */   
...
/*  43 */     this.campName = _os_.unmarshal_String("UTF-8");
/*  44 */     this.enterX = _os_.unmarshal_int();
/*  45 */     this.enterY = _os_.unmarshal_int();
/*  46 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  51 */     String path = dir + "mzm.gsp.singlebattle.confbean.SCampCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  64 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.singlebattle.confbean.SCampCfg"))
/*     */         {
/*     */ 
/*  67 */           SCampCfg obj = new SCampCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SCampCfg> all)
/*     */   {
/*  81 */     String path = dir + "mzm.gsp.singlebattle.confbean.SCampCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.singlebattle.confbean.SCampCfg"))
/*     */         {
/*     */ 
/*  96 */           SCampCfg obj = new SCampCfg();
...
/*     */     
/* 112 */     String path = dir + "mzm.gsp.singlebattle.confbean.SCampCfg.bny";
/*     */     try
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SCampCfg> all)
/*     */   {
/* 159 */     String path = dir + "mzm.gsp.singlebattle.confbean.SCampCfg.bny";
/*     */     try
/*     */     {
...
/*     */ 
/*     */ 
/*     */   public static SCampCfg getOld(int key)
/*     */   {
/* 207 */     return (SCampCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SCampCfg get(int key)
/*     */   {
/* 212 */     return (SCampCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SCampCfg> getOldAll()
/*     */   {
/* 217 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SCampCfg> getAll()
/*     */   {
/* 222 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SCampCfg> newAll)
/*     */   {
/* 227 */     oldAll = all;
/* 228 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\singlebattle\confbean\SCampCfg.class
