...
/*     */ 
/*     */ public class SGatherItemWeightCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SGatherItemWeightCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SGatherItemWeightCfg> all = null;
/*     */   
/*     */   public int id;
...
/*  26 */     this.gatherItemWeightLibId = Integer.valueOf(rootElement.attributeValue("gatherItemWeightLibId")).intValue();
/*  27 */     this.gatherItemCfgId = Integer.valueOf(rootElement.attributeValue("gatherItemCfgId")).intValue();
...
/*  34 */     _os_.marshal(this.gatherItemWeightLibId);
/*  35 */     _os_.marshal(this.gatherItemCfgId);
...
/*  43 */     this.gatherItemWeightLibId = _os_.unmarshal_int();
/*  44 */     this.gatherItemCfgId = _os_.unmarshal_int();
...
/*     */   {
/*  51 */     String path = dir + "mzm.gsp.singlebattle.confbean.SGatherItemWeightCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  64 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.singlebattle.confbean.SGatherItemWeightCfg"))
/*     */         {
/*     */ 
/*  67 */           SGatherItemWeightCfg obj = new SGatherItemWeightCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SGatherItemWeightCfg> all)
/*     */   {
/*  81 */     String path = dir + "mzm.gsp.singlebattle.confbean.SGatherItemWeightCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.singlebattle.confbean.SGatherItemWeightCfg"))
/*     */         {
/*     */ 
/*  96 */           SGatherItemWeightCfg obj = new SGatherItemWeightCfg();
...
/*     */     
/* 112 */     String path = dir + "mzm.gsp.singlebattle.confbean.SGatherItemWeightCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 139 */           SGatherItemWeightCfg _v_ = new SGatherItemWeightCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SGatherItemWeightCfg> all)
/*     */   {
/* 159 */     String path = dir + "mzm.gsp.singlebattle.confbean.SGatherItemWeightCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 186 */           SGatherItemWeightCfg _v_ = new SGatherItemWeightCfg();
...
/*     */ 
/*     */ 
/*     */   public static SGatherItemWeightCfg getOld(int key)
/*     */   {
/* 207 */     return (SGatherItemWeightCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SGatherItemWeightCfg get(int key)
/*     */   {
/* 212 */     return (SGatherItemWeightCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SGatherItemWeightCfg> getOldAll()
/*     */   {
/* 217 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SGatherItemWeightCfg> getAll()
/*     */   {
/* 222 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SGatherItemWeightCfg> newAll)
/*     */   {
/* 227 */     oldAll = all;
/* 228 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\singlebattle\confbean\SGatherItemWeightCfg.class
