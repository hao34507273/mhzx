...
/*     */ 
/*     */ public class SLeaderBuffInfoCfg extends SBuffInfoCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  15 */   private static volatile Map<Integer, SLeaderBuffInfoCfg> oldAll = null;
/*     */   
/*  17 */   private static Map<Integer, SLeaderBuffInfoCfg> all = null;
/*     */   
/*     */   public int resource_multiple;
/*     */   
...
/*  26 */     this.resource_multiple = Integer.valueOf(rootElement.attributeValue("resource_multiple")).intValue();
/*     */   }
/*     */   
...
/*  34 */     _os_.marshal(this.resource_multiple);
/*  35 */     return _os_;
/*     */   }
/*     */   
...
/*  43 */     this.resource_multiple = _os_.unmarshal_int();
/*  44 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  49 */     String path = dir + "mzm.gsp.singlebattle.confbean.SLeaderBuffInfoCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  62 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.singlebattle.confbean.SLeaderBuffInfoCfg"))
/*     */         {
/*     */ 
/*  65 */           SLeaderBuffInfoCfg obj = new SLeaderBuffInfoCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SLeaderBuffInfoCfg> all)
/*     */   {
/*  79 */     String path = dir + "mzm.gsp.singlebattle.confbean.SLeaderBuffInfoCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  91 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.singlebattle.confbean.SLeaderBuffInfoCfg"))
/*     */         {
/*     */ 
/*  94 */           SLeaderBuffInfoCfg obj = new SLeaderBuffInfoCfg();
...
/*     */     
/* 110 */     String path = dir + "mzm.gsp.singlebattle.confbean.SLeaderBuffInfoCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 137 */           SLeaderBuffInfoCfg _v_ = new SLeaderBuffInfoCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SLeaderBuffInfoCfg> all)
/*     */   {
/* 157 */     String path = dir + "mzm.gsp.singlebattle.confbean.SLeaderBuffInfoCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 184 */           SLeaderBuffInfoCfg _v_ = new SLeaderBuffInfoCfg();
...
/*     */   {
/* 203 */     for (Map.Entry<Integer, SLeaderBuffInfoCfg> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static void handleData(Map<Integer, SLeaderBuffInfoCfg> all, Map<Integer, SBuffInfoCfg> parent)
/*     */   {
/* 218 */     for (Map.Entry<Integer, SLeaderBuffInfoCfg> entry : all.entrySet())
/*     */     {
...
/*     */   
/*     */ 
/*     */   public static SLeaderBuffInfoCfg getOld(int key)
/*     */   {
/* 233 */     return (SLeaderBuffInfoCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SLeaderBuffInfoCfg get(int key)
/*     */   {
/* 238 */     return (SLeaderBuffInfoCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SLeaderBuffInfoCfg> getOldAllSelf()
/*     */   {
/* 243 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SLeaderBuffInfoCfg> getAllSelf()
/*     */   {
/* 248 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SLeaderBuffInfoCfg> newAll)
/*     */   {
/* 253 */     oldAll = all;
/* 254 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\singlebattle\confbean\SLeaderBuffInfoCfg.class
