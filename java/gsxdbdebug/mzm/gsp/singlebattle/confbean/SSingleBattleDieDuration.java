...
/*     */ 
/*     */ public class SSingleBattleDieDuration implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SSingleBattleDieDuration> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SSingleBattleDieDuration> all = null;
/*     */   
/*     */   public int dieCount;
/*     */   public int duration;
/*     */   
...
/*     */   {
/*  23 */     this.dieCount = Integer.valueOf(rootElement.attributeValue("dieCount")).intValue();
/*  24 */     this.duration = Integer.valueOf(rootElement.attributeValue("duration")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  29 */     _os_.marshal(this.dieCount);
/*  30 */     _os_.marshal(this.duration);
/*  31 */     return _os_;
/*     */   }
/*     */   
...
/*  37 */     this.duration = _os_.unmarshal_int();
/*  38 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.singlebattle.confbean.SSingleBattleDieDuration.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.singlebattle.confbean.SSingleBattleDieDuration"))
/*     */         {
/*     */ 
/*  59 */           SSingleBattleDieDuration obj = new SSingleBattleDieDuration();
/*  60 */           obj.loadFromXml(elem);
/*  61 */           if (all.put(Integer.valueOf(obj.dieCount), obj) != null) {
/*  62 */             throw new RuntimeException("duplicate key : " + obj.dieCount);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SSingleBattleDieDuration> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.singlebattle.confbean.SSingleBattleDieDuration.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.singlebattle.confbean.SSingleBattleDieDuration"))
/*     */         {
/*     */ 
/*  88 */           SSingleBattleDieDuration obj = new SSingleBattleDieDuration();
/*  89 */           obj.loadFromXml(elem);
/*  90 */           if (all.put(Integer.valueOf(obj.dieCount), obj) != null) {
/*  91 */             throw new RuntimeException("duplicate key : " + obj.dieCount);
/*     */           }
/*     */         }
/*     */       }
/*     */     } catch (Exception e) {
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.singlebattle.confbean.SSingleBattleDieDuration.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           SSingleBattleDieDuration _v_ = new SSingleBattleDieDuration();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SSingleBattleDieDuration> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.singlebattle.confbean.SSingleBattleDieDuration.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           SSingleBattleDieDuration _v_ = new SSingleBattleDieDuration();
...
/*     */ 
/*     */ 
/*     */   public static SSingleBattleDieDuration getOld(int key)
/*     */   {
/* 199 */     return (SSingleBattleDieDuration)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SSingleBattleDieDuration get(int key)
/*     */   {
/* 204 */     return (SSingleBattleDieDuration)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SSingleBattleDieDuration> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SSingleBattleDieDuration> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SSingleBattleDieDuration> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\singlebattle\confbean\SSingleBattleDieDuration.class
