...
/*     */ 
/*     */ public class SGrabPositionCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SGrabPositionCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SGrabPositionCfg> all = null;
/*     */   
/*     */   public int id;
...
/*  24 */     this.positionLibId = Integer.valueOf(rootElement.attributeValue("positionLibId")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  29 */     _os_.marshal(this.id);
/*  30 */     _os_.marshal(this.positionLibId);
/*  31 */     return _os_;
/*     */   }
/*     */   
...
/*  37 */     this.positionLibId = _os_.unmarshal_int();
/*  38 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  43 */     String path = dir + "mzm.gsp.singlebattle.confbean.SGrabPositionCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  56 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.singlebattle.confbean.SGrabPositionCfg"))
/*     */         {
/*     */ 
/*  59 */           SGrabPositionCfg obj = new SGrabPositionCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SGrabPositionCfg> all)
/*     */   {
/*  73 */     String path = dir + "mzm.gsp.singlebattle.confbean.SGrabPositionCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  85 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.singlebattle.confbean.SGrabPositionCfg"))
/*     */         {
/*     */ 
/*  88 */           SGrabPositionCfg obj = new SGrabPositionCfg();
...
/*     */     
/* 104 */     String path = dir + "mzm.gsp.singlebattle.confbean.SGrabPositionCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 131 */           SGrabPositionCfg _v_ = new SGrabPositionCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SGrabPositionCfg> all)
/*     */   {
/* 151 */     String path = dir + "mzm.gsp.singlebattle.confbean.SGrabPositionCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 178 */           SGrabPositionCfg _v_ = new SGrabPositionCfg();
...
/*     */ 
/*     */ 
/*     */   public static SGrabPositionCfg getOld(int key)
/*     */   {
/* 199 */     return (SGrabPositionCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SGrabPositionCfg get(int key)
/*     */   {
/* 204 */     return (SGrabPositionCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SGrabPositionCfg> getOldAll()
/*     */   {
/* 209 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SGrabPositionCfg> getAll()
/*     */   {
/* 214 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SGrabPositionCfg> newAll)
/*     */   {
/* 219 */     oldAll = all;
/* 220 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\singlebattle\confbean\SGrabPositionCfg.class
