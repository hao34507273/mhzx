...
/*     */ 
/*     */ public class SBattleTaskLibCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SBattleTaskLibCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SBattleTaskLibCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public int taskLibId;
/*     */   public int taskId;
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  24 */     this.id = Integer.valueOf(rootElement.attributeValue("id")).intValue();
/*  25 */     this.taskLibId = Integer.valueOf(rootElement.attributeValue("taskLibId")).intValue();
/*  26 */     this.taskId = Integer.valueOf(rootElement.attributeValue("taskId")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  31 */     _os_.marshal(this.id);
/*  32 */     _os_.marshal(this.taskLibId);
...
/*  40 */     this.taskLibId = _os_.unmarshal_int();
/*  41 */     this.taskId = _os_.unmarshal_int();
/*  42 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  47 */     String path = dir + "mzm.gsp.singlebattle.confbean.SBattleTaskLibCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  60 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.singlebattle.confbean.SBattleTaskLibCfg"))
/*     */         {
/*     */ 
/*  63 */           SBattleTaskLibCfg obj = new SBattleTaskLibCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SBattleTaskLibCfg> all)
/*     */   {
/*  77 */     String path = dir + "mzm.gsp.singlebattle.confbean.SBattleTaskLibCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  89 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.singlebattle.confbean.SBattleTaskLibCfg"))
/*     */         {
/*     */ 
/*  92 */           SBattleTaskLibCfg obj = new SBattleTaskLibCfg();
...
/*     */     
/* 108 */     String path = dir + "mzm.gsp.singlebattle.confbean.SBattleTaskLibCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 135 */           SBattleTaskLibCfg _v_ = new SBattleTaskLibCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SBattleTaskLibCfg> all)
/*     */   {
/* 155 */     String path = dir + "mzm.gsp.singlebattle.confbean.SBattleTaskLibCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 182 */           SBattleTaskLibCfg _v_ = new SBattleTaskLibCfg();
...
/*     */ 
/*     */ 
/*     */   public static SBattleTaskLibCfg getOld(int key)
/*     */   {
/* 203 */     return (SBattleTaskLibCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SBattleTaskLibCfg get(int key)
/*     */   {
/* 208 */     return (SBattleTaskLibCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SBattleTaskLibCfg> getOldAll()
/*     */   {
/* 213 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SBattleTaskLibCfg> getAll()
/*     */   {
/* 218 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SBattleTaskLibCfg> newAll)
/*     */   {
/* 223 */     oldAll = all;
/* 224 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\singlebattle\confbean\SBattleTaskLibCfg.class
