...
/*     */ 
/*     */ public class SBattleTaskCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, SBattleTaskCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, SBattleTaskCfg> all = null;
/*     */   
/*     */   public int id;
/*     */   public int taskType;
/*     */   public int needNum;
...
/*  26 */     this.taskType = Integer.valueOf(rootElement.attributeValue("taskType")).intValue();
/*  27 */     this.needNum = Integer.valueOf(rootElement.attributeValue("needNum")).intValue();
/*  28 */     this.addPoint = Integer.valueOf(rootElement.attributeValue("addPoint")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  33 */     _os_.marshal(this.id);
/*  34 */     _os_.marshal(this.taskType);
/*  35 */     _os_.marshal(this.needNum);
/*  36 */     _os_.marshal(this.addPoint);
/*  37 */     return _os_;
/*     */   }
/*     */   
...
/*  43 */     this.taskType = _os_.unmarshal_int();
/*  44 */     this.needNum = _os_.unmarshal_int();
/*  45 */     this.addPoint = _os_.unmarshal_int();
/*  46 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  51 */     String path = dir + "mzm.gsp.singlebattle.confbean.SBattleTaskCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  64 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.singlebattle.confbean.SBattleTaskCfg"))
/*     */         {
/*     */ 
/*  67 */           SBattleTaskCfg obj = new SBattleTaskCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, SBattleTaskCfg> all)
/*     */   {
/*  81 */     String path = dir + "mzm.gsp.singlebattle.confbean.SBattleTaskCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.singlebattle.confbean.SBattleTaskCfg"))
/*     */         {
/*     */ 
/*  96 */           SBattleTaskCfg obj = new SBattleTaskCfg();
...
/*     */     
/* 112 */     String path = dir + "mzm.gsp.singlebattle.confbean.SBattleTaskCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 139 */           SBattleTaskCfg _v_ = new SBattleTaskCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, SBattleTaskCfg> all)
/*     */   {
/* 159 */     String path = dir + "mzm.gsp.singlebattle.confbean.SBattleTaskCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 186 */           SBattleTaskCfg _v_ = new SBattleTaskCfg();
...
/*     */ 
/*     */ 
/*     */   public static SBattleTaskCfg getOld(int key)
/*     */   {
/* 207 */     return (SBattleTaskCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static SBattleTaskCfg get(int key)
/*     */   {
/* 212 */     return (SBattleTaskCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, SBattleTaskCfg> getOldAll()
/*     */   {
/* 217 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, SBattleTaskCfg> getAll()
/*     */   {
/* 222 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, SBattleTaskCfg> newAll)
/*     */   {
/* 227 */     oldAll = all;
/* 228 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\singlebattle\confbean\SBattleTaskCfg.class
