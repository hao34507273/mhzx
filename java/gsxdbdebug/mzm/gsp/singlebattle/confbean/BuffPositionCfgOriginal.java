...
/*     */ 
/*     */ public class BuffPositionCfgOriginal implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, BuffPositionCfgOriginal> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, BuffPositionCfgOriginal> all = null;
/*     */   
/*     */   public int id;
/*     */   public int play_cfg_id;
/*     */   public int sort_id;
...
/*  29 */     this.play_cfg_id = Integer.valueOf(rootElement.attributeValue("play_cfg_id")).intValue();
/*  30 */     this.sort_id = Integer.valueOf(rootElement.attributeValue("sort_id")).intValue();
/*  31 */     this.buff_info_cfg_id = Integer.valueOf(rootElement.attributeValue("buff_info_cfg_id")).intValue();
...
/*  34 */     this.radius = Integer.valueOf(rootElement.attributeValue("radius")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  39 */     _os_.marshal(this.id);
/*  40 */     _os_.marshal(this.play_cfg_id);
/*  41 */     _os_.marshal(this.sort_id);
/*  42 */     _os_.marshal(this.buff_info_cfg_id);
/*  43 */     _os_.marshal(this.x);
/*  44 */     _os_.marshal(this.y);
/*  45 */     _os_.marshal(this.radius);
/*  46 */     return _os_;
/*     */   }
/*     */   
...
/*  52 */     this.play_cfg_id = _os_.unmarshal_int();
/*  53 */     this.sort_id = _os_.unmarshal_int();
/*  54 */     this.buff_info_cfg_id = _os_.unmarshal_int();
/*  55 */     this.x = _os_.unmarshal_int();
/*  56 */     this.y = _os_.unmarshal_int();
/*  57 */     this.radius = _os_.unmarshal_int();
/*  58 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  63 */     String path = dir + "mzm.gsp.singlebattle.confbean.BuffPositionCfgOriginal.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  76 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.singlebattle.confbean.BuffPositionCfgOriginal"))
/*     */         {
/*     */ 
/*  79 */           BuffPositionCfgOriginal obj = new BuffPositionCfgOriginal();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, BuffPositionCfgOriginal> all)
/*     */   {
/*  93 */     String path = dir + "mzm.gsp.singlebattle.confbean.BuffPositionCfgOriginal.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 105 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.singlebattle.confbean.BuffPositionCfgOriginal"))
/*     */         {
/*     */ 
/* 108 */           BuffPositionCfgOriginal obj = new BuffPositionCfgOriginal();
...
/*     */     
/* 124 */     String path = dir + "mzm.gsp.singlebattle.confbean.BuffPositionCfgOriginal.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 151 */           BuffPositionCfgOriginal _v_ = new BuffPositionCfgOriginal();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, BuffPositionCfgOriginal> all)
/*     */   {
/* 171 */     String path = dir + "mzm.gsp.singlebattle.confbean.BuffPositionCfgOriginal.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 198 */           BuffPositionCfgOriginal _v_ = new BuffPositionCfgOriginal();
...
/*     */ 
/*     */ 
/*     */   public static BuffPositionCfgOriginal getOld(int key)
/*     */   {
/* 219 */     return (BuffPositionCfgOriginal)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static BuffPositionCfgOriginal get(int key)
/*     */   {
/* 224 */     return (BuffPositionCfgOriginal)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, BuffPositionCfgOriginal> getOldAll()
/*     */   {
/* 229 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, BuffPositionCfgOriginal> getAll()
/*     */   {
/* 234 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, BuffPositionCfgOriginal> newAll)
/*     */   {
/* 239 */     oldAll = all;
/* 240 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\singlebattle\confbean\BuffPositionCfgOriginal.class
