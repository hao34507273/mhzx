...
/*     */ 
/*     */ public class BuffPlayCfgOriginal implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, BuffPlayCfgOriginal> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, BuffPlayCfgOriginal> all = null;
/*     */   
/*     */   public int id;
...
/*  26 */     this.disappear_interval_in_minute = Integer.valueOf(rootElement.attributeValue("disappear_interval_in_minute")).intValue();
/*  27 */     this.max_refresh_interval_in_minute = Integer.valueOf(rootElement.attributeValue("max_refresh_interval_in_minute")).intValue();
/*  28 */     this.min_refresh_interval_in_minute = Integer.valueOf(rootElement.attributeValue("min_refresh_interval_in_minute")).intValue();
/*     */   }
/*     */   
/*     */   public OctetsStream marshal(OctetsStream _os_)
/*     */   {
/*  33 */     _os_.marshal(this.id);
/*  34 */     _os_.marshal(this.disappear_interval_in_minute);
/*  35 */     _os_.marshal(this.max_refresh_interval_in_minute);
/*  36 */     _os_.marshal(this.min_refresh_interval_in_minute);
/*  37 */     return _os_;
/*     */   }
/*     */   
...
/*  43 */     this.disappear_interval_in_minute = _os_.unmarshal_int();
/*  44 */     this.max_refresh_interval_in_minute = _os_.unmarshal_int();
/*  45 */     this.min_refresh_interval_in_minute = _os_.unmarshal_int();
/*  46 */     return _os_;
/*     */   }
/*     */   
/*     */   public static void loadXml(String dir)
/*     */   {
/*  51 */     String path = dir + "mzm.gsp.singlebattle.confbean.BuffPlayCfgOriginal.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  64 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.singlebattle.confbean.BuffPlayCfgOriginal"))
/*     */         {
/*     */ 
/*  67 */           BuffPlayCfgOriginal obj = new BuffPlayCfgOriginal();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, BuffPlayCfgOriginal> all)
/*     */   {
/*  81 */     String path = dir + "mzm.gsp.singlebattle.confbean.BuffPlayCfgOriginal.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.singlebattle.confbean.BuffPlayCfgOriginal"))
/*     */         {
/*     */ 
/*  96 */           BuffPlayCfgOriginal obj = new BuffPlayCfgOriginal();
...
/*     */     
/* 112 */     String path = dir + "mzm.gsp.singlebattle.confbean.BuffPlayCfgOriginal.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 139 */           BuffPlayCfgOriginal _v_ = new BuffPlayCfgOriginal();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, BuffPlayCfgOriginal> all)
/*     */   {
/* 159 */     String path = dir + "mzm.gsp.singlebattle.confbean.BuffPlayCfgOriginal.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 186 */           BuffPlayCfgOriginal _v_ = new BuffPlayCfgOriginal();
...
/*     */ 
/*     */ 
/*     */   public static BuffPlayCfgOriginal getOld(int key)
/*     */   {
/* 207 */     return (BuffPlayCfgOriginal)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static BuffPlayCfgOriginal get(int key)
/*     */   {
/* 212 */     return (BuffPlayCfgOriginal)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, BuffPlayCfgOriginal> getOldAll()
/*     */   {
/* 217 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, BuffPlayCfgOriginal> getAll()
/*     */   {
/* 222 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, BuffPlayCfgOriginal> newAll)
/*     */   {
/* 227 */     oldAll = all;
/* 228 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\singlebattle\confbean\BuffPlayCfgOriginal.class
