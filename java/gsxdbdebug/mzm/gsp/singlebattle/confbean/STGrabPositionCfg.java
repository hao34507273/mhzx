...
/*     */ 
/*     */ public class STGrabPositionCfg implements com.goldhuman.Common.Marshal.Marshal
/*     */ {
/*  14 */   private static volatile Map<Integer, STGrabPositionCfg> oldAll = null;
/*     */   
/*  16 */   private static Map<Integer, STGrabPositionCfg> all = null;
/*     */   
/*     */   public int id;
/*  19 */   public java.util.ArrayList<Integer> positionDatas = new java.util.ArrayList();
/*     */   
/*     */   public void loadFromXml(Element rootElement)
/*     */   {
/*  23 */     this.id = Integer.valueOf(rootElement.attributeValue("id")).intValue();
/*     */     
/*  25 */     Element collectionElement = util.XmlHelper.getVariableElement(rootElement, "positionDatas");
...
/*     */         }
/*     */         
/*  50 */         this.positionDatas.add(Integer.valueOf(_v_));
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*  58 */     _os_.compact_uint32(this.positionDatas.size());
/*  59 */     for (Integer _v_ : this.positionDatas)
/*     */     {
...
/*  73 */       this.positionDatas.add(Integer.valueOf(_v_));
/*     */     }
/*  75 */     return _os_;
/*     */   }
/*     */   
...
/*     */   {
/*  80 */     String path = dir + "mzm.gsp.singlebattle.confbean.STGrabPositionCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/*  93 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.singlebattle.confbean.STGrabPositionCfg"))
/*     */         {
/*     */ 
/*  96 */           STGrabPositionCfg obj = new STGrabPositionCfg();
...
/*     */   }
/*     */   
/*     */   public static void reLoadXml(String dir, Map<Integer, STGrabPositionCfg> all)
/*     */   {
/* 110 */     String path = dir + "mzm.gsp.singlebattle.confbean.STGrabPositionCfg.xml";
/*     */     
/*     */     try
/*     */     {
...
/* 122 */         if (elem.getName().equalsIgnoreCase("mzm.gsp.singlebattle.confbean.STGrabPositionCfg"))
/*     */         {
/*     */ 
/* 125 */           STGrabPositionCfg obj = new STGrabPositionCfg();
...
/*     */     
/* 141 */     String path = dir + "mzm.gsp.singlebattle.confbean.STGrabPositionCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 168 */           STGrabPositionCfg _v_ = new STGrabPositionCfg();
...
/*     */   
/*     */ 
/*     */   public static void reLoadBny(String dir, Map<Integer, STGrabPositionCfg> all)
/*     */   {
/* 188 */     String path = dir + "mzm.gsp.singlebattle.confbean.STGrabPositionCfg.bny";
/*     */     try
/*     */     {
...
/*     */           
/* 215 */           STGrabPositionCfg _v_ = new STGrabPositionCfg();
...
/*     */ 
/*     */ 
/*     */   public static STGrabPositionCfg getOld(int key)
/*     */   {
/* 236 */     return (STGrabPositionCfg)oldAll.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static STGrabPositionCfg get(int key)
/*     */   {
/* 241 */     return (STGrabPositionCfg)all.get(Integer.valueOf(key));
/*     */   }
/*     */   
/*     */   public static Map<Integer, STGrabPositionCfg> getOldAll()
/*     */   {
/* 246 */     return oldAll;
/*     */   }
/*     */   
/*     */   public static Map<Integer, STGrabPositionCfg> getAll()
/*     */   {
/* 251 */     return all;
/*     */   }
/*     */   
/*     */   public static void setAll(Map<Integer, STGrabPositionCfg> newAll)
/*     */   {
/* 256 */     oldAll = all;
/* 257 */     all = newAll;
/*     */   }
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\mzm\gsp\singlebattle\confbean\STGrabPositionCfg.class
