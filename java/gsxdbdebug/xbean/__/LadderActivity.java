...
/*     */ 
/*     */ public final class LadderActivity extends xdb.XBean implements xbean.LadderActivity
/*     */ {
...
/*     */   }
/*     */   
/*     */   LadderActivity(int __, xdb.XBean _xp_, String _vn_)
/*     */   {
/*  23 */     super(_xp_, _vn_);
...
/*     */   }
/*     */   
/*     */   public LadderActivity(LadderActivity _o_)
/*     */   {
/*  34 */     this(_o_, null, null);
/*     */   }
/*     */   
/*     */   LadderActivity(xbean.LadderActivity _o1_, xdb.XBean _xp_, String _vn_)
/*     */   {
/*  39 */     super(_xp_, _vn_);
/*  40 */     if ((_o1_ instanceof LadderActivity)) { assign((LadderActivity)_o1_);
...
/*     */   }
/*     */   
/*     */   private void assign(LadderActivity _o_) {
...
/*     */   
/*     */ 
/*     */   public xbean.LadderActivity copy()
/*     */   {
/* 163 */     _xdb_verify_unsafe_();
/* 164 */     return new LadderActivity(this);
/*     */   }
/*     */   
/*     */ 
/*     */   public xbean.LadderActivity toData()
/*     */   {
/* 170 */     _xdb_verify_unsafe_();
/* 171 */     return new Data(this);
/*     */   }
/*     */   
/*     */   public xbean.LadderActivity toBean()
/*     */   {
/* 176 */     _xdb_verify_unsafe_();
/* 177 */     return new LadderActivity(this);
/*     */   }
/*     */   
/*     */ 
/*     */   public xbean.LadderActivity toDataIf()
/*     */   {
/* 183 */     _xdb_verify_unsafe_();
/* 184 */     return new Data(this);
/*     */   }
/*     */   
/*     */   public xbean.LadderActivity toBeanIf()
/*     */   {
...
/* 223 */     LadderActivity _o_ = null;
/* 224 */     if ((_o1_ instanceof LadderActivity)) { _o_ = (LadderActivity)_o1_;
...
/*     */   }
/*     */   
/*     */   private class Const implements xbean.LadderActivity {
/*     */     private Const() {}
/*     */     
/*     */     LadderActivity nThis() {
/* 263 */       return LadderActivity.this;
/*     */     }
/*     */     
/*     */ 
/*     */     public void _reset_unsafe_()
...
/*     */     public xbean.LadderActivity copy()
/*     */     {
/* 275 */       return LadderActivity.this.copy();
/*     */     }
/*     */     
/*     */ 
/*     */     public xbean.LadderActivity toData()
/*     */     {
/* 281 */       return LadderActivity.this.toData();
/*     */     }
/*     */     
/*     */     public xbean.LadderActivity toBean()
/*     */     {
/* 286 */       return LadderActivity.this.toBean();
/*     */     }
/*     */     
/*     */ 
/*     */     public xbean.LadderActivity toDataIf()
/*     */     {
/* 292 */       return LadderActivity.this.toDataIf();
/*     */     }
/*     */     
/*     */     public xbean.LadderActivity toBeanIf()
/*     */     {
/* 297 */       return LadderActivity.this.toBeanIf();
/*     */     }
/*     */     
/*     */ 
/*     */ 
/*     */     public Set<Long> getRoleids()
/*     */     {
/* 304 */       LadderActivity.this._xdb_verify_unsafe_();
/* 305 */       return xdb.Consts.constSet(LadderActivity.this.roleids);
/*     */     }
/*     */     
/*     */ 
/*     */     public Set<Long> getRoleidsAsData()
/*     */     {
/* 311 */       LadderActivity.this._xdb_verify_unsafe_();
/*     */       
/* 313 */       LadderActivity _o_ = LadderActivity.this;
...
/*     */     public xdb.Bean toConst()
/*     */     {
/* 322 */       LadderActivity.this._xdb_verify_unsafe_();
/* 323 */       return this;
/*     */     }
/*     */     
/*     */ 
...
/*     */     {
/* 329 */       LadderActivity.this._xdb_verify_unsafe_();
/* 330 */       return true;
/*     */     }
/*     */     
/*     */ 
...
/*     */     {
/* 336 */       return LadderActivity.this.isData();
/*     */     }
/*     */     
/*     */ 
/*     */     public OctetsStream marshal(OctetsStream _os_)
/*     */     {
/* 342 */       return LadderActivity.this.marshal(_os_);
/*     */     }
/*     */     
/*     */     public OctetsStream unmarshal(OctetsStream _os_)
/*     */       throws com.goldhuman.Common.Marshal.MarshalException
/*     */     {
/* 348 */       LadderActivity.this._xdb_verify_unsafe_();
...
/*     */     public int getSerializedSize()
/*     */     {
/* 355 */       return LadderActivity.this.getSerializedSize();
/*     */     }
/*     */     
/*     */     public CodedOutputStream marshal(CodedOutputStream _output_)
/*     */       throws InvalidProtocolBufferException
/*     */     {
/* 361 */       return LadderActivity.this.marshal(_output_);
/*     */     }
/*     */     
/*     */     public CodedInputStream unmarshal(CodedInputStream _input_)
/*     */       throws InvalidProtocolBufferException
/*     */     {
/* 367 */       LadderActivity.this._xdb_verify_unsafe_();
...
/*     */     {
/* 374 */       return LadderActivity.this.xdbParent();
/*     */     }
/*     */     
/*     */ 
/*     */     public boolean xdbManaged()
/*     */     {
/* 380 */       return LadderActivity.this.xdbManaged();
/*     */     }
/*     */     
/*     */ 
/*     */     public String xdbVarname()
/*     */     {
/* 386 */       return LadderActivity.this.xdbVarname();
/*     */     }
/*     */     
/*     */ 
/*     */     public Long xdbObjId()
/*     */     {
/* 392 */       return LadderActivity.this.xdbObjId();
/*     */     }
/*     */     
/*     */ 
/*     */     public boolean equals(Object obj)
/*     */     {
/* 398 */       return LadderActivity.this.equals(obj);
/*     */     }
/*     */     
/*     */ 
/*     */     public int hashCode()
/*     */     {
/* 404 */       return LadderActivity.this.hashCode();
/*     */     }
/*     */     
/*     */ 
/*     */     public String toString()
/*     */     {
/* 410 */       return LadderActivity.this.toString();
/*     */     }
/*     */   }
/*     */   
/*     */ 
/*     */   public static final class Data
/*     */     implements xbean.LadderActivity
/*     */   {
...
/*     */     }
/*     */     
/*     */     Data(xbean.LadderActivity _o1_)
/*     */     {
/* 432 */       if ((_o1_ instanceof LadderActivity)) { assign((LadderActivity)_o1_);
/* 433 */       } else if ((_o1_ instanceof Data)) { assign((Data)_o1_);
/* 434 */       } else if ((_o1_ instanceof LadderActivity.Const)) assign(((LadderActivity.Const)_o1_).nThis()); else {
...
/*     */     public xbean.LadderActivity toBean()
/*     */     {
/* 560 */       return new LadderActivity(this, null, null);
/*     */     }
/*     */     
/*     */ 
/*     */     public xbean.LadderActivity toDataIf()
...
/*     */     public xbean.LadderActivity toBeanIf()
/*     */     {
/* 571 */       return new LadderActivity(this, null, null);
/*     */     }
/*     */     
/*     */ 
/*     */     public boolean xdbManaged()
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\xbean\__\LadderActivity.class
