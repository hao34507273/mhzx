...
/*     */ import xdb.XBean;
/*     */ 
/*     */ public final class LocalCrossToken extends XBean implements xbean.LocalCrossToken
/*     */ {
/*     */   private int zoneid;
/*     */   private byte[] token;
/*     */   private long roleid;
...
/*     */   }
/*     */   
/*     */   LocalCrossToken(int __, XBean _xp_, String _vn_)
/*     */   {
/*  29 */     super(_xp_, _vn_);
/*  30 */     this.token = new byte[0];
/*     */   }
/*     */   
/*     */   public LocalCrossToken()
/*     */   {
/*  35 */     this(0, null, null);
/*     */   }
/*     */   
/*     */   public LocalCrossToken(LocalCrossToken _o_)
/*     */   {
/*  40 */     this(_o_, null, null);
/*     */   }
/*     */   
/*     */   LocalCrossToken(xbean.LocalCrossToken _o1_, XBean _xp_, String _vn_)
/*     */   {
/*  45 */     super(_xp_, _vn_);
/*  46 */     if ((_o1_ instanceof LocalCrossToken)) { assign((LocalCrossToken)_o1_);
...
/*     */   }
/*     */   
/*     */   private void assign(LocalCrossToken _o_) {
...
/*     */   
/*     */ 
/*     */   public xbean.LocalCrossToken copy()
/*     */   {
/* 172 */     _xdb_verify_unsafe_();
/* 173 */     return new LocalCrossToken(this);
/*     */   }
/*     */   
/*     */ 
/*     */   public xbean.LocalCrossToken toData()
/*     */   {
/* 179 */     _xdb_verify_unsafe_();
/* 180 */     return new Data(this);
/*     */   }
/*     */   
/*     */   public xbean.LocalCrossToken toBean()
/*     */   {
/* 185 */     _xdb_verify_unsafe_();
/* 186 */     return new LocalCrossToken(this);
/*     */   }
/*     */   
/*     */ 
/*     */   public xbean.LocalCrossToken toDataIf()
/*     */   {
/* 192 */     _xdb_verify_unsafe_();
/* 193 */     return new Data(this);
/*     */   }
/*     */   
/*     */   public xbean.LocalCrossToken toBeanIf()
/*     */   {
...
/*     */       {
/* 266 */         new xdb.logs.LogInt(this, LocalCrossToken.this.zoneid)
/*     */         {
/*     */           public void rollback()
/*     */           {
/* 270 */             LocalCrossToken.this.zoneid = this._xdb_saved;
/*     */           }
/*     */         };
/*     */       }
/* 274 */     });
...
/*     */       protected xdb.Log create()
/*     */       {
/* 287 */         new xdb.logs.LogObject(this, LocalCrossToken.this.token)
/*     */         {
/*     */           public void rollback()
/*     */           {
/* 291 */             LocalCrossToken.this.token = ((byte[])this._xdb_saved);
/*     */           }
/*     */         };
/*     */       }
/* 295 */     });
...
/*     */     {
/*     */       protected xdb.Log create() {
/* 307 */         new xdb.logs.LogObject(this, LocalCrossToken.this.token)
/*     */         {
/*     */           public void rollback()
/*     */           {
/* 311 */             LocalCrossToken.this.token = ((byte[])this._xdb_saved);
/*     */           }
/*     */         };
/*     */       }
/* 315 */     });
...
/*     */       protected xdb.Log create()
/*     */       {
/* 328 */         new xdb.logs.LogLong(this, LocalCrossToken.this.roleid)
/*     */         {
/*     */           public void rollback()
/*     */           {
/* 332 */             LocalCrossToken.this.roleid = this._xdb_saved;
/*     */           }
/*     */         };
/*     */       }
/* 336 */     });
...
/* 344 */     LocalCrossToken _o_ = null;
/* 345 */     if ((_o1_ instanceof LocalCrossToken)) { _o_ = (LocalCrossToken)_o1_;
...
/*     */   }
/*     */   
/*     */   private class Const implements xbean.LocalCrossToken {
/*     */     private Const() {}
/*     */     
/*     */     LocalCrossToken nThis() {
/* 394 */       return LocalCrossToken.this;
/*     */     }
/*     */     
/*     */ 
/*     */     public void _reset_unsafe_()
...
/*     */     public xbean.LocalCrossToken copy()
/*     */     {
/* 406 */       return LocalCrossToken.this.copy();
/*     */     }
/*     */     
/*     */ 
/*     */     public xbean.LocalCrossToken toData()
/*     */     {
/* 412 */       return LocalCrossToken.this.toData();
/*     */     }
/*     */     
/*     */     public xbean.LocalCrossToken toBean()
/*     */     {
/* 417 */       return LocalCrossToken.this.toBean();
/*     */     }
/*     */     
/*     */ 
/*     */     public xbean.LocalCrossToken toDataIf()
/*     */     {
/* 423 */       return LocalCrossToken.this.toDataIf();
/*     */     }
/*     */     
/*     */     public xbean.LocalCrossToken toBeanIf()
/*     */     {
/* 428 */       return LocalCrossToken.this.toBeanIf();
/*     */     }
/*     */     
/*     */ 
/*     */ 
/*     */     public int getZoneid()
/*     */     {
/* 435 */       LocalCrossToken.this._xdb_verify_unsafe_();
/* 436 */       return LocalCrossToken.this.zoneid;
/*     */     }
/*     */     
/*     */ 
/*     */ 
/*     */     public <T extends Marshal> T getToken(T _v_)
/*     */     {
/* 443 */       LocalCrossToken.this._xdb_verify_unsafe_();
/* 444 */       return LocalCrossToken.this.getToken(_v_);
/*     */     }
/*     */     
/*     */ 
/*     */ 
/*     */     public boolean isTokenEmpty()
/*     */     {
/* 451 */       LocalCrossToken.this._xdb_verify_unsafe_();
/* 452 */       return LocalCrossToken.this.isTokenEmpty();
/*     */     }
/*     */     
/*     */ 
/*     */ 
/*     */     public byte[] getTokenCopy()
/*     */     {
/* 459 */       LocalCrossToken.this._xdb_verify_unsafe_();
/* 460 */       return LocalCrossToken.this.getTokenCopy();
/*     */     }
/*     */     
/*     */ 
/*     */ 
/*     */     public long getRoleid()
/*     */     {
/* 467 */       LocalCrossToken.this._xdb_verify_unsafe_();
/* 468 */       return LocalCrossToken.this.roleid;
/*     */     }
/*     */     
/*     */ 
/*     */ 
/*     */     public void setZoneid(int _v_)
/*     */     {
/* 475 */       LocalCrossToken.this._xdb_verify_unsafe_();
...
/*     */     public void setToken(Marshal _v_)
/*     */     {
/* 483 */       LocalCrossToken.this._xdb_verify_unsafe_();
...
/*     */     public void setTokenCopy(byte[] _v_)
/*     */     {
/* 491 */       LocalCrossToken.this._xdb_verify_unsafe_();
...
/*     */     public void setRoleid(long _v_)
/*     */     {
/* 499 */       LocalCrossToken.this._xdb_verify_unsafe_();
...
/*     */     public xdb.Bean toConst()
/*     */     {
/* 506 */       LocalCrossToken.this._xdb_verify_unsafe_();
/* 507 */       return this;
/*     */     }
/*     */     
/*     */ 
...
/*     */     {
/* 513 */       LocalCrossToken.this._xdb_verify_unsafe_();
/* 514 */       return true;
/*     */     }
/*     */     
/*     */ 
...
/*     */     {
/* 520 */       return LocalCrossToken.this.isData();
/*     */     }
/*     */     
/*     */ 
/*     */     public OctetsStream marshal(OctetsStream _os_)
/*     */     {
/* 526 */       return LocalCrossToken.this.marshal(_os_);
/*     */     }
/*     */     
/*     */     public OctetsStream unmarshal(OctetsStream _os_)
/*     */       throws MarshalException
/*     */     {
/* 532 */       LocalCrossToken.this._xdb_verify_unsafe_();
...
/*     */     public int getSerializedSize()
/*     */     {
/* 539 */       return LocalCrossToken.this.getSerializedSize();
/*     */     }
/*     */     
/*     */     public CodedOutputStream marshal(CodedOutputStream _output_)
/*     */       throws InvalidProtocolBufferException
/*     */     {
/* 545 */       return LocalCrossToken.this.marshal(_output_);
/*     */     }
/*     */     
/*     */     public CodedInputStream unmarshal(CodedInputStream _input_)
/*     */       throws InvalidProtocolBufferException
/*     */     {
/* 551 */       LocalCrossToken.this._xdb_verify_unsafe_();
...
/*     */     {
/* 558 */       return LocalCrossToken.this.xdbParent();
/*     */     }
/*     */     
/*     */ 
/*     */     public boolean xdbManaged()
/*     */     {
/* 564 */       return LocalCrossToken.this.xdbManaged();
/*     */     }
/*     */     
/*     */ 
/*     */     public String xdbVarname()
/*     */     {
/* 570 */       return LocalCrossToken.this.xdbVarname();
/*     */     }
/*     */     
/*     */ 
/*     */     public Long xdbObjId()
/*     */     {
/* 576 */       return LocalCrossToken.this.xdbObjId();
/*     */     }
/*     */     
/*     */ 
/*     */     public boolean equals(Object obj)
/*     */     {
/* 582 */       return LocalCrossToken.this.equals(obj);
/*     */     }
/*     */     
/*     */ 
/*     */     public int hashCode()
/*     */     {
/* 588 */       return LocalCrossToken.this.hashCode();
/*     */     }
/*     */     
/*     */ 
/*     */     public String toString()
/*     */     {
/* 594 */       return LocalCrossToken.this.toString();
/*     */     }
/*     */   }
/*     */   
/*     */ 
/*     */   public static final class Data
/*     */     implements xbean.LocalCrossToken
/*     */   {
/*     */     private int zoneid;
/*     */     
/*     */     private byte[] token;
...
/*     */     }
/*     */     
/*     */     Data(xbean.LocalCrossToken _o1_)
/*     */     {
/* 620 */       if ((_o1_ instanceof LocalCrossToken)) { assign((LocalCrossToken)_o1_);
/* 621 */       } else if ((_o1_ instanceof Data)) { assign((Data)_o1_);
/* 622 */       } else if ((_o1_ instanceof LocalCrossToken.Const)) assign(((LocalCrossToken.Const)_o1_).nThis()); else {
...
/*     */     public xbean.LocalCrossToken toBean()
/*     */     {
/* 751 */       return new LocalCrossToken(this, null, null);
/*     */     }
/*     */     
/*     */ 
/*     */     public xbean.LocalCrossToken toDataIf()
...
/*     */     public xbean.LocalCrossToken toBeanIf()
/*     */     {
/* 762 */       return new LocalCrossToken(this, null, null);
/*     */     }
/*     */     
/*     */ 
/*     */     public boolean xdbManaged()
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\xbean\__\LocalCrossToken.class
