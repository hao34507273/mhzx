...
/*     */ 
/*     */ public final class ReceiveInvitation extends xdb.XBean implements xbean.ReceiveInvitation
/*     */ {
...
/*     */   }
/*     */   
/*     */   ReceiveInvitation(int __, xdb.XBean _xp_, String _vn_)
/*     */   {
/*  23 */     super(_xp_, _vn_);
...
/*     */   }
/*     */   
/*     */   public ReceiveInvitation(ReceiveInvitation _o_)
/*     */   {
/*  34 */     this(_o_, null, null);
/*     */   }
/*     */   
/*     */   ReceiveInvitation(xbean.ReceiveInvitation _o1_, xdb.XBean _xp_, String _vn_)
/*     */   {
/*  39 */     super(_xp_, _vn_);
/*  40 */     if ((_o1_ instanceof ReceiveInvitation)) { assign((ReceiveInvitation)_o1_);
...
/*     */   }
/*     */   
/*     */   private void assign(ReceiveInvitation _o_) {
...
/*     */   
/*     */ 
/*     */   public xbean.ReceiveInvitation copy()
/*     */   {
/* 163 */     _xdb_verify_unsafe_();
/* 164 */     return new ReceiveInvitation(this);
/*     */   }
/*     */   
/*     */ 
/*     */   public xbean.ReceiveInvitation toData()
/*     */   {
/* 170 */     _xdb_verify_unsafe_();
/* 171 */     return new Data(this);
/*     */   }
/*     */   
/*     */   public xbean.ReceiveInvitation toBean()
/*     */   {
/* 176 */     _xdb_verify_unsafe_();
/* 177 */     return new ReceiveInvitation(this);
/*     */   }
/*     */   
/*     */ 
/*     */   public xbean.ReceiveInvitation toDataIf()
/*     */   {
/* 183 */     _xdb_verify_unsafe_();
/* 184 */     return new Data(this);
/*     */   }
/*     */   
/*     */   public xbean.ReceiveInvitation toBeanIf()
/*     */   {
...
/*     */     
/* 213 */     ReceiveInvitation _o_ = this;
...
/* 223 */     ReceiveInvitation _o_ = null;
/* 224 */     if ((_o1_ instanceof ReceiveInvitation)) { _o_ = (ReceiveInvitation)_o1_;
...
/*     */   }
/*     */   
/*     */   private class Const implements xbean.ReceiveInvitation {
/*     */     private Const() {}
/*     */     
/*     */     ReceiveInvitation nThis() {
/* 263 */       return ReceiveInvitation.this;
/*     */     }
/*     */     
/*     */ 
/*     */     public void _reset_unsafe_()
...
/*     */     public xbean.ReceiveInvitation copy()
/*     */     {
/* 275 */       return ReceiveInvitation.this.copy();
/*     */     }
/*     */     
/*     */ 
/*     */     public xbean.ReceiveInvitation toData()
/*     */     {
/* 281 */       return ReceiveInvitation.this.toData();
/*     */     }
/*     */     
/*     */     public xbean.ReceiveInvitation toBean()
/*     */     {
/* 286 */       return ReceiveInvitation.this.toBean();
/*     */     }
/*     */     
/*     */ 
/*     */     public xbean.ReceiveInvitation toDataIf()
/*     */     {
/* 292 */       return ReceiveInvitation.this.toDataIf();
/*     */     }
/*     */     
/*     */     public xbean.ReceiveInvitation toBeanIf()
/*     */     {
/* 297 */       return ReceiveInvitation.this.toBeanIf();
/*     */     }
/*     */     
/*     */ 
/*     */ 
/*     */     public Set<Long> getInvitations()
/*     */     {
/* 304 */       ReceiveInvitation.this._xdb_verify_unsafe_();
/* 305 */       return xdb.Consts.constSet(ReceiveInvitation.this.invitations);
/*     */     }
/*     */     
/*     */ 
/*     */     public Set<Long> getInvitationsAsData()
/*     */     {
/* 311 */       ReceiveInvitation.this._xdb_verify_unsafe_();
/*     */       
/* 313 */       ReceiveInvitation _o_ = ReceiveInvitation.this;
...
/*     */     public xdb.Bean toConst()
/*     */     {
/* 322 */       ReceiveInvitation.this._xdb_verify_unsafe_();
/* 323 */       return this;
/*     */     }
/*     */     
/*     */ 
...
/*     */     {
/* 329 */       ReceiveInvitation.this._xdb_verify_unsafe_();
/* 330 */       return true;
/*     */     }
/*     */     
/*     */ 
...
/*     */     {
/* 336 */       return ReceiveInvitation.this.isData();
/*     */     }
/*     */     
/*     */ 
/*     */     public OctetsStream marshal(OctetsStream _os_)
/*     */     {
/* 342 */       return ReceiveInvitation.this.marshal(_os_);
/*     */     }
/*     */     
/*     */     public OctetsStream unmarshal(OctetsStream _os_)
/*     */       throws com.goldhuman.Common.Marshal.MarshalException
/*     */     {
/* 348 */       ReceiveInvitation.this._xdb_verify_unsafe_();
...
/*     */     public int getSerializedSize()
/*     */     {
/* 355 */       return ReceiveInvitation.this.getSerializedSize();
/*     */     }
/*     */     
/*     */     public CodedOutputStream marshal(CodedOutputStream _output_)
/*     */       throws InvalidProtocolBufferException
/*     */     {
/* 361 */       return ReceiveInvitation.this.marshal(_output_);
/*     */     }
/*     */     
/*     */     public CodedInputStream unmarshal(CodedInputStream _input_)
/*     */       throws InvalidProtocolBufferException
/*     */     {
/* 367 */       ReceiveInvitation.this._xdb_verify_unsafe_();
...
/*     */     {
/* 374 */       return ReceiveInvitation.this.xdbParent();
/*     */     }
/*     */     
/*     */ 
/*     */     public boolean xdbManaged()
/*     */     {
/* 380 */       return ReceiveInvitation.this.xdbManaged();
/*     */     }
/*     */     
/*     */ 
/*     */     public String xdbVarname()
/*     */     {
/* 386 */       return ReceiveInvitation.this.xdbVarname();
/*     */     }
/*     */     
/*     */ 
/*     */     public Long xdbObjId()
/*     */     {
/* 392 */       return ReceiveInvitation.this.xdbObjId();
/*     */     }
/*     */     
/*     */ 
/*     */     public boolean equals(Object obj)
/*     */     {
/* 398 */       return ReceiveInvitation.this.equals(obj);
/*     */     }
/*     */     
/*     */ 
/*     */     public int hashCode()
/*     */     {
/* 404 */       return ReceiveInvitation.this.hashCode();
/*     */     }
/*     */     
/*     */ 
/*     */     public String toString()
/*     */     {
/* 410 */       return ReceiveInvitation.this.toString();
/*     */     }
/*     */   }
/*     */   
/*     */ 
/*     */   public static final class Data
/*     */     implements xbean.ReceiveInvitation
/*     */   {
...
/*     */     }
/*     */     
/*     */     Data(xbean.ReceiveInvitation _o1_)
/*     */     {
/* 432 */       if ((_o1_ instanceof ReceiveInvitation)) { assign((ReceiveInvitation)_o1_);
/* 433 */       } else if ((_o1_ instanceof Data)) { assign((Data)_o1_);
/* 434 */       } else if ((_o1_ instanceof ReceiveInvitation.Const)) assign(((ReceiveInvitation.Const)_o1_).nThis()); else {
...
/*     */     public xbean.ReceiveInvitation toBean()
/*     */     {
/* 560 */       return new ReceiveInvitation(this, null, null);
/*     */     }
/*     */     
/*     */ 
/*     */     public xbean.ReceiveInvitation toDataIf()
...
/*     */     public xbean.ReceiveInvitation toBeanIf()
/*     */     {
/* 571 */       return new ReceiveInvitation(this, null, null);
/*     */     }
/*     */     
/*     */ 
/*     */     public boolean xdbManaged()
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\xbean\__\ReceiveInvitation.class
