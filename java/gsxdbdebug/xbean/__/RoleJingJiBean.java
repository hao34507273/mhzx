...
/*     */ 
/*     */ public final class RoleJingJiBean extends XBean implements xbean.RoleJingJiBean
/*     */ {
/*     */   private long roleid;
/*     */   private int point;
/*     */   
...
/*     */   }
/*     */   
/*     */   RoleJingJiBean(int __, XBean _xp_, String _vn_)
/*     */   {
/*  26 */     super(_xp_, _vn_);
/*     */   }
/*     */   
/*     */   public RoleJingJiBean()
/*     */   {
/*  31 */     this(0, null, null);
/*     */   }
/*     */   
/*     */   public RoleJingJiBean(RoleJingJiBean _o_)
/*     */   {
/*  36 */     this(_o_, null, null);
/*     */   }
/*     */   
/*     */   RoleJingJiBean(xbean.RoleJingJiBean _o1_, XBean _xp_, String _vn_)
/*     */   {
/*  41 */     super(_xp_, _vn_);
/*  42 */     if ((_o1_ instanceof RoleJingJiBean)) { assign((RoleJingJiBean)_o1_);
...
/*     */   }
/*     */   
/*     */   private void assign(RoleJingJiBean _o_) {
...
/*     */   
/*     */ 
/*     */   public xbean.RoleJingJiBean copy()
/*     */   {
/* 157 */     _xdb_verify_unsafe_();
/* 158 */     return new RoleJingJiBean(this);
/*     */   }
/*     */   
/*     */ 
/*     */   public xbean.RoleJingJiBean toData()
/*     */   {
/* 164 */     _xdb_verify_unsafe_();
/* 165 */     return new Data(this);
/*     */   }
/*     */   
/*     */   public xbean.RoleJingJiBean toBean()
/*     */   {
/* 170 */     _xdb_verify_unsafe_();
/* 171 */     return new RoleJingJiBean(this);
/*     */   }
/*     */   
/*     */ 
/*     */   public xbean.RoleJingJiBean toDataIf()
/*     */   {
/* 177 */     _xdb_verify_unsafe_();
/* 178 */     return new Data(this);
/*     */   }
/*     */   
/*     */   public xbean.RoleJingJiBean toBeanIf()
/*     */   {
...
/*     */       {
/* 219 */         new xdb.logs.LogLong(this, RoleJingJiBean.this.roleid)
/*     */         {
/*     */           public void rollback()
/*     */           {
/* 223 */             RoleJingJiBean.this.roleid = this._xdb_saved;
/*     */           }
/*     */         };
/*     */       }
/* 227 */     });
...
/*     */       protected xdb.Log create()
/*     */       {
/* 240 */         new xdb.logs.LogInt(this, RoleJingJiBean.this.point)
/*     */         {
/*     */           public void rollback()
/*     */           {
/* 244 */             RoleJingJiBean.this.point = this._xdb_saved;
/*     */           }
/*     */         };
/*     */       }
/* 248 */     });
...
/* 256 */     RoleJingJiBean _o_ = null;
/* 257 */     if ((_o1_ instanceof RoleJingJiBean)) { _o_ = (RoleJingJiBean)_o1_;
...
/*     */   }
/*     */   
/*     */   private class Const implements xbean.RoleJingJiBean {
/*     */     private Const() {}
/*     */     
/*     */     RoleJingJiBean nThis() {
/* 301 */       return RoleJingJiBean.this;
/*     */     }
/*     */     
/*     */ 
/*     */     public void _reset_unsafe_()
...
/*     */     public xbean.RoleJingJiBean copy()
/*     */     {
/* 313 */       return RoleJingJiBean.this.copy();
/*     */     }
/*     */     
/*     */ 
/*     */     public xbean.RoleJingJiBean toData()
/*     */     {
/* 319 */       return RoleJingJiBean.this.toData();
/*     */     }
/*     */     
/*     */     public xbean.RoleJingJiBean toBean()
/*     */     {
/* 324 */       return RoleJingJiBean.this.toBean();
/*     */     }
/*     */     
/*     */ 
/*     */     public xbean.RoleJingJiBean toDataIf()
/*     */     {
/* 330 */       return RoleJingJiBean.this.toDataIf();
/*     */     }
/*     */     
/*     */     public xbean.RoleJingJiBean toBeanIf()
/*     */     {
/* 335 */       return RoleJingJiBean.this.toBeanIf();
/*     */     }
/*     */     
/*     */ 
/*     */ 
/*     */     public long getRoleid()
/*     */     {
/* 342 */       RoleJingJiBean.this._xdb_verify_unsafe_();
/* 343 */       return RoleJingJiBean.this.roleid;
/*     */     }
/*     */     
/*     */ 
/*     */ 
/*     */     public int getPoint()
/*     */     {
/* 350 */       RoleJingJiBean.this._xdb_verify_unsafe_();
/* 351 */       return RoleJingJiBean.this.point;
/*     */     }
/*     */     
/*     */ 
/*     */ 
/*     */     public void setRoleid(long _v_)
/*     */     {
/* 358 */       RoleJingJiBean.this._xdb_verify_unsafe_();
...
/*     */     public void setPoint(int _v_)
/*     */     {
/* 366 */       RoleJingJiBean.this._xdb_verify_unsafe_();
...
/*     */     public Bean toConst()
/*     */     {
/* 373 */       RoleJingJiBean.this._xdb_verify_unsafe_();
/* 374 */       return this;
/*     */     }
/*     */     
/*     */ 
...
/*     */     {
/* 380 */       RoleJingJiBean.this._xdb_verify_unsafe_();
/* 381 */       return true;
/*     */     }
/*     */     
/*     */ 
...
/*     */     {
/* 387 */       return RoleJingJiBean.this.isData();
/*     */     }
/*     */     
/*     */ 
/*     */     public OctetsStream marshal(OctetsStream _os_)
/*     */     {
/* 393 */       return RoleJingJiBean.this.marshal(_os_);
/*     */     }
/*     */     
/*     */     public OctetsStream unmarshal(OctetsStream _os_)
/*     */       throws com.goldhuman.Common.Marshal.MarshalException
/*     */     {
/* 399 */       RoleJingJiBean.this._xdb_verify_unsafe_();
...
/*     */     public int getSerializedSize()
/*     */     {
/* 406 */       return RoleJingJiBean.this.getSerializedSize();
/*     */     }
/*     */     
/*     */     public CodedOutputStream marshal(CodedOutputStream _output_)
/*     */       throws InvalidProtocolBufferException
/*     */     {
/* 412 */       return RoleJingJiBean.this.marshal(_output_);
/*     */     }
/*     */     
/*     */     public CodedInputStream unmarshal(CodedInputStream _input_)
/*     */       throws InvalidProtocolBufferException
/*     */     {
/* 418 */       RoleJingJiBean.this._xdb_verify_unsafe_();
...
/*     */     {
/* 425 */       return RoleJingJiBean.this.xdbParent();
/*     */     }
/*     */     
/*     */ 
/*     */     public boolean xdbManaged()
/*     */     {
/* 431 */       return RoleJingJiBean.this.xdbManaged();
/*     */     }
/*     */     
/*     */ 
/*     */     public String xdbVarname()
/*     */     {
/* 437 */       return RoleJingJiBean.this.xdbVarname();
/*     */     }
/*     */     
/*     */ 
/*     */     public Long xdbObjId()
/*     */     {
/* 443 */       return RoleJingJiBean.this.xdbObjId();
/*     */     }
/*     */     
/*     */ 
/*     */     public boolean equals(Object obj)
/*     */     {
/* 449 */       return RoleJingJiBean.this.equals(obj);
/*     */     }
/*     */     
/*     */ 
/*     */     public int hashCode()
/*     */     {
/* 455 */       return RoleJingJiBean.this.hashCode();
/*     */     }
/*     */     
/*     */ 
/*     */     public String toString()
/*     */     {
/* 461 */       return RoleJingJiBean.this.toString();
/*     */     }
/*     */   }
/*     */   
/*     */ 
/*     */   public static final class Data
/*     */     implements xbean.RoleJingJiBean
/*     */   {
/*     */     private long roleid;
/*     */     
/*     */     private int point;
...
/*     */     
/*     */ 
/*     */     Data(xbean.RoleJingJiBean _o1_)
/*     */     {
/* 484 */       if ((_o1_ instanceof RoleJingJiBean)) { assign((RoleJingJiBean)_o1_);
/* 485 */       } else if ((_o1_ instanceof Data)) { assign((Data)_o1_);
/* 486 */       } else if ((_o1_ instanceof RoleJingJiBean.Const)) assign(((RoleJingJiBean.Const)_o1_).nThis()); else {
...
/*     */     public xbean.RoleJingJiBean toBean()
/*     */     {
/* 604 */       return new RoleJingJiBean(this, null, null);
/*     */     }
/*     */     
/*     */ 
/*     */     public xbean.RoleJingJiBean toDataIf()
...
/*     */     public xbean.RoleJingJiBean toBeanIf()
/*     */     {
/* 615 */       return new RoleJingJiBean(this, null, null);
/*     */     }
/*     */     
/*     */ 
/*     */     public boolean xdbManaged()
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\xbean\__\RoleJingJiBean.class
