...
/*     */ 
/*     */ public final class TargetData extends XBean implements xbean.TargetData
/*     */ {
...
/*     */   }
/*     */   
/*     */   TargetData(int __, XBean _xp_, String _vn_)
/*     */   {
/*  29 */     super(_xp_, _vn_);
/*     */   }
/*     */   
...
/*     */   }
/*     */   
/*     */   public TargetData(TargetData _o_)
/*     */   {
/*  39 */     this(_o_, null, null);
/*     */   }
/*     */   
/*     */   TargetData(xbean.TargetData _o1_, XBean _xp_, String _vn_)
/*     */   {
/*  44 */     super(_xp_, _vn_);
/*  45 */     if ((_o1_ instanceof TargetData)) { assign((TargetData)_o1_);
...
/*     */   }
/*     */   
/*     */   private void assign(TargetData _o_) {
...
/*     */   
/*     */ 
/*     */   public xbean.TargetData copy()
/*     */   {
/* 171 */     _xdb_verify_unsafe_();
/* 172 */     return new TargetData(this);
/*     */   }
/*     */   
/*     */ 
/*     */   public xbean.TargetData toData()
/*     */   {
/* 178 */     _xdb_verify_unsafe_();
/* 179 */     return new Data(this);
/*     */   }
/*     */   
/*     */   public xbean.TargetData toBean()
/*     */   {
/* 184 */     _xdb_verify_unsafe_();
/* 185 */     return new TargetData(this);
/*     */   }
/*     */   
/*     */ 
/*     */   public xbean.TargetData toDataIf()
/*     */   {
/* 191 */     _xdb_verify_unsafe_();
/* 192 */     return new Data(this);
/*     */   }
/*     */   
/*     */   public xbean.TargetData toBeanIf()
/*     */   {
...
/*     */       {
/* 241 */         new LogInt(this, TargetData.this.targetid)
/*     */         {
/*     */           public void rollback()
/*     */           {
/* 245 */             TargetData.this.targetid = this._xdb_saved;
/*     */           }
/*     */         };
/*     */       }
/* 249 */     });
...
/*     */       protected xdb.Log create()
/*     */       {
/* 262 */         new LogInt(this, TargetData.this.targetstate)
/*     */         {
/*     */           public void rollback()
/*     */           {
/* 266 */             TargetData.this.targetstate = this._xdb_saved;
/*     */           }
/*     */         };
/*     */       }
/* 270 */     });
...
/*     */       protected xdb.Log create()
/*     */       {
/* 283 */         new LogInt(this, TargetData.this.targetparam)
/*     */         {
/*     */           public void rollback()
/*     */           {
/* 287 */             TargetData.this.targetparam = this._xdb_saved;
/*     */           }
/*     */         };
/*     */       }
/* 291 */     });
...
/* 299 */     TargetData _o_ = null;
/* 300 */     if ((_o1_ instanceof TargetData)) { _o_ = (TargetData)_o1_;
...
/*     */   }
/*     */   
/*     */   private class Const implements xbean.TargetData {
/*     */     private Const() {}
/*     */     
/*     */     TargetData nThis() {
/* 349 */       return TargetData.this;
/*     */     }
/*     */     
/*     */ 
/*     */     public void _reset_unsafe_()
...
/*     */     public xbean.TargetData copy()
/*     */     {
/* 361 */       return TargetData.this.copy();
/*     */     }
/*     */     
/*     */ 
/*     */     public xbean.TargetData toData()
/*     */     {
/* 367 */       return TargetData.this.toData();
/*     */     }
/*     */     
/*     */     public xbean.TargetData toBean()
/*     */     {
/* 372 */       return TargetData.this.toBean();
/*     */     }
/*     */     
/*     */ 
/*     */     public xbean.TargetData toDataIf()
/*     */     {
/* 378 */       return TargetData.this.toDataIf();
/*     */     }
/*     */     
/*     */     public xbean.TargetData toBeanIf()
/*     */     {
/* 383 */       return TargetData.this.toBeanIf();
/*     */     }
/*     */     
/*     */ 
/*     */ 
/*     */     public int getTargetid()
/*     */     {
/* 390 */       TargetData.this._xdb_verify_unsafe_();
/* 391 */       return TargetData.this.targetid;
/*     */     }
/*     */     
/*     */ 
/*     */ 
/*     */     public int getTargetstate()
/*     */     {
/* 398 */       TargetData.this._xdb_verify_unsafe_();
/* 399 */       return TargetData.this.targetstate;
/*     */     }
/*     */     
/*     */ 
/*     */ 
/*     */     public int getTargetparam()
/*     */     {
/* 406 */       TargetData.this._xdb_verify_unsafe_();
/* 407 */       return TargetData.this.targetparam;
/*     */     }
/*     */     
/*     */ 
/*     */ 
/*     */     public void setTargetid(int _v_)
/*     */     {
/* 414 */       TargetData.this._xdb_verify_unsafe_();
...
/*     */     public void setTargetstate(int _v_)
/*     */     {
/* 422 */       TargetData.this._xdb_verify_unsafe_();
...
/*     */     public void setTargetparam(int _v_)
/*     */     {
/* 430 */       TargetData.this._xdb_verify_unsafe_();
...
/*     */     public xdb.Bean toConst()
/*     */     {
/* 437 */       TargetData.this._xdb_verify_unsafe_();
/* 438 */       return this;
/*     */     }
/*     */     
/*     */ 
...
/*     */     {
/* 444 */       TargetData.this._xdb_verify_unsafe_();
/* 445 */       return true;
/*     */     }
/*     */     
/*     */ 
...
/*     */     {
/* 451 */       return TargetData.this.isData();
/*     */     }
/*     */     
/*     */ 
/*     */     public OctetsStream marshal(OctetsStream _os_)
/*     */     {
/* 457 */       return TargetData.this.marshal(_os_);
/*     */     }
/*     */     
/*     */     public OctetsStream unmarshal(OctetsStream _os_)
/*     */       throws com.goldhuman.Common.Marshal.MarshalException
/*     */     {
/* 463 */       TargetData.this._xdb_verify_unsafe_();
...
/*     */     public int getSerializedSize()
/*     */     {
/* 470 */       return TargetData.this.getSerializedSize();
/*     */     }
/*     */     
/*     */     public CodedOutputStream marshal(CodedOutputStream _output_)
/*     */       throws InvalidProtocolBufferException
/*     */     {
/* 476 */       return TargetData.this.marshal(_output_);
/*     */     }
/*     */     
/*     */     public CodedInputStream unmarshal(CodedInputStream _input_)
/*     */       throws InvalidProtocolBufferException
/*     */     {
/* 482 */       TargetData.this._xdb_verify_unsafe_();
...
/*     */     {
/* 489 */       return TargetData.this.xdbParent();
/*     */     }
/*     */     
/*     */ 
/*     */     public boolean xdbManaged()
/*     */     {
/* 495 */       return TargetData.this.xdbManaged();
/*     */     }
/*     */     
/*     */ 
/*     */     public String xdbVarname()
/*     */     {
/* 501 */       return TargetData.this.xdbVarname();
/*     */     }
/*     */     
/*     */ 
/*     */     public Long xdbObjId()
/*     */     {
/* 507 */       return TargetData.this.xdbObjId();
/*     */     }
/*     */     
/*     */ 
/*     */     public boolean equals(Object obj)
/*     */     {
/* 513 */       return TargetData.this.equals(obj);
/*     */     }
/*     */     
/*     */ 
/*     */     public int hashCode()
/*     */     {
/* 519 */       return TargetData.this.hashCode();
/*     */     }
/*     */     
/*     */ 
/*     */     public String toString()
/*     */     {
/* 525 */       return TargetData.this.toString();
/*     */     }
/*     */   }
/*     */   
/*     */ 
/*     */   public static final class Data
/*     */     implements xbean.TargetData
/*     */   {
/*     */     private int targetid;
/*     */     
/*     */     private int targetstate;
...
/*     */     
/*     */ 
/*     */     Data(xbean.TargetData _o1_)
/*     */     {
/* 550 */       if ((_o1_ instanceof TargetData)) { assign((TargetData)_o1_);
/* 551 */       } else if ((_o1_ instanceof Data)) { assign((Data)_o1_);
/* 552 */       } else if ((_o1_ instanceof TargetData.Const)) assign(((TargetData.Const)_o1_).nThis()); else {
...
/*     */     public xbean.TargetData toBean()
/*     */     {
/* 681 */       return new TargetData(this, null, null);
/*     */     }
/*     */     
/*     */ 
/*     */     public xbean.TargetData toDataIf()
...
/*     */     public xbean.TargetData toBeanIf()
/*     */     {
/* 692 */       return new TargetData(this, null, null);
/*     */     }
/*     */     
/*     */ 
/*     */     public boolean xdbManaged()
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\xbean\__\TargetData.class
