...
/*      */ import xdb.XBean;
/*      */ 
/*      */ public final class NoneRealTimeMultiFightValueRank extends XBean implements xbean.NoneRealTimeMultiFightValueRank
/*      */ {
...
/*      */   }
/*      */   
/*      */   NoneRealTimeMultiFightValueRank(int __, XBean _xp_, String _vn_)
/*      */   {
/*   32 */     super(_xp_, _vn_);
...
/*      */   }
/*      */   
/*      */   public NoneRealTimeMultiFightValueRank()
/*      */   {
/*   40 */     this(0, null, null);
/*      */   }
/*      */   
/*      */   public NoneRealTimeMultiFightValueRank(NoneRealTimeMultiFightValueRank _o_)
/*      */   {
/*   45 */     this(_o_, null, null);
/*      */   }
/*      */   
/*      */   NoneRealTimeMultiFightValueRank(xbean.NoneRealTimeMultiFightValueRank _o1_, XBean _xp_, String _vn_)
/*      */   {
/*   50 */     super(_xp_, _vn_);
/*   51 */     if ((_o1_ instanceof NoneRealTimeMultiFightValueRank)) { assign((NoneRealTimeMultiFightValueRank)_o1_);
...
/*      */   }
/*      */   
/*      */   private void assign(NoneRealTimeMultiFightValueRank _o_) {
/*   59 */     _o_._xdb_verify_unsafe_();
/*   60 */     this.rankdatas = new LinkedList();
/*   61 */     for (xbean.NoneRealRoleMultiFightValueBean _v_ : _o_.rankdatas)
/*   62 */       this.rankdatas.add(new NoneRealRoleMultiFightValueBean(_v_, this, "rankdatas"));
...
/*   73 */     for (xbean.NoneRealRoleMultiFightValueBean _v_ : _o_.rankdatas)
/*   74 */       this.rankdatas.add(new NoneRealRoleMultiFightValueBean(_v_, this, "rankdatas"));
...
/*   87 */     for (xbean.NoneRealRoleMultiFightValueBean _v_ : this.rankdatas)
/*      */     {
/*   89 */       _v_.marshal(_os_);
/*      */     }
...
/*      */     {
/*  108 */       xbean.NoneRealRoleMultiFightValueBean _v_ = new NoneRealRoleMultiFightValueBean(0, this, "rankdatas");
...
/*  136 */     int _size_ = 0;
/*  137 */     for (xbean.NoneRealRoleMultiFightValueBean _v_ : this.rankdatas)
/*      */     {
...
/*      */     try
/*      */     {
/*  157 */       for (xbean.NoneRealRoleMultiFightValueBean _v_ : this.rankdatas)
/*      */       {
...
/*      */ 
/*      */         case 10: 
/*  195 */           xbean.NoneRealRoleMultiFightValueBean _v_ = new NoneRealRoleMultiFightValueBean(0, this, "rankdatas");
...
/*      */   
/*      */ 
/*      */   public xbean.NoneRealTimeMultiFightValueRank copy()
/*      */   {
/*  249 */     _xdb_verify_unsafe_();
/*  250 */     return new NoneRealTimeMultiFightValueRank(this);
/*      */   }
/*      */   
/*      */ 
/*      */   public xbean.NoneRealTimeMultiFightValueRank toData()
/*      */   {
/*  256 */     _xdb_verify_unsafe_();
/*  257 */     return new Data(this);
/*      */   }
/*      */   
/*      */   public xbean.NoneRealTimeMultiFightValueRank toBean()
/*      */   {
/*  262 */     _xdb_verify_unsafe_();
/*  263 */     return new NoneRealTimeMultiFightValueRank(this);
/*      */   }
/*      */   
/*      */ 
/*      */   public xbean.NoneRealTimeMultiFightValueRank toDataIf()
/*      */   {
/*  269 */     _xdb_verify_unsafe_();
/*  270 */     return new Data(this);
/*      */   }
/*      */   
/*      */   public xbean.NoneRealTimeMultiFightValueRank toBeanIf()
/*      */   {
...
/*      */     
/*  299 */     NoneRealTimeMultiFightValueRank _o_ = this;
/*  300 */     List<xbean.NoneRealRoleMultiFightValueBean> rankdatas = new LinkedList();
/*  301 */     for (xbean.NoneRealRoleMultiFightValueBean _v_ : _o_.rankdatas)
/*  302 */       rankdatas.add(new NoneRealRoleMultiFightValueBean.Data(_v_));
...
/*      */     
/*  320 */     NoneRealTimeMultiFightValueRank _o_ = this;
...
/*      */       {
/*  352 */         new xdb.logs.LogLong(this, NoneRealTimeMultiFightValueRank.this.savetime)
/*      */         {
/*      */           public void rollback()
/*      */           {
/*  356 */             NoneRealTimeMultiFightValueRank.this.savetime = this._xdb_saved;
/*      */           }
/*      */         };
/*      */       }
/*  360 */     });
...
/*      */       protected xdb.Log create()
/*      */       {
/*  373 */         new xdb.logs.LogLong(this, NoneRealTimeMultiFightValueRank.this.awardtime)
/*      */         {
/*      */           public void rollback()
/*      */           {
/*  377 */             NoneRealTimeMultiFightValueRank.this.awardtime = this._xdb_saved;
/*      */           }
/*      */         };
/*      */       }
/*  381 */     });
...
/*  389 */     NoneRealTimeMultiFightValueRank _o_ = null;
/*  390 */     if ((_o1_ instanceof NoneRealTimeMultiFightValueRank)) { _o_ = (NoneRealTimeMultiFightValueRank)_o1_;
...
/*      */   }
/*      */   
/*      */   private class Const implements xbean.NoneRealTimeMultiFightValueRank {
/*      */     private Const() {}
/*      */     
/*      */     NoneRealTimeMultiFightValueRank nThis() {
/*  444 */       return NoneRealTimeMultiFightValueRank.this;
/*      */     }
/*      */     
/*      */ 
/*      */     public void _reset_unsafe_()
...
/*      */     public xbean.NoneRealTimeMultiFightValueRank copy()
/*      */     {
/*  456 */       return NoneRealTimeMultiFightValueRank.this.copy();
/*      */     }
/*      */     
/*      */ 
/*      */     public xbean.NoneRealTimeMultiFightValueRank toData()
/*      */     {
/*  462 */       return NoneRealTimeMultiFightValueRank.this.toData();
/*      */     }
/*      */     
/*      */     public xbean.NoneRealTimeMultiFightValueRank toBean()
/*      */     {
/*  467 */       return NoneRealTimeMultiFightValueRank.this.toBean();
/*      */     }
/*      */     
/*      */ 
/*      */     public xbean.NoneRealTimeMultiFightValueRank toDataIf()
/*      */     {
/*  473 */       return NoneRealTimeMultiFightValueRank.this.toDataIf();
/*      */     }
/*      */     
/*      */     public xbean.NoneRealTimeMultiFightValueRank toBeanIf()
/*      */     {
/*  478 */       return NoneRealTimeMultiFightValueRank.this.toBeanIf();
/*      */     }
/*      */     
/*      */ 
/*      */ 
/*      */     public List<xbean.NoneRealRoleMultiFightValueBean> getRankdatas()
/*      */     {
/*  485 */       NoneRealTimeMultiFightValueRank.this._xdb_verify_unsafe_();
/*  486 */       return xdb.Consts.constList(NoneRealTimeMultiFightValueRank.this.rankdatas);
/*      */     }
/*      */     
/*      */ 
/*      */     public List<xbean.NoneRealRoleMultiFightValueBean> getRankdatasAsData()
/*      */     {
/*  492 */       NoneRealTimeMultiFightValueRank.this._xdb_verify_unsafe_();
/*      */       
/*  494 */       NoneRealTimeMultiFightValueRank _o_ = NoneRealTimeMultiFightValueRank.this;
/*  495 */       List<xbean.NoneRealRoleMultiFightValueBean> rankdatas = new LinkedList();
/*  496 */       for (xbean.NoneRealRoleMultiFightValueBean _v_ : _o_.rankdatas)
/*  497 */         rankdatas.add(new NoneRealRoleMultiFightValueBean.Data(_v_));
...
/*      */     public Map<Long, Integer> getKeytorankchange()
/*      */     {
/*  505 */       NoneRealTimeMultiFightValueRank.this._xdb_verify_unsafe_();
/*  506 */       return xdb.Consts.constMap(NoneRealTimeMultiFightValueRank.this.keytorankchange);
/*      */     }
/*      */     
/*      */ 
/*      */ 
/*      */     public Map<Long, Integer> getKeytorankchangeAsData()
/*      */     {
/*  513 */       NoneRealTimeMultiFightValueRank.this._xdb_verify_unsafe_();
/*      */       
/*  515 */       NoneRealTimeMultiFightValueRank _o_ = NoneRealTimeMultiFightValueRank.this;
...
/*      */     public long getSavetime()
/*      */     {
/*  526 */       NoneRealTimeMultiFightValueRank.this._xdb_verify_unsafe_();
/*  527 */       return NoneRealTimeMultiFightValueRank.this.savetime;
/*      */     }
/*      */     
/*      */ 
/*      */ 
/*      */     public long getAwardtime()
/*      */     {
/*  534 */       NoneRealTimeMultiFightValueRank.this._xdb_verify_unsafe_();
/*  535 */       return NoneRealTimeMultiFightValueRank.this.awardtime;
/*      */     }
/*      */     
/*      */ 
/*      */ 
/*      */     public void setSavetime(long _v_)
/*      */     {
/*  542 */       NoneRealTimeMultiFightValueRank.this._xdb_verify_unsafe_();
...
/*      */     public void setAwardtime(long _v_)
/*      */     {
/*  550 */       NoneRealTimeMultiFightValueRank.this._xdb_verify_unsafe_();
...
/*      */     public xdb.Bean toConst()
/*      */     {
/*  557 */       NoneRealTimeMultiFightValueRank.this._xdb_verify_unsafe_();
/*  558 */       return this;
/*      */     }
/*      */     
/*      */ 
...
/*      */     {
/*  564 */       NoneRealTimeMultiFightValueRank.this._xdb_verify_unsafe_();
/*  565 */       return true;
/*      */     }
/*      */     
/*      */ 
...
/*      */     {
/*  571 */       return NoneRealTimeMultiFightValueRank.this.isData();
/*      */     }
/*      */     
/*      */ 
/*      */     public OctetsStream marshal(OctetsStream _os_)
/*      */     {
/*  577 */       return NoneRealTimeMultiFightValueRank.this.marshal(_os_);
/*      */     }
/*      */     
/*      */     public OctetsStream unmarshal(OctetsStream _os_)
/*      */       throws com.goldhuman.Common.Marshal.MarshalException
/*      */     {
/*  583 */       NoneRealTimeMultiFightValueRank.this._xdb_verify_unsafe_();
...
/*      */     public int getSerializedSize()
/*      */     {
/*  590 */       return NoneRealTimeMultiFightValueRank.this.getSerializedSize();
/*      */     }
/*      */     
/*      */     public CodedOutputStream marshal(CodedOutputStream _output_)
/*      */       throws InvalidProtocolBufferException
/*      */     {
/*  596 */       return NoneRealTimeMultiFightValueRank.this.marshal(_output_);
/*      */     }
/*      */     
/*      */     public CodedInputStream unmarshal(CodedInputStream _input_)
/*      */       throws InvalidProtocolBufferException
/*      */     {
/*  602 */       NoneRealTimeMultiFightValueRank.this._xdb_verify_unsafe_();
...
/*      */     {
/*  609 */       return NoneRealTimeMultiFightValueRank.this.xdbParent();
/*      */     }
/*      */     
/*      */ 
/*      */     public boolean xdbManaged()
/*      */     {
/*  615 */       return NoneRealTimeMultiFightValueRank.this.xdbManaged();
/*      */     }
/*      */     
/*      */ 
/*      */     public String xdbVarname()
/*      */     {
/*  621 */       return NoneRealTimeMultiFightValueRank.this.xdbVarname();
/*      */     }
/*      */     
/*      */ 
/*      */     public Long xdbObjId()
/*      */     {
/*  627 */       return NoneRealTimeMultiFightValueRank.this.xdbObjId();
/*      */     }
/*      */     
/*      */ 
/*      */     public boolean equals(Object obj)
/*      */     {
/*  633 */       return NoneRealTimeMultiFightValueRank.this.equals(obj);
/*      */     }
/*      */     
/*      */ 
/*      */     public int hashCode()
/*      */     {
/*  639 */       return NoneRealTimeMultiFightValueRank.this.hashCode();
/*      */     }
/*      */     
/*      */ 
/*      */     public String toString()
/*      */     {
/*  645 */       return NoneRealTimeMultiFightValueRank.this.toString();
/*      */     }
/*      */   }
/*      */   
/*      */ 
/*      */   public static final class Data
/*      */     implements xbean.NoneRealTimeMultiFightValueRank
/*      */   {
/*      */     private LinkedList<xbean.NoneRealRoleMultiFightValueBean> rankdatas;
/*      */     
/*      */     private HashMap<Long, Integer> keytorankchange;
...
/*      */     }
/*      */     
/*      */     Data(xbean.NoneRealTimeMultiFightValueRank _o1_)
/*      */     {
/*  675 */       if ((_o1_ instanceof NoneRealTimeMultiFightValueRank)) { assign((NoneRealTimeMultiFightValueRank)_o1_);
/*  676 */       } else if ((_o1_ instanceof Data)) { assign((Data)_o1_);
/*  677 */       } else if ((_o1_ instanceof NoneRealTimeMultiFightValueRank.Const)) assign(((NoneRealTimeMultiFightValueRank.Const)_o1_).nThis()); else {
...
/*  684 */       for (xbean.NoneRealRoleMultiFightValueBean _v_ : _o_.rankdatas)
/*  685 */         this.rankdatas.add(new NoneRealRoleMultiFightValueBean.Data(_v_));
...
/*  696 */       for (xbean.NoneRealRoleMultiFightValueBean _v_ : _o_.rankdatas)
/*  697 */         this.rankdatas.add(new NoneRealRoleMultiFightValueBean.Data(_v_));
...
/*  709 */       for (xbean.NoneRealRoleMultiFightValueBean _v_ : this.rankdatas)
/*      */       {
...
/*      */       {
/*  729 */         xbean.NoneRealRoleMultiFightValueBean _v_ = xbean.Pod.newNoneRealRoleMultiFightValueBeanData();
...
/*      */     {
/*  756 */       int _size_ = 0;
/*  757 */       for (xbean.NoneRealRoleMultiFightValueBean _v_ : this.rankdatas)
/*      */       {
...
/*      */       try
/*      */       {
/*  776 */         for (xbean.NoneRealRoleMultiFightValueBean _v_ : this.rankdatas)
/*      */         {
...
/*      */ 
/*      */           case 10: 
/*  813 */             xbean.NoneRealRoleMultiFightValueBean _v_ = xbean.Pod.newNoneRealRoleMultiFightValueBeanData();
...
/*      */     public xbean.NoneRealTimeMultiFightValueRank toBean()
/*      */     {
/*  878 */       return new NoneRealTimeMultiFightValueRank(this, null, null);
/*      */     }
/*      */     
/*      */ 
/*      */     public xbean.NoneRealTimeMultiFightValueRank toDataIf()
...
/*      */     public xbean.NoneRealTimeMultiFightValueRank toBeanIf()
/*      */     {
/*  889 */       return new NoneRealTimeMultiFightValueRank(this, null, null);
/*      */     }
/*      */     
/*      */ 
/*      */     public boolean xdbManaged()
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\xbean\__\NoneRealTimeMultiFightValueRank.class
