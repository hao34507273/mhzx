...
/*     */ 
/*     */ public final class MercenaryFights extends xdb.XBean implements xbean.MercenaryFights
/*     */ {
...
/*     */   }
/*     */   
/*     */   MercenaryFights(int __, xdb.XBean _xp_, String _vn_)
/*     */   {
/*  23 */     super(_xp_, _vn_);
/*  24 */     this.fights = new SetX();
/*     */   }
/*     */   
/*     */   public MercenaryFights()
/*     */   {
/*  29 */     this(0, null, null);
/*     */   }
/*     */   
/*     */   public MercenaryFights(MercenaryFights _o_)
/*     */   {
/*  34 */     this(_o_, null, null);
/*     */   }
/*     */   
/*     */   MercenaryFights(xbean.MercenaryFights _o1_, xdb.XBean _xp_, String _vn_)
/*     */   {
/*  39 */     super(_xp_, _vn_);
/*  40 */     if ((_o1_ instanceof MercenaryFights)) { assign((MercenaryFights)_o1_);
...
/*     */   }
/*     */   
/*     */   private void assign(MercenaryFights _o_) {
...
/*     */   
/*     */ 
/*     */   public xbean.MercenaryFights copy()
/*     */   {
/* 163 */     _xdb_verify_unsafe_();
/* 164 */     return new MercenaryFights(this);
/*     */   }
/*     */   
/*     */ 
/*     */   public xbean.MercenaryFights toData()
/*     */   {
/* 170 */     _xdb_verify_unsafe_();
/* 171 */     return new Data(this);
/*     */   }
/*     */   
/*     */   public xbean.MercenaryFights toBean()
/*     */   {
/* 176 */     _xdb_verify_unsafe_();
/* 177 */     return new MercenaryFights(this);
/*     */   }
/*     */   
/*     */ 
/*     */   public xbean.MercenaryFights toDataIf()
/*     */   {
/* 183 */     _xdb_verify_unsafe_();
/* 184 */     return new Data(this);
/*     */   }
/*     */   
/*     */   public xbean.MercenaryFights toBeanIf()
/*     */   {
...
/* 223 */     MercenaryFights _o_ = null;
/* 224 */     if ((_o1_ instanceof MercenaryFights)) { _o_ = (MercenaryFights)_o1_;
...
/*     */   }
/*     */   
/*     */   private class Const implements xbean.MercenaryFights {
/*     */     private Const() {}
/*     */     
/*     */     MercenaryFights nThis() {
/* 263 */       return MercenaryFights.this;
/*     */     }
/*     */     
/*     */ 
/*     */     public void _reset_unsafe_()
...
/*     */     public xbean.MercenaryFights copy()
/*     */     {
/* 275 */       return MercenaryFights.this.copy();
/*     */     }
/*     */     
/*     */ 
/*     */     public xbean.MercenaryFights toData()
/*     */     {
/* 281 */       return MercenaryFights.this.toData();
/*     */     }
/*     */     
/*     */     public xbean.MercenaryFights toBean()
/*     */     {
/* 286 */       return MercenaryFights.this.toBean();
/*     */     }
/*     */     
/*     */ 
/*     */     public xbean.MercenaryFights toDataIf()
/*     */     {
/* 292 */       return MercenaryFights.this.toDataIf();
/*     */     }
/*     */     
/*     */     public xbean.MercenaryFights toBeanIf()
/*     */     {
/* 297 */       return MercenaryFights.this.toBeanIf();
/*     */     }
/*     */     
/*     */ 
/*     */ 
/*     */     public Set<Long> getFights()
/*     */     {
/* 304 */       MercenaryFights.this._xdb_verify_unsafe_();
/* 305 */       return xdb.Consts.constSet(MercenaryFights.this.fights);
/*     */     }
/*     */     
/*     */ 
/*     */     public Set<Long> getFightsAsData()
/*     */     {
/* 311 */       MercenaryFights.this._xdb_verify_unsafe_();
/*     */       
/* 313 */       MercenaryFights _o_ = MercenaryFights.this;
...
/*     */     public xdb.Bean toConst()
/*     */     {
/* 322 */       MercenaryFights.this._xdb_verify_unsafe_();
/* 323 */       return this;
/*     */     }
/*     */     
/*     */ 
...
/*     */     {
/* 329 */       MercenaryFights.this._xdb_verify_unsafe_();
/* 330 */       return true;
/*     */     }
/*     */     
/*     */ 
...
/*     */     {
/* 336 */       return MercenaryFights.this.isData();
/*     */     }
/*     */     
/*     */ 
/*     */     public OctetsStream marshal(OctetsStream _os_)
/*     */     {
/* 342 */       return MercenaryFights.this.marshal(_os_);
/*     */     }
/*     */     
/*     */     public OctetsStream unmarshal(OctetsStream _os_)
/*     */       throws com.goldhuman.Common.Marshal.MarshalException
/*     */     {
/* 348 */       MercenaryFights.this._xdb_verify_unsafe_();
...
/*     */     public int getSerializedSize()
/*     */     {
/* 355 */       return MercenaryFights.this.getSerializedSize();
/*     */     }
/*     */     
/*     */     public CodedOutputStream marshal(CodedOutputStream _output_)
/*     */       throws InvalidProtocolBufferException
/*     */     {
/* 361 */       return MercenaryFights.this.marshal(_output_);
/*     */     }
/*     */     
/*     */     public CodedInputStream unmarshal(CodedInputStream _input_)
/*     */       throws InvalidProtocolBufferException
/*     */     {
/* 367 */       MercenaryFights.this._xdb_verify_unsafe_();
...
/*     */     {
/* 374 */       return MercenaryFights.this.xdbParent();
/*     */     }
/*     */     
/*     */ 
/*     */     public boolean xdbManaged()
/*     */     {
/* 380 */       return MercenaryFights.this.xdbManaged();
/*     */     }
/*     */     
/*     */ 
/*     */     public String xdbVarname()
/*     */     {
/* 386 */       return MercenaryFights.this.xdbVarname();
/*     */     }
/*     */     
/*     */ 
/*     */     public Long xdbObjId()
/*     */     {
/* 392 */       return MercenaryFights.this.xdbObjId();
/*     */     }
/*     */     
/*     */ 
/*     */     public boolean equals(Object obj)
/*     */     {
/* 398 */       return MercenaryFights.this.equals(obj);
/*     */     }
/*     */     
/*     */ 
/*     */     public int hashCode()
/*     */     {
/* 404 */       return MercenaryFights.this.hashCode();
/*     */     }
/*     */     
/*     */ 
/*     */     public String toString()
/*     */     {
/* 410 */       return MercenaryFights.this.toString();
/*     */     }
/*     */   }
/*     */   
/*     */ 
/*     */   public static final class Data
/*     */     implements xbean.MercenaryFights
/*     */   {
...
/*     */     }
/*     */     
/*     */     Data(xbean.MercenaryFights _o1_)
/*     */     {
/* 432 */       if ((_o1_ instanceof MercenaryFights)) { assign((MercenaryFights)_o1_);
/* 433 */       } else if ((_o1_ instanceof Data)) { assign((Data)_o1_);
/* 434 */       } else if ((_o1_ instanceof MercenaryFights.Const)) assign(((MercenaryFights.Const)_o1_).nThis()); else {
...
/*     */     public xbean.MercenaryFights toBean()
/*     */     {
/* 560 */       return new MercenaryFights(this, null, null);
/*     */     }
/*     */     
/*     */ 
/*     */     public xbean.MercenaryFights toDataIf()
...
/*     */     public xbean.MercenaryFights toBeanIf()
/*     */     {
/* 571 */       return new MercenaryFights(this, null, null);
/*     */     }
/*     */     
/*     */ 
/*     */     public boolean xdbManaged()
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\xbean\__\MercenaryFights.class
