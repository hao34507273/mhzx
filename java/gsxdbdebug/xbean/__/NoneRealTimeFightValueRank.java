...
/*      */ import xdb.XBean;
/*      */ 
/*      */ public final class NoneRealTimeFightValueRank extends XBean implements xbean.NoneRealTimeFightValueRank
/*      */ {
/*      */   private LinkedList<xbean.NoneRealRoleFightValueBean> rankdatas;
...
/*      */   }
/*      */   
/*      */   NoneRealTimeFightValueRank(int __, XBean _xp_, String _vn_)
/*      */   {
/*   32 */     super(_xp_, _vn_);
...
/*      */   }
/*      */   
/*      */   public NoneRealTimeFightValueRank()
/*      */   {
/*   40 */     this(0, null, null);
/*      */   }
/*      */   
/*      */   public NoneRealTimeFightValueRank(NoneRealTimeFightValueRank _o_)
/*      */   {
/*   45 */     this(_o_, null, null);
/*      */   }
/*      */   
/*      */   NoneRealTimeFightValueRank(xbean.NoneRealTimeFightValueRank _o1_, XBean _xp_, String _vn_)
/*      */   {
/*   50 */     super(_xp_, _vn_);
/*   51 */     if ((_o1_ instanceof NoneRealTimeFightValueRank)) { assign((NoneRealTimeFightValueRank)_o1_);
...
/*      */   }
/*      */   
/*      */   private void assign(NoneRealTimeFightValueRank _o_) {
/*   59 */     _o_._xdb_verify_unsafe_();
/*   60 */     this.rankdatas = new LinkedList();
/*   61 */     for (xbean.NoneRealRoleFightValueBean _v_ : _o_.rankdatas)
/*   62 */       this.rankdatas.add(new NoneRealRoleFightValueBean(_v_, this, "rankdatas"));
...
/*   73 */     for (xbean.NoneRealRoleFightValueBean _v_ : _o_.rankdatas)
/*   74 */       this.rankdatas.add(new NoneRealRoleFightValueBean(_v_, this, "rankdatas"));
...
/*   87 */     for (xbean.NoneRealRoleFightValueBean _v_ : this.rankdatas)
/*      */     {
/*   89 */       _v_.marshal(_os_);
/*      */     }
...
/*      */     {
/*  108 */       xbean.NoneRealRoleFightValueBean _v_ = new NoneRealRoleFightValueBean(0, this, "rankdatas");
...
/*  136 */     int _size_ = 0;
/*  137 */     for (xbean.NoneRealRoleFightValueBean _v_ : this.rankdatas)
/*      */     {
...
/*      */     try
/*      */     {
/*  157 */       for (xbean.NoneRealRoleFightValueBean _v_ : this.rankdatas)
/*      */       {
...
/*      */ 
/*      */         case 10: 
/*  195 */           xbean.NoneRealRoleFightValueBean _v_ = new NoneRealRoleFightValueBean(0, this, "rankdatas");
...
/*      */   
/*      */ 
/*      */   public xbean.NoneRealTimeFightValueRank copy()
/*      */   {
/*  249 */     _xdb_verify_unsafe_();
/*  250 */     return new NoneRealTimeFightValueRank(this);
/*      */   }
/*      */   
/*      */ 
/*      */   public xbean.NoneRealTimeFightValueRank toData()
/*      */   {
/*  256 */     _xdb_verify_unsafe_();
/*  257 */     return new Data(this);
/*      */   }
/*      */   
/*      */   public xbean.NoneRealTimeFightValueRank toBean()
/*      */   {
/*  262 */     _xdb_verify_unsafe_();
/*  263 */     return new NoneRealTimeFightValueRank(this);
/*      */   }
/*      */   
/*      */ 
/*      */   public xbean.NoneRealTimeFightValueRank toDataIf()
/*      */   {
/*  269 */     _xdb_verify_unsafe_();
/*  270 */     return new Data(this);
/*      */   }
/*      */   
/*      */   public xbean.NoneRealTimeFightValueRank toBeanIf()
/*      */   {
...
/*      */ 
/*      */ 
/*      */   public List<xbean.NoneRealRoleFightValueBean> getRankdatas()
/*      */   {
...
/*      */   
/*      */ 
/*      */   public List<xbean.NoneRealRoleFightValueBean> getRankdatasAsData()
/*      */   {
/*  297 */     _xdb_verify_unsafe_();
/*      */     
/*  299 */     NoneRealTimeFightValueRank _o_ = this;
/*  300 */     List<xbean.NoneRealRoleFightValueBean> rankdatas = new LinkedList();
/*  301 */     for (xbean.NoneRealRoleFightValueBean _v_ : _o_.rankdatas)
/*  302 */       rankdatas.add(new NoneRealRoleFightValueBean.Data(_v_));
...
/*      */     
/*  320 */     NoneRealTimeFightValueRank _o_ = this;
...
/*      */       {
/*  352 */         new xdb.logs.LogLong(this, NoneRealTimeFightValueRank.this.savetime)
/*      */         {
/*      */           public void rollback()
/*      */           {
/*  356 */             NoneRealTimeFightValueRank.this.savetime = this._xdb_saved;
/*      */           }
/*      */         };
/*      */       }
/*  360 */     });
...
/*      */       protected xdb.Log create()
/*      */       {
/*  373 */         new xdb.logs.LogLong(this, NoneRealTimeFightValueRank.this.awardtime)
/*      */         {
/*      */           public void rollback()
/*      */           {
/*  377 */             NoneRealTimeFightValueRank.this.awardtime = this._xdb_saved;
/*      */           }
/*      */         };
/*      */       }
/*  381 */     });
...
/*  389 */     NoneRealTimeFightValueRank _o_ = null;
/*  390 */     if ((_o1_ instanceof NoneRealTimeFightValueRank)) { _o_ = (NoneRealTimeFightValueRank)_o1_;
...
/*      */   }
/*      */   
/*      */   private class Const implements xbean.NoneRealTimeFightValueRank {
/*      */     private Const() {}
/*      */     
/*      */     NoneRealTimeFightValueRank nThis() {
/*  444 */       return NoneRealTimeFightValueRank.this;
/*      */     }
/*      */     
/*      */ 
/*      */     public void _reset_unsafe_()
...
/*      */     public xbean.NoneRealTimeFightValueRank copy()
/*      */     {
/*  456 */       return NoneRealTimeFightValueRank.this.copy();
/*      */     }
/*      */     
/*      */ 
/*      */     public xbean.NoneRealTimeFightValueRank toData()
/*      */     {
/*  462 */       return NoneRealTimeFightValueRank.this.toData();
/*      */     }
/*      */     
/*      */     public xbean.NoneRealTimeFightValueRank toBean()
/*      */     {
/*  467 */       return NoneRealTimeFightValueRank.this.toBean();
/*      */     }
/*      */     
/*      */ 
/*      */     public xbean.NoneRealTimeFightValueRank toDataIf()
/*      */     {
/*  473 */       return NoneRealTimeFightValueRank.this.toDataIf();
/*      */     }
/*      */     
/*      */     public xbean.NoneRealTimeFightValueRank toBeanIf()
/*      */     {
/*  478 */       return NoneRealTimeFightValueRank.this.toBeanIf();
/*      */     }
/*      */     
/*      */ 
/*      */ 
/*      */     public List<xbean.NoneRealRoleFightValueBean> getRankdatas()
/*      */     {
/*  485 */       NoneRealTimeFightValueRank.this._xdb_verify_unsafe_();
/*  486 */       return xdb.Consts.constList(NoneRealTimeFightValueRank.this.rankdatas);
/*      */     }
/*      */     
/*      */ 
/*      */     public List<xbean.NoneRealRoleFightValueBean> getRankdatasAsData()
/*      */     {
/*  492 */       NoneRealTimeFightValueRank.this._xdb_verify_unsafe_();
/*      */       
/*  494 */       NoneRealTimeFightValueRank _o_ = NoneRealTimeFightValueRank.this;
/*  495 */       List<xbean.NoneRealRoleFightValueBean> rankdatas = new LinkedList();
/*  496 */       for (xbean.NoneRealRoleFightValueBean _v_ : _o_.rankdatas)
/*  497 */         rankdatas.add(new NoneRealRoleFightValueBean.Data(_v_));
...
/*      */     public Map<Long, Integer> getKeytorankchange()
/*      */     {
/*  505 */       NoneRealTimeFightValueRank.this._xdb_verify_unsafe_();
/*  506 */       return xdb.Consts.constMap(NoneRealTimeFightValueRank.this.keytorankchange);
/*      */     }
/*      */     
/*      */ 
/*      */ 
/*      */     public Map<Long, Integer> getKeytorankchangeAsData()
/*      */     {
/*  513 */       NoneRealTimeFightValueRank.this._xdb_verify_unsafe_();
/*      */       
/*  515 */       NoneRealTimeFightValueRank _o_ = NoneRealTimeFightValueRank.this;
...
/*      */     public long getSavetime()
/*      */     {
/*  526 */       NoneRealTimeFightValueRank.this._xdb_verify_unsafe_();
/*  527 */       return NoneRealTimeFightValueRank.this.savetime;
/*      */     }
/*      */     
/*      */ 
/*      */ 
/*      */     public long getAwardtime()
/*      */     {
/*  534 */       NoneRealTimeFightValueRank.this._xdb_verify_unsafe_();
/*  535 */       return NoneRealTimeFightValueRank.this.awardtime;
/*      */     }
/*      */     
/*      */ 
/*      */ 
/*      */     public void setSavetime(long _v_)
/*      */     {
/*  542 */       NoneRealTimeFightValueRank.this._xdb_verify_unsafe_();
...
/*      */     public void setAwardtime(long _v_)
/*      */     {
/*  550 */       NoneRealTimeFightValueRank.this._xdb_verify_unsafe_();
...
/*      */     public xdb.Bean toConst()
/*      */     {
/*  557 */       NoneRealTimeFightValueRank.this._xdb_verify_unsafe_();
/*  558 */       return this;
/*      */     }
/*      */     
/*      */ 
...
/*      */     {
/*  564 */       NoneRealTimeFightValueRank.this._xdb_verify_unsafe_();
/*  565 */       return true;
/*      */     }
/*      */     
/*      */ 
...
/*      */     {
/*  571 */       return NoneRealTimeFightValueRank.this.isData();
/*      */     }
/*      */     
/*      */ 
/*      */     public OctetsStream marshal(OctetsStream _os_)
/*      */     {
/*  577 */       return NoneRealTimeFightValueRank.this.marshal(_os_);
/*      */     }
/*      */     
/*      */     public OctetsStream unmarshal(OctetsStream _os_)
/*      */       throws com.goldhuman.Common.Marshal.MarshalException
/*      */     {
/*  583 */       NoneRealTimeFightValueRank.this._xdb_verify_unsafe_();
...
/*      */     public int getSerializedSize()
/*      */     {
/*  590 */       return NoneRealTimeFightValueRank.this.getSerializedSize();
/*      */     }
/*      */     
/*      */     public CodedOutputStream marshal(CodedOutputStream _output_)
/*      */       throws InvalidProtocolBufferException
/*      */     {
/*  596 */       return NoneRealTimeFightValueRank.this.marshal(_output_);
/*      */     }
/*      */     
/*      */     public CodedInputStream unmarshal(CodedInputStream _input_)
/*      */       throws InvalidProtocolBufferException
/*      */     {
/*  602 */       NoneRealTimeFightValueRank.this._xdb_verify_unsafe_();
...
/*      */     {
/*  609 */       return NoneRealTimeFightValueRank.this.xdbParent();
/*      */     }
/*      */     
/*      */ 
/*      */     public boolean xdbManaged()
/*      */     {
/*  615 */       return NoneRealTimeFightValueRank.this.xdbManaged();
/*      */     }
/*      */     
/*      */ 
/*      */     public String xdbVarname()
/*      */     {
/*  621 */       return NoneRealTimeFightValueRank.this.xdbVarname();
/*      */     }
/*      */     
/*      */ 
/*      */     public Long xdbObjId()
/*      */     {
/*  627 */       return NoneRealTimeFightValueRank.this.xdbObjId();
/*      */     }
/*      */     
/*      */ 
/*      */     public boolean equals(Object obj)
/*      */     {
/*  633 */       return NoneRealTimeFightValueRank.this.equals(obj);
/*      */     }
/*      */     
/*      */ 
/*      */     public int hashCode()
/*      */     {
/*  639 */       return NoneRealTimeFightValueRank.this.hashCode();
/*      */     }
/*      */     
/*      */ 
/*      */     public String toString()
/*      */     {
/*  645 */       return NoneRealTimeFightValueRank.this.toString();
/*      */     }
/*      */   }
/*      */   
/*      */ 
/*      */   public static final class Data
/*      */     implements xbean.NoneRealTimeFightValueRank
/*      */   {
/*      */     private LinkedList<xbean.NoneRealRoleFightValueBean> rankdatas;
/*      */     
/*      */     private HashMap<Long, Integer> keytorankchange;
...
/*      */     }
/*      */     
/*      */     Data(xbean.NoneRealTimeFightValueRank _o1_)
/*      */     {
/*  675 */       if ((_o1_ instanceof NoneRealTimeFightValueRank)) { assign((NoneRealTimeFightValueRank)_o1_);
/*  676 */       } else if ((_o1_ instanceof Data)) { assign((Data)_o1_);
/*  677 */       } else if ((_o1_ instanceof NoneRealTimeFightValueRank.Const)) assign(((NoneRealTimeFightValueRank.Const)_o1_).nThis()); else {
...
/*  684 */       for (xbean.NoneRealRoleFightValueBean _v_ : _o_.rankdatas)
/*  685 */         this.rankdatas.add(new NoneRealRoleFightValueBean.Data(_v_));
...
/*  696 */       for (xbean.NoneRealRoleFightValueBean _v_ : _o_.rankdatas)
/*  697 */         this.rankdatas.add(new NoneRealRoleFightValueBean.Data(_v_));
...
/*  709 */       for (xbean.NoneRealRoleFightValueBean _v_ : this.rankdatas)
/*      */       {
...
/*      */       {
/*  729 */         xbean.NoneRealRoleFightValueBean _v_ = xbean.Pod.newNoneRealRoleFightValueBeanData();
...
/*      */     {
/*  756 */       int _size_ = 0;
/*  757 */       for (xbean.NoneRealRoleFightValueBean _v_ : this.rankdatas)
/*      */       {
...
/*      */       try
/*      */       {
/*  776 */         for (xbean.NoneRealRoleFightValueBean _v_ : this.rankdatas)
/*      */         {
...
/*      */ 
/*      */           case 10: 
/*  813 */             xbean.NoneRealRoleFightValueBean _v_ = xbean.Pod.newNoneRealRoleFightValueBeanData();
...
/*      */     public xbean.NoneRealTimeFightValueRank toBean()
/*      */     {
/*  878 */       return new NoneRealTimeFightValueRank(this, null, null);
/*      */     }
/*      */     
/*      */ 
/*      */     public xbean.NoneRealTimeFightValueRank toDataIf()
...
/*      */     public xbean.NoneRealTimeFightValueRank toBeanIf()
/*      */     {
/*  889 */       return new NoneRealTimeFightValueRank(this, null, null);
/*      */     }
/*      */     
/*      */ 
/*      */     public boolean xdbManaged()
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\xbean\__\NoneRealTimeFightValueRank.class
