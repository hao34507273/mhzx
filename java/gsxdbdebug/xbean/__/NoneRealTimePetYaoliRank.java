...
/*      */ import xdb.XBean;
/*      */ 
/*      */ public final class NoneRealTimePetYaoliRank extends XBean implements xbean.NoneRealTimePetYaoliRank
/*      */ {
/*      */   private LinkedList<xbean.NoneRealTimePetYaoliBean> rankdatas;
...
/*      */   }
/*      */   
/*      */   NoneRealTimePetYaoliRank(int __, XBean _xp_, String _vn_)
/*      */   {
/*   32 */     super(_xp_, _vn_);
...
/*      */   }
/*      */   
/*      */   public NoneRealTimePetYaoliRank()
/*      */   {
/*   40 */     this(0, null, null);
/*      */   }
/*      */   
/*      */   public NoneRealTimePetYaoliRank(NoneRealTimePetYaoliRank _o_)
/*      */   {
/*   45 */     this(_o_, null, null);
/*      */   }
/*      */   
/*      */   NoneRealTimePetYaoliRank(xbean.NoneRealTimePetYaoliRank _o1_, XBean _xp_, String _vn_)
/*      */   {
/*   50 */     super(_xp_, _vn_);
/*   51 */     if ((_o1_ instanceof NoneRealTimePetYaoliRank)) { assign((NoneRealTimePetYaoliRank)_o1_);
...
/*      */   }
/*      */   
/*      */   private void assign(NoneRealTimePetYaoliRank _o_) {
/*   59 */     _o_._xdb_verify_unsafe_();
/*   60 */     this.rankdatas = new LinkedList();
/*   61 */     for (xbean.NoneRealTimePetYaoliBean _v_ : _o_.rankdatas)
/*   62 */       this.rankdatas.add(new NoneRealTimePetYaoliBean(_v_, this, "rankdatas"));
...
/*   73 */     for (xbean.NoneRealTimePetYaoliBean _v_ : _o_.rankdatas)
/*   74 */       this.rankdatas.add(new NoneRealTimePetYaoliBean(_v_, this, "rankdatas"));
...
/*   87 */     for (xbean.NoneRealTimePetYaoliBean _v_ : this.rankdatas)
/*      */     {
/*   89 */       _v_.marshal(_os_);
/*      */     }
...
/*      */     {
/*  108 */       xbean.NoneRealTimePetYaoliBean _v_ = new NoneRealTimePetYaoliBean(0, this, "rankdatas");
...
/*  136 */     int _size_ = 0;
/*  137 */     for (xbean.NoneRealTimePetYaoliBean _v_ : this.rankdatas)
/*      */     {
...
/*      */     try
/*      */     {
/*  157 */       for (xbean.NoneRealTimePetYaoliBean _v_ : this.rankdatas)
/*      */       {
...
/*      */ 
/*      */         case 10: 
/*  195 */           xbean.NoneRealTimePetYaoliBean _v_ = new NoneRealTimePetYaoliBean(0, this, "rankdatas");
...
/*      */   
/*      */ 
/*      */   public xbean.NoneRealTimePetYaoliRank copy()
/*      */   {
/*  249 */     _xdb_verify_unsafe_();
/*  250 */     return new NoneRealTimePetYaoliRank(this);
/*      */   }
/*      */   
/*      */ 
/*      */   public xbean.NoneRealTimePetYaoliRank toData()
/*      */   {
/*  256 */     _xdb_verify_unsafe_();
/*  257 */     return new Data(this);
/*      */   }
/*      */   
/*      */   public xbean.NoneRealTimePetYaoliRank toBean()
/*      */   {
/*  262 */     _xdb_verify_unsafe_();
/*  263 */     return new NoneRealTimePetYaoliRank(this);
/*      */   }
/*      */   
/*      */ 
/*      */   public xbean.NoneRealTimePetYaoliRank toDataIf()
/*      */   {
/*  269 */     _xdb_verify_unsafe_();
/*  270 */     return new Data(this);
/*      */   }
/*      */   
/*      */   public xbean.NoneRealTimePetYaoliRank toBeanIf()
/*      */   {
...
/*      */ 
/*      */ 
/*      */   public List<xbean.NoneRealTimePetYaoliBean> getRankdatas()
/*      */   {
...
/*      */   
/*      */ 
/*      */   public List<xbean.NoneRealTimePetYaoliBean> getRankdatasAsData()
/*      */   {
/*  297 */     _xdb_verify_unsafe_();
/*      */     
/*  299 */     NoneRealTimePetYaoliRank _o_ = this;
/*  300 */     List<xbean.NoneRealTimePetYaoliBean> rankdatas = new LinkedList();
/*  301 */     for (xbean.NoneRealTimePetYaoliBean _v_ : _o_.rankdatas)
/*  302 */       rankdatas.add(new NoneRealTimePetYaoliBean.Data(_v_));
...
/*      */     
/*  320 */     NoneRealTimePetYaoliRank _o_ = this;
...
/*      */       {
/*  352 */         new xdb.logs.LogLong(this, NoneRealTimePetYaoliRank.this.savetime)
/*      */         {
/*      */           public void rollback()
/*      */           {
/*  356 */             NoneRealTimePetYaoliRank.this.savetime = this._xdb_saved;
/*      */           }
/*      */         };
/*      */       }
/*  360 */     });
...
/*      */       protected xdb.Log create()
/*      */       {
/*  373 */         new xdb.logs.LogLong(this, NoneRealTimePetYaoliRank.this.awardtime)
/*      */         {
/*      */           public void rollback()
/*      */           {
/*  377 */             NoneRealTimePetYaoliRank.this.awardtime = this._xdb_saved;
/*      */           }
/*      */         };
/*      */       }
/*  381 */     });
...
/*  389 */     NoneRealTimePetYaoliRank _o_ = null;
/*  390 */     if ((_o1_ instanceof NoneRealTimePetYaoliRank)) { _o_ = (NoneRealTimePetYaoliRank)_o1_;
...
/*      */   }
/*      */   
/*      */   private class Const implements xbean.NoneRealTimePetYaoliRank {
/*      */     private Const() {}
/*      */     
/*      */     NoneRealTimePetYaoliRank nThis() {
/*  444 */       return NoneRealTimePetYaoliRank.this;
/*      */     }
/*      */     
/*      */ 
/*      */     public void _reset_unsafe_()
...
/*      */     public xbean.NoneRealTimePetYaoliRank copy()
/*      */     {
/*  456 */       return NoneRealTimePetYaoliRank.this.copy();
/*      */     }
/*      */     
/*      */ 
/*      */     public xbean.NoneRealTimePetYaoliRank toData()
/*      */     {
/*  462 */       return NoneRealTimePetYaoliRank.this.toData();
/*      */     }
/*      */     
/*      */     public xbean.NoneRealTimePetYaoliRank toBean()
/*      */     {
/*  467 */       return NoneRealTimePetYaoliRank.this.toBean();
/*      */     }
/*      */     
/*      */ 
/*      */     public xbean.NoneRealTimePetYaoliRank toDataIf()
/*      */     {
/*  473 */       return NoneRealTimePetYaoliRank.this.toDataIf();
/*      */     }
/*      */     
/*      */     public xbean.NoneRealTimePetYaoliRank toBeanIf()
/*      */     {
/*  478 */       return NoneRealTimePetYaoliRank.this.toBeanIf();
/*      */     }
/*      */     
/*      */ 
/*      */ 
/*      */     public List<xbean.NoneRealTimePetYaoliBean> getRankdatas()
/*      */     {
/*  485 */       NoneRealTimePetYaoliRank.this._xdb_verify_unsafe_();
/*  486 */       return xdb.Consts.constList(NoneRealTimePetYaoliRank.this.rankdatas);
/*      */     }
/*      */     
/*      */ 
/*      */     public List<xbean.NoneRealTimePetYaoliBean> getRankdatasAsData()
/*      */     {
/*  492 */       NoneRealTimePetYaoliRank.this._xdb_verify_unsafe_();
/*      */       
/*  494 */       NoneRealTimePetYaoliRank _o_ = NoneRealTimePetYaoliRank.this;
/*  495 */       List<xbean.NoneRealTimePetYaoliBean> rankdatas = new LinkedList();
/*  496 */       for (xbean.NoneRealTimePetYaoliBean _v_ : _o_.rankdatas)
/*  497 */         rankdatas.add(new NoneRealTimePetYaoliBean.Data(_v_));
...
/*      */     public Map<Long, Integer> getKeytorankchange()
/*      */     {
/*  505 */       NoneRealTimePetYaoliRank.this._xdb_verify_unsafe_();
/*  506 */       return xdb.Consts.constMap(NoneRealTimePetYaoliRank.this.keytorankchange);
/*      */     }
/*      */     
/*      */ 
/*      */ 
/*      */     public Map<Long, Integer> getKeytorankchangeAsData()
/*      */     {
/*  513 */       NoneRealTimePetYaoliRank.this._xdb_verify_unsafe_();
/*      */       
/*  515 */       NoneRealTimePetYaoliRank _o_ = NoneRealTimePetYaoliRank.this;
...
/*      */     public long getSavetime()
/*      */     {
/*  526 */       NoneRealTimePetYaoliRank.this._xdb_verify_unsafe_();
/*  527 */       return NoneRealTimePetYaoliRank.this.savetime;
/*      */     }
/*      */     
/*      */ 
/*      */ 
/*      */     public long getAwardtime()
/*      */     {
/*  534 */       NoneRealTimePetYaoliRank.this._xdb_verify_unsafe_();
/*  535 */       return NoneRealTimePetYaoliRank.this.awardtime;
/*      */     }
/*      */     
/*      */ 
/*      */ 
/*      */     public void setSavetime(long _v_)
/*      */     {
/*  542 */       NoneRealTimePetYaoliRank.this._xdb_verify_unsafe_();
...
/*      */     public void setAwardtime(long _v_)
/*      */     {
/*  550 */       NoneRealTimePetYaoliRank.this._xdb_verify_unsafe_();
...
/*      */     public xdb.Bean toConst()
/*      */     {
/*  557 */       NoneRealTimePetYaoliRank.this._xdb_verify_unsafe_();
/*  558 */       return this;
/*      */     }
/*      */     
/*      */ 
...
/*      */     {
/*  564 */       NoneRealTimePetYaoliRank.this._xdb_verify_unsafe_();
/*  565 */       return true;
/*      */     }
/*      */     
/*      */ 
...
/*      */     {
/*  571 */       return NoneRealTimePetYaoliRank.this.isData();
/*      */     }
/*      */     
/*      */ 
/*      */     public OctetsStream marshal(OctetsStream _os_)
/*      */     {
/*  577 */       return NoneRealTimePetYaoliRank.this.marshal(_os_);
/*      */     }
/*      */     
/*      */     public OctetsStream unmarshal(OctetsStream _os_)
/*      */       throws com.goldhuman.Common.Marshal.MarshalException
/*      */     {
/*  583 */       NoneRealTimePetYaoliRank.this._xdb_verify_unsafe_();
...
/*      */     public int getSerializedSize()
/*      */     {
/*  590 */       return NoneRealTimePetYaoliRank.this.getSerializedSize();
/*      */     }
/*      */     
/*      */     public CodedOutputStream marshal(CodedOutputStream _output_)
/*      */       throws InvalidProtocolBufferException
/*      */     {
/*  596 */       return NoneRealTimePetYaoliRank.this.marshal(_output_);
/*      */     }
/*      */     
/*      */     public CodedInputStream unmarshal(CodedInputStream _input_)
/*      */       throws InvalidProtocolBufferException
/*      */     {
/*  602 */       NoneRealTimePetYaoliRank.this._xdb_verify_unsafe_();
...
/*      */     {
/*  609 */       return NoneRealTimePetYaoliRank.this.xdbParent();
/*      */     }
/*      */     
/*      */ 
/*      */     public boolean xdbManaged()
/*      */     {
/*  615 */       return NoneRealTimePetYaoliRank.this.xdbManaged();
/*      */     }
/*      */     
/*      */ 
/*      */     public String xdbVarname()
/*      */     {
/*  621 */       return NoneRealTimePetYaoliRank.this.xdbVarname();
/*      */     }
/*      */     
/*      */ 
/*      */     public Long xdbObjId()
/*      */     {
/*  627 */       return NoneRealTimePetYaoliRank.this.xdbObjId();
/*      */     }
/*      */     
/*      */ 
/*      */     public boolean equals(Object obj)
/*      */     {
/*  633 */       return NoneRealTimePetYaoliRank.this.equals(obj);
/*      */     }
/*      */     
/*      */ 
/*      */     public int hashCode()
/*      */     {
/*  639 */       return NoneRealTimePetYaoliRank.this.hashCode();
/*      */     }
/*      */     
/*      */ 
/*      */     public String toString()
/*      */     {
/*  645 */       return NoneRealTimePetYaoliRank.this.toString();
/*      */     }
/*      */   }
/*      */   
/*      */ 
/*      */   public static final class Data
/*      */     implements xbean.NoneRealTimePetYaoliRank
/*      */   {
/*      */     private LinkedList<xbean.NoneRealTimePetYaoliBean> rankdatas;
/*      */     
/*      */     private HashMap<Long, Integer> keytorankchange;
...
/*      */     }
/*      */     
/*      */     Data(xbean.NoneRealTimePetYaoliRank _o1_)
/*      */     {
/*  675 */       if ((_o1_ instanceof NoneRealTimePetYaoliRank)) { assign((NoneRealTimePetYaoliRank)_o1_);
/*  676 */       } else if ((_o1_ instanceof Data)) { assign((Data)_o1_);
/*  677 */       } else if ((_o1_ instanceof NoneRealTimePetYaoliRank.Const)) assign(((NoneRealTimePetYaoliRank.Const)_o1_).nThis()); else {
...
/*  684 */       for (xbean.NoneRealTimePetYaoliBean _v_ : _o_.rankdatas)
/*  685 */         this.rankdatas.add(new NoneRealTimePetYaoliBean.Data(_v_));
...
/*  696 */       for (xbean.NoneRealTimePetYaoliBean _v_ : _o_.rankdatas)
/*  697 */         this.rankdatas.add(new NoneRealTimePetYaoliBean.Data(_v_));
...
/*  709 */       for (xbean.NoneRealTimePetYaoliBean _v_ : this.rankdatas)
/*      */       {
...
/*      */       {
/*  729 */         xbean.NoneRealTimePetYaoliBean _v_ = xbean.Pod.newNoneRealTimePetYaoliBeanData();
...
/*      */     {
/*  756 */       int _size_ = 0;
/*  757 */       for (xbean.NoneRealTimePetYaoliBean _v_ : this.rankdatas)
/*      */       {
...
/*      */       try
/*      */       {
/*  776 */         for (xbean.NoneRealTimePetYaoliBean _v_ : this.rankdatas)
/*      */         {
...
/*      */ 
/*      */           case 10: 
/*  813 */             xbean.NoneRealTimePetYaoliBean _v_ = xbean.Pod.newNoneRealTimePetYaoliBeanData();
...
/*      */     public xbean.NoneRealTimePetYaoliRank toBean()
/*      */     {
/*  878 */       return new NoneRealTimePetYaoliRank(this, null, null);
/*      */     }
/*      */     
/*      */ 
/*      */     public xbean.NoneRealTimePetYaoliRank toDataIf()
...
/*      */     public xbean.NoneRealTimePetYaoliRank toBeanIf()
/*      */     {
/*  889 */       return new NoneRealTimePetYaoliRank(this, null, null);
/*      */     }
/*      */     
/*      */ 
/*      */     public boolean xdbManaged()
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\xbean\__\NoneRealTimePetYaoliRank.class
