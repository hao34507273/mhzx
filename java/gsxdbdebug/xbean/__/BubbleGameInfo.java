...
/*     */ 
/*     */ public final class BubbleGameInfo extends XBean implements xbean.BubbleGameInfo
/*     */ {
...
/*     */   private BubbleGameContext context;
/*     */   
...
/*     */   }
/*     */   
/*     */   BubbleGameInfo(int __, XBean _xp_, String _vn_)
/*     */   {
/*  38 */     super(_xp_, _vn_);
...
/*     */   }
/*     */   
/*     */   public BubbleGameInfo()
/*     */   {
/*  49 */     this(0, null, null);
/*     */   }
/*     */   
/*     */   public BubbleGameInfo(BubbleGameInfo _o_)
/*     */   {
/*  54 */     this(_o_, null, null);
/*     */   }
/*     */   
/*     */   BubbleGameInfo(xbean.BubbleGameInfo _o1_, XBean _xp_, String _vn_)
/*     */   {
/*  59 */     super(_xp_, _vn_);
...
/*     */   
/*     */ 
/*     */   public xbean.BubbleGameInfo copy()
/*     */   {
/*  96 */     _xdb_verify_unsafe_();
/*  97 */     return new BubbleGameInfo(this);
/*     */   }
/*     */   
/*     */ 
/*     */   public xbean.BubbleGameInfo toData()
/*     */   {
/* 103 */     _xdb_verify_unsafe_();
/* 104 */     return new Data(this);
/*     */   }
/*     */   
/*     */   public xbean.BubbleGameInfo toBean()
/*     */   {
/* 109 */     _xdb_verify_unsafe_();
/* 110 */     return new BubbleGameInfo(this);
/*     */   }
/*     */   
/*     */ 
/*     */   public xbean.BubbleGameInfo toDataIf()
/*     */   {
/* 116 */     _xdb_verify_unsafe_();
/* 117 */     return new Data(this);
/*     */   }
/*     */   
/*     */   public xbean.BubbleGameInfo toBeanIf()
/*     */   {
...
/*     */ 
/*     */ 
/*     */   public BubbleGameContext getContext()
/*     */   {
...
/*     */       {
/* 190 */         new LogInt(this, BubbleGameInfo.this.game_state)
/*     */         {
/*     */           public void rollback()
/*     */           {
/* 194 */             BubbleGameInfo.this.game_state = this._xdb_saved;
/*     */           }
/*     */         };
/*     */       }
/* 198 */     });
...
/*     */       protected Log create()
/*     */       {
/* 211 */         new LogInt(this, BubbleGameInfo.this.complete_turn_index)
/*     */         {
/*     */           public void rollback()
/*     */           {
/* 215 */             BubbleGameInfo.this.complete_turn_index = this._xdb_saved;
/*     */           }
/*     */         };
/*     */       }
/* 219 */     });
...
/*     */       protected Log create()
/*     */       {
/* 232 */         new LogInt(this, BubbleGameInfo.this.right_turn_num)
/*     */         {
/*     */           public void rollback()
/*     */           {
/* 236 */             BubbleGameInfo.this.right_turn_num = this._xdb_saved;
/*     */           }
/*     */         };
/*     */       }
/* 240 */     });
...
/*     */       protected Log create()
/*     */       {
/* 253 */         new xdb.logs.LogLong(this, BubbleGameInfo.this.sessionid)
/*     */         {
/*     */           public void rollback()
/*     */           {
/* 257 */             BubbleGameInfo.this.sessionid = this._xdb_saved;
/*     */           }
/*     */         };
/*     */       }
/* 261 */     });
...
/*     */       protected Log create()
/*     */       {
/* 274 */         new xdb.logs.LogLong(this, BubbleGameInfo.this.start_timestamp)
/*     */         {
/*     */           public void rollback()
/*     */           {
/* 278 */             BubbleGameInfo.this.start_timestamp = this._xdb_saved;
/*     */           }
/*     */         };
/*     */       }
/* 282 */     });
...
/*     */ 
/*     */ 
/*     */   public void setContext(BubbleGameContext _v_)
/*     */   {
...
/*     */       protected Log create()
/*     */       {
/* 295 */         new xdb.logs.LogObject(this, BubbleGameInfo.this.context)
/*     */         {
/*     */           public void rollback()
/*     */           {
/* 299 */             BubbleGameInfo.this.context = ((BubbleGameContext)this._xdb_saved);
/*     */           }
/*     */         };
/*     */       }
/* 303 */     });
...
/* 311 */     BubbleGameInfo _o_ = null;
/* 312 */     if ((_o1_ instanceof BubbleGameInfo)) { _o_ = (BubbleGameInfo)_o1_;
...
/*     */   }
/*     */   
/*     */   private class Const implements xbean.BubbleGameInfo {
/*     */     private Const() {}
/*     */     
/*     */     BubbleGameInfo nThis() {
/* 376 */       return BubbleGameInfo.this;
/*     */     }
/*     */     
/*     */ 
/*     */     public void _reset_unsafe_()
...
/*     */     public xbean.BubbleGameInfo copy()
/*     */     {
/* 388 */       return BubbleGameInfo.this.copy();
/*     */     }
/*     */     
/*     */ 
/*     */     public xbean.BubbleGameInfo toData()
/*     */     {
/* 394 */       return BubbleGameInfo.this.toData();
/*     */     }
/*     */     
/*     */     public xbean.BubbleGameInfo toBean()
/*     */     {
/* 399 */       return BubbleGameInfo.this.toBean();
/*     */     }
/*     */     
/*     */ 
/*     */     public xbean.BubbleGameInfo toDataIf()
/*     */     {
/* 405 */       return BubbleGameInfo.this.toDataIf();
/*     */     }
/*     */     
/*     */     public xbean.BubbleGameInfo toBeanIf()
/*     */     {
/* 410 */       return BubbleGameInfo.this.toBeanIf();
/*     */     }
/*     */     
/*     */ 
/*     */ 
/*     */     public int getGame_state()
/*     */     {
/* 417 */       BubbleGameInfo.this._xdb_verify_unsafe_();
/* 418 */       return BubbleGameInfo.this.game_state;
/*     */     }
/*     */     
/*     */ 
/*     */ 
/*     */     public int getComplete_turn_index()
/*     */     {
/* 425 */       BubbleGameInfo.this._xdb_verify_unsafe_();
/* 426 */       return BubbleGameInfo.this.complete_turn_index;
/*     */     }
/*     */     
/*     */ 
/*     */ 
/*     */     public int getRight_turn_num()
/*     */     {
/* 433 */       BubbleGameInfo.this._xdb_verify_unsafe_();
/* 434 */       return BubbleGameInfo.this.right_turn_num;
/*     */     }
/*     */     
/*     */ 
/*     */ 
/*     */     public long getSessionid()
/*     */     {
/* 441 */       BubbleGameInfo.this._xdb_verify_unsafe_();
/* 442 */       return BubbleGameInfo.this.sessionid;
/*     */     }
/*     */     
/*     */ 
/*     */ 
/*     */     public long getStart_timestamp()
/*     */     {
/* 449 */       BubbleGameInfo.this._xdb_verify_unsafe_();
/* 450 */       return BubbleGameInfo.this.start_timestamp;
/*     */     }
/*     */     
/*     */ 
/*     */ 
/*     */     public BubbleGameContext getContext()
/*     */     {
/* 457 */       BubbleGameInfo.this._xdb_verify_unsafe_();
/* 458 */       return BubbleGameInfo.this.context;
/*     */     }
/*     */     
/*     */ 
/*     */ 
/*     */     public void setGame_state(int _v_)
/*     */     {
/* 465 */       BubbleGameInfo.this._xdb_verify_unsafe_();
...
/*     */     public void setComplete_turn_index(int _v_)
/*     */     {
/* 473 */       BubbleGameInfo.this._xdb_verify_unsafe_();
...
/*     */     public void setRight_turn_num(int _v_)
/*     */     {
/* 481 */       BubbleGameInfo.this._xdb_verify_unsafe_();
...
/*     */     public void setSessionid(long _v_)
/*     */     {
/* 489 */       BubbleGameInfo.this._xdb_verify_unsafe_();
...
/*     */     public void setStart_timestamp(long _v_)
/*     */     {
/* 497 */       BubbleGameInfo.this._xdb_verify_unsafe_();
...
/*     */     public void setContext(BubbleGameContext _v_)
/*     */     {
/* 505 */       BubbleGameInfo.this._xdb_verify_unsafe_();
...
/*     */     public Bean toConst()
/*     */     {
/* 512 */       BubbleGameInfo.this._xdb_verify_unsafe_();
/* 513 */       return this;
/*     */     }
/*     */     
/*     */ 
...
/*     */     {
/* 519 */       BubbleGameInfo.this._xdb_verify_unsafe_();
/* 520 */       return true;
/*     */     }
/*     */     
/*     */ 
...
/*     */     {
/* 526 */       return BubbleGameInfo.this.isData();
/*     */     }
/*     */     
/*     */ 
/*     */     public OctetsStream marshal(OctetsStream _os_)
/*     */     {
/* 532 */       return BubbleGameInfo.this.marshal(_os_);
/*     */     }
/*     */     
/*     */     public OctetsStream unmarshal(OctetsStream _os_)
/*     */       throws com.goldhuman.Common.Marshal.MarshalException
/*     */     {
/* 538 */       BubbleGameInfo.this._xdb_verify_unsafe_();
...
/*     */     public int getSerializedSize()
/*     */     {
/* 545 */       return BubbleGameInfo.this.getSerializedSize();
/*     */     }
/*     */     
/*     */     public CodedOutputStream marshal(CodedOutputStream _output_)
/*     */       throws InvalidProtocolBufferException
/*     */     {
/* 551 */       return BubbleGameInfo.this.marshal(_output_);
/*     */     }
/*     */     
/*     */     public CodedInputStream unmarshal(CodedInputStream _input_)
/*     */       throws InvalidProtocolBufferException
/*     */     {
/* 557 */       BubbleGameInfo.this._xdb_verify_unsafe_();
...
/*     */     {
/* 564 */       return BubbleGameInfo.this.xdbParent();
/*     */     }
/*     */     
/*     */ 
/*     */     public boolean xdbManaged()
/*     */     {
/* 570 */       return BubbleGameInfo.this.xdbManaged();
/*     */     }
/*     */     
/*     */ 
/*     */     public String xdbVarname()
/*     */     {
/* 576 */       return BubbleGameInfo.this.xdbVarname();
/*     */     }
/*     */     
/*     */ 
/*     */     public Long xdbObjId()
/*     */     {
/* 582 */       return BubbleGameInfo.this.xdbObjId();
/*     */     }
/*     */     
/*     */ 
/*     */     public boolean equals(Object obj)
/*     */     {
/* 588 */       return BubbleGameInfo.this.equals(obj);
/*     */     }
/*     */     
/*     */ 
/*     */     public int hashCode()
/*     */     {
/* 594 */       return BubbleGameInfo.this.hashCode();
/*     */     }
/*     */     
/*     */ 
/*     */     public String toString()
/*     */     {
/* 600 */       return BubbleGameInfo.this.toString();
/*     */     }
/*     */   }
/*     */   
/*     */ 
/*     */   public static final class Data
/*     */     implements xbean.BubbleGameInfo
/*     */   {
/*     */     private int game_state;
/*     */     
/*     */     private int complete_turn_index;
...
/*     */     }
/*     */     
/*     */     Data(xbean.BubbleGameInfo _o1_)
/*     */     {
...
/*     */     public xbean.BubbleGameInfo toBean()
/*     */     {
/* 684 */       return new BubbleGameInfo(this, null, null);
/*     */     }
/*     */     
/*     */ 
/*     */     public xbean.BubbleGameInfo toDataIf()
...
/*     */     public xbean.BubbleGameInfo toBeanIf()
/*     */     {
/* 695 */       return new BubbleGameInfo(this, null, null);
/*     */     }
/*     */     
/*     */ 
/*     */     public boolean xdbManaged()
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\xbean\__\BubbleGameInfo.class
