...
/*     */ import xdb.XBean;
/*     */ 
/*     */ public final class ActivityTeamBean extends XBean implements xbean.ActivityTeamBean
/*     */ {
...
/*     */   }
/*     */   
/*     */   ActivityTeamBean(int __, XBean _xp_, String _vn_)
/*     */   {
/*  23 */     super(_xp_, _vn_);
/*     */   }
/*     */   
/*     */   public ActivityTeamBean()
/*     */   {
/*  28 */     this(0, null, null);
/*     */   }
/*     */   
/*     */   public ActivityTeamBean(ActivityTeamBean _o_)
/*     */   {
/*  33 */     this(_o_, null, null);
/*     */   }
/*     */   
/*     */   ActivityTeamBean(xbean.ActivityTeamBean _o1_, XBean _xp_, String _vn_)
/*     */   {
/*  38 */     super(_xp_, _vn_);
/*  39 */     if ((_o1_ instanceof ActivityTeamBean)) { assign((ActivityTeamBean)_o1_);
...
/*     */   }
/*     */   
/*     */   private void assign(ActivityTeamBean _o_) {
...
/*     */   
/*     */ 
/*     */   public xbean.ActivityTeamBean copy()
/*     */   {
/* 143 */     _xdb_verify_unsafe_();
/* 144 */     return new ActivityTeamBean(this);
/*     */   }
/*     */   
/*     */ 
/*     */   public xbean.ActivityTeamBean toData()
/*     */   {
/* 150 */     _xdb_verify_unsafe_();
/* 151 */     return new Data(this);
/*     */   }
/*     */   
/*     */   public xbean.ActivityTeamBean toBean()
/*     */   {
/* 156 */     _xdb_verify_unsafe_();
/* 157 */     return new ActivityTeamBean(this);
/*     */   }
/*     */   
/*     */ 
/*     */   public xbean.ActivityTeamBean toDataIf()
/*     */   {
/* 163 */     _xdb_verify_unsafe_();
/* 164 */     return new Data(this);
/*     */   }
/*     */   
/*     */   public xbean.ActivityTeamBean toBeanIf()
/*     */   {
...
/*     */       {
/* 197 */         new xdb.logs.LogLong(this, ActivityTeamBean.this.sessionid)
/*     */         {
/*     */           public void rollback()
/*     */           {
/* 201 */             ActivityTeamBean.this.sessionid = this._xdb_saved;
/*     */           }
/*     */         };
/*     */       }
/* 205 */     });
...
/* 213 */     ActivityTeamBean _o_ = null;
/* 214 */     if ((_o1_ instanceof ActivityTeamBean)) { _o_ = (ActivityTeamBean)_o1_;
...
/*     */   }
/*     */   
/*     */   private class Const implements xbean.ActivityTeamBean {
/*     */     private Const() {}
/*     */     
/*     */     ActivityTeamBean nThis() {
/* 253 */       return ActivityTeamBean.this;
/*     */     }
/*     */     
/*     */ 
/*     */     public void _reset_unsafe_()
...
/*     */     public xbean.ActivityTeamBean copy()
/*     */     {
/* 265 */       return ActivityTeamBean.this.copy();
/*     */     }
/*     */     
/*     */ 
/*     */     public xbean.ActivityTeamBean toData()
/*     */     {
/* 271 */       return ActivityTeamBean.this.toData();
/*     */     }
/*     */     
/*     */     public xbean.ActivityTeamBean toBean()
/*     */     {
/* 276 */       return ActivityTeamBean.this.toBean();
/*     */     }
/*     */     
/*     */ 
/*     */     public xbean.ActivityTeamBean toDataIf()
/*     */     {
/* 282 */       return ActivityTeamBean.this.toDataIf();
/*     */     }
/*     */     
/*     */     public xbean.ActivityTeamBean toBeanIf()
/*     */     {
/* 287 */       return ActivityTeamBean.this.toBeanIf();
/*     */     }
/*     */     
/*     */ 
/*     */ 
/*     */     public long getSessionid()
/*     */     {
/* 294 */       ActivityTeamBean.this._xdb_verify_unsafe_();
/* 295 */       return ActivityTeamBean.this.sessionid;
/*     */     }
/*     */     
/*     */ 
/*     */ 
/*     */     public void setSessionid(long _v_)
/*     */     {
/* 302 */       ActivityTeamBean.this._xdb_verify_unsafe_();
...
/*     */     public Bean toConst()
/*     */     {
/* 309 */       ActivityTeamBean.this._xdb_verify_unsafe_();
/* 310 */       return this;
/*     */     }
/*     */     
/*     */ 
...
/*     */     {
/* 316 */       ActivityTeamBean.this._xdb_verify_unsafe_();
/* 317 */       return true;
/*     */     }
/*     */     
/*     */ 
...
/*     */     {
/* 323 */       return ActivityTeamBean.this.isData();
/*     */     }
/*     */     
/*     */ 
/*     */     public OctetsStream marshal(OctetsStream _os_)
/*     */     {
/* 329 */       return ActivityTeamBean.this.marshal(_os_);
/*     */     }
/*     */     
/*     */     public OctetsStream unmarshal(OctetsStream _os_)
/*     */       throws com.goldhuman.Common.Marshal.MarshalException
/*     */     {
/* 335 */       ActivityTeamBean.this._xdb_verify_unsafe_();
...
/*     */     public int getSerializedSize()
/*     */     {
/* 342 */       return ActivityTeamBean.this.getSerializedSize();
/*     */     }
/*     */     
/*     */     public CodedOutputStream marshal(CodedOutputStream _output_)
/*     */       throws InvalidProtocolBufferException
/*     */     {
/* 348 */       return ActivityTeamBean.this.marshal(_output_);
/*     */     }
/*     */     
/*     */     public CodedInputStream unmarshal(CodedInputStream _input_)
/*     */       throws InvalidProtocolBufferException
/*     */     {
/* 354 */       ActivityTeamBean.this._xdb_verify_unsafe_();
...
/*     */     {
/* 361 */       return ActivityTeamBean.this.xdbParent();
/*     */     }
/*     */     
/*     */ 
/*     */     public boolean xdbManaged()
/*     */     {
/* 367 */       return ActivityTeamBean.this.xdbManaged();
/*     */     }
/*     */     
/*     */ 
/*     */     public String xdbVarname()
/*     */     {
/* 373 */       return ActivityTeamBean.this.xdbVarname();
/*     */     }
/*     */     
/*     */ 
/*     */     public Long xdbObjId()
/*     */     {
/* 379 */       return ActivityTeamBean.this.xdbObjId();
/*     */     }
/*     */     
/*     */ 
/*     */     public boolean equals(Object obj)
/*     */     {
/* 385 */       return ActivityTeamBean.this.equals(obj);
/*     */     }
/*     */     
/*     */ 
/*     */     public int hashCode()
/*     */     {
/* 391 */       return ActivityTeamBean.this.hashCode();
/*     */     }
/*     */     
/*     */ 
/*     */     public String toString()
/*     */     {
/* 397 */       return ActivityTeamBean.this.toString();
/*     */     }
/*     */   }
/*     */   
/*     */ 
/*     */   public static final class Data
/*     */     implements xbean.ActivityTeamBean
/*     */   {
/*     */     private long sessionid;
/*     */     
/*     */     public void _reset_unsafe_()
...
/*     */     
/*     */ 
/*     */     Data(xbean.ActivityTeamBean _o1_)
/*     */     {
/* 418 */       if ((_o1_ instanceof ActivityTeamBean)) { assign((ActivityTeamBean)_o1_);
/* 419 */       } else if ((_o1_ instanceof Data)) { assign((Data)_o1_);
/* 420 */       } else if ((_o1_ instanceof ActivityTeamBean.Const)) assign(((ActivityTeamBean.Const)_o1_).nThis()); else {
...
/*     */     public xbean.ActivityTeamBean toBean()
/*     */     {
/* 527 */       return new ActivityTeamBean(this, null, null);
/*     */     }
/*     */     
/*     */ 
/*     */     public xbean.ActivityTeamBean toDataIf()
...
/*     */     public xbean.ActivityTeamBean toBeanIf()
/*     */     {
/* 538 */       return new ActivityTeamBean(this, null, null);
/*     */     }
/*     */     
/*     */ 
/*     */     public boolean xdbManaged()
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\xbean\__\ActivityTeamBean.class
