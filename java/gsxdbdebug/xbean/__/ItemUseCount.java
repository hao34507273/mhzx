...
/*     */ import xdb.XBean;
/*     */ 
/*     */ public final class ItemUseCount extends XBean implements xbean.ItemUseCount
/*     */ {
...
/*     */   }
/*     */   
/*     */   ItemUseCount(int __, XBean _xp_, String _vn_)
/*     */   {
/*  26 */     super(_xp_, _vn_);
...
/*     */   }
/*     */   
/*     */   ItemUseCount(xbean.ItemUseCount _o1_, XBean _xp_, String _vn_)
/*     */   {
/*  43 */     super(_xp_, _vn_);
/*  44 */     if ((_o1_ instanceof ItemUseCount)) { assign((ItemUseCount)_o1_);
...
/* 200 */     return new ItemUseCount(this);
/*     */   }
/*     */   
/*     */ 
...
/* 213 */     return new ItemUseCount(this);
/*     */   }
/*     */   
/*     */ 
...
/*     */       {
/* 274 */         new xdb.logs.LogLong(this, ItemUseCount.this.cleartime)
/*     */         {
/*     */           public void rollback()
/*     */           {
/* 278 */             ItemUseCount.this.cleartime = this._xdb_saved;
/*     */           }
/*     */         };
/*     */       }
/* 282 */     });
...
/* 290 */     ItemUseCount _o_ = null;
/* 291 */     if ((_o1_ instanceof ItemUseCount)) { _o_ = (ItemUseCount)_o1_;
...
/*     */     public xbean.ItemUseCount copy()
/*     */     {
/* 347 */       return ItemUseCount.this.copy();
/*     */     }
/*     */     
/*     */ 
/*     */     public xbean.ItemUseCount toData()
/*     */     {
/* 353 */       return ItemUseCount.this.toData();
/*     */     }
/*     */     
/*     */     public xbean.ItemUseCount toBean()
/*     */     {
/* 358 */       return ItemUseCount.this.toBean();
/*     */     }
/*     */     
/*     */ 
/*     */     public xbean.ItemUseCount toDataIf()
/*     */     {
/* 364 */       return ItemUseCount.this.toDataIf();
/*     */     }
/*     */     
/*     */     public xbean.ItemUseCount toBeanIf()
/*     */     {
/* 369 */       return ItemUseCount.this.toBeanIf();
/*     */     }
/*     */     
/*     */ 
/*     */ 
/*     */     public long getCleartime()
/*     */     {
/* 376 */       ItemUseCount.this._xdb_verify_unsafe_();
/* 377 */       return ItemUseCount.this.cleartime;
/*     */     }
/*     */     
/*     */ 
/*     */ 
/*     */     public Map<Integer, Integer> getId2count()
/*     */     {
/* 384 */       ItemUseCount.this._xdb_verify_unsafe_();
/* 385 */       return xdb.Consts.constMap(ItemUseCount.this.id2count);
/*     */     }
/*     */     
/*     */ 
/*     */ 
/*     */     public Map<Integer, Integer> getId2countAsData()
/*     */     {
/* 392 */       ItemUseCount.this._xdb_verify_unsafe_();
/*     */       
/* 394 */       ItemUseCount _o_ = ItemUseCount.this;
...
/*     */     public void setCleartime(long _v_)
/*     */     {
/* 405 */       ItemUseCount.this._xdb_verify_unsafe_();
...
/*     */     public xdb.Bean toConst()
/*     */     {
/* 412 */       ItemUseCount.this._xdb_verify_unsafe_();
/* 413 */       return this;
/*     */     }
/*     */     
/*     */ 
...
/*     */     {
/* 419 */       ItemUseCount.this._xdb_verify_unsafe_();
/* 420 */       return true;
/*     */     }
/*     */     
/*     */ 
...
/*     */     {
/* 426 */       return ItemUseCount.this.isData();
/*     */     }
/*     */     
/*     */ 
/*     */     public OctetsStream marshal(OctetsStream _os_)
/*     */     {
/* 432 */       return ItemUseCount.this.marshal(_os_);
/*     */     }
/*     */     
/*     */     public OctetsStream unmarshal(OctetsStream _os_)
/*     */       throws com.goldhuman.Common.Marshal.MarshalException
/*     */     {
/* 438 */       ItemUseCount.this._xdb_verify_unsafe_();
...
/*     */     public int getSerializedSize()
/*     */     {
/* 445 */       return ItemUseCount.this.getSerializedSize();
/*     */     }
/*     */     
/*     */     public CodedOutputStream marshal(CodedOutputStream _output_)
/*     */       throws InvalidProtocolBufferException
/*     */     {
/* 451 */       return ItemUseCount.this.marshal(_output_);
/*     */     }
/*     */     
/*     */     public CodedInputStream unmarshal(CodedInputStream _input_)
/*     */       throws InvalidProtocolBufferException
/*     */     {
/* 457 */       ItemUseCount.this._xdb_verify_unsafe_();
...
/*     */     {
/* 464 */       return ItemUseCount.this.xdbParent();
/*     */     }
/*     */     
/*     */ 
/*     */     public boolean xdbManaged()
/*     */     {
/* 470 */       return ItemUseCount.this.xdbManaged();
/*     */     }
/*     */     
/*     */ 
/*     */     public String xdbVarname()
/*     */     {
/* 476 */       return ItemUseCount.this.xdbVarname();
/*     */     }
/*     */     
/*     */ 
/*     */     public Long xdbObjId()
/*     */     {
/* 482 */       return ItemUseCount.this.xdbObjId();
/*     */     }
/*     */     
/*     */ 
/*     */     public boolean equals(Object obj)
/*     */     {
/* 488 */       return ItemUseCount.this.equals(obj);
/*     */     }
/*     */     
/*     */ 
/*     */     public int hashCode()
/*     */     {
/* 494 */       return ItemUseCount.this.hashCode();
/*     */     }
/*     */     
/*     */ 
/*     */     public String toString()
/*     */     {
/* 500 */       return ItemUseCount.this.toString();
/*     */     }
/*     */   }
/*     */   
/*     */ 
/*     */   public static final class Data
/*     */     implements xbean.ItemUseCount
/*     */   {
/*     */     private long cleartime;
/*     */     
/*     */     private HashMap<Integer, Integer> id2count;
...
/*     */     {
/* 525 */       if ((_o1_ instanceof ItemUseCount)) { assign((ItemUseCount)_o1_);
/* 526 */       } else if ((_o1_ instanceof Data)) { assign((Data)_o1_);
/* 527 */       } else if ((_o1_ instanceof ItemUseCount.Const)) assign(((ItemUseCount.Const)_o1_).nThis()); else {
...
/*     */     public xbean.ItemUseCount toBean()
/*     */     {
/* 685 */       return new ItemUseCount(this, null, null);
/*     */     }
/*     */     
/*     */ 
/*     */     public xbean.ItemUseCount toDataIf()
...
/*     */     public xbean.ItemUseCount toBeanIf()
/*     */     {
/* 696 */       return new ItemUseCount(this, null, null);
/*     */     }
/*     */     
/*     */ 
/*     */     public boolean xdbManaged()
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\xbean\__\ItemUseCount.class
