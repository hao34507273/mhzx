...
/*     */ 
/*     */ public final class RoleReceiveFlowerBean extends XBean implements xbean.RoleReceiveFlowerBean
/*     */ {
/*     */   private long roleid;
/*     */   private int point;
/*     */   
...
/*     */   }
/*     */   
/*     */   RoleReceiveFlowerBean(int __, XBean _xp_, String _vn_)
/*     */   {
/*  26 */     super(_xp_, _vn_);
/*     */   }
/*     */   
/*     */   public RoleReceiveFlowerBean()
/*     */   {
/*  31 */     this(0, null, null);
/*     */   }
/*     */   
/*     */   public RoleReceiveFlowerBean(RoleReceiveFlowerBean _o_)
/*     */   {
/*  36 */     this(_o_, null, null);
/*     */   }
/*     */   
/*     */   RoleReceiveFlowerBean(xbean.RoleReceiveFlowerBean _o1_, XBean _xp_, String _vn_)
/*     */   {
/*  41 */     super(_xp_, _vn_);
/*  42 */     if ((_o1_ instanceof RoleReceiveFlowerBean)) { assign((RoleReceiveFlowerBean)_o1_);
...
/*     */   }
/*     */   
/*     */   private void assign(RoleReceiveFlowerBean _o_) {
...
/*     */   
/*     */ 
/*     */   public xbean.RoleReceiveFlowerBean copy()
/*     */   {
/* 157 */     _xdb_verify_unsafe_();
/* 158 */     return new RoleReceiveFlowerBean(this);
/*     */   }
/*     */   
/*     */ 
/*     */   public xbean.RoleReceiveFlowerBean toData()
/*     */   {
/* 164 */     _xdb_verify_unsafe_();
/* 165 */     return new Data(this);
/*     */   }
/*     */   
/*     */   public xbean.RoleReceiveFlowerBean toBean()
/*     */   {
/* 170 */     _xdb_verify_unsafe_();
/* 171 */     return new RoleReceiveFlowerBean(this);
/*     */   }
/*     */   
/*     */ 
/*     */   public xbean.RoleReceiveFlowerBean toDataIf()
/*     */   {
/* 177 */     _xdb_verify_unsafe_();
/* 178 */     return new Data(this);
/*     */   }
/*     */   
/*     */   public xbean.RoleReceiveFlowerBean toBeanIf()
/*     */   {
...
/*     */       {
/* 219 */         new xdb.logs.LogLong(this, RoleReceiveFlowerBean.this.roleid)
/*     */         {
/*     */           public void rollback()
/*     */           {
/* 223 */             RoleReceiveFlowerBean.this.roleid = this._xdb_saved;
/*     */           }
/*     */         };
/*     */       }
/* 227 */     });
...
/*     */       protected xdb.Log create()
/*     */       {
/* 240 */         new xdb.logs.LogInt(this, RoleReceiveFlowerBean.this.point)
/*     */         {
/*     */           public void rollback()
/*     */           {
/* 244 */             RoleReceiveFlowerBean.this.point = this._xdb_saved;
/*     */           }
/*     */         };
/*     */       }
/* 248 */     });
...
/* 256 */     RoleReceiveFlowerBean _o_ = null;
/* 257 */     if ((_o1_ instanceof RoleReceiveFlowerBean)) { _o_ = (RoleReceiveFlowerBean)_o1_;
...
/*     */   }
/*     */   
/*     */   private class Const implements xbean.RoleReceiveFlowerBean {
/*     */     private Const() {}
/*     */     
/*     */     RoleReceiveFlowerBean nThis() {
/* 301 */       return RoleReceiveFlowerBean.this;
/*     */     }
/*     */     
/*     */ 
/*     */     public void _reset_unsafe_()
...
/*     */     public xbean.RoleReceiveFlowerBean copy()
/*     */     {
/* 313 */       return RoleReceiveFlowerBean.this.copy();
/*     */     }
/*     */     
/*     */ 
/*     */     public xbean.RoleReceiveFlowerBean toData()
/*     */     {
/* 319 */       return RoleReceiveFlowerBean.this.toData();
/*     */     }
/*     */     
/*     */     public xbean.RoleReceiveFlowerBean toBean()
/*     */     {
/* 324 */       return RoleReceiveFlowerBean.this.toBean();
/*     */     }
/*     */     
/*     */ 
/*     */     public xbean.RoleReceiveFlowerBean toDataIf()
/*     */     {
/* 330 */       return RoleReceiveFlowerBean.this.toDataIf();
/*     */     }
/*     */     
/*     */     public xbean.RoleReceiveFlowerBean toBeanIf()
/*     */     {
/* 335 */       return RoleReceiveFlowerBean.this.toBeanIf();
/*     */     }
/*     */     
/*     */ 
/*     */ 
/*     */     public long getRoleid()
/*     */     {
/* 342 */       RoleReceiveFlowerBean.this._xdb_verify_unsafe_();
/* 343 */       return RoleReceiveFlowerBean.this.roleid;
/*     */     }
/*     */     
/*     */ 
/*     */ 
/*     */     public int getPoint()
/*     */     {
/* 350 */       RoleReceiveFlowerBean.this._xdb_verify_unsafe_();
/* 351 */       return RoleReceiveFlowerBean.this.point;
/*     */     }
/*     */     
/*     */ 
/*     */ 
/*     */     public void setRoleid(long _v_)
/*     */     {
/* 358 */       RoleReceiveFlowerBean.this._xdb_verify_unsafe_();
...
/*     */     public void setPoint(int _v_)
/*     */     {
/* 366 */       RoleReceiveFlowerBean.this._xdb_verify_unsafe_();
...
/*     */     public Bean toConst()
/*     */     {
/* 373 */       RoleReceiveFlowerBean.this._xdb_verify_unsafe_();
/* 374 */       return this;
/*     */     }
/*     */     
/*     */ 
...
/*     */     {
/* 380 */       RoleReceiveFlowerBean.this._xdb_verify_unsafe_();
/* 381 */       return true;
/*     */     }
/*     */     
/*     */ 
...
/*     */     {
/* 387 */       return RoleReceiveFlowerBean.this.isData();
/*     */     }
/*     */     
/*     */ 
/*     */     public OctetsStream marshal(OctetsStream _os_)
/*     */     {
/* 393 */       return RoleReceiveFlowerBean.this.marshal(_os_);
/*     */     }
/*     */     
/*     */     public OctetsStream unmarshal(OctetsStream _os_)
/*     */       throws com.goldhuman.Common.Marshal.MarshalException
/*     */     {
/* 399 */       RoleReceiveFlowerBean.this._xdb_verify_unsafe_();
...
/*     */     public int getSerializedSize()
/*     */     {
/* 406 */       return RoleReceiveFlowerBean.this.getSerializedSize();
/*     */     }
/*     */     
/*     */     public CodedOutputStream marshal(CodedOutputStream _output_)
/*     */       throws InvalidProtocolBufferException
/*     */     {
/* 412 */       return RoleReceiveFlowerBean.this.marshal(_output_);
/*     */     }
/*     */     
/*     */     public CodedInputStream unmarshal(CodedInputStream _input_)
/*     */       throws InvalidProtocolBufferException
/*     */     {
/* 418 */       RoleReceiveFlowerBean.this._xdb_verify_unsafe_();
...
/*     */     {
/* 425 */       return RoleReceiveFlowerBean.this.xdbParent();
/*     */     }
/*     */     
/*     */ 
/*     */     public boolean xdbManaged()
/*     */     {
/* 431 */       return RoleReceiveFlowerBean.this.xdbManaged();
/*     */     }
/*     */     
/*     */ 
/*     */     public String xdbVarname()
/*     */     {
/* 437 */       return RoleReceiveFlowerBean.this.xdbVarname();
/*     */     }
/*     */     
/*     */ 
/*     */     public Long xdbObjId()
/*     */     {
/* 443 */       return RoleReceiveFlowerBean.this.xdbObjId();
/*     */     }
/*     */     
/*     */ 
/*     */     public boolean equals(Object obj)
/*     */     {
/* 449 */       return RoleReceiveFlowerBean.this.equals(obj);
/*     */     }
/*     */     
/*     */ 
/*     */     public int hashCode()
/*     */     {
/* 455 */       return RoleReceiveFlowerBean.this.hashCode();
/*     */     }
/*     */     
/*     */ 
/*     */     public String toString()
/*     */     {
/* 461 */       return RoleReceiveFlowerBean.this.toString();
/*     */     }
/*     */   }
/*     */   
/*     */ 
/*     */   public static final class Data
/*     */     implements xbean.RoleReceiveFlowerBean
/*     */   {
/*     */     private long roleid;
/*     */     
/*     */     private int point;
...
/*     */     
/*     */ 
/*     */     Data(xbean.RoleReceiveFlowerBean _o1_)
/*     */     {
/* 484 */       if ((_o1_ instanceof RoleReceiveFlowerBean)) { assign((RoleReceiveFlowerBean)_o1_);
/* 485 */       } else if ((_o1_ instanceof Data)) { assign((Data)_o1_);
/* 486 */       } else if ((_o1_ instanceof RoleReceiveFlowerBean.Const)) assign(((RoleReceiveFlowerBean.Const)_o1_).nThis()); else {
...
/*     */     public xbean.RoleReceiveFlowerBean toBean()
/*     */     {
/* 604 */       return new RoleReceiveFlowerBean(this, null, null);
/*     */     }
/*     */     
/*     */ 
/*     */     public xbean.RoleReceiveFlowerBean toDataIf()
...
/*     */     public xbean.RoleReceiveFlowerBean toBeanIf()
/*     */     {
/* 615 */       return new RoleReceiveFlowerBean(this, null, null);
/*     */     }
/*     */     
/*     */ 
/*     */     public boolean xdbManaged()
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\xbean\__\RoleReceiveFlowerBean.class
