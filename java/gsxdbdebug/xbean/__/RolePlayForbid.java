...
/*     */ 
/*     */ public final class RolePlayForbid extends xdb.XBean implements xbean.RolePlayForbid
/*     */ {
...
/*     */   }
/*     */   
/*     */   RolePlayForbid(int __, xdb.XBean _xp_, String _vn_)
/*     */   {
/*  23 */     super(_xp_, _vn_);
/*  24 */     this.forbids = new HashMap();
/*     */   }
/*     */   
/*     */   public RolePlayForbid()
/*     */   {
/*  29 */     this(0, null, null);
/*     */   }
/*     */   
/*     */   public RolePlayForbid(RolePlayForbid _o_)
/*     */   {
/*  34 */     this(_o_, null, null);
/*     */   }
/*     */   
/*     */   RolePlayForbid(xbean.RolePlayForbid _o1_, xdb.XBean _xp_, String _vn_)
/*     */   {
/*  39 */     super(_xp_, _vn_);
/*  40 */     if ((_o1_ instanceof RolePlayForbid)) { assign((RolePlayForbid)_o1_);
...
/*     */   }
/*     */   
/*     */   private void assign(RolePlayForbid _o_) {
...
/*     */   
/*     */ 
/*     */   public xbean.RolePlayForbid copy()
/*     */   {
/* 184 */     _xdb_verify_unsafe_();
/* 185 */     return new RolePlayForbid(this);
/*     */   }
/*     */   
/*     */ 
/*     */   public xbean.RolePlayForbid toData()
/*     */   {
/* 191 */     _xdb_verify_unsafe_();
/* 192 */     return new Data(this);
/*     */   }
/*     */   
/*     */   public xbean.RolePlayForbid toBean()
/*     */   {
/* 197 */     _xdb_verify_unsafe_();
/* 198 */     return new RolePlayForbid(this);
/*     */   }
/*     */   
/*     */ 
/*     */   public xbean.RolePlayForbid toDataIf()
/*     */   {
/* 204 */     _xdb_verify_unsafe_();
/* 205 */     return new Data(this);
/*     */   }
/*     */   
/*     */   public xbean.RolePlayForbid toBeanIf()
/*     */   {
...
/* 246 */     RolePlayForbid _o_ = null;
/* 247 */     if ((_o1_ instanceof RolePlayForbid)) { _o_ = (RolePlayForbid)_o1_;
...
/*     */   }
/*     */   
/*     */   private class Const implements xbean.RolePlayForbid {
/*     */     private Const() {}
/*     */     
/*     */     RolePlayForbid nThis() {
/* 286 */       return RolePlayForbid.this;
/*     */     }
/*     */     
/*     */ 
/*     */     public void _reset_unsafe_()
...
/*     */     public xbean.RolePlayForbid copy()
/*     */     {
/* 298 */       return RolePlayForbid.this.copy();
/*     */     }
/*     */     
/*     */ 
/*     */     public xbean.RolePlayForbid toData()
/*     */     {
/* 304 */       return RolePlayForbid.this.toData();
/*     */     }
/*     */     
/*     */     public xbean.RolePlayForbid toBean()
/*     */     {
/* 309 */       return RolePlayForbid.this.toBean();
/*     */     }
/*     */     
/*     */ 
/*     */     public xbean.RolePlayForbid toDataIf()
/*     */     {
/* 315 */       return RolePlayForbid.this.toDataIf();
/*     */     }
/*     */     
/*     */     public xbean.RolePlayForbid toBeanIf()
/*     */     {
/* 320 */       return RolePlayForbid.this.toBeanIf();
/*     */     }
/*     */     
/*     */ 
/*     */ 
/*     */     public Map<Integer, xbean.IdipForbidInfo> getForbids()
/*     */     {
/* 327 */       RolePlayForbid.this._xdb_verify_unsafe_();
/* 328 */       return xdb.Consts.constMap(RolePlayForbid.this.forbids);
/*     */     }
/*     */     
/*     */ 
/*     */ 
/*     */     public Map<Integer, xbean.IdipForbidInfo> getForbidsAsData()
/*     */     {
/* 335 */       RolePlayForbid.this._xdb_verify_unsafe_();
/*     */       
/* 337 */       RolePlayForbid _o_ = RolePlayForbid.this;
...
/*     */     public xdb.Bean toConst()
/*     */     {
/* 347 */       RolePlayForbid.this._xdb_verify_unsafe_();
/* 348 */       return this;
/*     */     }
/*     */     
/*     */ 
...
/*     */     {
/* 354 */       RolePlayForbid.this._xdb_verify_unsafe_();
/* 355 */       return true;
/*     */     }
/*     */     
/*     */ 
...
/*     */     {
/* 361 */       return RolePlayForbid.this.isData();
/*     */     }
/*     */     
/*     */ 
/*     */     public OctetsStream marshal(OctetsStream _os_)
/*     */     {
/* 367 */       return RolePlayForbid.this.marshal(_os_);
/*     */     }
/*     */     
/*     */     public OctetsStream unmarshal(OctetsStream _os_)
/*     */       throws com.goldhuman.Common.Marshal.MarshalException
/*     */     {
/* 373 */       RolePlayForbid.this._xdb_verify_unsafe_();
...
/*     */     public int getSerializedSize()
/*     */     {
/* 380 */       return RolePlayForbid.this.getSerializedSize();
/*     */     }
/*     */     
/*     */     public CodedOutputStream marshal(CodedOutputStream _output_)
/*     */       throws InvalidProtocolBufferException
/*     */     {
/* 386 */       return RolePlayForbid.this.marshal(_output_);
/*     */     }
/*     */     
/*     */     public CodedInputStream unmarshal(CodedInputStream _input_)
/*     */       throws InvalidProtocolBufferException
/*     */     {
/* 392 */       RolePlayForbid.this._xdb_verify_unsafe_();
...
/*     */     {
/* 399 */       return RolePlayForbid.this.xdbParent();
/*     */     }
/*     */     
/*     */ 
/*     */     public boolean xdbManaged()
/*     */     {
/* 405 */       return RolePlayForbid.this.xdbManaged();
/*     */     }
/*     */     
/*     */ 
/*     */     public String xdbVarname()
/*     */     {
/* 411 */       return RolePlayForbid.this.xdbVarname();
/*     */     }
/*     */     
/*     */ 
/*     */     public Long xdbObjId()
/*     */     {
/* 417 */       return RolePlayForbid.this.xdbObjId();
/*     */     }
/*     */     
/*     */ 
/*     */     public boolean equals(Object obj)
/*     */     {
/* 423 */       return RolePlayForbid.this.equals(obj);
/*     */     }
/*     */     
/*     */ 
/*     */     public int hashCode()
/*     */     {
/* 429 */       return RolePlayForbid.this.hashCode();
/*     */     }
/*     */     
/*     */ 
/*     */     public String toString()
/*     */     {
/* 435 */       return RolePlayForbid.this.toString();
/*     */     }
/*     */   }
/*     */   
/*     */ 
/*     */   public static final class Data
/*     */     implements xbean.RolePlayForbid
/*     */   {
/*     */     private HashMap<Integer, xbean.IdipForbidInfo> forbids;
/*     */     
/*     */     public void _reset_unsafe_()
...
/*     */     }
/*     */     
/*     */     Data(xbean.RolePlayForbid _o1_)
/*     */     {
/* 457 */       if ((_o1_ instanceof RolePlayForbid)) { assign((RolePlayForbid)_o1_);
/* 458 */       } else if ((_o1_ instanceof Data)) { assign((Data)_o1_);
/* 459 */       } else if ((_o1_ instanceof RolePlayForbid.Const)) assign(((RolePlayForbid.Const)_o1_).nThis()); else {
...
/*     */     public xbean.RolePlayForbid toBean()
/*     */     {
/* 606 */       return new RolePlayForbid(this, null, null);
/*     */     }
/*     */     
/*     */ 
/*     */     public xbean.RolePlayForbid toDataIf()
...
/*     */     public xbean.RolePlayForbid toBeanIf()
/*     */     {
/* 617 */       return new RolePlayForbid(this, null, null);
/*     */     }
/*     */     
/*     */ 
/*     */     public boolean xdbManaged()
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\xbean\__\RolePlayForbid.class
