...
/*     */ 
/*     */ public final class OwnTaskData extends xdb.XBean implements xbean.OwnTaskData
/*     */ {
...
/*     */   }
/*     */   
/*     */   OwnTaskData(int __, xdb.XBean _xp_, String _vn_)
/*     */   {
/*  23 */     super(_xp_, _vn_);
...
/*     */   }
/*     */   
/*     */   public OwnTaskData(OwnTaskData _o_)
/*     */   {
/*  34 */     this(_o_, null, null);
/*     */   }
/*     */   
/*     */   OwnTaskData(xbean.OwnTaskData _o1_, xdb.XBean _xp_, String _vn_)
/*     */   {
/*  39 */     super(_xp_, _vn_);
/*  40 */     if ((_o1_ instanceof OwnTaskData)) { assign((OwnTaskData)_o1_);
...
/*     */   }
/*     */   
/*     */   private void assign(OwnTaskData _o_) {
...
/*     */   
/*     */ 
/*     */   public xbean.OwnTaskData copy()
/*     */   {
/* 163 */     _xdb_verify_unsafe_();
/* 164 */     return new OwnTaskData(this);
/*     */   }
/*     */   
/*     */ 
/*     */   public xbean.OwnTaskData toData()
/*     */   {
/* 170 */     _xdb_verify_unsafe_();
/* 171 */     return new Data(this);
/*     */   }
/*     */   
/*     */   public xbean.OwnTaskData toBean()
/*     */   {
/* 176 */     _xdb_verify_unsafe_();
/* 177 */     return new OwnTaskData(this);
/*     */   }
/*     */   
/*     */ 
/*     */   public xbean.OwnTaskData toDataIf()
/*     */   {
/* 183 */     _xdb_verify_unsafe_();
/* 184 */     return new Data(this);
/*     */   }
/*     */   
/*     */   public xbean.OwnTaskData toBeanIf()
/*     */   {
...
/* 223 */     OwnTaskData _o_ = null;
/* 224 */     if ((_o1_ instanceof OwnTaskData)) { _o_ = (OwnTaskData)_o1_;
...
/*     */   }
/*     */   
/*     */   private class Const implements xbean.OwnTaskData {
/*     */     private Const() {}
/*     */     
/*     */     OwnTaskData nThis() {
/* 263 */       return OwnTaskData.this;
/*     */     }
/*     */     
/*     */ 
/*     */     public void _reset_unsafe_()
...
/*     */     public xbean.OwnTaskData copy()
/*     */     {
/* 275 */       return OwnTaskData.this.copy();
/*     */     }
/*     */     
/*     */ 
/*     */     public xbean.OwnTaskData toData()
/*     */     {
/* 281 */       return OwnTaskData.this.toData();
/*     */     }
/*     */     
/*     */     public xbean.OwnTaskData toBean()
/*     */     {
/* 286 */       return OwnTaskData.this.toBean();
/*     */     }
/*     */     
/*     */ 
/*     */     public xbean.OwnTaskData toDataIf()
/*     */     {
/* 292 */       return OwnTaskData.this.toDataIf();
/*     */     }
/*     */     
/*     */     public xbean.OwnTaskData toBeanIf()
/*     */     {
/* 297 */       return OwnTaskData.this.toBeanIf();
/*     */     }
/*     */     
/*     */ 
/*     */ 
/*     */     public Set<Integer> getGraphids()
/*     */     {
/* 304 */       OwnTaskData.this._xdb_verify_unsafe_();
/* 305 */       return xdb.Consts.constSet(OwnTaskData.this.graphids);
/*     */     }
/*     */     
/*     */ 
/*     */     public Set<Integer> getGraphidsAsData()
/*     */     {
/* 311 */       OwnTaskData.this._xdb_verify_unsafe_();
/*     */       
/* 313 */       OwnTaskData _o_ = OwnTaskData.this;
...
/*     */     public xdb.Bean toConst()
/*     */     {
/* 322 */       OwnTaskData.this._xdb_verify_unsafe_();
/* 323 */       return this;
/*     */     }
/*     */     
/*     */ 
...
/*     */     {
/* 329 */       OwnTaskData.this._xdb_verify_unsafe_();
/* 330 */       return true;
/*     */     }
/*     */     
/*     */ 
...
/*     */     {
/* 336 */       return OwnTaskData.this.isData();
/*     */     }
/*     */     
/*     */ 
/*     */     public OctetsStream marshal(OctetsStream _os_)
/*     */     {
/* 342 */       return OwnTaskData.this.marshal(_os_);
/*     */     }
/*     */     
/*     */     public OctetsStream unmarshal(OctetsStream _os_)
/*     */       throws com.goldhuman.Common.Marshal.MarshalException
/*     */     {
/* 348 */       OwnTaskData.this._xdb_verify_unsafe_();
...
/*     */     public int getSerializedSize()
/*     */     {
/* 355 */       return OwnTaskData.this.getSerializedSize();
/*     */     }
/*     */     
/*     */     public CodedOutputStream marshal(CodedOutputStream _output_)
/*     */       throws InvalidProtocolBufferException
/*     */     {
/* 361 */       return OwnTaskData.this.marshal(_output_);
/*     */     }
/*     */     
/*     */     public CodedInputStream unmarshal(CodedInputStream _input_)
/*     */       throws InvalidProtocolBufferException
/*     */     {
/* 367 */       OwnTaskData.this._xdb_verify_unsafe_();
...
/*     */     {
/* 374 */       return OwnTaskData.this.xdbParent();
/*     */     }
/*     */     
/*     */ 
/*     */     public boolean xdbManaged()
/*     */     {
/* 380 */       return OwnTaskData.this.xdbManaged();
/*     */     }
/*     */     
/*     */ 
/*     */     public String xdbVarname()
/*     */     {
/* 386 */       return OwnTaskData.this.xdbVarname();
/*     */     }
/*     */     
/*     */ 
/*     */     public Long xdbObjId()
/*     */     {
/* 392 */       return OwnTaskData.this.xdbObjId();
/*     */     }
/*     */     
/*     */ 
/*     */     public boolean equals(Object obj)
/*     */     {
/* 398 */       return OwnTaskData.this.equals(obj);
/*     */     }
/*     */     
/*     */ 
/*     */     public int hashCode()
/*     */     {
/* 404 */       return OwnTaskData.this.hashCode();
/*     */     }
/*     */     
/*     */ 
/*     */     public String toString()
/*     */     {
/* 410 */       return OwnTaskData.this.toString();
/*     */     }
/*     */   }
/*     */   
/*     */ 
/*     */   public static final class Data
/*     */     implements xbean.OwnTaskData
/*     */   {
...
/*     */     }
/*     */     
/*     */     Data(xbean.OwnTaskData _o1_)
/*     */     {
/* 432 */       if ((_o1_ instanceof OwnTaskData)) { assign((OwnTaskData)_o1_);
/* 433 */       } else if ((_o1_ instanceof Data)) { assign((Data)_o1_);
/* 434 */       } else if ((_o1_ instanceof OwnTaskData.Const)) assign(((OwnTaskData.Const)_o1_).nThis()); else {
...
/*     */     public xbean.OwnTaskData toBean()
/*     */     {
/* 560 */       return new OwnTaskData(this, null, null);
/*     */     }
/*     */     
/*     */ 
/*     */     public xbean.OwnTaskData toDataIf()
...
/*     */     public xbean.OwnTaskData toBeanIf()
/*     */     {
/* 571 */       return new OwnTaskData(this, null, null);
/*     */     }
/*     */     
/*     */ 
/*     */     public boolean xdbManaged()
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\xbean\__\OwnTaskData.class
