...
/*     */ import xdb.XBean;
/*     */ 
/*     */ public final class HulaRank extends XBean implements xbean.HulaRank
/*     */ {
...
/*     */   }
/*     */   
/*     */   HulaRank(int __, XBean _xp_, String _vn_)
/*     */   {
/*  23 */     super(_xp_, _vn_);
...
/*     */   }
/*     */   
/*     */   public HulaRank(HulaRank _o_)
/*     */   {
/*  34 */     this(_o_, null, null);
/*     */   }
/*     */   
/*     */   HulaRank(xbean.HulaRank _o1_, XBean _xp_, String _vn_)
/*     */   {
/*  39 */     super(_xp_, _vn_);
/*  40 */     if ((_o1_ instanceof HulaRank)) { assign((HulaRank)_o1_);
...
/*     */   }
/*     */   
/*     */   private void assign(HulaRank _o_) {
...
/*     */   {
/*  55 */     this.ranklist = new LinkedList();
...
/*     */   
/*     */ 
/*     */   public xbean.HulaRank copy()
/*     */   {
/* 163 */     _xdb_verify_unsafe_();
/* 164 */     return new HulaRank(this);
/*     */   }
/*     */   
/*     */ 
/*     */   public xbean.HulaRank toData()
/*     */   {
/* 170 */     _xdb_verify_unsafe_();
/* 171 */     return new Data(this);
/*     */   }
/*     */   
/*     */   public xbean.HulaRank toBean()
/*     */   {
/* 176 */     _xdb_verify_unsafe_();
/* 177 */     return new HulaRank(this);
/*     */   }
/*     */   
/*     */ 
/*     */   public xbean.HulaRank toDataIf()
/*     */   {
/* 183 */     _xdb_verify_unsafe_();
/* 184 */     return new Data(this);
/*     */   }
/*     */   
/*     */   public xbean.HulaRank toBeanIf()
/*     */   {
...
/*     */     
/* 213 */     HulaRank _o_ = this;
/* 214 */     List<Long> ranklist = new LinkedList();
...
/* 223 */     HulaRank _o_ = null;
/* 224 */     if ((_o1_ instanceof HulaRank)) { _o_ = (HulaRank)_o1_;
...
/*     */   }
/*     */   
/*     */   private class Const implements xbean.HulaRank {
/*     */     private Const() {}
/*     */     
/*     */     HulaRank nThis() {
/* 263 */       return HulaRank.this;
/*     */     }
/*     */     
/*     */ 
/*     */     public void _reset_unsafe_()
...
/*     */     public xbean.HulaRank copy()
/*     */     {
/* 275 */       return HulaRank.this.copy();
/*     */     }
/*     */     
/*     */ 
/*     */     public xbean.HulaRank toData()
/*     */     {
/* 281 */       return HulaRank.this.toData();
/*     */     }
/*     */     
/*     */     public xbean.HulaRank toBean()
/*     */     {
/* 286 */       return HulaRank.this.toBean();
/*     */     }
/*     */     
/*     */ 
/*     */     public xbean.HulaRank toDataIf()
/*     */     {
/* 292 */       return HulaRank.this.toDataIf();
/*     */     }
/*     */     
/*     */     public xbean.HulaRank toBeanIf()
/*     */     {
/* 297 */       return HulaRank.this.toBeanIf();
/*     */     }
/*     */     
/*     */ 
/*     */ 
/*     */     public List<Long> getRanklist()
/*     */     {
/* 304 */       HulaRank.this._xdb_verify_unsafe_();
/* 305 */       return xdb.Consts.constList(HulaRank.this.ranklist);
/*     */     }
/*     */     
/*     */ 
/*     */     public List<Long> getRanklistAsData()
/*     */     {
/* 311 */       HulaRank.this._xdb_verify_unsafe_();
/*     */       
/* 313 */       HulaRank _o_ = HulaRank.this;
/* 314 */       List<Long> ranklist = new LinkedList();
...
/*     */     public xdb.Bean toConst()
/*     */     {
/* 322 */       HulaRank.this._xdb_verify_unsafe_();
/* 323 */       return this;
/*     */     }
/*     */     
/*     */ 
...
/*     */     {
/* 329 */       HulaRank.this._xdb_verify_unsafe_();
/* 330 */       return true;
/*     */     }
/*     */     
/*     */ 
...
/*     */     {
/* 336 */       return HulaRank.this.isData();
/*     */     }
/*     */     
/*     */ 
/*     */     public OctetsStream marshal(OctetsStream _os_)
/*     */     {
/* 342 */       return HulaRank.this.marshal(_os_);
/*     */     }
/*     */     
/*     */     public OctetsStream unmarshal(OctetsStream _os_)
/*     */       throws com.goldhuman.Common.Marshal.MarshalException
/*     */     {
/* 348 */       HulaRank.this._xdb_verify_unsafe_();
...
/*     */     public int getSerializedSize()
/*     */     {
/* 355 */       return HulaRank.this.getSerializedSize();
/*     */     }
/*     */     
/*     */     public CodedOutputStream marshal(CodedOutputStream _output_)
/*     */       throws InvalidProtocolBufferException
/*     */     {
/* 361 */       return HulaRank.this.marshal(_output_);
/*     */     }
/*     */     
/*     */     public CodedInputStream unmarshal(CodedInputStream _input_)
/*     */       throws InvalidProtocolBufferException
/*     */     {
/* 367 */       HulaRank.this._xdb_verify_unsafe_();
...
/*     */     {
/* 374 */       return HulaRank.this.xdbParent();
/*     */     }
/*     */     
/*     */ 
/*     */     public boolean xdbManaged()
/*     */     {
/* 380 */       return HulaRank.this.xdbManaged();
/*     */     }
/*     */     
/*     */ 
/*     */     public String xdbVarname()
/*     */     {
/* 386 */       return HulaRank.this.xdbVarname();
/*     */     }
/*     */     
/*     */ 
/*     */     public Long xdbObjId()
/*     */     {
/* 392 */       return HulaRank.this.xdbObjId();
/*     */     }
/*     */     
/*     */ 
/*     */     public boolean equals(Object obj)
/*     */     {
/* 398 */       return HulaRank.this.equals(obj);
/*     */     }
/*     */     
/*     */ 
/*     */     public int hashCode()
/*     */     {
/* 404 */       return HulaRank.this.hashCode();
/*     */     }
/*     */     
/*     */ 
/*     */     public String toString()
/*     */     {
/* 410 */       return HulaRank.this.toString();
/*     */     }
/*     */   }
/*     */   
/*     */ 
/*     */   public static final class Data
/*     */     implements xbean.HulaRank
/*     */   {
/*     */     private LinkedList<Long> ranklist;
/*     */     
/*     */     public void _reset_unsafe_()
...
/*     */     public Data()
/*     */     {
/* 427 */       this.ranklist = new LinkedList();
/*     */     }
/*     */     
/*     */     Data(xbean.HulaRank _o1_)
/*     */     {
/* 432 */       if ((_o1_ instanceof HulaRank)) { assign((HulaRank)_o1_);
/* 433 */       } else if ((_o1_ instanceof Data)) { assign((Data)_o1_);
/* 434 */       } else if ((_o1_ instanceof HulaRank.Const)) assign(((HulaRank.Const)_o1_).nThis()); else {
/* 435 */         throw new UnsupportedOperationException();
/*     */       }
/*     */     }
/*     */     
/*     */     private void assign(HulaRank _o_) {
/* 440 */       this.ranklist = new LinkedList();
/* 441 */       this.ranklist.addAll(_o_.ranklist);
/*     */     }
/*     */     
/*     */     private void assign(Data _o_)
/*     */     {
/* 446 */       this.ranklist = new LinkedList();
...
/*     */     public xbean.HulaRank toBean()
/*     */     {
/* 560 */       return new HulaRank(this, null, null);
/*     */     }
/*     */     
/*     */ 
/*     */     public xbean.HulaRank toDataIf()
...
/*     */     public xbean.HulaRank toBeanIf()
/*     */     {
/* 571 */       return new HulaRank(this, null, null);
/*     */     }
/*     */     
/*     */ 
/*     */     public boolean xdbManaged()
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\xbean\__\HulaRank.class
