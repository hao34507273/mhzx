...
/*     */ 
/*     */ public final class ChineseValentineAwardRecord extends XBean implements xbean.ChineseValentineAwardRecord
/*     */ {
...
/*     */   }
/*     */   
/*     */   ChineseValentineAwardRecord(int __, XBean _xp_, String _vn_)
/*     */   {
/*  26 */     super(_xp_, _vn_);
/*     */   }
/*     */   
/*     */   public ChineseValentineAwardRecord()
/*     */   {
/*  31 */     this(0, null, null);
/*     */   }
/*     */   
/*     */   public ChineseValentineAwardRecord(ChineseValentineAwardRecord _o_)
/*     */   {
/*  36 */     this(_o_, null, null);
/*     */   }
/*     */   
/*     */   ChineseValentineAwardRecord(xbean.ChineseValentineAwardRecord _o1_, XBean _xp_, String _vn_)
/*     */   {
/*  41 */     super(_xp_, _vn_);
/*  42 */     if ((_o1_ instanceof ChineseValentineAwardRecord)) { assign((ChineseValentineAwardRecord)_o1_);
...
/*     */   }
/*     */   
/*     */   private void assign(ChineseValentineAwardRecord _o_) {
...
/*     */   
/*     */ 
/*     */   public xbean.ChineseValentineAwardRecord copy()
/*     */   {
/* 157 */     _xdb_verify_unsafe_();
/* 158 */     return new ChineseValentineAwardRecord(this);
/*     */   }
/*     */   
/*     */ 
/*     */   public xbean.ChineseValentineAwardRecord toData()
/*     */   {
/* 164 */     _xdb_verify_unsafe_();
/* 165 */     return new Data(this);
/*     */   }
/*     */   
/*     */   public xbean.ChineseValentineAwardRecord toBean()
/*     */   {
/* 170 */     _xdb_verify_unsafe_();
/* 171 */     return new ChineseValentineAwardRecord(this);
/*     */   }
/*     */   
/*     */ 
/*     */   public xbean.ChineseValentineAwardRecord toDataIf()
/*     */   {
/* 177 */     _xdb_verify_unsafe_();
/* 178 */     return new Data(this);
/*     */   }
/*     */   
/*     */   public xbean.ChineseValentineAwardRecord toBeanIf()
/*     */   {
...
/*     */       {
/* 219 */         new xdb.logs.LogInt(this, ChineseValentineAwardRecord.this.awardcount)
/*     */         {
/*     */           public void rollback()
/*     */           {
/* 223 */             ChineseValentineAwardRecord.this.awardcount = this._xdb_saved;
/*     */           }
/*     */         };
/*     */       }
/* 227 */     });
...
/*     */       protected xdb.Log create()
/*     */       {
/* 240 */         new xdb.logs.LogLong(this, ChineseValentineAwardRecord.this.timestamp)
/*     */         {
/*     */           public void rollback()
/*     */           {
/* 244 */             ChineseValentineAwardRecord.this.timestamp = this._xdb_saved;
/*     */           }
/*     */         };
/*     */       }
/* 248 */     });
...
/* 256 */     ChineseValentineAwardRecord _o_ = null;
/* 257 */     if ((_o1_ instanceof ChineseValentineAwardRecord)) { _o_ = (ChineseValentineAwardRecord)_o1_;
...
/*     */   }
/*     */   
/*     */   private class Const implements xbean.ChineseValentineAwardRecord {
/*     */     private Const() {}
/*     */     
/*     */     ChineseValentineAwardRecord nThis() {
/* 301 */       return ChineseValentineAwardRecord.this;
/*     */     }
/*     */     
/*     */ 
/*     */     public void _reset_unsafe_()
...
/*     */     public xbean.ChineseValentineAwardRecord copy()
/*     */     {
/* 313 */       return ChineseValentineAwardRecord.this.copy();
/*     */     }
/*     */     
/*     */ 
/*     */     public xbean.ChineseValentineAwardRecord toData()
/*     */     {
/* 319 */       return ChineseValentineAwardRecord.this.toData();
/*     */     }
/*     */     
/*     */     public xbean.ChineseValentineAwardRecord toBean()
/*     */     {
/* 324 */       return ChineseValentineAwardRecord.this.toBean();
/*     */     }
/*     */     
/*     */ 
/*     */     public xbean.ChineseValentineAwardRecord toDataIf()
/*     */     {
/* 330 */       return ChineseValentineAwardRecord.this.toDataIf();
/*     */     }
/*     */     
/*     */     public xbean.ChineseValentineAwardRecord toBeanIf()
/*     */     {
/* 335 */       return ChineseValentineAwardRecord.this.toBeanIf();
/*     */     }
/*     */     
/*     */ 
/*     */ 
/*     */     public int getAwardcount()
/*     */     {
/* 342 */       ChineseValentineAwardRecord.this._xdb_verify_unsafe_();
/* 343 */       return ChineseValentineAwardRecord.this.awardcount;
/*     */     }
/*     */     
/*     */ 
/*     */ 
/*     */     public long getTimestamp()
/*     */     {
/* 350 */       ChineseValentineAwardRecord.this._xdb_verify_unsafe_();
/* 351 */       return ChineseValentineAwardRecord.this.timestamp;
/*     */     }
/*     */     
/*     */ 
/*     */ 
/*     */     public void setAwardcount(int _v_)
/*     */     {
/* 358 */       ChineseValentineAwardRecord.this._xdb_verify_unsafe_();
...
/*     */     public void setTimestamp(long _v_)
/*     */     {
/* 366 */       ChineseValentineAwardRecord.this._xdb_verify_unsafe_();
...
/*     */     public Bean toConst()
/*     */     {
/* 373 */       ChineseValentineAwardRecord.this._xdb_verify_unsafe_();
/* 374 */       return this;
/*     */     }
/*     */     
/*     */ 
...
/*     */     {
/* 380 */       ChineseValentineAwardRecord.this._xdb_verify_unsafe_();
/* 381 */       return true;
/*     */     }
/*     */     
/*     */ 
...
/*     */     {
/* 387 */       return ChineseValentineAwardRecord.this.isData();
/*     */     }
/*     */     
/*     */ 
/*     */     public OctetsStream marshal(OctetsStream _os_)
/*     */     {
/* 393 */       return ChineseValentineAwardRecord.this.marshal(_os_);
/*     */     }
/*     */     
/*     */     public OctetsStream unmarshal(OctetsStream _os_)
/*     */       throws com.goldhuman.Common.Marshal.MarshalException
/*     */     {
/* 399 */       ChineseValentineAwardRecord.this._xdb_verify_unsafe_();
...
/*     */     public int getSerializedSize()
/*     */     {
/* 406 */       return ChineseValentineAwardRecord.this.getSerializedSize();
/*     */     }
/*     */     
/*     */     public CodedOutputStream marshal(CodedOutputStream _output_)
/*     */       throws InvalidProtocolBufferException
/*     */     {
/* 412 */       return ChineseValentineAwardRecord.this.marshal(_output_);
/*     */     }
/*     */     
/*     */     public CodedInputStream unmarshal(CodedInputStream _input_)
/*     */       throws InvalidProtocolBufferException
/*     */     {
/* 418 */       ChineseValentineAwardRecord.this._xdb_verify_unsafe_();
...
/*     */     {
/* 425 */       return ChineseValentineAwardRecord.this.xdbParent();
/*     */     }
/*     */     
/*     */ 
/*     */     public boolean xdbManaged()
/*     */     {
/* 431 */       return ChineseValentineAwardRecord.this.xdbManaged();
/*     */     }
/*     */     
/*     */ 
/*     */     public String xdbVarname()
/*     */     {
/* 437 */       return ChineseValentineAwardRecord.this.xdbVarname();
/*     */     }
/*     */     
/*     */ 
/*     */     public Long xdbObjId()
/*     */     {
/* 443 */       return ChineseValentineAwardRecord.this.xdbObjId();
/*     */     }
/*     */     
/*     */ 
/*     */     public boolean equals(Object obj)
/*     */     {
/* 449 */       return ChineseValentineAwardRecord.this.equals(obj);
/*     */     }
/*     */     
/*     */ 
/*     */     public int hashCode()
/*     */     {
/* 455 */       return ChineseValentineAwardRecord.this.hashCode();
/*     */     }
/*     */     
/*     */ 
/*     */     public String toString()
/*     */     {
/* 461 */       return ChineseValentineAwardRecord.this.toString();
/*     */     }
/*     */   }
/*     */   
/*     */ 
/*     */   public static final class Data
/*     */     implements xbean.ChineseValentineAwardRecord
/*     */   {
/*     */     private int awardcount;
/*     */     
/*     */     private long timestamp;
...
/*     */     
/*     */ 
/*     */     Data(xbean.ChineseValentineAwardRecord _o1_)
/*     */     {
/* 484 */       if ((_o1_ instanceof ChineseValentineAwardRecord)) { assign((ChineseValentineAwardRecord)_o1_);
/* 485 */       } else if ((_o1_ instanceof Data)) { assign((Data)_o1_);
/* 486 */       } else if ((_o1_ instanceof ChineseValentineAwardRecord.Const)) assign(((ChineseValentineAwardRecord.Const)_o1_).nThis()); else {
...
/*     */     public xbean.ChineseValentineAwardRecord toBean()
/*     */     {
/* 604 */       return new ChineseValentineAwardRecord(this, null, null);
/*     */     }
/*     */     
/*     */ 
/*     */     public xbean.ChineseValentineAwardRecord toDataIf()
...
/*     */     public xbean.ChineseValentineAwardRecord toBeanIf()
/*     */     {
/* 615 */       return new ChineseValentineAwardRecord(this, null, null);
/*     */     }
/*     */     
/*     */ 
/*     */     public boolean xdbManaged()
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\xbean\__\ChineseValentineAwardRecord.class
