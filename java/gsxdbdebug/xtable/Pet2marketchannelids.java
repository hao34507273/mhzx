...
/*    */ import xdb.TTable;
/*    */ 
/*    */ public class Pet2marketchannelids
/*    */ {
/*    */   public static MarketChannelIds get(Long key)
/*    */   {
/* 12 */     return (MarketChannelIds)_Tables_.getInstance().pet2marketchannelids.get(key);
/*    */   }
/*    */   
/*    */   public static MarketChannelIds get(Long key, MarketChannelIds value)
/*    */   {
/* 17 */     return (MarketChannelIds)_Tables_.getInstance().pet2marketchannelids.get(key, value);
/*    */   }
/*    */   
/*    */   public static void insert(Long key, MarketChannelIds value)
/*    */   {
/* 22 */     _Tables_.getInstance().pet2marketchannelids.insert(key, value);
/*    */   }
/*    */   
/*    */   public static void delete(Long key)
/*    */   {
/* 27 */     _Tables_.getInstance().pet2marketchannelids.delete(key);
/*    */   }
/*    */   
/*    */   public static boolean add(Long key, MarketChannelIds value)
/*    */   {
/* 32 */     return _Tables_.getInstance().pet2marketchannelids.add(key, value);
/*    */   }
/*    */   
/*    */   public static boolean remove(Long key)
/*    */   {
/* 37 */     return _Tables_.getInstance().pet2marketchannelids.remove(key);
/*    */   }
/*    */   
/*    */   public static xdb.TTableCache<Long, MarketChannelIds> getCache()
/*    */   {
/* 42 */     return _Tables_.getInstance().pet2marketchannelids.getCache();
/*    */   }
/*    */   
/*    */   public static TTable<Long, MarketChannelIds> getTable()
/*    */   {
/* 47 */     return _Tables_.getInstance().pet2marketchannelids;
/*    */   }
/*    */   
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\xtable\Pet2marketchannelids.class
