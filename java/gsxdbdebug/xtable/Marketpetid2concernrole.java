...
/*    */ import xdb.TTable;
/*    */ 
/*    */ public class Marketpetid2concernrole
/*    */ {
/*    */   public static ConcernRoleIdSet get(Long key)
/*    */   {
/* 12 */     return (ConcernRoleIdSet)_Tables_.getInstance().marketpetid2concernrole.get(key);
/*    */   }
/*    */   
/*    */   public static ConcernRoleIdSet get(Long key, ConcernRoleIdSet value)
/*    */   {
/* 17 */     return (ConcernRoleIdSet)_Tables_.getInstance().marketpetid2concernrole.get(key, value);
/*    */   }
/*    */   
/*    */   public static void insert(Long key, ConcernRoleIdSet value)
/*    */   {
/* 22 */     _Tables_.getInstance().marketpetid2concernrole.insert(key, value);
/*    */   }
/*    */   
/*    */   public static void delete(Long key)
/*    */   {
/* 27 */     _Tables_.getInstance().marketpetid2concernrole.delete(key);
/*    */   }
/*    */   
/*    */   public static boolean add(Long key, ConcernRoleIdSet value)
/*    */   {
/* 32 */     return _Tables_.getInstance().marketpetid2concernrole.add(key, value);
/*    */   }
/*    */   
/*    */   public static boolean remove(Long key)
/*    */   {
/* 37 */     return _Tables_.getInstance().marketpetid2concernrole.remove(key);
/*    */   }
/*    */   
/*    */   public static xdb.TTableCache<Long, ConcernRoleIdSet> getCache()
/*    */   {
/* 42 */     return _Tables_.getInstance().marketpetid2concernrole.getCache();
/*    */   }
/*    */   
/*    */   public static TTable<Long, ConcernRoleIdSet> getTable()
/*    */   {
/* 47 */     return _Tables_.getInstance().marketpetid2concernrole;
/*    */   }
/*    */   
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\xtable\Marketpetid2concernrole.class
