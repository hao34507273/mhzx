...
/*    */ import xdb.TTable;
/*    */ 
/*    */ public class Role2buffmemory
/*    */ {
/*    */   public static RoleBuffList get(Long key)
/*    */   {
/* 12 */     return (RoleBuffList)_Tables_.getInstance().role2buffmemory.get(key);
/*    */   }
/*    */   
/*    */   public static RoleBuffList get(Long key, RoleBuffList value)
/*    */   {
/* 17 */     return (RoleBuffList)_Tables_.getInstance().role2buffmemory.get(key, value);
/*    */   }
/*    */   
/*    */   public static void insert(Long key, RoleBuffList value)
/*    */   {
/* 22 */     _Tables_.getInstance().role2buffmemory.insert(key, value);
/*    */   }
/*    */   
/*    */   public static void delete(Long key)
/*    */   {
/* 27 */     _Tables_.getInstance().role2buffmemory.delete(key);
/*    */   }
/*    */   
/*    */   public static boolean add(Long key, RoleBuffList value)
/*    */   {
/* 32 */     return _Tables_.getInstance().role2buffmemory.add(key, value);
/*    */   }
/*    */   
/*    */   public static boolean remove(Long key)
/*    */   {
/* 37 */     return _Tables_.getInstance().role2buffmemory.remove(key);
/*    */   }
/*    */   
/*    */   public static xdb.TTableCache<Long, RoleBuffList> getCache()
/*    */   {
/* 42 */     return _Tables_.getInstance().role2buffmemory.getCache();
/*    */   }
/*    */   
/*    */   public static TTable<Long, RoleBuffList> getTable()
/*    */   {
/* 47 */     return _Tables_.getInstance().role2buffmemory;
/*    */   }
/*    */   
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\xtable\Role2buffmemory.class
