...
/*    */ import xdb.TTable;
/*    */ 
/*    */ public class Rolegiveflowerrank_backup
/*    */ {
/*    */   public static RoleGiveFlowerRank get(Long key)
/*    */   {
/* 12 */     return (RoleGiveFlowerRank)_Tables_.getInstance().rolegiveflowerrank_backup.get(key);
/*    */   }
/*    */   
/*    */   public static RoleGiveFlowerRank get(Long key, RoleGiveFlowerRank value)
/*    */   {
/* 17 */     return (RoleGiveFlowerRank)_Tables_.getInstance().rolegiveflowerrank_backup.get(key, value);
/*    */   }
/*    */   
/*    */   public static void insert(Long key, RoleGiveFlowerRank value)
/*    */   {
/* 22 */     _Tables_.getInstance().rolegiveflowerrank_backup.insert(key, value);
/*    */   }
/*    */   
/*    */   public static void delete(Long key)
/*    */   {
/* 27 */     _Tables_.getInstance().rolegiveflowerrank_backup.delete(key);
/*    */   }
/*    */   
/*    */   public static boolean add(Long key, RoleGiveFlowerRank value)
/*    */   {
/* 32 */     return _Tables_.getInstance().rolegiveflowerrank_backup.add(key, value);
/*    */   }
/*    */   
/*    */   public static boolean remove(Long key)
/*    */   {
/* 37 */     return _Tables_.getInstance().rolegiveflowerrank_backup.remove(key);
/*    */   }
/*    */   
/*    */   public static xdb.TTableCache<Long, RoleGiveFlowerRank> getCache()
/*    */   {
/* 42 */     return _Tables_.getInstance().rolegiveflowerrank_backup.getCache();
/*    */   }
/*    */   
/*    */   public static TTable<Long, RoleGiveFlowerRank> getTable()
/*    */   {
/* 47 */     return _Tables_.getInstance().rolegiveflowerrank_backup;
/*    */   }
/*    */   
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\xtable\Rolegiveflowerrank_backup.class
