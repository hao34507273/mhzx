...
/*    */ import xdb.TTable;
/*    */ 
/*    */ public class Role2storage16
/*    */ {
/*    */   public static Bag get(Long key)
/*    */   {
/* 12 */     return (Bag)_Tables_.getInstance().role2storage16.get(key);
/*    */   }
/*    */   
/*    */   public static Bag get(Long key, Bag value)
/*    */   {
/* 17 */     return (Bag)_Tables_.getInstance().role2storage16.get(key, value);
/*    */   }
/*    */   
/*    */   public static void insert(Long key, Bag value)
/*    */   {
/* 22 */     _Tables_.getInstance().role2storage16.insert(key, value);
/*    */   }
/*    */   
/*    */   public static void delete(Long key)
/*    */   {
/* 27 */     _Tables_.getInstance().role2storage16.delete(key);
/*    */   }
/*    */   
/*    */   public static boolean add(Long key, Bag value)
/*    */   {
/* 32 */     return _Tables_.getInstance().role2storage16.add(key, value);
/*    */   }
/*    */   
/*    */   public static boolean remove(Long key)
/*    */   {
/* 37 */     return _Tables_.getInstance().role2storage16.remove(key);
/*    */   }
/*    */   
/*    */   public static xdb.TTableCache<Long, Bag> getCache()
/*    */   {
/* 42 */     return _Tables_.getInstance().role2storage16.getCache();
/*    */   }
/*    */   
/*    */   public static TTable<Long, Bag> getTable()
/*    */   {
/* 47 */     return _Tables_.getInstance().role2storage16;
/*    */   }
/*    */   
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\xtable\Role2storage16.class
