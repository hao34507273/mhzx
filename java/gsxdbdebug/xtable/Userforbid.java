...
/*    */   {
/* 12 */     return (ForbidInfo)_Tables_.getInstance().userforbid.get(key);
/*    */   }
/*    */   
/*    */   public static ForbidInfo get(String key, ForbidInfo value)
/*    */   {
/* 17 */     return (ForbidInfo)_Tables_.getInstance().userforbid.get(key, value);
/*    */   }
/*    */   
/*    */   public static void insert(String key, ForbidInfo value)
/*    */   {
/* 22 */     _Tables_.getInstance().userforbid.insert(key, value);
/*    */   }
/*    */   
/*    */   public static void delete(String key)
/*    */   {
/* 27 */     _Tables_.getInstance().userforbid.delete(key);
/*    */   }
/*    */   
/*    */   public static boolean add(String key, ForbidInfo value)
/*    */   {
/* 32 */     return _Tables_.getInstance().userforbid.add(key, value);
/*    */   }
/*    */   
/*    */   public static boolean remove(String key)
/*    */   {
/* 37 */     return _Tables_.getInstance().userforbid.remove(key);
/*    */   }
/*    */   
/*    */   public static TTableCache<String, ForbidInfo> getCache()
/*    */   {
/* 42 */     return _Tables_.getInstance().userforbid.getCache();
/*    */   }
/*    */   
/*    */   public static TTable<String, ForbidInfo> getTable()
/*    */   {
/* 47 */     return _Tables_.getInstance().userforbid;
/*    */   }
/*    */   
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\xtable\Userforbid.class
