...
/*    */ 
/*    */ public class Roleforbid
/*    */ {
/*    */   public static ForbidInfo get(Long key)
/*    */   {
/* 12 */     return (ForbidInfo)_Tables_.getInstance().roleforbid.get(key);
/*    */   }
/*    */   
/*    */   public static ForbidInfo get(Long key, ForbidInfo value)
/*    */   {
/* 17 */     return (ForbidInfo)_Tables_.getInstance().roleforbid.get(key, value);
/*    */   }
/*    */   
/*    */   public static void insert(Long key, ForbidInfo value)
/*    */   {
/* 22 */     _Tables_.getInstance().roleforbid.insert(key, value);
/*    */   }
/*    */   
/*    */   public static void delete(Long key)
/*    */   {
/* 27 */     _Tables_.getInstance().roleforbid.delete(key);
/*    */   }
/*    */   
/*    */   public static boolean add(Long key, ForbidInfo value)
/*    */   {
/* 32 */     return _Tables_.getInstance().roleforbid.add(key, value);
/*    */   }
/*    */   
/*    */   public static boolean remove(Long key)
/*    */   {
/* 37 */     return _Tables_.getInstance().roleforbid.remove(key);
/*    */   }
/*    */   
/*    */   public static TTableCache<Long, ForbidInfo> getCache()
/*    */   {
/* 42 */     return _Tables_.getInstance().roleforbid.getCache();
/*    */   }
/*    */   
/*    */   public static TTable<Long, ForbidInfo> getTable()
/*    */   {
/* 47 */     return _Tables_.getInstance().roleforbid;
/*    */   }
/*    */   
...
/* Location:              D:\桌面\山海\gsxdbdebug.jar!\xtable\Roleforbid.class
