...
def.override("number", "number", "userdata", "table", "=>", "boolean").Operate = function(self, bagId, itemKey, m_panel, context)
  ...
  local function equip()
    ...
    local gender = context and context.gender or heroProp.gender
    if ocp == heroProp.occupation and gender == heroProp.gender then
      ...
      OcpEquipmentMgr.Instance():CPutOnOcpEquipReq(ocp, gender, item.uuid[1])
    end
  end
